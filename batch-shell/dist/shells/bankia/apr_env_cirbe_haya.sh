...
> $DIR_LOCAL/apr_env_cirbe_haya.txt

rm -f $DIR_LOCAL/backup/CIRBE*
...
ftp -vn $SERVER <<END_OF_SESSION
	...
	lcd $DIR_LOCAL
        ...
        put CIRBE*.zip
        put CIRBE*.sem
        put apr_env_cirbe_haya.txt

	bye
END_OF_SESSION

mv -f $DIR_LOCAL/CIRBE*  $DIR_LOCAL/backup/
rm -f $DIR_LOCAL/apr_env_cirbe_haya.txt
