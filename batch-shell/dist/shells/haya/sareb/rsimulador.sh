...
#lanzar apr_refresh_zpu_1.0.2.sh
...
# BLOQUE CONVIVENCIAS #
#lanzar convivenciaF2_procedimientos_1.22.sh
...
#lanzar apr_main_adresses.sh apr_main_phones.sh apr_main_assets.sh 
#lanzarParalelo apr_main_assets_1.13.sh apr_main_phones.sh apr_main_adresses.sh
