...
echo "Incio del proceso de aprovisionamiento de los ficheros CATASTRALES_GR"

#############
### OGF
############# 
echo "Se inicia la transferecia de los ficheros de la gestoria OGF"
fichero=OGF_CATASTRALES_GR
...
fichero=TECNOTRAMIT_CATASTRALES_GR
...
fichero=GUTIERREZL_CATASTRALES_GR
...
fichero=MONTALVO_CATASTRALES_GR
...
fichero=GESTINOVA_CATASTRALES_GR
...
fichero=MARETRA_CATASTRALES_GR
...
fichero=MEDITERRANEO_CATASTRALES_GR
...
fichero=GRUPOBC_CATASTRALES_GR
...
fichero=GESTINOVA99_CATASTRALES_GR
...
fichero=SUNCAPITAL_CATASTRALES_GR
