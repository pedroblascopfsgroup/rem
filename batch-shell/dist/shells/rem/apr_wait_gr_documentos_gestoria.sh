...
echo "Incio del proceso de aprovisionamiento de los ficheros DOCUMENTOS_GR"
...
fichero=TINSACERTIFY_DOCUMENTOS_GR
...
fichero=GUTIERREZL_DOCUMENTOS_GR
...
fichero=MONTALVO_DOCUMENTOS_GR
...
fichero=GESTINOVA_DOCUMENTOS_GR
...
fichero=MEDITERRANEO_DOCUMENTOS_GR
...
fichero=SUNCAPITAL_DOCUMENTOS_GR
