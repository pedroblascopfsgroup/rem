...
echo "Gestoria EMAIS - EMAIS_STOCK_RG_${1}.dat"
lftp -u sftp_emais,"UZ-q4}{k" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/emais/output/EMAIS_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria F&G - F&G_STOCK_RG_${1}.dat"
lftp -u sftp_fyg,"D]it&2/J" sftp://192.168.49.14 <<EOF
cd /output/
mput F\&G_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria GESTINOVA - GESTINOVA_STOCK_RG_${1}.dat"
lftp -u sftp_gestinova,"JD3Rir('" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/gestinova/output/GESTINOVA_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria MARETRA - MARETRA_STOCK_RG_${1}.dat"
lftp -u sftp_maretra,"4Dmx<HEb" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/maretra/output/MARETRA_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria QIPERT - QIPERT_STOCK_RG_${1}.dat"
lftp -u sftp_qipert,"E4GL7~|K" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/qipert/output/QIPERT_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria MEDITERRANEO - MEDITERRANEO_STOCK_RG_${1}.dat"
lftp -u sftp_mediterraneo,"3qP*X8iG" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/mediterraneo/output/MEDITERRANEO_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria GRUPOBC - GRUPOBC_STOCK_RG_${1}.dat"
lftp -u sftp_grupobc,"eDRvpuxN" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/grupoBC/output/GRUPOBC_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria GESTINOVA99 - GESTINOVA99_STOCK_RG_${1}.dat"
lftp -u sftp_gestinova99,"u2K#Plqv" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/gestinova99/output/GESTINOVA99_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
...
echo "Gestoria SUNCAPITAL - SUNCAPITAL_STOCK_RG_${1}.dat"
lftp -u sftp_suncapital,"johl:ohzoS3u" sftp://192.168.49.14 <<EOF
cd /output/
mput $INSTALL_DIR/control/etl/suncapital/output/SUNCAPITAL_STOCK_RG_${1}.dat
bye
EOF
echo "Fichero movido satisfactoriamente"
