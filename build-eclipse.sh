...
if [ "x$1" != "x-q" ]; then
	echo "-----------------------------------------------------------------------------------------------------"
	echo " ASISTENTE PARA CREAR EL PROYECTO EN ECLIPSE PARA recovery-iplus-plugin"
	echo "-----------------------------------------------------------------------------------------------------"
	echo ""
...
mvn $BUILD_PROPERTIES eclipse:eclipse  -Declipse.projectNameTemplate="maven-archetype-webapp"
