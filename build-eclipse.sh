...
if [ "x$1" != "x-q" ]; then
	echo "-----------------------------------------------------------------------------------------------------"
	echo " ASISTENTE PARA CREAR EL PROYECTO EN ECLIPSE PARA MEJORAS"
	echo "-----------------------------------------------------------------------------------------------------"
	echo ""
...
mvn $BUILD_PROPERTIES eclipse:eclipse  -Declipse.projectNameTemplate="recovery-mejoras-plugin$TEMPLATE"
