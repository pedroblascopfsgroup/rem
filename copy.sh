...
if [ -f target/$PLUGIN*-SNAPSHOT.jar ]; then
	rm /var/tomcat/$ENTORNO/webapps/pfs/WEB-INF/lib/$PLUGIN*
	...
	echo "No se encuentra target/$PLUGIN-SNAPSHOT.jar, no se sobreescribira"
fi
