...
if [ -f utils/security/ac-common-web-security.xml ]; then
	rm -Rf /var/tomcat/$ENTORNO/webapps/pfs/WEB-INF/classes/ac-common-web-security.xml
	cp -Rf utils/security/ac-common-web-security.xml /var/tomcat/$ENTORNO/webapps/pfs/WEB-INF/classes/
	chmod 777 /var/tomcat/$ENTORNO/webapps/pfs/WEB-INF/classes/ac-common-web-security.xml
	echo "Se ha copiado utils/security/ac-common-web-security.xml"
else
	echo "No se encuentra utils/security/ac-common-web-security.xml, no se sobreescribira"
fi
