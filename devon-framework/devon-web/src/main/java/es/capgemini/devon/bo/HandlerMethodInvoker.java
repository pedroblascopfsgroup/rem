...
public class HandlerMethodInvoker {
            ...
            if (paramName == null) {
                ...
                if (argValue != WebArgumentResolver.UNRESOLVED) {
                    ...
                    if (paramType.isInstance(binder)) {
                        ...
                        throw new IllegalStateException("Unsupported argument [" + paramType.getName() + "] for @InitBinder method: "
                                + initBinderMethod);
                    }
                }
            }
    ...
    private Object resolveRequestParam(String paramName, boolean paramRequired, MethodParameter methodParam, NativeWebRequest webRequest,
        ...
        if ("".equals(paramName)) {
            ...
            if (paramName == null) {
                throw new IllegalStateException("No parameter specified for @RequestParam argument of type [" + paramType.getName()
    ...
    private WebDataBinder resolveModelAttribute(String attrName, MethodParameter methodParam, ExtendedModelMap implicitModel,
    ...
    @SuppressWarnings("unchecked")
    public final void updateModelAttributes(Object handler, Map mavModel, ExtendedModelMap implicitModel, NativeWebRequest webRequest)
            throws Exception {
    ...
    protected boolean isBindingCandidate(Object value) {
        return (value != null && !value.getClass().isArray() && !(value instanceof Collection) && !(value instanceof Map)
                && !ClassUtils.isPrimitiveOrWrapper(value.getClass()) && !(value instanceof CharSequence) && !(value instanceof Number) && !(value instanceof Date));
    }
