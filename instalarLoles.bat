copy target\recovery-panelControl-plugin-*SNAPSHOT.jar C:\pfs\batch
move target\recovery-panelControl-*SNAPSHOT.jar C:\pfssor\sortomcat\wtpwebapps\rec-web\WEB-INF\lib
