move target\recovery-masivo-common-1.2-SNAPSHOT.jar C:\pfssor\sortomcat\wtpwebapps\rec-web\WEB-INF\lib
...
xcopy /s /y src\web\img\*.* C:\pfssor\sortomcat\wtpwebapps\rec-web\img
xcopy /s /y src\web\plantillas\*.* C:\pfssor\sortomcat\wtpwebapps\rec-web\plantillas\
xcopy /s /y src\web\js\*.* C:\pfssor\sortomcat\wtpwebapps\rec-web\js\
