...
export DESCRIPCION="Envio de ficheros de Impulsos Automáticos generados (sin procurador)"
export HOST=vip.lindorff.nl
export USER=PFS
export PASS=tNCWdYVnbP
export FTP_DIR=SALIDA/IMPULSOS_AUTOMATICOS/SIN_PROCURADOR
export DIR_ENTRADA=/tmp/impulsos/sin_proc
