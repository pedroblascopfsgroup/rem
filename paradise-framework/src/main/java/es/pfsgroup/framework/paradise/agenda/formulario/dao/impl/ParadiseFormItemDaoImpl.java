package es.pfsgroup.framework.paradise.agenda.formulario.dao.impl;
...
@Repository("ParadiseFormItemDaoImpl")
public class ParadiseFormItemDaoImpl extends AbstractEntityDao<GenericFormItem, Long> implements ParadiseFormItemDao{
