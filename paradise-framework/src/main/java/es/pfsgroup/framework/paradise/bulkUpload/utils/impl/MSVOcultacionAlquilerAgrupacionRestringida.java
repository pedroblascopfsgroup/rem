...
@Component
public class MSVOcultacionAlquilerAgrupacionRestringida extends MSVExcelValidatorAbstract{

	private static final String ACTIVE_NOT_EXISTS = "El activo no existe";
	private static final String ACTIVO_VENDIDO = "Hay activos vendidos";
	private static final String ACTIVO_NO_PUBLICABLE = "Hay activos no publicables";
	private static final String ACTIVO_NO_COMERCIALIZABLE = "Hay activos no comercializables";
	private static final String DESTINO_FINAL_NO_ALQUILER = "Hay activos cuyo destino comercial no es alquiler";
	private static final String ACTIVO_NO_PUBLICADO = "Hay activos que no están publicados";
	private static final String ACTIVO_OCULTO = "Hay activos que estan ocultos";
