...
//            this.form.afterAction(this, true);
    ...
    ,onMetaChange:function(form, meta) {
        ...
        this.add(new Ext.Panel({
            ...
            ,border:false
            ,defaults:(function(){
            	var cc = meta.formConfig ? meta.formConfig.columnCount || this.columnCount : this.columnCount;
                this.columnCount = parseInt(cc);
        ...
        columns = this.items.get(colItem).items;
        colIndex = 0;
        tabIndex = 1;
        ...
        Ext.each(meta.columns || meta.fields, function(item) {
            ...
            var config = Ext.apply({}, item.editor, {
                ...
                ,data: item.editor && item.editor.data ? item.editor.data : null
            });
        ...
        this.windowWidth = parseInt(meta.formConfig.width || 0);
        this.windowHeight = parseInt(meta.formConfig.height || 0);
        this.windowTitle = meta.formConfig.wtitle || null;
        this.readOnly = meta.formConfig.readOnly || false;
