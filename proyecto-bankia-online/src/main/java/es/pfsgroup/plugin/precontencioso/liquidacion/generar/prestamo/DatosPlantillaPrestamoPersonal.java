...
/**
 * Clase que obtiene los datos necesarios para rellenar la plantilla de prestamo personal
 * 
 * @author jmartin
 */
@Component
public class DatosPlantillaPrestamoPersonal extends DatosPlantillaPrestamoAbstract implements DatosPlantillaFactory {

	// Codigo de la liquidacion a la que aplica los datos
	private static final String CODIGO_TIPO_LIQUIDACION = "PERSONAL";
