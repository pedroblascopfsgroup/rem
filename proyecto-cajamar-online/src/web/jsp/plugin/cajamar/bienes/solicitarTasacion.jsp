...
<fwk:page>
	...
	var ctac = new Ext.form.NumberField({
		fieldLabel:'<s:message code="plugin.cajamar.bienes.ctac" text="**Cuenta asociada al préstamo" />'
	...
	var nroTfno = new Ext.form.NumberField({
		fieldLabel:'<s:message code="plugin.cajamar.bienes.telefono" text="**Teléfono" />'
	...
	var btnGuardar = new Ext.Button({
		...
		,handler : function(){
			if(!ctac.validate()) {
				...
				Ext.Ajax.request({
					url : page.resolveUrl('bienhaya/solicitarTasacion'), 
