...
var cb_notificacion = items[1 + muestraBotonGuardar];
var fecha_notificacion = items[2 + muestraBotonGuardar];

cb_notificacion.on('select', function(){
	
	if(cb_notificacion.getValue() == '01') {//si
		fecha_notificacion.setDisabled(false);
	}
	else if(cb_notificacion.getValue() == '02') {//no
		fecha_notificacion.setValue('');
		fecha_notificacion.setDisabled(true);
	}
});
