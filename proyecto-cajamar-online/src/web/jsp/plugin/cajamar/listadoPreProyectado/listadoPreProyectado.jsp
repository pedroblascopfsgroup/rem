...
<fwk:page>
	...
	var comboEstadoGestion = new Ext.form.ComboBox({
		...
		,editable: false
		,emptyText:'---'
		,fieldLabel:'<s:message code="plugin.cajamar.listadoPreProyectado.datosGenerales.estadoGestion" text="**Estado gesti√≥n"/>'
	});
...
// codigo expediente
	...
	var comboJerarquia = app.creaCombo({triggerAction: 'all', data:nivelesExp, value:nivelesExp.diccionario[0].codigo, name: 'nivelesExp',fieldLabel:'<s:message code="plugin.cajamar.listadoPreProyectado.expediente.jerarquia" text="**Jerarqu√≠a"/>' })
...
<%-- 		} --%>
	...
	var comboJerarquiaContrato = app.creaCombo({triggerAction: 'all', data:jerarquia, value:jerarquia.diccionario[0].codigo, name: 'jerarquia',fieldLabel:'<s:message code="plugin.cajamar.listadoPreProyectado.contrato.jerarquia" text="**Jerarqu√≠a"/>' })
	...
	var contratosCM = new Ext.grid.ColumnModel([
		...
		,{header: '<s:message code="preproyectado.contratos.diasVencidos" text="**DÌas vencidos" />',dataIndex: 'diasVencidos',sortable:true, align: 'right'}
		...
		,{header: '<s:message code="preproyectado.contratos.propuesta" text="**⁄ltima Propuesta" />',dataIndex: 'propuesta',sortable:true}
		,{header: '<s:message code="preproyectado.contratos.estadoGestion" text="**Estado GestiÛn" />',dataIndex: 'estadoGestion',sortable:true}
		,{header: '<s:message code="preproyectado.contratos.fechaPrevistaRegularizacion" text="**Fecha prevista regularizaciÛn" />',dataIndex: 'fechaPrevReguCnt',sortable:true}
	]);
	...
	var expedientesCM = new Ext.grid.ColumnModel([
		...
		,{header: '<s:message code="preproyectado.expedientes.diasVencidosExp" text="**DÌas vencidos" />',dataIndex: 'diasVencidosExp',sortable:true, align: 'right', css: cssExp}
		...
		,{header: '<s:message code="preproyectado.expedientes.fechaPrevReguExp" text="**Fecha prevista regularizaciÛn" />',dataIndex: 'fechaPrevReguExp',sortable:true, css: cssExp}		
	]);
	...
	//aÒadimos el panel principal a la pagina
	page.add(mainPanel);
