...
var cb_conformidad = items[2 + muestraBotonGuardar];
var ta_propuesta = items[3 + muestraBotonGuardar];

ta_propuesta.setDisabled(true);

cb_conformidad.on('select', function(){
	if(cb_conformidad.getValue() != 'MOD') {
		ta_propuesta.setDisabled(true);
		ta_propuesta.allowBlank = true;
	}
	else{
		ta_propuesta.setDisabled(false);
		ta_propuesta.allowBlank = false;
	}
});
