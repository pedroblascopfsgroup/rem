...
var cuantiaLetrado = items[1+muestraBotonGuardar];
var cuantiaProcurador = items[2+muestraBotonGuardar];

cuantiaLetrado.setReadOnly(true);
cuantiaProcurador.setReadOnly(true);
