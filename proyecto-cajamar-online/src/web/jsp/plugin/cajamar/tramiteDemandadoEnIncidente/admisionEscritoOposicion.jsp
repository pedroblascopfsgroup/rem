...
var cb_comboVista = items[2 + muestraBotonGuardar];
var d_fechaVista = items[3 + muestraBotonGuardar];

d_fechaVista.setDisabled(true);

cb_comboVista.on('select', function(){
	if(cb_comboVista.getValue() == '01') {//si
		d_fechaVista.setDisabled(false);
		d_fechaVista.allowBlank = false;
	}
	else if(cb_comboVista.getValue() == '02') {//no
		d_fechaVista.setDisabled(true);
		d_fechaVista.setValue('');
		d_fechaVista.allowBlank = true;
	}
});	
