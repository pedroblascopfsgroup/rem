...
var cb_requerida = items[2 + muestraBotonGuardar];
//var cb_suspender = items[3 + muestraBotonGuardar];
//var cb_motivoSuspension = items[4 + muestraBotonGuardar];
var cb_consignacion = items[3 + muestraBotonGuardar];
var cuantia_consignacion = items[4 + muestraBotonGuardar];

cb_consignacion.on('select', function(){
	//Borramos todos los combos dependientes ante cualquier cambio
	//cb_requerida.setValue('');
	//cb_motivoSuspension.setValue('');
	
	if(cb_consignacion.getValue() == '01') {//si
		cuantia_consignacion.setDisabled(false);
		//cb_requerida.setDisabled(true);
	}
	else if(cb_consignacion.getValue() == '02') {//no
		cuantia_consignacion.setValue('');
		cuantia_consignacion.setDisabled(true);
		//cb_requerida.setDisabled(false);
	}
});
