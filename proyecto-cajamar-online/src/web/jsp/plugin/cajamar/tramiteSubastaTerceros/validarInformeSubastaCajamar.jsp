...
var cb_atribuciones = items[1 + muestraBotonGuardar];
var cb_autorizacion = items[3 + muestraBotonGuardar];


cb_atribuciones.on('select', function(){
	//Borramos todos los combos dependientes ante cualquier cambio
	cb_autorizacion.setValue('');
	
	if(cb_atribuciones.getValue() == '01') {//si
		cb_autorizacion.setDisabled(true);
		cb_autorizacion.allowBlank = true;
	}
	else if(cb_atribuciones.getValue() == '02') {//no
		cb_autorizacion.setDisabled(false);
		cb_autorizacion.allowBlank = false;
	}
});
