...
<c:if test="${form.tareaExterna.tareaPadre.fechaFin==null && form.errorValidacion==null && !readOnly}">
	var btnGuardar = new Ext.Button({
		...
		,handler : function(){
			...
			// **************************************************************** //
			var tx_fechaOposicion = items[1 + muestraBotonGuardar];
			var cb_existeOposicion = items[2 + muestraBotonGuardar];
			...
			if (existeOposicion == '02' && fechaOposicion != ''){
				tx_fechaOposicion.markInvalid('Sin oposicion, no debe registrar ninguna fecha de oposicion');
				ok = 1
			}
