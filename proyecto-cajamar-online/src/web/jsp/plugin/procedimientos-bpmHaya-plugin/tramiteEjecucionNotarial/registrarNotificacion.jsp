...
var ta_otrosTitulares = items[1 + muestraBotonGuardar];
var tx_sujeto = items[2 + muestraBotonGuardar];
var cb_notificado = items[3 + muestraBotonGuardar];
var d_fechaNotificado = items[4 + muestraBotonGuardar];

ta_otrosTitulares.setDisabled(true);

if(ta_otrosTitulares.getValue().trim().length > 0){
	tx_sujeto.setDisabled(false);
	cb_notificado.setDisabled(false);
	d_fechaNotificado.setDisabled(false);
	tx_sujeto.allowBlank = false;
	cb_notificado.allowBlank = false;
	d_fechaNotificado.allowBlank = false;
}else{
	tx_sujeto.setDisabled(true);
	cb_notificado.setDisabled(true);
	d_fechaNotificado.setDisabled(true);
	tx_sujeto.allowBlank = true;
	cb_notificado.allowBlank = true;
	tx_sujeto.allowBlank = true;
}
