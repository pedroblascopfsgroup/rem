...
var resultado = items[2 + offset];
var agencia = items[3 + offset];
var seguridad = items[4 + offset];
var catastro = items[5 + offset];
var ayuntamiento = items[6 + offset];
var otros = items[7 + offset];
var solvencia = items[8 + offset];
var impuestos = items[9 + offset];

resultado.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboRegistro']}");
agencia.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboAgTribut']}");
seguridad.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboSegSocial']}");
catastro.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboCatastro']}");
ayuntamiento.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboAyto']}");
otros.setValue("${valores['H044_RegistrarResultadoInvestigacion']['comboOtros']}");
solvencia.setValue("${valores['H044_RegistrarResultadoInvestigacion']['solvencia']}");
impuestos.setValue("${valores['H044_RegistrarResultadoInvestigacion']['impuestos']}");

resultado.setDisabled(true);
agencia.setDisabled(true);
seguridad.setDisabled(true);
catastro.setDisabled(true);
ayuntamiento.setDisabled(true);
otros.setDisabled(true);
solvencia.setDisabled(true);
impuestos.setDisabled(true);
