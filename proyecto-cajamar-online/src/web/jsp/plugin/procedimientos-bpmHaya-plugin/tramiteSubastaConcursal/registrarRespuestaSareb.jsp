...
//Bloqueamos el campo de número de propuesta porque viene preinformado de la anterior tarea y no debe modificarse
var numeroPropuestaSareb = items[2 + muestraBotonGuardar];
numeroPropuestaSareb.setDisabled(true);
