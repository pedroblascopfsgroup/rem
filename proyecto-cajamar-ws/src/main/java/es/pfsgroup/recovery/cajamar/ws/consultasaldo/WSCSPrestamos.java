...
import org.cajamar.ws.S_C_RECOVERY_DAT_PR.INPUT;
import org.cajamar.ws.S_C_RECOVERY_DAT_PR.OUTPUT;
import org.cajamar.ws.S_C_RECOVERY_DAT_PR.ObjectFactory;
import org.cajamar.ws.S_C_RECOVERY_DAT_PR.SCRECOVERYDATPR;
import org.cajamar.ws.S_C_RECOVERY_DAT_PR.SCRECOVERYDATPRType;
...
@Component(value="wsCSCuentaPR")
public class WSCSPrestamos extends BaseWS implements WSConsultaSaldos {

	private static final String WEB_SERVICE_NAME = "S_C_RECOVERY_DAT_PR";
	...
	private ResultadoConsultaSaldo ejecutaServicio(INPUT input) throws MalformedURLException {
		...
		SCRECOVERYDATPR service = new SCRECOVERYDATPR(wsdlLocation, qName);
		SCRECOVERYDATPRType servicePort = service.getSCRECOVERYDATPRPort();
		OUTPUT output = servicePort.sCRECOVERYDATPR(input);
