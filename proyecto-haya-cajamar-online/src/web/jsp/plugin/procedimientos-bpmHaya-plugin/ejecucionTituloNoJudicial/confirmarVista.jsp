...
var cb_hayVista = items[1 + muestraBotonGuardar];
var fechaVista = items[2 + muestraBotonGuardar];

cb_hayVista.on('select', function(){
	if(cb_hayVista.getValue() == '01') {//si
		fechaVista.setDisabled(false);
	}
	else if(cb_hayVista.getValue() == '02') {//no
		fechaVista.setValue('');
		fechaVista.setDisabled(true);		
	}
});
