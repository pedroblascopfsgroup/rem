...
var cb_adjudicadoEntidad = items[3 + muestraBotonGuardar];
var cb_cesionRemate = items[4 + muestraBotonGuardar];
var cb_adjudicadoTercero = items[5 + muestraBotonGuardar];
...
cb_subastaCelebrada.on('select', function(){
	...
	if(cb_subastaCelebrada.getValue() == '01') {//si
		...
		cb_adjudicadoTercero.setDisabled(true);
		cb_motivo.setDisabled(false);
		cb_cesionRemate.allowBlank = true;
		cb_adjudicadoEntidad.allowBlank = true;
		cb_adjudicadoTercero.allowBlank = true;
