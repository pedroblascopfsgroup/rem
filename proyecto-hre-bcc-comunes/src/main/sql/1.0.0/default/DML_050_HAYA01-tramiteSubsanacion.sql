...
--######################################################################
--## Author: Roberto
--## BPM: T. Subsanación Decreto de Adjudicación (H052)
...
DECLARE
    ...
    CODIGO_PROCEDIMIENTO_ANTIGUO VARCHAR2(10 CHAR) := 'P414'; -- Variable con el código (DD_TPO_ID) del procedimiento antiguo para poder desactivarlo

    TYPE T_TIPO_TPO IS TABLE OF VARCHAR2(1000);
    TYPE T_ARRAY_TPO IS TABLE OF T_TIPO_TPO;
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
		T_TIPO_TPO('H052','T. de subsanación de decreto de embargo','T. de subsanación de decreto de embargo','','haya_tramiteSubsanacionEmbargo','0','DML','0','AP','','','8','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('H052','H052_EntregarNuevoDecreto','','comprobarExisteDocumentoDSSDA() ? null : ''Es necesario adjuntar el Decreto subsanado.''','','','','0','Entregar nuevo decreto/testimonio decreto de adjudicación','0','DML','0','','','','1','EXTTareaProcedimiento','3','','39','','GAREO',''),
		T_TIPO_TAP('H052','H052_RegistrarPresentacionEscritoSub','','','','','','0','Registrar presentación de escrito de subsanación','0','DML','0','','','','0','EXTTareaProcedimiento','3','','39','','GAREO','')		
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(    
		T_TIPO_PLAZAS('','','H052_EntregarNuevoDecreto','(valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''] != null ?(valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''][''comboSituacionTitulo''] != null ? (valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''][''comboSituacionTitulo''] == ''PEN'' ? (damePlazo(valoresBPMPadre[''H005_ConfirmarTestimonio''][''fechaEnvioGestoria'']) + 5*24*60*60*1000L) : 10*24*60*60*1000L) : 10*24*60*60*1000L ) : 10*24*60*60*1000L)','0','0','DML'),
		T_TIPO_PLAZAS('','','H052_RegistrarPresentacionEscritoSub','(valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''][''comboSituacionTitulo''] == ''PEN'' ? (valoresBPMPadre[''H005_ConfirmarTestimonio''][''fechaEnvioGestoria''] + 5*24*60*60*1000L) : 10*24*60*60*1000L )','0','0','DML')		
    ); 
