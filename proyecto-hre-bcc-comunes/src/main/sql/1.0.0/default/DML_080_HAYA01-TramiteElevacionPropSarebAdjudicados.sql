...
--## BPM: H010 Trámite Elevacion Propuesta Sareb Adjudicados
--## Finalidad: Insertar datos en tablas de configuración del BPM
--## INSTRUCCIONES: Configurar variables marcadas con [PARAMETRO]
--## VERSIONES:
--##        + 0.1 Versión inicial
--##        + 0.2 Reformateado para facilitar datos de arrays
--##        + 0.3 Campos con Foreign keys recalculados por selects
--##              a tablas entidad o diccionarios
--##        + 0.4 Parametrizacion de tablas
--##        + 0.5 (JoseVI) Adaptadas validaciones de existencia de registros. Si existen se descartan INSERTs
--##        + 0.6 (JoseVI) Se incluye salida cuando error WHENEVER SQLERROR EXIT
--######################################################################
--*/
...
DECLARE
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO(
        /*DD_TPO_CODIGO.............::*/ 'H010',
        /*DD_TPO_DESCRIPCION.........:*/ 'T. Elevacion Propuesta Sareb Adjudicados',
        /*DD_TPO_DESCRIPCION_LARGA...:*/ 'T. de Elevacion de Propuesta a Sareb para Adjudicados',
        /*DD_TPO_HTML................:*/ null,
        /*DD_TPO_XML_JBPM............:*/ 'haya_tramiteElevacionPropSarebAdjudicados',
        /*VERSION....................:*/ '0',
        /*USUARIOCREAR...............:*/ 'DD',
        /*BORRADO....................:*/ '0',
        /*DD_TAC_ID..................:*/ 'CO',
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H010',
        /*TAP_CODIGO...................:*/ 'H010_ElevarPropuestaSareb',
        /*TAP_VIEW.....................:*/ null,
        ...
        /*TAP_SUPERVISOR,..............:*/ '0',
        /*TAP_DESCRIPCION,.............:*/ 'Elevar la propuesta a Sareb',
        /*VERSION......................:*/ '0',
        /*USUARIOCREAR.................:*/ 'DD',
        /*BORRADO......................:*/ '0',
      ...
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H010',
        /*TAP_CODIGO...................:*/ 'H010_RespuestaSareb',
        /*TAP_VIEW.....................:*/ 'plugin/procedimientos-bpmHaya/tramiteElevacionSareb/respuestaSareb',
        /*TAP_SCRIPT_VALIDACION........:*/ 'comprobarExisteDocumentoINRSI() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial;"><p style="margin-bottom: 10px">Para poder continuar debe adjuntar el documento "Respuesta de Sareb con Instrucciones".</p></div>''',
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
        /*TAP_SCRIPT_DECISION..........:*/ null,
        /*DD_TPO_ID_BPM(FK)............:*/ null,
        /*TAP_SUPERVISOR,..............:*/ '0',
        /*TAP_DESCRIPCION,.............:*/ 'Respuesta de Sareb',
        /*VERSION......................:*/ '0',
        /*USUARIOCREAR.................:*/ 'DD',
        /*BORRADO......................:*/ '0',
        /*TAP_ALERT_NO_RETORNO.........:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H010_ElevarPropuestaSareb',
       ...
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H010_RespuestaSareb',
          /*DD_PTP_PLAZO_SCRIPT......:*/ 'damePlazo(valores[''H010_ElevarPropuestaSareb''][''fecha'']) + 7*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
        )  --Cerrar con ")," si no es la ultima fila. Cerrar con ")" si es ultima fila
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H010_RespuestaSareb',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Informar de la resolución del Sareb.</p><p style="margin-bottom: 10px">En el campo observaciones informar de cualquier aspecto relevante que le interese quede reflejado en este punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute; "Registrar propuesta de acuerdo" a realizar por el letrado.</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI(
            ...
            /*TFI_TIPO...............:*/ 'date',
            /*TFI_NOMBRE.............:*/ 'fecha',
            /*TFI_LABEL..............:*/ 'Fecha apertura negociaciones',
            /*TFI_ERROR_VALIDACION...:*/ 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio',
            /*TFI_VALIDACION.........:*/ 'valor != null && valor != '''' ? true : false',
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI(
            ...
            /*TFI_ERROR_VALIDACION...:*/ 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio',
            /*TFI_VALIDACION.........:*/ 'valor != null && valor != '''' ? true : false',
            /*TFI_VALOR_INICIAL......:*/ 'valores[''H010_ElevarPropuestaSareb''][''numprop'']',
            /*TFI_BUSINESS_OPERATION.:*/ null,
            /*VERSION................:*/ '0',
            /*USUARIOCREAR...........:*/ 'DD'
        ), --Cerrar con ")," si no es la ultima fila. Cerrar con ")" si es ultima fila
        
		T_TIPO_TFI('H010_RespuestaSareb','3','combo','comboResultado','Resultado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDResultadoComiteConcursal','0','DD'),
		--T_TIPO_TFI('H010_RespuestaSareb','4','htmleditor','propuestaInstrucciones','Instrucciones propuestas','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H017_ElevarPropuestaASareb_1''] == null ? '''' : (valores[''H017_ElevarPropuestaASareb_1''][''propuestaInstrucciones''])',null,'0','DD'),
