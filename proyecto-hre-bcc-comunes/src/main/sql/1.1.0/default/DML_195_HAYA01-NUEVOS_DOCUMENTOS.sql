...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('CNAUAP', 'Convenio y auto aprobación', 'Convenio y auto aprobación', 'CO'), -- T. Presentación propuesta de convenio
      T_TIPO_TFA('ACPCARDP', 'Aceptación del cargo depositario', 'Documento del Juzgado de Aceptación del Cargo', 'TR'), -- T. Depositario
      T_TIPO_TFA('ACUENTDP', 'Acuerdo Entrega a depositario', 'Documento que acredite el acuerdo de la entrega y la entrega efectiva', 'TR'), -- T. Depositario
      T_TIPO_TFA('RETNJ', 'Resolución (Ejecución Titulo No Judicial)', 'Resolución (Ejecución Titulo No Judicial)', 'EJ') -- T. Ejecución Titulo No Judicial
    ); 
