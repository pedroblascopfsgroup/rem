...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      ...
      T_TIPO_TFA('RAP', 'Documento resolución acredite precinto (Precinto)', 'Documento de resolución que acredite el precinto (Precinto)', 'TR'),
      T_TIPO_TFA('DREP', 'Documento realización efectiva precinto (Precinto)', 'Documento de realización efectiva del precinto (Precinto)', 'TR')
