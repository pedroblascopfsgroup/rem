...
--######################################################################
--## Author: Nacho
--## BPM: T. Solicitud Actuaciones o Pronunciamientos (H019)
...
DECLARE
    ...
    CODIGO_PROCEDIMIENTO_ANTIGUO VARCHAR2(10 CHAR) := 'P27'; -- Variable con el código (DD_TPO_ID) del procedimiento antiguo para poder desactivarlo

    TYPE T_TIPO_TPO IS TABLE OF VARCHAR2(1000);
    TYPE T_ARRAY_TPO IS TABLE OF T_TIPO_TPO;
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
		T_TIPO_TPO('H019','T. de solicitud de actuaciones o pronunciamientos','Trámite de solicitud de actuaciones o pronunciamientos','','haya_tramiteSolicitudActuacionesPronunciamientos','0','DD','0','CO','','','1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('H019','H019_presentarSolicitud','','','','','','0','Presentar solicitud','0','DD','0','','','01','1','EXTTareaProcedimiento','3','','39','','GUCL',''),
		T_TIPO_TAP('H019','H019_RegistrarResultadoSolicitud','','','','','','0','Registrar resultado solicitud','0','DD','0','','','01','0','EXTTareaProcedimiento','3','','39','','GUCL','')
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(    
		T_TIPO_PLAZAS('','','H019_presentarSolicitud','5*24*60*60*1000L','0','0','DD'),
		T_TIPO_PLAZAS('','','H019_RegistrarResultadoSolicitud','damePlazo(valores[''H019_presentarSolicitud''][''fecha'']) + 60*24*60*60*1000L','0','0','DD')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		T_TIPO_TFI('H019_presentarSolicitud','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Informar fecha de presentaci&oacute;n en el Juzgado del escrito de declaraci&oacute;n de no afecci&oacute;n o del requerimiento dirigido a la Administraci&oacute;n Concursal para solicitud de actuaciones de reintegraci&oacute;n, o de otro tipo, contra terceros as&iacute; como el nombre de la persona o entidad implicada.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento</p><p style="margin-bottom: 10px">La siguiente tarea ser&aacute; “Registrar resultado solicitud”.</p></div>','','','','','0','DD'),
		T_TIPO_TFI('H019_presentarSolicitud','1','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','','0','DD'),
		T_TIPO_TFI('H019_presentarSolicitud','2','text','terceroImplicado','Tercero implicado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','','0','DD'),
		T_TIPO_TFI('H019_presentarSolicitud','3','textarea','observaciones','Observaciones','',null,'','','0','DD'),
		T_TIPO_TFI('H019_RegistrarResultadoSolicitud','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla se deber&aacute; de informar la fecha de notificaci&oacute;n del resultado que hubiere reca&iacute;do, así como el resultado ya sea aceptada o no.</p><p style="margin-bottom: 10px">En el campo observaciones consignar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, la siguiente tarea le propondr&aacute;, seg&uacute;n su criterio, que indique la siguiente actuaci&oacute;n al responsable de la entidad.</p></div>','','','','','0','DD'),
		T_TIPO_TFI('H019_RegistrarResultadoSolicitud','1','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','','0','DD'),
		T_TIPO_TFI('H019_RegistrarResultadoSolicitud','2','combo','comboResultado','Aceptado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','DDSiNo','0','DD'),
		T_TIPO_TFI('H019_RegistrarResultadoSolicitud','3','textarea','observaciones','Observaciones','',null,'','','0','DD')
    ); 
