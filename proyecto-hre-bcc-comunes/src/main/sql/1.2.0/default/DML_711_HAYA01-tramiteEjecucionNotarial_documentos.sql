...
--##########################################
--## Author: Roberto
--## Finalidad: DML para crear los nuevos tipos de documentos adjuntos del Trámite de Ejecución Notarial o Extrajudicial
...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('CRG', 'Certificado Registral (T. Ejecución Notarial o Extrajudicial)', 'Certificado Registral (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('ADS', 'Auto declarando subasta (T. Ejecución Notarial o Extrajudicial)', 'Auto declarando subasta (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('BOP', 'Boletin Oficial Propiedad (T. Ejecución Notarial o Extrajudicial)', 'Boletin Oficial Propiedad (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('TSU', 'Tasación de la subasta (T. Ejecución Notarial o Extrajudicial)', 'Tasación de la subasta (T. Ejecución Notarial o Extrajudicial)', 'EX'),
	  T_TIPO_TFA('ASU', 'Acta de subasta (T. Ejecución Notarial o Extrajudicial)', 'Acta de subasta (T. Ejecución Notarial o Extrajudicial)', 'EX'),
	  T_TIPO_TFA('PIN', 'Propuesta de instrucciones (T. Ejecución Notarial o Extrajudicial)', 'Propuesta de instrucciones (T. Ejecución Notarial o Extrajudicial)', 'EX'),
	  T_TIPO_TFA('PSUDUL', 'Propuesta Subasta firmada por Dtor UCyL (T. Ejecución Notarial o Extrajudicial)', 'Propuesta Subasta firmada por Dtor UCyL (T. Ejecución Notarial o Extrajudicial)', 'EX'),
	  T_TIPO_TFA('PSUSB', 'Plantilla subasta SAREB (T. Ejecución Notarial o Extrajudicial)', 'Plantilla subasta SAREB (T. Ejecución Notarial o Extrajudicial)', 'EX'),
	  T_TIPO_TFA('RSARE', 'Respuesta SAREB (T. Ejecución Notarial o Extrajudicial)', 'Respuesta SAREB (T. Ejecución Notarial o Extrajudicial)', 'EX')
    ); 
