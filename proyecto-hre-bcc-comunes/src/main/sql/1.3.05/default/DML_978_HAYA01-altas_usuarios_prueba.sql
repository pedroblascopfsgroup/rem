...
--##########################################
--## Author: Roberto
--## Finalidad: DML para crear usuarios de prueba suplementarios
...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(     
      T_TIPO_TFA('DUCL','D_UCL_V','1234','NOMBRE_PRUEBA','Gestoría Director Unidad Concursos y Litigios'),      
      T_TIPO_TFA('SUCL','S_UCL_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor Unidad Concursos y Litigios'),
      T_TIPO_TFA('GUCL','G_UCL_V','1234','NOMBRE_PRUEBA','Gestoría Gestor Unidad Concursos y Litigios'),            
      T_TIPO_TFA('GSUB','G_SUB_V','1234','NOMBRE_PRUEBA','Gestoría Gestor subastas'),
      T_TIPO_TFA('SSUB','S_SUB_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor subastas'),
      T_TIPO_TFA('GDEU','G_DEUDA_V','1234','NOMBRE_PRUEBA','Gestoría Gestor deuda'),
      T_TIPO_TFA('SDEU','S_DEUDA_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor gestión deuda'),
      T_TIPO_TFA('GSDE','G_SOP_V','1234','NOMBRE_PRUEBA','Gestoría Gestor soporte deuda'),
      T_TIPO_TFA('SSDE','S_SOP_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor soporte deuda'),
      T_TIPO_TFA('UCON','G_CONT_V','1234','NOMBRE_PRUEBA','Gestoría Usuario contabilidad'),
      T_TIPO_TFA('SCON','S_CONT_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor contabilidad'),
      T_TIPO_TFA('UFIS','G_FISC_V','1234','NOMBRE_PRUEBA','Gestoría Usuario fiscal'),
      T_TIPO_TFA('SFIS','S_FISC_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor fiscal'),
      T_TIPO_TFA('GAREO','G_ADM_V','1234','NOMBRE_PRUEBA','Gestoría Gestor admisión REO'),      
      T_TIPO_TFA('SAREO','S_ADM_V','1234','NOMBRE_PRUEBA','Gestoría Supervisor admisión REO'),  
      T_TIPO_TFA('GPS','G_SAN_V','1234','NOMBRE_PRUEBA','Gestoría Gestoría para saneamiento'), /*No lo utilizamos, es de Bankia*/
      T_TIPO_TFA('GPA','G_ADJ_V','1234','NOMBRE_PRUEBA','Gestoría Gestoría para adjudicación'), /*No lo utilizamos, es de Bankia*/
      ...
      T_TIPO_TFA('LETR','LETRADO_V','1234','NOMBRE_PRUEBA','Gestoría Letrado'),
      T_TIPO_TFA('GESTORIA','GESTORIA_V','1234','NOMBRE_PRUEBA','Gestoría') /*Este tipo de gestor ya existía de Bankia*/      
