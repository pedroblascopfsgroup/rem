...
create or replace 
PROCEDURE ALTA_BPM_INSTANCES_ALL AS
  ...
  , PROCEDIMIENTOS AS (
    ...
    WHERE --PRC.PRC_PROCESS_BPM IS NULL AND 
    PRC.BORRADO = 0
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  TMP_ALTA_BPM_INSTANCES';
  ...
  LOOP
    ...
    VALUES (L_PRC(I).PRC_ID, L_PRC(I).DEFINITION_ID, L_PRC(I).NODE_ID, L_PRC(I).TAP_CODIGO, L_PRC(I).TEX_ID
      , HAYAMASTER.HIBERNATE_SEQUENCE.NEXTVAL, HAYAMASTER.HIBERNATE_SEQUENCE.CURRVAL, HAYAMASTER.HIBERNATE_SEQUENCE.CURRVAL, HAYAMASTER.HIBERNATE_SEQUENCE.CURRVAL);
