...
docker run -u $(id -u):$(id -g) --rm -t -v $EXTJS_IN_FOLDER:/input -v $EXTJS_OUT_FOLDER:/output docker-repo.pfsgroup.es:5000/extjs/cmd-6.0.1.76:1.0 sencha-build.sh 998 997 $BUILD_MODE $DEBUG_MODE
