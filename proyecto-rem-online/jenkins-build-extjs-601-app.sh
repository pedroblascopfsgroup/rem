...
<<<<<<< HEAD
docker run -u $(id -u):$(id -g) --rm -i -v $EXTJS_IN_FOLDER:/input -v $EXTJS_OUT_FOLDER:/output docker-repo.pfsgroup.es:5000/extjs/cmd-6.0.1.76:1.0 sencha-build.sh $(id -u) $(id -g) $BUILD_MODE $DEBUG_MODE
=======
