 ...
 * Bundle is used to load .properties bundle files based in language and expose the bundle's keys thru getMsg method. 
        ...
        Ext.application({
            name: 'AppTest',
            requires: ['HreRem.ux.i18n.Bundle'],
 ...
 */
Ext.define('HreRem.ux.i18n.Bundle', {
    extend: 'Ext.data.Store',
    requires: [
        'Ext.app.Application',
        'HreRem.ux.i18n.reader.Property',
        'HreRem.ux.i18n.reader.Json'
    ],
    ...
    autoLoad: false,
    //TODO: review this
    model : Ext.define('HreRem.ux.i18n._modelBundle', {
        ...
        initConfig: function(instanceConfig) {
            ...
            for(k in instanceConfig){
                if(instanceConfig.hasOwnProperty(k) && instanceConfig[k] && typeof instanceConfig[k] === 'object' && instanceConfig[k].type && instanceConfig[k].type === 'bundle'){
                    instanceConfig[k] = HreRem.ux.i18n.Bundle.instance.getMsg(instanceConfig[k].key);
                }
            }
    ...
    Ext.override(Ext.app.Application, {
        onBeforeLaunch: function() {
            ...
            if(me.bundle){
                ...
                me.bundle = Ext.create('HreRem.ux.i18n.Bundle', Ext.apply({
                    autoLoad: true,
                    listeners: {
                        loaded: function(){
                            overridden.apply(me);
                ...
                HreRem.ux.i18n.Bundle.instance = me.bundle;
            }else{
                me.callOverridden();
            }
        }
