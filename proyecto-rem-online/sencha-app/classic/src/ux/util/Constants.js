...
Ext.define('HreRem.ux.util.Constants', {
	...
	SUBTIPOS_PROVEEDOR: {
		...
		ENTIDAD_DE_CONSERVACION: '09',
		JUNTA_DE_COMPENSACION: '10',
		AGRUPACION_DE_INTERES_URBANISTICO: '11',
		AYUNTAMIENTO_MUNICIPAL: '13',
		DIPUTACION_PROVINCIAL: '14',
		CONSEJERIA_AUTONOMICO: '15',
		HACIENDA_ESTATAL: '16',
		OTRA_ADMINISTRACION_PUBLICA: '17',
		NOTARIO: '21',
		REGISTRO: '24',
		PROCURADORES: '43',
		SUMINISTRO: '25',
...
//		INVISIBLE:		Si creamos un registro-enlace-expediente en TFI y como codigo (en TFI_NOMBRE) damos este valor, ocultara el enlace
    ...
    PERFILES: {
    	...
    	GESTOR_CONTROLLER: 'PERFGCONTROLLER',
    	HAYASUPER: 'HAYASUPER',
		...
		TASADORA: 'TASADORA',
		DESINMOBILIARIO: 'DESINMOBILIARIO',
		KAM_BBVA: 'KAMBBVA'
    },
