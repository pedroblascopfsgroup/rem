/**
 * Utility class for generating different styles of message boxes.  The singleton instance, HreRem.MessageBox
 * alias `HreRem.Msg` can also be used.
 *
 ...
 *
 *     @example
 *     HreRem.Msg.alert('Status', 'Changes saved successfully.');
 *
 * Prompt for user data and process the result using a callback
 *
 *     @example
 *     HreRem.Msg.prompt('Name', 'Please enter your name:', function(btn, text){
 *         if (btn == 'ok'){
 ...
 *         buttons: HreRem.Msg.YESNOCANCEL,
 *         icon: HreRem.Msg.QUESTION,
 *         fn: function(btn) {
 *             if (btn === 'yes') {
 ...
 *     });
 * 
 * Showing HreRem.Msg while it's already shown will cause the visible instance to be 
 * overwritten with the newly passed config.  While this may be the desired outcome, you 
 * can also create a new MessageBox that can exist alongside the HreRem.Msg 
 * singleton instance.
 * 
 *     @example
 *     var myMsg = Ext.create('HreRem.ux.window.MessageBox', {
 ...
 *         message: 'I can exist along with HreRem.Msg'
 *     });
 *     
 *     HreRem.Msg.alert('Overlapping', 'HreRem.Msg instance');
 */
Ext.define('HreRem.ux.window.MessageBox', {
    ...
    Ext.onInternalReady(function() {
        HreRem.MessageBox = HreRem.Msg = new MessageBox();
    });
});
