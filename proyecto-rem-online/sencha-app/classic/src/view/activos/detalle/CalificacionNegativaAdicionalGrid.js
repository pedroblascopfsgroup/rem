Ext.define('HreRem.view.activos.detalle.CalificacionNegativaAdicionalGrid', {
    extend		: 'HreRem.view.common.GridBaseEditableRow',
    xtype		: 'calificacionnegativaadicionalgrid',
	topBar		: true,
	targetGrid	: 'calificacionNegativaAdicional',
	idPrincipal : 'idMotivo',
	idSecundaria: 'activo.id',
	editOnSelect: true,
	disabledDeleteBtn: false,
    bind: {
        store: '{storeCalifiacionNegativaAdicional}' // TODO CAMBIAR ESTO
    },
    ...
    listeners: {
		containermouseover: function () {
    		var me = this;
    		me.up('saneamientoactivo').down('historicotramitaciontitulogrid').evaluarBotonAdd(); //por programar historicotramitaciontitulogrif
    ...
    initComponent: function () {
		...
		me.columns = [
				...
				},
		        {
		            ...
		            reference: 'motivoCalificacionNegativaAdicional',
		            ...
		            editor: {
						...
						store: new Ext.data.Store({
							...
							proxy: {
								type: 'uxproxy',
								remoteUrl: 'generic/getDiccionario',
								extraParams: {diccionario: 'estadoMotivoCalificacionNegativa'} //por programar
							},
							autoLoad: true
						}),
						displayField: 'descripcion',
