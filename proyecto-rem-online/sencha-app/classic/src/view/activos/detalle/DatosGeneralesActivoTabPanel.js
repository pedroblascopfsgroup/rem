...
Ext.define('HreRem.view.activos.detalle.DatosGeneralesActivoTabPanel', {
	...
	,initComponent: function() {
    	...
    	$AU.confirmFunToFunctionExecution(function(){me.items.push({xtype: 'datoscomunidadactivo', funPermEdition: ['EDITAR_DATOS_COMUNIDAD_ACTIVO'], disabled: me.lookupController().getViewModel().get("activo.divHorizontal") == "0"})}, ['TAB_ACTIVO_DATOS_COMUNIDAD']);
