...
Ext.define('HreRem.view.activos.detalle.DatosGeneralesActivoTabPanel', {
    ...
    initComponent: function() {
    	...
    	$AU.confirmFunToFunctionExecution(function(){items.push({xtype: 'datoscomunidadactivo',ocultarBotonesEdicion: !$AU.userHasFunction('EDITAR_DATOS_COMUNIDAD_ACTIVO')})}, ['TAB_ACTIVO_DATOS_COMUNIDAD']); 
