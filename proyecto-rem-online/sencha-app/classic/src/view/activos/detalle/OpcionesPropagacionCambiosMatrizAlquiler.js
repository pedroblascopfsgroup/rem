Ext.define('HreRem.view.activos.detalle.OpcionesPropagacionCambiosMatrizExpediente', {
    	...
    	
    	{
    		...
    		items: [
			    ...
			    },  
	    		{
			        ...
			        hidden: true,
			        items: [
			        	{ boxLabel: HreRem.i18n("label.solo.activo.actual"), name: 'seleccion', inputValue: '1', checked: false, hidden: Ext.isEmpty(me.form), disabled:true },
			            { boxLabel: HreRem.i18n("label.activos.agrupacion.pertenece"), name: 'seleccion', inputValue: '2',  checked: false,disabled:true},
			            { boxLabel: HreRem.i18n("label.activos.subdivision.pertenece"), name: 'seleccion', inputValue: '3',  checked: false,disabled:true},
			            { boxLabel: HreRem.i18n("label.siguientes.activos.seleccionados"), name: 'seleccion', inputValue: '4', checked: true,disabled:true }
			        ]			        
	    		},
	    		{
	    			xtype: 'gridBase',
