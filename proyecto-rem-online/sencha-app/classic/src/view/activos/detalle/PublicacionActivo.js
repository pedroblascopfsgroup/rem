Ext.define('HreRem.view.activos.detalle.Publicacion', {
    ...
    layout		: 'fit',
    requires	: ['HreRem.view.activos.detalle.InformeComercialActivo', 'HreRem.view.activos.detalle.DatosPublicacionActivo', 'HreRem.view.activos.detalle.FasesDePublicacionActivo'],
	...
	tabBar: {
     ...
     evaluarBotonesEdicion: function(tab) {    
		...
		var editionEnabled = function(tab) {
			...
			}else if(tab.xtype=='fasesdepublicacionactivo') {
				visible = false;
			}
    ...
    initComponent: function () {
		...
		if ($AU.userIsRol(CONST.PERFILES['HAYASUPER']) || me.lookupController().getViewModel().get('activo').get('visualizarTabFasesPublicacion')) {
			items.push({xtype: 'fasesdepublicacionactivo', ocultarBotonesEdicion: false});
		}
