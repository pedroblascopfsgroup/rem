								...
								[
									{
										...
										title:HreRem.i18n('title.gastos.asociados.adquisicion.fiscalidad'),
							        	xtype: 'fieldsettable', 
										reference: 'gastosasociadosfiscalidadref',
										colspan: 3,
										items : [
									        {
									        	xtype : 'comboboxfieldbasedd',
											 	fieldLabel : HreRem.i18n('fieldlabel.tipo.impuesto.compra'),
											 	name: 'tipoImpuestoCompra',
							                	reference: 'tipoImpuestoCompraRef',
											 	bind : {
											 		store: '{comboTipoImpuestoCompra}',
						            				value: '{saneamiento.tipoImpuestoCompraCodigo}',
						            				rawValue: '{saneamiento.tipoImpuestoCompraDescripcion}',
													readOnly: '{esEditableUsuariosCaixa}'
						            			}				
									        },
									        {
									        	xtype : 'comboboxfieldbasedd',
											 	fieldLabel : HreRem.i18n('fieldlabel.subtipo.impuesto.compra'),
											 	name: 'subtipoImpuestoCompra',
							                	reference: 'subtipoImpuestoCompraRef',
											 	bind : {
											 		store: '{comboSubtipoImpuestoCompra}',
						            				value: '{saneamiento.subtipoImpuestoCompraCodigo}',
						            				rawValue: '{saneamiento.subtipoImpuestoCompraDescripcion}',
													readOnly: '{esEditableUsuariosCaixa}'
						            			}
									        },
									        {
							                	...
							                	fieldLabel:  HreRem.i18n('fieldlabel.porcentaje.impuesto.compra'),
							                	name: 'porcentajeImpuestoCompra',
							                	reference: 'porcentajeImpuestoCompraRef',
							                	maskRe: /[0-9.]/,
							                	bind: {
							                		value: '{saneamiento.porcentajeImpuestoCompra}',
													readOnly: '{esEditableUsuariosCaixa}'
							                	},
									        ...
									        {
									        	xtype : 'textfieldbase',
							                	fieldLabel : HreRem.i18n('fieldlabel.codigo.tp.iva.compra'),
							                	name : 'codigoTpIvaCompra',
							                	reference: 'codigoTpIvaCompraRef',
							                	bind : {
							                		value : '{saneamiento.codigoTpIvaCompra}',
													readOnly: '{esEditableUsuariosCaixa}'
							                    }
									        },
									        {
									        	xtype : 'comboboxfieldbase',
												fieldLabel : HreRem.i18n('fieldlabel.renuncia.exencion.impusto.compra'),
												name : 'renunciaExencion',
												reference: 'renunciaExencionRef',
												bind : {
													store : '{comboSiNoRenunciaExencion}',
													value : '{saneamiento.renunciaExencionCompra}',
													readOnly: '{esEditableUsuariosCaixa}'
							                    }
									        }		
										]	
