Ext.define('HreRem.view.administracion.AdministracionController', {
    ...
    init: function() {
    	...
    	// Si el usuario es proveedor, las b煤squedas deberan filtrarse por el nif de este, 
    	// y todas las listas de selecci贸n de proveedores estar谩n deshabilitadas.
    	var me = this;
...
//    			}
    ...
    //Funcion que se ejecuta al hacer click en el bot贸n buscar gastos
	...
	// Funci贸n que se ejecuta al hacer click en el bot贸n de Exportar en gesti贸n gastos.
	...
	// Funci贸n que se ejecuta al hacer click en el bot贸n de Exportar en agrupaciones de gastos.
	...
	// Funci贸n que se ejecuta al hacer click en el bot贸n de Exportar en gastos por agrupaci贸n.
	...
	//Funcion que se ejecuta al hacer click en el bot贸n buscar provisiones
    ...
    onClickAutorizarContabilidadAgrupacion: function(btn, origen){ 
    	...
    	Ext.Ajax.request({
		     ...
		     // Recuperamos todos los ids de los gastos de la agrupaci髇
    ...
    autorizarGastoContabilidadAgrupacion: function(btn, origen) {
    	...
    	var individual = false;
    	var idAgrupacion = agrupacion[0].id;
    	// Recuperamos todos los ids de los gastos de la agrupaci髇 seleccionada
    	Ext.Array.each(gastos, function(gasto, index) {
    		var gastoModel = Ext.create('HreRem.model.Gasto');
			gastoModel.set('entidadPropietariaCodigo', gasto.entidadPropietariaCodigo);
			gastoModel.set('estadoGastoCodigo', gasto.estadoGastoCodigo);
    ...
    validarSeleccionGasto: function(operacion, gasto, origen) { 
    	...
    	if(CONST.ESTADOS_GASTO['ANULADO'] == gasto.get("estadoGastoCodigo") ||
			...
			error = ("<span>Se han seleccionado gastos agrupados. Estos gastos deben gestionarse desde la pesta帽a de agrupaci贸n de gastos.</span></br>")
