Ext.define('HreRem.view.agenda.AgendaAvisosSearch', {
    extend: 'HreRem.view.common.FormBase',
    xtype: 'agendaavisossearch',
    isSearchFormAvisos : true,
	...
	initComponent: function() {
		...
		var me = this;
    	me.setTitle(HreRem.i18n('title.filtro.avisos'));
	    me.items= [
...
//		            }
    	...
    	me.buttonAlign = 'left';
    	me.buttons = [
    		{ text: 'Buscar', handler: 'onSearchAvisosClick' },
