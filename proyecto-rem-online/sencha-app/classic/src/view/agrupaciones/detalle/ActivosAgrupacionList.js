Ext.define('HreRem.view.agrupaciones.detalle.ActivosAgrupacionList', {
    ...
    onAddClick: function(btn){
      ...
      var municipio = me.up('agrupacionesdetallemain').getViewModel().get("agrupacionficha.municipioCodigo");
      ...
      } else if (provincia == null || municipio == null || cartera == null){
    	  Ext.Msg.show({ message: 'No se ha cumplimentado el campo Provincia, Municipio o Cartera.', buttons: Ext.Msg.YES});
      } else {
