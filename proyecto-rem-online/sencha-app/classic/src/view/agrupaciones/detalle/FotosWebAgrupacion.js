    ...
    initComponent: function () {
		...
		me.dockedItems = [{
		    ...
		    items: [
		        ...
		        { iconCls:'x-tbar-loading', itemId:'reloadButton', handler: 'onReloadFotoClick', secFunPermToEnable: 'EDITAR_TAB_FOTOS_AGRUPACION'},
		        { iconCls:'x-tbar-loading', itemId:'removeButton', bind : {hidden: '{hideBotoneraFotosWebAgrupacion}'},handler: 'onReloadFotoClick', secFunPermToEnable: 'EDITAR_TAB_FOTOS_AGRUPACION'}
		    ]
		}
		];
