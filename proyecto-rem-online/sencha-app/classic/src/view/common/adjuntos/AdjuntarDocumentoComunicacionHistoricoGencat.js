Ext.define('HreRem.view.common.adjuntos.AdjuntarDocumentoComunicacionHistoricoGencat', {
   ...
   /* height	: Ext.Element.getViewportHeight() > 700 ? 700 : Ext.Element.getViewportHeight() - 50 ,*/
    ...
    /**
     * Párametro para saber a qué comunicación del histórico se hará referencia a la hora de subir el documento
     * @type
     */
    idHComunicacion: -1,
