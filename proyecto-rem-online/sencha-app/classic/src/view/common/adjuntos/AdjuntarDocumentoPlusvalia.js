Ext.define('HreRem.view.common.adjuntos.AdjuntarDocumentoPlusvalia', {
	extend		: 'HreRem.view.common.WindowBase',
    xtype		: 'adjuntardocumentoplusvaliawindow',
    layout	: 'fit',
    width	: Ext.Element.getViewportWidth() /3,
   /* height	: Ext.Element.getViewportHeight() > 700 ? 700 : Ext.Element.getViewportHeight() - 50 ,*/
	reference: 'adjuntarDocumentoPlusvaliaWindowRef',
    /**
    ...
    initComponent: function() {
    	...
    	var comboTipoDocumento = new Ext.data.Store({
			...
			proxy: {
				...
				extraParams: {diccionario: 'tipoDocumentoPlusvalia'}
			}
    	});
    	...
    	me.items = [
    				{
	    				xtype: 'formBase',
	    				url: $AC.getRemoteUrl(me.entidad + "/uploadPlusvalia"),
