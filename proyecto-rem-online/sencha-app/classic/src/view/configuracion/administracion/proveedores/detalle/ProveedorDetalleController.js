Ext.define('HreRem.view.configuracion.administracion.proveedores.detalle.ProveedorDetalleController', {
    ...
    /**
     * Funci贸n que refresca la pesta帽a activa, y marca el resto de componentes para referescar.
    ...
    onClickBotonRefrescar: function () {
		...
		Ext.Array.each(me.getView().query('component[funcionRecargar]'), function(component) {
  		...
  		// Actualizamos la pesta帽a actual si tiene funci贸n de recargar
	...
	/**
	 * Funci贸n que abre el activo seleccionado del grid cuando es pulsado su icono.
	 */
	...
	/**
	 * Funci贸n que habilita o deshabilita y filtra el combo de Municipio dentro del grid DireccionesDelegacionesList.
	 */
    ...
    /**
     * Funci贸n para mostrar un check en color verde o gris seg煤n si un usuario es el principal o no.
     */
    ...
    /**
     * Este m茅todo es llamado cuando se deselecciona un elemento del grid DireccionesDelegaciones.
     */
    ...
    /**
     * Este m茅todo es llamado cuando se selecciona un elemento del grid DireccionesDelegaciones.
     */
    ...
    /**
     * Funci贸n que borra un documento del grid de documentos.
     */
	...
	/**
	 * Funci贸n que descarga un documento del grid de documentos.
	 */
