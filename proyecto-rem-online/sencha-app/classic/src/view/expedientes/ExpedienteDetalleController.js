			...
			if(CONST.ESTADOS_EXPEDIENTE['VENDIDO'] != codigoEstado){
				if(CONST.TIPOS_EXPEDIENTE_COMERCIAL['ALQUILER'] == tipoExpedienteCodigo){
					...
					if(Ext.isEmpty(fechaSancion)){
						...
						Ext.create('HreRem.view.expedientes.WizardAltaComprador',{idExpediente: idExpediente, parent: ventanaCompradores, expediente: expediente, deshabilitarCamposDoc: false}).show();
						me.onClickBotonRefrescar();
					} else {
