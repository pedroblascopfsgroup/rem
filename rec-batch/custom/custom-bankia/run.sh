...
java -Djava.rmi.server.hostname=localhost -Xms:1024m -Xmx:3072m -Xns:256m -XX:+HeapDumpOnOutOfMemoryError -XX:+UnlockDiagnosticVMOptions -XX:MaxClassBlockMemory=75M -classpath $APPCLASSPATH es.capgemini.pfs.batch.Main &
