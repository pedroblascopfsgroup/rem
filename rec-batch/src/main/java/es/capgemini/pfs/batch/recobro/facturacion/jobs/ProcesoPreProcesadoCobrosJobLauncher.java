...
/**
 * Clase que implementa el Job Launcher para el proceso de PreProcesado de los Cobros de Recobro para la posterior facturación a Agencias
 * @author Guillem
 *
 */
public class ProcesoPreProcesadoCobrosJobLauncher implements BatchPCRConstantes, JobRunner {
	...
	/**
	 * Inicia el proceso de PreProcesado de los Cobros de Recobro para la posterior facturación a Agencias
	 * @param workingCode
	 * @param extractTime
	 */
	public void handle(String workingCode, Date extractTime) {
		...
		JobInfo jobInfo = new JobInfo(PreProcesadoCobros.PROCESO_PREPROCESADO_COBROS_RECOBRO_JOBNAME, workingCode, this);
	...
	public void run() {
		try{
			...
			BatchExitStatus result = batchManager.run(PreProcesadoCobros.PROCESO_PREPROCESADO_COBROS_RECOBRO_JOBNAME, parameters);
