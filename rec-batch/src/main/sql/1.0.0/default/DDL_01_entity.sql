...
, COD_ENTIDAD_OFI_ADMIN NUMBER(5, 0) NOT NULL 
, COD_OFI_ADMIN NUMBER(5, 0) NOT NULL 
...
, SITUACION_CONTABLE VARCHAR2(50 CHAR) NOT NULL 
, POS_VIVA_NO_VENCIDA NUMBER(16, 2) NOT NULL 
, POS_VIVA_VENCIDA NUMBER(16, 2) NOT NULL 
, INT_ORDIN_DEVEN NUMBER(16, 2) NOT NULL 
, INT_MORAT_DEVEN NUMBER(16, 2) NOT NULL 
, COMISIONES NUMBER(16, 2) NOT NULL 
, GASTOS NUMBER(16, 2) NOT NULL 
, IMPUESTOS NUMBER(16, 2) 
, ENTREGAS NUMBER(16, 2) NOT NULL 
, INT_ENTREGAS NUMBER(16, 2) NOT NULL 
, DEUDA_IRREGULAR NUMBER(16, 2) NOT NULL 
, LIMITE_INICIAL NUMBER(16, 2) NOT NULL 
, LIMITE_ACTUAL NUMBER(16, 2) NOT NULL 
, FECHA_CREACION TIMESTAMP(6) NOT NULL 
, FECHA_INI_IRREGU TIMESTAMP(6) 
, FECHA_POS_VENCIDA TIMESTAMP(6) NOT NULL 
...
, FECHA_PLAZO_MINIMO_GESTION TIMESTAMP(6) NOT NULL 
, FECHA_MAX_COBRO_PARCIAL TIMESTAMP(6) 
, FECHA_MAX_REGULARIZACION TIMESTAMP(6) NOT NULL 
...
CREATE TABLE REC_FICHERO_PERSONAS (
  RCF_AGE_ID NUMBER(16, 0) NOT NULL 
, CODIGO_PROPIETARIO NUMBER(5, 0) NOT NULL 
, CODIGO_PERSONA NUMBER(16, 0) NOT NULL 
, TIPO_PERSONA NUMBER(1, 0) NOT NULL 
...
, SALDO_PASIVO NUMBER(16, 2) NOT NULL 
, RIESGO_DIRECTO_CLIENTE NUMBER(16, 2) NOT NULL 
, RIESGO_INDIRECTO_CLIENTE NUMBER(16, 2) NOT NULL 
, RIESGO_DIRECTO_IRREGULAR_CLI NUMBER(16, 2) NOT NULL 
, RIESGO_INDIRECTO_IRREGULAR_CLI NUMBER(16, 2) NOT NULL 
...
, CODIGO_PROPIETARIO NUMBER(5, 0) NOT NULL 
, CODIGO_PERSONA NUMBER(16, 0) NOT NULL 
, CODIGO_DIRECCION VARCHAR2(33 CHAR) NOT NULL 
...
, DIRECCION_PRINCIPAL NUMBER(1, 0) 
...
, DIRECCION_BLOQUEADA NUMBER(1, 0) 
, FECHA_EXTRA1 TIMESTAMP(6) 
, FECHA_EXTRA2 TIMESTAMP(6) 
, FECHA_EXTRA3 TIMESTAMP(6) 
, FECHA_EXTRA4 TIMESTAMP(6) 
...
, TELEFONO_BLOQUEADO NUMBER(1, 0) NOT NULL 
, ULTIMO_CONTACTO NUMBER(1, 0) NOT NULL 
