...
--## INCIDENCIA_LINK=BCFI-626
--## PRODUCTO=NO
--##
--## Finalidad: Modificar el procedimiento PROCESA_PROCESO_FACT para que facture cobros fuera que
--##		tramo de sus tarifas, pero que se disponga de un porcentaje por defecto para tales casos
