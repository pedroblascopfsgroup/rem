 ...
 * Recobro. Este test prueba la generación del expediente arrastrando los
 * contratos del grupo y de la primera generación.
 * 
 * @author Guillem
 * 
 */
...
public class ProcesoGeneracionExpedientesJobLauncherGrupoyPrimeraGeneracionTest
		extends GenericTest {
	...
	protected ConfigLoadData loadConfigLoadDataTest() {
		...
		try {
			...
			configLoadDataTest
					.setSqlFile("loadTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_primeraGeneracion.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
	...
	protected ConfigValidationData loadConfigValidationDataTest() {
		...
		try {
			...
			configValidationDataTest
					.setSqlFile("validationTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_primeraGeneracion.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
