...
public class DDTipoReclamacion implements Dictionary, Auditable {
    ...
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoReclamacionGenerator")
    @SequenceGenerator(name = "DDTipoReclamacionGenerator", sequenceName = "S_DD_TRE_TIPO_RECLAMACION")
    private Long id;
