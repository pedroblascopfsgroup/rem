...
public abstract class BaseActionHandler implements ActionHandler {
    ...
    protected void lanzaNuevoBpmHijo() {
        ...
        Procedimiento procPadre = getProcedimiento();
        Procedimiento procHijo = processUtils.creaProcedimientoHijo(tipoProcedimientoHijo, procPadre);
        processUtils.lanzaBPMAsociadoAProcedimiento(procHijo.getId(), getTokenId());
    ...
    protected TareaProcedimiento getTareaProcedimiento(String codigoTarea) {
        ...
        Long idTipoProcedimiento = getProcedimiento().getTipoProcedimiento().getId();
     ...
     */
    protected Procedimiento getProcedimiento() {

        Procedimiento procedimiento = procedimientoManager.getProcedimiento((Long) getVariable(PROCEDIMIENTO_TAREA_EXTERNA));
        ...
        if (procedimiento == null) {
            ...
            String mensajeError = "El BPM en ejecución para el procedimiento " + nombreProcedimiento
                    + " no tiene asociado un PRC_PROCEDIMIENTO y por tanto no puede continuar su ejecución";
