...
spool borrarTareasExpCanceladoInc126&v_entorno&v_date&v_time..log
--03 Borrado Lógico de Tareas de expedientes cancelados excepto la notificación de expediente cancelado
update pfs01.tar_tareas_notificaciones tar2 set tar2.borrado = 1,usuarioborrar='INC126',fechaborrar=sysdate where tar2.tar_id in 
(select  tar.TAR_ID
