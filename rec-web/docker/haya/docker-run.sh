...
docker run --rm -ti -p=22 -p=8080 -p=1044 \
	...
	-v $(pwd)/tomcat-intehaya-ibd011-server.xml:/recovery/app-server/tomcat/conf/server.xml \
	-v $(pwd)/devon-intehaya-ibd011.properties:/recovery/app-server/devon.properties \
