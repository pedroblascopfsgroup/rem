...
(function(page,entidad){
  ...
  entidad.cacheStore(contratosExpedienteStore);
	...
	var excluirContrato = new Ext.Button({
		...
		,cls: 'x-btn-text-icon'
		,handler: function() {
				Ext.Msg.confirm('<s:message code="expedientes.consulta.tabcabecera.otrosCont.excluirContratos" text="**Excluir contrato" />', '<s:message code="expedientes.consulta.tabcabecera.otrosCont.excluirContratos.confirmar" text="**¿Está seguro que desea excluir el contrato del expediente?" />', this.evaluateAndSend);
		}
