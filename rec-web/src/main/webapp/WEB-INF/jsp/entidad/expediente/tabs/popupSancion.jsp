...
(function(page,entidad){
	...
	var fechaSancionSareb = new Ext.ux.form.XDateField({
		name : 'fechaEscritura'
		,fieldLabel : '<s:message code="precontencioso.grid.documento.incluirDocumento.fechaEscritura" text="**F. Sanción Sareb" />'
		,style:'margin:0px'
	});
	...
	var formSancion = new Ext.form.FormPanel({
		border:false
		,autoHeight:true
		,items:[<sec:authorize ifAllGranted="PERSONALIZACION-HY">fechaElevacionSareb, fechaSancionSareb, </sec:authorize>decionSancion,labelObs,observaciones]
	});
	...
	panel.setValue = function(){
		...
		entidad.setLabel('fechaElevacionSareb', cabecera.codExpediente);
	};
