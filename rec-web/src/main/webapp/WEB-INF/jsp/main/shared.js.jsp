...
app.creaMinMaxMoneda = function(label, name, config){
	...
	var labelWidth = config.labelWidth || 108;
	var maxLength = config.maxLength || "15";
	var min = app.creaMoneda("min"+name, label,'',{width:width1,maxLength:16,autoCreate:{tag: "input", type: "text", size: "4",maxLength:maxLength, autocomplete: "off"}});
	var max = app.creaMoneda("max"+name, label,'',{width:width2,maxLength:16,autoCreate:{tag: "input", type: "text", size: "4",maxLength:maxLength, autocomplete: "off", style: "margin-left:4px"}});
	var cfgPanel = {
		style : "margin-top:4px;margin-bottom:2px;"
	};
	if (config.widthPanel){ cfgPanel.width = config.widthPanel; }
...
<%@ include file="moneyField.js.jsp"%>
