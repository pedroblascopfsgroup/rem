...
@Component
public class HistoricoAsuntoAbrirDetalleTarea implements HistoricoAsuntoAbrirDetalleHandler {
    ...
    public Object getViewData(Long idTarea, Long idTraza, Long idEntidad) {
        ...
        result.setDescripcion(substituirCadenaEspacioHtml(info.get(AgendaMultifuncionTipoEventoRegistro.EventoTarea.DESCRIPCION_TAREA)));
