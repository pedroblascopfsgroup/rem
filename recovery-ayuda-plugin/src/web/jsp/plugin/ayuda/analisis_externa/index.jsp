...
<h2 style="font-family: Arial; color: rgb(255, 204, 51);"><font size="+2"><a name="_Toc275761529">AN&Aacute;LISIS EXTERNA</a></font></h2>
...
<p style="font-family: Arial;" class="MsoNormal">Permita generar informes de an&aacute;lisis de la
gesti&oacute;n externa: &lsquo;An&aacute;lisis de Externa&rsquo;</p>
...
<p style="font-family: Arial;" class="MsoNormal">Generan datos agregados que permitan
posteriormente explotarlos mediante informes.</p>
...
<h3 style="margin-left: 0cm; font-family: Arial; color: rgb(153, 153, 153);"><font size="+1"><a name="_Toc275761530">1 CRITERIOS DE SALIDA</a></font></h3>
...
<p style="font-family: Arial;" class="MsoNormal">Desde el formulario de &lsquo;An&aacute;lisis de Externa&rsquo; se
parametrizar&aacute; el filtrado de los datos para el informe, as&iacute; como su criterio de
salida</p>



<p style="font-family: Arial;" class="MsoNormal"><img style="width: 700px; height: 312px;" alt="analisis" src="../img/plugin/ayuda/analisis_externa/analisis.jpg">&nbsp;</p>
...
</v:shapetype><v:shape id="Imagen_x0020_7" o:spid="_x0000_i1034" type="#_x0000_t75"
...
<p style="font-family: Arial;" class="MsoNormal">Los par&aacute;metros de filtrado y salida se podr&aacute;n
definir mediante el formulario de la pesta&ntilde;a de &lsquo;An&aacute;lisis Externa&rsquo;:</p>
...
<p class="MsoListParagraph" style="text-indent: -14.15pt; font-family: Arial; margin-left: 0px; width: 700px;">&nbsp; &nbsp; <img style="width: 676px; height: 65px;" alt="fase_procesal" src="../img/plugin/ayuda/analisis_externa/fase_procesal.jpg"></p>
...
<h3 style="margin-left: 0cm; font-family: Arial; color: rgb(153, 153, 153);"><font size="+1"><a name="_Toc275761531">2 FUNCIONALIDADES PROPIAS DE AN&Aacute;LISIS EXTERNA</a></font></h3>
...
<p style="font-family: Arial;" class="MsoNormal"><span style="font-weight: bold;">2.1 Exportar
a Excel</span> </p>
...
<p style="font-family: Arial;" class="MsoNormal">La exportaci&oacute;n a Excel de la informaci&oacute;n de
an&aacute;lisis de la gesti&oacute;n externa. La informaci&oacute;n de an&aacute;lisis se exporta con un
formato visual similar a su exportaci&oacute;n a PDF.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Sus mecanismos y funcionamientos son id&eacute;nticos
a su exportaci&oacute;n a PDF, por lo que &uacute;nicamente se destaca un ejemplo Excel del
criterio de salida por despacho.</p>
...
<p class="MsoNormal" style="font-family: Arial; font-weight: bold;">2.2 Exportar
a PDF</p>
...
<p class="MsoNormal" style="font-family: Arial; text-align: center;">&nbsp;<img style="width: 570px; height: 892px;" alt="pdf1" src="../img/plugin/ayuda/analisis_externa/pdf1.jpg"></p>
...
<p style="font-family: Arial;" class="MsoNormal">La informaci&oacute;n que se almacena para los
informes se agrega en los siguientes campos:</p>
...
<p style="font-family: Arial;" class="MsoNormal">Por ejemplo, si la salida fuera por &lsquo;tipo de
procedimiento&rsquo; se tendr&iacute;a este informe:</p>
...
<p style="font-family: Arial;" class="MsoNormal">&nbsp;<img style="width: 700px; height: 89px;" alt="tabla" src="../img/plugin/ayuda/analisis_externa/tabla.jpg"></p>
