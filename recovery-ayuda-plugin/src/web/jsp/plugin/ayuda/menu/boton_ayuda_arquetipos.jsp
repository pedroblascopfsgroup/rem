...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_arquetipos';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.arquetipos" text="**Ayuda configuración arquetipos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
