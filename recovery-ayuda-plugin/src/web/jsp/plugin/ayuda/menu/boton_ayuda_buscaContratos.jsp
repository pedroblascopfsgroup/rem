...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=busqueda_contratos';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.busquedaContratos" text="**Ayuda búsqueda de contratos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
