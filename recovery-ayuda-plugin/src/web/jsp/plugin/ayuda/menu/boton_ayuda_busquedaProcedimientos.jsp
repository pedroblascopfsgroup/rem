...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=busqueda_procedimientos';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.procedimientos.busqueda" text="**Ayuda búsqueda procedimientos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
