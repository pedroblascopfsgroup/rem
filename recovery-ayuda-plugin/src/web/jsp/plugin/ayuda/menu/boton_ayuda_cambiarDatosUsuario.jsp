...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=cambiar_datos_usuario';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.cambiarDatosUsuario" text="**Ayuda para cambiar los datos del usuario" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
