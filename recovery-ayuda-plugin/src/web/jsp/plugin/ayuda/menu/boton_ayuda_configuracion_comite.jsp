...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_comite';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.comite" text="**Ayuda para configuración de comités" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
