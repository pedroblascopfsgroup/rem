...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_despachos_procuradores';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.despachoExterno" text="**Ayuda para configuración despachos externos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
