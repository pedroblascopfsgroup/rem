...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_diccionario_datos';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.diccionariosDatos" text="**Ayuda para configuración de diccionarios de datos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
