...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_entidad';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.entidad" text="**Ayuda para configuración básica de la entidad" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
