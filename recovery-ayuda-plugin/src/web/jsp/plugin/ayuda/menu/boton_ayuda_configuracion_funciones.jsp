...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_funciones';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.funciones" text="**Ayuda para configuración de funciones" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
