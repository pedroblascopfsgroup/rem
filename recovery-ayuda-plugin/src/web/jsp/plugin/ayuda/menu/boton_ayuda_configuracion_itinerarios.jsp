...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=itinerarios';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.itinerarios" text="**Ayuda para configuración de itinerarios" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
