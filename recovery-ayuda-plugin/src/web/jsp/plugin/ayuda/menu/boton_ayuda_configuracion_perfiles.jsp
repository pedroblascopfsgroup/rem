...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_perfiles';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.perfiles" text="**Ayuda para configuración de perfiles" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
