...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=plazas_juzgados';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.plazasJuzgados" text="**Ayuda para configuración de plazas y juzgados" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
