...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_usuarios';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.usuarios" text="**Ayuda para configuración de usuarios" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
