...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=instrucciones_tareas';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.instruccionesTareas" text="**Ayuda para configuración de instrucciones de tareas externas" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
