...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=configuracion_modelos_arquetipo';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuarion.modelosArquetipos" text="**Ayuda configuración de modelos de arquetipos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
