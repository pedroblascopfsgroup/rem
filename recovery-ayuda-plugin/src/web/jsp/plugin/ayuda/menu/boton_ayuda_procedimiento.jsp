...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=procedimientos_actuaciones';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.procedimientos" text="**Ayuda sobre procedimientos" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
