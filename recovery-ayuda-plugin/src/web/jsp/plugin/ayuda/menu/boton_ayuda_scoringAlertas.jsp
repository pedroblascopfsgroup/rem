...
new Ext.Button({
	...
	,handler:function(){
		...
		var _url = '/${appProperties.appName}/ayuda/html.htm?item=scoring_rating';
	 	var win = new Ext.Window({
        	...
        	,title:'<s:message code="app.ayuda.configuracion.scoringRating" text="**Ayuda para Scoring y Alertas" />'
        	<%--,tbar:[{
             	text:'Reload'
            	,handler:function() {
