...
<head>
  ...
  <title>actuacion_procedimiento</title>
</head>
...
<h2 style="width: 700px; color: rgb(255, 204, 51); font-family: Arial;"><font size="+2"><a name="_Toc273601824">PROCEDIMIENTOS / ACTUACIONES</a></font></h2>




<p style="color: rgb(255, 204, 51); font-family: Arial;" class="MsoNormal">&nbsp;</p>




<p class="MsoNormal" style="margin-bottom: 12pt; font-family: Arial;">Son las unidades de gesti&oacute;n en las que se descomponen los asuntos.</p>
...
<p class="MsoNormal" style="margin-bottom: 12pt; font-family: Arial;">La herramienta permite determinar que se realicen actuaciones
judiciales y amistosas.</p>
...
<p class="MsoNormal" style="margin-bottom: 12pt; font-family: Arial;">&Eacute;stas se asignar&aacute;n a un asunto, por lo que todas las actuaciones de
un asunto son llevadas a cabo por el mismo gestor.</p>
...
<p class="MsoNormal" style="margin-bottom: 12pt; font-family: Arial;">Los procedimientos tienen un hilo temporal, que conocemos por flujo
de gesti&oacute;n, que permite a la herramienta ir enviando las tareas pertinentes
sobre las que el gestor externo tendr&aacute; que reportar una serie datos y en la
fecha de vencimiento asignada. </p>
...
<p class="MsoNormal" style="margin-bottom: 12pt; font-family: Arial;">Esto permite mantener un hist&oacute;rico de tareas realizadas, donde
adem&aacute;s se puede consultar el detalle de cada una y saber en cada momento cu&aacute;l
es la tarea activa, pendiente de ser realizada por el gestor (en su caso, a
veces, tambi&eacute;n de manera autom&aacute;tica se le env&iacute;an tareas al supervisor).</p>
...
<p style="font-family: Arial;" class="MsoNormal">Podr&iacute;amos decir que los procedimientos o
actuaciones son &ldquo;bloques&rdquo; de tareas que permiten agruparlas para obtener un
sentido hist&oacute;rico, en base a los procedimientos y tr&aacute;mites m&aacute;s usados de la Ley
de Enjuiciamiento Civil, y de la Ley Concursal (por ejemplo, un procedimiento
declarativo ser&iacute;a una actuaci&oacute;n, el ejecutivo subsiguiente otra, el aval&uacute;o
otra, la subasta una m&aacute;s,&hellip;).</p>
...
<p style="font-family: Arial;" class="MsoNormal">Como se ha comentado, son los bloques de hitos
y tareas que tienen sentido por si mismos y son en un principio directamente
encomendados al gestor.</p>
...
<p style="font-family: Arial;" class="MsoNormal">En los momentos en los que se vayan superando
los &uacute;ltimos hitos definidos en cada actuaci&oacute;n, la herramienta dar&aacute; un breve
plazo de tiempo al gestor para que haga la propuesta de continuidad en las
funcionalidades asociadas a la &ldquo;Decisi&oacute;n de continuidad&rdquo;.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Las tareas que le aparecer&aacute;n al gestor, m&aacute;s
comunes que se refieren a actuaciones ser&aacute;n:</p>
...
actuaci&oacute;n y procedimiento. Estas tareas aparecen en el Panel de Tareas
pendientes y al seleccionarlas (doble click) nos dirigen directamente a dicho
procedimiento, concretamente a la pesta&ntilde;a de tareas que ser explica m&aacute;s adelante.</p>
...
<h3 style="margin-left: 63.8pt; text-indent: -14.15pt; font-family: Arial;">&nbsp;</h3>




<h3 style="margin-left: 0cm; font-family: Arial;"><font size="+1"><a style="color: rgb(153, 153, 153);" name="_Toc273601825">1
DETALLE DE ACTUACIONES/PROCEDIMIENTOS</a></font></h3>
...
<p style="font-family: Arial;" class="MsoNormal">Una vez dentro del procedimiento o actuaci&oacute;n se pueden ver las siguientes pesta&ntilde;as:</p>
...
</v:shapetype><v:shape id="Imagen_x0020_388" o:spid="_x0000_s1071" type="#_x0000_t75"
 style='position:absolute;margin-left:42.75pt;margin-top:16.7pt;width:279.7pt;
 height:21.05pt;z-index:-43;visibility:visible;mso-wrap-style:square;
 mso-wrap-distance-left:9pt;mso-wrap-distance-top:0;mso-wrap-distance-right:9pt;
 mso-wrap-distance-bottom:0;mso-position-horizontal:absolute;
 mso-position-horizontal-relative:text;mso-position-vertical:absolute;
 mso-position-vertical-relative:text' wrapcoords="-116 0 -116 20010 21546 20010 21546 0 -116 0">
...
<h4 style="text-indent: -114pt; font-family: Arial;"><a name="_Toc273601826">&nbsp;</a></h4>




<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><br>


</h4>


<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;">1.1 Cabecera: </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Muestra la informaci&oacute;n b&aacute;sica&nbsp; del procedimiento</p>
...
<p style="text-align: center; font-family: Arial;" class="MsoNormal"><img style="width: 700px; height: 129px;" alt="asunto" src="../img/plugin/ayuda/procediminetos_actuaciones/asunto.jpg"></p>
...
<p style="font-family: Arial;" class="Prrafodelista1">&nbsp;</p>
...
<p class="MsoNormal" style="text-indent: 7.1pt; font-family: Arial;">&nbsp;<br>
...
<p class="MsoNormal" style="text-indent: 0cm; font-family: Arial; text-align: center; margin-left: 0px; width: 700px;"><img style="width: 700px; height: 88px;" alt="deudores" src="../img/plugin/ayuda/procediminetos_actuaciones/deudores.jpg"></p>




<p class="Prrafodelista1" style="margin-left: 0cm; text-align: left; font-family: Arial;" align="left">&nbsp;</p>




<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601827">1.2 Contratos:</a> </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Recoge la lista de contratos relacionados con
la actuaci&oacute;n o procedimiento que se est&aacute; llevando a cabo.</p>


<div style="text-align: center; font-family: Arial;"><img style="width: 700px; height: 269px;" alt="contratos" src="../img/plugin/ayuda/procediminetos_actuaciones/contratos.jpg"></div>
...
<h4 style="font-family: Arial;">&nbsp;</h4>




<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601828">1.3 Bienes:</a> </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Recoger&aacute; los bienes que se hayan ido metiendo
en la aplicaci&oacute;n por parte del gestor de la oficina. De esta forma el gestor
externo conocer&aacute; los bienes que posee el deudor y podr&aacute; solicitar el embargo de
dichos bienes.</p>
...
<p class="MsoNormal" style="margin-left: 35.45pt; font-family: Arial;">&nbsp;</p>




<p class="MsoNormal" style="text-align: center; font-family: Arial; margin-left: 0px; width: 700px;"><img style="width: 700px; height: 270px;" alt="bienes" src="../img/plugin/ayuda/procediminetos_actuaciones/bienes.jpg"></p>
...
<p class="Prrafodelista1" style="margin-left: 71.3pt; font-family: Arial;"><br>
...
<p class="MsoNormal" style="text-indent: -14.6pt; font-family: Arial;">&nbsp;</p>


<span style="font-family: Arial; font-weight: bold; font-style: italic;">1. Modificar datos de un bien</span>
...
<p style="font-family: Arial;" class="MsoNormal">Para el caso de &ldquo;Modificar&rdquo;, la herramienta
permite cargar los siguientes datos referentes a los procedimientos judiciales:</p>
...
<p style="font-family: Arial;" class="MsoNormal">Donde las distintas tareas de las actuaciones y
procedimientos ir&aacute;n pidiendo que se completen los datos relevantes.</p>
...
<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601829">1.4 Recursos:</a> </h4>




<p class="Prrafodelista1" style="margin-left: 36pt; font-family: Arial;">&nbsp;</p>




<p style="font-family: Arial;" class="MsoNormal">Recoge los recursos que se han interpuesto en
el procedimiento tanto por parte del gestor como de un tercero contra el asunto
...
<p style="font-family: Arial;" class="MsoNormal">El responsable de dar de alta y mantener
informado un recurso es el gestor que tendr&aacute; que consignar el tipo de recurso y
los datos necesarios que le solicita la herramienta.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Se contempla la posibilidad de que haya un
n&uacute;mero indefinido de recursos para una actuaci&oacute;n. Por supuesto s&oacute;lo aplicar&iacute;a a
actuaciones del tipo judicial, aunque la herramienta muestra esta funcionalidad
siempre.</p>
...
<p class="MsoNormal" style="text-indent: 35.4pt; text-align: left; font-family: Arial;">&nbsp;<br>


Como se ha comentado anteriormente, existe una
tarea de actualizaci&oacute;n de recurso que le exige al gestor mantener al corriente
la informaci&oacute;n de fechas y resultados y que no desaparecer&aacute; hasta que se de por
finalizado dicho recurso.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Esta tarea se genera autom&aacute;ticamente en el
momento que se da de alta el recurso en cuesti&oacute;n.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Desde esta pesta&ntilde;a se podr&aacute; agregar y
ver/editar nuevos recursos.</p>
...
<p style="font-family: Arial; font-weight: bold;" class="MsoNormal">a) Agregar recurso </p>




<p class="MsoNormal" style="text-indent: 35.4pt; font-family: Arial; font-weight: bold;">&nbsp;</p>




<p style="font-family: Arial;" class="MsoNormal">Al seleccionar Agregar, el formulario
resultante debe ser rellenado por el gestor externo con los datos propios del
recurso y se selecciona Guardar:</p>
...
<p style="font-family: Arial;" class="MsoNormal">Con la interposici&oacute;n de un recurso, las tareas
que se estaban realizando pertenecientes a esa actuaci&oacute;n (procedimiento) hasta
el momento quedan paralizadas y desaparecen del panel de tareas y le aparecer&aacute;
una nueva tarea espec&iacute;fica al interponer un recurso que es &ldquo;Actualizar el estado del recurso
actual&rdquo;.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Al supervisor le llegar&aacute; una notificaci&oacute;n de
que se ha interpuesto un recurso. </p>
...
<p style="font-family: Arial;" class="MsoNormal">Una vez resuelto el recurso tanto favorable
como desfavorable el procedimiento contin&uacute;a desde el punto donde se hab&iacute;a quedado,
apareciendo las mismas tareas para as&iacute; poder retomarlas. La fecha marcada como
fecha de resoluci&oacute;n ser&aacute; la fecha de inicio con la que las tareas del
procedimiento se reinicien.</p>
...
<p style="font-family: Arial;" class="MsoNormal">En caso de que el procedimiento o actuaci&oacute;n
haya finalizado con una resoluci&oacute;n desfavorable en el recurso, se dar&aacute; uso de
la pesta&ntilde;a &ldquo;Decisiones&rdquo; en la que el gestor puede proponer la paralizaci&oacute;n
temporal, la finalizaci&oacute;n o la derivaci&oacute;n del procedimiento en curso.</p>
...
<p style="font-family: Arial; font-weight: bold;" class="MsoNormal">b) Ver / Editar un recurso </p>
...
<p style="font-family: Arial;" class="MsoNormal">A trav&eacute;s de esta selecci&oacute;n podremos modificar o
bien solo consultar un recurso que ya estaba dado de alta.</p>
...
<p class="MsoNormal" style="text-indent: -7.1pt; font-family: Arial;">&nbsp;</p>
...
<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601830">1.5 Decisiones:</a></h4>


<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601830"></a></h4>


<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial; text-align: center;">&nbsp;<img style="width: 700px; height: 269px;" alt="decisiones" src="../img/plugin/ayuda/procediminetos_actuaciones/decisiones.jpg"><br>
...
Esta pesta&ntilde;a pretende ser el punto desde el que
cambiar o ampliar el curso de las actuaciones. Es el grupo de funcionalidades
que permiten acercar las realidades que no se pueden tener en cuenta por ser
innumerables y que provocan cambios dr&aacute;sticos en la gesti&oacute;n de los casos.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Adem&aacute;s es la pesta&ntilde;a a la que remitir&aacute; al
gestor cada vez que una actuaci&oacute;n termine con su &uacute;ltima tarea, con el fin de
que sea &eacute;l, el que proponga cuales son los siguientes pasos a realizar. Esta
tarea propia del procedimiento aparecer&aacute; en el panel de tareas pendientes y le
forzar&aacute; a completar una propuesta.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Adem&aacute;s en cualquier momento, tanto el gestor
como el supervisor pueden usar esta funcionalidad, a&uacute;n en el caso de no haber
terminado ning&uacute;n proceso.</p>




<p class="Heading3h3" style="margin-left: 71.4pt; text-indent: -43.05pt; line-height: 115%; font-family: Arial;">&nbsp;</p>




<p class="Heading3h3" style="line-height: 115%; font-family: Arial; font-weight: bold;">a) Agregar
Decisi&oacute;n </p>
...
<p class="MsoNormal" style="text-align: center; font-family: Arial;" align="center"><img style="width: 613px; height: 443px;" alt="nueva_decision" src="../img/plugin/ayuda/procediminetos_actuaciones/nueva_decision.jpg"><br>
...
<p style="font-family: Arial;" class="MsoNormal">En la pantalla se recoge diversa informaci&oacute;n
agrupada en dos partes:</p>
...
<p class="MsoNormal" style="margin-left: 70.9pt; text-indent: -14.2pt; font-family: Arial;"></p>
...
<p style="font-family: Arial; text-align: center;" class="MsoNormal">&nbsp;<img style="width: 86px; height: 28px;" alt="proponer" src="../img/plugin/ayuda/procediminetos_actuaciones/proponer.jpg"></p>
...
<p style="font-family: Arial; font-weight: bold;" class="MsoNormal">b) Ver / Editar</p>
...
<p style="font-family: Arial;" class="MsoNormal">Seleccionando una decisi&oacute;n ya dada de alta con
anterioridad y pulsando el bot&oacute;n Ver / Editar podremos como su nombre indica
consultar los datos o bien modificar alg&uacute;n dato.</p>
...
<p class="MsoNormal" style="margin-left: 99.25pt; text-indent: -14.2pt; font-family: Arial;">&nbsp;</p>
...
<p style="font-family: Arial;" class="MsoNormal">&nbsp;<img style="width: 700px; height: 129px;" alt="finalizar_origen_2" src="../img/plugin/ayuda/procediminetos_actuaciones/finalizar_origen_2.jpg"></p>
...
<p style="font-family: Arial; font-weight: bold;" class="MsoNormal">a)Alta de una Actuaci&oacute;n / Procedimientos</p>




<p class="MsoNormal" style="margin-left: 18pt; font-family: Arial;">&nbsp;</p>




<p class="MsoNormal" style="font-family: Arial;">Desde la
pantalla de Decisi&oacute;n podremos agregar una actuaci&oacute;n indicando todos los datos
respecto al tipo de acci&oacute;n as&iacute; como Datos econ&oacute;micos y los demandados. Se
selecciona agregar y autom&aacute;ticamente se rellenara con la actuaci&oacute;n dada de alta
en el cuadro de Actuaciones.</p>
...
<p class="MsoNormal" style="text-indent: 35.4pt; font-family: Arial;">&nbsp;<br style="font-family: Arial;" clear="all">
...
<p style="font-family: Arial;" class="MsoNormal">El alta de actuaciones se amplia a&ntilde;adiendo una
m&aacute;scara de formato al n&uacute;mero de procedimiento en juzgado (n&ordm; de auto), as&iacute; como
realizando validaciones con respecto a los importes de las estimaciones de
...
<p style="font-family: Arial;" class="MsoNormal">El formato para el n&uacute;mero de auto es el siguiente
&lsquo;xxxxx/xxxx&rsquo;&nbsp; donde la x indica un n&uacute;mero
entre 0 y 9.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Adem&aacute;s, los tipos de acci&oacute;n (Judicial, Amistosa,
etc.) prefiltran los tipos de actuaci&oacute;n (Procedimientos, Tr&aacute;mites, etc.)
haci&eacute;ndolos dependientes.</p>
...
<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601831">2.5.1.6 Tareas:</a> </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Es la pesta&ntilde;a en la que se muestran las tareas
pendientes para esa actuaci&oacute;n o procedimiento en el momento de la consulta. Hay
que tener en cuenta que existen tareas que las debe realizar el supervisor y
por tanto el gestor no las visualizar&aacute; y viceversa.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Para marcar una tarea como realizada se pulsa
sobre ella doble click o seleccion&aacute;ndola y pulsando el bot&oacute;n &ldquo;Ver/Editar&rdquo;. Cada
tarea mostrar&aacute; en una ventana emergente un formulario diferente en funci&oacute;n de
c&oacute;mo se haya definido cada procedimiento.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Cada tarea y su formulario son auto
explicativos con instrucciones propias sobro como proceder y cuales ser&aacute;n los
efectos a encontrarse al realizarlo. </p>
...
<p style="font-family: Arial;" class="MsoNormal">Una vez rellenado se pulsar&aacute; el bot&oacute;n &ldquo;Guardar&rdquo;
para marcar la tarea como finalizada.</p>
...
<p class="MsoNormal" style="text-align: left; font-family: Arial; font-weight: bold;" align="left">a) Ver / editar </p>
...
<p style="font-family: Arial;" class="MsoNormal">La pantalla que salta es la siguiente:</p>
...
<p style="font-family: Arial;" class="MsoNormal">La cual tiene una informaci&oacute;n ajustada a la
entidad.</p>
...
<p style="font-family: Arial; font-weight: bold;" class="MsoNormal">b) Solicitar pr&oacute;rroga. &nbsp;</p>
...
<p style="font-family: Arial;" class="MsoNormal">Toda
tarea podr&aacute; ser solicitada para prorrogarse y que la fecha en la que se hab&iacute;a
establecido anteriormente se retrase hasta la fecha deseada.</p>
...
<p class="MsoNormal" style="margin-left: 35.45pt; font-family: Arial;">&nbsp;<img style="width: 392px; height: 345px;" alt="solicitar_prorroga" src="../img/plugin/ayuda/procediminetos_actuaciones/solicitar_prorroga.jpg"></p>
...
<p style="font-family: Arial;" class="MsoNormal">Sabiendo que el n&uacute;mero de d&iacute;as m&aacute;ximo que la
aplicaci&oacute;n le permitir&aacute; solicitar viene determinado por los criterios introducidos
en su par&aacute;metro correspondiente por los Servicios Centrales de la Entidad.</p>
...
<p class="MsoNormal" style="text-align: left; font-family: Arial; font-weight: bold;" align="left">c) Cancelar tarea &nbsp;</p>
...
<p class="MsoNormal" style="font-family: Arial; text-align: center;">&nbsp;<img style="width: 362px; height: 48px;" alt="cancelar_tarea" src="../img/plugin/ayuda/procediminetos_actuaciones/cancelar_tarea.jpg"></p>




<br style="font-family: Arial;" clear="all">




<p class="MsoNormal" style="text-align: left; font-family: Arial;" align="left">En
algunas ocasiones es posible Podremos cancelar la &uacute;ltima tarea realizada</p>
...
<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601832">2.5.1.7
Documentaci&oacute;n:</a> </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Se trata de una pesta&ntilde;a de apoyo en la que se determina
que documentaci&oacute;n es requerida para cada tipo de procedimiento de tal manera
que tanto el supervisor y el gestor tengan una referencia de la documentaci&oacute;n
necesaria.</p>
...
<p style="font-family: Arial;" class="MsoNormal">En la parte secundaria se determinar&aacute; por el
supervisor la fecha en la que la informaci&oacute;n fue recopilada y por tanto
enviada, as&iacute; como la fecha en la que el gestor externo recibe la documentaci&oacute;n.
Ambas fechas deben ser introducidas por el supervisor y el gestor
respectivamente seleccionando bot&oacute;n Recopilada. Tambi&eacute;n podr&aacute;n introducir
observaciones.</p>




<p class="MsoNormal" style="margin-left: 35.45pt; text-align: left; font-family: Arial;" align="left">&nbsp;</p>
...
<h4 style="margin-left: 0cm; text-indent: 0cm; font-family: Arial;"><a name="_Toc273601833">2.5.1.8 Hist&oacute;rico de
operaciones:</a> </h4>
...
<p style="font-family: Arial;" class="MsoNormal">Recoge todas las tareas que se han ido haciendo
tanto por parte del supervisor como del gestor.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Esta pesta&ntilde;a contiene la historia de cada
actuaci&oacute;n/procedimiento y permite comprobar los datos que se introdujeron en
casda etapa o hito.</p>
...
<p style="font-family: Arial;" class="MsoNormal">Adem&aacute;s nos sirve para mantener la secuencia
...
<p style="font-family: Arial;" class="MsoNormal"><span style="font-weight: bold;">a) Consultar</span> </p>
...
<p style="font-family: Arial;" class="MsoNormal">Al pulsar el bot&oacute;n consultar nos aparece la
tarea con los datos que se rellenaron.</p>
...
<h3 style="margin-left: 0cm; font-family: Arial;"><a name="_Toc273601834">2.5.2
Funciones Propias de las Actuaciones</a></h3>
...
<p style="font-family: Arial;" class="MsoNormal"><span style="font-weight: bold;">1. Comunicaci&oacute;n</span>
</p>
...
<p class="MsoNormal" style="margin-bottom: 10pt; font-family: Arial;">Durante, o una
vez finalizada la actividad de gestionar el asunto, el usuario Gestor externo
tiene la posibilidad de enviar comunicaciones a su supervisor relativas a las
actuaciones en cuesti&oacute;n de tal forma que quede constancia de ello en la
herramienta. Nunca debe ser usado como correo electr&oacute;nico sobre temas que nada
tienen que ver con los asuntos.</p>




<p style="font-family: Arial;" class="MsoNormal">Cuando un usuario desea realizar alguna
comunicaci&oacute;n, se despliega el siguiente cuadro:</p>
...
<p class="MsoListParagraph" style="margin-left: 21.3pt; font-family: Arial;"><%--[if gte vml 1]><v:shape
 ...
 mso-wrap-distance-bottom:0;mso-position-horizontal:absolute;
 mso-position-horizontal-relative:text;mso-position-vertical:absolute;
 mso-position-vertical-relative:text' wrapcoords="-292 0 -292 18000 21581 18000 21581 0 -292 0">
...
<p class="MsoListParagraph" style="margin-left: 21.3pt; font-family: Arial;"><%--[if gte vml 1]><v:shape
 ...
 mso-wrap-distance-bottom:0;mso-position-horizontal:absolute;
 mso-position-horizontal-relative:text;mso-position-vertical:absolute;
 mso-position-vertical-relative:text' wrapcoords="-256 0 -256 19736 21540 19736 21540 0 -256 0">
...
<p class="MsoListParagraph" style="margin-left: 53.45pt; font-family: Arial;">&nbsp;</p>
...
<p style="font-family: Arial;" class="MsoNormal">Autom&aacute;ticamente, la aplicaci&oacute;n generar&aacute; una
...
<p class="MsoNormal" style="margin-bottom: 10pt; text-align: left;" align="left">&nbsp;</p>
