...
if [ "x$1" != "x-q" ]; then
	echo "-----------------------------------------------------------------------------------------------------"
	echo " ASISTENTE PARA CREAR EL PROYECTO EN ECLIPSE PARA COREEXTENSION"
	echo "-----------------------------------------------------------------------------------------------------"
	echo ""
...
mvn $BUILD_PROPERTIES eclipse:eclipse  -Declipse.projectNameTemplate="recovery-coreextension-plugin$TEMPLATE"
