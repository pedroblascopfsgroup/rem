...
//	}		
	...
	public Boolean esGestorDecision() {
		...
		try {
			...
			logger.fatal("No se ha podido averiguar si el usuario con Id " + usuario.getId() + " es gestor de Decisi�n del asunto");
			return false;
			//throw new BusinessOperationException(e);
		}
	}		
	 ...
	 * esUsuarioGestorDecision
	 * 
	 * Nos devuelve si este usuario tiene alg�n gestor de tipo Decisi�n
	 * 
	 * @param usu Usuario
	 * @return true / false
	 */
