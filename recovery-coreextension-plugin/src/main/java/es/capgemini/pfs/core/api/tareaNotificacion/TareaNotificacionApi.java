...
public interface TareaNotificacionApi {
    ...
    /**
     * Crea una notificaci�n para un expediente.
     * @param idEntidadInformacion el id de la entidad que genera la notificaci�n.
     * @param idTipoEntidadInformacion indica a que tipo de entidad corresponde el id anterior.
     * @param codigoSubtipoTarea el c�digo de la notificacion a insertar.
     * @param descripcion descripcion
     * @return el id de la notificaci�n que se cre�.
     */
    ...
    /**
	 * m�todo para marcar una tarea alertada como revisada
