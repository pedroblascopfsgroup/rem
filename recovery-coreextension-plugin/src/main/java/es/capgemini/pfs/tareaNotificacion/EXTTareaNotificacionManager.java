...
public class EXTTareaNotificacionManager extends EXTAbstractTareaNotificacionManager implements TareaNotificacionApi {
    ...
    private final static String[] NOMBRES_COLUMNAS = new String[] { "ID", "Nombre", "Unidad de Gesti�n", "Descripci�n", "Fecha Inicio", "Fecha Vencimiento", "Tipo Solicitud", "D�as Vencida",
