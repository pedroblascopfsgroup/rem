...
public class DespachoExternoExtrasDto {
	...
	public void setDocumentoCif(String documentiCif) {
		this.documentoCif = documentiCif;
	}
	...
	public String getIrpfAplicado() {
		return irpfAplicado;
	}
	public void setIrpfAplicado(String irpfAplicado) {
		this.irpfAplicado = irpfAplicado;
	}
	...
	public String getClasifDespachoConcursos() {
		return clasifDespachoConcursos;
	}
	public void setClasifDespachoConcursos(String clasifDespachoConcursos) {
		this.clasifDespachoConcursos = clasifDespachoConcursos;
	}
	public String getClasifDespachoPerfil() {
		return clasifDespachoPerfil;
	}
