 ...
 */
@Entity
@Table(name = "DD_REC_RESULTADO_COMITE", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class DDResultadoComite implements Auditable, Dictionary {

	private static final long serialVersionUID = 1L;
	public static final String ACEPTADA = "ACE";
	public static final String SUSPENDER = "SUS";
	public static final String RECTIFICAR = "REC";
