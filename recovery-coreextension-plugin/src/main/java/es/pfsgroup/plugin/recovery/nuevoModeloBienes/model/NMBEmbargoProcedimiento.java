...
@Entity
@Table(name = "EMP_NMBEMBARGOS_PROCEDIMIENTOS", schema = "${entity.schema}")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
public class NMBEmbargoProcedimiento implements Serializable, Auditable {
	    ...
	    @Column(name = "EMP_FECHA_DENEGACION_EMBARGO")
