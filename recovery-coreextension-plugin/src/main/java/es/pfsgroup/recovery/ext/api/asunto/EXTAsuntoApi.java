...
public interface EXTAsuntoApi {
	...
	/**
	 * Esta funciï¿½n no devuelve una lista de tipos de gestor (modelo multigestor)
	 * para el usuario logado. Si el modelo NO es multigestor, devuelve la Lista VACï¿½A
	 * @param idAsunto
	 * @return
	 */
