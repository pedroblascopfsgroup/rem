...
/**
 * Interfaz que define los manejadores de los filtros dínamicos para la busqueda de Asuntos
 * 
 * **/
...
public interface EXTBusquedaAsuntoFiltroDinamico {
	 ...
	 * origen:valor;parámetroDinamico1:valor1;parámetroDinamico2:valor2;
	 * 
