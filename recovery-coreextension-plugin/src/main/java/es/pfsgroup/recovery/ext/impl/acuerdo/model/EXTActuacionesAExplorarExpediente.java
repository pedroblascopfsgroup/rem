...
/**
 * Clase que representa a un EXTActuacionesAExplorarExpediente.
 * @author jbosnjak
 *
 */
@Entity
@Table(name="AEE_ACTUACION_EXPLORAR_EXP", schema="${entity.schema}")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
public class EXTActuacionesAExplorarExpediente implements Serializable,Auditable,Comparable<Object> {

	private static final long serialVersionUID = 0L;

	@Id
	@Column(name="AEE_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "EXTActuacionesAExplorarExpedienteGenerator")
    @SequenceGenerator(name = "EXTActuacionesAExplorarExpedienteGenerator", sequenceName = "S_AEE_ACTUACION_EXPLORAR_EXP")
	private Long id;
	...
	public int compareTo(Object o) {
	    EXTActuacionesAExplorarExpediente act = (EXTActuacionesAExplorarExpediente) o;
