...
public class HistoricoProcedimientoExtDaoImpl extends AbstractEntityDao<EXTHistoricoProcedimiento, Long> implements HistoricoProcedimientoExtDao{
	...
	public List<EXTHistoricoProcedimiento> getListByProcedimiento(
        ...
        try {
            String query = "SELECT TIPO_ENTIDAD, ID_ENTIDAD, RESPUESTA, NOMBRE, FECHA, FECHA_INI, FECHA_VENC, FECHA_FIN, USUARIO, FECHA_VENC_REAL, STA_CODIGO, TAR_DESCRIPCION, TAP_CODIGO FROM ("
            ...
            while (it.hasNext()) {
                ...
                hProcedimiento.setFechaVencReal((Date) vector[9]);//FechaVencReal                
                if(vector[10] != null){
                	hProcedimiento.setSubtipoTarea(vector[10].toString());//dd_sta_codigo
                }else{
                	hProcedimiento.setSubtipoTarea("");
                }
                hProcedimiento.setDescripcionTarea((String) vector[11]);
                hProcedimiento.setCodigoTarea((String) vector[12]); 
	...
	private String getConsultaAgregada() {
        ...
        return "SELECT TIPO_ENTIDAD, ID_ENTIDAD, RESPUESTA, PRC_ID, NOMBRE, FECHA, FECHA_INI, FECHA_VENC, FECHA_FIN, USUARIO, FECHA_VENC_REAL, STA_CODIGO, TAR_DESCRIPCION, TAP_CODIGO FROM "
        //Tareas externa
                + "( " + "    SELECT "
                ...
                + ", TAR.TAR_FECHA_INI AS FECHA_INI, TAR.TAR_FECHA_VENC AS FECHA_VENC, TAR.TAR_FECHA_FIN AS FECHA_FIN, TAR.USUARIOCREAR AS USUARIO, TAR.TAR_FECHA_VENC_REAL AS FECHA_VENC_REAL, STA5.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, TAP.TAP_CODIGO AS TAP_CODIGO "
                ...
                + " AS TIPO_ENTIDAD, TEX.TAR_ID AS ID_ENTIDAD, 0 AS RESPUESTA, TAR.PRC_ID AS PRC_ID, TAR_TAREA AS NOMBRE, TEX.FECHACREAR AS FECHA"
                + ", TAR.TAR_FECHA_INI AS FECHA_INI, TAR.TAR_FECHA_VENC AS FECHA_VENC, TAR.TAR_FECHA_FIN AS FECHA_FIN, TAR.USUARIOCREAR AS USUARIO, TAR.TAR_FECHA_VENC_REAL AS FECHA_VENC_REAL, STA6.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, TAP.TAP_CODIGO AS TAP_CODIGO "
                ...
                + ", TAR_ID, 0, PRC.PRC_ID, TAR_TAREA, TAR.FECHACREAR, TAR.TAR_FECHA_INI, TAR.TAR_FECHA_VENC, TAR.TAR_FECHA_FIN, TAR.USUARIOCREAR, TAR.TAR_FECHA_VENC_REAL AS FECHA_VENC_REAL, STA.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, NULL "
                ...
                + "', REC.FECHACREAR, REC.FECHACREAR, null, null, REC.USUARIOCREAR, null, STA7.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, NULL FROM TAR_TAREAS_NOTIFICACIONES TAR, RCR_RECURSOS_PROCEDIMIENTOS REC, ${master.schema}.DD_STA_SUBTIPO_TAREA_BASE STA7 "
                ...
                + "', REC.FECHAMODIFICAR, REC.FECHACREAR, null, REC.FECHAMODIFICAR, REC.USUARIOMODIFICAR, null, STA8.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, NULL FROM TAR_TAREAS_NOTIFICACIONES TAR, RCR_RECURSOS_PROCEDIMIENTOS REC, ${master.schema}.DD_STA_SUBTIPO_TAREA_BASE STA8 "
                ...
                + "', SPR.FECHACREAR, SPR.FECHACREAR, null, null, SPR.USUARIOCREAR, null, STA9.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, NULL FROM TAR_TAREAS_NOTIFICACIONES TAR, SPR_SOLICITUD_PRORROGA SPR, ${master.schema}.DD_STA_SUBTIPO_TAREA_BASE STA9 "
                ...
                + "', SPR.FECHAMODIFICAR, SPR.FECHACREAR, null, SPR.FECHAMODIFICAR, SPR.USUARIOMODIFICAR, null, STA10.DD_STA_CODIGO AS STA_CODIGO, TAR.TAR_DESCRIPCION AS TAR_DESCRIPCION, NULL FROM TAR_TAREAS_NOTIFICACIONES TAR, SPR_SOLICITUD_PRORROGA SPR, ${master.schema}.DD_STA_SUBTIPO_TAREA_BASE STA10 "
                ...
                + "', ACU.FECHACREAR, ACU.FECHACREAR, null, null, ACU.USUARIOCREAR, null, null, null, NULL FROM ACU_ACUERDO_PROCEDIMIENTOS ACU, PRC_PROCEDIMIENTOS PRC"
                ...
                + "' || eac.dd_eac_descripcion_larga, ACU.FECHAMODIFICAR, ACU.FECHAMODIFICAR, null, ACU.FECHAMODIFICAR, ACU.USUARIOMODIFICAR, null, null, ACU.ACU_MOTIVO, NULL "
                ...
                + "', DPR.FECHACREAR, DPR.FECHACREAR, null, null, DPR.USUARIOCREAR, null, null, null, NULL FROM DPR_DECISIONES_PROCEDIMIENTOS DPR, PRC_PROCEDIMIENTOS PRC"
                ...
                + "', DPR.FECHAMODIFICAR, DPR.FECHACREAR, null, DPR.FECHAMODIFICAR, DPR.USUARIOMODIFICAR, null, null, null, NULL FROM DPR_DECISIONES_PROCEDIMIENTOS DPR"
