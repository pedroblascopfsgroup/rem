...
public static String convertNumberToLetter(String number)
        throws NumberFormatException {
	String numeroFormateado =number.replace(".", ""); 
	String numeroFormateado2=numeroFormateado.replace(",", ".");
	String numeroFormateado3 =numeroFormateado2.replace("\"", "");
    return convertNumberToLetter(Double.parseDouble(numeroFormateado3));
}
