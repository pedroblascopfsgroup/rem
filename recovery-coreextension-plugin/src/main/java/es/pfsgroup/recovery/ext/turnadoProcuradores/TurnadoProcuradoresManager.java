...
public class TurnadoProcuradoresManager implements TurnadoProcuradoresApi {
	...
	@Override
	@Transactional
	public List<Long> aÒadirNuevoTpoAPlazas(Long idEsquema, Long idTpo, Long[] arrayPlazas) {
	...
	public List<TipoProcedimiento> getTPODisponiblesByPlaza(Long idEsquema, Long idPlaza) {
		...
		//FIXME Cambiar si se desea poder asignar el tpo por defecto a cualquier plaza (aÒadir el tpo por defecto a ambos casos)
		if(idPlaza!=-1){
