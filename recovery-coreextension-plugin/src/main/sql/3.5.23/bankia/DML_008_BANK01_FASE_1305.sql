...
ELSE
	...
	SELECT S_FUN_PEF.nextval, (SELECT DISTINCT fun.FUN_ID FROM '||V_ESQUEMA_M||'.FUN_FUNCIONES fun WHERE fun.FUN_DESCRIPCION = ''PUEDE_VER_TITULZADA'' ), pef.PEF_ID, 0, ''FASE-1305'',SYSDATE,0 
	FROM bank01.PEF_PERFILES pef';
