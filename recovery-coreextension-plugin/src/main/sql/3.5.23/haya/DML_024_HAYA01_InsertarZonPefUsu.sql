...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION(
      	...
      	/*usu_id..................:*/ 'SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = ''GEST_UCO''',
      	/*zon_id..................:*/ 'SELECT ZON_ID FROM '||V_ESQUEMA||'.ZON_ZONIFICACION WHERE ZON_COD = ''01'''
      ),
      T_FUNCION(
      	/*pef_id..................:*/ 'SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''FPFSRFUNCSUP''',
      	/*usu_id..................:*/ 'SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = ''G_UCO_V''',
      	/*zon_id..................:*/ 'SELECT ZON_ID FROM '||V_ESQUEMA||'.ZON_ZONIFICACION WHERE ZON_COD = ''01'''
      ),
      T_FUNCION(
      	/*pef_id..................:*/ 'SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''FPFSRFUNCSUP''',
      	/*usu_id..................:*/ 'SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = ''G_UCO_H''',
      	/*zon_id..................:*/ 'SELECT ZON_ID FROM '||V_ESQUEMA||'.ZON_ZONIFICACION WHERE ZON_COD = ''01'''
      )
    ); 
