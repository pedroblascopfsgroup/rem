 ...
 */
@Entity
@Table(name = "DD_ACC_CAPACIDAD_PAGO", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class DDAnalisisCapacidadPago implements Dictionary, Auditable {

    private static final long serialVersionUID = -5000987797957822994L;

    @Id
    @Column(name = "DD_ACC_ID")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "DDAnalisisCapacidadPagoGenerator")
    @SequenceGenerator(name = "DDAnalisisCapacidadPagoGenerator", sequenceName = "S_DD_ACC_CAPACIDAD_PAGO")
    private Long id;
