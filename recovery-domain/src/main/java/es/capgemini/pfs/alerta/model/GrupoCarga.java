 ...
 */
@Entity
@Table(name = "GRC_GRUPO_CARGA", schema = "${entity.schema}")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
public class GrupoCarga implements Serializable, Auditable {
    ...
    @Column(name = "GRC_CODIGO")
    private String codigo;

    @Column(name = "GRC_DESCRIPCION")
    private String descripcion;

    @Column(name = "GRC_DESCRIPCION_LARGA")
    private String descripcionLarga;

    @OneToMany(mappedBy = "grupoCarga", fetch = FetchType.LAZY)
