...
public class Procedimiento implements Serializable, Auditable, Comparable<Procedimiento> {
    ...
    /**
     * m�todo para registrar los saldos vencido y no vencido originales del
     * �ltimo movimiento del contrato.
     */
    ...
    /**
     * Devuelve si el procedimiento actual es un procedimiento v�lido contablemente (aceptado, cerrado o derivado)
     * @return
     */
    ...
    /**
     * Comprueba si el procedimiento NO se encuentra entre uno de los tres primeros estados (en conformaci�n, confirmado o propuesto)
     * Es decir, comprueba que el asunto est� aceptado y con su BPM externo activo.
     * @return boolean
     */
    ...
    /**
     * Comprueba si es un procedimiento derivado si est� o no aceptado
     * @return
     */
