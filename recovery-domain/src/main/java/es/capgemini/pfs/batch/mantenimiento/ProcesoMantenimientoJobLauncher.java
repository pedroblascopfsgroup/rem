...
public class ProcesoMantenimientoJobLauncher implements BatchPCRConstantes, JobRunner {
    ...
    public void handle(Message<GenericEvent> message) {
        ...
        JobInfo jobInfo = new JobInfo(PCR_MANTENIMIENTO_JOBNAME, message.getPayload().getPropertyAsString(ENTIDAD), this);
    ...
    public void run() {
        ...
        try {
            ...
            if (BatchExitStatus.COMPLETED.equals(exitStatus)) {
                ...
                revisionJobLauncher.handle(workingCode, (Date) event.getProperty(EXTRACTTIME));
            } else {
