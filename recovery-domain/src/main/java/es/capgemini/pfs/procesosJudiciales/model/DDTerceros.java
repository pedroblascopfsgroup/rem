 ...
 */
@Entity
@Table(name = "DD_TRC_TERCEROS",schema = "${master.schema}")
@Cache(usage=CacheConcurrencyStrategy.READ_ONLY)
public class DDTerceros implements Auditable, Dictionary{
	...
	@Column(name = "DD_TRC_DESCRIPCION")
	private String descripcion;

	@Column(name = "DD_TRC_DESCRIPCION_LARGA")
