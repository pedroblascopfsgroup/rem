...
/**
 * entidad de la tabla DD_RPR_RAZON_PRORROGA.
 * @author jbosnjak
 *
 */
@Entity
@Table(name = "DD_RPR_RAZON_PRORROGA", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class RespuestaProrroga implements Serializable, Auditable {
    ...
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "RespuestaProrrogaGenerator")
    @SequenceGenerator(name = "RespuestaProrrogaGenerator", sequenceName = "S_DD_RPR_RAZON_PRORROGA")
    private Long id;
