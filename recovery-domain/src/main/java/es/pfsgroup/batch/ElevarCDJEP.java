...
public class ElevarCDJEP extends JobExecutionPolicy {

	

	public ElevarCDJEP(String workingCode, Date extractTime) {
		
	}

	/**
	 * Politia: No se puede ejecutar una revision si esta esperando para
	 * ejecucion uno job de tipo: - PCR - Scoring - Prepolitica - Carga Grupos
	 * 
	 */
	...
	/**
	 * Metodo para verificar si se debe agregar la revision o no. Politica: Si
	 * ya ha una revision para la misma fecha de extracción NO debemos generar
	 * una nueva.
	 */
	@Override
