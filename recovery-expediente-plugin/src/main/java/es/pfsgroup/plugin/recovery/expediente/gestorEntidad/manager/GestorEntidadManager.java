package es.pfsgroup.plugin.recovery.expediente.gestorEntidad.manager;
...
import es.pfsgroup.plugin.recovery.expediente.gestorEntidad.model.GestorAsunto;
import es.pfsgroup.plugin.recovery.expediente.gestorEntidad.model.GestorAsuntoHistorico;
import es.pfsgroup.plugin.recovery.expediente.gestorEntidad.model.GestorEntidadHistorico;
import es.pfsgroup.plugin.recovery.expediente.gestorEntidad.model.GestorExpedienteHistorico;
...
public class GestorEntidadManager implements GestorEntidadApi {
	...
	@BusinessOperation(BO_INSERTAR_GESTOR_ADICIONAL_ENTIDAD)
	...
	@Override
	@Transactional(readOnly = false)
	@BusinessOperation(BO_BORRAR_GESTOR_ADICIONAL_ENTIDAD)
	...
	@Override
	@BusinessOperation(GET_LISTADO_TIPO_GESTOR_EDITABLE)
	...
	@Override
	@BusinessOperation(GET_LISTADO_GESTOREXPEDIENTE_POR_TIPO)
