...
<!-- 		} -->
	...
	var contratosCM = new Ext.grid.ColumnModel([
		...
		,{header: '<s:message code="preproyectado.contratos.diasVencidos" text="**D�as vencidos" />',dataIndex: 'diasVencidos',sortable:true, align: 'right'}
		...
		,{header: '<s:message code="preproyectado.contratos.estadoGestion" text="**Estado Gesti�n" />',dataIndex: 'estadoGestion',sortable:true}
		,{header: '<s:message code="preproyectado.contratos.fechaPrevistaRegularizacion" text="**Fecha prevista regularizaci�n" />',dataIndex: 'fechaPrevReguCnt',sortable:true}
	]);
