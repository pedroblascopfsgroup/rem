...
<!-- 		} -->
	...
	var expedientesCM = new Ext.grid.ColumnModel([
		...
		,{header: '<s:message code="preproyectado.expedientes.diasVencidosExp" text="**DÌas vencidos" />',dataIndex: 'diasVencidosExp',sortable:true, align: 'right'}
		...
		,{header: '<s:message code="preproyectado.expedientes.fechaPrevReguExp" text="**Fecha prevista regularizaciÛn" />',dataIndex: 'fechaPrevReguExp',sortable:true}		
	]);
