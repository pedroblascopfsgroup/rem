copy target\recovery-geninformes-plugin-*-SNAPSHOT.jar C:\pfssor\batch
move target\recovery-geninformes-plugin-*-SNAPSHOT.jar C:\pfssor\sortomcat\wtpwebapps\rec-web\WEB-INF\lib
