...
import es.pfsgroup.plugin.gestorDocumental.model.servicios.EntidadMetadatos;
...
public class CrearGarantiaDto {
	...
	/**
	 * Objeto constituido por los metadatos para un expediente de entidades
	 */
	private EntidadMetadatos entidadMetadatos;
	...
	public EntidadMetadatos getEntidadMetadatos() {
		return entidadMetadatos;
	}
	
	public void setEntidadMetadatos(EntidadMetadatos entidadMetadatos) {
		this.entidadMetadatos = entidadMetadatos;
	}
}