...
public class CrearJuntaDto {
	 ...
	 */
	private String descripcionJunta;
	...
	public String getDescripcionJunta() {
		return descripcionJunta;
	}

	public void setDescripcionJunta(String descripcionJunta) {
		this.descripcionJunta = descripcionJunta;
	}
