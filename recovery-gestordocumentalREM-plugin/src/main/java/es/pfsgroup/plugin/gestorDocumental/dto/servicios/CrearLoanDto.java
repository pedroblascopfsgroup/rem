...
import es.pfsgroup.plugin.gestorDocumental.model.servicios.LoanMetadatos;
...
public class CrearLoanDto {
	...
	/**
	 * Objeto constituido por los metadatos para un expediente financiero
	 */
	private LoanMetadatos loanMetadatos;
	...
	public LoanMetadatos getLoanMetadatos() {
		return loanMetadatos;
	}
	
	public void setLoanMetadatos(LoanMetadatos loanMetadatos) {
		this.loanMetadatos = loanMetadatos;
	}
