 ...
 * generated in the es.pfsgroup.plugin.gestorDocumental.ws.MAESTRO_UNIDADES package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.pfsgroup.plugin.gestorDocumental.ws.MAESTRO_UNIDADES
     * 
     */
