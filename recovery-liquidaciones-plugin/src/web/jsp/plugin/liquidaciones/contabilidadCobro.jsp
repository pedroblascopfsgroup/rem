...
<fwk:page>
	...
	var numEnlace  = new Ext.form.TextArea({
		fieldLabel:'<s:message code="contabilidad.numEnlace" text="**N�mero Enlace" />'
		,labelStyle:labelStyle
		,style:style
		,width:135
		,height:21
	...
	var numMandamiento  = new Ext.form.TextArea({
		fieldLabel:'<s:message code="contabilidad.numMandamiento" text="**N�mero Mandamiento" />'
		,labelStyle:labelStyle
		,style:style
		,width:135
		,height:21
	...
	var numCheque  = new Ext.form.TextArea({
		fieldLabel:'<s:message code="contabilidad.numCheque" text="**N�mero Cheque" />'
		,labelStyle:labelStyle
		,width:135
		,height:21
		,style:style
	...
	labelStyle:labelStyle,
    items: [
        {fieldLabel: '<s:message code="contabilidad.operacionesTramite" text="**Operaciones Tr�mite" />'
        ,name: 'cb-1'
        ,style:style
		,labelStyle:labelStyle
