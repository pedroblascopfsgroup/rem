...
@Component
public class MSVBusinessAltaAsuntosSQLValidator implements MSVBusinessValidatorsAutowiredSupport {
...
//	}
	...
	MSVFactoriaQuerysSQLValidarAltaAsuntos msvQuerys;

	@Override
	public String getCodigoTipoOperacion() {
		return MSVDDOperacionMasiva.CODIGO_ALTA_ASUNTOS;
	}
	...
	public MSVFactoriaQuerysSQLValidarAltaAsuntos getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLValidarAltaAsuntos msvQuerys) {
