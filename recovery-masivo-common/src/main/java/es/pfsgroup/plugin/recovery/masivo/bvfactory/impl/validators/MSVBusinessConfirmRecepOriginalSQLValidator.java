...
@Component
public class MSVBusinessConfirmRecepOriginalSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLConfirmContratoOriginal msvQuerys;
	...
	public MSVFactoriaQuerysSQLConfirmContratoOriginal getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLConfirmContratoOriginal msvQuerys) {
