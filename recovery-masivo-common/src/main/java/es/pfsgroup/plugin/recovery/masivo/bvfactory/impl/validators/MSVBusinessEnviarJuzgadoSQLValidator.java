...
@Component
public class MSVBusinessEnviarJuzgadoSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLEnviarJuzgado msvQuerys;
	...
	public MSVFactoriaQuerysSQLEnviarJuzgado getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLEnviarJuzgado msvQuerys) {
