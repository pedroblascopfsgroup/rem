...
@Component
public class MSVBusinessGenerarFicheroTasasSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLGenerarFicheroTasas msvQuerys;

	@Override
	public String getCodigoTipoOperacion() {
		return MSVDDOperacionMasiva.CODIGO_GENERAR_FICHERO_TASAS;
	}
	...
	public MSVFactoriaQuerysSQLGenerarFicheroTasas getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLGenerarFicheroTasas msvQuerys) {
