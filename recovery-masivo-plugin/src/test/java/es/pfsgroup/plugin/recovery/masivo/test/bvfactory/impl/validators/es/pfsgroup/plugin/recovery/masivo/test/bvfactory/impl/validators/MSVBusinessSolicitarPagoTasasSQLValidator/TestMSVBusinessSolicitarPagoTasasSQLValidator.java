package es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.MSVBusinessSolicitarPagoTasasSQLValidator;
...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.MSVBusinessSolicitarPagoTasasSQLValidator;
...
public class TestMSVBusinessSolicitarPagoTasasSQLValidator extends MSVBusiness_OPERACIONES_SQLValidator {
	
	@Mock
	private MSVFactoriaQuerysSQLSolicitarPagoTasas mockMsvQuerys;

	@InjectMocks
	private MSVBusinessSolicitarPagoTasasSQLValidator validator;

	@Test
	public void testCodigoTipoOperacion() {
		super.testCodigoTipoOperacion(MSVDDOperacionMasiva.CODIGO_SOLICITAR_PAGO_TASAS, validator);
	}
