package es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.sqlValidator16;
...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.MSVBusinessValidarFicheroTasasSQLValidator;
...
public class TestMSVBusinessValidarFicheroTasasSQLValidator extends MSVBusiness_OPERACIONES_SQLValidator {
	
	@Mock
	private MSVFactoriaQuerysSQLValidarFicheroTasas mockMsvQuerys;

	@InjectMocks
	private MSVBusinessValidarFicheroTasasSQLValidator validator;

	@Test
	public void testCodigoTipoOperacion() {
		super.testCodigoTipoOperacion(MSVDDOperacionMasiva.CODIGO_VALIDAR_FICHERO_TASAS, validator);
	}
