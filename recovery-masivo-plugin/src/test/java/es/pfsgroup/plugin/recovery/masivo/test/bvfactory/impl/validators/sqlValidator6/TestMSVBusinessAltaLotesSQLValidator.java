package es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.sqlValidator6;
...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.MSVBusinessAltaLotesSQLValidator;
...
/**
 * Test del validador de alta de lotes.
 * @author manuel
 *
 */
@RunWith(MockitoJUnitRunner.class)
public class TestMSVBusinessAltaLotesSQLValidator  {
	...
	@Mock
	private MSVFactoriaQuerysSQLValidarAltaLotes mockMsvQuerys;

	@InjectMocks
	private MSVBusinessAltaLotesSQLValidator validator;

	@Test
	public void testCodigoTipoOperacion() {
		assertEquals(MSVDDOperacionMasiva.CODIGO_ALTA_LOTES, validator.getCodigoTipoOperacion());
	}
