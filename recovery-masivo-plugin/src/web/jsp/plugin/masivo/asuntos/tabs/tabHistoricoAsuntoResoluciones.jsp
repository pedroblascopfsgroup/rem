...
(function(page,entidad){
	...
	var HistoricoAsuntoRT = Ext.data.Record.create([
		...
		,{name : 'fechaInicio', type:'date', dateFormat:'d/m/Y', sortType:Ext.data.SortTypes.asDate}
		,{name : 'fechaFin', type:'date', dateFormat:'d/m/Y', sortType:Ext.data.SortTypes.asDate}
		,{name : 'fechaVencReal', type:'date', dateFormat:'d/m/Y', sortType:Ext.data.SortTypes.asDate}
		,{name : 'fechaVencimiento', type:'date', dateFormat:'d/m/Y', sortType:Ext.data.SortTypes.asDate}
	...
	var historicoAsuntoCM = new Ext.grid.ColumnModel([
		...
		,{header : '<s:message code="plugin.mejoras.asunto.tabHistorico.fechainicio" text="**fecha inicio"/>'
						...
						,sortable:true
						,renderer: app.format.dateRenderer
		}
