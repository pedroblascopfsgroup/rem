		...
		if (columnName == 'fechaSolicitudAvDomiciliaria') {
		    ...
		    if (idDemandado) {
		    	...
		    	if (columnName == 'excluido') {
					if (!datosEditables) {
						Ext.Msg.alert('<s:message code="fwk.ui.errorList.fieldLabel"/>','<s:message code="plugin.masivo.notificacionDemandados.error.noEditable" text="** Sólo puede editar este campo cuando se accede desde el formulario de una resolución."/>');
						return false;
					}
				}
		    }else{
