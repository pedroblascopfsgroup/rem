package es.pfsgroup.plugin.recovery.mejoras.devolucionAsunto.process;
 ...
 *
 */
public interface MEJTareaBPMConstants extends BPMContants{
   ...
   String TRANSITION_AMPLIAR_PLAZO= "AplazarTarea";
