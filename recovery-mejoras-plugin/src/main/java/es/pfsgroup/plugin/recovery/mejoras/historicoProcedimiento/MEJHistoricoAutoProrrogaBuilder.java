...
@Component
public class MEJHistoricoAutoProrrogaBuilder implements HistoricoProcedimientoBuilder{
	
	public static final String NOMBRE_TAREA = "Autoprorroga";

	protected static final long ID_TIPO_ENTIDAD_INFORMACION = 13 ;
	...
	private MEJTrazaDto dtoBusqueda(final long idProcedimiento) {
		...
		params.put("tipoEvento", MEJDDTipoRegistro.CODIGO_AUTO_PRORROGA);
