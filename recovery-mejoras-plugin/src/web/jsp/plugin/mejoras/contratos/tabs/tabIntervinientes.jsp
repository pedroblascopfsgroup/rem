...
(function(){
	...
	var intervinientesStore = new Ext.data.JsonStore({
		data : intervinientes
		,root : 'intervinientes'
		,fields : ['nombre','apellidos','codClienteEntidad','nif','saldoVencido','totalRiesgo','numContratos'
	...
	var intervinientesCm = new Ext.grid.ColumnModel([
		...
		,{header : '<s:message code="contrato.consulta.tabIntervinientes.clientes.apellidos" text="**Apellidos" />', dataIndex : 'apellidos', sortable:false, width:130 }
