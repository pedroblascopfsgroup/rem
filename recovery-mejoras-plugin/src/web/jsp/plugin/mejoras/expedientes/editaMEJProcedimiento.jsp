...
<fwk:page>
	...
	*/
	...
	var labelStyleTextField='font-weight:bolder;margin-bottom:1px;margin-top:1px;width:145px'	
	var labelStyle='font-weight:bolder;width:145';
	...
	var panelEdicion = new Ext.form.FormPanel({
		...
		,items : [
			...
			,{ 
				...
				,defaults :  {height:200,style:'padding:3px'}
				,items : [
					{
