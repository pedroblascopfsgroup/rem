...
<fwk:page>
	...
	favIcon = function(value){
		...
		if (idx==app.constants.FAV_TIPO_BIEN) icon = 'house.gif';
		if (idx==app.constants.FAV_TIPO_ASUNTOND) icon = 'folder_page.gif';
			...
			rowdblclick : function(grid, rowIndex){
				...
				switch(tipo){
					...
					case app.constants.FAV_TIPO_ASUNTO:
						...
						break;
					case app.constants.FAV_TIPO_ASUNTOND:
						app.abreAsuntoNd(rec.get('codigo'), rec.get('nombre'));
						break;
					...
					case app.constants.FAV_TIPO_CONTRATO:
						...
						break;
					case app.constants.FAV_TIPO_BIEN:
						app.abreBien(rec.get('codigo'), rec.get('nombre'));
						break;							
				}
			}
			,render: function(g) {
