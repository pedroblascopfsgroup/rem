...
<%@ include file="/WEB-INF/jsp/plugin/mejoras/generico/partesGenericForm/items.jsp" %>
<%@ include file="/WEB-INF/jsp/plugin/mejoras/generico/partesGenericForm/botonExportar.jsp" %>
<%@ include file="/WEB-INF/jsp/plugin/mejoras/generico/partesGenericForm/botonGuardar.jsp" %>
...
<%@ include file="/WEB-INF/jsp/plugin/mejoras/generico/partesGenericForm/panelEdicion.jsp" %>
