...
public class AsyncServiceActivator implements ApplicationContextAware{
	...
	private Object invoqueMethodAndManageExceptions(Message<Object> msg, Object service, String methodName,
		...
		try {
			...
			throw new WrongMessage(msg, methodName + ": method cannot be accessed in " + service.getClass().getName(), e);
		} catch (NoSuchMethodException e) {
			throw new WrongMessage(msg, methodName + ": method doesn't exist in " + service.getClass().getName());
		} catch (IllegalArgumentException e) {
			throw new WrongMessage(msg, service.getClass().getName() + "." + methodName + ": unexpected argument type " + parameter.getClass().getName(),e);
		} catch (IllegalAccessException e) {
			throw new WrongMessage(msg, methodName + ": method cannot be accessed in " + service.getClass().getName(), e);
		} catch (InvocationTargetException e) {
			throw new WrongMessage(msg, service.getClass().getName() + "." + methodName + ":: method execution error", e);
		}
	}
