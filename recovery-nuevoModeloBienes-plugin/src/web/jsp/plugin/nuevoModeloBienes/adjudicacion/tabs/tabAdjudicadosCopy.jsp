...
//				return '';
	...
	var checkColumnAdjudicado = new Ext.grid.CheckColumn({
	    ...
	    ,width:50,dataIndex:'incluidoAdjudicado'});

	//FIN CHECK
	var checkColumnPosesion = new Ext.grid.CheckColumn({
	    header : '<s:message code="subastas.agregarExcluirBien.grid.seleccionar" text="**Seleccionar"/>'
	    ,width:50,dataIndex:'incluidoPosesion'});
	//CHECK2
...
<%-- 	
	...
	var marcadoBienesStore = page.getStore({
  	...
  	var marcadoBienesCM = new Ext.grid.ColumnModel([
		{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.id" text="**Id"/>', dataIndex : 'id', width:75, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.codigo" text="**Codigo"/>', dataIndex : 'codigo', width:75}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.numeroActivo" text="**Numero Activo"/>', dataIndex : 'numeroActivo', width:75}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.origen" text="**Origen"/>', dataIndex : 'origen', width:75}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.descripcion" text="**Descripci&oacute;n"/>', dataIndex : 'descripcion', width:150}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.habitual" text="**Vivienda habitual"/>', dataIndex : 'habitual', width:75, renderer: SI_NO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.tareaActivaAdjudicacion" text="**tareaActivaAdjudicacion"/>', dataIndex : 'tareaActivaAdjudicacion', width:150}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.tareaActivaSaneamiento" text="**tareaActivaSaneamiento"/>', dataIndex : 'tareaActivaSaneamiento', width:150}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.tareaActivaPosesion" text="**tareaActivaPosesion"/>', dataIndex : 'tareaActivaPosesion', width:150}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.tareaActivaLlaves" text="**tareaActivaLlaves"/>', dataIndex : 'tareaActivaLlaves', width:150}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.adjudicacion" text="**Adjudicacion"/>', dataIndex : 'adjudicacion', width:75, renderer: OK_KO_Render}		
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.saneamiento" text="**Saneamiento"/>', dataIndex : 'saneamiento', width:90, renderer: OK_KO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.posesion" text="**Posesion"/>', dataIndex : 'posesion', width:90, renderer: OK_KO_Render }
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.marcadoBienesGrid.llaves" text="**LLaves"/>', dataIndex : 'llaves', width:90, renderer: OK_KO_Render }
	]);
...
//FIN PANEL BIENES
	...
	var adjudicacionCM = new Ext.grid.ColumnModel([
		smAdjudicacion
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.idBien" text="**Id"/>', dataIndex : 'idBien', width:100, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.codigo" text="**Codigo"/>', dataIndex : 'codigo', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.numeroActivo" text="**Numero Activo"/>', dataIndex : 'numeroActivo', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaId" text="**Id. tarea"/>', dataIndex : 'tareaId', width:100, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaCodigo" text="**Código tarea"/>', dataIndex : 'tareaCodigo', width:100, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaDescripcion" text="**Tarea"/>', dataIndex : 'tareaDescripcion', width:100}		
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.origen" text="**Origen"/>', dataIndex : 'origen', width:100}
		...
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.habitual" text="**Vivienda habitual"/>', dataIndex : 'habitual', width:100, renderer: SI_NO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.notificacion" text="**notificacion"/>', dataIndex : 'notificacion', width:100, renderer: SI_NO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.gestoriaAdjudicataria" text="**gestoriaAdjudicataria"/>', dataIndex : 'gestoriaAdjudicataria', width:100}
	]);
	...
	var posesionCM = new Ext.grid.ColumnModel([
		...
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.descripcion" text="**Descripci&oacute;n"/>', dataIndex : 'descripcion'}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.habitual" text="**Vivienda habitual"/>', dataIndex : 'habitual', width:100, renderer: SI_NO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.ocupado" text="**ocupado"/>', dataIndex : 'ocupado', width:100, renderer: SI_NO_Render}		
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.posiblePosesion" text="**posiblePosesion"/>', dataIndex : 'posiblePosesion', width:100, renderer: SI_NO_Render}
	]);
	
	
	var llavesCM = new Ext.grid.ColumnModel([
		smLlaves
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.idBien" text="**Id"/>', dataIndex : 'idBien', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.codigo" text="**Codigo"/>', dataIndex : 'codigo', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.numeroActivo" text="**Numero Activo"/>', dataIndex : 'numeroActivo', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaId" text="**Id. tarea"/>', dataIndex : 'tareaId', width:100, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaCodigo" text="**Código tarea"/>', dataIndex : 'tareaCodigo', width:100, hidden:true}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.tareaDescripcion" text="**Tarea"/>', dataIndex : 'tareaDescripcion', width:100}		
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.origen" text="**Origen"/>', dataIndex : 'origen', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.descripcion" text="**Descripci&oacute;n"/>', dataIndex : 'descripcion', width:100}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.habitual" text="**Vivienda habitual"/>', dataIndex : 'habitual', width:100, renderer: SI_NO_Render}
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.llavesNecesarias" text="**llavesNecesarias"/>', dataIndex : 'llavesNecesarias', width:100, renderer: SI_NO_Render}		
		,{header : '<s:message code="plugin.nuevoModeloBienes.adjudicados.adjudicacionGrid.nombreArrendatario" text="**nombreArrendatario"/>', dataIndex : 'nombreArrendatario', width:100}
	]);
