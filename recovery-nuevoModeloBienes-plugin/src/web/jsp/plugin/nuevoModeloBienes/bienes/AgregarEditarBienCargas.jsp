...
<fwk:page>
	...
	var tipoCarga = app.creaLabel('<s:message code="plugin.nuevoModeloBienes.cargas.tipoCarga" text="**Tipo Carga"/>','${tipoCarga}', {labelStyle:labelStyleAjusteColumnas});
	var idCarga = '${idCarga}';
		...
		var btnEditar = new Ext.Button({
		    ...
		    ,handler:function(){
				if (validateForm()) {		    
			    	var p = getParametros();
			    	Ext.Ajax.request({
							url : page.resolveUrl('editbien/saveCarga'), 
							params : p ,
							method: 'POST',
