...
(function(){
	...
	// DATOS PRINCIPALES
	var codBien				= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.CodigoBien" text="**C�digo"/>','${NMBbien.bienEntidad.id}', {labelStyle:labelStyle});
	var codigoInterno		= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.codigoInterno" text="**C�digo internno"/>','${NMBbien.bienEntidad.codigoInterno}', {labelStyle:labelStyle});
	...
	var fechaVerificacion	= app.creaLabel('<s:message code="bienesCliente.fechaverificacion" text="**Fecha verificaci�n"/>','<fwk:date value="${NMBbien.bienEntidad.fechaVerificacion}"/>', {labelStyle:labelStyle});
	...
	var fechaValApreciacion	= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.fechaValorApreciacion" text="**Fecha val. apreciaci�n"/>','<fwk:date value="${NMBbien.bienEntidad.fechaValorApreciacion}"/>',{labelStyle:labelStyle});
	var valorApreciacion	= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.importeValorApreciacion" text="**Val. Apreciaci�n"/>',app.format.moneyRenderer('${NMBbien.bienEntidad.importeValorApreciacion}'),{labelStyle:labelStyle});
	var fechaValTasacion	= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.fechaValorTasacion" text="**Fecha val. tasaci�n"/>','<fwk:date value="${NMBbien.bienEntidad.fechaValorTasacion}"/>',{labelStyle:labelStyle});
	var valorTasacion		= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.importeValorTasacion" text="**Val. Tasaci�n"/>',app.format.moneyRenderer('${NMBbien.bienEntidad.importeValorTasacion}'),{labelStyle:labelStyle});
	...
	var numRegistro			= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.bienesNMB.numRegistro" text="**N� Registro"/>','${NMBbien.bienEntidad.numRegistro}',{labelStyle:labelStyle});
	...
	var inscripcion			= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.inscripcion" text="**Inscripci�n"/>','${NMBbien.bienEntidad.inscripcion}',{labelStyle:labelStyle});
	var fechaInscripcion	= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.fechaInscripcion" text="**Fecha Inscripci�n"/>','<fwk:date value="${NMBbien.bienEntidad.fechaInscripcion}"/>',{labelStyle:labelStyle});
	var numFinca			= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.numFinca" text="**N� Finca"/>','${NMBbien.bienEntidad.numFinca}',{labelStyle:labelStyle});
	...
	var poblacion			= app.creaLabel('<s:message code="plugin.mejoras.bienesNMB.poblacion" text="**Provisi�n"/>', '<s:message javaScriptEscape="true" text="${NMBbien.bienEntidad.poblacion}" />',{labelStyle:labelStyle});
	...
	//cuenta propia
	var codIAE				= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.epigrafeIAE" text="**C�digo IAE"/>', '<s:message javaScriptEscape="true" text="${NMBbien.bienEntidad.codIAE}" />',{labelStyle:labelStyle});
	var desIAE				= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.descripcionIAE" text="**Descripci�n IAE"/>', '<s:message javaScriptEscape="true" text="${NMBbien.bienEntidad.desIAE}" />',{labelStyle:labelStyle});
	...
	var numCuenta			= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.nCuenta" text="**N� Cuenta"/>', '<s:message javaScriptEscape="true" text="${NMBbien.bienEntidad.numCuenta}" />',{labelStyle:labelStyle});
	...
	var fechaMatricula		= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.fechaMatriculacion" text="**Fecha matriculaci�n"/>','<fwk:date value="${NMBbien.bienEntidad.fechaMatricula}"/>', {labelStyle:labelStyleAjusteColumnas});
	...
	var valorProdBancario	= app.creaLabel('<s:message code="plugin.nuevoModeloBienes.importeValorProdBancario" text="**Valoraci�n"/>',app.format.moneyRenderer('${NMBbien.bienEntidad.valoracion}'),{labelStyle:labelStyle});
	...
	//var secGarantia = app.creaLabel('<s:message code="plugin.nuevoModeloBienes.fichaBien.tabCabecera.otrosDatos.secGarantia" text="**Secuencia de la Garant�a de la operaci�n"/>','<fwk:date value="${NMBbien.adicional.fechaMatricula}"/>', {labelStyle:labelStyleAjusteColumnas});
