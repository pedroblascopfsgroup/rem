...
<fwk:page>
	...
	<sec:authorize ifAllGranted="ESTRUCTURA_COMPLETA_BIENES">
		...
		var validarFormNMB = function() {
			...
			for(var i=0;i < listaTabs.length;i++) {
				 if (listaTabs[i].tipoBien == tipoBienValidar)  {	 	
				 	<%-- Comprobamos pesta�as del tipo de bien correspondiente --%>
		...
		<%--Obtiene el tipoBien cuyas pesta�as se validar�n, en caso de no encontrarse, se validar�n las pesta�as por defecto --%>
