...
public interface NMBProjectContext {
	...
	/**
	 * Completa el Dto como si se hubiera completado la tarea Validar Propuesta seg煤n el BPM de subastas como se hubiera realizado desde el formulario.
	 *  
	 * @param subasta
	 * @param dtoForm
	 * @param tareaExterna
	...
	/**
	 * Actualiza el lote seg煤n la informaci贸n de la tarea y la decisi贸n que se ha tomado.
	 * 
	 * @param lote
	...
	/**
	 * Devuelve los c贸digos de las subastas sobre las que hacer la validacion PRE en la tarea Confirmar testimonio del tr谩mite de adjudicaci贸n. 
	 * 
	 * @return Listado de c贸digos de subasta
	 */
	List<String> getCodigosSubastaValidacion();
	
	/**
	 * Devuelve los c贸digos de todas las subastas  
	 * 
	 * @return Listado de c贸digos de subasta
	 */
	...
	/**
	 * Devuelve el c骴igo de Subasta Sareb
	 * 
	 * @return C骴gio Subasta Sareb
	 */        
	...
	/**
	 * Devuelve el nombre del jrxml del informe de propuesta de cancelaci贸n de cargas.
	 * 
