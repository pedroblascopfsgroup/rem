...
BEGIN
    ...
    if v_column_count = 1 then
        ...
        execute immediate 'alter table HAYA01.DD_TFO_TIPO_FONDO add (DD_TFO_CES_REM  NUMBER(1,0))';
        commit;  
    end if;
    ...
    if v_column_count = 1 then
        ...
        execute immediate 'alter table HAYA01.DD_TFO_TIPO_FONDO add (DD_TFO_CODIGO_NAL  VARCHAR2(20 BYTE))';
        commit;
    end if;
    ...
    if v_column_count = 1 then
        ...
        execute immediate 'alter table HAYA01.DD_TFO_TIPO_FONDO add (DD_TFO_CODIGO_APROV  VARCHAR2(20 BYTE))';
        commit;
    end if;
