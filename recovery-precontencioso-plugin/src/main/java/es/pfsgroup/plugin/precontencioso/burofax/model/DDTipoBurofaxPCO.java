...
public class DDTipoBurofaxPCO implements Dictionary, Auditable {
	...
	@Id
	@Column(name = "DD_PCO_BFT_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoBurofaxPCOGenerator")
	@SequenceGenerator(name = "DDTipoBurofaxPCOGenerator", sequenceName = "S_DD_PCO_BFT_TIPO")
	private Long id;

	@Column(name = "DD_PCO_BFT_CODIGO")
	private String codigo;

	@Column(name = "DD_PCO_BFT_DESCRIPCION")
