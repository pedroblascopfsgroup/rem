...
/* OFICINAS PARA CAJAMAR */
INSERT INTO CMMASTER.USU_USUARIOS (USU_ID, USU_NOMBRE, USU_USERNAME, USU_PASSWORD, FECHACREAR, USUARIOCREAR)
SELECT CMMASTER.S_USU_USUARIOS.NEXTVAL, OFI_NOMBRE, OFI_CODIGO, 1234, sysdate, 'PCO_OFICINAS' 
FROM OFI_OFICINAS;

INSERT INTO USD_USUARIOS_DESPACHOS (USD_ID, USU_ID, USD_GESTOR_DEFECTO, USD_SUPERVISOR, DES_ID, FECHACREAR, USUARIOCREAR)
SELECT S_USD_USUARIOS_DESPACHOS.NEXTVAL, USU_ID, 0, 0, (SELECT DES_ID FROM DES_DESPACHO_EXTERNO WHERE DD_TDE_ID = (SELECT DD_TDE_ID FROM CMMASTER.DD_TDE_TIPO_DESPACHO WHERE DD_TDE_CODIGO = 'OFICINA')), sysdate, 'PCO_OFICINAS' 
FROM CMMASTER.USU_USUARIOS
WHERE USUARIOCREAR = 'PCO_OFICINAS';

/* Gestor estudio CAJAMAR */
INSERT INTO DES_DESPACHO_EXTERNO (DES_ID, DES_DESPACHO, DD_TDE_ID, USUARIOCREAR, FECHACREAR) 
	VALUES (S_DES_DESPACHO_EXTERNO.NEXTVAL, 'Gestoria de estudio', (SELECT DD_TDE_ID FROM &master .DD_TDE_TIPO_DESPACHO WHERE DD_TDE_CODIGO = 'CM_GE_PCO'), 'PCOPrueba', SYSDATE);

INSERT INTO &master .usu_usuarios (USU_ID,ENTIDAD_ID,USU_USERNAME,USU_PASSWORD,USU_NOMBRE,USU_APELLIDO1,USU_APELLIDO2,USU_TELEFONO,
  		USU_MAIL,VERSION,USUARIOCREAR,FECHACREAR,BORRADO,USU_EXTERNO,USU_FECHA_VIGENCIA_PASS,USU_GRUPO,USU_FECHA_EXTRACCION,USU_BAJA_LDAP)
	VALUES (&master .s_usu_usuarios.nextval, 1, 'CM_GE_PCO', '1234', 'CM_GE_PCO', 'CM_GE_PCO', 'CM_GE_PCO', '111111111', 
		'my@email.com', 0, 'PCOPrueba', SYSDATE, 0, 1, TO_DATE('01/01/2017', 'dd/mm/yyyy'), 0, SYSDATE, 0);
INSERT INTO ZON_PEF_USU (ZON_ID, PEF_ID, USU_ID, ZPU_ID, VERSION, USUARIOCREAR,	FECHACREAR, BORRADO, ZPU_FECHA_EXTRACCION)
	SELECT ZON_ID, PEF_ID, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GE_PCO'), S_ZON_PEF_USU.nextval, 
		0, 'PCOPrueba', SYSDATE, 0, ZPU_FECHA_EXTRACCION FROM ZON_PEF_USU WHERE ZPU_ID=10000000021604;
	
INSERT INTO usd_usuarios_despachos (USD_ID, USU_ID, DES_ID, USD_GESTOR_DEFECTO, USD_SUPERVISOR, USUARIOCREAR, FECHACREAR) 
	VALUES (S_usd_usuarios_despachos.nextval, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GE_PCO'), (SELECT DES_ID FROM DES_DESPACHO_EXTERNO WHERE DES_DESPACHO = 'Gestoria de estudio'), 1, 0, 'PCOPrueba', SYSDATE);


INSERT INTO DES_DESPACHO_EXTERNO (DES_ID, DES_DESPACHO, DD_TDE_ID, USUARIOCREAR, FECHACREAR) 
	VALUES (S_DES_DESPACHO_EXTERNO.NEXTVAL, 'Gestoria de documentacion', (SELECT DD_TDE_ID FROM &master .DD_TDE_TIPO_DESPACHO WHERE DD_TDE_CODIGO = 'CM_GD_PCO'), 'PCOPrueba', SYSDATE);

INSERT INTO &master .usu_usuarios (USU_ID,ENTIDAD_ID,USU_USERNAME,USU_PASSWORD,USU_NOMBRE,USU_APELLIDO1,USU_APELLIDO2,USU_TELEFONO,
  		USU_MAIL,VERSION,USUARIOCREAR,FECHACREAR,BORRADO,USU_EXTERNO,USU_FECHA_VIGENCIA_PASS,USU_GRUPO,USU_FECHA_EXTRACCION,USU_BAJA_LDAP)
	VALUES (&master .s_usu_usuarios.nextval, 1, 'CM_GD_PCO', '1234', 'CM_GD_PCO', 'CM_GD_PCO', 'CM_GD_PCO', '111111111', 
		'my@email.com', 0, 'PCOPrueba', SYSDATE, 0, 1, TO_DATE('01/01/2017', 'dd/mm/yyyy'), 0, SYSDATE, 0);
INSERT INTO ZON_PEF_USU (ZON_ID, PEF_ID, USU_ID, ZPU_ID, VERSION, USUARIOCREAR,	FECHACREAR, BORRADO, ZPU_FECHA_EXTRACCION)
	SELECT ZON_ID, PEF_ID, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GD_PCO'), S_ZON_PEF_USU.nextval, 
		0, 'PCOPrueba', SYSDATE, 0, ZPU_FECHA_EXTRACCION FROM ZON_PEF_USU WHERE ZPU_ID=10000000021604;
	
INSERT INTO usd_usuarios_despachos (USD_ID, USU_ID, DES_ID, USD_GESTOR_DEFECTO, USD_SUPERVISOR, USUARIOCREAR, FECHACREAR) 
	VALUES (S_usd_usuarios_despachos.nextval, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GD_PCO'), (SELECT DES_ID FROM DES_DESPACHO_EXTERNO WHERE DES_DESPACHO = 'Gestoria de documentacion'), 1, 0, 'PCOPrueba', SYSDATE);

	
INSERT INTO DES_DESPACHO_EXTERNO (DES_ID, DES_DESPACHO, DD_TDE_ID, USUARIOCREAR, FECHACREAR) 
	VALUES (S_DES_DESPACHO_EXTERNO.NEXTVAL, 'Gestoria de liquidacion', (SELECT DD_TDE_ID FROM &master .DD_TDE_TIPO_DESPACHO WHERE DD_TDE_CODIGO = 'CM_GL_PCO'), 'PCOPrueba', SYSDATE);

INSERT INTO &master .usu_usuarios (USU_ID,ENTIDAD_ID,USU_USERNAME,USU_PASSWORD,USU_NOMBRE,USU_APELLIDO1,USU_APELLIDO2,USU_TELEFONO,
  		USU_MAIL,VERSION,USUARIOCREAR,FECHACREAR,BORRADO,USU_EXTERNO,USU_FECHA_VIGENCIA_PASS,USU_GRUPO,USU_FECHA_EXTRACCION,USU_BAJA_LDAP)
	VALUES (&master .s_usu_usuarios.nextval, 1, 'CM_GL_PCO', '1234', 'CM_GL_PCO', 'CM_GL_PCO', 'CM_GL_PCO', '111111111', 
		'my@email.com', 0, 'PCOPrueba', SYSDATE, 0, 1, TO_DATE('01/01/2017', 'dd/mm/yyyy'), 0, SYSDATE, 0);
INSERT INTO ZON_PEF_USU (ZON_ID, PEF_ID, USU_ID, ZPU_ID, VERSION, USUARIOCREAR,	FECHACREAR, BORRADO, ZPU_FECHA_EXTRACCION)
	SELECT ZON_ID, PEF_ID, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GL_PCO'), S_ZON_PEF_USU.nextval, 
		0, 'PCOPrueba', SYSDATE, 0, ZPU_FECHA_EXTRACCION FROM ZON_PEF_USU WHERE ZPU_ID=10000000021604;
	
INSERT INTO usd_usuarios_despachos (USD_ID, USU_ID, DES_ID, USD_GESTOR_DEFECTO, USD_SUPERVISOR, USUARIOCREAR, FECHACREAR) 
	VALUES (S_usd_usuarios_despachos.nextval, (SELECT USU_ID FROM &master .usu_usuarios WHERE USU_USERNAME='CM_GL_PCO'), (SELECT DES_ID FROM DES_DESPACHO_EXTERNO WHERE DES_DESPACHO = 'Gestoria de liquidacion'), 1, 0, 'PCOPrueba', SYSDATE);
