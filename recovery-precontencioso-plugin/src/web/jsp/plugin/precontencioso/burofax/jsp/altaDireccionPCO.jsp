...
<fwk:page>
	...
	<pfsforms:ddCombo name="tipoVia"
		labelKey="rec-web.direccion.form.tipoVia" 
 		label="**Tipo V�a" value="" dd="${tiposVia}" 
		propertyCodigo="id" propertyDescripcion="descripcion" />
	...
	<pfsforms:textfield name="numero"
			labelKey="rec-web.direccion.form.numero" label="**N�mero"
	...
	btnGuardar.on('click', function(){
		if (provincia.getValue() == '') {
			...
			Ext.Msg.alert('Error', '<s:message code="rec-web.direccion.validacion.tipoViaObligatoria" text="**El tipo de v�a es obligatorio." />');
			tipoVia.focus();
		} else {
					    ...
					    failure: function(form, action) {
					        ...
					        switch (action.failureType) {
					            ...
					            case Ext.form.Action.CONNECT_FAILURE:
					                Ext.Msg.alert('Error', '<s:message code="rec-web.direccion.validacion.errorComunicacion" text="**Error de comunicaci�n" />');
					                break;
					       }
						}
