...
var expedienteCorrectoNO = '<fwk:const value="es.capgemini.pfs.procesosJudiciales.model.DDSiNo.NO" />';

var motivo_asignacion = items[2];
var expediente_correcto = items[3];

expediente_correcto.on('select', function() {
	if(expediente_correcto.getValue() == expedienteCorrectoNO) {
		motivo_asignacion.allowBlank = false;
	}else{
		motivo_asignacion.allowBlank = true;
	}
});
