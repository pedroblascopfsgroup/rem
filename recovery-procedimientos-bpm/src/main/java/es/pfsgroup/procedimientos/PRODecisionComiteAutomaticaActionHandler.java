...
public class PRODecisionComiteAutomaticaActionHandler extends PROBaseActionHandler
	...
	public void run(ExecutionContext executionContext) throws Exception {
		...
		Arquetipo a = (Arquetipo) executor.execute(
				...
				idArquetipo);
		Estado estadoDC = a.getItinerario().getEstado(
				DDEstadoItinerario.ESTADO_DECISION_COMIT);

		// Estado estadoDC =
		// arquetipoManager.getWithEstado(idArquetipo).getItinerario().getEstado(DDEstadoItinerario.ESTADO_DECISION_COMIT);
