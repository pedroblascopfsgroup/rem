 ...
 *
 */
public class PRODevolverADecisionActionHandler extends PROBaseActionHandler implements ExpedienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        logger.debug("---------ENTRE EN DevolverADecisionActionHandler---------");
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Vuelvo al estado del expediente a DC");
        }
