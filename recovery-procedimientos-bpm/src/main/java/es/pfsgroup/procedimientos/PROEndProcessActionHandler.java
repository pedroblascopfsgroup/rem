...
public class PROEndProcessActionHandler extends PROBaseActionHandler {
	...
	protected String getGuidTAROrigen(ExecutionContext executionContext) {
        ...
        if (hasVariable(AsuntoPayload.JBPM_TAR_GUID_ORIGEN, executionContext)) {
        	guidTARorigen = (String)getVariable(AsuntoPayload.JBPM_TAR_GUID_ORIGEN, executionContext);
        }
