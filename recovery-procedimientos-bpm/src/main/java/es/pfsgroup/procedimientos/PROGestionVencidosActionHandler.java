 ...
 */
@Component
public class PROGestionVencidosActionHandler extends PROBaseActionHandler implements ClienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        ...
        cliente = proxyFactory.proxy(ClienteApi.class).getWithEstado(clienteId);
