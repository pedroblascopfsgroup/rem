 ...
 *
 */
public class PROEnviarAEnSancionDeudaActionHandler extends PROBaseActionHandler implements ExpedienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        logger.debug("---------ENTRE EN EnviarAEnSancionDeudaActionHandler---------");
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Cambio el estado del expediente a ENSAN");
        }
