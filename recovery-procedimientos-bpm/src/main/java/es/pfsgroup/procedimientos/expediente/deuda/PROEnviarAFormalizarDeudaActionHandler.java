 ...
 *
 */
public class PROEnviarAFormalizarDeudaActionHandler extends PROBaseActionHandler implements ExpedienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        logger.debug("---------ENTRE EN EnviarAFormalizarPropuestaDeudaActionHandler---------");
