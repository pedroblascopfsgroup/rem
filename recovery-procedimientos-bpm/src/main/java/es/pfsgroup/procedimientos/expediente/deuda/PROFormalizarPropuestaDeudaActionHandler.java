 ...
 *
 */
public class PROFormalizarPropuestaDeudaActionHandler extends PROBaseActionHandler implements ExpedienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("FormalizarPropuestaDeudaActionHandler......");
        }
        ...
        if (!GENERAR_NOTIFICACION.equals(comeFrom) && !SOLICITAR_PRORROGA_EXTRA.equals(comeFrom)) {
            ...
            Long plazoRestante = calcularTiempoRestante(idExpediente, estadoCE.getPlazo() + estadoRE.getPlazo() + estadoEnSan.getPlazo() + estadoSan.getPlazo() + estadoFP.getPlazo(), fechaFin);
