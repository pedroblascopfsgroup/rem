 ...
 *
 */
public class PRORevisionExpedienteDeudaActionHandler extends PROBaseActionHandler implements ExpedienteBPMConstants {
    ...
    public void run(ExecutionContext executionContext) throws Exception {
        if (logger.isDebugEnabled()) {
            logger.debug("RevisionExpedienteDeudaActionHandler......");
        }
        ...
        if (!GENERAR_NOTIFICACION.equals(comeFrom) && !SOLICITAR_PRORROGA_EXTRA.equals(comeFrom)) {
            ...
            if (!DEVOLVER_REVISION.equals(comeFrom) && estadoRE.getAutomatico() != null && estadoRE.getAutomatico()) {
                ...
                executionContext.setVariable(WHERE_TO_GO, TRANSITION_ENVIARAENSANCION);
            } else {
                executionContext.setVariable(GENERAALERTA, Boolean.TRUE);
