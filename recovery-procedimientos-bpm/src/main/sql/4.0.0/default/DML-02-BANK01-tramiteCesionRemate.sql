...
--## Finalidad: Tramite Cesión Remate (P410)
--## INSTRUCCIONES:  Tramite Cesión Remate (P410)
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      ...
      T_TIPO_TPO('P410','T. de cesión de remate','T. de cesión de remate',null,'tramiteCesionRemateV4','0','DD','0','AP',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
        T_TIPO_TAP('P410','P410_AperturaPlazo',null,null,null,'( valores[''P410_AperturaPlazo''][''comboFinaliza''] == DDSiNo.SI ? ''SI'':''NO'')',null,'0','Apertura plazo cesión de remate','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
        T_TIPO_TAP('P410','P410_BPMTramiteAdjudicacion',null,null,null,null,'P413','0','Trámite de Adjudicación','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
        T_TIPO_TAP('P410','P410_RealizacionCesionRemate',null,null,null,'( valores[''P410_RealizacionCesionRemate''][''comboTitularizado''] == DDSiNo.SI ? ''SI'':''NO'')',null,'0','Realización de la cesión de remate','0','DD','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
        T_TIPO_TAP('P410','P410_ResenyarFechaComparecencia',null,null,null,null,null,'0','Reseñar fecha de comparecencia','0','DD','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null)
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      T_TIPO_PLAZAS(null,null,'P410_AperturaPlazo','damePlazo(valoresBPMPadre[''P401_SenyalamientoSubasta''][''fechaSenyalamiento''])+5*24*60*60*1000L','0','0','DD'),
      T_TIPO_PLAZAS(null,null,'P410_ResenyarFechaComparecencia','damePlazo(valores[''P410_AperturaPlazo''][''fecha'']) + 20*24*60*60*1000L','0','0','DD'),
      T_TIPO_PLAZAS(null,null,'P410_RealizacionCesionRemate','damePlazo(valores[''P410_ResenyarFechaComparecencia''][''fecha'']) + 5*24*60*60*1000L','0','0','DD'),
      T_TIPO_PLAZAS(null,null,'P410_BPMTramiteAdjudicacion','300*24*60*60*1000L','0','0','DD')
    ); 
