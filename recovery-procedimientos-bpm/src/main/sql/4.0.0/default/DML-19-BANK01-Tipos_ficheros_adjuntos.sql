...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('ESRAS', 'Edicto de subasta y resol. acord. señ.', 'Edicto de subasta y resolución acordando señalamiento', 'AP'),
      T_TIPO_TFA('INS', 'informe de subasta', 'informe de subasta','AP'),
      T_TIPO_TFA('PRI', 'Propuesta de instrucciones', 'Propuesta de instrucciones', 'AP'),
      T_TIPO_TFA('ACS', 'Acta de subasta', 'Acta de subasta', 'AP'),
      T_TIPO_TFA('DUEDIL', 'DUE-DILIGENCE', 'DUE-DILIGENCE', 'AP'),
      T_TIPO_TFA('PSSB', 'Plantilla subasta SAREB', 'Plantilla subasta SAREB', 'AP'),
      T_TIPO_TFA('FSSF', 'Front-sheet SAREB', 'Front-sheet SAREB', 'AP'),
      T_TIPO_TFA('FSSB', 'Ficha suelo SAREB', 'Ficha suelo SAREB', 'AP'),
      T_TIPO_TFA('TAB', 'Tasación asociada a cada bien', 'Tasación asociada a cada bien', 'AP'),
      T_TIPO_TFA('RCT', 'Respuesta a la consulta de tributación', 'Respuesta a la consulta de tributación', 'AP'),
      T_TIPO_TFA('DFA', 'Decreto firme de adjudicación', 'Decreto firme de adjudicación', 'AP'),
      T_TIPO_TFA('LII', 'Liquidación de impuestos', 'Liquidación de impuestos', 'AP'),
      T_TIPO_TFA('TIRNR', 'Test. inscrito en el reg. y nota registral', 'Testimonio inscrito en el registro y nota registral', 'AP'),
      T_TIPO_TFA('DJP', 'Diligencia judicial de la posesión', 'Diligencia judicial de la posesión', 'AP' ),
      T_TIPO_TFA('DJL', 'Diligencia judicial del lanzamiento', 'Diligencia judicial del lanzamiento', 'AP' ),
      T_TIPO_TFA('PCC', 'Propuesta de cancel. de las cargas', 'Propuesta de cancelación de las cargas', 'AP'),
      T_TIPO_TFA('EDCINR', 'Escritura o doc. cancel. inscrito y nota registral', 'Escritura o documento cancelacion inscrito y nota registral', 'AP'),
      T_TIPO_TFA('ISP', 'Informe de situación de la posesión', 'Informe de situación de la posesión', 'AP'),      
      T_TIPO_TFA('LIC', 'Liquidación de contrato', 'Liquidación de contrato', 'CO'),
      T_TIPO_TFA('ESC', 'Escritura', 'Escritura', 'CO'),
      T_TIPO_TFA('CON', 'Contrato', 'Contrato', 'CO'),
      T_TIPO_TFA('POL', 'Póliza', 'Póliza', 'CO'),
      T_TIPO_TFA('EXT', 'Extracto', 'Extracto', 'CO'),      
      T_TIPO_TFA('DSCC', 'Dem. sellada + certif. cargas', 'Demanda sellada + certificación de cargas (cuando se obtenga)', 'EJ'),
      T_TIPO_TFA('DSO', 'Demanda sellada', 'Demanda sellada', 'DE'),      
      T_TIPO_TFA('ESI', 'Escrito de insinuación', 'Escrito de insinuación', 'CO')
    ); 
