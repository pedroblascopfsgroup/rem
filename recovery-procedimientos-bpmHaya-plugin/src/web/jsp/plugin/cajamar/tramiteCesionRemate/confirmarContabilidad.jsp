...
items[2 + offset].setDisabled(true);
items[3 + offset].setDisabled(true);
items[4 + offset].setDisabled(true);
items[5 + offset].setDisabled(true);
items[6 + offset].setDisabled(true);
items[7 + offset].setDisabled(true);
items[8 + offset].setDisabled(true);
items[9 + offset].setDisabled(true);
items[10 + offset].setDisabled(true);
items[11 + offset].setDisabled(true);
items[12 + offset].setDisabled(true);
items[13 + offset].setDisabled(true);
items[14 + offset].setDisabled(true);
items[15 + offset].setDisabled(true);
items[16 + offset].setDisabled(true);
items[17 + offset].setDisabled(true);
