...
var comboAlquilerFormalizado = items[1 + offset];
var comboPosibleFormalizacion = items[2 + offset];
var fechaFormalizacion = items[3 + offset];

comboPosibleFormalizacion.setDisabled(true);
fechaFormalizacion.setDisabled(true);

comboAlquilerFormalizado.on('select', function(){
	...
	if(comboAlquilerFormalizado.getValue() == '01') {//si
		...
		fechaFormalizacion.setDisabled(false);
		fechaFormalizacion.allowBlank = false;
	}
	else if(comboAlquilerFormalizado.getValue() == '02') {//no
		comboPosibleFormalizacion.setDisabled(false);
		comboPosibleFormalizacion.allowBlank = false;
		fechaFormalizacion.setDisabled(true);
		fechaFormalizacion.allowBlank = true;
	}
});
