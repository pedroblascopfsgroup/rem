...
var comboConflicto = items[2 + offset];
var comboAceptacion = items[3 + offset];
var observaciones = items[4 + offset];
principal.setDisabled(true);
if(comboConflicto.value!=''){
	comboConflicto.setReadOnly(true);
}
if(comboAceptacion.value!=''){
	comboAceptacion.setReadOnly(true);
}
