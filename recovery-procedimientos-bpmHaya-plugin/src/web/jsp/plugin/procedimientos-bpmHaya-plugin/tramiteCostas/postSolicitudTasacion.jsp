...
var fecha = items[1+muestraBotonGuardar];
var resultado = items[2+muestraBotonGuardar];
var aprobada = items[3+muestraBotonGuardar];
var cuantiaLetrado = items[4+muestraBotonGuardar];
var cuantiaProcurador = items[5+muestraBotonGuardar];

cuantiaLetrado.setReadOnly(true);
cuantiaProcurador.setReadOnly(true);
fecha.setReadOnly(true);
resultado.setReadOnly(true);
aprobada.setReadOnly(true);
