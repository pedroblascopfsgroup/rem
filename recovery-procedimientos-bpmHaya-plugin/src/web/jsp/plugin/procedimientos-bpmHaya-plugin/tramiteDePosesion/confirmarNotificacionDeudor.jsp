...
var fechaNotificacion = items[2 + offset];

fechaNotificacion.setDisabled(true);

comboNotificado.on('select', function(){
	//Borramos todos los combos dependientes ante cualquier cambio
	fechaNotificacion.setValue('');
	
	if(comboNotificado.getValue() == '01') {//si
		fechaNotificacion.setDisabled(false);
		fechaNotificacion.allowBlank = false;
	}
	else if(comboNotificado.getValue() == '02') {//no
		fechaNotificacion.setDisabled(true);
		fechaNotificacion.allowBlank = true;
	}
});
