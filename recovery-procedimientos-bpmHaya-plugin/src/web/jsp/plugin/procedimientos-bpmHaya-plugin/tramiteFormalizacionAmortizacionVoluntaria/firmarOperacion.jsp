...
var cb_comboFormalizadaOp = items[1 + muestraBotonGuardar];
var cb_fechaRealFirma = items[3 + muestraBotonGuardar];


cb_fechaRealFirma.setDisabled(true);
cb_fechaRealFirma.allowBlank = true;


cb_comboFormalizadaOp.on('select', function(){
	if(cb_comboFormalizadaOp.getValue() == '01') {//si
		cb_fechaRealFirma.setDisabled(false);
		cb_fechaRealFirma.setValue('');
		cb_fechaRealFirma.allowBlank = false;
	}
	else if(cb_comboFormalizadaOp.getValue() == '02') {//no
		cb_fechaRealFirma.setDisabled(true);
		cb_fechaRealFirma.allowBlank = true;
	}
});
