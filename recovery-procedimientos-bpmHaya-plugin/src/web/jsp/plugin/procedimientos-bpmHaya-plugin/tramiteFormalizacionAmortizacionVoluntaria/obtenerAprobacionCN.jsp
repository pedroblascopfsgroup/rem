...
var cb_comboObtencAprob = items[2 + muestraBotonGuardar];
var cb_comboRevCorrecta = items[3 + muestraBotonGuardar];


cb_comboRevCorrecta.setDisabled(true);
cb_comboRevCorrecta.allowBlank = true;


cb_comboObtencAprob.on('select', function(){
	if(cb_comboObtencAprob.getValue() == '01') {//si
		cb_comboRevCorrecta.setDisabled(false);
		cb_comboRevCorrecta.setValue('');
		cb_comboRevCorrecta.allowBlank = false;
	}
	else if(cb_comboObtencAprob.getValue() == '02') {//no
		cb_comboRevCorrecta.setDisabled(true);
		cb_comboRevCorrecta.allowBlank = true;
	}
});
