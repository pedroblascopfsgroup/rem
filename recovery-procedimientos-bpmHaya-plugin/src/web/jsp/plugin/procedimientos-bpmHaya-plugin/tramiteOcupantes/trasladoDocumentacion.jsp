...
var fecha_vista = items[7 + muestraBotonGuardar];
var fecha_alegaciones = items[8 + muestraBotonGuardar];

fecha_vista.on('blur', function(){	
	fecha_alegaciones.setDisabled(false);
	if(fecha_vista.getValue() != '') {
		fecha_alegaciones.setDisabled(true);
	}
});

fecha_alegaciones.on('blur', function(){	
	fecha_vista.setDisabled(false);
	if(fecha_alegaciones.getValue() != '') {
