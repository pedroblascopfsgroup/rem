...
var cb_otorgamientoDeEscritura = items[5 + muestraBotonGuardar];
var cb_decisionSuspension = items[6 + muestraBotonGuardar];
var cb_motivo = items[7 + muestraBotonGuardar];
...
cb_subastaCelebrada.on('select', function(){
	...
	cb_otorgamientoDeEscritura.setValue('');
	...
	if(cb_subastaCelebrada.getValue() == '01') {//si
		...
		cb_otorgamientoDeEscritura.setDisabled(false);
		...
		cb_otorgamientoDeEscritura.setDisabled(true);
