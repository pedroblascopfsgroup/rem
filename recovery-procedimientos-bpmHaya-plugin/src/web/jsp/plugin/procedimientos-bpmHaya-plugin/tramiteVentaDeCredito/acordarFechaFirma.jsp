...
var campo1 = items[1 + muestraBotonGuardar]; //aprobacion
var campo2 = items[2 + muestraBotonGuardar]; //resolucion con acreditado
var campo3 = items[3 + muestraBotonGuardar]; //accion del rechazo
var campo4 = items[4 + muestraBotonGuardar]; //fecha prevista
var campo5 = items[5 + muestraBotonGuardar]; //firma en notaria
var campo6 = items[6 + muestraBotonGuardar]; //notario
var campo7 = items[7 + muestraBotonGuardar]; //asistencia a firma

campo2.setDisabled(true);
campo3.setDisabled(true);
campo4.setDisabled(true);
campo7.setDisabled(true);
...
campo2.on('select', function(){	
	if(campo2.getValue() == 'REC') {//rechazada
	...
	else if(campo2.getValue() == 'ACE') {//aceptada
		campo3.reset();
		campo3.setDisabled(true);
		campo4.setDisabled(false);
		campo7.setDisabled(false);
