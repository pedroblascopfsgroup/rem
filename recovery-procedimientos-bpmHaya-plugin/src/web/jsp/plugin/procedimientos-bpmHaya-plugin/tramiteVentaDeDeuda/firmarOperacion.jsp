...
var campo1 = items[1 + muestraBotonGuardar]; //formalizada
var campo2 = items[2 + muestraBotonGuardar]; //fecha prevista
var campo3 = items[3 + muestraBotonGuardar]; //fecha real
var campo4 = items[4 + muestraBotonGuardar]; //fecha fin

campo1.on('select', function(){	
	if(campo1.getValue() == '01') {//si
		campo3.setDisabled(false);
		campo4.setDisabled(false);
	}
	else if(campo1.getValue() == '02') {//no
		campo3.reset();
		campo4.reset();
