...
public class AdjudicacionCajamarLeaveActionHandler extends AdjudicacionHayaLeaveActionHandler {
	...
	protected void setDecisionVariable(ExecutionContext executionContext) {
		...
		if (executionContext
				.getNode()
				.getName()
				.equals("CJ105_notificacionDecretoAdjudicacionAEntidad")) {
			...
			this.setVariable("op_requieComAdicional", (opE ? "SI" : "NO"), executionContext);
				...
				.getNode()
				.getName()
				.equals("CJ105_ConfirmarTestimonio")) {
