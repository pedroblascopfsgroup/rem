...
public class CesionRemateCajamarLeaveActionHandler extends PROGenericLeaveActionHandler {
	...
	private void personalizamosTramiteCesionRemate(
		...
		if ("CJ106_ConfirmarContabilidad".equals(executionContext
				.getNode().getName())) {
	...
	protected void setDecisionVariable(ExecutionContext executionContext) {
		...
		if (executionContext
				.getNode()
				.getName()
				.equals("CJ106_RealizacionCesionRemate")) {
