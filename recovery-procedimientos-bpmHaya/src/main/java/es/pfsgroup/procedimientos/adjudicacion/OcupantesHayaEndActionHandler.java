...
public class OcupantesHayaEndActionHandler extends PROEndProcessActionHandler {

	private static final String RESULTADO_FAVORABLE = "favorable";
	private static final String RESULTADO_DESFAVORABLE = "desfavorable";
            ...
            if (proxyFactory.proxy(JBPMProcessApi.class).hasTransitionToken(idToken, transitionName)) {
        		...
        		processManager.execute(new JbpmCallback() {
        			...
        			public Object doInJbpm(JbpmContext context) {
        				...
        				if (executionContext.getVariable("H048_ResolucionFirmeDecision") != null) {
        					value = executionContext.getVariable("H048_ResolucionFirmeDecision").toString();
        				} 
