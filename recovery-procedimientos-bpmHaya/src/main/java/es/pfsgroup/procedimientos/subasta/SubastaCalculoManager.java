...
public class SubastaCalculoManager {
	...
	private final String TPO_SUBASTA_SAREB = "H002";
	private final String TPO_SUBASTA_CONCURSAL = "H003";
	private final String TPO_SUBASTA_TERCEROS = "H004";
	private final String TPO_EJECUCION_NOTARIAL = "H036";
	private final String TAP_CELEBRACION_SUBASTA_SAREB = "H002_CelebracionSubasta";
	private final String TAP_CELEBRACION_SUBASTA_CONCURSAL = "H003_CelebracionSubasta";
	private final String TAP_CELEBRACION_SUBASTA_TERCEROS = "H004_CelebracionSubasta";
	private final String TAP_CELEBRACION_SUBASTA_NOTARIAL = "H036_CelebracionSubasta";
	private final String TAP_SENYALAMIENTO_SUBASTA_SAREB = "H002_SenyalamientoSubasta";
	private final String TAP_SENYALAMIENTO_SUBASTA_CONCURSAL = "H003_SenyalamientoSubasta";
	private final String TAP_SENYALAMIENTO_SUBASTA_TERCEROS = "H004_SenyalamientoSubasta";
	...
	public void crearSubasta(Procedimiento procedimiento) {
		...
		if (!Checks.esNulo(procedimiento.getProcedimientoPadre())) {
			...
			if (TPO_SUBASTA_SAREB.equals(prcPadre.getTipoProcedimiento().getCodigo()) || TPO_SUBASTA_CONCURSAL.equals(prcPadre.getTipoProcedimiento().getCodigo()) || TPO_SUBASTA_TERCEROS.equals(prcPadre.getTipoProcedimiento().getCodigo()) || TPO_EJECUCION_NOTARIAL.equals(prcPadre.getTipoProcedimiento().getCodigo())) {
		...
		if (condicion1) {
			...
			for (TareaNotificacion t : tareas) {
				if (TAP_CELEBRACION_SUBASTA_SAREB.equals(t.getCodigo()) || TAP_CELEBRACION_SUBASTA_CONCURSAL.equals(t.getCodigo()) || TAP_CELEBRACION_SUBASTA_TERCEROS.equals(t.getCodigo()) || TAP_CELEBRACION_SUBASTA_NOTARIAL.equals(t.getCodigo())) {
					...
					for (TareaExternaValor tev : valores) {
						if ("comboDecisionSuspension".equals(tev.getNombre())) {
	...
	private float getCostesSubasta(Procedimiento procedimiento) {
		...
		for (TareaNotificacion t : tareas) {
			if (t.getTareaExterna()==null || 
					(!TAP_SENYALAMIENTO_SUBASTA_SAREB.equals(t.getTareaExterna().getTareaProcedimiento().getCodigo()) ) || (!TAP_SENYALAMIENTO_SUBASTA_CONCURSAL.equals(t.getTareaExterna().getTareaProcedimiento().getCodigo()) )
					|| (!TAP_SENYALAMIENTO_SUBASTA_TERCEROS.equals(t.getTareaExterna().getTareaProcedimiento().getCodigo()) )) {
				continue;
			}
			TareaExterna tareaExterna = t.getTareaExterna();
			List<TareaExternaValor> valores = tareaExterna.getValores();
