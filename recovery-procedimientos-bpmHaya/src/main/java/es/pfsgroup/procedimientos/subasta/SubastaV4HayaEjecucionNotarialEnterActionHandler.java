...
public class SubastaV4HayaEjecucionNotarialEnterActionHandler extends PROGenericEnterActionHandler {
...
//		DDTipoReclamacion tipoReclamacion = (DDTipoReclamacion) executor.execute(ComunBusinessOperation.BO_DICTIONARY_GET_BY_CODE, DDTipoReclamacion.class, procPadre.getTipoReclamacion());
	...
	private void crearNotificacionManualAdjudicacion(Procedimiento prc, String nombreTarea) {
		...
		if(!Checks.esNulo(nombreTarea)){
			...
			tex.setTareaProcedimiento(genericDao.get(TareaProcedimiento.class, genericDao.createFilter(FilterType.EQUALS, "codigo", "H036_BPMTramiteAdjudicacion")));
		}
