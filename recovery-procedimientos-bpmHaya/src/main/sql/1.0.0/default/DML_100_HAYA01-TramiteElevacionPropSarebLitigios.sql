...
--## BPM: H012 Trámite Elevacion Propuesta Sareb Litigios
...
DECLARE
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO(
        /*DD_TPO_CODIGO.............::*/ 'H012',
        /*DD_TPO_DESCRIPCION.........:*/ 'T. Elevacion Propuesta Sareb Litigios',
        /*DD_TPO_DESCRIPCION_LARGA...:*/ 'T. de Elevacion de Propuesta a Sareb para Litigios',
        /*DD_TPO_HTML................:*/ null,
        /*DD_TPO_XML_JBPM............:*/ 'haya_tramiteElevacionPropSarebLitigios',
        /*VERSION....................:*/ '0',
        /*USUARIOCREAR...............:*/ 'DD',
        /*BORRADO....................:*/ '0',
        /*DD_TAC_ID..................:*/ 'CO',
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H012',
        /*TAP_CODIGO...................:*/ 'H012_InformarSarebAlegaciones',
        /*TAP_VIEW.....................:*/ null,
        ...
        /*TAP_SUPERVISOR,..............:*/ '0',
        /*TAP_DESCRIPCION,.............:*/ 'Informar alegaciones a Sareb',
        /*VERSION......................:*/ '0',
        /*USUARIOCREAR.................:*/ 'DD',
        /*BORRADO......................:*/ '0',
      ...
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H012',
        /*TAP_CODIGO...................:*/ 'H012_RespuestaSareb',
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H012_InformarSarebAlegaciones',
       ...
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H012_RespuestaSareb',
          /*DD_PTP_PLAZO_SCRIPT......:*/ 'damePlazo(valores[''H012_InformarSarebAlegaciones''][''fecha'']) + 7*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
        )  --Cerrar con ")," si no es la ultima fila. Cerrar con ")" si es ultima fila
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H012_InformarSarebAlegaciones',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea deberá usted informar a SAREB, vía propuesta workflow de que se van a presentar alegaciones al concurso. </p><p style="margin-bottom: 10px">En el campo Fecha deberá indicar la fecha en la que ha elevado la comunicación a SAREB. En el campo Numero Propuesta deberá recoger el número de propuesta workflow.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en este punto del procedimiento.</p></div>',
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H012_RespuestaSareb',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea deberá usted adjuntar desde la pestaña de adjuntos del asunto la respuesta recibida desde SAREB así como notificar vía Notificación interna de Recovery al Gestor de Litigios y Concursos de que se ha recibido la respuesta de SAREB. En el campo Fecha indicar la fecha en la que recibimos la respuesta de SAREB y realiza usted la notificación al Gestor de Litigios y Concursos.</p><p style="margin-bottom: 10px">En el campo observaciones podrá informar cualquier aspecto relevante que le interese quede reflejado en este punto del procedimiento.</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI(
            ...
            /*TFI_ERROR_VALIDACION...:*/ 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio',
            /*TFI_VALIDACION.........:*/ 'valor != null && valor != '''' ? true : false',
            /*TFI_VALOR_INICIAL......:*/ 'valores[''H012_InformarSarebAlegaciones''][''numprop'']',
            /*TFI_BUSINESS_OPERATION.:*/ null,
            /*VERSION................:*/ '0',
            /*USUARIOCREAR...........:*/ 'DD'
        ), --Cerrar con ")," si no es la ultima fila. Cerrar con ")" si es ultima fila

        T_TIPO_TFI('H012_RespuestaSareb','3','combo','comboResultado','Resultado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDResultadoComiteConcursal','0','DD'),
