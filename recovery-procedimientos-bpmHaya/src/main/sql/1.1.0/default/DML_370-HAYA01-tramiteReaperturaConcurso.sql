...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('H043',  'P. reapertura de concurso',  'P. reapertura de concurso',  '', 'haya_tramiteReaperturaConcurso',  '0',  'DD', '0',  'CO', '', '', '1',  'MEJTipoProcedimiento', '1',  '0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP('H043',  'H043_registrarOposicion',  '', '', '( (valores[''H043_registrarOposicion''][''comboOposicion''] == DDSiNo.SI) && ((valores[''H043_registrarOposicion''][''fechaOposicion''] == null) || (valores[''H043_registrarOposicion''][''fechaVista''] == null)) ) ? ''tareaExterna.error.faltaAlgunaFecha'':null', 'valores[''H043_registrarOposicion''][''comboOposicion''] == DDSiNo.SI ? ''SI'' : (valores[''H043_registrarOposicion''][''comboOposicion''] == DDSiNo.NO ? ''NO'':''ALLANAMIENTO'')', '', '0',  'Registrar oposición',  '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_SolicitudConcursal',  '', '!asuntoConProcurador() ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><p>¡Atenci&oacute;n! Para dar por terminada esta tarea debe registrar el procurador que representa a la entidad en la ficha del asunto correspondiente.</p></div>'' : null',  '', '', '', '0',  'Presentar solicitud reapertura concurso',  '0',  'DD', '0',  '', '', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_ResolucionFirme', '', '', '', 'valores[''H043_RegistrarResolucion''][''comboResultado''] == DDFavorable.FAVORABLE ? ''Favorable'' : ''Desfavorable''',  '', '0',  'Resolución firme', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_RegistrarVista',  '', '', '', '', '', '0',  'Registrar vista',  '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_RegistrarResolucion', '', '', '', '', '', '0',  'Registrar resolución', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_ConfirmarNotificacionDemandado',  '', '', '', '', '', '0',  'Confirmar notificación al concursado', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_ConfirmarAdmision', 'plugin/procedimientos/tramiteReaperturaConcurso/confirmarAdmision',  '', '', '', '', '0',  'Confirmar admisión', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_BPMtramiteFaseComunOrdinario',  '', '', '', '', 'H045', '0',  'Ejecución del Trámite fase común ordinario', '0',  'DD', '0',  '', '', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_BPMtramiteFaseComunAbreviado',  '', '', '', '', 'H009', '0',  'Ejecución del Trámite fase común abreviado', '0',  'DD', '0',  '', '', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_AutoDeclarandoConcurso',  '', '', '', 'valores[''H043_AutoDeclarandoConcurso''][''comboEligeTramite''] == DDAccionAuto.ORDINARIO ? ''NO'' : ''SI''',  '', '0',  'Auto declarando reapertura de concurso', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'GUCL', ''),
      T_TIPO_TAP('H043',  'H043_InformarSareb', '', '', '', '', '', '0',  'Informar a Sareb', '0',  'DD', '0',  '', 'tareaExterna.cancelarTarea', '', '0',  'EXTTareaProcedimiento',  '3',  '', '39', '', 'SUCL', '')
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      ...
      T_TIPO_PLAZAS('', '', 'H043_InformarSareb', 'damePlazo(valores[''H043_RegistrarResolucion''][''fecha'']) + 2*24*60*60*1000L', '0',  '0',  'DD'),
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
      ...
      T_TIPO_TFI('H043_InformarSareb', '0',  'label',  'titulo', '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea deberá informar la fecha en la que comunica a Sareb la Resolución, ya sea vía workflow a enviadno una comunicación de tipo correo electrónico desde la herramienta.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',  '', '', '', '', '0',  'DD'),
      T_TIPO_TFI('H043_InformarSareb', '1',  'date', 'fecha',  'Fecha',  'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio',  'valor != null && valor != '''' ? true : false',  '', '', '0',  'DD'),
      T_TIPO_TFI('H043_InformarSareb', '2',  'textarea', 'observaciones',  'Observaciones',  '', 'valor != null && valor != '''' ? true : false',  '', '', '0',  'DD'),
