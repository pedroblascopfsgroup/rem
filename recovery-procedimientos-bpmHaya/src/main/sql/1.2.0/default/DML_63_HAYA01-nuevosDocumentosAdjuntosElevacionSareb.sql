...
--##########################################
--## Author: Gonzalo
--## Finalidad: DML para crear los nuevos tipos de documentos adjuntos del T. Elevación Sareb
...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('RSPCCA', 'Resp. Sareb Propuesta Cancelación Cargas', 'Respuesta Sareb sobre Propuesta Cancelación Cargas', 'CO'),
      T_TIPO_TFA('RSFSCO', 'Resp. Sareb Fase Común', 'Respuesta Sareb sobre Fase Común', 'CO'),
      T_TIPO_TFA('RSPRAL', 'Resp. Sareb Presentación Alegaciones', 'Respuesta Sareb sobre Presentación de Alegaciones', 'CO'),
      T_TIPO_TFA('RSINFC', 'Resp. Sareb Instrucciones Fase Convenio', 'Respuesta Sareb con Instrucciones sobre Fase Convenio', 'CO'),
      T_TIPO_TFA('RSCOPR', 'Resp. Sareb Convenio Propio', 'Respuesta Sareb sobre Convenio Propio', 'CO'),
      T_TIPO_TFA('RSISDI', 'Resp. Sareb Instrucciones Demanda Incidental', 'Respuesta Sareb con Instrucciones sobre Demanda Incidental', 'CO'),
      T_TIPO_TFA('RSIPAC', 'Resp. Sareb Instrucciones Propuesta Anticipada Convenio', 'Respuesta Sareb con Instrucciones sobre Propuesta Anticipada Convenio', 'CO'),
      T_TIPO_TFA('RSPPAL', 'Resp. Sareb Propuesta Alegaciones', 'Respuesta Sareb sobre Propuesta de Alegaciones', 'CO'),
      T_TIPO_TFA('RSANSU', 'Resp. Sareb Anuncio Subasta', 'Respuesta Sareb sobre Anuncio de la Subasta', 'CO'),
      T_TIPO_TFA('RSINPA', 'Resp. Sareb Instrucciones Propuesta Acuerdo', 'Respuesta Sareb con Instrucciones sobre la Propuesta de Acuerdo', 'CO')      
    ); 
