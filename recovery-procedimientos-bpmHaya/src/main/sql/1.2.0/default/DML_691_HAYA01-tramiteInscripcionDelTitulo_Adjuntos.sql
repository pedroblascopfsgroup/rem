...
DECLARE
    ...
    T_TIPO_TFA('MINUTA', 'Minuta (Inscripción Título)', 'Minuta (Inscripción Título)', 'EX'),
    T_TIPO_TFA('RECIGEST', 'Recibí de Gestoría (Inscripción Título)', 'Recibí de Gestoría (Inscripción Título)', 'EX'),  
    T_TIPO_TFA('COAPH', 'Copia de la autoliquidación presentada en Hacienda (Inscripción Título)', 'Copia de la autoliquidación presentada en Hacienda (Inscripción Título)', 'EX')
