...
--##########################################
--## Author: Gonzalo
--## Finalidad: DML para crear los nuevos tipos de documentos adjuntos del T. Tributación de Bienes Sareb
...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('INFFIS', 'Informe Fiscal (Tributación de Bienes Sareb)', 'Informe Fiscal (Tributación de Bienes Sareb)', 'CO'),
      T_TIPO_TFA('EJUZTBS', 'Escrito presentado al Juzgado (Tributación de Bienes Sareb)', 'Escrito presentado al Juzgado (Tributación de Bienes Sareb)', 'CO')      
    ); 
