...
--######################################################################
--## Author: Roberto
--## Tarea: http://link.pfsgroup.es/jira/browse/HR-422 - T. Fase Convenio - Tarea 2 permite guardar sin rellenar
...
BEGIN
	...
	V_MSQL := 'update tfi_tareas_form_items'
				...
				|| '       and tap_id=(select tap_id from tap_tarea_procedimiento where tap_codigo=''H017_revisarEjecucionesParalizadas'')';
