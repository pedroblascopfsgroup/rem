...
--##########################################
--## Author: Nacho
--## Finalidad: DML para crear nuevos tipos de documentos adjuntos del Trámite de Ejecución Notarial
...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      T_TIPO_TFA('MINEN', 'Minuta (T. Ejecución Notarial o Extrajudicial)', 'Minuta (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('MPEN', 'Mandamiento de Pago (T. Ejecución Notarial o Extrajudicial)', 'Mandamiento de Pago (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('RSIEN', 'Resultado servicio índices (T. Ejecución Notarial o Extrajudicial)', 'Resultado servicio índices (T. Ejecución Notarial o Extrajudicial)', 'EX'),
      T_TIPO_TFA('RSARINE', 'Respuesta Sareb índices (T. Ejecución Notarial o Extrajudicial)', 'Respuesta Sareb índices (T. Ejecución Notarial o Extrajudicial)', 'EX')
    ); 
