...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(  
      T_TIPO_TFA('DDULI','DTOR_ULI','1234','NOMBRE_PRUEBA','Gestoría Director Unidad de Litigios'),      
      T_TIPO_TFA('DSULI','SUPER_ULI','1234','NOMBRE_PRUEBA','Gestoría Supervisor Unidad de Litigios'),
      T_TIPO_TFA('DGULI','GEST_ULI','1234','NOMBRE_PRUEBA','Gestoría Gestor Unidad de Litigios'),
      T_TIPO_TFA('DDULI','D_ULI_V','1234','NOMBRE_PRUEBA_V','Gestoría Director Unidad de Litigios'),      
      T_TIPO_TFA('DSULI','S_ULI_V','1234','NOMBRE_PRUEBA_V','Gestoría Supervisor Unidad de Litigios'),
      T_TIPO_TFA('DGULI','G_ULI_V','1234','NOMBRE_PRUEBA_V','Gestoría Gestor Unidad de Litigios'),
      T_TIPO_TFA('DDULI','D_ULI_H','1234','NOMBRE_PRUEBA_H','Gestoría Director Unidad de Litigios'),      
      T_TIPO_TFA('DSULI','S_ULI_H','1234','NOMBRE_PRUEBA_H','Gestoría Supervisor Unidad de Litigios'),
      T_TIPO_TFA('DGULI','G_ULI_H','1234','NOMBRE_PRUEBA_H','Gestoría Gestor Unidad de Litigios')
    ); 
