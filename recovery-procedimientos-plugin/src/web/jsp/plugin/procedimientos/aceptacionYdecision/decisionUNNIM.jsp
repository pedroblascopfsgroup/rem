...
<c:forEach items="${form.items}" var="item">
	...
	<c:if test="${item.nombre=='tipoProcPropuesto'}">
		...
		<c:if test="${item.value=='P56'}">
			values = {"diccionario":[{"codigo":"P56","descripcion":"T. fase común abreviado"}]};
		</c:if>
...
var tipoProcedimientoOriginal = items[2 + offset];
