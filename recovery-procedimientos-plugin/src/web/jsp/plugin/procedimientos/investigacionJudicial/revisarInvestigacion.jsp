...
resultado.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboRegistro']}");
agencia.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboAgTribut']}");
seguridad.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboSegSocial']}");
catastro.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboCatastro']}");
ayuntamiento.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboAyto']}");
otros.setValue("${valores['P20_RegistrarResultadoInvestigacion']['comboOtros']}");
solvencia.setValue("${valores['P20_RegistrarResultadoInvestigacion']['solvencia']}");
impuestos.setValue("${valores['P20_RegistrarResultadoInvestigacion']['impuestos']}");
