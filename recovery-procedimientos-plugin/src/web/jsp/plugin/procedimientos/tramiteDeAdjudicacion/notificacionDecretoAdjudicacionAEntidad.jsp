...
var cb_entidad = items[2 + offset];
var cb_fondo = items[3 + offset];

cb_entidad.on('select', function(){

	//Borramos todos los combos dependientes ante cualquier cambio
	cb_fondo.setValue('');
	if(cb_entidad.getValue() == '2') {//si
		cb_fondo.setDisabled(false);
	} else {//no
		cb_fondo.setDisabled(true);
	}
});
