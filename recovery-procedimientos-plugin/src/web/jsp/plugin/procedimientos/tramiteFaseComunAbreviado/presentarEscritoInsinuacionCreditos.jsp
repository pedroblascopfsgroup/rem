...
var totalCredMasa= items[2 + offset];
var totalCredPrivEsp = items[3 + offset];
var totalCredPrivGen = items[4 + offset];
var totalCredOrdi = items[5 + offset];
var totalCredSub = items[6 + offset];
var totalCredCont = items[7 + offset];
var totalCred = items[8 + offset];

totalCredMasa.setDisabled(true);
totalCredPrivEsp.setDisabled(true);
totalCredPrivGen.setDisabled(true);
totalCredOrdi.setDisabled(true);
totalCredSub.setDisabled(true);
totalCredCont.setDisabled(true);
totalCred.setDisabled(true);
