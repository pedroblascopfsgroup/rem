			...
			,items:[{
					...
					,items:[items[0 + offset],
					{
						...
						,items:[
							{border:false
							,items:[
								{layout:'form', border:false, items: [items[1 + offset]]}
								,{layout:'form', border:false, items: [items[2 + offset]]}
								,{layout:'form', border:false, items: [items[3 + offset]]}
								,{layout:'form', border:false, items: [items[4 + offset]]}
								,{layout:'form', border:false, items: [items[5 + offset]]}
								,{layout:'form', border:false, items: [items[6 + offset]]}
								//,{layout:'form', border:false, items: [items[17 + offset]]}
								,{layout:'form', border:false, items: [items[21 + offset]]}
								,{layout:'form', border:false, items: [items[13 + offset]]}
								,{layout:'form', border:false, items: [items[14 + offset]]}
							]}
							,{border:false
							 ,items:[
								{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[7 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[8 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[9 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[18 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[10 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[11 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[12 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[19 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[13 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[14 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[15 + offset]]}
								,{layout:'form', border:false, bodyStyle:'margin-left:45px', items: [items[20 + offset]]}
							]}
						]
					}, items[16 + offset]
				  ]
