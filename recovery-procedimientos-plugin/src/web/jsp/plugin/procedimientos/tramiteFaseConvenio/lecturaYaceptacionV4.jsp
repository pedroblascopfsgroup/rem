...
//instruccionesSup.setDisabled(true);
//observacionesSup.setDisabled(true);
*/

var instrucciones = items[2 + offset];
instrucciones.setValue("${valores['P408_registrarResultadoComite']['propuestaInstrucciones']}")
