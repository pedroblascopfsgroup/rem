...
var cb_adjudicacion = items[2 + muestraBotonGuardar];

//Deshabilitamos Motivo suspension
items[3 + muestraBotonGuardar].setDisabled(true);
	
cb_adjudicacion.on('select', function(){
	//reseteamos Motivo suspensión ante cualquier cambio
	items[3 + muestraBotonGuardar].reset();
		
	if(cb_adjudicacion.getValue() == '04'){
		items[3 + muestraBotonGuardar].setDisabled(false);
	}
	else{
		items[3 + muestraBotonGuardar].setDisabled(true);
	}
