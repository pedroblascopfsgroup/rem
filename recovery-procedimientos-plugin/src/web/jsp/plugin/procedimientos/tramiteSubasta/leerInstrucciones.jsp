...
var costasLetrado = items[2 + offset];
var costasProcurador = items[3 + offset];
var intereses = items[4 + offset];
var limitePostores = items[5 + offset];
var intSinPostores = items[6 + offset];
var importe = items[7 + offset];

principal.setDisabled(true);
costasLetrado.setDisabled(true);
costasProcurador.setDisabled(true);
intereses.setDisabled(true);
limitePostores.setDisabled(true);
intSinPostores.setDisabled(true);
