...
'valores[''P06_ResultadoDomicilio''][''comboNotificacion''] == DDImpugnacion2.NOTIF_POSITIVA ? ''NotificacionPositiva'' :(valores[''P06_ResultadoDomicilio''][''comboNotificacion''] == DDImpugnacion2.AV_POSITIVA ? ''AveriguacionPositiva'' : ''NotificacionAveriguacionNegativa'')', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P06_ResultadoDomicilio'), 3, 'date', 'fecha', 'Fecha', 'valor != null &&'||' valor != '''' ? true : false', 'tareaExterna.error.P06_NotificacionAveriguacionDomicilio.fechaObligatoria', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
...
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P06'), 'P06_ResultadoEdicto', 0, 'Registrar resultado notificación', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
