...
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P09', 'Trámite de Embargo de Salarios', 'Trámite de Embargo de Salarios', '', 'tramiteEmbargoSalarios', 0, 'DD', SYSDATE, 0);
...
Insert INTO DD_TPO_TIPO_PROCEDIMIENTO(DD_TPO_ID, DD_TPO_CODIGO, DD_TPO_DESCRIPCION, DD_TPO_DESCRIPCION_LARGA, DD_TPO_HTML, DD_TPO_XML_JBPM, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values (S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P16', 'Procedimiento Ejecución de Título Judicial', 'Procedimiento Ejecución de Título Judicial', '', 'ejecucionTituloJudicial', 0, 'DD', SYSDATE, 0);
...
Insert into DD_TPO_TIPO_PROCEDIMIENTO(DD_TPO_ID, DD_TPO_CODIGO, DD_TPO_DESCRIPCION, DD_TPO_DESCRIPCION_LARGA, DD_TPO_HTML, DD_TPO_XML_JBPM, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P14', 'Trámite de mejora de embargo', 'Trámite de mejora de embargo', '', 'tramiteMejoraEmbargo', 0, 'DD', SYSDATE, 0);
...
Insert into DD_TPO_TIPO_PROCEDIMIENTO(DD_TPO_ID, DD_TPO_CODIGO, DD_TPO_DESCRIPCION, DD_TPO_DESCRIPCION_LARGA, DD_TPO_HTML, DD_TPO_XML_JBPM, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P15', 'Procedimiento ejecución de título no judicial', 'Procedimiento ejecución de título no judicial', '', 'procedimientoEjecucionTituloNoJudicial', 0, 'DD', SYSDATE, 0);
...
Insert into DD_TPO_TIPO_PROCEDIMIENTO(DD_TPO_ID, DD_TPO_CODIGO, DD_TPO_DESCRIPCION, DD_TPO_DESCRIPCION_LARGA, DD_TPO_HTML, DD_TPO_XML_JBPM, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P22', 'Contratos bloqueados', 'Contratos bloqueados', '', 'procedimientoContratosBloqueado', 0, 'DD', SYSDATE, 0);

-- Actuación Amistosa
Insert into DD_TPO_TIPO_PROCEDIMIENTO(DD_TPO_ID, DD_TPO_CODIGO, DD_TPO_DESCRIPCION, DD_TPO_DESCRIPCION_LARGA, DD_TPO_HTML, DD_TPO_XML_JBPM, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P23', 'Actuación Amistosa', 'Actuación Amistosa', '', 'procedimientoActuacionAmistosa', 0, 'DD', SYSDATE, 0);
