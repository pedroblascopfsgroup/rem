...
BEGIN
	...
	execute immediate 'update '||V_ESQUEMA||'.tap_tarea_procedimiento set tap_script_decision = ''decidirPrepararPropuestaSubasta()'' where tap_codigo = ''P409_PrepararPropuestaSubasta''';
