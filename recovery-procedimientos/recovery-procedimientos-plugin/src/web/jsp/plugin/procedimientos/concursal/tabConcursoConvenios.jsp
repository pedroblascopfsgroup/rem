...
(function(){
	...
	<pfs:remoteStore name="conveniosDS" resultRootVar="convenios" recordType="Convenio" dataFlow="plugin/procedimientos/concursal/listadoConveniosData" parameters="params" autoload="true"/>
