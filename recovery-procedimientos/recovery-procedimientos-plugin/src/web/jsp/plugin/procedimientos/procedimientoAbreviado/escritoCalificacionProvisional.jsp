				...
				,items:[items[0 + offset],
						{ layout:'table'
						 ...
						 ,items:[{ layout:'form'
								 	...
								 	,border:false
								 	,width: 312
								 	,bodyStyle:'font-size: 8pt; font-family: Arial; height:150px; line-height:22px;'
									,items:[ 
										{ html:"<b> Ministerio fiscal </b>", border:false, bodyStyle:'font-size: 8pt; font-family: Arial; line-height:18px;'},
										items[1 + offset], 
										items[2 + offset], 
										items[3 + offset] 
									 ]
								 ...
								 { layout:'form'
								 	...
								 	,bodyStyle:'font-size: 8pt; font-family: Arial; height:150px; line-height:22px; '
									,items:[
										{ html:"<b> Acusaci&oacute;n particular </b>", border:false, bodyStyle:'font-size: 8pt; font-family: Arial; line-height:18px;'},
										items[4 + offset], 
										items[5 + offset], 
										items[6 + offset]
								]}
