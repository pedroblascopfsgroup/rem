...
//CODIGO ESPECIFICO DE LA TAREA

var comboCelebrada = items[1];
var fechaSubasta = items[2];
var comboEntidad = items[3];
var comboTercero = items[4];

fechaSubasta.setReadOnly(true);
comboEntidad.setDisabled(true);
comboTercero.setDisabled(true);
	
comboCelebrada.on('select',function(){

	comboEntidad.reset();
	comboTercero.reset();
	
	if(comboCelebrada.getValue()=='01'){
		comboEntidad.setDisabled(false);
		comboTercero.setDisabled(false);
	}
	else{
		comboEntidad.setDisabled(true);
		comboTercero.setDisabled(true);
...
comboEntidad.on('select', function(){
	comboTercero.reset();
	if(comboEntidad.getValue()=='01'){
		comboTercero.setDisabled(true);
	}
	else{
		comboTercero.setDisabled(false);
