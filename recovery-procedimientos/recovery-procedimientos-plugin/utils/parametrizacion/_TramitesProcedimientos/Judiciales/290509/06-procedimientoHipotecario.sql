...
'pfsgroup/procedimientoHipotecario/autoDespachandoEjecucion', 'valores[''P01_AutoDespachandoEjecucion''][''comboResultado''] == DDSiNo.SI ? ''SI'' : ''NO''', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P01_AutoDespachandoEjecucion'), 4, 'textproc', 'numProcedimiento', 'Nº de procedimiento', 'valor != null &&'||' valor != '''' ? true : false', 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_BUSINESS_OPERATION, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
...
'((valores[''P01_ConfirmarNotificacionReqPago''][''comboResultado''] == DDPositivoNegativo.POSITIVO) &&'||' (valores[''P01_ConfirmarNotificacionReqPago''][''fecha''] == ''''))?''tareaExterna.error.PGENERICO_ConfirmarNotificacion.fechaOblgatoria'':null', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
'((valores[''P01_ConfirmarSiExisteOposicion''][''comboResultado''] == DDSiNo.SI) &&'||' ((valores[''P01_ConfirmarSiExisteOposicion''][''fechaOposicion''] == '''') || (valores[''P01_ConfirmarSiExisteOposicion''][''fechaComparecencia''] == '''')))?''tareaExterna.error.P01_ConfirmarSiExisteOposicion.fechasOblgatorias'':null', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P01'), 'P01_RegistrarComparecencia', 0, 'Registrar comparecencia', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Insert into TAP_TAREA_PROCEDIMIENTO(TAP_ID, DD_TPO_ID, TAP_CODIGO, TAP_SUPERVISOR, TAP_DESCRIPCION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO, TAP_ALERT_VUELTA_ATRAS)
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P01'), 'P01_RegistrarResolucion', 0, 'Registrar resolución', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Insert into TAP_TAREA_PROCEDIMIENTO(TAP_ID, DD_TPO_ID, TAP_CODIGO, TAP_SUPERVISOR, TAP_DESCRIPCION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO, TAP_ALERT_VUELTA_ATRAS)
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P01'), 'P01_ResolucionFirme', 0, 'Resolución firme', 0, 'DD', SYSDATE, 0, 'tareaExterna.cancelarTarea');
...
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P01'), 'P01_BPMTramiteSubasta', (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P11'), 0, 'Ejecución del Trámite de subastas', 0, 'DD', SYSDATE, 0);
...
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P01_BPMTramiteSubasta'), 0, 'label', 'titulo', 'Ejecución del Trámite de subastas', 0, 'DD', SYSDATE, 0);

--Pantalla 9 ESPECIAL INVOCAR A UN NUEVO TRAMITE / PROCEDIMIENTO
Insert into TAP_TAREA_PROCEDIMIENTO(TAP_ID, DD_TPO_ID, TAP_CODIGO, DD_TPO_ID_BPM, TAP_SUPERVISOR, TAP_DESCRIPCION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P01'), 'P01_BPMTramiteNotificacion', (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P06'), 0, 'Ejecución del Trámite de notificación', 0, 'DD', SYSDATE, 0);
...
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P01_BPMTramiteNotificacion'), 0, 'label', 'titulo', 'Ejecución del Trámite de notificación', 0, 'DD', SYSDATE, 0);
