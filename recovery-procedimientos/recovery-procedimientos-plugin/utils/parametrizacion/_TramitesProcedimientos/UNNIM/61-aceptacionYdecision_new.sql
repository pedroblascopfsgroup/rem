...
Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P61', 'T. de aceptación y decisión', 'T. de aceptación y decisión', '', 'aceptacionYdecision', 0, 'DD', SYSDATE, 0, (select DD_TAC_ID from DD_TAC_TIPO_ACTUACION where DD_TAC_CODIGO ='03') );
...
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P61'), 'P61_registrarAceptacion', 0, 'Registrar aceptación de asunto',
...
--NUEVO RegistrarDecisioinProcedimiento_UNNIM
ALTER TABLE UN001.TAP_TAREA_PROCEDIMIENTO
MODIFY(TAP_SCRIPT_DECISION VARCHAR2(1100 CHAR));

Insert into TAP_TAREA_PROCEDIMIENTO(TAP_ID, DD_TPO_ID, TAP_CODIGO, TAP_SUPERVISOR, TAP_DESCRIPCION, TAP_SCRIPT_DECISION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO, TAP_VIEW, DTYPE, DD_FAP_ID, TAP_ALERT_VUELTA_ATRAS)
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P61'), 'P61_registrarDecisionProcedimiento_UNNIM', 0, 'Registrar toma de decisión',
'((valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento'']==valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcPropuesto''])||(valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcPropuesto'']==''''))?((valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento''] == ''P01'') ? ''hipotecario'' : (
 ...
 (valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento''] == ''P04'')?''verbal'': null)))))))):''No''', 0, 'DD', SYSDATE, 0, 
'plugin/procedimientos/aceptacionYdecision/decisionUNNIM', 'EXTTareaProcedimiento', (select DD_FAP_ID from DD_FAP_FASE_PROCESAL where DD_FAP_CODIGO='09'), 'tareaExterna.cancelarTarea');

Insert into DD_PTP_PLAZOS_TAREAS_PLAZAS(DD_PTP_ID, TAP_ID, DD_PTP_PLAZO_SCRIPT, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_PTP_PLAZOS_TAREAS_PLAZAS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), '3*24*60*60*1000L', 0, 'DD', SYSDATE, 0);

Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), 0, 'label', 'titulo', '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla deber&'||'aacute; consignar la fecha en la que recibe la documentaci&'||'oacute;n completa y correcta del expediente en cuesti&'||'oacute;n, en caso de que la documentaci&'||'oacute;n recibida este incompleta o contenga errores a corregir por parte de la entidad, deber&'||'aacute; enviar una comunicaci&'||'oacute;n al supervisor a trav&'||'eacute;s del bot&'||'oacute;n "Comucicaci&'||'oacute;n" de la ficha del procedimiento, es muy importante que no termine esta tarea hasta que no tenga la documentaci&'||'oacute;n completa del expediente.</p><p style="margin-bottom: 10px">En el campo "Procedimiento propuesto  por el comit&'||'eacute;" se le indica el tipo de procedimiento propuesto por el comit&'||'eacute;. En caso de estar de acuerdo con dicha propuesta de actuaci&'||'oacute;n, deber&'||'aacute; consignar en el campo "Procedimiento a inciar" el mismo tipo de procedimiento, en caso contrario, deber&'||'aacute; seleccionar otro procedimiento seg&'||'uacute;n su criterio, el cual ser&'||'aacute; propuesto al supervisor asignado a este asunto.</p><p style="margin-bottom: 10px">En el campo observaciones consignar cualquier aspecto relevante que le interesa quede reflejado en este punto.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, en caso de haber seleccionado el mismo tipo de procedimiento que el comit&'||'eacute; se inciar&'||'aacute; dicho procedimiento, en caso de haber seleccionado un procedimiento distinto al propuesto por el comit&'||'eacute;, se iniciar&'||'aacute; una tarea en la que el supervisor deber&'||'aacute; validar el cambio de procedimiento que haya propuesto.</p></div>', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), 1, 'date', 'fecha', 'Fecha recepción documentación completa', 'valor != null &&'||' valor != '''' ? true : false', 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_BUSINESS_OPERATION, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO,TFI_VALOR_INICIAL)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), 2, 'combo', 'tipoProcPropuesto', 'Procedimiento propuesto por el comité', 'TipoProcedimiento', NULL, 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0,'dameTipoProcedimientoOrigianal()');
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_BUSINESS_OPERATION, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), 3, 'combo', 'tipoProcedimiento', 'Procedimiento a iniciar', 'TipoProcedimiento', 'valor != null &&'||' valor != '''' ? true : false', 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_registrarDecisionProcedimiento_UNNIM'), 4, 'textarea', 'observaciones', 'Observaciones', 0, 'DD', SYSDATE, 0);

--NUEVO validarCambioActuacionDecision
Insert into TAP_TAREA_PROCEDIMIENTO(TAP_ID, DD_TPO_ID, TAP_CODIGO, TAP_SUPERVISOR, TAP_DESCRIPCION, TAP_SCRIPT_DECISION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO, TAP_VIEW, DTYPE, DD_FAP_ID, TAP_ALERT_VUELTA_ATRAS)
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P61'), 'P61_validarCambioActuacion', 1, 'Validar cambio de actuacion',
'(valores[''P61_validarCambioActuacion''][''comboValidacion''] == DDSiNo.SI )? ( 
 ...
 (valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento''] == ''P15'') ? ''etnj'' : (
 (valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento''] == ''P04'') ? ''verbal'' : null)))))))):''No''', 0, 'DD', SYSDATE, 0, 
'plugin/procedimientos/aceptacionYdecision/validacionTipoProcedimientoPropuestoLetrado', 'EXTTareaProcedimiento', (select DD_FAP_ID from DD_FAP_FASE_PROCESAL where DD_FAP_CODIGO='09'), 'tareaExterna.cancelarTarea');

Insert into DD_PTP_PLAZOS_TAREAS_PLAZAS(DD_PTP_ID, TAP_ID, DD_PTP_PLAZO_SCRIPT, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_DD_PTP_PLAZOS_TAREAS_PLAZAS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_validarCambioActuacion'), '3*24*60*60*1000L', 0, 'DD', SYSDATE, 0);

Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_validarCambioActuacion'), 0, 'label', 'titulo', '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea deber&'||'aacute; validar el cambio del tipo de actuaci&'||'oacute;n propuesto por el letrado respecto a la decisi&'||'oacute;n del comit&'||'eacute.<p style="margin-bottom: 10px">En el campo observaciones consignar cualquier aspecto relevante que le interesa quede reflejado en este punto.</p><p style="margin-bottom: 10px">En caso de validar el cambio de actuaci&'||'oacute;n se iniciar&'||'aacute; la actuaci&'||'oacute;n seleccionada, en caso contrario se lanzar&'||'aacute; de nuevo la tarea "Registrar decisi&'||'oacute;n" al letrado.</p></div>', 0, 'DD', SYSDATE, 0);
...
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_validarCambioActuacion'), 1, 'combo', 'procPropLetrado', 'Tipo procedimiento propuesto por el letrado', NULL, 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0,'valores[''P61_registrarDecisionProcedimiento_UNNIM''][''tipoProcedimiento'']');
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_BUSINESS_OPERATION, TFI_VALIDACION, TFI_ERROR_VALIDACION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_validarCambioActuacion'), 2,'combo', 'comboValidacion', 'Solicitud aceptada', 'DDSiNo', 'valor != null &&'||' valor != ''''? true : false', 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio', 0, 'DD', SYSDATE, 0);
Insert into TFI_TAREAS_FORM_ITEMS(TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
Values(S_TFI_TAREAS_FORM_ITEMS.nextval, (select TAP_ID from TAP_TAREA_PROCEDIMIENTO where TAP_CODIGO='P61_validarCambioActuacion'), 3, 'textarea', 'observaciones', 'Observaciones', 0, 'DD', SYSDATE, 0);