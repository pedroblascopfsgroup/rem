...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '221', 'R_TR_SOL_TAS_COST', 'Escrito sellado solicitando tasacion de costas y liquidacion de intereses', 'Escrito sellado solicitando tasacion de costas y liquidacion de intereses', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_SOL_TAS_COST'),'P07_SolicitudTasacion', 'NONE', 0, 'MOD_PROC', 
