Insert into BANKMASTER.DD_STA_SUBTIPO_TAREA_BASE
 ...
 Values
   (810, 1, '810', 'Tarea recordatorio', 'Tarea recordatorio', NULL, 0, 'DD', TO_TIMESTAMP('21/05/2015 0:00:00.000000','DD/MM/YYYY fmHH24fm:MI:SS.FF'), NULL, NULL, NULL, NULL, 0, NULL, 'EXTSubtipoTarea');
