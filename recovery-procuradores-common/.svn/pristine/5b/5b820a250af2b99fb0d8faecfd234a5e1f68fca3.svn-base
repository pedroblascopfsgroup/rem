 ...
 * Tareas: P15_RegistrarResolucion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_RSV_OPF'),'P15_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
