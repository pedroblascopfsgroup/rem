 ...
 * Tareas: P03_ConfirmarNotDemanda 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CNF_NOT_DEM'),'P03_ConfirmarNotDemanda', 'NONE', 0, 'MOD_PROC', 
