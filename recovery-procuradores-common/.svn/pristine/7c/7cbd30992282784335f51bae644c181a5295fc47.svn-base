 ...
 * Tareas: P17_RegistrarAnotacionRegistro 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '333', 'R_MAN_ANT_EMB', 'Mandamiento cumplimentario de anotación de embargo','Mandamiento cumplimentario de anotación de embargo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_MAN_ANT_EMB'),'P17_RegistrarAnotacionRegistro', 'NONE', 0, 'MOD_PROC', 
