 ...
 * Tareas: P18_NombramientoDepositario 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '299', 'R_NOMBR_DEP', 'Resolución nombramiento de depositario','Resolución nombramiento de depositario',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PDD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_NOMBR_DEP'),'P18_NombramientoDepositario', 'NONE', 0, 'MOD_PROC', 
