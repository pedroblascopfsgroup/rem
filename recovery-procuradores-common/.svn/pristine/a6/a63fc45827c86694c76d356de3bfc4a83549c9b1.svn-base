...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '276', 'R_RES_FIR_VBL', 'Resolución firme','Resolución firme',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBL')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda resolución firme.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_RES_FIR_VBL','Input resolución firme',
'Input resolución firme', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RES_FIR_VBL'),'P04_ResolucionFirme', 'NONE', 0, 'MOD_PROC', 
