 ...
 * Tareas: P417_RegistrarEnvioLlaves 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '239', 'R_REG_ENV_LLV', 'Comunicación envio llaves', 'Comunicación al letrado que se han enviado las llaves a la entidad', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'GLL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_ENV_LLV'),'P417_RegistrarEnvioLlaves', 'NONE', 0, 'MOD_PROC', 
