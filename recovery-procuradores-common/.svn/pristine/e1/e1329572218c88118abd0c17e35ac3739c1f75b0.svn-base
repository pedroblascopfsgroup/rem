 ...
 * Resolución: Trámite de notificación
 * Tareas: P10_BPMTramiteNotificacion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '235', 'R_TRAM_NOTI', 'Impugnacion tasacion de intereses', 'Diligencia señalando visita impugnacion tasacion de intereses', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda de diligencia señalando visita impugnacion tasacion de intereses.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_TRAM_NOTI','Input diligencia señalando visita impugnacion tasacion de intereses',
'Input diligencia señalando visita impugnacion tasacion de intereses', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TRAM_NOTI'),'P10_BPMTramiteNotificacion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_TRAM_NOTI') 
