 ...
 * Tareas: P418_PresentarConformidadMoratoria 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_PRS_CONF_MOR'),'P418_PresentarConformidadMoratoria', 'NONE', 0, 'MOD_PROC', 
