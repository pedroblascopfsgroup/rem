...
SELECT '201','RESOL_PROCU_PRUEBA_1','Resolución de Prueba 1','Resolución de Prueba 1',
(SELECT DD_TJ_ID FROM DD_TJ_TIPO_JUICIO WHERE DD_TJ_CODIGO = 'MON'),'0','SUPER', sysdate, '0',
'Ayuda de prueba de las resoluciones de procurador.', 
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'INPUT_PROCURADORES_PRUEBA','Input Procuradores Prueba',
...
Values(S_BPM_TPI_TIPO_PROC_INPUT.NEXTVAL, (SELECT DD_TPO_ID FROM DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO='P70'), 
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='INPUT_PROCURADORES_PRUEBA'),'ALL', 'NONE', 0, 'MASIVO', 
...
select S_BPM_IDT_INPUT_DATOS.nextVal, bpm_tpi_id , 'd_fechaPrueba', 'generico', 'fechaPrueba',
0, 'manuel', sysdate, 0 from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input 
where bpm_dd_tin_codigo='INPUT_PROCURADORES_PRUEBA') 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='INPUT_PROCURADORES_PRUEBA') 
and dd_tpo_id=(select dd_tpo_id from dd_tpo_tipo_procedimiento where dd_tpo_codigo='P70');
