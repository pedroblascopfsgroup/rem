...
Insert into FUN_PEF
   (FUN_ID, PEF_ID, FP_ID, VERSION, USUARIOCREAR, 
    ...
    BORRADO)
 Values
   ((select fun_id from BANKMASTER.fun_funciones fun where fun.FUN_DESCRIPCION = 'MANTENIMIENTO_CATEGORIAS'), 10000000000701, S_FUN_PEF.NEXTVAL, 0, 'SUPER_PR', SYSDATE, NULL, NULL, NULL, NULL,0);
...
Insert into FUN_PEF
   (FUN_ID, PEF_ID, FP_ID, VERSION, USUARIOCREAR, 
    ...
    BORRADO)
 Values
   ((select fun_id from BANKMASTER.fun_funciones fun where fun.FUN_DESCRIPCION = 'MENU_PROCURADORES_GENERAL'), 10000000000700, S_FUN_PEF.NEXTVAL, 0, 'SUPER_PR', SYSDATE, NULL, NULL, NULL, NULL,0);
...
Insert into FUN_PEF
   (FUN_ID, PEF_ID, FP_ID, VERSION, USUARIOCREAR, 
    ...
    BORRADO)
 Values
   ((select fun_id from BANKMASTER.fun_funciones fun where fun.FUN_DESCRIPCION = 'MENU_PROCESADO_PROCURADORES'), 10000000000700, S_FUN_PEF.NEXTVAL, 0, 'SUPER_PR', SYSDATE, NULL, NULL, NULL, NULL,0);
...
Insert into FUN_PEF
   (FUN_ID, PEF_ID, FP_ID, VERSION, USUARIOCREAR, 
    ...
    BORRADO)
 Values
   ((select fun_id from BANKMASTER.fun_funciones fun where fun.FUN_DESCRIPCION = 'INITIAL_TAB_RESOL_PROC'), 10000000000700, S_FUN_PEF.NEXTVAL, 0, 'SUPER_PR', SYSDATE, NULL, NULL, NULL, NULL,0);
 ...
 Insert into FUN_PEF
   (FUN_ID, PEF_ID, FP_ID, VERSION, USUARIOCREAR, 
    ...
    BORRADO)
 Values
   ((select fun_id from BANKMASTER.fun_funciones fun where fun.FUN_DESCRIPCION = 'RAMA_TAREAS_PENDIENTES_VALIDAR'), 10000000000700, S_FUN_PEF.NEXTVAL, 0, 'SUPER_PR', SYSDATE, NULL, NULL, NULL, NULL,0);
