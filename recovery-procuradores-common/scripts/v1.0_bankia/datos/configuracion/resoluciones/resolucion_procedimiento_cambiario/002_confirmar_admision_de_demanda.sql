 ...
 * Tareas: P17_CnfAdmiDemaDecretoEmbargo_new1 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '332', 'R_ATO_REQ_PGS', 'Auto requerido de pago y medidas embargo preventivo','Auto requerido de pago y acordado medidas embargo preventivo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda auto requerido de pago y acordado medidas embargo preventivo.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_ATO_REQ_PGS','Input auto requerido de pago y acordado medidas embargo preventivo',
'Input auto requerido de pago y acordado medidas embargo preventivo.', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ATO_REQ_PGS'),'P17_CnfAdmiDemaDecretoEmbargo_new1', 'NONE', 0, 'MOD_PROC', 
