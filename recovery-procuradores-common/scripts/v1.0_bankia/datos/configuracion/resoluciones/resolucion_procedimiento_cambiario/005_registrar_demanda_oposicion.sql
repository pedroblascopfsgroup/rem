 ...
 * Tareas: P17_RegistrarDemandaOposicion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEM_OPS_PCM'),'P17_RegistrarDemandaOposicion', 'NONE', 0, 'MOD_PROC', 
