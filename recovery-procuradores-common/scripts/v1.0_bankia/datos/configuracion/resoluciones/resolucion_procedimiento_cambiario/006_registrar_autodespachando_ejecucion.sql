 ...
 * Tareas: P17_RegistrarAutoEjecucion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_DEJ_PCM'),'P17_RegistrarAutoEjecucion', 'NONE', 0, 'MOD_PROC', 
