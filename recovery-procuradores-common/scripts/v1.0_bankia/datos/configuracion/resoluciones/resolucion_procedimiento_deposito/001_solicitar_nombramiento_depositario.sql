 ...
 * Tareas: P18_SolicitarNombramiento 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESL_SOL_DEP'),'P18_SolicitarNombramiento', 'NONE', 0, 'MOD_PROC', 
