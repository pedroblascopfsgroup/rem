 ...
 * Tareas: P18_AceptacionCargoDepositario 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ACT_ACP_DEP'),'P18_AceptacionCargoDepositario', 'NONE', 0, 'MOD_PROC', 
