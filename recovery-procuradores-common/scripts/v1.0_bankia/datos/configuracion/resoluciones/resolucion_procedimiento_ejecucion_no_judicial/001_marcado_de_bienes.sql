 ...
 * Tareas: P15_InterposicionDemandaMasBienes 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '308', 'R_DEM_SLL_NJD', 'Demanda sellada','Demanda sellada',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEM_SLL_NJD'),'P15_InterposicionDemandaMasBienes', 'NONE', 0, 'MOD_PROC', 
