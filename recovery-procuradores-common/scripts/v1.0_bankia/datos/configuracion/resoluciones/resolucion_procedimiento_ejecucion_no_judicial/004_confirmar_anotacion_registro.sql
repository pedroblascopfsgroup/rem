 ...
 * Tareas: P15_RegistrarAnotacionRegistro 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '311', 'R_CNF_ANT_REG', 'Anotación de embargo en el registro','Mandamiento cumplimentado de anotación de embargo en el registro',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CNF_ANT_REG'),'P15_RegistrarAnotacionRegistro', 'NONE', 0, 'MOD_PROC', 
