 ...
 * Tareas: P15_ConfirmarNotifiReqPago 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '312', 'R_REQ_POS_PNJ', 'Requerimiento','Requerimiento',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REQ_POS_PNJ'),'P15_ConfirmarNotifiReqPago', 'NONE', 0, 'MOD_PROC', 
