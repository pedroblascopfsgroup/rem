 ...
 * Resolución: Registrar celebración vista
 * Tareas: P15_RegistrarCelebracionVista 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '315', 'R_RPT_CLB_VST', 'Reporte celebración de vista','Reporte celebración de vista',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_RPT_CLB_VST','Input reporte celebración de vista',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RPT_CLB_VST'),'P15_RegistrarCelebracionVista', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_RPT_CLB_VST') 
