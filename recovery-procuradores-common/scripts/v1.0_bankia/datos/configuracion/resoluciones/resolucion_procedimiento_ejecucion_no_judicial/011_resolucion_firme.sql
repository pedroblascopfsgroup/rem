...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '318', 'R_NOT_REC_AUT', 'No se recurre auto','No se recurre auto',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_NOT_REC_AUT'),'P15_ResolucionFirme', 'NONE', 0, 'MOD_PROC', 
