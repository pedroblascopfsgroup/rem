 ...
 * Tareas: P02_ConfirmarAdmisionDemanda 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_ADI_DEM'),'P02_ConfirmarAdmisionDemanda', 'NONE', 0, 'MOD_PROC', 
