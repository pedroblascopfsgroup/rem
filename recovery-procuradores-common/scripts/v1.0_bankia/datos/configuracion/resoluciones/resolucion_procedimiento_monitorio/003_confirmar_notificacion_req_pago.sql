 ...
 * Tareas: P02_ConfirmarNotificacionReqPago 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '267', 'R_NOT_REQ_PAG', 'Notificacion requerimiento pago', 'Notificacion requerimiento pago', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MON')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_NOT_REQ_PAG'),'P02_ConfirmarNotificacionReqPago', 'NONE', 0, 'MOD_PROC', 
