 ...
 * Tareas: P02_ConfirmarOposicionCuantia 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '268', 'R_ESC_OP_MON', 'Escrito de oposición monitorio', 'Escrito de oposición monitorio', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MON')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_OP_MON'),'P02_ConfirmarOposicionCuantia', 'NONE', 0, 'MOD_PROC', 
