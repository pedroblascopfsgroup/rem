/**
 * Trámite: P.Monitorio
 * Resolución: Registrar auto despachando ejecucion
 * Tareas: P02_RegAutodespachandoEjecucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '269', 'R_DEC_FIN_MON', 'Decreto fin de monitorio', 'Decreto fin de monitorio', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MON')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda decreto fin de monitorio.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_DEC_FIN_MON','Input decreto fin de monitorio',
'Input decreto fin de monitorio', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_FIN_MON'),'P02_RegAutodespachandoEjecucion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_DEC_FIN_MON') 
