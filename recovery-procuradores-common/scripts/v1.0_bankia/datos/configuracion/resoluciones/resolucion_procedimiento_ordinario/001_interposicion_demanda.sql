 ...
 * Tareas: P03_InterposicionDemanda 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '256', 'R_ORD_DEM_SEL', 'Demanda sellada', 'Demanda sellada', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ORD_DEM_SEL'),'P03_InterposicionDemanda', 'NONE', 0, 'MOD_PROC', 
