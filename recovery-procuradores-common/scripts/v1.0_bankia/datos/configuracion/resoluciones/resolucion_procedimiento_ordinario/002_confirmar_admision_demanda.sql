...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '257', 'R_DEC_ADM_DEM', 'Decreto de admision de demanda', 'Decreto de admision de demanda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_ADM_DEM'),'P03_ConfirmarAdmision', 'NONE', 0, 'MOD_PROC', 
