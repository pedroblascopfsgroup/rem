 ...
 * Tareas: P03_RegistrarAudienciaPrevia 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '260', 'R_ACT_AUD_PRV', 'Acta audiencia previa', 'Acta audiencia previa', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
Values(S_BPM_TPI_TIPO_PROC_INPUT.NEXTVAL, (SELECT DD_TPO_ID FROM DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO='P03'), 
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ACT_AUD_PRV'),'P03_RegistrarAudienciaPrevia', 'NONE', 0, 'MOD_PROC', 
...
and dd_tpo_id=(select dd_tpo_id from dd_tpo_tipo_procedimiento where dd_tpo_codigo='P03');
