...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '264', 'R_RES_FIRM', 'Decreto de firmeza', 'Decreto de firmeza', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RES_FIRM'),'P03_ResolucionFirme', 'NONE', 0, 'MOD_PROC', 
