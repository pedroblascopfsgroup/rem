 ...
 * Tareas: P16_AutoDespachando_new1 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '320', 'R_AUT_DSP_PJU', 'Auto despachando ejecución según demanda','Auto despachando ejecución según demanda',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_AUT_DSP_PJU','Input auto despachando ejecución según demanda',
'Input auto despachando ejecución según demanda.', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_DSP_PJU'),'P16_AutoDespachando_new1', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_AUT_DSP_PJU') 
