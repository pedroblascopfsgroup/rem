...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '321', 'R_AUT_DSP_DAB', 'Auto despachando ejecución declarando clausulas abusivas','Auto despachando ejecución declarando clausulas abusivas',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_DSP_DAB'),'P16_AutoDespachando_new1', 'NONE', 0, 'MOD_PROC', 
