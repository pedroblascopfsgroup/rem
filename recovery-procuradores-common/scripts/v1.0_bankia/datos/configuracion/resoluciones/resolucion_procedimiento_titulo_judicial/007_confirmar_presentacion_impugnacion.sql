 ...
 * Tareas: P16_ConfirmarPresentacionImpugnacion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SLL_IMP'),'P16_ConfirmarPresentacionImpugnacion', 'NONE', 0, 'MOD_PROC', 
