...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '326', 'R_HAY_VST', 'Si / No','Si / No',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_HAY_VST'),'P16_HayVista', 'NONE', 0, 'MOD_PROC', 
