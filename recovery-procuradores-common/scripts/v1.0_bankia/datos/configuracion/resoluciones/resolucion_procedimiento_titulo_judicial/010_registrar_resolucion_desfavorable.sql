...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '328', 'R_ATO_RSV_OPF', 'Auto que resuelve oposición desfavorable','Auto que resuelve oposición desfavorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ATO_RSV_OPF'),'P16_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
