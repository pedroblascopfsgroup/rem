 ...
 * Tareas: P16_RegistrarResolucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '329', 'R_ATO_RSV_OPD', 'Auto que resuelve oposición favorable','Auto que resuelve oposición favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_ATO_RSV_OPD','Input auto que resuelve oposición favorable',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ATO_RSV_OPD'),'P16_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_ATO_RSV_OPD') 
