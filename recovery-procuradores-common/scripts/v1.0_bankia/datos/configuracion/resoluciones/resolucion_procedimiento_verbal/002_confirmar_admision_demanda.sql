/**
 * Trámite: P.VERBAL
 * Resolución: Confirmar admisión de demanda
 * Tareas: P04_ConfirmarAdmisionDemanda 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '271', 'R_AD_DEM_VIS', 'Admisión demanda y señalamiento visita','Decreto de admisión de demanda y señalamiento de visita',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBL')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda decreto de admisión de demanda y señalamiento de visita.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_AD_DEM_VIS','Input decreto de admisión de demanda y señalamiento de visita',
'Input decreto de admisión de demanda y señalamiento de visita', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AD_DEM_VIS'),'P04_ConfirmarAdmisionDemanda', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_AD_DEM_VIS') 
