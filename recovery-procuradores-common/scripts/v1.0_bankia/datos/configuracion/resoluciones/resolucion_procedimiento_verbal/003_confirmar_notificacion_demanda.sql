 ...
 * Tareas: P04_ConfirmarNotifiDemanda 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '272', 'R_NOT_PRC_VBL', 'Notificación','Notificación',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_NOT_PRC_VBL'),'P04_ConfirmarNotifiDemanda', 'NONE', 0, 'MOD_PROC', 
