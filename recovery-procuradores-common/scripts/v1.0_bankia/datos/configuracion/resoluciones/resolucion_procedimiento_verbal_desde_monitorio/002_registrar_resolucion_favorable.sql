...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '279', 'R_RES_FAV_VMN', 'Sentencia favorable','Sentencia favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VMN')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RES_FAV_VMN'),'P21_RegistrarJuicioVerbal', 'NONE', 0, 'MOD_PROC', 
