 ...
 * Tareas: P09_SolicitarNotificacion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '286', 'R_SOL_NOT_EMB', 'Decreto acordando embargo salario','Decreto acordando embargo salario',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'EMS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SOL_NOT_EMB'),'P09_SolicitarNotificacion', 'NONE', 0, 'MOD_PROC', 
