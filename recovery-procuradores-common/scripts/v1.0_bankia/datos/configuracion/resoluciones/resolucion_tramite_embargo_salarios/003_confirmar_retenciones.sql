 ...
 * Tareas: P09_ConfirmarRetenciones 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '288', 'R_ACU_ENT_CNT', 'DO Acuerda entrega cantidades retenidas','DO Acuerda entrega cantidades retenidas',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'EMS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ACU_ENT_CNT'),'P09_ConfirmarRetenciones', 'NONE', 0, 'MOD_PROC', 
