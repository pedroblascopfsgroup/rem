 ...
 * Tareas: P14_SolicitudMejoraEmbargo 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '296', 'R_SOL_MEJ_EMB', 'Escrito sellado solicitando mejora embargo','Escrito sellado solicitando mejora embargo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MEM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SOL_MEJ_EMB'),'P14_SolicitudMejoraEmbargo', 'NONE', 0, 'MOD_PROC', 
