...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '290', 'R_SOL_AVL_PER', 'Solicitud avaluo','Escrito sellado solicitando avaluo y se nombra perito tasador',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBI')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_SOL_AVL_PER','Input solicitud avaluo',
'Input solicitud avaluo.', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SOL_AVL_PER'),'P12_SolicitarAvaluo', 'NONE', 0, 'MOD_PROC', 
