...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '291', 'R_OBTE_AVAO', 'Informe pericial','Informe pericial',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBI')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_OBTE_AVAO'),'P12_ObtencionAvaluo', 'NONE', 0, 'MOD_PROC', 
