 ...
 * Tareas: P13_SolicitarJustiprecio 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '294', 'R_SLC_AVL_NOM', 'Solicitud avaluo y nombre perito tasador','Escrito sellado solicitando avaluo y se nombre perito tasador',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBM')
...
Values(S_BPM_TPI_TIPO_PROC_INPUT.NEXTVAL, (SELECT DD_TPO_ID FROM DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO='P13'), 
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SLC_AVL_NOM'),'P13_SolicitarJustiprecio', 'NONE', 0, 'MOD_PROC', 
...
and dd_tpo_id=(select dd_tpo_id from dd_tpo_tipo_procedimiento where dd_tpo_codigo='P13');
