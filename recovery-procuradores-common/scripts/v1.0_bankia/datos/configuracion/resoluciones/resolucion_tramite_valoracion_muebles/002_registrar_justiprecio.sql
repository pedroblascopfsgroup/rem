 ...
 * Tareas: P13_RegistrarJustiprecio 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '295', 'R_DEC_VAL_DEF', 'Decreto determina valoración definitiva','Decreto determina valoración definitiva',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_VAL_DEF'),'P13_RegistrarJustiprecio', 'NONE', 0, 'MOD_PROC', 
