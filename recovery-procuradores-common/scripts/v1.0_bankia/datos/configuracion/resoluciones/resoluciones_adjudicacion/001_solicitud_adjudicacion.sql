 ...
 * Tareas: P413_SolicitudDecretoAdjudicacion
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_ADJ_SOL_ESC'),'P413_SolicitudDecretoAdjudicacion', 'NONE', 0, 'MOD_PROC', 
