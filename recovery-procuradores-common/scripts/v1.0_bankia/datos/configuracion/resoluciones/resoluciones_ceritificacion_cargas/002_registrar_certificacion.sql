 ...
 * Tareas: P08_RegistrarCertificacion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_CERT_CARG'),'P08_RegistrarCertificacion', 'NONE', 0, 'MOD_PROC', 
