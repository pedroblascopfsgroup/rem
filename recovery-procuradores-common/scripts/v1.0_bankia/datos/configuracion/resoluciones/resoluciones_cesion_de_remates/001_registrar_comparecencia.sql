 ...
 * Tareas: P410_ResenyarFechaComparecencia
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '216', 'R_TR_CES_FECH_CES', 'Resolucion acordando fecha de cesion', 'Resolucion acordando fecha de cesion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CES')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_CES_FECH_CES'),'P410_ResenyarFechaComparecencia', 'NONE', 0, 'MOD_PROC', 
...
and dd_tpo_id=(select dd_tpo_id from dd_tpo_tipo_procedimiento where dd_tpo_codigo='P410');
