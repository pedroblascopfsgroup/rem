 ...
 * Tareas: P07_RegistrarCelebracionVista 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '224', 'R_DIL_IMPUG_TAS_COST', 'Diligencia señalando visita impugnación tasación de costas', 'Diligencia señalando visita impugnación tasación de costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DIL_IMPUG_TAS_COST'),'P07_RegistrarCelebracionVista', 'NONE', 0, 'MOD_PROC', 
