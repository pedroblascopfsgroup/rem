...
INSERT INTO bpm_dd_tac_tipo_accion
     ...
     VALUES (54, 'TAREAS', 'Tareas', 'Tareas', 0, 'MOD_PROC', SYSDATE, 0);
...
SELECT '1003','RESOL_ESP_TAREA','Tarea','Tarea',
(SELECT DD_TJ_ID FROM DD_TJ_TIPO_JUICIO WHERE DD_TJ_CODIGO = 'HIP'),'0','MOD_PROC', sysdate, '0',
'Ayuda de resolución de tarea.', 
(SELECT BPM_DD_TAC_ID FROM BPM_DD_TAC_TIPO_ACCION WHERE BPM_DD_TAC_CODIGO='TAREAS') from dual;
