 ...
 * Tareas: P01_RegistrarComparecencia
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_PR_HIP_SENA_VIST'),'P01_RegistrarComparecencia', 'NONE', 0, 'MOD_PROC', 
