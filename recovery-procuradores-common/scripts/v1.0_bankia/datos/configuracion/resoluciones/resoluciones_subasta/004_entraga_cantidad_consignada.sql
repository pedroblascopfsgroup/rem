 ...
 * Tareas: P401_ConfirmarRecepcionMtoPago
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '215', 'R_TR_SUB_CANT_CONS', 'Confirmar recepción mandamiento de pago', 'Confirmar recepción mandamiento de pago', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'SUB')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda confirmar recepción mandamiento de pago.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_TR_SUB_CANT_CONS','Input confirmar recepción mandamiento de pago',
'Input confirmar recepción mandamiento de pago', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_SUB_CANT_CONS'),'P401_ConfirmarRecepcionMtoPago', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_TR_SUB_CANT_CONS') 
