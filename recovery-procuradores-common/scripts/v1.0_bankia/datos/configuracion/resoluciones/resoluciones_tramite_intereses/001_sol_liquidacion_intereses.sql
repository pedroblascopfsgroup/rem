 ...
 * Tareas: P10_SolicitarLiquidacion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SOL_LIQ_INT'),'P10_SolicitarLiquidacion', 'NONE', 0, 'MOD_PROC', 
