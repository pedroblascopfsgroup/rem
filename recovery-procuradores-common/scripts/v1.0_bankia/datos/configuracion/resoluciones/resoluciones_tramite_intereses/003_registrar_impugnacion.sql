 ...
 * Tareas: P10_RegistrarImpugnacion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REGI_IMPUG'),'P10_RegistrarImpugnacion', 'NONE', 0, 'MOD_PROC', 
