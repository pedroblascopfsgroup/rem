 ...
 * Tareas: P10_RegistrarResolucionVista 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_APR_INT'),'P10_RegistrarResolucionVista', 'NONE', 0, 'MOD_PROC', 
