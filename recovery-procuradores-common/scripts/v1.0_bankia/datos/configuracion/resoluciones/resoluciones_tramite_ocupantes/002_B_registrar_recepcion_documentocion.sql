...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '242', 'R_REG_REP_DOC_B', 'Títulos aportados de contrario sin plazo', 'Resolución requiriendo hacer alegaciones a títulos aportados de contrario sin plazo', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_REP_DOC_B'),'P419_RegistrarRecepcionDoc', 'NONE', 0, 'MOD_PROC', 
