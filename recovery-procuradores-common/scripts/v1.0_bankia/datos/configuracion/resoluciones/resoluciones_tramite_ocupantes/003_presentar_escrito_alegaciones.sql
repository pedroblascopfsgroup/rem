 ...
 * Tareas: P419_PresentarEscritoAlegaciones 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '244', 'R_PRS_ESC_ALE', 'Presentar escrito alegaciones', 'Presentar escrito alegaciones', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda presentar escrito alegaciones.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_PRS_ESC_ALE','Input escrito sellado frente a ocupantes de la vivienda',
'Input escrito sellado frente a ocupantes de la vivienda', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_PRS_ESC_ALE'),'P419_PresentarEscritoAlegaciones', 'NONE', 0, 'MOD_PROC', 
