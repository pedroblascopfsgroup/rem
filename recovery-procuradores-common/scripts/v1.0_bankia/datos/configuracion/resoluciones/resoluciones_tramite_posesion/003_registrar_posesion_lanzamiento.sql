 ...
 * Tareas: P416_RegistrarPosesionYLanzamiento 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '253', 'R_REG_POS_LAN', 'Registrar posesión y decision lanzamiento', 'Registrar posesión y decision lanzamiento', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_POS_LAN'),'P416_RegistrarPosesionYLanzamiento', 'NONE', 0, 'MOD_PROC', 
