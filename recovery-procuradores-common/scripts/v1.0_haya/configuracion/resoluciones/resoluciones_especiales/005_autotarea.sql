...
INSERT INTO bpm_dd_tac_tipo_accion
     ...
     VALUES (55, 'AUTOTAREA', 'Autotarea', 'Autotarea', 0, 'MOD_PROC', SYSDATE, 0);
...
SELECT '1004','RESOL_ESP_AUTOTAREA','Autotarea','Autotarea',
...
(SELECT BPM_DD_TAC_ID FROM BPM_DD_TAC_TIPO_ACCION WHERE BPM_DD_TAC_CODIGO='AUTOTAREA') from dual;
