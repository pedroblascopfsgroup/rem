...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '201', 'R_TR_NOTI_ESC_SELL_AVE', 'Escrito sellado solicitando averiguación domiciliaria', 'Escrito sellado solicitando averiguacion domiciliaria', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'NOT')
