...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '201', 'R_TR_NOTI_RES_ACU_AVE', 'Resolución acuerda averiguación domiciliaria.', 'Resolución acuerda averiguación domiciliaria.', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'NOT')
