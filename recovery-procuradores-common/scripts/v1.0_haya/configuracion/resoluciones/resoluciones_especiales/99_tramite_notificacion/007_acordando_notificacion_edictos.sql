...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '201', 'R_TR_NOTI_DO_ACO_NOTI', 'D.O. acordando notificación por edictos', 'D.O. acordando notificación por edictos', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'NOT')
