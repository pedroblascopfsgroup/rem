 ...
 * Resolución: Señalamiento Vista Oposición.
 * Tareas: H001_RegistrarComparecencia
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '207', 'R_PR_HIP_SENA_VIST', 'Señalamiento Vista Oposición', 'Señalamiento Vista Oposición', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'HIP')
          , '0','MOD_PROC', SYSDATE, '0', 'Señalamiento Vista Oposición.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_PR_HIP_SENA_VIST','Input señalamiento vista oposición',
'Input señalamiento vista oposición', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_PR_HIP_SENA_VIST'),'H001_RegistrarComparecencia', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_PR_HIP_SENA_VIST') 
