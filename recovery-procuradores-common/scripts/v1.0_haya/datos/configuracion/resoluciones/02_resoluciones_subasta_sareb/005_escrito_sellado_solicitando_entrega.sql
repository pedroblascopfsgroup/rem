...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '216', 'R_TR_SUB_SAR_ESC_SELL_SOL', 'Escrito sellado solicitando entrega SAREB', 'Escrito sellado solicitando entrega SAREB', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'SBS')
