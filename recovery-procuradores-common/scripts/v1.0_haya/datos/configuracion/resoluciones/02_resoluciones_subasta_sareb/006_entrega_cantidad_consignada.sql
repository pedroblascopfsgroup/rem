 ...
 * Resolución: Entrega de cantidad consignada
 * Tareas: H002_ConfirmarRecepcionMandamientoDePago
 **/
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_TR_SUB_SAR_CANT_CONS','Input confirmar recepción mandamiento de pago SAREB',
'Input confirmar recepción mandamiento de pago SAREB', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_SUB_SAR_CANT_CONS'),'H002_ConfirmarRecepcionMandamientoDePago', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_TR_SUB_SAR_CANT_CONS') 
