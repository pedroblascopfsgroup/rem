...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '223', 'R_TR_CES_FECH_CES', 'Resolucion acordando fecha de cesion', 'Resolucion acordando fecha de cesion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CES')
...
Values(S_BPM_TPI_TIPO_PROC_INPUT.NEXTVAL, (SELECT DD_TPO_ID FROM DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO='P410'), 
