...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '224', 'R_TR_CES_ACT_CES', 'Resolucion acta cesión de remate', 'Resolucion acta cesión de remate', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CES')
