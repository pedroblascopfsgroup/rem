...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '217', 'R_TR_ADJ_SOL_ESC', 'Escrito sellado solicitando adjudicacion', 'Escrito sellado solicitando adjudicacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ADJ')
