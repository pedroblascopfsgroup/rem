 ...
 * Tareas: H005_notificacionDecretoAdjudicacionAEntidad
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '224', 'R_TR_ADJ_DEC_ADJ', 'Decreto adjudicacion', 'Decreto adjudicacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ADJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_ADJ_DEC_ADJ'),'H005_notificacionDecretoAdjudicacionAEntidad', 'NONE', 0, 'MOD_PROC', 
