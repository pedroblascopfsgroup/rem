...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '225', 'R_TR_ADJ_TEST_DEC_ADJ', 'Testimonio de decreto de adjudicacion', 'Testimonio de decreto de adjudicacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ADJ')
