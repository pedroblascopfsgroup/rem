 ...
 * Tareas: H005_ConfirmarTestimonio
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '226', 'R_TR_ADJ_CONF_TEST', 'Confirmar testimonio decreto adjudicacion', 'Confirmar testimonio decreto adjudicacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ADJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TR_ADJ_CONF_TEST'),'H005_ConfirmarTestimonio', 'NONE', 0, 'MOD_PROC', 
