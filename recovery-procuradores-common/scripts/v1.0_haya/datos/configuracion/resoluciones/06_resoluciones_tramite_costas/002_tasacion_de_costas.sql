...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '228', 'R_TAS_COST_JUZG', 'Tasación de costas del juzgado', 'Tasación de costas del juzgado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_TAS_COST_JUZG'),'H007_TasacionCostas', 'NONE', 0, 'MOD_PROC', 
