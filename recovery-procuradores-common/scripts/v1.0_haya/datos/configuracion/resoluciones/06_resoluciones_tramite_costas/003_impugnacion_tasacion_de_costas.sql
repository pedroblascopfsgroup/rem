...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '229', 'R_IMPUG_TAS_COST_JUZG', 'Traslado de contrario impugnando tasación de costas', 'Traslado de contrario impugnando tasación de costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCS')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda de traslado de contrario impugnando tasación de costas.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_IMPUG_TAS_COST_JUZG','Input traslado de contrario impugnando tasación de costas',
'Input traslado de contrario impugnando tasación de costas', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_IMPUG_TAS_COST_JUZG'),'H007_Impugnacion', 'NONE', 0, 'MOD_PROC', 
