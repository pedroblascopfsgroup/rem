 ...
 * Resolución: Registrar celebración visita
 * Tareas: H007_RegistrarCelebracionVista 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '230', 'R_DIL_IMPUG_TAS_COST', 'Diligencia señalando visita impugnación tasación de costas', 'Diligencia señalando visita impugnación tasación de costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCS')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_DIL_IMPUG_TAS_COST','Input diligencia señalando visita impugnación tasación de costas',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DIL_IMPUG_TAS_COST'),'H007_RegistrarCelebracionVista', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_DIL_IMPUG_TAS_COST') 
