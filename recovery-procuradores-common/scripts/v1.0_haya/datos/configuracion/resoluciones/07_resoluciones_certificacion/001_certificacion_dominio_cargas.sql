...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '232', 'R_SOL_CER_CARG', 'Escrito sellado solicitando certificación de cargas', 'Escrito sellado solicitando certificación de cargas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCG')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SOL_CER_CARG'),'H030_SolicitudCertificacion', 'NONE', 0, 'MOD_PROC', 
