...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '235', 'R_REG_INF_CARG', 'Traslado oficio acreedores anteriores', 'Traslado oficio acreedores anteriores', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCG')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_INF_CARG'),'H030_RegistrarInformacionCargasAnt', 'NONE', 0, 'MOD_PROC', 
