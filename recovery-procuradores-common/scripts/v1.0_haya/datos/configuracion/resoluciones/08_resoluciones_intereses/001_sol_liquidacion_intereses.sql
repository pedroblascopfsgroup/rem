...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '232', 'R_SOL_LIQ_INT', 'Solicitar liquidación de intereses', 'Solicitar liquidación de intereses', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
