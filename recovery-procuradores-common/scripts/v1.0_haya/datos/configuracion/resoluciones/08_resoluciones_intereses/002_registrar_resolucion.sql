 ...
 * Tareas: H042_RegistrarResolucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '238', 'R_REGI_RESOL', 'Tasación de intereses del juzgado', 'Tasación de intereses del juzgado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REGI_RESOL'),'H042_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
