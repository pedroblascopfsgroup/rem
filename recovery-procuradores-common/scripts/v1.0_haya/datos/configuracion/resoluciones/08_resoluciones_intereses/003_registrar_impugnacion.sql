...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '234', 'R_REGI_IMPUG', 'Traslado de contrario impugnando tasación de intereses', 'Traslado de contrario impugnando tasación de intereses', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
