...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '240', 'R_REG_VIS_IMP', 'Decreto estimando / desestimando impugnacion', 'Decreto estimando / desestimando impugnacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_VIS_IMP'),'H042_RegistrarVista', 'NONE', 0, 'MOD_PROC', 
