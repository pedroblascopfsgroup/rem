...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '237', 'R_DEC_APR_INT', 'Decreto aprobando tasación de intereses', 'Decreto aprobando tasación de intereses', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INT')
