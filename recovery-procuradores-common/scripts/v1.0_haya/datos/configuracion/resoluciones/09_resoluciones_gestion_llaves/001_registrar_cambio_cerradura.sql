 ...
 * Tareas: H040_RegistrarCambioCerradura 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '242', 'R_REG_CAM_CERR', 'Comunicación cambio cerradura al letrado', 'Comunicación cambio cerradura al letrado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'GLL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_CAM_CERR'),'H040_RegistrarCambioCerradura', 'NONE', 0, 'MOD_PROC', 
