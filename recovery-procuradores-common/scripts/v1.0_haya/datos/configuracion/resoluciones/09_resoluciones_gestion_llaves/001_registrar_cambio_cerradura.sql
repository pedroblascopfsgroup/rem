...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '251', 'R_REG_CAM_CERR', 'Comunicación cambio cerradura al letrado', 'Comunicación cambio cerradura al letrado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'GLL')
