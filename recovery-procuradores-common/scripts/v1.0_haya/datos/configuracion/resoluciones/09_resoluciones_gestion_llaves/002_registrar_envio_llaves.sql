...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '252', 'R_REG_ENV_LLV', 'Comunicación al letrado del envio llaves a la entidad', 'Comunicación al letrado que se han enviado las llaves a la entidad', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'GLL')
