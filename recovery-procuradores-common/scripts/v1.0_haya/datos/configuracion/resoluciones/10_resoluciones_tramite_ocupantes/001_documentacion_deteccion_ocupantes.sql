 ...
 * Tareas: H048_SolicitudRequerimientoDocOcupantes 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '244', 'R_ESC_SOL_OCU', 'Escrito sellado solicitando a ocupantes títulos', 'Escrito sellado solicitando a ocupantes títulos', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SOL_OCU'),'H048_SolicitudRequerimientoDocOcupantes', 'NONE', 0, 'MOD_PROC', 
