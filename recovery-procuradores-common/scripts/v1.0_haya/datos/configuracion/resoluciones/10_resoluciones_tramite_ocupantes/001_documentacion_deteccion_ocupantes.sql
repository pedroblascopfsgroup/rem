...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '253', 'R_ESC_SOL_OCU', 'Escrito sellado solicitando a ocupantes títulos', 'Escrito sellado solicitando a ocupantes títulos', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
