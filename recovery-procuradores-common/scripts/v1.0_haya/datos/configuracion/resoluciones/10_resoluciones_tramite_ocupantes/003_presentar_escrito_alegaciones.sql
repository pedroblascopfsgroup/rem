...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '257', 'R_PRS_ESC_ALE', 'Escrito sellado alegaciones frente a ocupantes de la vivienda', 'Escrito sellado alegaciones frente a ocupantes de la vivienda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
