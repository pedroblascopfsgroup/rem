...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_CONF_VIS','Input señalamiento vista de ocupantes',
'Input señalamiento vista de ocupantes', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CONF_VIS'),'H048_ConfirmarVista', 'NONE', 0, 'MOD_PROC', 
