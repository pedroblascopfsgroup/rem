...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '259', 'R_REG_RES_PER', 'Auto declara derecho ocupantes a permanecer en la vivienda', 'Auto declara derecho ocupantes a permanecer en la vivienda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
