...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '260', 'R_REG_RES_NPR', 'Auto declara ocupante no tiene derecho a permanecer en la vivienda', 'Auto declara ocupante no tiene derecho a permanecer en la vivienda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'OCU')
