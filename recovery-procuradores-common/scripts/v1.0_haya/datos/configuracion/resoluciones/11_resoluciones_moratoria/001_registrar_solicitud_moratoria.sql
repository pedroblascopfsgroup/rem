...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '261', 'R_REG_SOL_MRT', 'Registrar solicitud de moratoria', 'Registrar solicitud de moratoria', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MRL')
