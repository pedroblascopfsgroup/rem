 ...
 * Tareas: H011_RegistrarSolicitudMoratoria 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '252', 'R_REG_SOL_MRT', 'Registrar solicitud de moratoria', 'Registrar solicitud de moratoria', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MRL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_SOL_MRT'),'H011_RegistrarSolicitudMoratoria', 'NONE', 0, 'MOD_PROC', 
