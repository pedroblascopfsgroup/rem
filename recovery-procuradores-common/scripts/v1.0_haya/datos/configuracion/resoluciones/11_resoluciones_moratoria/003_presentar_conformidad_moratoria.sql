...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '249', 'R_PRS_CONF_MOR', 'Presentar conformidad moratoria', 'Presentar conformidad moratoria', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MRL')
