 ...
 * Tareas: H011_RegistrarResolucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '255', 'R_REGST_RESOL', 'Registrar resolución', 'Registrar resolución', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MRL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REGST_RESOL'),'H011_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
