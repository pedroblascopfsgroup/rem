 ...
 * Tareas: H015_RegistrarSolicitudPosesion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '256', 'R_REG_SOL_POS', 'Escrito sellado solicitando posesión', 'Escrito sellado solicitando posesión', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_SOL_POS'),'H015_RegistrarSolicitudPosesion', 'NONE', 0, 'MOD_PROC', 
