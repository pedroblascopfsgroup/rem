...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '265', 'R_REG_SOL_POS', 'Escrito sellado solicitando posesión', 'Escrito sellado solicitando posesión', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
