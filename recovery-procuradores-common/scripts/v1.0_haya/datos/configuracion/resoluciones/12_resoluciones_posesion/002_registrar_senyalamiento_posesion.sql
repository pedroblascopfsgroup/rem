...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '266', 'R_REG_SENY_POS', 'Registrar señalamiento posesión', 'Registrar señalamiento posesión', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
