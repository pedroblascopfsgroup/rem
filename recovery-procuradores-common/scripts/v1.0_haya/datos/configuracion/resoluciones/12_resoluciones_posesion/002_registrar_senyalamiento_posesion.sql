 ...
 * Tareas: H015_RegistrarSenyalamientoPosesion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '257', 'R_REG_SENY_POS', 'Registrar señalamiento posesión', 'Registrar señalamiento posesión', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_SENY_POS'),'H015_RegistrarSenyalamientoPosesion', 'NONE', 0, 'MOD_PROC', 
