...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '267', 'R_REG_POS_LAN', 'Registrar posesión y decision lanzamiento', 'Registrar posesión y decision lanzamiento', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
