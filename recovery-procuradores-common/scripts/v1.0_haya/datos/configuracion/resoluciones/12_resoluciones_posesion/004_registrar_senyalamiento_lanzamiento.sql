...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '254', 'R_REG_SNY_LAN', 'Registrar señalamiento lanzamiento', 'Registrar señalamiento lanzamiento', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
