...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '269', 'R_REG_LAN_EFC', 'Registrar lanzamiento efectuado', 'Registrar lanzamiento efectuado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
