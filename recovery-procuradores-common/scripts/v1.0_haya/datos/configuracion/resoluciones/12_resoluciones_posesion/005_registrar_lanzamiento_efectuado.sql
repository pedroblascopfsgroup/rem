 ...
 * Tareas: H015_RegistrarLanzamientoEfectuado 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '260', 'R_REG_LAN_EFC', 'Registrar lanzamiento efectuado', 'Registrar lanzamiento efectuado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'POS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_LAN_EFC'),'H015_RegistrarLanzamientoEfectuado', 'NONE', 0, 'MOD_PROC', 
