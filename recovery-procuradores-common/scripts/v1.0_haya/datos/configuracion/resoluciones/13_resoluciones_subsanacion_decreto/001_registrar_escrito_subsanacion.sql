...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '270', 'R_REG_PRS_ESB', 'Escrito sellado solicitando subsanación decreto adjudicación', 'Escrito sellado solicitando subsanación decreto adjudicación', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'SDA')
