...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '271', 'R_ETR_NVO_DCTO', 'Decreto de adjudicacion/testimonio subsanado', 'Decreto de adjudicacion/testimonio subsanado', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'SDA')
