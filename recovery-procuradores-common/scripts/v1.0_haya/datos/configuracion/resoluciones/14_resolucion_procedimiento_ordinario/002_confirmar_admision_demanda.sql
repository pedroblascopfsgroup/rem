/**
 * Trámite: P.Ordinario
 * Resolución: Confirmar admision demanda
 * Tareas: H024_ConfirmarAdmision 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '264', 'R_DEC_ADM_DEM', 'Decreto de admision de demanda', 'Decreto de admision de demanda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_DEC_ADM_DEM','Input decreto de admision de demanda',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_ADM_DEM'),'H024_ConfirmarAdmision', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_DEC_ADM_DEM') 
