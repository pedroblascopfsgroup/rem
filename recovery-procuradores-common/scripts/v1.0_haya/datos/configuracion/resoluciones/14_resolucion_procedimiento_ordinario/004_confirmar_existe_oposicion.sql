...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '266', 'R_ESC_CON_DEM', 'Escrito de contestación a la demanda', 'Escrito de contestación a la demanda', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
