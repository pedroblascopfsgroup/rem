 ...
 * Tareas: H024_RegistrarResolucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '269', 'R_REG_RES_FAV', 'Sentencia favorable', 'Sentencia favorable', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_RES_FAV'),'H024_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
