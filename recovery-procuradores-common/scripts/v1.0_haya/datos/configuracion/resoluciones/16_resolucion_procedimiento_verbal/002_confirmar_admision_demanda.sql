 ...
 * Tareas: H026_ConfirmarAdmisionDemanda 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '277', 'R_AD_DEM_VIS', 'Admisión demanda y señalamiento visita','Decreto de admisión de demanda y señalamiento de visita',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBL')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AD_DEM_VIS'),'H026_ConfirmarAdmisionDemanda', 'NONE', 0, 'MOD_PROC', 
