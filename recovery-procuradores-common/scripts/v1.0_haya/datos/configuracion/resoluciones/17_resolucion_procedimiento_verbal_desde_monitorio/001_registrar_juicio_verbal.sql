 ...
 * Tareas: H028_RegistrarJuicioVerbal 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '283', 'R_REG_JUZ_VRB', 'Citación vista','Citación vista',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VMN')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_JUZ_VRB'),'H028_RegistrarJuicioVerbal', 'NONE', 0, 'MOD_PROC', 
