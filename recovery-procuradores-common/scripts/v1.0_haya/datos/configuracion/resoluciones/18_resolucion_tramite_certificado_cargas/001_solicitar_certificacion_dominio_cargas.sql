...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '287', 'R_CER_DOM_CAR', 'Certificación de dominio de cargas','Escrito solicitando certificación de dominio de cargas',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCR')
