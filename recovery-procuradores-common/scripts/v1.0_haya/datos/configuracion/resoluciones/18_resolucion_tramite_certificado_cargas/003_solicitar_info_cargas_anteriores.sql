 ...
 * Tareas: H030_SolicitarInformacionCargasAnt 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '289', 'R_INF_CAR_ANT', 'Escrito sellado solicitando información cargas anteriores','Escrito sellado solicitando información cargas anteriores',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCR')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_INF_CAR_ANT'),'H030_SolicitarInformacionCargasAnt', 'NONE', 0, 'MOD_PROC', 
