...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '290', 'R_CNT_CAR_ANT', 'Contestación oficio cargas anteriores','Contestación oficio cargas anteriores',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCR')
