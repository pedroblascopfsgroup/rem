...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '291', 'R_SOL_INF_CANT', 'Escrito sellado solicitando más información cargas anteriores','Escrito sellado solicitando más información cargas anteriores',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CCR')
