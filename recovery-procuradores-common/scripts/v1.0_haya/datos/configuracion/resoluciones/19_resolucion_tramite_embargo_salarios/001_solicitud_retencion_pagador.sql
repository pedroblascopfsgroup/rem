...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '292', 'R_SOL_NOT_EMB', 'Decreto acordando embargo salario','Decreto acordando embargo salario',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'EMS')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda decreto acordando embargo salario.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_SOL_NOT_EMB','Input decreto acordando embargo salario',
'Input decreto acordando embargo salario.', 0, 'MOD_PROC', sysdate, '0',null from dual;
