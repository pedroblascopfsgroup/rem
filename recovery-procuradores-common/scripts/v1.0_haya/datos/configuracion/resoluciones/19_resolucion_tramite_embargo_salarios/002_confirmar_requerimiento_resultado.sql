 ...
 * Tareas: H038_ConfirmarRequerimientoResultado 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '293', 'R_RSP_EMP_EMB', 'Respuesta empresa embargo salario','Respuesta empresa embargo salario',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'EMS')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RSP_EMP_EMB'),'H038_ConfirmarRequerimientoResultado', 'NONE', 0, 'MOD_PROC', 
