...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '296', 'R_SOL_AVL_PER', 'Escrito sellado solicitando avaluo','Escrito sellado solicitando avaluo y nombre perito tasador',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBI')
