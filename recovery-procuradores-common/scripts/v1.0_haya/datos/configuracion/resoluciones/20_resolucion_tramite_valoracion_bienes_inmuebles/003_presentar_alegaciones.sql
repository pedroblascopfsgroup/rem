 ...
 * Tareas: H058_PresentarAlegaciones 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '298', 'R_ESC_ELG_AVL', 'Escrito alegaciones avaluo','Escrito alegaciones avaluo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBI')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_ELG_AVL'),'H058_PresentarAlegaciones', 'NONE', 0, 'MOD_PROC', 
