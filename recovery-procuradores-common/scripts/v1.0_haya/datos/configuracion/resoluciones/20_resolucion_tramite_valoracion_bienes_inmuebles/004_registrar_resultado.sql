 ...
 * Tareas: H058_RegistrarResultado 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '299', 'R_DEC_DET_VDF', 'Decreto determinando valoración definitiva','Decreto determinando valoración definitiva',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBI')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEC_DET_VDF'),'H058_RegistrarResultado', 'NONE', 0, 'MOD_PROC', 
