 ...
 * Tareas: H046_confirmarDecretoEmbargo 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '303', 'R_ACR_MEJ_EMB', 'Decreto acordando mejora embargo','Decreto acordando mejora embargo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MEM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ACR_MEJ_EMB'),'H046_confirmarDecretoEmbargo', 'NONE', 0, 'MOD_PROC', 
