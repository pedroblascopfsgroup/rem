 ...
 * Tareas: H046_registrarAnotacionRegistro 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '304', 'R_REG_ANT_EMB', 'Anotacion de embargo','Anotacion de embargo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'MEM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REG_ANT_EMB'),'H046_registrarAnotacionRegistro', 'NONE', 0, 'MOD_PROC', 
