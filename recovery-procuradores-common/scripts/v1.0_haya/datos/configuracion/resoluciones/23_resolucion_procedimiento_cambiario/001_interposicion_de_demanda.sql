 ...
 * Tareas: H016_interposicionDemandaMasBienes 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '305', 'R_DEM_SEL_PCM', 'Demanda sellada','Demanda sellada',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEM_SEL_PCM'),'H016_interposicionDemandaMasBienes', 'NONE', 0, 'MOD_PROC', 
