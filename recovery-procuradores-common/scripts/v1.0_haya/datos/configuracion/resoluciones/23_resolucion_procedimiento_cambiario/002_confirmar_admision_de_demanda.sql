...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '306', 'R_ATO_REQ_PGS', 'Auto requerido de pago y medidas embargo preventivo','Auto requerido de pago y acordado medidas embargo preventivo',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
