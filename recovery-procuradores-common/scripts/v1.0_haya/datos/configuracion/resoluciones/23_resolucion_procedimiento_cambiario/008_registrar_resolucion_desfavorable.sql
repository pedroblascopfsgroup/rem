 ...
 * Tareas: H016_registrarResolucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '312', 'R_SEN_REO_DFV', 'Sentencia resolviendo oposición desfavorable','Sentencia resolviendo oposición desfavorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SEN_REO_DFV'),'H016_registrarResolucion', 'NONE', 0, 'MOD_PROC', 
