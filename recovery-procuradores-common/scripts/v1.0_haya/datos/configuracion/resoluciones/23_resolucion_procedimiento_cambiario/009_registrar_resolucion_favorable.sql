/**
 * Trámite: P. CAMBIARIO
 * Resolución: Registrar resolucion favorable
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '313', 'R_SEN_REO_FVR', 'Sentencia resolviendo oposición favorable','Sentencia resolviendo oposición favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
          , '0','MOD_PROC', SYSDATE, '0', 'Ayuda sentencia resolviendo oposición favorable.', (SELECT bpm_dd_tac_id FROM bpm_dd_tac_tipo_accion WHERE bpm_dd_tac_codigo = 'ADVANCE')
     FROM DUAL;
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_SEN_REO_FVR','Input sentencia resolviendo oposición favorable',
'Input sentencia resolviendo oposición favorable.', 0, 'MOD_PROC', sysdate, '0',null from dual;
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_SEN_REO_FVR'),'H016_registrarResolucion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_SEN_REO_FVR') 
