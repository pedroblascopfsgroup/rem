...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '318', 'R_ESC_SOL_REM', 'Escrito sellado solicitando remocion','Escrito sellado solicitando remocion',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PDD')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SOL_REM'),'H034_SolicitarRemocion', 'NONE', 0, 'MOD_PROC', 
