...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '322', 'R_AUT_DSP_ABU', 'Auto despachando ejecución declarando clausulas abusivas','Auto despachando ejecución declarando clausulas abusivas',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
