 ...
 * Tareas: H020_RegistrarAnotacionRegistro 
 **/
/* --LA TAREA NO EXISTE EN TAP_TAREAS_PROCEDIMIENTOS
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '323', 'R_CNF_ANT_REG', 'Anotación de embargo en el registro','Mandamiento cumplimentado de anotación de embargo en el registro',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CNF_ANT_REG'),'H020_RegistrarAnotacionRegistro', 'NONE', 0, 'MOD_PROC', 
