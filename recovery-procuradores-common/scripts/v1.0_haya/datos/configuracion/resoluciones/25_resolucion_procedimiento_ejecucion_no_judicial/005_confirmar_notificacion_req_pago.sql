...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '324', 'R_REQ_POS_PNJ', 'Diligencia de notificación','Diligencia de notificación',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_REQ_POS_PNJ','Input requerimiento',
