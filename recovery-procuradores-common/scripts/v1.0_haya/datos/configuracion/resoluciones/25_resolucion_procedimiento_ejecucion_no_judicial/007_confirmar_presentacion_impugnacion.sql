 ...
 * Tareas: H020_ConfirmarPresentacionImpugnacion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '326', 'R_ESC_SEO_IPG', 'Escrito sellado de impugnación','Escrito sellado de impugnación',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SEO_IPG'),'H020_ConfirmarPresentacionImpugnacion', 'NONE', 0, 'MOD_PROC', 
