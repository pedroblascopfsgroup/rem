 ...
 * Tareas: H020_RegistrarCelebracionVista 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '328', 'R_RPT_CLB_VST', 'Reporte celebración de vista','Reporte celebración de vista',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RPT_CLB_VST'),'H020_RegistrarCelebracionVista', 'NONE', 0, 'MOD_PROC', 
