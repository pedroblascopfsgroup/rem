...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '330', 'R_AUT_RSV_OPF', 'Auto que resuelve oposición favorable','Auto que resuelve oposición favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
