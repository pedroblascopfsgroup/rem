...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '331', 'R_NOT_REC_AUT', 'No se recurre auto','No se recurre auto',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_NOT_REC_AUT','Input no se recurre auto',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_NOT_REC_AUT'),'H020_ResolucionFirme', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_NOT_REC_AUT') 
