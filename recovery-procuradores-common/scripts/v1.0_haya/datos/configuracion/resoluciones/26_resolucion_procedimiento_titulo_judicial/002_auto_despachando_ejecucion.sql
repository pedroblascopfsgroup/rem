...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '333', 'R_AUT_DSP_PJU', 'Auto despachando ejecución según demanda','Auto despachando ejecución según demanda',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_DSP_PJU'),'H018_AutoDespachando', 'NONE', 0, 'MOD_PROC', 
