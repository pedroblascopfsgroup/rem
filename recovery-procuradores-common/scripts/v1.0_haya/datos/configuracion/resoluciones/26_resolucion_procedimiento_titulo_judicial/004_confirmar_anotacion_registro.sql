...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '335', 'R_CNF_NOT_REG', 'Anotación de embargo en el registro','Mandamiento cumplimentado de anotación de embargo en el registro',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
