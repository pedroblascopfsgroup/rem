...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '340', 'R_REP_CEL_VST', 'Reporte celebración de vista','Reporte celebración de vista',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REP_CEL_VST'),'H018_RegistrarVista', 'NONE', 0, 'MOD_PROC', 
