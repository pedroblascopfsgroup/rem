...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '342', 'R_ATO_RSV_OPD', 'Auto que resuelve oposición favorable','Auto que resuelve oposición favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ATO_RSV_OPD'),'H018_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
