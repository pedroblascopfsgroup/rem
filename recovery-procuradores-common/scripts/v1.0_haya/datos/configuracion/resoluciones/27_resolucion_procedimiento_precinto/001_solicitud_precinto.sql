...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '303', 'R_ESC_SOL_PRE', 'Escrito sellado solicitando precinto','Escrito sellado solicitando precinto',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PRE')
