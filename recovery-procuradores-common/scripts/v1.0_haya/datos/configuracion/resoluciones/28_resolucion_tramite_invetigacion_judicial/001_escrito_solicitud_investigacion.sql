 ...
 * Tareas: H044_SolicitudInvestigacionJudicial 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '347', 'R_ESC_SLI_INV', 'Escrito sellado solicitando investigación','Escrito sellado solicitando investigación',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'INJ')
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SLI_INV'),'H044_SolicitudInvestigacionJudicial', 'NONE', 0, 'MOD_PROC', 
