...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '353', 'R_TR_COS_ENT_SELL_IMPUG', 'Escrito sellado impugnando costas', 'Escrito sellado impugnando costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCE')
