/**
 * Trámite: P. CAMBIARIO
 * Resolución: Registrar auto despachando ejecución
 * Tareas: H016_registrarAutoEjecucion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '336', 'R_AUT_DEJ_PCM', 'Auto despachando ejecución','Auto despachando ejecución',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_AUT_DEJ_PCM','Input auto despachando ejecución',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_AUT_DEJ_PCM'),'H016_registrarAutoEjecucion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_AUT_DEJ_PCM') 
