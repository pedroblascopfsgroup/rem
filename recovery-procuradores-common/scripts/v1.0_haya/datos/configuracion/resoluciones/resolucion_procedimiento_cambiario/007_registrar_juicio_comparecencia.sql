 ...
 * Tareas: H016_registrarJuicioComparecencia 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_REP_JUI_PCM'),'H016_registrarJuicioComparecencia', 'NONE', 0, 'MOD_PROC', 
