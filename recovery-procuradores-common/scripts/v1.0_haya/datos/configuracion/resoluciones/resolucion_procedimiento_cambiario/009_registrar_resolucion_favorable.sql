...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '339', 'R_SEN_REO_FVR', 'Sentencia resolviendo oposición favorable','Sentencia resolviendo oposición favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PCM')
