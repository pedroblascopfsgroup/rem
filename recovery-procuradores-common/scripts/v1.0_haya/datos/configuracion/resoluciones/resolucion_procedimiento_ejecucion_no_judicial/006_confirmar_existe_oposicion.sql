 ...
 * Tareas: H020_ConfirmarSiExisteOposicion 
 **/
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_OPO_PNJ'),'H020_ConfirmarSiExisteOposicion', 'NONE', 0, 'MOD_PROC', 
