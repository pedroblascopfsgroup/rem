...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '316', 'R_AUT_RSV_OPD', 'Auto que resuelve oposición desfavorable','Auto que resuelve oposición desfavorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PNJ')
