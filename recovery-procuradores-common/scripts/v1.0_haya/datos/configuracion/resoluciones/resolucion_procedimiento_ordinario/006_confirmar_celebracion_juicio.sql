/**
 * Trámite: P.Ordinario
 * Resolución: Confirmar celebración juicio
 * Tareas: H024_RegistrarJuicio 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '261', 'R_CNF_CEL_JUC', 'Reporte juicio', 'Reporte juicio', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'ORD')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_CNF_CEL_JUC','Input reporte juicio',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CNF_CEL_JUC'),'H024_RegistrarJuicio', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_CNF_CEL_JUC') 
