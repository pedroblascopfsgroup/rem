 ...
 * Tareas: H018_InterposicionDemanda 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '319', 'R_DEM_SLL_JUD', 'Demanda sellada','Demanda sellada',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_DEM_SLL_JUD','Input demanda sellada',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_DEM_SLL_JUD'),'H018_InterposicionDemanda', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_DEM_SLL_JUD') 
