 ...
 * Tareas: H018_RegistrarAnotacion 
 **/
/* --NO TENEMOS LA TAREA EN LA BD AL IGUAL QUE EN EL ETNJ
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '322', 'R_CNF_NOT_REG', 'Anotación de embargo en el registro','Mandamiento cumplimentado de anotación de embargo en el registro',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_CNF_NOT_REG','Input mandamiento cumplimentado de anotación de embargo en el registro',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_CNF_NOT_REG'),'H018_RegistrarAnotacion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_CNF_NOT_REG') 
