 ...
 * Tareas: H018_ConfirmarPresentacionImpugnacion 
 **/
...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '325', 'R_ESC_SLL_IMP', 'Escrito sellado de impugnación','Escrito sellado de impugnación',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'PTJ')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_ESC_SLL_IMP','Input escrito sellado de impugnación',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_ESC_SLL_IMP'),'H018_ConfirmarPresentacionImpugnacion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_ESC_SLL_IMP') 
