...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '275', 'R_RES_VBL_FAV', 'Sentencia favorable','Sentencia favorable',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VBL')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_RES_VBL_FAV','Input sentencia favorable',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RES_VBL_FAV'),'H026_RegistrarResolucion', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_RES_VBL_FAV') 
