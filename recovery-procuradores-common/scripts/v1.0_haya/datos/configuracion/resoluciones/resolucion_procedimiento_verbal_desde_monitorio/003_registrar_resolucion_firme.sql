...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '280', 'R_RES_FRM_MON', 'Decreto firmeza','Decreto firmeza',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'VMN')
...
SELECT S_BPM_DD_TIN_TIPO_INPUT.nextVal,'I_RES_FRM_MON','Input decreto firmeza',
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO='I_RES_FRM_MON'),'H028_ResolucionFirme', 'NONE', 0, 'MOD_PROC', 
...
from bpm_tpi_tipo_proc_input where bpm_dd_tin_id = (select bpm_dd_tin_id from bpm_dd_tin_tipo_input where bpm_dd_tin_codigo='I_RES_FRM_MON') 
