...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '289', 'R_SOL_AVG_BIN', 'Escrito solicitando averiguación bienes','Escrito solicitando averiguación bienes',(SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'EMS')
