...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '201', 'R_PR_CON_ESC_SELL_ACR', 'Escrito sellado acreditando consignacion', 'Escrito sellado acreditando consignacion', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'CON')
