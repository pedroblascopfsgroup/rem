...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '230', 'R_TR_COS_ENT_IMPUG_TAS', 'Diligencia señalando visita impugnación tasación de costas', 'Diligencia señalando visita impugnación tasación de costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCE')
