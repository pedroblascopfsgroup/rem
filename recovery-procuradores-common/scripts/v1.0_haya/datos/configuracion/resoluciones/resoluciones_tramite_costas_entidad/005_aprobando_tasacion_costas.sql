...
INSERT INTO dd_tr_tipos_resolucion
   ...
   SELECT '231', 'R_TR_COS_ENT_DECRE_TAS_COS', 'Decreto aprobando tasación de costas', 'Decreto aprobando tasación de costas', (SELECT dd_tj_id FROM dd_tj_tipo_juicio WHERE dd_tj_codigo = 'TCE')
