...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito Sellado solicitando entrega para la tarea H002_SolicitarMandamientoPago.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'214';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_SUB_SAR_ESC_SELL_SOL';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_SUB_SAR_ESC_SELL_SOL';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H002';
    V_NODO VARCHAR2(50 CHAR):=				'H002_SolicitarMandamientoPago';
