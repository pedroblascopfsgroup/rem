...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'387';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_ADJ_DEC_ADJ_CON';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_ADJ_DEC_ADJ_CON';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H005';
    V_NODO VARCHAR2(50 CHAR):=				'H005_notificacionDecretoAdjudicacionAlContrario';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboNotificacion','comboNotificacion'),
