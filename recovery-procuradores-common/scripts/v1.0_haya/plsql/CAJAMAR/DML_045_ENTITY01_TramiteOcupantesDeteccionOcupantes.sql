...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'391';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_DOC_DET_OCU';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Documentación detección ocupantes';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'OCU';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DOT_DET_OCU';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H048';
    V_NODO VARCHAR2(50 CHAR):=				'H048_TrasladoDocuDeteccionOcupantes';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaDocumentos','fechaDocumentos'),
