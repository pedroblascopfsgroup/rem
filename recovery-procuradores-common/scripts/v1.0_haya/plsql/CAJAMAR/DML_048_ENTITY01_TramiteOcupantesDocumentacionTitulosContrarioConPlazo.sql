...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Resolución requiriendo hacer alegaciones a títulos aportados de contrario con plazo para la tarea H048_RegistrarRecepcionDoc.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'247';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_REP_DOC_C';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolución requiriendo hacer alegaciones a títulos aportados de contrario con plazo';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'OCU';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_REP_DOC_C';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H048';
    V_NODO VARCHAR2(50 CHAR):=				'H048_RegistrarRecepcionDoc';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaVista','fechaVista'),
    	T_INPUT('d_fechaFinAle','fechaFinAle'),
    	T_INPUT('d_comboOcupado','comboOcupado'),
    	T_INPUT('d_comboDocumentacion','comboDocumentacion'),
    	T_INPUT('d_comboInquilino','comboInquilino'),
    	T_INPUT('d_fechaContrato','fechaContrato'),
    	T_INPUT('d_nombreArrendatario','nombreArrendatario'),
