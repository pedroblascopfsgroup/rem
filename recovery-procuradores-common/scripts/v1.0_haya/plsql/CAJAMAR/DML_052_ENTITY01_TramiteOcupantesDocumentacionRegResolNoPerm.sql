...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Auto declara ocupante no tiene derecho a permanecer en la vivienda para la tarea H048_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'251';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_RES_NPR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Auto declara ocupante no tiene derecho a permanecer en la vivienda';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'OCU';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_RES_NPR';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H048';
    V_NODO VARCHAR2(50 CHAR):=				'H048_RegistrarResolucion';
