...
DECLARE
    ...
    */
    ...
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito de notificación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'EMS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SOL_NOT_EMB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H038';
    V_NODO VARCHAR2(50 CHAR):=				'H038_SolicitarNotificacion';
