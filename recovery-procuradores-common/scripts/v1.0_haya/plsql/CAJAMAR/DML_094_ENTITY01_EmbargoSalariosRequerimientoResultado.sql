...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Respuesta empresa embargo salario para la tarea H038_SolicitarNotificacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'293';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RSP_EMP_EMB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resultado notificación requerimiento retención';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'EMS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RSP_EMP_EMB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H038';
    V_NODO VARCHAR2(50 CHAR):=				'H038_ConfirmarRequerimientoResultado';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboRequerido','comboRequerido'),
    	T_INPUT('d_comboResultado','comboResultado'),
    	T_INPUT('d_importeNom','importeNom'),
    	T_INPUT('d_importeRet','importeRet'),
