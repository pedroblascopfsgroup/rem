...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Resolución firme para la tarea H016_resolucionFirme.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	*/
	...
	V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_AUT_PCM';
	...
	V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_AUT_PCM';
