...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DEM_SLL_NJD';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H020';
    V_NODO VARCHAR2(50 CHAR):=				'H020_InterposicionDemandaMasBienes';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaInterposicion','fechaInterposicion'),
    	...
    	T_INPUT('d_capitalNoVencido','capitalNoVencido'),
