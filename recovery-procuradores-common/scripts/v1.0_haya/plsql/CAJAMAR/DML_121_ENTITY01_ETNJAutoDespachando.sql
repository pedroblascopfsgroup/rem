...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Auto Despachando Ejecucion para la tarea H020_AutoDespaEjecMasDecretoEmbargo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'321';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_AUT_DSP_PNJ';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_AUT_DSP_PNJ';
