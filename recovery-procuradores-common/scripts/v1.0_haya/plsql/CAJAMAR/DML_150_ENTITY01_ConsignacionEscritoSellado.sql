...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado acreditando consignacion para la tarea H064_presentacionJuzgado.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'350';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_CON_ESC_SELL_ACR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito de presentación en el juzgado';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CON';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_CON_ESC_SELL_ACR';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H064';
    V_NODO VARCHAR2(50 CHAR):=				'H064_presentacionJuzgado';
