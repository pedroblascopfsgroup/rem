...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Decreto aprobando tasación de costas para la tarea H032_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'355';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_COS_ENT_DECRE_TAS_CO';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_COS_ENT_DECRE_TAS_CO';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H032';
    V_NODO VARCHAR2(50 CHAR):=				'H032_RegistrarResolucion';
