...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea H001_RegResolucionJuzgado.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	*/
	...
	V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_RES_JUZ';
	
	V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H001';
	V_NODO VARCHAR2(50 CHAR):=				'H001_RegResolucionJuzgado';
	...
	V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
		...
		T_INPUT('d_cuantiaCargasPrevias','cuantiaCargasPrevias'),
