...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución  para la tarea H015_SuspensionLanzamiento.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POS_SUS_LAN';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H015';
    V_NODO VARCHAR2(50 CHAR):=				'H015_SuspensionLanzamiento';
