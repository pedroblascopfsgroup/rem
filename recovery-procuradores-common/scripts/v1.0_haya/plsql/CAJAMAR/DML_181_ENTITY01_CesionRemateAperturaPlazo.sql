...
DECLARE
    ...
    */
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboFinaliza','comboFinaliza'),
        T_INPUT('d_fecha','fecha'),
        T_INPUT('d_instrucciones','instrucciones'),
        T_INPUT('d_cbCresionRemate','cbCresionRemate'),
        T_INPUT('d_cbTitulizado','cbTitulizado'),
