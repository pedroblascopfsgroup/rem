...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea HC105_NotificacionOcupante.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'399';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_POI_NOT_OCU';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Notificación ocupante';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'POI';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POI_NOT_OCU';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'HC105';
    V_NODO VARCHAR2(50 CHAR):=				'HC105_NotificacionOcupante';
