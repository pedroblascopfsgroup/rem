...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea HC105_RegistrarDisconformidadEjecutado.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'405';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_POI_REG_DIS_EJE';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Disconformidad con rendición de cuentas del ejecutado';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'POI';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POI_REG_DIS_EJE';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'HC105';
    V_NODO VARCHAR2(50 CHAR):=				'HC105_RegistrarDisconformidadEjecutado';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboDisconformidad','comboDisconformidad'),
