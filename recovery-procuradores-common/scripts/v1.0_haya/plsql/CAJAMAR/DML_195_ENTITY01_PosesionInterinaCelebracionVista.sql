...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea HC105_CelebracionVista.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'408';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_POI_CEL_VIS';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POI_CEL_VIS';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'HC105';
    V_NODO VARCHAR2(50 CHAR):=				'HC105_CelebracionVista';
