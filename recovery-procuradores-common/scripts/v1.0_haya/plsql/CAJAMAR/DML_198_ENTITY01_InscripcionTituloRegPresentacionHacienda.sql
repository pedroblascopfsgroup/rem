...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea H066_registrarPresentacionHacienda.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_IDT_REG_PRE_HAC';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H066';
    V_NODO VARCHAR2(50 CHAR):=				'H066_registrarPresentacionHacienda';
