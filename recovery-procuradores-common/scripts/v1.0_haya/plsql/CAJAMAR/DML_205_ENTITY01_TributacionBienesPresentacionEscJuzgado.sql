...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'425';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TRB_PES_JUZ';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito al juzgado para comunicar la operación sujeta a IVA';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TRB';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TRB_PES_JUZ';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H054';
    V_NODO VARCHAR2(50 CHAR):=				'H054_PresentarEscritoJuzgado';
