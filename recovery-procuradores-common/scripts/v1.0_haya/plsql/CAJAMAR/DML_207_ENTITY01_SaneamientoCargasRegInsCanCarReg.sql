...
DECLARE
    ...
    */
    ...
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_INS_CAN_CAR_REG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Registrar inscripción cancelación cargas registrales';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			''; --JODO
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_INS_CAN_CAR_REG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H008';
    V_NODO VARCHAR2(50 CHAR):=				'H008_RegInsCancelacionCargasReg';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_fechaInscripcion','fechaInscripcion'),
