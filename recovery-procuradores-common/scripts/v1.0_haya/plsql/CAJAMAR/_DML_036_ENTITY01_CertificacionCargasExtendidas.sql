...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Traslado oficio acreedores anteriores para la tarea H030_RegistrarInformacionCargasAnt.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'235';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_INF_CARG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Notificación información cargas anteriores';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCG';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_INF_CARG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H030';
    V_NODO VARCHAR2(50 CHAR):=				'H030_RegistrarInformacionCargasAnt';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboCompletitud','comboCompletitud'),
