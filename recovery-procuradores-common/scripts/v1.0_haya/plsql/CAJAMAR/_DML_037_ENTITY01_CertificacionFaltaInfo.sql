...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando información no aportada para la tarea H030_RequerirInfoFalta.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'236';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REQ_MAS_INFO';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Nueva solicitud información cargas anteriores';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCG';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REQ_MAS_INFO';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H030';
    V_NODO VARCHAR2(50 CHAR):=				'H030_RequerirInfoFalta';
