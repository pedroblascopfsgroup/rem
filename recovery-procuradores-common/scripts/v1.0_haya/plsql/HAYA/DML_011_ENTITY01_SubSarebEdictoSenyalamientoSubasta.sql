...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Edicto subasta señalamiento subasta para la tarea H002_SenyalamientoSubasta.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_SUB_SAR_EDIC_SUB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H002';
    V_NODO VARCHAR2(50 CHAR):=				'H002_SenyalamientoSubasta';
