...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'213';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_SUB_SAR_ACT_SUB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Acta de subasta SAREB';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'SBS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_SUB_SAR_ACT_SUB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H002';
    V_NODO VARCHAR2(50 CHAR):=				'H002_CelebracionSubasta';
