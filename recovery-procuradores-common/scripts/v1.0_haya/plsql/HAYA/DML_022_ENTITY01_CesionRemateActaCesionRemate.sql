...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Resolucion acta cesión de remate para la tarea H006_RealizacionCesionRemate.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'222';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_CES_ACT_CES';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolucion acta cesión de remate';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CES';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_CES_ACT_CES';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H006';
    V_NODO VARCHAR2(50 CHAR):=				'H006_RealizacionCesionRemate';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboTitularizado','comboTitularizado'),
