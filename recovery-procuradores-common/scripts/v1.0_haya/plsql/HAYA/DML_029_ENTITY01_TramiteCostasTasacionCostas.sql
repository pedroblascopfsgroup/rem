...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Tasación de costas del juzgado para la tarea H007_TasacionCostas.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'228';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TAS_COST_JUZG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Tasación de costas del juzgado';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TAS_COST_JUZG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H007';
    V_NODO VARCHAR2(50 CHAR):=				'H007_TasacionCostas';
