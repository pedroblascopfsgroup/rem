...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Diligencia señalando visita impugnación tasación de costas para la tarea H007_RegistrarCelebracionVista.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'230';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_DIL_IMPUG_TAS_COST';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DIL_IMPUG_TAS_COST';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H007';
    V_NODO VARCHAR2(50 CHAR):=				'H007_RegistrarCelebracionVista';
