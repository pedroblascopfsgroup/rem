...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Decreto aprobando tasación de costas para la tarea H007_AutoAprobacionCostas.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'231';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_AUT_APRO_COST';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Decreto aprobando tasación de costas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_AUT_APRO_COST';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H007';
    V_NODO VARCHAR2(50 CHAR):=				'H007_AutoAprobacionCostas';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboAprobada','comboAprobada'),
