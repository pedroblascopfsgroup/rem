...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando certificación de cargas para la tarea H030_SolicitudCertificacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'232';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SOL_CER_CARG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando certificación de cargas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCG';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SOL_CER_CARG';
