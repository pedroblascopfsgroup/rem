...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Tasación de intereses del juzgado para la tarea H042_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'238';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REGI_RESOL';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Tasación de intereses del juzgado';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'INT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REGI_RESOL';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H042';
    V_NODO VARCHAR2(50 CHAR):=				'H042_RegistrarResolucion';
