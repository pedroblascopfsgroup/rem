...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar admision y emplazamiento para la tarea H011_RegistrarAdmisionYEmplazamiento.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'253';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_ADM_EML';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Registrar admision y emplazamiento';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MRL';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_ADM_EML';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H011';
    V_NODO VARCHAR2(50 CHAR):=				'H011_RegistrarAdmisionYEmplazamiento';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboAdminEmplaza','comboAdminEmplaza'),
    	T_INPUT('d_fechaNotificacion','fechaNotificacion'),
    	T_INPUT('d_comboVista','comboVista'),
