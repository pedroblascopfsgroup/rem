...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando subsanación decreto adjudicación para la tarea H052_RegistrarPresentacionEscritoSub.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'261';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_PRS_ESB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando subsanación decreto adjudicación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'SDA';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_PRS_ESB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H052';
    V_NODO VARCHAR2(50 CHAR):=				'H052_RegistrarPresentacionEscritoSub';
