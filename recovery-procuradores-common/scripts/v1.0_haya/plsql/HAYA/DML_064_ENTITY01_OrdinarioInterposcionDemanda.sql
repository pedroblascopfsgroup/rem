...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Demanda sellada para la tarea H024_InterposicionDemanda.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'263';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ORD_DEM_SEL';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ORD_DEM_SEL';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H024';
    V_NODO VARCHAR2(50 CHAR):=				'H024_InterposicionDemanda';
