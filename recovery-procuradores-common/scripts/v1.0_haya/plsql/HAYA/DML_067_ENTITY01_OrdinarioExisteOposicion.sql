...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito de contestación a la demanda para la tarea H024_ConfirmarOposicion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'266';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_CON_DEM';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito de contestación a la demanda';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'ORD';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_CON_DEM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H024';
    V_NODO VARCHAR2(50 CHAR):=				'H024_ConfirmarOposicion';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaAudiencia','fechaAudiencia'),
