...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Decreto de firmeza para la tarea H024_ResolucionFirme.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'271';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_FIRM';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_FIRM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H024';
    V_NODO VARCHAR2(50 CHAR):=				'H024_ResolucionFirme';
