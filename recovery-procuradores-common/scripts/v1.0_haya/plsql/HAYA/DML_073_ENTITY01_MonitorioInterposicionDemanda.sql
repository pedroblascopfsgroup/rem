...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Copia sellada solicitud inicial procedimiento monitorio para la tarea H022_InterposicionDemanda.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'272';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SOL_INI_MON';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Copia sellada solicitud inicial procedimiento monitorio';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MON';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SOL_INI_MON';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H022';
    V_NODO VARCHAR2(50 CHAR):=				'H022_InterposicionDemanda';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaCierre','fechaCierre'),
    	T_INPUT('d_principalDemanda','principalDemanda'),
