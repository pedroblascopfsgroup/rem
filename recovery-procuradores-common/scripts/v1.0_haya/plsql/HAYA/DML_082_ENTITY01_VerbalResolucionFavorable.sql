...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia favorable para la tarea H026_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'281';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_VBL_FAV';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_VBL_FAV';
