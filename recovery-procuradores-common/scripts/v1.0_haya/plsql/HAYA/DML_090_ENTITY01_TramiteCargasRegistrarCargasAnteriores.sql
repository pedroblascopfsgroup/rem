...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'289';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_INF_CAR_ANT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando información cargas anteriores';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCR';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_INF_CAR_ANT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H030';
    V_NODO VARCHAR2(50 CHAR):=				'H030_SolicitarInformacionCargasAnt';
