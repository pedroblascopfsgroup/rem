...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Contestación oficio cargas anteriores para la tarea H030_RegistrarInformacionCargasAnt.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'290';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_CNT_CAR_ANT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Contestación oficio cargas anteriores';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCR';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_CNT_CAR_ANT';
