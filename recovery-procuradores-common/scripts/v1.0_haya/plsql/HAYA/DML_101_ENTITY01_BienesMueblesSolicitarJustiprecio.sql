...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Solicitar justiprecio para la tarea H060_SolicitarJustiprecio.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'300';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SLC_AVL_NOM';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Solicitud avaluo y nombre perito tasador';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VBM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SLC_AVL_NOM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H060';
    V_NODO VARCHAR2(50 CHAR):=				'H060_SolicitarJustiprecio';
