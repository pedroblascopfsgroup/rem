...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar justiprecio para la tarea H060_RegistrarJustiprecio.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'301';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_DEC_VAL_DEF';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Decreto determina valoración definitiva';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VBM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DEC_VAL_DEF';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H060';
    V_NODO VARCHAR2(50 CHAR):=				'H060_RegistrarJustiprecio';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaRegistro','fechaRegistro'),
    	T_INPUT('d_cuantia','cuantia'),
