...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Registro decreto de embargo para la tarea H046_confirmarDecretoEmbargo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'303';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ACR_MEJ_EMB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Decreto acordando mejora embargo';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MEM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ACR_MEJ_EMB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H046';
    V_NODO VARCHAR2(50 CHAR):=				'H046_confirmarDecretoEmbargo';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboBienes','comboBienes'),
