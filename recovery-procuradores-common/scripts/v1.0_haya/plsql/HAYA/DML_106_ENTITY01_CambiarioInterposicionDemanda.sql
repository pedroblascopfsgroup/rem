...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Interposicion de la demanda + marcado de bienes para la tarea H016_interposicionDemandaMasBienes.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DEM_SEL_PCM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H016';
    V_NODO VARCHAR2(50 CHAR):=				'H016_interposicionDemandaMasBienes';
