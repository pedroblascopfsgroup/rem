...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'314';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_FRM_PCM';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolución firmeza';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PCM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_FRM_PCM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H016';
    V_NODO VARCHAR2(50 CHAR):=				'H016_resolucionFirme';
