...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Aceptación cargo depositario para la tarea H034_AceptacionCargoDepositario.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'317';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ACT_ACP_DEP';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Acta aceptación de depositario';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PDD';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ACT_ACP_DEP';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H034';
    V_NODO VARCHAR2(50 CHAR):=				'H034_AceptacionCargoDepositario';
