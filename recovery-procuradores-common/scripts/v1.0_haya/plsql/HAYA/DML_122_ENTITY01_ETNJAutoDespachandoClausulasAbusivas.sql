...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Auto despachando ejecucion - marcado de bienes decreto embargo para la tarea H020_AutoDespaEjecMasDecretoEmbargo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'322';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_AUT_DSP_ABU';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Auto despachando ejecución declarando clausulas abusivas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PNJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_AUT_DSP_ABU';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H020';
    V_NODO VARCHAR2(50 CHAR):=				'H020_AutoDespaEjecMasDecretoEmbargo';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboPlaza','comboPlaza'),
    	T_INPUT('d_numJuzgado','numJuzgado'),
    	T_INPUT('d_numProcedimiento','numProcedimiento'),
    	T_INPUT('d_comboAdmisionDemanda','comboAdmisionDemanda'),
    	T_INPUT('d_bienesEmbargables','bienesEmbargables'),
