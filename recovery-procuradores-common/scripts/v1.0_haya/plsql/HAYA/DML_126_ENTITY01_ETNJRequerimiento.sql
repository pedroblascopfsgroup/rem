...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Confirmar presentación de impugnación para la tarea H020_ConfirmarPresentacionImpugnacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'326';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_SEO_IPG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado de impugnación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PNJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_SEO_IPG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H020';
    V_NODO VARCHAR2(50 CHAR):=				'H020_ConfirmarPresentacionImpugnacion';
