...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Confirmar si hay vista para la tarea H020_ConfirmarVista.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'327';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_DO_SEN_VSTA';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'D.O Señalando vista','D.O Señalando vista';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PNJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DO_SEN_VSTA';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H020';
    V_NODO VARCHAR2(50 CHAR):=				'H020_ConfirmarVista';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboHayVista','comboHayVista'),
