...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Interposición de la demanda - marcado de bienes para la tarea H018_InterposicionDemanda.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_NODO VARCHAR2(50 CHAR):=				'H018_InterposicionDemanda';
