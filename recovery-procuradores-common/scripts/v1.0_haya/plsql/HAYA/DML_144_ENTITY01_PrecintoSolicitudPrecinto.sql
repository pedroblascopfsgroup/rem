...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Solicitud de precinto para la tarea H050_SolicitarPrecinto.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'344';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_SOL_PRE';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando precinto';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PRE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_SOL_PRE';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H050';
    V_NODO VARCHAR2(50 CHAR):=				'H050_SolicitarPrecinto';
