...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Revisar resultado de investigación y actualización de datos para la tarea H044_RevisarInvestigacionYActualizacionDatos.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'349';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REV_INV_ACD';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando nuevos datos';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'INJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REV_INV_ACD';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H044';
    V_NODO VARCHAR2(50 CHAR):=				'H044_RevisarInvestigacionYActualizacionDatos';
