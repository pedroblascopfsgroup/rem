...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Traslado de contrario instando solicitud de costas para la tarea H032_RegistrarSolCostasContrario.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'351';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_COS_ENT_SOL_COST';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Traslado de contrario instando solicitud de costas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_COS_ENT_SOL_COST';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H032';
    V_NODO VARCHAR2(50 CHAR):=				'H032_RegistrarSolCostasContrario';
