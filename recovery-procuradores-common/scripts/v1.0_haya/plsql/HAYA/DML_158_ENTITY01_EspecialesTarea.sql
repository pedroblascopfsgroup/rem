...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'1003';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'RESOL_ESP_TAREA';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Tareas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'TAREAS'; -- ADVANCE, INFO, etc.
