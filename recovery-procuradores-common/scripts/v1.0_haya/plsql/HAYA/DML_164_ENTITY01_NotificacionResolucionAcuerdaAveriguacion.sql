...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Resolución acuerda averiguación domiciliaria para la tarea P400_GestionarNotificaciones.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'360';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_NOTI_RES_ACU_AVE';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolución acuerda averiguación domiciliaria';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'NOT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'INFO'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_NOTI_RES_ACU_AVE';
