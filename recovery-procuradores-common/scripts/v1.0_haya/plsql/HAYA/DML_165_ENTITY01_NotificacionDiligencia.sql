...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Diligencia de requerimiento para la tarea P400_GestionarNotificaciones.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'361';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_NOTI_DIL_REQ';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Diligencia de requerimiento';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'NOT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'INFO'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_NOTI_DIL_REQ';
