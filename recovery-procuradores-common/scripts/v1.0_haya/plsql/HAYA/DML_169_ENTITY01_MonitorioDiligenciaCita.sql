...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Diligencia que cita a las partes a la vista para la tarea H022_ConfirmarOposicionCuantia.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'367';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_DIL_CITA_PART';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Diligencia que cita a las partes a la vista';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MON';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'INFO'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_DIL_CITA_PART';
