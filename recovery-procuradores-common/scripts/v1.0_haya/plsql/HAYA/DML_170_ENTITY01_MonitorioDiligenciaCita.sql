...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Requerimiento interponer demanda Ordinario para la tarea H022_ConfirmarOposicionCuantia.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'368';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REQUE_INTER_DEM_OR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Requerimiento para interponer la demanda de ordinario';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MON';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'INFO'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REQUE_INTER_DEM_OR';
