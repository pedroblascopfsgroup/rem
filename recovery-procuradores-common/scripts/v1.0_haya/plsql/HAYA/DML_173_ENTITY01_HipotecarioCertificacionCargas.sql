...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Demanda Sellada para la tarea H001_RegistrarCertificadoCargas.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'371';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_REG_CERTI';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Registrar certificación cargas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_REG_CERTI';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H001';
    V_NODO VARCHAR2(50 CHAR):=				'H001_RegistrarCertificadoCargas';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_cargasPrevias','cargasPrevias'),
