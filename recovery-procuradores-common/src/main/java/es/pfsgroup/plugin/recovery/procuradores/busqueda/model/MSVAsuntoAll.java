package es.pfsgroup.plugin.recovery.procuradores.busqueda.model;
...
@Entity
@Table(name = "V_MSV_BUSQUEDA_ASUNTOS_USU_V2", schema = "${entity.schema}")
@Cache(usage=CacheConcurrencyStrategy.READ_ONLY)
public class MSVAsuntoAll implements Serializable {
