...
<fwk:json>
	...
	<json:object name="oficina">
		...
		<json:property name='telefono1' value="${expediente.oficina.telefono1}" />
	...
	<json:object name="cabeceraRecobro">
		<json:property name="cartera" value="${cabeceraRecobro.carteraEsquema.cartera.nombre}"/>		
		<json:property name="subcartera" value="${cabeceraRecobro.subCartera.nombre}"/>
		<json:property name="agencia" value="${cabeceraRecobro.agencia.nombre}"/>
		<json:property name="fechaAsignacion">
			<fwk:date value="${cabeceraRecobro.fechaAsignacion}"/>
		</json:property>
		<json:property name="itinerarioMV" value="${cabeceraRecobro.itinerarioMV.nombre}"/>
		<json:property name="fechaMaxEnAgencia">
			<fwk:date value="${cabeceraRecobro.fechaMaxEnAgencia}"/>
		</json:property>			
		<json:property name="fechaMaxCobroParcial">
			<fwk:date value="${cabeceraRecobro.fechaMaxCobroParcial}"/>
		</json:property>
	</json:object>
