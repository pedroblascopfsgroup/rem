...
public class EXTRecobroCobroPago implements Auditable, Serializable {
	...
	public Float getCobroFacturable() {
		return cobroFacturable;
	}

	public void setCobroFacturable(Float cobroFacturable) {
