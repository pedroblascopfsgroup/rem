...
(function(){
	...
	<pfs:defineParameters name="idExpediente" paramId="${expediente.id}"/>
	...
	<pfs:remoteStore name="hitoExtraJudicialStore" 
		...
		dataFlow="sidhiaccionesnoproc/getHitoExtraJudicialExpediente"
	...
	<pfs:remoteStore name="interaccionExtraJudicialStore" 
		...
		dataFlow="sidhiaccionesnoproc/getAccionesNoProcExpediente"
		parameters="idExpediente"
		resultTotalVar="total"
		autoload="true"/>
