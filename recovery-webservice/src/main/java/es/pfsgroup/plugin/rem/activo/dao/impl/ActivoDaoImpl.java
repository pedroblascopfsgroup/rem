...
public class ActivoDaoImpl extends AbstractEntityDao<Activo, Long> implements ActivoDao {
	...
	@Override
	public Long getIdAgrupacionActivoAgrRestringidaPorActivoId(Long id) {
		HQLBuilder hb = new HQLBuilder(
				"select act.agrupacion.id from ActivoAgrupacionActivo act where act.agrupacion.fechaBaja is null and act.activo.id = "
						+ id + " and act.agrupacion.tipoAgrupacion.codigo = "
						+ DDTipoAgrupacion.AGRUPACION_RESTRINGIDA);
	...
	public Long getUltimoHistoricoPresupuesto(Long id) {
		HQLBuilder hb = new HQLBuilder("select presupuesto.id from PresupuestoActivo presupuesto "
				+ " where presupuesto.activo.id = " + id + " order by presupuesto.ejercicio.anyo desc ");
	...
	public Boolean publicarActivoSinHistorico(Long idActivo, String username,
		...
		// Antes de realizar la llamada al SP realizar las operaciones previas
		// con los datos.
		if (doFlush) {
	...
	private Boolean publicarActivo(Long idActivo, String username, Boolean historificar,
			String eleccionUsuarioTipoPublicacionAlquiler) {
	 ...
	 *         ha sido satisfactoria.
	 */
	private Boolean publicarAgrupacion(Long idAgrupacion, String username, Boolean historificar,
			String eleccionUsuarioTipoPublicacionAlquiler) {
