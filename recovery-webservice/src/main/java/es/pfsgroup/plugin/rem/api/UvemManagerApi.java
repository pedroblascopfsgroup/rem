...
public interface UvemManagerApi {
	...
	public enum MOTIVO_ANULACION {
		COMPRADOR_NO_INTERESADO, DECISION_AREA, NO_DISPONE_DINERO_FINANCIACION, CIRCUSTANCIAS_DISTINTAS_PACTADAS, NO_CUMPLEN_CONDICIONANTES, NO_DESEAN_ESCRITURAR, DECISION_HAYA, NO_APLICA
	}

	public enum INDICADOR_DEVOLUCION_RESERVA {
		DEVOLUCION_RESERVA, NO_DEVOLUCION_RESERVA, NO_APLICA
	}
	
	public enum CODIGO_SERVICIO_MODIFICACION {
		PROPUESTA_ANULACION_RESERVA_FIRMADA, ANULACION_PROPUESTA_ANULACION_RESERVA_FIRMADA, SOLICITUD_ANULACION_PROPUESTA_ANULACION_RESERVA_FIRMADA, ANULAR_SOLICITUD_ANULACION_PROPUESTA_ANULACION_RESERVA_FIRMADA
	}
