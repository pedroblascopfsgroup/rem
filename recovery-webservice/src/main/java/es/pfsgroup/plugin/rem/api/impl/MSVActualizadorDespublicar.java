...
@Component
public class MSVActualizadorDespublicar extends AbstractMSVActualizador implements MSVLiberator {
	...
	public String getValidOperation() {
		return MSVDDOperacionMasiva.CODE_FILE_BULKUPLOAD_ACTUALIZAR_DESPUBLICAR;
	}
