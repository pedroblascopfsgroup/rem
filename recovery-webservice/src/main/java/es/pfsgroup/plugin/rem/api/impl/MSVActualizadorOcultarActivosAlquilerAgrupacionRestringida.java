...
@Component
public class MSVActualizadorOcultarActivosAlquilerAgrupacionRestringida extends AbstractMSVActualizador implements MSVLiberator{
	...
	public String getValidOperation() {
		return MSVDDOperacionMasiva.CODE_FILE_BULKUPLOAD_OCULTACION_ALQUILER_AGRUPACION_RESTRINGIDA;
	}
