...
public class MSVActualizadorPrinex extends AbstractMSVActualizador implements MSVLiberator {
	...
	public ResultadoProcesarFila procesaFila(MSVHojaExcel exc, int fila, Long prmToken)
		...
		Long gpvNumGasto = Long
				.valueOf(exc.dameCelda(fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPV_NUM_GASTO_HAYA));
		Long numActivo = null;
		Activo activo = null;

		if (!Checks.esNulo(exc.dameCelda(fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.ACT_NUM_ACTIVO_HAYA))) {
			numActivo = Long
					.valueOf(exc.dameCelda(fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.ACT_NUM_ACTIVO_HAYA));
		...
		if (activo != null) {
			...
			gasto = genericDao.get(GastoPrinex.class,
					...
					genericDao.createFilter(FilterType.EQUALS, "promocion", Long
							.valueOf(exc.dameCelda(fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_PROYECTO))));
		}
		...
		if ("fin".equals(exc.dameCelda(fila, 63))) {
			gastoProveedorApi.updateGastoByPrinexLBK(gasto.getIdGasto());
	...
	private void actualizarEntidad(GastoPrinex entidad, Integer columna, MSVHojaExcel exc, int fila)
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_INMUEBLE:
			entidad.setTipoInmueble(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_INMUEBLE));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CONDICIONES:
			entidad.setCondiciones(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CONDICIONES));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_SCTA_EFECTOS:
			entidad.setSctaEfectos(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_SCTA_EFECTOS));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_FRA_SII:
			entidad.setTipoFraSii(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_FRA_SII));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CLAVE_RE_AD1:
			entidad.setClaveReAd1(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CLAVE_RE_AD1));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CLAVE_RE_AD2:
			entidad.setClaveReAd2(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CLAVE_RE_AD2));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_PARTIDA:
			entidad.setTipoPartida(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_TIPO_PARTIDA));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CONCEPTO_FAC:
			entidad.setConceptoFac(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CONCEPTO_FAC));
			break;
		...
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CARACTERISTICA:
			entidad.setCaracteristica(
					dameString(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_CARACTERISTICA));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_BASE:
			entidad.setDiario1Base(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_BASE));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_CUOTA:
			entidad.setDiario1Cuota(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_CUOTA));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_TIPO:
			entidad.setDiario1Tipo(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO1_TIPO));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_BASE:
			entidad.setDiario2Base(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_BASE));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_CUOTA:
			entidad.setDiario2Cuota(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_CUOTA));
			break;
		case MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_TIPO:
			entidad.setDiario2Tipo(
					dameNumero(exc, fila, MSVInfoDetallePrinexLbkExcelValidator.COL_NUM.GPL_DIARIO2_TIPO));
			break;
	...
	private Date dameFecha(MSVHojaExcel exc, int fila, Integer columna) throws IOException, ParseException {
	...
	private Double dameNumero(MSVHojaExcel exc, int fila, Integer columna) throws IOException, ParseException {
	...
	private Long dameLong(MSVHojaExcel exc, int fila, Integer columna) throws IOException, ParseException {
		Long resultado = null;
		if (exc.dameCelda(fila, columna) != null && exc.dameCelda(fila, columna).trim().length() != 0)
	...
	private String dameString(MSVHojaExcel exc, int fila, Integer columna) throws IOException, ParseException {
