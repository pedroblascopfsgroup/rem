...
@Component
public class MSVActualizadorPropuestaPreciosActivo extends AbstractMSVActualizador implements MSVLiberator {
	...
	public String getValidOperation() {
		return MSVDDOperacionMasiva.CODE_FILE_BULKUPLOAD_PROPUESTA_PRECIOS_ACTIVO;
	}
	
	@Override
	public int getFilaInicial() {
		return MSVActualizadorPropuestaPreciosActivo.EXCEL_FILA_INICIAL;
	}
