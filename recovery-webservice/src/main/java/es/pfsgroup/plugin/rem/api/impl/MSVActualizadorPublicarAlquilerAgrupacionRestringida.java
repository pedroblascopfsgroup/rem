...
@Component
public class MSVActualizadorPublicarAlquilerAgrupacionRestringida extends AbstractMSVActualizador implements MSVLiberator {
	...
	public String getValidOperation() {
		return MSVDDOperacionMasiva.CODE_FILE_BULKUPLOAD_AGRUPACION_ALQUILER_RESTRINGIDA;
	}
