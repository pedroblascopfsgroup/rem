...
@Component
public class MSVAgruparActivosProyecto extends AbstractMSVActualizador implements MSVLiberator {
	...
	protected static final Log logger = LogFactory.getLog(MSVAgruparActivosProyecto.class);

	@Override
	public String getValidOperation() {
		return MSVDDOperacionMasiva.CODE_FILE_BULKUPLOAD_AGRUPACION_PROYECTO;
	}
