...
public interface ServiciosWebcomApi {
	 ...
	 */
	public void enviaActualizacionEstadoOferta(Long idRem, Long idWebcom, String codEstadoOferta, Long idActivoHaya, String codEstadoExpediente, Boolean vendido);
