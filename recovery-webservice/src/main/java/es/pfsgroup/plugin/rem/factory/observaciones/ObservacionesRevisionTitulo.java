...
@Component
public class ObservacionesRevisionTitulo extends GridObservaciones implements GridObservacionesApi {

	@Override
	public String getCode() {
		return REVISION_TITULO;
	}

	@Override
	public String[] tiposObservacion() {
		return new String[] { DDTipoObservacionActivo.CODIGO_REVISION_TITULO };
	}
