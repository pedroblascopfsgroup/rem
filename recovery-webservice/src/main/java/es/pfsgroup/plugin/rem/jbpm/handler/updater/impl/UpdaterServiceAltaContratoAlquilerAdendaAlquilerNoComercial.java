...
@Component
public class UpdaterServiceAltaContratoAlquilerAdendaAlquilerNoComercial implements UpdaterService {
    ...
    protected static final Log logger = LogFactory.getLog(UpdaterServiceAltaContratoAlquilerAdendaAlquilerNoComercial.class);
	...
	public String[] getCodigoTarea() {
		return new String[]{CODIGO_T018_ALTA_CONTRATO_ALQUILER_ADENDA};
	}
