...
@Component
public class UpdaterServiceAprobacionContratoAlquilerNoComercial implements UpdaterService {
    ...
    protected static final Log logger = LogFactory.getLog(UpdaterServiceAprobacionContratoAlquilerNoComercial.class);
	...
	public String[] getCodigoTarea() {
		return new String[]{CODIGO_T018_APROBACION_CONTRATO};
	}
