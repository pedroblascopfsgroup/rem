...
@Component
public class UpdaterServiceCalculoRiesgoAlquiler implements UpdaterService {
	...
	private static final String CODIGO_T015_CALCULO_RIESGO = "T015_CalculoRiesgo";
	private static final String COMBO_RIESGO = "comboRiesgo";

	protected static final Log logger = LogFactory.getLog(UpdaterServiceCalculoRiesgoAlquiler.class);
			...
			if(!Checks.esNulo(comboResultado)) {
				...
				if(comboResultado.equals(DDRiesgoOperacion.CODIGO_ROP_NO_APLICA)) {
					...
					estadoBcCodigo = DDEstadoExpedienteBc.CODIGO_INGRESO_FINAL_PDTE_BC;
						...
						||comboResultado.equals(DDRiesgoOperacion.CODIGO_ROP_BAJO)) {
	...
	public String[] getCodigoTarea() {
		return new String[] { CODIGO_T015_CALCULO_RIESGO };
	}
