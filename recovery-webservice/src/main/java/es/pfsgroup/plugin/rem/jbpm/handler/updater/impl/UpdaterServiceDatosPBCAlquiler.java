...
@Component
public class UpdaterServiceDatosPBCAlquiler implements UpdaterService {
	...
	private static final String CODIGO_T015_DATOSPBC = "T015_DatosPBC";
	private static final String COMBO_RESULTADO = "comboResultado";

	protected static final Log logger = LogFactory.getLog(UpdaterServiceDatosPBCAlquiler.class);
	...
	public String[] getCodigoTarea() {
		return new String[] { CODIGO_T015_DATOSPBC };
	}
