...
@Component
public class UpdaterServiceSancionOfertaAlquilerAprobacionOfertaAlquilerComercial implements UpdaterService {
	...
	public String[] getCodigoTarea() {
		return new String[]{CODIGO_T015_APROBACION_OFERTA_ALQUILER_COMERCIAL};
	}
