...
public class ComercialAlquilerUserAssignationService implements UserAssigantionService {
	...
	private static final String CODIGO_T015_APROBACION_OFR_ALQUILER_COMERCIAL = "T015_AprobacionOfertaAlquilerComercial";
	private static final String CODIGO_T015_APROBACION_CLAUSULAS_CLIENTE = "T015_AprobacionClienteClausulas";
	...
	public String[] getCodigoTarea() {
		return new String[]{CODIGO_T015_ACEPTACION_CLIENTE, CODIGO_T015_CIERRE_CONTRATO, 
				...
				CODIGO_T015_PBC, CODIGO_T015_ENVIO_CONTRATO,CODIGO_T015_AGENDAR_FECHA_FIRMA,CODIGO_T015_BLOQUEOSCORING,
				CODIGO_T015_APROBACION_OFR_ALQUILER_COMERCIAL,CODIGO_T015_APROBACION_CLAUSULAS_CLIENTE,
				CODIGO_T015_NEGOCIACION_CLAUSULAS_ALQUILER,CODIGO_T015_ENTREGA_FIANZAS, CODIGO_T015_RESPUESTA_BC_REAGENDACION};
	}
