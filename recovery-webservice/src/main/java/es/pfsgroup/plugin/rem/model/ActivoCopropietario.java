...
/**
 * Modelo que gestiona los copropietarios de los activos
 * 
 * @author Juanjo Arbona
 *
 */
@Entity
@Table(name = "ACT_CPR_COPROPIETARIO", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class ActivoCopropietario implements Serializable, Auditable {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 @Id
	 @Column(name = "CPR_ID")
	 @GeneratedValue(strategy = GenerationType.AUTO, generator = "ActivoCopropietarioGenerator")
	 @SequenceGenerator(name = "ActivoCopropietarioGenerator", sequenceName = "S_ACT_CPR_COPROPIETARIO")
	 private Long id;
	 ...
	 @Column(name = "CPR_APELLIDO1")   
	 private String apellido1;
	 
	 @Column(name = "CPR_APELLIDO2")   
	 ...
	 @Column(name = "CPR_CONTACTO_NOM")
	 private String nombreContacto;
	 
	 @Column(name = "CPR_CONTACTO_TELF1")
	 private String telefono1Contacto;
	 
	 @Column(name = "CPR_CONTACTO_TELF2")
	 private String telefono2Contacto;
	 
	 @Column(name = "CPR_CONTACTO_EMAIL")
	 private String emailContacto;
	 
	 @Column(name = "CPR_CONTACTO_DIR")
	 private String direccionContacto;
	 
	 @Column(name = "CPR_CONTACTO_CP")
	 private Integer codigoPostalContacto;
	
	 @Column(name = "CPR_PAGA_EJECUTANTE")
