...
@Entity
@Table(name = "CFG_COMITE_SANCIONADOR", schema = "${entity.schema}")
@Where(clause = Auditoria.UNDELETED_RESTICTION)
public class CFGComiteSancionador implements Serializable, Auditable {

	private static final long serialVersionUID = 4477763412715784465L;

	@Id
    @Column(name = "CCS_ID")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "ComiteSancionadorGenerator")
    @SequenceGenerator(name = "ComiteSancionadorGenerator", sequenceName = "S_CFG_COMITE_SANCIONADOR")
    private Long id;
