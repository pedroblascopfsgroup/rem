 ...
 */
@Entity
@Table(name = "CVA_CUENTAS_VIRTUALES_ALQUILER", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Where(clause = Auditoria.UNDELETED_RESTICTION)
public class CuentasVirtualesAlquiler implements Serializable, Auditable {

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "CVA_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "CuentasVirtualesAlquilerGenerator")
	@SequenceGenerator(name = "CuentasVirtualesAlquilerGenerator", sequenceName = "S_CVA_CUENTAS_VIRTUALES_ALQUILER")
	private Long id;
	...
	@Column(name = "CVA_FECHA_INICIO")
	private Date fechaInicio;

	@Column(name = "CVA_FECHA_FIN")
