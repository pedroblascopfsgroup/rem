...
public class DtoActivoGridFilter extends WebDto {
	...
	private String numFincaAvanzada;
	...
	private Integer fechaInscripcionReg;
	private String carteraAvanzadaCodigo;
	private String subcarteraAvanzadaCodigo;
	private String nombrePropietario;
	private String docPropietario;
	private Integer ocupado;
	private String conTituloCodigo;
	private Integer fechaPosesion;
	...
	public String getProvinciaAvanzadaCodigo() {
		return provinciaAvanzadaCodigo;
	}
	public void setProvinciaAvanzadaCodigo(String provinciaAvanzadaCodigo) {
		this.provinciaAvanzadaCodigo = provinciaAvanzadaCodigo;
	}
	public String getLocalidadAvanzadaDescripcion() {
		return localidadAvanzadaDescripcion;
	}
	public void setLocalidadAvanzadaDescripcion(String localidadAvanzadaDescripcion) {
		this.localidadAvanzadaDescripcion = localidadAvanzadaDescripcion;
	}
	...
	public String getNumFincaAvanzada() {
		return numFincaAvanzada;
	}
	public void setNumFincaAvanzada(String numFincaAvanzada) {
		this.numFincaAvanzada = numFincaAvanzada;
	}
	...
	public Integer getFechaInscripcionReg() {
		return fechaInscripcionReg;
	}
	public void setFechaInscripcionReg(Integer fechaInscripcionReg) {
		this.fechaInscripcionReg = fechaInscripcionReg;
	}
	public String getCarteraAvanzadaCodigo() {
		return carteraAvanzadaCodigo;
	}
	public void setCarteraAvanzadaCodigo(String carteraAvanzadaCodigo) {
		this.carteraAvanzadaCodigo = carteraAvanzadaCodigo;
	}
	public String getSubcarteraAvanzadaCodigo() {
		return subcarteraAvanzadaCodigo;
	}
	public void setSubcarteraAvanzadaCodigo(String subcarteraAvanzadaCodigo) {
		this.subcarteraAvanzadaCodigo = subcarteraAvanzadaCodigo;
	}
	...
	public Integer getFechaPosesion() {
		return fechaPosesion;
	}
	public void setFechaPosesion(Integer fechaPosesion) {
