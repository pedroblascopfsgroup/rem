...
public class DtoDatosPublicacionAgrupacion extends DtoDatosPublicacionActivo {
	...
	public DtoDatosPublicacionAgrupacion(DtoDatosPublicacionActivo aux) {
		...
		this.setFechaRevisionPublicacionesVenta(aux.getFechaRevisionPublicacionesVenta());
		this.setFechaRevisionPublicacionesAlquiler(aux.getFechaRevisionPublicacionesAlquiler());
	}
