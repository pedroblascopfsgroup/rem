...
@Entity
@Table(name = "MRA_MOTIVO_RESC_ARRAS", schema = "${entity.schema}")
@Where(clause = Auditoria.UNDELETED_RESTICTION)
public class MotivoRescinsionArras implements Serializable, Auditable {
	...
	@Id
    @Column(name = "MRA_ID")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "MotivoRescArrasGenerator")
    @SequenceGenerator(name = "MotivoRescArrasGenerator", sequenceName = "S_MRA_MOTIVO_RESC_ARRAS")
    private Long id;
    ...
    @Column(name = "MRA_INS_TITULO")
    private Boolean inscripcionTitulo;
    
    @Column(name = "MRA_TANTEO_DL")
    private Boolean tanteoDL;
    
    @Column(name = "MRA_CARGAS")
    private Boolean cargas;
    
    @Column(name = "MRA_TEMAS_TECNICOS")
    private Boolean temasTecnicos;
    
    @Column(name = "MRA_POSESION")
    private Boolean posesion;
    
    @Column(name = "MRA_TEMAS_CATASTRALES")
    private Boolean temasCatastrales;
    
    @Column(name = "MRA_AUTOR_VPO")
