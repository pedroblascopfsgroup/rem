...
/**
 * Modelo que gestiona la informacion de los testigos obligatorios.
 * 
 * @author Alejandro Valverde
 *
 */
@Entity
@Table(name = "TOB_TESTIGOS_OBLIGATORIOS", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Where(clause = Auditoria.UNDELETED_RESTICTION)
public class TestigosObligatorios implements Serializable, Auditable {
    ...
    @Column(name = "TOB_PORCENTAJE_DESC")
	private Double porcentajeDescuento;
	 
    @Column(name = "TOB_IMPORTE_MIN")
	private Double importeMinimo;
	 
	@Column(name = "TOB_REQUIERE_TESTIGOS")
	private Boolean requiereTestigos;
	...
	public Boolean getRequiereTestigos() {
		return requiereTestigos;
	}

	public void setRequiereTestigos(Boolean requiereTestigos) {
