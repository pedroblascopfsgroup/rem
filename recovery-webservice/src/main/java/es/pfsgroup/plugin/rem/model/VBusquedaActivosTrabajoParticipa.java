...
public class VBusquedaActivosTrabajoParticipa implements Serializable {
	...
	private Float importeParticipa;
	...
	public Float getImporteParticipa() {
		return importeParticipa;
	}

	public void setImporteParticipa(Float importeParticipa) {
