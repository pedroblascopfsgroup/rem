...
/**
 * Gestiona la vista que identifica los condicionantes de disponibilidad de cada agrupacion
 * 
 * @author Pier Gotta
 *
 */
@Entity
@Table(name = "V_COND_AGR_DISPONIBILIDAD", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Where(clause = Auditoria.UNDELETED_RESTICTION)
public class VCondicionantesAgrDisponibilidad  implements Serializable {
	...
	public void idAgrupacion(Long idAgrupacion) {
