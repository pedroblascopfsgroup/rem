...
@Entity
@Table(name = "V_LISTADO_ACT_EXP_BBVA_GRID", schema = "${entity.schema}")
public class VListadoActivosExpedienteBbvaGrid implements Serializable{
