...
/**
 * Modelo que gestiona el diccionario de Canales de prescripción de una oferta.
 * 
 * @author Luis Caballero
 *
 */
@Entity
@Table(name = "DD_CAP_CANAL_PRESCRIPCION", schema = "${entity.schema}")
...
public class DDCanalPrescripcion implements Auditable, Dictionary {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDCanalPrescripcionGenerator")
	@SequenceGenerator(name = "DDCanalPrescripcionGenerator", sequenceName = "S_DD_CAP_CANAL_PRESCRIPCION")
	private Long id;
