...
public class DDComiteSancion implements Auditable, Dictionary {
	...
	public static final String CODIGO_COMITE_DIVARIAN_ARROW = "40";
	public static final String CODIGO_COMITE_DIVARIAN_REMAINING = "41";
	//public static final String CODIGO_COMITE_DIVARIAN_APPLE = "42";
