...
/**
 * Modelo que gestiona el diccionario de TIPOS DE DESTINATARIO DE UN GASTO
 */
@Entity
@Table(name = "DD_DEG_DESTINATARIOS_GASTO", schema = "${entity.schema}")
...
public class DDDestinatarioGasto implements Auditable, Dictionary {
	...
	@Column(name = "DD_DEG_DESCRIPCION_LARGA")   
