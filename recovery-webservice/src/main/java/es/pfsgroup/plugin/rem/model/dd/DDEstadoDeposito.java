...
@Entity
@Table(name = "DD_EDP_EST_DEPOSITO", schema = "${entity.schema}")
...
public class DDEstadoDeposito implements Auditable, Dictionary {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDEstadoDepositoGenerator")
	@SequenceGenerator(name = "DDEstadoDepositoGenerator", sequenceName = "S_DD_EDP_EST_DEPOSITO")
	private Long id;
