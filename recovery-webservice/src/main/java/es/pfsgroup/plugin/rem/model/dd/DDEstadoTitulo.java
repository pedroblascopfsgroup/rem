...
/**
 * Modelo que gestiona el diccionario de los estados de los títulos
 * 
 * @author Anahuac de Vicente
 *
 */
@Entity
@Table(name = "DD_ETI_ESTADO_TITULO", schema = "${entity.schema}")
...
public class DDEstadoTitulo implements Auditable, Dictionary {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDEstadoTituloGenerator")
	@SequenceGenerator(name = "DDEstadoTituloGenerator", sequenceName = "S_DD_ETI_ESTADO_TITULO")
	private Long id;
	   
	@Column(name = "DD_ETI_CODIGO")   
	private String codigo;
	 
	@Column(name = "DD_ETI_DESCRIPCION")   
	private String descripcion;
	    
	@Column(name = "DD_ETI_DESCRIPCION_LARGA")   
