 ...
 */
@Entity
@Table(name = "DD_EVI_ESTADOS_VISITA", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDEstadosVisita implements Auditable, Dictionary {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDEstadosVisitaGenerator")
	@SequenceGenerator(name = "DDEstadosVisitaGenerator", sequenceName = "S_DD_EVI_ESTADOS_VISITA")
	private Long id;
	...
	@Column(name = "DD_EVI_DESCRIPCION_LARGA")   
