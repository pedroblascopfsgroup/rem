 ...
 */
@Entity
@Table(name = "DD_MRA_MOTIVO_REAGENDACION", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDMotivoReagendacion implements Auditable, Dictionary {

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "DD_MRA_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDMotivoReagendacionGenerator")
	@SequenceGenerator(name = "DDMotivoReagendacionGenerator", sequenceName = "S_DD_MRA_MOTIVO_REAGENDACION")
	private Long id;
