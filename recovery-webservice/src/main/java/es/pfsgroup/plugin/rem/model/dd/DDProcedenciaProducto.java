...
public class DDProcedenciaProducto implements Auditable, Dictionary {
	...
	public static final String COD_CREDITICIO = "01";
	public static final String COD_NO_CREDITICIO = "02";

	@Id
	@Column(name = "DD_PRP_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDProcedenciaProductoGenerator")
	@SequenceGenerator(name = "DDProcedenciaProductoGenerator", sequenceName = "S_DD_PRP_PROCEDENCIA_PRODUCTO")
	private Long id;
