 ...
 */
@Entity
@Table(name = "DD_REM_REGIMENES_MATRIMONIALES", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDRegimenesMatrimoniales implements Auditable, Dictionary {
	

	private static final long serialVersionUID = 1L;
	
	public static String COD_GANANCIALES = "01";
	...
	@Column(name = "DD_REM_DESCRIPCION")   
	private String descripcion;
	    
	@Column(name = "DD_REM_DESCRIPCION_LARGA")   
