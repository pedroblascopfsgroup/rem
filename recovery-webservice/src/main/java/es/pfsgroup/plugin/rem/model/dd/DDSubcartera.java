...
public class DDSubcartera implements Auditable, Dictionary {
	...
	public static final String CODIGO_DIVARIAN = "150";
	public static final String CODIGO_DIVARIAN_ARROW = "151";
	public static final String CODIGO_DIVARIAN_REMAINING = "152";
