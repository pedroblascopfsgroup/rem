...
/**
 * Modelo que gestiona el diccionario de Tipo de Bulk Advisory Note
 * @author Cristian Montoya
 *
 */
@Entity
@Table(name = "DD_TBK_TIPO_BULK_AN", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDTipoBulkAdvisoryNote implements Auditable, Dictionary {
    ...
    @Column(name = "DD_TBK_CODIGO")   
	private String codigo;
	 
	@Column(name = "DD_TBK_DESCRIPCION")   
	private String descripcion;
	    
	@Column(name = "DD_TBK_DESCRIPCION_LARGA")   
