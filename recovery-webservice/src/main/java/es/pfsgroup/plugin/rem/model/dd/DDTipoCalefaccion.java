...
/**
 * Modelo que gestiona el diccionario de tipo calefaccion
 * 
 * @author Ivan Repiso
 *
 */
...
public class DDTipoCalefaccion implements Auditable, Dictionary {
	...
	public static final String COD_GAS_NATURAL ="01";
	public static final String COD_BOMBA_CALOR ="02";
	public static final String COD_ELECTRICA ="03";
	public static final String COD_SUELO_RADIANTE ="04";
