 ...
 */
@Entity
@Table(name = "DD_TCR_TIPO_CARTERA_RESCISION", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDTipoCarteraRescision implements Auditable, Dictionary {
	
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "DD_TCR_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoCarteraRescisionGenerator")
	@SequenceGenerator(name = "DDTipoCarteraRescisionGenerator", sequenceName = "S_DD_TCR_TIPO_CARTERA_RESCISION")
	private Long id;
