...
@Entity
@Table(name = "DD_TCC_TIPO_CUOTA_COM", schema = "${entity.schema}")
...
public class DDTipoCuotaComunidad implements Auditable, Dictionary{
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoCuotaComunidadGenerator")
	@SequenceGenerator(name = "DDTipoCuotaComunidadGenerator", sequenceName = "S_DD_TCC_TIPO_CUOTA_COM")
	private Long id;
