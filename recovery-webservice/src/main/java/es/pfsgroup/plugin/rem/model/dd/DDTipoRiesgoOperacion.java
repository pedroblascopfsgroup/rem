 ...
 */
@Entity
@Table(name = "DD_RIO_RIESGO_OPERACION", schema = "${entity.schema}")
...
public class DDTipoRiesgoOperacion implements Auditable, Dictionary {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoRiesgoOperacionGenerator")
	@SequenceGenerator(name = "DDTipoRiesgoOperacionGenerator", sequenceName = "S_DD_RIO_RIESGO_OPERACION")
	private Long id;
