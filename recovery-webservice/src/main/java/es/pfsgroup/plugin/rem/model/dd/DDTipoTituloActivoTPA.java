...
public class DDTipoTituloActivoTPA implements Serializable, Auditable, Dictionary {
    ...
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTipoTituloActivoTPAGenerator")
    @SequenceGenerator(name = "DDTipoTituloActivoTPAGenerator", sequenceName = "S_DD_TPA_TIPO_TITULO_ACT")
    private Long id;
