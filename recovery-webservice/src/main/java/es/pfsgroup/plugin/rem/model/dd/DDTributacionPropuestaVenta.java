...
@Entity
@Table(name = "DD_TPV_TRIBUT_PROP_VENTA", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@Where(clause=Auditoria.UNDELETED_RESTICTION)
public class DDTributacionPropuestaVenta implements Auditable, Serializable {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "DDTributacionPropuestaVentaGenerator")
	@SequenceGenerator(name = "DDTributacionPropuestaVentaGenerator", sequenceName = "S_DD_TPV_TRIBUT_PROP_VENTA")
	private Long id;
