...
public abstract class ClienteWebcomBase {
	...
	protected Map<String, Object> send(HttpClientFacade httpClient, WebcomEndpoint endpoint, ParamsList paramsList)
		...
		try {
			...
			String signature = WebcomSignatureUtils.computeSignatue(endpoint.getApiKey(), getPublicAddress(),
					requestBody.toString());
			logger.debug("Cálculo del signature [apiKey=" + endpoint.getApiKey() + ", ip=" + getPublicAddress()
					+ "] => " + signature);
