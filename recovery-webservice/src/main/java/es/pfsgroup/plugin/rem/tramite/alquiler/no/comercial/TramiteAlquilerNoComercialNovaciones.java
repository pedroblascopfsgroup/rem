...
@Component
public class TramiteAlquilerNoComercialNovaciones extends TramiteAlquilerNoComercialAbstract implements TramiteAlquilerNoComercial {

	private final Log logger = LogFactory.getLog(TramiteAlquilerNoComercialNovaciones.class);
