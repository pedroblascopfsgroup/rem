...
public interface AgrupacionValidator extends GenericService{
	...
	public static final String ERROR_EN_OTRA_ASISTIDA = "El activo pertenece a otra agrupación asistida vigente";
	...
	public static final String ERROR_OFERTA_ACTIVO_ACEPTADA = "El activo tiene un expediente comercial aprobado y no puede ser incluido";
