...
public class ConformacionAsuntoTab extends ElementoDinamicoPorFuncion {
    ...
    private boolean tieneAnalisisDePoliticas(Object id) {
        ...
        Boolean puedeVerDecisionComite = (Boolean) executor.execute("asuntosManager.puedeVerDecisionComite", id);
        return asunto != null && asunto.getEstaPropuesto() && puedeVerDecisionComite;
    }
