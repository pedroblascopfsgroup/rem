...
(function(){
    ...
    var comite =app.creaLabel('<s:message code="decisioncomite.consulta.comite" text="**Comite" />','${asunto.comite.nombre}');    
			...
			win = app.openWindow(
				{
					...
					params: {idAsuntoOrigen:${asunto.id},idExpediente:${asunto.expediente.id}},
					/*				
