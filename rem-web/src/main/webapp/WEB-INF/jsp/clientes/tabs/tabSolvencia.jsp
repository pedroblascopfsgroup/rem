	...
	panel.on('render', function()
	{
		...
		//AGREGAR FUNCION de visibilidad de este boton VERIFICAR_BIEN	
			var btnVerificarBien = new Ext.Button({
                ...
                ,cls: 'x-btn-text-icon'
				//Por ahora dejamos el boton deshabilitado, pues PFS no dispondrá de momento de servidor SMTP para enviar mails de verificacion
				//,disabled:true
                ,handler : function(){
		...
		var bienesCm = new Ext.grid.ColumnModel([
			...
			{   header: '<s:message code="clientes.consultacliente.solvenciaTab.fechaVerificacion" text="**Fecha Verificacióm"/>',
		...
		<sec:authorize ifAllGranted="EDITAR_SOLVENCIA">
			bienesGrid.getBottomToolbar().addButton([btnAgregarBien, btnEditarBien, btnBorrarBien]);
		</sec:authorize>
