/* tab de ejemplo
  ...
  el tab se define en una funcion que recibe el objeto page (para crear stores mediante page.getStore) y entidad (para enlazar con los datos de la entidad que representa)

  la funcion debe devolver un panel

  el panel debe implementar las funciones :
    - getValue 
    - setValue
*/
