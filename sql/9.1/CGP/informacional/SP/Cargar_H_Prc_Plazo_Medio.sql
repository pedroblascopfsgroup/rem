...
DROP PROCEDURE IF EXISTS `Cargar_H_Prc_Plazo_Medio` $$
...
CREATE DEFINER=`bi_cdd`@`62.15.160.14` PROCEDURE `Cargar_H_Prc_Plazo_Medio`(IN date_start Date, IN date_end Date, OUT o_error_status varchar(500))
MY_BLOCK_H_PCR_PLA_MED: BEGIN
	...
	VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'TRUNCATE TABLE TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
	VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'INSERT INTO TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	FETCH C_FECHA INTO FECHA;        
		...
		-- ===============================================================================================
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'INSERT INTO TMP_PRC_TAREA_PM_ALL', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'INSERT INTO TMP_PRC_TAREA_PM_INT', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'UPDATE TMP_PRC_TAREA_PM_ALL => FECHA_CONFOR_ASUNTO', CURDATE(), CURTIME(), NULL, NULL);
	...
	*/
	...
	/* EJD:> Descartamos del análisis la Interposición dado que no tenemos tarea estable válida de calculo inicial.
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'P01_AutoDespachandoEjecucion -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'P01_ConfirmarNotificacionReqPago -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'oposición del deudor -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'solicitud subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'anuncio subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'celebración subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'cesión de remate -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'solicitud adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'solicitud de posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'lanzamiento -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'tasación de costas -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'liquidación de intereses -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
...
*/
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'insert into TMP_PLAZO_MEDIO_BYPASS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'insert into TMP_PLAZO_MEDIO', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'update TMP_PLAZO_MEDIO tpm => tpm.FECHA_INTERPOS_DEMANDA', CURDATE(), CURTIME(), NULL, NULL);
...
/*
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'update TMP_PLAZO_MEDIO tpm (FECHA_INTERPOS_DEMANDA= FECHA_CONFOR_ASUNTO)', CURDATE(), CURTIME(), NULL, NULL);
...
*/   	
	...
	-- ===============================================================================================
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'update TMP_PLAZO_MEDIO => FECHA_VALOR_TAREA', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'update TMP_PLAZO_MEDIO => NUM_DIAS_INTERPOS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Prc_Plazo_Medio', 'PASO A PRODUCCION', CURDATE(), CURTIME(), NULL, NULL);
...
-- ULT_TAR_CREADA_DESC_ID _> Esta nos dará la descripcion de la tarea finalizada.
