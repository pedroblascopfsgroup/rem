...
DROP PROCEDURE IF EXISTS `Cargar_H_Tareas` $$
...
CREATE DEFINER=`bi_cdd`@`62.15.160.14` PROCEDURE `Cargar_H_Tareas`(IN date_start Date, IN date_end Date, OUT o_error_status varchar(500))
MY_BLOCK_H_TAR: BEGIN
	...
	-- Fecha última modificación: 02/04/2015
	-- Motivos del cambio: Incluimos el histórico de la tabla de Hechos de Tareas.
	...
	VALUE (  'Cargar_H_Tareas', 'TRUNCATE TABLE TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
	VALUE (  'Cargar_H_Tareas', 'INSERT INTO TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	FETCH C_FECHA INTO FECHA;        
		...
		-- ===============================================================================================
		-- 2) Tabla temporal con todas las tareas : TMP_PRC_TAREA_PM_ALL 
		-- 		Recogemos todas las tareas NO comenzadas AÚN.
		-- ===============================================================================================
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'INSERT INTO TMP_PRC_TAREA_PM_ALL', CURDATE(), CURTIME(), NULL, NULL);
		
		INSERT INTO TMP_PRC_TAREA_PM_ALL (FECHA, ITER, FASE, TAREA, FECHA_INI, FECHA_FIN, FECHA_VENCIMIENTO, FECHA_VENCIMIENTO_REAL, DESCRIPCION_TAREA, ENTIDAD_CEDENTE_ID)
		SELECT 
			FECHA,
			TPJ.ITER, 
			TPJ.FASE_ACTUAL, 
			...
			COALESCE(TAR.TAR_FECHA_VENC, '0000-00-00 00:00:00'),
			COALESCE(TAR.TAR_FECHA_VENC_REAL, '0000-00-00 00:00:00'),    
			TAR.TAR_TAREA, 
		...
		SELECT 
			...
			COALESCE(TAR2.TAR_FECHA_VENC, '0000-00-00 00:00:00'),
			COALESCE(TAR2.TAR_FECHA_VENC_REAL, '0000-00-00 00:00:00'),   			
			TAR2.TAR_TAREA, 
		...
		SELECT 
			...
			COALESCE(TAR3.TAR_FECHA_VENC, '0000-00-00 00:00:00'),
			COALESCE(TAR3.TAR_FECHA_VENC_REAL, '0000-00-00 00:00:00'),   			
			TAR3.TAR_TAREA, 
		...
		SELECT 
			...
			COALESCE(TAR4.TAR_FECHA_VENC, '0000-00-00 00:00:00'),
			COALESCE(TAR4.TAR_FECHA_VENC_REAL, '0000-00-00 00:00:00'),   					
			TAR4.TAR_TAREA, 
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'INSERT INTO TMP_PRC_TAREA_PM_INT', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO `bi_cdd_dwh`.`H_TAR`(
			...
			TPT.FECHA, -- <{DIA_ID: }>,
			TPT.FECHA, -- <{FECHA_CARGA_DATOS: }>,
			TPT.ITER, -- <{PROCEDIMIENTO_ID: }>,
			TPT.FASE, -- <{FASE_MAX_PRIORIDAD: }>,
			NULL ASUNTO_ID,
			TPT.ITER, -- <{ITER: }>,
			TPT.FASE, -- <{FASE: }>,
			TPT.TAREA, -- <{TAREA: }>,
			TPT.FECHA_INI, -- <{FECHA_INI: }>,
			TPT.FECHA_FIN, -- <{FECHA_FIN: }>,
			TPT.FECHA_VENCIMIENTO, 
			TPT.FECHA_VENCIMIENTO_REAL,
			TPT.DESCRIPCION_TAREA,  -- <{DESCRIPCION_TAREA: }>,
			TPT.TAP_ID, -- <{TAP_ID: }>,
			TPT.TEX_ID,  -- <{TEX_ID: }>,
			TPT.DESCRIPCION_FORMULARIO, -- <{DESCRIPCION_FORMULARIO: }>,
			TPT.FECHA_FORMULARIO, -- <{FECHA_FORMULARIO: }>,	
			CASE
				WHEN TPT.FECHA_FIN > TPT.FECHA_VENCIMIENTO THEN 1 -- Incumplido
				ELSE 0 -- Cumplido
			END CUMPLIMIENTO,
			TPT.ENTIDAD_CEDENTE_ID -- <{ENTIDAD_CEDENTE_ID: }>
		FROM TMP_PRC_TAREA_PM_INT TPT
		WHERE TPT.FECHA = FECHA
		;
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'UPDATE TMP_PRC_TAREA_PM_ALL => FECHA_CONFOR_ASUNTO', CURDATE(), CURTIME(), NULL, NULL);
	...
	*/
	...
	/* EJD:> Descartamos del análisis la Interposición dado que no tenemos tarea estable válida de calculo inicial.
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'P01_AutoDespachandoEjecucion -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'P01_ConfirmarNotificacionReqPago -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'oposición del deudor -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'solicitud subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'anuncio subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'celebración subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'cesión de remate -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'solicitud adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'solicitud de posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'lanzamiento -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'tasación de costas -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE (  'Cargar_H_Tareas', 'liquidación de intereses -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
...
*/
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'insert into TMP_PLAZO_MEDIO_BYPASS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'insert into TMP_PLAZO_MEDIO', CURDATE(), CURTIME(), NULL, NULL);
	...
	(
		...
		FASE_ACTUAL_DETALLE_ID, NUM_DIAS_INTERPOS2
	) 
		SELECT 
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'update TMP_PLAZO_MEDIO tpm => tpm.FECHA_INTERPOS_DEMANDA', CURDATE(), CURTIME(), NULL, NULL);
...
/*
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'update TMP_PLAZO_MEDIO tpm (FECHA_INTERPOS_DEMANDA= FECHA_CONFOR_ASUNTO)', CURDATE(), CURTIME(), NULL, NULL);
...
*/   	
	...
	-- ===============================================================================================
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'update TMP_PLAZO_MEDIO => FECHA_VALOR_TAREA', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'update TMP_PLAZO_MEDIO => NUM_DIAS_INTERPOS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE (  'Cargar_H_Tareas', 'PASO A PRODUCCION', CURDATE(), CURTIME(), NULL, NULL);
	...
	fetch c_meses INTO mes;        
		...
		INSERT INTO `bi_cdd_dwh`.`H_TAR_MES` (
			`MES_ID`,
			`FECHA_CARGA_DATOS`,
			`PROCEDIMIENTO_ID`,
			`FASE_MAX_PRIORIDAD`,
	...
	fetch c_trimestre INTO trimestre;        
		...
		INSERT INTO `bi_cdd_dwh`.`H_TAR_TRIMESTRE` (
			`TRIMESTRE_ID`,
			`FECHA_CARGA_DATOS`,
			`PROCEDIMIENTO_ID`,
			`FASE_MAX_PRIORIDAD`,
	...
	fetch c_anio INTO anio;        
		...
		INSERT INTO `bi_cdd_dwh`.`H_TAR_ANIO` (
			`ANIO_ID`,
			`FECHA_CARGA_DATOS`,
			`PROCEDIMIENTO_ID`,
			`FASE_MAX_PRIORIDAD`,
