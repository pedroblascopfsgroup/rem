...
DROP PROCEDURE IF EXISTS `Cargar_H_Procedimiento_Especifico2` $$

CREATE DEFINER=`bi_cdd`@`62.15.160.14` PROCEDURE `Cargar_H_Procedimiento_Especifico2`(IN date_start Date, IN date_end Date, OUT o_error_status varchar(500))
MY_BLOCK_H_PCR_ESP2: BEGIN
	...
	-- Reseteamos la tabla de control de tiempos.

	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
	VALUE ( 'Cargar_H_Procedimiento_Especifico', 'TRUNCATE TABLE TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
	VALUE ( 'Cargar_H_Procedimiento_Especifico', 'INSERT INTO TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
	...
	FETCH C_FECHA INTO FECHA;        
		...
		-- ===============================================================================================
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
	VALUE ( 'Cargar_H_Procedimiento_Especifico2', 'TRUNCATE TABLE TMP_PRC_JERARQUIA_PM', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'INSERT INTO TMP_PRC_TAREA_PM_INT', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'UPDATE TMP_PRC_TAREA_PM_ALL => FECHA_CONFOR_ASUNTO', CURDATE(), CURTIME(), NULL, NULL);
	...
	*/
	...
	/* EJD:> Descartamos del análisis la Interposición dado que no tenemos tarea estable válida de calculo inicial.
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'P01_AutoDespachandoEjecucion -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'P01_ConfirmarNotificacionReqPago -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'oposición del deudor -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		*/		
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'solicitud subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'anuncio subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'celebración subasta -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'cesión de remate -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'solicitud adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'adjudicación -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'solicitud de posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'posesión -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'lanzamiento -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'tasación de costas -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
		...
		INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
			VALUE ( 'Cargar_H_Procedimiento_Especifico', 'liquidación de intereses -- ABANCA', CURDATE(), CURTIME(), NULL, NULL);
...
*/
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'insert into TMP_PLAZO_MEDIO_BYPASS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'insert into TMP_PLAZO_MEDIO', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'update TMP_PLAZO_MEDIO tpm => tpm.FECHA_INTERPOS_DEMANDA', CURDATE(), CURTIME(), NULL, NULL);
...
/*
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'update TMP_PLAZO_MEDIO tpm (FECHA_INTERPOS_DEMANDA= FECHA_CONFOR_ASUNTO)', CURDATE(), CURTIME(), NULL, NULL);
...
*/   	
	...
	-- ===============================================================================================
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'update TMP_PLAZO_MEDIO => FECHA_VALOR_TAREA', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'update TMP_PLAZO_MEDIO => NUM_DIAS_INTERPOS', CURDATE(), CURTIME(), NULL, NULL);
	...
	INSERT INTO TIMER_ANALIZE_SP ( `NAME_SP`, `STEP_SP`, `TIME_EXECUTE`, `TIME_START_EXECUTE`, `TIME_END_EXECUTE`, `TIME_DIFF_EXECUTE`) 
		VALUE ( 'Cargar_H_Procedimiento_Especifico', 'PASO A PRODUCCION', CURDATE(), CURTIME(), NULL, NULL);
