...
DROP PROCEDURE IF EXISTS `Truncar_H_Procedimiento_Especifico` $$
...
CREATE DEFINER=`bi_cdd`@`62.15.160.14` PROCEDURE `Truncar_H_Procedimiento_Especifico`(OUT o_error_status varchar(500))
