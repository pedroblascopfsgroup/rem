...
VALUES (1,''01'',''SIN ACCION'',''SIN ACCION'',''NO'',0,''GEST'',SYSDATE,0 )
';
EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
...
VALUES (2,''02'',''NO LOCALIZADO'',''NO LOCALIZADO'',''NO'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (3,''03'',''CONTACTADO / EN NEGOCIACION'',''CONTACTADO / EN NEGOCIACION'',''SI'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (4,''04'',''COMPROMISO DE PAGO'',''COMPROMISO DE PAGO'',''SI'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (5,''05'',''ADECUACION'',''ADECUACION'',''SI'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (6,''06'',''DACION EN PAGO'',''DACION EN PAGO'',''SI'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (7,''07'',''CANCELACION CON QUITA'',''CANCELACION CON QUITA'',''NO'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (8,''08'',''PASE A LITIGIO'',''PASE A LITIGIO'',''NO'',0,''GEST'',SYSDATE,0)
';EXECUTE IMMEDIATE 'INSERT INTO '|| V_ESQUEMA ||'.DD_TAF_TIPO_ACTUACION_FSR 
(    
DD_TAF_ID,
DD_TAF_CODIGO,
...
VALUES (9,''09'',''PREFALLIDO'',''PREFALLIDO'',''NO'',0,''GEST'',SYSDATE,0)
';
...
VALUES (10,''99'',''ILOCALIZABLE'',''ILOCALIZABLE'',''NO'',0,''GEST'',SYSDATE,0)
';
