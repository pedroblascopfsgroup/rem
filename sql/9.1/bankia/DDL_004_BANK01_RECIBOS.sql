...
BEGIN
    ...
    select count(1) into V_NUM_TABLAS from USER_tables where table_name = 'RCB_RECIBOS_LIQ';
    ...
    CREATE TABLE '|| V_ESQUEMA ||'.RCB_RECIBOS_LIQ
      (
	    ...
	    --CONSTRAINT PK_RCB_PCO_LIQ_ID    PRIMARY KEY (RCB_PCO_LIQ_ID),
		CONSTRAINT RCB_UNIQUE_LIQ_EXTERN_ID UNIQUE (RCB_XCOEMP,RCB_COPSER,RCB_IDPRIG,RCB_IDCOEC,RCB_FEVACM,RCB_FEPEAU,RCB_CLLIQ1)				)	 ' ; 
