...
BEGIN
    ...
    select count(1) into V_NUM_TABLAS from USER_tables where table_name = 'INC_INTERESES_CONTRATO_LIQ';
    ...
    CREATE TABLE '|| V_ESQUEMA ||'.INC_INTERESES_CONTRATO_LIQ
      (
	    ...
	    --CONSTRAINT PK_INC_PCO_LIQ_ID    PRIMARY KEY (INC_PCO_LIQ_ID),
		CONSTRAINT INC_UNIQUE_LIQ_EXTERN_ID UNIQUE (INC_XCOEMP,INC_COPSER,INC_IDPRIG,INC_IDCOEC,INC_FEVACM,INC_FEPEAU,INC_CLLIQ1)						   ) ' ; 
