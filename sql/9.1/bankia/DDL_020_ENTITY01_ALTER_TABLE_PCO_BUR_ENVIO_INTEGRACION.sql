...
DECLARE
    ...
    IF V_NUM_TABLAS = 1 THEN
    		...
    		IF V_NUM_TABLAS = 0 THEN
	            V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.PCO_BUR_ENVIO_INTEGRACION ADD ID_ASUNTO_RCV NUMBER(16,0)';
    ...
    IF V_NUM_TABLAS = 1 THEN
    		...
    		--si no existe la columna la creamos
    		IF V_NUM_TABLAS = 0 THEN
	            V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.PCO_BUR_ENVIO_INTEGRACION ADD PCO_BUR_FICHERO_DOC VARCHAR2(100 CHAR)';
	            EXECUTE IMMEDIATE V_MSQL;
