...
DECLARE
 ...
 V_SCHEMA_MASTER VARCHAR(25) := 'BANKMASTER';
 V_SCHEMA VARCHAR(25) := 'BANK01'; 
...
--Validamos si la tabla existe antes de crearla
  ...
  IF V_EXISTE = 1 THEN   
     EXECUTE IMMEDIATE ('DROP TABLE '||V_SCHEMA||'.'||TABLA1|| ' cascade constraints');
...
--  TABLESPACE '||TABLE_SPACE||'';
  ...
  IF V_EXISTE = 1 THEN   
     EXECUTE IMMEDIATE ('DROP TABLE '||V_SCHEMA||'.'||TABLA2||' cascade constraints' );
