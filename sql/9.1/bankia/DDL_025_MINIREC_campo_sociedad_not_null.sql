...
--## INCIDENCIA_LINK=BKREC-1149
--## PRODUCTO=NO
--##########################################
--*/
39d484772e826de228227dff613a9e93d242a952
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[START] ALTER TABLE MINIRECOVERY_PREP_PRELIT_RCV campo SOCIEDAD');
            
    EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA_MIN||'.MINIRECOVERY_PREP_PRELIT_RCV MODIFY(SOCIEDAD NULL)';
