...
-- */
execute immediate 'update '||V_ESQUEMA||'.tap_Tarea_procedimiento set usuariomodificar=''BKREC-1133'', fechamodificar=sysdate, tap_script_validacion=''!asuntoConProcurador() ? ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe registrar el procurador que representa a la entidad en la ficha del asunto correspondiente.</div>'''' : null'', usuariomodificar=''BKREC-1133'', FECHAMODIFICAR=SYSDATE where tap_codigo=''P15_InterposicionDemandaMasBienes''';

execute immediate 'update '||V_ESQUEMA||'.tap_Tarea_procedimiento set usuariomodificar=''BKREC-1133'', fechamodificar=sysdate, tap_script_validacion=''!asuntoConProcurador() ? ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe registrar el procurador que representa a la entidad en la ficha del asunto correspondiente.</div>'''' : null '', usuariomodificar=''BKREC-1133'', FECHAMODIFICAR=SYSDATE where tap_codigo=''P16_InterposicionDemanda''';
