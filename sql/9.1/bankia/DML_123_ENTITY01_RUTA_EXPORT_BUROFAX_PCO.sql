...
DBMS_OUTPUT.PUT_LINE('[INICIO]');
	...
	V_SQL := ' SELECT COUNT(1) FROM '||V_ESQUEMA||'.PEN_PARAM_ENTIDAD WHERE PEN_PARAM = ''directorioPdfBurofaxPCO''';
    ...
    ELSE        
      V_SQL := 'Insert into '||V_ESQUEMA||'.PEN_PARAM_ENTIDAD
 			...
 			Values
   			('||V_ESQUEMA||'.s_pen_param_entidad.nextval, ''directorioPdfBurofaxPCO'', ''/datos/usuarios/recovecp/pfs/burofax'', ''Directorio donde se almacenan los acrhivos pdf de los BUROFAXES'', 0, ''DD'', sysdate, 0)';
