...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P421','P421_AsignarLetradoConcurso','plugin/precontencioso/tramite/asignarLetradoConcurso','comprobarExistenciaGestor() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><p>&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe asignar al asunto un letrado (gestor externo) .</p></div>'' ',null,null,null,'0','Asignar letrado para concurso','0','PRODUCTO-541','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
       T_TIPO_TAP('P421','P421_RevisarTurnadoLetradoConcurso','plugin/precontencioso/tramite/revisarTurnadoLetradoConcurso','comprobarExistenciaGestor() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><p>&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe asignar al asunto un letrado (gestor externo) .</p></div>'' ',null,null,null,'0','Revisar turnado de letrado para concurso','0','PRODUCTO-541','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
