...
DECLARE
    ...
    V_CODIGO_STA2 VARCHAR2(50 CHAR) := 'TD_SUP_PCO';
...
IF V_NUM_TABLAS > 0 THEN				
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO '||
		' SET DD_STA_ID = (SELECT DD_STA_ID FROM '||V_ESQUEMA_M||'.DD_STA_SUBTIPO_TAREA_BASE WHERE DD_STA_CODIGO=''' || V_CODIGO_STA1 || '''), DD_TSUP_ID = (SELECT DD_STA_ID FROM '||V_ESQUEMA_M||
		'.DD_STA_SUBTIPO_TAREA_BASE WHERE DD_STA_CODIGO=''' || V_CODIGO_STA1 || ''')
...
IF V_NUM_TABLAS > 0 THEN				
	DBMS_OUTPUT.PUT_LINE('[INICIO] '||V_ESQUEMA||'.DD_STA_SUBTIPO_TAREA_BASE... Actualizar TAP_TAREA_PROCEDIMIENTO');
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO '||
		' SET DD_STA_ID = (SELECT DD_STA_ID FROM '||V_ESQUEMA_M||'.DD_STA_SUBTIPO_TAREA_BASE WHERE DD_STA_CODIGO=''' || V_CODIGO_STA2 || '''), DD_TSUP_ID = (SELECT DD_STA_ID FROM '||V_ESQUEMA_M||
		'.DD_STA_SUBTIPO_TAREA_BASE WHERE DD_STA_CODIGO=''' || V_CODIGO_STA2 || ''')
