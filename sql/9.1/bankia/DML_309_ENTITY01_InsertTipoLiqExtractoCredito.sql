...
--## INCIDENCIA_LINK=BKREC-1754
--## PRODUCTO=NO
--## Finalidad: DML , Inserción del tipo de liquidación EXTRACTO CREDITO
--##           
...
IF V_NUM_TABLAS = 0 THEN
    ...
    EXECUTE IMMEDIATE V_INSERT || ' ('||V_ESQUEMA||'.S_DD_PCO_LIQ_TIPO.nextval, ''EXTRACTO'', ''EXTRACTO CREDITO Descripcion'', ''EXTRACTO CREDITO Descripcion'',''EXTRACTO_CREDITO.docx'',''INICIAL'',sysdate) ';
END IF;
