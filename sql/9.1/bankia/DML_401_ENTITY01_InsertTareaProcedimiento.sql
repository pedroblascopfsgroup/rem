...
BEGIN	
    ...
    IF V_NUM_TABLAS > 0 THEN
		...
		V_SQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET DD_TPO_ID_BPM = (SELECT DD_TPO_ID FROM '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO = ''P421'') WHERE  TAP_CODIGO = ''P412_BPMTramiteAceptacionV4'' ';
