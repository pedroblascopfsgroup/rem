...
SET DD_EDE_ID = (SELECT DD_EDE_ID FROM BANKMASTER.DD_EDE_ESTADOS_DECISION WHERE DD_EDE_DESCRIPCION = 'ACEPTADO'), USUARIOMODIFICAR = 'BKREC-1726', FECHAMODIFICAR = SYSDATE
