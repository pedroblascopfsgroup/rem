 ...
 BEGIN
    ...
    IF table_count = 1 THEN
    		...
    		IF v_column_count = 0 THEN
	            ...
	            DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA_MINIREC || '.PCO_BUR_ENVIO_INTEGRACION columna FECHA_INICIO_SITUACION añadida');
	        ELSE
	        	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA_MINIREC || '.PCO_BUR_ENVIO_INTEGRACION columna FECHA_INICIO_SITUACION ya existe');
	        END IF;	
    ELSE	
		    DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA_MINIREC || '.PCO_BUR_ENVIO_INTEGRACION... La tabla NO existe.');
    END IF;
