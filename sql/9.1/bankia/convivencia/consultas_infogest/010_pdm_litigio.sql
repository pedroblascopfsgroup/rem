...
MERGE INTO MINIREC.RCV_GEST_PDM_LITIGIO RCV
      USING (
		 select * from (
		 SELECT DPR.PRC_ID, DPR.DD_DFI_ID, DFI.DD_DFI_DESCRIPCION, TRUNC(GREATEST(DPR.FECHACREAR, NVL(DPR.FECHAMODIFICAR,to_date('01/01/1900','DD/MM/RRRR')))) FECHAMODIFICAR, 
