...
SELECT DISTINCT
  ...
  , CASE WHEN (FECHA_FINALIZACION.FECHAMODIFICAR IS NULL AND DD_EAS.DD_EAS_CODIGO IN ('05', '06')) THEN ULT_TAR.TAR_FECHA_FIN 
    ...
    ,PRC_BIE_ADJ.BIE_ADJ_F_DECRETO_FIRME FECHA_AUTO
...
FROM BANK01.ASU_ASUNTOS ASU 
  ...
  LEFT JOIN ULTIMO_PROC_ADJUDICACION ULTADJU ON ULTADJU.ASU_ID = ASU.ASU_ID
  LEFT JOIN PRC_BIE_ADJ ON PRC_BIE_ADJ.PRC_ID = ULTADJU.PRC_ID 
