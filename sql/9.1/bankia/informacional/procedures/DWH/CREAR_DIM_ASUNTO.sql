...
-- Motivos del cambio:correccion D_ASU_ROL_GESTOR
...
BEGIN
  ...
  begin
    ...
    ------------------------------ D_ASU_GESTION_ASUNTO --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_ASU_GESTION_ASUNTO'', 
                          ''GESTION_ASUNTO_ID NUMBER(16,0) NOT NULL,
                              GESTION_ASUNTO_DESC VARCHAR2(250 CHAR),
                            PRIMARY KEY (GESTION_ASUNTO_ID)'', 
                          :error); END;';
    execute immediate V_SQL USING OUT error;
