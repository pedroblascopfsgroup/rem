...
BEGIN
  ...
  begin
    ...
    ------------------------------ D_F_ULT_6_MESES ------------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_6_MESES'', ''ES_ID INTEGER NOT NULL,
                                                        ULT_6_MESES_ID INTEGER'', 
                                                        :error); END;';
    execute immediate V_SQL USING OUT error;
    
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_6_MESES_IX'', ''D_F_ULT_6_MESES (MES_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;  
      
    ------------------------------ D_F_ULT_12_MESES ------------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_12_MESES'', ''MES_ID INTEGER NOT NULL,
                                                          ULT_12_MESES_ID INTEGER'', 
                                                        :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_12_MESES_IX'', ''D_F_ULT_12_MESES (MES_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
