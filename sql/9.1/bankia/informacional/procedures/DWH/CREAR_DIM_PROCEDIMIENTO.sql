...
declare
  ...
  begin
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_PRC_GESTOR_IX'', ''TMP_PRC_GESTOR (PROCEDIMIENTO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_PRC_SUPER_IX'', ''TMP_PRC_SUPERVISOR (PROCEDIMIENTO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;  
  ...
  ----------------------------- D_PRC_FINALIZADO --------------------------
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_PRC_TIPO_ACUERDO'', 
                      ''TIPO_ACUERDO_PRC_ID NUMBER(16,0) NOT NULL,
                        ...
                        PRIMARY KEY (TIPO_ACUERDO_PRC__ID)'', 
                      :error); END;';
    execute immediate V_SQL USING OUT error;
