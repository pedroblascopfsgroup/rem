create or replace PROCEDURE CREAR_H_CONTRATO (error OUT VARCHAR2) AS
-- ===============================================================================================
...
-- Motivos del cambio:  Se añade ACTUACION_RESTRICTIVA_ID a H_CNT y sus tablas jerarquía
  ...
  begin
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_CNT'', 
                            ''DIA_ID DATE NOT NULL,
                              ...
                              SITUACION_CNT_DETALLE_ID NUMBER(16,0),
                              SITUACION_ANT_CNT_DETALLE_ID NUMBER(16,0),
                              SITUACION_RESP_PER_ANT_ID NUMBER(16,0),
                              ...
                              ACTUACION_RESTRICTIVA_ID NUMBER(16,0)
   ...
   ------------------------------ H_CNT_DET_CICLO_REC_TRIMESTRE --------------------------
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_CICLO_REC_TRI_IX'', ''H_CNT_DET_CICLO_REC_TRIMESTRE (TRIMESTRE_ID, FECHA_ALTA_CICLO_REC, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ H_CNT_DET_CICLO_REC_ANIO --------------------------
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_CNT_INICIO_CAMPANA_RECOBRO'', 
                            ''FECHA_INICIO_CAMPANA_RECOBRO DATE NOT NULL,       -- Fecha �ltimo d�a cargado
                              ...
                              -- Recobro
                              IMPORTE_RECLAMAR_INI_CAMP_REC NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ TMP_CNT_DET_ACUERDO --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_DET_ACUERDO'', 
                            ''DIA_ID DATE NOT NULL,
                              ...
                              -- Metricas
                              NUM_ACUERDOS INTEGER ,
                              IMPORTE_PAGO NUMBER(16,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ TMP_CNT_DET_INCI --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_DET_INCI'', 
                            ''DIA_ID DATE NOT NULL,
                              ...
                              ENVIADO_AGENCIA_INCI_ID NUMBER(16,0) NULL,
                              -- Metricas
                              NUM_INCIDENCIAS INTEGER'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ H_CNT_DET_INCI_SEMANA --------------------------
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_INCI_SEMANA_IX'', ''H_CNT_DET_INCI_SEMANA (SEMANA_ID, FECHA_INCIDENCIA, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ H_CNT_DET_INCI_ANIO --------------------------
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_H_CNT_DET_EFICACIA'', 
                            ''DIA_ID DATE NULL,  
                              ...
                              ER_IMPORTE_COBRO NUMBER(14,2),
                              ER_DEUDA_IRREGULAR_STOCK_INI NUMBER(14,2),
                              ER_DEUDA_IRREGULAR_ENTRADAS NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_EFICACIA_TRI_IX'', ''H_CNT_DET_EFICACIA_TRIMESTRE (TRIMESTRE_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_H_CNT_DET_CREDITO'', 
                            ''DIA_ID DATE NOT NULL,    
                                  ...
                                  PRINCIPAL_INICIAL NUMBER(16,2) NULL,
                                  PRINCIPAL_GESTOR NUMBER(16,2) NULL,
                                  PRINCIPAL_FINAL NUMBER(16,2) NULL)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_CREDITO_SEMANA_IX'', ''H_CNT_DET_CREDITO_SEMANA (SEMANA_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_CREDITO_MES_IX'', ''H_CNT_DET_CREDITO_MES (MES_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_CREDITO_TRIMESTRE_IX'', ''H_CNT_DET_CREDITO_TRIMESTRE (TRIMESTRE_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_CNT_DET_CREDITO_ANIO_IX'', ''H_CNT_DET_CREDITO_ANIO (ANIO_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    ------------------------------ TMP_FECHA_CNT --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_CNTTMP_FECHA_CNT'', 
                            ''DIA_CNT DATE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_H'', 
                            ''DIA_H DATE ,
                              ...
                              TRAMO_IRREGULARIDAD_FASES_H NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_ANT'', 
                            ''DIA_ANT DATE ,
                              ...
                              NUM_DIAS_VENC_PERIODO_ANT INTEGER ,
                              T_IRREG_FASES_PER_ANT NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_MANTIENE'', 
                            ''DIA_ID DATE ,
                              ...
                              ANIO_ID INTEGER ,
                              CONTRATO_ID NUMBER(16,0) NOT NULL'', :error); END;';
    execute immediate V_SQL USING OUT error;
    
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla TMP_MANTIENE');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_MANTIENE_DIA_IX'', ''TMP_MANTIENE (DIA_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_MANTIENE_SEMANA_IX'', ''TMP_MANTIENE (SEMANA_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_MANTIENE_MES_IX'', ''TMP_MANTIENE (MES_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_MANTIENE_TRIMESTRE_IX'', ''TMP_MANTIENE (TRIMESTRE_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_MANTIENE_ANIO_IX'', ''TMP_MANTIENE (ANIO_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_PROCEDIMIENTO_AUX'', 
                            ''CONTRATO_ID NUMBER(16,0),
                                PROCEDIMIENTO_ID NUMBER(16,0),
                                TIPO_PROCEDIMIENTO_AGRUPADO_ID NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_PROCEDIMIENTO'', 
                            ''CONTRATO_ID NUMBER(16,0),
                                LITIGIO NUMBER(16,0),
                                CONCURSO NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_EXPEDIENTE'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              ...
                              MOTIVO_SALIDA_EXP_CNT_ID NUMBER(16,0),
                              TIPO_INCIDENCIA_EXP_CNT_ID NUMBER(16,0),
                              ESTADO_INCIDENCIA_EXP_CNT_ID NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_SITUACION_FINANCIERA'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              SITUACION_FINANCIERA_DESC VARCHAR2(50)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_RECOBRO'', 
                          ...
                          NUM_ACT_REC_ACUMULADO INTEGER ,
                          NUM_ACT_REC_CONTACTO_UTIL_ACU INTEGER'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_ESPECIALIZADA'', 
                          ...
                          SUPERVISOR_N1_ESPEC_ID NUMBER(16,0)   ,
                          SUPERVISOR_N2_ESPEC_ID NUMBER(16,0)   ,
                          SUPERVISOR_N3_ESPEC_ID NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_PREVISIONES'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              ...
                              IMP_RIESGO_PREV_AUTO NUMBER(14,2) ,
                              IMP_RIESGO_PREV_MANUAL NUMBER(14,2) ,
                              IMP_RIESGO_PREV_FINAL NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_LOAN_INFORMATION'', 
                            ...
                            FECHA_TOMA_POSESION	VARCHAR2(250'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_ESTUDIO_CARTERA'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              ...
                              NGB_UGAS NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_COBRO'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              FECHA_COBRO DATE ,
                              MAX_FECHA_CONTRATO DATE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_ENVIO_AGENCIA'', 
                            ''CONTRATO_ID NUMBER(16,0),
                              ...
                              DEUDA_IRREGULAR NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_ENTSAL_D1'', 
                            ...
                            GASTOS_CICLO_REC NUMBER(16,2) ,
                            IMPUESTOS_CICLO_REC NUMBER(16,2),
                            DEUDA_IRREGULAR_CICLO_REC NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_FACTURACION'', 
                            ''COBRO_ID NUMBER(16,0),
                              ...
                              TARIFA NUMBER(16,2),
                              CORRECTOR NUMBER(2,5)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_DET_COBROS_PAGOS'', 
                            ''CPA_ID	NUMBER(16,0),
                                ...
                                CPA_FECHA_VALOR	DATE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_ACCIONES'', 
                            ''CONTRATO NUMBER(16,0),
                              ...
                              PRIORIDAD_GESTION NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_CNT_GESTOR_CREDITO'', 
                            '' PROCEDIMIENTO_ID NUMBER(16,0),
                              GESTOR_CREDITO_ID NUMBER(16,0) '', :error); END;';
    execute immediate V_SQL USING OUT error;
