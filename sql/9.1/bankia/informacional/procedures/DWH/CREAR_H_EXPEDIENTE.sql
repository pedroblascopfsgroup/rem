...
-- Fecha última modificación: 17/08/2015
...
-- HECHO EXPEDIENTE
    ...
    -- H_EXP_ANIO
    -- H_EXP_DET_COBRO
    -- H_EXP_DET_COBRO_SEMANA
    -- H_EXP_DET_COBRO_MES
    -- H_EXP_DET_COBRO_TRIMESTRE
    -- H_EXP_DET_COBRO_ANIO
    -- H_EXP_DET_CNT
    -- TMP_H_EXP_DET_CNT
    -- H_EXP_DET_CNT_SEMANA
    -- H_EXP_DET_CNT_MES
    -- H_EXP_DET_CNT_TRIMESTRE
    -- H_EXP_DET_CNT_ANIO
    -- TMP_EXP_CNT
    -- TMP_EXP_COBROS
    -- TMP_EXP_ACCIONES
  ...
  begin
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_H_EXP'', 
                            ''DIA_ID DATE NOT NULL,
                              ...
                              COMISIONES NUMBER(14,2)  ,                               -- Comsiones de los contratos asociados al expediente
                              GASTOS NUMBER(14,2),                                     -- Gastos de los contratos asociados al expediente
                              IMPORTE_COMPROMETIDO NUMBER(14,2)                        -- Importe comprometido mediante acciones extrajudiciales'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    ------------------------------ H_EXP_DET_COBRO --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_COBRO'', 
                            ''DIA_ID DATE NOT NULL,
                              ...
                              FECHA_COBRO DATE ,
                              -- Dimensiones
                              TIPO_COBRO_EXPEDIENTE_ID NUMBER(16,0) ,
                              ...
                              GASTOS_FACTURA NUMBER(16,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_COBRO');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_COBRO_IX'', ''H_EXP_DET_COBRO (DIA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_COBRO');


    ------------------------------ H_EXP_DET_COBRO_SEMANA --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_COBRO_SEMANA'', 
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_COBRO_SEMANA');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_COBRO_SEMANA_IX'', ''H_EXP_DET_COBRO_SEMANA (SEMANA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_COBRO_SEMANA');



    ------------------------------ H_EXP_DET_COBRO_MES --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_COBRO_MES'', 
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_COBRO_MES');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_COBRO_MES_IX'', ''H_EXP_DET_COBRO_MES (MES_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_COBRO_MES');


    ------------------------------ H_EXP_DET_COBRO_TRIMESTRE --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_COBRO_TRIMESTRE'', 
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_COBRO_TRIMESTRE');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_COBRO_TRIMESTRE_IX'', ''H_EXP_DET_COBRO_TRIMESTRE (TRIMESTRE_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_COBRO_TRIMESTRE');


   ------------------------------ H_EXP_DET_COBRO_ANIO --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_COBRO_ANIO'', 
                            ''ANIO_ID DECIMAL(16,0) NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID DECIMAL(16,0) NOT NULL,
                              CONTRATO_ID DECIMAL(16,0)  ,
                              FECHA_COBRO DATE ,
                              -- Dimensiones
                              TIPO_COBRO_EXPEDIENTE_ID DECIMAL(16,0) ,
                              COBRO_FACTURADO_ID DECIMAL(16,0) ,
                              REMESA_FACTURA_ID DECIMAL(16,0) ,
                              -- Metricas
                              NUM_COBROS INTEGER ,
                              IMPORTE_COBRO DECIMAL(16,2) ,
                              POSICION_VENCIDA_COBRO DECIMAL(16,2) ,
                              POSICION_NO_VENCIDA_COBRO DECIMAL(16,2) ,
                              INT_REMUNERATORIOS_COBRO DECIMAL(16,2) ,
                              INT_MORATORIOS_COBRO DECIMAL(16,2) ,
                              COMISIONES_COBRO DECIMAL(16,2) ,
                              GASTOS_COBRO DECIMAL(16,2) ,
                              IMPORTE_FACTURA_TOTAL DECIMAL(16,2) ,                       -- Importe factura total: IMPORTE_FACTURA_TARIFA + CORRECTOR_FACTURA
                              IMPORTE_FACTURA_TARIFA DECIMAL(16,2) ,                      -- Importe factura tarifa: suma del desglose de la factura
                              CORRECTOR_FACTURA DECIMAL(16,2) ,
                              POSICION_VENCIDA_FACTURA DECIMAL(16,2) ,
                              POSICION_NO_VENCIDA_FACTURA DECIMAL(16,2) ,
                              INT_REMUNERATORIOS_FACTURA DECIMAL(16,2) ,
                              INT_MORATORIOS_FACTURA DECIMAL(16,2) ,
                              COMISIONES_FACTURA DECIMAL(16,2) ,
                              GASTOS_FACTURA DECIMAL(16,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
   
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_COBRO_ANIO');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_COBRO_ANIO_IX'', ''H_EXP_DET_COBRO_ANIO (ANIO_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_COBRO_ANIO');


   ------------------------------ H_EXP_DET_CNT --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CNT'', 
                            ''DIA_ID DATE NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
                              FECHA_GESTION DATE ,
                              TIPO_GESTION_EXP_CNT_ID NUMBER(16,0),  
                              RESULTADO_GESTION_EXP_CNT_ID NUMBER(16,0) NULL,
                              FECHA_COMPROMETIDA_PAGO DATE,
                              -- Metricas
                              NUM_CONTRATOS_EXPEDIENTE INTEGER,
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CNT');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_IX'', ''H_EXP_DET_CNT (DIA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_CNT_IX'', ''H_EXP_DET_CNT (DIA_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_CNT');


   ------------------------------ TMP_H_EXP_DET_CNT --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_H_EXP_DET_CNT'', 
                            ''DIA_ID DATE NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
                              ...
                              -- Metricas
                              NUM_CONTRATOS_EXPEDIENTE INTEGER,
                              IMPORTE_COMPROMETIDO NUMBER(14,2)'', :error); END;';
    execute immediate V_SQL USING OUT error;
   
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla TMP_H_EXP_DET_CNT');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_H_EXP_DET_CNT_IX'', ''TMP_H_EXP_DET_CNT (DIA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_H_EXP_DET_CNT_CNT_IX'', ''TMP_H_EXP_DET_CNT (DIA_ID, CONTRATO_ID'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    
    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en TMP_H_EXP_DET_CNT');


   ------------------------------ H_EXP_DET_CNT_SEMANA --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CNT_SEMANA'', 
                            ''SEMANA_ID NUMBER(16,0) NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CNT_SEMANA');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_SEMANA_IX'', ''H_EXP_DET_CNT_SEMANA (SEMANA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_SEMANA_CNT_IX'', ''H_EXP_DET_CNT_SEMANA (SEMANA_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_CNT_SEMANA');


   ------------------------------ H_EXP_DET_CNT_MES --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CNT_MES'', 
                            ''MES_ID NUMBER(16,0) NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CNT_MES');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_MES_IX'', ''H_EXP_DET_CNT_MES (MES_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_MES_CNT_IX'', ''H_EXP_DET_CNT_MES (MES_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_CNT_MES');


   ------------------------------ H_EXP_DET_CNT_TRIMESTRE --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CNT_TRIMESTRE'', 
                            ''TRIMESTRE_ID NUMBER(16,0) NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CNT_TRIMESTRE');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_TRIMESTRE_IX'', ''H_EXP_DET_CNT_TRIMESTRE (TRIMESTRE_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_TRIMESTRE_CNT_IX'', ''H_EXP_DET_CNT_TRIMESTRE (TRIMESTRE_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_CNT_TRIMESTRE');


   ------------------------------ H_EXP_DET_CNT_ANIO --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CNT_ANIO'', 
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CNT_ANIO');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_ANIO_IX'', ''H_EXP_DET_CNT_ANIO (ANIO_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CNT_ANIO_CNT_IX'', ''H_EXP_DET_CNT_ANIO (ANIO_ID, CONTRATO_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_CNT_ANIO');


/*
   ------------------------------ H_EXP_DET_PROPUESTA --------------------------
    select count(*) into nCount from user_tables where table_name = 'H_EXP_DET_PROPUESTA';
    if(nCount <= 0) then
      execute immediate 'CREATE TABLE H_EXP_DET_PROPUESTA(
                              DIA_ID DATE NOT NULL,
                              FECHA_CARGA_DATOS DATE NOT NULL,
                              EXPEDIENTE_ID NUMBER(16,0) NOT NULL,
                              CONTRATO_ID NUMBER(16,0),
                              TIPO_PROPUESTA_EXP_ID NUMBER(16,0),  
                              ESTADO_PROPUESTA_EXP_ID NUMBER(16,0) NULL,
                              FECHA_COMPROMETIDA_PAGO DATE,
                              FECHA_COMPROMETIDA_PAGO DATE,
                              FECHA_COMPROMETIDA_PAGO DATE,
                              -- Metricas
      ...
      DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_PROPUESTA');

      execute immediate 'CREATE INDEX H_EXP_DET_PROPUESTA_IX ON H_EXP_DET_PROPUESTA (DIA_ID, EXPEDIENTE_ID)';
      execute immediate 'CREATE INDEX H_EXP_DET_PROPUESTA_CNT_IX ON H_EXP_DET_PROPUESTA (DIA_ID, CONTRATO_ID)';
      DBMS_OUTPUT.PUT_LINE('---- Creacion indices en H_EXP_DET_PROPUESTA');
   ...
   ------------------------------ TMP_EXP_CNT --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_EXP_CNT'', 
                            ''EXPEDIENTE_ID NUMBER(16,0),
                              ...
                              MAX_PRIORIDAD_ACTUACION NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ TMP_EXP_COBROS --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_EXP_COBROS'', 
                            ''EXPEDIENTE_ID NUMBER(16,0),
                              FECHA_ULTIMO_COBRO DATE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla TMP_EXP_COBROS');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_EXP_COBROS_IX'', ''TMP_EXP_COBROS (EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en TMP_EXP_COBROS');
   ...
   ------------------------------ TMP_EXP_ACCIONES --------------------------
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''TMP_EXP_ACCIONES'', 
                            ''CONTRATO NUMBER(16,0),
                              ...
                              TIPO_GESTION NUMBER(16,0),
                              RESULTADO_ACTUACION NUMBER(16,0),
                              PRIORIDAD_ACTUACION NUMBER(16,0)'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CICLO_REC'', 
                            ''DIA_ID DATE NOT NULL, 
                              ...
                              DEUDA_IRREGULAR_EXP_CR NUMBER(14,2)       -- Deuda irregular de los contratos asociados al expediente'', :error); END;';
    execute immediate V_SQL USING OUT error;

    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CICLO_REC');

    V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''H_EXP_DET_CICLO_REC_IX'', ''H_EXP_DET_CICLO_REC (DIA_ID, EXPEDIENTE_ID)'', ''S'', '''', :error); END;';
    execute immediate V_SQL USING OUT error;
    
    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_CICLO_REC');
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla TMP_EXP_DET_CICLO_REC');
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en TMP_EXP_DET_CICLO_REC');
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''H_EXP_DET_CICLO_REC_SEMANA'', 
                            ''SEMANA_ID NUMBER(16,0) NOT NULL, 
                              ...
                              SALDO_TOTAL_EXP_CR NUMBER(14,2)  ,        -- Suma de los saldos vencido y no vencido de los contratos asociados al expediente
                              RIESGO_VIVO_EXP_CR NUMBER(14,2)  ,        -- Riesgo vivo de los contratos asociados al expediente
                              DEUDA_IRREGULAR_EXP_CR NUMBER(14,2)       -- Deuda irregular de los contratos asociados al expedient'', :error); END;';
    execute immediate V_SQL USING OUT error;
    
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CICLO_REC_SEMANA');    
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_CICLO_REC_SEMANA');
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CICLO_REC_MES');    
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_CICLO_REC_MES');    
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion tabla H_EXP_DET_CICLO_REC_TRIMESTRE');    
    ...
    DBMS_OUTPUT.PUT_LINE('---- Creacion indice en H_EXP_DET_CICLO_REC_TRIMESTRE');    
