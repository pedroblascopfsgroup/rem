...
-- Fecha ultima modificacion: 01/02/2015
...
commit;
   ...
   commit;
    ...
    --Log_Proceso
    execute immediate 'BEGIN INSERTAR_Log_Proceso(:NOMBRE_PROCESO, :DESCRIPCION, :TAB); END;' USING IN V_NOMBRE, 'H_TAR. Registros Insertados: ' || TO_CHAR(V_ROWCOUNT), 4;
