...
from     
   (SELECT fun.fun_id FROM cmmaster.FUN_FUNCIONES fun
       WHERE fun.FUN_DESCRIPCION IN ( 
		'SOLICITAR_EXP_MANUAL_RECUPERACIONES','SOLICITAR_EXP_MANUAL_SEGUIMIENTO','MENU-LIST-PROPRE','MENU-LIST-CLI','MENU-LIST-EXP','MENU-LIST-ASU','BUSQUEDA','RESPONDER','MENU-LIST-CNT','EXPORTAR_ANALISIS_PDF','TAB-CNT-EXP-ASU','MOSTRAR_VR_TAREAS','VER-CONFIGURACION','VER-OBSERVACIONES-ASUNTO','ROLE_MENUARQ','BUSCAR-TAREAS',
    ...
    'ROLE_EDIT_CABECERA_PROCEDIMIENTO','ROLE_COMITE','ROLE_COMITE_MENU','ROLE_ADDCOMITE','ROLE_EDITCOMITE','ROLE_EDIT_COM_ITI','ROLE_COMITE_BORRAPUESTO','ROLE_COMITE_ALTAPUESTO','ROLE_COMITE_EDITPUESTO','ROLE_BORRACOMITE','ROLE_CONFITI','BORRAR_ADJ_OTROS_USU','SOLVENCIA_NUEVO',
