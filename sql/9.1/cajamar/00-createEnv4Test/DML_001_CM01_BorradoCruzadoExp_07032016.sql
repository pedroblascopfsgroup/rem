...
UPDATE CM01.EXP_EXPEDIENTES SET USUARIOBORRAR = 'PARABORRAR' WHERE (USUARIOCREAR = 'REC-BATCH' 
or USUARIOCREAR LIKE 'val.%'
or USUARIOCREAR = 'MIGRACM01'
or USUARIOCREAR = 'MIGRACM01PCO'
or USUARIOCREAR = 'ALTAASUNCM'
) AND EXP_ID NOT IN (
SELECT EXP.EXP_ID
