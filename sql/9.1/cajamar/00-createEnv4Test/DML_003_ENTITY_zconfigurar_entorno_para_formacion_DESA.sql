...
delete from cm01.mej_irg_info_registro where REG_ID in (select REG_ID from mej_reg_registro where usu_id in (select usu_id from cmmaster.usu_usuarios));

delete from cm01.mej_reg_registro where usu_id in (select usu_id from cmmaster.usu_usuarios);

delete from cm01.obj_objetivo where pol_id in (select pol_id from pol_politica where usu_id in (select usu_id from cmmaster.usu_usuarios));
...
where iti_id in (select iti_id from iti_itinerarios where iti_nombre in (
'Persona física Hipotecario_copia',
'Persona física Hipotecario',
'Generico'));

update cm01.lia_lista_arquetipos set borrado = 1, fechaborrar = sysdate, usuarioborrar = 'SAG'
where lia_nombre in (
'Persona física Hipotecario', 'Clientes sin dudoso y más de 1 millón dispuesto','Hipotecario con mas de 500Mil de dudoso'
);
...
where des_despacho = 'Despacho Supervisor administración contable';
...
insert into CM01.des_despacho_externo des (des_id, des_despacho, fechacrear, usuariocrear, dd_tde_id, zon_id) values (CM01.s_des_despacho_externo.nextval, 'Precontencioso - Gestor de liquidación', sysdate, 'SAG', (select dd_tde_id from cmmaster.dd_tde_tipo_despacho where dd_tde_codigo = 'CM_GL_PCO'), (select max(zon_id) from CM01.zon_zonificacion where zon_cod = '01'));
insert into CM01.des_despacho_externo des (des_id, des_despacho, fechacrear, usuariocrear, dd_tde_id, zon_id) values (CM01.s_des_despacho_externo.nextval, 'Precontencioso - Gestor de documentación', sysdate, 'SAG', (select dd_tde_id from cmmaster.dd_tde_tipo_despacho where dd_tde_codigo = 'CM_GD_PCO'), (select max(zon_id) from CM01.zon_zonificacion where zon_cod = '01'));
...
INSERT INTO CM01.PEF_PERFILES( PEF_ID,PEF_DESCRIPCION_LARGA,PEF_DESCRIPCION,USUARIOCREAR,FECHACREAR,PEF_CODIGO,PEF_ES_CARTERIZADO,DTYPE) VALUES (CM01.S_PEF_PERFILES.nextval,'Acceso a toda la operativa de configuración','Administrador','SAG',sysdate,'ADM_ADMINISTRADOR',0,'EXTPerfil');
...
INSERT INTO CM01.PEF_PERFILES( PEF_ID,PEF_DESCRIPCION_LARGA,PEF_DESCRIPCION,USUARIOCREAR,FECHACREAR,PEF_CODIGO,PEF_ES_CARTERIZADO,DTYPE) VALUES (CM01.S_PEF_PERFILES.nextval,'Acceso a las funcionalidades de supervisión de los asuntos judiciales','Supervisor','SAG',sysdate,'SUP_SUPERVISOR',0,'EXTPerfil');
...
INSERT INTO CM01.PEF_PERFILES( PEF_ID,PEF_DESCRIPCION_LARGA,PEF_DESCRIPCION,USUARIOCREAR,FECHACREAR,PEF_CODIGO,PEF_ES_CARTERIZADO,DTYPE) VALUES (CM01.S_PEF_PERFILES.nextval,'Acceso a las funcionalidades propias de la dirección territorial de riesgos','Director territorial riesgos','SAG',sysdate,'DIR_TERRITORIAL_RIESGOS',0,'EXTPerfil');
INSERT INTO CM01.PEF_PERFILES( PEF_ID,PEF_DESCRIPCION_LARGA,PEF_DESCRIPCION,USUARIOCREAR,FECHACREAR,PEF_CODIGO,PEF_ES_CARTERIZADO,DTYPE) VALUES (CM01.S_PEF_PERFILES.nextval,'Acceso a las funcionalidades propias de la dirección territorial','Director territorial','SAG',sysdate,'DIR_TERRITORIAL',0,'EXTPerfil');
...
/* insertar usuarios de grupo por despacho */   
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'GCGHRE', '1234', 'Grupo - Gestor control de gestión HRE', sysdate, 'SAG', 1, 1);
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'SCGHRE', '1234', 'Grupo - Supervisor control gestión HRE', sysdate, 'SAG', 1, 1);
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'DIRECU', '1234', 'Grupo - Dirección recuperaciones', sysdate, 'SAG', 1, 1);
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'GESTA', '1234', 'Grupo - Gestor análisis de recuperaciones', sysdate, 'SAG', 1, 1);
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'GACON', '1234', 'Grupo - Gestor administración contable', sysdate, 'SAG', 1, 1);
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'SUPANAREC', '1234', 'Grupo - Supervisor análisis de recuperaciones', sysdate, 'SAG', 1, 1);
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'SUPADMC', '1234', 'Grupo - Supervisor administración contable', sysdate, 'SAG', 1, 1);
 ...
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'DIRCGHRE', '1234', 'Grupo - Director control gestión HRE', sysdate, 'SAG', 1, 1);
 insert into cmmaster.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre, fechacrear, usuariocrear, usu_externo, usu_grupo) values (cmmaster.s_usu_usuarios.nextval, 1, 'GESTCOHREI', '1234', 'Grupo - Gestor concursal HRE insinuación', sysdate, 'SAG', 1, 1);

insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GCGHRE'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'DIRECU'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'DIRCON'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'DIRCGHRE'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTR'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GACON'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTA'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTC'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTCHRE'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTCOHREI'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTI'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'GEST_EXTERNO'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GOFI'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPADMC'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPANAREC'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPCO'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPCHRE'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SCGHRE'), 'SAG', sysdate);
insert into cm01.zon_pef_usu zpu (zpu.zpu_id, zpu.zon_id, zpu.pef_id, zpu.usu_id, zpu.usuariocrear, zpu.fechacrear)values(s_zon_pef_usu.nextval, (select max(zon_id) from zon_zonificacion where zon_cod = '01'),  (select pef_id from pef_perfiles where pef_codigo = 'SUP_SUPERVISOR'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPIN'), 'SAG', sysdate);

insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Dirección recuperaciones'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'DIRECU' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Director control gestión HRE'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'DIRCGHRE' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Gestor administración contable'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GACON' and borrado = 0), 1, 0, sysdate, 'SAG');
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Gestor análisis de recuperaciones'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTA' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Gestor concursal HRE insinuación'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GESTCOHREI' and borrado = 0), 1, 0, sysdate, 'SAG');
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Gestor control de gestión HRE'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'GCGHRE' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Supervisor administración contable'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPADMC' and borrado = 0), 1, 0, sysdate, 'SAG');
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Supervisor análisis de recuperaciones'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SUPANAREC' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into cm01.usd_usuarios_despachos usd (usd_id, des_id, usu_id, usd_gestor_defecto, usd_supervisor, fechacrear, usuariocrear) values (cm01.s_usd_usuarios_despachos.nextval,  (select des_id from cm01.des_despacho_externo where borrado = 0 and des_despacho = 'Despacho Supervisor control gestión HRE'), (select usu_id from cmmaster.usu_usuarios where usu_username = 'SCGHRE' and borrado = 0), 1, 0, sysdate, 'SAG');
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.dirterriegos','1234','Dirección territorial riesgos','','','' , 'JSV', sysdate, 0,0);
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.dirterritorial','1234','Dirección territorial','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.gestdocumentacion','1234','Gestor documentación','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.GESCHRE','1234','Gestor control de gestión HRE','','','' , 'JSV', sysdate, 0,0);
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.SUCHRE','1234','Supervisor control gestión HRE','','','' , 'JSV', sysdate, 0,0);
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.DIRREC','1234','Dirección recuperaciones','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.GEANREC','1234','Gestor análisis de recuperaciones','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.GADMCON','1234','Gestor administración contable','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.SUANREC','1234','Supervisor análisis de recuperaciones','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.SUADCON','1234','Supervisor administración contable','','','' , 'JSV', sysdate, 0,0);
...
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.DIRHRE','1234','Director control gestión HRE','','','' , 'JSV', sysdate, 0,0);
insert into CMMASTER.usu_usuarios (usu_id, entidad_id, usu_username, usu_password, usu_nombre,usu_apellido1,usu_apellido2,usu_mail, usuariocrear,fechacrear, usu_externo, usu_grupo)  values  ( CMMASTER.s_usu_usuarios.nextval, 1,'val.GEHREIN','1234','Gestor concursal HRE insinuación','','','' , 'JSV', sysdate, 0,0);
...
---Despacho
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.gestdocumentacion'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Precontencioso - Gestor de liquidación'),0,0 , 'JSV', sysdate );
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.gestliquidaciones'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Precontencioso - Gestor de documentación'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.GESCHRE'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Gestor control de gestión HRE'),0,0 , 'JSV', sysdate );
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.SUCHRE'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Supervisor control gestión HRE'),0,0 , 'JSV', sysdate );
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.DIRREC'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Dirección recuperaciones'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.GEANREC'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Gestor análisis de recuperaciones'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.GADMCON'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Gestor administración contable'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.SUANREC'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Supervisor análisis de recuperaciones'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.SUADCON'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Supervisor administración contable'),0,0 , 'JSV', sysdate );
...
insert into CM01.usd_usuarios_despachos usd (usd_id, usu_id, des_id, usd_gestor_defecto, usd_supervisor, usuariocrear, fechacrear) values (CM01.s_usd_usuarios_despachos.nextval,(select usu.usu_id from CMMASTER.usu_usuarios usu where usu.usu_username = 'val.DIRHRE'), (select des.des_id from CM01.des_despacho_externo des where des.borrado = 0 and des.DES_DESPACHO = 'Despacho Director control gestión HRE'),0,0 , 'JSV', sysdate );
