...
DECLARE
 ...
 V_TABLESPACE VARCHAR(30) := 'DRECOVERYONL8M' ;
 err_num NUMBER;
...
DBMS_OUTPUT.PUT_LINE(''||TABLA2||' Modificada');
  ...
  V_MSQL5 := 'ALTER TABLE '||V_ESQUEMA||'.'||TABLA2||'  MODIFY
             (
               ...
               , CODIGO_BIEN NUMBER(16)  
               , NOMBRE_EMPRESA VARCHAR2(250)
               , CNAE_EMPRESA VARCHAR2(50) 
               , CHAR_EXTRA1 VARCHAR2(50)
               , CHAR_EXTRA2 VARCHAR2(50)
            )';
...
DBMS_OUTPUT.PUT_LINE(''||TABLA2||' Modificada');
 ...
 V_MSQL_CREA := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLAC1||' 
   (	"FECHA_EXTRACCION" DATE, 
	...
	"NOMBRE_EMPRESA" VARCHAR2(250 BYTE), 
	"CIF_EMPRESA" VARCHAR2(20 CHAR), 
	"CNAE_EMPRESA" VARCHAR2(50 BYTE), 
