...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla MIG_BIENES_OPERACIONES
...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_BIENES_OPERACIONES';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	  ID_BIENES_OPERACIONES        NUMBER(16) 	 NOT NULL,
	  CD_PROCEDIMIENTO             NUMBER(16) 	 NOT NULL,
	  CD_BIEN                      VARCHAR2(20 CHAR) NOT NULL,
	  NUMERO_ACTIVO                NUMBER(9) 	 NOT NULL,
	  ...
	  ESTADO_RELACION              VARCHAR2(20 CHAR),
	  FECHA_INICIO_RELACION        DATE,
	  FECHA_FIN_RELACION           DATE,
	  IMPORTE_GARANTIZADO          NUMBER(16,2),
	  CONSTRAINT "PK_ID_BIENES_OPERACIONES" PRIMARY KEY ("ID_BIENES_OPERACIONES") 
