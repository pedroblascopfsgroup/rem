...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla MIG_CONCURSOS_OPERACIONES
...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_CONCURSOS_OPERACIONES';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	  ID_CONCURSO_OPERAC  NUMBER(16) 	NOT NULL, 
	  ...
	  IMPORTE_RECONOCIDO  NUMBER(16,2)      NULL,
	  CONSTRAINT "PK_ID_CONCURSO_OPERAC" PRIMARY KEY ("ID_CONCURSO_OPERAC") 
    	  USING INDEX
