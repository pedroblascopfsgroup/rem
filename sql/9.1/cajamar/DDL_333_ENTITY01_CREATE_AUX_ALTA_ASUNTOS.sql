...
DECLARE
 ...
 ITABLE_SPACE VARCHAR(25) :='CM01';
 TABLA VARCHAR(30) :='AUX_ALTA_ASUNTOS_LITIGIOS';
 TABLA2 VARCHAR(30) :='AUX_ALTA_ASUNTOS_CONCURSOS';
 err_num NUMBER;
 ...
 V_EXISTE NUMBER (1);
 V_EXISTE2 NUMBER (1);
 SECUENCIA VARCHAR(30) :='S_AUX_ALTA_ASUNTOS_LITIGIOS';
