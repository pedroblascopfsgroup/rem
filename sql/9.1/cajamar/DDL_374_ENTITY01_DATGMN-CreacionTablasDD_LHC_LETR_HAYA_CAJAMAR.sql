...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de TABLA de DD_LHC_LETR_HAYA_CAJAMAR
--##                   
...
DECLARE
 ...
 TABLA1 VARCHAR(30) :='DD_LHC_LETR_HAYA_CAJAMAR';
 err_num NUMBER;
...
BEGIN 
  ...
  -- CREAMOS LA TABLA DE DD_LHC_LETR_HAYA_CAJAMAR 
  V_EXISTE:=0;
  ...
  V_MSQL1 := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA1||' 
   (
        DD_LHC_HAYA_CODIGO  VARCHAR2(20 CHAR) NOT NULL ENABLE, 
        DD_LHC_BCC_CODIGO   VARCHAR2(20 CHAR), 
