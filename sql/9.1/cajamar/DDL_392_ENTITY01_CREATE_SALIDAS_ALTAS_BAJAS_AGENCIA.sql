...
DECLARE
 ...
 TABLA VARCHAR(30) :='SALIDAS_ALTAS_BAJAS_AGENCIA';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
	 ...
	 TIPO_MOVIMIENTO  VARCHAR2(1 BYTE) NOT NULL ENABLE, 
	 FECHA_INFORMACION  VARCHAR2(8 BYTE) NOT NULL ENABLE, 
	 PRIMARY KEY (CNT_CONTRATO, TIPO_MOVIMIENTO)
               )';
