	...
	TOTAL_INSERTS := 0;
 	LOOP
 		...
 		OPEN USUARIOS_CURSOR FOR 'SELECT tg.DD_TGE_ID, ud.USD_ID, u.USU_USERNAME, u.USU_ID ' ||
							...
							' , ''CJ_SUCONGE'', ''CJ_SUCONPR'', ''CJ_SCTRGE'', ''CJ_SGESDOC'', ''CJ_SPGL'', ''CJ_GESCHRE'', ''CJ_SUCHRE'', ''CJ_DIRREC'', ''CJ_GESCON'' ' ||
							' , ''CJ_GESINC'', ''CJ_GERREC'', ''CJ_GEANREC'', ''CJ_GESHRE'', ''CJ_GADMCON'', ''CJ_GESOF'', ''CJ_SUCON'', ''CJ_SUINC'', ''CJ_SUANREC'' ' ||
							' , ''CJ_SUHRE'', ''CJ_SUADCON'', ''CJ_DIRCON'', ''CJ_DIRHRE'')';
 	 	LOOP
