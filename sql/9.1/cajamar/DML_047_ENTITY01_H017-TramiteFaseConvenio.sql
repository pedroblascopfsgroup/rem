...
BEGIN
    ...
    */
     ...
     * 
     */
    EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. fase convenio - HCJ'', DD_TPO_XML_JBPM = ''hcj_tramiteFaseConvenio'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';
