...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''P. Solicitud de Concurso - CJ'', DD_TPO_XML_JBPM = ''cj_solicitudConcursal'' WHERE DD_TPO_CODIGO = ''H021''';
	...
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_VIEW = ''plugin/cajamar/procedimientoSolicitudConcursal/registrarOposicion'' WHERE TAP_CODIGO = ''H021_registrarOposicion''';
