...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. Demandado en Incidente - CJ'', DD_TPO_XML_JBPM = ''cj_tramiteDemandadoEnIncidente'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';
