...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(75 CHAR)   := 'Trámite de demandado en incidente';   -- [PARAMETRO] Título del trámite
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
	      T_TIPO_TAP(
	        ...
	        /*TAP_CODIGO...................:*/ 'H025_ElaborarInformeCancelacion',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ 'comprobarExisteDocumentoINFCANOPE() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial;"><p style="margin-bottom: 10px">Para poder continuar debe adjuntar el documento "Informe de cancelaci&oacute;n de operaci&oacute;n".</p></div>''',
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ null,
	        /*DD_TPO_ID_BPM(FK)............:*/ null,
	        /*TAP_SUPERVISOR,..............:*/ '0',
	        /*TAP_DESCRIPCION,.............:*/ 'Elaborar informe de cancelación de operación',
	        /*VERSION......................:*/ '0',
	        /*USUARIOCREAR.................:*/ 'DD',
	        /*BORRADO......................:*/ '0',
	        ...
	        T_TIPO_TAP(
	        /*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
	        /*TAP_CODIGO...................:*/ 'H025_RegistrarRespuestaComite',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ null,
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ null,
	        ...
	        T_TIPO_TAP(
	        /*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
	        /*TAP_CODIGO...................:*/ 'H025_ActualizarInsinuacionCreditos',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ null,
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ null,
	        /*DD_TPO_ID_BPM(FK)............:*/ null,
	        /*TAP_SUPERVISOR,..............:*/ '0',
	        /*TAP_DESCRIPCION,.............:*/ 'Actualizar insinuación de créditos',
	        /*VERSION......................:*/ '0',
	        /*USUARIOCREAR.................:*/ 'DD',
	        /*BORRADO......................:*/ '0',
	        /*TAP_ALERT_NO_RETORNO.........:*/ null,
	        ...
	        T_TIPO_TAP(
	        /*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
	        /*TAP_CODIGO...................:*/ 'H025_BPMTramiteCostas',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ null,
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ null,
	        /*DD_TPO_ID_BPM(FK)............:*/ 'H007',
	        /*TAP_SUPERVISOR,..............:*/ '0',
	        /*TAP_DESCRIPCION,.............:*/ 'Trámite de costas',
	        /*VERSION......................:*/ '0',
	        /*USUARIOCREAR.................:*/ 'DD',
	        /*BORRADO......................:*/ '0',
	        /*TAP_ALERT_NO_RETORNO.........:*/ null,
	        ...
	        T_TIPO_TAP(
	        /*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
	        /*TAP_CODIGO...................:*/ 'H025_InsinuacionDecision',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ null,
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H025_ElaborarInformeCancelacion',
        ...
        T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H025_RegistrarRespuestaComite',
          /*DD_PTP_PLAZO_SCRIPT......:*/ '7*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
        ...
        T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H025_ActualizarInsinuacionCreditos',
          /*DD_PTP_PLAZO_SCRIPT......:*/ '15*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
        ...
        T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H025_BPMTramiteCostas',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_notificacionDemandaIncidental',
            /*TFI_ORDEN..............:*/ '6',
            /*TFI_TIPO...............:*/ 'combo',
            /*TFI_NOMBRE.............:*/ 'comboOposicion',
            /*TFI_LABEL..............:*/ 'Oposición / Allanamiento',
            ...
            /*TFI_BUSINESS_OPERATION.:*/ 'DDValidarInstrucciones',
			/*VERSION................:*/ '0',
            /*USUARIOCREAR...........:*/ 'DD'
        ),
        
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_registrarResolucion',
            /*TFI_ORDEN..............:*/ '7',
            /*TFI_TIPO...............:*/ 'combo',
            /*TFI_NOMBRE.............:*/ 'comboOperacion',
            /*TFI_LABEL..............:*/ 'Cancelación operación',
        ...
        T_TIPO_TFI (
            ...
            /*TFI_LABEL..............:*/ 'Cancelación de los créditos',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ 'DDSiNo',
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_ElaborarInformeCancelacion',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por finalizada esta tarea deber&aacute; indicar la fecha en la que realiza el informe as&iacute; como adjuntarlo al procedimiento.</p><p style="margin-bottom: 10px">Antes de dar por finalizada esta tarea deber&aacute; enviar una notificaci&oacute;n a An&aacute;lisis de recuperaciones (AnalisisdeRecuperacion@cajamar.int) indicando que se retrocedan las operaciones afectadas, si procede.</p><p style="margin-bottom: 10px">En caso de que se deba dar de baja el bien, deber&aacute; enviar una notificaci&oacute;n a Unidad de Registro Hipotecario (xxx@cajamar.ing) indicando esta circunstancia.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute; "Elevar a comit&eacute;".</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_ElevarComite',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por finalizada esta tarea deber&aacute; indicar la fecha en la que eleva al comit&eacute; el informe elaborado previamente.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute; "Registrar respuesta del comit&eacute;".</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_RegistrarRespuestaComite',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta tarea deber&aacute; registrar la fecha y la respuesta del comit&eacute;.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">La siguiente tarea ser&aacute; "Confirmar contabilidad".</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_ActualizarInsinuacionCreditos',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Antes de rellenar esta pantalla, para el supuesto que quiera insinuar alg&uacute;n cr&eacute;dito, deber&aacute; ir a la pestaña "Cr&eacute;ditos" de la ficha del asunto correspondiente y proceder a la actualizaci&oacute;n de las insinuaciones de los cr&eacute;ditos que corresponda.</p><p style="margin-bottom: 10px">En el campo Fecha indicar la fecha de actualizaci&oacute;n de las insinuaciones de los cr&eacute;ditos.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla se abrir&aacute; una tarea en la que propondr&aacute;, seg&uacute;n su criterio, la siguiente actuaci&oacute;n al responsable de la entidad.</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H025_BPMTramiteCostas',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se inicia el trámite de costas.</p></div>',
            /*TFI_ERROR_VALIDACION...:*/ null,
            /*TFI_VALIDACION.........:*/ null,
            /*TFI_VALOR_INICIAL......:*/ null,
            /*TFI_BUSINESS_OPERATION.:*/ null,
    ...
    CURSOR CRS_TAREA_BORRAR(P_COD_PROCEDIMIENTO V_COD_PROCEDIMIENTO%TYPE) IS 
		SELECT TAP_CODIGO 
			...
			WHERE TPO.DD_TPO_CODIGO = P_COD_PROCEDIMIENTO
				...
				AND TAP_CODIGO NOT IN ('H025_notificacionDemandaIncidental', 'H025_registrarOposicion', 'H025_admisionEscritoOposicion', 'H025_registrarVista', 'H025_registrarAllanamiento',
										'H025_registrarResolucion', 'H025_resolucionFirme', 'H025_registrarImporteCuotasAbonar', 'H025_ElaborarInformeCancelacion', 'H025_ElevarComite',
										'H025_RegistrarRespuestaComite', 'H025_contabilizar', 'H025_ActualizarInsinuacionCreditos', 'H025_BPMTramiteCostas', 'H025_InsinuacionDecision');
...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. Demandado en Incidente - CJ'', DD_TPO_XML_JBPM = ''cj_demandadoEnIncidente'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';
	
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_DECISION = ''valores[''''H025_notificacionDemandaIncidental''''][''''comboOposicion''''] == ''''OPOSICION'''' ? ''''OPOSICION'''' : valores[''''H025_notificacionDemandaIncidental''''][''''comboOposicion''''] == ''''ALLANAPARCIAL'''' ? ''''ALLANAPARCIAL'''' : ''''ALLANATOTAL'''''' WHERE TAP_CODIGO = ''H025_notificacionDemandaIncidental''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION = null WHERE TAP_CODIGO = ''H025_registrarResolucion''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_DECISION = ''valores[''''H025_registrarResolucion''''][''''comboCondena''''] == DDSiNo.SI ? ''''condena'''' : valores[''''H025_registrarResolucion''''][''''comboGarantias''''] == DDSiNo.SI ? ''''perdida'''' : valores[''''H025_registrarResolucion''''][''''comboOperacion''''] == DDSiNo.SI ? ''''cancelacion'''' : ''''otros'''''' WHERE TAP_CODIGO = ''H025_resolucionFirme''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_DESCRIPCION = ''Registrar el importe de las costas a abonar'' WHERE TAP_CODIGO = ''H025_registrarImporteCuotasAbonar''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_DESCRIPCION = ''Confirmar contabilidad'' WHERE TAP_CODIGO = ''H025_contabilizar''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''H025_resolucionFirme''''][''''combo1''''] == DDSiNo.SI && (valores[''''H025_registrarImporteCuotasAbonar''''][''''importeLetrado1''''] == null || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeLetrado1''''] == '''''''' || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeProcurador1''''] == null || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeProcurador1''''] == '''''''') ? ''''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Los importes de 1ª instancia son obligatorios</div>'''' : (valores[''''H025_resolucionFirme''''][''''combo2''''] == DDSiNo.SI && (valores[''''H025_registrarImporteCuotasAbonar''''][''''importeLetrado2''''] == null || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeLetrado2''''] == '''''''' || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeProcurador2''''] == null || valores[''''H025_registrarImporteCuotasAbonar''''][''''importeProcurador2''''] == '''''''') ? ''''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Los importes de 2ª instancia son obligatorios</div>'''' : null)'' WHERE TAP_CODIGO = ''H025_registrarImporteCuotasAbonar''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_VIEW = ''plugin/cajamar/tramiteDemandadoEnIncidente/registrarResolucion'' WHERE TAP_CODIGO = ''H025_registrarResolucion''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_VIEW = ''plugin/cajamar/tramiteDemandadoEnIncidente/admisionEscritoOposicion'' WHERE TAP_CODIGO = ''H025_admisionEscritoOposicion''';

	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_PTP_PLAZOS_TAREAS_PLAZAS SET DD_PTP_PLAZO_SCRIPT = ''(valores[''''H025_registrarVista''''] != null && valores[''''H025_registrarVista''''][''''fecha''''] != null ? damePlazo(valores[''''H025_registrarVista''''][''''fecha'''']) : (valores[''''H025_admisionEscritoOposicion''''] != null && valores[''''H025_admisionEscritoOposicion''''][''''fecha''''] != null ? damePlazo(valores[''''H025_admisionEscritoOposicion''''][''''fecha'''']) : damePlazo(valores[''''H025_registrarAllanamiento''''][''''fecha'''']))) + 30*24*60*60*1000L'' WHERE TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_PTP_PLAZOS_TAREAS_PLAZAS SET DD_PTP_PLAZO_SCRIPT = ''valores[''''H025_admisionEscritoOposicion''''] != null && valores[''''H025_admisionEscritoOposicion''''][''''fecha''''] != null ? damePlazo(valores[''''H025_admisionEscritoOposicion''''][''''fecha'''']) : damePlazo(valores[''''H025_registrarAllanamiento''''][''''fecha'''']) + 20*24*60*60*1000L'' WHERE TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_resolucionFirme'')';

	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Ind&iacute;quese la fecha en la que se nos notifica la demanda incidental, la plaza y el juzgado donde ha reca&iacute;do la demanda y el n&uacute;mero de procedimiento. Deber&aacute; usted adjuntar la demanda a trav&eacute;s de la pestaña de adjuntos del procedimiento junto a un informe sobre la misma, aunque no tiene car&aacute;cter obligatorio para finalizar esta tarea.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute;:<ul style="list-style-type:square;margin-left:35px;"><li>"Registrar oposici&oacute;n" si ha marcado Oposici&oacute;n o Allanamiento parcial</li><li>"Registrar allanamiento" si ha marcado Allanamiento total.</li></ul></p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_notificacionDemandaIncidental'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_ORDEN = 7 WHERE TFI_NOMBRE = ''observaciones'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_notificacionDemandaIncidental'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla debemos indicar la fecha en la que presentamos el allanamiento.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute; "Registrar resoluci&oacute;n".</p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarAllanamiento'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla se deber&aacute; de informar la fecha de notificaci&oacute;n de la Resoluci&oacute;n que hubiere reca&iacute;do.</p><p style="margin-bottom: 10px">Se indicar&aacute; si el resultado de dicha resoluci&oacute;n ha sido favorable para los intereses de la entidad o no.</p><p style="margin-bottom: 10px">Para el supuesto de que la resoluci&oacute;n si fuere favorable, deber&aacute; enviar una  notificaci&oacute;n a Control de Gesti&oacute;n Administraci&oacute;n (xxx@cajamar.int) informando de dicha circunstancia. Adem&aacute;s, se lanzará el Tr&aacute;mite de Costas.</p><p style="margin-bottom: 10px">Para el supuesto de que la resoluci&oacute;n no fuere favorable para la entidad, deber&aacute; notificar dicha circunstancia al responsable interno de la misma a trav&eacute;s del bot&oacute;n "Anotaci&oacute;n". Una vez reciba la aceptaci&oacute;n del supervisor deber&aacute; gestionar el recurso por medio de la pestaña "Recursos".</p><p style="margin-bottom: 10px">Para el supuesto de anuncio del recurso por la parte contraria se deber&aacute; gestionar directamente a trav&eacute;s de la pestaña "Recursos".</p><p style="margin-bottom: 10px">En caso de condena en costas deber&aacute; indicarlo en el campo correspondiente e informar de la cuant&iacute;a. En caso de p&eacute;rdida de garant&iacute;as deber&aacute; indicarlo expresamente as&iacute; como informar del importe de dichas garant&iacute;as rescindidas. En caso de cancelaci&oacute;n de operaci&oacute;n deber&aacute; indicarlo en el campo "Cancelaci&oacute;n operaci&oacute;n". En caso de que la resoluci&oacute;n no fuera favorable por ninguno de los motivos anteriores, deber&aacute; especificar el motivo en el campo Otros.</p><p style="margin-bottom: 10px">En caso de p&eacute;rdida de garant&iacute;a deber&aacute; enviar una notificaci&oacute;n v&iacute;a Recovery a la Unidad de Registro Hipotecario (xxx@cajamar.int).</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla la siguiente tarea ser&aacute; "Resoluci&oacute;n firme".</p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''Condena en costas'' WHERE TFI_NOMBRE = ''comboCondena'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''Importe condena en costas'' WHERE TFI_NOMBRE = ''importeCondena'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''Pérdida de garantía'' WHERE TFI_NOMBRE = ''comboGarantias'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''Importe de las garantías perdidas'' WHERE TFI_NOMBRE = ''importeGarantias'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'DELETE FROM '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS WHERE TFI_NOMBRE = ''comboRecurso'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_ORDEN = 10 WHERE TFI_NOMBRE = ''observaciones'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarResolucion'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se deber&aacute; informar la fecha en la que la Resoluci&oacute;n adquiere firmeza.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, en caso de que la resoluci&oacute;n sea Favorable, se lanzar&aacute; el "Tr&aacute;mite de costas". En caso contrario:<ul style="list-style-type:square;margin-left:35px;"><li>Si ha marcado Condena en costas, se lanzar&aacute; la tarea "Registrar el importe de las costas a abonar".</li><li>Si ha marcado P&eacute;rdida de garant&iacute;a, se lanzar&aacute; la tarea "Actualizar insinuaci&oacute;n de cr&eacute;ditos".</li><li>Si ha marcado Cancelaci&oacute;n operaci&oacute;n, se lanzar&aacute; la tarea "Elaborar informe de cancelaci&oacute;n de operaci&oacute;n".</li><li>Si el motivo no es ninguno de los anteriores finalizar&aacute; el tr&aacute;mite.</li></ul></p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_resolucionFirme'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_ORDEN = 4 WHERE TFI_NOMBRE = ''observaciones'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_resolucionFirme'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En caso de condena en costas, deber&aacute; informar los importes definitivos de las costas a abonar por la Entidad, ya sea si esta condena se ha producido tanto en el procedimiento como en el recurso.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_registrarImporteCuotasAbonar'')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea deber&aacute; confirmar e indicar la fecha en la que se ha contabilizado la cancelaci&oacute;n de la operaci&oacute;n.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellena esta pantalla, la siguiente tarea ser&aacute; "Actualizar insinuaci&oacute;n de cr&eacute;ditos".</p></div>'' WHERE TFI_NOMBRE = ''titulo'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H025_contabilizar'')';
