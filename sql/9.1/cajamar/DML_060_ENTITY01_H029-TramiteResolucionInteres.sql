...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(75 CHAR)   := 'Trámite de resolución de interés';   -- [PARAMETRO] Título del trámite
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'H029'; -- Código de procedimiento para reemplazar
...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. Resolución de Interés - CJ'', DD_TPO_XML_JBPM = ''cj_resolucionInteres'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';
