...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(50 CHAR)   := 'Trámite de créditos contingentes';   -- [PARAMETRO] Título del trámite
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'CJ003'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
    	T_TIPO_TPO(
    		...
    		/*DD_TPO_DESCRIPCION...........:*/ 'T. créditos contingentes - CJ',
    		/*DD_TPO_DESCRIPCION_LARGA.....:*/ 'Trámite de créditos contingentes',
    		/*DD_TPO_HTML..................:*/ null,
    		/*DD_TPO_XML_JBPM..............:*/ 'cj_creditosContingentes',
    		/*VERSION......................:*/ '0',
    		/*USUARIOCREAR.................:*/ 'DD',
    		/*BORRADO......................:*/ '0',
    		/*DD_TAC_ID(FK)................:*/ 'CO',
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP(
			...
			/*TAP_CODIGO...................:*/ 'CJ003_RevisarCreditosContingentes',
			/*TAP_VIEW.....................:*/ 'plugin/cajamar/tramiteCreditosContingentes/revisarCreditosContingentes',
			/*TAP_SCRIPT_VALIDACION........:*/ 'def fecha; for (java.util.Map.Entry<String, Map<String, String>> e : valores.entrySet()) { if (e.getKey().startsWith("CJ003_RevisarCreditosContingentes") && (fecha == null || e.getValue().get("fecha") > fecha)) { fecha = e.getValue().get("fecha"); };}; fecha = dameSiguienteFechaVencimiento(fecha); fecha == null ? ''<div align="justify" style="font-size: 8pt; font-family: Arial;"><p style="margin-bottom: 10px">No existen cr&eacute;ditos contingentes pr&oacute;ximos en el tiempo.</p></div>'' : null',
			/*TAP_SCRIPT_VALIDACION_JBPM...:*/ 'valores[''CJ003_RevisarCreditosContingentes''][''comboSeguimiento''] == DDSiNo.SI ? dameSiguienteFechaVencimiento(valores[''CJ003_RevisarCreditosContingentes''][''fecha'']) == null ? ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">No existen cr&eacute;ditos contingentes pr&oacute;ximos en el tiempo.</div>'' : null : null',
			/*TAP_SCRIPT_DECISION..........:*/ 'valores[''CJ003_RevisarCreditosContingentes''][''comboSeguimiento''] == DDSiNo.SI ? ''si'' : ''no''',
			/*DD_TPO_ID_BPM(FK)............:*/ null,
			/*TAP_SUPERVISOR,..............:*/ '0',
			/*TAP_DESCRIPCION,.............:*/ 'Revisar Créditos Contingentes',
			/*VERSION......................:*/ '0',
			/*USUARIOCREAR.................:*/ 'DD',
			/*BORRADO......................:*/ '0',
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS(
			/*DD_JUZ_ID(FK)............:*/ null,
			/*DD_PLA_ID(FK)............:*/ null,
			/*TAP_ID(FK)...............:*/ 'CJ003_RevisarCreditosContingentes',
			/*DD_PTP_PLAZO_SCRIPT......:*/ 'def fecha; if(nVecesTareaExterna > 0) { fecha = dameSiguienteFechaVencimiento(valores[''CJ003_RevisarCreditosContingentes''][''fecha'']) } else { fecha = dameSiguienteFechaVencimiento(null)}; fecha == null ? 1*24*60*60*1000L : damePlazo(fecha)',
			/*VERSION..................:*/ '0',
			/*BORRADO..................:*/ '0',
			/*USUARIOCREAR.............:*/ 'DD'
		)
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'CJ003_RevisarCreditosContingentes',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se deber&aacute; revisar el estado del cr&eacute;dito contingente a la fecha señalada en la pestaña de "Fase Com&uacute;n", si ha finalizado el mismo correctamente sin haberse materializado y si hay m&aacute;s cr&eacute;ditos contingentes en el procedimiento.</p><p style="margin-bottom: 10px">En el campo "Seguimiento" deber&aacute; indicar si es necesario un seguimiento para el siguiente cr&eacute;dito contingente con fecha de vencimiento m&aacute;s pr&oacute;ximo o si por el contrario decide finalizar este tr&aacute;mite para todos los cr&eacute;ditos contingentes reconocidos.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, si debe haber un Seguimiento, se lanzar&aacute; de nuevo la tarea "Revisar Cr&eacute;ditos Contingentes" con fecha vencimiento la del siguiente cr&eacute;dito contingente con fecha vencimiento m&aacute;s pr&oacute;xima. En caso de que no se necesite realizar un Seguimiento, finalizar&aacute; el tr&aacute;mite.</p></div>',
        ...
        T_TIPO_TFI (
            ...
            /*TFI_TIPO...............:*/ 'date',
            /*TFI_NOMBRE.............:*/ 'fecha',
            /*TFI_LABEL..............:*/ 'Fecha de vencimiento',
            ...
            /*TFI_VALOR_INICIAL......:*/ 'def fecha; for (java.util.Map.Entry<String, Map<String, String>> e : valores.entrySet()) { if (e.getKey().startsWith("CJ003_RevisarCreditosContingentes") && (fecha == null || e.getValue().get("fecha") > fecha)) { fecha = e.getValue().get("fecha"); };}; dameSiguienteFechaVencimiento(fecha);',
            /*TFI_BUSINESS_OPERATION.:*/ null,
            /*VERSION................:*/ '0',
            /*USUARIOCREAR...........:*/ 'DD'
        ),
