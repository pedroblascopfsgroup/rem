...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(50 CHAR)   := 'Trámite de solicitud de solvencia patrimonial';   -- [PARAMETRO] Título del trámite
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP(
			...
			/*TAP_CODIGO...................:*/ 'HC104_AutorizarPropuesta',
			/*TAP_VIEW.....................:*/ null,
			/*TAP_SCRIPT_VALIDACION........:*/ null,
			/*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
			/*TAP_SCRIPT_DECISION..........:*/ 'valores[''HC104_AutorizarPropuesta''][''resultado''] == ''ACEPTADO'' ? ''aceptado'' : ''denegado''',
		...
		T_TIPO_TAP(
			/*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
			/*TAP_CODIGO...................:*/ 'HC104_DecisionGestorContencioso',
			/*TAP_VIEW.....................:*/ null,
			/*TAP_SCRIPT_VALIDACION........:*/ null,
			/*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'HC104_AutorizarPropuesta',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI(
        	/*DD_TAP_ID..............:*/ 'HC104_AutorizarPropuesta',
        	/*TFI_ORDEN..............:*/ '0',
        	/*TFI_TIPO...............:*/ 'label',
        	/*TFI_NOMBRE.............:*/ 'titulo',
        	/*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px"><p style="margin-bottom: 10px">En esta tarea, la entidad se deber&aacute; confirmar si autoriza propuesta del gestor de contencioso procesal.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, y en caso de que la Entidad autorice la decisi&oacute;n, se lanzar&aacute; una toma de decisi&oacute;n al gestor de contencioso procesal para que derive el tr&aacute;mite propuesto. En caso contrario, la Entidad deber&aacute; indicar c&oacute;mo proceder.</p></div>',
...
BEGIN		
	...
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO SET TAP_CODIGO=''DEL_'||V_TAREA||''',BORRADO=1,FECHABORRAR=SYSDATE,USUARIOBORRAR=''ALBERTO C'' WHERE TAP_CODIGO='''||V_TAREA||'''';
	DBMS_OUTPUT.PUT_LINE('[INFO] Tarea HC104_TrasladarPropuestaEntidad actualizada.');
	
	V_TAREA:='HC104_BPMEjecucionTituloNoJudicial';
	EXECUTE IMMEDIATE 'DELETE FROM '||V_ESQUEMA ||'.DD_PTP_PLAZOS_TAREAS_PLAZAS WHERE TAP_ID IN (SELECT TAP_ID FROM '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = '''||V_TAREA||''')';
	EXECUTE IMMEDIATE 'DELETE FROM '||V_ESQUEMA ||'.TFI_TAREAS_FORM_ITEMS WHERE TAP_ID IN (SELECT TAP_ID FROM '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = '''||V_TAREA||''')';
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO SET TAP_CODIGO=''DEL_'||V_TAREA||''',BORRADO=1,FECHABORRAR=SYSDATE,USUARIOBORRAR=''ALBERTO C'' WHERE TAP_CODIGO='''||V_TAREA||'''';
	DBMS_OUTPUT.PUT_LINE('[INFO] Tarea HC104_BPMEjecucionTituloNoJudicial actualizada.');
	
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_DECISION = NULL WHERE TAP_CODIGO = ''HC104_RevisarSolvencia''';
	DBMS_OUTPUT.PUT_LINE('[INFO] Tarea HC104_RevisarSolvencia actualizada.');
