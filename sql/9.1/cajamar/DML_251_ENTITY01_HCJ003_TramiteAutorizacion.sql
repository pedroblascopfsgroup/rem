...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(50 CHAR)   := 'Trámite de autorización';   -- [PARAMETRO] Título del trámite
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'HCJ003'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
    	T_TIPO_TPO(
    		...
    		/*DD_TPO_DESCRIPCION...........:*/ 'T. autorización - HCJ',
    		/*DD_TPO_DESCRIPCION_LARGA.....:*/ 'Trámite de autorización',
    		/*DD_TPO_HTML..................:*/ null,
    		/*DD_TPO_XML_JBPM..............:*/ 'hcj_autorizacion',
    		/*VERSION......................:*/ '0',
    		/*USUARIOCREAR.................:*/ 'DD',
    		/*BORRADO......................:*/ '0',
    		/*DD_TAC_ID(FK)................:*/ 'TR',
    ...
    TYPE T_ARRAY_TAP IS TABLE OF T_TIPO_TAP;
		V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
	    	T_TIPO_TAP(
		        ...
		        /*TAP_CODIGO...................:*/ 'HCJ003_AutorizarPeticionPropuesta',
		        /*TAP_VIEW.....................:*/ null,
		        /*TAP_SCRIPT_VALIDACION........:*/ null,
		        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
		        /*TAP_SCRIPT_DECISION..........:*/ 'valores[''HCJ003_AutorizarPeticionPropuesta''][''comboResultado''] == ''ACEPTADO'' ? ''aceptado'' : ''denegado''',
		        /*DD_TPO_ID_BPM(FK)............:*/ null,
		        /*TAP_SUPERVISOR,..............:*/ '0',
		        /*TAP_DESCRIPCION,.............:*/ 'Autorizar petición o propuesta',
		        /*VERSION......................:*/ '0',
		        /*USUARIOCREAR.................:*/ 'DD',
		        /*BORRADO......................:*/ '0',
			...
			T_TIPO_TAP(
		        /*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
		        /*TAP_CODIGO...................:*/ 'HCJ003_AutorizacionDecision',
		        /*TAP_VIEW.....................:*/ null,
		        /*TAP_SCRIPT_VALIDACION........:*/ null,
		        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'HCJ003_AutorizarPeticionPropuesta',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'HCJ003_AutorizarPeticionPropuesta',
            /*TFI_ORDEN..............:*/ '0',
            /*TFI_TIPO...............:*/ 'label',
            /*TFI_NOMBRE.............:*/ 'titulo',
            /*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta tarea, la entidad deber&aacute; autorizar o denegar la petici&oacute;n/propuesta realizada por HRE para continuar con la gesti&oacute;n. Para ello, deber&aacute; revisar la actuaci&oacute;n en curso y los motivos por los que se le ha requerido autorizaci&oacute;n.</p><p style="margin-bottom: 10px">El resultado de su decisi&oacute;n deber&aacute; anotarlo en el combo Resultado.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellena esta pantalla:<ul style="list-style-type:square;margin-left:35px;"><li>En el caso que indique "Autorizado", saltar&aacute; la siguiente tarea al gestor de HRE correspondiente de acuerdo al flujo definido para la actuaci&oacute;n en curso.<li></li>En el caso que indique "Denegado", se le abrir&aacute; tarea en la que propondr&aacute;, seg&uacute;n su criterio, la siguiente actuaci&oacute;n al responsable de la entidad.</li></ul></p></div>',
