...
IF V_NUM_TABLAS = 0 THEN
	...
	V_MSQL := 'INSERT INTO ' || V_ESQUEMA || '.DES_DESPACHO_EXTERNO (DES_ID, DES_DESPACHO, VERSION, USUARIOCREAR, FECHACREAR, DD_TDE_ID) VALUES (S_DES_DESPACHO_EXTERNO.NEXTVAL, ''Despacho Oficina'', 0, ''PCO'', sysdate, ' || V_DD_TDE_ID_OFI || ')'; 
	EXECUTE IMMEDIATE V_MSQL;
END IF;
