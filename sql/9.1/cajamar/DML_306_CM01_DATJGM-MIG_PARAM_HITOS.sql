...
, T_MPH ('132','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','57','H005_SolicitudDecretoAdjudicacion','33','Solicitud de Decreto de Adjudicación','1','1')
, T_MPH ('133','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','57','H005_notificacionDecretoAdjudicacionAEntidad','34','Notificación del Decreto de Adjudicación a Entidad','1','1')
, T_MPH ('134','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','57','H005_DeclaracionIVAIGIC','35','Declarar IVA e IGIC','1','0')
, T_MPH ('135','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','57','H005_notificacionDecretoAdjudicacionAlContrario','36','Notificación del Decreto de Adjudicación al Contrario','1','0')
, T_MPH ('136','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','58','H005_SolicitudTestimonioDecretoAdjudicacion','37','Solicitud de Testimonio del Decreto de Adjudicación','1','1')
, T_MPH ('137','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','58','H005_ConfirmarTestimonio','38','Confirmar el Testimonio','1','1')
, T_MPH ('138','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','58','H005_RegistrarPresentacionEnRegistro','39','Registrar presentación en Registro','1','1')
, T_MPH ('139','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','58','H005_RegistrarInscripcionDelTitulo','40','Registrar Inscripción del Título','1','1')
, T_MPH ('140','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','58','H015_RegistrarSolicitudPosesion','41','Registrar Solicitud de Posesión','1','1')
, T_MPH ('141','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','58','H015_RegistrarSenyalamientoPosesion','42','Registrar Señalamiento de la Posesión','1','1')
, T_MPH ('142','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','58','H015_RegistrarPosesionYLanzamiento','43','Registrar posesión y decisión sobre lanzamiento','1','1')
, T_MPH ('143','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','58','H015_RegistrarSenyalamientoLanzamiento','44','Registrar Señalamiento del Lanzamiento','1','0')
