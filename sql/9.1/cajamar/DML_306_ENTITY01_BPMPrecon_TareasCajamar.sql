...
T_LINEA('PCO_PrepararExpediente','PCO_CM_GE_PCO','45','SUP_PCO'),
T_LINEA('PCO_SolicitarDoc','PCO_CM_GD_PCO','2','SUP_PCO'),
...
T_LINEA('PCO_SubsanarIncidenciaExp','PCO_CM_GE_PCO','10','SUP_PCO'),
--T_LINEA('PCO_ValidarCambioProc','PCO_SUP','2','SUP_PCO'),
T_LINEA('PCO_SubsanarCambioProc','PCO_CM_GE_PCO','10','SUP_PCO'),
--T_LINEA('PCO_RevisarExpediente','PCO_LET','5','SUP_PCO'),
T_LINEA('PCO_RegResultadoExped','PCO_CM_GD_PCO','2','SUP_PCO'),
T_LINEA('PCO_RecepcionExped','PCO_CM_GD_PCO','15','SUP_PCO'),
T_LINEA('PCO_RegResultadoDoc','PCO_CM_GD_PCO','2','SUP_PCO'),
T_LINEA('PCO_RegEnvioDoc','PCO_CM_GD_PCO','2','SUP_PCO'),
T_LINEA('PCO_RecepcionDoc','PCO_CM_GD_PCO','2','SUP_PCO'),
T_LINEA('PCO_AdjuntarDoc','PCO_CM_GD_PCO','10','SUP_PCO'),
T_LINEA('PCO_GenerarLiq','PCO_CM_GL_PCO','45','SUP_PCO'),
T_LINEA('PCO_ConfirmarLiq','PCO_CM_GL_PCO','2','SUP_PCO'),
T_LINEA('PCO_EnviarBurofax','PCO_CM_GL_PCO','2','SUP_PCO'),
T_LINEA('PCO_AcuseReciboBurofax','PCO_CM_GL_PCO','7','SUP_PCO')
    ); 
