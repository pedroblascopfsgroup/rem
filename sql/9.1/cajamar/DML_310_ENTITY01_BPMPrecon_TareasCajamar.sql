...
T_LINEA('PCO_RegResultadoDocG','TGESCON','2','PCO_CM_GE'),
T_LINEA('PCO_RevisarExpDigCONC','PCO_LET','2','SUP_PCO'),
T_LINEA('PCO_ResolverIncidenciaExpCONC','PCO_CM_GE','7','SUP_PCO')
    ); 
