...
BEGIN
    ...
    --** Comprobamos si existe la tabla   
 		...
 		V_SQL := 'SELECT COUNT(1) FROM '||v_esquema||'.dd_sce_segto_cli_entidad WHERE DD_SCE_CODIGO =''SinDefinir''';
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] '||v_esquema||'.dd_sce_segto_cli_entidad... DML FIN');  
