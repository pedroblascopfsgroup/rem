...
--## PRODUCTO=NO
--## Finalidad: Actualizar la tabla pen_param_entidad
--##           
...
BEGIN
    ...
    -----------------------   
                        ...
                        V_MSQL := 'UPDATE '||v_esquema||'.PEN_PARAM_ENTIDAD set pen_valor=500 where pen_param = ''expediente.obtenerContratosAdicionales.limite''';
