...
, T_MPH ('53','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','39','H005_SolicitudDecretoAdjudicacion','27','Solicitud de Decreto de Adjudicación','1','0')
, T_MPH ('54','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','63','H005_notificacionDecretoAdjudicacionAEntidad','28','Notificación del Decreto de Adjudicación a Entidad','1','1')
, T_MPH ('55','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','63','H005_DeclaracionIVAIGIC','29','Declarar IVA e IGIC','1','1')
, T_MPH ('56','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','63','H005_notificacionDecretoAdjudicacionAlContrario','31','Notificación del Decreto de Adjudicación al Contrario','1','1')
, T_MPH ('57','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','63','H005_SolicitudTestimonioDecretoAdjudicacion','32','Solicitud de Testimonio del Decreto de Adjudicación','1','1')
, T_MPH ('58','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','64','H005_ConfirmarTestimonio','33','Confirmar el Testimonio','1','0')
, T_MPH ('59','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','67','H005_RegistrarPresentacionEnRegistro','38','Registrar presentación en Registro','1','1')
, T_MPH ('60','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','67','H005_RegistrarInscripcionDelTitulo','39','Registrar Inscripción del Título','1','1')
, T_MPH ('61','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSolicitudPosesion','40','Registrar Solicitud de Posesión','1','1')
, T_MPH ('62','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSenyalamientoPosesion','41','Registrar Señalamiento de la Posesión','1','1')
, T_MPH ('63','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','67','H015_RegistrarPosesionYLanzamiento','42','Registrar posesión y decisión sobre lanzamiento','1','1')
, T_MPH ('64','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSenyalamientoLanzamiento','43','Registrar Señalamiento del Lanzamiento','1','0')
...
, T_MPH ('132','P03','Ejecución Ordinaria','H006','T. de cesión de remate - HCJ','57','H006_AperturaPlazo','33','Apertura del plazo de cesión de remate','1','1')
, T_MPH ('133','P03','Ejecución Ordinaria','H006','T. de cesión de remate - HCJ','57','H006_ResenyarFechaComparecencia','34','Registrar fecha comparecencia','1','0')
, T_MPH ('134','P03','Ejecución Ordinaria','H006','T. de cesión de remate - HCJ','58','H006_RealizacionCesionRemate','35','Registrar realización cesión de remate','1','1')
, T_MPH ('135','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','58','H005_SolicitudDecretoAdjudicacion','36','Solicitud de Decreto de Adjudicación','1','0')
, T_MPH ('136','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','63','H005_notificacionDecretoAdjudicacionAEntidad','37','Notificación del Decreto de Adjudicación a Entidad','1','1')
, T_MPH ('137','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','63','H005_DeclaracionIVAIGIC','38','Declarar IVA e IGIC','1','1')
, T_MPH ('138','P03','Ejecución Ordinaria','HCJ001','T. declaración IVA/IGIC - HCJ','63','HCJ001_DeclararIVAIGIC','39','Declarar IVA/IGIC','1','1')
, T_MPH ('139','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','63','H005_notificacionDecretoAdjudicacionAlContrario','40','Notificación del Decreto de Adjudicación al Contrario','1','1')
, T_MPH ('140','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','63','H005_SolicitudTestimonioDecretoAdjudicacion','41','Solicitud de Testimonio del Decreto de Adjudicación','1','1')
, T_MPH ('141','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','64','H005_ConfirmarTestimonio','42','Confirmar el Testimonio','1','0')
, T_MPH ('142','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','64','H005_RevisarInfoContable','43','Revisar y obtener información contable','1','0')
, T_MPH ('143','P03','Ejecución Ordinaria','H008','T. de saneamiento de cargas - HCJ','64','H008_RevisarEstadoCargas','44','Revisar el estado de las cargas','1','0')
...
, T_MPH ('208','P01','Ejecución Hipotecaria','HCJ001','T. declaración IVA/IGIC - HCJ','63','HCJ001_DeclararIVAIGIC','30','Declarar IVA/IGIC','1','1')
, T_MPH ('209','P01','Ejecución Hipotecaria','H006','T. de cesión de remate - HCJ','38','H006_AperturaPlazo','24','Apertura del plazo de cesión de remate','1','1')
, T_MPH ('210','P01','Ejecución Hipotecaria','H006','T. de cesión de remate - HCJ','38','H006_ResenyarFechaComparecencia','25','Registrar fecha comparecencia','1','0')
, T_MPH ('211','P01','Ejecución Hipotecaria','H006','T. de cesión de remate - HCJ','39','H006_RealizacionCesionRemate','26','Registrar realización cesión de remate','1','1')
, T_MPH ('212','P01','Ejecución Hipotecaria','H008','T. de saneamiento de cargas - HCJ','64','H008_RevisarEstadoCargas','35','Revisar el estado de las cargas','1','0')
, T_MPH ('213','P01','Ejecución Hipotecaria','H042','T. de Intereses - HCJ','65','H042_ElaborarLiquidacion','36','Elaborar, enviar Liquidación de intereses','1','0')
, T_MPH ('215','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','68','H015_RegistrarLanzamientoEfectuado','44','Registrar lanzamiento efectuado','1','0')
, T_MPH ('216','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','69','H015_RegistrarDecisionLlaves','45','Registrar decisión sobre llaves','1','0')
, T_MPH ('217','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','64','H005_RevisarInfoContable','34','Revisar y obtener información contable','1','0')
, T_MPH ('218','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','66','H005_ConfirmarContabilidad','37','Confirmar Contabilidad','1','1')
, T_MPH ('219','P03','Ejecución Ordinaria','H042','T. de Intereses - HCJ','65','H042_ElaborarLiquidacion','45','Elaborar, enviar Liquidación de intereses','1','0')
, T_MPH ('220','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','66','H005_ConfirmarContabilidad','46','Confirmar Contabilidad','1','1')
, T_MPH ('221','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','67','H005_RegistrarPresentacionEnRegistro','47','Registrar presentación en Registro','1','1')
, T_MPH ('222','P03','Ejecución Ordinaria','H005','Trámite de Adjudicación - HCJ','67','H005_RegistrarInscripcionDelTitulo','48','Registrar Inscripción del Título','1','1')
, T_MPH ('223','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSolicitudPosesion','49','Registrar Solicitud de Posesión','1','1')
, T_MPH ('224','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSenyalamientoPosesion','50','Registrar Señalamiento de la Posesión','1','1')
, T_MPH ('225','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','67','H015_RegistrarPosesionYLanzamiento','51','Registrar posesión y decisión sobre lanzamiento','1','1')
, T_MPH ('226','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','67','H015_RegistrarSenyalamientoLanzamiento','52','Registrar Señalamiento del Lanzamiento','1','0')
, T_MPH ('227','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','68','H015_RegistrarLanzamientoEfectuado','53','Registrar lanzamiento efectuado','1','0')
, T_MPH ('228','P03','Ejecución Ordinaria','H015','T. de Posesión - HCJ','69','H015_RegistrarDecisionLlaves','54','Registrar decisión sobre llaves','1','0')
);
