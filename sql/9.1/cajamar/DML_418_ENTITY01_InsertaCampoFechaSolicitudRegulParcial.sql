...
BEGIN
    ...
    IF V_NUM_TABLAS > 0 THEN	  
     V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACU_CAMPOS_TIPO_ACUERDO (CMP_ID,DD_TPA_ID,CMP_NOMBRE_CAMPO,VERSION,USUARIOCREAR,FECHACREAR,BORRADO,USUARIOMODIFICAR,FECHAMODIFICAR,USUARIOBORRAR,FECHABORRAR, CMP_LABEL) VALUES ('||V_ESQUEMA||'.S_ACU_CAMPOS_TIPO_ACUERDO.NEXTVAL,(SELECT DD_TPA_ID FROM DD_TPA_TIPO_ACUERDO WHERE DD_TPA_CODIGO = ''REGU_PARCIAL''), ''fechaSolucionPrevista'', 0, ''CMREC-1947'', SYSDATE, 0, NULL, NULL,NULL, NULL, ''Fecha Sol. Prevista'')';
