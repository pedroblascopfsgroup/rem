...
-- ----------------------------------------------------------------------------------------------
  ...
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_EXP_GESTOR(
      ...
      GESTOR_EXP_APELLIDO2) VALUES (-1 ,'Sin Gestor Asignado','Sin Gestor Asignado', 'Sin Gestor Asignado', 'Sin Gestor Asignado');
  END IF;
...
-- ----------------------------------------------------------------------------------------------
  ...
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_EXP_SUPERVISOR(
      ...
      SUPERVISOR_EXP_APELLIDO2) VALUES (-1 ,'Sin Supervisor Asignado','Sin Supervisor Asignado', 'Sin Supervisor Asignado', 'Sin Supervisor Asignado');
  END IF;
