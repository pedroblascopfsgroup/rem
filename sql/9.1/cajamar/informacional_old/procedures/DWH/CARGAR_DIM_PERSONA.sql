...
-- ----------------------------------------------------------------------------------------------
  ...
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (2,'< 100');
  END IF;
  SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 3;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (3,'100 - 300');
  END IF;
  SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 4;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (4,'301 - 500');
  END IF;
    SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 5;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (5,'501 - 700');
  END IF;
    SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 6;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (6,'701 - 1000');
  END IF;
  SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 7;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (7,'1000 - 2000');
  END IF;
  SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 8;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (8,'2000 - 3000');
  END IF;
    SELECT COUNT(*) INTO V_NUM_ROW FROM D_PER_TRAMO_PUNTUACION WHERE TRAMO_PUNTUACION_ID = 9;
  IF (V_NUM_ROW = 0) THEN
    INSERT INTO D_PER_TRAMO_PUNTUACION (TRAMO_PUNTUACION_ID, TRAMO_PUNTUACION_DESC) VALUES (9,'> 3000');
  END IF;
   commit;
