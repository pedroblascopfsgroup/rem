...
*/
    ...
    SELECT '||V_ESQUEMA||'.S_EXP_EXPEDIENTES.NEXTVAL as EXP_ID
      ...
      UNION
    	  SELECT CD_CONCURSO CD_PROCEDIMIENTO, NULL CD_EXPEDIENTE_NUSE , NULL NUMERO_EXP_NUSE 
    	    FROM '||V_ESQUEMA||'.MIG_CONCURSOS_CABECERA) PRC,      
         (SELECT DISTINCT CD_PROCEDIMIENTO 
            FROM MIG_MAESTRA_HITOS) MAE
