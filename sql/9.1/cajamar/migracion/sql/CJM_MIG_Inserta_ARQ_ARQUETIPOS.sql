...
--ITI_ITINERARIOS
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ITI_ITINERARIOS (ITI_ID,ITI_NOMBRE,USUARIOCREAR,FECHACREAR,DD_TIT_ID,DD_AEX_ID,TPL_ID) VALUES ( '||V_ESQUEMA||'.S_ITI_ITINERARIOS.nextval,''Migracion'',''PFS-CONF'',sysdate,(SELECT DD_TIT_ID FROM CMMASTER.DD_TIT_TIPO_ITINERARIOS WHERE DD_TIT_CODIGO = ''REC''),(select DD_AEX_ID from CMMASTER.DD_AEX_AMBITOS_EXPEDIENTE where DD_AEX_CODIGO = ''CP''),(select TPL_ID from '||V_ESQUEMA||'.TPL_TIPO_POLITICA where TPL_CODIGO = ''TPL02''))';
     EXECUTE IMMEDIATE V_MSQL;
...
--LIA_LISTA_ARQUETIPOS
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.LIA_LISTA_ARQUETIPOS (LIA_ID,ITI_ID,LIA_PRIORIDAD,LIA_NOMBRE,USUARIOCREAR,FECHACREAR,LIA_NIVEL,LIA_GESTION,LIA_PLAZO_DISPARO,DD_TSN_ID,RD_ID) VALUES ('||V_ESQUEMA||'.S_LIA_LISTA_ARQUETIPOS.nextval,null,null,''GR. Migracion'',''PFS-CONF'',sysdate,0,1,90,(SELECT DD_TSN_ID  FROM CMMASTER.DD_TSN_TIPO_SALTO_NIVEL  WHERE DD_TSN_CODIGO = ''TODOS''),(SELECT RD_ID  FROM '||V_ESQUEMA||'.RULE_DEFINITION  WHERE RD_NAME =''Migracion''))';
     EXECUTE IMMEDIATE V_MSQL;
...
--ARQ_ARQUETIPOS
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ARQ_ARQUETIPOS (ARQ_ID,ITI_ID,ARQ_PRIORIDAD,ARQ_NOMBRE,USUARIOCREAR,FECHACREAR,ARQ_NIVEL,ARQ_GESTION,ARQ_PLAZO_DISPARO,DD_TSN_ID,RD_ID,MRA_ID,DTYPE) VALUES ( '||V_ESQUEMA||'.S_ARQ_ARQUETIPOS.nextval,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''),1,''Migracion'',''PFS-CONF'',sysdate,0,1,90,(SELECT DD_TSN_ID FROM CMMASTER.DD_TSN_TIPO_SALTO_NIVEL WHERE DD_TSN_CODIGO = ''TODOS''),(SELECT RD_ID FROM '||V_ESQUEMA||'.RULE_DEFINITION WHERE RD_NAME = ''Migracion''), (select MRA_ID from MRA_REL_MODELO_ARQ where LIA_ID = (select LIA_ID from LIA_LISTA_ARQUETIPOS where LIA_NOMBRE =  ''Migracion'' )),''ARQArquetipo'')';
     EXECUTE IMMEDIATE V_MSQL;
     
--EST_ESTADOS
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''SER_CENTRALES''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''CAR''),0,5184000000,null,''PFS-CONF'',sysdate)';
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''SER_CENTRALES''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''GV''),0,864000000,null,''PFS-CONF'',sysdate)';
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''SER_CENTRALES''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''CE''),0,864000000,null,''PFS-CONF'',sysdate)';
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''DIR_RIESGOS''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_TERRITORIAL_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''RE''),0,432000000,null,''PFS-CONF'',sysdate)';
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''DIR_TERRITORIAL_RIESGOS''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_TERRITORIAL_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''DC''),0,604800000,null,''PFS-CONF'',sysdate)';
  V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.EST_ESTADOS (EST_ID,PEF_ID_GESTOR,PEF_ID_SUPERVISOR,TEL_ID,DCA_ID,ITI_ID,DD_EST_ID,EST_TELECOBRO,EST_PLAZO,EST_AUTOMATICO,USUARIOCREAR,FECHACREAR) VALUES ('||V_ESQUEMA||'.S_EST_ESTADOS.nextval,(SELECT PEF_ID FROM PEF_PERFILES WHERE PEF_CODIGO = ''SER_CENTRALES''),(SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''DIR_RIESGOS''),null,null,(SELECT ITI_ID FROM '||V_ESQUEMA||'.ITI_ITINERARIOS WHERE ITI_NOMBRE = ''Migracion''), (SELECT DD_EST_ID FROM CMMASTER.DD_EST_ESTADOS_ITINERARIOS WHERE DD_EST_CODIGO = ''FP''),0,1296000000,null,''PFS-CONF'',sysdate)';
     EXECUTE IMMEDIATE V_MSQL;
