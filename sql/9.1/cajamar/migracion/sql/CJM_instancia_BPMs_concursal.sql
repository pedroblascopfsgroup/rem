...
-- select PROCESSINSTANCE_, count(*) from ''||V_ESQUEMA_M||''.JBPM_VARIABLEINSTANCE where NAME_='DB_ID' group by PROCESSINSTANCE_ having count(*)>1 
...
--select * from ''||V_ESQUEMA_M||''.Jbpm_Variableinstance where processinstance_=164046426
