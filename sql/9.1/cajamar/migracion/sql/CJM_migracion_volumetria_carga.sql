...
--    UNION ALL SELECT 'LOAD'      AS BLOQUE, 'MIG_EXPEDIENTES_OBSER_TROZOS' AS TABLA, count(*) from  CM01.MIG_EXPEDIENTES_OBSER_TROZOS
    ...
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'CLI_CLIENTES'                   AS TABLA, count(*) from CM01.CLI_CLIENTES WHERE USUARIOCREAR = 'MIGRACM01'                                             
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'CCL_CONTRATOS_CLIENTE'          AS TABLA, count(*) from CM01.CCL_CONTRATOS_CLIENTE WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'EXP_EXPEDIENTES'                AS TABLA, count(*) from CM01.EXP_EXPEDIENTES WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'PEX_PERSONAS_EXPEDIENTE'        AS TABLA, count(*) from CM01.PEX_PERSONAS_EXPEDIENTE WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'CEX_CONTRATOS_EXPEDIENTE'       AS TABLA, count(*) from CM01.CEX_CONTRATOS_EXPEDIENTE WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'ASU_ASUNTOS'                    AS TABLA, count(*) from CM01.ASU_ASUNTOS WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'PRC_PROCEDIMIENTOS'             AS TABLA, count(*) from CM01.PRC_PROCEDIMIENTOS WHERE USUARIOCREAR = 'MIGRACM01'
    ...
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'TAR_TAREAS_NOTIFICACIONES'      AS TABLA, count(*) from CM01.TAR_TAREAS_NOTIFICACIONES WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'TEX_TAREA_EXTERNA'              AS TABLA, count(*) from CM01.TEX_TAREA_EXTERNA WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'TEV_TAREA_EXTERNA_VALOR'        AS TABLA, count(*) from CM01.TEV_TAREA_EXTERNA_VALOR WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'SUB_SUBASTA'                    AS TABLA, count(*) from CM01.SUB_SUBASTA WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'LOS_LOTE_SUBASTA'               AS TABLA, count(*) from CM01.LOS_LOTE_SUBASTA WHERE USUARIOCREAR = 'MIGRACM01'                                         
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'LOB_LOTE_BIEN'                  AS TABLA, count(*) from CM01.LOB_LOTE_BIEN
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'PRB_PRC_BIE'                    AS TABLA, count(*) from CM01.PRB_PRC_BIE WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'GAA_GESTOR_ADICIONAL_ASUNTO'    AS TABLA, count(*) from CM01.GAA_GESTOR_ADICIONAL_ASUNTO WHERE USUARIOCREAR = 'MIGRACM01'
    UNION ALL SELECT 'MIGRACION' AS BLOQUE, 'GAH_GESTOR_ADICIONAL_HISTORICO' AS TABLA, count(*) from CM01.GAH_GESTOR_ADICIONAL_HISTORICO WHERE USUARIOCREAR = 'MIGRACM01';
