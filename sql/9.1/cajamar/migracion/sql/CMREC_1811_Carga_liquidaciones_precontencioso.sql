...
BEGIN
        ...
        V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.PCO_LIQ_LIQUIDACIONES (PCO_LIQ_ID, PCO_PRC_ID, DD_PCO_LIQ_ID, CNT_ID, usuariocrear, fechacrear)
                      SELECT s_PCO_LIQ_LIQUIDACIONES.nextval, pco_prc_id, 1, cnt_id, ''SAG'', sysdate
                   FROM (
