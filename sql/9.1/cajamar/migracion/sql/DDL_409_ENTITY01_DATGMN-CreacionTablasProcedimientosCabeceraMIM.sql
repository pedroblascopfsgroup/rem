...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_PROCEDIMS_CABECERA_MIM';
 ...
 V_EXISTE NUMBER (1);
 SEQUENCE VARCHAR(30) :='S_MIG_PROCEDIMS_CABECERA_MIM';
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	  ...
	  GESTION_PLATAFORMA            VARCHAR2 (1)       NOT NULL ,       
	   CONSTRAINT "PK_ID_PROC_CABECERA_MIM" PRIMARY KEY ("ID_PROC_CABECERA")
