...
DECLARE
    ...
    -- SIN ESTADO "0" / ALTA DUDOSO "5" (484)
    CURSOR C_CONTRATOS_FP IS
		...
		AND CNT2.ESTADO_ACUERDO = 0 AND CNT2.TIPO_ACUERDO = 5
        ) TT;        
...
BEGIN 
   ...
   LOOP
    	...
    	DBMS_OUTPUT.PUT_LINE('Contrato para trabajar como ALTA DUDOSO...[ ' || V_FOND_PROP.CNT_CONTRATO || ' ].' );
                      ...
                      VALUES (CM01.s_tea_terminos_acuerdo.NEXTVAL, (SELECT MAX (acu_id)
                                                       ...
                                                       WHERE exp_id = (SELECT exp_id
                                                             ...
                                                             (SELECT dd_tpa_id
                                                              ...
                                                              WHERE dd_tpa_codigo = 'SINSOLUCION'), 0, 'val.oficina', SYSTIMESTAMP, 0, 1,
