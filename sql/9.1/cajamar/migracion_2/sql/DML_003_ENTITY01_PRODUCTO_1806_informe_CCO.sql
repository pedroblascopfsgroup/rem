...
SELECT
    ...
    cco_contabilizado
FROM CM01.cco_contabilidad_cobros
...
SELECT
    ...
    concepto_entrega
FROM CM01.mig_cco_contabilidad_cobros
WHERE NOT EXISTS (SELECT 1 FROM CM01.cco_contabilidad_cobros cco, CM01.asu_asuntos a 
