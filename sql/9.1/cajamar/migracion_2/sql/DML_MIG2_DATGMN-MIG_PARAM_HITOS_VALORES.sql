...
--*/
 ...
 TABLA                               VARCHAR2(100 CHAR):= 'MIG_PARAM_HITOS_VALORES';
 SECUENCIA                           VARCHAR2(100 CHAR):= 'S_MIG_PARAM_HITOS_VALORES';
 ...
 V_USUARIO_CREAR VARCHAR2(10) := 'MIGRA2CM01';
...
--Código de tabla
   ...
   V_MPH T_ARRAY_MPH := T_ARRAY_MPH(
                                      ...
                                      , T_MPH ( '356','143','MIG_PROCEDIMIENTOS_BIENES','0','1','1','H008_RevisarEstadoCargas','fecha')
                                      , T_MPH ( '363','142','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CONTABILIDAD)-4','1','1','H005_RevisarInfoContable','fecha')
                                      , T_MPH ( '311','141','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_TESTIMONIO_DECRETO)','1','1','H005_ConfirmarTestimonio','fechaTestimonio')
                                      , T_MPH ( '312','141','MIG_PROCEDIMIENTOS_BIENES','OBSERVACIONES_ADJUDICACION','2','0','H005_ConfirmarTestimonio','observaciones')
                                      , T_MPH ( '310','140','MIG_PROCEDIMIENTOS_BIENES','ADD_MONTHS(MIN(FECHA_DECRETO_ADJ_NO_FIRME),-1)','1','1','H005_SolicitudTestimonioDecretoAdjudicacion','fecha')
                                      , T_MPH ( '309','139','MIG_PROCEDIMIENTOS_BIENES','ADD_MONTHS(MIN(FECHA_DECRETO_ADJ_NO_FIRME),-2)','1','1','H005_notificacionDecretoAdjudicacionAlContrario','fecha')
                                      , T_MPH ( '319','137','MIG_PROCEDIMIENTOS_BIENES','ADD_MONTHS(MIN(FECHA_DECRETO_ADJ_NO_FIRME),-2)','1','1','H005_DeclaracionIVAIGIC','fecha')
                                      , T_MPH ( '308','136','MIG_PROCEDIMIENTOS_SUBASTAS','MIN(FECHA_DECRETO_ADJUDICACION)','2','0','H005_notificacionDecretoAdjudicacionAEntidad','fechaResol')
                                      , T_MPH ( '307','136','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_DECRETO_ADJ_NO_FIRME)','1','1','H005_notificacionDecretoAdjudicacionAEntidad','fecha')
                                      , T_MPH ( '306','135','MIG_PROCEDIMIENTOS_BIENES','ADD_MONTHS(MIN(FECHA_DECRETO_ADJ_NO_FIRME),-3)','1','1','H005_SolicitudDecretoAdjudicacion','fechaSolicitud')
                                      , T_MPH ( '357','134','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)','1','1','H006_RealizacionCesionRemate','fecha')
                                      ...
                                      , T_MPH ( '305','64','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_SENYALAMIENTO_POSESION)','1','1','H015_RegistrarSenyalamientoLanzamiento','fecha')
                                      ...
                                      , T_MPH ( '358','133','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)-2','1','1','H006_ResenyarFechaComparecencia','fecha')
                                      , T_MPH ( '359','132','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)-4','1','1','H006_AperturaPlazo','fecha')
                                      ...
                                      , T_MPH ( '330','225','MIG_PROCEDIMIENTOS_BIENES','MAX(NECESARIA_FUERZA_POSESION)','3','0','H015_RegistrarPosesionYLanzamiento','comboFuerzaPublica')
                                      , T_MPH ( '331','225','MIG_PROCEDIMIENTOS_BIENES','MAX(NECESARIA_FUERZA_LANZAMIENTO)','4','0','H015_RegistrarPosesionYLanzamiento','comboLanzamiento')
                                      , T_MPH ( '327','224','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_SENYALAMIENTO_POSESION)','1','1','H015_RegistrarSenyalamientoPosesion','fechaSenyalamiento')
                                      , T_MPH ( '326','223','MIG_PROCEDIMIENTOS_BIENES','MAX(OBSERVACIONES_POSESION)','7','0','H015_RegistrarSolicitudPosesion','observaciones')
                                      , T_MPH ( '325','223','MIG_PROCEDIMIENTOS_BIENES','DECODE(MAX(FECHA_SOLICITUD_MORATORIA),NULL,0,1)','6','0','H015_RegistrarSolicitudPosesion','comboMoratoria')
                                      , T_MPH ( '324','223','MIG_PROCEDIMIENTOS_BIENES','MAX(VIVIENDA_HABITUAL)','5','0','H015_RegistrarSolicitudPosesion','comboViviendaHab')
                                      , T_MPH ( '323','223','MIG_PROCEDIMIENTOS_BIENES','MAX(OCUPANTES)','4','0','H015_RegistrarSolicitudPosesion','comboOcupado')
                                      , T_MPH ( '321','223','MIG_PROCEDIMIENTOS_BIENES','DECODE(MAX(FECHA_CONTRATO_ARREND),NULL,0,1)','2','0','H015_RegistrarSolicitudPosesion','comboArrendamientoValido')
                                      , T_MPH ( '322','223','MIG_PROCEDIMIENTOS_BIENES','MAX(POSIBLE_POSESION)','3','0','H015_RegistrarSolicitudPosesion','comboPosesion')
                                      , T_MPH ( '320','223','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_SOLICITUD_POSESION)','1','1','H015_RegistrarSolicitudPosesion','fechaSolicitud')
                                      , T_MPH ( '317','222','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_ENVIO_AUTO_ADICION)','3','0','H005_RegistrarInscripcionDelTitulo','fechaEnvioDecretoAdicion')
                                      , T_MPH ( '318','222','MIG_PROCEDIMIENTOS_BIENES','OBSERVACIONES_INSCRIPCION','4','0','H005_RegistrarInscripcionDelTitulo','observaciones')
                                      , T_MPH ( '315','222','MIG_PROCEDIMIENTOS_BIENES','1','2','0','H005_RegistrarInscripcionDelTitulo','comboSituacionTitulo')
                                      , T_MPH ( '316','222','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_INSCRIPCION_TITULO)','1','1','H005_RegistrarInscripcionDelTitulo','fechaInscripcion')
                                      , T_MPH ( '314','221','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_SEGUNDA_PRES_REGISTRO)','2','0','H005_RegistrarPresentacionEnRegistro','fechaNuevoTest')
                                      , T_MPH ( '313','221','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_PRESENTACION_REGISTRO)','1','1','H005_RegistrarPresentacionEnRegistro','fechaPresentacion')
                                      , T_MPH ( '362','220','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CONTABILIDAD)','1','1','H005_ConfirmarContabilidad','fecha')
                                      , T_MPH ( '355','219','MIG_PROCEDIMIENTOS_BIENES','0','1','1','H042_ElaborarLiquidacion','fecha')
                                      , T_MPH ( '346','218','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CONTABILIDAD)','1','1','H005_ConfirmarContabilidad','fecha')
                                      , T_MPH ( '345','217','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CONTABILIDAD)-4','1','1','H005_RevisarInfoContable','fecha')
                                      , T_MPH ( '349','216','MIG_PROCEDIMIENTOS_BIENES','1','1','1','H015_RegistrarDecisionLlaves','comboLlaves')
                                      , T_MPH ( '347','215','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_REALIZACION_POSESION)','1','1','H015_RegistrarLanzamientoEfectuado','fecha')
                                      , T_MPH ( '354','213','MIG_PROCEDIMIENTOS_BIENES','0','1','1','H042_ElaborarLiquidacion','fecha')
                                      , T_MPH ( '353','212','MIG_PROCEDIMIENTOS_BIENES','0','1','1','H008_RevisarEstadoCargas','fecha')
                                      , T_MPH ( '352','211','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)','1','1','H006_RealizacionCesionRemate','fecha')
                                      , T_MPH ( '351','210','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)-2','1','1','H006_ResenyarFechaComparecencia','fecha')
                                      , T_MPH ( '350','209','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_CESION)-4','1','1','H006_AperturaPlazo','fecha')
                                      , T_MPH ( '121','208','MIG_PROCEDIMIENTOS_BIENES','ADD_MONTHS(MIN(FECHA_DECRETO_ADJ_NO_FIRME),-2)','1','1','HCJ001_DeclararIVAIGIC','fechaDeclaracion')
                                      ...
                                      , T_MPH ( '277','182','MIG_CONCURSOS_CABECERA','DECODE(SUBSTR(FASE_CONCURSO,1,INSTR(FASE_CONCURSO,''''-'''')-1),''''FASE LIQUIDACION'''',1,0)','1','0','H009_AnyadirTextosDefinitivos','comboLiquidacion')
                                      ...
                                      , T_MPH ( '360','228','MIG_PROCEDIMIENTOS_BIENES','1','1','1','H015_RegistrarDecisionLlaves','comboLlaves')
                                      ...
                                      , T_MPH ( '329','225','MIG_PROCEDIMIENTOS_BIENES','MAX(OCUPANTES_REALIZ_DILIGENCIA)','2','0','H015_RegistrarPosesionYLanzamiento','comboOcupado')
                                      ...
                                      , T_MPH ( '116','60','MIG_PROCEDIMIENTOS_BIENES','1','2','0','H005_RegistrarInscripcionDelTitulo','comboSituacionTitulo')
                                      , T_MPH ( '119','60','MIG_PROCEDIMIENTOS_BIENES','OBSERVACIONES_INSCRIPCION','4','0','H005_RegistrarInscripcionDelTitulo','observaciones')
                                      , T_MPH ( '117','60','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_INSCRIPCION_TITULO)','1','1','H005_RegistrarInscripcionDelTitulo','fechaInscripcion')
                                     ...
                                     , T_MPH ( '114','59','MIG_PROCEDIMIENTOS_BIENES','MIN(FECHA_PRESENTACION_REGISTRO)','1','1','H005_RegistrarPresentacionEnRegistro','fechaPresentacion')
                                      , T_MPH ( '112','58','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_TESTIMONIO_DECRETO)','1','1','H005_ConfirmarTestimonio','fechaTestimonio')
                                      ...
                                      , T_MPH ( '80','36','MIG_PROCEDIMIENTOS_DEMANDADOS','MAX(FECHA_OPOSICION)','2','0','H001_ConfirmarSiExisteOposicion','fechaOposicion')
                                      ...
                                      , T_MPH ( '361','227','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_REALIZACION_POSESION)','1','1','H015_RegistrarLanzamientoEfectuado','fecha')
                                      , T_MPH ( '332','226','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_SENYALAMIENTO_POSESION)','1','1','H015_RegistrarSenyalamientoLanzamiento','fecha')
                                      , T_MPH ( '328','225','MIG_PROCEDIMIENTOS_BIENES','MAX(FECHA_REALIZACION_POSESION)','1','1','H015_RegistrarPosesionYLanzamiento','fecha')
