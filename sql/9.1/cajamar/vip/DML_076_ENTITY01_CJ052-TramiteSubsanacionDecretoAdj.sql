...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(50 CHAR)   := 'Trámite de subsanación decreto adjudicación';   -- [PARAMETRO] Título del trámite
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'CJ052'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
    	T_TIPO_TPO(V_COD_PROCEDIMIENTO, 'T. Subsanación decreto adjudicación - CJ','T. Subsanación decreto adjudicación','','cj_tramiteSubsanacionEmbargo',0,'DML',0,'AP', null, null,8,'MEJTipoProcedimiento',1,1)
    ); 
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ052_EntregarNuevoDecreto','','comprobarExisteDocumentoDSSDA() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Es necesario adjuntar el Decreto subsanado.</div>''','','','',0,'Entregar nuevo decreto/testimonio decreto de adjudicación',0,'DML',0,'','','',0,'EXTTareaProcedimiento',0,'','', null,'',''),
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ052_RegistrarPresentacionEscritoSub','','','','','',0,'Registrar presentación de escrito de subsanación',0,'DML',0,'','','',0,'EXTTareaProcedimiento',0,'','', null,'','')
	);
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS('','','CJ052_EntregarNuevoDecreto','(damePlazo(valores[''CJ052_RegistrarPresentacionEscritoSub''][''fechaPresentacion'']) + 30*24*60*60*1000L)',0,0,'DML'),
		T_TIPO_PLAZAS('','','CJ052_RegistrarPresentacionEscritoSub','valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''] != null ? (valoresBPMPadre[''H005_RegistrarInscripcionDelTitulo''][''comboSituacionTitulo''] == ''PEN'' ? (damePlazo(valoresBPMPadre[''H005_ConfirmarTestimonio''][''fechaEnvioGestoria'']) + 5*24*60*60*1000L ) : 10*24*60*60*1000L ) : 10*24*60*60*1000L',0,0,'DML')
	); 
