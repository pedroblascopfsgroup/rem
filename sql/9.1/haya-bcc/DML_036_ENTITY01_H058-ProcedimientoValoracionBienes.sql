...
DECLARE
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H058',
        /*TAP_CODIGO...................:*/ 'H058_BPMProvisionFondos',
        /*TAP_VIEW.....................:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H058_BPMProvisionFondos',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H058_SolicitarAvaluo',
            /*TFI_ORDEN..............:*/ '2',
            /*TFI_TIPO...............:*/ 'combo',
...
BEGIN
	 ...
	 * -------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO tpo SET tpo.DD_TPO_DESCRIPCION = ''T. Valoración de Bienes - HCJ'', tpo.DD_TPO_DESCRIPCION_LARGA = ''Tramite de Valoración de Bienes'', tpo.DD_TPO_XML_JBPM = ''hcj_tramiteValoracionBienes'' WHERE tpo.DD_TPO_CODIGO = ''H058''';
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap SET tap.TAP_SCRIPT_DECISION = ''valores[''''H058_SolicitarAvaluo''''][''''provisionFondos''''] == DDSiNo.SI ? ''''conProvision'''' : ''''sinProvision'''''' WHERE tap.TAP_CODIGO = ''H058_SolicitarAvaluo''';
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi SET tfi.TFI_ORDEN = 3 WHERE tfi.TFI_ID  = (SELECT tfi_id FROM '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi_i, '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap WHERE tfi_i.TFI_NOMBRE = ''observaciones'' AND tfi_i.TAP_ID = tap.TAP_ID AND tap.TAP_CODIGO = ''H058_SolicitarAvaluo'')';
