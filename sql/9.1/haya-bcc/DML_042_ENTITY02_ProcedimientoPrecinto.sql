...
BEGIN
	 ...
	 * -------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.'||PAR_TABLENAME_TPROC||' tpo SET tpo.DD_TPO_DESCRIPCION = ''T. de Precinto - HCJ'', tpo.DD_TPO_XML_JBPM = ''hcj_tramitePrecinto'' WHERE tpo.DD_TPO_CODIGO = ''H050''';
