...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. Conclusión - HCJ'', DD_TPO_XML_JBPM = ''hcj_tramiteConclusion'' WHERE DD_TPO_CODIGO = ''H039''';
