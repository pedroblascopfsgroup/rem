...
BEGIN
	 ...
	 * -------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO tpo SET tpo.DD_TPO_DESCRIPCION = ''T. Valoración de Bienes - HCJ'', tpo.DD_TPO_XML_JBPM      = ''hcj_tramiteValoracionBienesInmuebles'' WHERE tpo.DD_TPO_CODIGO = ''H058''';
