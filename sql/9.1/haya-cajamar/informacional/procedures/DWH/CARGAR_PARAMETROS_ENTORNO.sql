...
BEGIN
  ...
  BEGIN
    ...
    insert into PARAMETROS_ENTORNO values ('ESQUEMA_DATASTAGE', 'recovery_haya02_DATASTAGE');
    insert into PARAMETROS_ENTORNO values ('FORMATO_FECHA_DDMMYY', 'DD/MM/YY');
    insert into PARAMETROS_ENTORNO values ('ORIGEN_01', 'haya02');
    insert into PARAMETROS_ENTORNO values ('ESQUEMA_DWH', 'recovery_haya02_DWH');
