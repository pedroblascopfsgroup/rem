...
DECLARE
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(     
        T_TIPO_TFI('H005_notificacionDecretoAdjudicacionAEntidad','2','date','fechaDecreto','Fecha emisión decreto',null,null,null,null,'0','DD')
    ); 
...
BEGIN	
    ...
    V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS' ||
			  ' SET TFI_LABEL = ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Antes de dar por completada esta tarea deber&aacute; de acceder a la pesta&ntilde;a Gestores del asunto correspondiente y asignar el tipo de gestor “Gestor&iacute;a adjudicaci&oacute;n” seg&uacute;n el protocolo que tiene establecido la entidad.</p><p style="margin-bottom: 10px">A trav&eacute;s de esta pantalla se ha de marcar la fecha que el Juzgado hace entrega del Testimonio del Decreto a favor de la Entidad. Se ha de tener en cuenta que desde la fecha que se indique en esta pantalla se inicia el plazo para liquidar los impuestos que correspondan.</p><p style="margin-bottom: 10px">Una vez confirmado con el procurador el env&iacute;o a la gestor&iacute;a, se deber&aacute; informar dicha fecha en el campo “Fecha env&iacute;o a Gestor&iacute;a” y del nombre de la gestor&iacute;a.</p><p style="margin-bottom: 10px">Con el objeto de evitar calificaciones desfavorables y subsanaciones posteriores que retrasan la inscripci&oacute;n deber&aacute;:</p><p style="margin-bottom: 10px">Obtenido el testimonio, se revisar&aacute; la  fecha de expedici&oacute;n  para liquidaci&oacute;n de impuestos en plazo, seg&uacute;n normativa de CCAA. La verificaci&oacute;n de la fecha del t&iacute;tulo es necesaria y fundamental para que la gestor&iacute;a pueda realizar la liquidaci&oacute;n en plazo.</p><p style="margin-bottom: 10px">Adicionalmente se  revisar&aacute;n el contenido fundamental y de forma, para evitar subsanaciones posteriores que retrasen la inscripci&oacute;n.</p><p style="margin-bottom: 10px">Contenido b&aacute;sico para revisar en testimonio decreto de adjudicaci&oacute;n  y mandamientos:</p><p style="margin-bottom: 10px; margin-left: 40px;">o Datos procesales b&aacute;sicos: (Nº autos, tipo de procedimiento, cantidad reclamada)</p><p style="margin-bottom: 10px; margin-left: 40px;">o Datos de la Entidad demandante (nombre CIF, domicilio) y en su caso de los adjudicados.</p><p style="margin-bottom: 10px; margin-left: 40px;">o Datos  de los demandados y titulares registrales.</p><p style="margin-bottom: 10px; margin-left: 40px;">o Importe de adjudicaci&oacute;n y cesi&oacute;n de remate (en su caso). Si hay cesi&oacute;n de remate no tiene sentido proseguir el procedimiento en Recovery.</p><p style="margin-bottom: 10px; margin-left: 40px;">o Orden de cancelaci&oacute;n de la nota marginal y cancelaci&oacute;n de la carga objeto de ejecuci&oacute;n as&iacute; como cargas posteriores)</p><p style="margin-bottom: 10px; margin-left: 40px;">o Descripci&oacute;n  y datos registrales completos de la finca adjudicada.</p><p style="margin-bottom: 10px; margin-left: 40px;">o Declaraci&oacute;n en el auto de la firmeza de la resoluci&oacute;n.</p><p style="margin-bottom: 10px">Una vez analizados los puntos descritos, en el campo Requiere subsanaci&oacute;n deber&aacute; indicar el resultado de dicho an&aacute;lisis.</p><p style="margin-bottom: 10px">Para dar por terminada esta tarea deber&aacute; de adjuntar al procedimiento correspondiente una copia escaneada del decreto firme de adjudicaci&oacute;n.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla se lanzar&aacute;, en caso de requerir subsanaci&oacute;n el tr&aacute;mite de subsanaci&oacute;n de  decreto de adjudicaci&oacute;n  y en caso contrario se lanzar&aacute; por un lado la tarea  “Registrar entrega del t&iacute;tulo” y por otro el tr&aacute;mite de posesi&oacute;n.</p><p style="margin-bottom: 10px">Una vez confirmado con el procurador el env&iacute;o a la gestor&iacute;a, se deber&aacute; informar dicha fecha en el campo “Fecha env&iacute;o a Gestor&iacute;a” y del nombre de la gestor&iacute;a.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>'' ' ||
