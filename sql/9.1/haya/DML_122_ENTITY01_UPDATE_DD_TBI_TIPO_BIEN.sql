...
V_MSQL:= 'INSERT ALL
INTO '||V_ESQUEMA||'.'||TABLA||' values ('||V_ESQUEMA||'.'||SECUENCIA||'.nextval,'100','Vehículo','Vehículo',0,'''||V_USUARIO_CREAR||''',SYSTIMESTAMP,NULL,NULL,NULL,NULL,0)
INTO '||V_ESQUEMA||'.'||TABLA||' values ('||V_ESQUEMA||'.'||SECUENCIA||'.nextval,'101','Coche','Coche',0,'''||V_USUARIO_CREAR||''',SYSTIMESTAMP,NULL,NULL,NULL,NULL,0)
...
INTO '||V_ESQUEMA||'.'||TABLA||' values ('||V_ESQUEMA||'.'||SECUENCIA||'.nextval,'1207','Plan Pensiones','Plan Pensiones',0,'''||V_USUARIO_CREAR||''',SYSTIMESTAMP,NULL,NULL,NULL,NULL,0)
SELECT * FROM dual';
