...
DROP TABLE  "#ESQUEMA#"."TMP_PER_PERSONAS" ;

  CREATE TABLE "#ESQUEMA#"."TMP_PER_PERSONAS" 
   (	
  ...
  TABLESPACE "#TABLESPACE_INDEX#"  ENABLE ) SEGMENT CREATION IMMEDIATE 
  ...
  CREATE UNIQUE INDEX "#ESQUEMA#"."UK_TMP_PER_PERSONAS" ON "#ESQUEMA#"."TMP_PER_PERSONAS" ("TMP_PER_COD_PERSONA") 
