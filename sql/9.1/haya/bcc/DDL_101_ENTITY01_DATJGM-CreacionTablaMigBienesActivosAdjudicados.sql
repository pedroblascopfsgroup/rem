...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla MIG_BIENES_ACTIVOS_ADJUDICADOS
...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_BIENES_ACTIVOS_ADJUDICADOS';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||'
   (	
	  ID_BIENES_ADJUDICADOS         NUMBER(16) 	  NOT NULL,
	  ...
	  FECHA_LANZAMIENTO_EFECTIVO    DATE,
	  ...
	  CONSTRAINT "PK_ID_BIENES_ADJ" PRIMARY KEY ("ID_BIENES_ADJUDICADOS") 
