...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla MIG_BIENES_PERSONAS
...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_BIENES_PERSONAS';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	  ID_BIENES_PERSONAS    NUMBER(16) 	  NOT NULL,
	  ...
	  ID_PERSONA_NUSE       NUMBER(8)	  NOT NULL,
	  REL_BIEN_PERS         VARCHAR2(6 CHAR)  NOT NULL,
	  CONSTRAINT "PK_ID_BIENES_PERSONAS" PRIMARY KEY ("ID_BIENES_PERSONAS") 
