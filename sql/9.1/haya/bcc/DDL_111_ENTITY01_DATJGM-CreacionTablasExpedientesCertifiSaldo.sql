...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	 MIG_ID_EXP_CERTIF_SALDO NUMBER(16,0) NOT NULL ENABLE, 
	 ...
	 CD_NOTARIO VARCHAR2(20)              NOT NULL,
	 FECHA_ENVIO_NOTARIO DATE             NOT NULL,
	 FECHA_RECEPCION_RESPUESTA DATE,
	 RESPUESTA VARCHAR2(20),
	 DISPONIBLE_IPLUS NUMBER(1,0),
	 IMPORTE_LIQUIDACION NUMBER(15,2)     NOT NULL,
