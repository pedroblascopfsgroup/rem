...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	MIG_EXP_OPE_ID 		NUMBER(16,0) 	  NOT NULL ENABLE, 
	CD_EXPEDIENTE  		NUMBER(16,0) 	  NOT NULL ENABLE, 
	COD_ENTIDAD    		NUMBER(4,0)  	  NOT NULL ENABLE, 
	COD_PROPIETARIO		NUMBER(5,0)	  NOT NULL ENABLE, 
	...
	TIPO_RELACION		VARCHAR2(20 CHAR) NOT NULL ENABLE, 
