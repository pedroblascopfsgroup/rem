...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_PROCEDIMIENTOS_OPERACIONES';
 ...
 V_EXISTE NUMBER (1);
 SEQUENCE VARCHAR(30) :='S_MIG_PROCEDIMIENTOS_OPER';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	  ...
	  CONSTRAINT "PK_ID_PROC_OPERA" PRIMARY KEY ("ID_PROC_OPERACIONES")
