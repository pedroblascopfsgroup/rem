...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla TMP_GUID_CEX_HRE
...
DECLARE
 ...
 TABLA VARCHAR(31) :='TMP_GUID_CEX_HRE';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (
         ...
         CEX_ID    NUMBER(16,0) NOT NULL ENABLE, 
         CONSTRAINT PK_TMP_GUID_CEX_HRE PRIMARY KEY (CEX_ID)
