...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla TMP_GUID_PCO_PRC_HEP_HRE
...
DECLARE
 ...
 TABLA VARCHAR(31) :='TMP_GUID_PCO_PRC_HEP_HRE';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (
         ...
         PCO_PRC_HEP_ID    NUMBER(16,0) NOT NULL ENABLE, 
         CONSTRAINT PK_TMP_GUID_PCO_PRC_HEP_HRE PRIMARY KEY (PCO_PRC_HEP_ID)
