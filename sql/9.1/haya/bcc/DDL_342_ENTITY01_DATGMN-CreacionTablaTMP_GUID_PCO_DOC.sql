...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla TMP_GUID_PCO_DOC_HRE
...
DECLARE
 ...
 TABLA VARCHAR(31) :='TMP_GUID_PCO_DOC_HRE';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (
         ...
         PCO_DOC_ID    NUMBER(16,0) NOT NULL ENABLE, 
         CONSTRAINT PK_TMP_GUID_PCO_DOC_HRE PRIMARY KEY (PCO_DOC_ID)
