...
DECLARE
    ...
    V_VIEWNAME VARCHAR2(30):= 'VTAR_NOMBRES_USUARIOS';
...
-- *************************************************************/
execute immediate ' CREATE OR REPLACE FORCE VIEW '||V_ESQUEMA||'.'||V_VIEWNAME||' (USU_ID, APELLIDO_NOMBRE) AS 
    select usu.usu_id, CASE
