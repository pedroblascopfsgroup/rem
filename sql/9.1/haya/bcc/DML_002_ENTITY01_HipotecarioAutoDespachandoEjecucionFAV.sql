...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Auto despachando ejecución para la tarea H001_AutoDespachandoEjecucion Favorable.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'202';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_AUTO_DESP_FAV';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Auto Despachando Ejecución Favorable';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_AUTO_DESP_FAV';
