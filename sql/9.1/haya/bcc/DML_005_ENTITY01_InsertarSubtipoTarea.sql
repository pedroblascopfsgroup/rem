...
--## PRODUCTO=SI
--##
--## Finalidad: Inserta el Subtipo de tarea Recordatorio en DD_STA_SUBTIPO_TAREA_BASE
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_STA_SUBTIPO T_ARRAY_STA := T_ARRAY_STA(
      T_STA_SUBTIPO(1, 'TAREA_RECORDATORIO', 'Tarea recordatorio', 'Tarea recordatorio', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, NULL, 'EXTSubtipoTarea')
    );   
