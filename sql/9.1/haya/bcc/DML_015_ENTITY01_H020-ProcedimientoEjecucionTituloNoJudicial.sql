...
DECLARE
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H020',
        /*TAP_CODIGO...................:*/ 'H020_BPMProvisionFondos',
        /*TAP_VIEW.....................:*/ null,
        ...
        /*TAP_SUPERVISOR,..............:*/ '0',
        /*TAP_DESCRIPCION,.............:*/ 'Provisión de fondos',
        /*VERSION......................:*/ '0',
        /*USUARIOCREAR.................:*/ 'DD',
        /*BORRADO......................:*/ '0',
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H020_BPMProvisionFondos',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H020_InterposicionDemandaMasBienes',
            /*TFI_ORDEN..............:*/ '9',
            /*TFI_TIPO...............:*/ 'combo',
            /*TFI_NOMBRE.............:*/ 'provisionFondos',
            /*TFI_LABEL..............:*/ 'Solicitar provisión de fondos',
...
BEGIN
	 ...
	 * -------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO tpo SET tpo.DD_TPO_DESCRIPCION = ''P. Ej. de título no judicial - HCJ'', tpo.DD_TPO_XML_JBPM      = ''hcj_ejecucionTituloNoJudicial'' WHERE tpo.DD_TPO_CODIGO = ''H020''';
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap SET tap.TAP_SCRIPT_DECISION = ''valores[''''H020_InterposicionDemandaMasBienes''''][''''provisionFondos''''] == DDSiNo.SI ? ''''conProvision'''' : ''''sinProvision'''''' WHERE tap.TAP_CODIGO = ''H020_InterposicionDemandaMasBienes''';
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap SET tap.TAP_SCRIPT_VALIDACION = ''!asuntoConProcurador() ? ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><p>&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe registrar el procurador que representa a la entidad en la ficha del asunto correspondiente.</p></div>'''' : (tieneBienes() && !isBienesConFechaSolicitud() ? ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><div id="permiteGuardar"><p>&iexcl;Atenci&oacute;n! En  caso de que haya bienes a embargar, deber&iacute;a de marcarlos a trav&eacute;s de la pesta&ntilde;a Bienes dentro de la ficha de la propia actuaci&oacute;n.</p></div></div>'''' : comprobarExisteDocumentoEDH() ? null : ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><div id="permiteGuardar"><p>Es necesario adjuntar el Escrito de la demanda completo + copia sellada de la demanda.</p></div></div>'''')'' WHERE tap.TAP_CODIGO = ''H020_InterposicionDemandaMasBienes''';
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi SET tfi.TFI_ORDEN = 10 WHERE tfi.TFI_ID  = (SELECT tfi_id FROM '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi_i, '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap WHERE tfi_i.TFI_NOMBRE = ''observaciones'' AND tfi_i.TAP_ID = tap.TAP_ID AND tap.TAP_CODIGO = ''H020_InterposicionDemandaMasBienes'')';
