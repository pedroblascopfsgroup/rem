...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Entraga cantidades consignadas para la tarea H002_ConfirmarRecepcionMandamientoDePago.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_SUB_SAR_CANT_CONS';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H002';
    V_NODO VARCHAR2(50 CHAR):=				'H002_ConfirmarRecepcionMandamientoDePago';
