...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Traslado de contrario impugnando tasación de costas para la tarea H007_Impugnacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'229';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_IMPUG_TAS_COST_JUZG';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito de impugnación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_IMPUG_TAS_COST_JUZG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H007';
    V_NODO VARCHAR2(50 CHAR):=				'H007_Impugnacion';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboImpugnacion','comboImpugnacion'),
    	T_INPUT('d_fechaImpugnacion','fechaImpugnacion'),
    	T_INPUT('d_vistaImpugnacion','vistaImpugnacion'),
