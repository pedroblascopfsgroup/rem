...
--## PRODUCTO=NO
--## 
--## Finalidad: Inserción de Campos Extras de personas en EXT_DD_IFX_INFO_EXTRA_CLI, esquema #ESQUEMA#.
...
--Configuracion  EXT_DD_IFX_INFO_EXTRA_CLI
   ...
   V_IFX T_ARRAY_IFX := T_ARRAY_IFX(
                                   ...
                                   , T_IFX('flag_extra1','Marca Cliente Reestructurado','Marca Cliente Reestructurado')
                                   ...
                                   , T_IFX('date_extra1','Fecha situación concursal','Fecha situación concursal')
