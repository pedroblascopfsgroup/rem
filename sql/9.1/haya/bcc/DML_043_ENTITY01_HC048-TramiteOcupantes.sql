...
DECLARE
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'H048'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
	      T_TIPO_TAP(
	        ...
	        /*TAP_CODIGO...................:*/ 'H048_ObtenerAprobacionAlquiler',
	        /*TAP_VIEW.....................:*/ null,
	        /*TAP_SCRIPT_VALIDACION........:*/ null,
	        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
	        /*TAP_SCRIPT_DECISION..........:*/ 'valores[''H048_ObtenerAprobacionAlquiler''][''comboAlegaciones''] == DDSiNo.SI ? ''siHayAleg'' : (valores[''H048_ObtenerAprobacionAlquiler''][''comboVista''] == DDSiNo.SI ? ''noHayAlegSiHayVista'' : ''noHayAlegNoHayVista'')',
	        /*DD_TPO_ID_BPM(FK)............:*/ null,
	        /*TAP_SUPERVISOR,..............:*/ '0',
	        /*TAP_DESCRIPCION,.............:*/ 'Obtener aprobación de alquiler',
	        /*VERSION......................:*/ '0',
	        /*USUARIOCREAR.................:*/ 'DD',
	        /*BORRADO......................:*/ '0',
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H048_ObtenerAprobacionAlquiler',
          /*DD_PTP_PLAZO_SCRIPT......:*/ '(valores[''H048_TrasladoDocuDeteccionOcupantes''][''fechaDocumentos''] != null ? damePlazo(valores[''H048_TrasladoDocuDeteccionOcupantes''][''fechaDocumentos'']) : damePlazo(valores[''H048_RegistrarRecepcionDoc''][''fecha''])) + 7*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
        )
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        T_TIPO_TFI (
            ...
            /*TFI_ORDEN..............:*/ '2',
            /*TFI_TIPO...............:*/ 'combo',
            /*TFI_NOMBRE.............:*/ 'comboContrato',
            /*TFI_LABEL..............:*/ 'Contrato válido',
            /*TFI_ERROR_VALIDACION...:*/ 'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio',
            /*TFI_VALIDACION.........:*/ 'valor != null && valor != '''' ? true : false',
            /*TFI_VALOR_INICIAL......:*/ null,
...
BEGIN
	 ...
	 * Actualizaciones 
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION=''T. de ocupantes - HCJ'', DD_TPO_XML_JBPM=''hcj_tramiteOcupantes'' WHERE DD_TPO_CODIGO = ''H048''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM=''valores[''''H048_TrasladoDocuDeteccionOcupantes''''][''''comboDocumentacion''''] == DDSiNo.SI && (valores[''''H048_TrasladoDocuDeteccionOcupantes''''][''''fechaDocumentos''''] == null || valores[''''H048_TrasladoDocuDeteccionOcupantes''''][''''fechaDocumentos''''] == '''''''') ?  ''''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Debe informar el campo "Fecha Documentaci&oacute;n"</div>'''' : null'' WHERE TAP_CODIGO = ''H048_TrasladoDocuDeteccionOcupantes''';
	
	-- BORRADO DE TAREA (lógico)
	V_TAREA:='H048_RegistrarInformeSituacion';
	...
	V_TAREA:='H048_RevisarInformeLetrado';
	EXECUTE IMMEDIATE 'DELETE FROM '||PAR_ESQUEMA ||'.DD_PTP_PLAZOS_TAREAS_PLAZAS WHERE TAP_ID IN (select tap_id from '||PAR_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = '''||V_TAREA||''')';
	EXECUTE IMMEDIATE 'DELETE FROM '||PAR_ESQUEMA ||'.TFI_TAREAS_FORM_ITEMS WHERE TAP_ID IN (select tap_id from '||PAR_ESQUEMA ||'.tap_Tarea_procedimiento where tap_codigo = '''||V_TAREA||''')';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO SET TAP_CODIGO=''DEL_'||V_TAREA||''', BORRADO=1, FECHABORRAR=SYSDATE, USUARIOBORRAR=''ALBERTO'' WHERE TAP_CODIGO='''||V_TAREA||'''';
