...
DECLARE
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'H022'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP(
			...
			/*TAP_CODIGO...................:*/ 'H022_BPMProvisionFondos',
			/*TAP_VIEW.....................:*/ null,
		...
		T_TIPO_TAP(
			/*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
			/*TAP_CODIGO...................:*/ 'H022_BPMOrdinario',
			/*TAP_VIEW.....................:*/ null,
			/*TAP_SCRIPT_VALIDACION........:*/ null,
			/*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
			/*TAP_SCRIPT_DECISION..........:*/ null,
			/*DD_TPO_ID_BPM(FK)............:*/ 'H024',
			/*TAP_SUPERVISOR,..............:*/ '0',
			/*TAP_DESCRIPCION,.............:*/ 'Procedimiento ordinario',
			/*VERSION......................:*/ '0',
			/*USUARIOCREAR.................:*/ 'DD',
			/*BORRADO......................:*/ '0',
			/*TAP_ALERT_NO_RETORNO.........:*/ null,
		...
		T_TIPO_TAP(
			/*DD_TPO_ID(FK)................:*/ V_COD_PROCEDIMIENTO,
			/*TAP_CODIGO...................:*/ 'H022_BPMVerbalDesdeMonitorio',
			/*TAP_VIEW.....................:*/ null,
			/*TAP_SCRIPT_VALIDACION........:*/ null,
			/*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
			/*TAP_SCRIPT_DECISION..........:*/ null,
			/*DD_TPO_ID_BPM(FK)............:*/ 'H028',
			/*TAP_SUPERVISOR,..............:*/ '0',
			/*TAP_DESCRIPCION,.............:*/ 'Procedimiento verbal desde monitorio',
			/*VERSION......................:*/ '0',
			/*USUARIOCREAR.................:*/ 'DD',
			/*BORRADO......................:*/ '0',
			/*TAP_ALERT_NO_RETORNO.........:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H022_BPMProvisionFondos',
        ...
        T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H022_BPMVerbalDesdeMonitorio',
          /*DD_PTP_PLAZO_SCRIPT......:*/ '300*24*60*60*1000L',
          /*VERSION..................:*/ '0',
          /*BORRADO..................:*/ '0',
          /*USUARIOCREAR.............:*/ 'DD'
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H022_InterposicionDemanda',
            /*TFI_ORDEN..............:*/ '8',
            /*TFI_TIPO...............:*/ 'combo',
        ...
        T_TIPO_TFI(
        	/*DD_TAP_ID..............:*/ 'H022_BPMProvisionFondos',
        	/*TFI_ORDEN..............:*/ '0',
        	/*TFI_TIPO...............:*/ 'label',
        	/*TFI_NOMBRE.............:*/ 'titulo',
        	/*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px"><p style="margin-bottom: 10px">Se inicia el Tr&aacute;mite de solicitud de fondos</p></div>',
        ...
        T_TIPO_TFI(
        	/*DD_TAP_ID..............:*/ 'H022_BPMOrdinario',
        	/*TFI_ORDEN..............:*/ '0',
        	/*TFI_TIPO...............:*/ 'label',
        	/*TFI_NOMBRE.............:*/ 'titulo',
        	/*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px"><p style="margin-bottom: 10px">Se inicia el Procedimiento Ordinario.</p></div>',
        	/*TFI_ERROR_VALIDACION...:*/ null,
			/*TFI_VALIDACION.........:*/ null,
			/*TFI_VALOR_INICIAL......:*/ null,
			/*TFI_BUSINESS_OPERATION.:*/ null,
        ...
        T_TIPO_TFI(
        	/*DD_TAP_ID..............:*/ 'H022_BPMVerbalDesdeMonitorio',
        	/*TFI_ORDEN..............:*/ '0',
        	/*TFI_TIPO...............:*/ 'label',
        	/*TFI_NOMBRE.............:*/ 'titulo',
        	/*TFI_LABEL..............:*/ '<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px"><p style="margin-bottom: 10px">Se inicia el Procedimiento Verbal desde Monitorio.</p></div>',
        	/*TFI_ERROR_VALIDACION...:*/ null,
			/*TFI_VALIDACION.........:*/ null,
			/*TFI_VALOR_INICIAL......:*/ null,
			/*TFI_BUSINESS_OPERATION.:*/ null,
...
BEGIN
	 ...
	 * Actualizaciones 
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION=''P. Monitorio - HCJ'', DD_TPO_XML_JBPM=''hcj_procedimientoMonitorio'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';

	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_DECISION = ''valores[''''H022_InterposicionDemanda''''][''''provisionFondos''''] == DDSiNo.NO ? ''''No'''' : ''''Si'''''' WHERE TAP_CODIGO = ''H022_InterposicionDemanda''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_DECISION = ''valores[''''H022_ConfirmarOposicionCuantia''''][''''comboResultado''''] == DDSiNo.NO ? ''''NO'''' : (procedimientoManager.getProcedimiento(idProcedimiento).getSaldoRecuperacion() > 6000 ? ''''mas6000'''' : ''''menos6000'''')'' WHERE TAP_CODIGO = ''H022_ConfirmarOposicionCuantia''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''H022_ConfirmarAdmisionDemanda''''][''''comboResultado''''] == DDSiNo.SI ? comprobarExisteDocumentoADEM() ? null : ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Es necesario adjuntar el documento Auto Despachando Ejecuci&oacute;n del P. Monitorio.</div>'''' : null '' WHERE TAP_CODIGO = ''H022_ConfirmarAdmisionDemanda''';
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''H022_ConfirmarOposicionCuantia''''][''''comboResultado''''] == DDSiNo.SI ? comprobarExisteDocumentoEOM() ? null : ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Es necesario adjuntar el documento Escrito de Oposici&oacute;n del P. Monitorio.</div>'''' : null '' WHERE TAP_CODIGO = ''H022_ConfirmarOposicionCuantia''';
	
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_ORDEN = 9 WHERE TFI_NOMBRE= ''observaciones'' AND TAP_ID  = (SELECT TAP_ID FROM '||PAR_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H022_InterposicionDemanda'')';
