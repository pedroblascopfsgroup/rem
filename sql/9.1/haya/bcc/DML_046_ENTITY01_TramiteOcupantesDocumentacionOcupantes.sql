...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Traslado de contrario aportando titulos como ocupantes de vivienda para la tarea H048_RegistrarRecepcionDoc.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'245';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_REP_DOC_A';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Recepción documentación ocupantes';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'OCU';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_REP_DOC_A';
