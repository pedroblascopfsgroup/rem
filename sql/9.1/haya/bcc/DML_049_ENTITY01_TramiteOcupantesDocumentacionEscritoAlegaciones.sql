...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado alegaciones frente a ocupantes de la vivienda para la tarea H048_PresentarEscritoAlegaciones.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'248';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PRS_ESC_ALE';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito alegaciones';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'OCU';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PRS_ESC_ALE';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H048';
    V_NODO VARCHAR2(50 CHAR):=				'H048_PresentarEscritoAlegaciones';
