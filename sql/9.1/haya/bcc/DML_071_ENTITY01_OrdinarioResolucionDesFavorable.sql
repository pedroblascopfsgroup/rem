...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia desfavorable para la tarea H024_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'270';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_RES_DES';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_RES_DES';
