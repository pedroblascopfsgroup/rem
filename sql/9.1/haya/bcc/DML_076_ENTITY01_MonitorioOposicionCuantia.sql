...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'275';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_OP_MON';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito de oposición monitorio';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MON';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_OP_MON';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H022';
    V_NODO VARCHAR2(50 CHAR):=				'H022_ConfirmarOposicionCuantia';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_procedimiento','procedimiento'),
    	T_INPUT('d_deuda','deuda'),
    	T_INPUT('d_comboResultado','comboResultado'),
    	T_INPUT('d_fechaOposicion','fechaOposicion'),
    	T_INPUT('d_fechaJuicio','fechaJuicio'),
