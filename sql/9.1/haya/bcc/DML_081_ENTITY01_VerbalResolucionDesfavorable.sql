...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia desfavorable para la tarea H026_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'280';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_VBL_DES';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Sentencia desfavorable';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VBL';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_VBL_DES';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H026';
    V_NODO VARCHAR2(50 CHAR):=				'H026_RegistrarResolucion';
