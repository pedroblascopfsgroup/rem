...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Decreto firmeza para la tarea H026_ResolucionFirme.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'283';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_JUZ_VRB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Celebración juicio verbal';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VMN';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_JUZ_VRB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H028';
    V_NODO VARCHAR2(50 CHAR):=				'H028_RegistrarJuicioVerbal';
