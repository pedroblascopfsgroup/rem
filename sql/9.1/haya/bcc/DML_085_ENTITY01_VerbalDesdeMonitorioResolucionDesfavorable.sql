...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia desfavorable para la tarea H028_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'284';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_DES_VMN';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_DES_VMN';
