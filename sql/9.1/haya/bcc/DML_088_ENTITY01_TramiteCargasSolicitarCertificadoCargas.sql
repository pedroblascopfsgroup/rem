...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Certificación de dominio de cargas para la tarea H030_SolicitudCertificacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'287';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_CER_DOM_CAR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito solicitando certificación de cargas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CCR';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_CER_DOM_CAR';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H030';
    V_NODO VARCHAR2(50 CHAR):=				'H030_SolicitudCertificacion';
