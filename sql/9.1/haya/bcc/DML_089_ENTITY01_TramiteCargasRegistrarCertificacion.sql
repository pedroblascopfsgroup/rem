...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'390';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_CER_CAR';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_CER_CAR';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H030';
    V_NODO VARCHAR2(50 CHAR):=				'H030_RegistrarCertificacion';
