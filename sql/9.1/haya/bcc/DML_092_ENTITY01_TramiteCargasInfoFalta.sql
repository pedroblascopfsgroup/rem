...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando más información cargas anteriores para la tarea H030_RequerirInfoFalta.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'291';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SOL_INF_CANT';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SOL_INF_CANT';
