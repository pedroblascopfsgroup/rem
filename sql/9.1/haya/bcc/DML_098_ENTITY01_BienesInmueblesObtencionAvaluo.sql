...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Obtención avaluo para la tarea H058_ObtencionAvaluo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'297';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_OBTE_AVAO';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Avalúo practicado';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VBI';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_OBTE_AVAO';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H058';
    V_NODO VARCHAR2(50 CHAR):=				'H058_ObtencionAvaluo';
