...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Confirmar notificacion requerimiento de pago negativo para la tarea H018_ConfirmarNotificacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'365';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REQ_POS_PJU_NGT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Requerimiento negativo';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PTJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REQ_POS_PJU_NGT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H018';
    V_NODO VARCHAR2(50 CHAR):=				'H018_ConfirmarNotificacion';
