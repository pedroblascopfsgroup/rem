...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'343';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_NOS_REC_AUT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolución de firmeza';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PTJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_NOS_REC_AUT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H018';
    V_NODO VARCHAR2(50 CHAR):=				'H018_ResolucionFirme';
