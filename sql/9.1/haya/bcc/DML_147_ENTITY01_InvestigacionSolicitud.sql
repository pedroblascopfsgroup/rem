...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito de solicitud de investigación judicial para la tarea H044_SolicitudInvestigacionJudicial.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'347';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_SLI_INV';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Solicitud de investigación judicial';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'INJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_SLI_INV';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H044';
    V_NODO VARCHAR2(50 CHAR):=				'H044_SolicitudInvestigacionJudicial';
