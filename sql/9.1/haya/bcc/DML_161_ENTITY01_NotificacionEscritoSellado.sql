...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando notificación en otros domicilios para la tarea P400_GestionarNotificaciones.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'418';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_NOTI_ESC_SELL_NOT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando notificación en otros domicilios';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'NOT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'INFO'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_NOTI_ESC_SELL_NOT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'P400';
    V_NODO VARCHAR2(50 CHAR):=				'P400_GestionarNotificaciones';
