...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución  para la tarea H015_ConfirmarNotificacionDeudor.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'381';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_POS_CON_DEU';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Notificación deudor subrogación contrato alquiler';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'POS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POS_CON_DEU';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H015';
    V_NODO VARCHAR2(50 CHAR):=				'H015_ConfirmarNotificacionDeudor';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboNotificado','comboNotificado'),
