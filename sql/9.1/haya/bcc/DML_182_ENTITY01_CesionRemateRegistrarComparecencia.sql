...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'395';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_COM_CES';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Señalamiento practica cesión remate';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'CES';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_COM_CES';
