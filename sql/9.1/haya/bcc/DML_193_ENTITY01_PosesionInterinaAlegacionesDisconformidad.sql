...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea HC105_AlegacionesDisconformidad.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'406';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_POI_ALE_DIS';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_POI_ALE_DIS';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'HC105';
    V_NODO VARCHAR2(50 CHAR):=				'HC105_AlegacionesDisconformidad';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboAlegaciones','comboAlegaciones'),
