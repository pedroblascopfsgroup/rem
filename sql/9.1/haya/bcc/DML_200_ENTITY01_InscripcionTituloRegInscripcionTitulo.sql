...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea H066_registrarInscripcionTitulo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'413';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_IDT_REG_INS_TIT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Inscripción del título';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'IDT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_IDT_REG_INS_TIT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H066';
    V_NODO VARCHAR2(50 CHAR):=				'H066_registrarInscripcionTitulo';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_situacionTitulo','situacionTitulo'),
