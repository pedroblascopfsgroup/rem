...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución para la tarea HC102_SolicitarArchivoProcedimiento.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'416';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_MCC_SOL_APR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Solicitud archivo procedimiento';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'MCC';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_MCC_SOL_APR';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'HC102';
    V_NODO VARCHAR2(50 CHAR):=				'HC102_SolicitarArchivoProcedimiento';
