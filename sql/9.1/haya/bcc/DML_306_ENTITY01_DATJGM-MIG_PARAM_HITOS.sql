...
--Código de tabla
   ...
   V_MPH T_ARRAY_MPH := T_ARRAY_MPH(
                     T_MPH ('1','P06','Cambiario','H016','P. Cambiario - HCJ','1','H016_interposicionDemandaMasBienes','1','Interposición de la demanda más marcado de bienes','0','0')
                          ...
                          , T_MPH ('40','P01','Ejecución Hipotecaria','H001','P. hipotecario - HCJ','33','H001_ResolucionFirme','11','Resolución firme','0','0')
                          ...
                          , T_MPH ('44','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','35','H002_PrepararInformeSubasta','15','Preparar propuesta subasta','0','1')
                          , T_MPH ('45','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','35','H002_ValidarInformeDeSubasta','16','Validar propuesta','0','1')
                          , T_MPH ('46','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','35','H002_ObtenerValidacionComite','17','Obtener validación comité','0','1')
                          , T_MPH ('47','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','35','H002_DictarInstruccionesSubasta','18','Dictar instrucciones','0','1')
                          , T_MPH ('48','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','36','H002_LecturaConfirmacionInstrucciones','19','Lectura y confirmación de instrucciones','0','1')
                          , T_MPH ('49','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','37','H002_SolicitarSuspenderSubasta','20','Solicitar suspender subasta','0','1')
                          , T_MPH ('50','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','37','H002_RegistrarResSuspSubasta','21','Registrar resolución suspensión subasta','0','1')
                          , T_MPH ('51','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','37','H002_DictarInstruccionesDeneSuspension','22','Dictar instrucciones por denegación de suspensión','0','1')
                          , T_MPH ('52','P01','Ejecución Hipotecaria','H002','T. de subasta - HCJ','34','H002_CelebracionSubasta','23','Celebración de subasta','0','0')
                          ...
                          , T_MPH ('57','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','38','H005_SolicitudTestimonioDecretoAdjudicacion','28','Solicitud de Testimonio del Decreto de Adjudicación','1','1')
                          , T_MPH ('58','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','38','H005_ConfirmarTestimonio','29','Confirmar el Testimonio','1','1')
                          , T_MPH ('59','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','38','H005_RegistrarPresentacionEnRegistro','30','Registrar presentación en Registro','1','1')
                          , T_MPH ('60','P01','Ejecución Hipotecaria','H005','Trámite de Adjudicación - HCJ','38','H005_RegistrarInscripcionDelTitulo','31','Registrar Inscripción del Título','1','1')
                          , T_MPH ('61','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','39','H015_RegistrarSolicitudPosesion','18','Registrar Solicitud de Posesión','0','1')
                          , T_MPH ('62','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','39','H015_RegistrarSenyalamientoPosesion','19','Registrar Señalamiento de la Posesión','0','1')
                          , T_MPH ('63','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','39','H015_RegistrarPosesionYLanzamiento','20','Registrar posesión y decisión sobre lanzamiento','0','1')
                          , T_MPH ('64','P01','Ejecución Hipotecaria','H015','T. de Posesión - HCJ','39','H015_RegistrarSenyalamientoLanzamiento','21','Registrar Señalamiento del Lanzamiento','0','0')
