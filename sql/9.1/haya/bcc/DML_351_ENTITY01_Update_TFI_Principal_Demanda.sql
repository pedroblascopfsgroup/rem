...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('P. hipotecario - HCJ	H001_DemandaCertificacionCargas');
	...
	DBMS_OUTPUT.PUT_LINE('P. Ej. de Titulo no judicial - HCJ	H020_InterposicionDemandaMasBienes');
	...
	DBMS_OUTPUT.PUT_LINE('P. ordinario - HCJ	H024_InterposicionDemanda');
	...
	DBMS_OUTPUT.PUT_LINE('P. Monitorio - HCJ	H022_InterposicionDemanda');
	...
	DBMS_OUTPUT.PUT_LINE('P. Cambiario - HCJ	H016_interposicionDemandaMasBienes');
	...
	DBMS_OUTPUT.PUT_LINE('P. verbal - HCJ	H026_InterposicionDemanda');
