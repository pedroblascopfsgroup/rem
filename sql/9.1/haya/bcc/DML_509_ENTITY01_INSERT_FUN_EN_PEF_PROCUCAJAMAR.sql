...
BEGIN	
	...
	IF V_NUM_TABLAS = 0 THEN    
	  DBMS_OUTPUT.PUT_LINE('Perfil PROCUCAJAMAR no existe.');
	ELSE
		...
		DBMS_OUTPUT.PUT_LINE('[INFO] Funciones ROLE_OCULTAR_ARBOL_OBJETIVOS_PENDIENTES y ROLE_OCULTAR_ARBOL_GESTION_CLIENTES insertadas.');
		COMMIT;
	END IF;
