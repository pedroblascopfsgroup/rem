...
--## INCIDENCIA_LINK=PRODUCTO-1149
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Notificación Liquidación Intereses a Contrario 
--##            para la tarea H042_ConfirmarNotificacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'448';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_NOT_LIQ_INT_CONT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Notificación Liquidación Intereses a Contrario';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'INT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_NOT_LIQ_INT_CONT';
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H042';
    V_NODO VARCHAR2(50 CHAR):=				'H042_ConfirmarNotificacion';
