...
--## INCIDENCIA_LINK=PRODUCTO-1200
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Diligencia de señalamiento edicto de subasta 
--##            para la tarea H004_SenyalamientoSubasta.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'459';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SUB_TER_SENY_SUB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Diligencia de señalamiento edicto de subasta';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'SBT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SUB_TER_SENY_SUB';
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H004';
    V_NODO VARCHAR2(50 CHAR):=				'H004_SenyalamientoSubasta';
