...
BEGIN    
    ...
    EXECUTE IMMEDIATE V_MSQL;
    V_MSQL := 'update '||V_ESQUEMA||'.DD_TR_TIPOS_RESOLUCION set dd_tr_id = ''456'', usuariomodificar = ''PRODUCTO-1196'', fechamodificar=sysdate where dd_tr_codigo = ''R_POI_REG_RES''';
    EXECUTE IMMEDIATE V_MSQL;
