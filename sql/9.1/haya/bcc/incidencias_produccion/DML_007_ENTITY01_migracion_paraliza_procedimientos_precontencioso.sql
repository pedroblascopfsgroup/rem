...
DECLARE
    ...
    USUARIO_C varchar2(20 CHAR) := 'MIGRAHAYA02PCO';    
    USUARIO_M varchar2(20 CHAR) := 'PARAMIGRAHAYA02PCO';
...
-- CREAMOS LOS PROCEDIMIENTOS DERIVADOS
   ...
   V_SQL:= 'INSERT INTO '||V_ESQUEMA||'.PRD_PROCEDIMIENTOS_DERIVADOS
            ...
            SELECT
                ...
                0 as BORRADO                
            FROM '||V_ESQUEMA||'.DPR_DECISIONES_PROCEDIMIENTOS DPR, PRC_PROCEDIMIENTOS prc
           where DPR.PRC_ID = prc.prc_id
             and PRC.USUARIOMODIFICAR = '''||USUARIO_M||''' ';
