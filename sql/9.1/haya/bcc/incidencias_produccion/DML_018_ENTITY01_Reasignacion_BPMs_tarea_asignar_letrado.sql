...
--## INCIDENCIA_LINK=HR-2539
--## PRODUCTO=NO
--## 
--## Finalidad: Enganchar el motor de BPMs a los Litigios para las tareas "Revisar expediente y Asignar letrado"
--##            generadas tras la sincronización.
--## INSTRUCCIONES:  
--## VERSIONES:
--##            0.1 Versión inicial
