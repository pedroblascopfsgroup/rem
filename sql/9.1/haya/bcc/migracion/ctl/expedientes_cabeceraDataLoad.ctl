...
(
	...
	,FECHA_BAJA 								POSITION(110:117)   DATE 'DDMMYYYY' nullif (FECHA_BAJA=BLANKS) "replace( replace(:FECHA_BAJA, '01010001', ''), '00000000', '')"  
	,MOTIVO_BAJA 								POSITION(118:617)  CHAR  nullif (MOTIVO_BAJA=BLANKS) "replace(replace(replace(TRIM(:MOTIVO_BAJA),';',' '), '\"',''),'''','')"
)
