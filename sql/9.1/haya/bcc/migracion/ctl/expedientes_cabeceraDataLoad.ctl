...
LOAD DATA
INTO TABLE HAYA02.MIG_EXPEDIENTES_CABECERA
TRUNCATE 
TRAILING NULLCOLS
(
   ...
   , FECHA_REALIZ_ESTUDIO_SOLV         POSITION(1136:1143) DATE 'DDMMYYYY' nullif (FECHA_REALIZ_ESTUDIO_SOLV=BLANKS) "replace( replace(:FECHA_REALIZ_ESTUDIO_SOLV, '01010001', ''), '00000000', '')"     
   , FECHA_PREPARADO                   POSITION(1144:1151) DATE 'DDMMYYYY' nullif (FECHA_PREPARADO=BLANKS) "replace( replace(:FECHA_PREPARADO, '01010001', ''), '00000000', '')"        
)
