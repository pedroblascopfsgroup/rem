...
INTO TABLE HAYA02.MIG_PROCS_OBSERVACIONES_TROZOS --OJO COLOCAR LA LETRA S AL FINAL PARA LA ENTREGA
TRUNCATE 
TRAILING NULLCOLS
(
  ...
  ,TEXTO                                            POSITION(45:3044)  CHAR nullif(TEXTO=BLANKS)  "TRIM(:TEXTO)"
)
