...
*/
    ...
    EXECUTE IMMEDIATE v_sql INTO existe;
    IF (existe=0) THEN
       EXECUTE IMMEDIATE('CREATE INDEX IDX_MIG_OP_1 ON '||V_ESQUEMA||'.MIG_PROCEDIMIENTOS_OPERACIONES(NUMERO_CONTRATO) ');
    END IF;
    existe := 0;
    ...
    EXECUTE IMMEDIATE v_sql INTO existe;
    IF (existe=0) THEN
       EXECUTE IMMEDIATE('CREATE INDEX IDX_MIG_OP_2 ON '||V_ESQUEMA||'.MIG_CONCURSOS_OPERACIONES(NUMERO_CONTRATO) ');
    END IF;
