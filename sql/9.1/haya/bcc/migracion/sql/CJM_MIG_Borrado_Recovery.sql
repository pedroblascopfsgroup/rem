...
--    **************************/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.HAC_HISTORICO_ACCESOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.GAH_GESTOR_ADICIONAL_HISTORICO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.GAA_GESTOR_ADICIONAL_ASUNTO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
--    ********************/
      ...
      -- Recursos
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.RCR_RECURSOS_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOB_LOTE_BIEN... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOB_LOTE_BIEN(2)... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
--    ********************/
       ...
       DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOS_LOTE_SUBASTA... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
--    ********************/
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.EMP_NMBEMBARGOS_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.SUB_SUBASTA... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      -- CRE_PRC_CEX
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CRE_PRC_CEX... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      --PRC_CEX
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_CEX... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_CEX(2)... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEV_TAREA_EXTERNA_VALOR... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      END IF;
      --
       DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TER_TAREA_EXTERNA_RECUPERACION... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEX_TAREA_EXTERNA... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.SPR_SOLICITUD_PRORROGA... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CRT_CICLO_RECOBRO_TAREA_NOTI... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.DPR_DECISIONES_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ADA_ADJUNTOS_ASUNTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
*/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRB_PRC_BIE... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
/*
    ...
    --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_LOCALIZACION... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
    ...
    --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_VALORACIONES... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ADICIONAL... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ADJ_ADJUDICACION... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      END IF;
        ...
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_PER... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_CNT... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_CAR_CARGAS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
*/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.COV_CONVENIOS_CREDITOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      --COV_CONVENIOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.COV_CONVENIOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_SUI_SUBASTA_INSTRUCCIONES... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.IAG_IMPULSO_AUTO_GENERADO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      IF (EXISTE>0) THEN
           ...
           -- Por asunto
           EXECUTE IMMEDIATE 'DELETE FROM '||V_ESQUEMA ||'.TAR_TAREAS_NOTIFICACIONES WHERE ASU_ID IN ( SELECT ASU_ID FROM '||V_ESQUEMA||'.TABLA_TMP_ASU )';
           DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES .. Se han eliminado '||EXISTE||' registros por asunto');
           COMMIT;
           PRO_KEYS_STATUS(V_ESQUEMA, 'TAR_TAREAS_NOTIFICACIONES', 'ENABLE');
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.RES_RESOLUCIONES_MASIVO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      -- PRC_PROCEDIMIENTOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
    ...
    -- 5º delete from cm01.acu_acuerdo_procedimientos ...
     -- ***************************************************************
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AAR_ACTUACIONES_REALIZADAS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AEA_ACTUACIO_EXPLOR_ACUERDO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AAS_ANALISIS_ASUNTO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ANC_ANALISIS_CONTRATOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ANC_ANALISIS_CONTRATOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.HCA_HISTORICO_CAMBIOS_ASUNTO... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      -- ADJ_ADJUNTOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ADJ_ADJUNTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
--    *ORDEN DE BORRADO 4 *
--    ********************/
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ASU_ASUNTOS... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
...
--    ********************/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CEX_CONTRATOS_EXPEDIENTE... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PEX_PERSONAS_EXPEDIENTE... Comprobando si existen registros para el usuario MIGRACM01');
      EXISTE := 0;
