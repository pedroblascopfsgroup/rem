...
DECLARE
        ...
        USUARIO2     VARCHAR2(50 CHAR):= 'MIGRA2HAYA02PCO';
        USUARIO3     VARCHAR2(50 CHAR):= 'ALTAASUNCM2';
        USUARIO4     VARCHAR2(50 CHAR):= 'SINCRO_CM_HAYA2';         
...
--    **************************/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.HAC_HISTORICO_ACCESOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.GAH_GESTOR_ADICIONAL_HISTORICO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.GAA_GESTOR_ADICIONAL_ASUNTO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    ********************/
      ...
      -- Recursos
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.RCR_RECURSOS_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOB_LOTE_BIEN... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOB_LOTE_BIEN(2)... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    ********************/
       ...
       DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.LOS_LOTE_SUBASTA... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    ********************/
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.EMP_NMBEMBARGOS_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.SUB_SUBASTA... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_BUR_ENVIO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_BUR_BUROFAX... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_DOC_SOLICITUDES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_DOC_DOCUMENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_LIQ_LIQUIDACIONES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PCO_PRC_HEP_HISTOR_EST_PREP... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_PER... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      -- CRE_PRC_CEX
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CRE_PRC_CEX... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      --PRC_CEX
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_CEX... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_CEX(2)... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEV_TAREA_EXTERNA_VALOR... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
      --
       DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TER_TAREA_EXTERNA_RECUPERACION... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEX_TAREA_EXTERNA... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.SPR_SOLICITUD_PRORROGA... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CRT_CICLO_RECOBRO_TAREA_NOTI... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRD_PROCEDIMIENTOS_DERIVADOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.DPR_DECISIONES_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ADA_ADJUNTOS_ASUNTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
*/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRB_PRC_BIE... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
/*
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_DATOS_REGISTRALES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
    ...
    --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_LOCALIZACION... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
    ...
    --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_VALORACIONES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ADICIONAL... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ADJ_ADJUDICACION... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
        ...
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_PER... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_CNT... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_CAR_CARGAS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEA_TERMINOS_ACUERDO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      END IF;
        --
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_TEA... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
/*
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_BIEN... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
*/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.COV_CONVENIOS_CREDITOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      --COV_CONVENIOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.COV_CONVENIOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_SUI_SUBASTA_INSTRUCCIONES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.IAG_IMPULSO_AUTO_GENERADO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.MEJ_IRG_INFO_REGISTRO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      ---MEJ_REG_REGISTRO
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.MEJ_REG_REGISTRO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.RES_RESOLUCIONES_MASIVO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      -- PRC_PROCEDIMIENTOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PRC_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
    ...
    -- 5º delete from cm01.acu_acuerdo_procedimientos ...
     -- ***************************************************************
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ANA_ANALIS_ACUERDO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      -- 1º delete from tea_cnt ....
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.TEA_CNT... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AAR_ACTUACIONES_REALIZADAS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AEA_ACTUACIO_EXPLOR_ACUERDO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      -- 5º delete from cm01.acu_acuerdo_procedimientos ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ACU_ACUERDO_PROCEDIMIENTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.AAS_ANALISIS_ASUNTO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.BIE_ANC_ANALISIS_CONTRATOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ANC_ANALISIS_CONTRATOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.HCA_HISTORICO_CAMBIOS_ASUNTO... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      -- ADJ_ADJUNTOS
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ADJ_ADJUNTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    *ORDEN DE BORRADO 4 *
--    ********************/
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.ASU_ASUNTOS... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    ********************/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CEX_CONTRATOS_EXPEDIENTE... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.PEX_PERSONAS_EXPEDIENTE... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.SCX_SOL_CANCELAC_EXP... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
--    ********************/
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.EXP_EXPEDIENTES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CCL_CONTRATOS_CLIENTE... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
...
/*
      ...
      END IF;
*/
      DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||' '||V_ESQUEMA||'.CLI_CLIENTES... Comprobando si existen registros para el usuario MIGRA2HAYA02');
      EXISTE := 0;
