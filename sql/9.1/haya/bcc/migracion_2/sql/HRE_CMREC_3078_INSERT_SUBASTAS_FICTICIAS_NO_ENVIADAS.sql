...
DECLARE
    ...
    USUARIO varchar2(20 CHAR) := 'MIGRA2HAYA02';
...
DBMS_OUTPUT.PUT_LINE('[INICIO] CAJAMAR MIGRACION SUBASTAS FICTICIAS NO ENVIADAS');
    ...
    v_sql := 'INSERT INTO '||v_esquema||'.SUB_SUBASTA(SUB_ID, ASU_ID, PRC_ID, DD_ESU_ID, FECHACREAR, USUARIOCREAR, FECHAMODIFICAR, USUARIOMODIFICAR, SYS_GUID)
		SELECT '||v_esquema||'.S_SUB_SUBASTA.NEXTVAL, ASU_ID, PRC_ID, DD_ESU_ID, FECHACREAR, USUARIOCREAR, FECHAMODIFICAR, USUARIOMODIFICAR, SYS_GUID() FROM(
