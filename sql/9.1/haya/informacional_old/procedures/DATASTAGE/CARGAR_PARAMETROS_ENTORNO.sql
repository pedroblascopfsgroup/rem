...
BEGIN
  ...
  BEGIN
    ...
    insert into PARAMETROS_ENTORNO values ('ESQUEMA_DATASTAGE', 'RECOVERY_HAYA_DATASTAGE');
    insert into PARAMETROS_ENTORNO values ('FORMATO_FECHA_DDMMYY', 'DD/MM/YY');
    insert into PARAMETROS_ENTORNO values ('ORIGEN_01', 'HAYA01');
    insert into PARAMETROS_ENTORNO values ('ESQUEMA_DWH', 'RECOVERY_HAYA_DWH');
