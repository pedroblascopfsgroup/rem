...
---------------------------------------------------------------------------
 ...
 execute immediate V_SQL USING OUT error;
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_PER_ANOTACION_ENT_INF'', '''', :O_ERROR_STATUS); END;';
 execute immediate V_SQL USING OUT error;
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_PER_ANOTACION_TIPO'', '''', :O_ERROR_STATUS); END;';
 execute immediate V_SQL USING OUT error;
 ...
 execute immediate V_SQL USING OUT error;
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_PER_TIPO_GESTOR'', '''', :O_ERROR_STATUS); END;';
 execute immediate V_SQL USING OUT error;
