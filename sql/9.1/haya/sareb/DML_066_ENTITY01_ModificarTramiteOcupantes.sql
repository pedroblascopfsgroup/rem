...
BEGIN	
	...
	/* ------------------- --------------------------------- */
     ...
     V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS' ||
			  ' SET TFI_VALOR_INICIAL = null ' ||
			  ' WHERE TFI_NOMBRE = ''nombreArrendatario'' AND TAP_ID = (SELECT TAP_ID FROM '||V_ESQUEMA ||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H048_TrasladoDocuDeteccionOcupantes'')';
