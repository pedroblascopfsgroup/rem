...
DECLARE
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TIPO_TFI('H068_validarCambioProcedimiento','1','textarea','observacionesLetrado','Observaciones letrado',null,null,'valores[''H068_registrarProcedimiento''][''observaciones'']',null,'0','DD'),
		T_TIPO_TFI('H068_validarCambioProcedimiento','2','date','fechaEnvio','Fecha envío','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','DD'),
		T_TIPO_TFI('H068_validarCambioProcedimiento','3','textarea','observaciones','Observaciones',null,null,null,null,'0','DD')		
	); 
