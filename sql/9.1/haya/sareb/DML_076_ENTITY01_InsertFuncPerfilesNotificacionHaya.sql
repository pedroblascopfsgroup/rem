...
BEGIN	
    ...
    V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.FUN_PEF WHERE FUN_ID = (SELECT FUN_ID FROM '||V_ESQUEMA_M||'.FUN_FUNCIONES WHERE FUN_DESCRIPCION = ''TAB-NOTIFICACION-DEMANDADOS-v4'') ' ||
	...
	ELSE
		V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
					...
					' WHERE FUN.FUN_DESCRIPCION = ''TAB-NOTIFICACION-DEMANDADOS-v4'' AND PEF.PEF_CODIGO IN '||
