...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Resolución acuerda suspensión de subasta para la tarea H004_RegistrarResolucionSolicitudSuspension.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'217';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ACU_SUS_SUB_T';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Resolución acuerda suspensión de subasta';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'SBT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ACU_SUS_SUB_T';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H004';
    V_NODO VARCHAR2(50 CHAR):=				'H004_RegistrarResolucionSolicitudSuspension';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboSolicitudSubastaSuspendida','comboSolicitudSubastaSuspendida'),
