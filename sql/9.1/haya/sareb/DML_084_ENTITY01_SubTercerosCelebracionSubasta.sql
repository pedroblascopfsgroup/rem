...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Acta de subasta para la tarea H004_RegistrarResolucionSolicitudSuspension.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'218';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ACT_SUB_TRC';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Acta de subasta';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'SBT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ACT_SUB_TRC';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H004';
    V_NODO VARCHAR2(50 CHAR):=				'H004_CelebracionSubasta';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboCelebrada','comboCelebrada'),
    	T_INPUT('d_comboPostores','comboPostores'),
    	T_INPUT('d_comboDecisionSuspension','comboDecisionSuspension'),
