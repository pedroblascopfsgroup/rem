...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito sellado solicitando tasacion de costas y liquidacion de intereses para la tarea H007_SolicitudTasacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'227';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_SOL_TAS_COST';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito sellado solicitando tasacion de costas y liquidacion de intereses';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_SOL_TAS_COST';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H007';
    V_NODO VARCHAR2(50 CHAR):=				'H007_SolicitudTasacion';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_cuantiaLetrado','cuantiaLetrado'),
    	T_INPUT('d_cuantiaProcurador','cuantiaProcurador'),
