...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia favorable para la tarea H024_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'269';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_RES_FAV';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_RES_FAV';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H024';
    V_NODO VARCHAR2(50 CHAR):=				'H024_RegistrarResolucion';
