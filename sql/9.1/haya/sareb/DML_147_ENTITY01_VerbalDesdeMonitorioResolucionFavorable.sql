...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Sentencia favorable para la tarea H028_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'285';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_FAV_VMN';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Sentencia favorable';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'VMN';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_FAV_VMN';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H028';
    V_NODO VARCHAR2(50 CHAR):=				'H028_RegistrarResolucion';
