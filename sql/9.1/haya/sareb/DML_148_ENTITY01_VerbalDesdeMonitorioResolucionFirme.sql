...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'286';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_RES_FRM_MON';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_RES_FRM_MON';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H028';
    V_NODO VARCHAR2(50 CHAR):=				'H028_ResolucionFirme';
