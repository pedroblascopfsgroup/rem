...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución DO Acuerda entrega cantidades retenidas para la tarea H038_ConfirmarRetenciones.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'294';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ACU_ENT_CNT';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'DO Acuerda entrega cantidades retenidas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'EMS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ACU_ENT_CNT';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H038';
    V_NODO VARCHAR2(50 CHAR):=				'H038_ConfirmarRetenciones';
