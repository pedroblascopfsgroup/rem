...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito solicitando averiguación bienes para la tarea H038_ActualizarDatos.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'295';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SOL_AVG_BIN';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Escrito solicitando averiguación bienes';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'EMS';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SOL_AVG_BIN';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H038';
    V_NODO VARCHAR2(50 CHAR):=				'H038_ActualizarDatos';
