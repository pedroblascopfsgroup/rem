...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'334';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_AUT_DSP_DAB';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_AUT_DSP_DAB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H018';
    V_NODO VARCHAR2(50 CHAR):=				'H018_AutoDespachando';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_nProc','nProc'),
    	T_INPUT('d_comboSiNo','comboSiNo'),
    	T_INPUT('d_comboBienesRegistrables','comboBienesRegistrables'),
