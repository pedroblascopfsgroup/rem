...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Hay vista para la tarea H018_HayVista.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'339';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_HAY_VST';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_HAY_VST';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H018';
    V_NODO VARCHAR2(50 CHAR):=				'H018_HayVista';
