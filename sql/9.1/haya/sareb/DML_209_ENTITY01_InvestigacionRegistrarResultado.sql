...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar resultado de investigación para la tarea H044_RegistrarResultadoInvestigacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'348';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REG_RES_INV';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Averiguación patrimonial';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'INJ';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REG_RES_INV';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H044';
    V_NODO VARCHAR2(50 CHAR):=				'H044_RegistrarResultadoInvestigacion';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_comboRegistro','comboRegistro'),
    	T_INPUT('d_comboAgTribut','comboAgTribut'),
    	T_INPUT('d_comboSegSocial','comboSegSocial'),
    	T_INPUT('d_comboCatastro','comboCatastro'),
    	T_INPUT('d_comboAyto','comboAyto'),
    	T_INPUT('d_comboOtros','comboOtros'),
    	T_INPUT('d_solvencia','solvencia'),
    	T_INPUT('d_impuestos','impuestos'),
