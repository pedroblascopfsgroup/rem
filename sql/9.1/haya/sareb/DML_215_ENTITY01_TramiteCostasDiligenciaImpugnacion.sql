...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Diligencia señalando visita impugnación tasación de costas para la tarea H032_RegistrarCelebracionVista.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'354';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_TR_COS_ENT_IMPUG_TAS';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Diligencia señalando visita impugnación tasación de costas';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'TCE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_TR_COS_ENT_IMPUG_TAS';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H032';
    V_NODO VARCHAR2(50 CHAR):=				'H032_RegistrarCelebracionVista';
