...
DELETE FROM MINIREC.H_ACTIVOS_FINANCIEROS 
WHERE TO_CHAR(FECHA_HISTORICO,'YYYYMMDD') LIKE TO_CHAR(SYSDATE,'YYYYMMDD')
OR TO_CHAR(FECHA_HISTORICO,'YYYYMMDD') < TO_CHAR(SYSDATE-30,'YYYYMMDD')ç
;

--Transferencia de los datos al historico
INSERT INTO MINIREC.H_ACTIVOS_FINANCIEROS
(
FECHA_HISTORICO,
ASU_ID,
ID_PROCEDIMIENTO,
...
FROM MINIREC.ACTIVOS_FINANCIEROS
...
INSERT INTO  MINIREC.ACTIVOS_FINANCIEROS
(
ASU_ID,
ID_PROCEDIMIENTO,
ENTI,
