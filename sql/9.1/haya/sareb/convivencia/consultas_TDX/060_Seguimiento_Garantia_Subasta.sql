...
WITH POSTORES AS(
  ...
  FROM HAYA01.PRC_PROCEDIMIENTOS PRC
    INNER JOIN HAYA01.TAR_TAREAS_NOTIFICACIONES TAR ON TAR.PRC_ID = PRC.PRC_ID AND TAR.BORRADO = 0
...
Select DISTINCT
  ...
  SELECT
    ...
    ROW_NUMBER () OVER (PARTITION BY B.BIE_NUMERO_ACTIVO 
                  ORDER BY NVL(S.SUB_FECHA_SENYALAMIENTO,to_date('01/01/1900','DD/MM/RRRR')) DESC)RN
    ...
    INNER JOIN MINIREC.PROCEDIMIENTO_JUDICIAL_FOTO FOTO ON FOTO.ASU_ID = ASU.ASU_ID
