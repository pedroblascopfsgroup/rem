...
FROM (SELECT TAR.TAR_ID, TAR.PRC_ID, PRC.ASU_ID, TAR.FECHACREAR, TAR.TAR_FECHA_INI, TAR.TAR_FECHA_FIN, TAP.TAP_CODIGO, TAP.TAP_DESCRIPCION,
    ...
    FROM HAYA01.PRC_PROCEDIMIENTOS PRC
      ...
      INNER JOIN MINIREC.VAL_PROC_JUDICIAL_FOTO FOTO ON PRC.ASU_ID = FOTO.ASU_ID
