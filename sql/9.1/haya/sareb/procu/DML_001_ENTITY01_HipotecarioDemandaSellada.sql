...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'201';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_DEM_SELLADA';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_DEM_SELLADA';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H001';
    V_NODO VARCHAR2(50 CHAR):=				'H001_DemandaCertificacionCargas';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_fechaPresentacionDemanda','fechaPresentacionDemanda'),
    	T_INPUT('d_plazaJuzgado','plazaJuzgado'),
    	T_INPUT('d_fechaCierreDeuda','fechaCierreDeuda'),
    	T_INPUT('d_principalDeLaDemanda','principalDeLaDemanda'),
    	T_INPUT('d_capitalVencidoEnElCierre','capitalVencidoEnElCierre'),
    	T_INPUT('d_capitalNoVencidoEnElCierre','capitalNoVencidoEnElCierre'),
    	T_INPUT('d_interesesOrdinariosEnElCierre','interesesOrdinariosEnElCierre'),
    	T_INPUT('d_interesesDeDemoraEnElCierre','interesesDeDemoraEnElCierre'),
    	T_INPUT('d_plazoInteresesOrdinarios','plazoInteresesOrdinarios'),
    	T_INPUT('d_tipoMaximoInteresesOrdinarios','tipoMaximoInteresesOrdinarios'),
    	T_INPUT('d_plazoInteresesDemora','plazoInteresesDemora'),
    	T_INPUT('d_tipoMaximoInteresesDemora','tipoMaximoInteresesDemora'),
    	T_INPUT('d_tipoInteresDemora','tipoInteresDemora'),
