...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Confirmar anotación en registro para la tarea H020_BPMVigilanciaCaducidadAnotacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'323';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_CNF_ANT_REG';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_CNF_ANT_REG';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H020';
    V_NODO VARCHAR2(50 CHAR):=				'H020_BPMVigilanciaCaducidadAnotacion';
