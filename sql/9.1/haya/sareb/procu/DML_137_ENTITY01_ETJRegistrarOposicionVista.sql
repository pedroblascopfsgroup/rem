...
--## PRODUCTO=SI
--##
--## Finalidad: Realiza las inserciones de la resolución Escrito de oposición para la tarea H018_RegistrarOposicion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'337';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_ESC_OPO_PJU';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_ESC_OPO_PJU';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H018';
    V_NODO VARCHAR2(50 CHAR):=				'H018_RegistrarOposicion';
