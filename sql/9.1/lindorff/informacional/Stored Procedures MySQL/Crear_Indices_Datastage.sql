...
-- Fecha última modificación: 06/11/2014
-- Motivos del cambio: 
...
if (HAY < 1) then 
    ...
    set o_error_status:= concat('Se ha insertado el INDICE TABLA_FECHAS_NOTIFICACION_IX. Nº [', HAY, ']');
else 
    set o_error_status:= concat('Ya existe el INDICE TABLA_FECHAS_NOTIFICACION_IX. Nº [', HAY, ']');
end if;
