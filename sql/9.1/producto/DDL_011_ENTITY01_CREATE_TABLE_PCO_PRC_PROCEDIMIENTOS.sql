...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_PRC_PROCEDIMIENTOS
			   ...
			   ,PCO_PRC_TIPO_PRC_PROP  	  		VARCHAR2(50 CHAR) 
			   ,PCO_PRC_TIPO_PRC_INICIADO 		VARCHAR2(50 CHAR)
			   ,PCO_PRC_PRETURNADO 		  		INTEGER DEFAULT 0   NOT NULL
			   ,PCO_PRC_NOM_EXP_JUD 	  		VARCHAR2(50 CHAR)
			   ,PCO_PRC_FECHA_INICIO  	  		TIMESTAMP(6)
			   ,PCO_PRC_CNT_PRINCIPAL  	  		NUMBER(16)
			   ,PCO_PRC_NUM_EXP_INT 	  		VARCHAR2(50 CHAR)
			   ,DD_PCO_PTP_ID 		      		NUMBER(16)
			   ,PCO_PRC_FECHA_PREPARADO  		TIMESTAMP(6)
 			   ,PCO_PRC_FECHA_ENVIO_LETRADO 	TIMESTAMP(6)
			   ,PCO_PRC_FECHA_FINALIZADO  		TIMESTAMP(6)
			   ,PCO_PRC_FECHA_ULTIMA_SUBSANA  	TIMESTAMP(6)
			   ,PCO_PRC_FECHA_CANCELADO  		TIMESTAMP(6)
			   ,PCO_PRC_FECHA_PARALIZACION 	    TIMESTAMP(6)
			   ...
			   ,CONSTRAINT FK_PCO_PRC_ESTADO_PREP FOREIGN KEY (DD_PCO_PEP_ID) REFERENCES DD_PCO_PRC_ESTADO_PREPARACION (DD_PCO_PEP_ID)
