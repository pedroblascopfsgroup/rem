...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_PRC_PROCEDIMIENTOS
               ...
               ,CONSTRAINT FK_PCO_PRC_PRC_PROC FOREIGN KEY (PCO_PRC_TIPO_PRC_PROP) REFERENCES DD_TPO_TIPO_PROCEDIMIENTO (DD_TPO_ID)
               ,CONSTRAINT FK_PCO_PRC_PRC_PROC FOREIGN KEY (PCO_PRC_TIPO_PRC_INICIADO) REFERENCES DD_TPO_TIPO_PROCEDIMIENTO (DD_TPO_ID)
               )';
