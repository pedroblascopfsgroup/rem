...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_PRC_PROCEDIMIENTOS
			   ...
			   ,PCO_PRC_PRC_ID  		  		NUMBER(16) 		  NOT NULL ENABLE
			   ,PCO_PRC_PREPARACION_ID    		NUMBER(16) 		  NOT NULL ENABLE
			   ...
			   ,CONSTRAINT UNIQUE_PCO_PRC_PROCEDIMIENTOS UNIQUE (PCO_PRC_PRC_ID)
			   ,CONSTRAINT FK_PCO_PRC_ESTADO_PREP FOREIGN KEY (PCO_PRC_PREPARACION_ID) REFERENCES DD_PCO_PRC_ESTADO_PREPARACION (DD_PCO_PEP_ID)
			   ,CONSTRAINT FK_PCO_PRC_TIPO_PREP FOREIGN KEY (PCO_PRC_PTP_ID) REFERENCES DD_PCO_PRC_TIPO_PREPARACION (DD_PCO_PTP_ID)
			   ,CONSTRAINT FK_PCO_PRC_PRC_PROC FOREIGN KEY (PCO_PRC_PRC_ID) REFERENCES PRC_PROCEDIMIENTOS (PRC_ID)
               )';
