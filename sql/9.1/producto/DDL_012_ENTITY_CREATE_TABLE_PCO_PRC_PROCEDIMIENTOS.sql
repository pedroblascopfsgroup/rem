...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_PRC_PROCEDIMIENTOS
			   ...
			   ,TIPO_PRC_PROP  			  VARCHAR2(50 CHAR) 
			   ,TIPO_PRC_INICIADO  		  VARCHAR2(50 CHAR)
			   ,PRETURNADO 				  INTEGER DEFAULT 0   NOT NULL
			   ,NOM_EXP_JUD 			  VARCHAR2(50 CHAR)
			   ,FECHA_INICIO  			  TIMESTAMP(6)
			   ,CNT_PRINCIPAL  			  NUMBER(16)
			   ,NUM_EXP_INT 			  VARCHAR2(50 CHAR)
			   ,DD_PCO_PTP_ID 		      NUMBER(16)
			   ,FECHA_PREPARADO  		  TIMESTAMP(6)
 			   ,FECHA_ENVIO_LETRADO 	  TIMESTAMP(6)
			   ,FECHA_FINALIZADO  		  TIMESTAMP(6)
			   ,FECHA_ULTIMA_SUBSANACION  TIMESTAMP(6)
			   ,FECHA_CANCELADO  		  TIMESTAMP(6)
			   ,FECHA_PARALIZACION 	      TIMESTAMP(6)
