...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_LIQ_LIQUIDACIONES
			   ...
			   ,CONSTRAINT FK_PCO_LIQ_LIQUIDACIONES_PRC FOREIGN KEY (PCO_LIQ_PRC_ID) REFERENCES PCO_PRC_PROCEDIMIENTOS (PCO_PRC_ID)
			   ,CONSTRAINT FK_PCO_LIQ_LIQUIDACIONES_EST FOREIGN KEY (PCO_LIQ_ESTADO_ID) REFERENCES DD_PCO_LIQ_ESTADO (DD_PCO_LIQ_ID)
               )';
