...
DECLARE
    ...
    ELSE
    		...
    		V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.PCO_BUR_ENVIO
			   ...
			   ,PCO_BUR_ENVIO_BUROFAX_ID    		NUMBER(16)		  NOT NULL ENABLE
			   ,PCO_BUR_ENVIO_DIR_ID    			NUMBER(16) 		  NOT NULL ENABLE
			   ,PCO_BUR_ENVIO_TIPO_ID    			NUMBER(16) 		  NOT NULL ENABLE
			   ,PCO_BUR_ENVIO_FECHA_SOLICITUD    	TIMESTAMP(6)
			   ,PCO_BUR_ENVIO_FECHA_ENVIO    		TIMESTAMP(6) 
			   ,PCO_BUR_ENVIO_FECHA_ACUSO    		TIMESTAMP(6)
			   ,PCO_BUR_ENVIO_RESULTADO_ID    		NUMBER(16)
			   ...
			   ,CONSTRAINT FK_PCO_BUR_ENVIO_RESULTADO_ID FOREIGN KEY (PCO_BUR_ENVIO_RESULTADO_ID) REFERENCES DD_PCO_BFR_RESULTADO (DD_PCO_BFR_ID)
			   ,CONSTRAINT FK_PCO_BUR_ENVIO_TIPO_ID FOREIGN KEY (PCO_BUR_ENVIO_TIPO_ID) REFERENCES DD_PCO_BFT_TIPO (DD_PCO_BFT_ID)
			   ,CONSTRAINT FK_PCO_BUR_ENVIO_BUROFAX_ID  FOREIGN KEY (PCO_BUR_ENVIO_BUROFAX_ID ) REFERENCES PCO_BUR_BUROFAX (PCO_BUR_BUROFAX_ID)
			   ,CONSTRAINT FK_PCO_BUR_ENVIO_DIRECCION_ID FOREIGN KEY (PCO_BUR_ENVIO_DIR_ID) REFERENCES DIR_DIRECCIONES (DIR_ID)	
               )';
