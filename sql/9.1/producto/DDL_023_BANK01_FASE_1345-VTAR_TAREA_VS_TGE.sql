...
'FROM '||V_ESQUEMA||'.tar_tareas_notificaciones tar '||Chr(13)||Chr(10)||
 ...
 ' JOIN BANKMASTER.DD_EIN_ENTIDAD_INFORMACION ein ON tar.dd_ein_id = ein.dd_ein_id '||Chr(13)||Chr(10)||
...
'WHERE  (tar.tar_tarea_finalizada IS NULL OR tar.tar_tarea_finalizada = 0) '||Chr(13)||Chr(10)||
'   --AND tar.dd_ein_id IN (3, 5, 2, 9, 10) '||Chr(13)||Chr(10)||
