...
FROM HAYA01.TAR_TAREAS_NOTIFICACIONES TN
  INNER JOIN HAYA01.OBJ_OBJETIVO OBJ ON TN.OBJ_ID = OBJ.OBJ_ID
    INNER JOIN HAYA01.POL_POLITICA POL ON OBJ.POL_ID = POL.POL_ID
      LEFT JOIN HAYA01.ZON_ZONIFICACION ZONGES ON POL.ZON_ID_GESTOR = ZONGES.ZON_ID
      LEFT JOIN HAYA01.ZON_ZONIFICACION ZONSUP ON POL.ZON_ID_SUPER = ZONSUP.ZON_ID
