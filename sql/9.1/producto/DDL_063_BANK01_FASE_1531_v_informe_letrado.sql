       ...
       (SELECT /*+ MATERIALIZE */
         ...
         WHERE NOT tev.tev_valor IS NULL
           AND tap.tap_codigo IN
                  (''P01_DemandaCertificacionCargas'', ''P17_InterposicionDemandaMasBienes'', ''P04_InterposicionDemanda'', ''P25_interposicionDemanda'', ''P15_InterposicionDemandaMasBienes'',
                   ''P03_InterposicionDemanda'', ''P02_InterposicionDemanda'')) demanda ON prc.prc_id = demanda.prc_id
       LEFT JOIN
       (SELECT /*+ MATERIALIZE */
