...
BEGIN	
  ...
  -- CREACION DE INDICES
  DBMS_OUTPUT.PUT_LINE('INICIO CREATE INDEX '|| V_ESQUEMA ||'.EXP_EXPEDIENTES_INDEX6...');
  ...
  IF CUENTA=0 THEN
	  EXECUTE IMMEDIATE 'CREATE INDEX '|| V_ESQUEMA ||'.EXP_EXPEDIENTES_INDEX6 ON '|| V_ESQUEMA ||'.EXP_EXPEDIENTES (LOWER(EXP_DESCRIPCION) ASC)';  
  DBMS_OUTPUT.PUT_LINE('CREATE INDEX '|| V_ESQUEMA ||'.EXP_EXPEDIENTES_INDEX6...Creado');
  END IF;
