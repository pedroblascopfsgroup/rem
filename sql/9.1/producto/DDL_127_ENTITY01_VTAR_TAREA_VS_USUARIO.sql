...
--## INCIDENCIA_LINK=HR-1265
--## PRODUCTO=SI
--## Finalidad: Actualizar la vista para que se muestren correctamente las tareas pendientes.
--##           
...
'        UNION'||Chr(13)||Chr(10)||
'      SELECT * FROM '||V_ESQUEMA||'.VTAR_TAREA_VS_USUARIO_ACUERDOS'||Chr(13)||Chr(10)||
'    ) V'||Chr(13)||Chr(10)||
