...
--##########################################
--## AUTOR=CARLOS PEREZ
--## FECHA_CREACION=2015111
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.1.0-cj-rc21
...
PPF.PER_ID, PPF.EST_CICLO_VIDA, PPF.DIAS_VENC_RIESGO_DIRECTO, PPF.DIAS_VENC_RIESGO_INDIRECTO
        ...
        , NUM_EXP_ACTIVOS.NUM_EXP_ACTIVOS, NUM_ASU_ACTIVOS.NUM_ASU_ACTIVOS, NUM_ASU_ACTIVOS_POR_PRC.NUM_ASU_ACTIVOS_POR_PRC, PPF.SITUACION, PPF.RELACION_EXP, PPF.SERV_NOMINIA_PENSION
