...
BEGIN
    ...
    IF V_NUM_TABLAS = 1 THEN 
			...
			V_MSQL := 'ALTER TABLE '||v_esquema||'.BIE_CNT 
					   ADD BIE_SEC_GARANTIA_CNT NUMBER(14,2)';
			EXECUTE IMMEDIATE V_MSQL;
			DBMS_OUTPUT.PUT_LINE('[INFO] '||v_esquema||'.BIE_CNT... CAMPO BIE_SEC_GARANTIA_CNT CREADO');
		    END IF;			
   END IF;
    DBMS_OUTPUT.PUT_LINE('[INFO] '||v_esquema||'.BIE_CNT... Alter table FIN');  
