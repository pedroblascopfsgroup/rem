...
--Validamos si la tabla existe antes de crearla
  ...
  EXECUTE IMMEDIATE 'CREATE INDEX '||V_ESQUEMA||'.IDX_BATCH_SV_DATOS_CNT_PER_PK ON '||V_ESQUEMA||'.'||TABLA||' (CNT_ID,PER_ID) NOLOGGING';
  EXECUTE IMMEDIATE 'CREATE BITMAP INDEX '||V_ESQUEMA||'.IDX_BATCH_SV_DATOS_CNT_PER_BM ON '||V_ESQUEMA||'.'||TABLA||' (ARRASTRE) NOLOGGING';
  DBMS_OUTPUT.PUT_LINE(TABLA||' INDICES CREADOS');
