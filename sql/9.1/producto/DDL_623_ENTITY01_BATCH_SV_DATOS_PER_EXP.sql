...
DECLARE
 ...
 TABLA        VARCHAR(30 CHAR) := 'BATCH_SV_DATOS_PER_EXP';
...
--Validamos si la tabla existe antes de crearla
  ...
  DD_TPX_CODIGO  VARCHAR2(20 BYTE)
            ) NOLOGGING';
  ...
  ELSE
     ...
     EXECUTE IMMEDIATE V_MSQL;
     DBMS_OUTPUT.PUT_LINE(TABLA||' CREADA');
     EXECUTE IMMEDIATE ('Create index IDX_BATCH_SV_DATOS_PER_EXP on '||V_ESQUEMA||'.'||TABLA||' (per_id) nologging');
