...
DECLARE
 ...
 TABLA        VARCHAR(30 CHAR) := 'BATCH_VEN_DATOS_SALIDA_BASE';
...
--Validamos si la tabla existe antes de crearla
  ...
  ELSE
     ...
     EXECUTE IMMEDIATE V_MSQL;
     DBMS_OUTPUT.PUT_LINE(TABLA||' CREADA');
     EXECUTE IMMEDIATE ('Create index IDX_BATCH_VEN_DAT_SAL_BASE on BATCH_VEN_DATOS_SALIDA_BASE(exp_id, cnt_id, per_id) nologging');
