...
DECLARE
 ...
 TABLA        VARCHAR(30 CHAR) := 'BATCH_VEN_DATOS_SALIDA_TODO';
...
--Validamos si la tabla existe antes de crearla
  ...
  ELSE
     ...
     EXECUTE IMMEDIATE V_MSQL;
     DBMS_OUTPUT.PUT_LINE(TABLA||' CREADA');
     EXECUTE IMMEDIATE ('CREATE INDEX IDX_BATCH_VEN_DATOS_SALIDA_ALL ON '||V_ESQUEMA||'.'||TABLA||' (exp_id, per_id) nologging');
