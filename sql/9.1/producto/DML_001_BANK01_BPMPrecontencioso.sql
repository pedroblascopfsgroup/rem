...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('PCO','PCO_PreTurnadoManual',null,null,null,'valores[''PCO_PreTurnadoManual''][''preTurnado''] == DDSiNo.SI ? (valores[''PCO_PreTurnadoManual''][''automatico''] == DDSiNo.SI ? ''automatico'' : ''manual'') : ''posturnado''',null,'0','Seleccionar tipo de turnado','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
       T_TIPO_TAP('PCO','PCO_PreTurnado',null,null,null,null,null,'0','Preturnado automatico','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
       T_TIPO_TAP('PCO','PCO_RegistrarAceptacion',null,null,null,'valores[''PCO_RegistrarAceptacion''][''aceptacion''] == DDSiNo.SI ? ''aceptacion'' : ''no_aceptacion''',null,'0','Registrar aceptación del asunto','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
       ...
       T_TIPO_TAP('PCO','PCO_EnviarExpedienteLetrado',null,null,null,null,null,'0','Enviar expediente a letrado','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
       T_TIPO_TAP('PCO','PCO_RegistrarTomaDec',null,null,null,'valores[''PCO_RegistrarTomaDec''][''correcto''] == DDSiNo.SI ? ''ok'' : (valores[''PCO_RegistrarTomaDec''][''cambio_proc''] == DDSiNo.SI ? ''cambio_proc'' : ''requiere_subsanar'')',null,'0','Registrar toma de decisión','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
       T_TIPO_TAP('PCO','PCO_RevisarSubsanacion',null,null,null,'valores[''PCO_RegistrarTomaDec''][''correcto''] == DDSiNo.SI ? ''ok'' : (valores[''PCO_RegistrarTomaDec''][''cambio_proc''] == DDSiNo.SI ? ''cambio_proc'' : ''requiere_subsanar'')',null,'0','Revisar subsanacion propuesta','0','DD','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null),
