...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
	    T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'PCO',
        /*TAP_CODIGO...................:*/ 'PCO_VisarLiq',
        /*TAP_VIEW.....................:*/ 'plugin/precontencioso/tramite/preparacion',
        /*TAP_SCRIPT_VALIDACION........:*/ null,
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
        /*TAP_SCRIPT_DECISION..........:*/ null,
        /*DD_TPO_ID_BPM(FK)............:*/ null,
        /*TAP_SUPERVISOR,..............:*/ '1',
        /*TAP_DESCRIPCION,.............:*/ 'Visar factura',
        /*VERSION......................:*/ '0',
        /*USUARIOCREAR.................:*/ 'DD',
        /*BORRADO......................:*/ '0',
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
    	T_TIPO_PLAZAS(null,null,'PCO_VisarLiq','3*24*60*60*1000L','0','0','DD')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		T_TIPO_TFI('PCO_VisarLiq','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Tarea especial.</p></div>',null,null,null,null,'0','DD'),
		T_TIPO_TFI('PCO_VisarLiq','1','textarea','observaciones','Observaciones',null,null,null,null,'0','DD')
    ); 
