...
T_LINEA('PCO_PrepararExpediente','PCO_PREDOC','45','SUP_PCO'),
T_LINEA('PCO_SolicitarDoc','PCO_PREDOC','2','SUP_PCO'),
...
T_LINEA('PCO_EnviarExpedienteLetrado','PCO_PREDOC','2','SUP_PCO'),
...
T_LINEA('PCO_SubsanarIncidenciaExp','PCO_PREDOC','10','SUP_PCO'),
T_LINEA('PCO_ValidarCambioProc','PCO_SUP','2','SUP_PCO'),
T_LINEA('PCO_SubsanarCambioProc','PCO_PREDOC','10','SUP_PCO'),
T_LINEA('PCO_RevisarExpediente','PCO_LET','5','SUP_PCO'),
T_LINEA('PCO_RegResultadoExped','PCO_PREDOC','2','SUP_PCO'),
T_LINEA('PCO_RecepcionExped','PCO_PREDOC','15','SUP_PCO'),
T_LINEA('PCO_RegResultadoDoc','PCO_PREDOC','2','SUP_PCO'),
T_LINEA('PCO_RegEnvioDoc','PCO_GEST','2','PREDOC'),
T_LINEA('PCO_RecepcionDoc','PCO_PREDOC','2','SUP_PCO'),
T_LINEA('PCO_AdjuntarDoc','PCO_PREDOC','10','SUP_PCO'),
T_LINEA('PCO_GenerarLiq','PCO_PREDOC','45','SUP_PCO'),
T_LINEA('PCO_ConfirmarLiq','PCO_PREDOC','2','SUP_PCO'),
T_LINEA('PCO_EnviarBurofax','PCO_PREDOC','2','SUP_PCO'),
T_LINEA('PCO_AcuseReciboBurofax','PCO_PREDOC','7','SUP_PCO')
    ); 
