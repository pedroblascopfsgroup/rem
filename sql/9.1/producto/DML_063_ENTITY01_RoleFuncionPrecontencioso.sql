...
BEGIN
    ...
    V_SQL := 'SELECT COUNT(1) FROM ' || V_ESQUEMA || '.PEF_PERFILES WHERE PEF_CODIGO = ''FULLPRECON''';
    EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;

    -- INSERTANDO EN PEF_PERFILES

    IF V_NUM_TABLAS > 0 THEN
      DBMS_OUTPUT.PUT_LINE('[INFO] ya existe el perfil de precontencioso');
    ELSE
