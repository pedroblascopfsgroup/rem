...
V_MSQL := 'UPDATE ' || V_ESQUEMA_MASTER || '.DD_TGE_TIPO_GESTOR SET BORRADO = ''1'' WHERE DD_TGE_CODIGO = ''LET_PCO''';
EXECUTE IMMEDIATE V_MSQL;


DBMS_OUTPUT.PUT_LINE('[INFO] - Borrado logico en DD_TDE_TIPO_DESPACHO');
V_MSQL := 'UPDATE ' || V_ESQUEMA_MASTER || '.DD_TDE_TIPO_DESPACHO SET BORRADO = ''1'' WHERE DD_TDE_CODIGO = ''LET_PCO''';
EXECUTE IMMEDIATE V_MSQL;
