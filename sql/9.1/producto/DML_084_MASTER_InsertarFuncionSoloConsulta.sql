...
--## PRODUCTO=SI
--##
--## Finalidad: Insertar la funcionalidad SOLO_CONSULTA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
BEGIN	
	...
	IF V_NUM_TABLAS > 0 THEN    
	  ...
	  DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe SOLO_CONSULTA en FUN_FUNCIONES.');
	
	ELSE
	
	V_MSQL_1:= 'INSERT INTO '||V_ESQUEMA_M||'.FUN_FUNCIONES '||
	  '(FUN_ID, FUN_DESCRIPCION_LARGA,FUN_DESCRIPCION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)'||
	  ' VALUES ('||V_ESQUEMA_M||'.S_FUN_FUNCIONES.NEXTVAL,''Función solo consulta'',''SOLO_CONSULTA'',''0'',''DML'',SYSDATE,''0'') ';
