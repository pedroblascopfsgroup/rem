...
DECLARE
	...
	IF V_COUNT > 0 THEN
		...
		V_SQL := 'UPDATE '||V_ESQUEMA||'.DD_TPA_TIPO_ACUERDO SET DD_ENT_ACU_ID = (SELECT DD_ENT_ACU_ID FROM '||V_ESQUEMA||'.DD_ENTIDAD_ACUERDO WHERE DD_ENT_ACU_DESCRIPCION = ''Asunto'') WHERE DD_TPA_CODIGO = ''CES_REM''';
