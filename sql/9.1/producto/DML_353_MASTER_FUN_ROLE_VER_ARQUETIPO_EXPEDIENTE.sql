...
IF V_NUM_TABLAS = 0 THEN
	...
	V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (FUN_ID, FUN_DESCRIPCION_LARGA, FUN_DESCRIPCION,  VERSION, USUARIOCREAR, FECHACREAR,  BORRADO )  VALUES '||
				'(S_FUN_FUNCIONES.NEXTVAL, '' Permite ver el campo arquetipo e itinerario en los expedientes de recuperaciones o de seguimiento'', ''ROLE_VER_ARQUETIPO_EXPEDIENTE'', 0, ''DML'', SYSDATE, 0)';
