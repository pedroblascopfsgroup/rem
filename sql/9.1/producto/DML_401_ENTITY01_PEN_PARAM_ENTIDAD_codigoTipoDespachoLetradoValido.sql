...
BEGIN
  ...
  ELSE
    ...
    V_SQL := 'INSERT INTO '||V_ESQUEMA||'.PEN_PARAM_ENTIDAD
    	...
    	VALUES
    		('||V_ESQUEMA||'.s_pen_param_entidad.nextval, ''codigoTipoDespachoLetradoValido'', ''1'', ''Identifica el codigo del tipo despacho valido en la entidad, por defecto el codigo 1'', 0, ''DD'', sysdate, 0)';
