...
BEGIN	
    ...
    V_SQL := q'[MERGE INTO ]' || V_TABLENAME1 || q'[ f  USING (SELECT 'GENERAR_DOC_PRECONTENCIOSO' fun_descripcion, 
'Boton Generar Documentos Precontencioso' fun_descripcion_larga, 'PBO' usuariocrear, sysdate fechacrear, 0 version, 0 borrado 
from DUAL) actual
