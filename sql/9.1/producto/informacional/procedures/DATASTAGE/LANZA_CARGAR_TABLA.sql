...
-- ===============================================================================================
  ...
  cursor c_index is select INDEX_NAME, STATUS from USER_INDEXES where UPPER(TABLE_NAME) = V_NOMBRE_TABLA_DESTINO and TABLESPACE_NAME = V_ESQUEMA and INDEX_NAME not like 'SYS%' ;
