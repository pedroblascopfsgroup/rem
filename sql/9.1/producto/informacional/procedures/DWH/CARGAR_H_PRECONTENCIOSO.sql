...
-- Motivos del cambio: Trunc en fechas de estados.
...
*/
  ...
  execute immediate V_SQL USING OUT O_ERROR_STATUS;
    ...
    --GRADO_AVANCE_DOCUMENTOS   select * from RECOVERY_PRODUC_datastage.DD_PCO_DOC_ESTADO; --DD_PCO_DED_ID = 4 --Disponible/Recibido
    execute immediate 'merge into TMP_H_PRE t1  
    ...
    --GRADO_AVANCE_LIQUIDACIONES    select * from RECOVERY_PRODUC_datastage.DD_PCO_LIQ_ESTADO; --DD_PCO_LIQ_ID = 4 --Confirmada
    execute immediate 'merge into TMP_H_PRE t1  
    ...
    --GRADO_AVANCE_BUROFAXES    select * from RECOVERY_PRODUC_datastage.DD_PCO_BFE_ESTADO; --DD_PCO_BFE_ID = 1 --Notificado
    execute immediate 'merge into TMP_H_PRE t1  
