...
BEGIN
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_SITUACN_RESP_PER_ANT_PK'', ''D_CNT_SITUACION_RESP_PER_ANT (SITUACION_RESP_PER_ANT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_T_IRREG_DIAS_PER_ANT_PK'', ''D_CNT_T_IRREG_DIAS_PERIODO_ANT (T_IRREG_DIAS_PERIODO_ANT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_EST_FIN_A_INI_CAM_RE_PK'', ''D_CNT_EST_FIN_ANT_INI_CAMP_REC (EST_FIN_ANT_INI_CAMP_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_EN_GES_RE_INI_CAM_RE_PK'', ''D_CNT_EN_GEST_REC_INI_CAMP_REC (EN_GEST_REC_INI_CAMP_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_MODELO_RE_INI_CAM_RE_PK'', ''D_CNT_MODELO_REC_INI_CAMP_REC (MODELO_REC_INI_CAMP_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_T_IRREG_D_INI_CAM_RE_PK'', ''D_CNT_T_IRREG_D_INI_CAMP_REC (T_IRREG_D_INI_CAMP_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_T_IRREG_F_INI_CAM_RE_PK'', ''D_CNT_T_IRREG_F_INI_CAMP_REC (T_IRREG_F_INI_CAMP_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
      ...
      V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_CON_PREVISION_REVISA_PK'', ''D_CNT_CON_PREVISION_REVISADA (CNT_CON_PREV_REVISADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_PREV_SITUACION_INICI_PK'', ''D_CNT_PREV_SITUACION_INICIAL (PREV_SITUACION_INICIAL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
...
------------------------------ D_CNT_SITUACION_ESPECIALIZADA -------------------------
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_SITUACION_ESPECIALIZ_PK'', ''D_CNT_SITUACION_ESPECIALIZADA (SITUACION_ESPECIALIZADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
...
------------------------------ D_CNT_SUPERVISOR_N2_ESPEC -------------------------
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_MODELO_GESTION_CARTE_PK'', ''D_CNT_MODELO_GESTION_CARTERA (MODELO_GESTION_CARTERA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_UNIDAD_GESTION_CARTE_PK'', ''D_CNT_UNIDAD_GESTION_CARTERA (UNIDAD_GESTION_CARTERA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_TIPO_SALIDA_EXPEDIEN_PK'', ''D_CNT_TIPO_SALIDA_EXPEDIENTE (TIPO_SALIDA_EXP_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
...
------------------------------ D_CNT_MOTIVO_SALIDA_EXP -------------------------
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_SEGMENTO_CARTER_COBR_PK'', ''D_CNT_SEGMENTO_CARTERA_COBRO (SEGMENTO_CARTERA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
       ...
       V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_T_DEUDA_IRREGUL_COBR_PK'', ''D_CNT_T_DEUDA_IRREGULAR_COBRO (T_DEUDA_IRREGULAR_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
        ...
        V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_ENVIADO_AGENCI_ACUER_PK'', ''D_CNT_ENVIADO_AGENCIA_ACUERDO (ENVIADO_AGENCIA_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
        ...
        V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_CALIF_FINAL_CRED_INS_PK'', ''D_CNT_CALIF_FINAL_CREDITO_INSI (CALIF_FINAL_CREDITO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
 ...
 execute immediate V_SQL USING OUT error;
         ...
         V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_CNT_DESPACHO_GESTOR_CRED_PK'', ''D_CNT_DESPACHO_GESTOR_CREDITO (DESPACHO_GESTOR_CREDITO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error; 
