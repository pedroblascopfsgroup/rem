...
INSERT
INTO D_F_LLAMADA_TRIMESTRE
  (
    TRIMESTRE_LLAMADA_ID,
    TRIMESTRE_FECHA,
    TRIMESTRE_DESC,
    ANIO_LLAMADA_ID,
    TRIMESTRE_DURACION,
...
-- ----------------------------------------------------------------------------------------------      
      INSERT
INTO D_F_LLAMADA_DIA
  (
    DIA_LLAMADA_ID,
    DIA_SEMANA_LLAMADA_ID,
    MES_LLAMADA_ID,
    TRIMESTRE_LLAMADA_ID,
    ANIO_LLAMADA_ID,
    DIA_ANT_ID,
