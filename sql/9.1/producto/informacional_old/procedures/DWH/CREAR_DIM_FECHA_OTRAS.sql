...
BEGIN
  ...
  begin
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_CARGA_DATOS_ANIO'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_ANIO_PK'', ''D_F_CARGA_DATOS_ANIO (ANIO_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_DIA_SEMANA_PK'', ''D_F_CARGA_DATOS_DIA_SEMANA (DIA_SEMANA_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_MES_PK'', ''D_F_CARGA_DATOS_MES (MES_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_MES_ANIO_PK'', ''D_F_CARGA_DATOS_MES_ANIO (MES_ANIO_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_TRIMESTRE_PK'', ''D_F_CARGA_DATOS_TRIMESTRE (TRIMESTRE_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CARGA_DATOS_DIA_PK'', ''D_F_CARGA_DATOS_DIA (DIA_CARGA_DATOS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_ANIO_PK'', ''D_F_POS_VENCIDA_ANIO (ANIO_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_DIA_SEMANA_PK'', ''D_F_POS_VENCIDA_DIA_SEMANA (DIA_SEMANA_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_MES_PK'', ''D_F_POS_VENCIDA_MES (MES_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_MES_ANIO_PK'', ''D_F_POS_VENCIDA_MES_ANIO (MES_ANIO_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_TRIMESTRE_PK'', ''D_F_POS_VENCIDA_TRIMESTRE (TRIMESTRE_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_POS_VENCIDA_DIA_PK'', ''D_F_POS_VENCIDA_DIA (DIA_POS_VENCIDA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_ANIO_PK'', ''D_F_SALDO_DUDOSO_ANIO (ANIO_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_DIA_SEMANA_PK'', ''D_F_SALDO_DUDOSO_DIA_SEMANA (DIA_SEMANA_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_SALDO_DUDOSO_MES'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_MES_PK'', ''D_F_SALDO_DUDOSO_MES (MES_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_MES_ANIO_PK'', ''D_F_SALDO_DUDOSO_MES_ANIO (MES_ANIO_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_SALDO_DUDOSO_TRIMESTRE'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_TRIMESTRE_PK'', ''D_F_SALDO_DUDOSO_TRIMESTRE (TRIMESTRE_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SALDO_DUDOSO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SALDO_DUDOSO_DIA_PK'', ''D_F_SALDO_DUDOSO_DIA (DIA_SALDO_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_ASUNTO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_ASUNTO_ANIO_PK'', ''D_F_CREACION_ASUNTO_ANIO (ANIO_CREACION_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_ASUNTO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_ASUNTO_MES_PK'', ''D_F_CREACION_ASUNTO_MES (MES_CREACION_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CREACION_ASUNTO_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_CREACION_ASUNTO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_ASUNTO_DIA_PK'', ''D_F_CREACION_ASUNTO_DIA (DIA_CREACION_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_PRC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_ANIO_PK'', ''D_F_CREACION_PRC_ANIO (ANIO_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_DIA_SEMANA_PK'', ''D_F_CREACION_PRC_DIA_SEMANA (DIA_SEMANA_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_PRC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_MES_PK'', ''D_F_CREACION_PRC_MES (MES_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_MES_ANIO_PK'', ''D_F_CREACION_PRC_MES_ANIO (MES_ANIO_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CREACION_PRC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_TRIMESTRE_PK'', ''D_F_CREACION_PRC_TRIMESTRE (TRIMESTRE_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_CREACION_PRC_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_PRC_DIA_PK'', ''D_F_CREACION_PRC_DIA (DIA_CREACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_CRE_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_ANIO_PK'', ''D_F_ULT_TAR_CRE_ANIO (ANIO_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_CRE_DIA_SEMANA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_DIA_SEMANA_PK'', ''D_F_ULT_TAR_CRE_DIA_SEMANA (DIA_SEMANA_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_CRE_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_MES_PK'', ''D_F_ULT_TAR_CRE_MES (MES_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_MES_ANIO_PK'', ''D_F_ULT_TAR_CRE_MES_ANIO (MES_ANIO_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ULT_TAR_CRE_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_TRIMESTRE_PK'', ''D_F_ULT_TAR_CRE_TRIMESTRE (TRIMESTRE_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_CRE_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_CRE_DIA_PK'', ''D_F_ULT_TAR_CRE_DIA (DIA_ULT_TAR_CRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_FIN_ANIO'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_ANIO_PK'', ''D_F_ULT_TAR_FIN_ANIO (ANIO_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_DIA_SEMANA_PK'', ''D_F_ULT_TAR_FIN_DIA_SEMANA (DIA_SEMANA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_FIN_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_MES_PK'', ''D_F_ULT_TAR_FIN_MES (MES_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_MES_ANIO_PK'', ''D_F_ULT_TAR_FIN_MES_ANIO (MES_ANIO_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ULT_TAR_FIN_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_TRIMESTRE_PK'', ''D_F_ULT_TAR_FIN_TRIMESTRE (TRIMESTRE_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_FIN_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_FIN_DIA_PK'', ''D_F_ULT_TAR_FIN_DIA (DIA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_ACT_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_ANIO_PK'', ''D_F_ULT_TAR_ACT_ANIO (ANIO_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_DIA_SEMANA_PK'', ''D_F_ULT_TAR_ACT_DIA_SEMANA (DIA_SEMANA_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_ACT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_MES_PK'', ''D_F_ULT_TAR_ACT_MES (MES_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_MES_ANIO_PK'', ''D_F_ULT_TAR_ACT_MES_ANIO (MES_ANIO_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ULT_TAR_ACT_TRIMESTRE ------------------------------
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_ACT_TRIMESTRE'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_TRIMESTRE_PK'', ''D_F_ULT_TAR_ACT_TRIMESTRE (TRIMESTRE_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_ACT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_ACT_DIA_PK'', ''D_F_ULT_TAR_ACT_DIA (DIA_ULT_TAR_ACT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_PEN_ANIO'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_ANIO_PK'', ''D_F_ULT_TAR_PEN_ANIO (ANIO_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_DIA_SEMANA_PK'', ''D_F_ULT_TAR_PEN_DIA_SEMANA (DIA_SEMANA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ULT_TAR_PEN_MES'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_MES_PK'', ''D_F_ULT_TAR_PEN_MES (MES_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_MES_ANIO_PK'', ''D_F_ULT_TAR_PEN_MES_ANIO (MES_ANIO_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ULT_TAR_PEN_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_TRIMESTRE_PK'', ''D_F_ULT_TAR_PEN_TRIMESTRE (TRIMESTRE_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_TAR_PEN_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_TAR_PEN_DIA_PK'', ''D_F_ULT_TAR_PEN_DIA (DIA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_VA_ULT_TAR_PEN_ANIO'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_PEN_ANIO_PK'', ''D_F_VA_ULT_TAR_PEN_ANIO (ANIO_VA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_VA_ULT_TAR_PEN_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_PEN_MES_PK'', ''D_F_VA_ULT_TAR_PEN_MES (MES_VA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_PEN_MES_ANIO_PK'', ''D_F_VA_ULT_TAR_PEN_MES_ANIO (MES_ANIO_VA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_VA_ULT_TAR_PEN_TRIMESTRE ------------------------------
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_VA_ULT_TAR_PEN_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_PEN_DIA_PK'', ''D_F_VA_ULT_TAR_PEN_DIA (DIA_VA_ULT_TAR_PEN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_VA_ULT_TAR_FIN_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_FIN_ANIO_PK'', ''D_F_VA_ULT_TAR_FIN_ANIO (ANIO_VA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_VA_ULT_TAR_FIN_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_FIN_MES_PK'', ''D_F_VA_ULT_TAR_FIN_MES (MES_VA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_FIN_MES_ANIO_PK'', ''D_F_VA_ULT_TAR_FIN_MES_ANIO (MES_ANIO_VA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_VA_ULT_TAR_FIN_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_VA_ULT_TAR_FIN_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_VA_ULT_TAR_FIN_DIA_PK'', ''D_F_VA_ULT_TAR_FIN_DIA (DIA_VA_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COBRO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_ANIO_PK'', ''D_F_COBRO_ANIO (ANIO_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_DIA_SEMANA_PK'', ''D_F_COBRO_DIA_SEMANA (DIA_SEMANA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COBRO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_MES_PK'', ''D_F_COBRO_MES (MES_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_MES_ANIO_PK'', ''D_F_COBRO_MES_ANIO (MES_ANIO_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_COBRO_TRIMESTRE ------------------------------
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_COBRO_TRIMESTRE'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_TRIMESTRE_PK'', ''D_F_COBRO_TRIMESTRE (TRIMESTRE_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COBRO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COBRO_DIA_PK'', ''D_F_COBRO_DIA (DIA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACEPTACION_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_ANIO_PK'', ''D_F_ACEPTACION_ANIO (ANIO_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_DIA_SEMANA_PK'', ''D_F_ACEPTACION_DIA_SEMANA (DIA_SEMANA_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACEPTACION_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_MES_PK'', ''D_F_ACEPTACION_MES (MES_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_MES_ANIO_PK'', ''D_F_ACEPTACION_MES_ANIO (MES_ANIO_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_ACEPTACION_TRIMESTRE'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_TRIMESTRE_PK'', ''D_F_ACEPTACION_TRIMESTRE (TRIMESTRE_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACEPTACION_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACEPTACION_DIA_PK'', ''D_F_ACEPTACION_DIA (DIA_ACEPTACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INTER_DEM_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_ANIO_PK'', ''D_F_INTER_DEM_ANIO (ANIO_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_DIA_SEMANA_PK'', ''D_F_INTER_DEM_DIA_SEMANA (DIA_SEMANA_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INTER_DEM_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_MES_PK'', ''D_F_INTER_DEM_MES (MES_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_MES_ANIO_PK'', ''D_F_INTER_DEM_MES_ANIO (MES_ANIO_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_INTER_DEM_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_TRIMESTRE_PK'', ''D_F_INTER_DEM_TRIMESTRE (TRIMESTRE_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_INTER_DEM_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INTER_DEM_DIA_PK'', ''D_F_INTER_DEM_DIA (DIA_INTER_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DECRETO_FIN_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_ANIO_PK'', ''D_F_DECRETO_FIN_ANIO (ANIO_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_DIA_SEMANA_PK'', ''D_F_DECRETO_FIN_DIA_SEMANA (DIA_SEMANA_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DECRETO_FIN_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_MES_PK'', ''D_F_DECRETO_FIN_MES (MES_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_MES_ANIO_PK'', ''D_F_DECRETO_FIN_MES_ANIO (MES_ANIO_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DECRETO_FIN_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_TRIMESTRE_PK'', ''D_F_DECRETO_FIN_TRIMESTRE (TRIMESTRE_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DECRETO_FIN_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_FIN_DIA_PK'', ''D_F_DECRETO_FIN_DIA (DIA_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RESOL_FIRME_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_ANIO_PK'', ''D_F_RESOL_FIRME_ANIO (ANIO_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_DIA_SEMANA_PK'', ''D_F_RESOL_FIRME_DIA_SEMANA (DIA_SEMANA_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RESOL_FIRME_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_MES_PK'', ''D_F_RESOL_FIRME_MES (MES_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_MES_ANIO_PK'', ''D_F_RESOL_FIRME_MES_ANIO (MES_ANIO_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_RESOL_FIRME_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_TRIMESTRE_PK'', ''D_F_RESOL_FIRME_TRIMESTRE (TRIMESTRE_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_RESOL_FIRME_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RESOL_FIRME_DIA_PK'', ''D_F_RESOL_FIRME_DIA (DIA_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_ANIO_PK'', ''D_F_SUBASTA_ANIO (ANIO_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_DIA_SEMANA_PK'', ''D_F_SUBASTA_DIA_SEMANA (DIA_SEMANA_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUBASTA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_MES_PK'', ''D_F_SUBASTA_MES (MES_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_MES_ANIO_PK'', ''D_F_SUBASTA_MES_ANIO (MES_ANIO_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_SUBASTA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_TRIMESTRE_PK'', ''D_F_SUBASTA_TRIMESTRE (TRIMESTRE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUBASTA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUBASTA_DIA_PK'', ''D_F_SUBASTA_DIA (DIA_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INICIO_APREMIO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_APREMIO_ANIO_PK'', ''D_F_INICIO_APREMIO_ANIO (ANIO_INICIO_APREMIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INICIO_APREMIO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_APREMIO_MES_PK'', ''D_F_INICIO_APREMIO_MES (MES_INICIO_APREMIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_APREMIO_MES_ANIO_PK'', ''D_F_INICIO_APREMIO_MES_ANIO (MES_ANIO_INICIO_APREMIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_INICIO_APREMIO_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_INICIO_APREMIO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_APREMIO_DIA_PK'', ''D_F_INICIO_APREMIO_DIA (DIA_INICIO_APREMIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ESTIMADA_COBRO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ESTIMADA_COBRO_ANIO_PK'', ''D_F_ESTIMADA_COBRO_ANIO (ANIO_ESTIMADA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ESTIMADA_COBRO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ESTIMADA_COBRO_MES_PK'', ''D_F_ESTIMADA_COBRO_MES (MES_ESTIMADA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ESTIMADA_COBRO_MES_ANIO_PK'', ''D_F_ESTIMADA_COBRO_MES_ANIO (MES_ANIO_ESTIMADA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ESTIMADA_COBRO_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_ESTIMADA_COBRO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ESTIMADA_COBRO_DIA_PK'', ''D_F_ESTIMADA_COBRO_DIA (DIA_ESTIMADA_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_EST_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_ANIO_PK'', ''D_F_ULT_EST_ANIO (ANIO_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_DIA_SEMANA_PK'', ''D_F_ULT_EST_DIA_SEMANA (DIA_SEMANA_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_EST_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_MES_PK'', ''D_F_ULT_EST_MES (MES_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_MES_ANIO_PK'', ''D_F_ULT_EST_MES_ANIO (MES_ANIO_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ULT_EST_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_TRIMESTRE_PK'', ''D_F_ULT_EST_TRIMESTRE (TRIMESTRE_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ULT_EST_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_EST_DIA_PK'', ''D_F_ULT_EST_DIA (DIA_ULT_EST_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_LIQUIDACION_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_ANIO_PK'', ''D_F_LIQUIDACION_ANIO (ANIO_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_DIA_SEMANA_PK'', ''D_F_LIQUIDACION_DIA_SEMANA (DIA_SEMANA_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_LIQUIDACION_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_MES_PK'', ''D_F_LIQUIDACION_MES (MES_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_MES_ANIO_PK'', ''D_F_LIQUIDACION_MES_ANIO (MES_ANIO_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_LIQUIDACION_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_TRIMESTRE_PK'', ''D_F_LIQUIDACION_TRIMESTRE (TRIMESTRE_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_LIQUIDACION_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQUIDACION_DIA_PK'', ''D_F_LIQUIDACION_DIA (DIA_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INSI_FINAL_CRED_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INSI_FINAL_CRED_ANIO_PK'', ''D_F_INSI_FINAL_CRED_ANIO (ANIO_INSI_FINAL_CRED_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_INSI_FINAL_CRED_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INSI_FINAL_CRED_MES_PK'', ''D_F_INSI_FINAL_CRED_MES (MES_INSI_FINAL_CRED_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_INSI_FINAL_CRED_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_INSI_FINAL_CRED_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INSI_FINAL_CRED_DIA_PK'', ''D_F_INSI_FINAL_CRED_DIA (DIA_INSI_FINAL_CRED_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_AUTO_APERT_CONV_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_AUTO_APERT_CONV_ANIO_PK'', ''D_F_AUTO_APERT_CONV_ANIO (ANIO_AUTO_APERT_CONV_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_AUTO_APERT_CONV_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_AUTO_APERT_CONV_MES_PK'', ''D_F_AUTO_APERT_CONV_MES (MES_AUTO_APERT_CONV_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_AUTO_APERT_CONV_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_AUTO_APERT_CONV_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_AUTO_APERT_CONV_DIA_PK'', ''D_F_AUTO_APERT_CONV_DIA (DIA_AUTO_APERT_CONV_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_JUNTA_ACREE_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_ANIO_PK'', ''D_F_JUNTA_ACREE_ANIO (ANIO_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_DIA_SEMANA_PK'', ''D_F_JUNTA_ACREE_DIA_SEMANA (DIA_SEMANA_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_JUNTA_ACREE_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_MES_PK'', ''D_F_JUNTA_ACREE_MES (MES_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_MES_ANIO_PK'', ''D_F_JUNTA_ACREE_MES_ANIO (MES_ANIO_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_JUNTA_ACREE_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_TRIMESTRE_PK'', ''D_F_JUNTA_ACREE_TRIMESTRE (TRIMESTRE_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_JUNTA_ACREE_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_JUNTA_ACREE_DIA_PK'', ''D_F_JUNTA_ACREE_DIA (DIA_JUNTA_ACREE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_RESOL_LIQ_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_RESOL_LIQ_ANIO_PK'', ''D_F_REG_RESOL_LIQ_ANIO (ANIO_REG_RESOL_LIQ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_RESOL_LIQ_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_RESOL_LIQ_MES_PK'', ''D_F_REG_RESOL_LIQ_MES (MES_REG_RESOL_LIQ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_RESOL_LIQ_MES_ANIO_PK'', ''D_F_REG_RESOL_LIQ_MES_ANIO (MES_ANIO_REG_RESOL_LIQ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_REG_RESOL_LIQ_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_RESOL_LIQ_TRIMESTRE_PK'', ''D_F_REG_RESOL_LIQ_TRIMESTRE (TRIMESTRE_REG_RESOL_LIQ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_RESOL_LIQ_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_RESOL_LIQ_DIA_PK'', ''D_F_REG_RESOL_LIQ_DIA (DIA_REG_RESOL_LIQ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUB_EJEC_NOT_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_ANIO_PK'', ''D_F_SUB_EJEC_NOT_ANIO (ANIO_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_DIA_SEMANA_PK'', ''D_F_SUB_EJEC_NOT_DIA_SEMANA (DIA_SEMANA_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUB_EJEC_NOT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_MES_PK'', ''D_F_SUB_EJEC_NOT_MES (MES_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_MES_ANIO_PK'', ''D_F_SUB_EJEC_NOT_MES_ANIO (MES_ANIO_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_SUB_EJEC_NOT_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_TRIMESTRE_PK'', ''D_F_SUB_EJEC_NOT_TRIMESTRE (TRIMESTRE_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SUB_EJEC_NOT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SUB_EJEC_NOT_DIA_PK'', ''D_F_SUB_EJEC_NOT_DIA (DIA_SUB_EJEC_NOT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_TAREA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_TAREA_ANIO_PK'', ''D_F_CREACION_TAREA_ANIO (ANIO_CREACION_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREACION_TAREA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_TAREA_MES_PK'', ''D_F_CREACION_TAREA_MES (MES_CREACION_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_TAREA_MES_ANIO_PK'', ''D_F_CREACION_TAREA_MES_ANIO (MES_ANIO_CREACION_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CREACION_TAREA_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_CREACION_TAREA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREACION_TAREA_DIA_PK'', ''D_F_CREACION_TAREA_DIA (DIA_CREACION_TAREA_ID, MES_CREACION_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_FIN_TAREA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_ANIO_PK'', ''D_F_FIN_TAREA_ANIO (ANIO_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_DIA_SEMANA_PK'', ''D_F_FIN_TAREA_DIA_SEMANA (DIA_SEMANA_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_FIN_TAREA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_MES_PK'', ''D_F_FIN_TAREA_MES (MES_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_MES_ANIO_PK'', ''D_F_FIN_TAREA_MES_ANIO (MES_ANIO_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_FIN_TAREA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_TRIMESTRE_PK'', ''D_F_FIN_TAREA_TRIMESTRE (TRIMESTRE_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_FIN_TAREA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_TAREA_DIA_PK'', ''D_F_FIN_TAREA_DIA (DIA_FIN_TAREA_ID, MES_FIN_TAREA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECOG_DOC_ACEPT_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECOG_DOC_ACEPT_ANIO_PK'', ''D_F_RECOG_DOC_ACEPT_ANIO (ANIO_RECOG_DOC_ACEPT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECOG_DOC_ACEPT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECOG_DOC_ACEPT_MES_PK'', ''D_F_RECOG_DOC_ACEPT_MES (MES_RECOG_DOC_ACEPT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_RECOG_DOC_ACEPT_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_RECOG_DOC_ACEPT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECOG_DOC_ACEPT_DIA_PK'', ''D_F_RECOG_DOC_ACEPT_DIA (DIA_RECOG_DOC_ACEPT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_DEC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_ANIO_PK'', ''D_F_REG_DEC_ANIO (ANIO_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_DIA_SEMANA_PK'', ''D_F_REG_DEC_DIA_SEMANA (DIA_SEMANA_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_DEC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_MES_PK'', ''D_F_REG_DEC_MES (MES_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_MES_ANIO_PK'', ''D_F_REG_DEC_MES_ANIO (MES_ANIO_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_REG_DEC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_TRIMESTRE_PK'', ''D_F_REG_DEC_TRIMESTRE (TRIMESTRE_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REG_DEC_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REG_DEC_DIA_PK'', ''D_F_REG_DEC_DIA (DIA_FECHA_REG_DEC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECEP_DOC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_ANIO_PK'', ''D_F_RECEP_DOC_ANIO (ANIO_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_DIA_SEMANA_PK'', ''D_F_RECEP_DOC_DIA_SEMANA (DIA_SEMANA_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECEP_DOC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_MES_PK'', ''D_F_RECEP_DOC_MES (MES_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_MES_ANIO_PK'', ''D_F_RECEP_DOC_MES_ANIO (MES_ANIO_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_RECEP_DOC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_TRIMESTRE_PK'', ''D_F_RECEP_DOC_TRIMESTRE (TRIMESTRE_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECEP_DOC_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_DOC_DIA_PK'', ''D_F_RECEP_DOC_DIA (DIA_FECHA_RECEP_DOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CONT_LIT_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_ANIO_PK'', ''D_F_CONT_LIT_ANIO (ANIO_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_DIA_SEMANA_PK'', ''D_F_CONT_LIT_DIA_SEMANA (DIA_SEMANA_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CONT_LIT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_MES_PK'', ''D_F_CONT_LIT_MES (MES_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_MES_ANIO_PK'', ''D_F_CONT_LIT_MES_ANIO (MES_ANIO_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CONT_LIT_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_TRIMESTRE_PK'', ''D_F_CONT_LIT_TRIMESTRE (TRIMESTRE_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CONT_LIT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONT_LIT_DIA_PK'', ''D_F_CONT_LIT_DIA (DIA_FECHA_CONT_LIT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DPS_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_ANIO_PK'', ''D_F_DPS_ANIO (ANIO_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_DIA_SEMANA_PK'', ''D_F_DPS_DIA_SEMANA (DIA_SEMANA_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DPS_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_MES_PK'', ''D_F_DPS_MES (MES_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_MES_ANIO_PK'', ''D_F_DPS_MES_ANIO (MES_ANIO_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DPS_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_TRIMESTRE_PK'', ''D_F_DPS_TRIMESTRE (TRIMESTRE_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DPS_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DPS_DIA_PK'', ''D_F_DPS_DIA (DIA_DPS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COMP_PAGO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_ANIO_PK'', ''D_F_COMP_PAGO_ANIO (ANIO_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_DIA_SEMANA_PK'', ''D_F_COMP_PAGO_DIA_SEMANA (DIA_SEMANA_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COMP_PAGO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_MES_PK'', ''D_F_COMP_PAGO_MES (MES_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_MES_ANIO_PK'', ''D_F_COMP_PAGO_MES_ANIO (MES_ANIO_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_COMP_PAGO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_TRIMESTRE_PK'', ''D_F_COMP_PAGO_TRIMESTRE (TRIMESTRE_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_COMP_PAGO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_COMP_PAGO_DIA_PK'', ''D_F_COMP_PAGO_DIA (DIA_COMP_PAGO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ALTA_GEST_REC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_GEST_REC_ANIO_PK'', ''D_F_ALTA_GEST_REC_ANIO (ANIO_ALTA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ALTA_GEST_REC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_GEST_REC_MES_PK'', ''D_F_ALTA_GEST_REC_MES (MES_ALTA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_GEST_REC_MES_ANIO_PK'', ''D_F_ALTA_GEST_REC_MES_ANIO (MES_ANIO_ALTA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ALTA_GEST_REC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_GEST_REC_TRIMESTRE_PK'', ''D_F_ALTA_GEST_REC_TRIMESTRE (TRIMESTRE_ALTA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ALTA_GEST_REC_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_GEST_REC_DIA_PK'', ''D_F_ALTA_GEST_REC_DIA (DIA_ALTA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BAJA_GEST_REC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_GEST_REC_ANIO_PK'', ''D_F_BAJA_GEST_REC_ANIO (ANIO_BAJA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BAJA_GEST_REC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_GEST_REC_MES_PK'', ''D_F_BAJA_GEST_REC_MES (MES_BAJA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_GEST_REC_MES_ANIO_PK'', ''D_F_BAJA_GEST_REC_MES_ANIO (MES_ANIO_BAJA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BAJA_GEST_REC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_GEST_REC_TRIMESTRE_PK'', ''D_F_BAJA_GEST_REC_TRIMESTRE (TRIMESTRE_BAJA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BAJA_GEST_REC_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_GEST_REC_DIA_PK'', ''D_F_BAJA_GEST_REC_DIA (DIA_BAJA_GEST_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACT_RECOBRO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_ANIO_PK'', ''D_F_ACT_RECOBRO_ANIO (ANIO_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_DIA_SEMANA_PK'', ''D_F_ACT_RECOBRO_DIA_SEMANA (DIA_SEMANA_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACT_RECOBRO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_MES_PK'', ''D_F_ACT_RECOBRO_MES (MES_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_MES_ANIO_PK'', ''D_F_ACT_RECOBRO_MES_ANIO (MES_ANIO_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ACT_RECOBRO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_TRIMESTRE_PK'', ''D_F_ACT_RECOBRO_TRIMESTRE (TRIMESTRE_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACT_RECOBRO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACT_RECOBRO_DIA_PK'', ''D_F_ACT_RECOBRO_DIA (DIA_ACT_RECOBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PAGO_COMP_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PAGO_COMP_ANIO_PK'', ''D_F_PAGO_COMP_ANIO (ANIO_PAGO_COMP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PAGO_COMP_DIA_SEMANA_PK'', ''D_F_PAGO_COMP_DIA_SEMANA (DIA_SEMANA_PAGO_COMP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PAGO_COMP_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PAGO_COMP_MES_PK'', ''D_F_PAGO_COMP_MES (MES_PAGO_COMP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PAGO_COMP_MES_ANIO_PK'', ''D_F_PAGO_COMP_MES_ANIO (MES_ANIO_PAGO_COMP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PAGO_COMP_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PAGO_COMP_TRIMESTRE_PK'', ''D_F_PAGO_COMP_TRIMESTRE (TRIMESTRE_PAGO_COMP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BAJA_CICLO_REC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_CICLO_REC_MES_PK'', ''D_F_BAJA_CICLO_REC_MES (MES_BAJA_CICLO_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_CICLO_REC_MES_ANIO_PK'', ''D_F_BAJA_CICLO_REC_MES_ANIO (MES_ANIO_BAJA_CICLO_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_CICLO_REC_DIA_PK'', ''D_F_BAJA_CICLO_REC_DIA (DIA_BAJA_CICLO_REC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ALTA_EXP_CR_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_ANIO_PK'', ''D_F_ALTA_EXP_CR_ANIO (ANIO_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_DIA_SEMANA_PK'', ''D_F_ALTA_EXP_CR_DIA_SEMANA (DIA_SEMANA_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_MES_PK'', ''D_F_ALTA_EXP_CR_MES (MES_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_MES_ANIO_PK'', ''D_F_ALTA_EXP_CR_MES_ANIO (MES_ANIO_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_TRIMESTRE_PK'', ''D_F_ALTA_EXP_CR_TRIMESTRE (TRIMESTRE_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_EXP_CR_DIA_PK'', ''D_F_ALTA_EXP_CR_DIA (DIA_ALTA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BAJA_EXP_CR_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_ANIO_PK'', ''D_F_BAJA_EXP_CR_ANIO (ANIO_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_DIA_SEMANA_PK'', ''D_F_BAJA_EXP_CR_DIA_SEMANA (DIA_SEMANA_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_MES_PK'', ''D_F_BAJA_EXP_CR_MES (MES_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_MES_ANIO_PK'', ''D_F_BAJA_EXP_CR_MES_ANIO (MES_ANIO_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_TRIMESTRE_PK'', ''D_F_BAJA_EXP_CR_TRIMESTRE (TRIMESTRE_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_EXP_CR_DIA_PK'', ''D_F_BAJA_EXP_CR_DIA (DIA_BAJA_EXP_CR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_MEJOR_GESTION_ANIO_PK'', ''D_F_MEJOR_GESTION_ANIO (ANIO_MEJOR_GESTION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_MEJOR_GESTION_MES_PK'', ''D_F_MEJOR_GESTION_MES (MES_MEJOR_GESTION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_MEJOR_GESTION_MES_ANIO_PK'', ''D_F_MEJOR_GESTION_MES_ANIO (MES_ANIO_MEJOR_GESTION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_MEJOR_GESTION_TRIMESTRE_PK'', ''D_F_MEJOR_GESTION_TRIMESTRE (TRIMESTRE_MEJOR_GESTION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_MEJOR_GESTION_DIA_PK'', ''D_F_MEJOR_GESTION_DIA (DIA_MEJOR_GESTION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PROPUESTA_ACU_ANIO_PK'', ''D_F_PROPUESTA_ACU_ANIO (ANIO_PROPUESTA_ACU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PROPUESTA_ACU_MES_PK'', ''D_F_PROPUESTA_ACU_MES (MES_PROPUESTA_ACU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
...
------------------------------ D_F_PROPUESTA_ACU_MES_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PROPUESTA_ACU_MES_ANIO_PK'', ''D_F_PROPUESTA_ACU_MES_ANIO (MES_ANIO_PROPUESTA_ACU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PROPUESTA_ACU_TRIMESTRE_PK'', ''D_F_PROPUESTA_ACU_TRIMESTRE (TRIMESTRE_PROPUESTA_ACU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PROPUESTA_ACU_DIA_PK'', ''D_F_PROPUESTA_ACU_DIA (DIA_PROPUESTA_ACU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_ANIO_PK'', ''D_F_INCIDENCIA_ANIO (ANIO_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_DIA_SEMANA_PK'', ''D_F_INCIDENCIA_DIA_SEMANA (DIA_SEMANA_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_MES_PK'', ''D_F_INCIDENCIA_MES (MES_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_MES_ANIO_PK'', ''D_F_INCIDENCIA_MES_ANIO (MES_ANIO_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_TRIMESTRE_PK'', ''D_F_INCIDENCIA_TRIMESTRE (TRIMESTRE_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INCIDENCIA_DIA_PK'', ''D_F_INCIDENCIA_DIA (DIA_INCIDENCIA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CANCELA_ASUNTO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CANCELA_ASUNTO_ANIO_PK'', ''D_F_CANCELA_ASUNTO_ANIO (ANIO_CANCELA_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CANCELA_ASUNTO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CANCELA_ASUNTO_MES_PK'', ''D_F_CANCELA_ASUNTO_MES (MES_CANCELA_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CANCELA_ASUNTO_MES_ANIO_PK'', ''D_F_CANCELA_ASUNTO_MES_ANIO (MES_ANIO_CANCELA_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CANCELA_ASUNTO_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_CANCELA_ASUNTO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CANCELA_ASUNTO_DIA_PK'', ''D_F_CANCELA_ASUNTO_DIA (DIA_CANCELA_ASUNTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREDITO_INSI_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_ANIO_PK'', ''D_F_CREDITO_INSI_ANIO (ANIO_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_DIA_SEMANA_PK'', ''D_F_CREDITO_INSI_DIA_SEMANA (DIA_SEMANA_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREDITO_INSI_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_MES_PK'', ''D_F_CREDITO_INSI_MES (MES_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_MES_ANIO_PK'', ''D_F_CREDITO_INSI_MES_ANIO (MES_ANIO_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CREDITO_INSI_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_TRIMESTRE_PK'', ''D_F_CREDITO_INSI_TRIMESTRE (TRIMESTRE_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CREDITO_INSI_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CREDITO_INSI_DIA_PK'', ''D_F_CREDITO_INSI_DIA (DIA_CREDITO_INSI_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SOLIC_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOLIC_SUBASTA_ANIO_PK'', ''D_F_SOLIC_SUBASTA_ANIO (ANIO_SOLIC_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SOLIC_SUBASTA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOLIC_SUBASTA_MES_PK'', ''D_F_SOLIC_SUBASTA_MES (MES_SOLIC_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOLIC_SUBASTA_MES_ANIO_PK'', ''D_F_SOLIC_SUBASTA_MES_ANIO (MES_ANIO_SOLIC_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_SOLIC_SUBASTA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOLIC_SUBASTA_TRIMESTRE_PK'', ''D_F_SOLIC_SUBASTA_TRIMESTRE (TRIMESTRE_SOLIC_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SOLIC_SUBASTA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOLIC_SUBASTA_DIA_PK'', ''D_F_SOLIC_SUBASTA_DIA (DIA_SOLIC_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CELEB_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CELEB_SUBASTA_ANIO_PK'', ''D_F_CELEB_SUBASTA_ANIO (ANIO_CELEB_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CELEB_SUBASTA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CELEB_SUBASTA_MES_PK'', ''D_F_CELEB_SUBASTA_MES (MES_CELEB_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CELEB_SUBASTA_MES_ANIO_PK'', ''D_F_CELEB_SUBASTA_MES_ANIO (MES_ANIO_CELEB_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_CELEB_SUBASTA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CELEB_SUBASTA_TRIMESTRE_PK'', ''D_F_CELEB_SUBASTA_TRIMESTRE (TRIMESTRE_CELEB_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_CELEB_SUBASTA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CELEB_SUBASTA_DIA_PK'', ''D_F_CELEB_SUBASTA_DIA (DIA_CELEB_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_PARALIZACION_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_ANIO_PK'', ''D_F_PARALIZACION_ANIO (ANIO_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_DIA_SEMANA_PK'', ''D_F_PARALIZACION_DIA_SEMANA (DIA_SEMANA_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PARALIZACION_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_MES_PK'', ''D_F_PARALIZACION_MES (MES_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_MES_ANIO_PK'', ''D_F_PARALIZACION_MES_ANIO (MES_ANIO_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PARALIZACION_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_TRIMESTRE_PK'', ''D_F_PARALIZACION_TRIMESTRE (TRIMESTRE_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_PARALIZACION_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PARALIZACION_DIA_PK'', ''D_F_PARALIZACION_DIA (DIA_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
...
------------------------------ D_F_FINALIZACION_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_ANIO_PK'', ''D_F_FINALIZACION_ANIO (ANIO_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_DIA_SEMANA_PK'', ''D_F_FINALIZACION_DIA_SEMANA (DIA_SEMANA_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_FINALIZACION_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_MES_PK'', ''D_F_FINALIZACION_MES (MES_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_MES_ANIO_PK'', ''D_F_FINALIZACION_MES_ANIO (MES_ANIO_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_FINALIZACION_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_TRIMESTRE_PK'', ''D_F_FINALIZACION_TRIMESTRE (TRIMESTRE_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_FINALIZACION_DIA'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FINALIZACION_DIA_PK'', ''D_F_FINALIZACION_DIA (DIA_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_ANIO_PK'', ''D_F_ACUERDO_ANIO (ANIO_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_DIA_SEMANA_PK'', ''D_F_ACUERDO_DIA_SEMANA (DIA_SEMANA_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACUERDO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_MES_PK'', ''D_F_ACUERDO_MES (MES_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_MES_ANIO_PK'', ''D_F_ACUERDO_MES_ANIO (MES_ANIO_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_ACUERDO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_TRIMESTRE_PK'', ''D_F_ACUERDO_TRIMESTRE (TRIMESTRE_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_ACUERDO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ACUERDO_DIA_PK'', ''D_F_ACUERDO_DIA (DIA_ACUERDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_DECRETO_ADJ_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_ANIO_PK'', ''D_F_DECRETO_ADJ_ANIO (ANIO_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_DIA_SEMANA_PK'', ''D_F_DECRETO_ADJ_DIA_SEMANA (DIA_SEMANA_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DECRETO_ADJ_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_MES_PK'', ''D_F_DECRETO_ADJ_MES (MES_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_MES_ANIO_PK'', ''D_F_DECRETO_ADJ_MES_ANIO (MES_ANIO_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DECRETO_ADJ_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_TRIMESTRE_PK'', ''D_F_DECRETO_ADJ_TRIMESTRE (TRIMESTRE_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DECRETO_ADJ_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DECRETO_ADJ_DIA_PK'', ''D_F_DECRETO_ADJ_DIA (DIA_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_SOL_DECRETO_ADJ_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_DECRETO_ADJ_ANIO_PK'', ''D_F_SOL_DECRETO_ADJ_ANIO (ANIO_SOL_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_SOL_DECRETO_ADJ_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_DECRETO_ADJ_MES_PK'', ''D_F_SOL_DECRETO_ADJ_MES (MES_SOL_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_SOL_DECRETO_ADJ_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_SOL_DECRETO_ADJ_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_DECRETO_ADJ_DIA_PK'', ''D_F_SOL_DECRETO_ADJ_DIA (DIA_SOL_DECRETO_ADJ_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_RECEP_TESTIMO_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_TESTIMO_ANIO_PK'', ''D_F_RECEP_TESTIMO_ANIO (ANIO_RECEP_TESTIMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_RECEP_TESTIMO_MES'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_TESTIMO_MES_PK'', ''D_F_RECEP_TESTIMO_MES (MES_RECEP_TESTIMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_TESTIMO_MES_ANIO_PK'', ''D_F_RECEP_TESTIMO_MES_ANIO (MES_ANIO_RECEP_TESTIMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_RECEP_TESTIMO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_TESTIMO_TRIMESTRE_PK'', ''D_F_RECEP_TESTIMO_TRIMESTRE (TRIMESTRE_RECEP_TESTIMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_RECEP_TESTIMO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_RECEP_TESTIMO_DIA_PK'', ''D_F_RECEP_TESTIMO_DIA (DIA_RECEP_TESTIMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_PUBLICACION_BOE_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PUBLICACION_BOE_ANIO_PK'', ''D_F_PUBLICACION_BOE_ANIO (ANIO_PUBLICACION_BOE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PUBLICACION_BOE_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PUBLICACION_BOE_MES_PK'', ''D_F_PUBLICACION_BOE_MES (MES_PUBLICACION_BOE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PUBLICACION_BOE_TRIMESTRE ------------------------------
   ...
   ------------------------------ D_F_PUBLICACION_BOE_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PUBLICACION_BOE_DIA_PK'', ''D_F_PUBLICACION_BOE_DIA (DIA_PUBLICACION_BOE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
 ...
 ------------------------------ D_F_REGISTRAR_IAC_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REGISTRAR_IAC_ANIO_PK'', ''D_F_REGISTRAR_IAC_ANIO (ANIO_REGISTRAR_IAC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REGISTRAR_IAC_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REGISTRAR_IAC_MES_PK'', ''D_F_REGISTRAR_IAC_MES (MES_REGISTRAR_IAC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REGISTRAR_IAC_MES_ANIO_PK'', ''D_F_REGISTRAR_IAC_MES_ANIO (MES_ANIO_REGISTRAR_IAC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_REGISTRAR_IAC_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REGISTRAR_IAC_TRIMESTRE_PK'', ''D_F_REGISTRAR_IAC_TRIMESTRE (TRIMESTRE_REGISTRAR_IAC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_REGISTRAR_IAC_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_REGISTRAR_IAC_DIA_PK'', ''D_F_REGISTRAR_IAC_DIA (DIA_REGISTRAR_IAC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_ANIO_PK'', ''D_F_PRE_INICIO_ANIO (ANIO_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_INICIO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_TRIMESTRE_PK'', ''D_F_PRE_INICIO_TRIMESTRE (TRIMESTRE_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_F_PRE_INICIO_MES_ANIO'',
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_MES_ANIO_PK'', ''D_F_PRE_INICIO_MES_ANIO (MES_ANIO_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_INICIO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_MES_PK'', ''D_F_PRE_INICIO_MES (MES_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_DIA_SEMANA_PK'', ''D_F_PRE_INICIO_DIA_SEMANA (DIA_SEMANA_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_INICIO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_INICIO_DIA_PK'', ''D_F_PRE_INICIO_DIA (DIA_PRE_INICIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_ANIO_PK'', ''D_F_PRE_ESTUDIO_ANIO (ANIO_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_ESTUDIO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_TRIMESTRE_PK'', ''D_F_PRE_ESTUDIO_TRIMESTRE (TRIMESTRE_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_MES_ANIO_PK'', ''D_F_PRE_ESTUDIO_MES_ANIO (MES_ANIO_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ESTUDIO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_MES_PK'', ''D_F_PRE_ESTUDIO_MES (MES_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_DIA_SEMANA_PK'', ''D_F_PRE_ESTUDIO_DIA_SEMANA (DIA_SEMANA_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ESTUDIO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ESTUDIO_DIA_PK'', ''D_F_PRE_ESTUDIO_DIA (DIA_PRE_ESTUDIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PREPARADO_ANIO_PK'', ''D_F_PRE_PREPARADO_ANIO (ANIO_PRE_PREPARADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_PREPARADO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PREPARADO_TRIMESTRE_PK'', ''D_F_PRE_PREPARADO_TRIMESTRE (TRIMESTRE_PRE_PREPARADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PREPARADO_MES_ANIO_PK'', ''D_F_PRE_PREPARADO_MES_ANIO (MES_ANIO_PRE_PREPARADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_PREPARADO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PREPARADO_MES_PK'', ''D_F_PRE_PREPARADO_MES (MES_PRE_PREPARADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_PREPARADO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PREPARADO_DIA_PK'', ''D_F_PRE_PREPARADO_DIA (DIA_PRE_PREPARADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_ANIO_PK'', ''D_F_PRE_ENV_LET_ANIO (ANIO_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_ENV_LET_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_TRIMESTRE_PK'', ''D_F_PRE_ENV_LET_TRIMESTRE (TRIMESTRE_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_MES_ANIO_PK'', ''D_F_PRE_ENV_LET_MES_ANIO (MES_ANIO_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ENV_LET_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_MES_PK'', ''D_F_PRE_ENV_LET_MES (MES_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_DIA_SEMANA_PK'', ''D_F_PRE_ENV_LET_DIA_SEMANA (DIA_SEMANA_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ENV_LET_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ENV_LET_DIA_PK'', ''D_F_PRE_ENV_LET_DIA (DIA_PRE_ENV_LET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_FINALIZADO_ANIO_PK'', ''D_F_PRE_FINALIZADO_ANIO (ANIO_PRE_FINALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_FINALIZADO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_FINALIZADO_MES_ANIO_PK'', ''D_F_PRE_FINALIZADO_MES_ANIO (MES_ANIO_PRE_FINALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_FINALIZADO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_FINALIZADO_MES_PK'', ''D_F_PRE_FINALIZADO_MES (MES_PRE_FINALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_FINALIZADO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_FINALIZADO_DIA_PK'', ''D_F_PRE_FINALIZADO_DIA (DIA_PRE_FINALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_ANIO_PK'', ''D_F_PRE_ULT_SUBS_ANIO (ANIO_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_ULT_SUBS_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_TRIMESTRE_PK'', ''D_F_PRE_ULT_SUBS_TRIMESTRE (TRIMESTRE_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_MES_ANIO_PK'', ''D_F_PRE_ULT_SUBS_MES_ANIO (MES_ANIO_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ULT_SUBS_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_MES_PK'', ''D_F_PRE_ULT_SUBS_MES (MES_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_DIA_SEMANA_PK'', ''D_F_PRE_ULT_SUBS_DIA_SEMANA (DIA_SEMANA_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_ULT_SUBS_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_ULT_SUBS_DIA_PK'', ''D_F_PRE_ULT_SUBS_DIA (DIA_PRE_ULT_SUBS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_CANCELADO_ANIO_PK'', ''D_F_PRE_CANCELADO_ANIO (ANIO_PRE_CANCELADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_CANCELADO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_CANCELADO_TRIMESTRE_PK'', ''D_F_PRE_CANCELADO_TRIMESTRE (TRIMESTRE_PRE_CANCELADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_CANCELADO_MES_ANIO_PK'', ''D_F_PRE_CANCELADO_MES_ANIO (MES_ANIO_PRE_CANCELADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_FINALIZADO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_CANCELADO_MES_PK'', ''D_F_PRE_CANCELADO_MES (MES_PRE_CANCELADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_CANCELADO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_CANCELADO_DIA_PK'', ''D_F_PRE_CANCELADO_DIA (DIA_PRE_CANCELADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PARALIZADO_ANIO_PK'', ''D_F_PRE_PARALIZADO_ANIO (ANIO_PRE_PARALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_PRE_PARALIZADO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PARALIZADO_MES_ANIO_PK'', ''D_F_PRE_PARALIZADO_MES_ANIO (MES_ANIO_PRE_PARALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_PARALIZADO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PARALIZADO_MES_PK'', ''D_F_PRE_PARALIZADO_MES (MES_PRE_PARALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_PRE_PARALIZADO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PRE_PARALIZADO_DIA_PK'', ''D_F_PRE_PARALIZADO_DIA (DIA_PRE_PARALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_SOLICITUD_ANIO_PK'', ''D_F_BURO_SOLICITUD_ANIO (ANIO_BURO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BURO_SOLICITUD_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_SOLICITUD_MES_ANIO_PK'', ''D_F_BURO_SOLICITUD_MES_ANIO (MES_ANIO_BURO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_SOLICITUD_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_SOLICITUD_MES_PK'', ''D_F_BURO_SOLICITUD_MES (MES_BURO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_SOLICITUD_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_SOLICITUD_DIA_PK'', ''D_F_BURO_SOLICITUD_DIA (DIA_BURO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_ANIO_PK'', ''D_F_BURO_ENVIO_ANIO (ANIO_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BURO_ENVIO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_TRIMESTRE_PK'', ''D_F_BURO_ENVIO_TRIMESTRE (TRIMESTRE_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_MES_ANIO_PK'', ''D_F_BURO_ENVIO_MES_ANIO (MES_ANIO_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_ENVIO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_MES_PK'', ''D_F_BURO_ENVIO_MES (MES_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_DIA_SEMANA_PK'', ''D_F_BURO_ENVIO_DIA_SEMANA (DIA_SEMANA_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_ENVIO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ENVIO_DIA_PK'', ''D_F_BURO_ENVIO_DIA (DIA_BURO_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_ANIO_PK'', ''D_F_BURO_ACUSE_ANIO (ANIO_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_BURO_ACUSE_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_TRIMESTRE_PK'', ''D_F_BURO_ACUSE_TRIMESTRE (TRIMESTRE_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_MES_ANIO_PK'', ''D_F_BURO_ACUSE_MES_ANIO (MES_ANIO_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_ACUSE_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_MES_PK'', ''D_F_BURO_ACUSE_MES (MES_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_DIA_SEMANA_PK'', ''D_F_BURO_ACUSE_DIA_SEMANA (DIA_SEMANA_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_ACUSE_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BURO_ACUSE_DIA_PK'', ''D_F_BURO_ACUSE_DIA (DIA_BURO_ACUSE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_SOLICITUD_ANIO_PK'', ''D_F_DOC_SOLICITUD_ANIO (ANIO_DOC_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DOC_SOLICITUD_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_SOLICITUD_TRIMESTRE_PK'', ''D_F_DOC_SOLICITUD_TRIMESTRE (TRIMESTRE_DOC_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_SOLICITUD_MES_ANIO_PK'', ''D_F_DOC_SOLICITUD_MES_ANIO (MES_ANIO_DOC_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_SOLICITUD_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_SOLICITUD_MES_PK'', ''D_F_DOC_SOLICITUD_MES (MES_DOC_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_SOLICITUD_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_SOLICITUD_DIA_PK'', ''D_F_DOC_SOLICITUD_DIA (DIA_DOC_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_ANIO_PK'', ''D_F_DOC_ENVIO_ANIO (ANIO_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DOC_ENVIO_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_TRIMESTRE_PK'', ''D_F_DOC_ENVIO_TRIMESTRE (TRIMESTRE_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_MES_ANIO_PK'', ''D_F_DOC_ENVIO_MES_ANIO (MES_ANIO_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_BURO_ENVIO_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_MES_PK'', ''D_F_DOC_ENVIO_MES (MES_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_DIA_SEMANA_PK'', ''D_F_DOC_ENVIO_DIA_SEMANA (DIA_SEMANA_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_ENVIO_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_ENVIO_DIA_PK'', ''D_F_DOC_ENVIO_DIA (DIA_DOC_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_ANIO_PK'', ''D_F_DOC_RESULT_ANIO (ANIO_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DOC_RESULT_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_TRIMESTRE_PK'', ''D_F_DOC_RESULT_TRIMESTRE (TRIMESTRE_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_MES_ANIO_PK'', ''D_F_DOC_RESULT_MES_ANIO (MES_ANIO_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_RESULT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_MES_PK'', ''D_F_DOC_RESULT_MES (MES_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_DIA_SEMANA_PK'', ''D_F_DOC_RESULT_DIA_SEMANA (DIA_SEMANA_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_RESULT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RESULT_DIA_PK'', ''D_F_DOC_RESULT_DIA (DIA_DOC_RESULT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_ANIO_PK'', ''D_F_DOC_RECEP_ANIO (ANIO_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_DOC_RECEP_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_TRIMESTRE_PK'', ''D_F_DOC_RECEP_TRIMESTRE (TRIMESTRE_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_MES_ANIO_PK'', ''D_F_DOC_RECEP_MES_ANIO (MES_ANIO_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_RECEP_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_MES_PK'', ''D_F_DOC_RECEP_MES (MES_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_DIA_SEMANA_PK'', ''D_F_DOC_RECEP_DIA_SEMANA (DIA_SEMANA_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   ------------------------------ D_F_DOC_RECEP_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_DOC_RECEP_DIA_PK'', ''D_F_DOC_RECEP_DIA (DIA_DOC_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_SOLICITUD_ANIO_PK'', ''D_F_LIQ_SOLICITUD_ANIO (ANIO_LIQ_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
  ...
  ------------------------------ D_F_LIQ_SOLICITUD_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_SOLICITUD_TRIMESTRE_PK'', ''D_F_LIQ_SOLICITUD_TRIMESTRE (TRIMESTRE_LIQ_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_SOLICITUD_MES_ANIO_PK'', ''D_F_LIQ_SOLICITUD_MES_ANIO (MES_ANIO_LIQ_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
   ...
   ------------------------------ D_F_LIQ_SOLICITUD_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_SOLICITUD_MES_PK'', ''D_F_LIQ_SOLICITUD_MES (MES_LIQ_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
   ...
   ------------------------------ D_F_LIQ_SOLICITUD_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_SOLICITUD_DIA_PK'', ''D_F_LIQ_SOLICITUD_DIA (DIA_LIQ_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_ANIO_PK'', ''D_F_LIQ_RECEP_ANIO (ANIO_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
  ...
  ------------------------------ D_F_LIQ_RECEP_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_TRIMESTRE_PK'', ''D_F_LIQ_RECEP_TRIMESTRE (TRIMESTRE_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_MES_ANIO_PK'', ''D_F_LIQ_RECEP_MES_ANIO (MES_ANIO_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
   ...
   ------------------------------ D_F_LIQ_RECEP_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_MES_PK'', ''D_F_LIQ_RECEP_MES (MES_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_DIA_SEMANA_PK'', ''D_F_LIQ_RECEP_DIA_SEMANA (DIA_SEMANA_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_LIQ_RECEP_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_RECEP_DIA_PK'', ''D_F_LIQ_RECEP_DIA (DIA_LIQ_RECEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_ANIO_PK'', ''D_F_LIQ_CONFIRM_ANIO (ANIO_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
  ...
  ------------------------------ D_F_LIQ_CONFIRM_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_TRIMESTRE_PK'', ''D_F_LIQ_CONFIRM_TRIMESTRE (TRIMESTRE_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_MES_ANIO_PK'', ''D_F_LIQ_CONFIRM_MES_ANIO (MES_ANIO_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_LIQ_CONFIRM_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_MES_PK'', ''D_F_LIQ_CONFIRM_MES (MES_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_DIA_SEMANA_PK'', ''D_F_LIQ_CONFIRM_DIA_SEMANA (DIA_SEMANA_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_LIQ_CONFIRM_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CONFIRM_DIA_PK'', ''D_F_LIQ_CONFIRM_DIA (DIA_LIQ_CONFIRM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_ANIO_PK'', ''D_F_LIQ_CIERRE_ANIO (ANIO_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
  ...
  ------------------------------ D_F_LIQ_CIERRE_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_TRIMESTRE_PK'', ''D_F_LIQ_CIERRE_TRIMESTRE (TRIMESTRE_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_MES_ANIO_PK'', ''D_F_LIQ_CIERRE_MES_ANIO (MES_ANIO_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_LIQ_CIERRE_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_MES_PK'', ''D_F_LIQ_CIERRE_MES (MES_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_DIA_SEMANA_PK'', ''D_F_LIQ_CIERRE_DIA_SEMANA (DIA_SEMANA_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_LIQ_CIERRE_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LIQ_CIERRE_DIA_PK'', ''D_F_LIQ_CIERRE_DIA (DIA_LIQ_CIERRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONCESION_CNT_ANIO_PK'', ''D_F_CONCESION_CNT_ANIO (ANIO_CONCESION_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
  ...
  ------------------------------ D_F_CONCESION_CNT_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONCESION_CNT_TRIMESTRE_PK'', ''D_F_CONCESION_CNT_TRIMESTRE (TRIMESTRE_CONCESION_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONCESION_CNT_MES_ANIO_PK'', ''D_F_CONCESION_CNT_MES_ANIO (MES_ANIO_CONCESION_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_CONCESION_CNT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONCESION_CNT_MES_PK'', ''D_F_CONCESION_CNT_MES (MES_CONCESION_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
   ...
   ------------------------------ D_F_CONCESION_CNT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONCESION_CNT_DIA_PK'', ''D_F_CONCESION_CNT_DIA (DIA_CONCESION_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_ANIO_PK'', ''D_F_CONSTI_CNT_ANIO (ANIO_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
  ...
  ------------------------------ D_F_CONSTI_CNT_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_TRIMESTRE_PK'', ''D_F_CONSTI_CNT_TRIMESTRE (TRIMESTRE_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;		
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_MES_ANIO_PK'', ''D_F_CONSTI_CNT_MES_ANIO (MES_ANIO_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------ D_F_CONSTI_CNT_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_MES_PK'', ''D_F_CONSTI_CNT_MES (MES_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_DIA_SEMANA_PK'', ''D_F_CONSTI_CNT_DIA_SEMANA (DIA_SEMANA_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------ D_F_CONSTI_CNT_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CONSTI_CNT_DIA_PK'', ''D_F_CONSTI_CNT_DIA (DIA_CONSTI_CNT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------  D_F_SOL_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_ANIO_PK'', ''D_F_SOL_SUBASTA_ANIO (ANIO_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_DIA_SEMANA_PK'', ''D_F_SOL_SUBASTA_DIA_SEMANA (DIA_SEMANA_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_SUBASTA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_DIA_PK'', ''D_F_SOL_SUBASTA_DIA (DIA_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_SUBASTA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_MES_PK'', ''D_F_SOL_SUBASTA_MES (MES_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_SUBASTA_MES_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_MES_ANIO_PK'', ''D_F_SOL_SUBASTA_MES_ANIO (MES_ANIO_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_SOL_SUBASTA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_SUBASTA_TRIMESTRE_PK'', ''D_F_SOL_SUBASTA_TRIMESTRE (TRIMESTRE_SOL_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------  D_F_ANUN_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_ANIO_PK'', ''D_F_ANUN_SUBASTA_ANIO (ANIO_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_DIA_SEMANA_PK'', ''D_F_ANUN_SUBASTA_DIA_SEMANA (DIA_SEMANA_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ANUN_SUBASTA_DIA ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_DIA_PK'', ''D_F_ANUN_SUBASTA_DIA (DIA_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ANUN_SUBASTA_MES ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_MES_PK'', ''D_F_ANUN_SUBASTA_MES (MES_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ANUN_SUBASTA_MES_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_MES_ANIO_PK'', ''D_F_ANUN_SUBASTA_MES_ANIO (MES_ANIO_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_ANUN_SUBASTA_TRIMESTRE ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANUN_SUBASTA_TRIMESTRE_PK'', ''D_F_ANUN_SUBASTA_TRIMESTRE (TRIMESTRE_ANUN_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------  D_F_SE_SUBASTA_ANIO ------------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_ANIO_PK'', ''D_F_SE_SUBASTA_ANIO (ANIO_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_DIA_SEMANA_PK'', ''D_F_SE_SUBASTA_DIA_SEMANA (DIA_SEMANA_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SE_SUBASTA_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_DIA_PK'', ''D_F_SE_SUBASTA_DIA (DIA_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SE_SUBASTA_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_MES_PK'', ''D_F_SE_SUBASTA_MES (MES_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SUBASTA_MES_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_MES_ANIO_PK'', ''D_F_SE_SUBASTA_MES_ANIO (MES_ANIO_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_SE_SUBASTA_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SE_SUBASTA_TRIMESTRE_PK'', ''D_F_SE_SUBASTA_TRIMESTRE (TRIMESTRE_SE_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------  D_F_SOL_ART5_BIS_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_ANIO_PK'', ''D_F_SOL_ART5_BIS_ANIO (ANIO_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_DIA_SEMANA_PK'', ''D_F_SOL_ART5_BIS_DIA_SEMANA (DIA_SEMANA_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_ART5_BIS_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_DIA_PK'', ''D_F_SOL_ART5_BIS_DIA (DIA_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_ART5_BIS_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_MES_PK'', ''D_F_SOL_ART5_BIS_MES (MES_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_SOL_ART5_BIS_MES_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_MES_ANIO_PK'', ''D_F_SOL_ART5_BIS_MES_ANIO (MES_ANIO_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_SOL_ART5_BIS_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_SOL_ART5_BIS_TRIMESTRE_PK'', ''D_F_SOL_ART5_BIS_TRIMESTRE (TRIMESTRE_SOL_ART5_BIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------  D_F_PREP_DEC_PROP_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PREP_DEC_PROP_ANIO_PK'', ''D_F_PREP_DEC_PROP_ANIO (ANIO_PREP_DEC_PROP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_PREP_DEC_PROP_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PREP_DEC_PROP_DIA_PK'', ''D_F_PREP_DEC_PROP_DIA (DIA_PREP_DEC_PROP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_PREP_DEC_PROP_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PREP_DEC_PROP_MES_PK'', ''D_F_PREP_DEC_PROP_MES (MES_PREP_DEC_PROP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_PREP_DEC_PROP_MES_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PREP_DEC_PROP_MES_ANIO_PK'', ''D_F_PREP_DEC_PROP_MES_ANIO (MES_ANIO_PREP_DEC_PROP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_PREP_DEC_PROP_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_PREP_DEC_PROP_TRIMESTRE_PK'', ''D_F_PREP_DEC_PROP_TRIMESTRE (TRIMESTRE_PREP_DEC_PROP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_PROPUESTA_ANIO_PK'', ''D_F_ULT_PROPUESTA_ANIO (ANIO_ULT_PROPUESTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ULT_PROPUESTA_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_PROPUESTA_DIA_PK'', ''D_F_ULT_PROPUESTA_DIA (DIA_ULT_PROPUESTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ULT_PROPUESTA_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_PROPUESTA_MES_PK'', ''D_F_ULT_PROPUESTA_MES (MES_ULT_PROPUESTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
...
------------------------------ D_F_ULT_PROPUESTA_MES_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_PROPUESTA_MES_ANIO_PK'', ''D_F_ULT_PROPUESTA_MES_ANIO (MES_ANIO_ULT_PROPUESTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------ D_F_ULT_PROPUESTA_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ULT_PROPUESTA_TRIMESTRE_PK'', ''D_F_ULT_PROPUESTA_TRIMESTRE (TRIMESTRE_ULT_PROPUESTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_CAMBIO_TRAMO_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_ANIO_PK'', ''D_F_CAMBIO_TRAMO_ANIO (ANIO_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_CAMBIO_TRAMO_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_TRIMESTRE_PK'', ''D_F_CAMBIO_TRAMO_TRIMESTRE (TRIMESTRE_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_MES_ANIO_PK'', ''D_F_CAMBIO_TRAMO_MES_ANIO (MES_ANIO_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_CAMBIO_TRAMO_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_MES_PK'', ''D_F_CAMBIO_TRAMO_MES (MES_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_DIA_SEMANA_PK'', ''D_F_CAMBIO_TRAMO_DIA_SEMANA (DIA_SEMANA_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_CAMBIO_TRAMO_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_CAMBIO_TRAMO_DIA_PK'', ''D_F_CAMBIO_TRAMO_DIA (DIA_CAMBIO_TRAMO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_BAJA_DUDOSO_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_ANIO_PK'', ''D_F_BAJA_DUDOSO_ANIO (ANIO_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_BAJA_DUDOSO_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_TRIMESTRE_PK'', ''D_F_BAJA_DUDOSO_TRIMESTRE (TRIMESTRE_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_MES_ANIO_PK'', ''D_F_BAJA_DUDOSO_MES_ANIO (MES_ANIO_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_BAJA_DUDOSO_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_MES_PK'', ''D_F_BAJA_DUDOSO_MES (MES_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_DIA_SEMANA_PK'', ''D_F_BAJA_DUDOSO_DIA_SEMANA (DIA_SEMANA_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_BAJA_DUDOSO_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_BAJA_DUDOSO_DIA_PK'', ''D_F_BAJA_DUDOSO_DIA (DIA_BAJA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_ANIO_PK'', ''D_F_ALTA_DUDOSO_ANIO (ANIO_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_ALTA_DUDOSO_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_TRIMESTRE_PK'', ''D_F_ALTA_DUDOSO_TRIMESTRE (TRIMESTRE_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_MES_ANIO_PK'', ''D_F_ALTA_DUDOSO_MES_ANIO (MES_ANIO_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_ALTA_DUDOSO_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_MES_PK'', ''D_F_ALTA_DUDOSO_MES (MES_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_DIA_SEMANA_PK'', ''D_F_ALTA_DUDOSO_DIA_SEMANA (DIA_SEMANA_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_ALTA_DUDOSO_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ALTA_DUDOSO_DIA_PK'', ''D_F_ALTA_DUDOSO_DIA (DIA_ALTA_DUDOSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_CE_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_ANIO_PK'', ''D_F_INICIO_CE_ANIO (ANIO_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_CE_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_TRIMESTRE_PK'', ''D_F_INICIO_CE_TRIMESTRE (TRIMESTRE_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_MES_ANIO_PK'', ''D_F_INICIO_CE_MES_ANIO (MES_ANIO_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_CE_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_MES_PK'', ''D_F_INICIO_CE_MES (MES_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_DIA_SEMANA_PK'', ''D_F_INICIO_CE_DIA_SEMANA (DIA_SEMANA_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_CE_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_CE_DIA_PK'', ''D_F_INICIO_CE_DIA (DIA_INICIO_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_RE_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_ANIO_PK'', ''D_F_INICIO_RE_ANIO (ANIO_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_RE_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_TRIMESTRE_PK'', ''D_F_INICIO_RE_TRIMESTRE (TRIMESTRE_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_MES_ANIO_PK'', ''D_F_INICIO_RE_MES_ANIO (MES_ANIO_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_RE_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_MES_PK'', ''D_F_INICIO_RE_MES (MES_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_DIA_SEMANA_PK'', ''D_F_INICIO_RE_DIA_SEMANA (DIA_SEMANA_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_RE_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_RE_DIA_PK'', ''D_F_INICIO_RE_DIA (DIA_INICIO_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_ANIO_PK'', ''D_F_INICIO_DC_ANIO (ANIO_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_DC_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_TRIMESTRE_PK'', ''D_F_INICIO_DC_TRIMESTRE (TRIMESTRE_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_MES_ANIO_PK'', ''D_F_INICIO_DC_MES_ANIO (MES_ANIO_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_DC_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_MES_PK'', ''D_F_INICIO_DC_MES (MES_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_DIA_SEMANA_PK'', ''D_F_INICIO_DC_DIA_SEMANA (DIA_SEMANA_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_DC_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_DC_DIA_PK'', ''D_F_INICIO_DC_DIA (DIA_INICIO_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_ANIO_PK'', ''D_F_INICIO_FP_ANIO (ANIO_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_INICIO_FP_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_TRIMESTRE_PK'', ''D_F_INICIO_FP_TRIMESTRE (TRIMESTRE_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_MES_ANIO_PK'', ''D_F_INICIO_FP_MES_ANIO (MES_ANIO_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_FP_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_MES_PK'', ''D_F_INICIO_FP_MES (MES_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_DIA_SEMANA_PK'', ''D_F_INICIO_FP_DIA_SEMANA (DIA_SEMANA_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_INICIO_FP_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_INICIO_FP_DIA_PK'', ''D_F_INICIO_FP_DIA (DIA_INICIO_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_CE_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_ANIO_PK'', ''D_F_FIN_CE_ANIO (ANIO_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_FIN_CE_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_TRIMESTRE_PK'', ''D_F_FIN_CE_TRIMESTRE (TRIMESTRE_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_MES_ANIO_PK'', ''D_F_FIN_CE_MES_ANIO (MES_ANIO_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_CE_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_MES_PK'', ''D_F_FIN_CE_MES (MES_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_DIA_SEMANA_PK'', ''D_F_FIN_CE_DIA_SEMANA (DIA_SEMANA_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_CE_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_CE_DIA_PK'', ''D_F_FIN_CE_DIA (DIA_FIN_CE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_FIN_RE_ANIO ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_ANIO_PK'', ''D_F_FIN_RE_ANIO (ANIO_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_FIN_RE_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_TRIMESTRE_PK'', ''D_F_FIN_RE_TRIMESTRE (TRIMESTRE_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_MES_ANIO_PK'', ''D_F_FIN_RE_MES_ANIO (MES_ANIO_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_RE_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_MES_PK'', ''D_F_FIN_RE_MES (MES_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_DIA_SEMANA_PK'', ''D_F_FIN_RE_DIA_SEMANA (DIA_SEMANA_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_RE_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_RE_DIA_PK'', ''D_F_FIN_RE_DIA (DIA_FIN_RE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_ANIO_PK'', ''D_F_FIN_DC_ANIO (ANIO_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_FIN_DC_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_TRIMESTRE_PK'', ''D_F_FIN_DC_TRIMESTRE (TRIMESTRE_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_MES_ANIO_PK'', ''D_F_FIN_DC_MES_ANIO (MES_ANIO_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_DC_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_MES_PK'', ''D_F_FIN_DC_MES (MES_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_DIA_SEMANA_PK'', ''D_F_FIN_DC_DIA_SEMANA (DIA_SEMANA_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_DC_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_DC_DIA_PK'', ''D_F_FIN_DC_DIA (DIA_FIN_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_ANIO_PK'', ''D_F_FIN_FP_ANIO (ANIO_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_FIN_FP_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_TRIMESTRE_PK'', ''D_F_FIN_FP_TRIMESTRE (TRIMESTRE_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_MES_ANIO_PK'', ''D_F_FIN_FP_MES_ANIO (MES_ANIO_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_FP_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_MES_PK'', ''D_F_FIN_FP_MES (MES_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_DIA_SEMANA_PK'', ''D_F_FIN_FP_DIA_SEMANA (DIA_SEMANA_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_FIN_FP_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_FIN_FP_DIA_PK'', ''D_F_FIN_FP_DIA (DIA_FIN_FP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_ANIO_PK'', ''D_F_ANOTA_PER_ANIO (ANIO_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_ANOTA_PER_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_TRIMESTRE_PK'', ''D_F_ANOTA_PER_TRIMESTRE (TRIMESTRE_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_MES_ANIO_PK'', ''D_F_ANOTA_PER_MES_ANIO (MES_ANIO_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_ANOTA_PER_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_MES_PK'', ''D_F_ANOTA_PER_MES (MES_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_DIA_SEMANA_PK'', ''D_F_ANOTA_PER_DIA_SEMANA (DIA_SEMANA_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_ANOTA_PER_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_ANOTA_PER_DIA_PK'', ''D_F_ANOTA_PER_DIA (DIA_ANOTA_PER_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_ANIO_PK'', ''D_F_LLAMADA_ANIO (ANIO_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
  ...
  ------------------------------D_F_LLAMADA_TRIMESTRE ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_TRIMESTRE_PK'', ''D_F_LLAMADA_TRIMESTRE (TRIMESTRE_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_MES_ANIO_PK'', ''D_F_LLAMADA_MES_ANIO (MES_ANIO_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_LLAMADA_MES ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_MES_PK'', ''D_F_LLAMADA_MES (MES_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_DIA_SEMANA_PK'', ''D_F_LLAMADA_DIA_SEMANA (DIA_SEMANA_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
   ...
   ------------------------------D_F_LLAMADA_DIA ------------------------------
	...
	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_F_LLAMADA_DIA_PK'', ''D_F_LLAMADA_DIA (DIA_LLAMADA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;			
