...
declare
  ...
  begin
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_JUZGADO_PK'', ''D_PRC_JUZGADO (JUZGADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_PRC_PLAZA'', 
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PLAZA_PK'', ''D_PRC_PLAZA (PLAZA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_RECLAMACION_PK'', ''D_PRC_TIPO_RECLAMACION (TIPO_RECLAMACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PROCEDIMIENT_AGR_PK'', ''D_PRC_TIPO_PROCEDIMIENTO_AGR (TIPO_PROCEDIMIENTO_AGR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PROCEDIMIENTO_PK'', ''D_PRC_TIPO_PROCEDIMIENTO (TIPO_PROCEDIMIENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PROCEDIMIENT_DET_PK'', ''D_PRC_TIPO_PROCEDIMIENTO_DET (TIPO_PROCEDIMIENTO_DET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_ACTUAL_AGR_PK'', ''D_PRC_FASE_ACTUAL_AGR (FASE_ACTUAL_AGR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_ACTUAL_PK'', ''D_PRC_FASE_ACTUAL (FASE_ACTUAL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_ACTUAL_DETALLE_PK'', ''D_PRC_FASE_ACTUAL_DETALLE (FASE_ACTUAL_DETALLE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_ANTERIOR_PK'', ''D_PRC_FASE_ANTERIOR (FASE_ANTERIOR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_ANTERIOR_DETALLE_PK'', ''D_PRC_FASE_ANTERIOR_DETALLE (FASE_ANTERIOR_DETALLE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_PRC_ESTADO_PROCEDIMIENTO'', 
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_PROCEDIMIENTO_PK'', ''D_PRC_ESTADO_PROCEDIMIENTO (ESTADO_PROCEDIMIENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_FASE_ACTUAL_PK'', ''D_PRC_ESTADO_FASE_ACTUAL (ESTADO_FASE_ACTUAL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_FASE_ANTERIOR_PK'', ''D_PRC_ESTADO_FASE_ANTERIOR (ESTADO_FASE_ANTERIOR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_CREADA_TIPO_PK'', ''D_PRC_ULT_TAR_CREADA_TIPO (ULT_TAR_CREADA_TIPO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_CREA_TIPO_DET_PK'', ''D_PRC_ULT_TAR_CREADA_TIPO_DET (ULT_TAR_CREADA_TIPO_DET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_CREADA_DESC_PK'', ''D_PRC_ULT_TAR_CREADA_DESC (ULT_TAR_CREADA_DESC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_FIN_TIPO_PK'', ''D_PRC_ULT_TAR_FIN_TIPO (ULT_TAR_FIN_TIPO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_FIN_TIPO_DET_PK'', ''D_PRC_ULT_TAR_FIN_TIPO_DET (ULT_TAR_FIN_TIPO_DET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_FIN_DESC_PK'', ''D_PRC_ULT_TAR_FIN_DESC (ULT_TAR_FIN_DESC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_ACT_TIPO_PK'', ''D_PRC_ULT_TAR_ACT_TIPO (ULT_TAR_ACT_TIPO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_ACT_TIPO_DET_PK'', ''D_PRC_ULT_TAR_ACT_TIPO_DET (ULT_TAR_ACT_TIPO_DET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_ACT_DESC_PK'', ''D_PRC_ULT_TAR_ACT_DESC (ULT_TAR_ACT_DESC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_PEND_TIPO_PK'', ''D_PRC_ULT_TAR_PEND_TIPO (ULT_TAR_PEND_TIPO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_PEND_TIPO_DET_PK'', ''D_PRC_ULT_TAR_PEND_TIPO_DET (ULT_TAR_PEND_TIPO_DET_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_PEND_DESC_PK'', ''D_PRC_ULT_TAR_PEND_DESC (ULT_TAR_PEND_DESC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_DESPACHO_GESTOR_PK'', ''D_PRC_DESPACHO_GESTOR (DESPACHO_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_DESP_GESTOR_PK'', ''D_PRC_TIPO_DESP_GESTOR (TIPO_DESP_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_GESTOR_PK'', ''D_PRC_GESTOR (GESTOR_PRC_ID,DESPACHO_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_GESTOR_PRECONTENCIOSO_PK'', ''D_PRC_GESTOR_PRECONTENCIOSO (GESTOR_PRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_GESTOR_EN_RECOVERY_PK'', ''D_PRC_GESTOR_EN_RECOVERY (GESTOR_EN_RECOVERY_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ENTIDAD_GESTOR_PK'', ''D_PRC_ENTIDAD_GESTOR (ENTIDAD_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_NIVEL_DESP_GESTOR_PK'', ''D_PRC_NIVEL_DESP_GESTOR (NIVEL_DESP_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_OFI_DESP_GESTOR_PK'', ''D_PRC_OFI_DESP_GESTOR (OFI_DESP_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PROV_DESP_GESTOR_PK'', ''D_PRC_PROV_DESP_GESTOR (PROV_DESP_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_DESP_GESTOR_PK'', ''D_PRC_ZONA_DESP_GESTOR (ZONA_DESP_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_DESPACHO_SUPERVISOR_PK'', ''D_PRC_DESPACHO_SUPERVISOR (DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_DESPACHO_SUPERVI_PK'', ''D_PRC_TIPO_DESPACHO_SUPERVISOR (TIPO_DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_SUPERVISOR_PK'', ''D_PRC_SUPERVISOR (SUPERVISOR_PRC_ID,DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ENTIDAD_SUPERVISOR_PK'', ''D_PRC_ENTIDAD_SUPERVISOR (ENTIDAD_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_NIVEL_DESP_SUPERVISOR_PK'', ''D_PRC_NIVEL_DESP_SUPERVISOR (NIVEL_DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_OFI_DESP_SUPERVISOR_PK'', ''D_PRC_OFI_DESP_SUPERVISOR (OFICINA_DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PROV_DESP_SUPERVISOR_PK'', ''D_PRC_PROV_DESP_SUPERVISOR (PROV_DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_DESP_SUPERVISOR_PK'', ''D_PRC_ZONA_DESP_SUPERVISOR (ZONA_DESP_SUPER_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_PEND_CUMPL_PK'', ''D_PRC_ULT_TAR_PEND_CUMPL (CUMPLIMIENTO_ULT_TAR_PEND_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_FIN_CUMPL_PK'', ''D_PRC_ULT_TAR_FIN_CUMPL (CUMPLIMIENTO_ULT_TAR_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_CNT_GARANTIA_REAL_ASO_PK'', ''D_PRC_CNT_GARANTIA_REAL_ASOC (CNT_GARANTIA_REAL_ASOC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_COBRO_TIPO_DET_PK'', ''D_PRC_COBRO_TIPO_DET (TIPO_COBRO_DETALLE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_COBRO_TIPO_PK'', ''D_PRC_COBRO_TIPO (TIPO_COBRO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ACT_ESTIMACIONES_PK'', ''D_PRC_ACT_ESTIMACIONES (ACT_ESTIMACIONES_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_CARTERA_PK'', ''D_PRC_CARTERA (CARTERA_PROCEDIMIENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TITULAR_PK'', ''D_PRC_TITULAR (TITULAR_PROCEDIMIENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_0_PK'', ''D_PRC_ZONA_NIVEL_0 (ZONA_NIVEL_0_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
	...
	execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_1_PK'', ''D_PRC_ZONA_NIVEL_1 (ZONA_NIVEL_1_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_2_PK'', ''D_PRC_ZONA_NIVEL_2 (ZONA_NIVEL_2_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_3_PK'', ''D_PRC_ZONA_NIVEL_3 (ZONA_NIVEL_3_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_4_PK'', ''D_PRC_ZONA_NIVEL_4 (ZONA_NIVEL_4_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_5_PK'', ''D_PRC_ZONA_NIVEL_5 (ZONA_NIVEL_5_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_6_PK'', ''D_PRC_ZONA_NIVEL_6 (ZONA_NIVEL_6_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_7_PK'', ''D_PRC_ZONA_NIVEL_7 (ZONA_NIVEL_7_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_8_PK'', ''D_PRC_ZONA_NIVEL_8 (ZONA_NIVEL_8_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ZONA_NIVEL_9_PK'', ''D_PRC_ZONA_NIVEL_9 (ZONA_NIVEL_9_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PK'', ''D_PRC (PROCEDIMIENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_T_SALDO_TOTAL_PK'', ''D_PRC_T_SALDO_TOTAL (T_SALDO_TOTAL_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_T_SALDO_RECUPERACION_PK'', ''D_PRC_T_SALDO_RECUPERACION (T_SALDO_RECUPERACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_T_SALDO_TOTAL_CONCURS_PK'', ''D_PRC_T_SALDO_TOTAL_CONCURSO (T_SALDO_TOTAL_CONCURSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;    
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ULTIMA_ACTUALIZACI_PK'', ''D_PRC_TD_ULTIMA_ACTUALIZACION (TD_ULT_ACTUALIZACION_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CONTRATO_VENCIDO_PK'', ''D_PRC_TD_CONTRATO_VENCIDO (TD_CONTRATO_VENCIDO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CNT_VENC_CREAC_ASU_PK'', ''D_PRC_TD_CNT_VENC_CREACION_ASU (TD_CNT_VENC_CREACION_ASU_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CREA_ASU_A_INT_DEM_PK'', ''D_PRC_TD_CREA_ASU_A_INTERP_DEM (TD_CREA_ASU_A_INTERP_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CREACION_ASU_ACEPT_PK'', ''D_PRC_TD_CREACION_ASU_ACEPT (TD_CREACION_ASU_ACEPT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ACEPT_ASU_INTE_DEM_PK'', ''D_PRC_TD_ACEPT_ASU_INTERP_DEM (TD_ACEPT_ASU_INTERP_DEM_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CREA_ASU_RE_DOC_AC_PK'', ''D_PRC_TD_CREA_ASU_REC_DOC_ACEP (TD_CREA_ASU_REC_DOC_ACEP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_REC_DOC_ACE_REG_TD_PK'', ''D_PRC_TD_REC_DOC_ACEPT_REG_TD (TD_REC_DOC_ACEPT_REG_TD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_REC_DOC_ACE_REC_DC_PK'', ''D_PRC_TD_REC_DOC_ACEPT_REC_DC (TD_REC_DOC_ACEPT_REC_DC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_AUTO_FC_DIA_ANALIS_PK'', ''D_PRC_TD_AUTO_FC_DIA_ANALISIS (TD_AUTO_FC_DIA_ANALISIS_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_AUTO_FC_LIQUIDACIO_PK'', ''D_PRC_TD_AUTO_FC_LIQUIDACION (TD_AUTO_FC_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_CONVENIO_PK'', ''D_PRC_ESTADO_CONVENIO (ESTADO_CONVENIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_SEGUIMIENTO_CONVENIO_PK'', ''D_PRC_SEGUIMIENTO_CONVENIO (SEGUIMIENTO_CONVENIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_T_PORCENTA_QUITA_CONV_PK'', ''D_PRC_T_PORCENTAJE_QUITA_CONV (T_PORCENTAJE_QUITA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_GARANTIA_CONCURSO_PK'', ''D_PRC_GARANTIA_CONCURSO (GARANTIA_CONCURSO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ID_DECL_RESOL_FIRM_PK'', ''D_PRC_TD_ID_DECL_RESOL_FIRME (TD_ID_DECL_RESOL_FIRME_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ID_ORD_INI_APREMIO_PK'', ''D_PRC_TD_ID_ORD_INI_APREMIO (TD_ID_ORD_INI_APREMIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ID_HIP_SUBASTA_PK'', ''D_PRC_TD_ID_HIP_SUBASTA (TD_ID_HIP_SUBASTA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_SUB_SOL_SUB_CEL_PK'', ''D_PRC_TD_SUB_SOL_SUB_CEL (TD_SUB_SOL_SUB_CEL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_SUB_CEL_CESION_REM_PK'', ''D_PRC_TD_SUB_CEL_CESION_REMATE (TD_SUB_CEL_CESION_REMATE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_CEL_ADJUDICACION_PK'', ''D_PRC_TD_CEL_ADJUDICACION (TD_CEL_ADJUDICACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_RECEP_DECRE_ADJUDI_PK'', ''D_PRC_TD_RECEP_DECRE_ADJUDICA (TD_RECEP_DECRE_ADJUDICA_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_SUBASTA_HIPOTECA_PK'', ''D_PRC_FASE_SUBASTA_HIPOTECARIO (FASE_SUBASTA_HIPOTECARIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ULT_TAR_FASE_HIP_PK'', ''D_PRC_ULT_TAR_FASE_HIP (ULT_TAR_FASE_HIP_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TD_ID_MON_DECRETO_FIN_PK'', ''D_PRC_TD_ID_MON_DECRETO_FIN (TD_ID_MON_DECRETO_FIN_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_F_SUBASTA_EJEC_NOTARI_PK'', ''D_PRC_F_SUBASTA_EJEC_NOTARIAL (F_SUBASTA_EJEC_NOTARIAL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  
...
V_SQL :=  'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''TMP_PRC_SUPER_IX'', ''TMP_PRC_SUPERVISOR (PROCEDIMIENTO_ID)'', ''S'', '''', :O_ERROR_STATUS); END;';
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PARALIZADO_PK'', ''D_PRC_PARALIZADO (PRC_PARALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  	  
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FINALIZADO_PK'', ''D_PRC_FINALIZADO (PRC_FINALIZADO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  	      
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_MOTIVO_PARALIZACION_PK'', ''D_PRC_MOTIVO_PARALIZACION (MOTIVO_PARALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  	      
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_MOTIVO_FINALIZACION_PK'', ''D_PRC_MOTIVO_FINALIZACION (MOTIVO_FINALIZACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;	  	      
  ...
  DBMS_OUTPUT.PUT_LINE('---- Creacion tabla D_PRC_ACUERDO_TIPO');
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_ACUERDO_PK'', ''D_PRC_TIPO_ACUERDO (TIPO_ACUERDO_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
...
----------------------------- D_PRC_ESTADO_ACUERDO --------------------------
  ...
  DBMS_OUTPUT.PUT_LINE('---- Creacion tabla D_PRC_ESTADO_ACUERDO');
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_ACUERDO_PK'', ''D_PRC_ESTADO_ACUERDO (ESTADO_ACUERDO_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_GESTOR_PK'', ''D_PRC_TIPO_GESTOR (TIPO_GESTOR_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
   ...
   V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_PRC_FASE_SUBASTA_CONCURSAL'', 
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_FASE_SUBASTA_CONCURSA_PK'', ''D_PRC_FASE_SUBASTA_CONCURSAL (FASE_SUBASTA_CONCURSAL_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PROPIETARIO_PK'', ''D_PRC_PROPIETARIO (PROPIETARIO_PRC_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PRE_PK'', ''D_PRC_TIPO_PRE (TIPO_PROCEDIMIENTO_PRE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PRE_AGR_PK'', ''D_PRC_TIPO_PRE_AGR (TIPO_PRE_AGR_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_PREPARACION_PK'', ''D_PRC_ESTADO_PREPARACION (ESTADO_PREPARACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_PREPARACION_PK'', ''D_PRC_TIPO_PREPARACION (TIPO_PREPARACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_BUROFAX_PK'', ''D_PRC_ESTADO_BUROFAX (ESTADO_BUROFAX_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''CREATE'', ''D_PRC_RESULTADO_BUROFAX'', 
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_RESULTADO_BUROFAX_PK'', ''D_PRC_RESULTADO_BUROFAX (RESULTADO_BUROFAX_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_BUROFAX_ENVIO_PK'', ''D_PRC_TIPO_BUROFAX_ENVIO (TIPO_BUROFAX_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_RESULT_BUROFAX_ENVIO_PK'', ''D_PRC_RESULT_BUROFAX_ENVIO (RESULTADO_BUROFAX_ENVIO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_DOCUMENTO_PK'', ''D_PRC_TIPO_DOCUMENTO (TIPO_DOCUMENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;
...
------------------------------ D_PRC_ESTADO_DOCUMENTO--------------------------
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_DOCUMENTO_PK'', ''D_PRC_ESTADO_DOCUMENTO (ESTADO_DOCUMENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_RESULTADO_SOLICITUD_PK'', ''D_PRC_RESULTADO_SOLICITUD (RESULTADO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TIPO_ACTOR_SOLICITUD_PK'', ''D_PRC_TIPO_ACTOR_SOLICITUD (TIPO_ACTOR_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_USUARIO_SOLICITUD_PK'', ''D_PRC_USUARIO_SOLICITUD (USUARIO_SOLICITUD_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_LIQUIDACION_ESTADO_PK'', ''D_PRC_LIQUIDACION_ESTADO (ESTADO_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_MOTIVO_CANCELACION_PK'', ''D_PRC_MOTIVO_CANCELACION (MOTIVO_CANCELACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_MOTIVO_SUBSANACION_PK'', ''D_PRC_MOTIVO_SUBSANACION (MOTIVO_SUBSANACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TRAMO_SUBSANACION_PK'', ''D_PRC_TRAMO_SUBSANACION (TRAMO_SUBSANACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TRAMO_AVANCE_DOCUMENT_PK'', ''D_PRC_TRAMO_AVANCE_DOCUMENTO (TRAMO_AVANCE_DOCUMENTO_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TRAMO_AVANCE_LIQUIDAC_PK'', ''D_PRC_TRAMO_AVANCE_LIQUIDACION (TRAMO_AVANCE_LIQUIDACION_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_TRAMO_AVANCE_BUROFAX_PK'', ''D_PRC_TRAMO_AVANCE_BUROFAX (TRAMO_AVANCE_BUROFAX_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_DOCUME_PER_ANT_PK'', ''D_PRC_ESTADO_DOCUMENTO_PER_ANT (ESTADO_DOCUMENTO_PER_ANT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ESTADO_LIQ_PER_ANT_PK'', ''D_PRC_ESTADO_LIQ_PER_ANT (ESTADO_LIQ_PER_ANT_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_ENT_CEDENTE_PK'', ''D_PRC_ENT_CEDENTE (ENT_CEDENTE_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
    ...
    execute immediate V_SQL USING OUT error;
 	...
 	V_SQL := 'BEGIN OPERACION_DDL.DDL_INDEX(''CREATE'', ''D_PRC_PROP_SAREB_PK'', ''D_PRC_PROP_SAREB (PROP_SAREB_ID)'', ''S'', ''UNIQUE'', :error); END;';
    execute immediate V_SQL USING OUT error;        
