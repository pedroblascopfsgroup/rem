...
BEGIN
    ...
    IF V_NUM_TABLAS = 1 THEN 
            V_MSQL := 'DROP TABLE '||v_esquema||'.T_ARP_ARQ_RECOBRO_PERSONA CASCADE CONSTRAINTS';
    ...
    --** Creamos la tabla        
     V_MSQL := 'CREATE TABLE ' ||v_esquema|| '.T_ARP_ARQ_RECOBRO_PERSONA 
				   (	
					ARP_ID                         NUMBER(16,0), 
					PER_ID                         NUMBER(16,0), 
					ARQ_ID                         NUMBER(16,0), 
    ...
    EXECUTE IMMEDIATE V_MSQL;
    DBMS_OUTPUT.PUT_LINE('[INFO] '||v_esquema||'.T_ARP_ARQ_RECOBRO_PERSONA... Tabla creada');
         ...
         LOOP
          ...
          if v_num_tablas > 0 then
            v_sql := 'grant select, update, delete, insert
                         on '||v_esquema||'.T_ARP_ARQ_RECOBRO_PERSONA
