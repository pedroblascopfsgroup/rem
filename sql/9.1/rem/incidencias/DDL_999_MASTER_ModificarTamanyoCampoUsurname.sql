...
DECLARE
    ...
    CURSOR  TABLES_CURSOR IS
        SELECT 'ALTER TABLE '||V_ESQUEMA_M||'.'||tab.TABLE_NAME||' MODIFY '||tab.COLUMN_NAME|| ' VARCHAR2(50 CHAR)'
        ...
        AND EXISTS (SELECT 1 FROM ALL_OBJECTS a WHERE a.OBJECT_TYPE = 'TABLE' and tab.TABLE_NAME = a.OBJECT_NAME and a.owner = 'REMMASTER')
	AND tab.OWNER = 'REMMASTER'
