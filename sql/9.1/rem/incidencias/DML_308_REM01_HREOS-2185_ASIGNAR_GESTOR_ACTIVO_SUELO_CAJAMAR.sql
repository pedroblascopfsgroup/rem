...
--## PRODUCTO=NO
--## 
--## Finalidad: Asignar gestor de activo a todos los activos de tipo suelo y cartera cajamar a mhernandez.
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
   ...
   CURSOR ACTIVOS IS
	...
	WHERE TPA.DD_TPA_CODIGO ='01' AND CRA.DD_CRA_CODIGO = '01';

   ACTIVO ACTIVOS%ROWTYPE;

BEGIN	

	DBMS_OUTPUT.PUT_LINE('[INICIO] COMIENZA EL PROCESO PARA LA ASIGNACIÓN DE GESTOR DE ACTIVOS PARA ');
	DBMS_OUTPUT.PUT_LINE('         ACTIVOS DE TIPO SUELO Y CARTERA CAJAMAR');
	EXECUTE IMMEDIATE 'SELECT USU_ID FROM '||V_ESQUEMA_MASTER||'.USU_USUARIOS USU WHERE USU.USU_USERNAME = ''mhernandez''' INTO USU_ID_NUEVO;
