  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.V_BUSQUEDA_ACTIVOS 
	AS
		SELECT
			...
			ACT_LOC.LOC_LATITUD,
			--ACT.DD_EPA_ADMISION_ID AS FLAG_ADMISION,
	        --ACT.DD_EPA_PRECIO_ID AS FLAG_GESTION,
	        --ACT.DD_EPA_GESTION_ID AS FLAG_PRECIO,
	        --ACT.DD_EPA_PUBLICACION_ID AS FLAG_PUBLICACIONES,
	        --ACT.DD_EPA_COMERCIALIZAR_ID AS FLAG_COMERCIALIZAR,
			ACT.ACT_ADMISION,
			ACT.ACT_GESTION,
