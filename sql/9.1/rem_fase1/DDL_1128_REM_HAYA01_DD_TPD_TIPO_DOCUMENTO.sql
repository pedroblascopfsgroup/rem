...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('19' ,'Informe del trabajo realizado', 'Informe del trabajo realizado', 'AI-03-ESIN-34')
    ); 
...
BEGIN
    ...
    -- Si existe añadimos campos provisionales + insert
    IF CUENTA = 1 THEN             
        V_MSQL := 'UPDATE ' || V_ESQUEMA || '.DD_TPD_TIPO_DOCUMENTO SET DD_TPD_MATRICULA_GD = ''AI-03-PRES-07'' WHERE DD_TPD_CODIGO = ''18''';
        EXECUTE IMMEDIATE V_MSQL;
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA_M || '.DD_TPD_TIPO_DOCUMENTO... OK');
    END IF;
