...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla auxiliar para almacenar la información de alta de peticiones de trabajo procedentes de fichero.
--##           
...
DECLARE
    ...
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla auxiliar para almacenar la información de alta de peticiones de trabajo procedentes de fichero.'; -- Vble. para los comentarios de las tablas
...
BEGIN
    ...
    ACT_NUM_ACTIVO_UVEM      NUMBER(16,0)                NOT NULL,
    AGR_MEDIADOR                VARCHAR2(16 CHAR)      NOT NULL,
    TIPO_TRABAJO                  VARCHAR2(20 CHAR)      NOT NULL,
    SUBTIPO_TRABAJO             VARCHAR2(20 CHAR)     NOT NULL, 
    TBJ_FECHA_SOLICITUD       DATE,
    TBJ_DESCRIPCION             VARCHAR2(256 CHAR)      NOT NULL,
    TBJ_CONTACTO_OBS        VARCHAR2(256 CHAR) 
	)
	LOGGING 
	NOCOMPRESS 
	NOCACHE
