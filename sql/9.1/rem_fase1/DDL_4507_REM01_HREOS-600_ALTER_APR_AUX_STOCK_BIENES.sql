...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir columnas APR_AUX_STOCK_BIENES.AJD_LETRADO y APR_AUX_STOCK_BIENES.AJD_ID_ASUNTO
--##           
...
BEGIN
	...
	-- Comprobamos si existe columna ADJ_LETRADO
	...
	ELSE
		...
		DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.AJD_LETRADO... añadido.');
	END IF;
