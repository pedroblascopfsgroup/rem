...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('02'	,'Inscrito'										,'Inscrito'),
        T_TIPO_DATA('03'	,'Imposible inscripción'						,'Imposible inscripción'),
        T_TIPO_DATA('04'	,'Desconocido'									,'Desconocido')
    ); 
...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_ETI_ESTADO_TITULO -----------------------------------------------------------------
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN DD_ETI_ESTADO_TITULO] ');
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_ETI_ESTADO_TITULO (' ||
                      'DD_ETI_ID, DD_ETI_CODIGO, DD_ETI_DESCRIPCION, DD_ETI_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
      ...
      END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: DICCIONARIO DD_ETI_ESTADO_TITULO ACTUALIZADO CORRECTAMENTE ');
