...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01'	,'Gestoría de admisión'						,'Gestoría de admisión'),
    	T_TIPO_DATA('02'	,'Sociedad Tasadora'						,'Sociedad Tasadora'),
    	T_TIPO_DATA('03'	,'Aseguradora'								,'Aseguradora'),
    	T_TIPO_DATA('04'	,'Colaborador'								,'Colaborador'),
    	T_TIPO_DATA('05'	,'Mantenimiento'							,'Mantenimiento')
    ); 
