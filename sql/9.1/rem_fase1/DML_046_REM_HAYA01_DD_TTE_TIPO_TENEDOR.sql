...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01'	,'Mediador'													,'Mediador'),
        T_TIPO_DATA('02'	,'Oficina, Dir. Zona o Dir. Territorial'					,'Oficina Dir. Zona o Dir. Territorial'),
        T_TIPO_DATA('03'	,'Fuerza de Venta Directa'									,'Fuerza de Venta Directa'),
        T_TIPO_DATA('04'	,'Gestor de HRE'											,'Gestor de HRE')
    ); 
