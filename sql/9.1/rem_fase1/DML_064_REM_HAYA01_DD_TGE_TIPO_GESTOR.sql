...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GADM'	,'Gestor de admisión'						,'Gestor de admisión'),
    	T_TIPO_DATA('GACT'	,'Gestor de activos'						,'Gestor de activos'),
    	T_TIPO_DATA('TECN'	,'Técnico'									,'Técnico'),
    	T_TIPO_DATA('UPROV'	,'Proveedor'								,'Proveedor')
    ); 
