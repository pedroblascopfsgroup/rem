...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('CL'	,'Calle'			,'Calle'),
    	T_TIPO_DATA('PL'	,'Plaza'			,'Plaza'),
    	T_TIPO_DATA('AV'	,'Avenida'			,'Avenida'),
    	T_TIPO_DATA('CT'	,'Carretera'		,'Carretera'),
    	T_TIPO_DATA('UB'	,'Urbanización'		,'Urbanización'),
    	T_TIPO_DATA('LU'	,'Lugar'			,'Lugar'),
    	T_TIPO_DATA('PT'	,'Partida'			,'Partida'),
    	T_TIPO_DATA('PA'	,'Paseo'			,'Paseo'),
    	T_TIPO_DATA('PJ'	,'Pasaje'			,'Pasaje'),
    	T_TIPO_DATA('CA'	,'Camino'			,'Camino'),
    	T_TIPO_DATA('PG'	,'Polígono'			,'Polígono'),
    	T_TIPO_DATA('RO'	,'Ronda'			,'Ronda')
    ); 
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN DD_TVI_TIPO_VIA] ');
