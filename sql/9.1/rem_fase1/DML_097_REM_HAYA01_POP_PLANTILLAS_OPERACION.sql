...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('AGRUPAR_ACTIVOS_RESTRINGIDO','plantillas/plugin/masivo/AGRUPAR_ACTIVOS_RESTRINGIDO.xls'		,'AGAR'),
      T_TIPO_DATA('AGRUPAR_ACTIVOS_OBRA_NUEVA' ,'plantillas/plugin/masivo/AGRUPAR_ACTIVOS_OBRA_NUEVA.xls'     ,'AGAN')
    ); 
