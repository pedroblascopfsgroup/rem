...
--DECLARE
    ...
    --V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	--T_TIPO_DATA('1','GESTACT' ,'Pintor32', 'GESTACT', 'manuel.pardo@pfsgroup.es', '1'),
    	--T_TIPO_DATA('1','GESTADM' ,'Pintor32', 'GESTADM', 'manuel.pardo@pfsgroup.es', '1'),
    	--T_TIPO_DATA('1','USUPROV' ,'Pintor32', 'USUPROV', 'manuel.pardo@pfsgroup.es', '1')
    --); 
