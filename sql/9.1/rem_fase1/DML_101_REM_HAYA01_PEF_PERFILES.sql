...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('HAYAGESTADM' 	,'Gestor de admisión'	, 'Gestor de admisión'),
    	T_TIPO_DATA('HAYAGESACT' 	,'Gestor de activos'	, 'Gestor de activos'),
    	T_TIPO_DATA('HAYAPROV' 	,'Usuarios de proveedor'	, 'Usuarios de proveedor')
    ); 
