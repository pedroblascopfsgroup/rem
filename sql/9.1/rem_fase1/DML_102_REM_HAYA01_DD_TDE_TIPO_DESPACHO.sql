...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GADM', 'Gestor de admisión'),
    	T_TIPO_DATA('GACT', 'Gestor de activos'),
    	T_TIPO_DATA('UPROV', 'Usuario de proveedor')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       IF V_NUM_TABLAS > 0 THEN			       
         DBMS_OUTPUT.PUT_LINE('[INFO] Ya existen los datos en la tabla '||V_ESQUEMA_M||'.DD_TDE_TIPO_DESPACHO...no se modifica nada.');
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_TDE_TIPO_DESPACHO (' ||
          			  ...
          			  'SELECT '|| V_ID ||', '''||V_TMP_TIPO_DATA(1)||''',  '''||V_TMP_TIPO_DATA(2)||''', '''||V_TMP_TIPO_DATA(2)||''', 0, ''REM'', SYSDATE, 0 FROM DUAL';
      ...
      END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: DD_TDE_TIPO_DESPACHO ACTUALIZADO CORRECTAMENTE ');
