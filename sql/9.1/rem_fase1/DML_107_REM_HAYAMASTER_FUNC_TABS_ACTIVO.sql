...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Puede ver pestaña Datos Básicos en Activo', 'TAB_ACTIVO_DATOS_BASICOS'),
      T_FUNCION('Puede ver pestaña Admisión en Activo', 'TAB_ACTIVO_ADMISION'),
      T_FUNCION('Puede ver pestaña Gestión en Activo', 'TAB_ACTIVO_GESTION'),
      T_FUNCION('Puede ver pestaña Actuaciones en Activo', 'TAB_ACTIVO_ACTUACIONES'),
      T_FUNCION('Puede ver pestaña Gestores en Activo', 'TAB_ACTIVO_GESTORES')
    ); 
