...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Puede ver la opción de menú dashboard', 'MENU_DASHBOARD'),
      T_FUNCION('Puede ver la opción de menú agenda', 'MENU_AGENDA'),
      T_FUNCION('Puede ver la opción de menú activos', 'MENU_ACTIVOS'),
      T_FUNCION('Puede ver la opción de menú agrupaciones', 'MENU_AGRUPACIONES'),
      T_FUNCION('Puede ver la opción de menú trabajos', 'MENU_TRABAJOS'),
      T_FUNCION('Puede ver la opción de menú carga masiva', 'MENU_MASIVO')
    ); 
