...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('45','','','BANKIA','BANKIA'),
		T_TIPO_DATA('46','','','CAIXA LAIETANA','CAIXA LAIETANA'),
		T_TIPO_DATA('47','','','CAJA INSULAR','CAJA INSULAR'),
		T_TIPO_DATA('48','','','CAJA SEGOVIA','CAJA SEGOVIA'),
		T_TIPO_DATA('49','','','BANCAJA','BANCAJA'),
		T_TIPO_DATA('50','','','CAJA AVILA','CAJA AVILA'),
		T_TIPO_DATA('51','','','CAJA RIOJA','CAJA RIOJA')
    ); 
