...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA(2	,'13'	,'Propio de Origen Funcional'			,'Propio de Origen Funcional')
    ); 
...
BEGIN	
    ...
    -- LOOP para actualizar los valores en DD_STA_SUBTIPO_TITULO_ACTIVO -----------------------------------------------------------------
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZACION EN DD_STA_SUBTIPO_TITULO_ACTIVO] ');
