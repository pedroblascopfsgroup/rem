...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Puede ver pestaña Búsqueda de activos', 'TAB_BUSQUEDA_ACTIVOS'),
      T_FUNCION('Puede ver pestaña observaciones', 'TAB_ACTIVO_OBSERVACIONES'),
      T_FUNCION('Puede ver pestaña fotos', 'TAB_ACTIVO_FOTOS'),
      T_FUNCION('Puede ver pestaña documentos', 'TAB_ACTIVO_DOCUMENTOS'),
      T_FUNCION('Puede ver pestaña agrupaciones', 'TAB_ACTIVO_AGRUPACIONES')
