...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Puede editar listado de activos del trabajo', 'EDITAR_LIST_ACTIVOS_TRABAJO'),
      T_FUNCION('Puede editar listado de activos del trabajo', 'SUBIR_FOTOS_TRABAJO_SOLICITANTE'),
      T_FUNCION('Puede editar listado de activos del trabajo', 'EDITAR_LIST_PRESUPUESTOS_TRABAJO'),
      T_FUNCION('Puede editar listado de activos del trabajo', 'EDITAR_LIST_TARIFAS_TRABAJO'),
      T_FUNCION('Puede editar listado de activos del trabajo', 'EDITAR_LIST_RECARGOS_TRABAJO'),
      T_FUNCION('Puede editar listado de activos del trabajo', 'EDITAR_LIST_PROVSUPLI_TRABAJO')
