...
DECLARE
    ...
    V_FUNCION_DELETE T_ARRAY_FUNCION := T_ARRAY_FUNCION(
    ...
    V_FUNCION_INSERT T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	 	T_FUNCION('TAB_ACTIVO_DATOS_BASICOS'),
    	T_FUNCION('TAB_ACTIVO_FOTOS'),
    	T_FUNCION('EDITAR_LIST_TARIFAS_TRABAJO')
    );  
    V_TMP_FUNCION T_FUNCION;
    V_PERFILES VARCHAR2(100 CHAR) := 'HAYAPROV';  -- Cambiar por ALGÚN PERFIL para otorgar permisos a ese perfil.
...
BEGIN	
    ...
    FOR I IN V_FUNCION_DELETE.FIRST .. V_FUNCION_DELETE.LAST
      LOOP
            V_TMP_FUNCION := V_FUNCION_DELETE(I);
    ...
    FOR I IN V_FUNCION_INSERT.FIRST .. V_FUNCION_INSERT.LAST
      LOOP
            V_TMP_FUNCION := V_FUNCION_INSERT(I);
