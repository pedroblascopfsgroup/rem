...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('SUPER'	,'Super Administrador'						,'Super Administrador'),
    	T_TIPO_DATA('SUPADM','Supervisor de admisión'						,'Supervisor de admisión'),
    	T_TIPO_DATA('SUPACT','Supervisor del activo'						,'Supervisor del activo'),
    	T_TIPO_DATA('GGADM'	,'Gestoría de admisión'						,'Gestoría de admisión')
    ); 
