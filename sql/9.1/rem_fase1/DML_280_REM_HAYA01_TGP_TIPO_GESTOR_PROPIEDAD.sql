    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       IF V_NUM_TABLAS > 0 THEN			       
         DBMS_OUTPUT.PUT_LINE('[INFO] Ya existen los datos en la tabla '||V_ESQUEMA||'.TGP_TIPO_GESTOR_PROPIEDAD...no se modifica nada.');
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.TGP_TIPO_GESTOR_PROPIEDAD (' ||
          			  ...
          			  'SELECT '|| V_ID || ',(SELECT DD_TGE_ID FROM '||V_ESQUEMA_M||'.DD_TGE_TIPO_GESTOR WHERE DD_TGE_CODIGO = '''||V_TMP_TIPO_DATA(1)||'''), '||
          			  '''DES_VALIDOS'', '''||V_TMP_TIPO_DATA(1)||''', 0, ''REM'', SYSDATE, 0 FROM DUAL';
      ...
      END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: TGP_TIPO_GESTOR_PROPIEDAD ACTUALIZADO CORRECTAMENTE ');
