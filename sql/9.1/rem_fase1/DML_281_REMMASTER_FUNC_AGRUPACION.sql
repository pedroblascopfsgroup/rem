...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Función de edición general de agrupaciones', 'EDITAR_AGRUPACION'),
      T_FUNCION('Función de edición del listado agrupaciones', 'EDITAR_LIST_AGRUPACIONES'),
      T_FUNCION('Puede ver el tab de ficha de la agrupación', 'TAB_AGRUPACION_FICHA'),
      T_FUNCION('Puede ver el tab de listado de activos de la agrupación', 'TAB_AGRUPACION_LISTADO_ACTIVOS'),
      T_FUNCION('Puede ver el tab de fotos de la agrupación', 'TAB_AGRUPACION_FOTOS'),
      T_FUNCION('Puede ver el tab de observaciones de la agrupación', 'TAB_AGRUPACION_OBSERVACIONES'),
      T_FUNCION('Puede ver el tab de subdivision de la agrupación', 'TAB_AGRUPACION_SUBDIVISIONES')       
    ); 
