...
--## PRODUCTO=NO
--##
--## Finalidad: Script que modifica DD_TPD_TIPO_DOCUMENTO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('03'	,'Escritura pública inscrita'							,'Escritura pública inscrita')
    ); 
...
BEGIN	
    ...
    -- LOOP para actualizar los valores en DD_TPD_TIPO_DOCUMENTO -----------------------------------------------------------------
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZACION EN DD_TPD_TIPO_DOCUMENTO] ');
