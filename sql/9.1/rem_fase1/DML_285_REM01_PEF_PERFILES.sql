...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('HAYASUPER'	,'Super', 'Super'),
    	T_TIPO_DATA('HAYASUPACT', 'Supervisor de activo', 'Supervisor de activo'),
    	T_TIPO_DATA('HAYASUPADM', 'Supervisor de admisión', 'Supervisor de admisión')
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.PEF_PERFILES (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''',''DML'',SYSDATE,0 FROM DUAL';
