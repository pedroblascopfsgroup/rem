...
DECLARE
    ...
    CURSOR FUNCIONES IS
    	SELECT DISTINCT FUN.FUN_ID AS FUN FROM REMMASTER.FUN_FUNCIONES FUN 
    		...
    		WHERE PEF.PEF_CODIGO = 'HAYAGESACT' AND FUN.FUN_ID NOT IN (
		        SELECT FUN2.FUN_ID FROM REMMASTER.FUN_FUNCIONES FUN2 
    				...
    				WHERE PEF2.PEF_CODIGO = 'HAYASUPACT'
    			) ORDER BY FUN.FUN_ID;
      ...
      LOOP
		...
		DBMS_OUTPUT.PUT_LINE('INSERTANDO PROCURADOR: ' || FILA.FUN);
				...
				V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
						...
						' (SELECT PEF_ID FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''HAYASUPACT''),' || FILA.FUN ||
