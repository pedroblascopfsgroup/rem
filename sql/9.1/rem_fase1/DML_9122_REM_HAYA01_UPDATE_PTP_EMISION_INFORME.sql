...
DECLARE
    ...
    V_TAP_TAP_CODIGOS VARCHAR2(4000 CHAR) := ' ''T006_AnalisisPeticion''
                                            , ''T006_ValidacionInforme''
                                            , ''T006_AutorizacionPropietario'' ';
...
BEGIN 
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_PTP_CAMPO||' DE TABLA DD_PTP_PLAZOS_TAREAS_PLAZAS PARA T. EMISION INFORME - PLAZOS');



  --''T006_AnalisisPeticion'', ''T006_ValidacionInforme'', ''T006_AutorizacionPropietario'' - 3 Días ---
  ...
  --''T006_SolicitudExtraordinaria'', ''T006_CierreEconomico'' - 5 Días ------------------------------------

  V_TAP_TAP_CODIGOS :=' ''T006_SolicitudExtraordinaria'', ''T006_CierreEconomico'' ';
