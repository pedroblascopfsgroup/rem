...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA T. OBTENCION DOCUMENTAL (varios) - NOMBRES');
...
--T002_ObtencionLPOGestorInterno -------------------------------------------------------
  ...
  V_TFI_TAP_CODIGO := 'T002_ObtencionLPOGestorInterno';
  V_TFI_TFI_NOMBRE := 'comboObtencion';

-- NOMBRE CAMPO ------------
  V_TFI_CAMPO := 'tfi_label';
  V_TFI_VALOR := 'Documento obtenido (SI/NO)';
...
-- NOMBRE CAMPO ------------
  V_TFI_CAMPO := 'tfi_label';
  V_TFI_VALOR := 'Fecha obtención documento';
...
--T002_ObtencionDocumentoGestoria -------------------------------------------------------
  ...
  V_TFI_TAP_CODIGO := 'T002_ObtencionDocumentoGestoria';
  V_TFI_TFI_NOMBRE := 'comboObtencion';
...
-- NOMBRE CAMPO ------------
  V_TFI_CAMPO := 'tfi_label';
  V_TFI_VALOR := 'Hay que pagarle al proveedor la gestión que ha realizado pese a no haber obtenido el documento (SI/NO)';
