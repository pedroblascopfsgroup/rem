...
BEGIN    
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO' ||
			  ' SET TAP_SCRIPT_DECISION = ''valores[''''T006_ValidacionInforme''''][''''comboCorreccion''''] == DDSiNo.SI ? (valores[''''T006_ValidacionInforme''''][''''comboPagar''''] == DDSiNo.SI ? ''''OKConCoste'''' : ''''OKSinCoste'''') : ''''Incorrecto'''' '' '||
