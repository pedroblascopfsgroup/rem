...
--		   T_TFI(   'T004_FijacionPlazo'   ,   'fechaConcreta'   ,   'Debe indicar el plazo concreto de ejecuci&oacute;n del trabajo'   ),   
--		   T_TFI(   'T004_FijacionPlazo'   ,   'horaConcreta'   ,   'Debe indicar una hora concreta'   ),   
--		   T_TFI(   'T004_FijacionPlazo'   ,   'fechaTope'   ,   'Debe indicar el plazo tope de ejecuci&oacute;n del trabajo'   ),   
