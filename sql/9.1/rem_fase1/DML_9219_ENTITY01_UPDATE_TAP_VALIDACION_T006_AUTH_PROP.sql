...
BEGIN 
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO VALIDACIONES - T006_AutorizacionPropietario');


  --ACTUALIZACION DE VALIDACIONE POST 
  V_TAP_CAMPO := 'TAP_SCRIPT_VALIDACION_JBPM';

  --T. INFORME - AUTORIZACION PROPIETARIO - SIN VALIDACION ----------------------------------
