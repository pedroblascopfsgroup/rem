...
DECLARE
    ...
    --                TAP_CODIGO                                              TFI_NOMBRE                       TFI_TIPO
       T_TFI(   'T005_EmisionTasacion'                            ,        'fechaEmision'      ,             'datemaxtod'           ),
       T_TFI(   'T005_CierreEconomico'                            ,        'fechaCierre'       ,             'datemaxtod'           ),
       T_TFI(   'T005_SolicitudExtraordinaria'                    ,        'fecha'             ,             'datemaxtod'           ),
       T_TFI(   'T005_AutorizacionPropietario'                    ,        'fecha'             ,             'datemaxtod'           )
...
/* TIPOS DE CAMPO ANTERIORES
       T_TFI(   'T005_EmisionTasacion'                            ,        'fechaEmision'      ,             'date'                 ),
       T_TFI(   'T005_CierreEconomico'                            ,        'fechaCierre'       ,             'date'                 ),
       T_TFI(   'T005_SolicitudExtraordinaria'                    ,        'fecha'             ,             'date'                 ),
       T_TFI(   'T005_AutorizacionPropietario'                    ,        'fecha'             ,             'date'                 ),
*/    
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO] Actualizando datos de TFI_TAREAS_FORM_ITEMS. T. TASACION: Estableciendo FECHAS MAXIMAS a HOY()');
