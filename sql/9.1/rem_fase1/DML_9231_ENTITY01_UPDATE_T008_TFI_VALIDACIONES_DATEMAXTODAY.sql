...
DECLARE
    ...
    --                TAP_CODIGO                                              TFI_NOMBRE                       TFI_TIPO
       T_TFI(   'T008_SolicitudDocumento'                         ,        'fechaSolicitud'    ,             'datemaxtod'           ),
       T_TFI(   'T008_ObtencionDocumento'                         ,        'fechaEmision'      ,             'datemaxtod'           ),
       T_TFI(   'T008_CierreEconomico'                            ,        'fechaCierre'       ,             'datemaxtod'           )
		);
    V_TMP_T_TFI T_TFI;
...
/* TIPOS DE CAMPO ANTERIORES
       T_TFI(   'T008_SolicitudDocumento'                         ,        'fechaSolicitud'    ,             'date'                 ),
       T_TFI(   'T008_ObtencionDocumento'                         ,        'fechaEmision'      ,             'date'                 ),
       T_TFI(   'T008_CierreEconomico'                            ,        'fechaCierre'       ,             'date'                 ),
*/    
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO] Actualizando datos de TFI_TAREAS_FORM_ITEMS. T. CEDULA: Estableciendo FECHAS MAXIMAS a HOY()');
