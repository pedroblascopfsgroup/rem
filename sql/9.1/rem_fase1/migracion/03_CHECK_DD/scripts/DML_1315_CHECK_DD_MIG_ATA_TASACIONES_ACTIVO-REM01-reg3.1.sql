...
V_TABLA VARCHAR(30 CHAR) := 'MIG_ATA_TASACIONES_ACTIVO';
FICHERO VARCHAR2(30 CHAR) := 'TASACIONES_ACTIVO.dat';
...
BEGIN
  ...
  --DD_TTS_TIPO_TASACION--
  
  CAMPO := 'TAS_TIPO_TASACION';
  DICCIONARIO := 'DD_TTS_TIPO_TASACION';
  COD_DICC := 'DD_TTS_CODIGO';
