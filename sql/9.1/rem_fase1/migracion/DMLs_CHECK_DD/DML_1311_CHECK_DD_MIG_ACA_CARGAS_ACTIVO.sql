...
V_TABLA VARCHAR(30 CHAR) := 'MIG_ACA_CARGAS_ACTIVO';
FICHERO VARCHAR2(30 CHAR) := 'CARGAS_ACTIVO.dat';
...
BEGIN
  ...
  --DD_STC_SUBTIPO_CARGA--
  
  CAMPO := 'SUBTIPO_CARGA';
  DICCIONARIO := 'DD_STC_SUBTIPO_CARGA';
  COD_DICC := 'DD_STC_CODIGO';
  ...
  CAMPO := 'SITUACION_CARGA';
  DICCIONARIO := 'DD_SIC_SITUACION_CARGA';
  COD_DICC := 'DD_SIC_CODIGO';
