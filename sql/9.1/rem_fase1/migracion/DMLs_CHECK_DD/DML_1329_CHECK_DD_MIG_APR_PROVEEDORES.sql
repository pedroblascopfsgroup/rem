...
V_TABLA VARCHAR(30 CHAR) := 'MIG_APR_PROVEEDORES';
FICHERO VARCHAR2(30 CHAR) := 'ACTIVO_PROVEEDORES.dat';
SENTENCIA VARCHAR2(300 CHAR);
V_NUM NUMBER(10);
CAMPO VARCHAR2(30 CHAR);
DICCIONARIO VARCHAR2(30 CHAR);
COD_DICC VARCHAR2(30 CHAR);
CLAVE VARCHAR2(30 CHAR) := 'PVE_DOCIDENTIF';
...
BEGIN
  ...
  --DD_TPR_TIPO_PROVEEDOR--
  
  CAMPO := 'TIPO_PROVEEDOR';
  DICCIONARIO := 'DD_TPR_TIPO_PROVEEDOR';
  ...
  --DD_ZNG_ZONA_GEOGRAFICA--
  
  CAMPO := 'ZONA_GEOGRAFICA';
  DICCIONARIO := 'DD_ZNG_ZONA_GEOGRAFICA';
  COD_DICC := 'DD_ZNG_CODIGO';
  ...
  DBMS_OUTPUT.PUT_LINE('[INFO] Modificando campo PVE_LOCALIDAD...');
  DBMS_OUTPUT.PUT_LINE('[INFO] Añadiendo 0 a la izquierda...');
  
  EXECUTE IMMEDIATE '
  UPDATE '||V_ESQUEMA||'.'||V_TABLA||' 
  SET PVE_LOCALIDAD = LPAD(PVE_LOCALIDAD,5,''0'')
  '
  ;
