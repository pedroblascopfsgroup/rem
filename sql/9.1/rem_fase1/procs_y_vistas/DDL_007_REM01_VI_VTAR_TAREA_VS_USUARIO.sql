...
'      WHEN ''61'' --Activo '||Chr(13)||Chr(10)||
'        THEN nvl(ACT.ACT_NUM_ACTIVO,van.ACT_NUM_ACTIVO)  '||Chr(13)||Chr(10)||
'        -- TODO poner para el resto de unidades de gestion '||Chr(13)||Chr(10)||
'      ELSE -1 '||Chr(13)||Chr(10)||
...
'      WHEN ''61'' --Activo '||Chr(13)||Chr(10)||
'        THEN nvl(tac.ACT_ID,van.ACT_ID) '||Chr(13)||Chr(10)||
'        -- TODO poner para el resto de unidades de gestion '||Chr(13)||Chr(10)||
'      ELSE -1 '||Chr(13)||Chr(10)||
...
' LEFT JOIN '||V_ESQUEMA||'.V_ACTIVO_NOTIFICACION VAN ON VAN.IDTAREA = TAR.TAR_ID');
...
/* Recompilamos V_COUNT_TAREAS */
execute immediate ('alter view '||V_ESQUEMA||'.V_COUNT_TAREAS compile');
