...
DECLARE
    ...
    IF V_NUM_TABLAS = 1 THEN
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... El campo ya existe en la tabla');
         V_MSQL := 'alter table '||V_ESQUEMA||'.BIE_BIEN drop column DD_TRIV_ID';
          EXECUTE IMMEDIATE V_MSQL; 
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminado el campo DD_TRIV_ID');
    END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... El campo ya existe en la tabla');
        V_MSQL := 'alter table '||V_ESQUEMA||'.BIE_BIEN drop column DD_TPI_ID';        
        DBMS_OUTPUT.PUT_LINE(V_MSQL);
        EXECUTE IMMEDIATE V_MSQL; 
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminado el campo DD_TPI_ID');
    END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... El campo ya existe en la tabla');
        V_MSQL := 'alter table '||V_ESQUEMA||'.BIE_BIEN drop column DD_TPIV_ID';        
        DBMS_OUTPUT.PUT_LINE(V_MSQL);
        EXECUTE IMMEDIATE V_MSQL; 
         DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminado el campo DD_TPIV_ID');
    END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
        DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... El campo ya existe en la tabla');
        V_MSQL := 'alter table '||V_ESQUEMA||'.BIE_BIEN drop column DD_IPR_ID';        
        DBMS_OUTPUT.PUT_LINE(V_MSQL);
        EXECUTE IMMEDIATE V_MSQL; 
         DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminado el campo DD_IPR_ID');
    END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
    	...
    	V_MSQL := 'ALTER TABLE ' || V_ESQUEMA || '.BIE_BIEN DROP CONSTRAINT FK_BIEN_DD_TRIV';
			
		EXECUTE IMMEDIATE V_MSQL;     
		 DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminada la constraint FK_BIEN_DD_TRIV');
	END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN ... FK ya existe');
    	V_MSQL := 'ALTER TABLE ' || V_ESQUEMA || '.BIE_BIEN DROP cONSTRAINT FK_BIEN_DD_TPI';
			
		EXECUTE IMMEDIATE V_MSQL;     
		 DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN... Eliminada la constraint FK_BIEN_DD_TPI');
	END IF;
    ...
    IF V_NUM_TABLAS = 1 THEN
    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN ... FK ya existe');
    	V_MSQL := 'ALTER TABLE ' || V_ESQUEMA || '.BIE_BIEN DROP CONSTRAINT FK_BIEN_DD_TPIV';
    ...
    IF V_NUM_TABLAS = 1 THEN
    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.BIE_BIEN ... FK ya existe');
    	V_MSQL := 'ALTER TABLE ' || V_ESQUEMA || '.BIE_BIEN DROP CONSTRAINT FK_BIEN_DD_IPR';
