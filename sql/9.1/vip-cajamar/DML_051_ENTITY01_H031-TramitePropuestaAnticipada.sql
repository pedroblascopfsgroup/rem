...
BEGIN
    ...
    */
	 ...
	 * ---------------------------------------------------------------------------------------------------------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||PAR_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO SET DD_TPO_DESCRIPCION = ''T. Propuesta Anticipada Convenio - HCJ'', DD_TPO_XML_JBPM = ''hcj_tramitePropuestaAnticipada'' WHERE DD_TPO_CODIGO = '''||V_COD_PROCEDIMIENTO||'''';
