...
DECLARE
    ...
    *---------------------------------------------------------------------
    */
    PAR_TIT_TRAMITE VARCHAR2(60 CHAR)   := 'Trámite de certificado de libertad de arrendamiento';   -- [PARAMETRO] Título del trámite
    ...
    */    
    ...
    V_COD_PROCEDIMIENTO VARCHAR(10 CHAR) := 'CJ101'; -- Código de procedimiento para reemplazar
    ...
    */
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
    	T_TIPO_TPO(V_COD_PROCEDIMIENTO, 'T. certificado libertad arrendamiento - CJ','Trámite de certificado de libertad de arrendamiento', null, 'cj_certificadoLibertadArrendamiento','0','DD','0','TR',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ101_EmitirCertificado','','comprobarExisteDocumentoLIBARR() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Debe adjuntar el documento "Certificado de Libertad de arrendamientos".</div>''','','','',0,'Emitir certificado',0,'DD',0,'','','',1,'EXTTareaProcedimiento',3,'','', null,'',''),
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ101_LegitimacionNotarialFirma','','','','','',0,'Legitimación notarial de firma',0,'DD',0,'','tareaExterna.cancelarTarea','',1,'EXTTareaProcedimiento',3,'','', null,'',''),
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ101_RecepcionCertificacionNotarial','','','','','',0,'Recepción certificación notarial',0,'DD',0,'','tareaExterna.cancelarTarea','',1,'EXTTareaProcedimiento',3,'','', null,'',''),
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ101_RemitirCertificadoLetrado','','','','','',0,'Remitir certificado al letrado',0,'DD',0,'','tareaExterna.cancelarTarea','',1,'EXTTareaProcedimiento',3,'','', null,'',''),
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ101_ConfirmarRecepcionCertificado','','','','','',0,'Confirmar recepción certificado',0,'DD',0,'','tareaExterna.cancelarTarea','',1,'EXTTareaProcedimiento',3,'','', null,'','')
	);
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS('','','CJ101_EmitirCertificado','2*24*60*60*1000L',0,0,'DD'),
		T_TIPO_PLAZAS('','','CJ101_LegitimacionNotarialFirma','1*24*60*60*1000L',0,0,'DD'),
		T_TIPO_PLAZAS('','','CJ101_RecepcionCertificacionNotarial','3*24*60*60*1000L',0,0,'DD'),
		T_TIPO_PLAZAS('','','CJ101_RemitirCertificadoLetrado','1*24*60*60*1000L',0,0,'DD'),
		T_TIPO_PLAZAS('','','CJ101_ConfirmarRecepcionCertificado','5*24*60*60*1000L',0,0,'DD')
	); 
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI ('CJ101_EmitirCertificado',0,'label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Deber&aacute; emitirse el certificado de libertad de arrendamiento con los campos actualizados que correspondan.</p><p style="margin-bottom: 10px">Se informar&aacute; de la fecha de creaci&oacute;n del certificado.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla se lanzar&aacute; la tarea "Enviar para legitimación de firma".</p></div>','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_EmitirCertificado',1,'date','fechaEmision','Fecha emisión certificado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','',0,'DD'),
		T_TIPO_TFI ('CJ101_EmitirCertificado',2,'textarea','observaciones','Observaciones','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_LegitimacionNotarialFirma',0,'label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Antes de dar por finalizada esta tarea, deberá enviar el certificado al Notario para la legitimación de la firma.</p><p style="margin-bottom: 10px">Se informará la fecha del envío.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, se lanzará la tarea "Recepción certificación notarial".</p></div>','','','','',1,'DD'),
		T_TIPO_TFI ('CJ101_LegitimacionNotarialFirma',1,'date','fechaEnvio','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','',0,'DD'),
		T_TIPO_TFI ('CJ101_LegitimacionNotarialFirma',2,'textarea','observaciones','Observaciones','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RecepcionCertificacionNotarial',0,'label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Una vez recibido el certificado correctamente legitimado, deber&aacute; indicarse la fecha de recepci&oacute;n del mismo.</p><p style="margin-bottom: 10px">En el campo Observaciones informar de cualquier aspecto relevante que le interese quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla se lanzar&aacute;n  la tarea "Enviar certificado al letrado".</p></div>','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RecepcionCertificacionNotarial',1,'date','fechaRecepcion','Fecha recepción','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RecepcionCertificacionNotarial',2,'textarea','observaciones','Observaciones','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RemitirCertificadoLetrado',0,'label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se enviar&aacute; el certificado de libertad de arrendamiento con la firma legitimada al letrado, indic&aacute;ndose la fecha del env&iacute;o.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, se lanzar&aacute; la tarea "Confirmar recepci&oacute;n certificado" al letrado.</p></div>','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RemitirCertificadoLetrado',1,'date','fechaEnvio','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','',0,'DD'),
		T_TIPO_TFI ('CJ101_RemitirCertificadoLetrado',2,'textarea','observaciones','Observaciones','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_ConfirmarRecepcionCertificado',0,'label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se informar&aacute; la fecha de recepci&oacute;n del certificado.</p><p style="margin-bottom: 10px">En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellenada esta pantalla, finalizar&aacute; el tr&aacute;mite.</p></div>','','','','',0,'DD'),
		T_TIPO_TFI ('CJ101_ConfirmarRecepcionCertificado',1,'date','fechaRecepcion','Fecha recepción letrado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','','',0,'DD'),
		T_TIPO_TFI ('CJ101_ConfirmarRecepcionCertificado',2,'textarea','observaciones','Observaciones','','','','',0,'DD')
