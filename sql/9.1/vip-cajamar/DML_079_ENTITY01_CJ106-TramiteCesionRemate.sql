...
DECLARE
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		T_TIPO_TAP(V_COD_PROCEDIMIENTO,'CJ106_BPMTramiteAdjudicacion','','','','','CJ005',0,'Trámite de Adjudicación',0,'DD',0,'','','',0,'EXTTareaProcedimiento',0,'','', null,'',''),
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS('','','CJ106_AperturaPlazo','valoresBPMPadre[''CJ004_SenyalamientoSubasta''] == null ? 5*24*60*60*1000L : damePlazo(valoresBPMPadre[''CJ004_SenyalamientoSubasta''][''fechaSenyalamiento''])+5*24*60*60*1000L',0,0,'DD'),
