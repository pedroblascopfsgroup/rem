...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
        ...
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ 'comprobarInformadoComboTributacion() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Es necesario informar el tipo de tributaci&oacute;n</div>''',
        ...
        /*TAP_VIEW.....................:*/ null,
        /*TAP_SCRIPT_VALIDACION........:*/ 'comprobarExisteDocumentoCOMAD() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Debe adjuntar el documento Comunicación Adicional.</div>''',
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
        /*TAP_SCRIPT_DECISION..........:*/ null,
        /*DD_TPO_ID_BPM(FK)............:*/ null,
        /*TAP_SUPERVISOR,..............:*/ '0',
        ...
        /*TAP_VIEW.....................:*/ 'plugin/cajamar/tramiteAdjudicacion/confirmarContabilidad.jsp',
        /*TAP_SCRIPT_VALIDACION........:*/ null,
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
        /*TAP_SCRIPT_DECISION..........:*/ null,
        /*DD_TPO_ID_BPM(FK)............:*/ null,
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TIPO_TFI('H005_notificacionDecretoAdjudicacionAEntidad','4','combo','comboAdicional','Comunicación adicional requerida','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','DD'),
		T_TIPO_TFI('H005_notificacionDecretoAdjudicacionAEntidad','5','date','fechaLimite','Fecha límite comunicación','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','DD'),
		...
		T_TIPO_TFI('H005_ConfirmarTestimonio','3','combo','comboAdicional','Comunicación adicional requerida','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','DD'),
		T_TIPO_TFI('H005_ConfirmarTestimonio','4','date','fechaLimite','Fecha límite comunicación','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarTestimonio','5','combo','comboOcupantes','Constancia de ocupantes','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','DD'),
		...
		T_TIPO_TFI('H005_ConfirmarContabilidad','2','currency','nominal','Nominal','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''nominal'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','3','currency','intereses','Intereses','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''intereses'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','4','currency','demora','Demora','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''demora'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','5','currency','gAbogado','Gastos abogado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''gAbogado'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','6','currency','gProcurador','Gastos procurador','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''gProcurador'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','7','currency','gOtros','Otros gastos','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''gOtros'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','8','currency','aOpTramite','A op. trámite','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''aOpTramite'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','9','currency','tEntregas','Total entregas a pendiente','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''tEntregas'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','10','combo','cbTipoEntrega','Tipo de entrega','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''cbTipoEntrega'']','DDAdjContableTipoEntrega','0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','11','combo','cbConcepto','Concepto de entrega','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''cbConcepto'']','DDAdjContableConceptoEntrega','0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','12','currency','paseFallido','Pase a fallido','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''paseFallido'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','13','currency','qNominal','Quita Nominal','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''qNominal'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','14','currency','qIntereses','Quita Intereses','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''qIntereses'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','15','currency','qDemoras','Quita Demoras','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''qDemoras'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','16','currency','tQuitasGastos','Total Quita Gastos','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''tQuitasGastos'']',null,'0','DD'),
		T_TIPO_TFI('H005_ConfirmarContabilidad','17','currency','obsContables','Observaciones contables','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','valores[''H005_RevisarInfoContable''][''observaciones'']',null,'0','DD'),
