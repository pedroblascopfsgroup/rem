...
DECLARE
    ...
    */
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
      T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H026',
        /*TAP_CODIGO...................:*/ 'H026_BPMProvisionFondos',
        /*TAP_VIEW.....................:*/ null,
    ...
    */
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(
          /*DD_JUZ_ID(FK)............:*/ null,
          /*DD_PLA_ID(FK)............:*/ null,
          /*TAP_ID(FK)...............:*/ 'H026_BPMProvisionFondos',
    ...
    */
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI (
            /*DD_TAP_ID..............:*/ 'H026_InterposicionDemanda',
            /*TFI_ORDEN..............:*/ '8',
            /*TFI_TIPO...............:*/ 'combo',
...
BEGIN
	 ...
	 * -------
	 */
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO tpo SET tpo.DD_TPO_DESCRIPCION = ''P. verbal - HCJ'', tpo.DD_TPO_XML_JBPM      = ''hcj_procedimientoVerbal'' WHERE tpo.DD_TPO_CODIGO = ''H026''';
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap SET tap.TAP_SCRIPT_DECISION = ''valores[''''H026_InterposicionDemanda''''][''''provisionFondos''''] == DDSiNo.SI ? ''''conProvision'''' : ''''sinProvision'''''' WHERE tap.TAP_CODIGO = ''H026_InterposicionDemanda''';
	EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap SET tap.TAP_SCRIPT_VALIDACION = ''!asuntoConProcurador() ? ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><p>&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe registrar el procurador que representa a la entidad en la ficha del asunto correspondiente.</p></div>'''' : (comprobarExisteDocumentoEDCSDE() ? null : ''''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><div id="permiteGuardar"><p>Es necesario adjuntar el documento Escrito de demanda completo + copia sellada de la demanda.</p></div></div>'''')'' WHERE tap.TAP_CODIGO = ''H026_InterposicionDemanda''';
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi SET tfi.TFI_ORDEN = 9 WHERE tfi.TFI_ID  = (SELECT tfi_id FROM '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS tfi_i, '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO tap WHERE tfi_i.TFI_NOMBRE = ''observaciones'' AND tfi_i.TAP_ID = tap.TAP_ID AND tap.TAP_CODIGO = ''H026_InterposicionDemanda'')';
