...
DECLARE
    ...
    V_ESQUEMA_02 VARCHAR2(25 CHAR):= '#ESQUEMA02#'; -- Configuración para Esquema Multi-Entidad
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.FUN_PEF... Comprobaciones previas entidad01'); 
