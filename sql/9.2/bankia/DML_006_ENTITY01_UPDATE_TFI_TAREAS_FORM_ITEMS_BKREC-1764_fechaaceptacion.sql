...
BEGIN	
		...
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS SET TFI_ERROR_VALIDACION = null,TFI_VALIDACION = null WHERE TFI_LABEL LIKE ''%Fecha aceptación del cargo de la Adm. Concursal%''';
