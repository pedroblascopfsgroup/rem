...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_MNL_MOTIVO_NO_LITIGAR';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_MNL_MOTIVO_NO_LITIGAR';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_MNL_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('CARANT', 'Cargas anteriores', 'Cargas anteriores')
     ,T_TIPO('1HIBAN', '1ª Hipoteca Bankia', '1ª Hipoteca Bankia')
     ,T_TIPO('INSOLV', 'Insolvencia', 'Insolvencia')
     ,T_TIPO('CONCUR', 'Concurso', 'Concurso')
     ,T_TIPO('PRECON', 'Preconcurso', 'Preconcurso')
     ,T_TIPO('GARSGR', 'Garantia SGR', 'Garantia SGR')
     ,T_TIPO('OGAREA', 'Otra garantía real', 'Otra garantía real')
     ,T_TIPO('IMPDEU', 'Importe deuda', 'Importe deuda')
     ,T_TIPO('NOCUPO', 'No cumple políticas', 'No cumple políticas')
     ,T_TIPO('OTROS', 'Otros', 'Otros')
    ); 
    V_TMP_TIPO T_TIPO;
