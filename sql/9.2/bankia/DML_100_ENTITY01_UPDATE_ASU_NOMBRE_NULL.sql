...
--## PRODUCTO=NO
--##
--## Finalidad: Actualiza ASU_NOMBRE cuando tiene valor NULL.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
BEGIN		
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] '||V_ESQUEMA||'... UPDATEANDO ASU_ASUNTOS.ASU_NOMBRE WHERE ASU_NOMBRE IS NULL');
	...
	EXIT WHEN CUR%NOTFOUND;
		...
		V_SQL := 'UPDATE '||V_ESQUEMA||'.ASU_ASUNTOS
			SET ASU_NOMBRE='''||R_ASUNTO.nuevo_nombre||'''
	...
	EXIT WHEN CUR_PRC_PER%NOTFOUND;
		...
		V_SQL := 'UPDATE '||V_ESQUEMA||'.ASU_ASUNTOS
			SET ASU_NOMBRE='''||R_ASUNTO_PRC_PER.nuevo_nombre||'''
    ...
    DBMS_OUTPUT.PUT_LINE('[FIN] '||V_ESQUEMA||'... UPDATEADO ASU_ASUNTOS.ASU_NOMBRE WHERE ASU_NOMBRE IS NULL');
