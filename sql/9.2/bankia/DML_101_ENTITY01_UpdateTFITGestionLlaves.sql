...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Realiza el update de tfi de una tarea del mismo tramite
...
DECLARE
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        T_TIPO_TFI('P417_RegistrarEnvioLlaves','0','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por completada esta tarea deber&aacute; de consignar los campos “Nombre del primer depositario” y “Fecha env&iacute;o de llaves letrado”.</p><p style="margin-bottom: 10px">En el campo observaciones consignar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>','RECOVERY-16')
    ...
    FOR I IN V_TIPO_TFI.FIRST .. V_TIPO_TFI.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN        
          ...
          V_SQL := 'UPDATE '||V_ESQUEMA||'.'||VAR_TABLENAME||' SET TFI_LABEL=''' || REPLACE(TRIM(V_TMP_TIPO_TFI(3)),'''','''''') || ''',' ||
