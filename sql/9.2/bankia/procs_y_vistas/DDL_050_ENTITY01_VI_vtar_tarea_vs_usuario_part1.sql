...
DECLARE
    ...
    V_NOMBRE_VISTA VARCHAR2(30 CHAR):= 'vtar_tarea_vs_usuario_part1';
...
AS
   SELECT tar_id, usu_pendientes, NVL (usu_alerta, -1) usu_alerta, NVL (usu_supervisor, -1) usu_supervisor, dd_tge_id_alerta, dd_tge_id_pendiente, NULL zon_cod, NULL pef_id
