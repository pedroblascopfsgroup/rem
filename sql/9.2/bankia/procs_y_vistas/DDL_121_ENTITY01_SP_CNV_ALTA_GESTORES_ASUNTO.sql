...
--## PRODUCTO=NO
--## 
--## Finalidad: CNV_ALTA_GESTORES_ASUNTO
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
--*/
...
BEGIN
  ...
  SELECT V_FECHA_RECH, D.CODIGO_PROCEDIMIENTO_NUSE, D.CODIGO_EXPEDIENTE_NUSE, D.FECHA_PASE_A_LITIGIO, D.TIPO_PROCEDIMIENTO, D.COD_LETRADO, D.COD_PROCURADOR, D.GESTOR, D.NUMERO_EXP_NUSE, D.FECHA_PROCESO
  FROM #ESQUEMA#.CNV_AUX_ALTA_PRC D
