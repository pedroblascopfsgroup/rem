...
DECLARE
    ...
    V_TIPO_VALOR T_ARRAY_TFA := T_ARRAY_TFA(
		...
		T_TIPO_VALOR('H031','H031_ContabilizarConvenio','TGADMCON','SUADMCON')
		,T_TIPO_VALOR('H025','H025_ElevarComite','TGEANREC','SUANREC')
		,T_TIPO_VALOR('H025','H025_RegistrarRespuestaComite','TGEANREC','SUANREC')
		,T_TIPO_VALOR('CJ002','CJ002_ValidarFinSeguimiento','TGESCHRE','SUCHRE')
		,T_TIPO_VALOR('CJ001','CJ001_AdmisionJuzgado','TDIRTERRIE','DIRRIETERGCC')
		,T_TIPO_VALOR('CJ001','CJ001_ResolucionFirme','TDIRTERRIE','DIRRIETERGCC')
		,T_TIPO_VALOR('CJ001','CJ001_RegistrarFormalizacionVenta','TDIRTERRIE','DIRRIETERGCC')
		,T_TIPO_VALOR('CJ001','CJ001_ConfirmarContabilidad','TDIRTERRIE','DIRRIETERGCC')
		,T_TIPO_VALOR('CJ005','CJ005_RegistrarFechaReunion','TGESRIE','DIRTERRIE')
