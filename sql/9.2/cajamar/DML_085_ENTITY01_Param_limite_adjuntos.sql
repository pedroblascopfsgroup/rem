...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('fichero.persona.limite.gestorDoc','20971520', 'Limite maximo permitido en bytes para la subida de ficheros adjuntos de personas'),
      T_FUNCION('fichero.contrato.limite.gestorDoc','20971520', 'Limite maximo permitido en bytes para la subida de ficheros adjuntos de contrato'),
      T_FUNCION('fichero.expediente.limite.gestorDoc','20971520', 'Limite maximo permitido en bytes para la subida de ficheros adjuntos de expedientes'),
      T_FUNCION('fichero.asunto.limite.gestorDoc','20971520', 'Limite maximo permitido en bytes para la subida de ficheros adjuntos de asuntos')
    ); 
