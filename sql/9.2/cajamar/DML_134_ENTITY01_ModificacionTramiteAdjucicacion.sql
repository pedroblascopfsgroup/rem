...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       ...
       ,T_TIPO_TAP('H005','H005_RegistrarPresentacionHacienda','plugin/cajamar/tramiteAdjudicacion/registrarPresentacionHacienda',null,'valores[''H005_RegistrarPresentacionHacienda''][''comboLiquidacion''] == ''01'' ? (existeAdjuntoUG(''CALHAC'', ''PRC'') ? ((valores[''H005_RegistrarPresentacionHacienda''][''comboLiquidacion''] == ''01'' && valores[''H005_RegistrarPresentacionHacienda''][''fechaPresentacion''] == null) ? ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">El campo fecha de presentacion es obligatorio si Liquidaci&oacute;n testimonio es Si</div>'' : null) : (existeAdjuntoUGMensaje(''CALHAC'',''PRC''))) : null',null,null,'0','Registrar presentación en hacienda','0','PRODUCTO-1094','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'CJ-811',null,'CJ-SAREO',null)
