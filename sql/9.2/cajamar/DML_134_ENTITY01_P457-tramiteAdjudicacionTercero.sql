...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P457','T. de Adjudicación Terceros','T. de Adjudicación Terceros',null,'hcj_tramiteAdjudicacionTerceros','0','PRODUCTO-1095','0','AP',null,null,'1','MEJTipoProcedimiento','1','1')
    ); 
