...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		T_TIPO_TAP('P458','P458_ObtenerValidacionComite','plugin/cajamar/tramiteObtenerValidacionComite/obtenerValidacionComite',null,'(valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''02'' && valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == null) ? ''El campo motivo de no pagar tasa es obligatorio'' : null','valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''02'' ? ''rechazado'' : (valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''01'' ? ''siPagarTasa'' : ''noPagarTasa'')',null,'0','Obtener Validación Comité','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TGCTRGE',null,'DRECU',null)
	...
	,T_TIPO_TFI('P459_ObtenerValidacionComite','2','combo','comboResultadoComite','Resultado del Comité','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'NUEVODICCIONARIO','0','PRODUCTO-1093')
	,T_TIPO_TFI('P459_ObtenerValidacionComite','3','combo','comboMotivoImpago','Motivo de No Pagar la Tasa',null,null,null,'NUEVODICCIONARIO','0','PRODUCTO-1093')
