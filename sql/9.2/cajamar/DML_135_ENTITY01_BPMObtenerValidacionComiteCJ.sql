...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Obtener Validación Comité
...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P459','T. de Obtener Validación Comité','T. de Obtener Validación Comité',null,'tramiteObtenerValidacionComite','0','PRODUCTO-1093','0','AP',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		T_TIPO_TAP('P459','P459_ObtenerValidacionComite','plugin/cajamar/tramiteObtenerValidacionComite/obtenerValidacionComite',null,'(valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''NPT'' && valores[''P459_ObtenerValidacionComite''][''comboMotivoImpago''] == null) ? ''El campo motivo de no pagar tasa es obligatorio'' : null','valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''REC'' ? ''rechazado'' : (valores[''P459_ObtenerValidacionComite''][''comboResultadoComite''] == ''CSU'' ? ''siPagarTasa'' : ''noPagarTasa'')',null,'0','Obtener Validación Comité','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TGCTRGE',null,'DRECU',null)
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		...
		T_TIPO_PLAZAS(null,null,'P459_ObtenerValidacionComite','3*24*60*60*1000L','0','0','PRODUCTO-1093')
