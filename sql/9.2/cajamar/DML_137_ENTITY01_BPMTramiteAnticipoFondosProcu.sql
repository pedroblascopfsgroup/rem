...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P460','T. de anticipo de fondos y pago de suplidos','T. de anticipo de fondos y pago de suplidos',null,'hcj_anticipoFondosProcu','0','PRODUCTO-1315','0','TR_REM',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P460','P460_SolicitarAnticipoFondos',null,null,'!validarP460SolicitudFondos() ? ''Los campos N&uacute;mero de auto, Importe de la adjudicaci&oacute;n, Tipo de impuesto a liquidar, Tipo del impuesto de Transmisiones patrimoniales, Importe del impuesto de transmisiones Patrimoniales y Fecha fin de plazo de liquidaci&oacute;n del impuesto son obligatorios.'' : valores[''P460_SolicitarAnticipoFondos''][''tipoSolicitud''] == null ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Es necesario indicar el tipo de solicitud.</p></div>'' : valores[''P460_SolicitarAnticipoFondos''][''tipoSolicitud''] == "ANTFON" ? existeAdjuntoUG(''PRVFND'', ''PRC'') ? null : existeAdjuntoUGMensaje(''PRVFND'',''PRC'') : existeAdjuntoUG(''DOCSUP'', ''PRC'') ? null : existeAdjuntoUGMensaje(''DOCSUP'',''PRC'')',null,null,'0','Solicitar anticipo de Fondos o pago de suplidos','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_VisarSolicitud',null,null,'valores[''P460_VisarSolicitud''][''fecha''] == null || valores[''P460_VisarSolicitud''][''fecha''] == '''' ? ''El campo "Fecha" es obligatorio.'' : null','valores[''P460_VisarSolicitud''][''conforme''] == DDSiNo.NO ? ''KO'' : (valoresBPMPadre[''H005_ConfirmarTestimonio''] != null ? ''SI'' : ''NO'')',null,'0','Visar solicitud','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_RevisarSolicitud',null,null,null,'valores[''P460_RevisarSolicitud''][''motivo'']==''SUB'' ? ''subsanar'' : (bienConCesionRemate() ? ''cesion'' : ''otro'')',null,'0','Revisar solicitud','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_AprobarSolicitudFondos',null,null,null,'valores[''P460_AprobarSolicitudFondos''][''confirmacion'']==DDSiNo.SI ? ''sinatribuciones'' : valores[''P460_AprobarSolicitudFondos''][''resultado'']',null,'0','Aprobar solicitud de fondos','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_AprobarSolicitudInsc',null,null,null,'valores[''P460_AprobarSolicitudInsc''][''resultado'']',null,'0','Aprobar solicitud para inscripción','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_ConfirmarSolicitud',null,null,null,'valores[''P460_ConfirmarSolicitud''][''resultado''] == ''ACEPTADO'' ? ''aceptado'' : ''denegado''',null,'0','Autorizar solicitud','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_RealizarTransferencia',null,null,null,null,null,'0','Realizar transferencia','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_ConfirmarTransferencia',null,null,null,'valores[''P460_SolicitarAnticipoFondos''][''tipoSolicitud'']',null,'0','Confirmar transferencia realizada','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('P460','P460_AdjuntarFactura',null,'existeAdjuntoUG(''FACJUS'', ''PRC'') ? null : existeAdjuntoUGMensaje(''FACJUS'',''PRC'')',null,'valores[''P460_SolicitarAnticipoFondos''][''tipoSolicitud'']',null,'0','Adjuntar factura a nombre de la entidad','0','PRODUCTO-1315','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ); 
