...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P460','T. de anticipo de fondos procurador','T. de anticipo de fondos procurador',null,'hcj_anticipoFondosProcu','0','PRODUCTO-1315','0','TR_REM',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
