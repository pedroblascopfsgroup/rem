...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('H001','H001_BPMAnticipoFondos',null,null,null,null,'P460','0','Se inicia el trámite de anticipo de fondos y pago de suplidos','0','PRODUCTO-1794','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
	   ,T_TIPO_TAP('H001','H001_BPMProvisionFondos',null,null,null,null,'HC103','0','Se inicia el trámite de provisión de fondos','0','PRODUCTO-1794','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS(null,null,'H001_BPMAnticipoFondos','300*24*60*60*1000L','0','0','PRODUCTO-1794')
	   ,T_TIPO_PLAZAS(null,null,'H001_BPMProvisionFondos','300*24*60*60*1000L','0','0','PRODUCTO-1794')
	); 
	...
	T_TIPO_TFI('H001_BPMAnticipoFondos','0','label','titulo','<div style="FONT-SIZE: 8pt; MARGIN-BOTTOM: 30px; FONT-FAMILY: Arial" align="justify"><p style="font-family: Arial; text-align: justify; margin-bottom: 10px; ">Se inicia el Trámite Anticipo de fondos y pago de suplidos.</p></div>',null,null,null,null,'0','PRODUCTO-1794')
   ,T_TIPO_TFI('H001_BPMProvisionFondos','0','label','titulo','<div style="FONT-SIZE: 8pt; MARGIN-BOTTOM: 30px; FONT-FAMILY: Arial" align="justify"><p style="font-family: Arial; text-align: justify; margin-bottom: 10px; ">Se inicia el Trámite Provisión de fondos - HCJ.</p></div>',null,null,null,null,'0','PRODUCTO-1794')
