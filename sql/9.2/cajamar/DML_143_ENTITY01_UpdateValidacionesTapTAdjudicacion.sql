...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Actualiza el tramite Adjudicacion (CENTROPROCURA)
...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP( 
       T_TIPO_TAP('H005','H005_ConfirmarTestimonio','valores[''H005_ConfirmarTestimonio''][''comboSubsanacion'']==DDSiNo.SI ? ''SI'' : (existeTipoGestor("CENTROPROCURA") ? ''ANTI'' : ''NO'')','PRODUCTO-1794')
    );
