...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Actualiza el procedimiento Monitorio (CENTROPROCURA)
...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP( 
       T_TIPO_TAP('H022','H022_InterposicionDemanda','valores[''H022_InterposicionDemanda''][''provisionFondos''] == DDSiNo.NO ? ''No'' : (existeTipoGestor("CENTROPROCURA") ? ''Anti'' : ''Si'')','PRODUCTO-1975')
      ,T_TIPO_TAP('H022','H022_ConfirmarNotificacionReqPago','valores[''H022_ConfirmarNotificacionReqPago''][''comboResultado''] == DDPositivoNegativo.POSITIVO ? ''SI'' : (existeTipoGestor("CENTROPROCURA") ? ''PER'' : ''NO'')','PRODUCTO-1975')
    );
