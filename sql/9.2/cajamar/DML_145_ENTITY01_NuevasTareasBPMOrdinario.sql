...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - POrdinario (Nuevas tareas que lanzan bpm)
...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
        T_TIPO_TAP('H024','H024_BPMAnticipoFondos',null,null,null,null,'P460','0','Se inicia el trámite de anticipo de fondos y pago de suplidos','0','PRODUCTO-1975','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
       ,T_TIPO_TAP('H024','H024_BPMTramiteNotificacionPersonal',null,null,null,null,'HC108','0','Se inicia el trámite de notificación personal','0','PRODUCTO-1975','0',null,null,null,'1','EXTTareaProcedimiento','3',null,null,null,null,null)
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
        T_TIPO_PLAZAS(null,null,'H024_BPMAnticipoFondos','300*24*60*60*1000L','0','0','PRODUCTO-1975')
       ,T_TIPO_PLAZAS(null,null,'H024_BPMTramiteNotificacionPersonal','300*24*60*60*1000L','0','0','PRODUCTO-1975')
    ); 
    ...
    T_TIPO_TFI('H024_BPMAnticipoFondos','0','label','titulo','<div style="FONT-SIZE: 8pt; MARGIN-BOTTOM: 30px; FONT-FAMILY: Arial" align="justify"><p style="font-family: Arial; text-align: justify; margin-bottom: 10px; ">Se inicia el trámite anticipo de fondos y pago de suplidos.</p></div>',null,null,null,null,'0','PRODUCTO-1975')
   ,T_TIPO_TFI('H024_BPMTramiteNotificacionPersonal','0','label','titulo','<div style="FONT-SIZE: 8pt; MARGIN-BOTTOM: 30px; FONT-FAMILY: Arial" align="justify"><p style="font-family: Arial; text-align: justify; margin-bottom: 10px; ">Se inicia el trámite notificación personal - HCJ.</p></div>',null,null,null,null,'0','PRODUCTO-1975')
