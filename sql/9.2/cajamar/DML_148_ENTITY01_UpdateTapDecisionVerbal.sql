...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP( 
       T_TIPO_TAP('H026','H026_InterposicionDemanda','valores[''H026_InterposicionDemanda''][''provisionFondos''] == DDSiNo.SI ? (existeTipoGestor("CENTROPROCURA") ? ''conAnticipo'' : ''conProvision'') : ''sinProvision''','PRODUCTO-1975')
      ,T_TIPO_TAP('H026','H026_ConfirmarNotifiDemanda','valores[''H026_ConfirmarNotifiDemanda''][''comboResultado''] == DDPositivoNegativo.POSITIVO ? ''SI'' : (existeTipoGestor("CENTROPROCURA") ? ''PER'' : ''NO'')','PRODUCTO-1975')
    );
