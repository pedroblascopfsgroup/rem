...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		T_TIPO_TAP('CJ020','CJ020_ConfirmarNotifiReqPago' ,null ,null ,'((valores[''CJ020_ConfirmarNotifiReqPago''][''comboConfirmacionReqPago''] == DDPositivoNegativo.POSITIVO) && (valores[''CJ020_ConfirmarNotifiReqPago''][''fecha''] == null))?''tareaExterna.error.PGENERICO_ConfirmarNotificacion.fechaOblgatoria'':null' ,'valores[''CJ020_ConfirmarNotifiReqPago''][''comboConfirmacionReqPago''] == DDPositivoNegativo.POSITIVO ? ''SI'' : ''NO''' ,null ,'0','Confirmar notificación requerimiento de pago' ,'0','RECOVERY-2026','0' ,null ,null ,1,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ020','CJ020_ConfirmarSiExisteOposicion' ,'plugin/cajamar/ejecucionTituloNoJudicial/confirmarSiExisteOposicion' ,null ,'((valores[''CJ020_ConfirmarSiExisteOposicion''][''comboConfirmacion''] == DDSiNo.SI) && ((valores[''CJ020_ConfirmarSiExisteOposicion''][''fecha''] == null)))?''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Debe indicar la fecha</div>'':null' ,'valores[''CJ020_ConfirmarSiExisteOposicion''][''comboConfirmacion''] == DDSiNo.SI ? ''SI'' : ''NO''' ,null ,'0','Confirmar si existe oposición' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ020','CJ020_RegistrarCelebracionVista' ,null ,null ,null ,null ,null ,'0','Registrar celebración vista' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,1,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ020','CJ020_ResolucionFirme' ,null ,null ,null ,null ,null ,'0','Resolución firme' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,1,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ020','CJ020_JudicialDecision' ,null ,null ,null ,null ,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
