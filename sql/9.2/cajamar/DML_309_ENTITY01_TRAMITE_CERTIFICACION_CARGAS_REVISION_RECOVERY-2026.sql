...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('CJ030','CJ030_SolicitudCertificacion' ,null ,null ,null ,null ,null ,'0','Solicitud de certificación de dominios y cargas' ,'0','RECOVERY-2026','0' ,null ,null ,1,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null),
		T_TIPO_TAP('CJ030','CJ030_SolicitarInformacionCargasAnt' ,null ,null ,'((valores[''CJ030_SolicitarInformacionCargasAnt''][''comboResultado''] == DDSiNo.SI) && (valores[''CJ030_SolicitarInformacionCargasAnt''][''fecha''] == null))?''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Debe introducir la fecha de presentaci&oacute;n</div>'':null' ,'valores[''CJ030_SolicitarInformacionCargasAnt''][''comboResultado''] == DDSiNo.SI ? ''SI'' : ''NO''' ,null ,'0','Solicitar información de cargas anteriores' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ030','CJ030_RequerirInfoFalta' ,null ,null ,null ,null ,null ,'0','Requerir información que falta' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ030','CJ030_RegistrarInformacionCargasAnt' ,null ,null ,null ,'valores[''CJ030_RegistrarInformacionCargasAnt''][''comboCompletitud''] == DDCompletitud.COMPLETO ? ''Completo'' : ''Incompleto''' ,null ,'0','Registrar recepción información cargas anteriores' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		...
		T_TIPO_TAP('CJ030','CJ030_ActualizarDatosTerceria' ,null ,null ,null ,null ,null ,'0','Actualizar datos y estudiar tercería mejor derecho' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ030','CJ030_ActualizaDatosAnteriores' ,null ,null ,null ,null ,null ,'0','Actualizar datos anteriores' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ030','CJ030_CertificacionDecision' ,null ,null ,null ,null ,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null)
    );
