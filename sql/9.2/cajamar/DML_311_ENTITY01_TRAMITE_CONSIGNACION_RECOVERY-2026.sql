...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('CJ064','CJ064_solicitarAutorizacionConsignacionSareb' ,null ,'comprobarExisteDocumentoSOLCONS() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Debe adjuntar el documento "Solicitud de consignaci&oacute;n".</div>''' ,null ,null ,null ,'0','Solicitar autorización de consignación' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ064','CJ064_resultadoSolicitudConsignacion' ,null ,null ,null ,'valores[''CJ064_resultadoSolicitudConsignacion''][''resultado''] == ''ACEPTADO'' ? ''aceptado'' : ''denegado''' ,null ,'0','Autorizar solicitud' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ064','CJ064_confirmarRealizacionConsignacion' ,null ,'comprobarExisteDocumentoJUSPG() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Es necesario adjuntar el justificante de pago</div>''' ,null ,null ,null ,'0','Confirmar la realización de consignación' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ064','CJ064_presentacionJuzgado' ,null ,'comprobarExisteDocumentoESCPRJUZ() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Es necesario adjuntar el escrito de presentaci&oacute;n en el juzgado</div>''' ,null ,null ,null ,'0','Presentación al juzgado' ,'0','RECOVERY-2026','0' ,null ,null ,1,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null),
		T_TIPO_TAP('CJ064','CJ064_ConsignacionDecision' ,null,null ,null ,null,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS(null ,null ,'CJ064_solicitarAutorizacionConsignacionSareb','2*24*60*60*1000L' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ064_resultadoSolicitudConsignacion','3*24*60*60*1000L' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ064_confirmarRealizacionConsignacion','valoresBPMPadre[''CJ003_SenyalamientoSubasta''] != null ? damePlazo(valoresBPMPadre[''CJ003_SenyalamientoSubasta''][''fechaSenyalamiento'']) - 5*24*60*60*1000L : (valoresBPMPadre[''CJ070_SenyalamientoSubasta''] != null ? damePlazo(valoresBPMPadre[''CJ070_SenyalamientoSubasta''][''fechaSenyalamiento'']) - 5*24*60*60*1000L : (15*24*60*60*1000L))' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ064_presentacionJuzgado','valoresBPMPadre[''CJ003_SenyalamientoSubasta''] != null ? damePlazo(valoresBPMPadre[''CJ003_SenyalamientoSubasta''][''fechaSenyalamiento'']) : (valoresBPMPadre[''CJ070_SenyalamientoSubasta''] != null ? damePlazo(valoresBPMPadre[''CJ070_SenyalamientoSubasta''][''fechaSenyalamiento'']) : (10*24*60*60*1000L))' ,'0','0','RECOVERY-2026')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		T_TIPO_TFI('CJ064_solicitarAutorizacionConsignacionSareb','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea, deber&aacute; adjuntar al procedimiento el documento por el que requiere la autorizaci&oacute;n para la consignaci&oacute;n e informar de la fecha en la que realiza la solicitud.</p><p style="margin-bottom: 10px">En el campo Observaciones informar de cualquier aspecto relevante que le interesa quede reflejado en ese punto.</p><p style="margin-bottom: 10px">La siguiente tarea será "Resultado de la solicitud de consignación".</p></div>',null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_solicitarAutorizacionConsignacionSareb','1','date' ,'fecha','Fecha' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_solicitarAutorizacionConsignacionSareb','2','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_resultadoSolicitudConsignacion','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">A trav&eacute;s de esta pantalla deber&aacute; dejar constancia del resultado de la solicitud de consignaci&oacute;n formulada por el letrado, as&iacute; como la fecha en la que toma esta decisi&oacute;n.</p><p style="margin-bottom: 10px">En el campo Observaciones informar de cualquier aspecto relevante que le interesa quede reflejado en ese punto.</p><p style="margin-bottom: 10px">En el caso que el resultado sea aceptada, se lanzará  la tarea "Confirmar la realización de la consignación" y, en el caso que el resultado fuera denegada, se le abrirá una tarea en la que propondrá, según su criterio, la siguiente actuación al responsable de la entidad.</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_resultadoSolicitudConsignacion','1','combo' ,'resultado','Resultado' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,'DDAceptadoDenegado','0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_resultadoSolicitudConsignacion','2','date' ,'fecha','Fecha' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_resultadoSolicitudConsignacion','3','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_confirmarRealizacionConsignacion','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea, deber&aacute; realizar la consignaci&oacute;n mediante el pago correspondiente y deber&aacute; adjuntar el justificante de pago para que el letrado pueda presentar al juzgado a partir de ese momento.</p><p style="margin-bottom: 10px">En el campo Observaciones informar de cualquier aspecto relevante que le interesa quede reflejado en ese punto.</p><p style="margin-bottom: 10px">La siguiente tarea será "Presentación en el juzgado".</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_confirmarRealizacionConsignacion','1','date' ,'fecha','Fecha' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_confirmarRealizacionConsignacion','2','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_presentacionJuzgado','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por terminada esta tarea, deber&aacute; presentar en el Juzgado en tiempo y forma la presentaci&oacute;n de la consignaci&oacute;n adjuntando el escrito en el Juzgado como documento que acredite este hecho.</p><p style="margin-bottom: 10px">En el campo Observaciones informar de cualquier aspecto relevante que le interesa quede reflejado en ese punto.</p><p style="margin-bottom: 10px">Una vez completada esta tarea, finalizará el trámite.</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_presentacionJuzgado','1','date' ,'fechaPresentacion','Fecha presentacion' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ064_presentacionJuzgado','2','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026')
    );
