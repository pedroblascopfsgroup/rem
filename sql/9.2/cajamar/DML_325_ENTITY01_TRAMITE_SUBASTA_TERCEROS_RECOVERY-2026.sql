...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('CJ070','CJ070_SenyalamientoSubasta' ,null ,'comprobarMinimoBienLote() ? (existeAdjuntoUG("ESRAS","PRC") ? null : existeAdjuntoUGMensaje("ESRAS","PRC")) : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Al menos un bien debe estar asignado a un lote</div>''' ,null ,null ,null ,'0','Comunicación con señalamiento de subasta' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ070','CJ070_CelebracionDecision' ,null ,null ,null ,null ,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_RevisarDocumentacion' ,null ,null ,null ,null ,null ,'0','Revisar documentación' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_AdjuntarNotasSimples' ,null ,null ,null ,null ,null ,'0','Adjuntar notas simples' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_AdjuntarTasaciones' ,null ,null ,null ,'valores[''CJ070_AdjuntarTasaciones''][''comboInforme''] == DDSiNo.SI ?  ''SI'' : ''NO''' ,null ,'0','Adjuntar tasaciones' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_SolicitarInformeFiscal' ,null ,null ,null ,null ,null ,'0','Solicitar informe fiscal' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_AdjuntarInformeFiscal' ,null ,'comprobarExisteDocumentoIFISCAL() ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Debe adjuntar el Informe Fiscal.</div>''' ,null ,null ,null ,'0','Adjuntar informe fiscal' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ070','CJ070_ObtenerValidacionComite' ,null ,null ,null ,'valores[''CJ070_ObtenerValidacionComite''][''comboResultado''] == ''REC'' ? ''Rechazada'' : ''Aceptada''' ,null ,'0','Obtener validación comité' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ070','CJ070_RegistrarResSuspSubasta' ,null ,null ,null ,null ,null ,'0','Registrar resolución suspensión subasta' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		...
		T_TIPO_TAP('CJ070','CJ070_ConfirmarContabilidad' ,null ,null ,null ,null ,null ,'0','Confirmar contabilidad' ,'0','RECOVERY-2026','0' ,null ,'tareaExterna.cancelarTarea' ,null,'1' ,'EXTTareaProcedimiento','3',null ,'814',null ,null,null),
		T_TIPO_TAP('CJ070','CJ070_SuspenderDecision' ,null ,null ,null ,null ,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,'814',null ,null,null)
    );
