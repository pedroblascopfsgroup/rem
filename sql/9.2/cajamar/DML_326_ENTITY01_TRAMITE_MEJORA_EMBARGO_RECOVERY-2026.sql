...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('CJ046','CJ046_solicitudMejoraEmbargo' ,null ,'comprobarExisteDocumentoEPME() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial;"><p style="margin-bottom: 10px">Para poder continuar debe adjuntar el documento "Escrito de presentaci&oacute;n".</p></div>''' ,null ,null ,null ,'0','Solicitud de mejora de embargo' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null),
		T_TIPO_TAP('CJ046','CJ046_confirmarDecretoEmbargo' ,null ,'comprobarExisteDocumentoREME() ? null : ''<div align="justify" style="font-size: 8pt; font-family: Arial;"><p style="margin-bottom: 10px">Para poder continuar debe adjuntar el documento "Resoluci&oacute;n".</p></div>''' ,null ,'valores[''CJ046_confirmarDecretoEmbargo''][''comboBienes''] == DDSiNo.SI ? ''SI'' : ''NO''' ,null ,'0','Confirmar decreto de embargo' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null),
		T_TIPO_TAP('CJ046','CJ046_registrarAnotacionRegistro' ,null ,'isBienesConFechaDecreto() && !isBienesConFechaRegistro() ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;"><div id="permiteGuardar"><p>&iexcl;Atenci&oacute;n! En  caso de que haya bienes a embargar, deber&iacute;a de marcarlos a trav&eacute;s de la pesta&ntilde;a Bienes dentro de la ficha de la propia actuaci&oacute;n.</p></div></div>o'' : null' ,null ,'valores[''CJ046_registrarAnotacionRegistro''][''comboBienes''] == DDSiNo.SI ? ''SI'' : ''NO''' ,null ,'0','Registrar anotación en registro' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null),
		T_TIPO_TAP('CJ046','CJ046_MejoraDecision' ,null ,null ,null ,null ,null ,'0','Tarea toma de decisión' ,'0','RECOVERY-2026','0' ,null ,null ,null,'0' ,'EXTTareaProcedimiento','0',null ,null,null ,null,null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS(null ,null ,'CJ046_solicitudMejoraEmbargo','4*24*60*60*1000L' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ046_confirmarDecretoEmbargo','30*24*60*60*1000L' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ046_registrarAnotacionRegistro','30*24*60*60*1000L' ,'0','0','RECOVERY-2026')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		T_TIPO_TFI('CJ046_solicitudMejoraEmbargo','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Dado que hemos tenido conocimiento de otros bienes que pertenecen al deudor/es se ha de solicitar del Juzgado proceda a la mejora de embargo sobre los indicados bienes. Pues bien se ha de indicar en este momento la fecha de presentaci&oacute;n de dicho escrito en el Juzgado.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_solicitudMejoraEmbargo','1','date' ,'fechaSol','Fecha solicitud' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_solicitudMejoraEmbargo','2','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_confirmarDecretoEmbargo','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla se ha de indicar la fecha en la que se nos notifica la Resoluci&oacute;n que ha dictado el Juzgado por la que se admite nuestra solicitud de mejora de embargo. Por otro lado indicar si existen bienes registrables y por tanto se quiere lanzar la actuaci&oacute;n "Vigilancia caducidad anotaciones de embargo" para proceder a su anotaci&oacute;n en el registro y posterior seguimiento.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Una vez rellene esta pantalla, si se ha indicado que existen bienes registrables se iniciar&aacute; la actuación "Vigilancia caducidad anotaciones de embargo". Si no hay bienes registrables se le abrir&aacute; una tarea en la que propondr&aacute;, seg&uacute;n su criterio, la siguiente actuaci&oacute;n al responsable de la entidad.</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_confirmarDecretoEmbargo','1','date' ,'fecha','Fecha' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_confirmarDecretoEmbargo','2','combo' ,'comboBienes','Existen bienes embargables' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,'DDSiNo','0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_confirmarDecretoEmbargo','3','textarea' ,'observaciones','Observaciones' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_registrarAnotacionRegistro','0','label' ,'titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla se ha de informar la fecha de anotaci&oacute;n de los embargos trabados en el Registro de la Propiedad correspondiente.</p><p style="margin-bottom: 10px">Para el supuesto de la existencia de embargo de varios bienes y que estos se encuentren inscritos en diferentes Registros de la Propiedad, se deber&aacute; informar en esta pantalla &uacute;nicamente el de la anotaci&oacute;n del primero de ellos. Se deber&aacute; abrir la pesta&ntilde;a de "Bienes" para introducir la fecha de anotaci&oacute;n en el Registro de la Propiedad de cada uno de los bienes embargados.</p><p style="margin-bottom: 10px">Para el supuesto de que se trate de embargo de bien mueble, &uacute;nicamente se deber&aacute; informar el primer campo para el supuesto de que el mismo sea inscribible en el Registro de Bienes Muebles.</p><p style="margin-bottom: 10px">El siguiente campo deber&aacute; de mantenerse como afirmativo siempre que existan bienes no apremiados por la entidad, lo que permitir&aacute; que la herramienta nos genere una alerta para solicitar la pr&oacute;rroga de la anotaci&oacute;n de los embargos en el Registro.</p></div>' ,null ,null ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_registrarAnotacionRegistro','1','date' ,'fecha','Fecha de anotación de los embargos' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,null,'0','RECOVERY-2026'),
		T_TIPO_TFI('CJ046_registrarAnotacionRegistro','2','combo' ,'comboBienes','Existen bienes no apremiados' ,'tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio' ,'valor != null && valor != '' ? true : false' ,null ,'DDSiNo','0','RECOVERY-2026')
    );
