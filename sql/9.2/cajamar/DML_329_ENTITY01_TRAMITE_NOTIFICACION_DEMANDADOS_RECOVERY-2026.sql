...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('CJ400','CJ400_GestionarNotificaciones' ,null ,'!todosNotificados() ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe notificar todos los demandados o excluirlos.</div>'' : dameNumNotificadosNoEdictoNoExcluidos() != dameNumDocumentosTipo(''ACUREC'') ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Se deben adjuntar tantos documentos "Acuse de recibo" como demandados no excluidos y no notificados por edicto existan.</div>'' : null' ,null ,null ,null ,'0','Notificar demandados' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null),
		T_TIPO_TAP('CJ400','CJ400_GestionarNotificacionesAdjudicacion' ,null ,'!todosNotificados() ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe notificar todos los demandados o excluirlos.</div>'' : dameNumNotificadosNoEdictoNoExcluidos() != dameNumDocumentosTipo(''ACUREC'') ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Se deben adjuntar tantos documentos "Acuse de recibo" como demandados no excluidos y no notificados por edicto existan.</div>'' : null' ,null ,null ,null ,'0','Gestionar notificaciones desde Adjudicación' ,'0','RECOVERY-2026','0' ,null ,null ,null,'1' ,'EXTTareaProcedimiento','3',null ,null,null ,null,null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		T_TIPO_PLAZAS(null ,null ,'CJ400_GestionarNotificaciones','60*24*60*60*1000L' ,'0','0','RECOVERY-2026'),
		T_TIPO_PLAZAS(null ,null ,'CJ400_GestionarNotificacionesAdjudicacion','60*24*60*60*1000L' ,'0','0','RECOVERY-2026')
    ); 
