...
-- Fecha ultima modificacion: 04/07/16
-- Motivos del cambio: Se añade contrato_desc para poner representación de 14 dígitos en reports contrato
...
-- ----------------------------------------------------------------------------------------------
  ...
  LPAD(NVL(TO_CHAR(CNT_CONTRATO), '''||V_DESCONOCIDO||'''),15,0)
...
--      left join '||V_DATASTAGE||'.ZONA_JERARQUIA zon on cnt.CNT_COD_OFICINA = zon.NIVEL_0
 ...
 UPDATE D_CNT SET CONTRATO_COD_CONTRATO_15='Desconocido' WHERE CONTRATO_COD_CONTRATO_15='0000Desconocido';
  COMMIT;
