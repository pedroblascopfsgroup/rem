...
V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_EXP_TIPO_GESTION_CNT'', '''', :O_ERROR_STATUS); END;';
  ...
  V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_EXP_PER_ES_PASE'', '''', :O_ERROR_STATUS); END;';
  execute immediate V_SQL USING OUT error;
  
  V_SQL :=  'BEGIN OPERACION_DDL.DDL_TABLE(''TRUNCATE'', ''D_EXP_CNT_ES_PASE'', '''', :O_ERROR_STATUS); END;';
  execute immediate V_SQL USING OUT error;
