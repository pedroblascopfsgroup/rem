...
--## FECHA_CREACION=20170619
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-2093
--## PRODUCTO=NO
--## Finalidad: Adición de columnas: Fecha alta en catastro, fecha baja en catastro y observaciones.
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('CAT_F_ALTA_CATASTRO', 'DATE', '', 'Fecha de alta en catastro')
        ,T_TIPO_DATA('CAT_F_BAJA_CATASTRO', 'DATE', '', 'Fecha de baja en catastro')
        ,T_TIPO_DATA('CAT_OBSERVACIONES', 'VARCHAR2(400 CHAR)', '', 'Observaciones')
    ); 
