...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('AnotacionesEmailFrom','no-reply@pfsgroup.es','Anotaciones: email FROM'),
      T_FUNCION('AnotacionesMailSmtpUser','usuario-no-necesario','Anotaciones: email USER'),
      T_FUNCION('AnotacionesPwdCorreo','kV6TlLKX3WrmZiaRmMfn5w==59365096','Anotaciones: email PWD')
    ); 
