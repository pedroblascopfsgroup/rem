...
--## Finalidad: DML
--##           
--## INSTRUCCIONES: Elimina logicamente los estados itinerarios "Vigilancia metas volantes" y "Decisión de Comité"
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
BEGIN
	...
	V_MSQL := 'UPDATE ' ||V_ESQUEMA_M|| '.'||TABLADD1||' EXT SET EXT.BORRADO = 1 WHERE EXT.DD_EST_CODIGO = ''VMV'' or  EXT.DD_EST_CODIGO = ''DC''';
