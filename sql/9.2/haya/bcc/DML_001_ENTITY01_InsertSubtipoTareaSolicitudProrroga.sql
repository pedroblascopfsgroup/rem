...
DECLARE
    ...
    V_STA_SUBTIPO T_ARRAY_STA := T_ARRAY_STA(
      T_STA_SUBTIPO(1, 'RESPRO_SPGL', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SPGL', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_SSDE', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SSDE', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_DUCO', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DUCO', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_PREDOC', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'PREDOC', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_DRECU', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DRECU', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_CJ-GAREO', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'CJ-GAREO', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_GCONGE', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'GCONGE', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_GCONPR', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'GCONPR', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_CJ-GESTLLA', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'CJ-GESTLLA', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_CJ-SAREO', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'CJ-SAREO', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SAEST', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SAEST', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SAJUR', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SAJUR', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_CJ-SCON', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'CJ-SCON', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SUCONT', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SUCONT', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SUCONPR', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SUCONPR', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SCTRGE', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SCTRGE', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SGESDOC', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SGESDOC', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_CJ-SUEXT', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'CJ-SUEXT', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SUCONGEN2', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SUCONGEN2', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SUCONGE', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SUCONGE', 'EXTSubtipoTarea')
    );   
          ...
          IF V_NUM_TABLAS = 1 THEN
	          ...
	          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_STA_SUBTIPO_TAREA_BASE (' ||
	                      ...
	                      'SELECT '|| V_ENTIDAD_ID || ','''||V_TMP_STA_SUBTIPO(1)||''','''||V_TMP_STA_SUBTIPO(2)||''','''||V_TMP_STA_SUBTIPO(3)||''''||
							','''||V_TMP_STA_SUBTIPO(4)||''',NULL,'''||V_TMP_STA_SUBTIPO(6)||''''||
							','''||V_TMP_STA_SUBTIPO(7)||''',SYSDATE,NULL,NULL,NULL,NULL,'''||V_TMP_STA_SUBTIPO(13)||''','''||V_ID_TGE||''','''||V_TMP_STA_SUBTIPO(15)||''' FROM DUAL';
