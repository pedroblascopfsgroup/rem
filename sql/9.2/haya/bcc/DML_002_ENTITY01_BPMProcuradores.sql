...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
	    T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H007',
        /*TAP_CODIGO...................:*/ 'H007_RevisionCostas',
        /*TAP_VIEW.....................:*/ 'plugin/procedimientos-bpmHaya-plugin/tramiteCostas/revisionCostas',
        ...
        /*TAP_BUCLE_BPM................:*/ null        
       	...
       	T_TIPO_TAP(
        /*DD_TPO_ID(FK)................:*/ 'H007',
        /*TAP_CODIGO...................:*/ 'H007_PostSolicitudTasacion',
        /*TAP_VIEW.....................:*/ 'plugin/procedimientos-bpmHaya-plugin/tramiteCostas/postSolicitudTasacion',
        /*TAP_SCRIPT_VALIDACION........:*/ null,
        /*TAP_SCRIPT_VALIDACION_JBPM...:*/ null,
        /*TAP_SCRIPT_DECISION..........:*/ null,
        /*DD_TPO_ID_BPM(FK)............:*/ null,
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
    	T_TIPO_PLAZAS(null,null,'H007_RevisionCostas','2*24*60*60*1000L','0','0','DD'),
    	T_TIPO_PLAZAS(null,null,'H007_PostSolicitudTasacion','2*24*60*60*1000L','0','0','DD')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		T_TIPO_TFI('H007_RevisionCostas','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">A trav&eacute;s de esta tarea deber&aacute; revisar los importes introducidos por el letrado en la tarea anterior “Solicitud de tasaci&oacute;n de costas”. En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','DD'),
		T_TIPO_TFI('H007_RevisionCostas','1','currency','cuantiaLetrado','Cuantía Letrado',null,null,'(valores[''H007_SolicitudTasacion''][''cuantiaLetrado''])',null,'0','DD'),
		T_TIPO_TFI('H007_RevisionCostas','2','currency','cuantiaProcurador','Cuantía Procurador',null,null,'(valores[''H007_SolicitudTasacion''][''cuantiaProcurador''])',null,'0','DD'),
		T_TIPO_TFI('H007_RevisionCostas','3','textarea','observaciones','Observaciones',null,null,null,null,'0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">A trav&eacute;s de esta tarea deber&aacute; revisar los datos introducidos por el letrado tras el Auto de aprobaci&oacute;n de costas. En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','1','date','fecha','Fecha',null,null,'(valores[''H007_AutoAprobacionCostas''][''fecha''])',null,'0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','2','combo','resultado','Resultado',null,null,'(valores[''H007_AutoAprobacionCostas''][''comboResultado''])','DDFavorable','0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','3','combo','aprobada','Aprobada',null,null,'(valores[''H007_AutoAprobacionCostas''][''comboAprobada''])','DDSiNo','0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','4','currency','cuantiaLetrado','Cuantía Letrado',null,null,'(valores[''H007_AutoAprobacionCostas''][''cuantiaLetrado''])',null,'0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','5','currency','cuantiaProcurador','Cuantía Procurador',null,null,'(valores[''H007_AutoAprobacionCostas''][''cuantiaProcurador''])',null,'0','DD'),
		T_TIPO_TFI('H007_PostSolicitudTasacion','6','textarea','observaciones','Observaciones',null,null,null,null,'0','DD')
    ); 
