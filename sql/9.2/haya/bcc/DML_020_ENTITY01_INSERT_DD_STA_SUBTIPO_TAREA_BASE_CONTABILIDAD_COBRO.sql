...
BEGIN
    ...
    VALUES ('||V_ESQUEMA_M||'.S_DD_STA_SUBTIPO_TAREA_BASE.NEXTVAL,''1'',''CONTACOBR'',''Contabilizar Cobros'',''Contabilización de Cobros'',''1'',''0'',''PROD-954'',SYSDATE,null,null,null,null,''0'',(SELECT DD_TGE_ID FROM '||V_ESQUEMA_M||'.DD_TGE_TIPO_GESTOR WHERE DD_TGE_CODIGO = ''GCON''),''EXTSubtipoTarea'')';
