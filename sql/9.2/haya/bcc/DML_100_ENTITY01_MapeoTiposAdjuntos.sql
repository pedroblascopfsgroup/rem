...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  ...
	  T_FUNCION('AVPR', '00720'),
	  T_FUNCION('COMAD', '00721'),
	  T_FUNCION('DREP', '00722'),
	  T_FUNCION('RAP', '00723'),
	  T_FUNCION('ECM', '00724'),
	  T_FUNCION('ESALEG', '00725'),
	  T_FUNCION('HEDIMP', '00726'),
	  T_FUNCION('EIC', '00726'),
	  T_FUNCION('EII', '00726'),
	  T_FUNCION('ESCPET', '00727'),
	  T_FUNCION('ESCPRJUZ', '00728'),
	  T_FUNCION('ELAA', '00729'),
	  T_FUNCION('JUSPG', '00730'),
	  T_FUNCION('OFEVEN', '00731'),
	  T_FUNCION('PETPOS', '00732'),
	  T_FUNCION('PRECUE', '00733'),
	  T_FUNCION('PROPLAPAG', '00734'),
	  T_FUNCION('RECGES', '00735'),
	  T_FUNCION('RECIGEST', '00735'),
	  T_FUNCION('REREVC', '00736'),
	  T_FUNCION('RECA', '00737'),
	  T_FUNCION('REC', '00737'),
	  T_FUNCION('REDIT', '00737'),
	  T_FUNCION('RETNJ', '00737'),
	  T_FUNCION('HRESOL', '00737'),
	  T_FUNCION('REME', '00737'),
	  T_FUNCION('REM', '00737'),
	  T_FUNCION('REOC', '00737'),
	  T_FUNCION('RESADE', '00738'),
	  T_FUNCION('REI', '00739'),
	  T_FUNCION('REO', '00739'),
	  T_FUNCION('REVM', '00739'),
	  T_FUNCION('REV', '00739'),
	  T_FUNCION('RESJUD', '00739'),
	  T_FUNCION('RESJUZ', '00739'),
	  T_FUNCION('REACHA', '00740'),
	  T_FUNCION('ASP', '00741'),
	  T_FUNCION('SAP', '00742'),
	  T_FUNCION('SOLCONS', '00743'),
	  T_FUNCION('ACUENTDP', '00744'),
	  T_FUNCION('CSH', '00745'),
	  T_FUNCION('ECDRE', '00746'),
	  T_FUNCION('ESSORE', '00747'),
	  T_FUNCION('EDPI', '00748'),
	  T_FUNCION('ICP', '00749'),
	  T_FUNCION('LIC', '00750'),
	  T_FUNCION('PROTN', '00751'),
	  T_FUNCION('TIRNR', '00752'),
	  T_FUNCION('TTEPPM', '00753')
    ); 
