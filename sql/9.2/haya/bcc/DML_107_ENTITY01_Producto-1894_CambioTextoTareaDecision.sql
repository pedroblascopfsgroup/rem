...
DBMS_OUTPUT.PUT_LINE('[INICIO]');
      ...
      V_SQL := 'update '||V_ESQUEMA_M||'.DD_STA_SUBTIPO_TAREA_BASE SET DD_STA_DESCRIPCION=''Tarea de letrado'',DD_STA_DESCRIPCION_LARGA=''Tarea de letrado'', USUARIOMODIFICAR=''PRODUCTO-1894'', FECHAMODIFICAR=SYSDATE WHERE DD_STA_CODIGO=''CJ-814''';
      EXECUTE IMMEDIATE V_SQL ;      
	   ...
	   END IF;
        ...
        V_SQL := 'UPDATE '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES SET TAR_DESCRIPCION=''Tarea de letrado'', USUARIOMODIFICAR=''PRODUCTO-1894'', FECHAMODIFICAR=SYSDATE WHERE DD_STA_ID = (select dd_sta_id from '||V_ESQUEMA_M||'.dd_sta_subtipo_Tarea_base where dd_sta_codigo=''CJ-814'')';
        EXECUTE IMMEDIATE V_SQL ; 
