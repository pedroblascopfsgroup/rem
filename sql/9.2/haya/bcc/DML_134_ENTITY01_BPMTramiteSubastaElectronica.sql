...
DECLARE
	...
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','1','combo','comboDecision','Decisión suspensión','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDDecisionSuspElec','0','PRODUCTO-1093')
