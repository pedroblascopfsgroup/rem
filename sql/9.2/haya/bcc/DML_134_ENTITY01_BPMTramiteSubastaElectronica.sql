...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		,T_TIPO_TAP('P458','P458_DecretoConvocatoriaSubasta',null,'existeAdjuntoUG(''DCSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Decreto de convocatoria de subasta".</div>''',null,null,null,'0','Decreto Convocatoria de Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_EntregaRecepcionEdictoImpresoTasa','plugin/cajamar/tramiteSubastaElectronica/entregaYRecepcionEdictoEImpresoTasa','existeAdjuntoUG(''DO'', ''PRC'') ? (valores[P458_EntregaRecepcionEdictoImpresoTasa][comboEdicto] == ''01'' ? (existeAdjuntoUG(''EDSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Edicto de Subasta".</div>'') : null) : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Diligencia de ordenaci&oacute;n".</div>''','(valores[''P458_EntregaRecepcionEdictoImpresoTasa''][''comboEdicto''] == ''01'' && valores[''P458_EntregaRecepcionEdictoImpresoTasa''][''comboCorrecto''] == null) ? ''El campo correcto es obligatorio'' : null','valores[''P458_EntregaRecepcionEdictoImpresoTasa''][''comboEdicto''] == ''02'' ? ''no'' : (valores[''P458_EntregaRecepcionEdictoImpresoTasa''][''comboCorrecto''] == ''01'' ? ''siYCorreco'' : ''siYIncorrecto'')',null,'0','Entrega Y Recepcion Edicto e Impreso Tasa','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_RegistrarPagoTasaPublicacionBOE',null,'existeAdjuntoUG(''PTSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Pago tasa de subasta".</div>''',null,null,null,'0','Registrar el Pago de la Tasa para Publicacion BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegistrarPublicacionSubastaBOE','plugin/cajamar/tramiteSubastaElectronica/registrarPublicacionSubastaEnBOE','existeAdjuntoUG(''PPSBOE'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el "Pantallazo de publicaci&oacute;n de la subasta en BOE.es".</div>''','(valores[''P458_RegistrarPublicacionSubastaBOE''][''comboEdictoCorrecto''] == ''01'' && valores[''P458_RegistrarPublicacionSubastaBOE''][''fechaFinPeriodoPujas''] == null) ? ''El campo fecha fin de periodo de pujas es obligatorio''','valores[''P458_RegistrarPublicacionSubastaBOE''][''comboEdictoCorrecto''] == ''01'' ? ''si'' : ''no''',null,'0','Registrar Publicación de Subasta en el BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_ConfirmarCorrecccionEdictoPublicacionBOE',null,'existeAdjuntoUG(''ESUSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Edicto subsanado de subasta".</div>''',null,'valores[''P458_ConfirmarCorrecccionEdictoPublicacionBOE''][''comboPagoTasa''] == ''01'' ? ''si'' : ''no''',null,'0','Confirmar Corrección del Edicto Publicación BOE','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)

		,T_TIPO_TAP('P458','P458_RegistrarResultadoSubasta',null,'existeAdjuntoUG(''ACS'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el "Acta de subasta".</div>''',null,null,null,'0','Registrar Resultado de la Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_PrepararInformeSubasta',null,'existeAdjuntoUG(''INS'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Informe de Subasta".</div>''',null,null,null,'0','Preparar Informe de Subasta','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)
		,T_TIPO_TAP('P458','P458_ValidarInformeSubasta',null,null,'(valores[''P458_ValidarInformeSubasta''][''comboAceptarInforme''] == ''01'' && valores[''P458_ValidarInformeSubasta''][''comboAtribuciones''] == null) ? ''El campo atribuciones es obligatorio'' : null','valores[''P458_ValidarInformeSubasta''][''comboAceptarInforme''] == ''02'' ? ''rechazado'' : (valores[''P458_ValidarInformeSubasta''][''comboAtribuciones''] == ''01'' ? ''aceptadoConAtribuciones'' : ''aceptadoSinAtribuciones'')',null,'0','Validar Informe de Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TSUCONGE',null,'SUCONGEN2',null)
	...
	,T_TIPO_TFI('P458_SolicitudSubasta','7','number','telefonoRep','Telefono Representante','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')
...
',null,null,null,null,'0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_EntregaRecepcionEdictoImpresoTasa','4','date','fechaEntregaImpresoLiquidacionTasa','Fecha Entrega Impreso Liquidación Tasa',null,null,null,null,'0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_RegistrarPublicacionSubastaBOE','2','combo','comboEdictoCorrecto','Edicto Correcto',null,null,null,'DDSiNo','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarPublicacionSubastaBOE','3','date','fechaFinPeriodoPujas','Fecha Fin del Periodo de Pujas','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')     
...
Además, si ha habido postores en todos los bienes corresponde iniciar el mismo trámite, se indicará en el campo "Detalle Resultado Con Postores", cuya información se trasladará a la ficha de cada uno de los bienes de la Subasta.</p>- Si el Resultado de la Subasta, varía en función del bien subastado, deberá informarse en la ficha del bien si en la puja del bien ha habido o no postores, si se lo ha adjudicado la entidad o un tercero, el resultado de la  adjudicación y el valor de la adjudicación.<br>- En caso de suspensión de la subasta deberá indicar dicha circunstancia en el campo “Suspensión” deberá informar quien ha provocado dicha suspensión y en el campo “Motivo suspensión” deberá indicar el motivo por el cual se ha suspendido.<br>- En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p>Para dar por terminada esta tarea deberá adjuntar el acta de subasta al procedimiento a través de la pestaña "Adjuntos".</p>Una vez recogida toda la informacióndel resultado de la subasta:<br>- En caso de suspensión, se irá a la toma de decisión.<br>- En caso de no suspensión de la subasta, se lanzará un trámite u otro por bien en función de la información recogida en la ficha de cada uno de los bienes de la Subasta:<br>- En caso de que se haya adjudicado el bien a un tercero se lanzará el Trámite Adjudicación Terceros.<br>- En caso de que se haya adjudicado el bien la entidad, se lanzará el Trámite Adjudicacion.<br>- En caso de que el bien se haya adjudicado a la entidad con cesión de remate, se lanzará el Trámite de Cesión de Remate.</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','1','combo','comboSubastaBienes','Coincidencia del Resultado de la Subasta en los Bienes','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','2','combo','comboPostores','Con Postores','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','3','combo','comboDetalle','Detalle Resultado con Postores',null,null,null,'DDResultadoConPostores','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','4','combo','comboDecision','Decisión Suspensión',null,null,null,'DDDecisionSuspensionElectronica','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoSubasta','5','combo','comboMotivo','Motivo Suspensión',null,null,null,'DDMotivoSuspSubastaElectronica','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','4','combo','comboEntidadConCesion','Entidad con Cesión de Remate',null,null,null,'DDEntidadCesionRemate','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_ValidarInformeSubasta','3','combo','comboMotivo','Motivo de Autorización','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDMotivoAutorizacion','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_PendienteConfirmacionPagoTasa','1','text','motivoImpago','Motivo de No Pagar Tasa',null,null,'(valores[''P458_ObtenerValidacionComite''] !=null && valores[''P454_ObtenerValidacionComite''][''comboMotivoImpago''] !=null) ? valores[''P458_ObtenerValidacionComite''][''comboMotivoImpago''] : null',null,'0','PRODUCTO-1093')	
