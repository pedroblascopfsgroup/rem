...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		,T_TIPO_TAP('P458','P458_RegistrarPagoTasaPublicacionBOE',null,'existeAdjuntoUG(''PTSU'', ''PRC'') ? null : existeAdjuntoUGMensaje(''PTSU'',''PRC'')',null,null,null,'0','Registrar el Pago de la Tasa para Publicacion BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegistrarPublicacionSubastaBOE','plugin/cajamar/tramiteSubastaElectronica/registrarPublicacionSubastaEnBOE','existeAdjuntoUG(''PPSBOE'', ''PRC'') ? null : existeAdjuntoUGMensaje(''PPSBOE'',''PRC'')','(valores[''P458_RegistrarPublicacionSubastaBOE''][''comboEdictoCorrecto''] == ''01'' && valores[''P458_RegistrarPublicacionSubastaBOE''][''fechaFinPeriodoPujas''] == null) ? ''El campo fecha fin de periodo de pujas es obligatorio''','valores[''P458_RegistrarPublicacionSubastaBOE''][''comboEdictoCorrecto''] == ''01'' ? ''si'' : ''no''',null,'0','Registrar Publicación de Subasta en el BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_RegistrarResultadoSubasta','plugin/cajamar/tramiteSubastaElectronica/registrarResultadoSubasta','existeAdjuntoUG(''ACS'', ''PRC'') ? null : existeAdjuntoUGMensaje(''ACS'',''PRC'')','(valores[''P458_RegistrarResultadoSubasta''][''comboDecision''] == ''ENT'' || valores[''P458_RegistrarResultadoSubasta''][''comboDecision''] == ''TER'') ? (valores[''P458_RegistrarResultadoSubasta''][''comboMotivo''] == null ? ''El campo motivo de suspension es obligatorio'' : ((valores[''P458_RegistrarResultadoSubasta''][''comboMotivo''] == ''OTR'' && valores[''P458_RegistrarResultadoSubasta''][''observaciones'']==null) ? ''El campo observaciones es obligatorio'' : null)) : (valores[''P458_RegistrarResultadoSubasta''][''comboSubastaBienes'']==null ? ''El campo coincidencia del resultado de la subasta en los bienes es obligatorio'' : (valores[''P458_RegistrarResultadoSubasta''][''comboSubastaBienes''] == ''01'' ? (valores[''P458_RegistrarResultadoSubasta''][''comboPostores'']==null ? ''El campo con postores es obligatorio'' : (valores[''P458_RegistrarResultadoSubasta''][''comboPostores''] == ''01'' && valores[''P458_RegistrarResultadoSubasta''][''comboDetalle'']==null) ? ''El campo detalle resultado con postores es obligatorio'' : null) : compruebaPostores()))','valores[P458_RegistrarResultadoSubasta][comboDecision] == ''NO'' ? (dameDecisionRegistrarResultadoSubasta() ? ''tareaSolicitar'' : ''tramites'') : ''suspension''',null,'0','Registrar Resultado de la Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_SolicitarAdjudicacionInstruccionesEntidad',null,'existeAdjuntoUG(''ESADJ'', ''PRC'') ? null : existeAdjuntoUGMensaje(''ESADJ'',''PRC'')',null,null,null,'0','Solicitar Adjudicación Según Instrucciones Entidad','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegResulPresentacionEscrJuzgado','plugin/cajamar/tramiteSubastaElectronica/registrarResultadoPresentacionEscritoJuzgado',null,'(valores[''P458_RegResulPresentacionEscrJuzgado''][''comboResultado''] == ''FAV'' || valores[''P458_RegResulPresentacionEscrJuzgado''][''comboResultado''] == ''FAVC'') ? (valores[''P458_RegResulPresentacionEscrJuzgado''][''comboCoincidencia''] == null ? ''El campo coincidencia del resultado de la presentacion es obligatorio'' : ((valores[''P458_RegResulPresentacionEscrJuzgado''][''comboAdjudicacion''] == ''01'' && valores[''P458_RegResulPresentacionEscrJuzgado''][''comboEntidad''] == null)  ? ''El campo entidad es obligatorio'' : null)) : (valores[''P458_RegResulPresentacionEscrJuzgado''][''comboRecurso''] == null ? ''El campo recurso es obligatorio'' : null)','valores[''P458_RegResulPresentacionEscrJuzgado''][''comboResultado''] == ''DESF'' ? (valores[''P458_RegResulPresentacionEscrJuzgado''][''comboRecurso''] == DDSiNo.SI) ? ''desfConRecurso'' : ''desfSinRecurso'') : ''tramites''' ,null,'0','Registrar Resultado Presentación Escrito al Juzgado','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
...
Además, si ha habido postores en todos los bienes corresponde iniciar el mismo trámite, se indicará en el campo "Detalle Resultado Con Postores", cuya información se trasladará a la ficha de cada uno de los bienes de la Subasta.</p>- Si el Resultado de la Subasta, varía en función del bien subastado, deberá informarse en la ficha del bien si en la puja del bien ha habido o no postores, si se lo ha adjudicado la entidad o un tercero, el resultado de la  adjudicación y el valor de la adjudicación.<br>- En caso de suspensión de la subasta deberá indicar dicha circunstancia en el campo “Suspensión” deberá informar quien ha provocado dicha suspensión y en el campo “Motivo suspensión” deberá indicar el motivo por el cual se ha suspendido.<br>- En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p>Para dar por terminada esta tarea deberá adjuntar el acta de subasta al procedimiento a través de la pestaña "Adjuntos".</p>Una vez recogida toda la informacióndel resultado de la subasta:<br>- En caso de suspensión, se irá a la toma de decisión.<br>- En caso de no suspensión de la subasta, se lanzará un trámite u otro por bien en función de la información recogida en la ficha de cada uno de los bienes de la Subasta:<br>- En caso de que se haya adjudicado el bien a un tercero se lanzará el Trámite Adjudicación Terceros.<br>- En caso de que se haya adjudicado el bien la entidad, se lanzará el Trámite Adjudicacion.<br>- En caso de que el bien se haya adjudicado a la entidad con cesión de remate, se lanzará el Trámite de Cesión de Remate.</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_RegResulPresentacionEscrJuzgado','3','combo','comboCoincidencia','Coincidencia del resultado de la presentación escrito al juzgado en todos los bienes',null,null,null,'DDFavorableCondicional','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegResulPresentacionEscrJuzgado','4','combo','comboAdjudicacion','Adjudicación con cesión de remate','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-1093')
