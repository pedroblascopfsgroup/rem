...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		T_TIPO_TAP('P458','P458_SolicitudDeSubasta',null,'comprobarMinimoBienLote() ? (comprobarBienesSolitudSubasta() ? (existeAdjuntoUG(''ESSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Escrito de solicitud de la subasta".</div>'') : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Todos los bienes incluidos los lotes de la subasta deben tener informado la informaci&oacute;n de las cargas, si es vivienda habitual y la situaci&oacute;n posesoria.</div>'') : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Al menos un bien debe estar asignado a un lote</div>''',null,null,null,'0','Solicitud de Subasta','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONPR',null)
		,T_TIPO_TAP('P458','P458_DecretoConvocatoriaDeSubasta',null,'existeAdjuntoUG(''DCSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Decreto de convocatoria de subasta".</div>''',null,null,null,'0','Decreto Convocatoria de Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_EntregaYRecepcionEdictoEImpresoTasa','plugin/cajamar/tramiteSubastaElectronica/entregaYRecepcionEdictoEImpresoTasa','existeAdjuntoUG(''DO'', ''PRC'') ? (valores[P458_EntregaYRecepcionEdictoEImpresoTasa][comboEdicto] == ''01'' ? (existeAdjuntoUG(''EDSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Edicto de Subasta".</div>'') : null) : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Diligencia de ordenaci&oacute;n".</div>''','(valores[''P458_EntregaYRecepcionEdictoEImpresoTasa''][''comboEdicto''] == ''01'' && valores[''P458_EntregaYRecepcionEdictoEImpresoTasa''][''comboCorrecto''] == null) ? ''El campo correcto es obligatorio'' : null','valores[''P458_EntregaYRecepcionEdictoEImpresoTasa''][''comboEdicto''] == ''02'' ? ''no'' : (valores[''P458_EntregaYRecepcionEdictoEImpresoTasa''][''comboCorrecto''] == ''01'' ? ''siYCorreco'' : ''siYIncorrecto'')',null,'0','Entrega Y Recepcion Edicto e Impreso Tasa','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_ConfirmarCorreccionDelEdicto',null,'existeAdjuntoUG(''ESSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Edicto subsanado de subasta".</div>''',null,null,null,'0','Confirmar Correccion Del Edicto','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_ConfLecturaInstruccionesDeSubastaYPagoDeTasa',null,null,null,null,null,'0','Confirmar Lectura Instrucciones de Subasta y Pago de Tasa','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegistrarElPagoDeLaTasaParaPublicacionBOE',null,'existeAdjuntoUG(''PTSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Pago tasa de subasta".</div>''',null,null,null,'0','Registrar el Pago de la Tasa para Publicacion BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegistrarPublicacionDeSubastaEnElBOE','plugin/cajamar/tramiteSubastaElectronica/registrarPublicacionSubastaEnBOE','existeAdjuntoUG(''PPSBOE'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el "Pantallazo de publicaci&oacute;n de la subasta en BOE.es".</div>''','(valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''][''comboEdictoCorrecto''] == ''01'' && valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''][''fechaFinPeriodoPujas''] == null) ? ''El campo fecha fin de periodo de pujas es obligatorio''','valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''][''comboEdictoCorrecto''] == ''01'' ? ''si'' : ''no''',null,'0','Registrar Publicación de Subasta en el BOE','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_ConfirmarCorrecccionDelEdictoPublicacionBOE',null,'existeAdjuntoUG(''ESUSU'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Edicto subsanado de subasta".</div>''',null,'valores[''P458_ConfirmarCorrecccionDelEdictoPublicacionBOE''][''comboPagoTasa''] == ''01'' ? ''si'' : ''no''',null,'0','Confirmar Corrección del Edicto Publicación BOE','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)

		,T_TIPO_TAP('P458','P458_RegistrarResultadoDeLaSubasta',null,'existeAdjuntoUG(''ACS'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el "Acta de subasta".</div>''',null,null,null,'0','Registrar Resultado de la Subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)

		,T_TIPO_TAP('P458','P458_RegistrarResDecision2',null,null,null,null,null,'0','Tarea toma de decisión','0','PRODUCTO-1093','0',null,null,null,'0','EXTTareaProcedimiento','0',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_SolicitarAdjSegunInstruccionesEntidad',null,'existeAdjuntoUG(''ESADJ'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Escrito solicitud de Adjudicaci&oacute;n".</div>''',null,null,null,'0','Solicitar Adjudicación Según Instrucciones Entidad','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		,T_TIPO_TAP('P458','P458_RegResulPresentacionEscrAlJuzgado','plugin/cajamar/tramiteSubastaElectronica/registrarResultadoPresentacionEscritoJuzgado',null,'(valores[''P458_RegResulPresentacionEscrAlJuzgado''][''comboAdjudicacionConCesion''] == ''01'' && valores[''P458_RegResulPresentacionEscrAlJuzgado''][''comboEntidadConCesion''] == null) ? ''El campo entidad con cesion es obligatorio'' : null','valores[''P458_RegResulPresentacionEscrAlJuzgado''][''comboAdjudicacionConCesion''] == ''01'' ? ''conCesion'' : ''sinCesion''',null,'0','Registrar Resultado Presentación Escrito al Juzgado','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_AdjuntarTasaciones',null,'existeAdjuntoUG(''TCION'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Tasaci&oacute;n".</div>''',null,'valores[''P458_AdjuntarTasaciones''][''comboSolicitar''] == ''01'' ? ''si'' : ''no''',null,'0','Adjuntar Tasaciones','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)
		,T_TIPO_TAP('P458','P458_SolicitarInformeFiscal',null,'existeAdjuntoUG(''IFISCAL'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Informe fiscal (T. Subasta)".</div>''',null,null,null,'0','Solicitar Informe Fiscal','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_PrepararInformeDeSubasta',null,'existeAdjuntoUG(''INS'', ''PRC'') ? null : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Se debe adjuntar el documento "Informe de Subasta".</div>''',null,null,null,'0','Preparar Informe de Subasta','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)
		...
		,T_TIPO_TAP('P458','P458_PendienteConfirmacionPagoDeTasa',null,null,null,'valores[''P458_PendienteConfirmacionPagoDeTasa''][''comboResolucionDefinitiva''] == ''PAT'' ? ''si'' : ''no''',null,'0','Pendiente Confirmación Pago de Tasa','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TGCTRGE',null,'DRECU',null)
		,T_TIPO_TAP('P458','P458_PendienteConfDecision1',null,null,null,null,null,'0','Tarea toma de decisión','0','PRODUCTO-1093','0',null,null,null,'0','EXTTareaProcedimiento','0',null,'TGCTRGE',null,'DRECU',null)
		,T_TIPO_TAP('P458','P458_DictarInstrDeSubastaYPDeTasa',null,null,null,null,null,'0','Dictar Instrucciones de Subasta y Pago de Tasa','0','PRODUCTO-1093','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)	
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
		...
		,T_TIPO_PLAZAS(null,null,'P458_ConfLecturaInstruccionesDeSubastaYPagoDeTasa','2*24*60*60*1000L','0','0','PRODUCTO-1093')
		...
		,T_TIPO_PLAZAS(null,null,'P458_SolicitarAdjSegunInstruccionesEntidad','(valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''] !=null && valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''][''fechaFinPeriodoPujas''] !=null) ? damePlazo(valores[''P458_RegistrarPublicacionDeSubastaEnElBOE''][''fechaFinPeriodoPujas''])+2*24*60*60*1000L : 2*24*60*60*1000L','0','0','PRODUCTO-1093')
		,T_TIPO_PLAZAS(null,null,'P458_RegResulPresentacionEscrAlJuzgado','30*24*60*60*1000L','0','0','PRODUCTO-1093')
		...
		,T_TIPO_PLAZAS(null,null,'P458_DictarInstrDeSubastaYPDeTasa','3*24*60*60*1000L','0','0','PRODUCTO-1093') 
	); 
...
Además, si ha habido postores en todos los bienes corresponde iniciar el mismo trámite, se indicará en el campo "Detalle Resultado Con Postores", cuya información se trasladará a la ficha de cada uno de los bienes de la Subasta.</p>- Si el Resultado de la Subasta, varía en función del bien subastado, deberá informarse en la ficha del bien si en la puja del bien ha habido o no postores, si se lo ha adjudicado la entidad o un tercero, el resultado de la  adjudicación y el valor de la adjudicación.<br>- En caso de suspensión de la subasta deberá indicar dicha circunstancia en el campo “Suspensión” deberá informar quien ha provocado dicha suspensión y en el campo “Motivo suspensión” deberá indicar el motivo por el cual se ha suspendido.<br>- En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p>Para dar por terminada esta tarea deberá adjuntar el acta de subasta al procedimiento a través de la pestaña "Adjuntos".</p>Una vez recogida toda la informacióndel resultado de la subasta:<br>- En caso de suspensión, se irá a la toma de decisión.<br>- En caso de no suspensión de la subasta, se lanzará un trámite u otro por bien en función de la información recogida en la ficha de cada uno de los bienes de la Subasta:<br>- En caso de que se haya adjudicado el bien a un tercero se lanzará el Trámite Adjudicación Terceros.<br>- En caso de que se haya adjudicado el bien la entidad, se lanzará el Trámite Adjudicacion.<br>- En caso de que el bien se haya adjudicado a la entidad con cesión de remate, se lanzará el Trámite de Cesión de Remate.</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_RegistrarResultadoDeLaSubasta','3','combo','comboDetalle','Detalle Resultado con Postores',null,null,null,'DDResultadoConPostores','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegistrarResultadoDeLaSubasta','4','combo','comboDecision','Decisión Suspensión',null,null,null,'DDDecisionSuspensionElectronica','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_RegistrarResultadoDeLaSubasta','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Debe acceder a la pestaña "Decisiones" para derivar en la actuaci&oacute;n que corresponda.</p></div>',null,null,null,null,'0','PRODUCTO-1093')

	,T_TIPO_TFI('P458_SolicitarAdjSegunInstruccionesEntidad','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En caso de que el Resultado de la Subasta haya sido "sin postores", deberá proceder a la redacción del escrito en el que se solicite la adjudicación del bien o biens  de acuerdo a las instrucciones de la entidad.</p>Una vez rellene esta pantalla se lanzará la tarea “Registrar Resultado Presentación escrito al Juzgado".</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_SolicitarAdjSegunInstruccionesEntidad','1','date','fechaPresentacionEscrito','Fecha Presentación Escrito','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')     
	,T_TIPO_TFI('P458_SolicitarAdjSegunInstruccionesEntidad','2','combo','comboCuantia','Cuantía','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'NUEVODICCIONARIO','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_SolicitarAdjSegunInstruccionesEntidad','3','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1093')

	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta pantalla deberá recoger el resultado del escrito enviado al Juzgado. Si el resultado es Desfavorable, es decir que el Juzgado no ha admitido la adjudicación por la cantidad solicitada,  deberá ponerse en contacto con su Supervisor para tomar la decisión que corresponda según sus instrucciones. Si se decide Recurrir deberá indicarlo por la pestaña habilitada al efecto.</p>Si la resolución ha acogido de forma favorable la solicitud de adjudicación formulada, antes de finalizar esta tarea, deberá ir a la ficha del bien y actualizar los campos que corresponda de la pestaña de "Adjudicación y posesión".</p>Una vez rellene esta pantalla:<br>- En caso de que el bien sea Adjudicado a la Entidad y no haya Cesión de remate, se lanzará la tarea "Solicitud Decreto de Adjudicación".<br>- En caso de que el bien se Adjudique con cesión de remate se lanzará el Trámite "Trámite de Cesión de Remate".</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','1','date','fechaResolucion','Fecha Resolución','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')     
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','2','combo','comboResultado','Resultado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDFavorable','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','3','combo','comboAdjudicacionConCesion','Adjudicación con Cesión de Remate','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','4','combo','comboEntidadConCesion','Entidad con Cesión de Remate',null,null,null,'NUEVODICCIONARIO','0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_RegResulPresentacionEscrAlJuzgado','5','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_ValidarInformeDeSubasta','3','combo','comboMotivo','Motivo de Autorización','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDMotivoAutorizacion','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_PendienteConfirmacionPagoDeTasa','2','combo','comboResolucionDefinitiva','Resolución Definitiva','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDResolucionPagoTasa','0','PRODUCTO-1093')
	...
	,T_TIPO_TFI('P458_PendienteConfDecision1','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Debe acceder a la pestaña "Decisiones" para derivar en la actuaci&oacute;n que corresponda.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	
	,T_TIPO_TFI('P458_DictarInstrDeSubastaYPDeTasa','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Una vez aprobada la propuesta por su supervisor, en esta tarea el gestor de contencioso gestión deberá dictar las instrucciones de la subasta al letrado.</p>El campo Fecha deberá anotar la fecha en que se realiza esta tarea.</p>Una vez realizada esta tarea, se enviará un mensaje al Letrado a través de una notificación:<br>"Se han dictado instrucciones y la autorización para proceder al pago de la tasa".</p>En el campo Observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_DictarInstrDeSubastaYPDeTasa','1','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')	
	,T_TIPO_TFI('P458_DictarInstrDeSubastaYPDeTasa','2','textarea','instrucciones','Instrucciones','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1093')
	,T_TIPO_TFI('P458_DictarInstrDeSubastaYPDeTasa','3','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1093')
