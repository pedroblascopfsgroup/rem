...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
		...
		,T_TIPO_TAP('P458','P458_RegistrarResultadoSubasta','plugin/cajamar/tramiteSubastaElectronica/registrarResultadoSubasta','existeAdjuntoUG(''ACS'', ''PRC'') ? null : existeAdjuntoUGMensaje(''ACS'',''PRC'')','valores[''P458_RegistrarResultadoSubasta''][''comboDecision''] == ''NO'' ? (compruebaAdjudicatariaConPostores() ? (valores[''P458_RegistrarResultadoSubasta''][''comboSubastaBienes''] == ''02'' ? compruebaPostores() : null) : ''Existen bienes sin entidad adjudicataria''): null','valores[''P458_RegistrarResultadoSubasta''][''comboDecision''] != ''NO'' ? ''suspension'' : (valores[''P458_RegistrarResultadoSubasta''][''comboSubastaBienes''] == ''02'' ? (dameDecisionRegistrarResultadoSubasta() ? ''tareaSolicitar'' : ''tramites'') : valores[''P458_RegistrarResultadoSubasta''][''comboPostores''] == ''01'' ? ''tramites'' : ''tareaSolicitar'')',null,'0','Registrar resultado de la subasta','0','PRODUCTO-1093','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'814',null,'GCONGE',null)
