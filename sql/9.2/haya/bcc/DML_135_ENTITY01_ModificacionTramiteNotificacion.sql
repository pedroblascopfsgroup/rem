...
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Modificación Trámite de Notificacion
...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P400','T. notificación demandados - HCJ','T. notificación demandados',null,'tramiteNotificacionV4','0','PRODUCTO-1233','0','TR',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       ...
       ,T_TIPO_TAP('P400','P400_GestionarNotificaciones',null,'!todosNotificados() ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">&iexcl;Atenci&oacute;n! Para dar por terminada esta tarea debe notificar todos los demandados o excluirlos.</div>'' : dameNumNotificadosNoEdictoNoExcluidos() != dameNumDocumentosTipo(''ACUREC'') ? ''<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 10px;">Se deben adjuntar tantos documentos "Acuse de recibo" como demandados no excluidos y no notificados por edicto existan.</div>'' : null',null,null,null,'0','Notificar demandados','0','PRODUCTO-1233','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGCONGE',null,'SUCONGE',null)
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(null,null,'P400_GestionarNotificacionesAdjudicacion','60*24*60*60*1000L','0','0','PRODUCTO-1233')
    ); 
