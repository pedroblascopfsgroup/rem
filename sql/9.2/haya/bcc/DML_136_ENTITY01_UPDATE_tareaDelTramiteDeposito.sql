...
--## INCIDENCIA_LINK=PRODUCTO-1159
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Modificación de la tarea Aceptación cargo de depositario del Tramite de depósito
...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('H034','T. de depósito - HCJ','Trámite de depósito',null,'hcj_tramiteDeposito','0','PRODUCTO-1159','0','TR',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
        T_TIPO_TAP('H034','H034_AceptacionCargoDepositario',null,null,null,null,null,'0','Aceptación cargo de depositário','0','PRODUCTO-1159','0',null,'tareaExterna.cancelarTarea','1','0','EXTTareaProcedimiento','0',null,'CJ-814',null,'GCONGE',null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(null,null,'H034_AceptacionCargoDepositario','30*24*60*60*1000L','0','0','PRODUCTO-1159')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
         ...
         T_TIPO_TFI('H034_AceptacionCargoDepositario','0','label','titulo','<div align="justify" style="margin-bottom: 30px;"><p style="margin-bottom: 10px;"><font face="Arial"><span style="font-size: 10.6666669845581px;">En esta pantalla se ha de determinar la fecha en la que el Depositario ha sido citado en el Juzgado para la aceptación del cargo, siendo que la misma se ha de informar en el supuesto en el que éste hubiere aceptado.</span></font></p><p style="margin-bottom: 10px;"><font face="Arial"><span style="font-size: 10.6666669845581px;">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</span></font></p></div>',null,null,null,null,'0','PRODUCTO-1159')
	,T_TIPO_TFI('H034_AceptacionCargoDepositario','1','text','nomDepositario','Informar del nombre del depositario','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1159')
        ,T_TIPO_TFI('H034_AceptacionCargoDepositario','2','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1159')
        ,T_TIPO_TFI('H034_AceptacionCargoDepositario','3','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1159')
