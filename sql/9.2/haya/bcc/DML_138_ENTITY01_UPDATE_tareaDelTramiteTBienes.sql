...
--## INCIDENCIA_LINK=PRODUCTO-1195
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Modificación de la tarea H054_PresentarEscritoJuzgado del T.tributacion de bienes
...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('H054','T. Tributacion de Bienes - HCJ','Trámite de Tributación de Bienes Sareb',null,'hcj_tramiteTributacionBienesSareb','0','PRODUCTO-1195','0','AP',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
        T_TIPO_TAP('H054','H054_PresentarEscritoJuzgado',null,'existeAdjuntoUG(''ESCJUZTB'', ''PRC'') ? null : existeAdjuntoUGMensaje(''ESCJUZTB'',''PRC'')',null,null,null,'0','Presentar escrito al juzgado','0','PRODUCTO-1195','0',null,'tareaExterna.cancelarTarea',null,'0','EXTTareaProcedimiento','0',null,'CJ-814',null,'GCONGE',null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(null,null,'H054_PresentarEscritoJuzgado','5*24*60*60*1000L','0','0','PRODUCTO-1195')
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
         ...
         T_TIPO_TFI('H054_PresentarEscritoJuzgado','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por finalizada esta tarea, debe informar de la fecha de presentación del escrito en el juzgado y adjuntar el escrito, donde comunique que Sareb es sujeto pasivo del IVA así como el acogimiento al régimen establecido en la D.A. 6º de la LIVA.</p><p style="margin-bottom: 10px">En el campo observaciones informar cualquier aspecto relevante que le interesa quede reflejado en ese punto del procedimiento.</p><p style="margin-bottom: 10px">Un vez realizada la tarea, se finalizará el trámite.</p></div>',null,null,null,null,'0','PRODUCTO-1195')
		,T_TIPO_TFI('H054_PresentarEscritoJuzgado','1','date','fecha','Fecha presentación escrito','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-1195')
        ,T_TIPO_TFI('H054_PresentarEscritoJuzgado','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1195')
