...
DECLARE
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(    
        ...
        T_TIPO_TFI('PCO_RegistrarTomaDec','4','combo','tipo_problema','Tipo de problema en expediente (Documentación, Requerimiento, Liquidaciones, Cambio de procedimiento)','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDTipoProblemaDocPco','0','DD'),
        T_TIPO_TFI('PCO_RegistrarTomaDec','5','combo','proc_propuesto','Procedimiento propuesto por la entidad',null,null,'(valores[''PCO_RevisarExpedientePreparar''] !=null && valores[''PCO_RevisarExpedientePreparar''][''proc_iniciar''] !=null) ? valores[''PCO_RevisarExpedientePreparar''][''proc_iniciar''] : null','TipoProcedimiento','0','DD'),
