...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('PCO','Preparación de expediente judicial','Preparación de expediente judicial',null,'precontenciosocajamar','0','PRODUCTO-1343','0','PCO',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
       T_TIPO_PLAZAS(null,null,'PCO_ValidarAsignacion','1*24*60*60*1000L','0','0','PRODUCTO-1343')
    ); 
