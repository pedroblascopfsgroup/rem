...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       ...
       ,T_TIPO_TAP('HC106','HC106_ValidarAsignacion','plugin/cajamar/tramiteEnvioDemanda/validacionAsignacionProcu',null,null,null,null,'0','Validar asignación','0','PRODUCTO-1345','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TCP',null,null,null)
       ,T_TIPO_TAP('HC106','HC106_RevisarCompletitudDocu','plugin/cajamar/tramiteEnvioDemanda/revisarDocu',null,'(valores[''HC106_RevisarCompletitudDocu''][''documentacionCompletada''] == DDSiNo.NO && valores[''HC106_RevisarCompletitudDocu''][''observaciones''] == null) ? ''Atención, al haber indicado disconformidad con la documentación, deberá indicar el motivo en el campo Observaciones.'' : null ' ,'valores[''HC106_RevisarCompletitudDocu''][''documentacionCompletada''] == DDSiNo.SI ? ''completa'' : ''incompleta''',null,'0','Revisar completitud de la documentación','0','PRODUCTO-1345','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'543',null,null,null)
       ,T_TIPO_TAP('HC106','HC106_BPMTramiteProvisionFondosProcurador',null,null,null,null,'P460','0','Se inicia trámite de provisiones de fondos','0','PRODUCTO-1345','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'PCO_LET',null,null,null)
    );
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
     ...
     ,T_TIPO_PLAZAS(null,null,'HC106_ValidarAsignacion','15*24*60*60*1000L','0','0','PRODUCTO-1345')
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
       ...
       ,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu','1','currency','principal','Principal de la demanda','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''importeDemanda''] !=null) ? valores[''HC106_ValidarAsignacion''][''importeDemanda''] : procedimientoManager.getProcedimiento(idProcedimiento).getSaldoRecuperacion()',null,'0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu','2','combo','proc_a_iniciar','Procedimiento a iniciar','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''proc_a_iniciar''] !=null) ? valores[''HC106_ValidarAsignacion''][''proc_a_iniciar''] : dameValoresBPMPadrePCO(''proc_a_iniciar'')','DDTipoPrcIniciador','0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu','3','combo','partidoJudicial','Partido judicial','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false','(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''partidoJudicial''] !=null) ? valores[''HC106_ValidarAsignacion''][''partidoJudicial''] : dameValoresBPMPadrePCO(''partidoJudicial'')','TipoPlaza','0','PRODUCTO-1345')
       ...
       --,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu2','1','currency','principal','Principal de la demanda',null,null,'(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''importeDemanda''] !=null) ? valores[''HC106_ValidarAsignacionProcu''][''importeDemanda''] : null',null,'0','PRODUCTO-1345')
       --,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu2','2','combo','proc_a_iniciar','Procedimiento a iniciar',null,null,'(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''proc_a_iniciar''] !=null) ? valores[''HC106_ValidarAsignacion''][''proc_a_iniciar''] : null','TipoProcedimiento','0','PRODUCTO-1345')
       --,T_TIPO_TFI('HC106_RedactarDemandaAdjuntarDocu2','3','combo','partidoJudicial','Partido judicial',null,null,'(valores[''HC106_ValidarAsignacion''] !=null && valores[''HC106_ValidarAsignacion''][''partidoJudicial''] !=null) ? valores[''HC106_ValidarAsignacion''][''partidoJudicial''] : null','TipoPlaza','0','PRODUCTO-1345')
       ...
       ,T_TIPO_TFI('HC106_ValidarAsignacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Instrucciones pendientes de definir</div>',null,null,null,null,'0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_ValidarAsignacion','1','currency','importeDemanda','Importe de la demanda',null,null,'procedimientoManager.getProcedimiento(idProcedimiento).getSaldoRecuperacion()',null,'0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_ValidarAsignacion','2','combo','proc_a_iniciar','Procedimiento a iniciar',null,null,'(valores[''HC106_RedactarDemandaAdjuntarDocu''] !=null && valores[''HC106_RedactarDemandaAdjuntarDocu''][''proc_a_iniciar''] !=null) ? valores[''HC106_RedactarDemandaAdjuntarDocu''][''proc_a_iniciar''] : null','TipoProcedimiento','0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_ValidarAsignacion','3','combo','partidoJudicial','Partido judicial',null,null,'(valores[''HC106_RedactarDemandaAdjuntarDocu''] !=null && valores[''HC106_RedactarDemandaAdjuntarDocu''][''partidoJudicial''] !=null) ? valores[''HC106_RedactarDemandaAdjuntarDocu''][''partidoJudicial''] : null','TipoPlaza','0','PRODUCTO-1345')
       ,T_TIPO_TFI('HC106_ValidarAsignacion','4','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-1345')
