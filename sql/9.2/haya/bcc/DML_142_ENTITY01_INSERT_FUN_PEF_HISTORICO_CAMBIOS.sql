...
BEGIN
    ...
    IF V_NUM_TABLAS = 1 THEN	  
        ...
        IF V_NUM_TABLAS = 1 THEN	  
		    ...
		    V_SQL :='SELECT FUN_ID FROM '||V_ESQUEMA_M||'.FUN_FUNCIONES WHERE FUN_DESCRIPCION = ''VER_SOLO_TAREAS_PROPIAS'''; 
	        ...
	        IF V_NUM_TABLAS = 0 THEN	  
				...
				V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF (FP_ID, FUN_ID, PEF_ID, USUARIOCREAR, FECHACREAR, BORRADO) VALUES ( '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, '||V_FUN_ID||', '||V_PEF_ID||',''PRODUCTO-727'', SYSDATE, 0)';
