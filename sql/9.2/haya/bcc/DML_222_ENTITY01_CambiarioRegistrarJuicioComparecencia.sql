...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar juicio y comparecencia para la tarea H016_registrarJuicioComparecencia.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'311';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_REP_JUI_PCM';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_REP_JUI_PCM';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H016';
    V_NODO VARCHAR2(50 CHAR):=				'H016_registrarJuicioComparecencia';
