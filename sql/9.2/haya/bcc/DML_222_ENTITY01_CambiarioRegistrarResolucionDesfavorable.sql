...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar resolucion desfavorable para la tarea H016_registrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'312';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SEN_REO_DFV';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Sentencia resolviendo oposición desfavorable';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PCM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SEN_REO_DFV';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H016';
    V_NODO VARCHAR2(50 CHAR):=				'H016_registrarResolucion';
