...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Registrar resolucion favorable para la tarea H016_registrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'313';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_SEN_REO_FVR';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Sentencia resolviendo oposición favorable';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'PCM';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_SEN_REO_FVR';
