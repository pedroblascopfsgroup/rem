...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Auto estimando oposicion para la tarea H001_RegistrarResolucion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'209';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_AUTO_DESEST_OP';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Auto desestimado oposicion';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_AUTO_DESEST_OP';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=		'H001';
    V_NODO VARCHAR2(50 CHAR):=				'H001_RegistrarResolucion';
