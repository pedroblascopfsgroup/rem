...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'208';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_AUTO_EST_OP';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Auto estimado oposicion';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_AUTO_EST_OP';
