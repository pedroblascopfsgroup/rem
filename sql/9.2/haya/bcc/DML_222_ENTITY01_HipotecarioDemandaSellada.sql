...
DECLARE
    ...
    */
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
    	...
    	T_INPUT('d_respHipCap','respHipCap'),
    	T_INPUT('d_respHipIntRem','respHipIntRem'),
    	T_INPUT('d_respHipDem','respHipDem'),
    	T_INPUT('d_respHipCosGas','respHipCosGas'),
    	T_INPUT('d_creditoSupl','creditoSupl'),
    	T_INPUT('d_provisionFondos','provisionFondos'),
    	T_INPUT('d_notPersonal','notPersonal'),
    	T_INPUT('d_observaciones','observaciones')
    );
