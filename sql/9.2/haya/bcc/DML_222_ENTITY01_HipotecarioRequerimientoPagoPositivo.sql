...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la resolución Requerimiento de pago positivo para la tarea H001_ConfirmarNotificacionReqPago.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):= 			'204';
    V_TR_CODIGO VARCHAR2(25 CHAR):= 		'R_PR_HIP_REQ_PAGO_POS';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=	'Notificación requerimiento de pago positivo';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=			'HIP';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=		'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=		'I_PR_HIP_REQ_PAGO_POS';
