...
--## INCIDENCIA_LINK=PRODUCTO-1607
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Actualiza la validacion de la tarea H004_SenyalamientoSubasta
...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP( 
       T_TIPO_TAP('H004','H004_SenyalamientoSubasta','comprobarMinimoBienLote() ? (existeAdjuntoUG("ESRAS","PRC") ? null : existeAdjuntoUGMensaje("ESRAS","PRC")) : ''<div align="justify" style="font-size:8pt; font-family:Arial; margin-bottom:10px;">Al menos un bien debe estar asignado a un lote</div>''','PRODUCTO-1607')
    );
    ...
    FOR I IN V_TIPO_TAP.FIRST .. V_TIPO_TAP.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN                
            V_SQL := 'UPDATE '||V_ESQUEMA||'.'||VAR_TABLENAME||' SET TAP_SCRIPT_VALIDACION=''' || REPLACE(TRIM(V_TMP_TIPO_TAP(3)),'''','''''') || ''',' ||
