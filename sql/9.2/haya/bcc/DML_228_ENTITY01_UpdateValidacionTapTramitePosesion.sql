...
--## INCIDENCIA_LINK=PRODUCTO-1517
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Actualiza el tramite Posesión (fechaSolLanza no aplica)
    ...
    FOR I IN V_TIPO_TAP.FIRST .. V_TIPO_TAP.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN                
            V_SQL := 'UPDATE '||V_ESQUEMA||'.'||VAR_TABLENAME||' SET TAP_SCRIPT_VALIDACION_JBPM=''' || REPLACE(TRIM(V_TMP_TIPO_TAP(3)),'''','''''') || ''',' ||
