...
--## INCIDENCIA_LINK=PRODUCTO-1503
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea H005_RegistrarPresentacionHacienda.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '461';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_AD_REG_RES_HA';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_AD_REG_RES_HA';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'H005';
    V_NODO VARCHAR2(50 CHAR):=              'H005_RegistrarPresentacionHacienda';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboLiquidacion','comboLiquidacion'),
