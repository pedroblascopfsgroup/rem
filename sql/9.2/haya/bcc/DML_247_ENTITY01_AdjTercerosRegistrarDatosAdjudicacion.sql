...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P457_RegistrarDatosAdjudicacion.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '462';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_REG_DAT_ADJ';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=  'Registrar datos adjudicación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=         'ADT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=        'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_REG_DAT_ADJ';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P457';
    V_NODO VARCHAR2(50 CHAR):=              'P457_RegistrarDatosAdjudicacion';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_fechaLimitePeriodoConsignacion','fechaLimitePeriodoConsignacion'),
        T_INPUT('d_nombrePostor','nombrePostor'),
        T_INPUT('d_comboPostorConsignacion','comboPostorConsignacion'),
        T_INPUT('d_cantidadPuja','cantidadPuja'),
