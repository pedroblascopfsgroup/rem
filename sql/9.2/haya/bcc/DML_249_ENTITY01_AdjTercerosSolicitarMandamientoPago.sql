...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P457_SolicitarMandamientoPago.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '464';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_SOL_MAN_PA';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_SOL_MAN_PA';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P457';
    V_NODO VARCHAR2(50 CHAR):=              'P457_SolicitarMandamientoPago';
