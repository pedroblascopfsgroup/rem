...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P457_ConfirmarRecivoEnvioMandamientoPago.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '465';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_CON_REC_ENV';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=  'Mandamiento de pago';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=         'ADT';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=        'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_CON_REC_ENV';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P457';
    V_NODO VARCHAR2(50 CHAR):=              'P457_ConfirmarRecivoEnvioMandamientoPago';
