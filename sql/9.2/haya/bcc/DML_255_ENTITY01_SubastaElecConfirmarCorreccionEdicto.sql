...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P458_ConfirmarCorreccionEdicto.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '470';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_CON_COR_EDI';
    ...
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_CON_COR_EDI';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P458';
    V_NODO VARCHAR2(50 CHAR):=              'P458_ConfirmarCorreccionEdicto';
