...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P458_RegistrarPublicacionSubastaBOE.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '472';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_REG_PUB_SUB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=  'Pantallazo de publicación de la subasta en el BOE.es';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=         'SBE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=        'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_REG_PUB_SUB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P458';
    V_NODO VARCHAR2(50 CHAR):=              'P458_RegistrarPublicacionSubastaBOE';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_fechaPublicacionBOE','fechaPublicacionBOE'),
        T_INPUT('d_comboEdictoCorrecto','comboEdictoCorrecto'),
        T_INPUT('d_fechaFinPeriodoPujas','fechaFinPeriodoPujas'),
