...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P458_RegistrarResultadoSubasta.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '475';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_REG_RES_SUB';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=  'Acta de subasta (Certificado de cierre)';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=         'SBE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=        'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_REG_RES_SUB';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P458';
    V_NODO VARCHAR2(50 CHAR):=              'P458_RegistrarResultadoSubasta';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_comboDecision','comboDecision'),
        T_INPUT('d_comboMotivo','comboMotivo'),
        T_INPUT('d_comboSubastaBienes','comboSubastaBienes'),
        T_INPUT('d_comboPostores','comboPostores'),
        T_INPUT('d_comboDetalle','comboDetalle'),
