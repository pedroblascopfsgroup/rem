...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones de la  para la tarea P458_SolicitarAdjudicacionInstruccionesEntidad.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    */
    V_TR_ID VARCHAR2(16 CHAR):=             '476';
    V_TR_CODIGO VARCHAR2(25 CHAR):=         'R_SOL_ADJ_INS';
    V_TR_DESCRIPCION  VARCHAR2(100 CHAR):=  'Escrito solicitud de adjudicación';
    V_TJ_CODIGO VARCHAR2(20 CHAR):=         'SBE';
    V_TAC_CODIGO VARCHAR2(20 CHAR):=        'ADVANCE'; -- ADVANCE, INFO, etc.
    
    V_TIN_CODIGO VARCHAR2(50 CHAR):=        'I_SOL_ADJ_INS';
    
    V_TPO_CODIGO VARCHAR2(20 CHAR):=        'P458';
    V_NODO VARCHAR2(50 CHAR):=              'P458_SolicitarAdjudicacionInstruccionesEntidad';
    ...
    V_INPUT T_ARRAY_INPUT := T_ARRAY_INPUT(
        ...
        T_INPUT('d_fechaPresentacionEscrito','fechaPresentacionEscrito'),
        T_INPUT('d_comboCuantia','comboCuantia'),
