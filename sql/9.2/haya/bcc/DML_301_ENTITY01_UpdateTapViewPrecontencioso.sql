...
--## INCIDENCIA_LINK=RECOVERY-2296
--## PRODUCTO=NO
--##
--## Finalidad: BPM - Actualiza el tap view del precontencioso y envio de la demanda
...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP( 
       T_TIPO_TAP('PCO','PCO_ValidarAsignacion','','PRODUCTO-1975')
      ,T_TIPO_TAP('HC106','HC106_ValidarAsignacion','','PRODUCTO-1975')
    );
