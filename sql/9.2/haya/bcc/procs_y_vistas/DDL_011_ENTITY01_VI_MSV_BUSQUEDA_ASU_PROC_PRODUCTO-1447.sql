...
--## Finalidad: DDL
--##           
--## INSTRUCCIONES: Modificacion de la vista V_MSV_BUSQUEDA_ASU_PROC
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
BEGIN
	...
	V_MSQL := '
			CREATE OR REPLACE FORCE VIEW '||V_ESQUEMA||'.V_MSV_BUSQUEDA_ASU_PROC (ID_, ASU_ID, PRC_ID, ASU_NOMBRE, PLAZA, JUZGADO, AUTO, TIPO_PRC, PRINCIPAL, TEX_ID, COD_ESTADO_PRC, DES_ESTADO_PRC, PRC_SALDO_RECUPERACION, PRC_FECHA_CREAR, TAR_TAREA) AS 
 ...
 DBMS_OUTPUT.PUT_LINE('[INFO] V_MSV_BUSQUEDA_ASU_PROC  Creada o reemplazada');     
