...
IF V_NUM_TABLAS = 1 THEN
    ...
    ELSE
        DBMS_OUTPUT.PUT_LINE('[ERROR] El codigo 11 ya existe');
    END IF;
    ...
    ELSE
        DBMS_OUTPUT.PUT_LINE('[ERROR] El codigo 16 ya existe');
    END IF;
    ...
    ELSE
        DBMS_OUTPUT.PUT_LINE('[ERROR] El codigo 38 ya existe');
    END IF;
    ...
    ELSE
        DBMS_OUTPUT.PUT_LINE('[ERROR] El codigo 39 ya existe');
    END IF;
