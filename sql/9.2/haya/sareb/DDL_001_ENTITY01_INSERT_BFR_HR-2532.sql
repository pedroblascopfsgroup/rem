...
V_MSQL :='INSERT into '||V_ESQUEMA||'.'||V_TABLA||' VALUES ('||V_ESQUEMA||'.S_'||V_TABLA||'.NEXTVAL,''101'',''AUSENTE'',''AUSENTE'',0,''HR-2532'',SYSDATE,null,null,null,null,0,1)';
 DBMS_OUTPUT.PUT_LINE('[QUERY] '||V_MSQL);
	 EXECUTE IMMEDIATE V_MSQL;
...
V_MSQL :='INSERT into '||V_ESQUEMA||'.'||V_TABLA||' VALUES ('||V_ESQUEMA||'.S_'||V_TABLA||'.NEXTVAL,''106'',''DIRECCION INCORRECTA'',''DIRECCION INCORRECTA'',0,''HR-2532'',SYSDATE,null,null,null,null,0,0)';
 DBMS_OUTPUT.PUT_LINE('[QUERY] '||V_MSQL);
	 EXECUTE IMMEDIATE V_MSQL;
...
V_MSQL :='INSERT into '||V_ESQUEMA||'.'||V_TABLA||' VALUES ('||V_ESQUEMA||'.S_'||V_TABLA||'.NEXTVAL,''108'',''FALLECIDO'',''FALLECIDO'',0,''HR-2532'',SYSDATE,null,null,null,null,0,0)';
 DBMS_OUTPUT.PUT_LINE('[QUERY] '||V_MSQL);
	 EXECUTE IMMEDIATE V_MSQL;
...
V_MSQL :='INSERT into '||V_ESQUEMA||'.'||V_TABLA||' VALUES ('||V_ESQUEMA||'.S_'||V_TABLA||'.NEXTVAL,''158'',''ENTREGADO EN OFICINA'',''ENTREGADO EN OFICINA'',0,''HR-2532'',SYSDATE,null,null,null,null,0,1)';
 DBMS_OUTPUT.PUT_LINE('[QUERY] '||V_MSQL);
	 EXECUTE IMMEDIATE V_MSQL;
