...
--## INCIDENCIA_LINK=PRODUCTO-2007
--## PRODUCTO=NO
--## Finalidad: DML resolucion peticion PRODUCTO-2007 del cliente Haya.
--##           
...
DECLARE
    ...
    V_USUARIO_EJECUTA VARCHAR2(25 CHAR):= 'PRODUCTO-2007'; -- Usuario que EJECUTA el paquete.
  ...
  13 externo 
	*/
    ...
    V_TIPO_DATO T_ARRAY_DATO := T_ARRAY_DATO(  
      T_TIPO_DATO('let.mlorenzo','HAYA','Haya510','Miguel','Lorenzo','Torres','mltorres@mundo-r.com','01','HAYAGESTEXT','MIGUEL LORENZO TORRES','GRUPO - MIGUEL LORENZO TORRES','1','1')
    ); 
...
BEGIN
	...
	IF V_NUM_TABLAS > 0 THEN	  
		DBMS_OUTPUT.PUT_LINE('[INFO] Ya se ejecutó el proceso:'''||V_USUARIO_EJECUTA||'''');
	ELSE
