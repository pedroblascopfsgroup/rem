...
DECLARE
    ...
    V_STA_SUBTIPO T_ARRAY_STA := T_ARRAY_STA(
      T_STA_SUBTIPO(1, 'RESPRO_GADM', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'GADM', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_DSDE', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DSDE', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_DADM', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DADM', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_DCON', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DCON', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_DDEU', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DDEU', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_DLISUB', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'DLISUB', 'EXTSubtipoTarea'),
      ...
      T_STA_SUBTIPO(1, 'RESPRO_GSUBC', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'GSUBC', 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'RESPRO_SSUBC', 'Solicitar Prorroga PRC', 'Solicitar Prorroga PRC', NULL, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, 'SSUBC', 'EXTSubtipoTarea')
    );   
