...
DECLARE
    ...
    V_STA_SUBTIPO T_ARRAY_STA := T_ARRAY_STA(
      T_STA_SUBTIPO(1, 'SOLPRENSAN', 'Solicitar Prorroga ENSAN', 'Solicitar Prorroga En Sanción', 1, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(1, 'SOLPRSANC', 'Solicitar Prorroga SANC', 'Solicitar Prorroga Sancionado', 1, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(3, 'VENENSAN', 'Notificacion ENSAN Vencida', 'Notificacion En Sanción Vencida', 0, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(3, 'VENSANC', 'Notificacion SANC Vencida', 'Notificacion Sancionado Vencida', 0, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(3, 'PRRECENSAN', 'Notif Solic Prorroga ENSAN Rechazada', 'Notif Solic Prorroga En Sanción Rechazada', 1, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea'),
      T_STA_SUBTIPO(3, 'PRRECSANC', 'Notif Solic Prorroga SANC Rechazada', 'Notif Solic Prorroga Sancionado Rechazada', 1, 0, 'DD', SYSDATE, NULL, NULL, NULL, NULL, 0, null, 'EXTSubtipoTarea')
    );   
