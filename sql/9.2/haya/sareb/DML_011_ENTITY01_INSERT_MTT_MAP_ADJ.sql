...
BEGIN
    ...
    V_SQL := 'UPDATE '||V_ESQUEMA||'.MTT_MAP_ADJRECOVERY_ADJCM SET BORRADO = 1, USUARIOBORRAR =''PRODUCTO-1117'', FECHABORRAR = sysdate ';
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN   
        	...
        	IF V_NUM_TABLAS > 0 THEN
        			...
        			V_MSQL := 'UPDATE '||V_ESQUEMA||'.MTT_MAP_ADJRECOVERY_ADJCM SET TFA_CODIGO_EXTERNO =  '''||TRIM(V_TMP_FUNCION(2))||''' ,FECHAMODIFICAR = SYSDATE, USUARIOMODIFICAR = ''PRODUCTO-1117'', BORRADO=0, USUARIOBORRAR=NULL, FECHABORRAR=NULL  WHERE DD_TFA_ID = '''||V_TFA_ID||'''';
