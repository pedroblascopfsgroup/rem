...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		...
		T_FUNCION('OTR','PR-12-IPLS-15'),
		T_FUNCION('OTR','PR-12-IPLS-16'),
		T_FUNCION('OTR','PR-12-IPLS-17'),
		T_FUNCION('OTR','PR-12-IPLS-18'),
		T_FUNCION('OTR','PR-12-IPLS-19'),
		T_FUNCION('OTR','PR-12-IPLS-20'),
		T_FUNCION('OTR','PR-12-IPLS-21'),
		T_FUNCION('OTR','PR-12-IPLS-22'),
		T_FUNCION('OTR','PR-12-IPLS-23'),
		T_FUNCION('OTR','PR-12-IPLS-24'),
		T_FUNCION('OTR','PR-12-IPLS-25'),
		T_FUNCION('OTR','PR-12-IPLS-26'),
		T_FUNCION('OTR','PR-12-IPLS-27'),
		T_FUNCION('OTR','PR-12-IPLS-28'),
		T_FUNCION('OTR','PR-12-IPLS-36'),
		T_FUNCION('OTR','PR-12-IPLS-37'),
		T_FUNCION('OTR','PR-04-OTRO-02'),
		T_FUNCION('INFTAVA','PR-08-ESIN-AK'),
		T_FUNCION('PBOE','PR-09-CERA-61'),
		T_FUNCION('LIC','PR-09-CERA-62'),
		T_FUNCION('PTSU','PR-09-CERJ-79'),
		T_FUNCION('CON','PR-09-CNCV-63'),
		T_FUNCION('ESC','PR-09-ESCR-30'),
		T_FUNCION('POL','PR-09-SEGU-20'),
		T_FUNCION('ENOV','PR-13-ESCR-31'),
		T_FUNCION('EAMP','PR-13-ESCR-32'),
		T_FUNCION('EONDH','PR-13-ESCR-13'),
		T_FUNCION('EDRH','PR-13-ESCR-33'),
		T_FUNCION('ESAF','PR-13-ESCR-34'),
		T_FUNCION('PREN','PR-13-ESCR-35'),
		T_FUNCION('TEEJ','PR-13-DOCJ-87'),
		T_FUNCION('ESUB','PR-13-ESCR-18'),
		T_FUNCION('PBOE','PR-09-DOCJ-83'),
		T_FUNCION('LIC','PR-09-CERA-62'),
		T_FUNCION('ODE','PR-03-OTRO-04'),
		T_FUNCION('INFTAVA','PR-09-TASA-14')
    ); 
