...
BEGIN
    ...
    V_SQL := 'UPDATE '||V_ESQUEMA||'.MTC_MAPEO_TIPO_CONTENEDOR SET BORRADO = 1, USUARIOBORRAR =''PRODUCTO-1117'', FECHABORRAR = sysdate ';
        ...
        IF V_NUM_TABLAS > 0 THEN   
        	...
        	IF V_NUM_TABLAS = 0 THEN
          	...
          	ELSE
          		    ...
          		    DBMS_OUTPUT.PUT_LINE('YA EXISTE en MTC_MAPEO_TIPO_CONTENEDOR los datos: '''||V_TMP_FUNCION(1)||''','''||TRIM(V_TMP_FUNCION(2))||'''');
