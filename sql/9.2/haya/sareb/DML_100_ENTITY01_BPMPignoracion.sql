...
DECLARE
    ...
    V_TIPO_TPO T_ARRAY_TPO := T_ARRAY_TPO(
      T_TIPO_TPO('P450','T. formalización pignoración','Trámite formalización pignoración',null,'tramiteFormalizacionPignoracion','0','PRODUCTO-709','0','ACU',null,null,'1','MEJTipoProcedimiento','1','0')
    ); 
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P450','P450_GestionarEntregaCuenta',null,null,null,null,null,'0','Gestionar entrega a cuenta','0','PRODUCTO-709','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
       T_TIPO_TAP('P450','P450_ContabilizarOperacion',null,null,null,null,null,'0','Contabilizar la operación','0','PRODUCTO-709','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null),
       T_TIPO_TAP('P450','P450_InformeCierreSareb',null,null,null,null,null,'0','Informar cierre a Sareb','0','PRODUCTO-709','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'39',null,null,null)
    ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      T_TIPO_PLAZAS(null,null,'P450_GestionarEntregaCuenta','5*24*60*60*1000L','0','0','PRODUCTO-709'),
      T_TIPO_PLAZAS(null,null,'P450_ContabilizarOperacion','5*24*60*60*1000L','0','0','PRODUCTO-709'),  
      T_TIPO_PLAZAS(null,null,'P450_InformeCierreSareb','5*24*60*60*1000L','0','0','PRODUCTO-709') 
    ); 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        T_TIPO_TFI('P450_GestionarEntregaCuenta','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">El Gestor de Soporte Deuda ha de gestionar con la oficina la entrega a cuenta. </p><p>Para finalizar con esta tarea, indicaremos en el primer campo, la fecha en la que se realiza la entrega a cuenta. </p><p>En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-709'),
        T_TIPO_TFI('P450_GestionarEntregaCuenta','1','date','fecha','Fecha',null,null,null,null,'0','PRODUCTO-709'),
	    T_TIPO_TFI('P450_GestionarEntregaCuenta','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-709'),
	    T_TIPO_TFI('P450_ContabilizarOperacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para finalizar con esta tarea, se debe informar de la que fecha en la que ha contabilizado la operación en NOS. </p><p>En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-709'),
        T_TIPO_TFI('P450_ContabilizarOperacion','1','date','fecha','Fecha',null,null,null,null,'0','PRODUCTO-709'),
	    T_TIPO_TFI('P450_ContabilizarOperacion','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-709'),
	    T_TIPO_TFI('P450_InformeCierreSareb','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta tarea, se adjuntará en la pestaña de Adjuntos de la actuación toda la documentación obligatoria a Sareb para que éste lleve a cabo su cierre:</p><p>- Medio de pago nominativo que esté protocolizado en el escritura. </p><p>- Carta de pago de la cancelación total, en caso de cancelación total de la deuda.</p><p>En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento.</p></div>',null,null,null,null,'0','PRODUCTO-709'),
        T_TIPO_TFI('P450_InformeCierreSareb','1','date','fecha','Fecha',null,null,null,null,'0','PRODUCTO-709'),
	    T_TIPO_TFI('P450_InformeCierreSareb','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-709')
	    ); 
