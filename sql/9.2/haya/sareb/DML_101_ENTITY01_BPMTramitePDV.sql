...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P456','P456_ObtenerAprobacionCN','plugin/procedimientos-bpmHaya-plugin/tramitePDV/obtenerAprobacionCN',null,'(valores[''P456_ObtenerAprobacionCN''][''obtencionAprobacion''] == DDSiNo.SI && valores[''P456_ObtenerAprobacionCN''][''revisionCorrecta''] == null) ? ''El campo revisión correcta es obligatorio'' : null','valores[''P456_ObtenerAprobacionCN''][''obtencionAprobacion''] == DDSiNo.NO ? (valores[''P456_ObtenerAprobacionCN''][''revisionCorrecta''] == DDSiNo.Si ? ''Si'': ''No'') : ''No''',null,'0','Obtener aprobación CN','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'GCN',null)
       ,T_TIPO_TAP('P456','P456_ComunicacionAcreditadoCN',null,null,null,null,null,'0','Comunicación al acreditado CN','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_EnviarDesistirWFCN',null,null,null,null,null,'0','Enviar a desistir WF CN','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ConfeccionarBorradorContratoAcreditado',null,null,null,'valores[''P456_ConfeccionarBorradorContratoAcreditado''][''requiereValidacion''] == DDSiNo.SI ? ''Si'' : ''No''',null,'0','Confeccionar borrador contrato acreditado','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ValidarBorradorContratoAJ',null,null,null,'valores[''P456_ValidarBorradorContratoAJ''][''valida''] == ''01'' ? ''Aprobada'' : ''Rechazada''',null,'0','Validar borrador contrato AJ','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TAJUR',null,'SAJUR',null)
       ,T_TIPO_TAP('P456','P456_ComunicacionAcreditadoAJ',null,null,null,null,null,'0','Comunicación al acreditado AJ','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'SDEU',null,null,null)
       ,T_TIPO_TAP('P456','P456_EnviarDesistirWFAJ',null,null,null,null,null,'0','Enviar a desistir WF AJ','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_EnvioBorradorContratoAcreditado',null,null,null,null,null,'0','Envío borrador contrato al Acreditado','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_AcordarFechaFirma','plugin/procedimientos-bpmHaya-plugin/tramitePDV/acordarFechaFirma',null,'(valores[''P456_AcordarFechaFirma''][''comboAprobacion''] == ''02'' && valores[''P456_AcordarFechaFirma''][''comboResolucion''] == null) ? ''El campo resolución con acreditado es obligatorio'' : (valores[''P456_AcordarFechaFirma''][''comboResolucion''] == ''REC'' && valores[''P456_AcordarFechaFirma''][''comboRechazo''] == null) ? ''El campo acción del rechazo es obligatorio'' : (valores[''P456_AcordarFechaFirma''][''comboAprobacion''] == ''01'' && (valores[''P456_AcordarFechaFirma''][''fechaPrevista''] == null || valores[''P456_AcordarFechaFirma''][''comboAsistencia''] == null) ? ''Hay campos obligatorios pendientes de rellenar'' : (valores[''P456_AcordarFechaFirma''][''firmaNotario''] == DDSiNo.SI && valores[''P456_AcordarFechaFirma''][''notario''] == null  ? ''El campo notario es obligatorio'' : null))','valores[''P456_AcordarFechaFirma''][''comboAprobacion''] == ''01'' ? ''Aceptada'' : (valores[''P456_AcordarFechaFirma''][''comboResolucion''] == ''ACE'' ? ''Aceptada'' : (valores[''P456_AcordarFechaFirma''][''comboRechazo''] == ''RECON'' ? ''Reconsiderar'' : ''Desistir''))',null,'0','Acordar fecha firma','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_RevisarPropuesta',null,null,null,null,null,'0','Revisar propuesta','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ElevarSareb',null,null,null,null,null,'0','Elevar a Sareb','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_RegistrarResolucionSareb',null,null,null,'valores[''P456_RegistrarResolucionSareb''][''comboResolucion''] == ''01'' ? ''Aceptada'' : ''Rechazada''',null,'0','Registrar resolución Sareb','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ComunicacionAcreditadoSareb',null,null,null,null,null,'0','Comunicación al Acreditado Sareb','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_EnviarDesistirWFSareb',null,null,null,null,null,'0','Enviar a desistir WF Sareb','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_PrepararContrato',null,null,null,'valores[''P456_PrepararContrato''][''requiereValidacion''] == DDSiNo.SI ? ''Si'' : ''No''',null,'0','Preparar contrato','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ValidacionContratoAJ',null,null,null,'valores[''P456_ValidacionContratoAJ''][''valida''] == ''01'' ? ''Validado'' : ''NoValidado''',null,'0','Validación contrato AJ','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TAJUR',null,'SAJUR',null)
       ,T_TIPO_TAP('P456','P456_EnvioContratoAcreditado',null,null,null,null,null,'0','Envío del contrato al acreditado','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ...
       ,T_TIPO_TAP('P456','P456_EnviarDesistirPreviaFirmaOperacion',null,null,null,null,null,'0','Enviar a desistir WF previa firma operación','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_VolcadoCondicionesResolucion',null,null,null,null,null,'0','Volcado de condiciones resolución','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_InformarCierreSareb',null,null,null,null,null,'0','Informar cierre a Sareb','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_AnalisisEvolucionPDV',null,null,null,'valores[''P456_AnalisisEvolucionPDV''][''resultadoRevision''] == DDSiNo.SI ? ''Si'' : ''No''',null,'0','Análisis evolución PDV','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ObtenerDocumentacionOriginal',null,null,null,null,null,'0','Obtener documentación original','0','PRODUCTO-945','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P456','P456_ComunicacionAcreditadoRenovacion',null,null,null,null,null,'0','Comunicación al acreditado Renovación','0','PRODUCTO-945','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      ...
      ,T_TIPO_PLAZAS(null,null,'P456_AnalisisEvolucionPDV','damePlazo(valores[''P456_FirmarOperacion''][''fechaRenovacion'']) - 60*24*60*60*1000L','0','0','PRODUCTO-945') 
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        ,T_TIPO_TFI('P456_RegistrarResolucionSareb','1','number','numeroPropuesta','Número propuesta',null,null,'(valores[''P456_ElevarSareb''] !=null && valores[''P456_ElevarSareb''][''numeroPropuesta''] !=null) ? valores[''P456_ElevarSareb''][''numeroPropuesta''] : null',null,'0','PRODUCTO-945')
        ,T_TIPO_TFI('P456_RegistrarResolucionSareb','2','date','fechaPropuesta','Fecha propuesta','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-945')
        ,T_TIPO_TFI('P456_RegistrarResolucionSareb','3','combo','comboResolucion','Resolución Sareb',null,null,null,'DDFavorable','0','PRODUCTO-945')
        ,T_TIPO_TFI('P456_RegistrarResolucionSareb','4','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-945')
    ...
    FOR I IN V_TIPO_PLAZAS.FIRST .. V_TIPO_PLAZAS.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN                
          ...
          V_SQL := 'UPDATE '||V_ESQUEMA||'.DD_PTP_PLAZOS_TAREAS_PLAZAS SET DD_PTP_PLAZO_SCRIPT=''' || REPLACE(TRIM(V_TMP_TIPO_PLAZAS(4)),'''','''''')  || '''' || 
