...
DECLARE
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        ,T_TIPO_TFI('P456_EnvioBorradorContradoAcreditado','1','date','Fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-945')
		...
		,T_TIPO_TFI('P456_AcordarFechaFirma','2','combo','comboResolucion','Resolución con acreditado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-945')
		,T_TIPO_TFI('P456_AcordarFechaFirma','3','combo','comboRechazo','Acción del rechazo','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-945')
        ...
        ,T_TIPO_TFI('P456_PrepararContrato','1','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'(valores[''P456_ElevarSareb''] !=null && valores[''P456_ElevarSareb''][''numeroPropuesta''] !=null) ? valores[''P456_ElevarSareb''][''numeroPropuesta''] : null','0','PRODUCTO-945')
        ...
        ,T_TIPO_TFI('P456_EnvioContratoAcreditado','1','date','fecha','Fecha','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'(valores[''P456_ElevarSareb''] !=null && valores[''P456_ElevarSareb''][''numeroPropuesta''] !=null) ? valores[''P456_ElevarSareb''][''numeroPropuesta''] : null','0','PRODUCTO-945')
		...
		,T_TIPO_TFI('P456_FirmarOperacion','2','date','fechaPrevista','Fecha prevista de firma',null,null,null,'(valores[''P456_AcordarFechaFirma''] !=null && valores[''P456_AcordarFechaFirma''][''fechaPrevista''] !=null) ? valores[''P456_AcordarFechaFirma''][''fechaPrevista''] : null','0','PRODUCTO-945')
        ...
        ,T_TIPO_TFI('P456_AnalisisEvolucionPDV','2','text','resultadoRevision','Resultado revisión','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-945')
        ,T_TIPO_TFI('P456_AnalisisEvolucionPDV','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-945')
        ...
        ,T_TIPO_TFI('P456_ComunicacionAcreditadoRenovacion','1','date','fechaComunicacion','Fecha comunicación cliente','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-945')
