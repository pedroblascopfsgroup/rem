...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       ...
       ,T_TIPO_TAP('P453','P453_ObtenerAprobacionCN',null,null,'(valores[''P453_ObtenerAprobacionCN''][''comboObtencionAprobacionCN''] == DDSiNo.SI && valores[''P453_ObtenerAprobacionCN''][''comboRevisionCorrecta''] == null) ? ''El campo revisión correcta es obligatorio'' : null''','valores[''P453_ObtenerAprobacionCN''][''comboObtencionAprobacionCN''] == DDSiNo.SI ? ''si'':''no''',null,'0','Obtener aprobación CN','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        ,T_TIPO_TFI('P453_AcordarFechaFirma','2','combo','comboResolucion','Resolución con acreditado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDResolucionAcreditado','0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_AcordarFechaFirma','6','combo','comboAsistenciaAFirma','Asistencia a firma',null,null,null,'DDAsistenciaAFirma','0','PRODUCTO-948')
