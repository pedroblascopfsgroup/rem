...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P453','P453_DefinirDocumentacionAportar',null,null,null,null,null,'0','Definir documentación a aportar','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGEA',null,null,null)
       ,T_TIPO_TAP('P453','P453_AdjuntarDueDiligenceJuridica',null,null,null,null,null,'0','Adjuntar due diligence jurídica','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGEA',null,null,null)
       ,T_TIPO_TAP('P453','P453_AdjuntarDueDiligenceTecnica',null,null,null,null,null,'0','Adjuntar due diligence técnica','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGEA',null,null,null)
       ,T_TIPO_TAP('P453','P453_ObtenerAprobacionCN',null,null,null,'valores[''P453_ObtenerAprobacionCN''][''comboObtencionAprobacionCN''] == DDSiNo.SI ? ''si'':''no''',null,'0','Obtener aprobación CN','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_ComunicacionAcreditado',null,null,null,null,null,'0','Comuniación acreditado CN','0','PRODUCTO-948','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_EnviarDesistirWF',null,null,null,null,null,'0','Enviar a desistir WF CN','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_ConfeccionarNegociarSupervisarMinuta',null,null,null,'valores[''P453_ConfeccionarNegociarSupervisarMinuta''][''comboRequiereAutorizacion''] == DDSiNo.SI ? ''si'':''no''',null,'0','Confeccionar, negociar y supervisar minuta','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGEA',null,null,null)
       ,T_TIPO_TAP('P453','P453_RegistrarValidacionMinutaPorSareb',null,null,null,'valores[''P453_RegistrarValidacionMinutaPorSareb''][''comboResolucion''] == DDFavorable.FAVORABLE ? ''si'':''no''',null,'0','Registrar validacion minuta por Sareb','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'TGEA',null,null,null)
       ,T_TIPO_TAP('P453','P453_ComunicacionAcreditadoSareb',null,null,null,null,null,'0','Comunicación acreditado Sareb','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_EnviarDesistirWFSareb',null,null,null,null,null,'0','Enviar desistir WF Sareb','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_AcordarFechaFirma',null,null,null,'valores[''P453_AcordarFechaFirma''][''comboAprobacionCN''] == ''01'' ? ''si'' : (valores[''P453_AcordarFechaFirma''][''comboResolucionAcreditado''] == ''01'' ? ''si'' : ''no'')',null,'0','Acordar fecha firma','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_FirmarOperacion',null,null,null,'valores[''P453_FirmarOperacion''][''comboFormalizadaOperacion''] == DDSiNo.SI ? ''si'':''no''',null,'0','Firmar operación','0','PRODUCTO-948','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_ObtenerDocumentacionOriginal',null,null,null,null,null,'0','Obtener documentación original','0','PRODUCTO-948','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_InformarCierreSareb',null,null,null,null,null,'0','Informar cierre Sareb','0','PRODUCTO-948','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
       ,T_TIPO_TAP('P453','P453_ContabilizarOperacion',null,null,null,null,null,'0','Contabilizar operación','0','PRODUCTO-948','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,null,null)
       ,T_TIPO_TAP('P453','P453_EnviarDesisitirPreviaFirmaOperacion',null,null,null,null,null,'0','Enviar a desisitir previa firma operación','0','PRODUCTO-948','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      ...
      ,T_TIPO_PLAZAS(null,null,'P453_FirmarOperacion','(valores[''P453_AcordarFechaFirma''] !=null && valores[''P453_AcordarFechaFirma''][''fechaPrevistaFirma''] !=null) ? damePlazo(valores[''P453_AcordarFechaFirma''][''fechaPrevistaFirma'']) : 5*24*60*60*1000L','0','0','PRODUCTO-948')
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        ,T_TIPO_TFI('P453_DefinirDocumentacionAportar','2','combo','comboTecnica','Adjuntar Due Diligence Técnica','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-948')
		    ...
		    ,T_TIPO_TFI('P453_AdjuntarDueDiligenceJuridica','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por finalizada la tarea, debe adjuntar en la pestaña de adjuntos de la Actuación, la due diligence jurídica, que recoja el análisis del activo desde el punto de vista legal y fiscal. En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento. La due se realiza por externo homologado. La contratación de la due se realiza por equipo Adquisiciones dentro de las funciones delegadas con cargo a Sareb.</p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_AdjuntarDueDiligenceTecnica','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Para dar por finalizada la tarea, debe adjuntar en la pestaña de adjuntos de la Actuación, la due diligence técnica, que recoja el análisis del activo desde el punto de vista técnico o urbanístico. En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento. La due se realiza por externo homologado. La contratación de la due se realiza por equipo Adquisiciones dentro de las funciones delegadas con cargo a Sareb.</p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_ObtenerAprobacionCN','3','combo','comboRevisionCorrecta','Revisión correcta',null,null,null,'DDSiNo','0','PRODUCTO-948')
		    ...
		    ,T_TIPO_TFI('P453_ComunicacionAcreditado','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">Se deberá comunicar al Acreditado la finalización de la operación. A continuación, informaremos la fecha de comunicación al Acreditado. En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento. A continuación, saltará la tarea "Enviar a desistir WF".</p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_EnviarDesistirWF','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-948')
		    ...
		    ,T_TIPO_TFI('P453_ConfeccionarNegociarSupervisarMinuta','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px">En esta tarea, deberá adjuntarse el borrador de minuta de Dación. <br>El equipo de HRE-Adquisiciones supervisa y valida el borrador de minuta preparado por el despacho jurídico externo una vez negociado. <br>En el caso de que se requiera autorización de Sareb, debido a que sea necesario validar ciertas cláusulas de la minuta, susceptibles de revisión por parte de Sareb, se indicará con un Sí en el campo “Requiere autorización de Sareb”.<br>En caso de no ser necesario requerir la validación de la minuta por parte de Sareb,  se lanzará la siguiente  tarea “Informar de la fecha firma para la formalización” para formalizar la operación.<br>En el campo observaciones deberá informar cualquier aspecto relevante que le interese que quede reflejado en este punto del procedimiento.<br></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_RegistrarValidacionMinutaPorSareb','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_RegistrarValidacionMinutaPorSareb','4','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-948')
		    ...
		    ,T_TIPO_TFI('P453_ComunicacionAcreditadoSareb','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_EnviarDesistirWFSareb','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_AcordarFechaFirma','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','1','combo','comboAprobacionCN','Aprobación CN','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDSiNo','0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','2','combo','comboResolucionAcreditado','Resolución con acreditado','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'DDResolucionAcreditado','0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','4','date','fechaPrevistaFirma','Fecha prevista de firma',null,null,null,null,'0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','5','date','fechaFirmaNotaria','Firma en notaría','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','6','text','notario','Notario',null, null, null, null,'0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','7','combo','comboAsistenciaAFirma','Asistencia a firma',null,null,null,'DDAsistenciaAFirma','0','PRODUCTO-948')
        ,T_TIPO_TFI('P453_AcordarFechaFirma','8','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-948')

        ,T_TIPO_TFI('P453_FirmarOperacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_FirmarOperacion','2','date','fechaPrevistaFirma','Fecha Prevista de Firma',null,null,'(valores[''P453_AcordarFechaFirma''] !=null && valores[''P453_AcordarFechaFirma''][''fechaPrevistaFirma''] !=null) ? valores[''P453_AcordarFechaFirma''][''fechaPrevistaFirma''] : 5*24*60*60*1000L',null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_ObtenerDocumentacionOriginal','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_InformarCierreSareb','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_ContabilizarOperacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
        ...
        ,T_TIPO_TFI('P453_EnviarDesisitirPreviaFirmaOperacion','0','label','titulo','<div align="justify" style="font-size: 8pt; font-family: Arial; margin-bottom: 30px;"><p style="margin-bottom: 10px"></p></div>',null,null,null,null,'0','PRODUCTO-948')
    ...
    FOR I IN V_TIPO_TAP.FIRST .. V_TIPO_TAP.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          ' DD_TPO_ID_BPM=(SELECT DD_TPO_ID FROM ' || V_ESQUEMA || '.DD_TPO_TIPO_PROCEDIMIENTO WHERE TAP_CODIGO = ''' || TRIM(V_TMP_TIPO_TAP(7)) || ''')' ||
