...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       ...
       ,T_TIPO_TAP('P455','P455_EnviarDesistirWFEscrituras',null,null,null,null,null,'0','Enviar a desistir WF CN','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,null,null)
    ...
    V_TIPO_TFI T_ARRAY_TFI := T_ARRAY_TFI(
        ...
        ,T_TIPO_TFI('P455_RegistrarResolucionSareb','1','date','fechaPropuesta','Fecha propuesta','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,'(valores[''P455_ElevarSareb''] !=null && valores[''P455_ElevarSareb''][''numeroPropuesta''] !=null) ? valores[''P455_ElevarSareb''][''numeroPropuesta''] : null','0','PRODUCTO-946')
        ,T_TIPO_TFI('P455_RegistrarResolucionSareb','2','combo','comboResolucion','Resolución Sareb',null,null,null,'DDFavorable','0','PRODUCTO-946')
		,T_TIPO_TFI('P455_RegistrarResolucionSareb','3','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-946')
        ...
        ,T_TIPO_TFI('P455_EnviarDesistirWFSareb','1','date','fechaCierre','Fecha cierre WF','tareaExterna.error.PGENERICO_TareaGenerica.campoObligatorio','valor != null && valor != '''' ? true : false',null,null,'0','PRODUCTO-946')
        ,T_TIPO_TFI('P455_EnviarDesistirWFSareb','2','textarea','observaciones','Observaciones',null,null,null,null,'0','PRODUCTO-946')
