...
DECLARE
    ...
    V_TIPO_TAP T_ARRAY_TAP := T_ARRAY_TAP(
       T_TIPO_TAP('P455','P455_ObtenerAprobacionCN','plugin/procedimientos-bpmHaya-plugin/tramiteVentaDeCredito/obtenerAprobacionCN',null,'(valores[''P455_ObtenerAprobacionCN''][''obtencionAprobacion''] == DDSiNo.SI && valores[''P455_ObtenerAprobacionCN''][''revisionCorrecta''] == null) ? ''El campo revisión correcta es obligatorio'' : null','valores[''P455_ObtenerAprobacionCN''][''obtencionAprobacion''] == DDSiNo.SI ? (valores[''P455_ObtenerAprobacionCN''][''revisionCorrecta''] == DDSiNo.SI ? ''Si'' : ''No'') : ''No''',null,'0','Obtener aprobación CN','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'GCN',null)
       ,T_TIPO_TAP('P455','P455_ComunicacionAcreditadoCN',null,null,null,null,null,'0','Comunicación al acreditado CN','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_EnviarDesistirWFCN',null,null,null,null,null,'0','Enviar a desistir WF CN','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_ConfeccionarBorradorContratoAcreditado',null,null,null,'valores[''P455_ConfeccionarBorradorContratoAcreditado''][''requiereValidacion''] == DDSiNo.SI ? ''Si'' : ''No''',null,'0','Confeccionar borrador contrato acreditado','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_ValidarBorradorContratoAJ',null,null,null,'valores[''P455_ValidarBorradorContratoAJ''][''valida''] == ''01'' ? ''Aprobada'' : ''Rechazada''',null,'0','Validar borrador contrato AJ','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TAJUR',null,'SAJUR',null)
       ,T_TIPO_TAP('P455','P455_ComunicacionAcreditadoAJ',null,null,null,null,null,'0','Comunicación al acreditado AJ','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TAJUR',null,'SAJUR',null)
       ,T_TIPO_TAP('P455','P455_EnviarDesistirWFAJ',null,null,null,null,null,'0','Enviar a desistir WF AJ','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_EnvioBorradorContratoAcreditado',null,null,null,null,null,'0','Envío borrador contrato al Acreditado','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)      
       ,T_TIPO_TAP('P455','P455_PeticionEscriturasCaracterEjecutivo',null,null,'(valores[''P455_PeticionEscriturasCaracterEjecutivo''][''adjuntarEscrituras''] == DDSiNo.NO && valores[''P455_PeticionEscriturasCaracterEjecutivo''][''aceptacionAcreditado''] == null) ? ''Es necesario rellenar el campo aceptacion del acreditado'' : null','valores[''P455_PeticionEscriturasCaracterEjecutivo''][''adjuntarEscrituras''] == DDSiNo.SI ? ''si'' : ((valores[''P455_PeticionEscriturasCaracterEjecutivo''][''aceptacionAcreditado''] != null && valores[''P455_PeticionEscriturasCaracterEjecutivo''][''aceptacionAcreditado''] == DDSiNo.SI) ? ''si'':''no'')',null,'0','Peticion Escrituras con Caracter Ejecutivo','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_EnviarDesistirWFEscrituras',null,null,null,null,null,'0','Enviar a desistir WF Escrituras','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_AcordarFechaFirma','plugin/procedimientos-bpmHaya-plugin/tramiteVentaDeCredito/acordarFechaFirma',null,'(valores[''P455_AcordarFechaFirma''][''comboAprobacion''] == ''02'' && valores[''P455_AcordarFechaFirma''][''comboResolucion''] == null) ? ''El campo resolución con acreditado es obligatorio'' : (valores[''P455_AcordarFechaFirma''][''comboResolucion''] == ''REC'' && valores[''P455_AcordarFechaFirma''][''comboRechazo''] == null) ? ''El campo acción del rechazo es obligatorio'' : (valores[''P455_AcordarFechaFirma''][''comboAprobacion''] == ''01'' && (valores[''P455_AcordarFechaFirma''][''fechaPrevista''] == null || valores[''P455_AcordarFechaFirma''][''comboAsistencia''] == null) ? ''Hay campos obligatorios pendientes de rellenar'' : (valores[''P455_AcordarFechaFirma''][''firmaNotario''] == DDSiNo.SI && valores[''P455_AcordarFechaFirma''][''notario''] == null  ? ''El campo notario es obligatorio'' : null))','valores[''P455_AcordarFechaFirma''][''comboAprobacion''] == ''01'' ? ''Aceptada'' : (valores[''P455_AcordarFechaFirma''][''comboResolucion''] == ''ACE'' ? ''Aceptada'' : (valores[''P455_AcordarFechaFirma''][''comboRechazo''] == ''RECON'' ? ''Reconsiderar'' : ''Desistir''))',null,'0','Acordar fecha firma','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_RevisarPropuesta',null,null,null,null,null,'0','Revisar propuesta','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_ElevarSareb',null,null,null,null,null,'0','Elevar a Sareb','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_RegistrarResolucionSareb',null,null,null,'valores[''P455_RegistrarResolucionSareb''][''comboResolucion''] == ''01'' ? ''Aceptada'' : ''Rechazada''',null,'0','Registrar resolución Sareb','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SSDE',null)
       ,T_TIPO_TAP('P455','P455_ComunicacionAcreditadoSareb',null,null,null,null,null,'0','Comunicación al Acreditado Sareb','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'805',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_EnviarDesistirWFSareb',null,null,null,null,null,'0','Enviar a desistir WF Sareb','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_PrepararContrato',null,null,null,'valores[''P455_PrepararContrato''][''requiereValidacion''] == DDSiNo.SI ? ''Si'' : ''No''',null,'0','Preparar contrato','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'805',null,'SSDE',null)
       ,T_TIPO_TAP('P455','P455_ValidacionContratoAJ',null,null,null,'valores[''P455_ValidacionContratoAJ''][''valida''] == ''01'' ? ''Validado'' : ''NoValidado''',null,'0','Validación contrato AJ','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'TAJUR',null,'SAJUR',null)
       ,T_TIPO_TAP('P455','P455_EnvioContratoAcreditado',null,null,null,null,null,'0','Envío del contrato al acreditado','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ...
       ,T_TIPO_TAP('P455','P455_EnviarDesistirPreviaFirmaOperacion',null,null,null,null,null,'0','Enviar a desistir WF previa firma operación','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_InformarCierreSareb',null,null,null,null,null,'0','Informar cierre a Sareb','0','PRODUCTO-946','0',null,'tareaExterna.cancelarTarea',null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ,T_TIPO_TAP('P455','P455_ContabilizarOperacion',null,null,null,null,null,'0','Contabilizar Operacion','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'805',null,'SSDE',null)
       ,T_TIPO_TAP('P455','P455_ObtenerDocumentacionOriginal',null,null,null,null,null,'0','Obtener documentación original','0','PRODUCTO-946','0',null,null,null,'1','EXTTareaProcedimiento','3',null,'803',null,'SDEU',null)
       ); 
    ...
    V_TIPO_PLAZAS T_ARRAY_PLAZAS := T_ARRAY_PLAZAS(
      ...
      ,T_TIPO_PLAZAS(null,null,'P455_ContabilizarOperacion','5*24*60*60*1000L','0','0','PRODUCTO-946')
    ); 
