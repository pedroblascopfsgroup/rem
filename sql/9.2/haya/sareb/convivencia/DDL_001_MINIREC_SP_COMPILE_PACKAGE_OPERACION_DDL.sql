...
DECLARE
    ...
    V_ESQUEMA_MINI VARCHAR2(25 CHAR):= '#ESQUEMA_MINIREC#'; -- Configuracion Esquema Master
    ...
    V_MSQL := 'create or replace PACKAGE '||V_ESQUEMA_MINI||'.OPERACION_DDL AS 
    
  --** Declaramos Variables, Constantes, Excepcione s
...
V_MSQL := 'create or replace package body '||V_ESQUEMA_MINI||'.OPERACION_DDL as
