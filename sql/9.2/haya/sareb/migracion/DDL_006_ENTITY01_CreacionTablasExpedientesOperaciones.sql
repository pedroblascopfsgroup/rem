...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla MIG_EXPEDIENTES_OPERACIONES
...
DECLARE
 ...
 TABLA VARCHAR(30) :='MIG_EXPEDIENTES_OPERACIONES';
 err_num NUMBER;
 err_msg VARCHAR2(2048); 
 V_MSQL VARCHAR2(8500 CHAR);
 S_MSQL VARCHAR2(8500 CHAR);
 V_EXISTE NUMBER (1);
 SECUENCIA VARCHAR(30) :='S_MIG_EXPEDIENTES_OPERACIONES';
...
--Validamos si la tabla existe antes de crearla
  ...
  V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||TABLA||' 
   (	
	...
	TIPO_RELACION		VARCHAR2(20 CHAR) , 
	CONSTRAINT "PK_MIG_EXP_OPE_ID" PRIMARY KEY ("MIG_EXP_OPE_ID")
