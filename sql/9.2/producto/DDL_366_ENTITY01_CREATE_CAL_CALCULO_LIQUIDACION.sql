...
DECLARE
    ...
    IF V_NUM_TABLAS = 0 THEN	
		    ...
		    V_SQL := 'CREATE INDEX '||V_ESQUEMA||'.IDX_ASU_ID_CAL_CALCULO_LIQUIDACION ON '||V_ESQUEMA||'.CAL_CALCULO_LIQUIDACION (ASU_ID)  TABLESPACE ' || V_TS_INDEX;
	    	EXECUTE IMMEDIATE V_SQL;
	    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.CAL_CALCULO_LIQUIDACION ASU_ID... Indice creado');
	    	
	    	V_SQL := 'CREATE INDEX '||V_ESQUEMA||'.IDX_PRC_ID_CAL_CALCULO_LIQUIDACION ON '||V_ESQUEMA||'.CAL_CALCULO_LIQUIDACION (PRC_ID)  TABLESPACE ' || V_TS_INDEX;
	    	EXECUTE IMMEDIATE V_SQL;
	    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.CAL_CALCULO_LIQUIDACION PRC_ID... Indice creado');
	    	
	    	V_SQL := 'CREATE INDEX '||V_ESQUEMA||'.IDX_CNT_ID_CAL_CALCULO_LIQUIDACION ON '||V_ESQUEMA||'.CAL_CALCULO_LIQUIDACION (CNT_ID)  TABLESPACE ' || V_TS_INDEX;
	    	EXECUTE IMMEDIATE V_SQL;
	    	DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.CAL_CALCULO_LIQUIDACION CNT_ID... Indice creado');
	    	
	    	V_SQL := 'CREATE INDEX '||V_ESQUEMA||'.IDX_DD_ECA_ID_CAL_CALCULO_LIQUIDACION ON '||V_ESQUEMA||'.CAL_CALCULO_LIQUIDACION (DD_ECA_ID)  TABLESPACE ' || V_TS_INDEX;
	    	EXECUTE IMMEDIATE V_SQL;
