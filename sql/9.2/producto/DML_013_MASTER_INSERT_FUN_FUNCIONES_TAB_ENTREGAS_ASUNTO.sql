...
BEGIN	
	...
	IF V_NUM_TABLAS > 0 THEN    
	  ...
	  DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe el ROLE_PUEDE_VER_TAB_ENTREGAS_ASUNTO');
	
	ELSE
	  V_MSQL:= 'INSERT INTO '||V_ESQUEMA_M||'.FUN_FUNCIONES (FUN_ID, FUN_DESCRIPCION_LARGA,FUN_DESCRIPCION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES('||V_ESQUEMA_M||'.S_FUN_FUNCIONES.nextval,''Función que muestra la pestaña Entregas dentro de la configuración de los Asuntos'',''ROLE_PUEDE_VER_TAB_ENTREGAS_ASUNTO'',''0'',''PRODUCTO-953'',sysdate,''0'') ';
