...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_DES_DESISTIR';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_DES_DESISTIR';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_DES_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('DESIS', 'Desistir', 'Desistir')
     ,T_TIPO('RECON', 'Reconsiderar', 'Reconsiderar')
    ); 
    V_TMP_TIPO T_TIPO;
