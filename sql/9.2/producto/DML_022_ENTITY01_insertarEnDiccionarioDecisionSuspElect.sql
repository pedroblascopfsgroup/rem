...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_DSE_DECISION_SUSP_ELEC';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_DSE_DECISION_SUSP_ELEC';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_DSE_';
