...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_MNP_MOTIVO_NO_PAGAR_TASA';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_MNP_MOTIVO_NO_PAGAR_TASA';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_MNP_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('IEN', 'Instrucciones entidad', 'Instrucciones entidad')
     ,T_TIPO('PAD', 'Posible acuerdo con deudor', 'Posible acuerdo con deudor')
