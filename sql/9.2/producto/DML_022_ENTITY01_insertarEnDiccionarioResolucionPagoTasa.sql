...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_RPT_RESOLUCION_PAGO_TASA';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_RPT_RESOLUCION_PAGO_TASA';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_RPT_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('PAT', 'Pagar tasa', 'Pagar tasa')
     ,T_TIPO('NPT', 'No pagar tasa', 'No pagar tasa')
    ); 
    V_TMP_TIPO T_TIPO;
