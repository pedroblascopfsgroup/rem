...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_RCS_RESULTADO_COMITE_SUB';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_RCS_RESULTADO_COMITE_SUB';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_RCS_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('REC', 'Rechazar', 'Rechazar')
     ,T_TIPO('CSU', 'Continuar subasta', 'Continuar subasta')
