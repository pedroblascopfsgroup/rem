...
--## PRODUCTO=SI
--## Finalidad: DML Insertar valores en diccionario DD_FAC_FAVORABLE_CONDICION
--##           
...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_FAC_FAVORABLE_CONDICION';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_FAC_FAVORABLE_CONDICION';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_FAC_';
