        ...
        ELSE
          ...
          FOR I IN V_TIPO_COLUMN.FIRST .. V_TIPO_COLUMN.LAST
		      LOOP
		        ...
		        OPEN TABLES_CURSOR FOR 'SELECT DISTINCT PEF_ID FROM '||V_ESQUEMA||'.FUN_PEF WHERE FUN_ID = (SELECT FUN_ID FROM '||V_ESQUEMA_M||'.FUN_FUNCIONES WHERE FUN_DESCRIPCION <> ''SOLO_CONSULTA'')';
