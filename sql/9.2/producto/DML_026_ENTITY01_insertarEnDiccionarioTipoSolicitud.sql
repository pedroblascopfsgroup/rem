...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_TSO_TIPO_SOLICITUD';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_TSO_TIPO_SOLICITUD';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_TSO_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('ANTFON', 'Anticipo de fondos', 'Anticipo de fondos')
     ,T_TIPO('PAGSUP', 'Pago de suplidos', 'Pago de suplidos')
    ); 
    V_TMP_TIPO T_TIPO;
