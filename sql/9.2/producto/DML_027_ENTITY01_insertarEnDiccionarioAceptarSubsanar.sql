...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_ASU_ACEPTAR_SUBSANAR';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_ASU_ACEPTAR_SUBSANAR';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_ASU_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('ACE', 'Aceptar', 'Aceptar')
     ,T_TIPO('SUB', 'Subsanar', 'Subsanar')
    ); 
    V_TMP_TIPO T_TIPO;
