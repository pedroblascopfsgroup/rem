...
--## PRODUCTO=NO
--## Finalidad: DML para crear el nuevo diccionario Desistir/Reconsiderar
--##           
...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_TPI_TIPO_PRC_INICIADOR';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_TPI_TIPO_PRC_INICIADOR';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_TPI_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('H001', 'P. hipotecario - HCJ', 'Procedimiento hipotecario')
     ,T_TIPO('H018', 'P. Ej. de Título Judicial - HCJ', 'Procedimiento Ejecución de Título Judicial')
     ,T_TIPO('H020', 'P. Ej. de título no judicial - HCJ', 'Procedimiento ejecución de título no judicial')
     ,T_TIPO('H024', 'P. ordinario - HCJ', 'Procedimiento ordinario')
     ,T_TIPO('H022', 'P. Monitorio - HCJ', 'Procedimiento Monitorio')
     ,T_TIPO('H016', 'P. Cambiario - HCJ', 'Procedimiento Cambiario')
     ,T_TIPO('H026', 'P. verbal - HCJ', 'Procedimiento verbal')
     ,T_TIPO('H028', 'P. Verbal desde Monitorio - HCJ', 'Procedimiento Verbal desde Monitorio')
     ,T_TIPO('PCO', 'Preparación de expediente judicial', 'Preparación de expediente judicial')
    ); 
    V_TMP_TIPO T_TIPO;
