...
--## PRODUCTO=SI
--## Finalidad: INSERT diccionario DD_DCV_DESPACHO_CNT_VIGOR
--##           
...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_DCV_DESPACHO_CNT_VIGOR';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_DCV_DESPACHO_CNT_VIGOR';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_DCV_';
   ...
   V_MERGE  VARCHAR2(4000 CHAR) := 'MERGE INTO ' || V_ESQUEMA || '.' || V_DDNAME|| ' tabla  ' || 
    ...
    V_TIPO T_ARRAY := T_ARRAY(
      T_TIPO('Histórico Caja', 'Histórico Caja', 'Histórico Caja')
     ,T_TIPO('Acuerdo 2011', 'Acuerdo 2011', 'Acuerdo 2011')
     ,T_TIPO('2014', '2014', '2014')
     ,T_TIPO('2015', '2015', '2015')
    ); 
 V_TMP_TIPO T_TIPO;
