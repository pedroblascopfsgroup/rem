...
DECLARE
   ...
   V_DDNAME VARCHAR2(50 CHAR):= 'DD_DID_DESPACHO_IVA_DES';
   V_SEQNAME VARCHAR2(50 CHAR):= 'S_DD_DID_DES_IVA_DES';
   V_PREFIJO VARCHAR2(50 CHAR) := 'DD_DID_';
