...
DECLARE
    ...
    V_SQL_ASU_DFI_NULL VARCHAR2(4000 CHAR)  := 'UPDATE #ESQUEMA#.ASU_ASUNTOS SET DD_DFI_ID=null WHERE ASU_ID=:1'; 
    ...
    CURSOR C_CAMBIOMOTIVO_A_NULL IS
		...
		and asu.dd_eas_id not in (
							...
							from #ESQUEMA_MASTER#.dd_eas_estado_asuntos est
    ...
    V_CAMBIO_A_NULL C_CAMBIOMOTIVO_A_NULL%ROWTYPE;                      	
	V_CAMBIO C_CAMBIOMOTIVO%ROWTYPE;
	
	PROCEDURE ACTUALIZAR_DD_DFI_ID_A_NULL(ASU_ID IN NUMBER) IS
	BEGIN
		EXECUTE IMMEDIATE V_SQL_ASU_DFI_NULL USING ASU_ID;
...
BEGIN 
	...
	OPEN C_CAMBIOMOTIVO_A_NULL;
    LOOP
    	FETCH C_CAMBIOMOTIVO_A_NULL INTO V_CAMBIO_A_NULL;
		EXIT WHEN C_CAMBIOMOTIVO_A_NULL%NOTFOUND; 
	    	ACTUALIZAR_DD_DFI_ID_A_NULL(V_CAMBIO_A_NULL.ASU_ID);
