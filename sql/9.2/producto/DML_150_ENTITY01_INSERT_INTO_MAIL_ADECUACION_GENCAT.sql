...
--## PRODUCTO=NO
--##
--## Finalidad: Insertar en la tabla MAIL_ADECUACION_GENCAT.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
BEGIN   
	...
	V_SQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE TABLE_NAME = ''MAIL_ADECUACION_GENCAT'' and owner = '''||V_ESQUEMA||'''';
...
V_SQL := 'INSERT INTO '||V_ESQUEMA||'.MAIL_ADECUACION_GENCAT	(
					DE, 
					A, 
					COPIA, 
					CUERPO, 
