...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-8120'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'ACT_DCA_DATOS_CONTRATO_ALQ'; -- Tabla
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DCA_ID_CONTRATO_ANTIGUO', 'VARCHAR2(20 CHAR)', 'Código identificador único del contrato antiguo')
    ); 
