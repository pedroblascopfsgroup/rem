...
--## INCIDENCIA_LINK=REMVIP-3839
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'TRABAJOS_REPOSICIONAR'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TRABAJOS_REPOSICIONAR';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			TPO_ID				VARCHAR2(100 CHAR),
			TAP_ID				VARCHAR2(100 CHAR),
			TRA_ID				VARCHAR2(100 CHAR),
			TAR_ID				VARCHAR2(100 CHAR),
			TEX_ID				VARCHAR2(100 CHAR),
			USU_ID				VARCHAR2(100 CHAR),
			SUP_ID				VARCHAR2(100 CHAR),
			ACT_NUM_ACTIVO 		VARCHAR2(100 CHAR),
			TRA_PROCES_BPM 		VARCHAR2(100 CHAR)
		)'
;
