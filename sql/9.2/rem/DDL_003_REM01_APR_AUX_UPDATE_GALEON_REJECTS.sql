...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla desnormalizada para la carga de bienes rechazados en el proceso de actualizacion activos de Galeon
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TABLA VARCHAR2(30 CHAR):= 'APR_AUX_UPDATE_GALEON_REJECTS';
