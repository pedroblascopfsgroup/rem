...
V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    ...
    T_TIPO_DATA(2, '01', 'NIF', 'NIF', 'EN-01-DOCI-07'),
    T_TIPO_DATA(2, '02', 'Cuenta bancaria', 'Cuenta bancaria', 'EN-02-CERJ-86'),
    T_TIPO_DATA(2, '03', 'Escritura constitución', 'Escritura constitución', 'EN-05-ESCR-04'),
    T_TIPO_DATA(2, '04', 'Estatutos vigentes', 'Estatutos vigentes', 'EN-01-ESTA-02'),
    T_TIPO_DATA(2, '05', 'Acta de asamblea (Sociedad mercantil)', 'Acta de asamblea (Sociedad mercantil)', 'EN-05-ACTR-01'),
    T_TIPO_DATA(2, '06', 'Convocatoria asamblea', 'Convocatoria asamblea', 'EN-05-CONV-01'),
    T_TIPO_DATA(2, '07', 'Circular comunidad', 'Circular comunidad', 'EN-05-COMU-06'),
    T_TIPO_DATA(2, '08', 'Acta titular real', 'Acta titular real', 'EN-01-DOCN-05'),
    T_TIPO_DATA(2, '09', 'Certificado AEAT', 'Certificado AEAT', 'EN-02-CERJ-24'),
    T_TIPO_DATA(2, '10', 'Certificado SS', 'Certificado SS', 'EN-02-CERA-33'),
    T_TIPO_DATA(2, '11', 'Certificado subcontratistas', 'Certificado subcontratistas', 'EN-02-CERA-64'),
    T_TIPO_DATA(2, '12', 'Impuesto Actividades Económicas', 'Impuesto Actividades Económicas', 'EN-05-COMU-05'),
    T_TIPO_DATA(2, '13', 'Seguros sociales mes', 'Seguros sociales mes', 'EN-02-CERA-33'),
    T_TIPO_DATA(2, '14', 'Comunidad de propietarios: Carta para localización', 'Comunidad de propietarios: Carta para localización', 'EN-05-COMU-67'),
    T_TIPO_DATA(2, '15', 'Comunidad de propietarios: Burofax para localización', 'Comunidad de propietarios: Burofax para localización', 'EN-05-COMU-76'),
    T_TIPO_DATA(2, '16', 'Certificado no deuda', 'Certificado no deuda', 'EN-05-CERJ-11'),
    T_TIPO_DATA(2, '17', 'Acta Junta (Comunidad de propietarios)', 'Acta Junta (Comunidad de propietarios)', 'EN-05-ACTR-07')
);
...
(
    DD_SDP_ID                   NUMBER(16,0) GENERATED BY DEFAULT AS IDENTITY (START WITH 1 NOCACHE ORDER) NOT NULL ,
    ...
    DD_SDP_MATRICULA_GD         VARCHAR2(100 CHAR),
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
        ...
        LOOP
            ...
            V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (' ||
                        'DD_TDP_ID, DD_SDP_CODIGO, DD_SDP_DESCRIPCION, DD_SDP_DESCRIPCION_LARGA, DD_SDP_MATRICULA_GD, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
                        'VALUES('''||TRIM(V_TMP_TIPO_DATA(1))||''', '''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''', '''||TRIM(V_TMP_TIPO_DATA(5))||''', 0, ''DML'',SYSDATE, 0)';
            EXECUTE IMMEDIATE V_MSQL;
