...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('OFR_FECHA_RESPUESTA', 'DATE','', 'Fecha de la respuesta.'),
        T_TIPO_DATA('OFR_FECHA_APROBACION_PRO_MANZANA', 'DATE','', 'Fecha de la aprobación promontoria Manzana.')
    ); 
