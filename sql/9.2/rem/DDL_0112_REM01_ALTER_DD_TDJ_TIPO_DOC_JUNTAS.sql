...
--## PRODUCTO=NO
--## Finalidad: DDL Añadir dos columnas en la tabla DD_TDJ_TIPO_DOC_JUNTAS
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TDJ_TIPO_DOC_JUNTAS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_TDJ_VINCULABLE', 'NUMBER(1,0)', 'Si se vincula a los activos o no'),
        T_TIPO_DATA('DD_TDJ_TPD_ID', 'NUMBER(16,0)', 'Campo que relaciona los tipos de documentos vinculables')
