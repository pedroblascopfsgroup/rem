...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-6920'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'ACT_ACTIVO'; -- Tabla
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ID_CES', 'VARCHAR(50)', 'ID SERVICER'),
        T_TIPO_DATA('ID_SANTANDER', 'VARCHAR(50)', 'ID_INMUEBLE_BS')
    ); 
