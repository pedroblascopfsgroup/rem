...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ECG_ESTADO_CARGA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CDG VARCHAR2(27 CHAR) := 'ECG'; -- Vble. auxiliar para almacenar el codigo de la tabla para las columnas.
