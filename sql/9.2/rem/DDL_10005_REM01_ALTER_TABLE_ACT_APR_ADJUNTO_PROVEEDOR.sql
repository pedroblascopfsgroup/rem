...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los adjuntos del proveedor
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'APR_ID_DOCUMENTO_REST',		 			'NUMBER(16,0)',						'Id devuelto por el gestor documental al subir un adjunto.'	)
		);
    V_T_ALTER T_ALTER;
