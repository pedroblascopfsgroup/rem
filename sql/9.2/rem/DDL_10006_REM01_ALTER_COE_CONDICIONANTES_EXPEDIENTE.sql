...
DECLARE
   ...
   V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
     ...
     T_ALTER('DD_ETF_ID',        'NUMBER(16,0)',           'Fk al diccionario de entidad financiera')
   );
   V_T_ALTER T_ALTER;
   ...
   V_FK T_ARRAY_FK := T_ARRAY_FK(
     ...
     T_FK( 'FK_DDENTIDAD_FINANCIERA',   'DD_ETF_ID',    V_ESQUEMA||'.DD_ETF_ENTIDAD_FINANCIERA',   'DD_ETF_ID'     )
   );
   V_T_FK T_FK;
    
BEGIN	
	  
 DBMS_OUTPUT.PUT_LINE('[INICIO] ********' ||V_TEXT_TABLA|| '********'); 
