...
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=version-R191003
--## INCIDENCIA_LINK=HREOS-7874
--## PRODUCTO=NO
--##
--## INSTRUCCIONES: 
--## VERSIONES:
...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7038'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'RES_RESERVAS'; -- Tabla
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('RES_FECHA_CONTABILIZACION', 'DATE', 'Fecha de contabilización de la reserva')
    ); 
