...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar la información de las comunidades de propietarios de los activos.
--##           
...
DECLARE
    ...
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar la información de las comunidades de propietarios de los activos.'; -- Vble. para los comentarios de las tablas
...
BEGIN
	...
	(
		...
		CPR_PRESIDENTE_FECHA_INI	DATE,
		CPR_PRESIDENTE_FECHA_FIN	DATE,
