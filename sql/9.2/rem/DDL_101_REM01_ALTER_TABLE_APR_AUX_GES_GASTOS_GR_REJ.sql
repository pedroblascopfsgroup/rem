...
--## FECHA_CREACION=20192310
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-8023
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla APR_AUX_GES_GASTOS_GR
--##           
...
DECLARE
  ...
  V_CREAR_FK VARCHAR2(2 CHAR) := 'NO'; -- [SI, NO] Vble. para indicar al script si debe o no crear tambien las relaciones Foreign Keys.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
      ...
      T_ALTER('GPV_IDENTIFICADOR_UNICO',     'VARCHAR2(50 CHAR)',            'Identificador unico del gasto' ),
      T_ALTER('DD_TRG_CODIGO',               'VARCHAR2(20 CHAR)',            'Codigo identificador único del estado de la carga' )
