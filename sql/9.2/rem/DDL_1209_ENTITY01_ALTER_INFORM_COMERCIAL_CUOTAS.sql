...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de informacion comercial para usarla con informe comercial
--##           
...
DECLARE
    ...
    /* TABLA: ACT_ICO_INFO_COMERCIAL -- ARRAY CON NUEVAS COLUMNAS */
    TYPE T_ALTER IS TABLE OF VARCHAR2(4000);
    TYPE T_ARRAY_ALTER IS TABLE OF T_ALTER;
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    				-- NOMBRE CAMPO						TIPO CAMPO							DESCRIPCION
		T_ALTER(  'ICO_CUOTACP_ORIENTATIVA',		'NUMBER(08,2)',				'Cuota mensual orientativa de la comunidad de propietarios' ), --1
		T_ALTER(  'ICO_DERRAMACP_ORIENTATIVA',		'NUMBER(16,2)',				'Derrama orientativa de la comunidad de propietarios'		)  --2
...
BEGIN
	...
	-- Bucle que CREA las nuevas columnas del INFORME COMERCIAL
	...
	LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			...
			V_MSQL := 'ALTER TABLE ACT_ICO_INFO_COMERCIAL 
