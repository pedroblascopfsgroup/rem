...
BEGIN
	...
	ELSE
		...
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_DD_TPC_ID FOREIGN KEY (DD_TPC_ID) REFERENCES '||V_ESQUEMA_M||'.DD_TPC_TIPOS_COLABORADOR (DD_TPC_ID) ON DELETE SET NULL)';
