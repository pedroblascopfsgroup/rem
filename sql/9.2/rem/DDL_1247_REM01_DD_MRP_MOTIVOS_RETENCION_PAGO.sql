...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de motivos de retención de un pago
--##           
...
BEGIN
	...
	(
		DD_MRP_ID           		NUMBER(16)                  NOT NULL,
		DD_MRP_CODIGO        		VARCHAR2(20 CHAR)          	NOT NULL,
		DD_MRP_DESCRIPCION			VARCHAR2(100 CHAR),
		DD_MRP_DESCRIPCION_LARGA	VARCHAR2(250 CHAR),
	...
	-- Creamos indice	
	V_MSQL := 'CREATE UNIQUE INDEX '||V_ESQUEMA||'.DD_MRP_MOTIVOS_RET_PAGO_PK ON '||V_ESQUEMA|| '.'||V_TEXT_TABLA||'(DD_MRP_ID) TABLESPACE '||V_TABLESPACE_IDX;		
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||'_PK... Indice creado.');
	
	
	-- Creamos primary key
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT DD_MRP_MOT_RET_PAGO_PK PRIMARY KEY (DD_MRP_ID) USING INDEX)';
	EXECUTE IMMEDIATE V_MSQL;
