...
BEGIN
	...
	(
			...
			PVE_ID									NUMBER(16,0),
			CLC_PRESCRIPTOR							VARCHAR2(50 CHAR),
			CLC_API_RESPONSABLE						VARCHAR2(50 CHAR),
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_PRESCRIPTOR FOREIGN KEY (PVE_ID) REFERENCES '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR (PVE_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
