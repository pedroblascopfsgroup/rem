...
BEGIN
	...
	(
			...
			VIS_WEBCOM_ID							NUMBER(16,0)				NOT NULL,	
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_CLIENTE_COMERCIAL FOREIGN KEY (CLC_ID) REFERENCES '||V_ESQUEMA||'.CLC_CLIENTE_COMERCIAL (CLC_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
