...
BEGIN
	...
	(
			...
			PVE_ID_CUSTODIO							NUMBER(16),
			PVE_ID_FDV								NUMBER(16),
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.FK_OFR_PVE_API_RESPONSABLE... Foreign key creada.');
		...
		-- Creamos foreign key PVE_ID_CUSTODIO
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_OFR_PVE_CUSTODIO FOREIGN KEY (PVE_ID_CUSTODIO) REFERENCES '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR (PVE_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.FK_OFR_PVE_CUSTODIO... Foreign key creada.');
	
		-- Creamos foreign key PVE_ID_FDV
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_OFR_PVE_FDV FOREIGN KEY (PVE_ID_FDV) REFERENCES '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR (PVE_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.FK_OFR_PVE_FDV... Foreign key creada.');
