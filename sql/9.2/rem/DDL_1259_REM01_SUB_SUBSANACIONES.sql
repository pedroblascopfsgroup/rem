...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_SUB_ESU_ID FOREIGN KEY (ESU_ID) REFERENCES '||V_ESQUEMA||'.DD_ESU_ESTADOS_SUBSANACION (ESU_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
