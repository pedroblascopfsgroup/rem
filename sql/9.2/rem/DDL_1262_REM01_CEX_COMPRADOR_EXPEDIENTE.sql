...
BEGIN
	...
	(
		...
		DD_UAC_ID											NUMBER(16),
		CEX_IMPORTE_PROPORCIONAL_OFERTA						NUMBER(16,2),
		...
		CEX_DOCUMENTO_REPRESENTANTE							VARCHAR2(50 CHAR),
		CEX_TELEFONO1_REPRESENTANTE							VARCHAR2(50 CHAR),
		CEX_TELEFONO2_REPRESENTANTE							VARCHAR2(50 CHAR),
		CEX_EMAIL_REPRESENTANTE								VARCHAR2(50 CHAR),
		CEX_DIRECCION_REPRESENTANTE							VARCHAR2(256 CHAR),
		CEX_MUNICIPIO_REPRESENTANTE							VARCHAR2(50 CHAR),
		CEX_CODIGO_POSTAL_REPRESENTANTE						VARCHAR2(5 CHAR),
		CEX_PROVINCIA_REPRESENTANTE							VARCHAR2(50 CHAR),
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.FK_CEX_ECV_ID... Foreign key creada.');
			...
			-- Creamos foreign key DD_REC_ID
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_CEX_REM_ID FOREIGN KEY (DD_REC_ID) REFERENCES '||V_ESQUEMA||'.DD_REM_REGIMENES_MATRIMONIALES (DD_REM_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
