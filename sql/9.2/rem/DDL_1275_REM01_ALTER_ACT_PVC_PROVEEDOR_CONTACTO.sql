...
BEGIN
	...
	-- Creamos foreign key FK_DD_CPR_ID
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_DD_CPR_ID FOREIGN KEY (DD_CPR_ID) REFERENCES '||V_ESQUEMA||'.DD_CPC_CARGO_PROV_CONTACTO (DD_CPR_ID) ON DELETE SET NULL)';
