...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('OFR_IND_LOTE_RESTRINGIDO', 'NUMBER','(1,0)', 'Indicador de lote restringido.'),
        T_TIPO_DATA('OFR_IMPORTE_APROBADO', 'NUMBER','(16,2)', 'Importe aprobado de la oferta.')
