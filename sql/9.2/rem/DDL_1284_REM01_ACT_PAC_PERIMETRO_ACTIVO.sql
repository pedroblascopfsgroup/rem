...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_PAC_MNC FOREIGN KEY (PAC_MOTIVO_NOCOMERCIALIZAR) REFERENCES '||V_ESQUEMA||'.DD_MNC_MOTIVO_NOCOMERCIALIZACION (DD_MNC_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
