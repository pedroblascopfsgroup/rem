...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los gastos de expediente
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'GEX_GASTOS_EXPEDIENTE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'GEX_WEBCOM_ID',		 				'NUMBER(16,0)',						'Código identificador único del gasto en webcom.'	),
		T_ALTER(  'GEX_PROVEEDOR',		 				'NUMBER(16,0)',						'Código del proveedor responsable del gasto.'		),
		T_ALTER(  'GEX_OBSERVACIONES',		 			'VARCHAR2(250 CHAR)',				'Observaciones del proveedor responsable del gasto.'),
		T_ALTER(  'GEX_APROBADO',		 				'NUMBER(1,0)',						'Indicador de si el gasto ha sido aprobado.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_GASTOEXP_PROVEEDOR',				'GEX_PROVEEDOR',		V_ESQUEMA||'.ACT_PVE_PROVEEDOR',			'PVE_ID'			)
    );
    V_T_FK T_FK;
