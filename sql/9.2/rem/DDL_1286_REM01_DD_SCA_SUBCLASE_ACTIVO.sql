...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_DD_CLA FOREIGN KEY (DD_CLA_ID) REFERENCES '||V_ESQUEMA||'.DD_CLASE_ACTIVO (DD_CLA_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
