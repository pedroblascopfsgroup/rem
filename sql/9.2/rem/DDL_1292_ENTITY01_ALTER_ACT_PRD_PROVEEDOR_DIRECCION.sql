...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna AIN_PARTICIPACION en la tabla ACT_PRD_PROVEEDOR_DIRECCION.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME_0 VARCHAR2(30):= 'PRD_LOCAL_ABIERTO_PUBLICO'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE_0 VARCHAR2(500 CHAR):= 'Indica si el local esta abierto al público.'; -- Vble. para los comentarios de las tablas
