...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		T_ALTER('ACT_OFR','ACT_ID','Id del activo'),
		T_ALTER('ACT_OFR','OFR_ID','Id de la oferta'),
		T_ALTER('ACT_OFR','ACT_OFR_IMPORTE','Importe con el que participa el activo en la oferta')
