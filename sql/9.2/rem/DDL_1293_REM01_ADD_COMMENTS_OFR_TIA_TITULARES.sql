...
T_ALTER('OFR_TIA_TITULARES_ADICIONALES','TIA_ID','Id del titular'),
T_ALTER('OFR_TIA_TITULARES_ADICIONALES','OFR_ID','Id de la oferta'),
T_ALTER('OFR_TIA_TITULARES_ADICIONALES','TIA_NOMBRE','Nombre del titular'),
T_ALTER('OFR_TIA_TITULARES_ADICIONALES','DD_TDI_ID','Tipo de documento'),
T_ALTER('OFR_TIA_TITULARES_ADICIONALES','TIA_DOCUMENTO','Número de documento')
