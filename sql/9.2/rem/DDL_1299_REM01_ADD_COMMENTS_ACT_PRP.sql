...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	T_ALTER('ACT_PRP','ACT_ID','Id del activo'),
		T_ALTER('ACT_PRP','PRP_ID','Id de la propuesta'),
		T_ALTER('ACT_PRP','ACT_PRP_PRECIO_PROPUESTO','Precio propuesto'),
		T_ALTER('ACT_PRP','ACT_PRP_PRECIO_SANCIONADO','Precio sancionado'),
		T_ALTER('ACT_PRP','DD_EPA_ID','Estado del activo en la propuesta')
	);
    V_T_ALTER T_ALTER;
