...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_GPV_PVE_EMISOR FOREIGN KEY (PVE_ID_EMISOR) REFERENCES '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR (PVE_ID_EMISOR) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
