...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_GIP_DD_PPR FOREIGN KEY (DD_PPR_ID) REFERENCES '||V_ESQUEMA||'.DD_PPR_PDAS_PRESUPUESTARIAS (DD_PPR_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_GIP_DD_PPR_ESPECIAL FOREIGN KEY (DD_PPR_ID_ESPECIAL) REFERENCES '||V_ESQUEMA||'.DD_PPR_PDAS_PRESUPUESTARIAS (DD_PPR_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.FK_GIP_DD_PPR... Foreign key creada.');
