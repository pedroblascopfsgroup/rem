...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_GGE_DDMRP FOREIGN KEY (DD_MRP_ID) REFERENCES '||V_ESQUEMA||'.DD_MRP_MOTIVOS_RETENCION_PAGO (DD_MRP_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
