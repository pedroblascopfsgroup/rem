...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los propietarios
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_CRA_ID',		 				'NUMBER(16,0)',						'Cartera/Entidad del propietario'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACT_PRO_DD_CRA',					'DD_CRA_ID',			V_ESQUEMA||'.DD_CRA_CARTERA',				'DD_CRA_ID'			)
    );
    V_T_FK T_FK;
