...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna TAS_ID_EXTERNO en la tabla ACT_TAS_TASACION.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME_0 VARCHAR2(30):= 'TAS_ID_EXTERNO'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE_0 VARCHAR2(500 CHAR):= 'ID de la tasación externa.'; -- Vble. para los comentarios de las tablas
    
BEGIN
	-- Comprobar si existe la columna TAS_ID_EXTERNO.
