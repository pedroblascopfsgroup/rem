...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene la información de un comprador
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CLC_ID',		 					'NUMBER(16,0)',						'Código único del cliente comercial.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_COM_CLC',							'CLC_ID',		V_ESQUEMA||'.CLC_CLIENTE_COMERCIAL',					'CLC_ID'			)
    );
    V_T_FK T_FK;
