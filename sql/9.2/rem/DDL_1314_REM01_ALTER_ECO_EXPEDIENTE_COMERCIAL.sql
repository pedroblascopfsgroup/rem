...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ECO_FECHA_VENTA',					'DATE',								'Fecha de venta')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ECO_DD_COS',						'DD_COS_ID',				V_ESQUEMA||'.DD_COS_COMITES_SANCION',				'DD_COS_ID'			),
    	T_FK(	'FK_ECO_DD_COS',						'DD_COS_ID_PROPUESTO',		V_ESQUEMA||'.DD_COS_COMITES_SANCION',				'DD_COS_ID'			)
    );
    V_T_FK T_FK;
