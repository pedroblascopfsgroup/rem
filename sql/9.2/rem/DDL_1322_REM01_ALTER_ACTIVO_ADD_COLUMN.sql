...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TCR_ID',		 				'NUMBER(16,0)',						'Código identificador único deL tipo de comercializacion'	),
    	T_ALTER(  'DD_TAL_ID',		 				'NUMBER(16,0)',						'Código identificador único del tipo de alquiler'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACTIVO_DDTCR',						'DD_TCR_ID',		V_ESQUEMA||'.DD_TCR_TIPO_COMERCIALIZAR',		'DD_TCR_ID'			),
    	T_FK(	'FK_ACTIVO_DDTAL',						'DD_TAL_ID',		V_ESQUEMA||'.DD_TAL_TIPO_ALQUILER',				'DD_TAL_ID'			)
    );
    V_T_FK T_FK;
