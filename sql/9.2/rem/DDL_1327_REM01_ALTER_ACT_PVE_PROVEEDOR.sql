...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PVE_CRITERIO_CAJA_IVA',		 		'NUMBER(1)',					'Indica si se opta por el criterio de caja en IVA.'),
    	T_ALTER(  'PVE_FECHA_EJERCICIO_OPCION',		 	'DATE',							'Fecha del ejercicio opción.')
		);
    V_T_ALTER T_ALTER;
