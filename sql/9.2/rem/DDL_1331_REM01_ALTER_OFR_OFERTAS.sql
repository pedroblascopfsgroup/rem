...
--## FECHA_CREACION=20161222
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1310
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla de Ofertas con un nuevo campo.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'OFR_INTENCION_FINANCIAR',			'NUMBER(1)',				'Indica si se tiene intención de financiar.')
		);
    V_T_ALTER T_ALTER;
