...
--## FECHA_CREACION=20170112
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1330
--## PRODUCTO=NO
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_VENTA_EXTERNA_FECHA',		 	'DATE',						'Indica la fecha de venta para una venta externa a REM.'),
    	T_ALTER(  'ACT_VENTA_EXTERNA_OBSERVACION',		'VARCHAR2(255 CHAR)',		'Observaciones de una venta externa a REM.'),
    	T_ALTER(  'ACT_VENTA_EXTERNA_IMPORTE',		 	'NUMBER(16,2)',				'Indica el importe de venta de una venta externa a REM.')
		);
    V_T_ALTER T_ALTER;
