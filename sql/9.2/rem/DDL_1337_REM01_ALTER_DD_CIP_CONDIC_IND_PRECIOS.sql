...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla de condiciones indicador precios con un nuevo campo.
--## 
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CIP_NECESITA_CONDICION',		 		'NUMBER(1,0)',				'Indica si es necesario especificar detalles de la operación.')
		);
    V_T_ALTER T_ALTER;
