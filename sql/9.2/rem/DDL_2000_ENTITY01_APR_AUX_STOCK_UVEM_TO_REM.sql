...
BEGIN
	...
	(
		...
		PORCENTAJE_PROPIEDAD 			NUMBER(3,3) NOT NULL,
		...
		IMPORTE_ADJUDICACION 			NUMBER(16,2) NOT NULL,
		...
		RESULTADO_SUBASTA 				VARCHAR2(2 CHAR) NOT NULL,
		FEC_RECEP_ACTA_SUBASTA 			DATE NOT NULL,
		VALOR_JUDICIAL 					NUMBER(16,2) NOT NULL,
		...
		LLAVES_NECESARIAS 				NUMBER(1) NOT NULL,
		...
		NUM_PROTOCOLO 					NUMBER(8) NOT NULL,
		...
		PORCENTAJE_OBRA 				NUMBER(3,3) NOT NULL,
		PORCENTAJE_PROPIEDAD_COMUNI 	NUMBER(3,3) NOT NULL,
		REFERENCIA_CATASTRAL 			VARCHAR2(20 CHAR) NOT NULL,
		ACTIVO_SINGULAR 				VARCHAR2(2 CHAR) NOT NULL,
		SIGNO_LONGITUD 					VARCHAR2(2 CHAR) NOT NULL,
		LONGITUD 						VARCHAR2(17 CHAR) NOT NULL,
		SIGNO_LATITUD 					VARCHAR2(2 CHAR) NOT NULL,
		LATITUD 						VARCHAR2(17 CHAR) NOT NULL,
		SUP_TOTAL_REGISTRAL_UTIL 		NUMBER(6,3) NOT NULL,
		DORMITORIOS_ACTIVO 				NUMBER(4) NOT NULL,
		BAÑOS_ACTIVO 					NUMBER(4) NOT NULL,
		GARAJE 							VARCHAR2(2 CHAR) NOT NULL,
		NUM_PLAZAS_GARAJE 				NUMBER(5) NOT NULL,
		INMUEBLE_ARRENDADO 				VARCHAR2(2 CHAR) NOT NULL,
		ASCENSOR_ACTIVO 				VARCHAR2(2 CHAR) NOT NULL,
		TRASTERO_ACTIVO 				VARCHAR2(2 CHAR) NOT NULL,
		TIPO_VENTA 						VARCHAR2(2 CHAR) NOT NULL,
		...
		IMPORTE_APROBADO_OFERTA 		NUMBER(16,4) NOT NULL,
		...
		MOTIVO_OCULTACION 				VARCHAR2(2 CHAR) NOT NULL,
		SUBMOTIVO_OCULTACION 			VARCHAR2(2 CHAR) NOT NULL,
		INDICADOR_ACTIVO_PUBLICADO 		VARCHAR2(2 CHAR) NOT NULL,
		INDICADOR_NUM_VISITAS 			NUMBER(8) NOT NULL,
		NUM_OFERTAS_RECIBIDAS 			NUMBER(8) NOT NULL,
		FEC_ULTIMA_OFERTA_REALIZADA 	DATE NOT NULL,
		IMPORTE_ULTIMA_OFERTA 			NUMBER(16,2) NOT NULL,
		NUM_OFERTAS_DENEGADAS 			NUMBER(9) NOT NULL,
		IMPORTE_OFERTA_MAXIMO 			NUMBER(16,2) NOT NULL,
		TIPO_INMUEBLE_REM 				VARCHAR2(30 CHAR) NOT NULL,
		IMPORTE_VALOR_COMERCIAL 		NUMBER(16,2) NOT NULL,
		PRECIO_REFERENCIA 				NUMBER(16,2) NOT NULL,
		IMPORTE_VENTA 					NUMBER(16,2) NOT NULL,
