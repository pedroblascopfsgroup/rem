...
BEGIN
	...
	(
		...
		SUP_TOTAL_REGISTRAL_UTIL 		NUMBER(9,2) NOT NULL,
		...
		IMPORTE_ULTIMA_OFERTA 			NUMBER(13,2) NOT NULL,
		NUM_OFERTAS_DENEGADAS 			NUMBER(9) NOT NULL,
		IMPORTE_OFERTA_MAXIMO 			NUMBER(13,2) NOT NULL,
		TIPO_INMUEBLE_REM 				VARCHAR2(30 CHAR) NOT NULL,
		IMPORTE_VALOR_COMERCIAL 		NUMBER(13,2) NOT NULL,
		PRECIO_REFERENCIA 				NUMBER(13,2) NOT NULL,
		IMPORTE_VENTA 					NUMBER(13,2) NOT NULL,
