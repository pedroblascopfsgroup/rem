...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de las delegaciones de los proveedores
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PRD_ESCALERA',		 			'VARCHAR2(10 CHAR)',						'Escalera de la delegación.'	),
    	T_ALTER(  'PRD_PLANTA',		 				'VARCHAR2(11 CHAR)',						'Planta de la delegación.'	),
    	T_ALTER(  'PRD_TELEFONO2',		 			'VARCHAR2(20 CHAR)',						'Teléfono2 de la delegación.'	),
    	T_ALTER(  'DD_LOC_ID',		 				'NUMBER(16,0)',								'Localidad de la delegación.'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_PRD_DD_LOC_ID',				'DD_LOC_ID',		V_ESQUEMA_M||'.DD_LOC_LOCALIDAD',					'DD_LOC_ID'			)
    );
    V_T_FK T_FK;
