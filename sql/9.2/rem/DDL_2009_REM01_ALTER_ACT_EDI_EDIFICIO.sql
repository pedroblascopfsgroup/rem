...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos del edificio
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'EDI_DIVISIBLE',		 			'NUMBER(1,0)',						'Indica si es divisible.'	),
    	T_ALTER(  'EDI_DESC_PLANTAS',		 		'VARCHAR2(150 CHAR)',				'Descripción de las plantas del edificio.'	),
    	T_ALTER(  'EDI_OTRAS_CARACTERISTICAS',		'VARCHAR2(3000 CHAR)',				'Descripción otras características del edificio.'	)
