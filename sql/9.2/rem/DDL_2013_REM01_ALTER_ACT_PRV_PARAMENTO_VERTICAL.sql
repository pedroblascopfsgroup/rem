...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los paramentos verticales.
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ACT_PRV_PARAMENTO_VERTICAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PRV_PINTURA_GOTELE_TECHO_EST',				'NUMBER(1,0)',		'Indicador del estado de la pintura en techos de gotele.'),
    	T_ALTER(  'PRV_PINTURA_PAPEL_TECHO_EST',				'NUMBER(1,0)',		'Indicador del estado de la pintura en techos de papel pintado.')
		);
    V_T_ALTER T_ALTER;
