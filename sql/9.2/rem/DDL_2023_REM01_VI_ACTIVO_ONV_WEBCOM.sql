...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'AWH_ACT_ONV_WEBCOM_HIST'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
   ...
   -- Creamos vista materializada
	...
	AS
		...
		CASE WHEN (AGR.USUARIOMODIFICAR IS NOT NULL) 
			...
			WHERE USU.USU_USERNAME = AGR.USUARIOMODIFICAR) AS NUMBER(16,0))
