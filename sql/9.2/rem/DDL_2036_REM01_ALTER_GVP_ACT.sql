...
--## FECHA_CREACION=201601027
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-891
--## PRODUCTO=NO
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('GPV_PARTICIPACION_GASTO', 'NUMBER(16,2)','', 'Porcentaje de participación en el gasto.'),
        T_TIPO_DATA('GPV_REFERENCIA_CATASTRAL', 'VARCHAR(50 CHAR)','', 'Referencia catastral del activo.')
