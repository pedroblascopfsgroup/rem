...
BEGIN
	...
	(
		...
		RST_LLAMADA_ENDPOINT			        VARCHAR2(100 CHAR) 			NOT NULL,
		RST_LLAMADA_METODO				        VARCHAR2(50 CHAR) 			NOT NULL,
		RST_LLAMADA_TOKEN				        VARCHAR2(100 CHAR) 			NULL,	
		RST_LLAMADA_IP					        VARCHAR2(20 CHAR) 			NOT NULL,
		RST_LLAMADA_APIKEY				        VARCHAR2(20 CHAR) 			NOT NULL,
		RST_LLAMADA_SIGNATURE			        VARCHAR2(100 CHAR) 			NOT NULL,
		RST_LLAMADA_ERROR_DESC				    VARCHAR2(200 CHAR) 			NULL,	
		RST_LLAMADA_REQUEST				        CLOB 			            NOT NULL,
		RST_LLAMADA_RESPONSE			        CLOB 			            NOT NULL,
