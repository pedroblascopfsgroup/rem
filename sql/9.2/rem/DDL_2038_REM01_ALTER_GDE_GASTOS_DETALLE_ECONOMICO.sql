...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'GDE_REEMBOLSO_TERCERO',		 			'NUMBER(1,0)',						'Hay que reembolsar el pago al tercero.'	),
    	T_ALTER(  'GDE_INCLUIR_PAGO_PROVISION',		 				'NUMBER(1,0)',						'Incluir el pago en la provisión de fondos a la gestoría.'	),
    	T_ALTER(  'GDE_ABONO_CUENTA',		 			'NUMBER(1,0)',						'Abonar en la siguiente cuenta.'	),
    	T_ALTER(  'GDE_IBAN',		 			'VARCHAR(50 CHAR)',						'Número de IBAN.'	),
    	T_ALTER(  'GDE_TITULAR_CUENTA',		 			'VARCHAR(50 CHAR)',						'Titular de la cuenta.'	),
