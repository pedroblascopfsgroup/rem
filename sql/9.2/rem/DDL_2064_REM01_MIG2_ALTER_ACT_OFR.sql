...
--## PRODUCTO=NO
--## Finalidad: ANADIR EL CAMPO OFR_ACT_PORCEN_PARTICIPACION A LA TABLA ACT_OFR
--##           
...
DECLARE
      ...
      V_TABLA VARCHAR2(30 CHAR) := 'ACT_OFR'; -- Vble. con el nombre de la tabla afectada
      V_CAMPO VARCHAR2(30 CHAR) := 'OFR_ACT_PORCEN_PARTICIPACION'; -- Vble. con el nombre del nuevo campo
...
BEGIN
      ...
      IF V_NUM_TABLAS > 0 THEN            
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO] LA TABLA '||V_TABLA||' EXISTE.');
            ...
            ELSE        
                  ...
                  V_SQL := 'ALTER TABLE '||V_TABLA||' ADD '||V_CAMPO||' NUMBER(5,2)';      
