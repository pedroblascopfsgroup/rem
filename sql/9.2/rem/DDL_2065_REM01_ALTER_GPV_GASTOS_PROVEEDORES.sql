...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('GPV_COD_GASTO_AGRUPADO', 'NUMBER','(9)', 'Para aquellos Gastos que sean agrupados (Provisión de Fondos), marcar con un Código común los diverso(s) Gastos de la Agrupación'),
        T_TIPO_DATA('GPV_COD_TIPO_OPERACION', 'VARCHAR2','(20 CHAR)', 'Referencia UVEM: COSUFA'),
        T_TIPO_DATA('GPV_NUMERO_FACTURA_UVEM', 'VARCHAR2','(20 CHAR)', 'Referencia UVEM: NUFACA'),
        T_TIPO_DATA('GPV_NUMERO_PROVISION_FONDOS', 'VARCHAR2','(20 CHAR)', 'Referencia UVEM: NUPROF'),
        T_TIPO_DATA('GPV_NUMERO_PRESUPUESTO', 'VARCHAR2','(20 CHAR)', '')     
    ); 
