...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'OFR_FECHA_SOLICITUD_VISITA',			'DATE',								'Fecha de solicitud de visita de la administracion, al activo.'	),
    	T_ALTER(  'OFR_FECHA_REALIZACION_VISITA',		'DATE',								'Fecha de realización de visita de la administracion, al activo.')
		);
    V_T_ALTER T_ALTER;
