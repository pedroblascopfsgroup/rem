...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tablas de FACTURAS FAC_FACTURAS_SIN_PROV, LFS_LIN_FACT_SIN_PROV, FAC_FACTURAS_CON_PROV, LFP_LIN_FACT_PROV CREADA
--##
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
	...
	/***** APR_AUX_I_RU_FACT_SIN_PROV *****/
	
	V_TABLA := 'APR_AUX_I_RU_FACT_SIN_PROV';
	...
	/***** APR_AUX_I_RU_LFACT_SIN_PROV *****/

	V_TABLA := 'APR_AUX_I_RU_LFACT_SIN_PROV';
	...
	V_TABLA := 'APR_AUX_I_RU_FACT_PROV';
