...
BEGIN
	...
	/***** APR_AUX_I_UR_FACT_SP_REJECTS *****/

	V_TABLA := 'APR_AUX_I_UR_FACT_SP_REJECTS';
	...
	/***** APR_AUX_I_UR_FACT_CP_REJECTS *****/

	V_TABLA := 'APR_AUX_I_UR_FACT_CP_REJECTS';
