...
--## PRODUCTO=NO
--## Finalidad: ANADIR EL CAMPO PVE_COD_API_PROVEEDOR A LA TABLA ACT_PVE_PROVEEDOR
--##           
...
DECLARE
      ...
      V_TABLA VARCHAR2(30 CHAR) := 'ACT_PVE_PROVEEDOR'; -- Vble. con el nombre de la tabla afectada
      V_CAMPO VARCHAR2(30 CHAR) := 'PVE_COD_API_PROVEEDOR'; -- Vble. con el nombre del nuevo campo
...
BEGIN
      ...
      ELSE        
            ...
            V_SQL := 'ALTER TABLE '||V_TABLA||' ADD '||V_CAMPO||' VARCHAR2(4 CHAR)';
