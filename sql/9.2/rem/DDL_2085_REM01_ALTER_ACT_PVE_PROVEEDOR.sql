...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_PVE_PROVEEDOR, con campo de posibilidad de modificar el informe
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PVE_AUTORIZACION_WEB',			'NUMBER(1,0)',						'Indicador de autorizacion modificacion web al proveedor'	)
		);
    V_T_ALTER T_ALTER;
