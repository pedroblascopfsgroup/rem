...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla Proveedores, con info de TOP 150 y calificacion propuestas
--##           
...
DECLARE
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_CPR_ID_PROP_RET',				'DD_CPR_ID_PROP',		V_ESQUEMA||'.DD_CPR_CALIFICACION_RETIRAR',		'DD_CPR_ID'			)
    );
    V_T_FK T_FK;
