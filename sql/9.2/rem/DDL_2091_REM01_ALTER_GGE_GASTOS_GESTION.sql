...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'GGE_FECHA_ENVIO_GESTORIA',			'DATE',					'Fecha del último envio a la gestoria'),
    	T_ALTER(  'GGE_FECHA_ENVIO_PRPTRIO',		'DATE',					'Fecha del último envio al propietario'),
    	T_ALTER(  'GGE_FECHA_RECEPCION_GESTORIA',	 	'DATE',					'Fecha de la última recepción de la gestoria'),
    	T_ALTER(  'GGE_FECHA_RECEPCION_PRPTRIO',	'DATE',					'Fecha de la última recepción del propieatario')
		);
    V_T_ALTER T_ALTER;       
