...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('FOT_GDF_ID', 'NUMBER(16,0)','', 'id en el gestor documental remoto'),
        T_TIPO_DATA('FOT_GDF_URL', 'VARCHAR2(256 CHAR)','', 'url en el gestor documental remoto'),
	T_TIPO_DATA('FOT_GDF_WATERMARK', 'VARCHAR2(256 CHAR)','', 'url en el gestor documental remoto'),
	T_TIPO_DATA('FOT_GDF_OPTIMIZED', 'VARCHAR2(256 CHAR)','', 'url en el gestor documental remoto'),
	T_TIPO_DATA('FOT_GDF_THUMBNAIL', 'VARCHAR2(256 CHAR)','', 'url en el gestor documental remoto')
    ); 
    V_TMP_TIPO_DATA T_TIPO_DATA;
    
    
BEGIN
    --ponemos la columna ADJ_FICHERO como null
    EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' MODIFY (ADJ_ID NULL)';	
