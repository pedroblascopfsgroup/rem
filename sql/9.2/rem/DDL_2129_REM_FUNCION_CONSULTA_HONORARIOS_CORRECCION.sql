...
--## PRODUCTO=NO
--## Finalidad: Crear una función para obtener el porcentaje de honorarios. Correccion consulta principal
--##           
...
BEGIN
  DBMS_OUTPUT.PUT_LINE('[INFO] Función FUNCTION CALCULAR_HONORARIO: INICIANDO...');	     	 
	EXECUTE IMMEDIATE '
create or replace FUNCTION '||V_ESQUEMA||'.CALCULAR_HONORARIO (P_OFR_ID IN NUMBER, TIPO_COMISION IN VARCHAR2) RETURN NUMBER AS 
