...
--##########################################
--## AUTOR=JORGE ROS
--## FECHA_CREACION=20171203
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-10334
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_ACTIVO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_BLOQUEO_TIPO_COMERCIALIZAR',	'NUMBER(1) DEFAULT 0',				'Indicador No Bloqueado(0)/Bloqueado(1) el proceso automático para cambiar el Tipo de Comercialización'	)
		);
    V_T_ALTER T_ALTER;
