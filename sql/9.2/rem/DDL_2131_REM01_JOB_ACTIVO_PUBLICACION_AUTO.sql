...
DECLARE
  ...
  DBMS_SCHEDULER.CREATE_JOB (
   job_name             => 'JOB_ACTIVO_PUBLICACION_AUTO',
   job_type             => 'PLSQL_BLOCK',
   job_action           => V_ESQUEMA || '.ACTIVO_PUBLICACION_AUTO(null, null);',
   start_date           => to_date('21/12/2016 00:30:00','dd/mm/yyyy hh24:mi:ss'),
   repeat_interval      => 'FREQ=DAILY', 
   --end_date             => '15-SEP-08 1.00.00AM US/Pacific',
   enabled              =>  TRUE,
   comments             => 'Job de publicación automática');
