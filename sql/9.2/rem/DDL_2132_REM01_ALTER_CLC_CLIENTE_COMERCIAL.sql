...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CLC_RECHAZA_PUBLI',		'NUMBER(1,0)',			'Indicador de si el cliente no quiere que le llegue publicidad.'	),
		T_ALTER(  'CLC_ID_SALESFORCE',		'VARCHAR2(20 CHAR)',	'Identificador único del cliente en salesforce.'	),
		T_ALTER(  'CLC_TELF_CONTACTO_VIS',	'VARCHAR2(50 CHAR)',	'No. de teléfono del proveedor para contacto visitas'	)
		);
    V_T_ALTER T_ALTER;
