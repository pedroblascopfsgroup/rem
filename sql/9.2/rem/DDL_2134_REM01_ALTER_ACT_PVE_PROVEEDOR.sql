...
--## INCIDENCIA_LINK=HREOS-1395
--## PRODUCTO=NO
--## Finalidad: Cambiar la tabla ACT_PVE_PROVEEDOR, para añadir campos nuevos
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'PVE_TELF_CONTACTO_VIS',	'VARCHAR2(50 CHAR)',	'No. de teléfono del proveedor para contacto visitas'	)
		);
    V_T_ALTER T_ALTER;
