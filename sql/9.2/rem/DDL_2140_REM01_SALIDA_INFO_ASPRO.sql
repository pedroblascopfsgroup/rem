...
--##########################################
--## AUTOR=Joaquin_Arnal
--## FECHA_CREACION=20160110
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1371
--## PRODUCTO=NO
--## Finalidad: Creación de tablas auxiliares para salida de información ASPRO
--##           
...
BEGIN
	...
	V_TEXT_TABLA := 'ASPRO_10_CABECERA'; 
	...
	*/
	...
	(
		...
		IDPASA	VARCHAR2 (5 CHAR),
		FILLER	VARCHAR2 (226 CHAR),
		ERCOD9	VARCHAR2 (3 CHAR)
	)
	LOGGING 
	NOCOMPRESS 
	...
	*/
	...
	V_TEXT_TABLA := 'ASPRO_12_INMOVILIZADO'; 
	...
	*/
	...
	V_TEXT_TABLA := 'ASPRO_15_PROVEEDOR'; 
