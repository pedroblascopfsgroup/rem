...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene la información de Reserva con diccionario motivo anulacion
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MAN_ID',		 				'NUMBER(16,0)',						'Motivo de anulación de la reserva.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_RES_MOTIVO_ANUL',				'DD_MAN_ID',				V_ESQUEMA||'.DD_MAN_MOTIVO_ANULACION',			'DD_MAN_ID'			)
    );
    V_T_FK T_FK;
