...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla RCB_RESOL_COMITE_BANKIA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TRE_ID',						'NUMBER(16,0)',				'Tipo de resolución del comité'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    		...
    		T_FK(	'FK_RCB_TIPO_RESOL',				'DD_TRE_ID',			V_ESQUEMA||'.DD_TRE_TIPO_RESOLUCION',			'DD_TRE_ID'			)
    );
    V_T_FK T_FK;
