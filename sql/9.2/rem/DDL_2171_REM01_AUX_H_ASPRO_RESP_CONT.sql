...
BEGIN
  ...
  V_TEXT_TABLA := 'AUX_H_ASPRO_RESP_CONT'; 
  V_COMMENT_TABLE := 'Tabla auxiliar de entrada para respuesta fichero gastos ASPRO contabilidad'; 
  V_COLUMN_TABLE_UNIQUE := '';
	...
	-- CODREG	VARCHAR2(1 CHAR),
	-- COENTV	VARCHAR2(7 CHAR),
	-- FILLER_1	VARCHAR2(296 CHAR),
	-- NUFPR1	VARCHAR2(20 CHAR),
	-- FILLER_2	VARCHAR2(60 CHAR),
	-- FEPAGA	VARCHAR2(8 CHAR),
	-- FILLER_2	VARCHAR2(190 CHAR),
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN  '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.NUFPR1 IS ''NUMERO DE FACTURA ASPRO'' ';
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN  '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.FEPAGA IS ''FECHA DE PAGO DE LA FACTURA'' ';
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN  '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.FECTBL IS ''FECHA DE CONTABILIZACIÓN DE LA FACTURA'' ';
