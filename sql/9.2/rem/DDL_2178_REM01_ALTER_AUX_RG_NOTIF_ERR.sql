...
--##########################################
--## AUTOR=Joaquin_Arnal
--## FECHA_CREACION=20170424
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-2060
--## PRODUCTO=NO
--## Finalidad: Añadimos a la tabla APR_AUX_RG_NOTIF_ERR el campo del estado gasto.
--##           
...
DECLARE
    ...
    V_COL_TO_INSERT VARCHAR2(100 CHAR) := 'ESTADO_GASTO'; -- Vble. auxiliar para almacenar el nombre de la columna a insertar.
    V_TIPO_COL_TO_INSERT VARCHAR2(100 CHAR) := 'VARCHAR2(20 CHAR)'; -- Vble. auxiliar para almacenar el tipo de la columna a insertar.
