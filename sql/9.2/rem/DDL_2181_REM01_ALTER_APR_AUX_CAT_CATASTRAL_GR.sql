...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_CAT_CATASTRAL_GR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('FECHA_ALTA', 'DATE', '', 'Fecha de alta en catastro')
        ,T_TIPO_DATA('FECHA_BAJA', 'DATE', '', 'Fecha de baja en catastro')
