...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MAR_ID',		 					'NUMBER(16,0)',						'Código único del motivo de anulación de la reserva.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_MAR_MOTIVO_ANULACION_RES',						'DD_MAR_ID',				V_ESQUEMA||'.DD_MAR_MOTIVO_ANULACION_RES',				'DD_MAR_ID'			)
    );
    V_T_FK T_FK;
