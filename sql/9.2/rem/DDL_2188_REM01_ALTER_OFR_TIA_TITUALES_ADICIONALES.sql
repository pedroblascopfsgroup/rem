...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir nuevas columnas a la tabla OFR_TIA_TITULARES_ADICIONALES
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'TIA_APELLIDOS',		 			'VARCHAR2 (120 CHAR)',				'Apellidos del titular'),
    	T_ALTER(  'TIA_DIRECCION',		 			'VARCHAR2 (120 CHAR)',				'Direccion del titular'),
    	T_ALTER(  'DD_LOC_ID',		 				'NUMBER(16,0)',						'Localidad del titular'),
    	T_ALTER(  'DD_PRV_ID',		 				'NUMBER(16,0)',						'Provincia del titular'),
    	T_ALTER(  'TIA_CODPOSTAL',		 			'VARCHAR (20 CHAR)',				'Código postal del titular'),
    	T_ALTER(  'DD_ECV_ID',		 				'NUMBER(16,0)',						'Estado Civil del titular'),
    	T_ALTER(  'DD_REM_ID',		 				'NUMBER(16,0)',						'Régimen Económico del titular')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_LOC_ID_TIA',						'DD_LOC_ID',			V_ESQUEMA_M||'.DD_LOC_LOCALIDAD',				'DD_LOC_ID'			),
    	T_FK(	'FK_DD_PRV_ID_TIA',						'DD_PRV_ID',			V_ESQUEMA_M||'.DD_PRV_PROVINCIA',				'DD_PRV_ID'			),
    	T_FK(	'FK_DD_ECV_ID_TIA',						'DD_ECV_ID',			V_ESQUEMA||'.DD_ECV_ESTADOS_CIVILES',			'DD_ECV_ID'			),
    	T_FK(	'FK_DD_REM_ID_TIA',						'DD_REM_ID',			V_ESQUEMA||'.DD_REM_REGIMENES_MATRIMONIALES',	'DD_REM_ID'			)
    );	
    V_T_FK T_FK;
