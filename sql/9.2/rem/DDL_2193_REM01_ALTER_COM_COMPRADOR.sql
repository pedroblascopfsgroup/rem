...
--## INCIDENCIA_LINK=HREOS-5537
--## PRODUCTO=SI
--## Finalidad: Crear una nueva columna (ID_PERSONA_HAYA) en la tabla COM_COMPRADOR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ID_PERSONA_HAYA',		 			'NUMBER(16,0)',						'Campo que se rellena con la llamada al Maestro de Personas')
	);
    V_T_ALTER T_ALTER;    
