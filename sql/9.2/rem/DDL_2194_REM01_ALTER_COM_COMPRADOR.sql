...
--## INCIDENCIA_LINK=HREOS-5667
--## PRODUCTO=NO
--## Finalidad: Crear una nueva columna (ADCOM_ID) en la tabla COM_COMPRADOR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ADCOM_ID',		 			'NUMBER(16,0)',						'Adjunto relacionado en la ADC_ADJUNTO_COMPRADOR')
	);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ADCOM_ID',					'ADCOM_ID',				V_ESQUEMA||'.ADC_ADJUNTO_COMPRADOR',				'ADCOM_ID'		)
    );
    V_T_FK T_FK;
...
BEGIN
	...
	-- Bucle que CREA las FK de las nuevas columnas del COMPRADOR
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||' AMPLIADA CON COLUMNA NUEVA.');
	COMMIT;
