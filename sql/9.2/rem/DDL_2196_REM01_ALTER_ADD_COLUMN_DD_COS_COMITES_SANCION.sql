...
--## PRODUCTO=NO
--## Finalidad: Añadir columna DD_SCR_ID en la tabla DD_COS_COMITES_SANCION
--##           
...
DECLARE
    ...
    V_COLUMNA VARCHAR2(30 CHAR):= 'DD_SCR_ID'; -- Vble. para almacenar el nombre de la columna.
    V_COLUMNA_FK VARCHAR2(30 CHAR):= 'DD_SCR_ID'; -- Vble. para almacenar el nombre de la columna FK.
    V_TABLA VARCHAR2(50 CHAR):= 'DD_COS_COMITES_SANCION'; -- Vble. para almacenar el nombre de la tabla.
    V_TABLA_FK VARCHAR2(50 CHAR):= 'DD_SCR_SUBCARTERA'; -- Vble. para almacenar el nombre de la tabla FK.
    V_NOMBRE_FK VARCHAR (50 CHAR):='FK_DD_SCR_SUBCARTERA'; --Vble. para almacenar el nombre de la FK.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'FK  de la tabla DD_SCR_SUBCARTERA que guarda el ID de la subcartera'; -- Vble. para los comentarios de las tablas
