...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_ORC_ID',				'NUMBER(16,0)',			'Campo fk a DD_ORC_ORIGEN_COMPRADOR')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    			...
    			T_FK(	'FK_DD_ORC',				'DD_ORC_ID',			V_ESQUEMA||'.DD_ORC_ORIGEN_COMPRADOR',			'DD_ORC_ID'			)
    );
    V_T_FK T_FK;
