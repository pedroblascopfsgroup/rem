...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir las columnas en la tabla ACT_APU_ACTIVO-PUBLICACION que hacen referencia a los diccionarios de las fases y subfases de publicacion.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DD_FSP_ID',		 		'NUMBER(16,0)',		'Foreign key a DD_FSP_FASE_PUBLICACION.'),
    	T_ALTER('DD_SFP_ID',				'NUMBER(16,0)',		'Foreign key a DD_SFP_SUBFASE_PUBLICACION.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_FSP_ID',			'DD_FSP_ID',		V_ESQUEMA||'.DD_FSP_FASE_PUBLICACION',		'DD_FSP_ID'),
	T_FK(	'FK_SFP_ID',			'DD_SFP_ID',		V_ESQUEMA||'.DD_SFP_SUBFASE_PUBLICACION',	'DD_SFP_ID')
    );
    V_T_FK T_FK;
