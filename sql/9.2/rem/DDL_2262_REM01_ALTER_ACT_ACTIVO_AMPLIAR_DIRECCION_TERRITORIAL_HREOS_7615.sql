...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Añadir la columna en la tabla ACT_ACTIVO que hacen referencia al diccionario de Dirección Territorial.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DD_DRT_ID',		 		'NUMBER(16,0)',		'Foreign key a DD_DRT_DIRECCION_TERRITORIAL.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_DRT_ID',			'DD_DRT_ID',		V_ESQUEMA||'.DD_DRT_DIRECCION_TERRITORIAL',		'DD_DRT_ID')
    );
    V_T_FK T_FK;
