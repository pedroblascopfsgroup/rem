...
--## INCIDENCIA_LINK=HREOS-7810
--## PRODUCTO=NO
--## Finalidad: Gasto: Nuevo bloque "anticipo" - Procesos
--##           
--## INSTRUCCIONES: Elimina la columna SubFase de publicación de la tabla ACT_APU_ACTIVO_PUBLICACION
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(2400 CHAR) := 'DD_SFP_ID'; -- Vble. auxiliar para almacenar el nombre de la columna a añadir.
