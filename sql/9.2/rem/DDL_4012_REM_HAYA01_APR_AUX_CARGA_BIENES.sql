...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla auxiliar para el aprovisionamiento de la información de las cargas de los bienes de recovery-HAYA.
--##           
...
DECLARE
    ...
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla auxiliar para el aprovisionamiento de la información de las cargas de los bienes de recovery-HAYA.'; -- Vble. para los comentarios de las tablas
