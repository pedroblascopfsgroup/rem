...
--## PRODUCTO=NO
--## Finalidad: Nueva columna (ADG_FECHA_ENVIO_COMUNICA) en ACT_ADG_ADECUACION
--##           
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ACT_ADG_ADECUACION_GENCAT'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ADG_FECHA_ENVIO_COMUNICA', 'DATE', 'Fecha de envío de comunicación')
