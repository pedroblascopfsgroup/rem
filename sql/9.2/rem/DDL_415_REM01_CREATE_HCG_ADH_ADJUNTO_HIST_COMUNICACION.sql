...
DECLARE
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT FK_ADH_ADC_ID FOREIGN KEY (ADC_ID) REFERENCES '||V_ESQUEMA||'.ADC_ADJUNTO_COMUNICACION (ADC_ID) ON DELETE CASCADE)';
	EXECUTE IMMEDIATE V_MSQL;
