...
--## PRODUCTO=NO
--## Finalidad: DDL Creación de la tabla ACT_HRG_HIST_RECLAMACION_GENCAT
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'ACT_HRG_HIST_RECLAM_GENCAT'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    VN_COUNT NUMBER(16); -- Vble. para consulta que valida la existencia de una secuencia.
    
    BEGIN

    -- ******** ACT_HRG_HIST_RECLAMACION_GENCAT *******
    DBMS_OUTPUT.PUT_LINE('******** ACT_HRG_HIST_RECLAMACION_GENCAT ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TEXT_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla ACT_HRG_HIST_RECLAMACION_GENCAT
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
               (HRG_ID                   NUMBER(16,0) NOT NULL PRIMARY KEY,
			    HCG_ID                   NUMBER(16,0) NOT NULL,
			    HRG_FECHA_AVISO          DATE,
                HRG_FECHA_RECLAMACION    DATE,
			    ...
			    FECHABORRAR              DATE,
                CONSTRAINT FK_HRG_HIST_HCG_HIST FOREIGN KEY (HCG_ID) REFERENCES '|| V_ESQUEMA ||'.ACT_HCG_HIST_COM_GENCAT (HCG_ID)
			  )';
    ...
    END IF;
     	...
     	--Secuencia para la tabla ACT_HRG_HIST_RECLAMACION_GENCAT
