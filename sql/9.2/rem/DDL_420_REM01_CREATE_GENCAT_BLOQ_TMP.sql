...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'GENCAT_BLOQ_TMP'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	IF V_NUM_TABLAS = 0 THEN
		...
		V_MSQL := 'CREATE TABLE ' ||V_ESQUEMA||'.'||V_TABLA||'
	   	...
	   	(		 
			...
			ACT_ID 	 		 NUMBER(16,0), 
			OFR_ID 	 		 NUMBER(16,0), 
			V_BODY 			 VARCHAR2 (4000 CHAR),
			CC_MAIL			 VARCHAR2 (4000 CHAR)	
	 	)
		NOLOGGING 
		';
