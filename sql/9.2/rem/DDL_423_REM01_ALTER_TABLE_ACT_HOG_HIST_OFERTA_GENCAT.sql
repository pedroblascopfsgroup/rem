...
--## INCIDENCIA_LINK=HREOS-5866
--## PRODUCTO=SI
--## 
--## Finalidad: Incluir campo OFR_ID_ANT en tabla ACT_HOG_HIST_OFERTA_GENCAT.
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
      -- Recordatorios
  	  T_COL(''||V_ESQUEMA||'', 'ACT_HOG_HIST_OFERTA_GENCAT'        , 'OFR_ID_ANT'                   	  , 'NUMBER(16,0)'       	  , 'ID de la oferta anterior')
