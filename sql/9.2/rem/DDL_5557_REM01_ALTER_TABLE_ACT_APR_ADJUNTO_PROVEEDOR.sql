...
DECLARE
   ...
   V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
     ...
     T_ALTER('DD_TCP_ID',        'NUMBER(16,0)',           'Fk al diccionario de contenedores de proveedores.')
   );
   V_T_ALTER T_ALTER;
   ...
   V_FK T_ARRAY_FK := T_ARRAY_FK(
     ...
     T_FK( 'FK_APR_TCP_ID',   'DD_TCP_ID',    V_ESQUEMA||'.DD_TCP_TIPO_CONTENEDOR_PROV',   'DD_TCP_ID'     )
   );
   V_T_FK T_FK;
...
BEGIN	
 ...
 END IF;
    ...
    DBMS_OUTPUT.PUT_LINE('[FIN]: ACT_APR_ADJUNTO_PROVEEDOR ACTUALIZADA CORRECTAMENTE ');
