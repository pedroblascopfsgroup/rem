...
--## PRODUCTO=SI
--## 
--## Finalidad: Incluir campo CLIENTE_WS en tabla MGD_MAPEO_GESTOR_DOC.
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
      -- Recordatorios
  	  T_COL(''||V_ESQUEMA||'', 'MGD_MAPEO_GESTOR_DOC', 'CLIENTE_WS'                   	  , 'VARCHAR2(50 CHAR)'       	  , 'Cliente para enviar al Maestro de Activos')
