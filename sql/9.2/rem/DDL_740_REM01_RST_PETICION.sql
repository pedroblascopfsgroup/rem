...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_RST_BROKER_ID FOREIGN KEY  (RST_BROKER_ID) REFERENCES '||V_ESQUEMA||'.RST_BROKER (RST_BROKER_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
