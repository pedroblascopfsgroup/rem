...
--## PRODUCTO=SI
--## Finalidad: Crear una nueva columna (DD_TAL_ID) en la tabla ACT_AGR_AGRUPACION
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TAL_ID',		 			'NUMBER(16,0)',						'Tipo de alquiler')
	);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_TAL_TIPO_ALQUILER',					'DD_TAL_ID',				V_ESQUEMA||'.DD_TAL_TIPO_ALQUILER',				'DD_TAL_ID'		)
    );
    V_T_FK T_FK;
