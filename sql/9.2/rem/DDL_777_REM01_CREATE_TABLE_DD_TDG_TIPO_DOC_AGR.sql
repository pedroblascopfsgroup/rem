...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_TDG_TIPO_DOC_AGR'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- Creacion Tabla DD_TDG_TIPO_DOC_AGR
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.DD_TDG_ID IS ''Código identificador único de tipo de documento de agrupación.''';
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.DD_TDG_CODIGO IS ''Código único de tipo de documento de agrupación.''';
