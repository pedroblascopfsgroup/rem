...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_TST_TIPO_SOLICITUD_TRIB
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_TST_TIPO_SOLICITUD_TRIB'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'
               (DD_TST_ID NUMBER (16,0) 
				  , DD_TST_CODIGO VARCHAR2(20 CHAR) 
				  , DD_TST_DESCRIPCION VARCHAR2(100 CHAR) 
				  , DD_TST_DESCRIPCION_LARGA VARCHAR2(250 CHAR) 
				  ...
				  , CONSTRAINT PK_DD_TST_ID PRIMARY KEY(DD_TST_ID)
			  )';
		...
		-- execute immediate 'grant select, insert, delete, update, REFERENCES(DD_TST_ID) on ' || V_ESQUEMA || '.'||V_TABLA||' to '||V_ESQUEMA||'';
