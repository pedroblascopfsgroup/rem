...
--## PRODUCTO=NO
--## Finalidad: Añadir la columna en la tabla ACT_ACTIVO que hacen referencia al diccionario DD_SPG_SOCIEDAD_PAGO_ANTERIOR.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DD_SPG_ID',		 		'NUMBER(16,0)',		'Foreign Key a DD_SPG_SOCIEDAD_PAGO_ANTERIOR.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_SPG_ID',			'DD_SPG_ID',		V_ESQUEMA||'.DD_SPG_SOCIEDAD_PAGO_ANTERIOR',		'DD_SPG_ID')
    );
    V_T_FK T_FK;
