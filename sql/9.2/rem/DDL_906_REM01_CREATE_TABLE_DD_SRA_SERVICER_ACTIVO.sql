...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_SRA_SERVICER_ACTIVO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_SRA_SERVICER_ACTIVO'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- Creacion Tabla DD_SRA_SERVICER_ACTIVO
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'
               (DD_SRA_ID NUMBER (16,0) 
				  , DD_SRA_CODIGO VARCHAR2(20 CHAR) 
				  , DD_SRA_DESCRIPCION VARCHAR2(100 CHAR) 
				  , DD_SRA_DESCRIPCION_LARGA VARCHAR2(100 CHAR) 
				  ...
				  , CONSTRAINT PK_DD_SRA_ID PRIMARY KEY(DD_SRA_ID)
			  )';
		...
		-- execute immediate 'grant select, insert, delete, update, REFERENCES(DD_SRA_ID) on ' || V_ESQUEMA || '.'||V_TABLA||' to '||V_ESQUEMA||'';
