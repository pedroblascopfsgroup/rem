...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_CMS_CESION_COM_SANEAMIENTO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_CMS_CESION_COM_SANEAMIENTO'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- Creacion Tabla DD_CMS_CESION_COM_SANEAMIENTO
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'
               (DD_CMS_ID NUMBER (16,0) 
				  , DD_CMS_CODIGO VARCHAR2(20 CHAR) 
				  , DD_CMS_DESCRIPCION VARCHAR2(100 CHAR) 
				  , DD_CMS_DESCRIPCION_LARGA VARCHAR2(100 CHAR) 
				  ...
				  , CONSTRAINT PK_DD_CMS_ID PRIMARY KEY(DD_CMS_ID)
			  )';
		...
		-- execute immediate 'grant select, insert, delete, update, REFERENCES(DD_CMS_ID) on ' || V_ESQUEMA || '.'||V_TABLA||' to '||V_ESQUEMA||'';
