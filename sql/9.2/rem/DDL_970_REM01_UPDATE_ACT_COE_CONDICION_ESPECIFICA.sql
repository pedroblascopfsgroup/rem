...
--## INCIDENCIA_LINK=REMVIP-4534
--## PRODUCTO=No
--## Finalidad: crear nueva columna ACT_COE_CONDICION_ESPECIFICA.COE_CODIGO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'COE_CODIGO',					'VARCHAR2(50 CHAR)',		'Código identificador del registro.')
		);
    V_T_ALTER T_ALTER;
