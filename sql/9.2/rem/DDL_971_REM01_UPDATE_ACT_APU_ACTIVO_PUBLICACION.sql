...
--## INCIDENCIA_LINK=HREMVIP-4867
--## PRODUCTO=NO
--## Finalidad: Añadir nuevas columnas a ACT_APU_ACTIVO_PUBLICACION.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME_0 VARCHAR2(30):= 'APU_FECHA_REVISION_PUB_VENTA'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE_0 VARCHAR2(500 CHAR):= 'Indica la fecha de revisión de publicación de venta del activo.'; -- Vble. para los comentarios de las tablas
    V_COLUMN_NAME_1 VARCHAR2(30):= 'APU_FECHA_REVISION_PUB_ALQ'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE_1 VARCHAR2(500 CHAR):= 'Indica la fecha de revisión de publicación de alquiler del activo.'; -- Vble. para los comentarios de las tablas
