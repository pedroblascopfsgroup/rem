...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_SCR_ID',		 					'NUMBER(16,0)',						'ID SUBCARTERA')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CONFIGTARIFA_DDSUBCARTERA',		'DD_SCR_ID',		V_ESQUEMA||'.DD_SCR_SUBCARTERA',	    'DD_SCR_ID'			)
    );
    V_T_FK T_FK;
