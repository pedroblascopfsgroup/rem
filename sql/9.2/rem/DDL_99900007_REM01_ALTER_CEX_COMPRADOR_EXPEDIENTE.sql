...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('CEX_NUM_FACTURA', 'VARCHAR2(50 CHAR)','', 'Número de factura de por la venta reflejada en el expediente comercial'),
     	T_TIPO_DATA('CEX_FECHA_FACTURA', 'DATE','', 'Fecha de la factura generada.')
    ); 
