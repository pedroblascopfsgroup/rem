...
--## PRODUCTO=NO
--## Finalidad: Anyadir columna arrendamiento en CPP_CONFIG_PTDAS_PREP
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('CPP_ARRENDAMIENTO', 'NUMBER(1,0)','', 'Indicador de si la configuración de la partida es para activos arrendados'),
        T_TIPO_DATA('CPP_CANTIDAD_MAX_PRO', 'NUMBER(16,2)','', 'Importe máximo del proveedor por tipo de gasto')
    ); 
