...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: ADD auditoria en ACT_ETP_ENTIDAD_PROVEEDOR
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ACT_ETP_ENTIDAD_PROVEEDOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'VERSION',			'NUMBER(38,0) DEFAULT 0 NOT NULL ENABLE',				''	),
    	T_ALTER(  'USUARIOCREAR',		'VARCHAR2(50 CHAR) DEFAULT ''DEFAULT'' NOT NULL ENABLE',				''	),
    	T_ALTER(  'FECHACREAR',			'TIMESTAMP (6)	DEFAULT SYSDATE	NOT NULL ENABLE',				''	),
    	T_ALTER(  'USUARIOMODIFICAR',	'VARCHAR2(50 CHAR)',				''	),
    	T_ALTER(  'FECHAMODIFICAR',		'TIMESTAMP (6)',				''	),
    	T_ALTER(  'USUARIOBORRAR',		'VARCHAR2(50 CHAR)',				''	),
    	T_ALTER(  'FECHABORRAR',		'TIMESTAMP (6)',				''	),
    	T_ALTER(  'BORRADO',			'NUMBER(1,0) 				DEFAULT 0 NOT NULL ENABLE',				''	)
		);
    V_T_ALTER T_ALTER;
