...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: ADD CAT_IND_INTERFAZ_BANKIA en ACT_CAT_CATASTRO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CAT_IND_INTERFAZ_BANKIA',			'NUMBER(1,0) 				DEFAULT 0 NOT NULL ENABLE',				'Indicador de referencia catastral principal para seleccionar la referencia catastral en el caso de varias referencias por activo en bankia'	)
		);
    V_T_ALTER T_ALTER;
