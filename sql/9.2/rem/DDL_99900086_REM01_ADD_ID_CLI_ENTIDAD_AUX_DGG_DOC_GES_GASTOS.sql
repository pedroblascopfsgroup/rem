...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: ADD ID_CLI_ENTIDAD APR_AUX_DGG_DOC_GES_GASTOS
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_DGG_DOC_GES_GASTOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ID_CLI_ENTIDAD',			'VARCHAR2(20 CHAR) 				',				'A quien va dirigido el gasto (Bankia, HAYA, SAREB)'	)
   ,    T_ALTER(  'FECHA_GASTO',			'VARCHAR2(8 CHAR)',				'Fecha devengo real del gasto'	)		    	    	
		);
    V_T_ALTER T_ALTER;
...
BEGIN
	...
	IF V_CREAR_FK = 'SI' THEN
		...
		-- Bucle que CREA las FK de las nuevas columnas del 
