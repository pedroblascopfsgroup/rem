...
--## INCIDENCIA_LINK=HREOS-1681
--## PRODUCTO=NO
--## Finalidad: Creación de secuencia y tablas auxiliares para calcula los datos de salida de información UVEM - Gastos
--##           
...
BEGIN
	...
	/*  Creamos secuencia S_PRG_NUM_PROVISION_UVEM si no existe */
	V_TEXT_TABLA := 'PRG_NUM_PROVISION_UVEM'; 
	...
	V_TEXT_TABLA := 'AUX_AGRUPACION_UVEM'; 
	...
	/* AUX_AGRUPACION_UVEM_2 */

	V_TEXT_TABLA := 'AUX_AGRUPACION_UVEM_2'; 
    	V_COMMENT_TABLE := 'Tabla auxiliar para asignar un ID de agrupación a cada agrupación calulcada en AUX_AGRUPACION_UVEM_2'; 
    	V_COLUMN_TABLE_UNIQUE := '';
