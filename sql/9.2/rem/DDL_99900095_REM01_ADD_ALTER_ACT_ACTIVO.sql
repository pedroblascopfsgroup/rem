...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
         ...
         T_TIPO_DATA('DD_ENA_ID',                'NUMBER','(16,0)', 'Código de entrada del activo de Bankia-UVEM.'),
	 T_TIPO_DATA('ACT_NUM_INMOVILIZADO_BNK', 'NUMBER','(9,0)' , 'Número de Inmovilizado en Bankia.'    )
    );
