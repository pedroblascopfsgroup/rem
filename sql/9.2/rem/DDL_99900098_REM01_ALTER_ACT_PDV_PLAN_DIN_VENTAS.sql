...
--## INCIDENCIA_LINK=HREOS-1791
--## PRODUCTO=NO
--## Finalidad: Añadir una nueva columna en la tabla ACT_PDV_PLAN_DIN_VENTAS.
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('PDV_ID_GARANTIA', 'NUMBER(16,0)', 'ID de garantía.')
