...
DECLARE
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CCC_EJE',				'EJE_ID',		V_ESQUEMA||'.ACT_EJE_EJERCICIO',			'EJE_ID'			)
    );
    V_T_FK T_FK;
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'CCC_CUENTA_CONTABLE',			'VARCHAR2(50 CHAR)',				'Cuenta contable.'		),
    	T_ALTER(  'EJE_ID',		 					'NUMBER(16,0)',						'Código identificador único del ejercicio al que pertenece la configuración'	),
    	T_ALTER(  'CCC_ARRENDAMIENTO',				'NUMBER(1,0)',						'Indicador de si la configuración de la cuenta es para activos arrendados'		)
	);
	V_T_ALTER T_ALTER;
