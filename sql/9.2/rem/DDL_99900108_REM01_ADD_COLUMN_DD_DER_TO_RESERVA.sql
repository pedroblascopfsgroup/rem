...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_DER_ID',						'NUMBER(16)',				'Identificador único de la devolución de la reserva'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_RESERVA_DDDER',					'DD_DER_ID',			V_ESQUEMA||'.DD_DER_DEVOLUCION_RESERVA',	'DD_DER_ID'			)
    );
    V_T_FK T_FK;
