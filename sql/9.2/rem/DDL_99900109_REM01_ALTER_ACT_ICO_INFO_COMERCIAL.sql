...
--## FECHA_CREACION=20170425
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1930
--## PRODUCTO=No
--## Finalidad: Ampliar columna ICO_CONDICIONES_LEGALES a 3000 CHAR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ICO_CONDICIONES_LEGALES',		'VARCHAR2(3000 CHAR)',		'Descipción de las condiciones legales del activo.')
		);
    V_T_ALTER T_ALTER;
