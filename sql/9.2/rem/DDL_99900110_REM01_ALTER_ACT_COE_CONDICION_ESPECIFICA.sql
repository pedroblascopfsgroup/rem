...
--## PRODUCTO=No
--## Finalidad: Ampliar columna ACT_COE_CONDICION_ESPECIFICA.COE_TEXTO a 3000 CHAR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'COE_TEXTO',		'VARCHAR2(3000 CHAR)',		'Descripción de las condiciones específicas del activo.')
		);
    V_T_ALTER T_ALTER;
