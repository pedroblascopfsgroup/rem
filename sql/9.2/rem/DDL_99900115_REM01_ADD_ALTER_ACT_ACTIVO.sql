...
--## PRODUCTO=NO
--## Finalidad: Añadir columnas de gestión de calidad en ACT_ACTIVO.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_GESTOR_SELLO_CALIDAD',		'NUMBER(16,0)',						'Identificador del usuario gestor de sello de calidad.'),
    	T_ALTER(  'ACT_FECHA_SELLO_CALIDAD',		'DATE',								'Fecha del sello de calidad.')
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_GESTOR_CALIDAD_USER',			'ACT_GESTOR_SELLO_CALIDAD',		V_ESQUEMA_M||'.USU_USUARIOS',					'USU_ID'			)
    );
    V_T_FK T_FK;
