...
--## PRODUCTO=NO
--## Finalidad: Modificar tabla ACT_AOB_ACTIVO_OBS.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TOB_ID',						'NUMBER(16)',				'Identificador único del tipo de observación')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_TIPO_OBSERVACION_ACTIVO',		'DD_TOB_ID',			V_ESQUEMA||'.DD_TOB_TIPO_OBSERVACION',		'DD_TOB_ID')
    );
    V_T_FK T_FK;
