...
--## PRODUCTO=NO
--## Finalidad: Modificar tabla ECO_EXPEDIENTE_COMERCIAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ECO_BLOQUEADO',						'NUMBER(1)',				'Indica si el expediente esta bloqueado'),
    	T_ALTER(  'DD_MDE_ID',							'NUMBER(16)',				'Indica el motivo de desbloqueo'),
    	T_ALTER(  'ECO_MDE_OTROS',						'VARCHAR2(250 CHAR)',				'Texto libre que se guarda en caso de marcar Otros en DD_MDE_ID')
		);
    V_T_ALTER T_ALTER;
