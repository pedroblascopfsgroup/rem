...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los subtipo de documentos del expediente
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_SDE_VINCULABLE',		 		'NUMBER(1,0)',						'Si se vincula a los activos o no.'	)
		);
    V_T_ALTER T_ALTER;
