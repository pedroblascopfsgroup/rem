...
--## FECHA_CREACION=20170210
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1762
--## PRODUCTO=No
--## Finalidad: Añadir columna a la tabla RST_LLAMADA
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'RST_LLAMADA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'RST_REFRESCO_TIME',				'NUMBER(16,0)',		'Tiempo refresco vista materiaqlizada')
		);
    V_T_ALTER T_ALTER;
