...
--## PRODUCTO=NO
--## Finalidad: Añadir columna DD_TTR_FILTRAR en tabla DD_TTR_TIPO_TRABAJO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TTR_FILTRAR',		'NUMBER(1,0)',					'Indicador de si se debe de filtrar del listado de trabajos')
    	);
    V_T_ALTER T_ALTER;
