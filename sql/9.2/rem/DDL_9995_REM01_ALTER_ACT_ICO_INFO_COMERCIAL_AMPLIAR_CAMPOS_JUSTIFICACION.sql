...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ICO_JUSTIFICACION_VENTA', 'VARCHAR2','(3000 CHAR)', 'Justificacion para el valor de venta.'),
        T_TIPO_DATA('ICO_JUSTIFICACION_RENTA', 'VARCHAR2','(3000 CHAR)', 'Justificacion para el valor de renta.')
