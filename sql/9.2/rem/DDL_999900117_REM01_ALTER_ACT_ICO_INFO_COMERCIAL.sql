...
--## INCIDENCIA_LINK=HREOS-2564
--## PRODUCTO=NO
--## Finalidad: Modificar tabla ACT_ICO_INFO_COMERCIAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ICO_EXIS_COM_PROP',						'NUMBER(1,0)',				'Indica si existe la comunidad de propietarios')
		);
    V_T_ALTER T_ALTER;
