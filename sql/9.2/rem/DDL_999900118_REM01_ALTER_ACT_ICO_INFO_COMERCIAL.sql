...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_LOC_REGISTRO_ID',						'NUMBER(16,0)',				'mUNICIPIO DE REGISTRO')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_LOC_REGISTRO',		'DD_LOC_REGISTRO_ID',			V_ESQUEMA_M||'.DD_LOC_LOCALIDAD',		'DD_LOC_ID')
    );
    V_T_FK T_FK;
