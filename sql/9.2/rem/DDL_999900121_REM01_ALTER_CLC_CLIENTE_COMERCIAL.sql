...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TPE_ID',						'NUMBER(16,0)',				'Tipo de persona'),
    	T_ALTER(  'DD_ECV_ID',						'NUMBER(16,0)',				'Estado civil'),
    	T_ALTER(  'DD_REM_ID',						'NUMBER(16,0)',				'Regimen matrimonial')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CLC_DD_TPE_ID',						'DD_TPE_ID',			V_ESQUEMA||'.DD_TPE_TIPO_PERSONA',				'DD_TPE_ID'),
    	T_FK(	'FK_CLC_DD_ECV_ID',						'DD_ECV_ID',			V_ESQUEMA||'.DD_ECV_ESTADOS_CIVILES',			'DD_ECV_ID'),
    	T_FK(	'FK_CLC_DD_REM_ID',						'DD_REM_ID',			V_ESQUEMA||'.DD_REM_REGIMENES_MATRIMONIALES',	'DD_REM_ID')
    );
    V_T_FK T_FK;
