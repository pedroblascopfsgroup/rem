...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'RCB_RESOL_COMITE_BANKIA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MAN_ID',						'NUMBER(16,0)',				'Tipo de anulación'),
    	T_ALTER(  'DD_PEN_ID',						'NUMBER(16,0)',				'Penitenciarias')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_RCB_DD_MAN_ID',						'DD_MAN_ID',			V_ESQUEMA||'.DD_MAN_MOTIVO_ANULACION',				'DD_MAN_ID'),
    	T_FK(	'FK_RCB_DD_PEN_ID',						'DD_PEN_ID',			V_ESQUEMA||'.DD_PEN_PENITENCIALES',			'DD_PEN_ID')
    );
    V_T_FK T_FK;
