...
DECLARE
    ...
    V_COLUMN VARCHAR2(30 CHAR) := 'GPV_NUM_GASTO_HAYA';
    V_TABLE VARCHAR2(30 CHAR) := 'GPV_GASTOS_PROVEEDOR';
    V_NOMBRE_IDX VARCHAR2(30 CHAR) := 'IDX_GPV_NUM_GASTO_HAYA';--Nombre índice.
