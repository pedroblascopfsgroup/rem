...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla de MSVProcesoMasivo con un nuevo campo.
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'PRM_PROCESO_MASIVO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PRM_TOTAL_FILAS',			'NUMBER(16,0)',				'TOTAL FILAS DEL XLS'),
    	T_ALTER(  'PRM_TOTAL_FILAS_OK',			'NUMBER(16,0)',				'FILAS PROCESADAS OK'),
    	T_ALTER(  'PRM_TOTAL_FILAS_KO',			'NUMBER(16,0)',				'FILAS PROCESADAS KO')
		);
    V_T_ALTER T_ALTER;
