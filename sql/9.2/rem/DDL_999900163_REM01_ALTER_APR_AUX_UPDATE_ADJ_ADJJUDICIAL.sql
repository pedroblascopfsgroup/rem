...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_UPDATE_ADJ_ADJJUDICIAL'; 
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_EDJ_CODIGO','VARCHAR2(20 CHAR)'),
        T_TIPO_DATA('AJD_NUM_AUTO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('AJD_PROCURADOR','VARCHAR2(100 CHAR)'),
        T_TIPO_DATA('AJD_LETRADO','VARCHAR2(100 CHAR)'),
        T_TIPO_DATA('AJD_ID_ASUNTO','NUMBER(16,0)')
    ); 
