...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('DD_LOC_CODIGO','VARCHAR2(20 CHAR)'),
        T_TIPO_DATA('BIE_DREG_CODIGO_REGISTRO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('BIE_DREG_TOMO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('BIE_DREG_LIBRO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('BIE_DREG_FOLIO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('BIE_DREG_NUM_FINCA','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('DD_PRV_CODIGO','VARCHAR2(20 CHAR)'),
        T_TIPO_DATA('SPS_FECHA_VENC_TITULO','DATE'),
        T_TIPO_DATA('CAT_REF_CATASTRAL','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('ACT_NUM_ACTIVO','NUMBER(16,0)'),
        T_TIPO_DATA('ACT_NUM_ACTIVO_SAREB', 'VARCHAR2(55 CHAR)'),
        T_TIPO_DATA('ACT_RECOVERY_ID','NUMBER(16,0)'),
        T_TIPO_DATA('DD_TPN_CODIGO','VARCHAR2(20 CHAR)'),
        T_TIPO_DATA('DD_SAC_CODIGO','VARCHAR2(20 CHAR)'),
        T_TIPO_DATA('ACT_FECHA_REV_CARGAS','DATE'),
        T_TIPO_DATA('REG_SUPERFICIE_UTIL', 'NUMBER(16,2)')
    ); 
