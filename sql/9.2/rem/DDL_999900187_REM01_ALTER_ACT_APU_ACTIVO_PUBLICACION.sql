...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DD_TPU_V_ID', 			            'NUMBER(16,0)', 		        'Indica el tipo de publicación realizada para venta.'),
      	T_ALTER('DD_TPU_A_ID', 		                'NUMBER(16,0)', 		        'Indica el tipo de publicación realizada para alquiler.')
	);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
		...
		T_FK('FK_DD_TPU_V_ID_APU',              'DD_TPU_V_ID',              'DD_TPU_TIPO_PUBLICACION',                  'DD_TPU_ID'),
		T_FK('FK_DD_TPU_A_ID_APU',              'DD_TPU_A_ID',              'DD_TPU_TIPO_PUBLICACION',                  'DD_TPU_ID')
    );
    V_T_FK T_FK;
