...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene la información de permisos de funciones sobre los perfiles.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PERFGCCLIBERBANK',		 				'VARCHAR2(1 CHAR)',						'Perfil capa control Liberbank'	)
	);
    V_T_ALTER T_ALTER;
