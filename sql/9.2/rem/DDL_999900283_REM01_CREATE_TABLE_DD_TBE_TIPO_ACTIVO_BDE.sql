...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TPA_TIPO_ACTIVO_BDE.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_TBE_ID NUMBER(16,0) NOT NULL
				, DD_TBE_CODIGO NUMBER(5,0) NOT NULL
				, DD_TBE_DESCRIPCION VARCHAR2(50 CHAR) NOT NULL
				, DD_TBE_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT DD_TBE_ID_PK PRIMARY KEY (DD_TBE_ID)
				)
			  ';
