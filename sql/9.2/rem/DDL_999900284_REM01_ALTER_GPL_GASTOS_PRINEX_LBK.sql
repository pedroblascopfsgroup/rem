...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('GPL_DIARIO1_BASE', 'NUMBER(16,2)','', 'Diario 1 Base.'),
        T_TIPO_DATA('GPL_DIARIO1_TIPO', 'NUMBER(16,2)','', 'Diario 1 Tipo.'),
        T_TIPO_DATA('GPL_DIARIO1_CUOTA', 'NUMBER(16,2)','', 'Diario 1 Cuota.'),
        T_TIPO_DATA('GPL_DIARIO2_BASE', 'NUMBER(16,2)','', 'Diario 2 Base.'),
        T_TIPO_DATA('GPL_DIARIO2_TIPO', 'NUMBER(16,2)','', 'Diario 2 Tipo.'),
        T_TIPO_DATA('GPL_DIARIO2_CUOTA', 'NUMBER(16,2)','', 'Diario 2 Cuota.')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP      
		...
		IF V_NUM_TABLAS = 1 THEN
			...
			DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.'||V_TMP_TIPO_DATA(1)||'... Borrada'); 
