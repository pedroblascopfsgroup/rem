...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_SBE_SUBTIPO_ACTIVO_BDE.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_SBE_ID NUMBER(16,0) NOT NULL
				, DD_SBE_CODIGO NUMBER(5,0) NOT NULL
				, DD_SBE_DESCRIPCION VARCHAR2(50 CHAR) NOT NULL
				, DD_SBE_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT DD_SBE_ID_PK PRIMARY KEY (DD_SBE_ID)
				)
			  ';
