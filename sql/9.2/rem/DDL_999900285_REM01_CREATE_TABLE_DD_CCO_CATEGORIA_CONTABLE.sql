...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_CCO_CATEGORIA_CONTABLE.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'DD_CCO_CATEGORIA_CONTABLE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_CCO_ID NUMBER(16,0) NOT NULL
				, DD_CCO_CODIGO NUMBER(5,0) NOT NULL
				, DD_CCO_DESCRIPCION VARCHAR2(50 CHAR) NOT NULL
				...
				, CONSTRAINT DD_CCO_ID_PK PRIMARY KEY (DD_CCO_ID)
				)
			  ';
