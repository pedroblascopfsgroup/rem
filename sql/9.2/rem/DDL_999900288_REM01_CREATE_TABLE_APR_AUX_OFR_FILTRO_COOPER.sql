...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla APR_AUX_OFR_FILTRO_COOPER.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'APR_AUX_OFR_FILTRO_COOPER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
