...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla APR_AUX_TAS_FILTRO_COOPER.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'APR_AUX_TAS_FILTRO_COOPER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
						...
						,FEC_ULTIMA_TASACION          DATE             
						,IMPORTE_TASACION             NUMBER(16,2)     
				)
			  ';
