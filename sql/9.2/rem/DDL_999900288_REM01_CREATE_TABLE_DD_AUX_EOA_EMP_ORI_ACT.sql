...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_AUX_EOA_EMP_ORI_ACT.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_EOA_ID NUMBER(16,0) NOT NULL
				, DD_EOA_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_EOA_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_EOA_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_EOA_ID)
				)
			  ';
