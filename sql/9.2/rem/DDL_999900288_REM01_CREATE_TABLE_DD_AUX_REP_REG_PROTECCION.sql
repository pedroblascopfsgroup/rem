...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_AUX_REP_REG_PROTECCION.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_AUX_REP_ID NUMBER(16,0) NOT NULL
				, DD_AUX_REP_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_AUX_REP_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_AUX_REP_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_AUX_REP_ID)
				)
			  ';
