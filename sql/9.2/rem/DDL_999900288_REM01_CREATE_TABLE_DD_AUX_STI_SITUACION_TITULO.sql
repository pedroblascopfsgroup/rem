...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_AUX_STI_SITUACION_TITULO.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'DD_AUX_STI_SITUACION_TITULO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_AUX_STI_ID NUMBER(16,0) NOT NULL
				, DD_AUX_STI_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_AUX_STI_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_AUX_STI_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_AUX_STI_ID)
				)
			  ';
