...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_CEA_COD_ENTRADA_ACTIVO.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_CEA_ID NUMBER(16,0) NOT NULL
				, DD_CEA_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_CEA_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_CEA_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT DD_CEA_ID_PK PRIMARY KEY (DD_CEA_ID)
				)
			  ';
