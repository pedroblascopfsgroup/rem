...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_PTR_SIT_PATRIMONIAL.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_PTR_ID NUMBER(16,0) NOT NULL
				, DD_PTR_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_PTR_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_PTR_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT DD_PTR_ID_PK PRIMARY KEY (DD_PTR_ID)
				)
			  ';
