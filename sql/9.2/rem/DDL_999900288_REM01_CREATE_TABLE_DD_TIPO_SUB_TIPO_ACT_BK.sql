...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TIPO_SUB_TIPO_ACT_BK.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				  DD_TST_ACT_ID NUMBER(16,0) NOT NULL
				, DD_TST_ACT_CODIGO VARCHAR2(5 CHAR) NOT NULL
				, DD_TST_ACT_DESCRIPCION VARCHAR2(100 CHAR) NOT NULL
				, DD_TST_ACT_DESCRIPCION_LARGA VARCHAR2(250 CHAR) NOT NULL
				...
				, CONSTRAINT DD_TST_ACT_ID_PK PRIMARY KEY (DD_TST_ACT_ID)
				)
			  ';
