...
--## PRODUCTO=NO
--## Finalidad: DDL Creación de tabla AUX_MOT_OCULT_V
--##           
...
DECLARE
  ...
  V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'AUX_MOT_OCULT_V'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
