...
--## INCIDENCIA_LINK=REMVIP-2193
--## PRODUCTO=NO
--## Finalidad: Añadir columna ACT_PUJA en ACT_ACTIVO.
--##           
...
DECLARE
    ...
    V_TEXT_COLUMN_NAME VARCHAR2(40 CHAR) := 'ACT_PUJA';
...
BEGIN
	...
	IF V_NUM_TABLAS = 0 THEN
		...
		V_MSQL := 'ALTER TABLE '||V_TEXT_TABLA|| ' 
				   ADD ('||V_TEXT_COLUMN_NAME||' NUMBER(1,0) DEFAULT 0)
		';
		...
		-- Creamos comentario	
		V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.'||V_TEXT_COLUMN_NAME||' IS ''Indicador de si el activo está en puja(1) o no está en puja(0)''';		
		EXECUTE IMMEDIATE V_MSQL;
