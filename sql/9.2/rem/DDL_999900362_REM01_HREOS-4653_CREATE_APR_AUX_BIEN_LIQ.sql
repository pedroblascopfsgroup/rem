--/*
--##########################################
--## AUTOR=Miguel Angel Sánchez
--## FECHA_CREACION=20181022
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=RECOVERY-13445
--## PRODUCTO=NO
--## Finalidad: Tabla auxiliar para el aprovisionamiento de la información de las liquidaciones de recovery-HAYA.
--##           
...
BEGIN    
    ...
    V_MSQL := '
    SELECT COUNT(1) FROM ALL_TABLES WHERE TABLE_NAME = ''APR_AUX_BIEN_LIQ'' AND OWNER = '''||V_ESQUEMA||'''
    '
    ;
    ...
    IF V_NUM != 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO] LA TABLA APR_AUX_BIEN_LIQ YA EXISTE.');
        
        
        
    ELSE
    
        DBMS_OUTPUT.PUT_LINE('[INFO] LA TABLA APR_AUX_BIEN_LIQ NO EXISTE. SE CREARÁ.');
        
    

    EXECUTE IMMEDIATE '
    CREATE TABLE APR_AUX_BIEN_LIQ (
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] TABLA APR_AUX_BIEN_LIQ CREADA.');
  COMMIT;
  END IF;
