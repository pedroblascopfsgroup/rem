...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla de Ofertas con campo DD_EAL_ID.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_EAL_ID',							'NUMBER(16,0)',					'Código identificador único del diccionario de estado alquiler'),
		T_ALTER(  'DD_TPI_ID',							'NUMBER(16,0)',					'Código identificador único del diccionario de tipo inquilino'),
		T_ALTER(  'CHECK_SUBROGADO',					'NUMBER(1,0)',					'Incida si tiene el check Subrogado')
		);
    V_T_ALTER T_ALTER;
