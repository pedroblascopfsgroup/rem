...
--## FECHA_CREACION=20181221
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.1
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos de los adjuntos de la oferta
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ADC_ID_DOCUMENTO_REST',		 			'NUMBER(16,0)',						'Id devuelto por el gestor documental al subir un adjunto.'	)
		);
    V_T_ALTER T_ALTER;
