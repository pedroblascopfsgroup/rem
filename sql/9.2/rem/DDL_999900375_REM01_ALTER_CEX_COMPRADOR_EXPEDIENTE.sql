...
--##########################################
--## AUTOR=Stefany Morón
--## FECHA_CREACION=20181224
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HEROS-4933
--## PRODUCTO=NO
--## Finalidad: AÑADIR NUEVAS COLUMNAS QUE ADEMAS ES UNA FK DE OTRA TABLA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ADCOM_ID',		 				'NUMBER(16,0)',						'Documento'	)
		);
    V_T_ALTER T_ALTER;
    
    
      /* TABLA: CEX_COMPRADOR_EXPEDIENTE -- ARRAY CON NUEVAS FOREIGN KEYS */
    TYPE T_FK IS TABLE OF VARCHAR2(4000);
    TYPE T_ARRAY_FK IS TABLE OF T_FK;
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    			--NOMBRE FK 							CAMPO FK 				TABLA DESTINO FK 							CAMPO DESTINO FK
    	T_FK(	'FK_CEX_ADCOM_ID',				'ADCOM_ID',	V_ESQUEMA||'.ADC_ADJUNTO_COMPRADOR',					'ADCOM_ID'			)
    );
    V_T_FK T_FK;
