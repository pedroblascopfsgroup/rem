...
--## INCIDENCIA_LINK=HEROS-5217
--## PRODUCTO=NO
--## Finalidad: AÑADIR NUEVAS COLUMNAS OFR_TIA_TITULARES_ADICIONALES
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('TIA_RECHAZAR_PUBLI', 'NUMBER','(1)'),
        T_TIPO_DATA('TIA_RECHAZAR_PROPI', 'NUMBER','(1)'),
        T_TIPO_DATA('TIA_RECHAZAR_PROVE', 'NUMBER','(1)')
    ); 
