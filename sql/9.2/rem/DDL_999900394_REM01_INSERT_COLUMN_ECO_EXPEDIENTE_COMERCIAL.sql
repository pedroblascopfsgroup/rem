...
--## PRODUCTO=NO
--## Finalidad: Columna nueva en ECO_EXPEDIENTE_COMERCIAL
--##           
--## INSTRUCCIONES: Inserta la columna DD_TAL_ID en la tabla ECO_EXPEDIENTE_COMERCIAL
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(2400 CHAR) := 'DD_TAL_ID'; -- Vble. auxiliar para almacenar el nombre de la columna a añadir.
    ...
    T_FK(''||V_ESQUEMA||'', ''||V_TEXT_TABLA||''   ,'DD_TAL_ID'       ,''||V_ESQUEMA||''    ,'DD_TAL_TIPO_ALQUILER'    ,'DD_TAL_ID'         ,'FK_DD_TAL_ID')
  );      
  V_TMP_FK T_FK;
