...
--## PRODUCTO=NO
--## 
--## Finalidad: Alter tabla de SRE_SEGURO_RENTAS
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_TABLA VARCHAR2(50 CHAR):= 'SRE_SEGURO_RENTAS'; -- Nombre de la tabla a crear
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
  	  ...
  	  T_COL(''||V_ESQUEMA||'', ''||V_TABLA||''        , 'COMENTARIOS'     		, 'VARCHAR(200)'  )
