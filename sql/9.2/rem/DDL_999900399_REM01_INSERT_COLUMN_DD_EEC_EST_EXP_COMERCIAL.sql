...
--## PRODUCTO=NO
--## Finalidad: Columna nueva en DD_EEC_EST_EXP_COMERCIAL
--##           
--## INSTRUCCIONES: Inserta la columna DD_EEC_VENTA en la tabla DD_EEC_EST_EXP_COMERCIAL
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
BEGIN
    ...
    ELSE
      ...
      V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.'||V_COLUMN_NAME||' IS ''Campo que indica si el estado del expediente comercia es de tipo venta o de tipo alquiler.'' ';      
      EXECUTE IMMEDIATE V_MSQL;
      DBMS_OUTPUT.PUT_LINE('[INFO] ''Comentario añadido''');
    END IF;
