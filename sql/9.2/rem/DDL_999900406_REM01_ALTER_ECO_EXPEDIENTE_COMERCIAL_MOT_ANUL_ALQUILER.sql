...
--## INCIDENCIA_LINK=HREOS-4826
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene la información de un expediente comercial con diccionario motivo anulacion OFERTA(es el que se usa en tipo alquiler)
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MAO_ID',		 				'NUMBER(16,0)',						'Motivo de anulación del expediente de tipo alquiler.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ECO_MOTIVO_ANUL_OFR',				'DD_MAO_ID',				V_ESQUEMA||'.DD_MAO_MOTIVO_ANULACION_OFR',			'DD_MAO_ID'			)
    );
    V_T_FK T_FK;
