...
--## PRODUCTO=NO
--## Finalidad: Añadir columna DD_EEC_VENTA en DD_EEC_EST_EXP_COMERCIAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_EEC_ALQUILER',			'NUMBER(1,0)',		'Campo que indica si el estado del expediente comercial es de tipo alquiler.')
...
BEGIN
	...
	LOOP
		...
		ELSE
			DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe la columna.');
		END IF;
