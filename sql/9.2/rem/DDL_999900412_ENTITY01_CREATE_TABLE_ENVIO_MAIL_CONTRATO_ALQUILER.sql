...
--## 
--## Finalidad: DDL
--## INSTRUCCIONES: Crear tabla para mandar correos ENVIO_MAIL_CONTRATO_ALQUILER
--## VERSIONES:
--##        0.1 Versión inicial 
--##########################################
--*/
...
DECLARE
    ...
    V_TABLA VARCHAR2(32 CHAR) := 'ENVIO_MAIL_CONTRATO_ALQUILER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
