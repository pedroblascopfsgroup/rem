...
--## PRODUCTO=NO
--## Finalidad: Columna nueva en CLC_CLIENTE_COMERCIAL
--##           
--## INSTRUCCIONES: Inserta la columna CLC_ID_PERSONA_HAYA en la tabla CLC_CLIENTE_COMERCIAL
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(2400 CHAR) := 'CLC_ID_PERSONA_HAYA'; -- Vble. auxiliar para almacenar el nombre de la columna a añadir.
