...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla auxiliar para ETL apr_main_actualiza_estado_publicacion
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_ACTUALIZA_ESTADO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
