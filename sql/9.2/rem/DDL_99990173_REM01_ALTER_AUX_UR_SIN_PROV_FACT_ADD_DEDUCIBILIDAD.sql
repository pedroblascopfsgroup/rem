...
--##########################################
--## AUTOR=GUSTAVO MORA
--## FECHA_CREACION=20171004
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-2862
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas TIPO_DEDUCIBILIDAD y PORCENTAJE_DEDUCIBILIDAD en APR_AUX_I_UR_FACT_SIN_PROV
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_I_UR_FACT_SIN_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
          ...
          T_ALTER(  'FECHA_PAGO_NO_REAL_FACTU',     'DATE ',                      'Fecha de pago no real de la factura.'      )
    	, T_ALTER(  'TIPO_DEDUCIBILIDAD',		  'VARCHAR2(1 CHAR) ',		'Tipo de deducibilidad a aplicar en factura. Valores posibles: -'''' NO APLICA ''''1'''' - PRORRATA GENERAL ''''2'''' - 0%  ''''3'''' - 100 % ''''4'''' - % DEDUCIBILIDAD'	)
        , T_ALTER(  'PORCENTAJE_DEDUCIBILIDAD',           'NUMBER(6,3) ',               'Porcentaje de deducibilidad de factura.'      )
	);
	V_T_ALTER T_ALTER;
