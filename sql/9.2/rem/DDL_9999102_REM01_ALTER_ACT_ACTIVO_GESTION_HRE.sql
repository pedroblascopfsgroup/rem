...
--## INCIDENCIA_LINK=HREOS-2085
--## PRODUCTO=NO
--## Finalidad: Modificar comentario del campo ACT_GESTION_HRE para indicar que esta deprecated
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'ACT_GESTION_HRE',		 	'NUMBER(1) DEFAULT 0',			'Indicador control de gestión por Haya. (Deprecated)'			) --1
...
BEGIN
	...
	-- Bucle que recorre las columnas a cambiar el campo
	...
	LOOP
		...
		IF V_NUM_TABLAS > 0 THEN
			--Existe la columna y cambiamos el comentario
			-- Creamos comentario	
