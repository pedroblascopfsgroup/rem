...
--## PRODUCTO=NO
--## Finalidad: Añadimos a la tabla TRF_TRF_PRC_HONORARIOS el campo CODIGO DE PERSONA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(100 CHAR) := 'TRF_TRF_PRC_HONORARIOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COL_TO_INSERT VARCHAR2(100 CHAR) := 'DD_TPE_CODIGO'; -- Vble. auxiliar para almacenar el nombre de la columna a insertar.
