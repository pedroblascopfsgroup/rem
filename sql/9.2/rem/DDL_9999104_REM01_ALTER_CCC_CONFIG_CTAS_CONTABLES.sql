...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CCC_CUENTA_ANYO_CURSO',			'VARCHAR2(50 CHAR)',		'Cuenta contable para el año en curso.'	),
    	T_ALTER(  'CCC_CUENTA_ANYOS_ANTERIORES',	'VARCHAR2(50 CHAR)',		'Cuenta contable para años anteriores.'	)
	);
	V_T_ALTER T_ALTER;
