...
--## INCIDENCIA_LINK=HREOS-2031
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas CEX_FECHA_BAJA,DD_TGP_ID en CEX_COMPRADOR_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TGP_ID',			'NUMBER(1,0)',		'Tipo de Grado de Propiedad.'	),
    	T_ALTER(  'CEX_FECHA_BAJA',			'DATE',		'Fecha de baja.'	)
