...
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas DD_PAI_ID y DD_PAI_ID_RTE en CEX_COMPRADOR_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_PAI_ID',			'NUMBER(3,0)',		'Pais.'	),
    	T_ALTER(  'DD_PAI_ID_RTE',			'NUMBER(3,0)',		'Pais del representante.'	)
