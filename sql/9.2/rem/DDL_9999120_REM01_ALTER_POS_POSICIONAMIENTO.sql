...
--## INCIDENCIA_LINK=HREOS-2073
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas POS_FECHA_FIN_POSICIONAMIENTO en POS_POSICIONAMIENTO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'POS_FECHA_FIN_POSICIONAMIENTO',			'DATE',		'Fecha Fin de Posicionamiento'	)
