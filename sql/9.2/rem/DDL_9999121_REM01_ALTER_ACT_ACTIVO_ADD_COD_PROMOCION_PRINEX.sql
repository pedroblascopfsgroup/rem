...
--## INCIDENCIA_LINK=HREOS-2716
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas ACT_COD_PROMOCION_PRINEX en ACT_ACTIVO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_COD_PROMOCION_PRINEX',			'VARCHAR2(50 CHAR)',		'Código de promoción PRINEX'	)
