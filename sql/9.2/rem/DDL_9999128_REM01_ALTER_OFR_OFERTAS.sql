...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MRO_ID',		 				'NUMBER(16,0)',						'Motivo anulacion/denegacion de la oferta.'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_MRO_MOTIVO_RECHAZO_OFR',				'DD_MRO_ID',		V_ESQUEMA||'.DD_MRO_MOTIVO_RECHAZO_OFERTA',					'DD_MRO_ID'			)
    );
    V_T_FK T_FK;
