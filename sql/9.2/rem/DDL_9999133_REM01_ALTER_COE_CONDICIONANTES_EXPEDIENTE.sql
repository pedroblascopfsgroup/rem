...
--## PRODUCTO=NO
--## Finalidad: Añadir dos nuevas nuevas columnas en la tabla COE_CONDICIONANTES_EXPEDIENTE.
--##           
...
DECLARE
    ...
    --				NOMBRE								TIPO				COMENTARIO
        T_TIPO_DATA('COE_OPERACION_EXENTA', 			'NUMBER(1,0)', 		'Indica si la operación está exenta del tipo aplicable.'),
      	T_TIPO_DATA('COE_INVERSION_SUJETO_PASIVO', 		'NUMBER(1,0)', 		'Indica si el tipo de inversión de sujeto es pasivo.')
    ); 
