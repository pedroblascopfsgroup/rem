...
--## INCIDENCIA_LINK=HREOS-3231
--## PRODUCTO=NO
--## Finalidad: cambiar comentario
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ACT_VENTA_DIRECTA_BANKIA', 'NUMBER','(1,0) DEFAULT 0 NOT NULL', 'Indicador de venta con ausencia de servicios web Bankia.')
    ); 
