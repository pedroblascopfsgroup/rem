...
DECLARE
    ...
    V_EXISTS NUMBER(1);
    V_TABLA VARCHAR2(30 CHAR) := 'APR_AUX_UPDATE_ACTIVOS_SAREB';
    ...
    C_CAMPOS T_ARRAY_CAMPOS := T_ARRAY_CAMPOS(
        T_CAMPOS('BIE_ADJ_F_SOL_POSESION','DATE'),
        T_CAMPOS('BIE_ADJ_F_SEN_POSESION','DATE'),
        T_CAMPOS('BIE_ADJ_F_REA_POSESION','DATE'),
        T_CAMPOS('BIE_ADJ_LANZAMIENTO_NECES','NUMBER(1)'),
        T_CAMPOS('BIE_ADJ_F_SOL_MORATORIA','DATE'),
        T_CAMPOS('DD_FAV_CODIGO','VARCHAR2(20 CHAR)'),
        T_CAMPOS('BIE_ADJ_F_RES_MORATORIA','DATE')
    );
