...
--##########################################
--## AUTOR=DAP
--## FECHA_CREACION=20170502
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=2.0.12
--## INCIDENCIA_LINK=HREOS-3811
--## PRODUCTO=NO
...
DECLARE
    ...
    C_CAMPOS T_ARRAY_CAMPOS := T_ARRAY_CAMPOS(
        T_CAMPOS('OFR_OFERTA_EXPRESS','NUMBER(1,0) DEFAULT (0)'),
        T_CAMPOS('OFR_NECESITA_FINANCIACION','NUMBER(1,0) DEFAULT (0)'),
        T_CAMPOS('OFR_OBSERVACIONES','VARCHAR2(1000 CHAR)')
    );
