...
--## PRODUCTO=SI
--## Finalidad: DDL añade columna a la tabla ACT_CFT_CONFIG_TARIFA
--##           
...
DECLARE
    ...
    V_EXISTS NUMBER(1);
    V_TABLA VARCHAR2(30 CHAR) := 'ACT_CFT_CONFIG_TARIFA';
    ...
    IF V_EXISTS = 1 THEN
        ...
        LOOP
            ...
            IF V_EXISTS = 0 THEN
				...
				V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT FK_PVE_ID FOREIGN KEY (PVE_ID) REFERENCES '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR (PVE_ID) ON DELETE SET NULL)';
				EXECUTE IMMEDIATE V_MSQL;
