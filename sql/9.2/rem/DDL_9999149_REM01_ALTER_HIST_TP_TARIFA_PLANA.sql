...
--##########################################
--## AUTOR=Isidro Sotoca
--## FECHA_CREACION=20171116
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-3913
--## PRODUCTO=SI
--## Finalidad: DDL añade columna a la tabla HIST_TP_TARIFA_PLANA
--##           
...
DECLARE
    ...
    V_EXISTS NUMBER(1);
    V_TABLA VARCHAR2(30 CHAR) := 'HIST_TP_TARIFA_PLANA';
    ...
    C_CAMPOS T_ARRAY_CAMPOS := T_ARRAY_CAMPOS(
        T_CAMPOS('STR_FECHA_FIN_TP','DATE')
    );
