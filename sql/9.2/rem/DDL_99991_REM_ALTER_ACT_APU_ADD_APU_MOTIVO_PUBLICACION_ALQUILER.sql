...
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=?
--## INCIDENCIA_LINK=HREOS-5893
--## PRODUCTO=NO
--## Finalidad: DDL para añadir la columna APU_MOTIVO_PUBLICACION_ALQ a la tabla ACT_APU
--##           
...
DECLARE
	...
	V_COLUMN VARCHAR2(4000 CHAR) := 'APU_MOTIVO_PUBLICACION_ALQ';
...
BEGIN
	...
	ELSE
        ...
        ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||'
            ...
            ADD     APU_MOTIVO_PUBLICACION_ALQ		VARCHAR2(1500 CHAR)
