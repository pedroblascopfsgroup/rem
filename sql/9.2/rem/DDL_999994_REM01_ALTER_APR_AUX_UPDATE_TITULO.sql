...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_UPDATE_TITULO'; 
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('TIT_FECHA_ENTREGA_GESTORIA','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_PRESEN_HACIENDA','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_PRESEN1_REG','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_ENVIO_AUTO','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_PRESEN2_REG','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_RETIRADA_REG','VARCHAR2(50 CHAR)'),
        T_TIPO_DATA('TIT_FECHA_NOTA_SIMPLE','VARCHAR2(50 CHAR)')
    ); 
