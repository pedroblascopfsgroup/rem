...
--## INCIDENCIA_LINK=HREOS-4360
--## PRODUCTO=NO
--## Finalidad: añadir 2 llaves ajenas de los diccionarios de DD_TAL_TIPO_ALQUILER y DD_TPI_TIPO_INQUILINO y otras 2 columnas
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TPI_ID',		 					'NUMBER(16,0)',					'Tipo de inquilino'),
    	T_ALTER(  'OFR_CONTRATO_PRINEX',		 		'VARCHAR2(20 CHAR)',			'Num. Contrato Prinex'),
    	T_ALTER(  'OFR_REF_CIRCUITO_CLIENTE',		 	'VARCHAR2(20 CHAR)',			'Ref. Circuito Cliente')
	);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
		...
		T_FK(  'FK_DD_TAL',			'DD_TAL_ID',		V_ESQUEMA||'.DD_TAL_TIPO_ALQUILER',		'DD_TAL_ID'),
		T_FK(  'FK_DD_TPI',			'DD_TPI_ID',		V_ESQUEMA||'.DD_TPI_TIPO_INQUILINO',	'DD_TPI_ID')
    );
    V_T_FK T_FK;
