...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
			T_TIPO_DATA('PAC_CHECK_PUBLICAR', 'NUMBER','(1)', 'Indicador si aplica Publicar'),
			T_TIPO_DATA('PAC_FECHA_PUBLICAR', 'DATE','', 'Fecha de inclusión/exclusión de Publicar.'),
			T_TIPO_DATA('PAC_MOTIVO_PUBLICAR', 'VARCHAR2','(255 CHAR)', 'Motivo de inclusión/exclusión de Publicar')
    ); 
