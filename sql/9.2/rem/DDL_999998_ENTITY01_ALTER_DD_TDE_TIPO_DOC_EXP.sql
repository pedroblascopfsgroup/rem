...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene la información de un expediente comercial con diccionario motivo anulacion
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TOF_ID',		 				'NUMBER(16,0)',						'Tipo de oferta')
    	);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_TOF_TIPOS_OFERTA',				'DD_TOF_ID',				V_ESQUEMA||'.DD_TOF_TIPOS_OFERTA',				'DD_TOF_ID'		)
    );
    V_T_FK T_FK;
