...
--## PRODUCTO=NO
--## Finalidad: Tabla para crear histórico de resgistro de las llamadas REST que hacemos desde REM
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'RST_HIST_LLAMADA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= ' Histórico de Registro de peticiones REST.'; -- Vble. para los comentarios de las tablas
...
BEGIN
	...
	(
		...
		RST_REFRESCO_TIME						NUMBER(16)					NULL,
