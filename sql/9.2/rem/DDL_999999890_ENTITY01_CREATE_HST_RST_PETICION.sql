...
--## INCIDENCIA_LINK=HREOS-4935
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el histórico de LOS OPERADORES DE LA REST API DE REM
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'RST_HIST_PETICION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
	...
	(
		...
		RST_PETICION_TOKEN				        VARCHAR2(100 CHAR) 			NULL,	
		...
		RST_PETICION_SIGNATURE					VARCHAR2(50 CHAR)			NULL,
		RST_PETICION_RESPONSE					CLOB						NULL,
		RST_PETICION_TIME						NUMBER(16,0)				NULL,
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_RST_HIST_BROKER_ID FOREIGN KEY  (RST_BROKER_ID) REFERENCES '||V_ESQUEMA||'.RST_BROKER (RST_BROKER_ID) ON DELETE SET NULL)';
	EXECUTE IMMEDIATE V_MSQL;
