...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TDI_ID_CONYUGE',		 					'NUMBER(16,0)',						'Tipo documento del conyuge.')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CEX_TDI_ID_CONYUGE',						'DD_TDI_ID_CONYUGE',				V_ESQUEMA||'.DD_TDI_TIPO_DOCUMENTO_ID',				'DD_TDI_ID'			)
    );
    V_T_FK T_FK;
