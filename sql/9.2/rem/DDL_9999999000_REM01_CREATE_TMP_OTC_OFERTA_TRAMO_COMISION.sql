...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'TMP_OTC_OFERTA_TRAMO_COMISION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Relación de la oferta y el tramo de la comisión'; -- Vble. para los comentarios de las tablas	
