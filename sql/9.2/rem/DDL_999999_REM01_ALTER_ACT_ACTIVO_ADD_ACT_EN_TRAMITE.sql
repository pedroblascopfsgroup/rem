...
--## INCIDENCIA_LINK=HREOS-4332
--## PRODUCTO=NO
--## Finalidad: Anyadir columna ACT_EN_TRAMITE en ACT_ACTIVO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_EN_TRAMITE',			'NUMBER(1,0) DEFAULT 0',		' Campo que indica si el activo se encuentra en el estado En trámite'	)
