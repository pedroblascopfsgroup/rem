...
--## PRODUCTO=NO
--## Finalidad: Columna nueva en SCO_SCORING
--##           
--## INSTRUCCIONES: Inserta la columna ECO_ID en la tabla SCO_SCORING
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    T_FK(''||V_ESQUEMA||'', ''||V_TEXT_TABLA||''   ,'ECO_ID'       ,''||V_ESQUEMA||''    ,'ECO_EXPEDIENTE_COMERCIAL'    ,'ECO_ID'         ,'FK_SCO_ECO_ID')
  );      
  V_TMP_FK T_FK;
