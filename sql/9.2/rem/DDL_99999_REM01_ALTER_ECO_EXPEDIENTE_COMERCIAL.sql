...
--## INCIDENCIA_LINK=HREOS-6727
--## PRODUCTO=NO
--## Finalidad: Agregado de columna ECO_FECHA_ENVIO_ADVISORY_NOTE en ECO_EXPEDIENTE_COMERCIAL
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
			T_TIPO_DATA('ECO_FECHA_ENVIO_ADVISORY_NOTE', 'DATE', 'Fecha de envio de Advisory Note, para el tramite comercial Apple')
    ); 
