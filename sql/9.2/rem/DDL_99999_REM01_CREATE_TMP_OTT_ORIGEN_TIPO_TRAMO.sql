...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'TMP_OTT_ORIGEN_TIPO_TRAMO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	  V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Relación con la oferta y el origen del comprador'; -- Vble. para los comentarios de las tablas	
