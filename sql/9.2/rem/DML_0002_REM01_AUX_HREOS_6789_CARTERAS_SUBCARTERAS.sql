...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'AUX_HREOS_6789_CARTERA_SUBCARTERA';
...
V_MSQL := '
    INSERT INTO '||V_ESQUEMA||'.AUX_HREOS_6789
    (ACT_ID,GEE_CUR,USU_ID_GEE, CRA_CARTERA, SCR_SUBCARTERA)
    SELECT ACT.ACT_ID, GEE.GEE_ID, GEE.USU_ID, CRA.DD_CRA_ID, SCR.DD_SCR_ID
    ...
    WHERE CRA.DD_CRA_CODIGO IN (''11'', ''13'')
    AND SCR.DD_SCR_CODIGO IN (''28'', ''30'', ''41'')
...
V_MSQL := '
    ...
    WHERE CRA.DD_CRA_CODIGO IN (''11'', ''13'')
    OR SCR.DD_SCR_CODIGO IN (''28'', ''30'', ''41'')
    AND DD_TGE_CODIGO = ''HAYAGBOINM''
