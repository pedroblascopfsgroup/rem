...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ECV_ESTADOS_CIVILES_URSUS los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ECV_ESTADOS_CIVILES_URSUS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
					...
					', USUARIOMODIFICAR = ''HREOS-6640'' , FECHAMODIFICAR = SYSDATE '||
