...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      ...
      V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE TIPO_GESTOR = '''||TRIM(V_TMP_TIPO_DATA(1))||'''AND COD_CARTERA = '''||TRIM(V_TMP_TIPO_DATA(2))||''' AND USERNAME = '''||TRIM(V_TMP_TIPO_DATA(8))||''' 
