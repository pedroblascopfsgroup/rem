...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('16', 'Divarian', 'Divarian')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN                                
          ...
          V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_CRA_CARTERA '||
                    'SET DD_CRA_DESCRIPCION = '''||TRIM(V_TMP_TIPO_DATA(2))||'''
                            , DD_CRA_DESCRIPCION_LARGA = '''||TRIM(V_TMP_TIPO_DATA(3))||'''
                            , USUARIOMODIFICAR = ''HREOS-7494'' , FECHAMODIFICAR = SYSDATE 
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_CRA_CARTERA (' ||
                      ...
                      'SELECT '|| V_ESQUEMA ||'.S_DD_CRA_CARTERA.NEXTVAL DD_CRA_ID, '''||V_TMP_TIPO_DATA(1)||''', '''||TRIM(V_TMP_TIPO_DATA(2))||''', '''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-7494'', SYSDATE, 0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
