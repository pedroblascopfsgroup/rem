...
DECLARE
    ...
    --				Descripción Larga																			Descripción
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para agrupar activos de tipo promoción alquiler.', 'MASIVO_AGRUPAR_ACTIVOS_PROMOCION_ALQUILER')
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-5774'',SYSDATE,0 FROM DUAL';
