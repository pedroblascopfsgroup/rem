...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_MDT_MOTIVO_DEVOLUCION_TBJ los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_MDT_MOTIVO_DEVOLUCION_TBJ';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_MDT_MOTIVO_DEVOLUCION_TBJ';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7610'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'MDT';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('DOC_INCORRECTA', 'Documentación justificativa incorrecta', 'Documentación justificativa incorrecta'),
        T_TIPO_DATA('DOC_INCOMPLETA', 'Documentación justificativa incompleta', 'Documentación justificativa incompleta'),
        T_TIPO_DATA('TBJ_INCORRECTO', 'Incorrecta ejecución de los trabajos', 'Incorrecta ejecución de los trabajos')
