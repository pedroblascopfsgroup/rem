...
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=2.19.0
--## INCIDENCIA_LINK=HREOS-7988
--## PRODUCTO=NO
--##
--## Finalidad: Deshacer el cambio del script DML_020_REM01_UPDATE_TRAMITE_COMERCIAL_VENTA.sql
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(1024 CHAR):= 'HREOS-7988';

	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(4000);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(      
        T_TIPO_DATA('T013_ResolucionExpediente')
    ); 
