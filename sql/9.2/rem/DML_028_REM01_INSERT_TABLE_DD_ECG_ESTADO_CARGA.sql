...
--## INCIDENCIA_LINK=HREOS-7790
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ECG_ESTADO_CARGA los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_ECG_ESTADO_CARGA';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_ECG_ESTADO_CARGA';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7790'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'ECG';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('02', 'No requiere gestión', 'No requiere gestión'),
        T_TIPO_DATA('03', 'Cancelada', 'Cancelada'),
        T_TIPO_DATA('04', 'Caducada', 'Caducada')       	    
    ); 
