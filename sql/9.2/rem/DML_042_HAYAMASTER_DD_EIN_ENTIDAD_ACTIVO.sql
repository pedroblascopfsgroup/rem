...
-- */
V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA_M||'.'||V_DDNAME||' WHERE DD_EIN_CODIGO= ''61''';

EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;

IF V_NUM_TABLAS > 0 THEN    
  DBMS_OUTPUT.PUT_LINE('OK no se modifica nada.');
  DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe el registro "Activo" en el diccionario '||V_DDNAME||'.');
...
ELSE
  ...
  '('||V_ESQUEMA_M||'.S_DD_EIN_ENT_INFO.nextval,''61'',''Activo'',''Tareas de Activo'',''0'',''DML'',sysdate,''0'') ';
