...
--## INCIDENCIA_LINK=HREOS-5502
--## PRODUCTO=NO
--##
--## Finalidad: Añadir un supervisor a las tareas gencat de la TAP_TAREA_PROCEDIMIENTO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(1024 CHAR):= 'HREOS-5502';
