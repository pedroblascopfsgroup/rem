...
*/
    ...
    --                            TAP_CODIGO                    TFI_NOMBRE 
      T_TFI_DELETE(' ''T002_ValidacionActuacion'' ',    ' ''DOCU'' '),
    ...
    --       TAP_CODIGO                TFI_ORDEN  TFI_TIPO       TFI_NOMBRE       TFI_LABEL                                                                                                                                                                   TFI_ERROR_VALIDACION                      TFI_VALIDACION                  TFI_BUSINESS_OPERATION
        ...
        T_TFI('T002_ObtencionDocumentoGestoria'            ,'2'        ,'textfield','fecha'                ,'Motivo de no obtención'                                                                                                                                                                                                                                                                                                        ,'Debe indicar la fecha de autorizaci&oacute;n'                 ,'false'                                        ,''                 ),
