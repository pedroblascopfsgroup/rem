...
BEGIN	
 ...
 DBMS_OUTPUT.PUT_LINE('[INICIO] ');
	V_SQL:= 'SELECT COUNT(1) FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = ''pgarciafraile''';
	EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;  
	IF V_NUM_TABLAS > 0 THEN
		V_SQL := 'UPDATE '||V_ESQUEMA_M||'.USU_USUARIOS SET USU_NOMBRE = ''Pablo'' ,USU_APELLIDO1 = ''García'', USU_APELLIDO2 = ''Fraile'' WHERE USU_USERNAME = ''pgarciafraile''';
