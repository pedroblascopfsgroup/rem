...
BEGIN	
    ...
    -- Comprobamos si existen las tabla   
	...
	EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
        ...
        IF V_NUM_TABLAS = 1 THEN 	
            ...
            V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (TFP_ID, TFP_ORIGEN, TFP_DESTINO, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
                SELECT S_'||V_TABLA||'.NEXTVAL, C1.DD_SFP_CODIGO, C2.DD_SFP_CODIGO, 0, '''|| V_USUARIO_CREAR ||''', SYSDATE, 0
