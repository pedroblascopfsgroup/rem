...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('MASIVO_ADECUACION'                         , 'HAYAGESACT'),
        T_FUNCION('SUBIR_LISTA_ACTIVOS_IBI'                   , 'HAYAGESACT'),
        T_FUNCION('ALTA_ACTIVOS_THIRD_PARTY'                  , 'HAYAGESACT'),
        T_FUNCION('MASIVO_PLUSVALIA'                          , 'HAYAGESACT'),
        T_FUNCION('PERIMETRO_ACTUALIZAR'                      , 'HAYAGESACT'),
        T_FUNCION('MASIVO_PROYECTO'                           , 'HAYAGESACT'),
        T_FUNCION('SUBIR_CARGA_GESTORES'                      , 'HAYAGESACT'),
        T_FUNCION('MASIVO_OK_TECNICO'                         , 'HAYAGESACT')
