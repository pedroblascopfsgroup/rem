...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ELO_ESTADO_LOCALIZACION los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_ELO_ESTADO_LOCALIZACION';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_ELO_ESTADO_LOCALIZACION';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7817'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'ELO';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('PDTE', 'Pendiente de identificar', 'Pendiente de identificar'),
        T_TIPO_DATA('IDENT', 'Identificada', 'Identificada'),
        T_TIPO_DATA('NOE', 'No existe Comunidad de Propietarios', 'No existe Comunidad de Propietarios')
