...
--## PRODUCTO=NO
--##
--## Finalidad:	Añade en la tabla PEF_PERFILES un nuevo perfil
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA( 		
    ...
    T_TIPO_DATA('AUTOTRAMOFR','Autorizador tramitación oferta', 'Autorizador tramitación oferta')
  ); 
...
BEGIN	
  ...
  IF V_NUM_TABLAS = 1 THEN 
    ...
    LOOP
      ...
      WHERE PEF_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' 
      AND BORRADO = 0';
      ...
      IF V_NUM_LINES = 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO]: INSERT CORRECTO PARA PEF: '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
      ELSE
