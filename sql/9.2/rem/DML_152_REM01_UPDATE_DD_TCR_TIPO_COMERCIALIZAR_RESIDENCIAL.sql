...
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_TCR_TIPO_COMERCIALIZAR';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_TCR_TIPO_COMERCIALIZAR';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7398'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'TCR';
    
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('02'  ,'Residencial'   ,'Residencial')
    ); 
