...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EQG_EQUIPO_GESTION los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_EQG_EQUIPO_GESTION';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_EQG_EQUIPO_GESTION';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7397'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'EQG';
    
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('01', 'Mayorista', 'Mayorista'),
	    T_TIPO_DATA('02', 'Minorista','Minorista')
    ); 
