...
--## INCIDENCIA_LINK=HREOS-7641
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TDU_TIPO_DOC_PLUSVALIAS los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_TDU_TIPO_DOC_PLUSVALIAS';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_TDU_TIPO_DOC_PLUSVALIAS';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7641'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'TDU';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('01',
        'Impuesto: Plusvalía (IIVTNU) compra (Justificante de pago)',
        'Impuesto: Plusvalía (IIVTNU) compra (Justificante de pago)',
        'OP-34-CERA-86'),

        T_TIPO_DATA('02', 
        'Impuesto: Plusvalía (IIVTNU) compra (Recibo)', 
        'Impuesto: Plusvalía (IIVTNU) compra (Recibo)', 
        'OP-34-FACT-31')
    ); 
