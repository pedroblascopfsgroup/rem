...
--## INCIDENCIA_LINK=HREOS-7778
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_CIS_COMITE_INTERNO_SAN los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_CIS_COMITE_INTERNO_SAN';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_CIS_COMITE_INTERNO_SAN';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7778'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'CIS';
...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_CIS_COMITE_INTERNO_SAN -----------------------------------------------------------------
