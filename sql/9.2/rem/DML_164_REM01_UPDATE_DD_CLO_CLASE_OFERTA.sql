...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_CLO_CLASE_OFERTA los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_CLO_CLASE_OFERTA';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7778'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'CLO';
...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_CLO_CLASE_OFERTA -----------------------------------------------------------------
