...
DECLARE
    ...
    --			Descripción														                            Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para excluir el activo del data warehouse.', 'MASIVO_EXCLUIR_ACTIVOS_DWH')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''REMVIP-2793'',SYSDATE,0 FROM DUAL';
