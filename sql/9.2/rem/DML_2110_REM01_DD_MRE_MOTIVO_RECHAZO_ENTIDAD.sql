...
DECLARE
	...
	T_TIPO_DATA('T01','Formato incorrecto: Error tamaño','0',' '),
        ...
        T_TIPO_DATA('F08','ID_ACTIVO no es un valor del DD - ACT_ACTIVO','1','WHERE NOT EXISTS (SELECT * FROM ACT_ACTIVO ACT WHERE ACT.ACT_ID = AUX.ID_ACTIVO)')
    ); 
