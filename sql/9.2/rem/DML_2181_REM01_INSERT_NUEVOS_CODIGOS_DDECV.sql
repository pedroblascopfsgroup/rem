...
DECLARE
    ...
    --              DICCIONARIO                       CAMPO                  CODIGO   DESCRIPCION                                         DESCRIPCION_LARGA
        T_TIPO_DATA('DD_ECV_ESTADO_CONSERVACION'      ,'DD_ECV_CODIGO'       ,'05'    ,'Muy malo'                                          ,'Muy malo'                                    )
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TMP_TIPO_DATA(1)||' (' ||
                      'DD_ECV_ID, '||V_TMP_TIPO_DATA(2)||', DD_ECV_DESCRIPCION, DD_ECV_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
