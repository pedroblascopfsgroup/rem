...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva Reclamaciones Plusvalías.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Reclamaciones plusvalías', 'MASIVO_RECLAMACIONES_PLUSVALIAS')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-6822'',SYSDATE,0 FROM DUAL';
