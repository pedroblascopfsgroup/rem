...
--## INCIDENCIA_LINK=HREOS-8400
--## PRODUCTO=NO
--##
--## Finalidad: Script que updatea en DD_DRT_DIRECCION_TERRITORIAL los datos añadidos en T_ARRAY_DATA
...
DECLARE
    ...
    V_VALOR_SURESTE VARCHAR2(25 CHAR):= 'Sureste';
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN                                
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| V_VALOR_SURESTE ||''' POR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(2)) ||'''');
          V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_DRT_DIRECCION_TERRITORIAL '||
                    'SET DD_DRT_DESCRIPCION = '''||TRIM(V_TMP_TIPO_DATA(2))||'''
                            ...
                            , USUARIOMODIFICAR = ''HREOS-8400'' , FECHAMODIFICAR = SYSDATE 
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_DRT_DIRECCION_TERRITORIAL (' ||
                      ...
                      'SELECT '|| V_ESQUEMA ||'.S_DD_DRT_DIRECCION_TERRITORIAL.NEXTVAL DD_DRT_ID, '''||V_TMP_TIPO_DATA(1)||''', '''||TRIM(V_TMP_TIPO_DATA(2))||''', '''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-8400'', SYSDATE, 0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
