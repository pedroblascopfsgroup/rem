...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA('1', 'sruiz', 'by8g01', 'SHEILA', 'RUIZ', 'ALVAREZ', 'sruiz@externos.haya.es' , '0', 'HAYAGESTADM', 'REMADM'),
	T_TIPO_DATA('1', 'gruanes', 'cz1h11', 'GEMA', 'RUANES', 'MUÑOZ', 'gruanes@externos.haya.es' , '0', 'HAYAGESTADM', 'REMADM'),
	T_TIPO_DATA('1', 'mdelavilla', 'da1i39', 'MANUEL', 'DE LA VILLA', 'TENA', 'mdelavilla@externos.haya.es' , '0', 'HAYAGESTADM', 'REMADM'),
	T_TIPO_DATA('1', 'schacon', 'eb0j49', 'SONIA', 'CHACON', 'SEGOVIA', 'schacon@externos.haya.es' , '0', 'HAYAGESACT', 'REMACT'),
	T_TIPO_DATA('1', 'agonzaleza', 'fc3k33', 'ANA', 'GONZALEZ', 'ALONSO', 'agonzaleza@externos.haya.es' , '0', 'HAYAGESACT', 'REMACT'),
	T_TIPO_DATA('1', 'mavazquez', 'gd0l62', 'MARIA', 'ANGELES', 'VAZQUEZ', 'mavazquez@externos.haya.es' , '0', 'HAYAGESACT', 'REMACT')
  ); 
     ...
     LOOP
       ...
       DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN USD_USUARIOS_DESPACHOS ');
		...
		V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.USD_USUARIOS_DESPACHOS' ||
					...
					' (SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = '''||TRIM(V_TMP_TIPO_DATA(2))||'''),' ||
					' 1,1,''HREOS-548'',SYSDATE,0 FROM DUAL';
	   ...
	   IF TRIM(V_TMP_TIPO_DATA(9)) = 'HAYAGESTADM' THEN
