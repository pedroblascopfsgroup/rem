...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_ECV_ESTADOS_CIVILES -----------------------------------------------------------------
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN DD_ECV_ESTADOS_CIVILES] ');
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_ECV_ESTADOS_CIVILES '||
       ...
       ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_ECV_ESTADOS_CIVILES.NEXTVAL FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_ECV_ESTADOS_CIVILES (' ||
