...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_STR_SUBTIPO_TRABAJO los subtipos de trabajos de Precios
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      -- TIPO TRABAJO(DD_TTR_CODIGO),   SUBTIPO(DD_STR_CODIGO),  DESCRIPCION,  DESCRIPCION LARGA
        T_TIPO_DATA('04'	,'42'	,'Carga de precios'							           			,'Carga de precios'),
        T_TIPO_DATA('04'	,'43'	,'Acta de precios de descuento'									,'Acta de precios de descuento'),
        T_TIPO_DATA('04'	,'44'	,'Tramitar propuesta de precios'								,'Tramitar propuesta de precios'),		
        T_TIPO_DATA('04'	,'45'	,'Tramitar propuesta de precios de descuento'		,'Tramitar propuesta de precios de descuento'),
    		T_TIPO_DATA('04'	,'46'	,'Bloquear activos'									            ,'Bloquear activos'),
		    T_TIPO_DATA('04'	,'47'	,'Desbloquear activos'												  ,'Desbloquear activos')
    ); 
