...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      -- TIPO TRABAJO(DD_TTR_CODIGO),   SUBTIPO(DD_STR_CODIGO),  DESCRIPCION,  DESCRIPCION LARGA
        T_TIPO_DATA('05'	,'48'	,'Publicar'						,'Publicar'),
        T_TIPO_DATA('05'	,'49'	,'Ocultar activo'				,'Acta de precios de descuento'),
        T_TIPO_DATA('05'	,'50'	,'Desocultar activo'			,'Desocultar activo'),		
        T_TIPO_DATA('05'	,'51'	,'Ocultar precio'				,'Ocultar precio'),
        T_TIPO_DATA('05'	,'52'	,'Desocultar precio'			,'Desocultar precio'),
        T_TIPO_DATA('05'	,'53'	,'Despublicar'					,'Despublicar'),
    	T_TIPO_DATA('05'	,'54'	,'Autorizar edición a mediador'	,'Autorizar edición a mediador')
    ); 
