...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_PUBLICAR', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'APUB'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_OCULTARACTIVO', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'AOAC'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_DESOCULTARACTIVO', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'ADAC'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_OCULTARPRECIO', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'AOPR'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_DESOCULTARPRECIO', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'ADPR'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_DESPUBLICAR', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'ADPU'),
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_AUTORIZAREDICION', 'plantillas/plugin/masivo/LISTADO_ACTIVOS.xls', 'AEME')
    ); 
