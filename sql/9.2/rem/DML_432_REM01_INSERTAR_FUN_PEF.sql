...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('ACTUALIZAR_PUBLICAR'),
      T_FUNCION('ACTUALIZAR_OCULTARACTIVO'),
      T_FUNCION('ACTUALIZAR_DESOCULTARACTIVO'),
      T_FUNCION('ACTUALIZAR_OCULTARPRECIO'),
      T_FUNCION('ACTUALIZAR_DESOCULTARPRECIO'),
      T_FUNCION('ACTUALIZAR_DESPUBLICAR'),
      T_FUNCION('ACTUALIZAR_AUTORIZAREDICION')
    ); 
