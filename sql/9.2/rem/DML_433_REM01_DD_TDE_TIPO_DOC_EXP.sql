...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('01'	,'Identificación'					,'Identificación'),
        T_TIPO_DATA('02'	,'Tanteo'						,'Tanteo'),
        T_TIPO_DATA('03'	,'Reserva'						,'Reserva'),
        T_TIPO_DATA('04'	,'Formalización'						,'Formalización')
    ); 
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN DD_TDE_TIPO_DOC_EXP] ');
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_TDE_TIPO_DOC_EXP (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-751'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
