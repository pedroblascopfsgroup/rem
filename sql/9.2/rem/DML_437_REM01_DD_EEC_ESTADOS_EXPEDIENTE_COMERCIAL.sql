...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('05'	,'Bloqueo Adm.'					,'Bloqueo Adm.'),
        T_TIPO_DATA('06'	,'Reservado'							,'Reservado'),
        T_TIPO_DATA('07'	,'Posicionado'							,'Posicionado'),
        T_TIPO_DATA('08'	,'Vendido'					,'Vendido'),
        T_TIPO_DATA('09'  ,'Resuelto'         ,'Resuelto')
    ); 
