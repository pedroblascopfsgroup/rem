...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Puede actualizar precios de los activos' , 'PRECIOS_ACTUALIZAR'),
      T_FUNCION('Puede bloquear precios de los activos'   , 'PRECIOS_BLOQUEAR'),
      T_FUNCION('Puede desbloquear precios de los activos', 'PRECIOS_DESBLOQUEAR')
    ); 
