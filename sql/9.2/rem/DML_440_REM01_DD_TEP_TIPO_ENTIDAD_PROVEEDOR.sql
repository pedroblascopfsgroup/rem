...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.DD_TEP_TIPO_ENTIDAD_PROVEEDOR WHERE DD_MRE_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||'''';
       ...
       ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_TEP_TIPO_ENTIDAD_PROVEEDOR.NEXTVAL FROM DUAL';
