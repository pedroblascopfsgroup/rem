...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('LISTADO_ACTIVOS_ACTUALIZAR_PRECIOS', 'plantillas/plugin/masivo/CARGA_DIRECTA_PRECIOS_ACTIVOS.xls', 'ADPA'),
		  T_FUNCION('LISTADO_ACTIVOS_BLQQUEAR_PRECIOS', 'plantillas/plugin/masivo/LISTADO_ACTIVOS_BLOQUEO_PRECIOS.xls', 'BBPA'),
		  T_FUNCION('LISTADO_ACTIVOS_DESBLOQUEAR_PRECIOS', 'plantillas/plugin/masivo/LISTADO_ACTIVOS_DESBLOQUEO_PRECIOS.xls', 'DBPA')
    ); 
