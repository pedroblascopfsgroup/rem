...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('07'	,'Comunidad de propietarios'			,'Comunidad de propietarios'			,'01'),
        T_TIPO_DATA('08'	,'Complejo inmobiliario'				,'Complejo inmobiliario'				,'01'),
        T_TIPO_DATA('09'	,'Entidad de conservación'				,'Entidad de conservación'				,'01'),
        T_TIPO_DATA('10'	,'Junta de Compensación'				,'Junta de Compensación'				,'01'),
        T_TIPO_DATA('11'	,'Agrupación de Interés Urbanístico'	,'Agrupación de Interés Urbanístico'	,'01'),
        T_TIPO_DATA('12'	,'Otra entidad'							,'Otra entidad'							,'01'),
        T_TIPO_DATA('13'	,'Ayuntamiento (municipal)'				,'Ayuntamiento (municipal)'				,'02'),
        T_TIPO_DATA('14'	,'Diputación (provincial)'				,'Diputación (provincial)'				,'02'),
        T_TIPO_DATA('15'	,'Consejería (autonómico)'				,'Consejería (autonómico)'				,'02'),
        T_TIPO_DATA('16'	,'Hacienda (estatal)'					,'Hacienda (estatal)'					,'02'),
        T_TIPO_DATA('17'	,'Otra administración pública'			,'Otra administración pública'			,'02'),
        T_TIPO_DATA('18'	,'Fuerza de venta directa'				,'Fuerza de venta directa'				,'03'),
        T_TIPO_DATA('19'	,'Jurídico'								,'Jurídico'								,'03'),
        T_TIPO_DATA('20'	,'Mediador / Colaborador / API'			,'Mediador / Colaborador / API'			,'03'),
    	T_TIPO_DATA('21'	,'Notario'								,'Notario'								,'03'),
        T_TIPO_DATA('22'	,'Entidad bancaria'						,'Entidad bancaria'						,'03'),
        T_TIPO_DATA('23'	,'Portal web'							,'Portal web'							,'03'),
    	T_TIPO_DATA('24'	,'Registro'								,'Registro'								,'03'),
        T_TIPO_DATA('25'	,'Suministro'							,'Suministro'							,'03'),
        T_TIPO_DATA('26'	,'Tasadora'								,'Tasadora'								,'03'),
        T_TIPO_DATA('27'	,'Varios'								,'Varios'								,'03')
