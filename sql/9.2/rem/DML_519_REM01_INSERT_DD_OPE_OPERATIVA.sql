...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_OPE_OPERATIVA los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_OPE_OPERATIVA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('01'	,'Activa'				,'Activa'),
        T_TIPO_DATA('02'	,'Bloqueado'			,'Bloqueado')
    ); 
