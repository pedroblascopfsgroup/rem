...
DECLARE
    ...
    V_USUARIO_MODIFICAR VARCHAR2(20 CHAR) := 'HREOS-6444'; -- Vble. auxiliar para almacenar el usuario modificar

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('57'	,'Advisory Note'								,'Advisory Note'           ,null),
        T_TIPO_DATA('58'	,'Advisory Note CES'							,'Advisory Note CES'     ,null)
    ); 
...
BEGIN	
	...
	V_TDE_ID_SQL := 'SELECT DD_TDE_ID FROM DD_TDE_TIPO_DOC_EXP WHERE DD_TDE_CODIGO = ''05''';
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_REGISTROS > 0 THEN		
          ...
          ', USUARIOMODIFICAR = '''|| V_USUARIO_CREAR ||''' , FECHAMODIFICAR = SYSDATE '||
