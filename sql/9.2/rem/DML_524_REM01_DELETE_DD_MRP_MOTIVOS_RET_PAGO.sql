...
--## PRODUCTO=NO
--##
--## Finalidad: Script que borra en DD_MRP_MOTIVOS_RET_PAGO los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: BORRADO EN DD_MRP_MOTIVOS_RET_PAGO] ');
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: BORRAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(2)) ||'''');
       	  V_MSQL := 'DELETE  FROM '|| V_ESQUEMA ||'.DD_MRP_MOTIVOS_RET_PAGO '||                   
					'WHERE DD_MRP_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||'''';
