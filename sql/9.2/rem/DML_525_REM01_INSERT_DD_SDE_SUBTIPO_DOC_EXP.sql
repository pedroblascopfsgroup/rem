...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('22'	,'Contraoferta'							,'Contraoferta'							,'05'),
        T_TIPO_DATA('23'	,'Aprobación'							,'Aprobación'							,'05')
    ); 
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' SET BORRADO = 1 WHERE DD_SDE_CODIGO = ''11'' ';
