...
--## FECHA_CREACION=20161205
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1264
--## PRODUCTO=NO
--##
...
DECLARE
    ...
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'TEP'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('01'	,'Entidad en que se integra el activo'				,'Entidad en que se integra el activo'),
        T_TIPO_DATA('02'	,'Administración pública'							,'Administración pública')
    ); 
