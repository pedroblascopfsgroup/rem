...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ABL_AREA_BLOQUEOS los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ABL_AREA_BLOQUEOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'ABL'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('01'	,'Equipo técnico'								,'Equipo técnico'),
        T_TIPO_DATA('02'	,'Pendiente gestión ocupacional'				,'Pendiente gestión ocupacional'),
        T_TIPO_DATA('03'	,'Pendiente gestión recuperaciones'				,'Pendiente gestión recuperaciones'),
        T_TIPO_DATA('04'	,'Pendiente firma organismo'					,'Pendiente firma organismo'),
        T_TIPO_DATA('05'	,'Facturación'									,'Facturación')
    ); 
