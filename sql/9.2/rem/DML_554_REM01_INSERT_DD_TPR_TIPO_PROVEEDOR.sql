...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('28', 'Oficina Bankia', 'Oficina Bankia',3),
		T_TIPO_DATA('29', 'Oficina Cajamar', 'Oficina Cajamar',3),
		T_TIPO_DATA('30', 'Web Haya', 'Web Haya',3),
		T_TIPO_DATA('31', 'Cat (Centro de atención telefónica)', 'Cat (Centro de atención telefónica)',3)
		); 
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_TPR_TIPO_PROVEEDOR '||
					...
					', DD_TEP_ID = '||TRIM(V_TMP_TIPO_DATA(4))||''||
