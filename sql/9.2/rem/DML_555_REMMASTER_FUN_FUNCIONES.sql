...
DECLARE
    ...
    --						Descripción Larga																							Descripción
      T_FUNCION('Permite editar la tab de actuaciones del activo',																'EDITAR_TAB_ACTIVO_ACTUACIONES'),
      T_FUNCION('Permite editar la tab de gestores del activo',																	'EDITAR_TAB_ACTIVO_GESTORES'),
      T_FUNCION('Permite editar la tab de observaciones del activo',															'EDITAR_TAB_ACTIVO_OBSERVACIONES'),
      T_FUNCION('Permite editar la tab de documentos del activo',																'EDITAR_TAB_ACTIVO_DOCUMENTOS'),
      T_FUNCION('Permite editar la tab de agrupaciones del activo',																'EDITAR_TAB_ACTIVO_AGRUPACIONES'),
      ...
      T_FUNCION('Permite acceder a la tab comercial del activo',																'TAB_ACTIVO_COMERCIAL'),
 	  T_FUNCION('Permite editar la tab de administración del activo',															'EDITAR_TAB_ACTIVO_ADMINISTRACION'),
      ...
      T_FUNCION('Permite editar la tab de info comercial de la tab datos generales del activo',									'EDITAR_TAB_ACTIVO_INFO_COMERCIAL'),
      ...
      T_FUNCION('Permite editar la tab de check de documentos de la tab admisión del activo',									'EDITAR_TAB_CHECKING_DOC_ADMISION'),
      T_FUNCION('Permite acceder a la tab de check de documentos de la tab admisión del activo',								'TAB_CHECKING_DOC_ADMISION'),
      T_FUNCION('Permite editar la tab de historico peticiones de la tab gestión del activo',									'EDITAR_TAB_HIST_PETICIONES'),
      T_FUNCION('Permite acceder a la tab de historico peticiones de la tab gestión del activo',								'TAB_HIST_PETICIONES'),
      T_FUNCION('Permite acceder a la tab de presupuesto asignado de la tab gestión del activo',								'EDITAR_TAB_PRESUPUESTO_ASIGNADO_ACTIVO'),
      ...
      T_FUNCION('Permite editar la tab de propuestas precio de la tab precios del activo',										'EDITAR_TAB_PROPUESTAS_PRECIO'),
      ...
      T_FUNCION('Permite editar la tab de visitas de la tab comercial del activo',												'EDITAR_TAB_COMERCIAL_VISITAS'),
      T_FUNCION('Permite acceder a la tab de visitas de la tab comercial del activo',											'TAB_COMERCIAL_VISITAS'),
      T_FUNCION('Permite editar la tab de ofertas de la tab comercial del activo',												'EDITAR_TAB_COMERCIAL_OFERTAS'),
      T_FUNCION('Permite acceder a la tab de ofertas de la tab comercial del activo',											'TAB_COMERCIAL_OFERTAS'),
      T_FUNCION('Permite editar la tab de datos generales del trámite',															'EDITAR_TAB_DATOS_GENERALES_TRAMITE'),
      T_FUNCION('Permite acceder a la tab de datos generales del trámite',														'TAB_DATOS_GENERALES_TRAMITE'),
	  T_FUNCION('Permite editar la tab de tareas del trámite',																	'EDITAR_TAB_TAREAS_TRAMITE'),
	  T_FUNCION('Permite acceder a la tab de tareas del trámite',																'TAB_TAREAS_TRAMITE'),
	  T_FUNCION('Permite editar la tab de histórico tareas del trámite',														'EDITAR_TAB_HISTORICO_TAREAS_TRAMITE'),
	  T_FUNCION('Permite acceder a la tab de histórico tareas del trámite',														'TAB_HISTORICO_TAREAS_TRAMITE'),
	  T_FUNCION('Permite editar la tab de activo del trámite',																	'EDITAR_TAB_ACTIVOS_TRAMITE'),
	  ...
	  T_FUNCION('Permite editar la tab de fotos de la agrupación',																'EDITAR_TAB_FOTOS_AGRUPACION'),
	  ...
	  T_FUNCION('Permite editar la tab de subdivisiones de la agrupación',														'EDITAR_TAB_SUBDIVISIONES_AGRUPACION'),
	  ...
	  T_FUNCION('Permite editar la tab de listado activos del trabajo',															'EDITAR_TAB_ACTIVOS_TRABAJO'),
	  ...
	  T_FUNCION('Permite editar la tab de inclusión automática de la tab generación propuestas precios de precios',				'EDITAR_TAB_INCLUSION_AUTOMATICA_PRECIOS'),
	  ...
	  T_FUNCION('Permite editar la tab de selección manual de la tab generación propuestas precios de precios',					'EDITAR_TAB_SELECCION_MANUAL_PRECIOS'),
	  ...
	  T_FUNCION('Permite acceder a la tab de carga masiva',																		'TAB_CARGA_MASIVA'),
	  T_FUNCION('Permite editar la tab de carga masiva',																		'EDITAR_TAB_CARGA_MASIVA'),
