...
--Seguros sociales mes*
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      ...
      T_TIPO_DATA('03'	,'Escritura de constitución'	,'Escritura de constitución'),
      T_TIPO_DATA('04'	,'Estatutos vigentes'		,'Estatutos vigentes'),
      T_TIPO_DATA('05'	,'Acta de asamblea'			,'Acta de asamblea'),
      T_TIPO_DATA('06'	,'Convocatoria asamblea'				,'Convocatoria asamblea'),
      T_TIPO_DATA('07'	,'Circular comunidad'		,'Circular comunidad'),
      T_TIPO_DATA('08'  ,'Acta titular real'   ,'Acta titular real'),
      T_TIPO_DATA('09'  ,'Certificado AEAT'   ,'Certificado AEAT'),
      T_TIPO_DATA('10'  ,'Certificado SS'   ,'Certificado SS'),
      T_TIPO_DATA('11'  ,'Certificado subcontratistas'   ,'Certificado subcontratistas'),
      T_TIPO_DATA('12'  ,'Impuesto Actividades Económicas'   ,'Impuesto Actividades Económicas (IAAEE)'),
      T_TIPO_DATA('13'  ,'Seguros sociales mes'   ,'Seguros sociales mes')
		); 
