...
--## INCIDENCIA_LINK=HREOS-6432
--## PRODUCTO=NO
--##
--## Finalidad: Script que inserta en DD_TGE_TIPO_GESTOR nuevo tipo gestor para algunas de las nuevas tareas que se van a crear.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GPM'	,'Portfolio Manager','Portfolio Manager', 0)
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          ', DD_TGE_EDITABLE_WEB = '''||TRIM(V_TMP_TIPO_DATA(4))||''''||
					', USUARIOMODIFICAR = ''HREOS-6432'' , FECHAMODIFICAR = SYSDATE '||
					', BORRADO = 0 '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_TGE_TIPO_GESTOR (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''' ,'''||V_TMP_TIPO_DATA(2)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-6432'',SYSDATE,0,'''||V_TMP_TIPO_DATA(4)||''' FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
