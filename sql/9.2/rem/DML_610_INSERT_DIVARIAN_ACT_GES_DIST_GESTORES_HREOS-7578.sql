...
BEGIN   
    ...
    V_SQL := 'INSERT INTO REM01.ACT_GES_DIST_GESTORES (ID, TIPO_GESTOR, COD_CARTERA, COD_ESTADO_ACTIVO,
			 COD_TIPO_COMERZIALZACION, COD_PROVINCIA, COD_MUNICIPIO, COD_POSTAL, USERNAME, NOMBRE_USUARIO,
 			 ...
 			 SELECT S_ACT_GES_DIST_GESTORES.NEXTVAL, DIST.TIPO_GESTOR, DIST.COD_CARTERA, DIST.COD_ESTADO_ACTIVO,
 			 DIST.COD_TIPO_COMERZIALZACION, DIST.COD_PROVINCIA, DIST.COD_MUNICIPIO, DIST.COD_POSTAL, DIST.USERNAME, DIST.NOMBRE_USUARIO,
			 0, ''HREOS-7578'', SYSDATE, 0, ''150'' FROM REM01.ACT_GES_DIST_GESTORES DIST WHERE DIST.COD_SUBCARTERA = ''138'' AND DIST.BORRADO = 0';
