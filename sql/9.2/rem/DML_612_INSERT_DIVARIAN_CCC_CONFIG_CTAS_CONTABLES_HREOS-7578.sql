...
BEGIN   
    ...
    V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (CCC_ID, DD_STG_ID, DD_CRA_ID, PRO_ID, 
				...
				CCC_CUENTA_CONTABLE, EJE_ID, CCC_ARRENDAMIENTO, DD_SCR_ID, CCC_REFACTURABLE)
				SELECT S_CCC_CONFIG_CTAS_CONTABLES.NEXTVAL, CCC.DD_STG_ID, CCC.DD_CRA_ID, CCC.PRO_ID, 
				CCC.CCC_CUENTA_ACTIVABLE, 0, ''HREOS-7578'', SYSDATE, 0,
				CCC.CCC_CUENTA_CONTABLE, CCC.EJE_ID, CCC.CCC_ARRENDAMIENTO, '||V_ID_SCR_DIVARIAN||', CCC.CCC_REFACTURABLE
