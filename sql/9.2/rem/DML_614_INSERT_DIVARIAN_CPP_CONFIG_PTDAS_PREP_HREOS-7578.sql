...
BEGIN   
    ...
    V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (CPP_ID, EJE_ID, DD_STG_ID, DD_CRA_ID, 
				...
				FECHACREAR, BORRADO, CPP_ARRENDAMIENTO, CPP_CANTIDAD_MAX_PRO, CPP_REFACTURABLE)
				...
				SYSDATE, 0, CPP.CPP_ARRENDAMIENTO, CPP.CPP_CANTIDAD_MAX_PRO, CPP.CPP_REFACTURABLE
