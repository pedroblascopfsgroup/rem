...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TST_TIPO_SOLICITUD_TRIB los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TST_TIPO_SOLICITUD_TRIB'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'TST'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO_CREAR VARCHAR2(20 CHAR) := 'HREOS-6633'; -- Vble. auxiliar para almacenar el usuario crear
    V_USUARIO_MODIFICAR VARCHAR2(20 CHAR) := 'HREOS-6633'; -- Vble. auxiliar para almacenar el usuario modificar

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --T_TIPO_DATA('DD_TST_CODIGO'		,'DD_TST_DESCRIPCION'					,'DD_TST_DESCRIPCION_LARGA')
        T_TIPO_DATA('01',					'Derivación de deuda', 					'Derivación de deuda'),
        T_TIPO_DATA('02',					'Hipoteca legal tácita', 				'Hipoteca legal tácita'),
        T_TIPO_DATA('03',					'Sanción', 								'Sanción'),
        T_TIPO_DATA('04',					'Multa coercitiva', 					'Multa coercitiva'),
        T_TIPO_DATA('05',					'Solicitud bonificación tributaria', 	'Solicitud bonificación tributaria'),
        T_TIPO_DATA('06',					'Suspensión de deudas recurridas', 		'Suspensión de deudas recurridas')
    ); 
