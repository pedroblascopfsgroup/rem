...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en  DD_TRG_TIPO_RECARGO_GASTO los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := ' DD_TRG_TIPO_RECARGO_GASTO';  -- Tabla a modificar
    V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_TRG_TIPO_RECARGO_GASTO';  -- Tabla a modificar   
    V_USR VARCHAR2(30 CHAR) := 'HREOS-7831'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_CDG VARCHAR2(30 CHAR) := 'TRG';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('NO_EVI', 'No Evitable', 'No Evitable'),
        T_TIPO_DATA('EVI', 'Evitable', 'Evitable')    	    
    ); 
