...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir usuario 'fmartin' a USU_USUARIO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('fmartin','Fmartin@haya.es', 'Francisco Javier', 'Martín', 'Calvo', 'ÑDFHÑASDHF' )
    	); 
        ...
        ELSE
          ...
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
           ...
           V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.USU_USUARIOS (' ||
                      'USU_ID, USU_USERNAME, USU_MAIL, USU_PASSWORD, USU_NOMBRE, USU_APELLIDO1, USU_APELLIDO2,  USU_FECHA_VIGENCIA_PASS,USU_GRUPO, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
...
SYSDATE,0,0,''DML'',SYSDATE,0  FROM DUAL';
