...
DECLARE
    ...
    --		   TAP_CODIGO								TFI_ORDEN	TFI_TIPO		TFI_NOMBRE				TFI_LABEL															TFI_ERROR_VALIDACION							TFI_VALIDACION									TFI_BUSINESS_OPERATION
    	...
    	T_TFI('T013_DefinicionOferta'					,'3'		,'combo'	,'comboTanteo'			,'Objeto del tanteo y retracto'											,''												,''												,'DDSiNo'			),
    	T_TFI('T013_DefinicionOferta'					,'4'		,'text'		,'numExpediente'		,'Nº Expediente origen'													,''												,''												,''					),
