...
DECLARE
    ...
    V_TAP_TAP_CODIGOS VARCHAR2(4000 CHAR) := ' ''T014_DefinicionOferta'' ';
...
BEGIN 
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TAP_CAMPO||' DE TABLA TAP PARA T. SANCION OFERTA ALQUILER - DEFINICION OFERTA');


  --TRAMITE SANCION OFERTA ALQUILER, DECISION ATRIBUCIONES
