...
--## INCIDENCIA_LINK=HREOS-7082
--## PRODUCTO=NO
--##
--## Finalidad: Script para crear funciones especificadas en el array y asignar los perfiles indicados
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		    -- Descripción Larga,			Función,	UsuarioCrear
    T_FUNCION('Carga masiva valores perímetro Apple', 'VALORES_PERIMETRO_APPLE', 'HREOS-7082')
    ); 
