...
DECLARE
    ...
    --			Descripción														                            		Función					UsuarioCrear
      T_FUNCION('Carga masiva gastos refacturables', 'SUPER_GASTOS_REFACTURABLES', 'HREOS-6718')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, '''||TRIM(V_TMP_FUNCION(3))||''',SYSDATE,0 FROM DUAL';
