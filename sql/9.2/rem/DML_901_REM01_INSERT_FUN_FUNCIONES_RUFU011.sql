...
--## PRODUCTO=NO
--##
--## Finalidad: Script que inserta los valores especificados en el Array en la tabla FUN_FUNCIONES
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    --			Descripción														                            		Función					UsuarioCrear
      T_FUNCION('Control de tributos', 'MASIVO_CONTROL_TRIBUTOS', 'HREOS-6821')
    ); 
