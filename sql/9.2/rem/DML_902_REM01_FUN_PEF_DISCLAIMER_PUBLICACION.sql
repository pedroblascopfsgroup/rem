...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      ...
      T_FUNCION('SUPER_DISCLAIMER_PUBLICACION', 'Super'),
      T_FUNCION('SUPER_DISCLAIMER_PUBLICACION', 'Superusuario Publicaciones')
    ); 
      ...
      LOOP
			...
			IF V_NUM_TABLAS = 0 THEN	
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
							...
							' SELECT FUN.FUN_ID, PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, ''HREOS-6391'', SYSDATE, 0' ||
