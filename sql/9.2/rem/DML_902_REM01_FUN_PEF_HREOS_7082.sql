...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade a un perfil las funciones añadidas en T_ARRAY_FUNCION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      ...
      T_FUNCION('VALORES_PERIMETRO_APPLE', 	'Super')
      ...
      LOOP
			...
			IF V_NUM_TABLAS = 0 THEN	
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
							...
							' SELECT FUN.FUN_ID, PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, ''HREOS-7082'', SYSDATE, 0' ||
