...
--## PRODUCTO=NO
--##
--## Finalidad: Script que relaciona la plantilla con la función
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-7082';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('VALORES_PERIMETRO_APPLE', 'plantillas/plugin/masivo/VALORES_PERIMETRO_APPLE.xls', 'VALPA')
    ); 
