...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ACM_ACCION_MASIVA los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ACM_ACCION_MASIVA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'ACM'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO_CREAR VARCHAR2(20 CHAR) := 'HREOS-6821'; -- Vble. auxiliar para almacenar el usuario crear
    V_USUARIO_MODIFICAR VARCHAR2(20 CHAR) := 'HREOS-6821'; -- Vble. auxiliar para almacenar el usuario modificar

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --T_TIPO_DATA('DD_ACM_CODIGO'		,'DD_ACM_DESCRIPCION'					,'DD_ACM_DESCRIPCION_LARGA')
        T_TIPO_DATA('01',					'Añadir', 				'Añadir'),
        T_TIPO_DATA('02',					'Borrar', 				'Borrar'),
        T_TIPO_DATA('03',					'Modificar',				'Modificar')
