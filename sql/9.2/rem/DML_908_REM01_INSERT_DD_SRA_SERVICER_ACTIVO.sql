...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_SRA_SERVICER_ACTIVO los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_SRA_SERVICER_ACTIVO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'SRA'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('AAM',					'Altamira',					'Altamira'),
        T_TIPO_DATA('INTRUM',				'Intrum', 					'Intrum'),
        T_TIPO_DATA('HAYA',					'Haya',						'Haya')
