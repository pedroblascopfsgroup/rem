...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones del trámite de Actualizacion de Precios
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TPO_COD VARCHAR2(20 CHAR):= 			'T010';
    V_TPO_DES VARCHAR2(100 CHAR):=			'Trámite de actualización de precios';
    V_TPO_XML VARCHAR2(50 CHAR):=			'activo_tramiteActualizacionPrecios';
    ...
    -- TAP_SCRIPT_DECISION
    	...
    	T_TAP('T010_AnalisisPeticionCargaList',
