...
DECLARE
    ...
    --		   TAP_CODIGO							TFI_ORDEN		TFI_TIPO		TFI_NOMBRE				TFI_LABEL																																																																																		TFI_ERROR_VALIDACION											TFI_VALIDACION									TFI_BUSINESS_OPERATION
    	...
    	T_TFI('T014_DefinicionOferta'				,'2'			,'textinf'		,'comite'				,'Comité sancionador'																																																																			  												,''	                                                            ,''                                 			,''			),
    	T_TFI('T014_DefinicionOferta'				,'3'			,'textarea'	    ,'observaciones'		,'Observaciones'																																																																																,''																,''												,''			)
    	);
    V_TMP_T_TFI T_TFI;
