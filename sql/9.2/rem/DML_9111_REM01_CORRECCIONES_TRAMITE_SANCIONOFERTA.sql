...
BEGIN
    ...
    /* Validación post-guardado de tarea */
    V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO' ||
			  ' SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''T013_PosicionamientoYFirma''''][''''comboFirma''''] == DDSiNo.SI ? (checkPosicionamiento() ? existeAdjuntoUGValidacion("07,E") : ''''El expediente debe tener algún posicionamiento'''') : null  '' '||
    ...
    /* NOTA: Hay que meter lo de la validación anterior en la siguiente: es decir cuando se entre por atribuciones NO, habría que hacer la comprobación anterior. */
    /* Decisión */
    V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO' ||
