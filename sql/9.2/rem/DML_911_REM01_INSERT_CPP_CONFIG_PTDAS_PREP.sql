...
DECLARE
    ...
    V_CUENTAS T_ARRAY_CUENTAS := T_ARRAY_CUENTAS(
		...
		-- Derivación de deuda			
		T_CUENTA('101',                                                    '02',               'G011311',     		2019,      0,		             null),
		T_CUENTA('101',                                                    '07',               'G011311',     		2019,      0,			         '138'),
		T_CUENTA('101',                                                    '07',               'G011311',     		2019,      0,			         '105'),
		T_CUENTA('101',                                                    '10',               'G011311',     		2019,      0,		             null),
		T_CUENTA('101',                                                    '12',               'G011311',     		2019,      0,			         null),
		T_CUENTA('101',                                                    '15',               'G011311',     		2019,      0,		             null),
		
		T_CUENTA('101',                                                    '07',               'G011311',     		2019,      1,			         '138'),
		T_CUENTA('101',                                                    '07',               'G011311',     		2019,      1,			         '105'),

		-- Hipoteca legal tácita			
		T_CUENTA('102',                                                    '02',               'G011311',     		2019,      0,		             null),
		T_CUENTA('102',                                                    '07',               'G011311',     		2019,      0,			         '138'),
		T_CUENTA('102',                                                    '07',               'G011311',     		2019,      0,			         '105'),
		T_CUENTA('101',                                                    '10',               'G011311',     		2019,      0,		             null),
		T_CUENTA('102',                                                    '12',               'G011311',     		2019,      0,			         null),
		T_CUENTA('102',                                                    '15',               'G011311',     		2019,      0,		             null),
		
		T_CUENTA('102',                                                    '07',               'G011311',     		2019,      1,			         '138'),
		T_CUENTA('102',                                                    '07',               'G011311',     		2019,      1,			         '105')
    ...
    LOOP
        ...
        IF TRIM(V_TMP_CUENTA(2)) != null THEN
	        V_SQL :=   'SELECT COUNT(1)
	                    ...
	                    AND CPP_PARTIDA_PRESUPUESTARIA = '''||TRIM(V_TMP_CUENTA(3))||'''
	                    AND EJE_ID = '||V_EJE_ID||'
