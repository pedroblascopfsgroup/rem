...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_CAP_CLASIFICACION_APPLE los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_CAP_CLASIFICACION_APPLE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'CAP'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO_CREAR VARCHAR2(20 CHAR) := 'HREOS-7073'; -- Vble. auxiliar para almacenar el usuario crear
    V_USUARIO_MODIFICAR VARCHAR2(20 CHAR) := 'HREOS-7073'; -- Vble. auxiliar para almacenar el usuario modificar

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --T_TIPO_DATA('DD_CAP_CODIGO',		'DD_CAP_DESCRIPCION',		'DD_CAP_DESCRIPCION_LARGA')
        T_TIPO_DATA('04',					'Contingente venta',		'Contingente venta'),
        T_TIPO_DATA('05',					'Contingente excluido', 	'Contingente excluido'),
        T_TIPO_DATA('06',					'Baja contable',			'Baja contable')
