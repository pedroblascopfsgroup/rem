...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones del trámite de Actualización de estados
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TPO_COD VARCHAR2(20 CHAR):= 			'T012';
    V_TPO_DES VARCHAR2(100 CHAR):=			'Trámite de actualización de estados';
    V_TPO_XML VARCHAR2(50 CHAR):=			'activo_tramiteActualizacionEstados';
    ...
    -- TAP_SCRIPT_DECISION
    	...
    	T_TAP('T012_AnalisisPeticionActualizacionEstado',
    ...
    --		   TAP_CODIGO						TFI_ORDEN	TFI_TIPO	TFI_NOMBRE				TFI_LABEL																																																																																		TFI_ERROR_VALIDACION											TFI_VALIDACION									TFI_BUSINESS_OPERATION
    	T_TFI('T012_AnalisisPeticionActualizacionEstado'			,'0'		,'label'	    ,'titulo'				,'<p style="margin-bottom: 10px">Se ha formulado una solicitud para la actualizaci&oacute;n de publicaciones.</p>'																																									,''																,''												,''					),
    	T_TFI('T012_AnalisisPeticionActualizacionEstado'			,'1'		,'datemaxtod'	,'fechaCarga'		    ,'Fecha carga de listado'																																																																															,''																,''												,''			),
    	T_TFI('T012_AnalisisPeticionActualizacionEstado'			,'2'		,'textarea'	    ,'observaciones'		,'Observaciones'																																																																																,''																,''												,''					)
		);
    V_TMP_T_TFI T_TFI;
