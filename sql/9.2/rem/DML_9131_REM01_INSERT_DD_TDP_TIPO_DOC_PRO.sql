...
DECLARE
	...
	T_TIPO_DATA('185','Factura mensajería-correos (admisión)','Factura mensagería-correos (admisión)','AI-15-FACT-AM'),
        T_TIPO_DATA('187','Factura Gestoría (admisión)','Factura Gestoría (admisión)','AI-15-FACT-75')
