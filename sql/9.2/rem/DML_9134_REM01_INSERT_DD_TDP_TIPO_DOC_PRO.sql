...
DECLARE
	...
	T_TIPO_DATA('186','Ficha STD (Saneamiento Técnico Documental)', 'Ficha STD (Saneamiento Técnico Documental) P.Urquiza - Anexo Informes 0' ,'AI-03-FICH-28')
    ); 
