...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'REMVIP-5011';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('OPERAR_GASTO_AGRUPACION'               		, 'HAYAGESTADMT'),
        T_FUNCION('OPERAR_GASTO_AGRUPACION'                    	, 'GESTOPLUS'),
        T_FUNCION('OPERAR_GASTO_AGRUPACION'                     , 'GTOPOSTV')
