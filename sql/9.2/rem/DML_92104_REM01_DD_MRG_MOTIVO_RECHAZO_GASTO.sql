...
--## PRODUCTO=NO
--## Finalidad: Script que añade en DD_MRG_MOTIVO_RECHAZO_GASTO los datos añadidos de T_ARRAY_DATA
--##
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN 
  ...
  -- LOOP para insertar los valores en la tabla indicada
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
          ...
          ', USUARIOMODIFICAR = ''HREOS-6474'' , FECHAMODIFICAR = SYSDATE '||
      ...
      DBMS_OUTPUT.PUT_LINE(V_MSQL);
        ...
        ' VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
                          'SELECT '|| V_ID || ','''||TRIM(V_TMP_TIPO_DATA(1))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''','''||TRIM(V_TMP_TIPO_DATA(5))||''','||'0, ''HREOS-6474'',SYSDATE,0 FROM DUAL';
      DBMS_OUTPUT.PUT_LINE(V_MSQL);
              EXECUTE IMMEDIATE V_MSQL;
