...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] ');
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar registro existente  (Actualizar Función carga masiva de gestión económica de trabajos)');
      ...
      IF V_NUM_REGISTRO > 0 THEN
	      V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
	                    'SET DD_OPM_VALIDACION_FORMATO = ''n*,s,s,s,s,d,f''  '||
						', USUARIOMODIFICAR = ''REMVIP-5054'' , FECHAMODIFICAR = SYSDATE '||
