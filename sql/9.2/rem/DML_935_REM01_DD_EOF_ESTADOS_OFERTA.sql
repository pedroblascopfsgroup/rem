...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EOF_ESTADOS_OFERTA los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(         
        T_TIPO_DATA('05'	,'Anulada'				,'Anulada')
	); 
...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_EOF_ESTADOS_OFERTA -----------------------------------------------------------------
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_EOF_ESTADOS_OFERTA.NEXTVAL FROM DUAL';
