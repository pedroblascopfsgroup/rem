...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('252', 'CIUDAD DEL VATICANO'),
        T_TIPO_DATA('253', 'CURAÇAO'),
        T_TIPO_DATA('254', 'SAN MARTIN'),
        T_TIPO_DATA('255', 'ISLAS BONAIRE S.EUSTAQUIO SABA'),
        T_TIPO_DATA('256', 'SAMOA AMERICANA'),
        T_TIPO_DATA('257', 'GUAM (OCEANIA AMERICANA)'),
        T_TIPO_DATA('258', 'FEDERACION ESTADOS MICRONESIA'),
        T_TIPO_DATA('259', 'PALAU'),
        T_TIPO_DATA('260', 'COCOS (ISLA) (ISLAS KEELING)')
