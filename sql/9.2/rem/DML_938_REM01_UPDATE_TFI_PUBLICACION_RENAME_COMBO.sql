...
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza nombre campo del Trámite de Publicacion
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TFI_TFI_NOMBRE VARCHAR2(100 CHAR) := 'comboDatosIguales';
...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA T. PUBLICACION - COMBO DATOS IGUALES');
...
--T011_RevisionInformeComercial ----------------------------
  ...
  V_TFI_TFI_NOMBRE := 'comboDatosIguales';
  V_TFI_CAMPO := 'tfi_label';
  V_TFI_VALOR := 'Continuar proceso de publicación';
