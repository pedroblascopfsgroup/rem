...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('261', 'CIUDAD DEL VATICANO')
      ...
      LOOP
        ...
        IF V_NUM_TABLAS = 0 THEN				
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_PAI_PAISES (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''', 0, ''REMVIP-5253'', SYSDATE, 0 FROM DUAL';
