...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTA filas de TFI_TAREAS_FORM_ITEMS - Campos tarea T009_GenerarPropuestaPrecios del T. propuesta de precios
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T009_GenerarPropuestaPrecios',   		'datemaxtod',   		'fechaGeneracion',  '',					'Fecha generación de la propuesta',			'Debe indicar la fecha de generación',				'false' ),
		T_TFI(   'T009_GenerarPropuestaPrecios',   		'text',   				'nombrePropuesta',  '',					'Nombre de la propuesta',					'Debe indicar un nombre para la propuesta',			'false' ),
		T_TFI(   'T009_GenerarPropuestaPrecios',   		'textarea',   			'observaciones',	'',					'Observaciones',							'',													'' )
