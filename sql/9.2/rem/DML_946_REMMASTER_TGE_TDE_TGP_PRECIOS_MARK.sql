...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TGE_TIPO_GESTOR los SUPERVISORES de PRECIOS y MARKETING
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GPREC'	,'Gestor de precios'					,'Gestor de precios'),
    	T_TIPO_DATA('GMARK'	,'Gestor de marketing'					,'Gestor de marketing'),
    	T_TIPO_DATA('SPREC'	,'Supervisor de precios'				,'Supervisor de precios'),
    	T_TIPO_DATA('SMARK'	,'Supervisor de marketing'				,'Supervisor de marketing')
    ); 
