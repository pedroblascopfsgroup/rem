...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TGE; DD_TDE y TGP los GESTORES/SUPERVISORES de PUBLICACIONES
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GPUBL'	,'Gestor de publicaciones'					,'Gestor de publicaciones'),
    	T_TIPO_DATA('SPUBL'	,'Supervisor de publicaciones'				,'Supervisor de publicaciones')
    ); 
