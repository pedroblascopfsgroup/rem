...
DECLARE
    ...
    V_DD_TABLA VARCHAR2(100 CHAR) := 'DD_EEC_EST_EXP_COMERCIAL'; -- Vble. para indicar el nombre de tabla del diccionario
    V_DD_COD VARCHAR2(100 CHAR) := 'EEC'; -- Vble. para indicar el codigo que tienen los nombres de columna del diccionario

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('15'  ,'Alquilado'   ,'Alquilado')
    ); 
