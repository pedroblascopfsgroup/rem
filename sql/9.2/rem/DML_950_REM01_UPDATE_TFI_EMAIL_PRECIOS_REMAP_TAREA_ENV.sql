...
DECLARE
    ...
    --		   TAP_CODIGO						TFI_ORDEN	TFI_TIPO		TFI_NOMBRE				TFI_LABEL							TFI_ERROR_VALIDACION			TFI_VALIDACION			TFI_BUSINESS_OPERATION
 		T_TFI('T009_EnvioPropuestaPropietario'	,'2'   		,'text'   		,'emailPropietario'  	,'Email'							,''								,''						,''					)
		);
    V_TMP_T_TFI T_TFI;
 ...
 -- ########################################################################################
    ...
    /* ################################################################################
     ## MODIFICACIONES: Se cambia el campo email de la tarean envio al propietario
