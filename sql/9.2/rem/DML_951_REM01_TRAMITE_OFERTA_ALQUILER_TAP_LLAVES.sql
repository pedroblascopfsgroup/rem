...
DECLARE
    ...
    --         TAP_CODIGO                            TFI_ORDEN  TFI_TIPO         TFI_NOMBRE             TFI_LABEL                                                                                                                                                                                                                                                                                                                                       TFI_ERROR_VALIDACION                                            TFI_VALIDACION                                  TFI_BUSINESS_OPERATION
        ...
        T_TFI('T014_DevolucionLlavesHRE'                  ,'1'     ,'datemaxtod'    ,'fechaEnvio'          ,'Fecha de envío'                                                                                                                                                                                                                                                                                             ,'Debe indicar la fecha de env&iacute;o'       ,'false'                                        ,''                 ),
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO] Empezando a insertar tareas del BPM.');
      ...
      END LOOP;
        ...
        FOR I IN V_TFI.FIRST .. V_TFI.LAST
          LOOP
            ...
            IF table_count > 0 THEN
                DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA|| '.TFI_TAREAS_FORM_ITEMS... Ya existe el campo '||V_TMP_T_TFI(4)||' de la tarea '||V_TMP_T_TFI(1)||'.');
            ELSE
          ...
          END LOOP;
    	    ...
    	    DBMS_OUTPUT.PUT_LINE('[FIN] Fin de inserción de tareas.');
