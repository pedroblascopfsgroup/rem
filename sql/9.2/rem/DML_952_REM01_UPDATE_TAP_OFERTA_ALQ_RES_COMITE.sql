...
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza el Trámite Sancion Oferta Alquiler
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TAP_TAP_CODIGOS VARCHAR2(4000 CHAR) := ' ''T014_ResolucionComiteExterno'' ';

    --CAMPO TFI PARA ACTUALIZAR
    V_TAP_CAMPO VARCHAR2(100 CHAR)  := 'TAP_SCRIPT_VALIDACION';
    V_TAP_CAMPO2 VARCHAR2(100 CHAR)  := 'TAP_SCRIPT_VALIDACION_JBPM';
    V_TAP_VALOR VARCHAR2(1000 CHAR) := 'valores[''''T014_ResolucionComiteExterno''''][''''comboResAprobada''''] == DDSiNo.SI ? existeAdjuntoUGValidacion("08","E") : existeAdjuntoUGValidacion("09","E")';


  
BEGIN 
  
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TAP_CAMPO||' DE TABLA TAP PARA SANCION OFERTA ALQUILER');
