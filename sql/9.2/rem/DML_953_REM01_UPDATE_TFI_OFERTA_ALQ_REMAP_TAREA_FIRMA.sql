...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTA filas de TFI_TAREAS_FORM_ITEMS - Campos tarea T014_PosicionamientoFirma del T. propuesta de precios
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T014_PosicionamientoFirma',   		'date',   				'fechaInicio', 			 '',					'Fecha inicio',							'Debe indicar la fecha de inicio',				'false' ),
		T_TFI(   'T014_PosicionamientoFirma',   		'date',   				'fechaFin', 			 '',					'Fecha fin',							'Debe indicar la fecha de fin',					'false' ),
		T_TFI(   'T014_PosicionamientoFirma',   		'number',   			'numContrato',  		 '',					'Nº contrato',							'Debe indicar el no. de contrato',				'false' ),
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO] Insertando datos de TFI_TAREAS_FORM_ITEMS - remapeo de tarea T014_PosicionamientoFirma en T. propuesta de precios');
