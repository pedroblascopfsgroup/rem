...
DECLARE
    ...
    V_TAP_TAP_CODIGOS VARCHAR2(4000 CHAR) := ' ''T014_PosicionamientoFirma'' ';

    --CAMPO TFI PARA ACTUALIZAR
    V_TAP_CAMPO VARCHAR2(100 CHAR)  := 'TAP_SCRIPT_DECISION';
    V_TAP_VALOR VARCHAR2(1000 CHAR) := 'valores[''''T014_PosicionamientoFirma''''][''''comboFirma''''] == DDSiNo.SI ? ''''OK'''' : ''''KO'''' ';
