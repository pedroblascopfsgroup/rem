...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TGE_TIPO_GESTOR los gestores  de formalización y comercial de back office.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GIAFORM'	,'Gestoría de formalización'				,'Gestoría de formalización'),
    	T_TIPO_DATA('GCBO'	,'Gestor comercial de back office'		,'Gestor comercial de back office')
    ); 
