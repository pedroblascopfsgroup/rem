...
--## INCIDENCIA_LINK=HREOS-1338
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TAG_TIPO_AGRUPACION los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TAG_TIPO_AGRUPACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'TAG'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('13'			,'Asistida'						,'Asistida'),
        T_TIPO_DATA('14'			,'Comercial'					,'Comercial')
    ); 
