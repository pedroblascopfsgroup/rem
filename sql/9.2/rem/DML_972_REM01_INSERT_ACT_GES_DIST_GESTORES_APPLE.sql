...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USU VARCHAR2(2400 CHAR) := 'HREOS-5787';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
         ...
         T_TIPO_DATA('GCOM', '7', '', '', '', '', '', 'aescribano', 'ALVARO ESCRIBANO GALLO', '138'),
         T_TIPO_DATA('HAYAGBOINM', '7', '', '', '', '', '', 'imartin', 'ISAAC MARTIN URSULA', '138'),
         T_TIPO_DATA('HAYASBOINM', '7', '', '', '', '', '', 'usugrubac', 'USUARIO GRUPO COMERCIAL BACKOFFICE INMOBILIARIO', '138')
