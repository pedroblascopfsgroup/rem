...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('F21' ,'Emisor (proveedor) no existe o está dado de baja' , '1', 'WHERE AUX.NIF_PROVEEDOR is null OR NOT EXISTS (SELECT * FROM ACT_PVE_PROVEEDOR PVE WHERE PVE.PVE_DOCIDENTIF = AUX.NIF_PROVEEDOR AND PVE.BORRADO = 0 AND PVE.PVE_FECHA_BAJA IS NULL)' )
		); 
