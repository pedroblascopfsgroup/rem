...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('57'	,'Cancelación carga hipotecaria: escritura'																	,'Escritura de cancelación de hipoteca inscrita'						,'04'	,'OP-07-ESCR-01', ''),
        T_TIPO_DATA('58'	,'Notario: factura'																							,'Factura de notaría cancelación'										,'04'	,'OP-07-FACT-09', '' ),
        T_TIPO_DATA('59'	,'Registro Propiedad: factura'																				,'Factura de registro cancelación'										,'04'	,'OP-07-FACT-13', ''),
        T_TIPO_DATA('60'	,'Impuesto de transmisiones patrimoniales (ITP) y Actos Jurídicos Documentados (AJD)'						,'Impuesto AJD cancelación'												,'04'	,'OP-07-CERA-14', ''),
        T_TIPO_DATA('61'	,'Registro Propiedad: nota simple inscrita/sin cargas'														,'Nota simple inscripción cancelación'									,'04'	,'OP-07-NOTS-08', '')
    ); 
