...
--## INCIDENCIA_LINK=HREOS-6918
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función botón Ofertas CES BOTON_OFERTAS_CES
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Permite visualizar el botón Ofertas CES en el buscador de ofertas', 'BOTON_OFERTAS_CES')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-6918'',SYSDATE,0 FROM DUAL';
