...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva IMPUESTOS.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('SuperUsuario (Área Admisión): Actualización superficie construida/ útil', 'CARGA_MASIVA_SUPERFICIE')
    ); 
