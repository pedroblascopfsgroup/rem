...
BEGIN
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.ACT_ADG_ADECUACION_GENCAT ADG 
        WHERE EXISTS (SELECT 1 FROM '||V_ESQUEMA||'.ACT_CMG_COMUNICACION_GENCAT CMG WHERE CMG.CMG_ID = ADG.CMG_ID AND CMG.USUARIOCREAR = ''MIGRA_GENCAT'')';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.ACT_OFG_OFERTA_GENCAT OFG
        WHERE EXISTS (SELECT 1 FROM '||V_ESQUEMA||'.ACT_CMG_COMUNICACION_GENCAT CMG WHERE CMG.CMG_ID = OFG.CMG_ID AND CMG.USUARIOCREAR = ''MIGRA_GENCAT'')';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.TEV_TAREA_EXTERNA_VALOR TEV
        WHERE EXISTS (SELECT 1 
            ...
            WHERE TEX.TEX_ID = TEV.TEX_ID AND TRA.USUARIOCREAR = ''MIGRA_GENCAT'')';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.TEX_TAREA_EXTERNA TEX  
        WHERE EXISTS (SELECT 1 
            ...
            JOIN '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS TAC ON TAC.TAR_ID = TAR.TAR_ID
            JOIN '||V_ESQUEMA||'.ACT_TRA_TRAMITE TRA ON TRA.TRA_ID = TAC.TRA_ID
            WHERE TAR.TAR_ID = TEX.TAR_ID AND TRA.USUARIOCREAR = ''MIGRA_GENCAT'')';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS TAC
        WHERE EXISTS (SELECT 1 
            ...
            WHERE TRA.TRA_ID = TAC.TRA_ID AND TRA.USUARIOCREAR = ''MIGRA_GENCAT'')';
    EXECUTE IMMEDIATE V_MSQL;
