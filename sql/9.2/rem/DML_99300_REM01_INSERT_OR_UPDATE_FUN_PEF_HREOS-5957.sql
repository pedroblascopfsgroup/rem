...
--## VERSIONES:
--##        0.1 Versión inicial
--##        0.2 HREOS-5957 Carga masiva Gestión Economica Trabajos
--##########################################
--*/
...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-5957';

    -- EDITAR: FUNCIONES
    TYPE T_FUNCION IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_FUNCION IS TABLE OF T_FUNCION;
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('CARGA_MASIVA_GESTION_ECONOMICA_TRABAJOS')
    ); 
