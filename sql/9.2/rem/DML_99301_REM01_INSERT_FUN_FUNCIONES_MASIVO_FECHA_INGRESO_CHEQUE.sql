...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva FECHA INGRESO CHEQUES.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('SuperUsuario (Área Formalización): Fecha Ingreso Cheque', 'CARGA_MASIVA_FECHA_INGRESO_CHEQUE')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-5807'',SYSDATE,0 FROM DUAL';
