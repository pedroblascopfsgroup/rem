...
--## INCIDENCIA_LINK=HREOS-7024
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva juntas ordinarias y extraordinarias.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Carga masiva juntas ordinarias y extraordinarias', 'CARGA_MASIVA_JUNTAS')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-5808'',SYSDATE,0 FROM DUAL';
