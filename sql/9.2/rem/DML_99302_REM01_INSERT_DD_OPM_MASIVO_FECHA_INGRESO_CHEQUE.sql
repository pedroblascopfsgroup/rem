...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMFIC', 'SuperUsuario(Formalización): Fecha Ingreso Cheque', 'SuperUsuario (Área Formalización): Fecha Ingreso Cheque', 'CARGA_MASIVA_FECHA_INGRESO_CHEQUE','n*,f*')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-5807'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
