...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMJOE', 'Carga masiva juntas ordinarias y extraordinarias', 'Carga masiva juntas ordinarias y extraordinarias', 'CARGA_MASIVA_JUNTAS','f*,n*,n*,d,s,s,s*,s,s,s,s,s,s,d,d,d,d,s,s,s,s*')
    ); 
