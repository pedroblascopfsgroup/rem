...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-5805'; -- USUARIOCREAR/USUARIOMODIFICAR

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('SIMP', 'Información Administrativa')
    ); 
      ...
      LOOP
        ...
        V_TMP_TIPO_DATA := V_TIPO_DATA(I);
    		...
    		IF V_NUM_TABLAS = 1 THEN      
              ...
              SET DD_OPM_DESCRIPCION = '''||V_TMP_TIPO_DATA(2)||''',
              DD_OPM_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(2)||''',
