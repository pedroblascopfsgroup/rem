...
--## INCIDENCIA_LINK=REMVIP-4600
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva CAMBIAR_ESTADO_OFERTA_BANKIA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Permite cambiar el estado de una oferta Bankia antes de los 7 dias de espera', 'CAMBIAR_ESTADO_OFERTA_BANKIA')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''REMVIP-4600'',SYSDATE,0 FROM DUAL';
