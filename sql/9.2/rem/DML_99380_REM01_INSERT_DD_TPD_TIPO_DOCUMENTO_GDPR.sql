...
--## INCIDENCIA_LINK=HREOS-5215
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TPD_TIPO_DOCUMENTO nuevo tipo de Documento para GDPR
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('83'  ,'Consentimiento protección de datos (GDPR)', 'Consentimiento protección de datos (GDPR)', 'EN-01-CNCV-82')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: YA EXISTE UN REGISTRO CON CODIGO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
        ...
        ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_TPD_TIPO_DOCUMENTO (' ||
                      ...
                      'SELECT '||V_ID||','''||V_TMP_TIPO_DATA(1)||''','''||V_TMP_TIPO_DATA(2)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''',0,''HREOS-5215'',SYSDATE,0,'''||TRIM(V_TMP_TIPO_DATA(4))||''',0 FROM DUAL';
