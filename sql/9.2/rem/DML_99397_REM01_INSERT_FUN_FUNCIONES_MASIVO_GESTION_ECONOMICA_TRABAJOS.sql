...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva Gestión Economica Trabajos.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Función carga masiva gestión económica de trabajos', 'CARGA_MASIVA_GESTION_ECONOMICA_TRABAJOS')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-5957'',SYSDATE,0 FROM DUAL';
