        ...
        ELSE
          ...
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
           ...
           V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.MGD_MAPEO_GESTOR_DOC (MGD_ID, DD_CRA_ID, DD_SCR_ID, CLIENTE_GD, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES
                      ('|| V_ID ||',(SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = ''07''),(SELECT DD_SCR_ID FROM '||V_ESQUEMA||'.DD_SCR_SUBCARTERA WHERE DD_SCR_CODIGO = '''||ARRAY_SUBCARTERAS(I)||'''),''Promontoria Agora'',0,''HREOS-5654'',SYSDATE,0)';         
          EXECUTE IMMEDIATE V_MSQL;
