...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TGE_TIPO_GESTOR la Gestoría de Postventa
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GTOPOSTV'	,'Gestoría de Postventa','Gestoría de Postventa')
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_TGE_TIPO_GESTOR (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''' ,'''||V_TMP_TIPO_DATA(2)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-5530'',SYSDATE,0,1 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
