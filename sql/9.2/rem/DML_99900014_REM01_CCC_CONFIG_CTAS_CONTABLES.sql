...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(    
		...
		-- Cajamar
		T_TIPO_DATA('01','01','13','63103000001','63103000012'),
		T_TIPO_DATA('02','01','13','63103000001','63103000012'),
		T_TIPO_DATA('01','01','','48000000200','48000000200'),
		T_TIPO_DATA('02','01','','48000000200','48000000200')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.CCC_CONFIG_CTAS_CONTABLES (' ||
                    'CCC_ID, DD_STG_ID, DD_CRA_ID, PRO_ID, CCC_CUENTA_ANYO_CURSO, CCC_CUENTA_ANYOS_ANTERIORES, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES' ||
                      '('|| V_ID || ',
					  ...
					  (SELECT PRO_ID FROM '||V_ESQUEMA ||'.ACT_PRO_PROPIETARIO WHERE PRO_CODIGO_UVEM = '''||V_TMP_TIPO_DATA(3)||'''),
