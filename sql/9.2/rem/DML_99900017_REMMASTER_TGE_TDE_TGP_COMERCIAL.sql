...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade Gestor y Supervior de COMERCIAL Y FORMALIZACION en DD_TGE, DD_TDE y TGP..
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GCOM'	,'Gestor comercial'					,'Gestor comercial'),
    	T_TIPO_DATA('SCOM'	,'Supervisor comercial'				,'Supervisor comercial'),
    	T_TIPO_DATA('GFORM'	,'Gestor formalización'				,'Gestor formalización'),
    	T_TIPO_DATA('SFORM'	,'Supervisor formalización'			,'Supervisor formalización')
    ); 
