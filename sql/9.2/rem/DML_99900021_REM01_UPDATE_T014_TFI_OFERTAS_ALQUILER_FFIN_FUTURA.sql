...
DECLARE
    ...
    V_TFI_TFI_NOMBRE VARCHAR2(100 CHAR) := 'fechaFin';
...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA T. SANCION OFERTA ALQUILER - T014_PosicionamientoFirma - FFIN SIN VALIDAR LIMITE FECHA');
...
--T014_PosicionamientoFirma - Fecha Fin sin limite ----------------------------
  ...
  V_TFI_TFI_NOMBRE := 'comite';
  V_TFI_CAMPO := 'tfi_error_validacion';
  V_TFI_VALOR := 'En pesta&nacute;a oferta del expediente, debe indicar el comit&eacute; sancionador';
