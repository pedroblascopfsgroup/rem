...
--## INCIDENCIA_LINK=HREOS-1261
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_TPD_TIPO_DOCUMENTO nuevos tipos de Documento para la propuesta de precios
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('21'	,'Propuesta de precios inicial', 'Propuesta de precios inicial'),
    	T_TIPO_DATA('22'	,'Propuesta de precios enviada', 'Propuesta de precios enviada'),
    	T_TIPO_DATA('23'	,'Propuesta de precios propietario', 'Propuesta de precios propietario')
    ); 
