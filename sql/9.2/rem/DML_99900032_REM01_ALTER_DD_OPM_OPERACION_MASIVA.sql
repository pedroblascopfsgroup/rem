...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ADPF'	,'Publicación: Desmarcar publicación forzada'				,'Publicación: Desmarcar publicación forzada'),
        T_TIPO_DATA('AOAC'	,'Publicación: Ocultar activo publicado'					,'Publicación: Ocultar activo publicado'),
        T_TIPO_DATA('ADAC'	,'Publicación: Desocultar activo publicado'					,'Publicación: Desocultar activo publicado')
    ); 
