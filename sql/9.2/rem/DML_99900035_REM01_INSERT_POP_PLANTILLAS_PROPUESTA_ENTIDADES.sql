...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('PROPUESTA_PRECIOS_ACTIVOS_ENTIDAD01', 'plantillas/plugin/propuestaprecios/ACTIVOS_PROPUESTA_PRECIOS_ENTIDAD01.xls', 'CPPA_01'),
		  T_FUNCION('PROPUESTA_PRECIOS_ACTIVOS_ENTIDAD02', 'plantillas/plugin/propuestaprecios/ACTIVOS_PROPUESTA_PRECIOS_ENTIDAD02.xls', 'CPPA_02'),
		  T_FUNCION('PROPUESTA_PRECIOS_ACTIVOS_ENTIDAD03', 'plantillas/plugin/propuestaprecios/ACTIVOS_PROPUESTA_PRECIOS_ENTIDAD03.xls', 'CPPA_03')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.POP_PLANTILLAS_OPERACION' ||
							...
							' 0, ''HREOS-1309'', SYSDATE, 0 FROM DUAL';
