...
DECLARE
    ...
    --				CODIGO		DESCRIPCION									DESCRIPCION_LARGA
    	T_TIPO_DATA('GCOMRET'	,'Gestor comercial retail'					,'Gestor comercial retail'		),
    	T_TIPO_DATA('GCOMSIN'	,'Gestor comercial singular'				,'Gestor comercial singular'	),
    	
    	T_TIPO_DATA('SCOMRET'	,'Supervisor comercial retail'				,'Supervisor comercial retail'	),
    	T_TIPO_DATA('SCOMSIN'	,'Supervisor comercial singular'			,'Supervisor comercial singular')
    ); 
	...
	--				DES_DESPACHO	TDE_TIPO_DESPACHO
	    T_TIPO_DES('REMGCOMRET',	'GCOMRET'		),
	    T_TIPO_DES('REMGCOMSIN',	'GCOMSIN'		),
	      
	    T_TIPO_DES('REMSUPCOMRET',	'SCOMRET'		),
	    T_TIPO_DES('REMSUPCOMSIN',	'SCOMSIN'		)
	); 
	...
	--				CODIGO	  			DESCRIPCION	 						DESCRIPCION_LARGA   
		T_TIPO_PEF('HAYAGESTCOMRET', 	'Gestor comercial retail', 			'Gestor comercial retail'		),
		T_TIPO_PEF('HAYAGESTCOMSIN', 	'Gestor comercial singular', 		'Gestor comercial singular'		),
		
		T_TIPO_PEF('HAYASUPCOMRET', 	'Supervisor comercial retail', 		'Supervisor comercial retail'	),
		T_TIPO_PEF('HAYASUPCOMSIN', 	'Supervisor comercial singular', 	'Supervisor comercial singular'	)
	); 
	...
	V_TIPO_USU_GRU T_ARRAY_USU_GRU := T_ARRAY_USU_GRU(
		...
		T_TIPO_USU_GRU('1',	'GESTCOMRET',	'1234',		'Gestor comercial retail', 			'', 	'', 	'email@email.es' , 	'1', 'HAYAGESTCOMRET', 	'REMGCOMRET'	),
		T_TIPO_USU_GRU('1', 'GESTCOMSIN',	'1234', 	'Gestor comercial singular', 		'', 	'', 	'email@email.es' , 	'1', 'HAYAGESTCOMSIN', 	'REMGCOMSIN'	),
		
		T_TIPO_USU_GRU('1', 'SUPCOMRET',	'1234', 	'Supervisor comercial retail', 		'', 	'', 	'email@email.es' , 	'1', 'HAYASUPCOMRET', 	'REMSUPCOMRET'	),
		T_TIPO_USU_GRU('1', 'SUPCOMSIN',	'1234', 	'Supervisor comercial singular', 	'', 	'', 	'email@email.es' , 	'1', 'HAYASUPCOMSIN', 	'REMSUPCOMSIN'	)
	); 
