...
--## FECHA_CREACION=20170025
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-1974
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza el Tramite actuacion tecnica
--## INSTRUCCIONES:
--## VERSIONES:
...
DECLARE
    ...
    V_TFI_VALOR VARCHAR2(4000 CHAR) := 'datemintod';

  
BEGIN	
	
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA T004_FijacionPlazo');



  V_TFI_TFI_NOMBRE := 'fechaConcreta';
