...
--## PRODUCTO=NO
--##
--## Finalidad: Realiza las inserciones del trámite de obtencion documental CEE, existiendo ya el trámite
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    -- TAP_SCRIPT_DECISION
        ...
        T_TAP('T003_AutorizacionBankia',
                ...
                '',
                '',
                'valores[''''T003_AutorizacionBankia''''][''''comboAmpliacion''''] == DDSiNo.SI ? ''''OK'''' : ''''KO'''' '
            )
    );
    V_TMP_T_TAP T_TAP;
