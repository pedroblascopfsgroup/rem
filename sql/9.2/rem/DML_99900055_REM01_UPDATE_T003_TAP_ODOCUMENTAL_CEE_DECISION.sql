...
-- checkBankia() ? (checkSuperaPresupuestoActivo() ? ''''OKSinSaldoBankia'''' : ''''OKConSaldo'''') :
  ...
  V_TAP_VALOR := 'valores[''''T003_AnalisisPeticion''''][''''comboTramitar''''] == DDSiNo.NO ? ''''KO'''' : (checkBankia() ? (checkSuperaPresupuestoActivo() ? ''''OKSinSaldoBankia'''' : ''''OKConSaldo'''') : (valores[''''T003_AnalisisPeticion''''][''''comboSaldo''''] == DDSiNo.SI ? ''''OKConSaldo'''' : ''''OKSinSaldo'''')) ';
