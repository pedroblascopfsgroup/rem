...
BEGIN
    ...
    V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO' ||
		  ' SET TAP_SCRIPT_VALIDACION_JBPM = ''checkFormalizacion() ? (checkDeDerechoTanteo() == false ? (checkAtribuciones() ? null : (checkBankia() ? (altaComite() ? null : ''''Ha fallado el alta del comite'''') : null)) : null) : null '' '||
