...
DECLARE
    ...
    --						Descripción Larga																							Descripción
      T_FUNCION('Permite mostrar los botones de edición del grid de la tab de compradores del expediente',					'TAB_COMPRADORES_EXP_BTN_EDICION'),
	  T_FUNCION('Permite editar los detalles de comprador en su ventana de la tab de compradores del expediente',			'TAB_COMPRADORES_EXP_DETALLES_COMPRADOR')
    ); 
