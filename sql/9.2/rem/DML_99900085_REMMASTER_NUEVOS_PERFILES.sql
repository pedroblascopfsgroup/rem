...
DECLARE
    ...
    --				CODIGO			DESCRIPCION							DESCRIPCION_LARGA
	    T_TIPO_DATA('GCAL',			'Gestor Calidad',			 		'Gestor Calidad'					), 
		T_TIPO_DATA('GCOMSIN',		'Supervisor Calidad', 				'Supervisor Calidad'				), 
		T_TIPO_DATA('GFSV',			'Gestor FSV', 						'Gestor FSV'						), 
		T_TIPO_DATA('GBACKOFFICE',	'Supervisor Comercial BackOffice', 	'Supervisor Comercial BackOffice'	), 
		T_TIPO_DATA('GADMT',		'Gestor de Administración', 		'Gestor de Administración'			), 
		T_TIPO_DATA('SADM',			'Supervisor de Administración', 	'Supervisor de Administración'		), 
		T_TIPO_DATA('GLLA',			'Gestor de Llaves', 				'Gestor de Llaves'					), 
		T_TIPO_DATA('SLLA',			'Supervisor de Llaves', 			'Supervisor de Llaves'				), 
		T_TIPO_DATA('GTOADM',		'Gestoría de Admisión', 			'Gestoría de Admisión'				), 
		T_TIPO_DATA('GTOCED',		'Gestoría de Cédula', 				'Gestoría de Cédula'				), 
		T_TIPO_DATA('GTOPLUS',		'Gestoría de Plusvalía', 			'Gestoría de Plusvalía'				), 
		T_TIPO_DATA('GTOPDV',		'Gestoría de PDV', 					'Gestoría de PDV'					)  
    ); 
	...
	--				DES_DESPACHO	TDE_TIPO_DESPACHO
	    T_TIPO_DES('REMCAL', 		'GCAL'			),
		T_TIPO_DES('REMSUPCAL', 	'GCOMSIN'		),
		T_TIPO_DES('REMFSV', 		'GFSV'			),
		T_TIPO_DES('REMBACKOFFICE',	'GBACKOFFICE'	),
		T_TIPO_DES('HAYAADM', 		'GADMT'			),
		T_TIPO_DES('HAYASADM', 		'SADM'			),
		T_TIPO_DES('HAYALLA', 		'GLLA'			),
		T_TIPO_DES('HAYASLLA', 		'SLLA'			),
		T_TIPO_DES('GESTOADM', 		'GTOADM'		),
		T_TIPO_DES('GESTOCED', 		'GTOCED'		),
		T_TIPO_DES('GESTOPLUS', 	'GTOPLUS'		),
		T_TIPO_DES('GESTOPDV', 		'GTOPDV'		)
	); 
	...
	--				CODIGO	  			DESCRIPCION	 						DESCRIPCION_LARGA   
		T_TIPO_PEF('HAYACAL', 			'Gestor Calidad',			 		'Gestor Calidad'					),
		T_TIPO_PEF('HAYASUPCAL', 		'Supervisor Calidad', 				'Supervisor Calidad'				),
		T_TIPO_PEF('HAYAFSV', 			'Gestor FSV', 						'Gestor FSV'						),
		T_TIPO_PEF('HAYABACKOFFICE', 	'Supervisor Comercial BackOffice', 	'Supervisor Comercial BackOffice'	),
		T_TIPO_PEF('HAYAADM', 			'Gestor de Administración', 		'Gestor de Administración'			),
		T_TIPO_PEF('HAYASADM', 			'Supervisor de Administración', 	'Supervisor de Administración'		),
		T_TIPO_PEF('HAYALLA', 			'Gestor de Llaves', 				'Gestor de Llaves'					),
		T_TIPO_PEF('HAYASLLA', 			'Supervisor de Llaves', 			'Supervisor de Llaves'				),
		T_TIPO_PEF('GESTOADM', 			'Gestoría de Admisión', 			'Gestoría de Admisión'				),
		T_TIPO_PEF('GESTOCED', 			'Gestoría de Cédula', 				'Gestoría de Cédula'				),
		T_TIPO_PEF('GESTOPLUS', 		'Gestoría de Plusvalía', 			'Gestoría de Plusvalía'				),
		T_TIPO_PEF('GESTOPDV', 			'Gestoría de PDV', 					'Gestoría de PDV'					)
	); 
	...
	V_TIPO_USU_GRU T_ARRAY_USU_GRU := T_ARRAY_USU_GRU(
		...
		T_TIPO_USU_GRU('1','HAYACAL', 			'1234',     'Gestor Calidad',			 		'',     '',    'email@email.es' , 	'1', 'HAYACAL', 		'REMCAL' 			),
		T_TIPO_USU_GRU('1','HAYASUPCAL', 		'1234',     'Supervisor Calidad', 				'',     '',    'email@email.es' , 	'1', 'HAYASUPCAL', 		'REMSUPCAL' 		),
		T_TIPO_USU_GRU('1','HAYAFSV', 			'1234',     'Gestor FSV', 						'',     '',    'email@email.es' , 	'1', 'HAYAFSV', 		'REMFSV' 			),
		T_TIPO_USU_GRU('1','HAYABACKOFFICE', 	'1234',     'Supervisor Comercial BackOffice', 	'',     '',    'email@email.es' , 	'1', 'HAYABACKOFFICE',	'REMBACKOFFICE'		),
		T_TIPO_USU_GRU('1','HAYAADM', 			'1234',     'Gestor de Administración', 		'',     '',    'email@email.es' , 	'1', 'HAYAADM', 		'HAYAADM' 			),
		T_TIPO_USU_GRU('1','HAYASADM', 			'1234',     'Supervisor de Administración', 	'',     '',    'email@email.es' , 	'1', 'HAYASADM', 		'HAYASADM'	 		),
		T_TIPO_USU_GRU('1','HAYALLA', 			'1234',     'Gestor de Llaves', 				'',     '',    'email@email.es' , 	'1', 'HAYALLA', 		'HAYALLA' 			),
		T_TIPO_USU_GRU('1','HAYASLLA', 			'1234',     'Supervisor de Llaves', 			'',     '',    'email@email.es' , 	'1', 'HAYASLLA', 		'HAYASLLA'	 		),
		T_TIPO_USU_GRU('1','GESTOADM', 			'1234',     'Gestoría de Admisión', 			'',     '',    'email@email.es' , 	'1', 'GESTOADM', 		'GESTOADM'	 		),
		T_TIPO_USU_GRU('1','GESTOCED', 			'1234',     'Gestoría de Cédula', 				'',     '',    'email@email.es' , 	'1', 'GESTOCED', 		'GESTOCED'	 		),
		T_TIPO_USU_GRU('1','GESTOPLUS', 		'1234',     'Gestoría de Plusvalía', 			'',     '',    'email@email.es' , 	'1', 'GESTOPLUS', 		'GESTOPLUS'	 		),
		T_TIPO_USU_GRU('1','GESTOPDV', 			'1234',     'Gestoría de PDV', 					'',     '',    'email@email.es' , 	'1', 'GESTOPDV', 		'GESTOPDV'	 		)
	); 
