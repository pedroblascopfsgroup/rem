...
DECLARE
    ...
    V_PERFILES T_ARRAY_PERFILES := T_ARRAY_PERFILES(
    	...
    	T_PERFIL('HAYAGESTCOMSIN'), -- Gestor comercial singular.
    	T_PERFIL('HAYAGESTCOMRET'), -- Gestor comercial retail.
    	T_PERFIL('HAYASUPCOM'), -- Supervisor comercial.
    	T_PERFIL('GESTCOMBACKOFFICE'), -- Gestor comercial de back office.
    	T_PERFIL('HAYABACKOFFICE'), -- Supervisor comercial de back office.
