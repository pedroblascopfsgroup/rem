...
--## PRODUCTO=NO
--##
--## Finalidad: Script que pone obligatorio el campo motivo de anulación
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TFI_TFI_NOMBRE VARCHAR2(100 CHAR) := 'motivoAnulacion';
...
--T013_ResolucionExpediente ----------------------------
  ...
  V_TFI_TAP_CODIGO := 'T013_ResolucionExpediente';
  V_TFI_TFI_NOMBRE := 'motivoAnulacion';
