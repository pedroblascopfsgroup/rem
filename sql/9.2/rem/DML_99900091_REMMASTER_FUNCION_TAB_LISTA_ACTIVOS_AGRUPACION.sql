...
DECLARE
    ...
    --						Descripción Larga																							Descripción
      T_FUNCION('Permite mostrar el botón de opciones de publicación del grid listqado activos de la agrupación',		'EDITAR_TAB_PUBLICACION_LISTA_ACTIVOS_AGRUPACION')
    ); 
