...
--## INCIDENCIA_LINK=HREOS-1741
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza el Trámite de actualización de precios
--## INSTRUCCIONES:
--## VERSIONES:
...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA Trámite de actualización de precios');



-- CAMBIO OBLIGATORIEDAD CAMPOS --------------------------------------------------

--T010_AnalisisPeticionCargaList ----------------------------

  V_TFI_TAP_CODIGO := 'T010_AnalisisPeticionCargaList';
  ...
  V_TFI_VALOR := 'Debe indicar si acepta o rechaza la petici&oacute;n';
