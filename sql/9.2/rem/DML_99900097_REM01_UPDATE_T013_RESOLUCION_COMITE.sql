...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA T. SANCION OFERTA VENTA');


--T013_ResolucionComite ----------------------------

  V_TFI_TAP_CODIGO := 'T013_ResolucionComite';
  V_TFI_TFI_NOMBRE := 'comboResolucion';
  V_TFI_CAMPO := 'tfi_tipo';
  V_TFI_VALOR := 'comboinied';
  ...
  V_TFI_TAP_CODIGO := 'T013_ResolucionComite';
  V_TFI_TFI_NOMBRE := 'numImporte';
  V_TFI_CAMPO := 'tfi_nombre';
  V_TFI_VALOR := 'numImporteContra';
  ...
  V_TFI_TAP_CODIGO := 'T013_RatificacionComite';
  V_TFI_TFI_NOMBRE := 'comboResolucion';
  V_TFI_CAMPO := 'tfi_nombre';
  V_TFI_VALOR := 'comboRatificacion';
  ...
  V_TFI_TAP_CODIGO := 'T013_RatificacionComite';
  V_TFI_TFI_NOMBRE := 'comboRatificacion';
  V_TFI_CAMPO := 'tfi_tipo';
  V_TFI_VALOR := 'comboinied';
