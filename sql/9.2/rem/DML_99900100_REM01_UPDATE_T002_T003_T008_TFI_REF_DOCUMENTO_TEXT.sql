...
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza CAMPOS refDocumento refEtiqueta sean TEXT
--## INSTRUCCIONES:
--## VERSIONES:
...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_TFI_CAMPO||' DE TABLA TFI PARA CAMPOS refDocumento refEtiqueta sean TEXT');



-- CAMBIO TIPO CAMPOS: NUMBER TO TEXT ------------------------------------------------
--T002_ObtencionDocumentoGestoria - refDocumento
--T002_ObtencionLPOGestorInterno - refDocumento
--T003_ObtencionEtiqueta - refEtiqueta
--T008_ObtencionDocumento - refDocumento

--T002_ObtencionDocumentoGestoria ----------------------------

  V_TFI_TAP_CODIGO := 'T002_ObtencionDocumentoGestoria';
  V_TFI_TFI_NOMBRE := 'refDocumento';
...
--T008_ObtencionDocumento ----------------------------
  ...
  V_TFI_TAP_CODIGO := 'T008_ObtencionDocumento';
  V_TFI_TFI_NOMBRE := 'refDocumento';
  V_TFI_CAMPO := 'TFI_TIPO';
  V_TFI_VALOR := 'text';
