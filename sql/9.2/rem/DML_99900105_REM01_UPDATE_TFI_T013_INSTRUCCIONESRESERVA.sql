...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTA filas de TFI_TAREAS_FORM_ITEMS - Campos tarea T013_InstruccionesReserva 
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TAP_CODIGO VARCHAR2(2400 CHAR):='T013_InstruccionesReserva'; -- Vble. auxiliar
