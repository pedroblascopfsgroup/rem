...
--## INCIDENCIA_LINK=HREOS-1863
--## PRODUCTO=NO
--##
--## Finalidad: INSERTA filas de TFI_TAREAS_FORM_ITEMS - Campos tarea T013_ResolucionExpediente
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T013_ResolucionExpediente',   			'combo',			'comboProcede',	  		'DDDevolucionReserva',			'Procede Devolución',						'',																		'' )
		);
      V_TMP_T_TFI T_TFI;
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO] Insertando datos de TFI_TAREAS_FORM_ITEMS - remapeo de tarea T013_ResolucionExpediente');
	...
	LOOP
        ...
        ' ,USUARIOMODIFICAR = ''HREOS-1863'', FECHAMODIFICAR = SYSDATE '||
