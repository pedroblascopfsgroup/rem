...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EPP_ESTADO_PROP_PRECIO los datos añadidos en T_ARRAY_DATA y elimina un registro específico.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(27 CHAR) := 'DD_EPP_ESTADO_PROP_PRECIO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(3 CHAR) := 'EPP'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
...
BEGIN	
	...
	LOOP
      ...
      END LOOP;
		...
		-- Eliminar registro estado 'cargada'.
		V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE DD_'||V_TEXT_CHARS||'_CODIGO = ''04''';
		EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
