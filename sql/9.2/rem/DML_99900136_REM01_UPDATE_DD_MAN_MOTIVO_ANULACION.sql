...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(27 CHAR) := 'DD_MAN_MOTIVO_ANULACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(3 CHAR) := 'MAN'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''HREOS-2175'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    --				CODIGO		DESCRIPCION							DESCRIPCION_LARGA
        T_TIPO_DATA('901',		'FINANCIACIÓN DENEGADA'	,			'FINANCIACIÓN DENEGADA'),
        T_TIPO_DATA('902',		'PBC DENEGADO',						'PBC DENEGADO')
    ); 
