...
--##########################################
--## AUTOR=Adrián Molina
--## FECHA_CREACION=20180613
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=REMVIP-4501
--## PRODUCTO=NO
--##
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.DD_COS_COMITES_SANCION WHERE DD_COS_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||'''';
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_COS_COMITES_SANCION '||
					...
					', USUARIOMODIFICAR = ''REMVIP-4501'' , FECHAMODIFICAR = SYSDATE '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_COS_COMITES_SANCION (' ||
                      ...
                      '(SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(4))||'''), 0, ''REMVIP-4501'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
    ...
    DBMS_OUTPUT.PUT_LINE('[FIN]: DICCIONARIO DD_COS_COMITES_SANCION MODIFICADO CORRECTAMENTE ');
