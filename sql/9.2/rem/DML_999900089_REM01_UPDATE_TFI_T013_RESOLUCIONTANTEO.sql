...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTA filas de TFI_TAREAS_FORM_ITEMS - Campos tarea T013_ResolucionTanteo
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T013_InstruccionesReserva',   			'combo',			'Tipo de arras',	  		'DDTiposArras',			'Tipo de arras',						'',																		'' )
		);
      V_TMP_T_TFI T_TFI;
...
BEGIN
	...
	LOOP
        ...
        ' ,USUARIOMODIFICAR = ''HREOS-1864'', FECHAMODIFICAR = SYSDATE '||
