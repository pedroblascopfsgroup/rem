...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_ADM_ADMINISTRACION los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ADM_ADMINISTRACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'ADM'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    --				CODIGO		DESCRIPCION							DESCRIPCION_LARGA
        T_TIPO_DATA('01'	,'Ayuntamiento'							,'Ayuntamiento'					),
        T_TIPO_DATA('02'	,'Consejería'							,'Consejería'						)
    ); 
