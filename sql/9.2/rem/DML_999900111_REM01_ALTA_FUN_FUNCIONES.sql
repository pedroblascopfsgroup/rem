...
--## INCIDENCIA_LINK=HREOS-1983
--## PRODUCTO=NO
--##
--## Finalidad: Script que para crear la función EDITAR_SELLO_CALIDAD y las asigna a los perfiles de 'HAYACAL', 'HAYASUPCAL' y 'HAYASUPER'.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    --			Descripción Larga														Descripción
      T_FUNCION('Permitir marcar el check de sello de calidad en los activos.',			'EDITAR_SELLO_CALIDAD')
    ); 
