...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	...
    	T_TIPO_DATA('''<p style="margin-bottom: 10px">Para dar por cumplimentada esta tarea deberá realizar el cierre económico del trabajo.</p><p>Para ello deberá cumplimentar los importes correspondientes a cada uno de los bloques de la pestaña "gestión económica" del trabajo.</p><p>Debe tener en cuenta que, una vez cumplimentada esta tarea, ya no podrá modificar los importes que se hayan hecho constar en la pestaña de "gestión económica", que serán los que se tomarán para el proceso de facturación.</p><p>En el campo "observaciones" puede hacer constar cualquier aspecto relevante que considere que debe quedar reflejado en este punto del trámite.</p><p>Esta tarea pone fin al trámite de actuación técnica.</p><p style="margin-bottom: 10px">Para ello deberá cumplimentar (...). Asimismo, en el caso de que el trabajo afecte a más de un activo, deberá validar en la pestaña de Listado de Activos que es correcto el porcentaje de participación de cada uno de ellos en el coste del trabajo.</p><p style="margin-bottom: 10px">Para ello deberá cumplimentar (...). Asimismo, en el caso de que el trabajo afecte a más de un activo, deberá validar en la pestaña de Listado de Activos que es correcto el porcentaje de participación de cada uno de ellos en el coste del trabajo.</p><p style="margin-bottom: 10px">Para ello deberá cumplimentar (...). Asimismo, en el caso de que el trabajo afecte a más de un activo, deberá validar en la pestaña de Listado de Activos que es correcto el porcentaje de participación de cada uno de ellos en el coste del trabajo.</p><p style="margin-bottom: 10px">Para ello deberá cumplimentar (...). Asimismo, en el caso de que el trabajo afecte a más de un activo, deberá validar en la pestaña de Listado de Activos que es correcto el porcentaje de participación de cada uno de ellos en el coste del trabajo.</p><p style="margin-bottom: 10px">Para ello deberá cumplimentar (...). Asimismo, en el caso de que el trabajo afecte a más de un activo, deberá validar en la pestaña de Listado de Activos que es correcto el porcentaje de participación de cada uno de ellos en el coste del trabajo.</p>''')
    );
