...
DECLARE
    ...
    V_USU_BORRAR VARCHAR2(30 CHAR) := '''HREOS-2053'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T013_InformeJuridico',   				'checkFechaEmisionInformeJuridico() ? mismoNumeroAdjuntosComoActivosExpedienteUGValidacion("26", "E") : "No todos los activos tienen fecha de emisión de informe en el listado de activos del expediente comercial." ')
		);
      V_TMP_T_TFI T_TFI;
