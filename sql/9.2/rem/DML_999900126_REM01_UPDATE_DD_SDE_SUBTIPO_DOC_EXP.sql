...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('05',                 '36'	                   ,'Plantilla propuesta'					      ,'Plantilla propuesta',               null),
        T_TIPO_DATA('01',                 '37'	                   ,'Ficha cliente'				                  ,'Ficha cliente',                     null)
    );
    ...
    LOOP
      ...
      IF V_NUM_TABLAS > 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(2)) ||'''');
            ...
            ', USUARIOMODIFICAR = ''HREOS-2681'' , FECHAMODIFICAR = SYSDATE '||
     ...
     ELSE
        ...
        V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_SDE_SUBTIPO_DOC_EXP (' ||
          ...
          'SELECT '|| V_ID ||
           ...
           ','''||TRIM(V_TMP_TIPO_DATA(5))||''', 0, ''HREOS-2681'',SYSDATE,0 FROM DUAL';
        EXECUTE IMMEDIATE V_MSQL;
