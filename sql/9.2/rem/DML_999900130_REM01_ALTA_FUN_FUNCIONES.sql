...
--## INCIDENCIA_LINK=HREOS-2139
--## PRODUCTO=NO
--##
--## Finalidad: Script que para crear la función BOTON_ANULAR_TRAMITE
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    --			Descripción Larga														Descripción
      T_FUNCION('Permitir anular un trámite desde tareas pendientes.',			'BOTON_ANULAR_TRAMITE')
    ); 
