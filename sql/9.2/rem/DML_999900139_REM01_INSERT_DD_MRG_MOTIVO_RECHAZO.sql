...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('F32' ,'El activo de bankia carece de nº inmovilizado Bankia', '1', 'INNER JOIN ACT_ACTIVO ACT ON ACT.ACT_NUM_ACTIVO = AUX.COD_ACTIVO INNER JOIN DD_CRA_CARTERA CRA ON CRA.DD_CRA_ID = ACT.DD_CRA_ID WHERE CRA.DD_CRA_CODIGO = ''''03'''' AND ACT.ACT_NUM_INMOVILIZADO_BNK IS NULL')
		); 
