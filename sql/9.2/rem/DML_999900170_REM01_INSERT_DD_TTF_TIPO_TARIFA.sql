...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    		T_TIPO_DATA('BK-ALQANTIOC1','Alquiler mensual de puerta antiocupa	','Alquiler mensual de puerta antiocupa	'),
		T_TIPO_DATA('BK-ALQANTIOC2','Alquiler mensual de panel	','Alquiler mensual de panel'),
		T_TIPO_DATA('ALQANTIOC1','Alquiler mensual de puerta antiocupa	','Alquiler mensual de puerta antiocupa	'),
		T_TIPO_DATA('ALQANTIOC2','Alquiler mensual de panel	','Alquiler mensual de panel')
		); 
