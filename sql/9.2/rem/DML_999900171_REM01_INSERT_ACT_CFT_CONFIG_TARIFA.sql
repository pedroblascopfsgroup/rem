...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''HREOS-3446'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    --				TIPO_TARIFA_CODIGO		TIPO_TRABAJO_CODIGO		TIPO_SUBTRABAJO_CODIGO		CARTERA_CODIGO		PRECIO_UNITARIO		UNIDAD_MEDIDA
        		T_TIPO_DATA('BK-ALQANTIOC1',		'03',				'58',				'03',			'52.00',		'Mes o fracción'),
       			T_TIPO_DATA('BK-ALQANTIOC2',		'03',				'58',				'03',			'31.00',		'Mes o fracción'),
       			T_TIPO_DATA('ALQANTIOC1',	    	'03',				'58',				'01',			'52.00',    		'Mes o fracción'),
      			T_TIPO_DATA('ALQANTIOC2',		'03',				'58',				'01',			'31.00',		'Mes o fracción'),
      			T_TIPO_DATA('ALQANTIOC1',		'03',				'58',				'02',			'52.00',    		'Mes o fracción'),
        		T_TIPO_DATA('ALQANTIOC2',    		'03',				'58',				'02',			'31.00',		'Mes o fracción'),
       			T_TIPO_DATA('ALQANTIOC1',		'03',				'58',				'06',			'52.00',    		'Mes o fracción'),
        		T_TIPO_DATA('ALQANTIOC2',	    	'03',				'58',				'06',			'31.00',		'Mes o fracción')
    ); 
