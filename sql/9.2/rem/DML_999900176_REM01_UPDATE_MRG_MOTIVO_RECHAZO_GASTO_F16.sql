...
BEGIN
    ...
    V_QUERY_ITER := 'WHERE AUX.ID_PRIMER_GASTO_SERIE IS NOT NULL AND NOT EXISTS 
    (SELECT * FROM GPV_GASTOS_PROVEEDOR GPV 
    JOIN GGE_GASTOS_GESTION GGE ON GPV.GPV_ID = GGE.GPV_ID JOIN DD_EAH_ESTADOS_AUTORIZ_HAYA EAH ON EAH.DD_EAH_ID = GGE.DD_EAH_ID AND EAH.DD_EAH_CODIGO = ''''03'''' 
