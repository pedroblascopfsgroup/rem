...
--## INCIDENCIA_LINK=HREOS-3686
--## PRODUCTO=NO
--## Finalidad: Updatear la condicion del rechazo F20 de la tabla DD_MRG_MOTIVO_RECHAZO
--##           
...
DECLARE
    ...
    V_MRG_CODIGO VARCHAR2(16 CHAR) := 'F20';  
...
BEGIN
    ...
    V_QUERY_ITER := 'WHERE (AUX.PRINCIPAL + AUX.RECARGO + AUX.INT_DEMORA + AUX.COSTAS + AUX.OTROS_INCREMENTOS + AUX.PROVISIONES_Y_SUPL) = 0'
	;
