...
--## ARTEFACTO=online
--## VERSION_ARTEFACTO= p2.0.13-180201-rem
--## INCIDENCIA_LINK=HREOS-3777
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade nuevos códigos en DD_SEG_SUBTIPO_ERROR_GASTO  
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	     T_TIPO_DATA('04' , '84' , '84 - Gasto NO autorizado' , '84 - Gasto NO autorizado' )
       ,T_TIPO_DATA('04' , '414' , '414 - TIPO OPERACIÓN INCOMPATIBLE CON IMPORTE' , '414 - TIPO OPERACIÓN INCOMPATIBLE CON IMPORTE' )
       ,T_TIPO_DATA('04' , '415' , '415 - ERROR EN DATOS CONEXIÓN' , '415 - ERROR EN DATOS CONEXIÓN' )
		); 
