...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('Carga masiva/Alta activo third party' ,'ALTA_ACTIVOS_THIRD_PARTY')
		); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''',0, ''HREOS-3876'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
