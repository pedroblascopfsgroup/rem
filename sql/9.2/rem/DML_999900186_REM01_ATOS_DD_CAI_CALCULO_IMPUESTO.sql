...
BEGIN
	...
	V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (DD_CAI_ID, DD_CAI_CODIGO, DD_CAI_DESCRIPCION, DD_CAI_DESCRIPCION_LARGA, USUARIOCREAR, FECHACREAR) 
	VALUES (S_'||V_TEXT_TABLA||'.NEXTVAL, ''01'', ''Vencido'', ''Vencido'', ''REMVIP-472'', SYSDATE)';
	EXECUTE IMMEDIATE V_MSQL;

	V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (DD_CAI_ID, DD_CAI_CODIGO, DD_CAI_DESCRIPCION, DD_CAI_DESCRIPCION_LARGA, USUARIOCREAR, FECHACREAR) 
	VALUES (S_'||V_TEXT_TABLA||'.NEXTVAL, ''02'', ''En voluntaria'', ''En voluntaria'', ''REMVIP-472'', SYSDATE)';
	EXECUTE IMMEDIATE V_MSQL;
