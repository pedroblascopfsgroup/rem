...
DECLARE
    ...
    --	CODIGO				DESCRIPCION					DESCRIPCION_LARGA		TIPO_TRABAJO_CODIGO
        T_TIPO_DATA('59',		'Retirada de vehículos'	,		'Retirada de vehículos',		'03'),
	T_TIPO_DATA('60',		'Desbroce/tala de árboles',		'Desbroce/tala de árboles',		'03'),
	T_TIPO_DATA('61',		'Copia de llaves'	,		'Copia de llaves',			'03'),
	T_TIPO_DATA('62',		'Informe ocupación'	,		'Informe ocupación',			'03'),
	T_TIPO_DATA('63',		'Limpieza de sumideros'	,		'Limpieza de sumideros',		'03'),
	T_TIPO_DATA('64',		'Destapiado'		,		'Destapiado',				'03'),
	T_TIPO_DATA('65',		'Contratación de Suministros',		'Contratación de Suministros',		'03'),
	T_TIPO_DATA('66',		'Desinfección'		,		'Desinfección',				'03'),
	T_TIPO_DATA('67',		'Desratización'		,		'Desratización',			'03'),
	T_TIPO_DATA('68',		'Protocolo post alquiler',		'Protocolo post alquiler',		'03'),
	T_TIPO_DATA('69',		'Revisión del informe inicial',		'Revisión del informe inicial',		'03'),
	T_TIPO_DATA('70',		'Consultas Ayuntamiento y Organismos',	'Consultas Ayuntamiento y Organismos',	'03'),
	T_TIPO_DATA('71',		'Visita tasador'	,		'Visita tasador',			'03'),
	T_TIPO_DATA('72',		'Cartelería'		,		'Cartelería',				'03'),
	T_TIPO_DATA('73',		'Visita venta cartera'	,		'Visita venta cartera',			'03')
    ); 
