...
BEGIN
    ...
    V_MSQL := 'SELECT usu.USU_ID,vga.ACT_ID
		...
		--insertamos en usd
		V_SQL := 'INSERT INTO '||V_ESQUEMA||'.USD_USUARIOS_DESPACHOS (USD_ID, USU_ID, DES_ID, USD_GESTOR_DEFECTO,USD_SUPERVISOR,VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES
