...
DECLARE
    ...
    --			Descripción														                                Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para publicaciones venta.',		            'MASIVO_PUBLICACION_VENTA'),
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para publicaciones alquiler.',		        'MASIVO_PUBLICACION_ALQUILER')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-1983'',SYSDATE,0 FROM DUAL';
    ...
    FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      LOOP
			...
			V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
						...
						' WHERE FUN.FUN_DESCRIPCION = '''||TRIM(V_TMP_FUNCION(2))||''' AND PEF.PEF_CODIGO IN (''HAYACAL'',''HAYASUPCAL'',''HAYASUPER'')';
