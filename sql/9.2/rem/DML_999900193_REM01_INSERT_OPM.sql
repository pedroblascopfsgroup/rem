...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMOV', 'Carga masiva ocultación venta', 'Carga masiva ocultación venta', 'MASIVO_OCULTACION_VENTA', 'nD*,s*,s'),
	  T_FUNCION('CMOA', 'Carga masiva ocultación alquiler', 'Carga masiva ocultación alquiler', 'MASIVO_OCULTACION_ALQUILER', 'nD*,s*,s')
    ); 
