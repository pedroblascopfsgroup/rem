...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('APV', 'Publicar activos en venta', 'Publicar activos en venta','MASIVO_PUBLICACION_VENTA','nD*,s,s'),
	  T_FUNCION('APA', 'Publicar activos en alquiler', 'Publicar activos en alquiler','MASIVO_PUBLICACION_ALQUILER','nD*,s,s')
    ); 
