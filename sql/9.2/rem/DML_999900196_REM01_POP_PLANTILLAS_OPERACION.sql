...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('PUBLICAR_ACTIVO_VENTA',   'plantillas/plugin/masivo/PublicarActivosVenta.xls',  'APV'),
    	T_TIPO_DATA('PUBLICAR_ACTIVO_ALQUILER',   'plantillas/plugin/masivo/PublicarActivosAlquiler.xls',  'APA')
    );
