...
DECLARE
    ...
    --			Descripción														                                Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para publicaciones venta restringido.',		            'MASIVO_PUBLICACION_VENTA_RESTRINGIDO'),
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para publicaciones alquiler restringido.',		            'MASIVO_PUBLICACION_ALQUILER_RESTRINGIDO')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-3956'',SYSDATE,0 FROM DUAL';
