...
--## INCIDENCIA_LINK=HREOS-4090,HREOS-4091
--## PRODUCTO=NO
--##
...
DECLARE
    ...
    --			Descripción														                                Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para ocultación venta de agrupaciones restringidas.',		          'MASIVO_OCULTACION_VENTA_RESTRINGIDA'),
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para ocultación alquiler de agrupaciones restringidas.',		        'MASIVO_OCULTACION_ALQUILER_RESTRINGIDA')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-4090,HREOS-4091'',SYSDATE,0 FROM DUAL';
