...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AGVR', 'Agrupaciones: Agrupar activos venta (Restringidos)', 'Agrupaciones: Agrupar activos venta (Restringidos)','MASIVO_PUBLICACION_VENTA_RESTRINGIDO','nD*'),
	  T_FUNCION('AGQR', 'Agrupaciones: Agrupar activos alquiler (Restringidos)', 'Agrupaciones: Agrupar activos alquiler (Restringidos)','MASIVO_PUBLICACION_ALQUILER_RESTRINGIDO','nD*')
    ); 
