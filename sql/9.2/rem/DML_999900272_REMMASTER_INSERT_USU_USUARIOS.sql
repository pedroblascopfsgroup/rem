...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('ficticioPbcBankia','pruebashrem@gmail.com'),
	T_TIPO_DATA('ficticioPbcSareb','pruebashrem@gmail.com'),
	T_TIPO_DATA('ficticioPbcLiberbank','pruebashrem@gmail.com')
    	); 
        ...
        ELSE
          ...
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
           ...
           V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.USU_USUARIOS (' ||
                      'USU_ID, USU_USERNAME, USU_MAIL, USU_FECHA_VIGENCIA_PASS,USU_GRUPO, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
                      'SELECT '|| V_ID || ','''||TRIM(V_TMP_TIPO_DATA(1))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''',SYSDATE,0,0,''REMVIP-568'',SYSDATE,0  FROM DUAL';
