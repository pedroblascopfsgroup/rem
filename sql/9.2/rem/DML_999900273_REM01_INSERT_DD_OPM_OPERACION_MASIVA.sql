...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('OVAR', 'Ocultar venta de agrupaciones restringidas',    'Ocultar venta de agrupaciones restringidas',    'MASIVO_OCULTACION_VENTA_RESTRINGIDA',   'nD*,s*,s'),
    T_FUNCION('OAAR', 'Ocultar alquiler de agrupaciones restringidas', 'Ocultar alquiler de agrupaciones restringidas', 'MASIVO_OCULTACION_ALQUILER_RESTRINGIDA','nD*,s*,s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-4090,HREOS-4091'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
