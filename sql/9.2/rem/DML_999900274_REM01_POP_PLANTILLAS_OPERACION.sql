...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('MASIVO_OCULTACION_VENTA_RESTRINGIDA',      'plantillas/plugin/masivo/OcultarVentasRestringida.xls',     'OVAR'),
    	T_TIPO_DATA('MASIVO_OCULTACION_ALQUILER_RESTRINGIDA',   'plantillas/plugin/masivo/OcultarAlquileresRestringida.xls', 'OAAR')
    );
