...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('22', 'Haya', 'Haya', '08'),
        T_TIPO_DATA('23', 'Liberbank Residencial', 'Liberbank Residencial', '08'),
        T_TIPO_DATA('24', 'Liberbank Singular / Terciario', 'Liberbank Singular / Terciario', '08'),
        T_TIPO_DATA('25', 'Liberbank Inversión Inmobiliaria', 'Liberbank Inversión Inmobiliaria', '08')
		); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_COS_COMITES_SANCION '||
					...
					', USUARIOMODIFICAR = ''HREOS-4112'' , FECHAMODIFICAR = SYSDATE '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_COS_COMITES_SANCION (' ||
                      ...
                      '(SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(4))||'''), 0, ''HREOS-4112'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
