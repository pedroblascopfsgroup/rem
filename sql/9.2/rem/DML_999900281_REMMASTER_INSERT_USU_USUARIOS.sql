...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      ...
      T_TIPO_DATA('grucoinv','1234','Grupo Comité de Inversiones Inmobiliarias', 1),
	    T_TIPO_DATA('grucoinm','1234','Grupo Comité Inmobiliario',                 1),
    	T_TIPO_DATA('grucodi' ,'1234','Grupo Comité de Dirección',                 1)
    ); 
