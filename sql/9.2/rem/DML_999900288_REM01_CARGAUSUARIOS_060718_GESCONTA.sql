...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'pcalonge' ,'Pedro' ,'Calonge '  ,'Martin'  ,'pcalonge@haya.es'  , 'WYPNLRCNEL'  ,'GESCONTA'  ,''  ,''),
		T_TIPO_DATA( 'adoamarante' ,'Allan' ,'Do Amarante'  ,'Silva'  ,'adoamarante@haya.es'  , 'EUFPAZXKFG'  ,'GESCONTA'  ,''  ,''),
		T_TIPO_DATA( 'jlconde' ,'JOSE LUIS CONDE HUELGA' ,''  ,''  ,'jlconde@haya.es'  , 'VVSULPRYTW'  ,'GESCONTA'  ,''  ,'')
  ); 
