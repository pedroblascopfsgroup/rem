...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'imartin' ,'ISAAC MARTIN URSULA' ,' '  ,''  ,'imartin@haya.es'  , 'HSGSPCECQW'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'lcarrillo' ,'Lorena' ,'Carrillo'  ,'Martinez'  ,'lcarrillo@externos.haya.es'  , 'HCWVDXLOZU'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'lmarcos' ,'Lucia' ,'Marcos'  ,'Esteban'  ,'lmarcos@externos.haya.es'  , 'LJCPXLVTBH'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'prodriguezg' ,'Patricia' ,'Rodriguez'  ,'Guzman'  ,'prodriguezg@externos.haya.es'  , 'VUGNCYUEOM'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'fmorenor' ,'Felix' ,'Moreno'  ,'Rubio'  ,'fmorenor@haya.es'  , 'AMLNCPGLIZ'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM')
  ); 
