...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AGAP', 'Agrupaciones: Agrupar activos (Proyecto)', 'Agrupaciones: Agrupar activos (Proyecto)','MASIVO_PROYECTO','nT*,nD*')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-4298'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
