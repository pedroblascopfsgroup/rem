...
--## INCIDENCIA_LINK=RECOVERY-12195
--## PRODUCTO=NO
--##
--## Finalidad: 
--## INSTRUCCIONES:
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('PRINEX','n*,n,n,s,s,s,s,s,i,f,s,s,s,i,i,i,s,i,i,i,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,s,f,s,s,i,s,s')
    ); 
