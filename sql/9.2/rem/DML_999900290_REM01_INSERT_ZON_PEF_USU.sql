...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
	  T_FUNCION('grulibres',			'PERFGCCLIBERBANK'),
	  T_FUNCION('grulibinvinm',			'PERFGCCLIBERBANK'),
	  T_FUNCION('grulibsinter',			'PERFGCCLIBERBANK'),
	  T_FUNCION('grucoinv',				'PERFGCCLIBERBANK'),
	  T_FUNCION('grucoinm',				'PERFGCCLIBERBANK'),
	  T_FUNCION('grucodi',				'PERFGCCLIBERBANK')    
    );
