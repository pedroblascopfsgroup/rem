...
DECLARE
    ...
    --			Descripción														                                Función
      T_FUNCION('Permitir modificar grid listado de comunidad/entidades de la pestaña ficha.',		            			'EDITAR_GRID_LISTADO_FICHA_COMUNIDAD_ENTIDADES'),
      T_FUNCION('Permitir modificar grid de las condiciones de la pestaña listado de activos de expediente.',		            			'EDITAR_GRID_INFROME_JURIDICO_EXPEDIENTE')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-4238'',SYSDATE,0 FROM DUAL';
