...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('GALQ'	,'Gestor de activo alquiler'				,'Gestor de activo alquiler'),
	T_TIPO_DATA('SUALQ'	,'Supervisor de activo alquiler'			,'Supervisor de activo alquiler'),
	T_TIPO_DATA('GEDI'	,'Gestor de activo edificación'				,'Gestor de activo edificación'),
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_TGE_TIPO_GESTOR (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''' ,'''||V_TMP_TIPO_DATA(2)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-4346'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
