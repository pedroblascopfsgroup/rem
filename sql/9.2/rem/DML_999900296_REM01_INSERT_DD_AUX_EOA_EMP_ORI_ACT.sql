...
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_AUX_EOA_EMP_ORI_ACT
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_AUX NUMBER(16);
    V_TABLA VARCHAR2(27 CHAR) := 'DD_AUX_EOA_EMP_ORI_ACT'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	T_TIPO_DATA_2('02038','BANKIA'),
	T_TIPO_DATA_2('02037','CAJA RIOJA'),
	T_TIPO_DATA_2('02042','CAIXA LAIETANA'),
	T_TIPO_DATA_2('02052','CAJA INSULAR'),
	T_TIPO_DATA_2('02069','CAJA SEGOVIA'),
	T_TIPO_DATA_2('02077','BANCAJA'),
	T_TIPO_DATA_2('02094','CAJA AVILA')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_EOA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
