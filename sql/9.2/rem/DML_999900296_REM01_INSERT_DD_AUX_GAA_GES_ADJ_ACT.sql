...
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_AUX_GAA_GES_ADJ_ACT
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_AUX NUMBER(16);
    V_TABLA VARCHAR2(27 CHAR) := 'DD_AUX_GAA_GES_ADJ_ACT'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	T_TIPO_DATA_2('1','COBIAN'),
	T_TIPO_DATA_2('2','CASES'),
	T_TIPO_DATA_2('3','GTREZ.LABRADOR'),
	T_TIPO_DATA_2('4','VALDARNO'),
	T_TIPO_DATA_2('5','GICSA'),
	T_TIPO_DATA_2('6','OTROS'),
	T_TIPO_DATA_2('7','PROCURADOR'),
	T_TIPO_DATA_2('8','MONTALVO'),
	T_TIPO_DATA_2('9','MUNDIGESTION'),
	T_TIPO_DATA_2('10','GARSA'),
	T_TIPO_DATA_2('11','UNIGES'),
	T_TIPO_DATA_2('12','PINOS XXI')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_AUX_GAA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
				...
				IF V_AUX = 0 THEN 
				  ...
				  V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (		  
					  DD_AUX_GAA_ID
					, DD_AUX_GAA_CODIGO
					, DD_AUX_GAA_DESCRIPCION
					, DD_AUX_GAA_DESCRIPCION_LARGA
					, USUARIOCREAR
					, FECHACREAR
					) VALUES (
					  S_'||V_TABLA||'.NEXTVAL
