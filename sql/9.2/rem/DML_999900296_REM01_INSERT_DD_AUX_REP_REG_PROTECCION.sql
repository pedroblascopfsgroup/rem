...
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_AUX_REP_REG_PROTECCION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_AUX NUMBER(16);
    V_TABLA VARCHAR2(27 CHAR) := 'DD_AUX_REP_REG_PROTECCION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	T_TIPO_DATA_2('01','V.P.O.'),
	T_TIPO_DATA_2('02','V.P.O. ANT. 78'),
	T_TIPO_DATA_2('03','V.P.O. PRIVADA'),
	T_TIPO_DATA_2('04','V.P.O. PUBLICA'),
	T_TIPO_DATA_2('05','VENTA LIBRE'),
	T_TIPO_DATA_2('06','V.P.T.'),
	T_TIPO_DATA_2('07','SUBVENCIONADA')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_AUX_REP_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
				...
				IF V_AUX = 0 THEN 
				  ...
				  V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (		  
					  DD_AUX_REP_ID
					, DD_AUX_REP_CODIGO
					, DD_AUX_REP_DESCRIPCION
					, DD_AUX_REP_DESCRIPCION_LARGA
					, USUARIOCREAR
					, FECHACREAR
					) VALUES (
					  S_'||V_TABLA||'.NEXTVAL
