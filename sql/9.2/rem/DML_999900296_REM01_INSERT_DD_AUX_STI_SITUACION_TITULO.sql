...
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_AUX_STI_SITUACION_TITULO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	T_TIPO_DATA_2('0','DESCONOCIDO'),
	T_TIPO_DATA_2('1','NULO'),
	T_TIPO_DATA_2('2','INSCRITO'),
	T_TIPO_DATA_2('3','SUBSANAR'),
	T_TIPO_DATA_2('4','IMPOSIBLE INSCRIPCION'),
	T_TIPO_DATA_2('5','INMATRICULADOS')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_AUX_STI_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
				...
				IF V_AUX = 0 THEN 
				  ...
				  V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (		  
					  DD_AUX_STI_ID
					, DD_AUX_STI_CODIGO
					, DD_AUX_STI_DESCRIPCION
					, DD_AUX_STI_DESCRIPCION_LARGA
					, USUARIOCREAR
					, FECHACREAR
					) VALUES (
					  S_'||V_TABLA||'.NEXTVAL
