...
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_AUX_TTS_TIPO_TASACION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	T_TIPO_DATA_2('00','NO ESPECIFICADO'),
	T_TIPO_DATA_2('01','CONCESION OPERACION'),
	T_TIPO_DATA_2('02','TASACION ADJUDICACION'),
	T_TIPO_DATA_2('03','TASACION EXTERNA'),
	T_TIPO_DATA_2('04','OTRAS TASACIONES'),
	T_TIPO_DATA_2('05','ASESORAMIENTO COMERCIAL'),
	T_TIPO_DATA_2('06','DACION'),
	T_TIPO_DATA_2('07','COMPRA'),
	T_TIPO_DATA_2('08','PRESTAMO DUDOSO'),
	T_TIPO_DATA_2('09','TASACION ESTADISTICA'),
	T_TIPO_DATA_2('10','VALORACION COMERCIAL'),
	T_TIPO_DATA_2('11','TASACION DE VENTA RÁPIDA')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_AUX_TTS_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
				...
				IF V_AUX = 0 THEN 
				  ...
				  V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (		  
					  DD_AUX_TTS_ID
					, DD_AUX_TTS_CODIGO
					, DD_AUX_TTS_DESCRIPCION
					, DD_AUX_TTS_DESCRIPCION_LARGA
					, USUARIOCREAR
					, FECHACREAR
					) VALUES (
					  S_'||V_TABLA||'.NEXTVAL
