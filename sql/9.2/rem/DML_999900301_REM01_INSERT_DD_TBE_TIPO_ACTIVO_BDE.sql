...
--## INCIDENCIA_LINK=REMVIP-1446
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_TBE_TIPO_ACTIVO_BDE
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USUARIO VARCHAR2(32 CHAR) := 'REMVIP-1446';
 ...
 -- ARRAY PARA LA REACTIVACIÓN DE AGRUPACIONES
    ...
    --		DD_OFR_COD	DD_EEC_COD	DD_ERE_COD	 INDICE
		T_TIPO_DATA_2('01','EDIFIC EN CONSTRUC OBRA PARADA')
	); 
