...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('lib.sbravo','Liberbank'),
      T_FUNCION('lib.jgil','Liberbank'),
      T_FUNCION('lib.smacanas','Liberbank'),
      T_FUNCION('lib.gcampillo','Liberbank'),
      T_FUNCION('lib.aortega','Liberbank')
    ); 
