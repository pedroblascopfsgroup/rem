...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-1645'; -- USUARIO CREAR/MODIFICAR
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('usugrurba', 'fmorenor'),
      T_FUNCION('usugrubac', 'fmorenor'),
      T_FUNCION('usugrurba', 'lcarrillo'),
      T_FUNCION('usugrubac', 'lcarrillo'),
