...
DECLARE
    ...
    V_NUM_CELL NUMBER(16); -- Vble. para validar la existencia de un registro.
...
BEGIN	
	...
	V_SQL := 'SELECT COUNT(1) FROM ACT_PRO_PROPIETARIO WHERE TRIM(PRO_NOMBRE) = ''Vauxhall Propiedades SLU''';
	
	EXECUTE IMMEDIATE V_SQL INTO V_NUM_CELL;
	
	IF V_NUM_CELL <= 0
	
	THEN DBMS_OUTPUT.PUT_LINE('[ERROR] NO EXISTE EL PROVEEDOR Vauxhall Propiedades SLU');
