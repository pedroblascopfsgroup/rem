...
DECLARE
    ...
    --			 USU_USERNAME	DES_DESPACHO
      T_FUNCION('fmorenor',		'REMSUPCOM'),
      T_FUNCION('fmorenor',		'REMGBOINM'),
	  T_FUNCION('lcarrillo',	'REMSUPCOM'), 
      T_FUNCION('lcarrillo',	'REMGBOINM'),
      T_FUNCION('lmarcos',      'REMSUPCOM'),
      T_FUNCION('lmarcos',      'REMGBOINM'),
