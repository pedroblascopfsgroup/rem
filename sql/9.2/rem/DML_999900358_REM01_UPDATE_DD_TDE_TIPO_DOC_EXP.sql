...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('01','Identificación'         ,'1.- Identificación'        ,'1'),
        T_TIPO_DATA('02','Tanteo'                 ,'4.- Tanteo'                ,'1'),
        T_TIPO_DATA('03','Reserva'                ,'3.- Reserva'               ,'1'),
        T_TIPO_DATA('04','Formalización'          ,'5.- Formalización'         ,'1'),
        T_TIPO_DATA('05','Sanción'                ,'2.- Sanción'               ,'1'),
        T_TIPO_DATA('06','Documentos de alquiler' ,'6.- Documentos de alquiler','2')
    );
    ...
    LOOP
      ...
      IF V_NUM_TABLAS > 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(3)) ||'''');
          ...
          'SET ' ||
          'DD_TOF_ID = '''||TRIM(V_TMP_TIPO_DATA(4))||''''||
      ...
      ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_TDE_TIPO_DOC_EXP.NEXTVAL FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_TDE_TIPO_DOC_EXP (' ||
                      'DD_TDE_ID, DD_TDE_CODIGO, DD_TDE_DESCRIPCION, DD_TDE_DESCRIPCION_LARGA, VERSION, DD_TOF_ID, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''', 0, '''||TRIM(V_TMP_TIPO_DATA(4))||''', ''HREOS-4373'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
