...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-2334';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('033' ,'Garalma de Inversiones S.L','Garalma de Inversiones S.L','11'),
        T_TIPO_DATA('034' ,'Inmoinvertia Offerhouse S.L','Inmoinvertia Offerhouse S.L','11'),
        T_TIPO_DATA('035' ,'Vimergo S.L','Vimergo S.L','11')
		); 
