...
--## INCIDENCIA_LINK=REMVIP-2248
--## PRODUCTO=NO
--##
--## Finalidad: Insercion inicial DD_CCO_CATEGORIA_CONTABLE
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USUARIO VARCHAR2(32 CHAR) := 'REMVIP-2248';
 ...
 -- ARRAY PARA LA REACTIVACIÓN DE AGRUPACIONES
    ...
    --		DD_OFR_COD	DD_EEC_COD	DD_ERE_COD	 INDICE
		T_TIPO_DATA_2('I','Inmovilizado'),
		T_TIPO_DATA_2('E','Existencias'),
		T_TIPO_DATA_2('N','Activo No Corriente')
	); 
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_CCO_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
