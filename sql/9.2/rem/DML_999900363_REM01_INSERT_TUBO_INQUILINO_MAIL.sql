...
--## PRODUCTO=NO
--##
--## Finalidad: Insertar valores en TUBO_INQUILINO_ENVIO_MAIL
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLE VARCHAR2(27 CHAR) := 'TUBO_INQUILINO_ENVIO_MAIL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('noreply.rem@pfsgroup.es' , 'bo.alquileres@haya.es' , null , 'REM con fecha #fecha ha generado los Excels adjuntos con la información de los inquilinos de las ofertas posicionadas para su firma' , 'Tubos Prinex inquilinos ofertas alquiler REM #fecha')
    );
