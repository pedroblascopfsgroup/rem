...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('3'	,'09','Hipoteca','Hipoteca'),
        T_TIPO_DATA('3'	,'010','Embargo','Embargo'),
	T_TIPO_DATA('3'	,'011','Condición resolutoria','Condición resolutoria'),
        T_TIPO_DATA('3'	,'012','Afección urbanística','Afección urbanística'),
	T_TIPO_DATA('3'	,'013','Otros','Otros'),
        T_TIPO_DATA('3'	,'014','Impuesto','Impuesto'),
	T_TIPO_DATA('3'	,'015','Com. Propietarios','Com. Propietarios')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||''' - '''|| TRIM(V_TMP_TIPO_DATA(2))||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
					...
					', USUARIOMODIFICAR = ''REMVIP-2402'' , FECHAMODIFICAR = SYSDATE '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''' ,0, ''REMVIP-2402'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
