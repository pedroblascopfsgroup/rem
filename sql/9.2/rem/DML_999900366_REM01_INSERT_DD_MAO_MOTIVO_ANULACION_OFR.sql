...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_MAO_MOTIVO_ANULACION_OFR los posibles motivos de anulación de una oferta
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01'	,'Tiempo de tramitación de la oferta', 'Tiempo de tramitación de la oferta'),
	T_TIPO_DATA('02'	,'Perdida de interés en el inmueble', 'Perdida de interés en el inmueble'),
	T_TIPO_DATA('03'	,'No aceptación del cliente condiciones oferta aprobada', 'No aceptación del cliente condiciones oferta aprobada')
    ); 
