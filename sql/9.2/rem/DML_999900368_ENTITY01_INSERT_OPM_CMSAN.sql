...
--## PRODUCTO=NO
--##
--## Finalidad: Script que crea el tipo de operación masiva de Carga Masiva Sanciones
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMSAN', 'Carga Masiva Sanciones', 'Carga Masiva Sanciones','CARGA_MASIVA_SANCION','n*,f*,s*,s,s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-4915'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
