...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('4'	,'420','El tipo de operación no admite','El tipo de operación no admite impuestos indirectos'),
        T_TIPO_DATA('4'	,'421','Factura con tipo de impuesto','Factura con tipo de impuesto sin subtipo'),
	T_TIPO_DATA('4'	,'422','Factura sin tipo de impuesto','Factura sin tipo de impuesto con subtipo'),
	T_TIPO_DATA('4'	,'423','Factura sin impuesto indirecto','Factura sin impuesto indirecto con porcentaje de impuesto')
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''' ,0, ''REMVIP-2572'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
