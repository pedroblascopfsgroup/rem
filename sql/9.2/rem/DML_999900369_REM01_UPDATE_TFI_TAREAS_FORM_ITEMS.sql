...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_VerificarSeguroRentas','combo','motivoRechazo'),
	T_TIPO_DATA('T015_AceptacionCliente','combo','motivoAC')
    );
...
BEGIN
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS
		   SET TFI_BUSINESS_OPERATION = null, TFI_TIPO = ''textarea'',
