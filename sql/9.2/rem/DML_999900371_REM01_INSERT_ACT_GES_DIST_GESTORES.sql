...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USU VARCHAR2(2400 CHAR) := 'REMVIP-2577';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
			...
			T_TIPO_DATA('GFORM','3','','','8','','','vmoreno'),
			T_TIPO_DATA('GFORM','3','','','17','','','vmoreno'),
			T_TIPO_DATA('GFORM','3','','','25','','','vmoreno'),
			T_TIPO_DATA('GFORM','3','','','43','','','vmoreno')
	...
	IF (V_TMP_TIPO_DATA(6) is not null)  THEN
        ...
        END IF;
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (' ||
						...
						', '''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','||TRIM(V_TMP_TIPO_DATA(5))||' ' ||
