...
DECLARE
    ...
    --			Descripción														                            Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para desocultar activos ocultos venta.', 'MASIVO_DESOCULTAR_ACTIVOS_VENTA'),
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para desocultar activos ocultos alquiler.', 'MASIVO_DESOCULTAR_ACTIVOS_ALQUILER')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''REMVIP-2662'',SYSDATE,0 FROM DUAL';
