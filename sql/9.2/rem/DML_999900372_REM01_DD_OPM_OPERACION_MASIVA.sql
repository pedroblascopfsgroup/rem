...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMDOV', 'Carga masiva desocultación venta', 'Carga masiva desocultación venta','MASIVO_DESOCULTAR_ACTIVOS_VENTA','nD*'),
	  T_FUNCION('CMDOA', 'Carga masiva desocultación alquiler', 'Carga masiva desocultación alquiler','MASIVO_DESOCULTAR_ACTIVOS_ALQUILER','nD*')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''REMVIP-2662'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
