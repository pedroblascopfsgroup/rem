...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('MASIVO_DESOCULTACION_VENTA', 'plantillas/plugin/masivo/MASIVO_DESOCULTACION_VENTA.xls', 'CMDOV'),
		  T_FUNCION('MASIVO_DESOCULTACION_ALQUILER', 'plantillas/plugin/masivo/MASIVO_DESOCULTACION_ALQUILER.xls', 'CMDOA')
    ); 
