...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'grupobc02' ,'Grupo BC' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		T_TIPO_DATA( 'mediterraneo02' ,'Mediterraneo' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		T_TIPO_DATA( 'gestinova02' ,'Gestinova' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		T_TIPO_DATA( 'emais02' ,'Emais' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		T_TIPO_DATA( 'f&g02' ,'F&G' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		
		T_TIPO_DATA( 'maretra03' ,'Maretra' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'qipert03' ,'Qipert' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'grupobc03' ,'Grupo BC' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'mediterraneo03' ,'Mediterraneo' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'gestinova03' ,'Gestinova' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'emais03' ,'Emais' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM'),
		T_TIPO_DATA( 'f&g03' ,'F&G' ,'Formalización'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'GESTIAFORM'  ,''  ,'GESTORIAFORM')
