...
--## PRODUCTO=NO
--##
--## Finalidad: Actualiza el plazo de la tarea "T013_InformeJuridico" en DD_PTP_PLAZOS_TAREAS_PLAZAS.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''HREOS-2128'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    V_TFI T_ARRAY_TFI := T_ARRAY_TFI(
		...
		T_TFI(   'T013_InformeJuridico',   				'2*24*60*60*1000L')
		);
      V_TMP_T_TFI T_TFI;
