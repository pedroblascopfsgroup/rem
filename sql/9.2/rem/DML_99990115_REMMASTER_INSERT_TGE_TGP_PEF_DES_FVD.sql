...
DECLARE
    ...
    --				CODIGO		DESCRIPCION									DESCRIPCION_LARGA
    	T_TIPO_DATA('FVDNEG'		,'Gestor FVD de negocio'				,'Gestor FVD de negocio'		),
    	T_TIPO_DATA('FVDBACKOFR'	,'Gestor FVD de Backoffice de oferta'	,'Gestor FVD de Backoffice de oferta'		),
    	T_TIPO_DATA('FVDBACKVNT'	,'Gestor FVD de Backoffice de venta'	,'Gestor FVD de Backoffice de venta'		)
    ); 
	...
	--				DES_DESPACHO	TDE_TIPO_DESPACHO
	    T_TIPO_DES('REMFVDNEG',		'FVDNEG'		),
	    T_TIPO_DES('REMFVDBACKOFR',	'FVDBACKOFR'		),
	    T_TIPO_DES('REMFVDBACKVNT',	'FVDBACKVNT'		)
	); 
