...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AMIE', 'Lista de activos: Marcar IBI Exento', 'Lista de activos: Marcar IBI Exento','SUBIR_LISTA_ACTIVOS_IBI','nD*'),
	  T_FUNCION('ADIE', 'Lista de activos: Desmarcar IBI Exento', 'Lista de activos: Desmarcar IBI Exento','SUBIR_LISTA_ACTIVOS_IBI','nD*')
    ); 
