...
DECLARE
    ...
    --				CODIGO		DESCRIPCION				DESCRIPCION_LARGA
    	T_TIPO_DATA('SUPFVD'	,'Supervisor FVD'	,'Supervisor de Fuerza de Venta Directa'		)
    ); 
	...
	--				CODIGO	  			DESCRIPCION	 			DESCRIPCION_LARGA   
		T_TIPO_PEF('SUPFVD', 		'Supervisor FVD',	'Supervisor de Fuerza de Venta Directa'	)
	); 
