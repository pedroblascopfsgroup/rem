...
DECLARE
    ...
    V_TFI_TFI_TIPO VARCHAR2(100 CHAR) := 'combo';

    --CAMPO TFI PARA ACTUALIZAR
    V_TFI_CAMPO VARCHAR2(100 CHAR)  := 'tfi_nombre';
    V_TFI_VALOR VARCHAR2(4000 CHAR) := 'tipoArras';
...
-- CAMBIO EN NOMBRE DE CAMPO TFI BUSCANDO POR TIPO Y TAREA-----------------------------

--T013_InstruccionesReserva ----------------------------

  V_TFI_TAP_CODIGO := 'T013_InstruccionesReserva';
  V_TFI_TFI_TIPO := 'combo';
  V_TFI_CAMPO := 'tfi_nombre';
  V_TFI_VALOR := 'tipoArras';
