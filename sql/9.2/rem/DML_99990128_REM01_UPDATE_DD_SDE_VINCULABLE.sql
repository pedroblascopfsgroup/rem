...
--##			- NO ESTABLECE LOS QUE NO SON VINCULABLES, el resto se dejan como estaban			
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_CODIGOS_SDE_VINCULABLES VARCHAR2(2400 CHAR) := '
    ''05'',
    ''06'',
    ''09'',
    ''10'',
...
/* HABLADO CON DANI: EL RESTO DE CODIGOS SE DEJAN COMO ESTABAN, NO SE REDEFINEN A NO VINCULABLES
