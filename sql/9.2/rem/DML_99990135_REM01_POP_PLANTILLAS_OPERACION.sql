...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('LISTADO_ACTIVOS_MARCAR_IBI','plantillas/plugin/masivo/LISTADO_ACTIVOS_MARCAR_IBI.xls'		,'AMIE'),
    	T_TIPO_DATA('LISTADO_ACTIVOS_DESMARCAR_IBI','plantillas/plugin/masivo/LISTADO_ACTIVOS_DESMARCAR_IBI.xls'		,'ADIE')
    ); 
