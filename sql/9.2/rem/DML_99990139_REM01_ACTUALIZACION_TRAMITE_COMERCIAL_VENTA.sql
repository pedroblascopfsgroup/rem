...
--##########################################
--## AUTOR=CARLOS PONS
--## FECHA_CREACION=20170822
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2.0-X
--## INCIDENCIA_LINK=0
--## PRODUCTO=SI
--##
...
DECLARE
    ...
    --		   TAP_CODIGO								TFI_ORDEN	TFI_TIPO		TFI_NOMBRE				TFI_LABEL															TFI_ERROR_VALIDACION							TFI_VALIDACION									TFI_BUSINESS_OPERATION
		T_TFI('T013_ResolucionExpediente'				,'4'		,'textinf'  ,'estadoReserva'			,'Estado reserva'														,''												,''												,''					),
    T_TFI('T013_ResolucionExpediente'       ,'5'    ,'textarea' ,'observaciones'      ,'Observaciones'                            ,''                       ,''                       ,''         )
		);
    V_TMP_T_TFI T_TFI;
