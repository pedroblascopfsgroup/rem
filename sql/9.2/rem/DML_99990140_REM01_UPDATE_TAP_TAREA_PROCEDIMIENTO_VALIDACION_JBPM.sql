...
--## FECHA_CREACION=20170829
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=HREOS-2677
--## PRODUCTO=NO
--##
--## Finalidad: Actualiza la postcondición de la tarea "T013_InstruccionesReserva" para validar los documentos.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_USU_BORRAR VARCHAR2(30 CHAR) := '''HREOS-2677'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
