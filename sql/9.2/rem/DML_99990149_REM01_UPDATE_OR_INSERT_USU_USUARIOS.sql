...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	  ...
	  T_TIPO_DATA('acasero', 'Adrián', 'Casero', 'Barrera', 'acasero@haya.es', '1234', 'HAYAGESTCOM', '', 'REMGCOM'),
	  T_TIPO_DATA('aurena', 'Angel Custodio', 'Ureña', 'Hermosilla', 'aurena@haya.es', '1234', 'HAYACONSU', '', ''),
	  T_TIPO_DATA('jbacciadone', 'Juan', 'Facundo', 'Bacciadone', 'jbacciadone@haya.es', '1234', 'HAYACONSU', '', ''),
	  T_TIPO_DATA('gpradena', 'German', 'De Pradena', 'Carballido', 'gpradena@haya.es', '1234', 'HAYACONSU', '', ''),
