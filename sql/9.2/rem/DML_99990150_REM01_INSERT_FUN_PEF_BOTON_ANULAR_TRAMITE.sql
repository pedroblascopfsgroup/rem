...
DECLARE
    ...
    --				CODIGO		DESCRIPCION				DESCRIPCION_LARGA
    	T_TIPO_DATA('HAYAGBOINM'	,'Gestor Comercial Backoffice Inmobiliario'		,'Gestor Comercial Backoffice Inmobiliario'		),
    	T_TIPO_DATA('HAYASBOINM'	,'Supervisor Comercial Backoffice Inmobiliario'	,'Supervisor Comercial Backoffice Inmobiliario'		),
    	T_TIPO_DATA('HAYAGBOFIN'	,'Gestor Comercial Backoffice Financiero'		,'Gestor Comercial Backoffice Financiero'		),
    	T_TIPO_DATA('HAYASBOFIN'	,'Supervisor Comercial Backoffice Financiero'	,'Supervisor Comercial Backoffice Financiero'		),
    	T_TIPO_DATA('GESRES'		,'Gestor de reserva (Cajamar)'					,'Gestor de reserva (Cajamar)'		),
    	T_TIPO_DATA('SUPRES'		,'Supervisor de reserva (Cajamar)'				,'Supervisor de reserva (Cajamar)'		),
    	T_TIPO_DATA('GESMIN'		,'Gestor de minuta (Cajamar)'					,'Gestor de minuta (Cajamar)'		),
    	T_TIPO_DATA('SUPMIN'		,'Supervisor de minuta (Cajamar)'				,'Supervisor de minuta (Cajamar)'		)
    ); 
	...
	--				DES_DESPACHO	TDE_TIPO_DESPACHO
	    T_TIPO_DES('REMGBOINM',	'HAYAGBOINM'		),
	    T_TIPO_DES('REMSBOINM',	'HAYASBOINM'		),
	    T_TIPO_DES('REMGBOFIN',	'HAYAGBOFIN'		),
	    T_TIPO_DES('REMSBOFIN',	'HAYASBOFIN'		),
	    T_TIPO_DES('REMGESRES',	'GESRES'		),
	    T_TIPO_DES('REMSUPRES',	'SUPRES'		),
	    T_TIPO_DES('REMGESMIN',	'GESMIN'		),
	    T_TIPO_DES('REMSUPMIN',	'SUPMIN'		)
	); 
	...
	--				CODIGO	  			DESCRIPCION	 							DESCRIPCION_LARGA   
		T_TIPO_PEF('HAYAGBOINM'	,'Gestor Comercial Backoffice Inmobiliario'		,'Gestor Comercial Backoffice Inmobiliario'		),
    	T_TIPO_PEF('HAYASBOINM'	,'Supervisor Comercial Backoffice Inmobiliario'	,'Supervisor Comercial Backoffice Inmobiliario'		),
    	T_TIPO_PEF('HAYAGBOFIN'	,'Gestor Comercial Backoffice Financiero'		,'Gestor Comercial Backoffice Financiero'		),
    	T_TIPO_PEF('HAYASBOFIN'	,'Supervisor Comercial Backoffice Financiero'	,'Supervisor Comercial Backoffice Financiero'		),
    	T_TIPO_PEF('GESRES'		,'Gestor de reserva (Cajamar)'					,'Gestor de reserva (Cajamar)'		),
    	T_TIPO_PEF('SUPRES'		,'Supervisor de reserva (Cajamar)'				,'Supervisor de reserva (Cajamar)'		),
    	T_TIPO_PEF('GESMIN'		,'Gestor de minuta (Cajamar)'					,'Gestor de minuta (Cajamar)'		),
    	T_TIPO_PEF('SUPMIN'		,'Supervisor de minuta (Cajamar)'				,'Supervisor de minuta (Cajamar)'		)
	); 
