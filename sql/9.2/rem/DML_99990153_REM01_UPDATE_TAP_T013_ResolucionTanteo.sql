...
BEGIN
		...
		IF V_NUM_TABLAS > 0 THEN
		    ...
		    V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' SET TAP_SCRIPT_VALIDACION_JBPM = ''existeAdjuntoUGValidacion("13,E") == "" ? valores[''''T013_ResolucionTanteo''''][''''comboEjerce''''] == DDSiNo.SI ? (checkEjercidoTanteo() ? null : ''''No existe ningún activo del expediente con tanteo Ejercido'''') : (checkRenunciaTanteo() ? null : ''''Existe algún activo del expediente sin tanteo Renuncia'''') : existeAdjuntoUGValidacion("13,E")'''  || 
