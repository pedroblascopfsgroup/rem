...
--## INCIDENCIA_LINK=HREOS-2812
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza usuario 'acasero'
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
  ...
  V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-2812';
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	  ...
	  T_TIPO_DATA('gesres', 'Gestor de reserva (Cajamar)', '', '', 'gesres@haya.es', '1234', '1','GESRES', 'gesres', 'REMGESRES'),
	  T_TIPO_DATA('gesmin', 'Gestor de minuta (Cajamar)', '', '', 'gesmin@haya.es', '1234', '1','GESMIN', 'gesmin', 'REMGESMIN'),
	  T_TIPO_DATA('supres', 'Supervisor de reserva (Cajamar)', '', '', 'supres@haya.es', '1234', '1', 'SUPRES', 'supres', 'REMSUPRES'),
	  T_TIPO_DATA('supmin', 'Supervisor de minuta (Cajamar)', '', '', 'supmin@haya.es', '1234', '1', 'SUPMIN', 'supmin', 'REMSUPMIN')
