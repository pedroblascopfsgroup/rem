...
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza el Trámite de Obtención Documental
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TAP_TAP_CODIGOS VARCHAR2(4000 CHAR) := ' ''T002_SolicitudDocumentoGestoria'' ';

    --CAMPO TFI PARA ACTUALIZAR
    V_PTP_CAMPO VARCHAR2(100 CHAR)  := 'DD_PTP_PLAZO_SCRIPT';
    V_PTP_VALOR VARCHAR2(1000 CHAR) := '25*24*60*60*1000L';

BEGIN 
  
  DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZANDO CAMPO '||V_PTP_CAMPO||' DE TABLA DD_PTP_PLAZOS_TAREAS_PLAZAS PARA T. OBTENCION DOCUMENTAL - PLAZOS');



  --''T002_SolicitudDocumentoGestoria'' - 25 Días ----
