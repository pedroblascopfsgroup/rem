...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] ');
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar registro existente ');
      V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE DD_OPM_CODIGO = ''ACGA''';
	  ...
	  ELSE
	      DBMS_OUTPUT.PUT_LINE('[INFO]: No se ha encontrado el registro , no se continua...');
      END IF;
