...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('38'	,'Aprobación PBC'				,'Aprobación PBC'				,'05'	,'OP-09-ACUI-06'),
        T_TIPO_DATA('39'	,'Estudio de mercado'			,'Estudio de mercado'			,'05'	,'OP-09-ESIN-18'),
        T_TIPO_DATA('40'	,'Ficha técnica'				,'Ficha técnica'				,'05'	,'OP-09-FICH-11'),
        T_TIPO_DATA('41'	,'Informe fiscal'				,'Informe fiscal'				,'05'	,'OP-09-ESIN-86'),
        T_TIPO_DATA('42'	,'Correo electrónico'			,'Correo electrónico'			,'05'	,'OP-09-CORR-2')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
					...
					', USUARIOMODIFICAR = ''HREOS-2858'' , FECHAMODIFICAR = SYSDATE '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ', (SELECT DD_TDE_ID FROM DD_TDE_TIPO_DOC_EXP WHERE DD_TDE_CODIGO = '''||V_TMP_TIPO_DATA(4)||'''), '''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', '''||TRIM(V_TMP_TIPO_DATA(5))||''', 0, ''HREOS-2858'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
