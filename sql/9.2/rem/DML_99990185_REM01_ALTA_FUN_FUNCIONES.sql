...
--## PRODUCTO=NO
--##
--## Finalidad: Script que para crear la función SUBIR_CARGA_GESTORES y las asigna a los perfiles de 'HAYASUPER'.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    --			Descripción Larga														Descripción
      T_FUNCION('Permitir subir excel masivo para agregar gestores.',			'SUBIR_CARGA_GESTORES')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-3116'',SYSDATE,0 FROM DUAL';
    ...
    FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      LOOP
			...
			V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
						...
						' SELECT FUN.FUN_ID, PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, ''HREOS-3116'', SYSDATE, 0' ||
