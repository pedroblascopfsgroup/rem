...
BEGIN	
	...
	SET USUARIOMODIFICAR = ''HREOS-3330'', FECHAMODIFICAR = SYSDATE, DD_TPE_ID = (SELECT DD_TPE_ID FROM DD_TPE_TIPOS_PERIOCIDAD WHERE DD_TPE_CODIGO = ''01'')  
	WHERE GPV.DD_TPE_ID = (SELECT DD_TPE_ID FROM DD_TPE_TIPOS_PERIOCIDAD WHERE DD_TPE_CODIGO = ''08'') ';
