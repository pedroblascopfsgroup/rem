...
DECLARE
    ...
    V_ID NUMBER(16);
	V_USUARIO VARCHAR2(100 CHAR):= 'HREOS-3624';
    
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('23' ,'Blue Earth Invest, S.L.'		,'Blue Earth Invest, S.L.'		,'10'),
        T_TIPO_DATA('24' ,'Tifios, S.L.'				,'Tifios, S.L.'					,'10')
		); 
