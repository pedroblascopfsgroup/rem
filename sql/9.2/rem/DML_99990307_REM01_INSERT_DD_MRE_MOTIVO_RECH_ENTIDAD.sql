...
DECLARE
    ...
    --				CODIGO		DESCRIPCION					DESCRIPCION_LARGA		TIPO_TRABAJO_CODIGO
        T_TIPO_DATA('F09',		'TIPO_ENTIDAD = "03" no es un valor correcto - DD_TEP_TIPO_ENTIDAD_PROVEEDOR'	,		'TIPO_ENTIDAD = "03" no es un valor correcto - DD_TEP_TIPO_ENTIDAD_PROVEEDOR',		'1', 'WHERE EXISTS (SELECT * FROM DD_TEP_TIPO_ENTIDAD_PROVEEDOR TEP WHERE TEP.DD_TEP_CODIGO = AUX.TIPO_ENTIDAD AND TEP.DD_TEP_CODIGO = ''''03'''')')
    ); 
