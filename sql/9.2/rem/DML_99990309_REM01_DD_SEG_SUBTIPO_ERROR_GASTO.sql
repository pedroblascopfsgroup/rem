...
--## ARTEFACTO=online
--## VERSION_ARTEFACTO= p2.0.12-180124
--## INCIDENCIA_LINK=HREOS-3735
--## PRODUCTO=NO
--##
...
DECLARE
	...
	T_TIPO_DATA('04' , '405' , 'Importe base de impuesto directo distinto cero y tipo cero' , 'Importe base de impuesto directo distinto cero y tipo cero' )
		); 
