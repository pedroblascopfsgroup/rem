...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('17' ,'Third Party','Third Party','11'),
        T_TIPO_DATA('18' ,'Haya','Haya','11')
		); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_COS_COMITES_SANCION.NEXTVAL FROM DUAL'; -- TENEMOS QUE ESCRIBIR EL NOMBRE DE LA SECUENCIA. TODOS EMPIEZAN POR "S" Y SE VE EN SECUENCIAS EN ORACLE
