...
DECLARE
    ...
    --			Descripción														                                Función
      T_FUNCION('Permitir seleccionar el procesado de carga masiva para "OK Técnico".',		            'MASIVO_OK_TECNICO')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-3945'',SYSDATE,0 FROM DUAL';
