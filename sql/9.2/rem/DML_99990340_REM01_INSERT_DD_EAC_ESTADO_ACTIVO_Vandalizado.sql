...
--## INCIDENCIA_LINK=HREOS-4161
--## PRODUCTO=NO
--##
--## Finalidad: Nuevo valor en tabla DD_EAC_ESTADO_ACTIVO modulo Liberbank
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
  ...
  V_TABLA VARCHAR2(30 CHAR) := 'DD_EAC_ESTADO_ACTIVO';  -- Tabla a modificar
  V_TABLA_SEQ VARCHAR2(30 CHAR) := 'S_DD_EAC_ESTADO_ACTIVO';  -- Tabla a modificar  
  V_USR VARCHAR2(30 CHAR) := 'HREOS-4161'; -- USUARIOCREAR/USUARIOMODIFICAR
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('  [INFO] Comprobaciones previas...');
    ...
    LOOP
	  ...
	  V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE DD_EAC_CODIGO = '''||TRIM(V_TMP_CDC(1))||''' AND BORRADO = 0';
