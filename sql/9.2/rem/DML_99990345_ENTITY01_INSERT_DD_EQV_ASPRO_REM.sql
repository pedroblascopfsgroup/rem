...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR) := 'REMVIP-1079';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('0001' , null , 'CERBERUS'          , null)
       ,T_TIPO_DATA('0002' , '06' , 'HAYA TITULIZACION' , 'HyT')
       ,T_TIPO_DATA('0003' , null , 'PARTICULARES'      , null)
       ,T_TIPO_DATA('0004' , '04' , 'OTRAS CARTERAS'    , 'Otras carteras')
       ,T_TIPO_DATA('0005' , null , 'GESTICAIXA'        , null)
       ,T_TIPO_DATA('0006' , '07' , 'JAIPUR'            , 'Cerberus')
       ,T_TIPO_DATA('0007' , null , 'WATERFALL'         , null)
       ,T_TIPO_DATA('0008' , '13' , 'GESCOBRO'          , 'Egeo')
       ,T_TIPO_DATA('0009' , null , 'PROMONTORIA 227'   , null)
       ,T_TIPO_DATA('0010' , '12' , 'GOLDENTREE'        , 'Giants')
       ,T_TIPO_DATA('1465' , '11' , 'ING'               , 'Third Parties')
       ,T_TIPO_DATA('2038' , '03' , 'BANKIA'            , 'Bankia')
       ,T_TIPO_DATA('2048' , '08' , 'LIBERBANK'         , 'Liberbank')
       ,T_TIPO_DATA('3058' , '01' , 'CAJAMAR'           , 'Cajamar')
       ,T_TIPO_DATA('9035' , '02' , 'SAREB'             , 'Sareb')
       ,T_TIPO_DATA('9991' , null , 'SOLVIA'            , null )
