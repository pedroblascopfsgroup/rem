...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-1071';
    V_ARRAY T_ARRAY := T_ARRAY (
        T_LISTA ('mmarquis'     , NULL, NULL, 'REMGCOM'     , NULL, NULL, 'HAYAGESTCOM' , NULL, 'GCOM'  , NULL, NULL, NULL),
        T_LISTA ('rchicharro'   , NULL, NULL, 'REMGCOM'     , NULL, NULL, 'HAYAGESTCOM' , NULL, 'GCOM'  , NULL, NULL, NULL),
        T_LISTA ('50105489N'    , NULL, NULL, 'REMGCOM'     , NULL, NULL, 'HAYAGESTCOM' , NULL, 'GCOM'  , NULL, NULL, NULL),
        T_LISTA ('mmarquis'     , NULL, NULL, 'REMSUPCOM'   , NULL, NULL, 'HAYASUPCOM'  , NULL, 'SCOM'  , NULL, NULL, NULL),
        T_LISTA ('rchicharro'   , NULL, NULL, 'REMSUPCOM'   , NULL, NULL, 'HAYASUPCOM'  , NULL, 'SCOM'  , NULL, NULL, NULL),
        T_LISTA ('50105489N'    , NULL, NULL, 'REMSUPCOM'   , NULL, NULL, 'HAYASUPCOM'  , NULL, 'SCOM'  , NULL, NULL, NULL),
        T_LISTA ('44853989X'    , NULL, NULL, 'REMGFORM'    , NULL, NULL, 'HAYAGESTFORM', NULL, 'GFORM' , NULL, NULL, NULL),
        T_LISTA ('29199627T'    , NULL, NULL, 'REMGFORM'    , NULL, NULL, 'HAYAGESTFORM', NULL, 'GFORM' , NULL, NULL, NULL),
        T_LISTA ('44853989X'    , NULL, NULL, 'REMSUPFORM'  , NULL, NULL, 'HAYASUPFORM' , NULL, 'SFORM' , NULL, NULL, NULL),
        T_LISTA ('29199627T'    , NULL, NULL, 'REMSUPFORM'  , NULL, NULL, 'HAYASUPFORM' , NULL, 'SFORM' , NULL, NULL, NULL)
    );
    V_TMP_LISTA T_LISTA;
