...
DECLARE
	...
	V_USUSARIO_MOD VARCHAR2(50 CHAR) := 'HREOS-4251';
...
BEGIN
		...
		IF V_NUM_TABLAS > 0 THEN
		    ...
		    V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' SET TAP_SCRIPT_VALIDACION_JBPM = ''checkExpedienteBloqueado() ? (valores[''''T013_PosicionamientoYFirma''''][''''comboFirma''''] == DDSiNo.SI ? (checkPosicionamiento() ? existeAdjuntoUGValidacion("15,E") : ''''El expediente debe tener algún posicionamiento'''') : null) : ''''El expediente no está bloqueado'''''','|| 
