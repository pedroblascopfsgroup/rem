...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-1663';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('56' ,'Liberbank','Liberbank','08'),
        T_TIPO_DATA('57' ,'Mosacata','Mosacata','08'),
        T_TIPO_DATA('58' ,'Banco Castilla La Mancha','Banco Castilla La Mancha','08'),
        T_TIPO_DATA('59' ,'Beyos y Ponga','Beyos y Ponga','08'),
        T_TIPO_DATA('60' ,'Retamar','Retamar','08')
		); 
