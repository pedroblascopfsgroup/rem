...
--## PRODUCTO=NO
--## 
--## Finalidad: Insertar nueva subcarteras Inmobiliario (GALEON)
--##            
...
DECLARE
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	--			DD_CRA_CODIGO	DD_SCR_CODIGO		DD_SCR_DESCRIPCION		DD_SCR_DESCRIPCION_LARGA
        T_TIPO_DATA('15',			'40',				'Inmobiliario',			'Inmobiliario')
    );
