...
--## PRODUCTO=NO
--## 
--## Finalidad: Insertar propietario del array (GALEON)
--##            
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USUARIO VARCHAR2(100 CHAR):= 'HREOS-4446';
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('15',				'Vauxhall Propiedades SLU')
    );
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE 
					PRO_NOMBRE = '''||TRIM(V_TMP_TIPO_DATA(2))||''' ';
