...
BEGIN	
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO 
	SET TAP_SCRIPT_VALIDACION_JBPM = ''!esLiberBank() ? existeAdjuntoUGValidacion("06,E;12,E") : null'', 
	USUARIOMODIFICAR = ''REMVIP-1653'', 
	FECHAMODIFICAR = SYSDATE 
