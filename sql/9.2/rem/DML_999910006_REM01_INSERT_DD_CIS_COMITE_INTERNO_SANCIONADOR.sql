...
DECLARE
    ...
    V_AUX NUMBER(16);
    V_TABLA VARCHAR2(40 CHAR) := 'DD_CIS_COMITE_INTERNO_SAN'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-5452';
	...
	T_TIPO_DATA_2('01','Planificación y Control Inmobiliario'),
	T_TIPO_DATA_2('02','Director de Planificación y Control Inmobiliario'),
	T_TIPO_DATA_2('03','Comité de Inversiones Inmobiliarias'),
	T_TIPO_DATA_2('04','Comité de Dirección'),
	T_TIPO_DATA_2('05','Director de Recuperaciones y Centros Superiores'),
	T_TIPO_DATA_2('06','Comité de Seguimiento e Impagos'),
	T_TIPO_DATA_2('07','Comité de Riesgos')
		  ...
		  LOOP
			...
			V_TMP_TIPO_DATA_2 := V_TIPO_DATA_2(I);
			  ...
			  V_SQL := 'SELECT COUNT(1) FROM '||V_TABLA||' WHERE 
								DD_CIS_CODIGO = '''||TRIM(V_TMP_TIPO_DATA_2(1))||'''';
