...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'maretra02' ,'Maretra' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
		T_TIPO_DATA( 'qipert02' ,'Qipert' ,'Administración'  ,''  ,'pruebashrem@gmail.com'  , '1234'  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
       ...
       ELSE
	       ...
	       DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN USD_USUARIOS_DESPACHOS ');
			...
			V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.USD_USUARIOS_DESPACHOS' ||
						...
						' (SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = '''||TRIM(V_TMP_TIPO_DATA(1))||'''),' ||
						' 1,1,''HREOS-5316'',SYSDATE,0 FROM DUAL';
