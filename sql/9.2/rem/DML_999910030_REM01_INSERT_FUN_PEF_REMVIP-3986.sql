...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('CARGA_MASIVA_ENVIO_BUROFAX'                    , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('MASIVO_PLUSVALIA'                              , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('CARGA_MASIVA_IMPUESTOS'                        , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('ASISTIDAPDV_CARGA'                             , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('MASIVO_LOTE_COMERCIAL'                         , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('MASIVO_PROYECTO'                               , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('CARGA_ACTIVOS_GASTOS_PORCENTAJE'               , 'HAYAADMCARGASGESTACT'),
        T_FUNCION('SUBIR_LISTA_ACTIVOS_IBI'                       , 'HAYAADMCARGASGESTACT')
    ); 
