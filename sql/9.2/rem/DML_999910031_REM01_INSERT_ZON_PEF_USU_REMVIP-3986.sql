...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'REMVIP-3986';
    ...
    V_USUARIO T_ARRAY_USUARIO := T_ARRAY_USUARIO(
        ...
        T_USUARIO('dmontero'            , 'HAYAADMCARGASGESTACT'    , '1'), -- 1 PARA CREAR RELACIÓN
        T_USUARIO('smerayo'             , 'HAYAADMCARGASGESTACT'    , '1'),
        T_USUARIO('ebertrandelis'       , 'HAYAADMCARGASGESTACT'    , '1'),
        T_USUARIO('drodriguezs'         , 'HAYAADMCARGASGESTACT'    , '1')
