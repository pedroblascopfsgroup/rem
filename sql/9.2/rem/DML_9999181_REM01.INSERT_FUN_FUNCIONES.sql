...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función ROLE_PUEDE_VER_BOTON_APROBAR_INFORME
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Función que muestra el boton Aprobar informe comercial en la pestanya subdivision de las agrupaciones', 'ROLE_PUEDE_VER_BOTON_APROBAR_INFORME')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-4574'',SYSDATE,0 FROM DUAL';
