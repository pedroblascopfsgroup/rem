...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  ...
	  T_FUNCION('CMRE', 'Carga masiva reclamaciones', 'Hacer una carga masiva de reclamaciones', 'MASIVO_RECLAMACIONES', 'n*,f*')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-4916'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
