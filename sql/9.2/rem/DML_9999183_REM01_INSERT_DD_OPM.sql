...
--## PRODUCTO=NO
--## 
--## Finalidad: INSERTATAR DD_OPM COMUNICACIONES
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  ...
	  T_FUNCION('CMCO', 'Carga masiva comunicaciones', 'Hacer una carga masiva de comunicaciones', 'MASIVO_COMUNICACIONES', 'n*,f*')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-4914'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
