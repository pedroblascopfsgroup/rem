...
BEGIN   
    ...
    V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_APU_ACTIVO_PUBLICACION T1
        USING (
            ...
            WHERE ACT.BORRADO = 0 AND APU.BORRADO = 0
                AND EPV.DD_EPV_CODIGO NOT IN (''01'',''04'')) T2
    ...
    V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACT_AHP_HIST_PUBLICACION (AHP_ID, ACT_ID, DD_TPU_ID
    ...
    V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACT_AHP_HIST_PUBLICACION (AHP_ID, ACT_ID, DD_TPU_ID
        ...
        LEFT JOIN '||V_ESQUEMA||'.ACT_APU_ACTIVO_PUBLICACION APU ON APU.ACT_ID = HEP.ACT_ID
        LEFT JOIN RESERVA RES ON RES.ACT_ID = HEP.ACT_ID
        WHERE CO.DD_TCO_CODIGO IN (''03'',''04'')';
    EXECUTE IMMEDIATE V_MSQL;
    DBMS_OUTPUT.PUT_LINE('  REGISTROS INSERTADOS: '||SQL%ROWCOUNT);
    ...
    V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACT_AHP_HIST_PUBLICACION (AHP_ID, ACT_ID, DD_TPU_ID
        ...
        SELECT '||V_ESQUEMA||'.S_ACT_AHP_HIST_PUBLICACION.NEXTVAL AHP_ID, APU.ACT_ID, APU.DD_TPU_ID
