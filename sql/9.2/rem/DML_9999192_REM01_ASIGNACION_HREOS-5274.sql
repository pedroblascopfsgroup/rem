...
DECLARE
    ...
    V_ARRAY T_ARRAY := T_ARRAY (
        T_LISTA ('achillon', NULL, 'achillon', 'GFORMADM', 'GFORMADM', 'Gestor formalización-administración', 'HAYAGESTFORMADM' , 'Gestor formalización-administración', 'GFORMADM'  , 'Gestor formalización-administración', NULL, 0)
    );
    V_TMP_LISTA T_LISTA;
