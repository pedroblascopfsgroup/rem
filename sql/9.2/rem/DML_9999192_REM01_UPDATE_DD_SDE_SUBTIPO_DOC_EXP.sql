...
--## INCIDENCIA_LINK=HREOS-5142
--## PRODUCTO=NO
--##
--## Finalidad: Añadir vinculante a 1 en los casos que se requieren para la incidencia
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(20 CHAR) := 'HREOS-5142';
...
BEGIN
        ...
        V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
                SET DD_SDE_VINCULABLE = ''1'',
					...
					VERSION = VERSION + 1
                WHERE DD_SDE_CODIGO IN (''46'', ''49'', ''51'', ''52'', ''53'', ''54'')';
