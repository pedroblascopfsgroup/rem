...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-5302';
    ...
    T_ARRAY T_CONFIG := T_CONFIG (
    		T_GESTOR('GFORMADM', 'NULL', 'NULL', 'NULL', '8', 'NULL', 'NULL', 'achillon'),
    		T_GESTOR('GFORMADM', 'NULL', 'NULL', 'NULL', '17', 'NULL', 'NULL', 'achillon'),
    		T_GESTOR('GFORMADM', 'NULL', 'NULL', 'NULL', '43', 'NULL', 'NULL', 'achillon'),
    		T_GESTOR('GFORMADM', 'NULL', 'NULL', 'NULL', '25', 'NULL', 'NULL', 'achillon')
    	);
   	V_GESTOR T_GESTOR;
