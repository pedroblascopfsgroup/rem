...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-5912'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DE LA FUNCION
    V_FUN_CODIGO VARCHAR2(50) := 'MASIVO_OFERTAS_GTAM';
    V_FUN_DESCRIPCION VARCHAR2(255) := 'Permitir seleccionar el procesado de carga masiva para "Carga masiva ofertas GTAM".';
