...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-4094'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] INSERCION TABLA PEF_PERFILES');
	
	V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''HAYAGESTEXTADM''';
	...
	IF V_NUM_FILAS = 0 THEN
		...
		V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.PEF_PERFILES 
					...
					''HAYAGESTEXTADM'',
					''Perfil para cargas masivas administración'',
					''Perfil para cargas masivas de gestorías de administración'',
					0,
					''REMVIP-4094'',
					SYSDATE,
					0
