...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMOFG', 'Carga masiva ofertas GTAM', 'Carga masiva ofertas GTAM','MASIVO_OFERTAS_GTAM','n*,s,i*,n,n*,i*,n*,n,i,n*,f,s,f*,s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-5912'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
