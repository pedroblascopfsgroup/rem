...
--T004_EleccionPresupuesto ----------------------------
	...
	SET TAP_SCRIPT_DECISION = ''esLiberBank() ? (superaLimiteLiberbank() ? ''''LiberbankLimiteSuperado'''' : valores[''''T004_EleccionPresupuesto''''][''''comboPresupuesto''''] == DDSiNo.NO ? ''''PresupuestoInvalido'''' : (checkBankia() ? (checkSuperaPresupuestoActivo() ? ''''ValidoSuperaLimiteBankia'''' : (checkSuperaDelegacion() ? ''''ValidoSuperaLimiteBankia'''' : ''''ConSaldo''''))  : (checkEsMultiactivo() ? ''''ConSaldo'''' : (checkSuperaPresupuestoActivo() ? ''''ComprobarAdvisoryNote'''' : ''''ConSaldo'''')))) : valores[''''T004_EleccionPresupuesto''''][''''comboPresupuesto''''] == DDSiNo.NO ? ''''PresupuestoInvalido'''' : ((esCerberus() && (esSubcarteraJaipurInmobiliario() || esSubcarteraAgoraInmobiliario() || esSubcarteraEgeo() || esSubcarteraApple())) || (esEgeo() && (esSubcarteraZeus() || esSubcarteraPromontoria()))) ? ''''ComprobarAdvisoryNote'''' : (checkBankia() ? (checkSuperaPresupuestoActivo() ? ''''ValidoSuperaLimiteBankia'''' : (checkSuperaDelegacion() ? ''''ValidoSuperaLimiteBankia'''' : ''''ConSaldo''''))  : (checkEsMultiactivo() ? ''''ConSaldo'''' : (checkSuperaPresupuestoActivo() ? ''''ComprobarAdvisoryNote'''' : ''''ConSaldo'''')))'',
