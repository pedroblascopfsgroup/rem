...
BEGIN	
	...
	SET TAP_SCRIPT_VALIDACION_JBPM = ''checkExpedienteBloqueado() ? (valores[''''T013_PosicionamientoYFirma''''][''''comboFirma''''] == DDSiNo.SI ? (checkPosicionamiento() ? null : ''''El expediente debe tener algún posicionamiento'''') : null) : ''''El expediente no está bloqueado'''''',
