...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
      T_FUNCION( 'ogf.jpinilla', 	'HAYAGESTPUBL'  ),  
	  T_FUNCION( 'ogf.mnoguera', 	'HAYAGESTPUBL'     ),
	  T_FUNCION( 'ogf.oruiz', 		'HAYAGESTPUBL'     ),
	  T_FUNCION( 'ogf.lnogales', 	'HAYAGESTPUBL'     ),
	  T_FUNCION( 'avila', 			'HAYAGESTPUBL'     ),
	  T_FUNCION( 'bbaviera', 		'HAYAGESTPUBL'),
	  T_FUNCION( 'gespuapple',		'HAYAGESTPUBL')
    );
