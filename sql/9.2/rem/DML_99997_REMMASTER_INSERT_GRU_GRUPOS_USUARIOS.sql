...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
   	  ...
   	  T_FUNCION( 'gespuapple', 'ogf.jpinilla'  ),  
	  T_FUNCION( 'gespuapple', 'ogf.mnoguera'     ),
	  T_FUNCION( 'gespuapple', 'ogf.oruiz'     ),
	  T_FUNCION( 'gespuapple', 'ogf.lnogales'     ),
	  T_FUNCION( 'gespuapple', 'avila'     ),
	  T_FUNCION( 'gespuapple', 'bbaviera'),
	  T_FUNCION( 'gespuapple', 'gespuapple')
