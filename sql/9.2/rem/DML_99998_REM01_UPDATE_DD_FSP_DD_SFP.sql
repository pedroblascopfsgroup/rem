...
DBMS_OUTPUT.PUT_LINE('[INICIO] ');
  ...
  IF V_COUNT > 0 THEN
	...
	V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TABLA_SFP||' WHERE DD_SFP_DESCRIPCION = ''Devuelto''';
        EXECUTE IMMEDIATE V_SQL INTO V_COUNT;
	...
	V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TABLA_SFP||' WHERE DD_SFP_DESCRIPCION = ''Clasificado''';
        EXECUTE IMMEDIATE V_SQL INTO V_COUNT;
