...
BEGIN	
	...
	SET TAP_SCRIPT_DECISION = ''valores[''''T013_ResultadoPBC''''][''''comboResultado''''] == DDSiNo.SI ? esYubai() ? ''''esYubai'''' : esOmega() ? ''''esOmegaAprobado'''' : ''''Aprobado'''' : (checkReserva() ? esYubai() ? ''''esYubai'''' : ''''NoAprobadoConReserva'''' :  ''''NoAprobadoSinReserva'''')'',
