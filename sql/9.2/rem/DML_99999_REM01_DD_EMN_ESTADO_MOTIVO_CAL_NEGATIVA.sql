...
DECLARE
    ...
    V_AUX NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR) := 'DD_EMN_ESTADO_MOTIVO_CAL_NEG'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-5208';
	V_SIGLAS_TABLA VARCHAR2(3 CHAR) := 'EMN';
	...
	T_TIPO_DATA_2('01','Pendiente'),
	T_TIPO_DATA_2('02','Subsanado')		
	); 
