...
DECLARE
    ...
    --				CODIGO		DESCRIPCION					DESCRIPCION_LARGA		TIPO_TRABAJO_CODIGO
        T_TIPO_DATA('F13',		'validación del número de documento dni'	,		'validación del número de documento dni',		'1', 'WHERE AUX.NIF_CONTACTO IS NOT NULL AND AUX.DOCU_NIF_CONTACTO = ''''01'''' AND ((SELECT VALIDANIF(AUX.NIF_CONTACTO) FROM DUAL) = 0)')
    ); 
