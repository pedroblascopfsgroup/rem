...
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=v2.8.0-rem
--## INCIDENCIA_LINK=HREOS-6124
--## PRODUCTO=NO
--##
...
--ACTUALIZACION DE VALIDACIONES DE TAREA T003_ObtencionEtiqueta
  ...
  V_SDE_VALOR := 'esFechaMenor(valores[''''T003_ObtencionEtiqueta''''][''''fechaInscripcion''''], fechaAprobacionTrabajo()) ? ''''Fecha inscripci&oacute;n debe ser posterior o igual a fecha de aprobaci&oacute;n del trabajo'''' : existeAdjuntoUGValidacion("84","T") ';

  V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_SDE_TABLA||'
             SET '||V_SDE_CAMPO||'='''||V_SDE_VALOR||'''
             ,FECHAMODIFICAR = sysdate
             ,USUARIOMODIFICAR = ''HREOS-6124''
