...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-6973';
    V_ARRAY T_ARRAY := T_ARRAY (
        T_LISTA ('portfolioman', NULL, 'portfolioman', 'GPM', 'GPM', 'Portfolio Manager', 'HAYAGESTPORTMAN' , 'Portfolio Manager', 'GPM'  , 'Portfolio Manager', NULL, 0)
    );
    V_TMP_LISTA T_LISTA;
