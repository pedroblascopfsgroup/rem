...
nohup ./sql/pitertul/package-scripts-from-tag-and-folder.sh 2.0.0-00000004-rem REM migracion/fase1/migracion_BNK/DDLs_MIG
...
nohup ./sql/pitertul/package-scripts-from-tag-and-folder.sh 2.0.0-00000004-rem REM migracion/fase1/migracion_BNK/DMLs_CHECK_DD
...
nohup ./sql/pitertul/package-scripts-from-tag-and-folder.sh 2.0.0-00000004-rem REM migracion/fase1/migracion_BNK/DMLs_REM_MIGRATION
