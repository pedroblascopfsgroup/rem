...
function run_scripts {
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_009_REM01_VI_BUSQUEDA_ACTIVOS_PRECIOS.sql" "REM01" "JOSEVI JIMENEZ" "online"  "9.2" "20161003" "0" "NO" > /dev/null
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO.sql" "REM01" "Kevin Fernández" "online"  "9.2" "20160823" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO-REM01-reg3.1.sql > DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO.log
	echo " -- : DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_013_REM01_VI_BUSQUEDA_PUBLICACION_ACTIVO.log
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_014_REM01_VI_OFERTAS_ACTIVOS_AGRUPACION.sql" "REM01" "Luis Caballero" "online"  "9.1" "20162309" "0" "NO" > /dev/null
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_015_REM01_VI_BUSQUEDA_ACTIVOS_PROPUESTA.sql" "REM01" "JORGE ROS" "online"  "9.2" "20160902" "0" "NO" > /dev/null
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_016_REM01_VI_BUSQUEDA_NUM_ACTIVOS_TIPO_PRECIO.sql" "REM01" "JORGE ROS" "online"  "9.2" "20160914" "0" "NO" > /dev/null
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_017_REM01_VI_BUSQUEDA_TRABAJOS.sql" "REM01" "JOSE VILLEL" "online"  "9.1" "20160824" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_017_REM01_VI_BUSQUEDA_TRABAJOS.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_017_REM01_VI_BUSQUEDA_TRABAJOS-REM01-reg3.1.sql > DDL_017_REM01_VI_BUSQUEDA_TRABAJOS.log
	echo " -- : DDL_017_REM01_VI_BUSQUEDA_TRABAJOS.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_017_REM01_VI_BUSQUEDA_TRABAJOS.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE.sql" "REM01" "JORGE ROS" "online"  "9.2" "20160831" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE-REM01-reg3.1.sql > DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE.log
	echo " -- : DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_018_REM01_VI_BUSQUEDA_COMPRADORES_EXPEDIENTE.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES.sql" "REM01" "Kevin Fernández" "online"  "9.2" "20160912" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES-REM01-reg3.1.sql > DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES.log
	echo " -- : DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_018_REM01_VI_BUSQUEDA_PROVEEDORES.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP.sql" "REM01" "JORGE ROS" "online"  "9.2" "20160906" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP-REM01-reg3.1.sql > DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP.log
	echo " -- : DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_019_REM01_VI_BUSQUEDA_DATOS_COMPRADOR_EXP.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS.sql" "REM01" "CLV" "online"  "9.2" "20160907" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS-REM01-reg3.1.sql > DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS.log
	echo " -- : DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_020_REM01_SP_ACTUALIZA_ACT_IND_PRECIOS.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_021_REM01_SP_ACT_CHECK_INFO.sql" "REM01" "CLV" "online"  "9.2" "20160907" "0" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_021_REM01_SP_ACT_CHECK_INFO.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_021_REM01_SP_ACT_CHECK_INFO-REM01-reg3.1.sql > DDL_021_REM01_SP_ACT_CHECK_INFO.log
	echo " -- : DDL_021_REM01_SP_ACT_CHECK_INFO.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_021_REM01_SP_ACT_CHECK_INFO.log
	...
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_ENTITY01_reg3.sql "DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM.sql" "REM01" "David Gonzalez" "online"  "9.1" "20160927" "HREOS-788" "NO" > /dev/null
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_PREV_objects_REM01_DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM.log
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM-REM01-reg3.1.sql > DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM.log
	echo " -- : DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM.sql"
	exit | sqlplus -s -l REM01/$2 @./scripts/DDL_000_REM01_metadata_objects.sql > DB_SNAPSHOT_POST_objects_REM01_DDL_024_ENTITY01_SP_UPA_UPDATE_ACTIVES_UVEM.log
}
