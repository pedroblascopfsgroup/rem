...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG_APT_PRESUPUESTO_TRABAJO'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG_APT_PRESUPUESTO_TRABAJ_BNK';
...
(
	...
	PRT_FECHA						DATE,
	ESTADO_PRESUPUESTO				VARCHAR2(20 CHAR),
