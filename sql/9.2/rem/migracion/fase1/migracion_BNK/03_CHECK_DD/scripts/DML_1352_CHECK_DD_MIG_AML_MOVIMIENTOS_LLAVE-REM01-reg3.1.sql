...
V_TABLA VARCHAR(30 CHAR) := 'MIG_AML_MOVIMIENTOS_LLAVE_BNK';
FICHERO VARCHAR2(30 CHAR) := 'MIG_MOVIMIENTOS_LLAVE_BNK.dat';
SENTENCIA VARCHAR2(300 CHAR);
V_NUM NUMBER(10);
CAMPO VARCHAR2(30 CHAR);
DICCIONARIO VARCHAR2(30 CHAR);
COD_DICC VARCHAR2(30 CHAR);
CLAVE VARCHAR2(30 CHAR) := 'LLV_CODIGO_UVEM';
...
BEGIN
  ...
  CAMPO := 'MLV_TIPO_TENEDOR';
  DICCIONARIO := 'DD_TTE_TIPO_TENEDOR';
  COD_DICC := 'DD_TTE_CODIGO';
