...
V_TABLA VARCHAR(30 CHAR) := 'MIG_AID_INFCOMERCIAL_DISTR_BNK';
FICHERO VARCHAR2(30 CHAR) := 'INFCOMERCIAL_DISTRIB_BNK.dat';
...
BEGIN
  ...
  --DD_TPH_TIPO_HABITACULO--
  
  CAMPO := 'TIPO_HABITACULO';
  DICCIONARIO := 'DD_TPH_TIPO_HABITACULO';
  COD_DICC := 'DD_TPH_CODIGO';
