...
V_TABLA VARCHAR(30 CHAR) := 'MIG_AEP_ENTIDAD_PROVEEDOR_BNK';
FICHERO VARCHAR2(30 CHAR) := 'ENTIDAD_PROVEEDOR_BNK.dat';
...
BEGIN
  ...
  --DD_TCL_TIPO_COLABORACION--
  
  CAMPO := 'TIPO_COLABORACION';
  DICCIONARIO := 'DD_TCL_TIPO_COLABORACION';
  COD_DICC := 'DD_TCL_CODIGO';
