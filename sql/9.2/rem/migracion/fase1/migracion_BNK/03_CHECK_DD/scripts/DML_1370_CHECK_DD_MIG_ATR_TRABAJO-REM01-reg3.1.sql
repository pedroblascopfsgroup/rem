...
V_TABLA VARCHAR(30 CHAR) := 'MIG_ATR_TRABAJO_BNK';
FICHERO VARCHAR2(30 CHAR) := 'TRABAJO_BNK.dat';
...
BEGIN
  ...
  CAMPO := 'TIPO_TRABAJO';
  DICCIONARIO := 'DD_TTR_TIPO_TRABAJO';
  COD_DICC := 'DD_TTR_CODIGO';
  ...
  --DD_STR_SUBTIPO_TRABAJO--
  
  CAMPO := 'SUBTIPO_TRABAJO';
  DICCIONARIO := 'DD_STR_SUBTIPO_TRABAJO';
  COD_DICC := 'DD_STR_CODIGO';
  ...
  --DD_EST_ESTADO_TRABAJO--
  
  CAMPO := 'ESTADO_TRABAJO';
  DICCIONARIO := 'DD_EST_ESTADO_TRABAJO';
  COD_DICC := 'DD_EST_CODIGO';
