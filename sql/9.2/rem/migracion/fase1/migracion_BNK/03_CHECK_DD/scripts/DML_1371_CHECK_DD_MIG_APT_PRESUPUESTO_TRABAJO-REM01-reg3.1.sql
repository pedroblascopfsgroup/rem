...
V_TABLA VARCHAR(30 CHAR) := 'MIG_APT_PRESUPUESTO_TRABAJ_BNK';
FICHERO VARCHAR2(30 CHAR) := 'PRESUPUESTO_TRABAJO_BNK.dat';
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('[INFO] SE VA A PROCEDER A VALIDAR LOS CODIGOS DE DICCIONARIO.');
     ...
     --DD_ESP_ESTADO_PRESUPUESTO--
  
  CAMPO := 'ESTADO_PRESUPUESTO';
  DICCIONARIO := 'DD_ESP_ESTADO_PRESUPUESTO';
  COD_DICC := 'DD_ESP_CODIGO';
