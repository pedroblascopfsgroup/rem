...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_PRO_PROPIETARIOS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
        ...
        (
                PRO_PROPIETARIO_CODIGO_UVEM                             NUMBER(16,0)                    NOT NULL,
                PRO_COD_CARTERA                                                 VARCHAR2(20 CHAR)               NOT NULL,
                PRO_COD_SUBCARTERA                                              VARCHAR2(20 CHAR)               NOT NULL
        )'
        ;
