...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG_APS_PROVISION_SUPLIDO'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG_APS_PROVISION_SUPLIDO_BNK';
...
(
	...
	TIPO_ADELANTO				VARCHAR2(20 CHAR),
	PSU_CONCEPTO				VARCHAR2(250 CHAR),
	PSU_IMPORTE					NUMBER(16,2),
	PSU_FECHA					DATE
)'
;
