...
V_TABLA VARCHAR(30 CHAR) := 'MIG_APA_PROP_ACTIVO_BNK';
FICHERO VARCHAR2(30 CHAR) := 'PROPIETARIOS_ACTIVO_BNK.dat';
...
BEGIN
  ...
  --DD_TGP_TIPO_GRADO_PROPIEDAD--
  
  CAMPO := 'GRADO_PROPIEDAD';
  DICCIONARIO := 'DD_TGP_TIPO_GRADO_PROPIEDAD';
  COD_DICC := 'DD_TGP_CODIGO';
