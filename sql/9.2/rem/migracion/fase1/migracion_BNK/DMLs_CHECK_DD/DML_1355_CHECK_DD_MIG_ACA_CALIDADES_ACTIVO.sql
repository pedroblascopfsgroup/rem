...
V_TABLA VARCHAR(30 CHAR) := 'MIG_ACA_CALIDADES_ACTIVO_BNK';
FICHERO VARCHAR2(30 CHAR) := 'CALIDADES_ACTIVO_BNK.dat';
...
BEGIN
  ...
  --DD_ACR_ACABADO_CARPINTERIA--
  
  CAMPO := 'NIVEL_ACABADO_INTERIOR';
  DICCIONARIO := 'DD_ACR_ACABADO_CARPINTERIA';
  COD_DICC := 'DD_ACR_CODIGO';
