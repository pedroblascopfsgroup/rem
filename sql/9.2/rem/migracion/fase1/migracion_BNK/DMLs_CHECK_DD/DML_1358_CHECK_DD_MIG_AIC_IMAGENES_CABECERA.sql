...
V_TABLA VARCHAR(30 CHAR) := 'MIG_AIC_IMAGENES_CABECERA_BNK';
FICHERO VARCHAR2(30 CHAR) := 'IMAGENES_CABECERA_BNK.dat';
SENTENCIA VARCHAR2(300 CHAR);
V_NUM NUMBER(10);
CAMPO VARCHAR2(30 CHAR);
DICCIONARIO VARCHAR2(30 CHAR);
COD_DICC VARCHAR2(30 CHAR);
CLAVE VARCHAR2(30 CHAR) := 'FOT_COD_FOTO_UVEM';
...
BEGIN
  ...
  CAMPO := 'TIPO_FOTO';
  DICCIONARIO := 'DD_TFO_TIPO_FOTO';
  COD_DICC := 'DD_TFO_CODIGO';
