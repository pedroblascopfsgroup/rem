...
V_TABLA VARCHAR(30 CHAR) := 'MIG_APS_PROVISION_SUPLIDO_BNK';
FICHERO VARCHAR2(30 CHAR) := 'PROVISION_SUPLIDO_BNK.dat';
SENTENCIA VARCHAR2(300 CHAR);
V_NUM NUMBER(10);
CAMPO VARCHAR2(30 CHAR);
DICCIONARIO VARCHAR2(30 CHAR);
COD_DICC VARCHAR2(30 CHAR);
CLAVE VARCHAR2(30 CHAR) := 'TBJ_NUM_TRABAJO';
...
BEGIN
  ...
  --DD_TAD_TIPO_ADELANTO--
  
  CAMPO := 'TIPO_ADELANTO';
  DICCIONARIO := 'DD_TAD_TIPO_ADELANTO';
  COD_DICC := 'DD_TAD_CODIGO';
