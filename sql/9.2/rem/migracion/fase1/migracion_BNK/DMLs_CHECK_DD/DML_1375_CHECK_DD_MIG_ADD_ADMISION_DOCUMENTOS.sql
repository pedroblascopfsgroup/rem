...
V_TABLA VARCHAR(30 CHAR) := 'MIG_ADD_ADMISION_DOC_BNK';
FICHERO VARCHAR2(30 CHAR) := 'ADMISION_DOCUMENTOS_BNK.dat';
...
BEGIN
  ...
  DICCIONARIO := 'DD_TPD_TIPO_DOCUMENTO';
  COD_DICC := 'DD_TPD_CODIGO';
  ...
  --DD_EDC_ESTADO_DOCUMENTO--
  
  CAMPO := 'ESTADO_DOCUMENTO';
  DICCIONARIO := 'DD_EDC_ESTADO_DOCUMENTO';
  COD_DICC := 'DD_EDC_CODIGO';
  ...
  --DD_TCE_TIPO_CALIF_ENER--
  
  CAMPO := 'ADO_CALIFICACION';
  DICCIONARIO := 'DD_TCE_TIPO_CALIF_ENERGETICA';
  COD_DICC := 'DD_TCE_CODIGO';
