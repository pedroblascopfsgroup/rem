...
INSERT INTO '||V_ESQUEMA||'.'||V_TABLA6||' (
  ...
  -- Registros MIG
  V_SENTENCIA := '
	SELECT COUNT(ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE DD_TIC_ID = 1 AND USUARIOCREAR = ''MIGRAREM01BNK''
  '
  ;
  ...
  -- Registros insertados en REM
  V_SENTENCIA := '
	SELECT COUNT(VIV.ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA4||' VIV, '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL ICO WHERE ICO.USUARIOCREAR = ''MIGRAREM01BNK''
           AND VIV.ICO_ID=ICO.ICO_ID    
  '
  ;
  ...
  -- Registros MIG
  V_SENTENCIA := '
	SELECT COUNT(ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE DD_TIC_ID = 2 AND USUARIOCREAR = ''MIGRAREM01BNK''
  '
  ;
  ...
  -- Registros insertados en REM
  V_SENTENCIA := '
	SELECT COUNT(VIV.ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA5||' VIV, '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL ICO WHERE ICO.USUARIOCREAR = ''MIGRAREM01BNK''
	   AND VIV.ICO_ID=ICO.ICO_ID  
  '
  ;
  ...
  -- TABLA ACT_APR_PLAZA_APARCAMIENTO
    ...
    -- Registros MIG
  V_SENTENCIA := '
	SELECT COUNT(ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE DD_TIC_ID = 3 AND USUARIOCREAR = ''MIGRAREM01BNK''
  '
  ;
  ...
  -- Registros insertados en REM
  V_SENTENCIA := '
	SELECT COUNT(VIV.ICO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA6||' VIV, '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL ICO WHERE ICO.USUARIOCREAR = ''MIGRAREM01BNK''
	   AND VIV.ICO_ID=ICO.ICO_ID
  '
  ;
