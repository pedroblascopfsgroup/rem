...
V_TABLA_MIG VARCHAR2(40 CHAR) := 'MIG_ACA_CALIDADES_ACTIVO_BNK';
...
SELECT
  ...
  EXECUTE IMMEDIATE ('
	...
	(SELECT COUNT(CRI_ID) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA2||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(CRE_ID) FROM '||V_ESQUEMA||'.'||V_TABLA2||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA3||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(PRV_ID) FROM '||V_ESQUEMA||'.'||V_TABLA3||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA4||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(SOL_ID) FROM '||V_ESQUEMA||'.'||V_TABLA4||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA5||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(INF_ID) FROM '||V_ESQUEMA||'.'||V_TABLA5||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA6||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(ZCO_ID) FROM '||V_ESQUEMA||'.'||V_TABLA6||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA7||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(INS_ID) FROM '||V_ESQUEMA||'.'||V_TABLA7||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA8||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(BNY_ID) FROM '||V_ESQUEMA||'.'||V_TABLA8||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
  ...
  EXECUTE IMMEDIATE ('
	...
	'''||V_TABLA9||''',
	(SELECT COUNT(ACT_NUMERO_ACTIVO) FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||'),
	(SELECT COUNT(COC_ID) FROM '||V_ESQUEMA||'.'||V_TABLA9||' WHERE USUARIOCREAR = ''MIGRAREM01BNK''),
	'||V_REJECTS||',
	'||V_COD||',
	SYSDATE,
	'''||V_OBSERVACIONES||'''
