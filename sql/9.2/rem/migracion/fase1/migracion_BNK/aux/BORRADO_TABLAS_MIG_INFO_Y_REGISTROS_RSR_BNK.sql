...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] BORRANDO DE TABLAS _BNK...');
    LOOP
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] BORRANDO DE REGISTROS DE LA MIG_INFO_TABLE...');
    EXECUTE IMMEDIATE 'DELETE FROM REM01.MIG_INFO_TABLE WHERE TABLA_MIG LIKE ''%_BNK'' 
							OR TABLA_MIG = ''MIG2_PVC_PROVEEDOR_CONTACTO''
							OR TABLA_MIG = ''MIG2_PRD_PROVEEDOR_DIRECCION''
							OR TABLA_MIG = ''MIG2_PVE_PROVEEDORES''
							OR TABLA_MIG = ''MIG2_PRO_PROPIETARIOS'' ';
    ...
    EXECUTE IMMEDIATE 'DELETE FROM REM01.RSR_REGISTRO_SQLS WHERE RSR_INCIDENCIA_LINK = ''HREOS-719'' 
							OR RSR_INCIDENCIA_LINK = ''HREOS-855''';
