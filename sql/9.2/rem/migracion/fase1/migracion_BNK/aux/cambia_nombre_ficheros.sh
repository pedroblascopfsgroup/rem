...
mv Fich_Activo_Cabecera.dat ACTIVO_CABECERA.dat
mv Fich_Activo_DatosAdicionales.dat ACTIVO_DATOSADICIONALES.dat
mv Fich_Activo_Titulo.dat ACTIVO_TITULO.dat
mv Fich_Activo_PlanDinVentas.dat ACTIVO_PLANDINVENTAS.dat
mv Fich_Activo_Adj_Judicial.dat ACTIVO_ADJ_JUDICIAL.dat
mv Fich_Activo_Adj_No_Judicial.dat ACTIVO_ADJ_NO_JUDICIAL.dat
mv Fich_Com_Propietarios_Cabecera.dat COM_PROPIETARIOS_CABECERA.dat
mv Fich_Propietarios_Activo.dat PROPIETARIOS_ACTIVO.dat
...
mv Fich_Activo_Precios.dat ACTIVO_PRECIO.dat
mv Fich_Catastro_Activo.dat CATASTRO_ACTIVO.dat
