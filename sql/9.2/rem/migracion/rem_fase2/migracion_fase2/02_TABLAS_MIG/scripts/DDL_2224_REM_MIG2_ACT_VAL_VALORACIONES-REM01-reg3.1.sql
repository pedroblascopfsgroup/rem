...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_ACT_VAL_VALORACIONES'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_ACT_VAL_VALORACIONES';
...
(
	VAL_ACT_NUMERO_ACTIVO	NUMBER(16,0)      	NOT NULL,     
	VAL_COD_TIPO_PRECIO		VARCHAR2(20 CHAR)	NOT NULL,
