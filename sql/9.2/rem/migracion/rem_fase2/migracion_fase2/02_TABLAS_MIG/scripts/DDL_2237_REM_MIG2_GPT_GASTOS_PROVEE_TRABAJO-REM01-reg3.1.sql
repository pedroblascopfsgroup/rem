...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GPT_GASTOS_PROVEE_TRABAJO'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GPT_GASTOS_PROVEE_TRABAJO';
...
BEGIN
	...
	(
		GPT_COD_GASTO_PROVEEDOR			NUMBER(16)				NOT NULL,
		GPT_TBJ_NUM_TRABAJO				NUMBER(16)				NOT NULL,
		GPT_FECHA_EMISION_FACTURA		DATE
	)'
	;
