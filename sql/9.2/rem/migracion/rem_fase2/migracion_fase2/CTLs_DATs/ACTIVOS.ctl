...
(
	...
	ACT_GESTORIA_ADMISION				POSITION(332:371)		CHAR NULLIF(ACT_GESTORIA_ADMISION=BLANKS)							"REPLACE(REPLACE(REPLACE(TRIM(:ACT_GESTORIA_ADMISION),';',' '), '\"',''),'''','')",
	ACT_GESTOR_ACTIVO					POSITION(372:411)		CHAR NULLIF(ACT_GESTOR_ACTIVO=BLANKS)								"REPLACE(REPLACE(REPLACE(TRIM(:ACT_GESTOR_ACTIVO),';',' '), '\"',''),'''','')",
	ACT_GESTORIA_ADMINISTRACION			POSITION(412:451)		CHAR NULLIF(ACT_GESTORIA_ADMINISTRACION=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:ACT_GESTORIA_ADMINISTRACION),';',' '), '\"',''),'''','')"	
)
