...
INTO TABLE REM01.MIG2_CLC_CLIENTES_COMERCIALES
TRUNCATE
TRAILING NULLCOLS
(
	...
	CLC_COD_CLIENTE_HAYA			POSITION(18:34)			INTEGER EXTERNAL 										"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:CLC_COD_CLIENTE_HAYA),';',' '), '\"',''),'''',''),2,16))",
