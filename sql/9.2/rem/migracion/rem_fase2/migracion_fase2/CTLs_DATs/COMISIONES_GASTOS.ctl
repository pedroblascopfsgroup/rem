...
(	
	...
	GEX_ACT_NUMERO_ACTIVO		POSITION(283:299)		INTEGER EXTERNAL NULLIF(GEX_ACT_NUMERO_ACTIVO=BLANKS)		"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GEX_ACT_NUMERO_ACTIVO),';',' '), '\"',''),'''',''),2,16))"
)
