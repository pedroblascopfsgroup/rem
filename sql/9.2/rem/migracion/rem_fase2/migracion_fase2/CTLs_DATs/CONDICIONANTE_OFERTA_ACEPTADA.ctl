...
(	
	...
	COE_PORCENTAJE_RESERVA			POSITION(90:106)			INTEGER EXTERNAL NULLIF(COE_PORCENTAJE_RESERVA=BLANKS)				"CASE WHEN (:COE_PORCENTAJE_RESERVA) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:COE_PORCENTAJE_RESERVA,2,3)||','||SUBSTR(:COE_PORCENTAJE_RESERVA,5,2)),';',' '), '\"',''),'''','')) END",
