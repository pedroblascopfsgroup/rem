...
(	
	...
	COE_GESTOR_FORMALIZACION		POSITION(486:525)		CHAR NULLIF(COE_GESTOR_FORMALIZACION=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:COE_GESTOR_FORMALIZACION),';',' '), '\"',''),'''','')",
	COE_GESTORIA_FORMALIZACION		POSITION(526:565)		CHAR NULLIF(COE_GESTORIA_FORMALIZACION=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:COE_GESTORIA_FORMALIZACION),';',' '), '\"',''),'''','')"
)
