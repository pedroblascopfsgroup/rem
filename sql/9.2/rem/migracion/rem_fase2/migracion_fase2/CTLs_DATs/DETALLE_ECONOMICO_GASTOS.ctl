...
(
	...
	GDE_IND_IMP_INDIR_RENUNCIA_EXENCION			POSITION(159:160)		INTEGER EXTERNAL NULLIF(GDE_IND_IMP_INDIR_RENUNCIA_EXENCION=BLANKS)	"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GDE_IND_IMP_INDIR_RENUNCIA_EXENCION),';',' '), '\"',''),'''',''),2,1))",
	...
	GDE_COD_RESPONSABLE_PAGO_FUERA_PLAZO		POSITION(299:318)		CHAR NULLIF(GDE_COD_RESPONSABLE_PAGO_FUERA_PLAZO=BLANKS)			"REPLACE(REPLACE(REPLACE(TRIM(:GDE_COD_RESPONSABLE_PAGO_FUERA_PLAZO),';',' '), '\"',''),'''','')"
)
