...
(
	...
	GDE_TITULAR_CUENTA							POSITION(392:647)	CHAR NULLIF(GDE_TITULAR_CUENTA=BLANKS)								"REPLACE(REPLACE(REPLACE(TRIM(:GDE_TITULAR_CUENTA),';',' '), '\"',''),'''','')",
	GDE_NIF_TITULAR_CUENTA						POSITION(648:657)	CHAR NULLIF(GDE_NIF_TITULAR_CUENTA=BLANKS)							"REPLACE(REPLACE(REPLACE(TRIM(:GDE_NIF_TITULAR_CUENTA),';',' '), '\"',''),'''','')",
	GDE_PAGADO_CONEXION_BANKIA					POSITION(658:659)	INTEGER EXTERNAL NULLIF(GDE_PAGADO_CONEXION_BANKIA=BLANKS)			"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GDE_PAGADO_CONEXION_BANKIA),';',' '), '\"',''),'''',''),2,1))",
	GDE_NUMERO_CONEXION							POSITION(660:671)	CHAR NULLIF(GDE_NUMERO_CONEXION=BLANKS)								"REPLACE(REPLACE(REPLACE(TRIM(:GDE_NUMERO_CONEXION),';',' '), '\"',''),'''','')",
	GDE_OFICINA_BANKIA							POSITION(672:675)	CHAR NULLIF(GDE_OFICINA_BANKIA=BLANKS)								"REPLACE(REPLACE(REPLACE(TRIM(:GDE_OFICINA_BANKIA),';',' '), '\"',''),'''','')"
)
