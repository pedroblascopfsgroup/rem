...
(
	...
	GIM_FECHA_TOPE_IMPUGANCION				POSITION(18:25)		DATE 'YYYYMMDD' NULLIF(GIM_FECHA_TOPE_IMPUGANCION=BLANKS)			"REPLACE(:GIM_FECHA_TOPE_IMPUGANCION, '00000000', '')",
	GIM_FECHA_PRESENTACION_IMPUGANCION		POSITION(26:33)		DATE 'YYYYMMDD' NULLIF(GIM_FECHA_PRESENTACION_IMPUGANCION=BLANKS)	"REPLACE(:GIM_FECHA_PRESENTACION_IMPUGANCION, '00000000', '')",
