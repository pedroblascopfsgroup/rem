...
TRAILING NULLCOLS
(
	GPV_COD_GASTO_PROVEEDOR			POSITION(1:17)			INTEGER EXTERNAL NULLIF(GPV_COD_GASTO_PROVEEDOR=BLANKS)				"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GPV_COD_GASTO_PROVEEDOR),';',' '), '\"',''),'''',''),2,16))",
	...
	GPV_ID							POSITION(1038:1054)		INTEGER EXTERNAL													"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GPV_ID),';',' '), '\"',''),'''',''),2,16))",
	...
	GPV_NUMERO_PROVISION_FONDOS		POSITION(1095:1114)		CHAR NULLIF(GPV_COD_GASTO_AGRUPADO=BLANKS)							"REPLACE(REPLACE(REPLACE(TRIM(:GPV_NUMERO_PROVISION_FONDOS),';',' '), '\"',''),'''','')"
)
