...
(
	...
	GPT_ACT_NUMERO_ACTIVO		POSITION(18:34)		INTEGER EXTERNAL		"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GPT_ACT_NUMERO_ACTIVO),';',' '), '\"',''),'''',''),2,16))",
	GPT_TBJ_NUM_TRABAJO			POSITION(35:51)		INTEGER EXTERNAL		"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GPT_TBJ_NUM_TRABAJO),';',' '), '\"',''),'''',''),2,16))",
