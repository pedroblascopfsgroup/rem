...
(
	...
	OFR_GESTORIA_FORMALIZACION		POSITION(380:429)	CHAR NULLIF(OFR_GESTORIA_FORMALIZACION=BLANKS)					"REPLACE(REPLACE(REPLACE(TRIM(:OFR_GESTORIA_FORMALIZACION),';',' '), '\"',''),'''','')",
	OFR_GESTOR_FORMALIZACION		POSITION(430:479)	CHAR NULLIF(OFR_GESTOR_FORMALIZACION=BLANKS)					"REPLACE(REPLACE(REPLACE(TRIM(:OFR_GESTOR_FORMALIZACION),';',' '), '\"',''),'''','')"
)
