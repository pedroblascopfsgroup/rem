...
(
	...
	OFA_PORCENTAJE_PARTICIPACION		POSITION(35:40)		INTEGER EXTERNAL NULLIF(OFA_PORCENTAJE_PARTICIPACION=BLANKS)	"CASE WHEN (:OFA_PORCENTAJE_PARTICIPACION) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:OFA_PORCENTAJE_PARTICIPACION,1,15)||','||SUBSTR(:OFA_PORCENTAJE_PARTICIPACION,16,2)),';',' '), '\"',''),'''','')) END",
