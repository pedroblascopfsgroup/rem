...
(
	...
	PRP_COD_ESTADO_PRP		POSITION(274:293)		CHAR NULLIF(PRP_COD_ESTADO_PRP=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:PRP_COD_ESTADO_PRP),';',' '), '\"',''),'''','')",
	PRP_COD_CARTERA			POSITION(294:313)		CHAR NULLIF(PRP_COD_CARTERA=BLANKS)							"REPLACE(REPLACE(REPLACE(TRIM(:PRP_COD_CARTERA),';',' '), '\"',''),'''','')",
	PRP_COD_USUARIO			POSITION(314:333)		CHAR NULLIF(PRP_COD_USUARIO=BLANKS)							"REPLACE(REPLACE(REPLACE(TRIM(:PRP_COD_USUARIO),';',' '), '\"',''),'''','')",
	PRP_COD_TIPO_PRP		POSITION(334:353)		CHAR NULLIF(PRP_COD_TIPO_PRP=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:PRP_COD_TIPO_PRP),';',' '), '\"',''),'''','')",
