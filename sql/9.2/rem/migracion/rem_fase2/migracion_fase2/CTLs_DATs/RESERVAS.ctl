...
(	
	...
	RES_IMPORTE					POSITION(140:156)		INTEGER EXTERNAL 											"CASE WHEN (:RES_IMPORTE) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:RES_IMPORTE,1,15)||','||SUBSTR(:RES_IMPORTE,16,2)),';',' '), '\"',''),'''','')) END",
