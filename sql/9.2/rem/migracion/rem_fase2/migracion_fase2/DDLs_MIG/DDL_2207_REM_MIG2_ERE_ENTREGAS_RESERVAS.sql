...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_ERE_ENTREGAS_RESERVAS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_ERE_ENTREGAS_RESERVAS';
...
(
	...
	ERE_OBSERVACIONES		VARCHAR2(256 CHAR)
