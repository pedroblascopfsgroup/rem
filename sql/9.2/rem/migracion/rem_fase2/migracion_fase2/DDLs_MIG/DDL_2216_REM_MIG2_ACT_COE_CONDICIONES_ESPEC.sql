...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_ACT_COE_CONDICIONES_ESPEC'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_ACT_COE_CONDICIONES_ESPEC';
...
(
        COE_ACT_NUMERO_ACTIVO                   NUMBER(16,0)                NOT NULL,     
        COE_FECHA_DESDE                                 DATE                                            NOT NULL,
        COE_FECHA_HASTA                                 DATE,
        COE_COD_TEXTO                                   VARCHAR2(20 CHAR),
        COE_COD_USUARIO_ALTA                    VARCHAR2(50 CHAR),
        COE_COD_USUARIO_BAJA                    VARCHAR2(50 CHAR)
)'
;
