...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GPV_ACT_TBJ'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GPV_ACT_TBJ';
...
BEGIN
        ...
        (
                GPT_GPV_ID                                              NUMBER(16)                                      NOT NULL,
                GPT_ACT_NUMERO_ACTIVO                   NUMBER(16),
                GPT_TBJ_NUM_TRABAJO                             NUMBER(16),
                GPT_BASE_IMPONIBLE                              NUMBER(16,2)                            NOT NULL
        )'
        ;
