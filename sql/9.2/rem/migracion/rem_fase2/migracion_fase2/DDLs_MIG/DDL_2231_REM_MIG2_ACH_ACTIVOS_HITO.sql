...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_ACH_ACTIVOS_HITO'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_ACH_ACTIVOS_HITO';
...
BEGIN
        ...
        (
                ACH_NUMERO_ACTIVO                       NUMBER(16,0)    NOT NULL,
                ACH_CODIGO_HITO                         NUMBER(2,0)             NOT NULL
        )'
        ;
