...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GPV_ACT'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GPV_ACT';
...
BEGIN
	...
	(
		GPA_COD_GASTO_PROVEEDOR			NUMBER(16)				NOT NULL,
		GPA_ACT_NUMERO_ACTIVO			NUMBER(16)				NOT NULL
	)'
	;
