...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GDE_GASTOS_DETALLE_ECONOMICO'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GDE_GASTOS_DETALLE_ECONOMICO';
...
BEGIN
	...
	(
		...
		GDE_IND_IMP_INDIR_RENUNCIA_EXENCION			NUMBER(1),
		...
		GDE_COD_RESPONSABLE_PAGO_FUERA_PLAZO		VARCHAR2(20 CHAR)
	)'
	;
