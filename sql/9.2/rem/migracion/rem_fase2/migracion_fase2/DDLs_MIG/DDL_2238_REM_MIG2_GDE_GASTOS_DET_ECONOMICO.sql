...
BEGIN
	...
	(
		GDE_COD_GASTO_PROVEEDOR						NUMBER(16)				NOT NULL,
		...
		GDE_TITULAR_CUENTA							VARCHAR2(50 CHAR),
		GDE_NIF_TITULAR_CUENTA						VARCHAR2(50 CHAR),
		GDE_PAGADO_CONEXION_BANKIA					NUMBER(1,0),
		GDE_NUMERO_CONEXION							VARCHAR2(50 CHAR),
		GDE_OFICINA_BANKIA							VARCHAR2(50 CHAR)
	)'
	;
