...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GIM_GASTOS_IMPUGANCION'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GIM_GASTOS_IMPUGANCION';
...
BEGIN
	...
	(
		...
		GIM_FECHA_TOPE_IMPUGANCION				DATE,
		GIM_FECHA_PRESENTACION_IMPUGANCION		DATE,
