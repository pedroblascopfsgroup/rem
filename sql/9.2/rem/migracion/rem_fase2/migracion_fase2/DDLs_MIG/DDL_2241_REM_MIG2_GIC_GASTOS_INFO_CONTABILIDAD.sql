...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_GIC_GASTOS_INFO_CONTABILIDAD'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_GIC_GASTOS_INFO_CONTABILIDAD';
...
BEGIN
	...
	(
		GIC_COD_GASTO_INFO_CONTABILIDAD				NUMBER(16)				NOT NULL,
		GIC_EJERCICIO								NUMBER(4),
		GIC_COD_PARTIDA_PRESUPUESTARIA				VARCHAR2(20 CHAR),
		GIC_COD_CUENTA_CONTABLE						VARCHAR2(20 CHAR),
		GIC_FECHA_CONTABILIZACION					DATE,
		GIC_COD_DESTINATARIO_CONTABILIZA			VARCHAR2(20 CHAR),
		GIC_FECHA_DEVENGO_ESPECIAL					DATE,
		GIC_COD_PERIODICIDAD_ESPECIAL				VARCHAR2(20 CHAR),
		GIC_COD_PARTIDA_PRESUP_ESPECIAL				VARCHAR2(20 CHAR),
		GIC_COD_CUENTA_CONTABLE_ESPECIAL			VARCHAR2(20 CHAR)
	)'
	;
