...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_APD_ACTIVO_PLANDINVENTAS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_APD_ACTIVO_PLANDINVENTAS';
...
BEGIN
	...
	(
		APD_ACT_NUMERO_ACTIVO						NUMBER(16,0)			NOT NULL,
		APD_NOMBRE_ACREEDOR_ANTERIOR				VARCHAR2(100 CHAR)
	)'
	;
