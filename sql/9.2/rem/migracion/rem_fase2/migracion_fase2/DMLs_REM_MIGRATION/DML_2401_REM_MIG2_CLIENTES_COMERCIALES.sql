...
--## PRODUCTO=NO
--## 
--## Finalidad: Proceso de migración 'MIG2_CLC_CLIENTES_COMERCIALES' -> 'CLC_CLIENTE_COMERCIAL'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA_MIG VARCHAR2(40 CHAR) := 'MIG2_CLC_CLIENTES_COMERCIALES';
...
BEGIN
      ...
      '||V_ESQUEMA||'.S_.CLC_REM_ID.NEXTVAL                                        AS CLC_REM_ID,
      ...
      MIG2.CLC_COD_USUARIO_LDAP_ACCION                                           AS USU_ID,
      (SELECT DD.DD_TDI_ID 
      ...
      (SELECT DD.DD_TVI_ID
        ...
        WHERE DD.DD_TVI_CODIGO = MIG.CLC_COD_TIPO_VIA
