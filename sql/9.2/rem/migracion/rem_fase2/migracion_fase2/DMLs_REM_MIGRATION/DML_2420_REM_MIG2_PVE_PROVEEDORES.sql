...
BEGIN
      ...
      ( 
            ...
            FROM '||V_ESQUEMA||'.MIG2_PVE_PROVEEDORES MIG
                  ...
                  INNER JOIN '||V_ESQUEMA||'.DD_TDI_TIPO_DOCUMENTO_ID TDI ON TDI.DD_TDI_CODIGO = MIG.PVE_COD_TIPO_DOCUMENTO
                  INNER JOIN '||V_ESQUEMA||'.'||V_TABLA||' PVE ON PVE.PVE_COD_UVEM = MIG.PVE_COD_API_PROVEEDOR AND PVE.DD_TPR_ID = TPR.DD_TPR_ID
