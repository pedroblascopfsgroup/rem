 ...
 -- Registros insertados en REM
  ...
  IF V_REJECTS != 0 THEN
    ...
    IF TABLE_COUNT != 0 THEN
      ...
      V_OBSERVACIONES := 'Del total de registros rechazados, '||TABLE_COUNT||' han sido por PROVEEDORES inexistentes. ';
    ...
    IF TABLE_COUNT_2 != 0 THEN
      ...
      V_OBSERVACIONES := 'Del total de registros rechazados, '||TABLE_COUNT_2||' han sido por DD_TDP_TIPO_DIR_PROVEEDOR inexistentes. ';
