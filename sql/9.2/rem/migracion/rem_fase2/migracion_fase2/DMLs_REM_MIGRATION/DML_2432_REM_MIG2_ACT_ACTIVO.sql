      ...
      V_SENTENCIA := '
        ...
        USING ( SELECT  
                ...
                WHEN MATCHED THEN UPDATE SET
                  ...
                  ,ACT.DD_TPU_ID = (SELECT DD_TPU_ID FROM DD_TPU_TIPO_PUBLICACION WHERE DD_TPU_CODIGO = AUX.ACT_COD_TIPO_PUBLICACION)
                  ,ACT.DD_EPU_ID = (SELECT DD_EPU_ID FROM DD_EPU_ESTADO_PUBLICACION WHERE DD_EPU_CODIGO = AUX.ACT_COD_ESTADO_PUBLICACION)
                  ,ACT.DD_TCO_ID = (SELECT DD_TCO_ID FROM DD_TCO_TIPO_COMERCIALIZACION WHERE DD_TCO_CODIGO = AUX.ACT_COD_TIPO_COMERCIALIZACION)
