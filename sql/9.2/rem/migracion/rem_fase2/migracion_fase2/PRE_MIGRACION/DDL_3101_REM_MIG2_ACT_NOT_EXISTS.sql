...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla para registrar los numeros de activo (ACT_NUMERO_ACTIVO) inexistentes en ACT_ACTIVO que vienen provistos en las interfaces. FASE 2
--##           
...
DECLARE
    ...
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para registrar los activos no existentes en ACT_ACTIVO que vienen aprovisionados en migración. FASE 2'; -- Vble. para los comentarios de las tablas
