...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DELETE FROM REM01.RSR_REGISTRO_SQLS WHERE RSR_NOMBRE_SCRIPT LIKE ''%MIG2%''
							AND RSR_NOMBRE_SCRIPT != ''DML_1449_REM_MIG2_PRO_PROPIETARIOS.sql''
							AND RSR_NOMBRE_SCRIPT != ''DML_1461_REM_MIG2_PVE_PROVEEDORES.sql''
							AND RSR_NOMBRE_SCRIPT != ''DML_1462_REM_MIG2_PVC_PROVEEDOR_CONTACTO.sql''';
