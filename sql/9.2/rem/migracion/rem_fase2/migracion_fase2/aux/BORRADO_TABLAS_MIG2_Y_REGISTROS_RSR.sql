...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DELETE FROM REM01.MIG_INFO_TABLE WHERE TABLA_MIG LIKE ''%MIG2%'' 
							AND TABLA_MIG != ''MIG2_PVC_PROVEEDOR_CONTACTO''
							AND TABLA_MIG != ''MIG2_PRD_PROVEEDOR_DIRECCION''
							AND TABLA_MIG != ''MIG2_PVE_PROVEEDORES''
							AND TABLA_MIG != ''MIG2_PRO_PROPIETARIOS'' ';
    ...
    EXECUTE IMMEDIATE 'DELETE FROM REM01.RSR_REGISTRO_SQLS WHERE RSR_NOMBRE_SCRIPT LIKE ''%MIG2%''
							AND RSR_NOMBRE_SCRIPT != ''DML_1451_REM_MIG2_PRO_PROPIETARIOS.sql''
							AND RSR_NOMBRE_SCRIPT != ''DML_1440_REM_MIG2_PVE_PROVEEDORES.sql''
							AND RSR_NOMBRE_SCRIPT != ''DML_1463_REM_MIG2_PVC_PROVEEDOR_CONTACTO.sql''
							AND RSR_NOMBRE_SCRIPT != ''DML_1462_REM_MIG2_PRD_PROVEEDOR_DIRECCION.sql''';
