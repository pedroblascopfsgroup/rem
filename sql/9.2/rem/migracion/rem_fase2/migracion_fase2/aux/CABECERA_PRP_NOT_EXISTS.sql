  ...
  ELSE
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] SE HAN INFORMADO '||TABLE_COUNT||' PRUESTAS DE PRECIOS INEXISTENTES EN PRP_PROPUESTAS_PRECIOS. SE DERIVARÁN A LA TABLA '||V_ESQUEMA||'.MIG2_PRP_NOT_EXISTS.');
