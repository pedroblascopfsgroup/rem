...
BEGIN
  ...
  /*BORRADO*/
    ...
    DELETE FROM REM01.ACT_PVE_PROVEEDOR PVE WHERE PVE.USUARIOCREAR = 'MIG2'; 
	...
	/*FALTA EL BORRADO DE MIG2_PRH_PROP_HIST QUE NO TIENE TABLA FINAL DE MOMENTO Y MIG2_PVC_PROVEEDOR_CONTACTO (UPDTE)*/
    COMMIT;    
