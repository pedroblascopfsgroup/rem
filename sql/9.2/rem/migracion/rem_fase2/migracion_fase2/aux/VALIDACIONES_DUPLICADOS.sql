...
SELECT
      ...
      (SELECT SUM(COUNT(1)) FROM MIG2_CLC_CLIENTE_COMERCIAL GROUP BY CLC_COD_CLIENTE_HAYA HAVING COUNT(1) > 1) AS RESULTADO
FROM DUAL
...
SELECT
      ...
      (SELECT SUM(COUNT(1)) FROM MIG2_CLC_CLIENTE_COMERCIAL GROUP BY CLC_COD_CLIENTE_WEBCOM HAVING COUNT(1) > 1) AS RESULTADO
FROM DUAL
