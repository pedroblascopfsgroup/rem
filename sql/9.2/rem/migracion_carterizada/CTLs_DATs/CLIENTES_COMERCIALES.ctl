...
(
	...
	CLC_COD_LOCALIDAD				POSITION(1418:1437)		CHAR NULLIF(CLC_COD_LOCALIDAD=BLANKS) 					"LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:CLC_COD_LOCALIDAD),';',' '), '\"',''),'''',''),'00000'),5,'0')",
	...
	CLC_COD_PROVINCIA				POSITION(1463:1482)		CHAR NULLIF(CLC_COD_PROVINCIA=BLANKS) 					"TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:CLC_COD_PROVINCIA),';',' '), '\"',''),'''',''))",
