...
(
	...
	COE_COD_TEXTO			POSITION(34:3033)		CHAR NULLIF(COE_COD_TEXTO=BLANKS)						"REPLACE(REPLACE(REPLACE(TRIM(:COE_COD_TEXTO),';',' '), '\"',''),'''','')",
	COE_COD_USUARIO_ALTA	POSITION(3034:3083)		CHAR NULLIF(COE_COD_USUARIO_ALTA=BLANKS)				"REPLACE(REPLACE(REPLACE(TRIM(:COE_COD_USUARIO_ALTA),';',' '), '\"',''),'''','')",
	COE_COD_USUARIO_BAJA	POSITION(3084:3133)		CHAR NULLIF(COE_COD_USUARIO_BAJA=BLANKS)				"REPLACE(REPLACE(REPLACE(TRIM(:COE_COD_USUARIO_BAJA),';',' '), '\"',''),'''','')",
