...
(	
	...
	AOB_TIPO_OBSERVACION			POSITION(68:87)			CHAR NULLIF(AOB_TIPO_OBSERVACION=BLANKS) 				"REPLACE(REPLACE(REPLACE(TRIM(:AOB_TIPO_OBSERVACION),';',' '), '\"',''),'''','')",
	AOB_OBSERVACION					POSITION(88:1111)		CHAR NULLIF(AOB_OBSERVACION=BLANKS) 					"REPLACE(REPLACE(REPLACE(TRIM(:AOB_OBSERVACION),';',' '), '\"',''),'''','')",
	AOB_FECHA						POSITION(1112:1119)		DATE 'YYYYMMDD' NULLIF(AOB_FECHA=BLANKS) 				"REPLACE(:AOB_FECHA, '00000000', '')",
