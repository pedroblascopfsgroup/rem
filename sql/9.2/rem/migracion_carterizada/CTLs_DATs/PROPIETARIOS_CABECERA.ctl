...
(
	...
	LOCALIDAD_PROPIETARIO			POSITION(18:37)		CHAR NULLIF(LOCALIDAD_PROPIETARIO=BLANKS) 				"LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:LOCALIDAD_PROPIETARIO),';',' '), '\"',''),'''',''),'00000'),5,'0')",
	PROVINCIA_PROPIETARIO			POSITION(38:57)		CHAR NULLIF(PROVINCIA_PROPIETARIO=BLANKS) 				"TO_NUMBER(DECODE(TRIM(:PROVINCIA_PROPIETARIO),'0',NULL,REPLACE(REPLACE(REPLACE(TRIM(:PROVINCIA_PROPIETARIO	),';',' '), '\"',''),'''','')))",
	TIPO_PERSONA					POSITION(58:77)		CHAR NULLIF(TIPO_PERSONA=BLANKS)						"TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:TIPO_PERSONA),';',' '), '\"',''),'''',''))",
	...
	LOCALIDAD_CONTACTO				POSITION(747:766)	CHAR NULLIF(LOCALIDAD_CONTACTO=BLANKS) 					"LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:LOCALIDAD_CONTACTO),';',' '), '\"',''),'''',''),'00000'),5,'0')",
	PROVINCIA_CONTACTO				POSITION(767:786)	CHAR NULLIF(PROVINCIA_CONTACTO=BLANKS)					"TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:PROVINCIA_CONTACTO),';',' '), '\"',''),'''',''))",
