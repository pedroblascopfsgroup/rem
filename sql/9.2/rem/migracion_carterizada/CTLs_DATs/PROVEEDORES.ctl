...
(       
        ...
        PVE_COD_PROVINCIA                               POSITION(598:617)               CHAR NULLIF(PVE_COD_PROVINCIA=BLANKS)                           "TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_PROVINCIA),';',' '), '\"',''),'''',''))",
        PVE_COD_LOCALIDAD                               POSITION(618:637)               CHAR NULLIF(PVE_COD_LOCALIDAD=BLANKS)                           "LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_LOCALIDAD),';',' '), '\"',''),'''',''),'00000'),5,'0')",
        ...
        PVE_COD_TIPO_PERSONA                            POSITION(1131:1150)             CHAR NULLIF(PVE_COD_TIPO_PERSONA=BLANKS)                        "TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_TIPO_PERSONA),';',' '), '\"',''),'''',''))",
        ...
        PVE_WEBCOM_ID                                   POSITION(1805:1821)             INTEGER EXTERNAL NULLIF(PVE_WEBCOM_ID=BLANKS)                   "TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_WEBCOM_ID),';',' '), '\"',''),'''',''),2,16))",
