...
(	
	...
	PRD_COD_LOCALIDAD			POSITION(220:239)	CHAR NULLIF(PRD_COD_LOCALIDAD=BLANKS)					"LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:PRD_COD_LOCALIDAD),';',' '), '\"',''),'''',''),'00000'),5,'0')",
	...
	PRD_COD_PROVINCIA			POSITION(266:285)	CHAR NULLIF(PRD_COD_PROVINCIA=BLANKS)					"TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:PRD_COD_PROVINCIA),';',' '), '\"',''),'''',''))",
