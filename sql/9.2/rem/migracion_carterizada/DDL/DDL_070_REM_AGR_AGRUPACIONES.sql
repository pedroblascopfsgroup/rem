...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'MIG2_AGR_AGRUPACIONES'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'MIG2_AGR_AGRUPACIONES';
...
BEGIN
        ...
        (
                ...
                AGR_COD_TIPO_AGRUPACION                 VARCHAR2(20 CHAR),
                AGR_IND_PUBLICADA                               NUMBER(1,0),
                AGR_IND_BLOQUEADA                               NUMBER(1,0),
