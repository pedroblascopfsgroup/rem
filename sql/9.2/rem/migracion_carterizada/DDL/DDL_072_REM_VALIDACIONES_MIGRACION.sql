...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_MIGRACION'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_MIGRACION';
V_SEC VARCHAR2(40 CHAR) := 'S_VALIDACIONES_MIGRACION';
...
BEGIN
        ...
        (
			...
			CLAVE_DATO VARCHAR2(50 CHAR),
			COD_RECHAZO VARCHAR2(25 CHAR),
			MOTIVO_RECHAZO VARCHAR2(4000 CHAR)
		)';
		...
		EXECUTE IMMEDIATE 'CREATE SEQUENCE  '||V_ESQUEMA_1||'.'||V_SEC||' MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 0 CACHE 20 NOORDER  NOCYCLE';
