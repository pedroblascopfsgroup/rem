...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'INTERFAZ_CLAVES'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'INTERFAZ_CLAVE';
...
BEGIN
        ...
        (
			...
			CLAVE_DATO VARCHAR2(30 CHAR),
			CLAVE_POSICION NUMBER (1) DEFAULT 0 NOT NULL
		)';
