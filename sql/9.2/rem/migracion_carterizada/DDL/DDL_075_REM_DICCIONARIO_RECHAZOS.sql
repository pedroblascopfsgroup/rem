...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'DICCIONARIO_RECHAZOS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'DICCIONARIO_RECHAZOS';
...
BEGIN
        ...
        (
			CODIGO_RECHAZO VARCHAR2(50 CHAR),
			MOTIVO_RECHAZO VARCHAR2(200 CHAR)
		)';
