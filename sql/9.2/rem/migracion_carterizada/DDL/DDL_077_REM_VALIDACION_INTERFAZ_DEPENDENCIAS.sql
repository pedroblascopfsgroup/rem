...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VIC_VAL_INTERFAZ_DEP'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VIC_VAL_INTERFAZ_DEP';
V_SEC	VARCHAR2(40 CHAR) := 'S_VIC_VAL_INTERFAZ_DEP';
...
BEGIN
	...
	(
		...
		CAMPO_DEPENDIENTE VARCHAR2(30 CHAR),
