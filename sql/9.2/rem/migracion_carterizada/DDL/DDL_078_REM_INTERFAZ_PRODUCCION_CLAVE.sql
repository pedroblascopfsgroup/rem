...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'INTERFAZ_PRODUCCION_CLAVE'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'INTERFAZ_PRODUCCION_CLAVE';
...
BEGIN
        ...
        (
			NOMBRE_INTERFAZ_PRODUCCION VARCHAR2(50 CHAR),
