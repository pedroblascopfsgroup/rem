...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VIC_VAL_INTERFAZ_PRO'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VIC_VAL_INTERFAZ_PRO';
V_SEC VARCHAR2(30 CHAR) := 'S_VIC_VAL_INTERFAZ_PRO';
...
BEGIN
        ...
        (
			...
			CAMPOS_INTERFAZ VARCHAR2(180 CHAR),
			NOMBRE_PRODUCCION VARCHAR2(50 CHAR),
			CAMPOS_PRODUCCION VARCHAR2(180 CHAR),
