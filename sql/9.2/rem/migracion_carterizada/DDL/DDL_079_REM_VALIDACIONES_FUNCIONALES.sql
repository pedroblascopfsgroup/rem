...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'VIC_VAL_INTERFAZ_FUNC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_PK VARCHAR2(2400 CHAR) := 'PK_VIC_VAL_INTERFAZ_FUNC'; -- Vble. auxiliar para almacenar el nombre de la PK.    
    V_TEXT_SEQ VARCHAR2(2400 CHAR) := 'S_VIC_VAL_INTERFAZ_FUNC'; -- Vble. auxiliar para almacenar el nombre de la Sequencia.
