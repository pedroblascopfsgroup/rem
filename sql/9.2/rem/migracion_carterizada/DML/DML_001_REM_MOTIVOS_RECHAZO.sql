...
DECLARE
  ...
  V_TABLA   VARCHAR2(30 CHAR):= 'DICCIONARIO_RECHAZOS'; 
  ...
  V_DRE T_ARRAY_DRE := T_ARRAY_DRE(
	T_DRE('0','Dato correcto.'),
	T_DRE('1','Dato ya existente o relativo a un dato ya existente.'),
	T_DRE('2','Error en diccionarios.'),
	T_DRE('3','Error validación funcional.'),
	T_DRE('4','Registro dependiente no migrado.'));
