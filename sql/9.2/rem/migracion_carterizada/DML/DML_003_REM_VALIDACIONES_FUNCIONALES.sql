...
DECLARE
    ...
    V_VAL T_ARRAY_VAL := T_ARRAY_VAL(
        ...
        T_VAL('ACT_009'   ,'1'           ,'Activos sin título posesorio'                                                                                                                                      ,'MIG_ACA_CABECERA'                  ,'SELECT DISTINCT #SELECT_STATEMENT# FROM REM01.MIG_ACA_CABECERA AUX WHERE AUX.TIPO_TITULO IS NULL'),        
        ...
        T_VAL('PVE_001'   ,'1'           ,'Proveedores sin estado "Vigente" / "Baja"'                                                                                                                         ,'MIG2_PVE_PROVEEDORES'              ,'SELECT DISTINCT #SELECT_STATEMENT# FROM REM01.MIG2_PVE_PROVEEDORES AUX WHERE NVL(AUX.PVE_COD_ESTADO,''''NULL_VALUE'''') NOT IN (''''04'''',''''07'''',''''NULL_VALUE'''')'),
        ...
        T_VAL('PVE_004'   ,'1'           ,'Proveedores con un tipo de documento identificativo distinto al NIF'                                                                                               ,'MIG2_PVE_PROVEEDORES'              ,'SELECT DISTINCT #SELECT_STATEMENT# FROM REM01.MIG2_PVE_PROVEEDORES AUX WHERE AUX.PVE_COD_TIPO_DOCUMENTO != ''''15'''''),
