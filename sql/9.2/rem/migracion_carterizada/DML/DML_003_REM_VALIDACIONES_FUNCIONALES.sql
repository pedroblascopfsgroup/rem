...
DECLARE
    ...
    V_VAL T_ARRAY_VAL := T_ARRAY_VAL(
        ...
        T_VAL('GPV_007'   ,'1'           ,'Gastos cuyo tipo de operacion no sea Pago gasto, Pago gasto inversion o Abono/Factura rectificativa'                                                               ,'MIG2_GPV_GASTOS_PROVEEDORES'       ,'SELECT DISTINCT #SELECT_STATEMENT# FROM MIG2_GPV_GASTOS_PROVEEDORES AUX WHERE NVL(AUX.GPV_COD_TIPO_OPERACION,''''00'''') IN (''''01'''',''''02'''',''''03'''')')
        );
