...
--Llenamos la segunda tabla ACT_CRE_CARPINTERIA_EXT
  ...
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA2||''',''10''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
...
SELECT
 ...
 ACT.ICO_ID, 
  ...
  COMMIT;
   ...
   EXECUTE IMMEDIATE  'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA4||''',''10''); END;';
...
--Llenamos la quinta tabla ACT_INF_INFRAESTRUCTURA
 ...
 EXECUTE IMMEDIATE  'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA5||''',''10''); END;';
...
SELECT
  ...
  EXECUTE IMMEDIATE  'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA6||''',''10''); END;';
...
SELECT
  ...
  COMMIT;
    ...
    EXECUTE IMMEDIATE  'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA7||''',''10''); END;';
...
SELECT
  ...
  EXECUTE IMMEDIATE  'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA9||''',''10''); END;';
