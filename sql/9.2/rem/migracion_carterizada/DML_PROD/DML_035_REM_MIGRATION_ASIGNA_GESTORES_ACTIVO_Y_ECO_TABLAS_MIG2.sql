...
--## INCIDENCIA_LINK=HREOS-719 Y HREOS-1976 Y HREOS-2209
--## PRODUCTO=NO
--## 
...
V_USUARIO	VARCHAR2(100 char) := '#USUARIO_MIGRACION#';
...
--------------------------------------------------------------------
  ...
  WHERE TGE.DD_TGE_CODIGO = ''GACT'' AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
...
----------------------------------------------------------------------
  ...
  INNER JOIN '||V_ESQUEMA_MASTER||'.DD_TGE_TIPO_GESTOR TGE ON TGE.DD_TGE_ID = GACT.DD_TGE_ID
  WHERE TGE.DD_TGE_CODIGO = ''GCOM'' AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
  ) TMP ON (TMP.GEE_ID = GEE.GEE_ID)
  WHEN MATCHED THEN UPDATE 
  SET GEE.USU_ID = TMP.USU_ID,
  USUARIOMODIFICAR = '''||V_USUARIO||''',
...
----------------------------------------------------------------------
  ...
  INNER JOIN '||V_ESQUEMA_MASTER||'.DD_TGE_TIPO_GESTOR TGE ON TGE.DD_TGE_ID = GACT.DD_TGE_ID
  WHERE TGE.DD_TGE_CODIGO = ''GGADM''  AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
  ) TMP ON (TMP.GEE_ID = GEE.GEE_ID)
  WHEN MATCHED THEN UPDATE 
  SET GEE.USU_ID = TMP.USU_ID,
  USUARIOMODIFICAR = '''||V_USUARIO||''',
...
----------------------------------------------------------------------
  ...
  INNER JOIN '||V_ESQUEMA_MASTER||'.DD_TGE_TIPO_GESTOR TGE ON TGE.DD_TGE_ID = GACT.DD_TGE_ID
  WHERE TGE.DD_TGE_CODIGO = ''GIAADMT''  AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
  ) TMP ON (TMP.GEE_ID = GEE.GEE_ID)
  WHEN MATCHED THEN UPDATE 
  SET GEE.USU_ID = TMP.USU_ID,
  USUARIOMODIFICAR = '''||V_USUARIO||''',
...
------------------------------------------------------------------
  ...
  INSERT INTO '||V_ESQUEMA||'.GESTOR_ACTIVOS_ACTUALIZAR (
    ...
    AND GEE.BORRADO = 0 AND MIG.VALIDACION = 0
   '
   ;
  ...
  INNER JOIN '||V_ESQUEMA_MASTER||'.DD_TGE_TIPO_GESTOR TGE ON TGE.DD_TGE_ID = GACT.DD_TGE_ID
  WHERE TGE.DD_TGE_CODIGO = ''GFORM''  AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
  ) TMP ON (TMP.GEE_ID = GEE.GEE_ID)
  WHEN MATCHED THEN UPDATE 
  SET GEE.USU_ID = TMP.USU_ID,
  USUARIOMODIFICAR = '''||V_USUARIO||''',
...
------------------------------------------------------------------
  ...
  INSERT INTO '||V_ESQUEMA||'.GESTOR_ACTIVOS_ACTUALIZAR (
    ...
    AND GEE.BORRADO = 0 AND MIG2.VALIDACION = 0
   '
   ;
  ...
  INNER JOIN '||V_ESQUEMA_MASTER||'.DD_TGE_TIPO_GESTOR TGE ON TGE.DD_TGE_ID = GACT.DD_TGE_ID
  WHERE TGE.DD_TGE_CODIGO = ''GIAFORM''  AND TGE.BORRADO = 0 AND MIG2.VALIDACION = 0
  ) TMP ON (TMP.GEE_ID = GEE.GEE_ID)
  WHEN MATCHED THEN UPDATE 
  SET GEE.USU_ID = TMP.USU_ID,
  USUARIOMODIFICAR = '''||V_USUARIO||''',
