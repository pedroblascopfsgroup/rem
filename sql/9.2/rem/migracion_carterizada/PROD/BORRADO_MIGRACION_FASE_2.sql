...
BEGIN
  ...
  UPDATE REM01.ACT_PRO_PROPIETARIO PRO
	...
	/*
	DELETE FROM ACT_ADM_INF_ADMINISTRATIVA ADM
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND ADM.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_TIT_TITULO TIT
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND TIT.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_AJD_ADJJUDICIAL AJD
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND AJD.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_PDV_PLAN_DIN_VENTAS PDV
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND PDV.ACT_ID = T1.ACT_ID
	)
	;	

	DELETE FROM ACT_MLV_MOVIMIENTO_LLAVE MLV
	WHERE EXISTS (
		SELECT 1 FROM ACT_LLV_LLAVE A
		WHERE EXISTS (
		  SELECT 1 
		  FROM ACT_ACTIVO T1 
		  WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) 
		  AND A.ACT_ID = T1.ACT_ID
		) AND MLV.LLV_ID = A.LLV_ID
	)
	;

	DELETE FROM ACT_LLV_LLAVE A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_SPS_SIT_POSESORIA A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_REG_INFO_REGISTRAL A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_LOC_LOCALIZACION A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM GAH_GESTOR_ACTIVO_HISTORICO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_INP_INC_PRESUPUESTO MLV
	WHERE EXISTS (
    SELECT 1
    FROM ACT_PTO_PRESUPUESTO A
    WHERE EXISTS (
      SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
    ) AND MLV.PTO_ID = A.PTO_ID
	)
	;

	DELETE FROM ACT_PTO_PRESUPUESTO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_CAT_CATASTRO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_TAS_TASACION A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM GAC_GESTOR_ADD_ACTIVO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM TAC_TAREAS_ACTIVOS A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_HEP_HIST_EST_PUBLICACION A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_AOB_ACTIVO_OBS A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_ADN_ADJNOJUDICIAL A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_ADA_ADJUNTO_ACTIVO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_CRG_CARGAS A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_ADO_ADMISION_DOCUMENTO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_AGA_AGRUPACION_ACTIVO A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_AAH_AGRUP_ACTIVO_HIST A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;

	DELETE FROM ACT_HVA_HIST_VALORACIONES A
	WHERE EXISTS (
	  SELECT 1 FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID) AND A.ACT_ID = T1.ACT_ID
	)
	;
	...
	DELETE FROM ACT_ACTIVO T1 WHERE NOT EXISTS (SELECT 1 FROM ACT_CPR_COM_PROPIETARIOS T2 WHERE T2.CPR_ID = T1.CPR_ID);
	*/
