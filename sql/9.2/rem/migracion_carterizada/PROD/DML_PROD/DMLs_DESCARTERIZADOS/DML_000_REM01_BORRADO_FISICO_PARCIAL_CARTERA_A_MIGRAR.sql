...
DECLARE
  ...
  V_FUN T_ARRAY := T_ARRAY(
    ...
    --T_VAR('REM01.ACT_CRG_CARGAS',               'T1.ACT_ID',        'REM01.ACT_ACTIVO',      'T2.ACT_ID'),
    --T_VAR('REM01.BIE_CAR_CARGAS',               'T1.BIE_ID',        'REM01.BIE_BIEN'  ,      'T2.BIE_ID'),
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'TRUNCATE TABLE REM01.ACT_CRG_CARGAS';

    EXECUTE IMMEDIATE 'DELETE FROM REM01.BIE_CAR_CARGAS T1 WHERE NOT EXISTS (SELECT 1 FROM REM01.ACT_CRG_CARGAS T2 WHERE T1.BIE_CAR_ID = T2.BIE_CAR_ID)';
