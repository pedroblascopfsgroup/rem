...
EXECUTE IMMEDIATE ('
  ...
  EXECUTE IMMEDIATE '
    ...
    USING (SELECT ACT_NUMERO_ACTIVO, TIPO_ACTIVO, SUBTIPO_ACTIVO, ESTADO_ACTIVO, ESTADO_GESTION, SITUACION_COMERCIAL, ACT_CON_CARGAS, ACT_FECHA_REV_CARGAS, ESTADO_ADMISION
      FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||' MIG
