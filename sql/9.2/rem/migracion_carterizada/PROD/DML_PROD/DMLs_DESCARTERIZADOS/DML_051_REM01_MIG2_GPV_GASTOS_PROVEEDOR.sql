...
BEGIN
      ...
      V_SENTENCIA := '
      INSERT /*+ APPEND */ INTO '||V_ESQUEMA||'.'||V_TABLA||' (
            GPV_ID
            ,GPV_NUM_GASTO_HAYA
      ...
      FROM INSERTAR INS
            ...
            INNER JOIN '||V_ESQUEMA||'.MIG_AUX_ACT_PVE_PROVEEDOR PVE ON PVE.PVE_COD_UVEM = TO_CHAR(MIG2.GPV_COD_PVE_UVEM_EMISOR)
      ...
      V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA||''',''9''); END;';
      EXECUTE IMMEDIATE V_SENTENCIA;
      ...
      V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA||''',''7''); END;';
      EXECUTE IMMEDIATE V_SENTENCIA;
      ...
      V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''ANALYZE'','''||V_TABLA||''',''3''); END;';
      EXECUTE IMMEDIATE V_SENTENCIA;
