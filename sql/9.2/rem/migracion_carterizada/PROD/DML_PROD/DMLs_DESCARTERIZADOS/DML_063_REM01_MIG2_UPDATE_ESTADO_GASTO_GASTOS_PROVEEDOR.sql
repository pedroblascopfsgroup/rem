...
BEGIN
    ...
    EXECUTE IMMEDIATE 'MERGE INTO REM01.GGE_GASTOS_GESTION T1
        ...
        ON (T1.DD_EAP_ID = T2.DD_EAP_ID AND T2.DD_EAP_CODIGO IN (''05'',''06'',''07''))
        WHEN MATCHED THEN UPDATE SET
            T1.GGE_FECHA_EAP = SYSDATE
        WHERE T1.GGE_FECHA_EAP IS NULL';

    EXECUTE IMMEDIATE 'MERGE INTO REM01.GIC_GASTOS_INFO_CONTABILIDAD T1
        USING (SELECT T1.GIC_ID
            FROM REM01.GIC_GASTOS_INFO_CONTABILIDAD T1
            JOIN REM01.GGE_GASTOS_GESTION T2 ON T1.GPV_ID = T2.GPV_ID 
            JOIN REM01.DD_EAP_ESTADOS_AUTORIZ_PROP T3 ON T3.DD_EAP_ID = T2.DD_EAP_ID AND T3.DD_EAP_CODIGO IN (''05'',''06'',''07'')
            WHERE T1.GIC_FECHA_CONTABILIZACION IS NULL) T2
    ...
    EXECUTE IMMEDIATE 'MERGE INTO REM01.GGE_GASTOS_GESTION T1
        USING REM01.DD_EAP_ESTADOS_AUTORIZ_PROP T2
        ON (T1.DD_EAP_ID = T2.DD_EAP_ID AND T2.DD_EAP_CODIGO IN (''02'',''03'',''04''))
        WHEN MATCHED THEN UPDATE SET
            T1.GGE_FECHA_EAP = SYSDATE
        WHERE T1.GGE_FECHA_EAP IS NULL';
    ...
    -- SHG ELIMINO LINEA ->   --          JOIN REM01.DD_EAP_ESTADOS_AUTORIZ_PROP EAP ON GGE.DD_EAP_ID = EAP.DD_EAP_ID AND EAP.DD_EAP_CODIGO IN (''05'',''06'',''07'')
    V_SENTENCIA := '
        MERGE INTO REM01.GPV_GASTOS_PROVEEDOR T1
        USING (SELECT GPV.GPV_ID 
            FROM REM01.GPV_GASTOS_PROVEEDOR GPV
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GGE.GGE_ID 
            ...
            JOIN REM01.GDE_GASTOS_DETALLE_ECONOMICO GDE ON GDE.GPV_ID = GPV.GPV_ID
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            JOIN REM01.DD_EAP_ESTADOS_AUTORIZ_PROP EAP ON GGE.DD_EAP_ID = EAP.DD_EAP_ID AND EAP.DD_EAP_CODIGO IN (''05'',''06'')
            WHERE GPV.DD_EGA_ID = (SELECT DD_EGA_ID FROM REM01.DD_EGA_ESTADOS_GASTO WHERE DD_EGA_CODIGO = ''05'')) T2
        ON (T1.GGE_ID = T2.GGE_ID)
        WHEN MATCHED THEN UPDATE SET
            T1.DD_EAP_ID = (SELECT DD_EAP_ID FROM REM01.DD_EAP_ESTADOS_AUTORIZ_PROP WHERE DD_EAP_CODIGO = ''07'')
    '
    ;
    EXECUTE IMMEDIATE V_SENTENCIA;
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||'  '||V_ESQUEMA||'.'||V_TABLA||' ACTUALIZADAS. '||V_REG_ACTUALIZADOS||' Filas. ESTADO AUTORIZACION PROP EN GASTOS CON ESTADO PAGADO');
    
    V_SENTENCIA := '
        MERGE INTO REM01.GDE_GASTOS_DETALLE_ECONOMICO T1
        USING (SELECT GDE.GDE_ID, NVL(GIC.GIC_FECHA_CONTABILIZACION,GGE.GGE_FECHA_EAP) FECHA_PAGO
            ...
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            JOIN REM01.DD_EAP_ESTADOS_AUTORIZ_PROP EAP ON GGE.DD_EAP_ID = EAP.DD_EAP_ID AND EAP.DD_EAP_CODIGO IN (''05'',''06'')
            WHERE GDE.GDE_FECHA_PAGO IS NULL AND GPV.DD_EGA_ID = (SELECT DD_EGA_ID FROM REM01.DD_EGA_ESTADOS_GASTO WHERE DD_EGA_CODIGO = ''05'')) T2
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||'  '||V_ESQUEMA||'.'||V_TABLA||' ACTUALIZADAS. '||V_REG_ACTUALIZADOS||' Filas. GASTOS EN ESTADO RECHAZADO PROPIETARIO');
        ...
        USING (SELECT GGE.GGE_ID 
            ...
            JOIN REM01.GDE_GASTOS_DETALLE_ECONOMICO GDE ON GDE.GPV_ID = GPV.GPV_ID
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            JOIN REM01.DD_EAP_ESTADOS_AUTORIZ_PROP EAP ON GGE.DD_EAP_ID = EAP.DD_EAP_ID AND EAP.DD_EAP_CODIGO IN (''02'',''03'')
            WHERE GPV.DD_EGA_ID = (SELECT DD_EGA_ID FROM REM01.DD_EGA_ESTADOS_GASTO WHERE DD_EGA_CODIGO = ''08'')) T2
        ON (T1.GGE_ID = T2.GGE_ID)
        WHEN MATCHED THEN UPDATE SET
            T1.DD_EAP_ID = (SELECT DD_EAP_ID FROM REM01.DD_EAP_ESTADOS_AUTORIZ_PROP WHERE DD_EAP_CODIGO = ''04'')
    '
    ;
    EXECUTE IMMEDIATE V_SENTENCIA;
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||'  '||V_ESQUEMA||'.'||V_TABLA||' ACTUALIZADAS. '||V_REG_ACTUALIZADOS||' Filas. ESTADO AUTORIZACION PROP EN GASTOS EN ESTADO RECHAZADO PROPIETARIO');
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GPV.GPV_ID 
            ...
            JOIN REM01.GDE_GASTOS_DETALLE_ECONOMICO GDE ON GDE.GPV_ID = GPV.GPV_ID
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            WHERE GGE.DD_EAP_ID IS NULL AND GPV.DD_EGA_ID IS NULL AND 
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GPV.GPV_ID 
            ...
            WHERE GPV.DD_EGA_ID IS NULL AND GPV.PVE_ID_EMISOR IS NOT NULL AND GPV.DD_TGA_ID IS NOT NULL 
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GPV.GPV_ID 
            ...
            WHERE GPV.DD_EGA_ID IS NULL) T2
        ON (T1.GPV_ID = T2.GPV_ID)
        WHEN MATCHED THEN UPDATE SET
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GGE.GGE_ID 
            ...
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            JOIN REM01.DD_EAH_ESTADOS_AUTORIZ_HAYA EAH ON GGE.DD_EAH_ID = EAH.DD_EAH_ID AND EAH.DD_EAH_CODIGO = ''03''
            WHERE GPV.DD_EGA_ID = (SELECT DD_EGA_ID FROM REM01.DD_EGA_ESTADOS_GASTO WHERE DD_EGA_CODIGO = ''03'') 
    ...
    V_SENTENCIA := '
        ...
        USING (SELECT GGE.GGE_ID 
            ...
            JOIN REM01.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
            JOIN REM01.DD_EAH_ESTADOS_AUTORIZ_HAYA EAH ON GGE.DD_EAH_ID = EAH.DD_EAH_ID AND EAH.DD_EAH_CODIGO = ''02''
            WHERE GPV.DD_EGA_ID = (SELECT DD_EGA_ID FROM REM01.DD_EGA_ESTADOS_GASTO WHERE DD_EGA_CODIGO = ''02'') 
                AND GGE.GGE_FECHA_EAH IS NULL) T2
        ON (T1.GGE_ID = T2.GGE_ID)
        WHEN MATCHED THEN UPDATE SET
            T1.GGE_FECHA_EAH = SYSTIMESTAMP
