...
WHERE GEA.VALIDACION = 0 AND GEE.GEE_ID IS NULL
      ...
      DBMS_OUTPUT.PUT_LINE('  [INFO] INSERCION EN GAC_GESTOR_ADD_ACTIVO ');
       ...
       V_SQL := '
        ...
        SELECT GEA.GEE_ID, ACT.ACT_ID
        FROM '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD GEA
    ...
    WHERE GEA.VALIDACION = 0 AND GEE.GEH_ID IS NULL
      ...
      DBMS_OUTPUT.PUT_LINE('  [INFO] INSERCION EN GAH_GESTOR_ACTIVO_HISTORICO ');
       ...
       V_SQL := '
        ...
        SELECT GEA.GEH_ID, ACT.ACT_ID
        FROM REM01.GEH_GESTOR_ENTIDAD_HIST GEE
        LEFT JOIN REM01.GAH_GESTOR_ACTIVO_HISTORICO GAH ON GAH.GEH_ID = GEE.GEH_ID AND TO_CHAR(GAH.ACT_ID) = GEE.USUARIOMODIFICAR
        WHERE GEE.USUARIOCREAR = '''||USUARIO_MIGRACION||''' AND GEE.USUARIOMODIFICAR IS NOT NULL AND GAH.GEH_ID IS NULL
      '
      ;
      EXECUTE IMMEDIATE V_SQL;
