...
DECLARE
      ...
      V_USUARIO VARCHAR2(50 CHAR) := 'MIG_SAREB';
...
SELECT TBJ.TBJ_ID, ACT.ACT_ID
    , CASE WHEN TTR.DD_TTR_CODIGO = ''02'' THEN TPO_T004.DD_TPO_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO = ''18'' THEN TPO_T003.DD_TPO_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO = ''20'' THEN TPO_T008.DD_TPO_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO IN (''13'',''15'',''16'',''17'') THEN TPO_T002.DD_TPO_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' THEN TPO_T002.DD_TPO_ID
        END DD_TPO_ID
    , CASE WHEN TTR.DD_TTR_CODIGO = ''02'' THEN TAP_T004.TAP_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO = ''18'' THEN TAP_T003.TAP_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO = ''20'' THEN TAP_T008.TAP_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' AND STR.DD_STR_CODIGO IN (''13'',''15'',''16'',''17'') THEN TAP_T002.TAP_ID
        WHEN TTR.DD_TTR_CODIGO = ''03'' THEN TAP_T002.TAP_ID
        END TAP_ID
...
JOIN REM01.DD_EST_ESTADO_TRABAJO EST ON EST.DD_EST_ID = TBJ.DD_EST_ID AND EST.DD_EST_CODIGO IN (''01'',''04'',''09'',''10'',''11'',''13'')
