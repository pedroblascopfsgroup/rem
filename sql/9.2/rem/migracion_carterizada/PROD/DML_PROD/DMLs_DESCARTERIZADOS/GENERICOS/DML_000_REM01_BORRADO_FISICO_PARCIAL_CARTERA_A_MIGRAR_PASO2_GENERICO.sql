...
BEGIN
    ...
    V_MSQL := 'DELETE FROM REM01.ACT_OFR T1
    ...
    UPDATE ACT_ACTIVO SET USUARIOBORRAR = REPLACE(USUARIOBORRAR, 'BORRADO_FISICO_TABLAS_ACTIVOS_RECIBIDOS', '') WHERE USUARIOBORRAR LIKE 'BORRADO_FISICO_TABLAS_ACTIVOS_RECIBIDOS%';
