...
create or replace PROCEDURE ACTIVACION_BORRADO_CARTERA ( cartera REM01.DD_CRA_CARTERA.DD_CRA_DESCRIPCION%TYPE ) AUTHID CURRENT_USER IS
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('  [INFO] - '||TO_CHAR(SYSDATE,'HH24:MI:SS')||' - Se han activado '||SQL%ROWCOUNT||' filas en '||V_ESQUEMA||'.ACT_ACTIVO');
