...
(
	...
	GDE_PAGADO_CONEXION							POSITION(658:659)	INTEGER EXTERNAL NULLIF(GDE_PAGADO_CONEXION=BLANKS)					"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GDE_PAGADO_CONEXION),';',' '), '\"',''),'''',''),2,1))",
	...
	GDE_OFICINA									POSITION(672:675)	CHAR NULLIF(GDE_OFICINA=BLANKS)										"REPLACE(REPLACE(REPLACE(TRIM(:GDE_OFICINA),';',' '), '\"',''),'''','')",
	GDE_FECHA_CONEXION           				POSITION(676:683)   DATE 'YYYYMMDD'  NULLIF(GDE_FECHA_CONEXION=BLANKS)                  "REPLACE(:GDE_FECHA_CONEXION, '00000000', '')",
	GDE_ANTICIPO           						POSITION(684:685)   INTEGER EXTERNAL  NULLIF(GDE_ANTICIPO=BLANKS)                  		"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:GDE_ANTICIPO),';',' '), '\"',''),'''',''),2,1))",
	GDE_FECHA_ANTICIPO           				POSITION(686:693)   DATE 'YYYYMMDD'  NULLIF(GDE_FECHA_ANTICIPO=BLANKS)                  "REPLACE(:GDE_FECHA_ANTICIPO, '00000000', '')",
