...
TRAILING NULLCOLS
(       
		PVE_COD_ORIGEN           						POSITION(1:17)                	   INTEGER EXTERNAL                   								"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_ORIGEN),';',' '), '\"',''),'''',''),2,16))",
		TIPO_PROVEEDOR           						POSITION(18:37)                    CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:TIPO_PROVEEDOR),';',' '), '\"',''),'''','')",
		...
		TIPO_DOCUMENTO           						POSITION(538:557)                  CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:TIPO_DOCUMENTO),';',' '), '\"',''),'''','')",
		PVE_DOCIDENTIF           						POSITION(558:577)                  CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:PVE_DOCIDENTIF),';',' '), '\"',''),'''','')",
		ZONA_GEOGRAFICA           						POSITION(578:597)                  CHAR  NULLIF(ZONA_GEOGRAFICA=BLANKS)                  			"REPLACE(REPLACE(REPLACE(TRIM(:ZONA_GEOGRAFICA),';',' '), '\"',''),'''','')",
		PVE_PROVINCIA           						POSITION(598:617)                  CHAR  NULLIF(PVE_PROVINCIA=BLANKS)                  				"NVL(TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(:PVE_PROVINCIA),';',' '), '\"',''),'''','')), 0)",
		PVE_LOCALIDAD           						POSITION(618:637)                  CHAR  NULLIF(PVE_LOCALIDAD=BLANKS)                  				"LPAD(NVL(REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_LOCALIDAD),';',' '), '\"',''),'''',''),'00000'),5,'0')",
		PVE_CP           								POSITION(638:646)                  INTEGER EXTERNAL  NULLIF(PVE_CP=BLANKS)                  		"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_CP),';',' '), '\"',''),'''',''),2,8))",
		PVE_DIRECCION           						POSITION(647:896)                  CHAR  NULLIF(PVE_DIRECCION=BLANKS)                  				"REPLACE(REPLACE(REPLACE(TRIM(:PVE_DIRECCION),';',' '), '\"',''),'''','')",
		PVE_TELF1           							POSITION(897:916)                  CHAR  NULLIF(PVE_TELF1=BLANKS)                  					"REPLACE(REPLACE(REPLACE(TRIM(:PVE_TELF1),';',' '), '\"',''),'''','')",
		PVE_TELF2           							POSITION(917:936)                  CHAR  NULLIF(PVE_TELF2=BLANKS)                  					"REPLACE(REPLACE(REPLACE(TRIM(:PVE_TELF2),';',' '), '\"',''),'''','')",
		PVE_FAX           								POSITION(937:956)                  CHAR  NULLIF(PVE_FAX=BLANKS)                  					"REPLACE(REPLACE(REPLACE(TRIM(:PVE_FAX),';',' '), '\"',''),'''','')",
		PVE_EMAIL           							POSITION(957:1006)                 CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:PVE_EMAIL),';',' '), '\"',''),'''','')",
		PVE_PAGINA_WEB           						POSITION(1007:1056)                CHAR  NULLIF(PVE_PAGINA_WEB=BLANKS)                  			"REPLACE(REPLACE(REPLACE(TRIM(:PVE_PAGINA_WEB),';',' '), '\"',''),'''','')",
		PVE_FRANQUICIA           						POSITION(1057:1058)                INTEGER EXTERNAL  NULLIF(PVE_FRANQUICIA=BLANKS)                  "TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_FRANQUICIA),';',' '), '\"',''),'''',''),2,1))",
		PVE_IVA_CAJA           							POSITION(1059:1060)                INTEGER EXTERNAL  NULLIF(PVE_IVA_CAJA=BLANKS)                  	"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_IVA_CAJA),';',' '), '\"',''),'''',''),2,1))",
		PVE_NUM_CUENTA           						POSITION(1061:1110)                CHAR  NULLIF(PVE_NUM_CUENTA=BLANKS)                  			"REPLACE(REPLACE(REPLACE(TRIM(:PVE_NUM_CUENTA),';',' '), '\"',''),'''','')",
		PVE_COD_TIPO_COLABORADOR           				POSITION(1111:1130)                CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_TIPO_COLABORADOR),';',' '), '\"',''),'''','')",
		...
		PVE_COD_ESTADO           						POSITION(1189:1208)                CHAR                   											"REPLACE(REPLACE(REPLACE(TRIM(:PVE_COD_ESTADO),';',' '), '\"',''),'''','')",
		...
		PVE_IND_MODIFICAR_DATOS_WEB           			POSITION(1803:1804)                INTEGER EXTERNAL  NULLIF(PVE_IND_MODIFICAR_DATOS_WEB=BLANKS)     "TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PVE_IND_MODIFICAR_DATOS_WEB),';',' '), '\"',''),'''',''),2,1))",
