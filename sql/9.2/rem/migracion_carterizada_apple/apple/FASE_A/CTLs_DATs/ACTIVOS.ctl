...
ACT_NUMERO_INMOVILIZADO POSITION(282:298) INTEGER EXTERNAL "CASE WHEN (:ACT_NUMERO_INMOVILIZADO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:ACT_NUMERO_INMOVILIZADO,1,17)||','||SUBSTR(:ACT_NUMERO_INMOVILIZADO,18,0)),';',' '), '\"',''),'''','')) END",
...
ACT_IBI_EXENTO POSITION(709:710) INTEGER EXTERNAL "CASE WHEN (:ACT_IBI_EXENTO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:ACT_IBI_EXENTO,1,2)||','||SUBSTR(:ACT_IBI_EXENTO,3,0)),';',' '), '\"',''),'''','')) END",
