...
AJD_ID_ASUNTO POSITION(429:445) INTEGER EXTERNAL "CASE WHEN (:AJD_ID_ASUNTO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:AJD_ID_ASUNTO,1,17)||','||SUBSTR(:AJD_ID_ASUNTO,18,0)),';',' '), '\"',''),'''','')) END",
...
BIE_ADJ_OCUPADO POSITION(579:580) INTEGER EXTERNAL "CASE WHEN (:BIE_ADJ_OCUPADO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:BIE_ADJ_OCUPADO,1,2)||','||SUBSTR(:BIE_ADJ_OCUPADO,3,0)),';',' '), '\"',''),'''','')) END",
...
BIE_ADJ_EXISTE_INQUILINO POSITION(591:592) INTEGER EXTERNAL "CASE WHEN (:BIE_ADJ_EXISTE_INQUILINO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:BIE_ADJ_EXISTE_INQUILINO,1,2)||','||SUBSTR(:BIE_ADJ_EXISTE_INQUILINO,3,0)),';',' '), '\"',''),'''','')) END",
...
BIE_ADJ_GESTORIA_ADJUDIC POSITION(595:611) INTEGER EXTERNAL "CASE WHEN (:BIE_ADJ_GESTORIA_ADJUDIC) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:BIE_ADJ_GESTORIA_ADJUDIC,1,17)||','||SUBSTR(:BIE_ADJ_GESTORIA_ADJUDIC,18,0)),';',' '), '\"',''),'''','')) END",
...
BIE_ADJ_CESION_REMATE POSITION(959:960) INTEGER EXTERNAL "CASE WHEN (:BIE_ADJ_CESION_REMATE) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:BIE_ADJ_CESION_REMATE,1,2)||','||SUBSTR(:BIE_ADJ_CESION_REMATE,3,0)),';',' '), '\"',''),'''','')) END",
