...
AGR_GESTOR POSITION(18:34) INTEGER EXTERNAL "CASE WHEN (:AGR_GESTOR) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:AGR_GESTOR,1,17)||','||SUBSTR(:AGR_GESTOR,18,0)),';',' '), '\"',''),'''','')) END",
...
AGR_PUBLICADO POSITION(590:591) INTEGER EXTERNAL "CASE WHEN (:AGR_PUBLICADO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:AGR_PUBLICADO,1,2)||','||SUBSTR(:AGR_PUBLICADO,3,0)),';',' '), '\"',''),'''','')) END",
AGR_TEXTO_WEB POSITION(592:1103) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:AGR_TEXTO_WEB),';',' '), '\"',''),'''','')",
AGR_ACT_PRINCIPAL POSITION(1104:1120) INTEGER EXTERNAL "CASE WHEN (:AGR_ACT_PRINCIPAL) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:AGR_ACT_PRINCIPAL,1,17)||','||SUBSTR(:AGR_ACT_PRINCIPAL,18,0)),';',' '), '\"',''),'''','')) END",
LOC_AGRUP_OBRA_NUEVA POSITION(1121:1140) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:LOC_AGRUP_OBRA_NUEVA),';',' '), '\"',''),'''','')",
...
ONV_CP_AGRUP_OBRA_NUEVA POSITION(1436:1444) INTEGER EXTERNAL "CASE WHEN (:ONV_CP_AGRUP_OBRA_NUEVA) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:ONV_CP_AGRUP_OBRA_NUEVA,1,9)||','||SUBSTR(:ONV_CP_AGRUP_OBRA_NUEVA,10,0)),';',' '), '\"',''),'''','')) END",
...
LOC_AGRUP_LOTE_RESTRINGIDO POSITION(1700:1719) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:LOC_AGRUP_LOTE_RESTRINGIDO),';',' '), '\"',''),'''','')",
...
RES_CP_AGRUP_LOTE_RESTRINGIDO POSITION(1995:2003) INTEGER EXTERNAL "CASE WHEN (:RES_CP_AGRUP_LOTE_RESTRINGIDO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:RES_CP_AGRUP_LOTE_RESTRINGIDO,1,9)||','||SUBSTR(:RES_CP_AGRUP_LOTE_RESTRINGIDO,10,0)),';',' '), '\"',''),'''','')) END",
...
AGR_IS_FORMALIZACION POSITION(2020:2021) INTEGER EXTERNAL "CASE WHEN (:AGR_IS_FORMALIZACION) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:AGR_IS_FORMALIZACION,1,2)||','||SUBSTR(:AGR_IS_FORMALIZACION,3,0)),';',' '), '\"',''),'''','')) END",
