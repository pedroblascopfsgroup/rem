...
CPR_CONSTITUIDA POSITION(11:12) INTEGER EXTERNAL "CASE WHEN (:CPR_CONSTITUIDA) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:CPR_CONSTITUIDA,1,2)||','||SUBSTR(:CPR_CONSTITUIDA,3,0)),';',' '), '\"',''),'''','')) END",
CPR_NOMBRE POSITION(13:112) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_NOMBRE),';',' '), '\"',''),'''','')",
CPR_NIF POSITION(113:132) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_NIF),';',' '), '\"',''),'''','')",
CPR_DIRECCION POSITION(133:382) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_DIRECCION),';',' '), '\"',''),'''','')",
CPR_NUM_CUENTA POSITION(383:432) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_NUM_CUENTA),';',' '), '\"',''),'''','')",
CPR_PRESIDENTE_NOMBRE POSITION(433:532) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_PRESIDENTE_NOMBRE),';',' '), '\"',''),'''','')",
CPR_PRESIDENTE_TELF POSITION(533:552) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_PRESIDENTE_TELF),';',' '), '\"',''),'''','')",
...
CPR_PRESIDENTE_EMAIL POSITION(573:672) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_PRESIDENTE_EMAIL),';',' '), '\"',''),'''','')",
CPR_PRESIDENTE_DIR POSITION(673:922) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_PRESIDENTE_DIR),';',' '), '\"',''),'''','')",
...
CPR_ADMINISTRADOR_NOMBRE POSITION(939:1038) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_ADMINISTRADOR_NOMBRE),';',' '), '\"',''),'''','')",
CPR_ADMINISTRADOR_TELF POSITION(1039:1058) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_ADMINISTRADOR_TELF),';',' '), '\"',''),'''','')",
...
CPR_ADMINISTRADOR_DIR POSITION(1079:1328) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_ADMINISTRADOR_DIR),';',' '), '\"',''),'''','')",
CPR_ADMINISTRADOR_EMAIL POSITION(1329:1428) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:CPR_ADMINISTRADOR_EMAIL),';',' '), '\"',''),'''','')",
