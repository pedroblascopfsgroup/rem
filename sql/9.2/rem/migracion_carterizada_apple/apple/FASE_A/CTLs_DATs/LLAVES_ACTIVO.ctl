...
MLV_COMPLETO POSITION(305:306) INTEGER EXTERNAL "CASE WHEN (:MLV_COMPLETO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:MLV_COMPLETO,1,2)||','||SUBSTR(:MLV_COMPLETO,3,0)),';',' '), '\"',''),'''','')) END",
