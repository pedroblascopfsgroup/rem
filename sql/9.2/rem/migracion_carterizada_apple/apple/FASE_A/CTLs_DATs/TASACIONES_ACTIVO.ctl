...
TAS_CODIGO_TASA_EXTERNO POSITION(18:34) INTEGER EXTERNAL "CASE WHEN (:TAS_CODIGO_TASA_EXTERNO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_CODIGO_TASA_EXTERNO,1,17)||','||SUBSTR(:TAS_CODIGO_TASA_EXTERNO,18,0)),';',' '), '\"',''),'''','')) END",
TAS_TIPO_TASACION POSITION(35:54) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:TAS_TIPO_TASACION),';',' '), '\"',''),'''','')",
TAS_FECHA_INI_TASACION POSITION(55:62) DATE 'YYYYMMDD' "REPLACE(:TAS_FECHA_INI_TASACION, '00000000', '')",
TAS_FECHA_FIN_TASACION POSITION(63:70) DATE 'YYYYMMDD' "REPLACE(:TAS_FECHA_FIN_TASACION, '00000000', '')",
TAS_F_SOL_TASACION POSITION(71:78) DATE 'YYYYMMDD' NULLIF(TAS_F_SOL_TASACION=BLANKS) "REPLACE(:TAS_F_SOL_TASACION, '00000000', '')",
TAS_IMPORTE_VALOR_TASACION POSITION(79:95) INTEGER EXTERNAL "CASE WHEN (:TAS_IMPORTE_VALOR_TASACION) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_IMPORTE_VALOR_TASACION,1,15)||','||SUBSTR(:TAS_IMPORTE_VALOR_TASACION,16,2)),';',' '), '\"',''),'''','')) END",
...
TAS_OBSERVACIONES POSITION(533:1044) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:TAS_OBSERVACIONES),';',' '), '\"',''),'''','')",
...
TAS_CIF_TASADOR POSITION(1133:1147) CHAR "REPLACE(REPLACE(REPLACE(TRIM(:TAS_CIF_TASADOR),';',' '), '\"',''),'''','')",
...
TAS_FECHA_CADUCIDAD POSITION(1228:1235) DATE 'YYYYMMDD' "REPLACE(:TAS_FECHA_CADUCIDAD, '00000000', '')",
