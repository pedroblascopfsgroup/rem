...
(
	...
	VAL_FECHA_APROBACION	POSITION(71:78)		DATE 'YYYYMMDD' NULLIF(VAL_FECHA_APROBACION=BLANKS) "REPLACE(:VAL_FECHA_APROBACION, '00000000', '')",
	VAL_FECHA_CARGA			POSITION(79:86)		DATE 'YYYYMMDD' NULLIF(VAL_FECHA_CARGA=BLANKS) 		"REPLACE(:VAL_FECHA_CARGA, '00000000', '')",
