...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VIC_VAL_INTERFAZ_DUP'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VIC_VAL_INTERFAZ_DUP';
V_SEC	VARCHAR2(40 CHAR) := 'S_VIC_VAL_INTERFAZ_DUP';
...
BEGIN
	...
	(
		...
		NOMBRE_TABLA_FINAL VARCHAR2(50 CHAR),
