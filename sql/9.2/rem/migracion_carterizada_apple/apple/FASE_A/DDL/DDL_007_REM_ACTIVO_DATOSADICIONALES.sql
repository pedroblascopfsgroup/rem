...
TIPO_VPO VARCHAR2(20 CHAR) NOT NULL,
ADM_SUELO_VPO NUMBER(1,0) ,
ADM_PROMOCION_VPO NUMBER(1,0) ,
ADM_NUM_EXPEDIENTE VARCHAR2(50 CHAR) NOT NULL,
ADM_FECHA_CALIFICACION DATE NOT NULL,
...
SPS_FECHA_TOMA_POSESION DATE NOT NULL,
SPS_OCUPADO NUMBER(1,0) NOT NULL,
SPS_CON_TITULO NUMBER(1,0) NOT NULL,
...
TIPO_TITULO_POSESORIO VARCHAR2(20 CHAR) NOT NULL,
SPS_FECHA_TITULO DATE NOT NULL,
SPS_FECHA_VENC_TITULO DATE NOT NULL,
SPS_RENTA_MENSUAL NUMBER(16,2) NOT NULL,
SPS_FECHA_SOL_DESAHUCIO DATE NOT NULL,
SPS_FECHA_LANZAMIENTO DATE NOT NULL,
SPS_FECHA_LANZAMIENTO_EFECTIVO DATE NOT NULL,
SPS_OTRO VARCHAR2(255 CHAR) ,
SPS_ESTADO_PORTAL_EXTERNO NUMBER(1,0) ,
SPS_NUMERO_CONTRATO_ALQUILER NUMBER(16,0) NOT NULL,
SPS_FECHA_RESOLUCION_CONTRATO DATE NOT NULL,
SPS_LOTE_COMERCIAL NUMBER(16,0) ,
DD_SIJ_ID VARCHAR2(20 CHAR) NOT NULL,
SPS_EDITA_FECHA_TOMA_POSESION NUMBER(1,0) ,
SPS_DISPONIBILIDAD_JURIDICA NUMBER(16,0) NOT NULL,
...
REG_IDUFIR VARCHAR2(50 CHAR) NOT NULL,
...
REG_SUPERFICIE NUMBER(16,2) NOT NULL,
REG_SUPERFICIE_CONSTRUIDA NUMBER(16,2) NOT NULL,
REG_SUPERFICIE_UTIL NUMBER(16,2) NOT NULL,
REG_SUPERFICIE_ELEM_COMUN NUMBER(16,2) NOT NULL,
REG_SUPERFICIE_PARCELA NUMBER(16,2) NOT NULL,
...
ESTADO_OBRA_NUEVA VARCHAR2(20 CHAR) NOT NULL,
REG_FECHA_CFO DATE NOT NULL,
BIE_DREG_INSCRIPCION VARCHAR2(50 CHAR) NOT NULL,
BIE_DREG_MUNICIPIO_LIBRO VARCHAR2(50 CHAR) NOT NULL,
TIPO_UBICACION VARCHAR2(20 CHAR) ,
TIPO_VIA VARCHAR2(20 CHAR) NOT NULL,
LOC_NOMBRE_VIA VARCHAR2(100 CHAR) NOT NULL,
LOC_NUMERO_DOMICILIO VARCHAR2(100 CHAR) NOT NULL,
LOC_PORTAL VARCHAR2(10 CHAR) NOT NULL,
LOC_BLOQUE VARCHAR2(10 CHAR) NOT NULL,
LOC_ESCALERA VARCHAR2(10 CHAR) NOT NULL,
LOC_PISO VARCHAR2(10 CHAR) NOT NULL,
LOC_PUERTA VARCHAR2(10 CHAR) NOT NULL,
LOC_COD_POST VARCHAR2(20 CHAR) NOT NULL,
LOC_BARRIO VARCHAR2(100 CHAR) ,
UNIDAD_INFERIOR_MUNICIPIO VARCHAR2(20 CHAR) ,
MUNICIPIO VARCHAR2(20 CHAR) NOT NULL,
PROVINCIA VARCHAR2(20 CHAR) NOT NULL,
PAIS VARCHAR2(20 CHAR) NOT NULL,
LOC_LONGITUD NUMBER(21,15) NOT NULL,
LOC_LATITUD NUMBER(21,15) NOT NULL,
LOC_DIST_PLAYA NUMBER(16,2) ,
CPR_COD_COM_PROP_EXTERNO VARCHAR2(10 CHAR) ,
ACT_LLV_NECESARIAS NUMBER(1,0) NOT NULL,
ACT_LLV_LLAVES_HRE NUMBER(1,0) NOT NULL,
ACT_LLV_NUM_JUEGOS NUMBER(8,0) NOT NULL,
