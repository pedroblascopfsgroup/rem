...
ESTADO_DOCUMENTO VARCHAR2(20 CHAR) NOT NULL,
ADO_APLICA NUMBER(1,0) NOT NULL,
ADO_NUM_DOCUMENTO NUMBER(16,0) NOT NULL,
ADO_FECHA_VERIFICACION DATE ,
ADO_FECHA_SOLICITUD DATE ,
ADO_FECHA_EMISION DATE ,
ADO_FECHA_OBTENCION DATE NOT NULL,
ADO_FECHA_CADUCIDAD DATE NOT NULL,
ADO_FECHA_ETIQUETA DATE ,
ADO_FECHA_CALIFICACION DATE NOT NULL,
ADO_CALIFICACION VARCHAR2(20 CHAR) NOT NULL,
ADO_REF_DOC VARCHAR2(50 CHAR) NOT NULL,
