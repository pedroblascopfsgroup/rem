...
ACT_COD_TIPO_COMERCIALIZACION VARCHAR2(20 CHAR) NOT NULL,
ACT_COD_TIPO_ALQUILER VARCHAR2(20 CHAR) NOT NULL,
ACT_FECHA_VENTA DATE NOT NULL,
ACT_IMPORTE_VENTA NUMBER(16,2) NOT NULL,
ACT_COD_PROPIETARIO_ANTERIOR NUMBER(16,0) ,
ACT_BLOQUEO_PRECIO_FECHA_INI DATE ,
ACT_BLOQUEO_PRECIO_USU_ID VARCHAR2(50 CHAR) ,
ACT_COD_TIPO_PUBLICACION VARCHAR2(20 CHAR) NOT NULL,
ACT_COD_ESTADO_PUBLICACION VARCHAR2(20 CHAR) NOT NULL,
ACT_FECHA_IND_PRECIAR DATE ,
ACT_FECHA_IND_REPRECIAR DATE ,
ACT_FECHA_IND_DESCUENTO DATE ,
ACT_NUMERO_INMOVILIZADO NUMBER(16,0) NOT NULL,
ACT_CODIGO_ENTRADA VARCHAR2(20 CHAR) ,
SELLO_CALIDAD NUMBER(1,0) ,
GESTOR_CALIDAD VARCHAR2(50 CHAR) ,
FECHA_CALIDAD DATE ,
DD_TCR_ID VARCHAR2(20 CHAR) ,
DD_TAL_ID VARCHAR2(20 CHAR) NOT NULL,
...
ACT_IBI_EXENTO NUMBER(1,0) NOT NULL,
