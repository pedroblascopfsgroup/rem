...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_DICCIONARIOS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_DICCIONARIOS';
V_SEC	VARCHAR2(40 CHAR) := 'S_VALIDACIONES_DICCIONARIOS';
...
BEGIN
	...
	(
		...
		NOMBRE_DICCIONARIO VARCHAR2(50 CHAR),
		NOMBRE_CODIGO VARCHAR2(100 CHAR),
		REQUERIDO NUMBER(1) DEFAULT 0,
