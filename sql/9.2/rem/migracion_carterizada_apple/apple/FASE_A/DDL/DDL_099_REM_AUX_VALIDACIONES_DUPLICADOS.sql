...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_DUPLICADOS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_DUPLICADOS';
V_SEC VARCHAR2(30 CHAR) := 'S_VALIDACIONES_DUPLICADOS';
