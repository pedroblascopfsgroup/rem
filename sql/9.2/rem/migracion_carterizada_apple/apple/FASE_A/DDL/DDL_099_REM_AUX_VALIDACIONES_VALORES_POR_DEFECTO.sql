...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_VALORESDEF'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_VALORESDEF';
V_SEC	VARCHAR2(40 CHAR) := 'S_VALIDACIONES_VALORESDEF';
