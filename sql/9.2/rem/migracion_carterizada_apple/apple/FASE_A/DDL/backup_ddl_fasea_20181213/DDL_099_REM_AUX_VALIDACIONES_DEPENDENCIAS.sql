...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_DEPENDENCIAS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_DEPENDENCIAS';
V_SEC	VARCHAR2(40 CHAR) := 'S_VALIDACIONES_DEPENDENCIAS';
...
BEGIN
	...
	(
		...
		CAMPO_ORIGEN VARCHAR2(50 CHAR),
		NOMBRE_INTERFAZ_DEPENDIENTE VARCHAR2(50 CHAR),
		CAMPO_DEPENDIENTE VARCHAR2(50 CHAR),
		PRIORIDAD_DEPENDENCIA NUMBER(5),
