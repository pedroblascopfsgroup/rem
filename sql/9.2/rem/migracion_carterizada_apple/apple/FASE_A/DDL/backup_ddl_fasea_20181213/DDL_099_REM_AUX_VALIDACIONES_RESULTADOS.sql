...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla de migración 'VALIDACIONES_RESULTADOS'
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'VALIDACIONES_RESULTADOS';
V_SEC VARCHAR2(40 CHAR) := 'S_VALIDACIONES_RESULTADOS';
