...
BEGIN
   ...
   DBMS_OUTPUT.PUT_LINE('[INICIO] Comienza la migración de ACTIVOS PLAN DE INVENTAS');

   -------------------------------------------------
   --INSERCION EN ACT_PDV_PLAN_DIN_VENTAS--
   -------------------------------------------------
   DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_PDV_PLAN_DIN_VENTAS');
  ...
  DBMS_OUTPUT.PUT_LINE('[FIN] Acaba la migración de ACTIVOS PLAN DE INVENTAS');
