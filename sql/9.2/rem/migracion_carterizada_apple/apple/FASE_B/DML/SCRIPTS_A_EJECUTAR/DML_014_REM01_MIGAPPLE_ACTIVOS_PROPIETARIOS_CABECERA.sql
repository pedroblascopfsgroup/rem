...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] Comienza la migración de ACTIVOS PROPIETARIOS CABECERA');

  -------------------------------------------------
  --INSERCION EN ACT_PRO_PROPIETARIO--
  -------------------------------------------------
  ...
  INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (
	...
	(
		  SELECT MIGW.PRO_CODIGO, 
		         MIGW.PRO_COD_CARTERA
	...
	SELECT
		...
		MIG.PRO_SOCIEDAD_PAGADORA										PRO_SOCIEDAD_PAGADORA
  ...
  DBMS_OUTPUT.PUT_LINE('[FIN] Acaba la migración de ACTIVOS PROPIETARIOS CABECERA');
