...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO] Comienza la migración de ACTIVOS CALIDADES');

  -------------------------------------------------
  --INSERCION EN ACT_CRI_CARPINTERIA_INT--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_CRI_CARPINTERIA_INT');
  ...
  SELECT
		...
		MIG.CRI_PTA_ENT_NORMAL								  CRI_PTA_ENT_NORMAL,
		MIG.CRI_PTA_ENT_BLINDADA							  CRI_PTA_ENT_BLINDADA,
		MIG.CRI_PTA_ENT_ACORAZADA							  CRI_PTA_ENT_ACORAZADA,
		MIG.CRI_PTA_PASO_MACIZAS							  CRI_PTA_PASO_MACIZAS,
		MIG.CRI_PTA_PASO_HUECAS								  CRI_PTA_PASO_HUECAS,
		MIG.CRI_PTA_PASO_LACADAS							  CRI_PTA_PASO_LACADAS,
		MIG.CRI_ARMARIOS_EMPOTRADOS							  CRI_ARMARIOS_EMPOTRADOS,
		MIG.CRI_CRP_INT_OTROS								  CRI_CRP_INT_OTROS,    
	    0                                                 	  VERSION,
	    ...
	    0                                                     BORRADO
  FROM '||V_ESQUEMA||'.'||V_TABLA_MIG||' 	MIG
  JOIN '||V_ESQUEMA||'.ACT_NUM_ACTIVO 		ACT ON ACT.ACT_NUMERO_ACTIVO = MIG.ACT_NUMERO_ACTIVO
  ');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_CRE_CARPINTERIA_EXT--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_CRE_CARPINTERIA_EXT');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_PRV_PARAMENTO_VERTICAL--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_PRV_PARAMENTO_VERTICAL');
  ...
  INSERT INTO '||V_ESQUEMA||'.'||V_TABLA3||' (
	  ...
	  FECHABORRAR,
	  BORRADO,
	  PRV_PINTURA_GOTELE_TECHO_EST,
	  PRV_PINTURA_PAPEL_TECHO_EST
  )
  WITH ACT_NUM_ACTIVO AS (
        SELECT MIG.ACT_NUMERO_ACTIVO, 
               ICO.ICO_ID
  ...
  -------------------------------------------------
  --INSERCION EN ACT_SOL_SOLADO--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_SOL_SOLADO');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_INF_INFRAESTRUCTURA--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_INF_INFRAESTRUCTURA');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_ZCO_ZONA_COMUN--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_ZCO_ZONA_COMUN');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_INS_INSTALACION--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_INS_INSTALACION');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_BNY_BANYO--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_BNY_BANYO');
  ...
  -------------------------------------------------
  --INSERCION EN ACT_COC_COCINA--
  -------------------------------------------------
  DBMS_OUTPUT.PUT_LINE('	[INFO] INSERCION EN ACT_COC_COCINA');
  ...
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA3||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA4||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA5||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA6||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA7||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA8||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
  V_SENTENCIA := 'BEGIN '||V_ESQUEMA||'.OPERACION_DDL.DDL_TABLE(''STATS'','''||V_TABLA9||''',''1''); END;';
  EXECUTE IMMEDIATE V_SENTENCIA;
	
  DBMS_OUTPUT.PUT_LINE('[FIN] Acaba la migración de ACTIVOS CALIDADES');
