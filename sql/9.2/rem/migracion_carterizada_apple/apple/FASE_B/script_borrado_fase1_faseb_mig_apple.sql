--BORRADO MIGRACION APPLE FASE I. En éste orden
...
DELETE FROM REM01.ACT_PTO_PRESUPUESTO           WHERE USUARIOCREAR = 'MIG_APPLE';--0
...
DELETE FROM REM01.ACT_AGR_AGRUPACION            WHERE USUARIOCREAR = 'MIG_APPLE';--0
...
DELETE FROM REM01.ACT_ACTIVO                    WHERE USUARIOCREAR = 'MIG_APPLE';--0
