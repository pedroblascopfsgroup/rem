...
PDV_ACREEDOR_CODIGO POSITION(118:134) INTEGER EXTERNAL NULLIF(PDV_ACREEDOR_CODIGO=BLANKS) "CASE WHEN (:PDV_ACREEDOR_CODIGO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:PDV_ACREEDOR_CODIGO,1,17)||','||SUBSTR(:PDV_ACREEDOR_CODIGO,18,0)),';',' '), '\"',''),'''','')) END",
