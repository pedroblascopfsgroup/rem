...
(
	...
	CAT_REFERENCIA_PRINCIPAL 		POSITION(1:1) 		CHAR  NULLIF(CAT_REFERENCIA_PRINCIPAL=BLANKS) "REPLACE(REPLACE(REPLACE(TRIM(:CAT_REFERENCIA_PRINCIPAL),';',' '), '\"',''),'''','')",
	CAT_F_ALTA_CATASTRO 			POSITION(2:9) 		DATE 'YYYYMMDD'  NULLIF(CAT_F_ALTA_CATASTRO=BLANKS) "REPLACE(:CAT_F_ALTA_CATASTRO, '00000000', '')",
	CAT_F_BAJA_CATASTRO 			POSITION(10:17) 	DATE 'YYYYMMDD'  NULLIF(CAT_F_BAJA_CATASTRO=BLANKS) "REPLACE(:CAT_F_BAJA_CATASTRO, '00000000', '')",
	CAT_OBSERVACIONES 			POSITION(18:417) 	CHAR  NULLIF(CAT_OBSERVACIONES=BLANKS) "REPLACE(REPLACE(REPLACE(TRIM(:CAT_OBSERVACIONES),';',' '), '\"',''),'''','')",
