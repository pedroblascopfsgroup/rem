...
TRAILING NULLCOLS
(
	PRO_CODIGO           			POSITION(1:17)                     INTEGER EXTERNAL                   						"TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:PRO_CODIGO),';',' '), '\"',''),'''',''),2,16))",
	...
	POR_COD_CARTERA           		POSITION(2238:2257)                CHAR  NULLIF(POR_COD_CARTERA=BLANKS)                  	"REPLACE(REPLACE(REPLACE(TRIM(:POR_COD_CARTERA),';',' '), '\"',''),'''','')",
