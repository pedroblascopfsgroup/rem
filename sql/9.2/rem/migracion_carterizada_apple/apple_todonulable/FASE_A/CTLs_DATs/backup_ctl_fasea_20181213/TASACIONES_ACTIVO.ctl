...
TAS_CODIGO_TASA_EXTERNO 		POSITION(18:34) 		INTEGER EXTERNAL  "TO_NUMBER(SUBSTR(REPLACE(REPLACE(REPLACE(TRIM(:TAS_CODIGO_TASA_EXTERNO),';',' '), '\"',''),'''',''),2,16))",
...
TAS_VALOR_SEGURO 			POSITION(1079:1095) 		INTEGER EXTERNAL  "CASE WHEN (:TAS_VALOR_SEGURO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_VALOR_SEGURO,1,15)||','||SUBSTR(:TAS_VALOR_SEGURO,16,2)),';',' '), '\"',''),'''','')) END",
TAS_VALOR_LIQUIDATIVO 			POSITION(1096:1112) 		INTEGER EXTERNAL  "CASE WHEN (:TAS_VALOR_LIQUIDATIVO) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_VALOR_LIQUIDATIVO,1,15)||','||SUBSTR(:TAS_VALOR_LIQUIDATIVO,16,2)),';',' '), '\"',''),'''','')) END",
TAS_PORCENTAJE_AJUSTE 			POSITION(1113:1118) 		INTEGER EXTERNAL  "CASE WHEN (:TAS_PORCENTAJE_AJUSTE) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_PORCENTAJE_AJUSTE,1,4)||','||SUBSTR(:TAS_PORCENTAJE_AJUSTE,5,2)),';',' '), '\"',''),'''','')) END",
TAS_TASACION_MODIFICADA 		POSITION(1119:1132) 		INTEGER EXTERNAL  "CASE WHEN (:TAS_TASACION_MODIFICADA) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_TASACION_MODIFICADA,1,12)||','||SUBSTR(:TAS_TASACION_MODIFICADA,13,2)),';',' '), '\"',''),'''','')) END",
TAS_CIF_TASADOR 			POSITION(1133:1147) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_CIF_TASADOR),';',' '), '\"',''),'''','')",
TAS_EXPEDIENTE_EXTERNO 			POSITION(1148:1177) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_EXPEDIENTE_EXTERNO),';',' '), '\"',''),'''','')",
TAS_TECNICO_TASADOR 			POSITION(1178:1227) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_TECNICO_TASADOR),';',' '), '\"',''),'''','')",
TAS_FECHA_CADUCIDAD 			POSITION(1228:1235) 		DATE 'YYYYMMDD'  "REPLACE(:TAS_FECHA_CADUCIDAD, '00000000', '')",
TAS_TASACION_ACTIVA 			POSITION(1236:1236) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_TASACION_ACTIVA),';',' '), '\"',''),'''','')",
TAS_FECHA_VIGENCIA_INI 			POSITION(1237:1244) 		DATE 'YYYYMMDD'  "REPLACE(:TAS_FECHA_VIGENCIA_INI, '00000000', '')",
TAS_FECHA_VIGENCIA_FIN 			POSITION(1245:1252) 		DATE 'YYYYMMDD'  "REPLACE(:TAS_FECHA_VIGENCIA_FIN, '00000000', '')",
TAS_CONDICIONANTE 			POSITION(1253:1253) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_CONDICIONANTE),';',' '), '\"',''),'''','')",
TAS_CONDICIONANTE_OBS 			POSITION(1254:1353) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_CONDICIONANTE_OBS),';',' '), '\"',''),'''','')",
TAS_ORDEN_ECO 				POSITION(1354:1354) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_ORDEN_ECO),';',' '), '\"',''),'''','')",
TAS_ORDEN_ECO_OBS 			POSITION(1355:1454) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_ORDEN_ECO_OBS),';',' '), '\"',''),'''','')",
TAS_ADVERTENCIAS 			POSITION(1455:1455) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_ADVERTENCIAS),';',' '), '\"',''),'''','')",
TAS_ADVERTENCIAS_OBS 			POSITION(1456:1555) 		CHAR  "REPLACE(REPLACE(REPLACE(TRIM(:TAS_ADVERTENCIAS_OBS),';',' '), '\"',''),'''','')",
TAS_PORCENTAJE_PARTICIPACION 		POSITION(1556:1561) 		INTEGER EXTERNAL  "CASE WHEN (:TAS_PORCENTAJE_PARTICIPACION) IS NULL THEN NULL ELSE TO_NUMBER(REPLACE(REPLACE(REPLACE(TRIM(SUBSTR(:TAS_PORCENTAJE_PARTICIPACION,1,4)||','||SUBSTR(:TAS_PORCENTAJE_PARTICIPACION,5,2)),';',' '), '\"',''),'''','')) END",
