...
(
    ...
    PVE_EMAIL                               VARCHAR2(50 CHAR)                                 NOT NULL,
    PVE_PAGINA_WEB                          VARCHAR2(50 CHAR),
    PVE_FRANQUICIA                          NUMBER(1,0),
    PVE_IVA_CAJA                            NUMBER(1,0),
    PVE_NUM_CUENTA                          VARCHAR2(50 CHAR),
    PVE_COD_TIPO_COLABORADOR                VARCHAR2(20)                                  	  NOT NULL,
    PVE_COD_TIPO_PERSONA                    VARCHAR2(20),
    PVE_RAZON_SOCIAL                        VARCHAR2(20),
    PVE_FECHA_ALTA                          DATE                                              NOT NULL,
    PVE_FECHA_BAJA                          DATE,
    PVE_IND_LOCALIZADO                      NUMBER(1,0),
    PVE_COD_ESTADO                          VARCHAR2(20)                                      NOT NULL,
    PVE_FECHA_CONSTITUCION                  DATE,
    PVE_AMBITO                              VARCHAR2(100),
    PVE_OBSERVACIONES                       VARCHAR2(200),
    PVE_IND_HOMOLOGADO                      NUMBER(1,0),
    PVE_COD_CALIFICACION                    VARCHAR2(20),
    PVE_TOP                                 NUMBER(1,0),
    PVE_TITULAR                             VARCHAR2(200),
    PVE_IND_RETENER                         NUMBER(1,0),
    PVE_COD_MOTIVO_RETENCION                VARCHAR2(20),
    PVE_FECHA_RETENCION                     DATE,
    PVE_FECHA_PBC                           DATE,
    PVE_COD_RES_PROCESO_BLANQUEO            VARCHAR2(20),
    PVE_COD_API_PROVEEDOR                   VARCHAR2(4),
