...
BEGIN
        ...
        (
                GPV_NUM_GASTO_PROVEEDOR                 NUMBER(16)						NOT NULL,
                GPV_REFERENCIA_EMISOR                   VARCHAR2(128 CHAR)				NOT NULL,
                GPV_COD_PVE_ORIGEN                 		NUMBER(16)                      NOT NULL,
      ...
      DBMS_OUTPUT.PUT_LINE('ÍNDICE "PK_MIG2_GPV_GASTOS_PROVEE" CREADO.');
        ...
        EXECUTE IMMEDIATE 'CREATE INDEX "REM01"."IDX_GPV_COD_PVE_UVEM_EMISOR" ON "REM01"."MIG2_GPV_GASTOS_PROVEEDORES" (TO_CHAR("GPV_COD_PVE_UVEM_EMISOR")) 
          PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
          STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
          PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
          BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
        ...
        EXECUTE IMMEDIATE 'CREATE INDEX "REM01"."IDX_GPV_NUM_PROVISION_FONDOS" ON "REM01"."MIG2_GPV_GASTOS_PROVEEDORES" ("GPV_NUMERO_PROVISION_FONDOS") 
          PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
          STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
          PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
          BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
