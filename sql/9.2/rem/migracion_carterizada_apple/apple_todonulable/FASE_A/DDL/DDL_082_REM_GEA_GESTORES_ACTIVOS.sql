...
--## PRODUCTO=NO
--##
--## Finalidad: Creación de tabla de migración 'MIG2_GEA_GESTORES_ACTIVOS'
--##
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
        ...
        (
GEA_NUMERO_ACTIVO NUMBER(16,0) ,
GEA_GESTOR_ACTIVO VARCHAR2(20 CHAR) ,
GEA_TIPO_GESTOR VARCHAR2(20 CHAR) ,
