...
BEGIN
      ...
      DBMS_OUTPUT.PUT_LINE('[INICIO] Comienza la migración de ACTIVOS PERÍMETRO-ACTIVO');
      ...
      INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (
        ...
        SELECT 
			...
			FROM (      
			  ...
			  MIG2.PAC_IND_CHECK_ASIGNAR_MEDIADOR                                              		AS PAC_CHECK_ASIGNAR_MEDIADOR,
			  ...
			  NVL(MIG2.PAC_IND_CHECK_PUBLICAR,0)													AS PAC_CHECK_PUBLICAR,
			  MIG2.PAC_FECHA_PUBLICAR															    AS PAC_FECHA_PUBLICAR,
			  MIG2.PAC_MOTIVO_PUBLICAR																AS PAC_MOTIVO_PUBLICAR
      ...
      DBMS_OUTPUT.PUT_LINE('[FIN] Acaba la migración de ACTIVOS PERÍMETRO-ACTIVO');
