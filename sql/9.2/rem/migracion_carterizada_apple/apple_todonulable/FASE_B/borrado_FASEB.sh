...
PROMPT [INFO] BORRANDO DE LA TABLA REM01.act_activo las foreign keys...
DELETE FROM REM01.ACT_HVA_HIST_VALORACIONES             gac      WHERE EXISTS (
SELECT 1 FROM REM01.ACT_ACTIVO ACT WHERE ACT.ACT_ID = GAC.ACT_ID AND ACT.USUARIOCREAR = 'MIG_APPLE');
