...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP3692'; -- Vble. del usuario que crea los registros
	
    V_TEXT1 VARCHAR2(2400 CHAR); -- Vble. auxiliar
    V_ENTIDAD_ID NUMBER(16);
    V_ID NUMBER(16);
    --Usuario a insertar en los dos grupos
    V_USUARIA VARCHAR2(30 CHAR) := 'bbaviera';
...
BEGIN	
    ...
    -- LOOP para insertar los valores en GRU_GRUPOS_USUARIOS -----------------------------------------------------------------
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        --Comprobamos el grupo en el que insertaremos a la gestora
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA_M||'.GRU_GRUPOS_USUARIOS 
				  ...
				  AND USU_ID_USUARIO = (SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = '''||V_USUARIA||''')';
        ...
        ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.GRU_GRUPOS_USUARIOS (' ||
                      ...
                      (SELECT USU_ID FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = '''||V_USUARIA||'''),
                      0,
                      '''||V_USU||''',
                      SYSDATE,
                      0 
