...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3727'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3727';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			MUNICIPIO_REGISTRO				VARCHAR2 (100 CHAR),
			REG_NUM_REGISTRO				VARCHAR2 (100 CHAR),
			REG_TOMO						VARCHAR2 (100 CHAR),
			REG_LIBRO						VARCHAR2 (100 CHAR),
			REG_FOLIO						VARCHAR2 (100 CHAR),
			REG_NUM_FINCA					VARCHAR2 (100 CHAR),
			REG_IDUFIR						VARCHAR2 (100 CHAR),
			REG_SUPERFICIE_CONSTRUIDA		VARCHAR2 (100 CHAR),
			REG_SUPERFICIE_UTIL				VARCHAR2 (100 CHAR),
			BIE_DREG_MUNICIPIO_LIBRO		VARCHAR2 (100 CHAR)
		)'
;
