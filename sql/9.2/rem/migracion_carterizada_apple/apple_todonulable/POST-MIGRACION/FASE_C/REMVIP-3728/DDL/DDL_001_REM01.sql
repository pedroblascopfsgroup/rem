...
--## INCIDENCIA_LINK=REMVIP-3728
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3728'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3728';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ADM_NUM_EXPEDIENTE				VARCHAR2 (100 CHAR),
			ADM_FECHA_CALIFICACION			VARCHAR2 (100 CHAR),
			TIPO_VPO						VARCHAR2 (100 CHAR)
		)'
;
