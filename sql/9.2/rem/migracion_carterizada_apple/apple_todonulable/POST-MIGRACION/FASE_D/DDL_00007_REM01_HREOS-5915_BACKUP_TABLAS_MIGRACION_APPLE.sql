...
BEGIN	
    ...
    LOOP
        ...
        IF V_COUNT = 1 THEN
				...
				EXECUTE IMMEDIATE 'GRANT SELECT ON "'||V_ESQUEMA||'"."'||V_TABLA_MIG||'" TO "REM_QUERY" WITH GRANT OPTION';
				EXECUTE IMMEDIATE 'GRANT SELECT ON "'||V_ESQUEMA||'"."'||V_TABLA_MIG||'" TO "PFSREM" WITH GRANT OPTION';
