...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3743'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3743';
...
EXECUTE IMMEDIATE '
		...
		(
		    ACT_NUMERO_ACTIVO				VARCHAR2 (100 CHAR),
			TIPO_VIA						VARCHAR2 (100 CHAR),
			LOC_NOMBRE_VIA					VARCHAR2 (100 CHAR),
			LOC_NUMERO_DOMICILIO			VARCHAR2 (100 CHAR),
			LOC_BLOQUE						VARCHAR2 (100 CHAR),
			LOC_ESCALERA					VARCHAR2 (100 CHAR),
			LOC_PISO						VARCHAR2 (100 CHAR),
			LOC_PUERTA						VARCHAR2 (100 CHAR),
			LOC_COD_POST					VARCHAR2 (100 CHAR),
			MUNICIPIO						VARCHAR2 (100 CHAR),
			PROVINCIA						VARCHAR2 (100 CHAR),
			SIGNO_LOC_LONGITUD				VARCHAR2 (100 CHAR),
			LOC_LONGITUD					VARCHAR2 (100 CHAR),
			SIGNO_LOC_LATITUD				VARCHAR2 (100 CHAR),
			LOC_LATITUD						VARCHAR2 (100 CHAR)
		)'
;
