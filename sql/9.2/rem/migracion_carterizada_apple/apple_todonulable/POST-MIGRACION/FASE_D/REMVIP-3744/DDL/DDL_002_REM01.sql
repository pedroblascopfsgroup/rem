...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3744_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3744_2';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			REG_SUPERFICIE_CONSTRUIDA		VARCHAR2 (100 CHAR),
			REG_SUPERFICIE_UTIL				VARCHAR2 (100 CHAR)
		)'
;
