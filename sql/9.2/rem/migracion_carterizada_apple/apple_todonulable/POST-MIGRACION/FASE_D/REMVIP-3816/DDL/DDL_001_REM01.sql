...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3816'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3816';
...
EXECUTE IMMEDIATE '
		...
		(
		    ...
		    DD_SAC_ID					VARCHAR2 (100 CHAR),
		    DD_SAC_CODIGO				VARCHAR2 (100 CHAR),
		    TIPOLOGIA_ACTUAL_REM		VARCHAR2 (100 CHAR),
