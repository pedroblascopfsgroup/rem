...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3818'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3818';
...
EXECUTE IMMEDIATE '
		...
		(
		    ...
		    SEGMENTO_GENERAL 		VARCHAR2 (100 CHAR),
		    ALQUILADO				VARCHAR2 (100 CHAR),
		    REO_CO_DESTINO 			VARCHAR2 (100 CHAR),
		    NOMBRE_HOLD_CO			VARCHAR2 (100 CHAR),
		    CONTRATO_CRUCE			VARCHAR2 (100 CHAR)
		)'
;
