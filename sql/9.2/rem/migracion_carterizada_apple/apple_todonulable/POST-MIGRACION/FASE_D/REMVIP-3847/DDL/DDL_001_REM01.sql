...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3847_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3847_1';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			FECHA_INICIO_ASUNTO		VARCHAR2 (100 CHAR),
			FECHA_FIN_ASUNTO		VARCHAR2 (100 CHAR),
			FECHA_LANZAMIENTO		VARCHAR2 (100 CHAR),
			TIPO_ASUNTO				VARCHAR2 (100 CHAR),
			TIPO_DE_ACTUACION		VARCHAR2 (100 CHAR)
		)'
;
