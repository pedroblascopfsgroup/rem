...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_REMVIP_3861'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_REMVIP_3861';
...
EXECUTE IMMEDIATE '
		...
		(
		    FC_DATOS				VARCHAR2 (100 CHAR),
		    ID_HAYA					VARCHAR2 (100 CHAR),
		    OBSERVACIONES_1 		VARCHAR2 (100 CHAR),
		    OBSERVACIONES_2			VARCHAR2 (100 CHAR)
		)'
;
