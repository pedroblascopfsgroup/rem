...
--## INCIDENCIA_LINK=REMVIP-1809
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_NOM_AGRUP_REMVIP_1809'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_AGRUP_PROYECTO_HREOS_4591';
...
(
  ID_PROYECTO    NUMBER(16,0)
, AGR_NOMBRE           VARCHAR2(250 CHAR)
, ACT_NUM_ACTIVO       NUMBER(16,0)
, EXISTE_ACTIVO		   NUMBER(1,0)
, CARGAR_AGRUPACION	   NUMBER(1,0)
)'
;
