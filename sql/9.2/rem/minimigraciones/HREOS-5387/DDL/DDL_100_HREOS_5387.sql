...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_CARTERIAZA_HREOS_5387'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_CARTERIAZA_HREOS_5387';
...
(
  DD_TGE_CODIGO 	VARCHAR2(50 CHAR)
, DD_CRA_CODIGO 	NUMBER(16,0)
, DD_TCR_CODIGO		NUMBER(16,0)
, DD_PRV_CODIGO 	NUMBER(16,0)
, DD_LOC_CODIGO 	NUMBER(16,0)
