...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MIG_ALQUILERES_TAB_AFEC';
...
EXECUTE IMMEDIATE '
		...
		(
			ESQUEMA				VARCHAR2(100 CHAR),
			TABLA				VARCHAR2(100 CHAR),
			REGISTROS			NUMBER(16,0) DEFAULT 0 NOT NULL ENABLE,
			TABLA_BACKUP		VARCHAR2(100 CHAR),
			REGISTROS_BACKUP    NUMBER(16,0) DEFAULT 0 NOT NULL ENABLE
		)'
;
