...
--##        0.2 ODP 05/06/19 Añadido borrado duplicados
	...
	EXECUTE IMMEDIATE  'UPDATE '||V_ESQUEMA||'.AUX_HREOS_5932 SET DESTINO_COMERCIAL = ''03'' WHERE DESTINO_COMERCIAL in (''Alquiler'',''ALQUILER'')';
	...
	-- SUBROGADO
	EXECUTE IMMEDIATE  'UPDATE '||V_ESQUEMA||'.AUX_HREOS_5932 SET SUBROGADO = ''1'' WHERE SUBROGADO in (''S'',''s'')';
