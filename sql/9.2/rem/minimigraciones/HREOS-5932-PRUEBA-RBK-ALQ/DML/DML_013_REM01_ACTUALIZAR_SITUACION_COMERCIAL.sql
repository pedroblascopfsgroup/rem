...
BEGIN			
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO SET DD_SCM_ID = NULL WHERE USUARIOMODIFICAR LIKE ''HREOS-5932-PUNTO2'' AND BORRADO = 0';
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO SET DD_SCM_ID = NULL WHERE USUARIOMODIFICAR LIKE ''HREOS-5932-PUNTO3-VA'' AND BORRADO = 0';
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO SET DD_SCM_ID = NULL WHERE USUARIOMODIFICAR LIKE ''HREOS-5932-PUNTO3-6'' AND BORRADO = 0';

	EXECUTE IMMEDIATE V_MSQL;
	
	DBMS_OUTPUT.PUT_LINE('	[INFO] Se han actualizado '||SQL%ROWCOUNT||' registros.');
	
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO SET DD_SCM_ID = NULL WHERE USUARIOMODIFICAR LIKE ''HREOS-5932-PUNTO3-6-4'' AND BORRADO = 0';
