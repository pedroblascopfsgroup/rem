...
**/
		...
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAC_GESTOR_ADD_ACTIVO DISABLE CONSTRAINT FK_GESTORADDI_ACTIVO';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAC_GESTOR_ADD_ACTIVO DISABLE CONSTRAINT FK_GESTORADDI_GESTORENTIDAD';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD DISABLE CONSTRAINT GEE_TGE_FK';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD DISABLE CONSTRAINT GEE_USU_FK';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAH_GESTOR_ACTIVO_HISTORICO DISABLE CONSTRAINT FK_GESTORADDI_ACTIVOH';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAH_GESTOR_ACTIVO_HISTORICO DISABLE CONSTRAINT FK_GESTORADDI_GESTORENTIDADH';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEH_GESTOR_ENTIDAD_HIST DISABLE CONSTRAINT GEH_TGE_FK';
		EXECUTE IMMEDIATE V_MSQL;
		...
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAC_GESTOR_ADD_ACTIVO ENABLE CONSTRAINT FK_GESTORADDI_ACTIVO';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAC_GESTOR_ADD_ACTIVO ENABLE CONSTRAINT FK_GESTORADDI_GESTORENTIDAD';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD ENABLE CONSTRAINT GEE_TGE_FK';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD ENABLE CONSTRAINT GEE_USU_FK';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAH_GESTOR_ACTIVO_HISTORICO ENABLE CONSTRAINT FK_GESTORADDI_ACTIVOH';
		EXECUTE IMMEDIATE V_MSQL;
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GAH_GESTOR_ACTIVO_HISTORICO ENABLE CONSTRAINT FK_GESTORADDI_GESTORENTIDADH';
		EXECUTE IMMEDIATE V_MSQL;

		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.GEH_GESTOR_ENTIDAD_HIST ENABLE CONSTRAINT GEH_TGE_FK';
		EXECUTE IMMEDIATE V_MSQL;
