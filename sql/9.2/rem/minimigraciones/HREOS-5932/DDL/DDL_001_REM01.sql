...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_HREOS_5185' y 'AUX_HREOS_5932_PUBLICACION'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_HREOS_5932';
...
V_MSQL := 'SELECT COUNT(1) FROM ALL_INDEXES WHERE INDEX_NAME = ''AUX_HREOS_5932_IDX'' ';

EXECUTE IMMEDIATE V_MSQL INTO V_NUM_TABLAS;	
IF V_NUM_TABLAS = 0 THEN
		V_MSQL := 'CREATE INDEX '||V_ESQUEMA_1||'.ID_HAYA ON '||V_ESQUEMA_1||'.AUX_HREOS_5932 ( ID_HAYA ) TABLESPACE '||V_TABLESPACE_IDX;		
		EXECUTE IMMEDIATE V_MSQL;
		DBMS_OUTPUT.PUT_LINE('[INFO] Indice AUX_HREOS_5932 - creado.');
ELSE
		DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe el índice AUX_HREOS_5932 ');
END IF;
