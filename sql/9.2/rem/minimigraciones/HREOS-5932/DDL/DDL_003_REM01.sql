...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_HREOS_5932_PERIM'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_HREOS_5932_PERIM';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			FLAG_PUBLICACION		NUMBER(1,0) DEFAULT 0 NOT NULL ENABLE
		)'
;
...
V_MSQL := 'SELECT COUNT(1) FROM ALL_INDEXES WHERE INDEX_NAME = ''AUX_HREOS_5932_PERIM_IDX'' ';

EXECUTE IMMEDIATE V_MSQL INTO V_NUM_TABLAS;	
IF V_NUM_TABLAS = 0 THEN
		V_MSQL := 'CREATE INDEX '||V_ESQUEMA_1||'.ACT_NUM_ACTIVO ON '||V_ESQUEMA_1||'.AUX_HREOS_5932_PERIM ( ACT_NUM_ACTIVO ) TABLESPACE '||V_TABLESPACE_IDX;		
		EXECUTE IMMEDIATE V_MSQL;
		DBMS_OUTPUT.PUT_LINE('[INFO] Indice AUX_HREOS_5932_PERIM - creado.');
ELSE
		DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe el índice AUX_HREOS_5932_PERIM ');
END IF;
