...
BEGIN			
	...
	EXECUTE IMMEDIATE  'UPDATE '||V_ESQUEMA||'.AUX_HREOS_5932 SET TIPO_CONTRATO_ALQUILER = ''02'' WHERE TIPO_CONTRATO_ALQUILER = ''Con opcion a compra''';
	...
	EXECUTE IMMEDIATE  'UPDATE AUX_HREOS_5932 SET ALQUILADO = ''01'' WHERE ALQUILADO = ''N''';
	DBMS_OUTPUT.PUT_LINE('	[INFO] Se han actualizado '||SQL%ROWCOUNT||' registros. ESTADO_ALQUILER - Libre'); 
	EXECUTE IMMEDIATE  'UPDATE AUX_HREOS_5932 SET ALQUILADO = ''02'' WHERE ALQUILADO = ''S''';
