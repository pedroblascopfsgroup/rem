...
BEGIN			
	...
	EXECUTE IMMEDIATE  'UPDATE '||V_ESQUEMA||'.AUX_HREOS_5932 SET TIPO_CONTRATO_ALQUILER = ''02'' WHERE TIPO_CONTRATO_ALQUILER = ''Con opcion a compra'' OR UPPER(TRIM(TIPO_CONTRATO_ALQUILER)) = UPPER(TRIM(''Con opciÃ³n de compra''))';
