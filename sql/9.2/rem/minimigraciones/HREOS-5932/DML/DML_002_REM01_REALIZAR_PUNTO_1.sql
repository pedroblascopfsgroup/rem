...
**/
		...
		V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_ACTIVO ACT USING 
							(SELECT ACT.ACT_NUM_ACTIVO 
								...
								AND (PTA.CHECK_HPM = 1 OR TCO.DD_TCO_CODIGO in (''02'',''03''))) T2
...
**/
		...
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_PTA_PATRIMONIO_ACTIVO SET 
							CHECK_HPM = 0 
						,	DD_ADA_ID = NULL
						,	DD_ADA_ID_ANTERIOR = (SELECT PTA.DD_ADA_ID FROM '||V_ESQUEMA||'.ACT_PTA_PATRIMONIO_ACTIVO WHERE ACT_ID = '||FILA_HISTORICO.ACT_ID||')
						,	DD_EAL_ID = NULL
						,	DD_TPI_ID = NULL
