...
DECLARE
    ...
    CURSOR OFERTAS_A_ELIMINAR IS  SELECT DISTINCT  
										...
										FROM REM01.ACT_ACTIVO ACT 
											...
											LEFT JOIN REM01.DD_EEC_EST_EXP_COMERCIAL EEC ON ECO.DD_EEC_ID = EEC.DD_EEC_ID AND EEC.DD_EEC_CODIGO NOT IN ('02','08','09','16')
											...
											LEFT JOIN REM01.DD_TPO_TIPO_PROCEDIMIENTO TPO ON TPO.DD_TPO_ID = TAP.DD_TPO_ID AND TPO.DD_TPO_CODIGO in ('T014','T015')
