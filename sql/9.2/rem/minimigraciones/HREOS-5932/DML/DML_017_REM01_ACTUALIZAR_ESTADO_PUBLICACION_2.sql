...
--## PRODUCTO=NO
--## Finalidad: RECALCULAR ESTADO PUBLICACION PUNTO 2.
--##           
...
DECLARE
    ...
    CURSOR ESTADO_PUBLI_RECALCULAR IS SELECT ACT_NUM_ACTIVO
										FROM REM01.AUX_HREOS_5932_PERIM 
										WHERE USUARIOMODIFICAR = 'HREOS-5932-PUNTO2' AND FLAG_PUBLICACION = 0
										ORDER BY ACT_NUM_ACTIVO ASC;
...
BEGIN
	...
	LOOP
  		...
  		REM01.SP_CAMBIO_ESTADO_PUBLICACION (FILA.ACT_NUM_ACTIVO,1,''||V_USUARIOMODIFICAR||'');
