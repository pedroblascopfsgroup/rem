...
DECLARE
    ...
    CURSOR OFERTAS_A_ELIMINAR IS  SELECT DISTINCT  
										...
										FROM REM01.ACT_ACTIVO ACT 
											...
											INNER JOIN REM01.DD_EEC_EST_EXP_COMERCIAL EEC ON ECO.DD_EEC_ID = EEC.DD_EEC_ID AND EEC.DD_EEC_CODIGO NOT IN ('02','08','09','16')
											INNER JOIN REM01.DD_EOF_ESTADOS_OFERTA EOF on EOF.DD_EOF_ID = OFR.DD_EOF_ID AND EOF.DD_EOF_CODIGO <> '02'
											INNER JOIN REM01.ACT_TRA_TRAMITE TRA ON TRA.ACT_ID = ACT.ACT_ID AND TRA.TRA_FECHA_FIN IS NULL
											INNER JOIN REM01.TAC_TAREAS_ACTIVOS TAC on TAC.TRA_ID = TRA.TRA_ID AND TAC.BORRADO = 0
