...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'TMP_HREOS-7298'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TMP_HREOS_7298';
...
'(
	USUARIO_REM  VARCHAR2(50 CHAR),
	ID_OFICINA	NUMBER(16,0),
	ID_ENTIDAD	NUMBER(16,0)
)'
;
