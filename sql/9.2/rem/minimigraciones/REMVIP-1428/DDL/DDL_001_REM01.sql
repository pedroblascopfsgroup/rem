...
--## INCIDENCIA_LINK=REMVIP-824
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_CARGA_LLAVES'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_CARGA_LLAVES';
...
(
	ACT_NUM_UVEM NUMBER(16),
    ACT_ID NUMBER(16),
    NUM_LLAVES NUMBER(16),
    ARMARIO NUMBER(16),
    POSICION NUMBER(16),
    FECHA_ENVIO VARCHAR2(10 CHAR),
    COD_MEDIADOR VARCHAR2(50 CHAR),
    DESC_MEDIADOR VARCHAR2(50 CHAR)
)'
;
