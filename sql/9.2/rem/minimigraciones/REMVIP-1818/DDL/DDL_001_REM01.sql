...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_ECO_EXPEDIENTES'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_ECO_EXPEDIENTES';
...
EXECUTE IMMEDIATE '
		...
		(
			ECO_NUM_EXPEDIENTE			VARCHAR2 (250 CHAR),
			ECO_FECHA_CONT_PROPIETARIO	VARCHAR2 (250 CHAR),
			ECO_PETICIONARIO_ANULACION	VARCHAR2 (250 CHAR),
			ECO_IMP_DEV_ENTREGAS		VARCHAR2 (250 CHAR),
			ECO_FECHA_DEV_ENTREGAS		VARCHAR2 (250 CHAR),
			ECO_FECHA_SANCION_COMITE	VARCHAR2 (250 CHAR)
		)'
;
