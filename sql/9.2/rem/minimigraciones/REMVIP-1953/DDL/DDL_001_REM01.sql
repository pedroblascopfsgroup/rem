...
--## INCIDENCIA_LINK=REMVIP-1953
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_BRICK_O_CLOCK'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_BRICK_O_CLOCK';
