...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_PERIMETRO_ALQUILABLE'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_PERIMETRO_ALQUILABLE';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			INQUILINO_ANT_PROPIETARIO		VARCHAR2 (100 CHAR),
