...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_ACTIVOS_COOPER_SUELOS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
EXECUTE IMMEDIATE '
		...
		(
			TX_DIRECCION			VARCHAR2(256 CHAR),
			ID_HAYA					VARCHAR2(256 CHAR),
			CUENTA_DE_FC_DATOS		VARCHAR2(256 CHAR),
			ES_CORRECTO				VARCHAR2(256 CHAR)
		)'
;
