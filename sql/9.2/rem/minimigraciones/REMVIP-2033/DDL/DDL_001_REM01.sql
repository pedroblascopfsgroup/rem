...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_FLAG_CARGAS_LIBER'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_FLAG_CARGAS_LIBER';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			CRG_ID					VARCHAR2 (100 CHAR),
			BIE_CAR_IMPORTE_REGISTRAL	VARCHAR2 (100 CHAR),
			OK_PROPIA_REM			VARCHAR2 (100 CHAR)
		)'
;
