...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_GYSFORM_CAJAMAR'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_GYSFORM_CAJAMAR';
...
EXECUTE IMMEDIATE '
		...
		(
			COD_GESTOR			VARCHAR2 (100 CHAR),
			GESTOR				VARCHAR2 (100 CHAR),
			COD_SUPERVISOR		VARCHAR2 (100 CHAR),
			SUPERVISOR			VARCHAR2 (100 CHAR),
			COD_COM_AUTONOMA	VARCHAR2 (100 CHAR),
			COM_AUTONOMA		VARCHAR2 (100 CHAR),
			COD_PROVINCIA		VARCHAR2 (100 CHAR),
			PROVINCIA			VARCHAR2 (100 CHAR),
			GESTORIAS			VARCHAR2 (100 CHAR)
		)'
;
