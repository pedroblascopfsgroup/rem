...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_PER_ALQUI_COPIA'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_PER_ALQUI_COPIA';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DD_CRA_DESCRIPCION  VARCHAR2 (100 CHAR),	
			SPS_OCUPADO			VARCHAR2 (100 CHAR),
			SPS_CON_TITULO		VARCHAR2 (100 CHAR),
			DD_TAL_CODIGO		VARCHAR2 (100 CHAR),	
			DD_TAL_DESCRIPCION	VARCHAR2 (100 CHAR),
			DD_TCO_CODIGO		VARCHAR2 (100 CHAR),
