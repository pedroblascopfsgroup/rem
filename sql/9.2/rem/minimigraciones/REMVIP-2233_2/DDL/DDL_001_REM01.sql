...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_PER_519_ACT_NO_EXCEL'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_PER_519_ACT_NO_EXCEL';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ESTADO_ACTIVO				VARCHAR2 (100 CHAR),
			OCUPADO						VARCHAR2 (100 CHAR),
			TIENE_OFERTAS_VIVAS 		VARCHAR2 (100 CHAR)
		)'
;
