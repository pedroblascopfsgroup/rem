...
--## INCIDENCIA_LINK=REMVIP-2241
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_CAMBIO_PRINEX'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_CAMBIO_PRINEX';
...
EXECUTE IMMEDIATE '
		...
		(
			ID_ACTIVO_HAYA           VARCHAR2(40 CHAR),
    			ID_PRINEX                VARCHAR2(40 CHAR),
    			ID_HAYA_ACTUAL           VARCHAR2(40 CHAR)
		)'
;
