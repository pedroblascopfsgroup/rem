...
--## INCIDENCIA_LINK=REMVIP-2338
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2338'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2338';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUMERO_ACTIVO					VARCHAR2(100),
			ACT_NUM_ACTIVO_PRINEX				        VARCHAR2(100),
			COD_SOCIEDAD				                VARCHAR2(100),
			DESC_SOCIEDAD				                VARCHAR2(100)
		)'
;
