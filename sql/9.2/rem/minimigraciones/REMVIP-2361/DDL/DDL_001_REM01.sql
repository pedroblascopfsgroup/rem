...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_VRO_DD_TPN_TIPO_INMUEBLE'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_VRO_DD_TPN_TIPO_INMUEBLE';
...
EXECUTE IMMEDIATE '
		...
		(
			DD_TPN_ID			VARCHAR2 (100 CHAR),
			DD_TPN_CODIGO			VARCHAR2 (100 CHAR),
			DD_TPN_DESCRIPCION		VARCHAR2 (100 CHAR),
			DD_TPN_DESCRIPCION_LARGA	VARCHAR2 (100 CHAR),	
			VERSION				VARCHAR2 (100 CHAR),
			USUARIOCREAR			VARCHAR2 (100 CHAR),
			FECHACREAR			VARCHAR2 (100 CHAR),
			USUARIOMODIFICAR		VARCHAR2 (100 CHAR),
			FECHAMODIFICAR			VARCHAR2 (100 CHAR),
			USUARIOBORRAR			VARCHAR2 (100 CHAR),
			FECHABORRAR			VARCHAR2 (100 CHAR),
			BORRADO				VARCHAR2 (100 CHAR),
			DD_STN_ID			VARCHAR2 (100 CHAR) 
