...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_APR_AUX_MAPEO_DD_SAC'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_APR_AUX_MAPEO_DD_SAC';
...
EXECUTE IMMEDIATE '
		...
		(
			COD_BIEN_IRIS			VARCHAR2 (100 CHAR),
			DD_TPN_DESCRIPCION		VARCHAR2 (100 CHAR),
			DD_TPA_CODIGO			VARCHAR2 (100 CHAR),
			DD_TPA_DESCRIPCION		VARCHAR2 (100 CHAR),	
			DD_SAC_CODIGO			VARCHAR2 (100 CHAR),
