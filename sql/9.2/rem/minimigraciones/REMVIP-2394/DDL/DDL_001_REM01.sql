...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_APR_BIE_CARGAS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_APR_BIE_CARGAS';
...
EXECUTE IMMEDIATE '
		...
		(
			BIE_ID						VARCHAR2 (100 CHAR),
			BIE_CAR_ID					VARCHAR2 (100 CHAR),
			DD_TPC_CODIGO				VARCHAR2 (100 CHAR),
			BIE_CAR_LETRA				VARCHAR2 (100 CHAR),
			BIE_CAR_TITULAR				VARCHAR2 (100 CHAR),
			BIE_CAR_IMPORTE_REGISTRAL	VARCHAR2 (100 CHAR),	
			BIE_CAR_IMPORTE_ECONOMICO   VARCHAR2 (100 CHAR),
			BIE_CAR_REGISTRAL			VARCHAR2 (100 CHAR),
			DD_SIC_CODIGO				VARCHAR2 (100 CHAR),
			BIE_CAR_FECHA_PRESENTACION	VARCHAR2 (100 CHAR),
			BIE_CAR_FECHA_INSCRIPCION	VARCHAR2 (100 CHAR),
			BIE_CAR_FECHA_CANCELACION	VARCHAR2 (100 CHAR),
			BIE_CAR_ECONOMICA		    VARCHAR2 (100 CHAR),
			FECHABORRAR					VARCHAR2 (100 CHAR),
			BORRADO						VARCHAR2 (100 CHAR),
			DD_SIC_ID2_CODIGO			VARCHAR2 (100 CHAR)
		)'
;
