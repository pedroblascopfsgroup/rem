...
--## INCIDENCIA_LINK=REMVIP_2396
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2396_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2396_2';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUM			VARCHAR2(100 CHAR),
			FECHA_VENTA			VARCHAR2(100 CHAR),
			PRECIO_VENTA			VARCHAR2(100 CHAR)
