...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2419'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2419';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			PROPIETARIO_MALO VARCHAR2 (100 CHAR),
			PROPIETARIO_BUENO VARCHAR2 (100 CHAR),
