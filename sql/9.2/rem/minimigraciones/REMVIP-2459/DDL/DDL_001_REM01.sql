...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_COMPRADOR_CARGAS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_COMPRADOR_CARGAS';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			NIF							VARCHAR2 (100 CHAR),
			ID_COMPRADOR_URSUS			VARCHAR2 (100 CHAR),
			DD_TDI_ID					VARCHAR2 (100 CHAR)
		)'
;
