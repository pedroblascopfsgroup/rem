...
--## INCIDENCIA_LINK=REMVIP-2468
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2468'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2468';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			VALOR_VENTA_ACTIVO VARCHAR2 (100 CHAR),
			VALOR_RENTA_HAYA   VARCHAR2 (100 CHAR),
			FECHA_VALOR_VENTA VARCHAR2 (100 CHAR),
			LIQUIDEZ VARCHAR2 (100 CHAR)
		)'
;
