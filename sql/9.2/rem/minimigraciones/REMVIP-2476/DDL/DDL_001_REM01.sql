...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_JPR_FOR_FORMALIZACION'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_JPR_FOR_FORMALIZACION';
...
EXECUTE IMMEDIATE '
		...
		(
			numero_haya				VARCHAR2(256 CHAR),
			num_expediente			VARCHAR2(256 CHAR),
			capital_concedido		VARCHAR2(256 CHAR)
		)'
;
