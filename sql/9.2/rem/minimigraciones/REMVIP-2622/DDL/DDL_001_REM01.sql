...
--## INCIDENCIA_LINK=REMVIP-2622
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2622'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2622';
...
EXECUTE IMMEDIATE '
		...
		(
			NUM_ACTIVO_HAYA    VARCHAR2 (100 CHAR),
			FC_PRIMERA_PUBLI VARCHAR2 (100 CHAR),
			FC_ULTIMA_PUBLI	VARCHAR2 (100 CHAR)
