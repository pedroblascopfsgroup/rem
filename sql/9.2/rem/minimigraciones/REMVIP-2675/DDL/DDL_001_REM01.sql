--/*
--#########################################
--## AUTOR=Ivan Castello Cabrelles
--## FECHA_CREACION=20181127
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=2.0.17
--## INCIDENCIA_LINK=REMVIP-2675
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2675'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2675';
...
EXECUTE IMMEDIATE '
		...
		(
			FOT_GDF_ID    VARCHAR2 (100 CHAR),
			FOT_GDF_URL    VARCHAR2 (100 CHAR),
			FOT_GDF_OPTIMIZED    VARCHAR2 (100 CHAR),
			FOT_GDF_WATERMARK    VARCHAR2 (100 CHAR),
			FOT_GDF_THUMBNAIL    VARCHAR2 (100 CHAR)
