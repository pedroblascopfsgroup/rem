...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2681_3'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2681_3';
...
EXECUTE IMMEDIATE '
		...
		(
			ID_ACTIVO					VARCHAR2 (100 CHAR),
			TIPO_PUBLICACION				VARCHAR2 (100 CHAR),
			FECHA_INI					VARCHAR2 (100 CHAR)
		)'
;
