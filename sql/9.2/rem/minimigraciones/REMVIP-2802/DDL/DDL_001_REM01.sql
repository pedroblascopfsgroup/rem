...
--## INCIDENCIA_LINK=REMVIP_2802
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2802'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2802';
...
EXECUTE IMMEDIATE '
		...
		(
			COD_PROMOCION				VARCHAR2(100 CHAR),
			ACT_PRINEX				VARCHAR2(100 CHAR),
			ACT_HAYA				VARCHAR2(100 CHAR)
