...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2914'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2914';
...
EXECUTE IMMEDIATE '
		...
		(
			NUM_OFERTA				VARCHAR2 (100 CHAR),
			NUM_EXPEDIENTE				VARCHAR2 (100 CHAR),
			FECHA_CONT_PROPIETARIO			VARCHAR2 (100 CHAR),
			FECHA_VENTA_ECO				VARCHAR2 (100 CHAR),
			VENTA_EXT_FECHA_ACT			VARCHAR2 (100 CHAR)
