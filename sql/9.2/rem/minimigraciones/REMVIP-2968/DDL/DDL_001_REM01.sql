...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_JPR_CARGAS'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
EXECUTE IMMEDIATE '
		...
		(
			NUM_HAYA				VARCHAR2(256 CHAR),
			ID_PROMOCION_OIGEN		VARCHAR2(256 CHAR),
			TIPO_CARGA				VARCHAR2(256 CHAR),
			CARGAS_PROPIAS			VARCHAR2(256 CHAR),
			SUBTIPO_CARGA			VARCHAR2(256 CHAR),
			TITULAR_CARGA			VARCHAR2(256 CHAR),
			IMPORTE_REGISTRAL		VARCHAR2(256 CHAR),
			ESTADO_REGISTRAL		VARCHAR2(256 CHAR)
		)'
;
