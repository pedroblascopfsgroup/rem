...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_3081'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_3081';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ACT_NUMERO_PRINEX           VARCHAR2 (100 CHAR),
			DD_TIPO_TITULO	            VARCHAR2 (100 CHAR),
			ADN_FECHA_TITULO    	    VARCHAR2 (100 CHAR),
			DD_SITUACION_INSCRIPCION    VARCHAR2 (100 CHAR)
