...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_3329'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_3329';
...
EXECUTE IMMEDIATE '
		...
		(
			NUM_ACT						VARCHAR2 (100 CHAR),
			CAMPANYA					VARCHAR2 (100 CHAR),
			SIT_ESPECIAL					VARCHAR2 (100 CHAR)
