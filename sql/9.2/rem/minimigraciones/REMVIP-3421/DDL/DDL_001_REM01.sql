...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_ACT_TBJ_TRABAJO'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_ACT_TBJ_TRABAJO';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			REQUIRENTE				VARCHAR2( 256 CHAR ),
			EMAIL					VARCHAR2( 256 CHAR ),
			DIRECCION				VARCHAR2( 512 CHAR ),
			PERSONA_CTO				VARCHAR2( 256 CHAR ),
			TEL1					VARCHAR2( 16 CHAR ),
			TEL2					VARCHAR2( 16 CHAR ),
			NOMBRE_CTO				VARCHAR2( 256 CHAR ),
			PROV					VARCHAR2( 256 CHAR ),
			POB					VARCHAR2( 256 CHAR ),
			MEDIADOR				VARCHAR2( 256 CHAR )
