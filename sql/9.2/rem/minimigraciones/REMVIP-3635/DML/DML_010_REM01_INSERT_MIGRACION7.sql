...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('[INFO] COMIENZA EL PROCESO DE MIGRACION SOBRE LA TABLA '||V_ESQUEMA||'.'||V_TABLA||'.');
	...
	WITH PRO_CODIGO AS (
	  SELECT MIGW.PRO_CODIGO, MIGW.PRO_COD_CARTERA
	  ...
	  WHERE NOT EXISTS (
	    ...
	    WHERE PROW.PRO_CODIGO_UVEM = MIGW.PRO_CODIGO
	...
	MIG.PRO_CODIGO				  						PRO_CODIGO_UVEM,
	(SELECT DD_TPE_ID
	...
	INNER JOIN PRO_CODIGO PRO
	ON PRO.PRO_CODIGO = MIG.PRO_CODIGO
