...
--## INCIDENCIA_LINK=REMVIP-4289
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_4232'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_PERIM_ACTIVOS_MAYO_CEI';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUM_ACTIVO_UVEM  	VARCHAR2 (100 CHAR)
