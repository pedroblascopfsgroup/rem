...
--## INCIDENCIA_LINK=REMVIP-4269
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_4269_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
EXECUTE IMMEDIATE '
		...
		(
			...
			FECHA_REVISION		VARCHAR2 (20 CHAR),
			TIPO_CARGA  		VARCHAR2 (20 CHAR),
			SUBTIPO_CARGA		VARCHAR2 (50 CHAR),
			ESTADO_REGISTRAL  	VARCHAR2 (20 CHAR),
			DESCRIPCION_CARGA	VARCHAR2 (100 CHAR),
			TITULAR_CARGA  		VARCHAR2 (100 CHAR),
			IMPORTE_CARGA		VARCHAR2 (20 CHAR),
			OBSERVACIONES  		VARCHAR2 (20 CHAR),
			CARGAS_PROPIAS		VARCHAR2 (20 CHAR)
