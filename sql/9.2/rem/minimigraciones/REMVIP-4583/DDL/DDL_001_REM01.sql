...
--## INCIDENCIA_LINK=REMVIP-4583
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_4583'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_4583';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			OPERACION  	VARCHAR2( 7 CHAR ),
			PVC_TELF1  	VARCHAR2( 20 CHAR ),
			PVC_EMAIL  	VARCHAR2( 300 CHAR ),
			PVC_CARGO  	VARCHAR2( 50 BYTE )
		)'
;
