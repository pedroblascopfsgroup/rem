...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_5052'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_5052';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DD_PRV_CODIGO				VARCHAR( 20 CHAR ),
			DD_LOC_CODIGO				VARCHAR( 20 CHAR ),
			DD_UPO_CODIGO				VARCHAR( 10 CHAR )			
		)'
;
