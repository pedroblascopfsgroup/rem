...
--*******************************************************************************************************************************
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar estado de gastos a Pagado en gastos agrupados' );
			...
			USING (
			  SELECT DISTINCT GPV.GPV_ID
				FROM '||V_ESQUEMA||'.AUX_REMVIP_5486 AUX, '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV, '||V_ESQUEMA||'.H_ASPRO_10_CABECERA CAB, '||V_ESQUEMA||'.PRG_PROVISION_GASTOS PRG, '||V_ESQUEMA||'.GDE_GASTOS_DETALLE_ECONOMICO GDE
				WHERE 1 = 1
				AND AUX.NUFREM = PRG.PRG_NUM_PROVISION
				AND GPV.PRG_ID = PRG.PRG_ID
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar estado de gastos a Contabilizado en gastos agrupados' );
			...
			USING (
				...
				SELECT DISTINCT GPV.GPV_ID
				FROM '||V_ESQUEMA||'.AUX_REMVIP_5486 AUX, '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV, '||V_ESQUEMA||'.H_ASPRO_10_CABECERA CAB, '||V_ESQUEMA||'.PRG_PROVISION_GASTOS PRG, '||V_ESQUEMA||'.GDE_GASTOS_DETALLE_ECONOMICO GDE, '||V_ESQUEMA||'.GIC_GASTOS_INFO_CONTABILIDAD GIC
				WHERE 1 = 1
				AND AUX.NUFREM = PRG.PRG_NUM_PROVISION
				AND GPV.PRG_ID = PRG.PRG_ID
				AND GDE.GPV_ID = GPV.GPV_ID
...
--*******************************************************************************************************************************
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar estado de gastos a Pagado en gastos no agrupados' );
			...
			USING (
				SELECT DISTINCT
				GPV.GPV_ID
				FROM '||V_ESQUEMA||'.AUX_REMVIP_5486 AUX, '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV, '||V_ESQUEMA||'.H_ASPRO_10_CABECERA CAB, '||V_ESQUEMA||'.GDE_GASTOS_DETALLE_ECONOMICO GDE, '||V_ESQUEMA||'.GIC_GASTOS_INFO_CONTABILIDAD GIC
				WHERE 1 = 1
				AND AUX.NUFREM = GPV.GPV_NUM_GASTO_HAYA
				AND GDE.GPV_ID = GPV.GPV_ID
				AND GIC.GPV_ID = GPV.GPV_ID
...
--*******************************************************************************************************************************
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: Actualizar estado de la provisión a <Contabilizada> si todos los gastos están contabilizados' );
			...
			USING (
				SELECT
				DISTINCT PRG.PRG_ID
				FROM '||V_ESQUEMA||'.AUX_REMVIP_5486 AUX, '||V_ESQUEMA||'.H_ASPRO_10_CABECERA CAB, '||V_ESQUEMA||'.PRG_PROVISION_GASTOS PRG
				WHERE 1 = 1
				AND AUX.NUFREM = PRG.PRG_NUM_PROVISION
				AND TIPO = ''PROVISION''
				AND CAB.NUFREM = PRG.PRG_NUM_PROVISION
