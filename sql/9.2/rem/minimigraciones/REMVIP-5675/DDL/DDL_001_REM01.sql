...
--## INCIDENCIA_LINK=REMVIP-5675
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_5675'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_5675';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			NUFPRO VARCHAR2( 100 ),			
			ESTADO VARCHAR2( 100 ),
			FACTURA_CONTABILIDAD VARCHAR2( 100 ),
			FECHA_CONTABILIZACION VARCHAR2( 100 ),
			FECHA_PAGO VARCHAR2( 100 ),
			FECHA_RECHAZO VARCHAR2( 100 )
		)'
;
