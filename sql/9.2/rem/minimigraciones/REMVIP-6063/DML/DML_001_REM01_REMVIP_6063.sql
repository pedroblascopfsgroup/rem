...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-6063'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TABLA_AUX VARCHAR( 100 CHAR ) := 'AUX_REMVIP_6063';
    V_COUNT NUMBER(16);	
    V_ID NUMBER(16);	
...
BEGIN		
	...
	OPEN v_cursor FOR V_SQL;
   	...
   	LOOP
       		...
       		REM01.SP_CAMBIO_ESTADO_PUBLICACION( V_ID, 1, 'REMVIP-6063' );
	...
	OPEN v_cursor FOR V_SQL;
   	...
   	LOOP
       		...
       		REM01.SP_CAMBIO_ESTADO_PUBLI_AGR( V_ID, 1, 'REMVIP-6063' );
	...
	OPEN v_cursor FOR V_SQL;
   	...
   	LOOP
       		...
       		REM01.CALCULO_RATING_ACTIVO_AUTO( V_ID, 'REMVIP-6063' );
	...
	V_MSQL := ' MERGE INTO '|| V_ESQUEMA ||'.TAR_TAREAS_NOTIFICACIONES TAR
		    USING( 
				...
				FROM '||V_ESQUEMA||'.ACT_TRA_TRAMITE TRA, '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS TAC, '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES TAR, '||V_ESQUEMA||'.ACT_ACTIVO ACT, '||V_ESQUEMA||'.AUX_REMVIP_6063 AUX
