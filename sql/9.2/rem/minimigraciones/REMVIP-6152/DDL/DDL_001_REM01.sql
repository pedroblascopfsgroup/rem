...
--## INCIDENCIA_LINK=REMVIP-6152
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_6152'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_6152';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			COD_FASE NUMBER( 16, 0 ),
			COD_SUBFASE NUMBER( 16, 0 )
