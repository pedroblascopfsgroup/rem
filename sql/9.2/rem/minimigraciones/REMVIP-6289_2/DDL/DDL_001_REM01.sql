...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_6289_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_6289_2';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			BIE_ADJ_F_REA_ERRONEA VARCHAR2(20 CHAR),
			BIE_ADJ_F_REA_CORRECTA VARCHAR2(20 CHAR)
		)'
;
