...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_6289_5'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_6289_5';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ACT_ID NUMBER(16),
			SPS_FECHA_ERRONEA VARCHAR2(20 CHAR),
			SPS_FECHA_CORRECTA VARCHAR2(20 CHAR)
		)'
;
