...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_ACTIVOS_PUBLICACIONES'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_ACTIVOS_PUBLICACIONES';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			CHECK_PUBLICAR					VARCHAR2 (100 CHAR),
			CHECK_COMERCIALIZAR							VARCHAR2 (100 CHAR),
			MOTIVO_NO_PUBLICAR				VARCHAR2 (100 CHAR)
