...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_MMC_ACTIVOS_ESTADO_PUB'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_MMC_ACTIVOS_ESTADO_PUB';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DE_ESTADO_PUBLICACION				VARCHAR2 (100 CHAR),
			DE_DISCLAIMER_WEB					VARCHAR2 (100 CHAR),
			diferencias							VARCHAR2 (100 CHAR),
			anterior_publi						VARCHAR2 (100 CHAR),
			anterior_discl						VARCHAR2 (100 CHAR),
			DE_ESTADO_COMERCIALIZABLE			VARCHAR2 (100 CHAR)
		)'
;
