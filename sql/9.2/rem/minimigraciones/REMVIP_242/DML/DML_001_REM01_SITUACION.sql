...
DECLARE
    ...
    V_ESQUEMA VARCHAR2(10 CHAR) := 'rem_query'; 			--REM01
    V_ESQUEMA_MASTER VARCHAR2(15 CHAR) := 'rem_query'; 	--REMMASTER
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-242';
    V_TABLA_MIG VARCHAR2(40 CHAR) := 'AUX_REMVIP_SITUACION';
...
/*    EXECUTE IMMEDIATE 'MERGE INTO REM01.COE_CONDICIONANTES_EXPEDIENTE T1
		...
		WHEN MATCHED THEN UPDATE SET
			T1.COE_SOLICITA_FINANCIACION = 1
		      ...
		      , T1.USUARIOMODIFICAR = ''REMVIP-242''
