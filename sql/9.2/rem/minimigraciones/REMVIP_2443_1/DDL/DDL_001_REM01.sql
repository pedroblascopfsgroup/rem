...
--## INCIDENCIA_LINK=REMVIP-2432
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2432_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2432_1';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUM_ACTIVO_VIEJO VARCHAR2(50 CHAR),
			ACT_RECOVERY_ID_VIEJO VARCHAR2(50 CHAR),
			ACT_NUM_ACTIVO_NUEVO VARCHAR2(50 CHAR),
			ACT_RECOVERY_ID_NUEVO VARCHAR2(50 CHAR)
