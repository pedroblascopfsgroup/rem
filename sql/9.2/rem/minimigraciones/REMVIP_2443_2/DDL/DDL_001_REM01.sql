...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2432_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2432_2';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ID_SAREB_ACTUAL VARCHAR2(50 CHAR),
			ID_SAREB_CORRECTO VARCHAR2(50 CHAR)
