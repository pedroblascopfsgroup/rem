...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_2432_3'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_2432_3';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUM_ACTIVO VARCHAR2(50 CHAR),
			FINCA_REGISTRAL VARCHAR2(50 CHAR),
			ACT_RECOVERY_ID_ACTUAL VARCHAR2(50 CHAR),
			ACT_RECOVERY_ID_CORRECTO VARCHAR2(50 CHAR)
