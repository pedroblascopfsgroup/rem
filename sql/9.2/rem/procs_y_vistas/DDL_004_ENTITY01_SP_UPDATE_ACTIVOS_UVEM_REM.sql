...
--##        0.5 Borrado logico division cartera
--##########################################
--*/
...
FROM
#ESQUEMA#.APR_AUX_DATOS_ACTIVO DAT,
#ESQUEMA#.ACT_ACTIVO ACT,
#ESQUEMA#.ACT_LOC_LOCALIZACION LOC,
#ESQUEMA#.BIE_LOCALIZACION BLO,
#ESQUEMA#.ACT_ICO_INFO_COMERCIAL INFO
WHERE
...
A.DIS_ID
FROM
(SELECT DIS.DIS_ID, DIS.ICO_ID A1, DIS.DIS_NUM_PLANTA A2, DIS.DD_TPH_ID A3 FROM #ESQUEMA#.ACT_DIS_DISTRIBUCION DIS) A,

(
SELECT INFO.ICO_ID B1, DIST.DIS_NUM_PLANTA B2, TPH.DD_TPH_ID B3, DIST.DIS_CANTIDAD B4, DIS_SUPERFICIE B5 FROM #ESQUEMA#.APR_AUX_INFOCOMERCIAL_DIST DIST,
#ESQUEMA#.ACT_ACTIVO ACT,
#ESQUEMA#.APR_AUX_DATOS_ACTIVO DAT,
#ESQUEMA#.ACT_ICO_INFO_COMERCIAL INFO,
#ESQUEMA#.DD_TPH_TIPO_HABITACULO TPH
