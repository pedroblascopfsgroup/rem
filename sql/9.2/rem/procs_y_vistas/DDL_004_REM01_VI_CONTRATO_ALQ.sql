...
--##        0.3 HREOS-8120 Añadida columna DCA_ID_CONTRATO_ANTIGUO a la vista
--##########################################
--*/
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.'|| V_TEXT_VISTA ||'
	AS
		SELECT ACT.ACT_ID, DDA.DD_TPA_DESCRIPCION, BIE.BIE_LOC_DIRECCION, ALQ.DCA_ID_CONTRATO, ACT.ACT_NUM_ACTIVO, ALQ.DCA_NOM_PRINEX, ALQ.DCA_ID_CONTRATO_ANTIGUO  
