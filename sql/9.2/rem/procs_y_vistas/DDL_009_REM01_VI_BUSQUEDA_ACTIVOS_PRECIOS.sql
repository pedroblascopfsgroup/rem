...
BEGIN
  ...
  SELECT
	...
	(SELECT CASE WHEN (COUNT(1) > 0) THEN 1 ELSE 0 END
		...
		WHERE epp.DD_EPP_CODIGO != ''03'' AND epp.DD_EPP_CODIGO != ''05''
  ...
  JOIN '|| V_ESQUEMA ||'.DD_SCR_SUBCARTERA SCR ON SCR.DD_SCR_ID = ACT.DD_SCR_ID AND ACT.DD_SCR_ID != (SELECT DD_SCR_ID FROM DD_SCR_SUBCARTERA WHERE DD_SCR_CODIGO = ''03'')
