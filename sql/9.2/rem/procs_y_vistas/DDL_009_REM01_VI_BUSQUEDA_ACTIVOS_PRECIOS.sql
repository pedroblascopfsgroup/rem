...
--	    LEFT JOIN ( SELECT ACT_ID, VAL_IMPORTE, VAL_FECHA_INICIO 
--					FROM (SELECT VAL5.ACT_ID, VAL5.VAL_IMPORTE, VAL5.VAL_FECHA_INICIO, 
--					                MAX(VAL5.VAL_FECHA_INICIO) OVER(PARTITION BY VAL5.ACT_ID) AS FECHA_MAX        
...
--					WHERE VAL_FECHA_INICIO = FECHA_MAX) PRECIO_DESCUENTO_PUBLICADO ON ACT.ACT_ID = PRECIO_DESCUENTO_PUBLICADO.ACT_ID
