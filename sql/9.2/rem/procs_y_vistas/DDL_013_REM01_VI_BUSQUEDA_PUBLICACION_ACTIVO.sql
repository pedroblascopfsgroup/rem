...
EXECUTE IMMEDIATE 'CREATE OR REPLACE FORCE VIEW '||V_ESQUEMA||'.' || V_TEXT_VISTA || ' (act_id,
																  ...
																  GPUBL_USU_USERNAME,
																  FASE_PUBLICACION_CODIGO,
																  FASE_PUBLICACION_DESCRIPCION,
																  SUBFASE_PUBLICACION_CODIGO,
																  SUBFASE_PUBLICACION_DESCRIPCION,
																  TAS_IMPORTE_TAS_FIN,
																  DD_TAL_DESCRIPCION,
																  APU_FECHA_INI_VENTA,
...
AS 
  ...
  SELECT 
	...
	, EPV.DD_EPV_CODIGO EPV_CODIGO
	, EPA.DD_EPA_CODIGO EPA_CODIGO
	...
	, ACT_APU.APU_FECHA_INI_VENTA
	, ACT_APU.APU_FECHA_INI_ALQUILER
  ...
  LEFT JOIN '||V_ESQUEMA||'.ACT_HFP_HIST_FASES_PUB HFP ON HFP.ACT_ID = ACT.ACT_ID AND HFP.HFP_FECHA_FIN IS NULL AND HFP.BORRADO = 0
  ...
  SELECT ACT_ID, ACT_NUM_ACTIVO, TIPO_ACTIVO_CODIGO, TIPO_ACTIVO_DESCRIPCION, SUBTIPO_ACTIVO_CODIGO, SUBTIPO_ACTIVO_DESCRIPCION
    , DIRECCION, CARTERA_CODIGO, SUBCARTERA_CODIGO,	ESTADO_PUBLICACION_CODIGO, EPV_CODIGO, EPA_CODIGO, ESTADO_PUBLICACION_DESCRIPCION, TIPO_COMERCIALIZACION_CODIGO, TIPO_COMERCIALIZACION_DESC, ADMISION, GESTION
    , INFORME_COMERCIAL	, PUBLICACION, PRECIO, OKALQUILER, OKVENTA, MOTIVO_OCULTACION_ALQUILER, MOTIVO_OCULTACION_VENTA, GPUBL_USU_USERNAME, FASE_PUBLICACION_CODIGO, FASE_PUBLICACION_DESCRIPCION
	, SUBFASE_PUBLICACION_CODIGO, SUBFASE_PUBLICACION_DESCRIPCION, TAS_IMPORTE_TAS_FIN, DD_TAL_DESCRIPCION, APU_FECHA_INI_VENTA, APU_FECHA_INI_ALQUILER
  FROM VISTA_ACT_PUB
  WHERE RN = 1';
