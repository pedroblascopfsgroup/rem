...
AS 
  ...
  SELECT 
    ...
    , DECODE(TCO.DD_TCO_CODIGO,''01'',EPV.DD_EPV_CODIGO,''02'',EPA.DD_EPA_CODIGO,''03'',EPA.DD_EPA_CODIGO||''/''||EPV.DD_EPV_CODIGO)   ESTADO_PUBLICACION_CODIGO 
    , DECODE(TCO.DD_TCO_CODIGO,''01'',EPV.DD_EPV_DESCRIPCION,''02'',EPA.DD_EPA_DESCRIPCION,''03'',EPA.DD_EPA_DESCRIPCION||''/''||EPV.DD_EPV_DESCRIPCION)   ESTADO_PUBLICACION_DESCRIPCION              
