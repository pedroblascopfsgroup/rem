...
--				OFRACT.ACTIVOS,
		...
		LEFT JOIN '|| V_ESQUEMA ||'.ACT_ACTIVO ACT ON ACT.ACT_ID = VAO.ACT_ID and act.borrado = 0
    LEFT JOIN '|| V_ESQUEMA ||'.DD_CRA_CARTERA CRA ON ACT.DD_CRA_ID = CRA.DD_CRA_ID
    LEFT JOIN '|| V_ESQUEMA ||'.ACT_ABA_ACTIVO_BANCARIO ABA ON ACT.ACT_ID = ABA.ACT_ID and act.borrado = 0    
