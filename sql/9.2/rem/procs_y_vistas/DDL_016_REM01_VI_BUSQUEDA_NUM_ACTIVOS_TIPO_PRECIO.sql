  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.V_BUSQUEDA_NUM_ACT_TIPO_PRECIO 
	AS
		SELECT
		  ...
		  COUNT(CASE WHEN ACT.ACT_FECHA_IND_PRECIAR IS NULL THEN 1 END) AS NUM_ACTIVOS_PRECIAR,
		  COUNT(CASE WHEN ACT.ACT_FECHA_IND_PRECIAR IS NOT NULL THEN 1 END) AS NUM_ACTIVOS_REPRECIAR,
		  COUNT(CASE WHEN ACT.ACT_FECHA_IND_PRECIAR IS NOT NULL THEN 1 END) AS NUM_ACTIVOS_DESCUENTO
