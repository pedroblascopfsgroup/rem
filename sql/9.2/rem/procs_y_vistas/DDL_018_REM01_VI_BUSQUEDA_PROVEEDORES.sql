  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.'|| V_TEXT_VISTA ||' 
	AS
		SELECT
			...
			PVC.PVC_DOCIDENTIF AS CONTACTO_NIF_PROVEEDOR,
			PVC.PVC_NOMBRE AS CONTACTO_NOMBRE_PROVEEDOR,
		...
		LEFT JOIN ' || V_ESQUEMA || '.DD_TPE_TIPO_PERSONA TPE ON PVE.DD_TPE_ID = TPE.DD_TPE_ID
