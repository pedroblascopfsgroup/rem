...
--## FECHA_CREACION=20170504
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=2.0.3
--## INCIDENCIA_LINK=HREOS-1947
--## PRODUCTO=NO
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR.ACT_ID IS ''Id del activo asociado al gasto.''';
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR.ACT_NUM_ACTIVO IS ''Número de activo REM.''';
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR.RANGO IS ''Rango.''';
  ...
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR.DD_SCR_CODIGO IS ''Código de la subcartera del activo.''';
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR.DD_SCR_DESCRIPCION IS ''Descripción de la subcartera del activo.''';
