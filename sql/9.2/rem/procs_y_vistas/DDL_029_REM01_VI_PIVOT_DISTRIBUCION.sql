...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.'|| V_TEXT_VISTA ||'
	AS
		SELECT ICO_ID, DORMITORIOS, BANYOS, ASEOS, GARAJES, TERRAZAS_CUBIERTAS, TERRAZAS_DESCUBIERTAS
		...
		PIVOT(SUM(DIS_CANTIDAD) FOR DD_TPH_CODIGO IN (''01'' DORMITORIOS, ''02'' BANYOS, ''04'' ASEOS, ''12'' GARAJES, ''15'' TERRAZAS_CUBIERTAS,''16'' TERRAZAS_DESCUBIERTAS))';
