...
BEGIN/*Versión 0.2*/
	...
	AS
       ...
       v.descripcion_otros																	AS descripcion_otros,
        ...
        CAST(NVL2(PIVOT_UA.PROMOCION_ALQUILER_NUM_REM, SUBD_ACT.ID, NULL) AS NUMBER(16,0)) AS CODIGO_CABECERA_PA,
		...
		LEFT JOIN (
			...
			WHERE AGA.BORRADO = 0 AND AGR.BORRADO = 0 AND DDTAG.BORRADO = 0 AND AGR.AGR_FECHA_BAJA IS NULL
		) AGA_PA ON ACT.ACT_ID = AGA.ACT_ID AND AGA.RN = 1
