...
BEGIN/*Versión 0.2*/
	...
	AS
       ...
       v.descripcion_otros																	AS descripcion_otros,
        ...
        CAST(NVL2(PIVOT_AGR.PROMOCION_ALQUILER_NUM_REM, SUBD_ACT.ID, NULL) AS NUMBER(16,0)) AS CODIGO_CABECERA_PA,
		...
		END 																				AS ID_HAYA_AM,
        CASE WHEN (AGA.DD_TAG_ID = (SELECT AGA.DD_TAG_ID FROM DD_TAG_TIPO_AGRUPACION TAG WHERE TAG.DD_TAG_CODIGO = ''16''))
			THEN CAST(AGA.AGR_NUM_AGRUP_REM AS NUMBER(32,0))
			ELSE NULL
		END 																				AS ID_PA,
        CAST(NVL2(PIVOT_AGR.PROMOCION_ALQUILER_NUM_REM, SUBD_ACT.ID, NULL) AS NUMBER(32,0)) AS ID_SUBDIVISION_PA
