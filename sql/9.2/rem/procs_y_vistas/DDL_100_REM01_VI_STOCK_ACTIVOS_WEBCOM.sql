...
BEGIN
	...
	AS
		...
		CAST(VAL1.APROBADO_VENTA_WEB AS NUMBER(16,2)) 										AS ACTUAL_IMPORTE,
		...
		CASE WHEN (VAL1.APROBADO_VENTA_WEB_F_FIN IS NOT NULL) 
			THEN CAST(TO_CHAR(VAL1.APROBADO_VENTA_WEB_F_FIN ,
				''YYYY-MM-DD"T"HH24:MM:SS'') AS VARCHAR2(50 CHAR))
		ELSE NULL
