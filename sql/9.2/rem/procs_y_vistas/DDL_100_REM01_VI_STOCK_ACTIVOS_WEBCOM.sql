...
BEGIN/*Versión 0.8*/
	...
	AS
       ...
       v.descripcion_otros																	AS descripcion_otros,
		...
		WHEN LLV.LLV_COD_TENEDOR_POSEEDOR IS NULL AND LLV.LLV_COD_TENEDOR_NO_PVE IS NOT NULL AND LLV.LLV_COD_TENEDOR_NO_PVE NOT LIKE ''N/A'' THEN LLV.LLV_COD_TENEDOR_NO_PVE 
