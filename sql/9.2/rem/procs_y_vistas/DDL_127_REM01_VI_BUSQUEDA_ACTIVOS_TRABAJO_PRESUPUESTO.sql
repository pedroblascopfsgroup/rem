  ...
  SELECT
      ...
      FROM REM01.ACT_TBJ ACTTBJ
        ...
        LEFT JOIN (
          ...
          FROM ACT_TBJ ACTTBJ
          INNER JOIN ACT_TBJ_TRABAJO TBJ ON ACTTBJ.TBJ_ID = TBJ.TBJ_ID AND TBJ.BORRADO = 0 AND TBJ.DD_EST_ID IN(SELECT DD_EST_ID FROM REM01.DD_EST_ESTADO_TRABAJO WHERE DD_EST_ESTADO_CONTABLE = 1)
