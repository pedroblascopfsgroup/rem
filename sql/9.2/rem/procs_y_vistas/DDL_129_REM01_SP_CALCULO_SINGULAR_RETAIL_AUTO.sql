...
BEGIN
	...
	WHILE (crs_activos%FOUND) LOOP
		...
		V_MSQL := 'SELECT cra.dd_cra_codigo FROM #ESQUEMA#.ACT_ACTIVO act INNER JOIN #ESQUEMA#.DD_CRA_CARTERA cra ON act.dd_cra_id = cra.dd_cra_id WHERE act.act_id='||v_act_id;
