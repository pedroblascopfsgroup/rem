...
--[4.8] COSPAT -> ACTUALIZAR SUBCARTERA
...
--[21.2] COREAE --> ACB_COREAE 
  ...
  END IF;
      ...
      --[22]TABLA BIE_LOCALIZACION
      --[22.1] NOVIAS --> BIE_LOC_DIRECCION
      EXECUTE IMMEDIATE 'MERGE INTO '||V_ESQUEMA||'.BIE_LOCALIZACION T1
        USING (SELECT
      ...
      --[23]TABLA ACT_LOC_LOCALIZACION
      --[23.1] DESLO2 --> LOC_LONGITUD
      EXECUTE IMMEDIATE 'MERGE INTO '||V_ESQUEMA||'.ACT_LOC_LOCALIZACION T1
        USING (SELECT
                ACT_LOC.LOC_ID,
                CASE
