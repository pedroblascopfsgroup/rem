...
--[3.1]--BIE_ADJ_IMPORTE_ADJUDICACION
	...
	USING (
	  ...
	  OR T1.COD_RESOL_MORATORIA IS NULL) 
...
--[6.1]--ADN_FECHA_FIRMA_TITULO
	    ...
	    SELECT DECODE(APR.FETIFI,''00000000'',NULL,TO_DATE(APR.FETIFI,''YYYYMMDD'')) AS FECHA, ADN.ADN_FECHA_FIRMA_TITULO, ACT.ACT_ID FROM '||V_ESQUEMA||'.APR_AUX_STOCK_UVEM_TO_REM APR
	      ...
	      AND APR.REM = 1
	      AND ACT.BORRADO = 0
	      AND (ADN.ADN_FECHA_FIRMA_TITULO <> DECODE(APR.FETIFI,''00000000'',NULL,TO_DATE(APR.FETIFI,''YYYYMMDD'')) OR ADN.ADN_FECHA_FIRMA_TITULO IS NULL OR APR.FETIFI IS NULL
...
---------------------------------
  ...
  EXECUTE IMMEDIATE '
  	MERGE INTO '||V_ESQUEMA||'.ACT_VAL_VALORACIONES T1 USING (
           ...
           AND APR.REM = 1
           AND ACT.BORRADO = 0
           AND (APR.PRECIO_REFERENCIA <> VAL.VAL_IMPORTE OR VAL.VAL_IMPORTE IS NULL OR APR.PRECIO_REFERENCIA IS NULL)
