  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.VI_BUSQUEDA_GASTOS_PROVEEDOR_E
	AS
		SELECT
	        ...
	        ACT.ACT_NUM_ACTIVO,
	        GPV.GPV_ID||ACT.ACT_ID AS ID_VISTA,
			GIC.GIC_PTDA_PRESUPUESTARIA AS PTDA_PRESUPUESTARIA,
			GIC.GIC_CUENTA_CONTABLE AS CONCEPTO_CONTABLE,
		...
		LEFT JOIN ' || V_ESQUEMA || '.GIC_GASTOS_INFO_CONTABILIDAD GIC ON GIC.GPV_ID = GPV.GPV_ID
