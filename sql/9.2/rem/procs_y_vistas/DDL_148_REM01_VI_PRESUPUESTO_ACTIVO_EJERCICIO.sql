...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.V_PRESUPUESTO_ACTIVO_EJERCICIO 
	...
	IMPORTE_TRABAJO AS (
	    ...
	    FROM ACT_TBJ ACTTBJ
	    INNER JOIN REM01.ACT_TBJ_TRABAJO TBJ ON ACTTBJ.TBJ_ID = TBJ.TBJ_ID AND TBJ.BORRADO = 0 AND TBJ.DD_EST_ID IN(SELECT DD_EST_ID FROM REM01.DD_EST_ESTADO_TRABAJO WHERE DD_EST_ESTADO_CONTABLE = 1)
	    INNER JOIN REM01.DD_EST_ESTADO_TRABAJO EST ON TBJ.DD_EST_ID = EST.DD_EST_ID
