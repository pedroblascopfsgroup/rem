...
BEGIN
  ...
  SELECT DISTINCT ACT_ID, MAX(APLICA_BOLETIN_GAS) AS APLICA_BOLETIN_GAS, MAX(APLICA_BOLETIN_AGUA) AS APLICA_BOLETIN_AGUA,
                  ...
                  MAX(FECHA_BOLETIN_CFO) AS FECHA_BOLETIN_CFO, MAX(FECHA_BOLETIN_LPO) AS FECHA_BOLETIN_LPO,
                  MAX(FECHA_BOLETIN_CEE) AS FECHA_BOLETIN_CEE, MAX(APLICA_BOLETIN_LPO) AS APLICA_BOLETIN_LPO,
