...
BEGIN
	...
	AS
		...
		CAST((SELECT CASE
			...
			THEN TO_CHAR(HEP.HEP_FECHA_DESDE,''YYYY-MM-DD"T"HH24:MI:SS'')
			ELSE NULL 
			END PUBLICADO_DESDE
		...
		CAST(VSUB.AGR_NUM_AGRUP_REM AS VARCHAR2(9 CHAR))                                 	AS CODIGO_AGRUPACION_OBRA_NUEVA,
        CAST(VSUB.ID AS VARCHAR2(30 CHAR))                                 					AS CODIGO_CABECERA_OBRA_NUEVA,
