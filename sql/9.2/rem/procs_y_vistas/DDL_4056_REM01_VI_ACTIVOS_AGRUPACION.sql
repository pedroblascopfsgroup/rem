...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.V_ACTIVOS_AGRUPACION 
	AS
		...
		EPA.DD_EPA_DESCRIPCION AS PUBLICADO_A,
        EPV.DD_EPV_DESCRIPCION AS PUBLICADO_V,
    	...
    	LEFT JOIN '|| V_ESQUEMA ||'.ACT_APU_ACTIVO_PUBLICACION ACT_APU ON ACT.ACT_ID = ACT_APU.ACT_ID AND ACT_APU.BORRADO = 0
