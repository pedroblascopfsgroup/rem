...
--##		0.7 Se realiza un Join con la vista V_COND_PUBLICACION para sacar los campos COND_PUBL_VENTA, COND_PUBL_ALQUILER (HREOS-4907)
--##########################################
--*/
...
BEGIN
  ...
  V_MSQL := 'CREATE OR REPLACE VIEW ' || V_ESQUEMA || '.V_ACTIVOS_AGRUPACION 
	...
	INNER JOIN '|| V_ESQUEMA ||'.V_COND_PUBLICACION 				COND 	ON AGR.ACT_ID = COND.ACT_ID
