                    ...
                    FROM(
						...
						SELECT ACT3.ACT_ID	
							...
							, MTO.DD_MTO_ORDEN ORDEN		
								...
								JOIN  '|| V_ESQUEMA ||'.DD_EAL_ESTADO_ALQUILER EAL ON EAL.DD_EAL_ID = ACTPTA.DD_EAL_ID AND EAL.DD_EAL_CODIGO <> ''01''
								LEFT JOIN '|| V_ESQUEMA ||'.DD_MTO_MOTIVOS_OCULTACION MTO ON MTO.DD_MTO_CODIGO = ''16'' AND MTO.BORRADO = 0
