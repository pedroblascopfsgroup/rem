...
create or replace PROCEDURE REM01.SP_CAMBIO_ESTADO_PUBLICACION (pACT_ID IN NUMBER DEFAULT NULL
    ...
    nACT_ID           REM01.V_CAMBIO_ESTADO_PUBLI.ACT_ID%TYPE;
    vDD_TCO_CODIGO    REM01.V_CAMBIO_ESTADO_PUBLI.DD_TCO_CODIGO%TYPE;
    vCODIGO_ESTADO_A  REM01.V_CAMBIO_ESTADO_PUBLI.CODIGO_ESTADO_A%TYPE;
    vDESC_ESTADO_A    REM01.V_CAMBIO_ESTADO_PUBLI.DESC_ESTADO_A%TYPE;
    vCHECK_PUBLICAR_A REM01.V_CAMBIO_ESTADO_PUBLI.CHECK_PUBLICAR_A%TYPE;
    vCHECK_OCULTAR_A  REM01.V_CAMBIO_ESTADO_PUBLI.CHECK_OCULTAR_A%TYPE;
    vDD_MTO_CODIGO_A  REM01.V_CAMBIO_ESTADO_PUBLI.DD_MTO_CODIGO_A%TYPE;    
    vDD_MTO_MANUAL_A  REM01.V_CAMBIO_ESTADO_PUBLI.DD_MTO_MANUAL_A%TYPE; 
    vCODIGO_ESTADO_V  REM01.V_CAMBIO_ESTADO_PUBLI.CODIGO_ESTADO_V%TYPE;
    vDESC_ESTADO_V    REM01.V_CAMBIO_ESTADO_PUBLI.DESC_ESTADO_V%TYPE;
    vCHECK_PUBLICAR_V REM01.V_CAMBIO_ESTADO_PUBLI.CHECK_PUBLICAR_V%TYPE;
    vCHECK_OCULTAR_V  REM01.V_CAMBIO_ESTADO_PUBLI.CHECK_OCULTAR_V%TYPE;
    vDD_MTO_CODIGO_V  REM01.V_CAMBIO_ESTADO_PUBLI.DD_MTO_CODIGO_V%TYPE;
    vDD_MTO_MANUAL_V  REM01.V_CAMBIO_ESTADO_PUBLI.DD_MTO_MANUAL_V%TYPE; 
    vDD_TPU_CODIGO_A  REM01.V_CAMBIO_ESTADO_PUBLI.DD_TPU_CODIGO_A%TYPE;
    vDD_TPU_CODIGO_V  REM01.V_CAMBIO_ESTADO_PUBLI.DD_TPU_CODIGO_V%TYPE;
    vDD_TAL_CODIGO	  REM01.V_CAMBIO_ESTADO_PUBLI.DD_TAL_CODIGO%TYPE;	
    nADMISION         REM01.V_CAMBIO_ESTADO_PUBLI.ADMISION%TYPE;
    nGESTION          REM01.V_CAMBIO_ESTADO_PUBLI.GESTION%TYPE;
    nINFORME_COMERCIAL REM01.V_CAMBIO_ESTADO_PUBLI.INFORME_COMERCIAL%TYPE;
    nPRECIO_A         REM01.V_CAMBIO_ESTADO_PUBLI.PRECIO_A%TYPE;
    ...
    nES_CONDICIONADO  REM01.V_CAMBIO_ESTADO_PUBLI.ES_CONDICIONADO_PUBLI%TYPE;
      ...
      LOOP
		...
		V_MSQL := '
            ...
            FROM (
                ...
                JOIN '|| V_ESQUEMA ||'.DD_EPA_ESTADO_PUB_ALQUILER EPA ON EPA.DD_EPA_ID = AHP.DD_EPA_ID
        ...
        V_MSQL := 'SELECT TCO.DD_TCO_CODIGO, EPV.DD_EPV_CODIGO, EPA.DD_EPA_CODIGO, MTO_V.DD_MTO_CODIGO AS MTO_V_COD, MTO_A.DD_MTO_CODIGO AS MTO_A_COD
                , APU.APU_CHECK_OCULTAR_V, APU.APU_CHECK_OCULTAR_A
