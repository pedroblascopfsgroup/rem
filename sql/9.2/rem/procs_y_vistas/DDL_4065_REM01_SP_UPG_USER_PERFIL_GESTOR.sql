...
/*
declare
V_USUARIO   VARCHAR2(100 CHAR) := 'REMVIP-751_PRUEBA1';
V_USU_USER  VARCHAR2(100 CHAR) := 'golden.tree';
V_USU_GRUP  VARCHAR2(100 CHAR) := 'golden.tree';
V_DES_DESP  VARCHAR2(100 CHAR) := 'REMGTREE';
V_COD_TDES  VARCHAR2(100 CHAR) := 'GTREE';
V_TDE_DESC  VARCHAR2(100 CHAR) := 'Despacho Golden Tree';
V_COD_PERF  VARCHAR2(100 CHAR) := 'HAYAGOLDTREE';
V_PEF_DESC  VARCHAR2(100 CHAR) := 'Gestor de Golden Tree';
V_COD_GEST  VARCHAR2(100 CHAR) := 'GTREE';
V_GES_DESC  VARCHAR2(100 CHAR) := 'Gestor de Golden Tree';
V_COD_CART  VARCHAR2(100 CHAR) := '12';
V_CNF_GEST  NUMBER(1) := 1;
...
BEGIN
    ...
    IF SQL%ROWCOUNT = 0 THEN
        PL_OUTPUT := PL_OUTPUT || '   [INFO] Ya existe el perfil ' || V_PEF_DESC || CHR(10);
    ELSIF SQL%ROWCOUNT = 1 THEN
        PL_OUTPUT := PL_OUTPUT || '   [INFO] Perfil ' || V_PEF_DESC || ' creado ' || CHR(10);
    END IF;
