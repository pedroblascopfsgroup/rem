...
--## VERSIONES:
--##        0.1 Versión inicial
--##		0.2 REMVIP-2730 Se añade el precio de descuento
--##########################################
--*/
...
sql/9.2/rem/procs_y_vistas/DDL_4078_REM01_VI_V_TASACION_CALCULO_LBK.sql
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW '|| V_ESQUEMA ||'.V_TASACION_CALCULO_LBK
      AS
  SELECT ACT.ACT_ID||AGA.AGR_ID AS ID_VISTA, ACT.ACT_ID, AGA.AGR_ID, TAS.TAS_IMPORTE_TAS_FIN AS TASACION, V_PRE_2.VAL_IMPORTE AS PRECIO_APROBADO
