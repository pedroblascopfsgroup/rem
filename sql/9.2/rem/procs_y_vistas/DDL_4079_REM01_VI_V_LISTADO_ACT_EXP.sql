...
-- Modificación de la vista V_LISTADO_ACT_EXP de Fase1.
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW V_LISTADO_ACT_EXP AS 
        ...
        FROM ACT_BEX_BLOQ_EXP_FORMALIZAR BEX
        JOIN ECO_EXPEDIENTE_COMERCIAL ECO ON BEX.ACT_BEX_ECO_ID = ECO.ECO_ID
        JOIN ACT_OFR OFR ON ECO.OFR_ID = OFR.OFR_ID AND BEX.ACT_ID = OFR.ACT_ID
        )
		...
		LEFT JOIN '|| V_ESQUEMA ||'.ECO_TAN_TANTEO_ACTIVO TAN ON ECO.ECO_ID = TAN.ECO_ID AND OFR.ACT_ID = TAN.ACT_ID
