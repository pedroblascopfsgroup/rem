...
-- Modificación de la vista V_LISTADO_ACT_EXP de Fase1.
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW V_LISTADO_ACT_EXP AS 
		...
		LEFT JOIN '|| V_ESQUEMA ||'.DD_ETI_ESTADO_TITULO ETI2 ON TIT.DD_ETI_ID = ETI2.DD_ETI_IDLEFT JOIN '|| V_ESQUEMA ||'.DD_DRT_RESULTADO_TANTEO DRT ON TAN.DD_DRT_ID = DRT.DD_DRT_ID
