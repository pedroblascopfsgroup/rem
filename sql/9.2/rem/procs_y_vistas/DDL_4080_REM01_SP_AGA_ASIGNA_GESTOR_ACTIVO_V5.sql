...
--##		0.3 Añadidos gestores de alquiler GESTCOMALQ y SUPCOMALQ
--##########################################
--*/
...
CREATE OR REPLACE PROCEDURE #ESQUEMA#.SP_AGA_ASIGNA_GESTOR_ACTIVO_V5 (
    V_USUARIO       VARCHAR2 DEFAULT 'SP_AGA_V5',
...
--v0.3
    ...
    V_GESTOR_INMOBILIAR T_GESTOR := T_GESTOR('GADM','SUPADM','GACT','SUPACT','GPREC','SPREC','GPUBL','SPUBL','GCOM','SCOM','FVDNEG','FVDBACKOFR','FVDBACKVNT','SUPFVD','SFORM','GGADM','GIAFORM','GTOCED','CERT',
            'GIAADMT','PTEC', 'GTREE','GCODI','GCOINM','GCOIN','GLIBINVINM','GLIBSINTER','GLIBRES','HAYAGBOINM','SBACKOFFICEINMLIBER','GEDI', 'SUPEDI', 'GSUE', 'SUPSUE','GALQ','SUALQ','GESTCOMALQ','SUPCOMALQ');
    V_GESTOR T_GESTOR;
