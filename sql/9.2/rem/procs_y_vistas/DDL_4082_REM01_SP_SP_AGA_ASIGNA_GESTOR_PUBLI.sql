...
--## PRODUCTO=NO
--## Finalidad: Procedimiento almacenado que asigna Gestores de tipo Gestor Publicacion y Supervisor Publicacion
--##           
...
CREATE OR REPLACE PROCEDURE #ESQUEMA#.SP_AGA_ASIGNA_GESTOR_PUBLI (
...
--v0.4
    ...
    V_GESTOR_FINANCIERO T_GESTOR := T_GESTOR('GPUBL','SPUBL');
    V_GESTOR_INMOBILIAR T_GESTOR := T_GESTOR('GPUBL','SPUBL');
    V_GESTOR T_GESTOR;
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK;
        RAISE;
END SP_AGA_ASIGNA_GESTOR_PUBLI;
/
EXIT;
