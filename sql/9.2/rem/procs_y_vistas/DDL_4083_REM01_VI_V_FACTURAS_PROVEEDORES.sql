...
--##        0.2 20191113 Añadir nuevo campo 
--##########################################
--*/
...
,IMPORTE_GASTO,TIPO_PARTIDA,APARTADO,CAPITULO,PARTIDA,CTA_GASTO,SCTA_GASTO,REPERCUTIR,CONCEPTO_FAC,FECHA_FAC,COD_COEF,CODI_DIAR_IVA_V,PCTJE_IVA_V,NOMBRE,CARACTERISTICA,RUTA,ETAPA,PTDA_PRESUPUESTARIA
...
SELECT
   ...
   , GPL.GPL_PROYECTO                         AS PROYECTO
	...
	, GIC.GIC_PTDA_PRESUPUESTARIA					AS  PTDA_PRESUPUESTARIA
...
FROM
    ...
    INNER JOIN '|| V_ESQUEMA ||'.GPV_ACT REL
   ...
   SELECT
	...
	, TGA.DD_TGA_CODIGO						        AS  TIPO_GASTO
	, STG.DD_STG_CODIGO						        AS  SUBTIPO_GASTO
	, GCONT.GIC_PTDA_PRESUPUESTARIA					AS  PTDA_PRESUPUESTARIA
