...
SELECT
    ...
    , COALESCE(GPL.GPL_IMPORTE_IRPF,
		CASE	WHEN GDE.GDE_IRPF_TIPO_IMPOSITIVO  IS NOT NULL THEN sql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sqlGDE.GDE_IRPF_CUOTA
    ...
    , CONCAT(TO_CHAR(GPV.GPV_NUM_GASTO_HAYA),CONCAsql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sqlT(''-'',GPV.GPV_CONCEPTO))        AS    CONCEPTO
    ...
    , GPL.GPL_CLAVE_1								AS  CLAVE1  sql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql
    ...
    , GPL.GPL_CTA_GASTO								AS  CTsql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sqlA_GASTO
    ...
    , COALESCE(GPL.GPL_CONCEPTO_FAC,
		CASE WHEN GDE.GDE_REPERCUTIBLE_INQUILINO = 1 THEN
			CASE	WHEN STG.DD_STG_CODIGO=''08''       		 THEN ''BAS''
					...
					WHEN STG.DD_STG_CODIGO IN (''26'','sql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql'28'',''31'',''33'') THEN ''RTA''
...
FROM
    ...
    INNER JOIN REM01.GPV_ACT REL
        ON REL.ACT_ID = ACT.ACT_ID
            AND COALESCE(ACT.BORRADO, 0) = 0sql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql
    ...
    INNER JOIN REM01.ACT_PVE_PROVEEDOR PVE
        ON PVE.PVE_ID = GPV.PVE_ID_EMISORsql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql
    ...
    INNER JOIN REM01.ACT_PRO_PROPIETARIO PROPsql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql
	...
	INNER JOIN REM01.DD_TGA_TIPOS_GASTO	TGA
		ON TGA.DD_TGA_ID = STG.DD_TGA_ID
			AND TGA.DD_TGA_CODIGO NOT IN (''05'',''06'',''07'',''08'') sql/9.2/rem/procs_y_vistas/DDL_4084_REM01_VI_V_TASAS_IMPUESTOS.sql
