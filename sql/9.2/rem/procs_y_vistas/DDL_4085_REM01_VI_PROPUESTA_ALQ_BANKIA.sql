...
BEGIN
 ...
 EXECUTE IMMEDIATE 'CREATE OR REPLACE FORCE VIEW '|| V_ESQUEMA ||'.V_PROPUESTA_ALQ_BANKIA 
( 
	"ECO_ID","NUM_ACTIVO_UVEM","ALQ_CARENCIA","DD_TPA_DESCRIPCION","TXO_TEXTO","ECO_FECHA_ALTA","APU_FECHA_INI_ALQUILER","ALQ_FIANZA_IMPORTE","ALQ_FIANZA_MESES","OFR_IMPORTE",
	"DD_EAL_DESCRIPCION","PRO_NOMBRE","TAS_FECHA_RECEPCION_TASACION","TAS_IMPORTE_TAS_FIN","BIE_LOC_POBLACION","BIE_LOC_DIRECCION","BIE_LOC_COD_POST","DD_PRV_DESCRIPCION",
	"BIE_LOC_ESCALERA","BIE_LOC_PISO","BIE_LOC_PUERTA","BIE_LOC_NUMERO_DOMICILIO","DD_TVI_DESCRIPCION","COM_NOMBRE","COM_APELLIDOS","COM_DOCUMENTOS","DD_CRA_DESCRIPCION",
	"OFR_FECHA_ALTA"
) AS
