...
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=2.25 , MAXCOMISSIONAMMOUNT=22500 WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=2.25 , MAXCOMISSIONAMMOUNT=30000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.5 , MAXCOMISSIONAMMOUNT=40000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T05''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=9000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=18000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=22000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION''  AND TRAMO = ''T05''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.25 , MAXCOMISSIONAMMOUNT=STRECHMAX WHERE LEADORIGIN=''04'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T02'' ';
EXECUTE IMMEDIATE V_SQL;
...
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=9500  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.5 , MAXCOMISSIONAMMOUNT=30000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCION'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
...
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''01'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=8.3, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''02'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=10, MAXCOMISSIONAMMOUNT=STRECHMAX WHERE LEADORIGIN=''05'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCION'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
