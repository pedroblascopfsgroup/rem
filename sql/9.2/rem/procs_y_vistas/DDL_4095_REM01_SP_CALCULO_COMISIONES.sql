...
FROM (SELECT DD_TOF_CODIGO,DD_TCR_CODIGO AS TIPO_COMERCIALIZAR, 
      DECODE(DD_ACC_CODIGO,''04'',''PRESCRIPCIÓN'',''05'',''CUSTODIA'') AS TIPO_COMISION, 
      DD_ORC_CODIGO, 
      TRAMO_MIN,
      TRAMO_MAX,
      TRAMO_CODIGO
...
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=2.25 , MAXCOMISSIONAMMOUNT=22500 WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=2.25 , MAXCOMISSIONAMMOUNT=30000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.5 , MAXCOMISSIONAMMOUNT=40000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T05''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=9000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=18000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=22000  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN''  AND TRAMO = ''T05''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.25 , MAXCOMISSIONAMMOUNT=STRECHMAX WHERE LEADORIGIN=''04'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T02'' ';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.6 , MAXCOMISSIONAMMOUNT=6000  WHERE OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.6 , MAXCOMISSIONAMMOUNT=7500  WHERE OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T03'' ';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.6 , MAXCOMISSIONAMMOUNT=10000  WHERE OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''02'' AND TRAMO = ''T05''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.9 , MAXCOMISSIONAMMOUNT=9500  WHERE LEADORIGIN=''01'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=1.5 , MAXCOMISSIONAMMOUNT=30000  WHERE LEADORIGIN=''02'' AND OFFERTYPE=''01'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T03''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.25 , MAXCOMISSIONAMMOUNT=500  WHERE OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.25 , MAXCOMISSIONAMMOUNT=1000 WHERE OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T04''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.6 , MAXCOMISSIONAMMOUNT=5000 WHERE ASSETTYPE in (''03'',''04'') AND OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T01''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0.5 , MAXCOMISSIONAMMOUNT=5000 WHERE ASSETTYPE in (''03'',''04'') AND OFFERTYPE=''01'' AND COMISSIONTYPE=''CUSTODIA'' AND COMERCIALTYPE=''01'' AND TRAMO = ''T04''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''01'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=8.3, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''02'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=10, MAXCOMISSIONAMMOUNT=STRECHMAX WHERE LEADORIGIN=''05'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''PRESCRIPCIÓN'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=4, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''01'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''CUSTODIA'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=4, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''02'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''CUSTODIA'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
V_SQL:= 'UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET COMISSIONPERCENTAGE=0, MAXCOMISSIONAMMOUNT=STRECHMAX   WHERE LEADORIGIN=''05'' AND OFFERTYPE=''02'' AND COMISSIONTYPE=''CUSTODIA'' AND TRAMO = ''T02''';
EXECUTE IMMEDIATE V_SQL;
...
V_SQL:='UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET  comissionpercentage = 1.15, MAXCOMISSIONAMMOUNT=STRECHMAX WHERE  COMISSIONTYPE=''PRESCRIPCIÓN'' AND LEADORIGIN = ''04'' AND SUBCARTERA = ''139'' AND CARTERA = ''11'' AND TRAMO = ''T02'' AND  OFFERTYPE=''01'' ';
EXECUTE IMMEDIATE V_SQL;

V_SQL:='UPDATE '||V_ESQUEMA||'.TMP_COMISIONES_ACTIVOS SET  comissionpercentage = 1.75, MAXCOMISSIONAMMOUNT=STRECHMAX WHERE SUBCARTERA = ''139'' AND CARTERA = ''11'' AND  COMISSIONTYPE=''PRESCRIPCIÓN''AND LEADORIGIN NOT IN (''04'',''05'') AND  OFFERTYPE=''01'' ';
EXECUTE IMMEDIATE V_SQL;
