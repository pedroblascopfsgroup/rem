...
--## VERSIONES:
--##        0.1 Versión inicial Creación de la vista
--##########################################
--*/
...
BEGIN
  ...
  V_MSQL := 'CREATE VIEW ' || V_ESQUEMA || '.VI_LIST_OFERTAS_CES 
	AS
		...
		,BDR.BIE_DREG_REFERENCIA_CATASTRAL
  ...
  EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.VI_LIST_OFERTAS_CES.BIE_DREG_REFERENCIA_CATASTRAL IS ''Referencia catastral''';
