...
SELECT
       ...
       ELSE '' ENVIADO SIN REGISTRO EN EL HISTÓRICO'' END AS DESTINO,
       GPV_NUM_GASTO_HAYA,
       PRG.PRG_NUM_PROVISION AS NUM_PROVISION_FONDOS,
       GGE.GGE_FECHA_ENVIO_PRPTRIO AS FECHA_ENVIO,
       ''PROVISION'' AS TIPO,
...
FROM REM01.GPV_GASTOS_PROVEEDOR GPV, REM01.DD_EGA_ESTADOS_GASTO EGA, REM01.GGE_GASTOS_GESTION GGE, REM01.GDE_GASTOS_DETALLE_ECONOMICO GDE, REM01.PRG_PROVISION_GASTOS PRG
WHERE 1 = 1
AND EGA.DD_EGA_ID = GPV.DD_EGA_ID
AND GGE.GPV_ID = GPV.GPV_ID
AND GDE.GPV_ID = GPV.GPV_ID
AND PRG.PRG_ID = GPV.PRG_ID
AND NOT EXISTS ( SELECT 1 FROM REM01.H_ASPRO_10_CABECERA HIS
                 WHERE HIS.NUFREM = GPV.GPV_NUM_GASTO_HAYA AND COTIFA = ''A'' )
