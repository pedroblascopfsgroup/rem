...
--## INCIDENCIA_LINK=HREOS-5185
--## PRODUCTO=NO
--## 
--## Finalidad: Actualización tabla 'AUX_HREOS_5185'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
EXECUTE IMMEDIATE '
DROP TABLE REM01.AUX_HREOS_5319';


EXECUTE IMMEDIATE 'CREATE TABLE REM01.AUX_HREOS_5319 (
ACT_ID NUMBER(16),
...
EXECUTE IMMEDIATE '
INSERT INTO REM01.AUX_HREOS_5319
...
EXECUTE IMMEDIATE 'DELETE FROM REM01.AUX_HREOS_5319 WHERE USU_ID_DIST IS NULL'; 
...
USING 
(SELECT * FROM REM01.AUX_HREOS_5319 WHERE USU_ID_DIST <> USU_ID_GEE ) TMP
...
(SELECT DD_TGE_ID FROM REMMASTER.DD_TGE_TIPO_GESTOR WHERE DD_TGE_CODIGO = ''GIAFORM''),
TRUNC(SYSDATE) AS GEH_FECHA_DESDE,
''HREOS-5319'' AS USUARIOCREAR,
SYSDATE AS FECHACREAR

FROM REM01.AUX_HREOS_5319 WHERE USU_ID_DIST <> USU_ID_GEE';
...
(GEH_ID, ACT_ID)
SELECT GEH_NEXT AS GEH_ID , ACT_ID FROM REM01.AUX_HREOS_5319 WHERE USU_ID_DIST <> USU_ID_GEE';
