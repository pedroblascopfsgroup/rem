...
DECLARE
   ...
   USUARIO VARCHAR2(50 CHAR):= 'REMVIP-4326'; -- Usuario con el que se registraran las modificaciones. Campo obligatorio
   LIST_EXP_REP VARCHAR2(1024 CHAR):= '165941'; -- Ej. 'XXX,XXX,XXX'-- Lista de números de expedientes comerciales, separados por comas, que queramos reposicionar. Es obligatorio.
   TRAM_DESTINO VARCHAR2(1024 CHAR):= 'T013_DefinicionOferta' ; -- Trámite al que se quiere avanzar cada expediente comercial. Es obligatorio.
   ...
   EEC_DESTINO VARCHAR2(1024 CHAR):= ''; --  Código del estado en el que se quiere poner el expediente o expedientes comerciales que se pasen en la lista anterior. No es obligatorio, si se deja vacío no hará ese paso.
...
/*  
   ...
   T013_RespuestaBankiaDevolucion            Respuesta Bankia Devolución
   T013_PendienteDevolucion                  Pendiente Devolución
   T013_RespuestaBankiaAnulacionDevolucion   Respuesta Bankia anulación de la devolución
