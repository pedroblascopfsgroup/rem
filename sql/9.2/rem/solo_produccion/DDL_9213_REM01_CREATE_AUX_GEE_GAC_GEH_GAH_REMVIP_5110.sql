...
END IF;
	...
	V_MSQL := 'CREATE INDEX IDX_AUX_GAC_GAC_ID ON '||V_ESQUEMA_1||'.AUX_GAC_REMVIP_5110(ACT_ID)';
	EXECUTE IMMEDIATE V_MSQL;
	...
	V_MSQL := 'CREATE INDEX IDX_AUX_GAH_GAH_ID ON '||V_ESQUEMA_1||'.AUX_GAH_REMVIP_5110(ACT_ID)';
	EXECUTE IMMEDIATE V_MSQL;
