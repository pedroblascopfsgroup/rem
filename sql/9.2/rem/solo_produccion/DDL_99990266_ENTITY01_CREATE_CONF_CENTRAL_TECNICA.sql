...
--## INCIDENCIA_LINK=0
--## PRODUCTO=NO
--## Finalidad: Tabla auxiliar para cargar los gestores de central tecnica
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'CONF_CENTRAL_TECNICA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
	...
	V_MSQL := 'CREATE TABLE ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||'
			  (
					DD_CMA_DESCRIPCION	VARCHAR2(100 CHAR),
					PVE_COD_REM	NUMBER(16,0)
			  )';
