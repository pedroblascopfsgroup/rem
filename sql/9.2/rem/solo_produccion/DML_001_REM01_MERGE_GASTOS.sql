...
BEGIN	
	...
	V_MSQL:= 'MERGE INTO '||V_ESQUEMA||'.GGE_GASTOS_GESTION GES
					USING(SELECT DISTINCT GPV.GPV_ID,ENV.FECHA_ENVIO
							FROM '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV
								INNER JOIN REM_EXT.CARGA_INI_FECHA_ENVIO    	ENV     ON ENV.NUM_GASTO_HAYA=GPV.GPV_NUM_GASTO_HAYA
