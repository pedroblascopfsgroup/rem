...
BEGIN	
	...
	V_MSQL := 'MERGE INTO REM01.ACT_PVE_PROVEEDOR PVE
					USING ( select pve_id
					from REM_EXT.TMP_PVE_A_DESMARCAR tem
					 left join REM01.ACT_PVE_PROVEEDOR  pve
					   on PVE.PVE_DOCIDENTIF = TEM.NIF
					   group by pve_id) TEM
					ON (PVE.pve_id = TEM.pve_id)
					WHEN MATCHED THEN UPDATE 
					SET  PVE.PVE_ENVIADO = NULL
						,PVE.USUARIOMODIFICAR = ''ITREM-7341''
