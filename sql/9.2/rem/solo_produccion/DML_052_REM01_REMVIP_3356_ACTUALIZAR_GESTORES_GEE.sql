...
--## PRODUCTO=NO
--## 
--## Finalidad: Actualización tabla 'AUX_REMVIP_3356'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
SELECT COUNT(1) INTO TABLE_COUNT FROM ALL_TABLES WHERE TABLE_NAME = 'AUX_REMVIP_3356' AND OWNER= 'REM01';

IF TABLE_COUNT > 0 THEN
   EXECUTE IMMEDIATE 'DROP TABLE REM01.AUX_REMVIP_3356';
   
   DBMS_OUTPUT.PUT_LINE('[INFO] TABLA AUX ELIMINADA');
END IF;

V_MSQL := 'CREATE TABLE REM01.AUX_REMVIP_3356 (
ACT_ID NUMBER(16),
...
V_MSQL := '
INSERT INTO REM01.AUX_REMVIP_3356
...
V_MSQL := '
MERGE INTO REM01.AUX_REMVIP_3356 AUX
USING(
...
V_MSQL := 'DELETE FROM REM01.AUX_REMVIP_3356 WHERE USU_ID_DIST IS NULL'; 
EXECUTE IMMEDIATE V_MSQL;
...
USING 
(SELECT * FROM REM01.AUX_REMVIP_3356 WHERE USU_ID_DIST <> USU_ID_GEE ) TMP
ON (GEE.GEE_ID = TMP.GEE_CUR)
WHEN MATCHED THEN UPDATE
SET
GEE.USU_ID = TMP.USU_ID_DIST,
GEE.USUARIOMODIFICAR = ''REMVIP-3356'',
...
GEH.USUARIOMODIFICAR = ''REMVIP-3356'',
...
(SELECT DD_TGE_ID FROM REMMASTER.DD_TGE_TIPO_GESTOR WHERE DD_TGE_CODIGO = ''HAYAGBOINM''),
TRUNC(SYSDATE) AS GEH_FECHA_DESDE,
''REMVIP-3356'' AS USUARIOCREAR,
SYSDATE AS FECHACREAR

FROM REM01.AUX_REMVIP_3356 WHERE USU_ID_DIST <> USU_ID_GEE';
EXECUTE IMMEDIATE V_MSQL;
...
(GEH_ID, ACT_ID)
SELECT GEH_NEXT AS GEH_ID , ACT_ID FROM REM01.AUX_REMVIP_3356 WHERE USU_ID_DIST <> USU_ID_GEE';
EXECUTE IMMEDIATE V_MSQL;
