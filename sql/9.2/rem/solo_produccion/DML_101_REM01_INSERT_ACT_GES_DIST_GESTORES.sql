...
--## INCIDENCIA_LINK=REMVIP-3461
--## PRODUCTO=NO
--##
--## Finalidad: Script para sustituir el gestor actual de las configuraciones.
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USU VARCHAR2(2400 CHAR) := 'REMVIP-3461';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
         ...
         T_TIPO_DATA('GCOM', '', '2', '2', '28', '28079', '', 'ilopezgasco')
...
BEGIN	
	...
	V_MSQL := 'DELETE FROM '|| V_ESQUEMA ||'.ACT_GES_DIST_GESTORES WHERE COD_CARTERA IN (''2'') AND TIPO_GESTOR = ''GCOM'' AND COD_MUNICIPIO = ''28079'' AND COD_POSTAL IS NOT NULL';

          EXECUTE IMMEDIATE V_MSQL;

	V_MSQL := 'DELETE FROM '|| V_ESQUEMA ||'.ACT_GES_DIST_GESTORES WHERE COD_CARTERA IN (''3'') AND TIPO_GESTOR = ''GCOM'' AND COD_MUNICIPIO IN (''46250'', ''12040'') AND COD_POSTAL IS NOT NULL';
      ...
      LOOP
        ...
        V_TMP_TIPO_DATA := V_TIPO_DATA(I);
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (' ||
						...
						', '''||TRIM(V_TMP_TIPO_DATA(3))||''' ,'''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''','''||TRIM(V_TMP_TIPO_DATA(5))||''' ' ||
