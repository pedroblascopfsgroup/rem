...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: Modificamos el campo ACT_VENTA_EXTERNA_OBSERVACION');
			V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO ACT
						SET ACT_VENTA_EXTERNA_OBSERVACION = ''26/02 CHELO: solic FSV Re: SOLICITUD FSV ACTIVO Nº 6989359. Buenas tardes, El valor actual de venta del activo solicitado es 98.000€'',
						USUARIOMODIFICAR = ''REMVIP-3433'',
						FECHAMODIFICAR = SYSDATE
						WHERE ACT.ACT_NUM_ACTIVO_UVEM = 32509057
						';
