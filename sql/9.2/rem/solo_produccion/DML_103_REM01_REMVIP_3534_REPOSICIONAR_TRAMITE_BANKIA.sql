...
DECLARE
   ...
   USUARIO VARCHAR2(50 CHAR):= 'REMVIP-3534'; -- Usuario con el que se registraran las modificaciones. Campo obligatorio
   LIST_EXP_REP VARCHAR2(1024 CHAR):= '136901'; -- Ej. 'XXX,XXX,XXX'-- Lista de números de expedientes comerciales, separados por comas, que queramos reposicionar. Es obligatorio.
   TRAM_DESTINO VARCHAR2(1024 CHAR):= 'T013_RespuestaBankiaDevolucion' ; -- Trámite al que se quiere avanzar cada expediente comercial. Es obligatorio.
...
BEGIN
	...
	#ESQUEMA#.AVANCE_TRAMITE(USUARIO,LIST_EXP_REP,TRAM_DESTINO,LIST_EXP_EEC,EEC_DESTINO,PL_OUTPUT);
