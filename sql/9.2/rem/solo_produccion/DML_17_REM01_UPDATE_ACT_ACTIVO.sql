...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-2977'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
...
BEGIN	
	...
	IF V_NUM_FILAS = 1 THEN
		...
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO 
				   SET DD_CRA_ID = (SELECT DD_CRA_ID FROM DD_CRA_CARTERA WHERE DD_CRA_CODIGO = ''13''),
				   DD_SCR_ID = (SELECT DD_SCR_ID FROM DD_SCR_SUBCARTERA WHERE DD_SCR_CODIGO = ''41''),
