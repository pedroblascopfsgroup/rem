...
--##########################################
--## AUTOR=PIER GOTTA
--## FECHA_CREACION=2019118
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=REMVIP-3088
--## PRODUCTO=NO
--##
...
BEGIN	
    ...
    END LOOP;
   	...
   	V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.AUX_LISTA_NEGRA_GASTOS WHERE GPV_NUM_GASTO_HAYA = 10168543';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('ELIMINANDO GASTO: 10168543');
