...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('9','grupoBC' ,'Grupo BC' ,'Grupo BC', 'GRUPOBC','10009469','9990000000915','15','grupobc02'),  
		T_TIPO_DATA('11','maretra' ,'Maretra' ,'Maretra', 'MARETRA','110116879','9990000000917','17','maretra02'),  
		T_TIPO_DATA('12','qipert' ,'Qipert' ,'Qipert', 'QIPERT','110116880','9990000000916','16','qipert02'),    
		T_TIPO_DATA('13','mediterraneo' ,'Mediterraneo' ,'Mediterraneo', 'MEDITERRANEO','110116881','null','null','mediterraneo02'),
		T_TIPO_DATA('14','gestinova' ,'Gestinova' ,'Gestinova', 'GESTINOVA','110116882','null','null','gestinova02'),
		T_TIPO_DATA('15','emais' ,'Emais' ,'Emais', 'EMAIS','110116883','null','null','emais02'),
		T_TIPO_DATA('16','f&g' ,'F&G' ,'F&G', 'F&G','110116884','null','null','f&g02')
    ); 
