...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-4490'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
				T_JBV(255729,4350334,9227803),
				T_JBV(320684,4360401,9235734),
				T_JBV(324892,4308630,9198496)
				); 
	V_TMP_JBV T_JBV;
...
BEGIN	
	...
	ALTA_BPM_INSTANCES('REMVIP-4490', PL_OUTPUT);
