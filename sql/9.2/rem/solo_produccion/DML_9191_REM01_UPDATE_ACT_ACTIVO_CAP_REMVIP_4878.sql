...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] Actualizados '||SQL%ROWCOUNT||' registros en ACT_ACTIVO de SINTETICOS a NORMAL');  
			...
			MERGE INTO REM01.ACT_ACTIVO T1
				...
				SELECT AUX.ACT_NUM_ACTIVO 
				FROM '||V_ESQUEMA||'.AUX_REMVIP_4878_1 AUX 
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] Actualizados '||SQL%ROWCOUNT||' registros en ACT_ACTIVO de 118 a NORMAL');  
