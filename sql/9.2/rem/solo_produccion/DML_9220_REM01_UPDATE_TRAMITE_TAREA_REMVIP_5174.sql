...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-5174'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
...
BEGIN	
	...
	REM01.ALTA_BPM_INSTANCES('REMVIP-5174', PL_OUTPUT);
