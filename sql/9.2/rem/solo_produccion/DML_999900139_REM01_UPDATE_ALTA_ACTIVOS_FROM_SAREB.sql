...
DECLARE
	...
	IS
		...
		WHERE ACT.FECHACREAR >= TO_DATE('12/08/17', 'DD/MM/YYYY')
...
BEGIN	
	...
	IF V_NUM_TABLAS = 0 THEN
		...
		V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL (ICO_ID, ACT_ID, DD_TIC_ID, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
		(SELECT
