...
BEGIN
    ...
    EXECUTE IMMEDIATE 'UPDATE REM01.ACT_TRA_TRAMITE SET USUARIOCREAR = ''MIG_CAJAMAR'' WHERE USUARIOCREAR = ''MIG_SAREB'' AND FECHACREAR = TO_DATE(''06/10/2017'',''DD/MM/YYYY'')';
    EXECUTE IMMEDIATE 'UPDATE REM01.TAR_TAREAS_NOTIFICACIONES SET USUARIOCREAR = ''MIG_CAJAMAR'' WHERE USUARIOCREAR = ''MIG_SAREB'' AND FECHACREAR = TO_DATE(''06/10/2017'',''DD/MM/YYYY'')';
    EXECUTE IMMEDIATE 'UPDATE REM01.TEX_TAREA_EXTERNA SET USUARIOCREAR = ''MIG_CAJAMAR'' WHERE USUARIOCREAR = ''MIG_SAREB'' AND FECHACREAR = TO_DATE(''06/10/2017'',''DD/MM/YYYY'')';
