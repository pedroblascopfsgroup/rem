...
--## PRODUCTO=NO
--## 
--## Finalidad: Cambio de estado de publicación migrado "Publicado oculto" a despublicado. 
--##			   
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
...
DECLARE
  ...
  V_MOTIVO VARCHAR2 (100 CHAR) := 'Actualización masiva PFS';
...
BEGIN
 ...
 V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_ACTIVO ACT
  USING (SELECT DISTINCT ACT_ID, ADMISION, GESTION, PRECIO, PUBLICACION, ESTADO_PUBLICACION_CODIGO, INFORME_COMERCIAL FROM '||V_ESQUEMA||'.V_BUSQUEDA_PUBLICACION_ACTIVO) VISTA
