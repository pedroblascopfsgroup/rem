...
--#########################################
--## AUTOR=Gustavo Mora
--## FECHA_CREACION=20171125
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=0.1
--## INCIDENCIA_LINK=HREOS-3368
--## PRODUCTO=NO
--## 
...
DECLARE
    ...
    COUNTER NUMBER(2);
    COD_ITEM VARCHAR2(50 CHAR) := 'HREOS-3293';
    ...
    V_MSQL := 'INSERT INTO REM01.OFERTAS_REPOSICIONAR
        ...
        WHERE ECO.ECO_NUM_EXPEDIENTE IN (
                              select distinct eco.eco_num_expediente
                                 ...
                                 join rem01.dd_eof_estados_oferta eof on ofr.dd_eof_id = ofr.dd_eof_id
                                 ...
                                 join rem01.act_tra_tramite tra on tra.tbj_id = tbj.tbj_id
                                 ...
                                 where tar.borrado = 0 and eec.dd_eec_codigo = ''06'' and tar.tar_tarea = ''Instrucciones reserva'' and act.dd_cra_id = 21;
        )';
    EXECUTE IMMEDIATE V_MSQL;
