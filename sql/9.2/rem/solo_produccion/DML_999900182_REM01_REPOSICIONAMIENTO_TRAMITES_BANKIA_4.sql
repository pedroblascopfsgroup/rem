...
BEGIN
  ...
  /*  V_MSQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE TABLE_NAME = '''||V_TABLA_REP||''' AND OWNER = '''||V_ESQUEMA||''' ';
    ...
    V_MSQL := 'INSERT INTO REM01.OFERTAS_REPOSICIONAR
        ...
        /*INSERTAR AQUI LOS NUMEROS DE EXPEDIENTE A ACTUALIZAR*/
                    SELECT ECO2.ECO_NUM_EXPEDIENTE FROM REM01.ACT_ACTIVO ACT2
                    JOIN REM01.ACT_OFR OFR2 ON OFR2.ACT_ID = ACT2.ACT_ID
                    JOIN REM01.ECO_EXPEDIENTE_COMERCIAL ECO2 ON OFR2.OFR_ID = ECO2.OFR_ID
		    WHERE ACT2.ACT_NUM_ACTIVO_UVEM IN (	
							24777692,
							24777107,
							27321256,
							27440078,
