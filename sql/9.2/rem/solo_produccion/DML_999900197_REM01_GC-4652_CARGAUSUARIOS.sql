...
--## INCIDENCIA_LINK=REMNIVDOS-3105
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'jromeros' ,'Jessica ' ,'Romero '  ,'Soria'  ,'jromeros@externos.haya.es'  , 'UMJQZITKYF'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'omartinezs' ,'Oscar ' ,'Martinez '  ,'Sanchis'  ,'omartinez@externos.haya.es'  , 'IBUCNMBERG'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '50075594V' ,'Emilio ' ,'Villa  '  ,'Bordallo'  ,'emiliovilla@idecnet.com '  , 'FOPMLXDTXH'  ,'HAYAPROV'  ,''  ,'REMPROV'),
		T_TIPO_DATA( '02874944J' ,'Mar ' ,'Sanz  '  ,'Llorente'  ,'marsanzllorente@gmail.com '  , 'XCWIVJXYIR'  ,'HAYAPROV'  ,''  ,'REMPROV')
