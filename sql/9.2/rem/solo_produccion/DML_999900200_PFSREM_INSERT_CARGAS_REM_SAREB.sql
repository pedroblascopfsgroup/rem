...
BEGIN
	...
	V_SQL := 'INSERT
				...
				''HREOS-3412'' AS USUARIOCREAR,
				SYSDATE AS FECHACREAR
				FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT
				INNER JOIN PFSREM.aux_cargas_canyon_last APR_CRG				      ON APR_CRG.BIE_ENTIDAD_ID = ACT.ACT_NUM_ACTIVO
	...
	V_SQL := 'INSERT
				...
				FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT
				INNER JOIN PFSREM.AUX_CARGAS_CANYON_LAST aux		ON AUX.BIE_ENTIDAD_ID = ACT.ACT_NUM_ACTIVO
