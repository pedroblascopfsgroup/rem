...
BEGIN
	...
	V_SQL := 'INSERT
				...
				''HREOS-3594'' AS USUARIOCREAR,
				SYSDATE AS FECHACREAR
				FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT
				INNER JOIN PFSREM.aux_cargas_canyon_ultimate APR_CRG				ON APR_CRG.BIE_ID = ACT.ACT_RECOVERY_ID
	...
	V_SQL := 'INSERT
				...
				FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT
				INNER JOIN PFSREM.AUX_CARGAS_CANYON_ULTIMATE aux		ON AUX.BIE_ID = ACT.ACT_RECOVERY_ID
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA_1||'... SE HAN INSERTADO CORRECTAMENTE '||SQL%ROWCOUNT||' REGISTROS');
