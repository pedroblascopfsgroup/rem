...
--## FECHA_CREACION=20171229
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.2
--## INCIDENCIA_LINK=REMNIVDOS-3119
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'jtorress' ,'' ,''  ,''  ,''  , 'WICPGUASWY'  ,'HAYAGESTADM'  ,'usugruadm'  ,'REMADM'),
		T_TIPO_DATA( 'epena' ,'Elena ' ,'Peña '  ,'Sanz'  ,'epena@haya.es'  , 'DIXCDBIENR'  ,'HAYACONSU'  ,' '  ,''),
		T_TIPO_DATA( 'mrentero' ,'Maitane ' ,'Rentero '  ,'Valmala'  ,'mrentero@haya.es'  , 'MPQWSHGASB'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'pnevot' ,'Pablo ' ,'Nevot '  ,'Arroyo'  ,'pnevot@haya.es'  , 'SDMQYJWRIV'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'mpuig' ,'Marc ' ,'Puig '  ,'Redondo'  ,'mpuig@haya.es'  , 'HMIQYMIYEE'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'ygarciam' ,'' ,''  ,''  ,''  , 'OIXKPPQIPZ'  ,'SUPFVD'  ,'usugrrfv'  ,'REMSUPFVD'),
		T_TIPO_DATA( 'lclaret' ,'' ,''  ,''  ,''  , 'VSWJPCRUTM'  ,'SUPFVD'  ,'usugrrfv'  ,'REMSUPFVD')
