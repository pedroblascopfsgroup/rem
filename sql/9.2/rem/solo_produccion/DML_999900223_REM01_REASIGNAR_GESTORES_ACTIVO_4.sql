...
--## PRODUCTO=NO
--## 
--## Finalidad: Re-asignar activos de agonzaleza a acabello
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] COMIENZA EL PROCESO PARA LA RE-ASIGNACIÓN DE ACTIVOS DE agonzaleza A acabello');
...
IF V_USU_NUEVO > 0 THEN
	...
	FROM (
		...
		AND BIE.BIE_LOC_PROVINCIA IN (''1'', ''15'', ''20'', ''27'', ''31'', ''32'', ''33'', ''36'', ''39'', ''48'')
		AND USU.USU_USERNAME = ''agonzaleza''))';
	EXECUTE IMMEDIATE V_MSQL;
