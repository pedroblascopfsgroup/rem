...
--## PRODUCTO=NO
--## 
--## Finalidad: Re-asignar activos de mcanton a mgarciade
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] COMIENZA EL PROCESO PARA LA RE-ASIGNACIÓN DE ACTIVOS DE mcanton A mgarciade');
