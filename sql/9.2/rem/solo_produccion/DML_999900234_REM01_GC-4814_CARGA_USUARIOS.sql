...
--## INCIDENCIA_LINK=REMNIVDOS-3441, REMNIVDOS-3464 
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'schaveli' ,'' ,''  ,''  ,''  , 'SYMWSARJKV'  ,'HAYASUPER'  ,''  ,'REMSUPER'),
		T_TIPO_DATA( 'B41689837' ,'' ,''  ,''  ,''  , 'AACTICJXJN'  ,'HAYAPROV'  ,''  ,'REMPROV'),
		T_TIPO_DATA( 'msaizh' ,'Maria ' ,'Saiz '  ,'Hernandez'  ,'msaizh@externos.haya.es'  , 'CYGZTJCKLP'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '02786789V' ,'Carlos ' ,'Llona'  ,''  ,'carlos.llona@nfq.es'  , 'PPSENUKFDT'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'stubio' ,'Santiago ' ,'Tubio '  ,'Campos'  ,'stubio@externos.haya.es'  , 'MMNCOMCAXB'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'amachado' ,'Antonio ' ,'Machado '  ,'Moya'  ,'amachado@externos.haya.es'  , 'RHJVGDCVFK'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'lcastillo' ,'Luis Ramón ' ,'Castillo '  ,'Novalbos'  ,'lcastillo@externos.haya.es'  , 'URSIDLFSHY'  ,'HAYACONSU'  ,''  ,'')
