...
--## INCIDENCIA_LINK=REMNIVDOS-3628, REMNIVDOS-3625
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( '52701241F' ,'Mayte' ,'Zaragozá'  ,'Mirasol'  ,'mzaragozam@grupobc.com'  , 'FYVYJWZSTD'  ,'HAYAGESTADMT'  ,'cenahi01'  ,'REMGIAADMT'),
	T_TIPO_DATA( '52701241F' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTADMT'  ,'cenahi02'  ,'REMGIAADMT'),
	T_TIPO_DATA( '52701241F' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTADMT'  ,'cenahi03'  ,'REMGIAADMT'),
	T_TIPO_DATA( '52701241F' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTADMT'  ,'cenahi04'  ,'REMGIAADMT'),
	T_TIPO_DATA( 'acarmona' ,'Antonio ' ,'Carmona '  ,'Moreno'  ,'acarmona@haya.es'  , 'HLFRATTKBB'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'ilopeze' ,'Inmaculada ' ,'Lopez '  ,'Espinosa'  ,'ilopeze@haya.es'  , 'APSSAZQDDS'  ,'HAYACONSU'  ,''  ,'')
