...
--## INCIDENCIA_LINK=REMNIVDOS-3690
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'A142651' ,'Francisco Javier ' ,'Caballero '  ,'Rodriguez'  ,'fcaballero@bankia.com'  , 'IXCFAIKHMD'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'A135596' ,'Eva María' ,'Morro'  ,'Acedo'  ,'emorro@bankia.com'  , 'YDXJULNWXL'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'A117521' ,'Raquel' ,'Sanchez'  ,'Acedo'  ,'rsancheza@bankia.com'  , 'ZHSIQBXVAR'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'A110141' ,'Alfredo' ,'Ortas'  ,'Herrero'  ,'aortas@bankia.com'  , 'NSCJIOEUEU'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'aalvear' ,'Alberto Carlos ' ,'Alvear '  ,'Aragon'  ,'aalvear@haya.es'  , 'ZRHJLDXOHC'  ,'HAYAGESACT'  ,''  ,'REMACT'),
	T_TIPO_DATA( 'asantos' ,'Alvaro ' ,'Santos '  ,'del Valle'  ,'asantos@haya.es'  , 'YDZTGGHGIX'  ,'HAYAGESACT'  ,''  ,'REMACT'),
	T_TIPO_DATA( '34258621Y' ,'Pilar ' ,'Rey '  ,'Salgueiro'  ,'administración@psagroup.es'  , 'KPPRPGYOPU'  ,'HAYAPROV'  ,''  ,'REMPROV')
