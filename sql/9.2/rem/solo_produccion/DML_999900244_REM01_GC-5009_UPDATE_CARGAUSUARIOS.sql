...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '43161076N' ,'Antonio' ,'Ferragut'  ,'Herranz'  ,'aferragut@bcc.es'  , 'MKHCKRJMYP'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'fvaldes' ,'Francisco Javier ' ,'Valdés '  ,'Bueno'  ,'fvaldes@haya.es'  , 'WPEDPFMGEI'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '50468716T' ,'Roberto ' ,'Cáceres '  ,'Rodríguez'  ,'rcaceres@apreblanc.com'  , 'WDKKCMSKYR'  ,'HAYAPROV'  ,''  ,'REMPROV'),
		T_TIPO_DATA( '53197923G' ,'María ' ,'Martínez '  ,'Cividanes'  ,'mmartinez@apreblanc.com'  , 'JHBWVZBXON'  ,'HAYAPROV'  ,''  ,'REMPROV')
