...
--## PRODUCTO=NO
--##
--## Finalidad: Cambiar expediente a en tramitación
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
 ...
 BEGIN
  ...
  EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET
	  					   DD_EEC_ID = (SELECT DD_EEC_ID FROM '||V_ESQUEMA||'.DD_EEC_EST_EXP_COMERCIAL WHERE DD_EEC_CODIGO = ''01'')
						 , USUARIOMODIFICAR = '''||V_USUARIO||'''
						 , FECHAMODIFICAR = SYSDATE
					 WHERE ECO_NUM_EXPEDIENTE = 85136
  					';
  					
            DBMS_OUTPUT.put_line('[INFO] Cambiado el estado del expediente 82065 a en tramitación');
