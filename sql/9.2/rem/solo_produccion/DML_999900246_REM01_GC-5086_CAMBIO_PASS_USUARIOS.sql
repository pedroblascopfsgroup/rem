...
--## INCIDENCIA_LINK=REMNIVUNO-270, REMNIVUNO-257
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'valfonso', 'XBZSIWUFRN', 'valfonso@externos.haya.es'),
	T_TIPO_DATA( '46616519G', 'PGDCUINFSK', 'seguiment@icobo.es')
