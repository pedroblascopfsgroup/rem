...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'ecasis' ,'Eva Maria ' ,'Casis '  ,'Garcia'  ,'ecasis@haya.es'  , 'ACJWTAKBYS'  ,'HAYAGESTPUBL'  ,'usugrupub'  ,'REMGPUBL'),
	T_TIPO_DATA( 'ibenedito' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,'usugrupub'  ,'REMGPUBL'),
	T_TIPO_DATA( 'rdura' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,'usugrupub'  ,'REMGPUBL'),
	T_TIPO_DATA( 'saragon' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPREC'  ,'usugrupre'  ,'REMGPREC'),
	T_TIPO_DATA( 'saragon' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,'usugrupub'  ,'REMGPUBL'),
	T_TIPO_DATA( 'ndelaossa' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPREC'  ,'usugrupre'  ,'REMGPREC'),
	T_TIPO_DATA( 'ndelaossa' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,'usugrupub'  ,'REMGPUBL'),
	T_TIPO_DATA( 'brecuero' ,'Borja ' ,'Recuero '  ,'Coronil'  ,'brecuero@externos.haya.es'  , 'MBAGSDVHZZ'  ,'HAYAGESTADM'  ,'usugruadm'  ,'REMADM')
