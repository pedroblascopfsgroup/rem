...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'gzingone' ,'Giovanni ' ,'Zingone'  ,' '  ,'gzingone@haya.es'  , 'VUGNCYUEOM'  ,'HAYACONSU'  ,' '  ,''),
	T_TIPO_DATA( 'bgonzalezn' ,'Benito ' ,'Gonzalez '  ,'Noguera'  ,'bgonzalezn@haya.es'  , 'VALXKHVNDU'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
	T_TIPO_DATA( 'dmercado' ,'' ,''  ,''  ,''  , 'YYBFDDIYRI'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM')
