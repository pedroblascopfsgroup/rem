...
BEGIN 
  ...
  DBMS_OUTPUT.PUT_LINE('[INICIO]: Se va a actualizar el expediente comercial del activo 6957221 a Aprobado');
  ...
  EXECUTE IMMEDIATE 'SELECT ECO.ECO_NUM_EXPEDIENTE FROM '||V_ESQUEMA||'.ECO_EXPEDIENTE_COMERCIAL ECO
    ...
    WHERE ACT.ACT_NUM_ACTIVO = 6957221' INTO V_NUM_EXPEDIENTE;
  ...
  COMMIT;
  DBMS_OUTPUT.PUT_LINE('[FIN]: Expediente comercial del activo 6957221 actualizado a '||V_EEC);
