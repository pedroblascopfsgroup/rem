...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'B60546611' ,'DORSERAN SERVEIS DE LA CONSTRUCCIÓ, SL' ,''  ,''  ,'info@dorseran.net'  , 'ODXWGZUTAH'  ,'HAYAPROV'  ,''  ,'REMPROV'),
	T_TIPO_DATA( '33944952B' ,'Angel' ,'Del Moral '  ,'Rabat'  ,'angel@dorseran.net'  , 'BMZMIQMAYM'  ,'HAYAPROV'  ,'B60546611'  ,'REMPROV'),
	T_TIPO_DATA( '40559874H' ,'Elisabet' ,'Ester'  ,'Irla'  ,'lis@dorseran.net'  , 'DEHGSRCYNP'  ,'HAYAPROV'  ,'B60546611'  ,'REMPROV'),
	T_TIPO_DATA( 'B15704364' ,'ESC SERVICIOS GENERALES S.L.' ,''  ,''  ,'Jose-antonio.costana@prosegur.com'  , 'VXIQJOPTJE'  ,'HAYAPROV'  ,''  ,'REMPROV')
