...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'arueda' ,'Andres ' ,'Rueda '  ,'de la Puerta '  ,'arueda@haya.es'  , 'MWSDLCWOWU'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( 'ctorres' ,'Carlos ' ,'Torres '  ,'Perez'  ,'ctorres@externos.haya.es'  , 'YUPDQSWBGT'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'sortiz' ,'Susana ' ,'Ortiz '  ,'Martinez'  ,'sortiz@externos.haya.es'  , 'KGSPGDGOGN'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'esantorcuato' ,'Estefania ' ,'Santorcuato '  ,'Rocafull'  ,'esantorcuato@externos.haya.es'  , 'TDSJCPJITT'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'esantorcuato' ,'Estefania ' ,'Santorcuato '  ,'Rocafull'  ,'esantorcuato@externos.haya.es'  , 'OGZNSUWCEZ'  ,'HAYAGESTADM'  ,'usugruadm'  ,'REMADM'),
		T_TIPO_DATA( 'etorres' ,'Estela ' ,'Torres '  ,'Martinez'  ,'etorres@externos.haya.es'  , 'EWBGWSZONX'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'etorres' ,'Estela ' ,'Torres '  ,'Martinez'  ,'etorres@externos.haya.es'  , 'AOTQFXVOAM'  ,'HAYAGESTADM'  ,'usugruadm'  ,'REMADM'),
		T_TIPO_DATA( 'mblat' ,'Maria Cruz ' ,'Blat '  ,'Romero'  ,'mblat@externos.haya.es'  , 'VVSULPRYTW'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'mblat' ,'Maria Cruz ' ,'Blat '  ,'Romero'  ,'mblat@externos.haya.es'  , 'uAvRixybWs'  ,'HAYAGESACT'  ,' '  ,'REMACT'),
		T_TIPO_DATA( 'vcastillo' ,'Vanesa ' ,'Castillo '  ,'Tortajada'  ,'vcastillo@externos.haya.es'  , 'R"4U^B0fI1'  ,'HAYASADM'  ,''  ,'HAYASADM'),
		T_TIPO_DATA( 'vcastillo' ,'Vanesa ' ,'Castillo '  ,'Tortajada'  ,'vcastillo@externos.haya.es'  , 'DGTMUBOLVC'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( '02670559Y' ,'Luz del Carmen' ,'Jiménez'  ,'Bido'  ,'ljimenez@apreblanc.com'  , 'ARLRFLNBHX'  ,'HAYAPROV'  ,''  ,'REMPROV'),
		T_TIPO_DATA( '50331119N' ,'Alberto' ,'Sanz'  ,'Gómez'  ,'asanz@apreblanc.com   '  , 'BDZQSBRSTQ'  ,'HAYAPROV'  ,''  ,'REMPROV'),
		T_TIPO_DATA( '47411520X' ,'Noelia' ,'Hurtado'  ,'Aparicio'  ,'nhurtado@apreblanc.com   '  , 'YPNPPGOYJU'  ,'HAYAPROV'  ,''  ,'REMPROV')
  ); 
