...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'eacosta' ,'Esther ' ,'Acosta'  ,'Marquez'  ,'eacosta@externos.haya.es'  , 'KGSPGDGOGN'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'drodriguezs' ,'David ' ,'Rodriguez '  ,'Sastre'  ,'drodriguezs@externos.haya.es'  , 'TDSJCPJITT'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'lmoreno' ,'Laura ' ,'Moreno '  ,'Baena'  ,'lmoreno@externos.haya.es'  , 'OGZNSUWCEZ'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'pgomez' ,'Paula ' ,'Gomez '  ,'Ruiz'  ,'pgomez@externos.haya.es'  , 'EWBGWSZONX'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM')
