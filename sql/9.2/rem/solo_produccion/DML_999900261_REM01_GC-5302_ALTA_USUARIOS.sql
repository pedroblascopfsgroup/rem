...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '5327726Y' ,'María ' ,'Muruais '  ,'Barón'  ,'ocupaciones@montalvoabogados.es'  , 'PQXDXDTUYM'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '44500694H' ,'Alejandro' ,'Ramírez'  ,'Sangrones'  ,'agruserdepalancia@gmail.com'  , 'BBRDHWMBLT'  ,'HAYAPROV'  ,''  ,'REMPROV')
