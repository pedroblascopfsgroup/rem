...
DECLARE
	...
	V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-181';
    
    ACT_NUM_ACTIVO NUMBER(16):= 5930200;
 ...
 BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO] El activo '||ACT_NUM_ACTIVO||' se ha puesto como Disponible para la venta con oferta');
