...
--## FECHA_CREACION=2018015
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=2.0.15
--## INCIDENCIA_LINK=REMNIVUNO-481
--## PRODUCTO=NO
--## 
...
DECLARE
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'selena' ,'Silvia' ,'Elena'  ,'Lucas'  ,'selena@externos.haya.es'  , 'ZIAQUURVNF'  ,'HAYAGESACT'  ,''  ,0 ,'REMACT' ,'REMNIVUNO-481')
