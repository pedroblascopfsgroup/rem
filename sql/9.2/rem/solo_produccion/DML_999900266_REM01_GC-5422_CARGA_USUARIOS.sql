...
DECLARE
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '07488153C' ,'Pilar' ,'Lopez'  ,'Acedo'  ,'pilar@rojomata.com'  , 'LVFMDMSXNO'  ,'HAYAPROV'  ,''  ,0 ,'REMPROV' ,'REMNIVUNO-515'),
		T_TIPO_DATA( 'pcalonge' ,'Pedro ' ,'Calonge '  ,'Martin'  ,'pcalonge@haya.es'  , 'WYPNLRCNEL'  ,'HAYACONSU'  ,''  ,0 ,'' ,'REMNIVUNO-515'),
		T_TIPO_DATA( 'asalag' ,'' ,''  ,''  ,''  , 'LWAJWKJOTQ'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'maguilar' ,'' ,''  ,''  ,''  , 'ZAELFGVOZJ'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'fsamper' ,'' ,''  ,''  ,''  , 'LBTLFJOISL'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'gdelrosal' ,'' ,''  ,''  ,''  , 'FEVUQFKSUY'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'mjimenezr' ,'' ,''  ,''  ,''  , 'LUURSIYEOM'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'ateruel' ,'' ,''  ,''  ,''  , 'PVKZGEBDBY'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'gcarbonell' ,'' ,''  ,''  ,''  , 'OSBLSSZWUT'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'mmaldonado' ,'' ,''  ,''  ,''  , 'OJVFICVHSN'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'igomezr' ,'' ,''  ,''  ,''  , 'FITPHEQHIP'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508'),
		T_TIPO_DATA( 'acebrianm' ,'' ,''  ,''  ,''  , 'UUDKJNJFTX'  ,'GESRES'  ,'usugrurba'  ,0 ,'' ,'REMNIVUNO-508')
