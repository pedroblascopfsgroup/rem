...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'pramirez' ,'Patricia' ,'Ramirez '  ,'Marchante'  ,'pramirez@haya.es'  , '16C5FE65D0'  ,'HAYAADM'  ,''  ,'HAYAADM'),
		T_TIPO_DATA( 'gchisvert' ,'Gema' ,'Chisvert'  ,'Andreu'  ,'gchisvert@externos.haya.es'  , 'UMFTDXGNGL'  ,'HAYAADM'  ,''  ,'HAYAADM')
  ); 
