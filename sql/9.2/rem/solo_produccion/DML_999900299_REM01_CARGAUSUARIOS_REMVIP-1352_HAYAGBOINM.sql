...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'lcarrillo' ,'Lorena' ,'Carrillo'  ,'Martinez'  ,'lcarrillo@externos.haya.es'  , 'HCWVDXLOZU'  ,'HAYAGBOINM'  ,''  ,'GESTCOMBACKOFF'),
		T_TIPO_DATA( 'lmarcos' ,'Lucia' ,'Marcos'  ,'Esteban'  ,'lmarcos@externos.haya.es'  , 'LJCPXLVTBH'  ,'HAYAGBOINM'  ,''  ,'GESTCOMBACKOFF'),
		T_TIPO_DATA( 'prodriguezg' ,'Patricia' ,'Rodriguez'  ,'Guzman'  ,'prodriguezg@externos.haya.es'  , 'VUGNCYUEOM'  ,'HAYAGBOINM'  ,''  ,'GESTCOMBACKOFF'),
		T_TIPO_DATA( 'fmorenor' ,'Felix' ,'Moreno'  ,'Rubio'  ,'fmorenor@haya.es'  , 'AMLNCPGLIZ'  ,'HAYAGBOINM'  ,''  ,'GESTCOMBACKOFF')
  ); 
