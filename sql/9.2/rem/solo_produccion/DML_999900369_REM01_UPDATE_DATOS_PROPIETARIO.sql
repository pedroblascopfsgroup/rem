...
DECLARE
  ...
  TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
	...
	--------  DNI ANTERIOR ,LOCALIDAD,PROVINCIA,CODIGO UVEM,TIPO PERSONA, NOMBRE PROPIETARIO               , APELLIDO 1, APELLIDO 2, TIPO DOCUMENTO, NUM DOCUMENTO, DIRECCION, TELEFONO, EMAIL, CARTERA 
     T_TIPO_DATA('V86097979','NULL','NULL','NULL','NULL','AYT HIPOTECARIO MIXTO III','NULL','NULL','NULL','NULL','NULL','NULL','NULL','NULL'),
	 T_TIPO_DATA('V84776335','NULL','NULL','NULL','NULL','GC Pastor Hipotecario 5 FTA','NULL','NULL','NULL','V84325927','NULL','NULL','NULL','NULL')
	); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN		
			...
			V_MSQL := V_MSQL || ' USUARIOMODIFICAR = '''||V_USUARIO||''','|| 
							    ...
							    ' WHERE PRO_DOCIDENTIF = '''||TRIM(V_TMP_TIPO_DATA(1))||'''';	
