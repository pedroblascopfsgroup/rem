...
DECLARE
  ...
  TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    ...
    -- 	 	  NUM ACTIVO, FINCA , REF CATASTRAL 
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN		
			...
			DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS LA REF CATASTRAL Y FINCA DEL ACTIVO '||TRIM(V_TMP_TIPO_DATA(1))||'');
			...
			V_MSQL := 'UPDATE '||V_ESQUEMA||'.BIE_DATOS_REGISTRALES SET BIE_DREG_REFERENCIA_CATASTRAL = '''||TRIM(V_TMP_TIPO_DATA(3))||'''
    ...
    END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: '||SQL%ROWCOUNT||' REFERENCIAS CATASTRALES ACTUALIZADAS CORRECTAMENTE ');
