...
--## PRODUCTO=NO
--##
--## Finalidad: Carga masiva de fecha y precio cartera BOLT.
--##
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USU VARCHAR2(2400 CHAR) := 'REMVIP-2396';
...
BEGIN	
	...
	USING (
		SELECT DISTINCT ACT_PRINEX_ID, FECHA_VENTA, PRECIO_VENTA
		FROM REM01.AUX_REMVIP_2396 AUX
		JOIN REM01.ACT_ACTIVO ACT
		ON AUX.ACT_PRINEX_ID = ACT.ACT_NUM_ACTIVO_PRINEX
	) T2
	ON (T2.ACT_PRINEX_ID = ACT.ACT_NUM_ACTIVO_PRINEX)
	...
	ACT.USUARIOMODIFICAR = ''REMVIP-2396'',
