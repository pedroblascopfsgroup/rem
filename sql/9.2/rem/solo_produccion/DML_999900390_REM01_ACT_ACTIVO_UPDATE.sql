...
BEGIN	
	...
	V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.ACT_ACTIVO WHERE ACT_NUM_ACTIVO = 78574';
	...
	IF V_NUM_FILAS = 1 THEN
		...
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ACTIVO 
				   ...
				   WHERE ACT_NUM_ACTIVO = 78574';
	
		EXECUTE IMMEDIATE V_MSQL;
    
		DBMS_OUTPUT.PUT_LINE('[FIN] REGISTRO CON ACT_NUM_ACTIVO: 78574 ACTUALIZADO');
