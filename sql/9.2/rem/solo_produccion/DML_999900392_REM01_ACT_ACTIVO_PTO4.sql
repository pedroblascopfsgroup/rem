...
BEGIN	
	...
	V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_ACTIVO T1
			   USING (SELECT ACT.ACT_ID, AUX.ACT_NUM_ACTIVO_NUEVO, AUX.ACT_RECOVERY_ID_NUEVO
					  FROM '||V_ESQUEMA||'.AUX_REMVIP_2432_1 AUX
					  LEFT JOIN '||V_ESQUEMA||'.ACT_ACTIVO ACT ON ACT.ACT_NUM_ACTIVO = AUX.ACT_NUM_ACTIVO_VIEJO) T2
