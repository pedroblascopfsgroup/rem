...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USU VARCHAR2(2400 CHAR) := 'REMVIP-2318';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
         ...
         T_TIPO_DATA('GFORM', '', '4', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '6', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '7', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '10', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '11', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '12', '', '', '', '', 'cgarciah'), 
         T_TIPO_DATA('GFORM', '', '13', '', '', '', '', 'cgarciah')
...
BEGIN	
	...
	V_MSQL := 'DELETE FROM '|| V_ESQUEMA ||'.ACT_GES_DIST_GESTORES WHERE COD_CARTERA IN (''4'',''6'',''7'',''10'',''11'',''12'',''13'') AND TIPO_GESTOR = ''GFORM''';
      ...
      LOOP
        ...
        V_TMP_TIPO_DATA := V_TIPO_DATA(I);
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (' ||
						...
						', '''||TRIM(V_TMP_TIPO_DATA(3))||''' ,'''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(5))||''' ' ||
