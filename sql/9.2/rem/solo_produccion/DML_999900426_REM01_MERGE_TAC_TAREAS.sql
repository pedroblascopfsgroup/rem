...
BEGIN			
	...
	EXECUTE IMMEDIATE 'MERGE INTO '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS T1 USING (
		...
		WHERE TAP.TAP_CODIGO IN (''T013_InformeJuridico'', ''T013_PosicionamientoYFirma'',''T013_DocumentosPostVenta'')
                AND TAR.TAR_TAREA_FINALIZADA = 0 AND TGE.DD_TGE_CODIGO = ''GIAFORM''AND CRA.DD_CRA_DESCRIPCION = ''Cajamar'' AND ECO.ECO_NUM_EXPEDIENTE NOT IN(14311, 15172, 15906, 16469, 16533,
