...
--## PRODUCTO=NO
--##
--## Finalidad: Borrado logico de usuarios en la USD_USUARIOS_DESPACHOS
...
BEGIN	
    ...
    LOOP
		...
		IF V_EXISTE_USUARIO = 1 THEN
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO] Se va a aplicar el borrado lógico sobre la relación entre el despacho y el usuario '||TRIM(V_TMP_USUARIO(1))||'.');

            V_SQL := 	'UPDATE '||V_ESQUEMA||'.USD_USUARIOS_DESPACHOS
                        SET BORRADO = 1,
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO] Se ha borrado la relación entre el despacho y el usuario '||TRIM(V_TMP_USUARIO(1))||'.');
