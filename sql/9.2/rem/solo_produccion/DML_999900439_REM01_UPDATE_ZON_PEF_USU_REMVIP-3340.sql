...
--## PRODUCTO=NO
--##
--## Finalidad: Borrado logico de usuarios en la ZON_PEF_USU
...
BEGIN	
    ...
    LOOP
		...
		IF V_EXISTE_USUARIO = 1 THEN
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO] Se va a aplicar el borrado lógico sobre la relación entre el perfil y el usuario '||TRIM(V_TMP_USUARIO(1))||'.');

            V_SQL := 	'UPDATE '||V_ESQUEMA||'.ZON_PEF_USU
                        SET BORRADO = 1,
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO] Se ha borrado la relación entre el perfil y el usuario '||TRIM(V_TMP_USUARIO(1))||'.');
