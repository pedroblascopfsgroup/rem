...
--## PRODUCTO=NO
--## 
--## Finalidad: asignar los expedientes en tramitación al trámite definición de oferta
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
  ...
  /*  V_MSQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE TABLE_NAME = '''||V_TABLA_REP||''' AND OWNER = '''||V_ESQUEMA||''' ';
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] APROVISIONANDO LA TABLA AUXILIAR '||V_TABLA||'...');
      ...
      EXECUTE IMMEDIATE '
            ...
            JOIN REM01.TAP_TAREA_PROCEDIMIENTO TAP ON TAP.TAP_CODIGO = ''T013_DefinicionOferta'' AND BORRADO = 0';
