    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN
            ...
            V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.ACT_HEP_HIST_EST_PUBLICACION (HEP_ID, ACT_ID, DD_EPU_ID, HEP_FECHA_DESDE, USUARIOCREAR, FECHACREAR) VALUES 
            ('||S_ACT_HEP_HIST_EST_PUBLICACION.NEXTVAL||', '''||TRIM(V_ACT_ID)||''', '||V_TEXT1||', '''||V_FECHA||''', ''HREOS-3214'', '''||SYSDATE||''')';
            EXECUTE IMMEDIATE V_MSQL;
            
        	
            DBMS_OUTPUT.PUT_LINE('ACTIVO '''||TRIM(V_TMP_TIPO_DATA(1))||''' INSERTADO EN EL HISTÓRICO');
