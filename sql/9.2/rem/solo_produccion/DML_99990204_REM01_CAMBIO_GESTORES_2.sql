...
DECLARE
    ...
    V_TRABAJO VARCHAR2 (50 CHAR) := 'HREOS-3482_backofr';
    V_USUARIO VARCHAR2 (50 CHAR) := 'usugrfbv';
    V_GESTOR VARCHAR2 (50 CHAR) := 'FVDBACKOFR';
...
BEGIN
    ...
    V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS T1
        USING (SELECT TAC.TAR_ID, TAC.TRA_ID, TAC.ACT_ID
            ...
            WHERE ACT.BORRADO = 0 AND TAP.TAP_CODIGO = ''T013_InstruccionesReserva'') T2
