...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'bmorales' ,'Beatriz ' ,'Morales '  ,'Vigil'  ,'bmorales@externos.haya.es'  , ''  ,'HAYACAL'  ,''  ,'REMCAL'),
	T_TIPO_DATA( 'malcalde' ,'Maria Isabel ' ,'Alcalde '  ,'Yuste'  ,'malcalde@haya.es'  , ''  ,'HAYACONSU'  ,'gl03'  ,''),
	T_TIPO_DATA( 'ygarciam ' ,'' ,''  ,''  ,''  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT'),
	T_TIPO_DATA( 'lclaret' ,'' ,''  ,''  ,''  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT'),
	T_TIPO_DATA( 'ejust' ,'' ,''  ,''  ,''  , ''  ,'SUPFVD'  ,''  ,'REMSUPFVD'),
	T_TIPO_DATA( '0892090J' ,'JESUS' ,'DE LAS HERAS'  ,'SANCHEZ'  ,'jesus@gutierrezlabrador.es'  , ''  ,'HAYAGESTFORM'  ,''  ,'REMGFORM'),
	T_TIPO_DATA( 'amonge' ,'Alfredo Leonardo ' ,'Monge '  ,'Jurado'  ,'amonge@haya.es'  , ''  ,'HAYAGESACT'  ,''  ,'REMACT'),
	T_TIPO_DATA( 'prodriguezg' ,'Patricia ' ,'Rodriguez '  ,'Guzman'  ,'prodriguezg@externos.haya.es'  , ''  ,'HAYAGESTFORM'  ,''  ,'REMGFORM'),
	T_TIPO_DATA( 'vrodriguezd' ,'Victor ' ,'Rodriguez '  ,'Diez'  ,'vrodriguezd@externos.haya.es'  , ''  ,'HAYAADM'  ,''  ,'HAYAADM'),
	T_TIPO_DATA( '47460135A' ,'ALFONSO ' ,'LABRADOR'  ,'PEREZ'  ,'a.labrador@gutierrezlabrador.es'  , ''  ,'HAYAGESTADMT'  ,''  ,'REMGIAADMT'),
	T_TIPO_DATA( '46738841N' ,'María del Mar ' ,'Cobo '  ,'Pérez'  ,'administracion@icobo.es// coordinacion@icobo.es'  , ''  ,'HAYAPROV'  ,''  ,'REMPROV'),
	T_TIPO_DATA( 'maranda' ,'Maria Elena ' ,'Aranda  '  ,'Cesar'  ,'maranda@haya.es '  , ''  ,'HAYAGESACT'  ,''  ,'REMACT')
