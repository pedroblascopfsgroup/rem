...
DECLARE
    ...
    V_TIPO_DATA_2 T_ARRAY_DATA_2 := T_ARRAY_DATA_2(
		...
		T_TIPO_DATA_2('2728098','24/10/2017','24/10/2018'),
		T_TIPO_DATA_2('4790139','05/10/2017','08/10/2018'),
		T_TIPO_DATA_2('7770503','27/12/2016','29/12/2017'),
		T_TIPO_DATA_2('7354816','27/11/2017','22/06/2018'),
		T_TIPO_DATA_2('8380326','04/07/2017','04/07/2018'),
		T_TIPO_DATA_2('7354320','22/05/2017','24/05/2018')
    ...
    FOR I IN V_TIPO_DATA_2.FIRST .. V_TIPO_DATA_2.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN		
        	...
        	--FECHA BAJA, FECHA INICIO VIGENCIA, FECHA FIN VIGENIA
			 ...
			 EXECUTE IMMEDIATE 'MERGE INTO '||V_ESQUEMA||'.ACT_PAC_PERIMETRO_ACTIVO PAC USING(
				...
				WHEN MATCHED THEN UPDATE
				  ...
				  PAC.USUARIOMODIFICAR=''HREOS-3419'',
			...
			when matched then update
			  ...
			  t1.usuariomodificar=''HREOS-3419'',
