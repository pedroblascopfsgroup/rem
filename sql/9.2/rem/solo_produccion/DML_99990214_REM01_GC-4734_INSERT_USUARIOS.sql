...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'dmercado' ,'Daniel ' ,'Mercado '  ,'Izquierdo'  ,'dmercado@haya.es'  , 'ZAZVRNSILD'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( 'avila' ,'Aranzazu ' ,'Vila '  ,'Sanchis'  ,'avila@externos.haya.es'  , 'MKHCKRJMYP'  ,'HAYAGESTPREC'  ,''  ,'REMGPREC'),
		T_TIPO_DATA( 'avila' ,'Aranzazu ' ,'Vila '  ,'Sanchis'  ,'avila@externos.haya.es'  , ''  ,'HAYAGESTPUBL'  ,''  ,'REMGPUBL')
