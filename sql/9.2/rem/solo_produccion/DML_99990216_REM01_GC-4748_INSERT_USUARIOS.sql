...
--## INCIDENCIA_LINK=REMNIVDOS-3323
--## PRODUCTO=NO
--## 
--## Finalidad:
--##			
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '47021586H' ,'Borja ' ,'Garcia '  ,'Pallares'  ,'borja.garcia@nfq.es'  , 'CCRPYIJASW'  ,'HAYACONSU'  ,' '  ,''),
		T_TIPO_DATA( '50892090J' ,'Jesús ' ,'de las Heras '  ,'Sánchez'  ,'jesus@gutierrezlabrador.es '  , 'IHPAQXVHTS'  ,'HAYAGESTFORM'  ,'gl03'  ,'REMGFORM'),
		T_TIPO_DATA( '47460855X' ,'Alejandro ' ,'Elvira '  ,'De la Paz'  ,'alex@gutierrezlabrador.es'  , 'WICPGUASWY'  ,'HAYAGESTFORM'  ,'gl03'  ,'REMGFORM'),
		T_TIPO_DATA( 'tdiez' ,'Teresa ' ,'Diez '  ,'Cano'  ,'tdiez@externos.haya.es'  , 'DIXCDBIENR'  ,'SUPFVD'  ,'usugrrfv'  ,'REMSUPFVD'),
		T_TIPO_DATA( 'mantequera' ,'' ,''  ,''  ,''  , 'MPQWSHGASB'  ,'SUPFVD'  ,'usugrrfv'  ,'REMSUPFVD')
