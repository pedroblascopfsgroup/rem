...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'mescribano' ,'Maria Carmen ' ,'Escribano '  ,'Agraz'  ,'mescribano@externos.haya.es'  , 'XJIQFHFFYE'  ,'HAYAGESACT'  ,''  ,'REMACT'),
	T_TIPO_DATA( 'B24634198' ,'AGEMA INGENIERIA Y SERVICIOS' ,''  ,''  ,'rafael.pareja@grupoagema.com'  , 'SYMWSARJKV'  ,'HAYAPROV'  ,''  ,'REMPROV')
