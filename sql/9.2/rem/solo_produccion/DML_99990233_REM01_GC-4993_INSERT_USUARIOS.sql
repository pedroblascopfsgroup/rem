...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'A164780' ,'Sixto' ,'Flores'  ,'Llovera'  ,'sflores@haya.es'  , 'YMSEVJHBLQ'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( 'A142339' ,'Jesus' ,'Cook'  ,'Aroca'  ,'jcook@haya.es'  , 'GLPJRINPST'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'A142339' ,'' ,''  ,''  ,'jcook@haya.es'  , ''  ,'FVDBACKOFERTA'  ,''  ,''),
		T_TIPO_DATA( 'A142339' ,'' ,''  ,''  ,'jcook@haya.es'  , ''  ,'SUPFVD'  ,''  ,'REMSUPFVD'),
		T_TIPO_DATA( 'A142339' ,'' ,''  ,''  ,'jcook@haya.es'  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT'),
		T_TIPO_DATA( 'A186832' ,'Marta' ,'Antequera'  ,'Marcos'  ,'mantequera@haya.es'  , 'NUSPFQUFUO'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'A186832' ,'' ,''  ,''  ,'mantequera@haya.es'  , ''  ,'FVDBACKOFERTA'  ,''  ,''),
		T_TIPO_DATA( 'A186832' ,'' ,''  ,''  ,'mantequera@haya.es'  , ''  ,'SUPFVD'  ,''  ,'REMSUPFVD'),
		T_TIPO_DATA( 'A186832' ,'' ,''  ,''  ,'mantequera@haya.es'  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT'),
		T_TIPO_DATA( 'A164772' ,'Maria Jose' ,'Bondia'  ,'Garcia'  ,'mjbondia@haya.es'  , 'CKMQJXRUBP'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'A164772' ,'' ,''  ,''  ,'mjbondia@haya.es'  , ''  ,'FVDBACKOFERTA'  ,''  ,''),
		T_TIPO_DATA( 'A164772' ,'' ,''  ,''  ,'mjbondia@haya.es'  , ''  ,'SUPFVD'  ,''  ,'REMSUPFVD'),
		T_TIPO_DATA( 'A164772' ,'' ,''  ,''  ,'mjbondia@haya.es'  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT'),
		T_TIPO_DATA( 'A147782' ,'Daniel' ,'Tacero'  ,'Rico'  ,'dtacero@haya.es'  , 'RIEUHCASIN'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
		T_TIPO_DATA( 'A147782' ,'' ,''  ,''  ,'dtacero@haya.es'  , ''  ,'FVDBACKOFERTA'  ,''  ,''),
		T_TIPO_DATA( 'A147782' ,'' ,''  ,''  ,'dtacero@haya.es'  , ''  ,'SUPFVD'  ,''  ,'REMSUPFVD'),
		T_TIPO_DATA( 'A147782' ,'' ,''  ,''  ,'dtacero@haya.es'  , ''  ,'FVDBACKVENTA'  ,''  ,'REMFVDBACKVNT')
