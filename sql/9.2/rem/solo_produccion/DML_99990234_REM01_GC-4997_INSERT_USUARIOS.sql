...
--## INCIDENCIA_LINK=REMNIVDOS-3770
--## PRODUCTO=NO
--## 
...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'jcook' ,'' ,''  ,''  ,''  , 'XCWIVJXYIR'  ,'FVDBACKOFERTA'  ,'usugrfbo'  ,''),
		T_TIPO_DATA( 'mantequera' ,'' ,''  ,''  ,''  , 'LJCPXLVTBH'  ,'FVDBACKOFERTA'  ,'usugrfbo'  ,''),
		T_TIPO_DATA( 'dtacero' ,'' ,''  ,''  ,''  , 'CNIVOFJMKW'  ,'FVDBACKOFERTA'  ,'usugrfbo'  ,''),
		T_TIPO_DATA( 'mjbondia' ,'' ,''  ,''  ,''  , 'QRNUODLRBV'  ,'FVDBACKOFERTA'  ,'usugrfbo'  ,''),
		T_TIPO_DATA( '08941915K' ,'Julian ' ,'Martin '  ,'Maqueda'  ,'julianmartin@bcc.es'  , 'DNNUWCALFN'  ,'HAYACONSU'  ,''  ,'REMACT'),
		T_TIPO_DATA( '05284288S' ,'Juan Adolfo ' ,'Lopez '  ,'Rodrigo'  ,'juanadolfo_lopez@tecnologia.cajamar.es'  , 'EGHFDMIFVG'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '22574956L' ,'Maria Amparo ' ,'Carrascosa '  ,'Ferrer'  ,'amparocarrascosa@bcc.es'  , 'GNQVLZNOHY'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '52631995Z' ,'Carmen ' ,'Company '  ,'Per'  ,'ccompany@bcc.es'  , 'HYGPBZQIGU'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '46950664M' ,'Vicent ' ,'Escandell '  ,'Ferrer'  ,'vescandell@bcc.es'  , 'SOTRBTEWAJ'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( '18221665F' ,'Bartomeu ' ,'Bassa'  ,''  ,'bartomeubassa@bcc.es'  , 'KRFSRONAID'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'rlorenzo' ,'Roberto ' ,'Lorenzo '  ,'Extremadouro'  ,'rlorenzo@haya.es'  , 'BHJMCGGXNJ'  ,'HAYAGESACT'  ,'usugruhpm'  ,'REMACT'),
		T_TIPO_DATA( 'iplaza' ,'Irene ' ,'Plaza '  ,'Sierra'  ,'iplaza@haya.es'  , 'HBUOYHGVSL'  ,'HAYAGESACT'  ,'usugruhpm'  ,'REMACT'),
		T_TIPO_DATA( 'bcarrasco' ,'Beatriz ' ,'Carrasco '  ,'del Peso'  ,'bcarrasco@externos.haya.es'  , 'JXFMQZNUQJ'  ,'HAYAGESACT'  ,'usugruhpm'  ,'REMACT'),
		T_TIPO_DATA( 'ppapadatps' ,'Penñelope' ,'Espinal'  ,'Papadatos'  ,'ppapadatos@externos.haya.es'  , 'DRQQHVUZPP'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'ymorenoc' ,'Yeison Andrés' ,'Moreno'  ,'Córdoba'  ,'ymorenoc@externos.haya.es'  , 'CMYUYIZMNK'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'eespinal' ,'Elias' ,'Espinal'  ,'Bella'  ,'eespinal@externos.haya.es'  , 'AWYNQSHXGT'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'brodriguez' ,'Belén' ,'Rodríguez'  ,'Basalo'  ,'brodriguez@externos.haya.es'  , 'QJPEZOXPON'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'norviz' ,'Noelia' ,'Orviz'  ,'Suarez'  ,'norviz@externos.haya.es'  , 'XJIQFHFFYE'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'lceballos' ,'Leticia' ,'Ceballos'  ,'López'  ,'lceballos@externos.haya.es'  , 'JOQOXTJXNN'  ,'HAYACONSU'  ,''  ,''),
		T_TIPO_DATA( 'A142651' ,'Francisco Javier ' ,'Caballero '  ,'Rodriguez'  ,'fcaballero@bankia.com'  , 'PLJFTCBWJN'  ,'PERFGCCBANKIA'  ,''  ,'REMGCCBANKIA'),
		T_TIPO_DATA( 'A117521' ,'Raquel' ,'Sanchez'  ,'Acedo'  ,'rsancheza@bankia.com'  , 'VWWVBGEDSP'  ,'PERFGCCBANKIA'  ,''  ,'REMGCCBANKIA'),
		T_TIPO_DATA( 'A110141' ,'Alfredo' ,'Ortas'  ,'Herrero'  ,'aortas@bankia.com'  , 'WQLXIODZBN'  ,'PERFGCCBANKIA'  ,''  ,'REMGCCBANKIA'),
		T_TIPO_DATA( 'aalvear' ,'Alberto Carlos ' ,'Alvear '  ,'Aragon'  ,'aalvear@haya.es'  , 'VSWJPCRUTM'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( 'asantos' ,'Alvaro ' ,'Santos '  ,'del Valle'  ,'asantos@haya.es'  , 'WPRWILCYVX'  ,'HAYAGESACT'  ,''  ,'REMACT'),
		T_TIPO_DATA( '34258621Y' ,'Pilar ' ,'Rey '  ,'Salgueiro'  ,'administración@psagroup.es'  , 'MVIPLHTCZO'  ,'HAYAPROV'  ,''  ,'REMPROV')
