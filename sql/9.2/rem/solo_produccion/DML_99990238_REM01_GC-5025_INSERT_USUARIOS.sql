...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'saragon' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPREC'  ,''  ,'REMGPREC'),
	T_TIPO_DATA( 'saragon' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,''  ,'REMGPUBL'),
	T_TIPO_DATA( 'ndelaossa' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPREC'  ,''  ,'REMGPREC'),
	T_TIPO_DATA( 'ndelaossa' ,'' ,''  ,''  ,''  , ''  ,'HAYAGESTPUBL'  ,''  ,'REMGPUBL')
