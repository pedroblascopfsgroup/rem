...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'jnombela' ,'Judith ' ,'Nombela '  ,'Martin'  ,'jnombela@haya.es'  , 'CNIVOFJMKW'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'mgonzalezm' ,'Maria Angeles ' ,'Gonzalez '  ,'Martin'  ,'mgonzalezm@haya.es'  , 'QRNUODLRBV'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'mzorrilla' ,'Manuel ' ,'Zorrilla '  ,'Hernandez'  ,'mzorrilla@haya.es'  , 'DNNUWCALFN'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'agonzalezm' ,'Alejandro ' ,'Gonzalez '  ,'Martinez'  ,'agonzalezm@haya.es'  , 'EGHFDMIFVG'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'jdiazf' ,'Javier ' ,'Diaz '  ,'Fernandez'  ,'jdiazf@haya.es'  , 'GNQVLZNOHY'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'agonzalezc' ,'Adrian ' ,'Gonzalez '  ,'Cueva'  ,'agonzalezc@haya.es'  , 'HYGPBZQIGU'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'rsen' ,'Ron ' ,'Sen'  ,''  ,'rsen@haya.es'  , 'SOTRBTEWAJ'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'jjeong' ,'Jae ' ,'Jeong'  ,''  ,'jjeong@haya.es'  , 'KRFSRONAID'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'aelespuru' ,'Arantzazu ' ,'Elespuru '  ,'Sanchez-Sabogal'  ,'aelespuru@haya.es'  , 'BHJMCGGXNJ'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'desteban' ,'Diego ' ,'Esteban '  ,'Del Val'  ,'desteban@haya.es'  , 'HBUOYHGVSL'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'jcrespillo' ,'Juan Alberto ' ,'Crespillo '  ,'Guardeño'  ,'jcrespillo@haya.es'  , 'JXFMQZNUQJ'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'rmanau' ,'Ruben ' ,'Manau '  ,'Fandos'  ,'rmanau@haya.es'  , 'DRQQHVUZPP'  ,'HAYACONSU'  ,''  ,''),
	T_TIPO_DATA( 'omora' ,'' ,''  ,''  ,''  , 'CMYUYIZMNK'  ,'HAYAGBOINM'  ,''  ,'')
