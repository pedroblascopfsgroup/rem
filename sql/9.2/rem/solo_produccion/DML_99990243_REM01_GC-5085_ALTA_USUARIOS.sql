...
T_TIPO_DATA( 'idomingo' ,' ' ,' '  ,' '  ,''  , ''  ,'HAYAGESACT'  ,'usugruhpm'  ,'REMACT'),
T_TIPO_DATA( 'valfonso' ,'Victor ' ,'Alfonso '  ,'Campiña'  ,'valfonso@externos.haya.es'  , ''  ,'HAYAGESACT'  ,'usugruhpm'  ,'REMACT'),
T_TIPO_DATA( 'omora' ,'' ,''  ,''  ,''  , ''  ,'HAYAGBOINM'  ,'usugrubac'  ,''),
T_TIPO_DATA( '46616519G' ,'Montserrat' ,'Cañado '  ,'Julve'  ,'seguiment@icobo.es'  , ''  ,'HAYAPROV'  ,''  ,'REMPROV')
