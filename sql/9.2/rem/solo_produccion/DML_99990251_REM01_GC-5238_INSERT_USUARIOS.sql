...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	...
	T_TIPO_DATA( 'mdaza' ,'Maria Angeles ' ,'Daza '  ,'Garcia'  ,'mdaza@externos.haya.es'  , 'FNFQNNKAKX'  ,'HAYAGESTCOM'  ,''  ,'REMGCOM'),
T_TIPO_DATA( '53463773C' ,'Esmeralda ' ,'García'  ,'García'  ,'info@legazpiserviciosgenerales.com'  , 'NDNVZGQQDF'  ,'HAYAPROV'  ,''  ,'REMPROV'),
T_TIPO_DATA( '02282113F' ,'Noelia' ,'Sánchez'  ,'Martín'  ,'info@legazpiserviciosgenerales.com'  , 'YPUXLUDPFD'  ,'HAYAPROV'  ,''  ,'REMPROV'),
T_TIPO_DATA( '11854581J' ,'Hugo' ,'Legazpi'  ,'Durban'  ,'info@legazpiserviciosgenerales.com'  , 'YEZKMERTKW'  ,'HAYAPROV'  ,''  ,'REMPROV'),
T_TIPO_DATA( 'obolanos' ,'Olga Maribel' ,'Bolaños'  ,'Dominguez'  ,'obolanos@externos.haya.es'  , 'MBLSJUFVKO'  ,'HAYACONSU'  ,''  ,''),
T_TIPO_DATA( 'egonzalezvi' ,'Elena' ,'Gonzalez'  ,'Vivas'  ,'egonzalezvi@externos.haya.es'  , 'DAUNYQHJGS'  ,'HAYACONSU'  ,''  ,''),
T_TIPO_DATA( 'lescribano' ,'Laura ' ,'Escribano '  ,'Marquez'  ,'lescribano@externos.haya.es'  , 'QIFKHZHEOJ'  ,'HAYACONSU'  ,''  ,''),
T_TIPO_DATA( 'augia' ,'Alberto ' ,'Ugia '  ,'Ruiz'  ,'augia@externos.haya.es'  , 'CCRPYIJASW'  ,'HAYACONSU'  ,''  ,''),
T_TIPO_DATA( 'vroldan' ,'Virgilio ' ,'Roldan '  ,'Encina'  ,'vroldan@externos.haya.es'  , 'IHPAQXVHTS'  ,'HAYACONSU'  ,''  ,'')
