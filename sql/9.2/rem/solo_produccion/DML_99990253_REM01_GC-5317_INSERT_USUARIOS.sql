...
DECLARE
  ...
  V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '53418977M' ,'ELENA' ,'FERNÁNDEZ'  ,'MARTÍNEZ'  ,'info@instalacionesrbs.com'  , 'HCFTALFPTD'  ,'HAYAPROV'  ,'B87722229'  ,'REMPROV'),
		T_TIPO_DATA( 'cberenguel' ,'Clara Maria' ,'Berenguel'  ,'Arnedo'  ,'cberenguel@haya.es'  , 'XTJUMSIUDP'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'mcastillol' ,'Maria del Mar' ,'Castillo'  ,'Lopez'  ,'mcastillol@haya.es'  , 'BPHOZJSOOG'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'emartinezr' ,'Eloisa' ,'Martinez'  ,'Romero'  ,'emartinezr@haya.es'  , 'HVFWNMKNVQ'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'fgomez' ,'Filomena' ,'Gomez'  ,'Martinez'  ,'fgomez@externos.haya.es'  , 'DOIHVGMUXA'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'mgimenez' ,'Carmen' ,'Gimenez'  ,'Asis'  ,'mgimenez@haya.es'  , 'WEFFPDTEKS'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'vmaldonado' ,'Veronica' ,'Maldonado'  ,'Vargas'  ,'vmaldonado@haya.es'  , 'JLYMRLFUHH'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'mcanton' ,'' ,''  ,''  ,''  , 'IMJLXWWUJX'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'biglesias' ,'' ,''  ,''  ,''  , 'JPTTLXYYBY'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'ctorres' ,'' ,''  ,''  ,''  , 'FTYUCUANCC'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'esantorcuato' ,'' ,''  ,''  ,''  , 'OVGHLUABAY'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'etorres' ,'' ,''  ,''  ,''  , 'JEHMJIGPLS'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'vcastillo' ,'' ,''  ,''  ,''  , 'AGHRRHOAOM'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'mblat' ,'' ,''  ,''  ,''  , 'ODXWGZUTAH'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM'),
		T_TIPO_DATA( 'sortiz' ,'' ,''  ,''  ,''  , 'MYAQOWJDIY'  ,'HAYAADM'  ,'usugrupad'  ,'HAYAADM')
