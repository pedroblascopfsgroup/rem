...
--## FECHA_CREACION=2018013
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=2.0.15
--## INCIDENCIA_LINK=REMNIVUNO-465
--## PRODUCTO=NO
--## 
...
DECLARE
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( '50321160N' ,'FATIMA' ,'VILLADONIGA'  ,'DIEZ'  ,'FVILLADONIGA@aciertaasistencia.es'  , 'FVJYOEMZWS'  ,'HAYAPROV'  ,''  ,0 ,'REMPROV' ,'REMNIVUNO-465'),
		T_TIPO_DATA( 'ebachiller' ,'ESTHER' ,'BACHILLER'  ,'CORREGIDOR'  ,'ebachiller@externos.haya.es'  , 'NHIBRQPYIC'  ,'HAYACONSU'  ,''  ,0 ,'' ,'REMNIVUNO-465'),
		T_TIPO_DATA( 'rvicente' ,'ROSALIA' ,'VICENTE'  ,'LOPEZ'  ,'rvicente@externos.haya.es'  , 'PJJYIIJJVE'  ,'HAYACONSU'  ,''  ,0 ,'' ,'REMNIVUNO-465')
...
BEGIN	
    ...
    LOOP
        ...
        ELSE 
			...
			END IF;
				DBMS_OUTPUT.PUT_LINE('[INFO]: UPDATE EMAIL DEL USUARIO '||VV_USERNAME);
				EXECUTE IMMEDIATE UPD_USU_EMAIL USING VV_EMAIL,V_USU_ID;		
		END IF;
