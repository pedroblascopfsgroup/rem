...
DECLARE
	...
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA( 'gmurcia' ,'Guillermo' ,'Murcia'  ,'Verdu'  ,'gmurcia@externos.haya.es'  , 'OIZBESVXXE'  ,'HAYAGESACT'  ,''  ,0 ,'REMACT' ,'REMNIVUNO-472'),
		T_TIPO_DATA( 'asorianol' ,'Ana' ,'Soriano'  ,'Lorente'  ,'asorianol@externos.haya.es'  , 'HEAKOATUNF'  ,'HAYAGESTPUBL'  ,'usugrupub'  ,0 ,'REMGPUBL' ,'REMNIVUNO-472'),
		T_TIPO_DATA( 'ecasis' ,'Eva María' ,'Casis'  ,'García'  ,'ecasis@haya.es'  , 'ZIAQUURVNF'  ,'HAYAGESTPUBL'  ,'usugrupub'  ,0 ,'REMGPUBL' ,'REMNIVUNO-472')
