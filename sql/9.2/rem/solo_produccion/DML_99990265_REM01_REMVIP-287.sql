...
BEGIN
	...
	/*
Eliminar el expediente 88456 vinculado al activo 6815053 por cañonazo
*/
...
USING (SELECT DISTINCT TAR.TAR_ID
    ...
    WHERE ECO.ECO_NUM_EXPEDIENTE = 88456) T2
ON (T1.TAR_ID = T2.TAR_ID)
WHEN MATCHED THEN UPDATE SET
    T1.TAR_TAREA_FINALIZADA = 1, T1.TAR_FECHA_FIN = SYSDATE, T1.BORRADO = 1
    , T1.USUARIOMODIFICAR = 'REMVIP-287', T1.FECHAMODIFICAR = SYSDATE;--DD_EOF_ID (02, ANULADA)
...
WHEN MATCHED THEN UPDATE SET
    ...
    , T1.USUARIOMODIFICAR = 'REMVIP-287', T1.FECHAMODIFICAR = SYSDATE;
...
SET
  ACT.DD_SCM_ID = (SELECT SCM.DD_SCM_ID FROM DD_SCM_SITUACION_COMERCIAL SCM WHERE SCM.DD_SCM_CODIGO = '03'),
  ACT.USUARIOMODIFICAR = 'REMVIP-287',
  ACT.FECHAMODIFICAR = SYSDATE
WHERE ACT.DD_SCM_ID = (SELECT SCM.DD_SCM_ID FROM DD_SCM_SITUACION_COMERCIAL SCM WHERE SCM.DD_SCM_CODIGO = '05')
AND ACT.ACT_NUM_ACTIVO = 6815053;
