...
DECLARE
  ...
  V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-436';
...
BEGIN
	...
	V_REGISTROS := 'MERGE INTO '||V_ESQUEMA||'.'||V_TABLA||' T1
	    USING (SELECT BIE_ID 
	      ...
	      WHERE ACT_NUM_ACTIVO IN (150394, 140838, 158260, 78574, 149861, 177706, 149853, 177565, 158941, 146708, 146707, 158589)) T2
