...
DECLARE
	...
	T_TIPO_DATA( 'B98493190' ,'' ,''  ,''  ,'luis@integraval.es'  , ''  ,'HAYAPROV'  ,''  ,0 ,'REMPTEC' ,'CONF_CENTRAL_TECNICA'),
	T_TIPO_DATA( 'A28346054' ,'' ,''  ,''  ,'ggonzalez2@caser.es'  , ''  ,'HAYAPROV'  ,''  ,0 ,'REMPTEC' ,'CONF_CENTRAL_TECNICA'),
	T_TIPO_DATA( 'B85884336' ,'' ,''  ,''  ,'hugo_legazpi@legazpiserviciosgenerales.com'  , ''  ,'HAYAPROV'  ,''  ,0 ,'REMPTEC' ,'CONF_CENTRAL_TECNICA'),
	T_TIPO_DATA( '78472108H' ,'' ,''  ,''  ,'reformas.sg@hotmail.com'  , ''  ,'HAYAPROV'  ,''  ,0 ,'REMPTEC' ,'CONF_CENTRAL_TECNICA'),
	T_TIPO_DATA( 'B85343721' ,'' ,''  ,''  ,'pperez@brickoclock.es'  , ''  ,'HAYAPROV'  ,''  ,0 ,'REMPTEC' ,'CONF_CENTRAL_TECNICA')
