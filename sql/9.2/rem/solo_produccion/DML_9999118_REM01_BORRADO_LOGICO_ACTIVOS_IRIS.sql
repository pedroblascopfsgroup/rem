...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-???';
	V_BORRADO_FISICO VARCHAR2(2 CHAR) := 'NO';--SI o NO, no vale ningún otro valor ni minúsculas, ni acentos.
...
BEGIN
	...
	V_REGISTROS := 'MERGE INTO '||V_ESQUEMA||'.'||V_TABLA||' T1
	    USING (SELECT BIE_ID 
	      ...
	      WHERE ACT_NUM_ACTIVO IN (152198, 152214, 152255, 152257, 152261)) T2
