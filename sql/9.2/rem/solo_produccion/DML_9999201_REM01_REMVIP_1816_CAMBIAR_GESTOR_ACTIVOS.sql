...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('  [INFO] '||SQL%ROWCOUNT||' Insertamos en la AUX_SFORM_REMVIP_1816 ');
	...
	V_SQL := 'MERGE INTO '||V_ESQUEMA||'.GEE_GESTOR_ENTIDAD T1
				USING (WITH ECO AS (SELECT ECO.ACT as ECO_ID
				        ...
				        WHERE NOT EXISTS (SELECT 1 FROM GCO_GESTOR_ADD_ECO GCO
				            ...
				            WHERE GCO.ECO_ID = ECO.ACT))--31997 ECO LES FALTA ALGUN REGISTRO EN GEE, GEH, GCO o GCH PARA USUARIO SFORM Y EXISTE SFORM EN LA TABLA ACT_GES_DIST_GESTORES
	...
	DBMS_OUTPUT.PUT_LINE('  [INFO] '||SQL%ROWCOUNT||' Merge en la en GEE_GESTOR_ENTIDAD ');
	...
	DBMS_OUTPUT.PUT_LINE('  [INFO] '||SQL%ROWCOUNT||' Insertamos en la GCO_GESTOR_ADD_ECO ');
	...
	V_SQL := 'INSERT INTO '||V_ESQUEMA||'.GEH_GESTOR_ENTIDAD_HIST (GEH_ID,USU_ID,DD_TGE_ID,GEH_FECHA_DESDE
				...
				INSERT INTO GCH_GESTOR_ECO_HISTORICO (GEH_ID, ECO_ID)
	...
	DBMS_OUTPUT.PUT_LINE('  [INFO] '||SQL%ROWCOUNT||' Insertamos en la GEH_GESTOR_ENTIDAD_HIST ');
	...
	DBMS_OUTPUT.PUT_LINE('  [INFO] '||SQL%ROWCOUNT||' Merge en la GEH_GESTOR_ENTIDAD_HIST ');
