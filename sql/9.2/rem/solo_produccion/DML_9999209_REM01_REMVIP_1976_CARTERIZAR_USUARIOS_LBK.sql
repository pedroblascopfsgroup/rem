...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        T_FUNCION('assista.acortes','Liberbank'),
	T_FUNCION('assista.jasensi','Liberbank'),
	T_FUNCION('assista.ndahoui','Liberbank'),
	T_FUNCION('assista.sjuan','Liberbank')
    ); 
