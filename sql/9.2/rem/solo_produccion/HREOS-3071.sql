...
EXEC OPERACION_DDL.DDL_TABLE('ANALYZE','GPV_GASTOS_PROVEEDOR');
...
EXEC OPERACION_DDL.DDL_TABLE('ANALYZE','MIG_AUX_ACT_PVE_PROVEEDOR');
EXEC OPERACION_DDL.DDL_TABLE('ANALYZE','MIG2_GDE_GASTOS_DET_ECONOMICO');
EXEC OPERACION_DDL.DDL_TABLE('ANALYZE','MIG2_GPV_GASTOS_PROVEEDORES');
