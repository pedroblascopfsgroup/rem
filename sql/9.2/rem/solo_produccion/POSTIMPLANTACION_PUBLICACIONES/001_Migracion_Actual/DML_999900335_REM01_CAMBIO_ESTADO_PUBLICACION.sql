...
--## VERSIONES:
--##        0.1 Versión inicial 
--##		0.2 Modificaciones del SP_CAMBIO_ESTADO_PUBLICACION
--##########################################
--*/
...
DECLARE
    ...
    nACT_ID           REM01.AUX_CAMBIO_ESTADO_PUBLI.ACT_ID%TYPE;
    vDD_TCO_CODIGO    REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_TCO_CODIGO%TYPE;
    vCODIGO_ESTADO_A  REM01.AUX_CAMBIO_ESTADO_PUBLI.CODIGO_ESTADO_A%TYPE;
    vDESC_ESTADO_A    REM01.AUX_CAMBIO_ESTADO_PUBLI.DESC_ESTADO_A%TYPE;
    vCHECK_PUBLICAR_A REM01.AUX_CAMBIO_ESTADO_PUBLI.CHECK_PUBLICAR_A%TYPE;
    vCHECK_OCULTAR_A  REM01.AUX_CAMBIO_ESTADO_PUBLI.CHECK_OCULTAR_A%TYPE;
    vDD_MTO_CODIGO_A  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_MTO_CODIGO_A%TYPE;    
    vDD_MTO_MANUAL_A  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_MTO_MANUAL_A%TYPE; 
    vCODIGO_ESTADO_V  REM01.AUX_CAMBIO_ESTADO_PUBLI.CODIGO_ESTADO_V%TYPE;
    vDESC_ESTADO_V    REM01.AUX_CAMBIO_ESTADO_PUBLI.DESC_ESTADO_V%TYPE;
    vCHECK_PUBLICAR_V REM01.AUX_CAMBIO_ESTADO_PUBLI.CHECK_PUBLICAR_V%TYPE;
    vCHECK_OCULTAR_V  REM01.AUX_CAMBIO_ESTADO_PUBLI.CHECK_OCULTAR_V%TYPE;
    vDD_MTO_CODIGO_V  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_MTO_CODIGO_V%TYPE;
    vDD_MTO_MANUAL_V  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_MTO_MANUAL_V%TYPE; 
    vDD_TPU_CODIGO_A  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_TPU_CODIGO_A%TYPE;
    vDD_TPU_CODIGO_V  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_TPU_CODIGO_V%TYPE;
    vDD_TAL_CODIGO	  REM01.AUX_CAMBIO_ESTADO_PUBLI.DD_TAL_CODIGO%TYPE;	
    nADMISION         REM01.AUX_CAMBIO_ESTADO_PUBLI.ADMISION%TYPE;
    nGESTION          REM01.AUX_CAMBIO_ESTADO_PUBLI.GESTION%TYPE;
    nINFORME_COMERCIAL REM01.AUX_CAMBIO_ESTADO_PUBLI.INFORME_COMERCIAL%TYPE;
    nPRECIO_A         REM01.AUX_CAMBIO_ESTADO_PUBLI.PRECIO_A%TYPE;
    nPRECIO_V         REM01.AUX_CAMBIO_ESTADO_PUBLI.PRECIO_V%TYPE;
    nCEE_VIGENTE      REM01.AUX_CAMBIO_ESTADO_PUBLI.CEE_VIGENTE%TYPE;
    nADECUADO         REM01.AUX_CAMBIO_ESTADO_PUBLI.ADECUADO%TYPE;
    nES_CONDICONADO   REM01.AUX_CAMBIO_ESTADO_PUBLI.ES_CONDICONADO%TYPE;
  ...
  BEGIN
	IF pTIPO = 'A' THEN
		IF pDD_TCO_CODIGO IN ('02','03','04') THEN
		  ...
		  IF pDD_MTO_CODIGO = '06' THEN /*Revisión Publicación*/
		    vACTUALIZAR_COND := 'N';
		    REM01.SP_CREAR_AVISO (nACT_ID, 'GPUBL', pUSUARIOMODIFICAR, 'Se ha situado en Oculto Alquiler con motivo Revisión Publicación el activo: ', 0);
	...
	IF pTIPO = 'V' THEN
      ...
      V_MSQL:='UPDATE '|| V_ESQUEMA ||'.ACT_PAC_PERIMETRO_ACTIVO ACT '||
		...
		IF pDD_MTO_CODIGO = '06' THEN /*Revisión Publicación*/
		  vACTUALIZAR_COND := 'N';
		  REM01.SP_CREAR_AVISO (nACT_ID, 'GPUBL', pUSUARIOMODIFICAR, 'Se ha situado en Oculto Venta con motivo Revisión Publicación el activo: ', 0);
		END IF; 		
      ...
      LOOP
        ...
        IF vDD_TCO_CODIGO IN ('02','03','04') THEN
          IF (vCODIGO_ESTADO_A = '03' AND vCHECK_PUBLICAR_A = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_A (nACT_ID, 'A', OutOCULTAR, OutMOTIVO);
        ...
        IF vDD_TCO_CODIGO IN ('01','02') THEN
          IF (vCODIGO_ESTADO_V = '03' AND vCHECK_PUBLICAR_V = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_V (nACT_ID, 'V', OutOCULTAR, OutMOTIVO);
