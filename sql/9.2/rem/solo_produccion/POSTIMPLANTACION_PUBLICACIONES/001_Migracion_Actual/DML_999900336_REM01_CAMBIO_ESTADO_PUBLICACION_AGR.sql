...
--## VERSIONES:
--##        0.1 Versión inicial 
--##		0.2 Modificado el SP_CAMBIO_EST_PUB_AGR
--##########################################
--*/
...
declare
    ...
    nAGR_ID           REM01.V_CAMBIO_ESTADO_PUBLI_AGR.AGR_ID%TYPE;
    vDD_TCO_CODIGO    REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_TCO_CODIGO%TYPE;
    vCODIGO_ESTADO_A  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CODIGO_ESTADO_A%TYPE;
    vDESC_ESTADO_A    REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DESC_ESTADO_A%TYPE;
    vCHECK_PUBLICAR_A REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CHECK_PUBLICAR_A%TYPE;
    vCHECK_OCULTAR_A  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CHECK_OCULTAR_A%TYPE;
    vDD_MTO_CODIGO_A  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_MTO_CODIGO_A%TYPE;
    vDD_MTO_MANUAL_A  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_MTO_MANUAL_A%TYPE;
    vCODIGO_ESTADO_V  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CODIGO_ESTADO_V%TYPE;
    vDESC_ESTADO_V    REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DESC_ESTADO_V%TYPE;
    vCHECK_PUBLICAR_V REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CHECK_PUBLICAR_V%TYPE;
    vCHECK_OCULTAR_V  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CHECK_OCULTAR_V%TYPE;
    vDD_MTO_CODIGO_V  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_MTO_CODIGO_V%TYPE;
    vDD_MTO_MANUAL_V  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_MTO_MANUAL_V%TYPE;
    vDD_TPU_CODIGO_A  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_TPU_CODIGO_A%TYPE;
    vDD_TPU_CODIGO_V  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_TPU_CODIGO_V%TYPE;
    vDD_TAL_CODIGO	  REM01.V_CAMBIO_ESTADO_PUBLI_AGR.DD_TAL_CODIGO%TYPE;
    nADMISION         REM01.V_CAMBIO_ESTADO_PUBLI_AGR.ADMISION%TYPE;
    nGESTION          REM01.V_CAMBIO_ESTADO_PUBLI_AGR.GESTION%TYPE;
    nINFORME_COMERCIAL REM01.V_CAMBIO_ESTADO_PUBLI_AGR.INFORME_COMERCIAL%TYPE;
    nPRECIO_A         REM01.V_CAMBIO_ESTADO_PUBLI_AGR.PRECIO_A%TYPE;
    nPRECIO_V         REM01.V_CAMBIO_ESTADO_PUBLI_AGR.PRECIO_V%TYPE;
    nCEE_VIGENTE      REM01.V_CAMBIO_ESTADO_PUBLI_AGR.CEE_VIGENTE%TYPE;
    nADECUADO         REM01.V_CAMBIO_ESTADO_PUBLI_AGR.ADECUADO%TYPE;
      ...
      LOOP
        ...
        IF vDD_TCO_CODIGO IN ('02','03','04') THEN
          IF (vCODIGO_ESTADO_A = '03' AND vCHECK_PUBLICAR_A = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_a_AGR (nAGR_ID, 'A', OutOCULTAR, OutMOTIVO);
        ...
        IF vDD_TCO_CODIGO IN ('01','02') THEN
          IF (vCODIGO_ESTADO_V = '03' AND vCHECK_PUBLICAR_V = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_v_AGR (nAGR_ID, 'V', OutOCULTAR, OutMOTIVO);
