...
BEGIN	
	...
	EXECUTE IMMEDIATE '
	INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (OCULTO, DD_MTO_CODIGO, AHP_ID) (
	SELECT OCULTO, DD_MTO_CODIGO, AHP_ID
              FROM (
                  SELECT OCULTO, DD_MTO_CODIGO, AHP_ID, ROW_NUMBER () OVER (PARTITION BY AHP_ID ORDER BY ORDEN ASC) ROWNUMBER
                    FROM(
                          SELECT APU.AHP_ID
                               ...
                               , MTO.DD_MTO_ORDEN ORDEN
                                    ...
                                    JOIN '||V_ESQUEMA||'.ACT_AHP_HIST_PUBLICACION APU ON APU.ACT_ID = ACT.ACT_ID
                          ...
                          SELECT APU.AHP_ID
                               ...
                               , MTO.DD_MTO_ORDEN ORDEN
                                    ...
                                    JOIN '||V_ESQUEMA||'.ACT_AHP_HIST_PUBLICACION APU ON APU.ACT_ID = PAC.ACT_ID
                          ...
                          SELECT APU.AHP_ID
                               ...
                               , MTO.DD_MTO_ORDEN ORDEN
                                    ...
                                    JOIN '||V_ESQUEMA||'.V_CAMBIO_ESTADO_HPUBLI EST ON EST.AHP_ID = APU.AHP_ID AND EST.INFORME_COMERCIAL = 0
                          ...
                          SELECT APU.AHP_ID
                               ...
                               , MTO.DD_MTO_ORDEN ORDEN
                                   ...
                                   WHERE APU.BORRADO = 0
                                     AND APU.AHP_CHECK_PUB_SIN_PRECIO_A = 0
    ...
    REM01.OPERACION_DDL.DDL_TABLE('ANALYZE','AUX_MOT_OCULT_HA');
