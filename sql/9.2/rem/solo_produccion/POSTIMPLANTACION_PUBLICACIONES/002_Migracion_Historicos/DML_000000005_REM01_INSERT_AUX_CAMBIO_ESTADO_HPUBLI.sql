...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'AUX_CAMBIO_ESTADO_HPUBLI';  -- Tabla a modificar  
    ...
    EXECUTE IMMEDIATE ' TRUNCATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'';       
			...
			EXECUTE IMMEDIATE '
				...
				SELECT
				  ...
				  ADECUADO,							
				  ES_CONDICONADO
				FROM V_CAMBIO_ESTADO_HPUBLI';
		DBMS_OUTPUT.PUT_LINE('[INFO]: REGISTRO INSERTADO CORRECTAMENTE');

    COMMIT;
    #ESQUEMA#.OPERACION_DDL.DDL_TABLE('ANALYZE','AUX_CAMBIO_ESTADO_HPUBLI');
