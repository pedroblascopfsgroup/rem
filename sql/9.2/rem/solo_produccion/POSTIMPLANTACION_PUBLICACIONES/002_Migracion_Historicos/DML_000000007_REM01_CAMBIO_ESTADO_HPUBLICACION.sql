...
declare
    pAHP_ID NUMBER(16):= NULL;
    pCondAlquiler VARCHAR2(50 CHAR):= 1;
    pUSUARIOMODIFICAR VARCHAR2(50 CHAR):= 'SP_CAMBIO_EST_HPUB';
    ...
    nAHP_ID           REM01.V_CAMBIO_ESTADO_HPUBLI.AHP_ID%TYPE;
    vDD_TCO_CODIGO    REM01.V_CAMBIO_ESTADO_HPUBLI.DD_TCO_CODIGO%TYPE;
    vCODIGO_ESTADO_A  REM01.V_CAMBIO_ESTADO_HPUBLI.CODIGO_ESTADO_A%TYPE;
    vDESC_ESTADO_A    REM01.V_CAMBIO_ESTADO_HPUBLI.DESC_ESTADO_A%TYPE;
    vCHECK_PUBLICAR_A REM01.V_CAMBIO_ESTADO_HPUBLI.CHECK_PUBLICAR_A%TYPE;
    vCHECK_OCULTAR_A  REM01.V_CAMBIO_ESTADO_HPUBLI.CHECK_OCULTAR_A%TYPE;
    vDD_MTO_CODIGO_A  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_MTO_CODIGO_A%TYPE;    
    vDD_MTO_MANUAL_A  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_MTO_MANUAL_A%TYPE; 
    vCODIGO_ESTADO_V  REM01.V_CAMBIO_ESTADO_HPUBLI.CODIGO_ESTADO_V%TYPE;
    vDESC_ESTADO_V    REM01.V_CAMBIO_ESTADO_HPUBLI.DESC_ESTADO_V%TYPE;
    vCHECK_PUBLICAR_V REM01.V_CAMBIO_ESTADO_HPUBLI.CHECK_PUBLICAR_V%TYPE;
    vCHECK_OCULTAR_V  REM01.V_CAMBIO_ESTADO_HPUBLI.CHECK_OCULTAR_V%TYPE;
    vDD_MTO_CODIGO_V  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_MTO_CODIGO_V%TYPE;
    vDD_MTO_MANUAL_V  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_MTO_MANUAL_V%TYPE; 
    vDD_TPU_CODIGO_A  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_TPU_CODIGO_A%TYPE;
    vDD_TPU_CODIGO_V  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_TPU_CODIGO_V%TYPE;
    vDD_TAL_CODIGO	  REM01.V_CAMBIO_ESTADO_HPUBLI.DD_TAL_CODIGO%TYPE;	
    nADMISION         REM01.V_CAMBIO_ESTADO_HPUBLI.ADMISION%TYPE;
    nGESTION          REM01.V_CAMBIO_ESTADO_HPUBLI.GESTION%TYPE;
    nINFORME_COMERCIAL REM01.V_CAMBIO_ESTADO_HPUBLI.INFORME_COMERCIAL%TYPE;
    nPRECIO_A         REM01.V_CAMBIO_ESTADO_HPUBLI.PRECIO_A%TYPE;
    nPRECIO_V         REM01.V_CAMBIO_ESTADO_HPUBLI.PRECIO_V%TYPE;
    nCEE_VIGENTE      REM01.V_CAMBIO_ESTADO_HPUBLI.CEE_VIGENTE%TYPE;
    nADECUADO         REM01.V_CAMBIO_ESTADO_HPUBLI.ADECUADO%TYPE;
    nES_CONDICONADO   REM01.V_CAMBIO_ESTADO_HPUBLI.ES_CONDICONADO%TYPE;
  ...
  PROCEDURE PLP$LIMPIAR_ALQUILER(nAHP_ID NUMBER, pUSUARIOMODIFICAR VARCHAR2) IS
  ...
  PROCEDURE PLP$LIMPIAR_VENTA(nAHP_ID NUMBER, pUSUARIOMODIFICAR VARCHAR2) IS
  ...
  PROCEDURE PLP$CAMBIO_ESTADO_ALQUILER(nAHP_ID NUMBER, pESTADO VARCHAR2, pUSUARIOMODIFICAR VARCHAR2) IS
  ...
  PROCEDURE PLP$CAMBIO_ESTADO_VENTA(nAHP_ID NUMBER, pESTADO VARCHAR2, pUSUARIOMODIFICAR VARCHAR2) IS
  ...
  PROCEDURE PLP$CAMBIO_OCULTO_MOTIVO(nAHP_ID NUMBER
  ...
  BEGIN
		...
		IF pDD_TCO_CODIGO IN ('02','03','04') THEN
		  ...
		  */	  
		  IF pDD_MTO_CODIGO = '06' THEN /*Revisión Publicación*/
		    vACTUALIZAR_COND := 'N';
		    REM01.SP_CREAR_AVISO (nAHP_ID, 'GPUBL', pUSUARIOMODIFICAR, 'Se ha situado en Oculto Alquiler con motivo Revisión Publicación el activo: ', 0);
		  END IF; 
	...
	IF pTIPO = 'V' THEN
      ...
      V_MSQL:='UPDATE '|| V_ESQUEMA ||'.ACT_PAC_PERIMETRO_ACTIVO ACT '||
		...
		IF pDD_MTO_CODIGO = '06' THEN /*Revisión Publicación*/
		  vACTUALIZAR_COND := 'N';
		  REM01.SP_CREAR_AVISO (nAHP_ID, 'GPUBL', pUSUARIOMODIFICAR, 'Se ha situado en Oculto Venta con motivo Revisión Publicación el activo: ', 0);
		END IF; 		
  ...
  PROCEDURE PLP$CONDICIONANTE_VENTA(nAHP_ID NUMBER, pADMISION NUMBER, pGESTION NUMBER, pINFORME_COMERCIAL NUMBER, pPRECIO NUMBER, pUSUARIOMODIFICAR VARCHAR2) IS
  ...
  PROCEDURE PLP$CONDICIONANTE_ALQUILER(nAHP_ID NUMBER, pADMISION NUMBER, pGESTION NUMBER
  ...
  BEGIN
      ...
      IF pAHP_ID IS NOT NULL THEN
        vWHERE := ' WHERE V.ACT_ID='||pAHP_ID;
      END IF;

	  IF pUSUARIOMODIFICAR IS NULL THEN
	    vUSUARIOMODIFICAR := 'SP_CAMBIO_EST_HPUB';
	  ELSE
      ...
      V_MSQL := '
        SELECT 
          ...
          FROM '|| V_ESQUEMA ||'.AUX_CAMBIO_ESTADO_HPUBLI V'
          ||vWHERE
       ;

     OPEN v_cursor FOR V_MSQL;
      LOOP
        FETCH v_cursor INTO nAHP_ID, vDD_TCO_CODIGO
        ...
        IF vDD_TCO_CODIGO IN ('02','03','04') THEN
          ...
          IF vCODIGO_ESTADO_A = '02' THEN
            ...
            IF vCHECK_PUBLICAR_A = 0 THEN
              PLP$CAMBIO_ESTADO_ALQUILER(nAHP_ID, '01', vUSUARIOMODIFICAR);
        ...
        IF vDD_TCO_CODIGO IN ('01','02') THEN
          ...
          IF vCODIGO_ESTADO_V = '02' THEN
            ...
            IF vCHECK_PUBLICAR_V = 0 THEN
              PLP$CAMBIO_ESTADO_VENTA(nAHP_ID, '01', vUSUARIOMODIFICAR);
        ...
        IF vDD_TCO_CODIGO IN ('02','03','04') THEN
          IF (vCODIGO_ESTADO_A = '03' AND vCHECK_PUBLICAR_A = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_HA (nAHP_ID, 'A', OutOCULTAR, OutMOTIVO);
    
            IF OutOCULTAR = 1 THEN
              PLP$CAMBIO_OCULTO_MOTIVO(nAHP_ID, 'A', vDD_TCO_CODIGO, OutOCULTAR, OutMOTIVO, vUSUARIOMODIFICAR);
              PLP$CAMBIO_ESTADO_ALQUILER(nAHP_ID, '04', vUSUARIOMODIFICAR);
            END IF;
        ...
        IF vDD_TCO_CODIGO IN ('01','02') THEN
          IF (vCODIGO_ESTADO_V = '03' AND vCHECK_PUBLICAR_V = 1) THEN
            REM01.SP_MOTIVO_OCULTACION_HV (nAHP_ID, 'V', OutOCULTAR, OutMOTIVO);
            ...
            IF OutOCULTAR = 1 THEN
              IF OutMOTIVO = '03' AND vDD_TAL_CODIGO = '01' THEN /*SI MOTIVO ES ALQUILADO Y TIPO ALQUILER ORDINARIO, NO OCULTAR*/
                IF vDD_MTO_MANUAL_V = 0 THEN /*MOTIVO AUTOMÁTICO*/
                  ...
                  EXECUTE IMMEDIATE V_MSQL; 
                ELSE
                  PLP$CAMBIO_ESTADO_VENTA(nAHP_ID, '04', vUSUARIOMODIFICAR);               
                END IF;
              ELSE
