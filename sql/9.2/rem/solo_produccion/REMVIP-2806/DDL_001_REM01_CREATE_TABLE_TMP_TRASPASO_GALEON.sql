...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla AUX_ACT_TRASPASO_GALEON_2.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'AUX_ACT_TRASPASO_GALEON_2'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_USUARIO VARCHAR2(32 CHAR) := 'REMVIP-2806';
