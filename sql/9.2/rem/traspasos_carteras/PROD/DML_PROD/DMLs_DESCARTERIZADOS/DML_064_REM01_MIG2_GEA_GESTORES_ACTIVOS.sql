...
BEGIN
      ...
      DBMS_OUTPUT.PUT_LINE('  [INFO] INSERCION EN GAC_GESTOR_ADD_ACTIVO ');
       ...
       V_SQL := '
        ...
        WHERE GEE.USUARIOCREAR = '''||USUARIO_MIGRACION||''' AND GEE.USUARIOMODIFICAR IS NOT NULL AND GAC.GEE_ID IS NULL
      '
      ;
      EXECUTE IMMEDIATE V_SQL;
    ...
    WHERE GEA.VALIDACION = 0 AND GEE.GEH_ID IS NULL
      ...
      DBMS_OUTPUT.PUT_LINE('  [INFO] INSERCION EN GAH_GESTOR_ACTIVO_HISTORICO ');
       ...
       V_SQL := '
        ...
        WHERE GEH.USUARIOCREAR = '''||USUARIO_MIGRACION||''' AND GEH.USUARIOMODIFICAR IS NOT NULL AND GAH.GEH_ID IS NULL
      '
      ;
      EXECUTE IMMEDIATE V_SQL;
