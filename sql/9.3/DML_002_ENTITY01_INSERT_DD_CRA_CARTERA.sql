...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('11','','Third Parties','Third Parties')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'SELECT '|| V_ESQUEMA ||'.S_DD_CRA_CARTERA.NEXTVAL FROM DUAL'; --consultamos el siguiente ID de la clave primaria que se generará para que lo inserte en el nuevo registro.
          EXECUTE IMMEDIATE V_MSQL INTO V_ID; -- y lo almacenamos en esta variable.  
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_CRA_CARTERA (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''' ,'''||V_TMP_TIPO_DATA(2)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''', 0, ''HREOS-3876'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
