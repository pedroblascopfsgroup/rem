      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (' ||
                      	'DD_OPM_ID, DD_OPM_CODIGO, DD_OPM_DESCRIPCION, DD_OPM_DESCRIPCION_LARGA,DD_OPM_VALIDACION_FORMATO,FUN_ID, VERSION, USUARIOCREAR, FECHACREAR, BORRADO, DD_OPM_RESULTADO) ' ||
