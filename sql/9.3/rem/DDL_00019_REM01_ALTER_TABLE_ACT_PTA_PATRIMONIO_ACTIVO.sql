...
DECLARE
    ...
    V_TABLA_REF VARCHAR(150 CHAR) := 'DD_CDU_CESION_USO';
    V_COLUMN_REF VARCHAR(150 CHAR):= 'DD_CDU_ID';
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  V_COLUMN_REF,			'NUMBER (16,0)',		'Clave de la tabla DD_CDU_CESION_USO'	)
...
BEGIN
	...
	LOOP
		...
		ELSE
            ...
            V_SQL :='ALTER TABLE '||V_TEXT_TABLA||' ADD CONSTRAINT FK_'||V_TABLA_REF||' FOREIGN KEY ('||V_COLUMN_REF||') REFERENCES '||V_TABLA_REF||' ('||V_COLUMN_REF||')';
