...
BEGIN
	...
	END IF;
	-- BUSCA LA TABLA AEX_AUDITORIA_EXPORTACIONES REM01	
	 ...
	 IF V_NUM > 0 THEN
		...
		-- LA TABLA AEX_AUDITORIA_EXPORTACIONES YA EXISTE EN MINIREC
	 
		DBMS_OUTPUT.PUT_LINE('[INFO] Tabla '||V_TABLA||' ya existente en '||V_ESQUEMA||'.');
		
	 ELSE
	 
		-- SE CREA LA TABLA AEX_AUDITORIA_EXPORTACIONES EN MINIREC
