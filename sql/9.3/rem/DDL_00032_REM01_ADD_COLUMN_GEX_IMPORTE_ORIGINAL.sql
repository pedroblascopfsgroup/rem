...
--## INCIDENCIA_LINK=HREOS-8866
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla GEX_GASTOS_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'GEX_IMPORTE_ORIGINAL',			'NUMBER(16,2)',			'Importe original devuelto por comisionamiento'	)
		);
    V_T_ALTER T_ALTER;
