...
--## PRODUCTO=NO
--## Finalidad: Añadir la columna en la tabla ACT_DCA_DATOS_CONTRATO_ALQ booleana que indica si se contempla como Paz Social.
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DCA_PAZ_SOCIAL',		 	'NUMBER(1,0)',		'Booleano que indica si es de Paz Social.')
		);
    V_T_ALTER T_ALTER;
