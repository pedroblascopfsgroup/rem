...
DECLARE
    ...
    --Tipos de campo
    V_TIPO_VARCHAR VARCHAR2(250 CHAR):= 'VARCHAR2(1 CHAR)';
	
    --Nombre de las columnas
    V_CAMPO VARCHAR2(50 CHAR):= 'ACT_VALOR_LIQUIDEZ'; 
...
BEGIN   
	...
	IF V_NUM_TABLAS > 0 THEN    
		...
		IF V_NUM_TABLAS < 1 THEN
			...
			EXECUTE IMMEDIATE 'COMMENT ON COLUMN '|| V_ESQUEMA ||'.'||V_TABLA||'.'||V_CAMPO||' IS ''Valor de líquidez del activo''';
