...
BEGIN
    ...
    -- ******** CPS_CONFIG_SUBPTDAS_PRE *******
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla CPS_CONFIG_SUBPTDAS_PRE
    ...
    END IF; 
      ...
      DBMS_OUTPUT.PUT_LINE('[CREAMOS '||V_TABLA||']');
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				 ...
				 ,CPS_CUENTA_CONTABLE    		VARCHAR2(50 CHAR)		
    ...
    EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.'||V_TABLA||'.CPS_CUENTA_CONTABLE IS ''Cuenta contable relacionada al gasto''';
