...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CPS_ID',		 					'NUMBER(16,0)',						'Configuración de la subpartida')
		);
    V_T_ALTER T_ALTER;
...
BEGIN
	...
	LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			...
			V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_CPS_ID FOREIGN KEY (CPS_ID) REFERENCES '||V_ESQUEMA||'.CPS_CONFIG_SUBPTDAS_PRE (CPS_ID))';
			EXECUTE IMMEDIATE V_MSQL;
