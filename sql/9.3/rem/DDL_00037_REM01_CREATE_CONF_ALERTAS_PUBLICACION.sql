...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('BANKIA DACION','','',	                    '0','0','1','1','0','0','1','0'),
		T_TIPO_DATA('BANKIA','','',				    '1','1','1','1','0','0','0','0'),
		T_TIPO_DATA('SAREB','','',			 	    '0','0','1','1','0','1','0','0'),
		T_TIPO_DATA('CAJAMAR','','',			       	    '0','0','1','1','0','0','0','0'),
		T_TIPO_DATA('LIBERBANK','','',			 	    '0','0','1','1','1','0','0','1'),
		T_TIPO_DATA('CERBERUS','DIVARIAN REMAINING INMB','',        '0','1','1','1','1','0','1','0'),
		T_TIPO_DATA('CERBERUS','DIVARIAN INDUSTRIAL INMB','',	    '0','1','1','1','1','0','1','0'),
		T_TIPO_DATA('CERBERUS','JAIPUR - FINANCIERO','',	    '0','1','1','1','1','0','1','0'),
    ...
    V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'(
		...
		ALQUILADO			NUMBER(1,0),
        	TCO_ALQUILER       		NUMBER(1,0),
		OCUPADO				NUMBER(1,0),
        	FECHA_DECRETO       		NUMBER(1,0)
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.CONF_ALERTAS_PUBLICACION.TCO_ALQUILER IS ''Esta tipo comercializacion alquiler''';
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.CONF_ALERTAS_PUBLICACION.OCUPADO IS ''Esta ocupado (sin titulo)''';
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.CONF_ALERTAS_PUBLICACION.FECHA_DECRETO IS ''Tiene fecha decreto''';
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      ...
      V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (CARTERA, SUBCARTERA, SUBTIPO_TITULO, INSCRIPCION, CARGAS, POSESION,TIPO_ALQUILER, ALQUILADO,TCO_ALQUILER, OCUPADO, FECHA_DECRETO) VALUES (' ||
		      ...
		      ''''||V_TMP_TIPO_DATA(7)||''','''||TRIM(V_TMP_TIPO_DATA(8))||''','''||TRIM(V_TMP_TIPO_DATA(9))||''','''||TRIM(V_TMP_TIPO_DATA(10))||''','''||TRIM(V_TMP_TIPO_DATA(11))||''')';
