...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('BANKIA','','Adjudicación no judicial',	 	'0','0','1','1','0','0'),
		...
		T_TIPO_DATA('CERBERUS','DIVARIAN REMAINING INMB','',    '1','1','1','1','0','1'),
		T_TIPO_DATA('CERBERUS','DIVARIAN ARROW INMB','',	'1','1','1','1','0','1'),
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.CONF_ALERTAS_PUBLICACION.TIPO_TITULO IS ''Subtipo titulo''';
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_TMP_TIPO_DATA := V_TIPO_DATA(I);
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||' (CARTERA, SUBCARTERA, TIPO_TITULO, INSCRIPCION, CARGAS, POSESION,TIPO_ALQUILER, ALQUILADO, OCUPADO) VALUES (' ||
