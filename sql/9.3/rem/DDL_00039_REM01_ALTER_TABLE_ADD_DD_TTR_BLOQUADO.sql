...
--## INCIDENCIA_LINK=HREOS-9460
--## PRODUCTO=SI
--## 
--## Finalidad: Incluir campo DD_TTR_BLOQUADO en tabla DD_TTR_TIPO_TRABAJO.
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
      -- Recordatorios
  	  T_COL(''||V_ESQUEMA||'', 'DD_TTR_TIPO_TRABAJO',  'DD_TTR_BLOQUEADO'                   	  , 'NUMBER(1,0)  DEFAULT 0'       	  , 'Trabajo bloqueado')
