...
--## PRODUCTO=NO
--##
--## Finalidad: Cambio tamaño campo ICO_DESCRIPCION
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
	  V_TABLA VARCHAR2(50 CHAR):= 'ACT_ICO_INFO_COMERCIAL'; -- Nombre de la tabla a crear
	  V_COL VARCHAR2(50 CHAR):= 'ICO_DESCRIPCION'; --Nombre de la columna
	  V_TIPO VARCHAR2(250 CHAR):= 'VARCHAR2(3000)';--Tipo nuevo campo
