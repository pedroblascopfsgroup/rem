    ...
    IF V_NUM_TABLAS = 0 THEN        
        ...
        DBMS_OUTPUT.PUT_LINE('[CREAMOS '||V_TABLA||']');
            V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
                    ...
                    ,HPP_OBSERVACIONES            VARCHAR2(1024 CHAR)
                    ...
                    ,CONSTRAINT FK_HPP_ACT_ID 	 FOREIGN KEY (ACT_ID)     	 REFERENCES ACT_ACTIVO (ACT_ID)
                    )';        	
        ...
        EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.'||V_TABLA||'.ACT_ID IS ''ID único del activo''';
        ...
        EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA || '.'||V_TABLA||'.HPP_OBSERVACIONES IS ''Observaciones''';
