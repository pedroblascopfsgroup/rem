...
--## FECHA_CREACION=20200524
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-10321
--## PRODUCTO=NO
--## 
...
DECLARE
    ...
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
	  V_TABLA VARCHAR2(50 CHAR):= 'ACT_CRG_CARGAS'; -- Nombre de la tabla a crear
	  V_COL VARCHAR2(50 CHAR):= 'CRG_OCULTO_CARGA_MASIVA'; --Nombre de la columna
	  V_TIPO VARCHAR2(250 CHAR):= 'NUMBER(1)';--Tipo nuevo campo
...
--Comprobacion de la tabla
  ...
  IF V_NUM_TABLAS > 0 THEN                     
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.ACT_CRG_CARGAS.'||V_COL||' IS ''Indica si se oculta el campo o no debido a la carga masiva esparta.''';
