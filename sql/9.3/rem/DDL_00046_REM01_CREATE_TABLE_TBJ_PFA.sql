...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla TBJ_PFA
...
DECLARE
	...
	V_TABLA VARCHAR2(2400 CHAR) := 'TBJ_PFA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	--V_PK_COLUMN VARCHAR2(500 CHAR):= 'TBJ_ID'; -- Vble. para la columna PK
	...
	-- 	COLUMN 					COLUMN 			TABLE 						FK_NAME
		T_FK('TBJ_ID', 			'TBJ_ID', 		'ACT_TBJ_TRABAJO', 			'FK_TBJ_PFA_TBJ_ID'), 
		T_FK('PFA_ID', 			'PFA_ID', 		'PFA_PREFACTURA', 			'FK_TBJ_PFA_PFA_ID')
	); 
	V_TMP_FK T_FK;
...
BEGIN
	...
	V_SQL := 'CREATE TABLE ' ||V_ESQUEMA||'.'||V_TABLA||' (
		TBJ_ID 				NUMBER(16,0) 			NOT NULL ENABLE, 
		PFA_ID 				NUMBER(16,0) 			NOT NULL ENABLE,
