...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_ERA_ID',			'NUMBER(16)',			'Identificador único del estado registral del activo'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_ERA',						'DD_ERA_ID',		V_ESQUEMA||'.DD_ERA_ESTADO_REG_ACTIVO',				'DD_ERA_ID')
    );
    V_T_FK T_FK;
