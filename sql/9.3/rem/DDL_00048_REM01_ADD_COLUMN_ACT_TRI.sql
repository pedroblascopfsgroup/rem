...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_TRI_EXENTO',					'NUMBER(1)',			'Identificador único del mediador del informe comercial',  'DEFAULT 0 NOT NULL'),
    	T_ALTER(  'DD_MOE_ID',						'NUMBER(16)',			'Identificador único del mediador del informe comercial',  ''),
    	T_ALTER(  'DD_RES_ID',						'NUMBER(16)',			'Identificador único del mediador del informe comercial',  '')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_MOE',					'DD_MOE_ID',		V_ESQUEMA||'.DD_MOE_MOTIVO_EXENTO',					'DD_MOE_ID'),
    	T_FK(	'FK_DD_RES',					'DD_RES_ID',		V_ESQUEMA||'.DD_RES_RESULTADO_SOLICITUD',			'DD_RES_ID')
    );
    V_T_FK T_FK;
