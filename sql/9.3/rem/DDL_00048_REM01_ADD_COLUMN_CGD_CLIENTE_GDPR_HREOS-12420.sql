...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla CGD_CLIENTE_GDPR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ADCOM_DOC_IDENT',				'NUMBER(16)',	     'Identificador para adjunto gestor documental',  '')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ADJUNTO_COMPRADOR',			  'ADCOM_DOC_IDENT',	V_ESQUEMA||'.ADC_ADJUNTO_COMPRADOR',		       'ADCOM_ID')
    );
    V_T_FK T_FK;
