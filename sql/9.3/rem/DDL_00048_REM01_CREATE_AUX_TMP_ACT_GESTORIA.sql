...
--## INCIDENCIA_LINK=REMVIP_7777
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_TMP_ACT_GESTORIA'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TABLA1 VARCHAR2(40 CHAR) := 'AUX_TMP_ACT_GESTORIA';
...
BEGIN
	...
	EXECUTE IMMEDIATE 'CREATE TABLE '||V_ESQUEMA_1||'.'||V_TABLA1||'
          	 (ACT_ID VARCHAR2(16 CHAR),
             	  DD_GRF_CODIGO VARCHAR2(20 CHAR),
		  CONSTRAINT PK_TMP_GES_ACT_ID        PRIMARY KEY (ACT_ID)
           )';
