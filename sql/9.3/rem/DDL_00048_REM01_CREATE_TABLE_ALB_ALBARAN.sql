...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla ALB_ALBARAN
...
DECLARE
	...
	V_TABLA VARCHAR2(2400 CHAR) := 'ALB_ALBARAN'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_PK_COLUMN VARCHAR2(500 CHAR):= 'ALB_ID'; -- Vble. para la columna PK
	V_UK_COLUMN VARCHAR2(500 CHAR):= 'ALB_NUM_ALBARAN'; -- Vble. para la columna UK
	...
	-- 	COLUMN 							COMMENT
		T_COMMENT('ALB_ID', 			'Id del albarán.'), 
		T_COMMENT('ALB_NUM_ALBARAN', 	'Número del albarán.'),
		T_COMMENT('ALB_FECHA_ALBARAN', 	'Fecha de alta del albarán.'),
		T_COMMENT('DD_ESA_ID', 			'Estado del albarán.'),
...
BEGIN
	...
	V_SQL := 'CREATE TABLE ' ||V_ESQUEMA||'.'||V_TABLA||' (
		ALB_ID 				NUMBER(16,0) 			NOT NULL, 
		ALB_NUM_ALBARAN 	VARCHAR2 (50 CHAR) 		NOT NULL ENABLE, 
		ALB_FECHA_ALBARAN 	DATE 					NOT NULL ENABLE,
		DD_ESA_ID 			NUMBER(16,0) 			NOT NULL ENABLE,
