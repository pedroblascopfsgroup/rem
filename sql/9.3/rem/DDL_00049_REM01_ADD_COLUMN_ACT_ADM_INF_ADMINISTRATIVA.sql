...
/*tabla: ACT_ADM_INF_ADMINISTRATIVA
	ADM_FECHA_SOL_CERTIFICADO DATE,
	ADM_FECHA_COM_ADQUISICION DATE, 
	ADM_FECHA_COM_REG_DEM DATE,
	ADM_ACTUALIZA_PRECIO_MAX NUMBER(16) FK references DD_SIN_SINO -------
	ADM_FECHA_VENCIMIENTO DATE
*/
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'ADM_FECHA_SOL_CERTIFICADO',			'DATE',					'Fecha de solicitud del certificado'	), 
    	T_ALTER(  'ADM_FECHA_COM_ADQUISICION',			'DATE',					'Fecha de comunicacion de adquisicion.'	), 
    	T_ALTER(  'ADM_FECHA_COM_REG_DEM',				'DATE',					'Fecha comunicación al registro de demandantes'	), 
    	T_ALTER(  'ADM_ACTUALIZA_PRECIO_MAX',			'NUMBER(16)',			'Aplica actualización de precio máximo: Sí/No'	),
    	T_ALTER(  'ADM_FECHA_VENCIMIENTO',				'DATE',					'Fecha vencimiento fase venta'	)
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACT_ADM_INF_ADM_PRMAX',			'ADM_ACTUALIZA_PRECIO_MAX',		V_ESQUEMA||'.DD_SIN_SINO',					'DD_SIN_ID') 
    );
    V_T_FK T_FK;
