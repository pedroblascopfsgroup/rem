...
--## INCIDENCIA_LINK=HREOS-12420
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla OFR_TIA_TITULARES_ADICIONALES
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ADCOM_GDPR',						'NUMBER(16)',			'Identificador documento adjunto GDPR',  ''),
    	T_ALTER(  'ADCOM_DOC_IDENT',				'NUMBER(16)',			'Identificador documento adjunto identificativo',  '')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_GDPR',					    'ADCOM_GDPR',			V_ESQUEMA||'.ADC_ADJUNTO_COMPRADOR',			'ADCOM_ID'),
    	T_FK(	'FK_DOC_IDENT',					'ADCOM_DOC_IDENT',		V_ESQUEMA||'.ADC_ADJUNTO_COMPRADOR',			'ADCOM_ID')
    );
    V_T_FK T_FK;
