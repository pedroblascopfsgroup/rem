...
--## INCIDENCIA_LINK=REMVIP-7594
--## PRODUCTO=NO
--##
--## Finalidad: Añadir columna GIC_ACTIVABLE a GIC_GASTOS_INFO_CONTABILIDAD
--##
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'GIC_GASTOS_INFO_CONTABILIDAD';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('GIC_ACTIVABLE','number(1) default 0 not null')
    );
