...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_CFT_CONFIG_TARIFA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CFT_FECHA_INI',					'DATE',					'Fecha inicio de tarifa'),
    	T_ALTER(  'CFT_FECHA_FIN',					'DATE',					'Fecha fin de tarifa'),
    	T_ALTER(  'CFT_PRECIO_UNITARIO_CLIENTE',	'NUMBER(16,2)',			'Importe unitario cliente')
		);
    V_T_ALTER T_ALTER;
