...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_EAA_ID',			'NUMBER(16)',			'Identificador único del estado de admision'	),
    	T_ALTER(  'DD_SAA_ID',			'NUMBER(16)',			'Identificador único del subestado de admision'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACT_DD_EAA',			'DD_EAA_ID',		V_ESQUEMA||'.DD_EAA_ESTADO_ACT_ADMISION',				'DD_EAA_ID'),
    	T_FK(	'FK_ACT_DD_SAA',			'DD_SAA_ID',		V_ESQUEMA||'.DD_SAA_SUBESTADO_ACT_ADMISION',				'DD_SAA_ID')
    );
    V_T_FK T_FK;
