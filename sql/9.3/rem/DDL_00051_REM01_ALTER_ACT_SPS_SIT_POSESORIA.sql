...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('SPS_ACC_TAPIADO', 'NUMBER',' DEFAULT ON NULL 0'),
		T_TIPO_DATA('SPS_ACC_ANTIOCUPA', 'NUMBER',' DEFAULT ON NULL 0'),
		T_TIPO_DATA('SPS_OCUPADO', 'NUMBER',' DEFAULT ON NULL 0')
    ); 
...
BEGIN
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		...
		DBMS_OUTPUT.PUT_LINE('[FIN] ALTER TABLE '''||TRIM(V_TMP_TIPO_DATA(1))||''' A DEFAULT 0');
      END LOOP;
