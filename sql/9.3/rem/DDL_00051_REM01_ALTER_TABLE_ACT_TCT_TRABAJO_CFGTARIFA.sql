...
--## INCIDENCIA_LINK=HREOS-10507
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_TCT_TRABAJO_CFGTARIFA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'TCT_PRECIO_UNITARIO_CLIENTE',	'NUMBER(16,2)',			'Importe unitario cliente')
		);
    V_T_ALTER T_ALTER;
