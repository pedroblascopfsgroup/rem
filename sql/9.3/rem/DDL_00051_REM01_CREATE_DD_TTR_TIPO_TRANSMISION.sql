...
--## INCIDENCIA_LINK=HREOS-10763
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_TTR_TIPO_TRANSMISION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_TTR_TIPO_TRANSMISION'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'TTR';
...
BEGIN
    ...
    -- Creacion Tabla DD_CDU_CESION_USO
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'
               (DD_'||V_CODIGO_TABLA||'_ID NUMBER (16,0) 
				  ...
				  , DD_'||V_CODIGO_TABLA||'_DESCRIPCION VARCHAR2(100 CHAR) 
				  ...
				  , CONSTRAINT UK_'||V_CODIGO_TABLA||'_CODIGO UNIQUE (DD_'||V_CODIGO_TABLA||'_CODIGO)
			  )';
