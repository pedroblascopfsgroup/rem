...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'FECHA_ALTA',						'DATE',						'FECHA ALTA',						'0',						0,								0),
    	T_ALTER(  'USU_ID',							'NUMBER (16,0)',			'FK A USU_USUARIOS GESTOR ALTA',	'FK_ART_USU_ID',	''||V_ESQUEMA_M||'.USU_USUARIOS',		'USU_ID'),
    	T_ALTER(  'ACT_ID',							'NUMBER (16,0)',			'FK A ACT_ACTIVO',					'FK_ART_ACT_ID',	''||V_ESQUEMA||'.ACT_ACTIVO',			'ACT_ID')
