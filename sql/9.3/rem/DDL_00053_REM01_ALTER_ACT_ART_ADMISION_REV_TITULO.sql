...
--## PRODUCTO=NO
--## Finalidad: Añadir una columnas a ACT_ART_ADMISION_REV_TITULO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    		...
    		T_ALTER(  'ART_PORC_PROPIEDAD',		 			'NUMBER(5,2)'),
		T_ALTER(  'ART_PORC_CONS_TASACION_CF',		 		'NUMBER(5,2)'),
		T_ALTER(  'ART_PORC_CONS_TASACION_CJ',		 		'NUMBER(5,2)')
		);
    V_T_ALTER T_ALTER;
