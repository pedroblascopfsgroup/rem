...
--## INCIDENCIA_LINK=HREOS-10741
--## PRODUCTO=NO
--## Finalidad: Add una columna y su contrainst de PFA_PREFACTURA a Albaranes
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'PFA_ID',			'NUMBER(16,0)',				'Id de la tabla Prefactura'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_TBJ_PFA_ID',						'PFA_ID',					V_ESQUEMA||'.PFA_PREFACTURA',			'PFA_ID'			)
    );
    V_T_FK T_FK;
