...
--## PRODUCTO=NO
--## Finalidad: Anyadir nueva columna a la tabla DD_COS_CAMPOS_CONV_SAREB
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_CTD_ID',					'NUMBER(16)',			'Identificador del tipo de dato',  '')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_CTD',					'DD_CTD_ID',		V_ESQUEMA||'.DD_CTD_CAMPO_TIPO_DATO',					'DD_CTD_ID')
    );
    V_T_FK T_FK;
