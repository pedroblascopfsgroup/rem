...
--## PRODUCTO=NO
--## Finalidad: Add una columna a DD_TAL_TIPO_ALQUILER
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TAL_ARRENDAMIENTO_SOCIAL',	'NUMBER(1,0) DEFAULT 0',	'Marcador de arrendamiento social')
		);
    V_T_ALTER T_ALTER;
...
BEGIN
	...
	LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			...
			DBMS_OUTPUT.PUT_LINE('	[INFO] ... Columna '||V_T_ALTER(1)||' INSERTADA en tabla '||V_TEXT_TABLA||', con tipo '||V_T_ALTER(2));
