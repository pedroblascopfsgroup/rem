...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'SGT_ID',		 					'NUMBER(16,0)'),
		T_ALTER(  'CCC_PRINCIPAL',					'NUMBER(1,0) DEFAULT 0 NOT NULL ENABLE'),
		T_ALTER(  'CPP_PRINCIPAL',					'NUMBER(1,0) DEFAULT 0 NOT NULL ENABLE')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CTAS_SGT',						'SGT_ID',				V_ESQUEMA||'.ACT_SGT_SUBTIPO_GPV_TBJ',				'SGT_ID'			)
    );
    V_T_FK T_FK;
