...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_EAS_ESTADO_ADECUACION_SAREB
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_EAS_ESTADO_ADECUACION_SAREB'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'EAS';
