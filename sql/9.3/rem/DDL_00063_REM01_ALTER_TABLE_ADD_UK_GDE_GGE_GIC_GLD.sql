...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    ...
    T_COL('CREATE_CONSTRAINT', 'GGE_GASTOS_GESTION', 'UK_GGE_GASTOS_GESTION','GPV_ID, FECHABORRAR, BORRADO'),
    ...
    T_COL('CREATE_CONSTRAINT', 'GIC_GASTOS_INFO_CONTABILIDAD', 'UK_GIC_GASTOS_INFO_CONTABILIDAD','GPV_ID, FECHABORRAR, BORRADO'),
