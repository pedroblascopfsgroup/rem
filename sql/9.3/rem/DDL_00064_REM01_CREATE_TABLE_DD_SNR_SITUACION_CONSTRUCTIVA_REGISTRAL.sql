...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_SNR_SITUACION_CONSTRUCTIVA_REGISTRAL
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(1000 CHAR) := 'DD_SNR_SITUACION_CONSTRUCTIVA_REGISTRAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(3 CHAR) := 'SNR';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-10553';
 ...
 BEGIN
	...
	IF V_COUNT = 0 THEN
		...
		V_SQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
				...
				, DD_'||V_CHARS||'_CODIGO VARCHAR2(20 CHAR) NOT NULL
