...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_PTO_PROTECCION_OFICIAL
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(1000 CHAR) := 'DD_PTO_PROTECCION_OFICIAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(3 CHAR) := 'PTO';
