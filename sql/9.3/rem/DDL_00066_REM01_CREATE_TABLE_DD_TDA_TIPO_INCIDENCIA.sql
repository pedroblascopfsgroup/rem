...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TDA_TIPO_INCIDENCIA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(1000 CHAR) := 'DD_TDA_TIPO_INCIDENCIA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
