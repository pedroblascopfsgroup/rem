...
--## INCIDENCIA_LINK=HREOS-10959
--## PRODUCTO=NO
--## Finalidad: Actualizamos/Creamos columnas en ACT_ART_ADMISION_REV_TITULO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'TIPO_TITULO_ACTIVO_ENTRADA',		'NUMBER (16,0)',	'Identificador único FK a DD_TTA_TIPO_TITULO_ACTIVO',		'FK_TIPO_TITULO_ACTIVO_ENTRADA',		''||V_ESQUEMA||'.DD_TTA_TIPO_TITULO_ACTIVO',		'DD_TTA_ID'),
    	T_ALTER(  'SUBTIPO_TITULO_ACTIVO_ENTRADA',	'NUMBER (16,0)',	'Identificador único FK a DD_STA_SUBTIPO_TITULO_ACTIVO',	'FK_SUBTIPO_TITULO_ACTIVO_ENTRADA',		''||V_ESQUEMA||'.DD_STA_SUBTIPO_TITULO_ACTIVO',		'DD_STA_ID')
	);
	V_T_ALTER T_ALTER;
