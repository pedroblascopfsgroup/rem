...
--## PRODUCTO=NO
--## Finalidad: Crear una nueva columna en la tabla ASPRO_10_CABECERA
--##           
...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ASPRO_10_CABECERA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
