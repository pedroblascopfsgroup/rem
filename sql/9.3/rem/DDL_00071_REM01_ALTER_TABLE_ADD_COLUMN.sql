...
--## INCIDENCIA_LINK=HREOS-10796
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columnas a tablas de gastos y presupuestos
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'GPV_GASTOS_PROVEEDOR', 'GPV_PLAN_VISITAS', 'NUMBER(1,0) DEFAULT 0', 'Plan Visitas'),
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_PTDAS_PREP', 'CPP_ACTIVABLE', 'NUMBER(1,0) DEFAULT 0', 'Marca si la partida presupuestaria es activable'),
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_PTDAS_PREP', 'CPP_PLAN_VISITAS', 'NUMBER(1,0) DEFAULT 0', 'Plan Visitas'),
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_CTAS_CONTABLES', 'CCC_ACTIVABLE', 'NUMBER(1,0) DEFAULT 0', 'Marca si la cuenta contable es activable'),
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_CTAS_CONTABLES', 'CCC_PLAN_VISITAS', 'NUMBER(1,0) DEFAULT 0', 'Plan Visitas')
  );  
  V_TMP_COL T_COL;
