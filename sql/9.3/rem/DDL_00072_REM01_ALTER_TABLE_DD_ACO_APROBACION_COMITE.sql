...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir campos version
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'DD_ACO_APROBACION_COMITE'; -- Nombre de la tabla a crear
	V_COL1 VARCHAR2(50 CHAR):= 'VERSION'; --Nombre de la columna
	
	V_TIPO1 VARCHAR2(250 CHAR):= 'NUMBER(38,0)';--Tipo nuevo campo
...
--Comprobacion de la tabla
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                -- Añadimos el campo
                EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD '||V_COL1||' '||V_TIPO1||' DEFAULT 0 NOT NULL';    
                
                V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL1||' IS ''Número de la VERSION''';
