...
--## FECHA_CREACION=20200822
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-10767
--## PRODUCTO=NO
--## 
--## Finalidad: Incluir campo GLD_MATRICULA_REF en tabla gld_gastos_linea_detalle.
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
      -- Recordatorios
  	  T_COL(''||V_ESQUEMA||'', 'GLD_GASTOS_LINEA_DETALLE', 'GLD_MATRICULA_REF', 'VARCHAR2(50 CHAR)', 'Matricula para refacturados')
