...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_CTAS_CONTABLES', 'DD_TCH_ID', 'NUMBER(16)', 'Tipo de comisionado HRE'),
    T_COL('CREATE_COLUMN', 'ACT_CONFIG_PTDAS_PREP', 'DD_TCH_ID', 'NUMBER(16)', 'Tipo de comisionado HRE'),
    T_COL('CREATE_COLUMN', 'GIC_GASTOS_INFO_CONTABILIDAD', 'DD_TCH_ID', 'NUMBER(16)', 'Tipo de comisionado HRE'),
    T_COL('ADD_CONSTRAINT', 'ACT_CONFIG_CTAS_CONTABLES', 'FK_CCC_DD_TCH', 'DD_TCH_ID','DD_TCH_TIPO_COMISIONADO_HRE','DD_TCH_ID'),
    T_COL('ADD_CONSTRAINT', 'ACT_CONFIG_PTDAS_PREP', 'FK_CPP_DD_TCH', 'DD_TCH_ID','DD_TCH_TIPO_COMISIONADO_HRE','DD_TCH_ID'),
    T_COL('ADD_CONSTRAINT', 'GIC_GASTOS_INFO_CONTABILIDAD', 'FK_GIC_DD_TCH', 'DD_TCH_ID','DD_TCH_TIPO_COMISIONADO_HRE','DD_TCH_ID')
  );  
  V_TMP_COL T_COL;
