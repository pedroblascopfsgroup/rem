...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    ...
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'DD_CRA_ID'),
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'DD_SCR_ID'),
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'AGS_ACTIVO_GENERICO'),
    T_COL('ADD_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'PRO_ID', 'NUMBER(16) NOT NULL'),
    T_COL('ADD_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'AGS_ACTIVO_GENERICO', 'NUMBER(16) NOT NULL'),
