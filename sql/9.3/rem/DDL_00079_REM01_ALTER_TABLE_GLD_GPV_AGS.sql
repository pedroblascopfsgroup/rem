...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('MOVE_COLUMN', 'GPV_GASTOS_PROVEEDOR', 'GPV_GASTO_SIN_ACTIVOS', 'GLD_GASTOS_LINEA_DETALLE', 'GLD_LINEA_SIN_ACTIVOS','NUMBER(1) DEFAULT 0'),
    T_COL('DROP_CONSTRAINT', 'ACT_AGS_ACTIVO_GENERICO_STG', 'UK_AGS_ACTIVO_GENERICO'),
    T_COL('DROP_CONSTRAINT', 'ACT_AGS_ACTIVO_GENERICO_STG', 'FK_AGS_PRO_ID'),
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'DD_CRA_ID', '0'),
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'DD_SCR_ID', '0'),
    T_COL('DROP_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'AGS_ACTIVO_GENERICO', '1'),
    T_COL('ADD_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'PRO_ID', 'NUMBER(16) NOT NULL', '0'),
    T_COL('ADD_COLUMN', 'ACT_AGS_ACTIVO_GENERICO_STG', 'AGS_ACTIVO_GENERICO', 'VARCHAR2(50 CHAR)', '1'),
    T_COL('ADD_UK', 'ACT_AGS_ACTIVO_GENERICO_STG', 'UK_AGS_ACTIVO_GENERICO', 'DD_STG_ID, PRO_ID, AGS_ANYO, AGS_ACTIVO_GENERICO'),
    T_COL('ADD_FK', 'ACT_AGS_ACTIVO_GENERICO_STG', 'FK_AGS_PRO_ID', 'ACT_PRO_PROPIETARIO','PRO_ID')
  );  
  V_TMP_COL T_COL;
