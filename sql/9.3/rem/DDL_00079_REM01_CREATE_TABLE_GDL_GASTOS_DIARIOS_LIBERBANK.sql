...
IF TABLE_COUNT = 0 THEN
    ...
    V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD CONSTRAINT CK_GDL_GASTOS_DIARIOS_LIBERBANK CHECK ((BORRADO = 0 AND FECHABORRAR IS NULL) OR BORRADO = 1)';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD CONSTRAINT UK_GDL_GASTOS_DIARIOS_LIBERBANK UNIQUE (GPV_ID, BORRADO, FECHABORRAR)';
    EXECUTE IMMEDIATE V_MSQL;
