...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('DROP_CONSTRAINT', 'GLD_ENT', 'UK_GLD_ENT'),
    T_COL('CREATE_CONSTRAINT', 'GLD_ENT', 'UK_GLD_ENT','GLD_ID, DD_ENT_ID, ENT_ID, FECHABORRAR, BORRADO'),
    T_COL('DROP_CONSTRAINT', 'GLD_ENT', 'CK_GLD_ENT'),
    T_COL('ADD_CHECK_CONSTRAINT', 'GLD_ENT', 'CK_GLD_ENT','(BORRADO = 0 AND FECHABORRAR IS NULL) OR BORRADO = 1')
  );  
  V_TMP_COL T_COL;
