...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
		...
		WHERE OFR.'||V_TMP_TIPO_DATA(1)||' <> (SELECT DD_SIN_ID FROM '||V_ESQUEMA_M||'.DD_SIN_SINO WHERE DD_SIN_CODIGO = ''02'')
		OR OFR.'||V_TMP_TIPO_DATA(1)||' <> (SELECT DD_SIN_ID FROM '||V_ESQUEMA_M||'.DD_SIN_SINO WHERE DD_SIN_CODIGO = ''01'')';
		EXECUTE IMMEDIATE V_MSQL;
