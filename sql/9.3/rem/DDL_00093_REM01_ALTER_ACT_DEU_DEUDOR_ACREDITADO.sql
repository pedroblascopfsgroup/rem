...
--## INCIDENCIA_LINK=HREOS-11258
--## PRODUCTO=NO
--##
--## Finalidad: Eliminar campo DND en la tabla ACT_DEU_DEUDOR_ACREDITADO
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'ACT_DEU_DEUDOR_ACREDITADO'; -- Nombre de la tabla a crear
	V_COL VARCHAR2(50 CHAR):= 'COM_ID'; --Nombre de la columna
