...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_MAA_MOTIVO_AMPLIACION_ARRAS
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_MAA_MOTIVO_AMPLIACION_ARRAS'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'MAA';
...
BEGIN
    ...
    -- Creamos comentario	
	V_MSQL := 'COMMENT ON TABLE '||V_ESQUEMA||'.'||V_TABLA||' IS ''Tabla para gestionar los motivos de ampliación de arras.''';		
	EXECUTE IMMEDIATE V_MSQL;
