...
--## PRODUCTO=NO
--## Finalidad: Actualizamos/Creamos columnas en ACT_SAREB_ACTIVOS
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_EAS_ID',					'NUMBER (16,0)',	'Relación con DD_EAS_ESTADO_ADECUACION_SAREB',		'FK_DD_EAS_ACT_SAREB',		''||V_ESQUEMA||'.DD_EAS_ESTADO_ADECUACION_SAREB',		'DD_EAS_ID'),
    	T_ALTER(  'FECHA_PREV_ADECUACION',		'DATE',	'Fecha fin prevista adecuación SAREB',	'0')
	);
	V_T_ALTER T_ALTER;
