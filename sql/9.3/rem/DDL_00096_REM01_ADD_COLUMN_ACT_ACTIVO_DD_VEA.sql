...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_VEA_ID',			'NUMBER(16)',			'Identificador único del estado fisico del activo DND')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACT_DD_VEA',			'DD_VEA_ID',		V_ESQUEMA||'.DD_VEA_VALIDA_ESTADO_ACTIVO',				'DD_VEA_ID')
    );
    V_T_FK T_FK;
