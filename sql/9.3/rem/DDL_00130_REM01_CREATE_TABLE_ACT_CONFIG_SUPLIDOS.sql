...
BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD CONSTRAINT UK_DICCIONARIOS UNIQUE (DD_CRA_ID, DD_SCR_ID, DD_TGA_ID, DD_STG_ID) ENABLE';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.UK_DICCIONARIOS... Unique key creada.');
