...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ACT_ART_AGENDA_REV_TITULO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
      ...
      T_FK( 'FK_ART_ACT_OBS', 'AOB_ID', 'ACT_AOB_ACTIVO_OBS', 'AOB_ID')
    );
    V_T_FK T_FK;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_ART_AGENDA_REV_TITULO');
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_ART_AGENDA_REV_TITULO');
