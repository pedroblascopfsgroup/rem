...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'TIPO_TIT_ACT_ENT_REF',		'NUMBER (16,0)',	'Identificador único FK a DD_TTA_TIPO_TITULO_ACTIVO',		'FK_TIPO_TIT_ACT_ENT_REF',		''||V_ESQUEMA||'.DD_TTA_TIPO_TITULO_ACTIVO',		'DD_TTA_ID'),
    	T_ALTER(  'SUBTIPO_TIT_ACT_ENT_REF',	'NUMBER (16,0)',	'Identificador único FK a DD_STA_SUBTIPO_TITULO_ACTIVO',	'FK_SUBTIPO_TIT_ACT_ENT_REF',		''||V_ESQUEMA||'.DD_STA_SUBTIPO_TITULO_ACTIVO',		'DD_STA_ID')
	);
	V_T_ALTER T_ALTER;
