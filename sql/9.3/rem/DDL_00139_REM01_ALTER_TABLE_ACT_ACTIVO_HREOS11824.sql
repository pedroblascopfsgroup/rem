...
--## INCIDENCIA_LINK=HREOS-11824
--## PRODUCTO=NO
--## Finalidad: Insertar nueva columna en la tabla ACT_ACTIVO
--##           
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TTA_ID_BBVA',			'NUMBER (16,0)',	'FK A DD_TTA_TIPO_TITULO_ACTIVO',	'FK_ACT_TTA_ID_BBVA', ''||V_ESQUEMA||'.DD_TTA_TIPO_TITULO_ACTIVO', 'DD_TTA_ID')
	);
	V_T_ALTER T_ALTER;
