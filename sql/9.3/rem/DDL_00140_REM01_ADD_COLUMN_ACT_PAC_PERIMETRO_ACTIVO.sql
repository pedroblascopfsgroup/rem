...
DECLARE
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
        ...
        T_FK(   'FK_PAC_EXCLUIR_VALIDACIONES',   'PAC_EXCLUIR_VALIDACIONES',    V_ESQUEMA_M||'.DD_SIN_SINO',               'DD_SIN_ID'),
        T_FK(   'FK_PAC_MOTIVO_GESTION_COMERCIAL',   'PAC_MOTIVO_GESTION_COMERCIAL',    V_ESQUEMA||'.DD_MGC_MOTIVO_GEST_COMERCIAL',               'DD_MGC_ID')
