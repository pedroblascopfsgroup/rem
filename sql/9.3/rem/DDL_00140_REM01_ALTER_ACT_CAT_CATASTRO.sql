...
--## INCIDENCIA_LINK=HREOS-12072
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna CAT_FECHA_ALTERACION en la tabla ACT_CAT_CATASTRO.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(50):= 'CAT_FECHA_ALTERACION'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Fecha de alteración del catastro'; -- Vble. para los comentarios de las tablas
...
BEGIN
	...
	ELSE
		...
		EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD ('||V_COLUMN_NAME||' DATE)';
