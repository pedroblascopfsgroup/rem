...
--## INCIDENCIA_LINK=HREOS-12073
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna TAS_ILOCALIZABLE en la tabla ACT_TAS_TASACION.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(50):= 'TAS_ILOCALIZABLE'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Flag para indicar si el activo es o no localizable'; -- Vble. para los comentarios de las tablas
...
BEGIN
	...
	ELSE
		...
		EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD ('||V_COLUMN_NAME||' NUMBER(1))';
