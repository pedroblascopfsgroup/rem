...
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir 4 columnas en la tabla OFR_OFERTAS
--##
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(				
    	T_ALTER('OFR_RECOMENDACION_RC','VARCHAR2(5 CHAR)'),
		T_ALTER('OFR_FECHA_RECOMENDACION_RC','DATE'),
		T_ALTER('OFR_RECOMENDACION_DC','VARCHAR2(5 CHAR)'),
		T_ALTER('OFR_FECHA_RECOMENDACION_DC','DATE')
	);
    V_T_ALTER T_ALTER;
