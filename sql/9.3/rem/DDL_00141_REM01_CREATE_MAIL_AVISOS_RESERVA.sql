...
--## 
--## Finalidad: DDL
--## INSTRUCCIONES: Crear tabla para mandar correos MAIL_AVISOS_RESERVA
--## VERSIONES:
--##        0.1 Versión inicial 
--##########################################
--*/
...
DECLARE
    ...
    V_TABLA VARCHAR2(32 CHAR) := 'MAIL_AVISOS_RESERVA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
