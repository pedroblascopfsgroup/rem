...
--## INCIDENCIA_LINK=HREOS-12185
--## PRODUCTO=NO
--##
--## INSTRUCCIONES: Agregar nueva columna a la tabla DD_SAC_SUBTIPO_ACTIVO
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-12185'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_SAC_SUBTIPO_ACTIVO'; 		-- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_SAC_EN_BBVA', 'NUMBER(1,0)','DEFAULT 0', 'Indica si el subtipo es para activos de BBVA')
    ); 
