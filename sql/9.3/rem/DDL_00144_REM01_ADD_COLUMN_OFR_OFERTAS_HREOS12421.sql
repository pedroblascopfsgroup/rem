...
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columna FECHA_ENT_CRM_SF en la tabla OFR_OFERTAS
--##
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-12421'; -- USUARIOCREAR/USUARIOMODIFICAR.
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('FECHA_ENT_CRM_SF', 'DATE', 'Fecha entrada CRM/SF')
    ); 
