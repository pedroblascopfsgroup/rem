...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-8566'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TABLA VARCHAR2(100 CHAR):='AUX_APR_MAIN_TASACIONES_BBVA'; --Vble. auxiliar para la tabla a actualizar
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ILOCALIZABLE', 'VARCHAR2(1 CHAR)')
    ); 
