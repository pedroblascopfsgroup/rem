...
DECLARE
	...
	V_KEY_NAME_SRA VARCHAR2(50 CHAR):= 'FK_GIC_INV_SUJ_DD_SIN';
	
    --Nombre de las columnas
        V_COL_SCG VARCHAR2(50 CHAR):= 'GIC_INV_SUJ_PASIVO'; 
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                EXECUTE IMMEDIATE V_MSQL;
	  			...
	  			V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL_SCG||' IS ''Inversión de sujeto pasivo.''';
                EXECUTE IMMEDIATE V_MSQL; 					
            ELSE
