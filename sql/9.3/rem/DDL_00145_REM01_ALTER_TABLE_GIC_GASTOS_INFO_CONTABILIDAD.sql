...
--## INCIDENCIA_LINK=HREOS-12299
--## PRODUCTO=NO
--## Finalidad: Añadir nuevo campo en la tabla GIC
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(50 CHAR):= 'GIC_GASTOS_INFO_CONTABILIDAD'; -- Nombre de la tabla 
    
    --Tipos de campo
    V_TIPO_NUM_LONG VARCHAR2(250 CHAR):= 'NUMBER(16,0)';
	
    -- Nombre de tablas a REFERENCIAR
	V_TABLA_REF_SRA VARCHAR2(50 CHAR):= 'DD_TRT_TRIBUTOS_A_TERCEROS';
	V_TABLA_REF_COL VARCHAR2(50 CHAR):= 'DD_TRT_ID';
	V_KEY_NAME_SRA VARCHAR2(50 CHAR):= 'FK_GIC_DD_TRT_ID';
	
    --Nombre de las columnas
        V_COL_SCG VARCHAR2(50 CHAR):= 'DD_TRT_ID'; 
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                EXECUTE IMMEDIATE V_MSQL;
	  			...
	  			V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL_SCG||' IS ''Tributos a terceros. Sólo usado en ETL gastos de gestorías a REM.''';
                EXECUTE IMMEDIATE V_MSQL; 					
            ELSE
