...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-11298'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'ACT_TBJ_TRABAJO'; 
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('TBJ_PRIM_TOMA_POS', 'NUMBER(1,0)', 'Indicador de Toma de Posesion')
    ); 
