...
--## PRODUCTO=NO
--## 
--## Finalidad: Incluir campos en la tabla ACT_BBVA_ACTIVOS - el campo BBVA_TIPO_ACTIVO
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    ...
    T_COL(''||V_ESQUEMA||'', 'ACT_BBVA_ACTIVOS', 'BBVA_TIPO_ACTIVO', 'VARCHAR2(20 CHAR)', 'Tipo activo BBVA')
