...
BEGIN	
	...
	CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
	    ...
	    , "NUM_ACTIVO_CLIENTE"            VARCHAR2(250 CHAR)
	    ...
	    , "FASE"                          VARCHAR2(250 CHAR)
	    , "ID_PRINEX"                     NUMBER(16, 0)
	    , "ID_CLIENTE"                    NUMBER(16, 0)
	    , "ID_UFIR"                       VARCHAR2(250 CHAR)
	    , "REF_CATASTRAL"                 VARCHAR2(250 CHAR)
	    , "FECHA_REGISTRO"                DATE
	    , "NUM_DORMITORIOS"               NUMBER(10, 0)
	    , "NUM_BANYOS"                    NUMBER(10, 0)
	    , "SUP_UTIL_DESCRIPTOR"           NUMBER(16, 2)
	    , "SUP_CONSTRUIDA_DESCRIPTOR"     NUMBER(16, 2)
	    , "DESTINO_COMERCIAL"             VARCHAR2(250 CHAR)
	    , "FECHA_INI_COMERCIALIZACION"    DATE
	    , "SITUACION_COMERCIAL"           VARCHAR2(250 CHAR)
	    , "SITUACION_OCUPACIONAL"         VARCHAR2(250 CHAR)
	    ...
	    , "LIQUIDEZ"                      VARCHAR2(250 CHAR)
	    , "REGISTRADOR_PROPIEDAD"         VARCHAR2(250 CHAR)
	    , "REGISTRO"                      VARCHAR2(250 CHAR)
	    , "MUNICIPIO_REGISTRO"            VARCHAR2(250 CHAR)
	    , "LIBRO"                         VARCHAR2(250 CHAR)
	    , "TOMO"                          VARCHAR2(250 CHAR)
	    , "HOJA"                          VARCHAR2(250 CHAR)
	    , "PROPIETARIO"                   NUMBER(16, 0)
	    , "PROPIETARIO_NOMBRE"            VARCHAR2(250 CHAR)
	    ...
	    , "ESTADO_FISICO_ACTIVO"          VARCHAR2(250 CHAR)
	    , "ESTADO_BANCO_ESPANA"           VARCHAR2(250 CHAR)
	    , "SUBESTADO_BANCO_ESPANA"        VARCHAR2(250 CHAR)
