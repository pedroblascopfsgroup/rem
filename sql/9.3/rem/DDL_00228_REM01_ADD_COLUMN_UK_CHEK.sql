...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('ADD_UK', 'CFM_CONFIGURACION_REAM', 'UK_CFM_CONFIGURACION_REAM_SIN_REPETIDOS','DD_CRA_ID, DD_SCR_ID, PRO_ID, CFM_CARTERA_MAC, BORRADO, FECHABORRAR'),
    T_COL('ADD_CHECK_CONSTRAINT', 'CFM_CONFIGURACION_REAM', 'CK_CFM_CONFIGURACION_REAM_SIN_REPETIDOS','(BORRADO = 0 AND FECHABORRAR IS NULL) OR BORRADO = 1')
  );  
  V_TMP_COL T_COL;
