...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_RDC_ID',			'NUMBER(16)',			'Identificador único del responsable de la documentacion de cliente'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_RDC',			'DD_RDC_ID',		V_ESQUEMA||'.DD_RDC_RESPONSABLE_DOCUMENTACION_CLIENTE',				'DD_RDC_ID')
    );
    V_T_FK T_FK;
