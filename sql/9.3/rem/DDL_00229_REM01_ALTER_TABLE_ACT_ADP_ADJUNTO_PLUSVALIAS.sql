...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'ACT_ADP_ADJUNTO_PLUSVALIAS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(				
    	T_ALTER('USUARIOCREAR','VARCHAR2 (50 CHAR)'),
