...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'TXO_TEXTOS_OFERTA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(				
    	T_ALTER('TXO_TEXTO','VARCHAR2 (3000 CHAR)')
	);
    V_T_ALTER T_ALTER;
