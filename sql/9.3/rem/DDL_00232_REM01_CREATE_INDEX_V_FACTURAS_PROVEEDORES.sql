...
--## PRODUCTO=NO
--## Finalidad: Creación índices para V_FACTURAS_PROVEEDORES
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('ACT_PRO_PROPIETARIO_IDX2', 'ACT_PRO_PROPIETARIO', 'PRO_CODIGO_UVEM,BORRADO,PRO_ID'),
        T_TIPO_DATA('GPV_GASTOS_PROVEEDOR_IDX8', 'GPV_GASTOS_PROVEEDOR', 'BORRADO, GPV_ID, GPV_EXISTE_DOCUMENTO'),
        T_TIPO_DATA('GPV_GASTOS_PROVEEDOR_IDX9', 'GPV_GASTOS_PROVEEDOR', 'BORRADO, GPV_ID, GPV_NUM_GASTO_HAYA')
    ); 
