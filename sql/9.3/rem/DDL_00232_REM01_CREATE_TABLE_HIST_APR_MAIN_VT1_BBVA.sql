...
--## INCIDENCIA_LINK=REMVIP-9460
--## PRODUCTO=NO
--## Finalidad: Creacion HIST_APR_MAIN_VT1_BBVA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'HIST_APR_MAIN_VT1_BBVA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
