...
--## INCIDENCIA_LINK=REMVIP-9487
--## PRODUCTO=NO
--## Finalidad: Creacion AUX_APR_MAIN_VT1_BBVA_EXT
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'AUX_APR_MAIN_VT1_BBVA_EXT'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
