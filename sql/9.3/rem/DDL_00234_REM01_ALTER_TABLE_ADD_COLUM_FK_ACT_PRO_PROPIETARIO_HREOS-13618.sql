...
--## PRODUCTO=NO
--## Finalidad: Creacion columna en tabla ACT_PRO_PROPIETARIO (FK a tabla DD_TSP_TIPO_CORREO )
--##           
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	        ...
    	        T_ALTER(  'DD_TSP_ID',					'NUMBER (16,0)',	    ' Fk a la tabla DD_TSP_TIPO_CORREO',		'FK_DD_TSP_TIPO_CORREO',		''||V_ESQUEMA||'.DD_TSP_TIPO_CORREO',		'DD_TSP_ID')
	);
	V_T_ALTER T_ALTER;
...
BEGIN
	...
	END LOOP;
	 ...
	 -- Creamos comentario
		V_SQL := 'COMMENT ON COLUMN ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||'.DD_TSP_ID IS ''Fk a la tabla DD_TSP_TIPO_CORREO''';
        EXECUTE IMMEDIATE V_SQL;
