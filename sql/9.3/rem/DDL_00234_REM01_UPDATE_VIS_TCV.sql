...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla VIS_VISITAS
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TCV_ID',			'NUMBER(16)',			'Identificador único del tipo de comercializacion de la visita'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_VIS_TCV',					'DD_TCV_ID',		V_ESQUEMA||'.DD_TCV_TIPO_COM_VISITA',				'DD_TCV_ID')
    );
    V_T_FK T_FK;
