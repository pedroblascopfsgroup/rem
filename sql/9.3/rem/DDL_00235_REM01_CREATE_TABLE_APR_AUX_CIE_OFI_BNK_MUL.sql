...
--## PRODUCTO=NO
--## Finalidad: DDL Creación de la tabla APR_AUX_CIE_OFI_BNK_MUL
--##           
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(30 CHAR):= 'APR_AUX_CIE_OFI_BNK_MUL';
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA|| '.'||V_TEXT_TABLA||'...');
		...
		(
            CIEOFI_ID	            NUMBER(16,0)    NOT NULL
	...
	-- Creamos primary key
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT '||V_TEXT_TABLA||'_PK PRIMARY KEY (CIEOFI_ID))';
	EXECUTE IMMEDIATE V_MSQL;
