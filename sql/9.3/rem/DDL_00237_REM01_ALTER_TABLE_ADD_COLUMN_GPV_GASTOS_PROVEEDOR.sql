...
--## INCIDENCIA_LINK=REMVIP-10048
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columna a tabla GPV_GASTO_PROVEEDOR
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'GPV_GASTOS_PROVEEDOR', 'GPV_SOLICITUD_PAGO_URGENTE', 'NUMBER(1,0)', 'Check solicitud pago urgente')
  );  
  V_TMP_COL T_COL;
        ...
        IF 'CREATE_COLUMN' = ''||V_TMP_COL(1)||'' THEN
            ...
            IF V_NUM_TABLAS = 1 THEN              
                ...
                IF V_NUM_TABLAS = 0 THEN
                    ...
                    EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TMP_COL(2)||' ADD '||V_TMP_COL(3)||' '||V_TMP_COL(4)||' DEFAULT 0'; 
