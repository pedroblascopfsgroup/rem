...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											
			T_TIPO_DATA('OFR_SOSPECHOSA', 'NUMBER(1,0) DEFAULT 0', 'Oferta sospechosa')
    ); 
...
BEGIN
    ...
    LOOP      
      ...
      V_MSQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE OWNER = '''||V_ESQUEMA||''' AND TABLE_NAME = UPPER('''||V_TEXT_TABLA||''')';
