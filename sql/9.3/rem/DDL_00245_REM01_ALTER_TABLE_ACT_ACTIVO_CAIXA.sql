...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('FECHA_ECA_EST_COM_ALQUILER','DATE','Fecha estado comercial alquiler del activo'),
      T_ALTER('FECHA_ECV_EST_COM_VENTA','DATE','Fecha estado comercial venta del activo'),
      T_ALTER('FECHA_EAT_EST_TECNICO','DATE','Fecha estado técnico')
		);
    V_T_ALTER T_ALTER;
