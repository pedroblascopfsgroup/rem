...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-13942'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('ACT_NUM_ACTIVO_CAIXA', 'VARCHAR2(55 CHAR)', 'Código identificador único del activo en CAIXA.')
    ); 
...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_ACTIVO');
