...
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas TIPO_IMPUESTO y PORCENTAJE_IMPUESTO en H_APR_AUX_I_RU_LFACT_SIN_PROV
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'H_APR_AUX_I_RU_LFACT_SIN_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	  ...
    	  T_ALTER(  'TIPO_IMPUESTO',		  'VARCHAR2(2 CHAR) ',		'Tipo impuesto'	),
    	  T_ALTER(  'PORCENTAJE_IMPUESTO',		  'VARCHAR2(5 CHAR) ',		'Porcentaje impuesto'	)
	);
	V_T_ALTER T_ALTER;
