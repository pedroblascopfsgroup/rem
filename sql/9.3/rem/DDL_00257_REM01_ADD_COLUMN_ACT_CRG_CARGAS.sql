...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('CRG_ID_EXTERNO', 'NUMBER(16,0)', 'ID externo')
    ); 
    V_TMP_TIPO_DATA T_TIPO_DATA;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_CRG_CARGAS');
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_CRG_CARGAS');
