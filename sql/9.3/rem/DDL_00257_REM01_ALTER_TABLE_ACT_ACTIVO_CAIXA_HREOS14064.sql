...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    			-- NOMBRE CAMPO						     TIPO CAMPO		       COMENTARIO     
		T_ALTER(  'CBX_PRECIO_VENT_NEGO',				'NUMBER(1,0)', 'Indicador Precio Venta Negociable'),
        T_ALTER(  'CBX_PRECIO_ALQU_NEGO',				'NUMBER(1,0)', 'Indicador Precio Alquiler Negociable'),
        T_ALTER(  'CBX_CAMP_PRECIO_VENT_NEGO',			'NUMBER(1,0)', 'Indicador Campaña Precio Venta Negociable'),
        T_ALTER(  'CBX_CAMP_PRECIO_ALQ_NEGO',			'NUMBER(1,0)', 'Indicador Campaña Precio Alquiler Negociable')
		);
    V_T_ALTER T_ALTER;
BEGIN
