...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('CBX_FECHA_EST_TIT_ACT_INM','DATE','Fecha del estado de la titularidad del activo inmobiliario'),
        T_ALTER('CBX_FECHA_EST_POS_ACT_INM','DATE','Fecha del estado posesorio del activo inmobiliario')
    );
    V_T_ALTER T_ALTER;
