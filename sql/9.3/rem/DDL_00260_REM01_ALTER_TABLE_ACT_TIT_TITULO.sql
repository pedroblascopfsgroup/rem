...
--## INCIDENCIA_LINK=HREOS-0008
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la ACT_TIT_TITULO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('FECHA_EST_TIT_ACT_INM','DATE','Fecha del estado de la titularidad del activo inmobiliario')        
    );
    V_T_ALTER T_ALTER;
