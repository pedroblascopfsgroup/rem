...
--## INCIDENCIA_LINK=HREOS-14091
--## PRODUCTO=NO
--##
--## Finalidad:        Anyadir columna a la GPV_GASTOS_PROVEEDOR
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USR VARCHAR2(30 CHAR) := 'HREOS-14091'; 			-- USUARIOCREAR/USUARIOMODIFICAR.
	...
	V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER('GPV_NUM_CONTR_ALQUILER', 		'VARCHAR2(9 CHAR)', 		'', 			'Número de contrato alquiler.')
	);
	V_T_ALTER T_ALTER;
