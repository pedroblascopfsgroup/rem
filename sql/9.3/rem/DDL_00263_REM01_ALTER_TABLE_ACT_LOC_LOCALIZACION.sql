...
--## INCIDENCIA_LINK=HREOS-00001
--## PRODUCTO=NO
--##
--## Finalidad:        Anyadir columna a ACT_LOC_LOCALIZACION
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USR VARCHAR2(30 CHAR) := 'HREOS-00001'; 			-- USUARIOCREAR/USUARIOMODIFICAR.
	...
	V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER('LOC_BLOQUE', 		'VARCHAR2(10 CHAR)', 		'', 			'Bloque')
	);
	V_T_ALTER T_ALTER;
