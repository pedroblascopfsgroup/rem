...
--## INCIDENCIA_LINK=HREOS-14166
--## PRODUCTO=NO
--##
--## Finalidad:        Anyadir columna a ACT_REG_INFO_REGISTRAL
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USR VARCHAR2(30 CHAR) := 'HREOS-14166'; 			-- USUARIOCREAR/USUARIOMODIFICAR.
	V_TABLA VARCHAR2(2400 CHAR) := 'ACT_REG_INFO_REGISTRAL'; 		-- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER('REG_SUPERFICIE_PARCELA_UTIL', 		'NUMBER(16,2)', 		     '', 			'Superficie de la parcela útil del activo.')
	);
	V_T_ALTER T_ALTER;
