...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'ACT_ID',			'NUMBER(16,0)',					'Id de activo'	), 
    	T_ALTER(  'GLD_ID',				'NUMBER(16,0)',					'Id de linea detalle de gasto.'	)
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_ACT_RGS_ACT_ID',			'ACT_ID',		V_ESQUEMA||'.ACT_ACTIVO',					'ACT_ID'),
    	T_FK(	'FK_ACT_RGS_GLD_ID',			'GLD_ID',		V_ESQUEMA||'.GLD_GASTOS_LINEA_DETALLE',			'GLD_ID')
    );
    V_T_FK T_FK;
