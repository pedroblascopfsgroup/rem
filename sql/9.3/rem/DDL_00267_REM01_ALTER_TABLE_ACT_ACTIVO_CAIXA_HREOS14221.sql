...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'CBX_PUBL_PORT_PUBL_VENTA',				'NUMBER(1,0)', 'Indicador único de publicación en portal público de venta'),
        T_ALTER(  'CBX_PUBL_PORT_PUBL_ALQUILER',			'NUMBER(1,0)', 'Indicador único de publicación en portal público de alquiler'),
        T_ALTER(  'CBX_PUBL_PORT_INV_VENTA',			    'NUMBER(1,0)', 'Indicador único de publicación en portal inversor de venta'),
        T_ALTER(  'CBX_PUBL_PORT_INV_ALQUILER',			    'NUMBER(1,0)', 'Indicador único de publicación en portal inversor de alquiler'),
        T_ALTER(  'CBX_PUBL_PORT_API_VENTA',			    'NUMBER(1,0)', 'Indicador único de publicación en portal API de venta'),
        T_ALTER(  'CBX_PUBL_PORT_API_ALQUILER',			    'NUMBER(1,0)', 'Indicador único de publicación en portal API de alquiler')
		);
    V_T_ALTER T_ALTER;
BEGIN
