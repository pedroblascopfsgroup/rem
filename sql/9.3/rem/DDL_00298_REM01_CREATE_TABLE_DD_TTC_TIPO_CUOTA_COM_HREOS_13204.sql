...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TCC_TIPO_CUOTA_COM.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(28 CHAR) := 'DD_TCC_TIPO_CUOTA_COM'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(3 CHAR) := 'TCC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-13204';
 ...
 BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_TCC_ID))';
