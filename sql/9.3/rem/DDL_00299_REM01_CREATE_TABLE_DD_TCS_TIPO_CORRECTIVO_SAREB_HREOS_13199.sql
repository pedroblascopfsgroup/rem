...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TCS_TIPO_CORRECTIVO_SAREB.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(28 CHAR) := 'DD_TCS_TIPO_CORRECTIVO_SAREB'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(3 CHAR) := 'TCS';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-13199';
 ...
 BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_TCS_ID))';
