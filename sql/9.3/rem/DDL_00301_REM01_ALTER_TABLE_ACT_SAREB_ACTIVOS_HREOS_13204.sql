...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_TCC_ID', 'NUMBER(16,0)', 'Relación con diccionario de Tipo de cuota comunidad.')
		); 
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO CAMPOS]');
  	...
  	IF V_NUM_TABLAS > 0 THEN
        ...
        V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT FK_DD_TCC_ID FOREIGN KEY (DD_TCC_ID) REFERENCES '||V_ESQUEMA||'.DD_TCC_TIPO_CUOTA_COM (DD_TCC_ID) ON DELETE SET NULL)';
		EXECUTE IMMEDIATE V_MSQL;
