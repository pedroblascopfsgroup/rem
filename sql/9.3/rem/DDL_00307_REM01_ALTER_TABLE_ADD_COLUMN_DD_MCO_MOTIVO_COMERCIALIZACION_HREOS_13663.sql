...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'DD_MCO_MOTIVO_COMERCIALIZACION', 'DD_MPT_ID', 'NUMBER(16,0)', 'Id Motivos de Inclusión/Exclusión'),
    T_COL('ADD_CONSTRAINT', 'DD_MCO_MOTIVO_COMERCIALIZACION', 'FK_MPT_DD_MPT', 'DD_MPT_ID','DD_MPT_MTV_IN_EX_PERIMETRO','DD_MPT_ID')
  );  
  V_TMP_COL T_COL;
