...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la DD_TAG_TIPO_AGRUPACION
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('DD_VISIBLE_CAMPO','NUMBER(1,0) DEFAULT 1','Visibilidad del campo en los combos de agrupación')
    );
    V_T_ALTER T_ALTER;
