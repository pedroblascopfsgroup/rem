...
--#########################################
--## AUTOR=Daniel Algaba
--## FECHA_CREACION=202106
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=REMVIP-10016
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_RECALC_PUBL_SAREB_ACT'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_RECALC_PUBL_SAREB_ACT';
...
EXECUTE IMMEDIATE 'CREATE TABLE '||V_ESQUEMA_1||'.'||V_TABLA||'
