...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_CRA_ID',		 					'NUMBER(16,0)',						'Cartera del activo.'),
    	T_ALTER(  'DD_CLA_ID',		 					'NUMBER(16,0)',						'Clase del activo.'),
    	T_ALTER(  'DD_TPR_ID',		 					'NUMBER(16,0)',						'Tipo proveedor de la oferta del activo')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CFG_CRA_ID',						'DD_CRA_ID',				V_ESQUEMA||'.DD_CRA_CARTERA',				'DD_CRA_ID'			),
		T_FK(	'FK_CFG_CLA_ID',						'DD_CLA_ID',				V_ESQUEMA||'.DD_CLA_CLASE_ACTIVO',			'DD_CLA_ID'			),
		T_FK(	'FK_CFG_TPR_ID',						'DD_TPR_ID',				V_ESQUEMA||'.DD_TPR_TIPO_PROVEEDOR',		'DD_TPR_ID'			)
    );
    V_T_FK T_FK;
