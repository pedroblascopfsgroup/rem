...
--## INCIDENCIA_LINK=HREOS-14268
--## PRODUCTO=NO
--## 
--## Finalidad: Modificar columna AHT_FECHA_PRES_REGISTRO -> Nulable
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    ...
    T_COL(''||V_ESQUEMA||'', 'ACT_AHT_HIST_TRAM_TITULO', 'AHT_FECHA_PRES_REGISTRO', 'DATE', 'NULL')
    ...
    LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN              
            ...
            IF V_NUM_TABLAS = 1 THEN
                ...
                -- Añadimos el campo
                EXECUTE IMMEDIATE 'ALTER TABLE '||V_TMP_COL(1)||'.'||V_TMP_COL(2)||' MODIFY '||V_TMP_COL(3)||' '||V_TMP_COL(4)||' NULL';
            ELSE
