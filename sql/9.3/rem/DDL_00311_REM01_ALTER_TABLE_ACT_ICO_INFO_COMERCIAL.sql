...
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columna DD_TIC_ID_ANTERIOR y FK a tabla ACT_ICO_INFO_COMERCIAL
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'ACT_ICO_INFO_COMERCIAL', 'DD_TIC_ID_ANTERIOR', 'NUMBER(16,0)', 'Id Tipo informe anterior'),
    T_COL('ADD_CONSTRAINT', 'ACT_ICO_INFO_COMERCIAL', 'FK_DD_TIC_ID_ANTERIOR', 'DD_TIC_ID_ANTERIOR','DD_TIC_TIPO_INFO_COMERCIAL','DD_TIC_ID')
  );  
  V_TMP_COL T_COL;
