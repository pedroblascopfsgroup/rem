...
DECLARE
    ...
    V_COL VARCHAR2(32 CHAR) := 'OFR_FECHA_OFERTA_PENDIENTE';
 ...
 BEGIN
	...
	IF V_COUNT = 1 THEN 
        ...
        IF V_COUNT = 0 THEN 
            ...
            V_SQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.OFR_OFERTAS.'||V_COL||' IS ''Fecha de la primera vez que la oferta ha estado en estado pendiente.''';
