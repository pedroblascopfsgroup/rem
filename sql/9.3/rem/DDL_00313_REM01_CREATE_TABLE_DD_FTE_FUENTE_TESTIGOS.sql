...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de fuentes para testigos opcionales
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_FTE_FUENTE_TESTIGOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'FTE'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de fuentes para testigos opcionales'; -- Vble. para los comentarios de las tablas
