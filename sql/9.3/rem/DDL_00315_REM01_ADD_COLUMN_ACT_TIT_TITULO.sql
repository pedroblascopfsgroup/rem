...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_TIT_TITULO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER( 'TIT_PLUSVALIA_COMPRADOR', 'NUMBER(1,0)', 'Plusvalia del comprador'),
		T_ALTER( 'TIT_FECHA_LIQUIDACION_PLUSVALIA', 'DATE', 'fecha de liquidacion de la plusvalia')
		);
    V_T_ALTER T_ALTER;
