...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de estado informe mediador
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_ESI_ESTADO_INFORME_MEDIADOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'ESI'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de estado informe mediador'; -- Vble. para los comentarios de las tablas
