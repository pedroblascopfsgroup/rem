...
--##           
--## INSTRUCCIONES: Inserta columna RESERVADO_ALQUILER en la tabla ECO_EXPEDIENTE_COMERCIAL
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(2400 CHAR) := 'RESERVADO_ALQUILER'; -- Vble. auxiliar para almacenar el nombre de la columna a añadir.
...
BEGIN
	...
	V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TEXT_TABLA||'.'||V_COLUMN_NAME||' IS ''Campo check reservado alquiler'' ';
