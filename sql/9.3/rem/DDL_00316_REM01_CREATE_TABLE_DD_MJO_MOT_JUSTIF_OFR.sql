...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de motivo justificacion de oferta
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'DD_MJO_MOT_JUSTIF_OFR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(5 CHAR) := 'MJO'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
