...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de valores para financiacion
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'DD_SNS_SINONOSABE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(5 CHAR) := 'SNS'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
