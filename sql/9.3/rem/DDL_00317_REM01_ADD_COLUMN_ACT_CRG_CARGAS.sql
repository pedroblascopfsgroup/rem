...
--## INCIDENCIA_LINK=HREOS-15591
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_CRG_CARGAS
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER( 'CRG_FECHA_SOLICITUD_CARTA', 'DATE', 'fecha de solicitud de la carta'),
		T_ALTER( 'CRG_FECHA_RECEPCION_CARTA', 'DATE', 'fecha de recepcion de la carta'),
		T_ALTER( 'CRG_FECHA_PRESENTACION_CARTA', 'DATE', 'fecha de presentacion de la carta')
		);
    V_T_ALTER T_ALTER;
