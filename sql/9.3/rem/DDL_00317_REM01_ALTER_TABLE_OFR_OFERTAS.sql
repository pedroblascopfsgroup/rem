...
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir campo diccionario
--##
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'OFR_OFERTAS', 'DD_MJO_ID', 'NUMBER(16,0)', 'Relación con motivo justificación oferta'),
    T_COL('ADD_CONSTRAINT', 'OFR_OFERTAS', 'FK_OFR_DD_MJO_ID', 'DD_MJO_ID','DD_MJO_MOT_JUSTIF_OFR','DD_MJO_ID')
  );  
  V_TMP_COL T_COL;
