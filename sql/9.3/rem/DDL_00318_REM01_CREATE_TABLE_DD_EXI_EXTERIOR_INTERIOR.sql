...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de exterior interior
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_EXI_EXTERIOR_INTERIOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'EXI'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de exterior interior'; -- Vble. para los comentarios de las tablas
