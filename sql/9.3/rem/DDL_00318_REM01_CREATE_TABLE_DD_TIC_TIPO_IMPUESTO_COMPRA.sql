...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TIC_TIPO_IMPUESTO_COMPRA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TIC_TIPO_IMPUESTO_COMPRA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'TIC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-14???';
	V_MSQL VARCHAR2(32000 CHAR); -- Sentencia a ejecutar 
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tipo Impuesto de la compra'; -- Vble. para los comentarios de las tablas
 ...
 BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_TIC_ID))';
