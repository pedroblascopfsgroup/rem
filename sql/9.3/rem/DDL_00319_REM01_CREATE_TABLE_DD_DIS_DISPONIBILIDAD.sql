...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de disponibilidad
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_DIS_DISPONIBILIDAD'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'DIS'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de disponibilidad'; -- Vble. para los comentarios de las tablas
