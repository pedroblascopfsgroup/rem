...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_SIC_SUBTIPO_IMPUESTO_COMPRA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_SIC_SUBTIPO_IMPUESTO_COMPRA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'SIC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-14???';
	V_MSQL VARCHAR2(32000 CHAR); -- Sentencia a ejecutar 
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Subtipo de Impuesto de la compra'; -- Vble. para los comentarios de las tablas
 ...
 BEGIN
	...
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (DD_SIC_ID))';
