...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de motivos de indisponibilidad
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_MTI_MOTIVO_INDISPONIB'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'MTI'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de motivo de indisponibilidad'; -- Vble. para los comentarios de las tablas
