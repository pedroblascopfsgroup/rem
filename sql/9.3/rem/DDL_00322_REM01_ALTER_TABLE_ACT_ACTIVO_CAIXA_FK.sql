...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('DD_CVC_ID','NUMBER(16,0)','FK a DD_CVC_CARTERA_VENTA_CREDITOS','FK_DD_CVC_ID_CAIXA','DD_CVC_CARTERA_VENTA_CREDITOS'),
        T_ALTER('DD_CVA_ID','NUMBER(16,0)','FK a DD_CVA_CARTERA_VENTA_ACT','FK_DD_CVA_ID_CAIXA','DD_CVA_CARTERA_VENTA_ACT')
    );
    V_T_ALTER T_ALTER;
