...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la ACT_ACTIVO_CAIXA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('CBX_CARTERA_CONCENTRADA',              'NUMBER(1,0)','Flag Activo cartera concentrada.'),
        T_ALTER('CBX_ACTIVO_AAMM',                      'NUMBER(1,0)','Flag Activo AAMM'),
        T_ALTER('CBX_ACTIVO_PROM_ESTR',                 'NUMBER(1,0)','Flag Activo promociones estratégicas'),
        T_ALTER('CBX_FEC_INI_CONCU',                    'DATE','Fecha inicio concurrencia'),
        T_ALTER('CBX_FEC_FIN_CONCU',                    'DATE','Fecha fin concurrencia'),
        T_ALTER('CBX_ANYO_CONCES',                      'NUMBER(4,0)','Año de concesión'),
        T_ALTER('CBX_FEC_FIN_CONCES',                   'DATE','Fecha fin de conceción')            
    );
    V_T_ALTER T_ALTER;
