...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de valoracion ubicacion
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_VUB_VALORACION_UBICACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'VUB'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de valoracion ubicacion'; -- Vble. para los comentarios de las tablas
