...
--## FECHA_CREACION=20211024
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-16059
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_FOT_FOTO
--##           
--## INSTRUCCIONES: Anyadir la columna FOT_SUELOS
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'FOT_SUELOS', 'NUMBER(1,0)', 'Foto de los suelos'	)
		);
    V_T_ALTER T_ALTER;
