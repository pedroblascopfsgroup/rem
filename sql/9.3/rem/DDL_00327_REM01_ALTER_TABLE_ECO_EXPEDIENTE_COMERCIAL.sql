...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'ECO_ESTADO_ARRAS',							'NUMBER(1,0)',			'Estado PBC 0 Rechazado 1 Aceptado'),
		T_ALTER(  'ECO_ESTADO_CN',							    'NUMBER(1,0)',			'Estado PBC 0 Rechazado 1 Aceptado')
     );
     V_T_ALTER T_ALTER;
BEGIN
