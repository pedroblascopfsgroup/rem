...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] MODIFICAR ICO_ADMITE_MASCOTAS = 3 A NULL POR CONSTRAINT');
    V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' SET ICO_ADMITE_MASCOTAS = NULL WHERE ICO_ADMITE_MASCOTAS = 3';
