...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    ...
    T_COL('ADD_COLUMN', 'ICO_CALEFACCION', 'NUMBER(16,0)', 'Id Calefaccion del activo'),
    T_COL('ADD_CONSTRAINT', 'FK_ICO_ICO_CALEFACCION', 'ICO_CALEFACCION','DD_TCL_TIPO_CLIMATIZACION','DD_TCL_ID',''),
