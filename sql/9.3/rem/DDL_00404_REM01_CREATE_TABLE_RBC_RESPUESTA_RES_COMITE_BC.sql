...
--## PRODUCTO=NO
--## Finalidad: Creación tabla RBC_RESPUESTA_RES_COMITE_BC
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'RBC_RESPUESTA_RES_COMITE_BC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla con los datos de la respuesta del ws de caixa de resolución de comité'; -- Vble. para los comentarios de las tablas
...
BEGIN
    ...
    ELSE
            ...
            (
                RBC_ID          		    NUMBER(16)             	NOT NULL,
                ECO_ID        		        NUMBER(16)				NOT NULL,
                RBC_VALIDACION_BC           NUMBER(16),
				RBC_FECHA_RESP_BC           DATE,
                RBC_OBSERVACIONES_BC	    VARCHAR2(512 CHAR),
            ...
            -- Creamos primary key
            V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (RBC_ID) USING INDEX)';
            EXECUTE IMMEDIATE V_MSQL;
