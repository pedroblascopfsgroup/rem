...
--## PRODUCTO=NO
--## Finalidad: Creacion diccionario ACT_LGP_LISTADO_GASTOS_SAPBC_PRV
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'ACT_LGP_LISTADO_GASTOS_SAPBC_PRV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
    ...
    ELSE
            ...
            -- Creamos primary key
            V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (LGP_ID) USING INDEX)';
            EXECUTE IMMEDIATE V_MSQL;
