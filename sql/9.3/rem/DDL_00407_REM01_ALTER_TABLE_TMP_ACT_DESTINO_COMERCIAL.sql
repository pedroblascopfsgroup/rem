...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la TMP_ACT_DESTINO_COMERCIAL
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'TMP_ACT_DESTINO_COMERCIAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.	
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('EJECUTADO','NUMBER(1,0)','Indica si se ha ejecutado'),
        T_ALTER('FECHA_EJECUCION','TIMESTAMP(6)','Indica la fecha de ejecución')
    );
    V_T_ALTER T_ALTER;
