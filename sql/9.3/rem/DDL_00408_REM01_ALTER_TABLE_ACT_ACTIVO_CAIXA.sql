...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('DD_SOR_ID','NUMBER(16,0)','Identificador único DD_SOR_SOCIEDAD_ORIGEN','FK_DD_SOR_ID','DD_SOR_SOCIEDAD_ORIGEN'),
        T_ALTER('DD_BOR_ID','NUMBER(16,0)','Identificador único DD_BOR_BANCO_ORIGEN','FK_DD_BOR_ID','DD_BOR_BANCO_ORIGEN')
    );
    V_T_ALTER T_ALTER;
