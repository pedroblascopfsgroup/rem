...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la TMP_AGR_DESTINO_COMERCIAL
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'TMP_AGR_DESTINO_COMERCIAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.	
