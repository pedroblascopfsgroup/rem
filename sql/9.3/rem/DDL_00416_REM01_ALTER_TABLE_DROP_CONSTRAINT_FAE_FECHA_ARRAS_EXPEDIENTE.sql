...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('FAE_FECHA_ARRAS_EXPEDIENTE', 'FAE_VALIDACION_BC','FK_FAE_DD_APD')
  );  
  V_TMP_COL T_COL;
...
BEGIN
    ...
    LOOP
        ...
        IF V_NUM_TABLAS = 1 THEN              
            ...
            IF V_NUM_TABLAS = 1 THEN
                DBMS_OUTPUT.PUT_LINE('  [INFO] Borrando Constraint '||V_TMP_COL(2)||'');  
                EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TMP_COL(1)||' DROP CONSTRAINT '||V_TMP_COL(3)||'';       
