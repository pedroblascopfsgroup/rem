...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos a FAE_FECHA_ARRAS_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'FAE_FECHA_ARRAS_EXPEDIENTE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.	
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('FAE_MOTIVO_ANULACION','VARCHAR2(512 CHAR)','Motivo Anulación BC')
    );
    V_T_ALTER T_ALTER;
