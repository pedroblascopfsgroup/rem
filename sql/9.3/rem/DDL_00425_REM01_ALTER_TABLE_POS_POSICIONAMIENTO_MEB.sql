...
--## PRODUCTO=NO
--## Finalidad:Modificar la tabla pos_posicionamiento
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    			--NOMBRE CAMPO		--TIPO CAMPO		--DESCRIPCION									   --Nombre FK				-Tabla de dónde viene    -- Columna original
        T_ALTER('POS_VALIDACION_BC',	'NUMBER(16,0)',	'Identificador único con la respuesta del servcio',	'FK_POS_DD_MEB_ID',	'DD_MEB_MOTIVOS_ESTADO_BC' , 'DD_MEB_ID')
    );
    V_T_ALTER T_ALTER;
