...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'CBX_EMPL_FAML',						'NUMBER(1,0)', 				'Indica el empleado/Familiar de Caixa')
     );
     V_T_ALTER T_ALTER;
BEGIN
	...
	LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			--No existe la columna, la creamos
			DBMS_OUTPUT.PUT_LINE('[INFO] Creamos ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||'['||V_T_ALTER(1)||'] -------------------------------------------');
