...
--## PRODUCTO=NO
--## Finalidad:Modificar la tabla ACT_PAC_PROPIETARIO_ACTIVO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('PAC_ANYO_CONCES',	'VARCHAR(4 CHAR)',	'Año de concesión del activo'),
		T_ALTER('PAC_FEC_FIN_CONCES',	'DATE',	'Fecha de finalización de concesión del activo')
    );
    V_T_ALTER T_ALTER;
