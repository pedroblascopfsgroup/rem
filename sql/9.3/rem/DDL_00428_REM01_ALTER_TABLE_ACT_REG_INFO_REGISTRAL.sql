...
--## PRODUCTO=NO
--## Finalidad:Modificar la tabla ACT_REG_INFO_REGISTRAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('REG_NOMBRE_REGISTRO',	'VARCHAR(40 CHAR)',	'Nombre del registro de la propiedad'),
		T_ALTER('REG_NUMERO_REGISTRO',	'VARCHAR(40 CHAR)',	'Número del registro de la propiedad')
    );
    V_T_ALTER T_ALTER;
