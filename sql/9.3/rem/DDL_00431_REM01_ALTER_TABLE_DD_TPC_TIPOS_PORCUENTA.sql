...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir campos nuevos a la tabla DD_TPC_TIPOS_PORCUENTA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'DD_TPC_TIPOS_PORCUENTA'; -- Nombre de la tabla a crear
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	    T_TIPO_DATA('DD_TPC_CODIGO_C4C', 'VARCHAR2(20 CHAR)', 'Código C4C', 'NO', '', '')
); 
