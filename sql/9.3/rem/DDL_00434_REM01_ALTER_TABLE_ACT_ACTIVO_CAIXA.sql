...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir campos nuevos a la tabla ACT_ACTIVO_CAIXA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'ACT_ACTIVO_CAIXA'; -- Nombre de la tabla a crear
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	    T_TIPO_DATA('CBX_UNIDAD_ECONOMICA', 'VARCHAR2(8 CHAR)', 'Unidad ecónomica (Agrupación Obra Nueva Caixa) a la que pertenece el activo', 'NO', '', '')
); 
