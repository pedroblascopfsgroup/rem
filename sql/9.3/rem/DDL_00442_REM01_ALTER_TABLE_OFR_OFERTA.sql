...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											--Nombre en la tabla fk
			T_TIPO_DATA('DD_CCA_ID', 'NUMBER(16,0)', 'Clase de Contrato Alquiler', 	'DD_CCA_ID', 'DD_CCA_CLASE_CONTRATO_ALQUILER'),
			T_TIPO_DATA('DD_CAL_ID', 'NUMBER(16,0)', 'Clasificación', 				'DD_CAL_ID', 'DD_CAL_CLASIFICACION_ALQUILER')
    ); 
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('OFR_FECHA_APR_GARANTIAS_APORTADAS',			'DATE',				'Fecha Aprobación Garantías Aportadas'),
    	T_ALTER('OFR_FECHA_PRIMER_VENCIMIENTO',					'DATE',				'Fecha Primer Vencimiento'),
    	T_ALTER('OFR_FECHA_INICIO_CONTRATO',					'DATE',				'Fecha inicio contrato'),
		T_ALTER('OFR_FECHA_FIN_CONTRATO',						'DATE',				'Fecha fin contrato'),
		T_ALTER('OFR_ALQUILER_OPCION_COMPRA',					'NUMBER(1,0)',		'Alquiler con opción a compra'),
		T_ALTER('OFR_VALOR_OPCION_COMPRA',						'NUMBER(16,2)',		'Valor de la opción a compra'),
		T_ALTER('OFR_FECHA_VENC_OPCION_COMPRA',					'DATE',				'Fecha vencimiento opción a compra')
