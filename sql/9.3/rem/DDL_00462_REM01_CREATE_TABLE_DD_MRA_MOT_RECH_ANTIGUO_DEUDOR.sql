...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_MRA_MOT_RECH_ANTIGUO_DEUDOR
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_MRA_MOT_RECH_ANTIGUO_DEUDOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'MRA';
