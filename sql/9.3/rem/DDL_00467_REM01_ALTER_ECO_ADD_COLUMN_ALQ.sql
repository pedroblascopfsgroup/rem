...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ECO_MESES_DURACION_CNT_ALQ',	 'NUMBER(16,0)',			'Meses de duración del contrato de alquiler'),
    	T_ALTER(  'ECO_DETALLE_ANUL_ALQ',	 	 'VARCHAR2(250 CHAR)',		'Detalle anulación contrato alquiler')
	);
    V_T_ALTER T_ALTER;
