...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('CEX_PRP',                      'NUMBER(1,0)',          'Persona con responsabilidad pública'),
        T_ALTER('CEX_OFICINA_TRABAJO',          'VARCHAR2(150 CHAR)',   'Oficina en la que trabaja el empleado')
