...
--## INCIDENCIA_LINK=HREOS-15047
--## PRODUCTO=NO
--## 
--## Finalidad: Modificar constraints tabla ACT_AGA_AGRUPACION_ACTIVO.
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('DROP_CONSTRAINT', 'ACT_AGA_AGRUPACION_ACTIVO', 'UK_AGRID_ACTID'),
    T_COL('DROP_INDEX', 'ACT_AGA_AGRUPACION_ACTIVO', 'UK_AGRID_ACTID'),
    T_COL('CREATE_CONSTRAINT', 'ACT_AGA_AGRUPACION_ACTIVO', 'UK_AGRID_ACTID','AGR_ID, ACT_ID, FECHABORRAR, BORRADO')
  );  
  V_TMP_COL T_COL;
