...
--## INCIDENCIA_LINK=HREOS-15095
--## PRODUCTO=NO
--##
--## Finalidad: Anyadir FK a CLC_CLIENTE_COMERCIAL, CEX_COMPRADOR_EXPEDIENTE y OFR_TIA_TITULARES_ADICIONALES
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('DD_PRV_NAC_ID_REP'  ,'CLC_CLIENTE_COMERCIAL'   			,'NUMBER(16,0)' 	,'FK a DD_PRV_PROVINCIA'           ,'FK_CLC_DD_PRV_NAC_ID_REP'     ,'DD_PRV_PROVINCIA', 	'DD_PRV_ID'),
		T_ALTER('DD_PRV_NAC_ID_REP'  ,'CEX_COMPRADOR_EXPEDIENTE'   			,'NUMBER(16,0)' 	,'FK a DD_PRV_PROVINCIA'           ,'FK_CEX_DD_PRV_NAC_ID_REP'     ,'DD_PRV_PROVINCIA', 	'DD_PRV_ID'),
		T_ALTER('DD_PRV_NAC_ID_REP'  ,'OFR_TIA_TITULARES_ADICIONALES'  		,'NUMBER(16,0)' 	,'FK a DD_PRV_PROVINCIA'           ,'FK_TIA_DD_PRV_NAC_ID_REP'     ,'DD_PRV_PROVINCIA', 	'DD_PRV_ID')
    );
    V_T_ALTER T_ALTER;
