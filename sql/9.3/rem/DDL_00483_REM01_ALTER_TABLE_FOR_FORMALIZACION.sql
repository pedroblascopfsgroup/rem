...
--## PRODUCTO=NO
--## Finalidad: Alter table FOR_FORMALIZACION
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('FOR_VENTA_PLAZOS', 'NUMBER(1,0)', 'Flag venta a plazos'),
        T_ALTER('FOR_VENTA_COND_SUPENSIVA', 'NUMBER(1,0)', 'Flag venta con condición supensiva')    	    	    	    	
		);
    V_T_ALTER T_ALTER;            
