...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER(  'COE_SCORING_BC',				    'NUMBER(1,0)',		            'Flag scoring alquiler BC'),
        T_ALTER(  'COE_AVAL_BC',				    'NUMBER(1,0)',		            'Flag aval alquiler BC'),
        T_ALTER(  'COE_SEG_RENTAS_BC',				'NUMBER(1,0)',		            'Flag seguro de rentas alquiler BC')
     );
     V_T_ALTER T_ALTER;
BEGIN
