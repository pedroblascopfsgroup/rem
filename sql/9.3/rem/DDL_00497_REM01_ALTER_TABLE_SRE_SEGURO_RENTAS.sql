...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    			...
    			T_ALTER('SRE_FECHA_SANCION_BC',		'DATE',		        'Fecha de Sanción BC'),
                T_ALTER('SRE_MESES_BC',		        'NUMBER(2,0)',		'Meses seguro de rentas BC'),
                T_ALTER('SRE_IMPORTE_BC',		    'NUMBER(16,2)',		'Importe seguro de rentas BC')
	);
    V_T_ALTER T_ALTER;
