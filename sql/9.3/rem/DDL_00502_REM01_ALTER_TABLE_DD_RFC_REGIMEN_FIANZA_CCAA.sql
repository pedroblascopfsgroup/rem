...
--## INCIDENCIA_LINK=HREOS-15612
--## PRODUCTO=NO
--##
--## Finalidad: Añadir campos nuevos a la tabla DD_RFC_REGIMEN_FIANZA_CCAA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'DD_RFC_REGIMEN_FIANZA_CCAA'; -- Nombre de la tabla a crear
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
	    T_TIPO_DATA('DD_RFC_CODIGO_C4C', 'VARCHAR2(20 CHAR)', 'Código C4C', 'NO', '', '')
); 
