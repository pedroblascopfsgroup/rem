...
--## INCIDENCIA_LINK=REMVIP-10758
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la GPV_GASTOS_PROVEEDOR
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('CLAVE_FACTURA','VARCHAR2(250 CHAR)')
		);
    V_T_ALTER T_ALTER;
...
BEGIN
	...
	LOOP
		...
		ELSE
			DBMS_OUTPUT.PUT_LINE('[INFO] ... '||V_T_ALTER(1)||' YA EXISTE ');
		END IF;
