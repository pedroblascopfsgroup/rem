...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de valores para rechazo rcdc
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(50 CHAR) := 'DD_MRR_MOTIVO_RECHAZO_RCDC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(5 CHAR) := 'MRR'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para gestionar el diccionario de valores para rcdc'; -- Vble. para los comentarios de las tablas
