...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_RFT_ID',						'NUMBER(16,0)',						'Id del diccionario refacturación trabajo'	),
    	T_ALTER(  'DD_CMT_ID',						'NUMBER(16,0)',						'Id del diccionario del calculo del margen del trabajo'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_TBJ_DD_RFT_ID',						'DD_RFT_ID',					V_ESQUEMA||'.DD_RFT_REFACTURACION_TRABAJO',				'DD_RFT_ID'			),
    	T_FK(	'FK_TBJ_DD_CMT_ID',						'DD_CMT_ID',					V_ESQUEMA||'.DD_CMT_CALCULO_MARGEN_TRABAJO',			'DD_CMT_ID'			)
    );
    V_T_FK T_FK;
