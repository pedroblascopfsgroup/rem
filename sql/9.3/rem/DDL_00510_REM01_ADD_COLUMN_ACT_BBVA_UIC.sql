...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'BBVA_ACTIVO_EPA',			'NUMBER(16,0)',			      	'Activo EPA'	),
    	T_ALTER(  'BBVA_CEXPER',			    'VARCHAR2(50 CHAR)',			'Cexper de BBVA'	),
    	T_ALTER(  'BBVA_CONTRAPARTIDA',	  		'VARCHAR2(255 CHAR)',			'Contrapartida de BBVA'	),
		T_ALTER(  'BBVA_FOLIO',				    'VARCHAR2(255 CHAR)',			'Folio de BBVA'	),
		T_ALTER(  'BBVA_CDPEN',				    'VARCHAR2(20 CHAR)',			'Identificador del codigo PEN'	),
		T_ALTER(  'BBVA_OFICINA',				'VARCHAR2(255 CHAR)',			'Oficina de BBVA'	),
		T_ALTER(  'BBVA_EMPRESA',				'VARCHAR2(255 CHAR)',			'Empresa de BBVA'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_BBVA_ACTIVO_EPA_UIC',			'BBVA_ACTIVO_EPA',		V_ESQUEMA_M||'.DD_SIN_SINO',				'DD_SIN_ID')
    );
    V_T_FK T_FK;
