...
--## PRODUCTO=NO
--## Finalidad: Add columnas y su contrainsts en TBJ
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'TBJ_PORCENTAJE_MARGEN',			'DECIMAL(5,2)',						'Porcentaje de margen del trabajo'	),
    	T_ALTER(  'TBJ_IMPORTE_MARGEN',				'NUMBER(16,2)',						'Importe de margen del trabajo'	)
		);
    V_T_ALTER T_ALTER;
