...
DECLARE
    ...
    V_CAMPO VARCHAR2(128 CHAR) := 'ELEMENTO_PEP'; -- Nuevo Campo
    V_TIPO_CAMPO VARCHAR2(128 CHAR) := 'VARCHAR2(20 CHAR)'; -- Tipo Campo
    V_DESCRIPCIOM_CAMPO VARCHAR(128 CHAR):= 'Elemento PEP'; -- Descripción del campo
BEGIN
