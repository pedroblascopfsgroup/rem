...
DECLARE
	...
	V_TABLA_1 VARCHAR2(2400 CHAR) := 'DD_ETG_EQV_TIPO_GASTO'; 		-- Vble. auxiliar para almacenar el nombre de la tabla de ref1.
          ...
          IF V_NUM_TABLAS > 0 THEN
            ...
            -- Si existe la columna cambiamos/establecemos solo la FK
              IF V_NUM_TABLAS = 1 THEN
                  ...
                  V_SQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA_1||' DROP CONSTRAINT FK_ETG_'||V_CAMPO_2||'';
                  EXECUTE IMMEDIATE V_SQL;
                  DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA_1||'.'||V_CAMPO_2||'... FK Dropeada');
                  
                  V_SQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA_1||' ADD (CONSTRAINT FK_ETG_'||V_CAMPO_2||' FOREIGN KEY 
