...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos de fecha a la APR_AUX_I_RU_LFACT_SIN_PROV
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_I_RU_LFACT_SIN_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
