...
--## PRODUCTO=NO
--## Finalidad: Creacion FICHERO_I_UR_FACT_SIT_SAPBC
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'FICHERO_I_UR_FACT_SIT_SAPBC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
    ...
    ELSE
            ...
            (
                ...
                ,FECHA_FICHERO          VARCHAR2(250 CHAR)
                ,NOMBRE_FICHERO         VARCHAR2(250 CHAR)
            )
            LOGGING 
            NOCOMPRESS 
            NOCACHE
