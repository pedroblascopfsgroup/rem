...
DECLARE
    ...
    V_TABLA VARCHAR2(32 CHAR) := 'H_AUX_RC_COMUNIDADES'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	  V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla auxiliar H_AUX_RC_COMUNIDADES'; -- Vble. para los comentarios de las tablas
