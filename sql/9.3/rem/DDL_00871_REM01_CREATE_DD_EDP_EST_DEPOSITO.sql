...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_EDP_EST_DEPOSITO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_EDP_EST_DEPOSITO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
