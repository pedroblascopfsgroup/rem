...
--## INCIDENCIA_LINK=HREOS-15220
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_TOA_TIPO_OFR_ALQUILER
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TOA_TIPO_OFR_ALQUILER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
