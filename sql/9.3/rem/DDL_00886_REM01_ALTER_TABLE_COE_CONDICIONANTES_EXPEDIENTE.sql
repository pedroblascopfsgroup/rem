...
--## PRODUCTO=NO
--## Finalidad: Anyadir FK a las tablas del array
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('DD_GRI_ID'         ,'NUMBER(16,0)' ,'FK a DD_GRI_GRUPO_IMPUESTO' ,'FK_COE_DD_GRI_ID'    ,'DD_GRI_GRUPO_IMPUESTO', 'DD_GRI_ID','COE_CONDICIONANTES_EXPEDIENTE')
    );
    V_T_ALTER T_ALTER;
