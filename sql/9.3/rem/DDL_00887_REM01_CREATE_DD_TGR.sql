...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_TGR_TIPO_GASTO_REPERCUTIDO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TGR_TIPO_GASTO_REPERCUTIDO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
