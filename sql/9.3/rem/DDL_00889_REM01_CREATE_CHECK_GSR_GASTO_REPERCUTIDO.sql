...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_CONSTRAINT', 'GSR_GASTO_REPERCUTIDO', 'UK_GSR_GASTO_REPERCUTIDO','COE_ID, DD_TGR_ID,  FECHABORRAR, BORRADO'),
    T_COL('ADD_CHECK_CONSTRAINT', 'GSR_GASTO_REPERCUTIDO', 'CK_GSR_GASTO_REPERCUTIDO','(BORRADO = 0 AND FECHABORRAR IS NULL) OR BORRADO = 1')
  );  
  V_TMP_COL T_COL;
