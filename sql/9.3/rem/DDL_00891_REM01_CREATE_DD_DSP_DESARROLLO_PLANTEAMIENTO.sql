...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_DSP_DESARROLLO_PLANTEAMIENTO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_DSP_DESARROLLO_PLANTEAMIENTO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'DSP';
