...
--## INCIDENCIA_LINK=HREOS-15564
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla DD_CAL_CLASIFICACION_ALQUILER
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_CAL_CLASIFICACION_ALQUILER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_CAL_CODIGO_C4C',			'VARCHAR(20 CHAR)',			'Identificador c4c de la clasificación de alquiler'	)
		);
    V_T_ALTER T_ALTER;
