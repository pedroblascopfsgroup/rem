...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'GSR_GASTO_REPERCUTIDO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||' MODIFICACION COLUMNA... OK *************************************************');
	COMMIT;
