...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_FSG_FASE_GESTION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_FSG_FASE_GESTION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'FSG';
