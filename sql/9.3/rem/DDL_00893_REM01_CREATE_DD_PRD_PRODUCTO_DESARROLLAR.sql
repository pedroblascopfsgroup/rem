...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_PRD_PRODUCTO_DESARROLLAR
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_PRD_PRODUCTO_DESARROLLAR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'PRD';
