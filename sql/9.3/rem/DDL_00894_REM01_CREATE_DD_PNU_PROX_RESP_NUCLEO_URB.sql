...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_PNU_PROX_RESP_NUCLEO_URB
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_PNU_PROX_RESP_NUCLEO_URB'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'PNU';
