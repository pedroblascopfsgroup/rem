...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos a RBC_RESPUESTA_RES_COMITE_BC
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'RBC_RESPUESTA_RES_COMITE_BC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.	
    
    /* -- ARRAY CON NUEVAS COLUMNAS */
    TYPE T_ALTER IS TABLE OF VARCHAR2(4000);
    TYPE T_ARRAY_ALTER IS TABLE OF T_ALTER;
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        T_ALTER('RBC_SANCION_CL_ROD','VARCHAR2(150 CHAR)','Sanción CL/ROD'),
        T_ALTER('RBC_COMITE','NUMBER(1,0)','Indica si el Comité es Comercial (1) o CL/ROD (0).')
    );
    V_T_ALTER T_ALTER;
