...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_SGT_SISTEMA_GESTION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_SGT_SISTEMA_GESTION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'SGT';
