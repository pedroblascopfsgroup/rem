...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_MTV_METODO_VALORACION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_MTV_METODO_VALORACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'MTV';
