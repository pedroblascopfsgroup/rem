...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_TDU_TIPO_DAT_UTI_INM_COMP
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TDU_TIPO_DAT_UTI_INM_COMP'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'TDU';
