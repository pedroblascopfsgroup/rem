...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_PTA_PATRIMONIO_ACTIVO
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'ACUERDO_PAGO',					'NUMBER(1,0)',					'Acuerdo de pago (SI/NO)'	),
		T_ALTER(  'MOROSO',							'NUMBER(1,0)',					'Moroso/No Moroso (SI/NO)'	),
		T_ALTER(  'ACTIVO_PROMO_ESTRATEG',			'NUMBER(1,0)',					'Activo Estratégico'	)
		);
    V_T_ALTER T_ALTER;
