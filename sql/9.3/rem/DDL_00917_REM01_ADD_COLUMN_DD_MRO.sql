...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla DD_MRO_MOTIVO_RECHAZO_OFERTA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_MRO_CODIGO_C4C',			'VARCHAR2(20 CHAR)',			'Código c4c del motivo de anulación'	),
    	T_ALTER(  'DD_MRO_VISIBLE_CAIXA',		'NUMBER(1,0)',					'Indica si es visible para la cartera caixa'	)
		);
    V_T_ALTER T_ALTER;
