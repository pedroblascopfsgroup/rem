...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_CNO_CN_OCUPACIONAL
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_CNO_CN_OCUPACIONAL'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- ******** DD_CNO_CN_OCUPACIONAL *******º
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla DD_CNO_CN_OCUPACIONAL
