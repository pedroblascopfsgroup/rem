...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_EIC_ESTADO_INTERLOCUTOR
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_EIC_ESTADO_INTERLOCUTOR'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'EIC';
    ERR_NUM NUMBER(25);  -- Vble. auxiliar para registrar errores en el script.
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.

BEGIN

    -- ******** DD_EIC_ESTADO_INTERLOCUTOR *******º
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla DD_EIC_ESTADO_INTERLOCUTOR
