...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_FOJ_FORMA_JURIDICA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_FOJ_FORMA_JURIDICA'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- ******** DD_FOJ_FORMA_JURIDICA *******º
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla DD_FOJ_FORMA_JURIDICA
