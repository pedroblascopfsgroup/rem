...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_FIO_FUN_INTERLOCUTOR_OFERTA'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'FIO';
...
BEGIN
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.DD_'||V_CODIGO_TABLA||'_CODIGO_C4C IS ''Código único C4C Caixa.''';
