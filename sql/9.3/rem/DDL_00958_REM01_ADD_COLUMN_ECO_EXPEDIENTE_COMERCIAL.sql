...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ECO_EXPEDIENTE_COMERCIAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ECO_REVISADO_CONTROLLERS',		'NUMBER(1,0)',						'Booleano para ver si esta revisado o no'	),
    	T_ALTER(  'ECO_FECHA_REVISION',				'DATE',								'Fecha de revisión por los controllers'	)
		);
    V_T_ALTER T_ALTER;
