...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-18369'; -- USUARIOCREAR/USUARIOMODIFICAR.
...
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_ACTIVO_CAIXA');
    ...
    IF V_NUM_TABLAS > 0 THEN
      ...
      V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
             MODIFY ('||V_TMP_TIPO_DATA(1)||' '||V_TMP_TIPO_DATA(2)||' DEFAULT 0)';
    ...
    ELSE
    DBMS_OUTPUT.PUT_LINE('[INFO] ' || V_ESQUEMA || '.'||V_TEXT_TABLA||'No Existe la columna.');
