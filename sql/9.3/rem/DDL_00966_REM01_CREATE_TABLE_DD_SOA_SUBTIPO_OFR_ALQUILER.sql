...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_SOA_SUBTIPO_OFR_ALQUILER'; -- Vble. con el nombre de la tabla.
    V_CODIGO_TABLA VARCHAR2(3 CHAR):= 'SOA';
...
BEGIN
    ...
    ELSE  
    	 ...
    	 V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||'
               (DD_'||V_CODIGO_TABLA||'_ID NUMBER (16,0) 
				  ...
				  , CONSTRAINT FK_DD_TOA_ID FOREIGN KEY(DD_TOA_ID) REFERENCES DD_TOA_TIPO_OFR_ALQUILER (DD_TOA_ID)
			  )';
	...
	EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.DD_TOA_ID IS ''Código Tipo oferta.''';
