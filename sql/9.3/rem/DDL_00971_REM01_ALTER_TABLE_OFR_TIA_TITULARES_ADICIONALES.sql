...
--## INCIDENCIA_LINK=REMVIP-11293
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columnas y FK a tabla OFR_TIA_TITULARES_ADICIONALES
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'OFR_TIA_TITULARES_ADICIONALES', 'DD_TOC_ID', 'NUMBER(16,0)', 'Identificador único del diccionario de Ocupación'),
    T_COL('ADD_CONSTRAINT', 'OFR_TIA_TITULARES_ADICIONALES', 'FK_DD_TOC_ID_TIA', 'DD_TOC_ID', 'DD_TOC_TIPO_OCUPACION', 'DD_TOC_ID')
  );  
  V_TMP_COL T_COL;
