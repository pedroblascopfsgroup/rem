...
--## PRODUCTO=NO
--## Finalidad: Creacion tabla COD_CONFIGURACION_DEPOSITO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'COD_CONFIGURACION_DEPOSITO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
    ...
    ELSE
            ...
            -- Creamos primary key
            V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TABLA||'_PK PRIMARY KEY (COD_ID) USING INDEX)';
            EXECUTE IMMEDIATE V_MSQL;
		    ...
		    EXECUTE IMMEDIATE V_MSQL;	
            V_SQL := 'COMMENT ON COLUMN ' ||V_ESQUEMA||'.'||V_TABLA||'.COD_ID IS ''Id de la tabla''';
