...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir un nuevo campo en la tabla ACT_ACTIVO - DD_CAP_ID
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TABLA_REF VARCHAR2(50 CHAR):= 'DD_CAP_CLASIFICACION_APPLE'; -- Nombre de la tabla a REFERENCIAR
	V_COL VARCHAR2(50 CHAR):= 'DD_CAP_ID'; --Nombre de la columna
	 V_TIPO VARCHAR2(250 CHAR):= 'NUMBER(16,0)';--Tipo nuevo campo
	 V_KEY_NAME VARCHAR2(50 CHAR):= 'FK_ACT_DD_CAP_ID';
...
--Comprobacion de la tabla
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL||' IS ''Código identificador único de CLASIFICACIÓN APPLE.'''; 					
            ELSE
