...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('AGR_DND_ID', 'NUMBER(16,0)', 'FK de AGR_ID.')
    ); 
    V_TMP_TIPO_DATA T_TIPO_DATA;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_AGR_AGRUPACION');
    ...
    IF V_NUM_TABLAS = 0 THEN
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO] AÑADIDA '||V_TMP_TIPO_DATA(1)||' '||V_TMP_TIPO_DATA(2));
        ...
        V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
             ADD CONSTRAINT FK_AGR_DND_ID
             FOREIGN KEY (AGR_DND_ID) REFERENCES ACT_AGR_AGRUPACION(AGR_ID)';
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_AGR_AGRUPACION');
