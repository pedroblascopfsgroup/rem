...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('AGA_FECHA_ESCRITURACION', 'DATE', 'Fecha escrituración.')
    ); 
    V_TMP_TIPO_DATA T_TIPO_DATA;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_AGA_AGRUPACION_ACTIVO');
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_AGA_AGRUPACION_ACTIVO');
