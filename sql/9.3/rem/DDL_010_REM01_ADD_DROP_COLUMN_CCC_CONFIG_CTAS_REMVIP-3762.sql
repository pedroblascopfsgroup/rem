...
--## INCIDENCIA_LINK=REMPVIP-3762
--## PRODUCTO=NO
--## Finalidad: Add columna subcartera en CCC_CONFIG_CTAS_CONTABLES + FK
--##           
...
DECLARE
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_CCC_SCR',				'DD_SCR_ID',		V_ESQUEMA||'.DD_SCR_SUBCARTERA',			'DD_SCR_ID'			)
    );
    V_T_FK T_FK;
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER(  'DD_SCR_ID',						'NUMBER(16,0)',					'Código identificador único de la subcartera (opcional para algunas configuraciones)'		)
	);
	V_T_ALTER T_ALTER;
