...
BEGIN
	...
	ELSE
		...
		V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT FK_COMPRADOR_DDECV_URSUS FOREIGN KEY (DD_ECV_ID_URSUS) REFERENCES '||V_ESQUEMA||'.DD_ECV_ESTADOS_CIVILES_URSUS (DD_ECV_ID) ON DELETE SET NULL)';
