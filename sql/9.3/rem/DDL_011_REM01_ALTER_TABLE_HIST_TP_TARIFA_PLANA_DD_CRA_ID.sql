...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir un nuevo campo en la tabla DD_CRA_CARTERA - DD_CRA_ID
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
 	...
 	V_TABLA VARCHAR2(50 CHAR):= 'HIST_TP_TARIFA_PLANA'; -- Nombre de la tabla a crear
	V_TABLA_REF VARCHAR2(50 CHAR):= 'DD_CRA_CARTERA'; -- Nombre de la tabla a REFERENCIAR
	V_COL VARCHAR2(50 CHAR):= 'DD_CRA_ID'; --Nombre de la columna
	V_TIPO VARCHAR2(250 CHAR):= 'NUMBER(16,0)';--Tipo nuevo campo
	V_KEY_NAME VARCHAR2(50 CHAR):= 'FK_CRA_DD_CRA_ID';
...
--Comprobacion de la tabla
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                EXECUTE IMMEDIATE 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL||' IS ''Código único de la cartera.'''; 					
            ELSE
