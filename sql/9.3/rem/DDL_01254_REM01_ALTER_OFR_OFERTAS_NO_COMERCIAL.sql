...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
	    	...
	    	T_ALTER('OFR_CHECK_DOCUMENTAL_COMPLETO','NUMBER(1,0)','Checklist documental completo'),
			T_ALTER('OFR_SAN_ROD_GRR','VARCHAR2(150 CHAR)','Sanción ROD - GRR'),
			T_ALTER('OFR_SANC_LANZAMIENTOS','VARCHAR2(150 CHAR)','Sanción Comité Lanzamientos')
