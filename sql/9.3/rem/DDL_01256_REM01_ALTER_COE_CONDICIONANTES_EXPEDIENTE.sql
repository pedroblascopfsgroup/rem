...
--## INCIDENCIA_LINK=HREOS-15862
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla COE_CONDICIONANTES_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ALQ_DURACION_MESES',				'NUMBER(2,0)',			'Campo que indica los meses de duración'	)
		);
    V_T_ALTER T_ALTER;
