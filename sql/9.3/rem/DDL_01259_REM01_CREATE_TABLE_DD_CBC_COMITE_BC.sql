...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_CBC_COMITE_BC
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_CBC_COMITE_BC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'CBC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-16376';
