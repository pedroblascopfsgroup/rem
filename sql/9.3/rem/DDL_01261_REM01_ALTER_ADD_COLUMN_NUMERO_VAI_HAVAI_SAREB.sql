...
--##########################################
--## AUTOR=Jesus
--## FECHA_CREACION=2021213
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=REMVIP-10710
--## PRODUCTO=NO
--## Finalidad: Añadir columnas a la ECO_EXPEDIENTE_COMERCIAL
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'NUMERO_VAI_HAVAI_SAREB',   'VARCHAR2(20 CHAR)', 'Codigo VAI o HAVAI para expedientes Sareb')
