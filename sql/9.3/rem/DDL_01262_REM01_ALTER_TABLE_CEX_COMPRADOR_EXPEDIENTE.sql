...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('DD_PAI_ID_ISO',		 			'NUMBER(16,0)',						'FK a la tabla DD_PAI_PAISES Nacionalidad Comprador'),
		T_ALTER('DD_PAI_ID_ISO_RPR',		 		'NUMBER(16,0)',						'FK a la tabla DD_PAI_PAISES Nacionalidad Representante')
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
		...
		T_FK(	'FK_DD_PAI_ID_ISO_RPR_CEX',				'DD_PAI_ID_ISO_RPR',		V_ESQUEMA||'.DD_PAI_PAISES',				'DD_PAI_ID'			)
    );
    V_T_FK T_FK;
