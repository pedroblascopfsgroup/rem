...
DECLARE
    ...
    V_TABLA_FK VARCHAR2(2400 CHAR) := 'ACT_PRO_PROPIETARIO';  
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											
			T_TIPO_DATA('PRO_ID_TITULAR_CARTA', 		'NUMBER(16,0)', 		'Titular carta que llega desde gestorías, relacionado con el propietario', 			'PRO_ID')
    ); 
