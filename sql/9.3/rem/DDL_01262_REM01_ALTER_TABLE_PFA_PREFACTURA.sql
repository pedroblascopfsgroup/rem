...
--## PRODUCTO=NO
--## Finalidad: Alter PFA_PREFACTURA.PRO_ID
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'PFA_PREFACTURA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER('PRO_ID',						'NUMBER(16,0) NULL')
		);
    V_T_ALTER T_ALTER;
...
BEGIN
	...
	LOOP
		...
		IF V_NUM_TABLAS > 0 THEN
			--Si existe la columna, la modificamos
