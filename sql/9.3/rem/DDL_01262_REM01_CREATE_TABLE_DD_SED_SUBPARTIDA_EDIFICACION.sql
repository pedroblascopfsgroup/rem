...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir campos nuevos a la tabla DD_SED_SUBPARTIDA_EDIFICACION
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_SED_SUBPARTIDA_EDIFICACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'SED';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-16615';
