...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'ACT_DISCREPANCIAS_LOC',	 			'NUMBER(1,0)',				'Discrepancias localización'),
    	T_ALTER(  'ACT_OBSERVACIONES_DISC_LOC',	 		'VARCHAR2(150)',			'Discrepancias localización observaciones')
	);
    V_T_ALTER T_ALTER;
