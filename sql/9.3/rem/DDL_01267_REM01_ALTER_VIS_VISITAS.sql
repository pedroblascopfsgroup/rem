...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'VIS_CODIGO_OPORTUNIDAD',	 		'VARCHAR2(50 CHAR)',			'Código oportunidad asociada'),
    	T_ALTER(  'VIS_ESTADO_OPORTUNIDAD',	 		'VARCHAR2(50 CHAR)',			'Código estado de oportunidad'),
    	T_ALTER(  'VIS_CIERRE_OPORTUNIDAD',	 		'VARCHAR2(50 CHAR)',			'Código subestado (cierre) de oportunidad'),
    	T_ALTER(  'VIS_ALTA_OPORTUNIDAD',	 		'DATE',							'Fecha alta oportunidad')
	);
    V_T_ALTER T_ALTER;
