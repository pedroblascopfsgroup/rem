...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'APR_AUX_GASTOS_ENVIAR';
...
BEGIN	
  ...
  EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, DELETE, UPDATE ON '||V_TABLA||' TO PFSREM, REM_QUERY';
