...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla DD_SVI_SUBESTADOS_VISITA
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_SVI_SUBESTADOS_VISITA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_SVI_EXTUSC_SIN',			'VARCHAR2(20 CHAR)',			'Código ExternalUserStatusCode de la visita si el activo es Singular'	),
    	T_ALTER(  'DD_SVI_EXTUSC_RET',			'VARCHAR2(20 CHAR)',			'Código ExternalUserStatusCode de la visita si el activo es Retail'	),
    	T_ALTER(  'DD_SVI_RESRCOD',				'VARCHAR2(20 CHAR)',			'Código ResultReasonCode de la visita'	)
		);
    V_T_ALTER T_ALTER;
