...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tablas AUX_INFOR_RECH_GASTOS_UNICOS_CAIXA
--##
--## INSTRUCCIONES:  
--## VERSIONES:
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_INFOR_RECH_GASTOS_UNICOS_CAIXA';

BEGIN
	


	/***** AUX_INFOR_RECH_GASTOS_UNICOS_CAIXA *****/

	V_TABLA := 'AUX_INFOR_RECH_GASTOS_UNICOS_CAIXA';
