...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TAT_PROVEEDOR',	 			'NUMBER(1,0) DEFAULT 0 NOT NULL',	'Marca si es Proveedor'),
		T_ALTER(  'DD_TAT_GESTOR',	 				'NUMBER(1,0) DEFAULT 0 NOT NULL',	'Marca si es Gestor')
	);
    V_T_ALTER T_ALTER;
