...
--## PRODUCTO=NO
--## 
--## Finalidad: Añadir columnas y FK a tabla diccionario DD_MCO_MOTIVO_COMERCIALIZACION
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('CREATE_COLUMN', 'DD_EOB_ESTADO_OFERTA_BC', 'DD_EOB_CODIGO_C4C', 'VARCHAR2(50 CHAR)', 'Codigo C4C'),
    T_COL('CREATE_COLUMN', 'DD_EOB_ESTADO_OFERTA_BC', 'DD_EOB_FLAG_ALQUILER', 'NUMBER(1,0)','Flag alquiler'),
    T_COL('CREATE_COLUMN', 'DD_EOB_ESTADO_OFERTA_BC', 'DD_EOB_FLAG_VENTA', 'NUMBER(1,0)','Flag venta')
