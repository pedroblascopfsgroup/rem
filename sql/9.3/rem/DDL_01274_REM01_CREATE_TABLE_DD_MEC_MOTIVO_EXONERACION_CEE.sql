...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_MEC_MOTIVO_EXONERACION_CEE
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_MEC_MOTIVO_EXONERACION_CEE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'MEC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-17154';
	V_MSQL VARCHAR2(32000 CHAR); -- Sentencia a ejecutar 
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Motivo Exoneración CEE'; -- Vble. para los comentarios de las tablas
