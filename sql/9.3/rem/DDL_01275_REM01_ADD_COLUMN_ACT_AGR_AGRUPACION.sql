...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-17536'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(      
       T_TIPO_DATA('AGR_FECHA_PREV_FINALIZACION', 'DATE', 'Fecha prevista finalización.'),
       T_TIPO_DATA('AGR_FECHA_ESCRITURA_DESDE', 'DATE', 'Fecha escrituración desde.'),
       T_TIPO_DATA('AGR_FECHA_ESCRITURA_HASTA', 'DATE', 'Fecha escrituración hasta.')
    ); 
