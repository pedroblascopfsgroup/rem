...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_ACTIVO_CAIXA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_ETP_ID',			'NUMBER(16,0)',			'Estado posesorio BC'	),
		T_ALTER(  'FEC_EST_POSESORIO_BC',			'DATE',			'Fecha Estado posesorio BC'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_ETP',			'DD_ETP_ID',		V_ESQUEMA||'.DD_ETP_ESTADO_POSESORIO',				'DD_ETP_ID')
    );
    V_T_FK T_FK;
