...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TVC_TIPO_VIVIENDA_CAIXA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TVC_TIPO_VIVIENDA_CAIXA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'TVC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-17614';
	V_MSQL VARCHAR2(32000 CHAR); -- Sentencia a ejecutar 
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tipo de vivienda para informe comercial'; -- Vble. para los comentarios de las tablas
