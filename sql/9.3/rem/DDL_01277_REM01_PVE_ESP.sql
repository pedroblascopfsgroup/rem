...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'PVE_ESP'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
	...
	-- Creamos primary key
	V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' ADD (CONSTRAINT '||V_TEXT_TABLA||'_PK PRIMARY KEY (PVE_ID, DD_ESP_ID))';
	EXECUTE IMMEDIATE V_MSQL;
