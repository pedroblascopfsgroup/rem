...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-17598'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       ...
       T_TIPO_DATA('PRD_PISO', 'NUMBER(16,0)', 'Piso.','','','','NO'),
       T_TIPO_DATA('PRD_OTROS', 'VARCHAR2(100 CHAR)', 'Otros.','','','','NO'),
       T_TIPO_DATA('PRD_LINEA_NEGOCIO', 'NUMBER(16,0)', 'Línea de negocio, FK de DD_TCO_TIPO_COMERCIALIZACION.','FK_PRD_LINEA_NEGOCIO','DD_TCO_TIPO_COMERCIALIZACION','DD_TCO_ID','SI'),     
        T_TIPO_DATA('PRD_NUMERO_COMERCIALES', 'NUMBER(16,0)', 'Número de comerciales.','','','','NO'),
       T_TIPO_DATA('PRD_GEST_CLIENT_NO_RESIDENTES', 'NUMBER(16,0)', 'Gestión de clientes no residentes.','FK_PRD_GEST_CLIENT','REMMASTER.DD_SIN_SINO','DD_SIN_ID','SI')
      
    ); 
    V_TMP_TIPO_DATA T_TIPO_DATA;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION ACT_PRD_PROVEEDOR_DIRECCION');
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA ACT_PRD_PROVEEDOR_DIRECCION');
