...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('DD_TVC_ID', 'NUMBER(16,0)', '','DD_TVC_TIPO_VIVIENDA_CAIXA', 'DD_TVC_ID', 'Tipo vivienda Caixa'),
    T_TIPO_DATA('DD_TEC_ID', 'NUMBER(16,0)', '','DD_TEC_TIPO_EDIFICIO_CAIXA', 'DD_TEC_ID', 'Tipología edificio Caixa')
    ); 
...
BEGIN	
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      ...
      V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD (CONSTRAINT '||V_TMP_TIPO_DATA(1)||'_FK FOREIGN KEY ('||V_TMP_TIPO_DATA(1)||') REFERENCES '||V_ESQUEMA||'.'||V_TMP_TIPO_DATA(4)||' ('||V_TMP_TIPO_DATA(5)||'))';
      EXECUTE IMMEDIATE V_MSQL;
