...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_TPB_TIPO_BLOQUEO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TPB_TIPO_BLOQUEO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
