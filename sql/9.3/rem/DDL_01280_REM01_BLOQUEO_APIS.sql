...
--## PRODUCTO=NO
--## Finalidad: INSERCIÓN diccionario BAP_BLOQUEO_APIS
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'BAP_BLOQUEO_APIS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla de bloqueo de apis'; -- Vble. para los comentarios de las tablas
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'BAP';
