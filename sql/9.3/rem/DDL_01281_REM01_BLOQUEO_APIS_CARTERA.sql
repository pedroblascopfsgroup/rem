...
--## PRODUCTO=NO
--## Finalidad: INSERCIÓN diccionario BAC_BLOQUEO_APIS_CARTERA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'BAC_BLOQUEO_APIS_CARTERA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla de bloqueo de apis - Cartera'; -- Vble. para los comentarios de las tablas
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'BAC';
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	 T_FK(   'DD_CRA_ID',            	 V_ESQUEMA||'.DD_CRA_CARTERA',    'DD_CRA_ID'),
...
BEGIN
    ...
    ELSE
        	...
        	V_SQL := 'COMMENT ON COLUMN ' ||V_ESQUEMA||'.'||V_TABLA||'.DD_CRA_ID IS ''Carteras del bloqueo ''';
            EXECUTE IMMEDIATE V_SQL;
