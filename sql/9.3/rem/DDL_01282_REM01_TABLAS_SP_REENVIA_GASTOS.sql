...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('GGE_FECHA_EAH') , 
		T_TIPO_DATA('GGE_FECHA_EAP') ,
		T_TIPO_DATA('GGE_FECHA_ENVIO_PRPTRIO') ,
		T_TIPO_DATA('GGE_FECHA_ENVIO_INFORMATIVA')
    ); 
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			...
			V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA_ALTER|| ' ADD ('||V_TMP_TIPO_DATA(1)||' DATE)';		   
			EXECUTE IMMEDIATE V_MSQL;
