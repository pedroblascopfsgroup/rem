...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_SOA_ID',			'NUMBER(16)',			'Identificador único del subtipo de oferta alquiler'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_DD_SOA',			'DD_SOA_ID',		V_ESQUEMA||'.DD_SOA_SUBTIPO_OFR_ALQUILER',				'DD_SOA_ID')
    );
    V_T_FK T_FK;
