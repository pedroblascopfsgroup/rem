...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'BAE_BLOQUEO_APIS_ESP'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla de bloqueo de apis - Especialidad'; -- Vble. para los comentarios de las tablas
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'BAE';
...
BEGIN
    ...
    ELSE
        	...
        	V_SQL := 'COMMENT ON COLUMN ' ||V_ESQUEMA||'.'||V_TABLA||'.DD_ESP_ID IS ''Especialidad ''';
            EXECUTE IMMEDIATE V_SQL;
