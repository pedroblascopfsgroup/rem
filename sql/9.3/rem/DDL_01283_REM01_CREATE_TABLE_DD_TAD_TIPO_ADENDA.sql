...
--## INCIDENCIA_LINK=HREOS-18221
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla DD_TAD_TIPO_ADENDA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TAD_TIPO_ADENDA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CHARS VARCHAR2(6 CHAR) := 'TAD';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-18221';
	V_MSQL VARCHAR2(32000 CHAR); -- Sentencia a ejecutar 
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Diccionario tipo de adenda'; -- Vble. para los comentarios de las tablas
