...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'BAR_BLOQUEO_APIS_PROVINCIA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla de bloqueo de apis - Provincia'; -- Vble. para los comentarios de las tablas
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'BAR';
