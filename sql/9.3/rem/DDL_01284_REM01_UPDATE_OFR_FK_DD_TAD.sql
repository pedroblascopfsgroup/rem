...
--## PRODUCTO=NO
--## Finalidad: Alter DD_TAD_TIPO_ADENDA crear campo y FK a OFR_OFERTAS
--##           
...
DECLARE
    ...
    V_TABLA_FK VARCHAR2(2400 CHAR) := 'DD_TAD_TIPO_ADENDA';  
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											--Nombre en la tabla fk
			T_TIPO_DATA('DD_TAD_ID', 'NUMBER(16,0)', 'Diccionario tipo adenda', 'DD_TAD_ID', 'OFR')
    ); 
