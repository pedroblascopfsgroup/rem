...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       ...
       T_TIPO_DATA('PRD_NOMBRE_PERSONA_CONTACTO', 'VARCHAR2(50 CHAR)','Nombre persona de contacto'),
       T_TIPO_DATA('PRD_EMAIL_PERSONA_CONTACTO', 'VARCHAR2(50 CHAR)','Email persona de contacto')
    ); 
