...
BEGIN
	...
	(
		...
		,D_ZONA_ACTUACION_PROVINCIAS		VARCHAR2(1000 CHAR) 		NOT NULL
		,D_ZONA_ACTUACION_MUNICIPIOS		VARCHAR2(1000 CHAR) 		NOT NULL
		,D_ZONA_ACTUACION_CP				VARCHAR2(1000 CHAR) 		NOT NULL
