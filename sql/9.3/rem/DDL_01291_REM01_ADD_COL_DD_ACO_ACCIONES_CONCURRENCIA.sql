...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ACO_ACCIONES_CONCURRENCIA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'CODIGO_URL',	 			'VARCHAR2(10 CHAR)',			'Código identificador único para la url del end point de rem3')
	);
    V_T_ALTER T_ALTER;
