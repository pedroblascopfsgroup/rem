...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_DEC_DECISION_COMITE
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_DEC_DECISION_COMITE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'DEC';
