...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_TCR_TIPO_CARTERA_RESCISION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_TCR_TIPO_CARTERA_RESCISION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'TCR';
