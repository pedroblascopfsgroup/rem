...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'COE_FECHA_INI_BONIFICACION',	 	'DATE',			'Fecha inicio de bonificación'),
    	T_ALTER(  'COE_FECHA_FIN_BONIFICACION',	 	'DATE',			'Fecha fin de bonificación')
	);
    V_T_ALTER T_ALTER;
