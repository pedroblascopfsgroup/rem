...
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna ACT_FECHA_CAMBIO_TIPO_ACT en la tabla ACT_FECHA_CAMBIO_TIPO_ACT.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME_0 VARCHAR2(30):= 'ACT_FECHA_CAMBIO_TIPO_ACT'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE_0 VARCHAR2(500 CHAR):= 'Indica la fecha del último cambio del estado fisico del activo.'; -- Vble. para los comentarios de las tablas
