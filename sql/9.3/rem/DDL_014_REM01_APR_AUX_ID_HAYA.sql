...
--## INCIDENCIA_LINK=HREOS-9044
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla auxiliar para la carga de datos del DWH de Haya
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TABLA VARCHAR2(50 CHAR):= 'APR_AUX_ID_HAYA';
...
BEGIN	
	...
	CREATE TABLE '||V_ESQUEMA||'.'||V_TABLA||' (
		...
		, ID_ACTIVO_CLIENTE 	VARCHAR2(50 CHAR)
		, ACT_RECOVERY_ID	VARCHAR2(50 CHAR)
		, ALTA			NUMBER(1,0) DEFAULT 0
	)';
