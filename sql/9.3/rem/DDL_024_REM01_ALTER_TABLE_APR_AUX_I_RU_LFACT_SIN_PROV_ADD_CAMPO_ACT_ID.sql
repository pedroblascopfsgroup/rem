...
DECLARE
    ...
    V_CAMPO VARCHAR2(128 CHAR) := 'ACT_ID'; -- Nuevo Campo
    V_TIPO_CAMPO VARCHAR2(128 CHAR) := 'NUMBER(16,0)'; -- Tipo Campo
    V_DESCRIPCIOM_CAMPO VARCHAR(128 CHAR):= 'Campo utilizado para evitar error en los casos en los que el activo no tiene ID_ACTIVO_ESPECIAL'; -- Descripción del campo
BEGIN
