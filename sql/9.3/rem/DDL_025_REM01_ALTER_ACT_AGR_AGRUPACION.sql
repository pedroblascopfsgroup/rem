...
--## PRODUCTO=NO
--## Finalidad: Crear una nueva columna en la tabla ACT_AGR_AGRUPACION
--##           
...
DECLARE
	...
	V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER('AGR_COMERCIALIZABLE_CONS_PLANO', 'NUMBER(1,0)', 'Comercializable en construcción / plano'),
		T_ALTER('AGR_EXISTE_PISO_PILOTO', 'NUMBER(1,0)', 'Existe piso piloto'),
		T_ALTER('AGR_VISITABLE', 'NUMBER(1,0)', 'Visitable')
	);
	V_T_ALTER T_ALTER;
