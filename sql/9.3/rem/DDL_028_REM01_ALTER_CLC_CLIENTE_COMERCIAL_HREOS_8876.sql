...
--## INCIDENCIA_LINK=HREOS-8876
--## PRODUCTO=NO
--## Finalidad: Añadir columna CLC_COD_CLIENTE_DIVARIAN en CLC_CLIENTE_COMERCIAL
--##           
...
DECLARE
	...
	V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	-- NOMBRE CAMPO, TIPO CAMPO, DESCRIPCION, NULL/NOT NULL
		T_ALTER('CLC_COD_CLIENTE_DIVARIAN', 'VARCHAR2(100 CHAR)', 'Código cliente', 'NULL')
	);
	V_T_ALTER T_ALTER;
...
BEGIN	
	...
	LOOP
		...
		IF V_NUM_TABLAS = 0 THEN
			...
			V_MSQL := 'ALTER TABLE '||V_TEXT_TABLA|| ' ADD ('||V_T_ALTER(1)||' '||V_T_ALTER(2)||' '||V_T_ALTER(4)||')';
