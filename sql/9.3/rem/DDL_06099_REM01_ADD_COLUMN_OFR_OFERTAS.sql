...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-18198'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('OFR_FECHA_LIQUIDA', 'DATE', 'Fecha líquida.')
    ); 
...
BEGIN	
  ...
  DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||' AMPLIADA CON COLUMNAS *************************************************');
