...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-18305'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'H_APR_AUX_I_RU_FACT_SIN_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ACTUALIZACION H_APR_AUX_I_RU_FACT_SIN_PROV');
	...
	DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA H_APR_AUX_I_RU_FACT_SIN_PROV');
