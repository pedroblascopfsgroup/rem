...
--## PRODUCTO=NO
--##
--## Finalidad: Modificar tabla ACT_REG_INFO_REGISTRAL
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-18641'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('REG_SUPERFICIE_ALQUILABLE', 'NUMBER(16,2)', '', 'Superficie alquilables')
    ); 
