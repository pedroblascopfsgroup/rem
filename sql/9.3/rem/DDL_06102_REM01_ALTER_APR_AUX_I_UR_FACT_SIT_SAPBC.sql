...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_I_UR_FACT_SIT_SAPBC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'NOMBRE_FICHERO',			'VARCHAR2(50 CHAR)',		'Nombre fichero'),
        T_ALTER(  'FECHA_FICHERO',			'VARCHAR2(8 CHAR)',		'Fecha fichero'),
        T_ALTER(  'SECUENCIAL_FICHERO',			'VARCHAR2(5 CHAR)',		'Secuencial fichero')
		);
    V_T_ALTER T_ALTER;
