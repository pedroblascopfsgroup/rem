...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'APR_AUX_I_RU_FACT_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	  ...
    	  T_ALTER(  'DOMICILIADO',		  'NUMBER(1,0)',		'Domiciliado'	)
	);
	V_T_ALTER T_ALTER;
