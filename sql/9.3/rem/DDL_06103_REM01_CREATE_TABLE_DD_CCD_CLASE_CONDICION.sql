...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_CCD_CLASE_CONDICION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_CCD_CLASE_CONDICION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
