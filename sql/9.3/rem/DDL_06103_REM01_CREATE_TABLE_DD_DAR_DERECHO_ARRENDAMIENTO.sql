...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_DAR_DERECHO_ARRENDAMIENTO
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_DAR_DERECHO_ARRENDAMIENTO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
		V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'DAR';
