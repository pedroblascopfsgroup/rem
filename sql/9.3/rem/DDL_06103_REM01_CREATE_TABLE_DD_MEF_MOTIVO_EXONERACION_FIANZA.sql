...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_MEF_MOTIVO_EXONERACION_FIANZA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_MEF_MOTIVO_EXONERACION_FIANZA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
