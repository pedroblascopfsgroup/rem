...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_MRA_MOTIVO_REAGENDACION
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_MRA_MOTIVO_REAGENDACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
