...
--## PRODUCTO=NO
--## Finalidad: Creación diccionario DD_RIM_RETENCIONES_IMPUESTOS
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'DD_RIM_RETENCIONES_IMPUESTOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
