...
--## INCIDENCIA_LINK=HREOS-18479
--## PRODUCTO=NO
--## Finalidad: Anyadir columnas DOMICILIADO en APR_AUX_I_RU_FACT_SIN_PROV
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'H_APR_AUX_I_RU_FACT_PROV'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	  ...
    	  T_ALTER(  'DOMICILIADO',		  'NUMBER(1,0)',		'Domiciliacion'	)
	);
	V_T_ALTER T_ALTER;
