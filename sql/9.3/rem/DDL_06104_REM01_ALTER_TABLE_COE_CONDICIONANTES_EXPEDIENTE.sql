...
--## PRODUCTO=NO
--## Finalidad: Alter table COE_CONDICIONANTES_EXPEDIENTE
--##           
...
DECLARE
    ...
    V_PREF_TABLA VARCHAR2(2400 CHAR) := 'COE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											--Nombre en la tabla fk
			T_TIPO_DATA('DD_MEF_ID', 'NUMBER(16,0)', 'Motico exoneracion fianza', 				'DD_MEF_ID', 'DD_MEF_MOTIVO_EXONERACION_FIANZA')
    ); 
