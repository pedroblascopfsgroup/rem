...
--## PRODUCTO=NO
--## Finalidad: Alter table HRE_HISTORICO_REAGENDACIONES
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'HRE_HISTORICO_REAGENDACIONES'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_PREF_TABLA VARCHAR2(2400 CHAR) := 'HRE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											--Nombre en la tabla fk
			T_TIPO_DATA('DD_MRA_ID', 'NUMBER(16,0)', 'Motivo reagendacion', 				'DD_MRA_ID', 'DD_MRA_MOTIVO_REAGENDACION')
    ); 
