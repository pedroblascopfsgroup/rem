...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(											--Nombre en la tabla fk
			T_TIPO_DATA('DD_MRC_ID', 'NUMBER(16,0)', 'Motivo rescision', 	'DD_MRC_ID', 'DD_MRC_MOTIVO_RESCISION'),
      T_TIPO_DATA('DD_CCD_ID', 'NUMBER(16,0)', 'Clase condicion', 	'DD_CCD_ID', 'DD_CCD_CLASE_CONDICION'),
      T_TIPO_DATA('DD_DAR_ID', 'NUMBER(16,0)', 'Derecho arrendamiento', 	'DD_DAR_ID', 'DD_DAR_DERECHO_ARRENDAMIENTO'),
			T_TIPO_DATA('DD_RIM_ID', 'NUMBER(16,0)', 'Retencion impuestos', 				'DD_RIM_ID', 'DD_RIM_RETENCIONES_IMPUESTOS')
    ); 
