...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'AUX_APR_INTERLOCUTOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Auxiliar interlocutor'; -- Vble. para los comentarios de las tablas
