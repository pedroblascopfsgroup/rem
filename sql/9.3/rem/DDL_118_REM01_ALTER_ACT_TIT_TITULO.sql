...
--## PRODUCTO=NO
--## Finalidad: Añadir nueva columna TIT_FEC_MARCAJE_INSC en la tabla ACT_TIT_TITULO.
--##           
...
DECLARE
    ...
    V_COLUMN_NAME VARCHAR2(50):= 'TIT_FEC_MARCAJE_INSC'; -- Vble. para el nombre de las columnas.
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Fecha de marcaje de la inscripción.'; -- Vble. para los comentarios de las tablas
