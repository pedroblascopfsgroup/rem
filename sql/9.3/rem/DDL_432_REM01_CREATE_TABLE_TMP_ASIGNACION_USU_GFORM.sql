...
--## PRODUCTO=NO
--##
--## Finalidad: Crear la tabla TMP_ASIGNACION_USU_GFORM.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'TMP_ASIGNACION_USU_GFORM'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Tabla para realizar las asignaciones de GFORM'; -- Vble. para los comentarios de las tablas	
