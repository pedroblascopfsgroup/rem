...
--## PRODUCTO=NO
--## Finalidad: Actualizamos la columna TCP_PERMITIDA en TCP_TAREA_CONFIG_PETICION
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'TCP_PERMITIDA',			'NUMBER(1,0)',		'Indica si la tarea puede ser avanzada o no'	)
