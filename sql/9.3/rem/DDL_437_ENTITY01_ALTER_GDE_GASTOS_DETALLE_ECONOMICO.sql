...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla que contiene los datos del detalle económico del gasto
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'GDE_GASTO_REFACTURABLE',		 		'NUMBER(1,0)',						'Se trata de un gasto refacturable.'	)
		);
    V_T_ALTER T_ALTER;
	...
	T_FK('FK_DD_SIN_SINO',	'GDE_GASTO_REFACTURABLE',	V_ESQUEMA_M||'.DD_SIN_SINO',	'DD_SIN_ID')
    );
    V_T_FK T_FK;
