...
--## INCIDENCIA_LINK=HREOS-7724
--## PRODUCTO=NO
--## Finalidad: Nuevo campo ACT_NUM_ACTIVO_DIVARIAN
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ACT_NUM_ACTIVO_DIVARIAN', 'VARCHAR2','(20 CHAR)', 'Código identificador único del activo en DIVARIAN.')
    ); 
