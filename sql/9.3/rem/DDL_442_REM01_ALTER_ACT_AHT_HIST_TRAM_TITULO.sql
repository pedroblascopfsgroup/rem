...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('USUARIOCREAR','VARCHAR2(50 CHAR)',''),
	T_TIPO_DATA('USUARIOMODIFICAR','VARCHAR2(50 CHAR)',''),
	T_TIPO_DATA('USUARIOBORRAR','VARCHAR2(50 CHAR)','')
    ); 
...
BEGIN
	...
	V_TMP_TIPO_DATA := V_TIPO_DATA(I);
		...
		ELSE
			V_MSQL := 'ALTER TABLE '||V_ESQUEMA||'.'||V_TEXT_TABLA||' MODIFY ('||V_TMP_TIPO_DATA(1)||' '||V_TMP_TIPO_DATA(2)||' '||V_TMP_TIPO_DATA(3)||')';
