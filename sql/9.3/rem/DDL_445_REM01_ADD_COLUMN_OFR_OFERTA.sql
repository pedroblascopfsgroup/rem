...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-8934'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('OFR_ID_PRES_ORI_LEAD', 'NUMBER(16,0)', 'Id proveedor prescriptor del lead origen suministrado por Webcom'),
       T_TIPO_DATA('OFR_FECHA_ORI_LEAD', 'DATE', 'Fecha de la prescripción del lead origin suministrado por Webcom'),
       T_TIPO_DATA('OFR_COD_TIPO_PROV_ORI_LEAD' , 'VARCHAR2(100 CHAR)', 'Canal origen cliente suministrado por Webcom'),
       T_TIPO_DATA('OFR_ID_REALIZA_ORI_LEAD', 'NUMBER(16,0)', 'Id proveedor realizador del lead origen suministrado por Webcom')
    ); 
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
      ...
      T_FK( 'FK_OFR_PRES_ORI_PVE_ID',        'OFR_ID_PRES_ORI_LEAD',   	  'ACT_PVE_PROVEEDOR',      'PVE_ID'      ),
      T_FK( 'FK_OFR_REALIZA_ORI_PVE_ID',     'OFR_ID_REALIZA_ORI_LEAD',   'ACT_PVE_PROVEEDOR',      'PVE_ID'      )
    );
    V_T_FK T_FK;
