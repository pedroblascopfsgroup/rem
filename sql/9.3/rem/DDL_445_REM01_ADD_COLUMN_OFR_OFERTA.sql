...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
       T_TIPO_DATA('OFR_ID_PRES_ORI_LEAD', 'VARCHAR2(100 CHAR)', 'Código proveedor prescriptor del lead origen suministrado por Webcom'),
       ...
       T_TIPO_DATA('OFR_ID_REALIZA_ORI_LEAD', 'VARCHAR2(100 CHAR)', 'Proveedor realizador del lead origen suministrado por Webcom') 
    ); 
