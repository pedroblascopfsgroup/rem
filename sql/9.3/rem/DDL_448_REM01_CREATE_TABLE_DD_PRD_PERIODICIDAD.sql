...
--## PRODUCTO=NO
--## Finalidad: Tabla para gestionar el diccionario de Periocidad
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'DD_PRD_PERIODICIDAD'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_COMMENT_TABLE VARCHAR2(500 CHAR):= 'Diccionario de Periocidad'; -- Vble. para los comentarios de las tablas
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('04','Cuatrimestral','Cuatrimestral'),
		T_TIPO_DATA('05','Aperiódico','Aperiódico')
    ); 
