...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'CCA_COMISIONES_CALC_ACTIVOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(256);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
			T_TIPO_DATA('CLASSTYPE', 'VARCHAR2','(20 CHAR)')
    ); 
