...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla ACT_ICM_INF_COMER_HIST_MEDI
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'DD_TRL_ID',					'NUMBER(16)',			'Identificador único del tipo de rol del mediador'	)
		);
    V_T_ALTER T_ALTER;
    ...
    V_FK T_ARRAY_FK := T_ARRAY_FK(
    	...
    	T_FK(	'FK_TRL_INC_INF',			'DD_TRL_ID',		V_ESQUEMA||'.DD_TRL_TIPO_ROLES_MEDIADOR',				'DD_TRL_ID')
    );
    V_T_FK T_FK;
