...
--## PRODUCTO=NO
--##
--## Finalidad: Añadir dos nuevos campos en la tabla ACT_TBJ_TRABAJO
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_COL VARCHAR2(50 CHAR):= 'TBJ_CODIGO_PARTIDA'; --Nombre de la columna
	V_COL1 VARCHAR2(50 CHAR):= 'TBJ_CODIGO_SUBPARTIDA'; --Nombre de la columna
...
--Comprobacion de la tabla
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL||' IS ''Código de partida.''';
  ...
  IF V_NUM_TABLAS > 0 THEN  
            ...
            IF V_NUM_TABLAS = 0 THEN
                ...
                EXECUTE IMMEDIATE 'ALTER TABLE '||V_ESQUEMA||'.'||V_TABLA||' ADD '||V_COL1||' '||V_TIPO1||'';
                 V_MSQL := 'COMMENT ON COLUMN '||V_ESQUEMA||'.'||V_TABLA||'.'||V_COL1||' IS ''Código de subpartida.''';
				EXECUTE IMMEDIATE V_MSQL;
            ELSE
