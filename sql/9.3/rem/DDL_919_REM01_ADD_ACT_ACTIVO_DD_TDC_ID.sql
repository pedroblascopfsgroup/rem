...
BEGIN
		...
		IF V_NUM_TABLAS > 0 THEN
			...
			EXECUTE IMMEDIATE 'SELECT COUNT(1) FROM ALL_TAB_COLUMNS WHERE TABLE_NAME = '''||V_TEXT_TABLA||''' AND COLUMN_NAME = ''DD_TDC_ID'' AND OWNER ='''||V_ESQUEMA||'''' INTO V_NUM_TABLAS;
			...
			ELSE
				DBMS_OUTPUT.PUT_LINE('[La columna a insertar ya existe...]');
			END IF;
		ELSE 
