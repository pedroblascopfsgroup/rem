...
--## INCIDENCIA_LINK=HREOS-10485
--## PRODUCTO=NO
--## Finalidad: Nuevo campo ACT_PERIMETRO_ADMISION
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('ACT_PERIMETRO_ADMISION', 'NUMBER','(1,0)', 'Indicador de si el activo está en el perímetro de admisión')
    ); 
