...
--## PRODUCTO=NO
--## Finalidad: Creacion AUX_APR_MAIN_VT1_BBVA
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(2400 CHAR) := 'AUX_APR_MAIN_VT1_BBVA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
...
BEGIN
    ...
    ELSE
            ...
            (
                ...
                ,DEP_JURIDICAMENTE          VARCHAR2(1 CHAR)
                ,FECHA_DEP_JURIDICA         VARCHAR2(10 CHAR)
                ,NUM_AUTOS                  VARCHAR2(7 CHAR)
                ...
                ,RESTO_FINCAS               VARCHAR2(450 CHAR)
