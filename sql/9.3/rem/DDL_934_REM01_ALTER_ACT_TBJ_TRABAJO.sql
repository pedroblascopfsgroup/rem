...
--## INCIDENCIA_LINK=HREOS-11346
--## PRODUCTO=NO
--##
--## INSTRUCCIONES: Agregar columna a ACT_TBJ_TRABAJO
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-11346'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TEXT_TABLA VARCHAR2(30 CHAR) := 'ACT_TBJ_TRABAJO';
   
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('TBJ_FECHA_CAMBIO_ESTADO', 'DATE', 'Fecha del cambio de Estado')
    );
...
DBMS_OUTPUT.PUT_LINE('[FIN] ACTUALIZADA '||V_TEXT_TABLA||'s');
