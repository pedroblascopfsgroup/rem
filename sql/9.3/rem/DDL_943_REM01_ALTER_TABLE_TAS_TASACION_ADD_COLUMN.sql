...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-12854'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TABLE_NAME VARCHAR2(50 CHAR) := 'ACT_TAS_TASACION'; -- Vble. que almacena el nombre de la tabla.
    ...
    T_ARRAY_OF_COMMENTS T_COMMENTS := T_COMMENTS(
        'Flag que marca si la tasación ha sido creada desde REM o RECOVERY.'
    );
