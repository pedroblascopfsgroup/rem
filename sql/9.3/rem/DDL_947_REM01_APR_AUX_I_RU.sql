...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tablas APR_AUX_I_RU_FACT_SIN_PROV_BFA, APR_AUX_I_RU_LFACT_SIN_PROV_BFA y APR_AUX_I_RU_FACT_PROV_BFA
--##
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
	...
	/***** APR_AUX_I_RU_FACT_SIN_PROV_BFA *****/
	
	V_TABLA := 'APR_AUX_I_RU_FACT_SIN_PROV_BFA';
	...
	/***** APR_AUX_I_RU_LFACT_SIN_PROV_BFA *****/

	V_TABLA := 'APR_AUX_I_RU_LFACT_SIN_PROV_BFA';
	...
	V_TABLA := 'APR_AUX_I_RU_FACT_PROV_BFA';
