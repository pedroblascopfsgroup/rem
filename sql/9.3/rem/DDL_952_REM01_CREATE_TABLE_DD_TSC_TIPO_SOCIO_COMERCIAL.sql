...
--## PRODUCTO=NO
--##
--## Finalidad: DDL Creación de la tabla DD_TSC_TIPO_SOCIO_COMERCIAL
--##           
...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_TSC_TIPO_SOCIO_COMERCIAL'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- ******** DD_TSC_TIPO_SOCIO_COMERCIAL *******º
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla DD_TSC_TIPO_SOCIO_COMERCIAL
