...
DECLARE
    ...
    V_TABLA VARCHAR2(150 CHAR):= 'DD_ECC_ESTADO_COMUNICACION_C4C'; -- Vble. con el nombre de la tabla.
...
BEGIN
    ...
    -- ******** DD_ECC_ESTADO_COMUNICACION_C4C *******º
    DBMS_OUTPUT.PUT_LINE('******** '||V_TABLA||' ********'); 
    DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA||'.'||V_TABLA||'... Comprobaciones previas'); 
    
    -- Creacion Tabla DD_ECC_ESTADO_COMUNICACION_C4C
