...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
    	...
    	T_ALTER(  'IAP_ID',		 			 'NUMBER(16,0)',						'clave ajena a la tabla IAP_INFO_ADC_PERSONA'),
    	T_ALTER(  'COM_FECHA_NACIMIENTO',	 'DATE',						        'fecha de nacimiento'),
    	T_ALTER(  'DD_LOC_NAC_ID',		 	 'NUMBER(16,0)',						'localidad de nacimiento')
	);
    V_T_ALTER T_ALTER;    
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ' ||V_ESQUEMA||'.'||V_TEXT_TABLA||' AMPLIADA CON COLUMNAS NUEVAS.');
	COMMIT;
