...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('IAP_ID',                    'NUMBER(16,0)'       , 'clave ajena a la tabla IAP_INFO_ADC_PERSONA'),
        T_TIPO_DATA('TIA_FECHA_NACIMIENTO',      'DATE'               , 'Fecha de nacimiento'),
        T_TIPO_DATA('DD_LOC_NAC_ID',             'NUMBER(16,0)'       , 'Localidad de nacimiento'),
        T_TIPO_DATA('DD_PAI_NAC_ID',             'NUMBER(16,0)'       , 'Pais de nacimiento')
    );
