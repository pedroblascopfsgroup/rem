...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('ADD_COLUMN', 'IAP_INFO_ADC_PERSONA', 'IAP_MODIFICA_PBC', 'NUMBER(1,0)', '0'),
    T_COL('ADD_COLUMN', 'IAP_INFO_ADC_PERSONA', 'IAP_PRP', 'NUMBER(1,0) ', '0')
  );  
  V_TMP_COL T_COL;
