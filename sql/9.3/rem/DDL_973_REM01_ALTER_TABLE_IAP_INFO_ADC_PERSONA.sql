...
--## PRODUCTO=NO
--## Finalidad: Anyadir nuevos campos a la IAP_INFO_ADC_PERSONA
--##           
...
DECLARE
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
        ...
        T_ALTER('IAP_ANTIGUO_DEUDOR','NUMBER(1,0)','Flag que indica si es antiguo deudor'),
        T_ALTER('IAP_SOCIEDAD','VARCHAR2(150 CHAR)','Sociedad')
    );
    V_T_ALTER T_ALTER;
