...
DECLARE    
    ...
    V_NUM_TABLAS NUMBER(16); -- Vble. para validar la existencia de una tabla.
		...
		V_USU_CREAR VARCHAR2(30 CHAR) := '''REMVIP-5080'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    (
		...
		T_TIPO_DATA('T017_PBCReserva',					'1'	,				'comboRespuesta',				'SELECT DD_APD_CODIGO FROM '||V_ESQUEMA||'.DD_APD_APRUEBA_DENIEGA', 			'IN'),					
				...
				DBMS_OUTPUT.PUT_LINE('[INICIO]');		
					...
					FOR I IN V_TIPO_TAREA.FIRST .. V_TIPO_TAREA.LAST
						LOOP
							...
							EXECUTE IMMEDIATE V_TAREA_T017 INTO V_NUM_TAREA_T017;
