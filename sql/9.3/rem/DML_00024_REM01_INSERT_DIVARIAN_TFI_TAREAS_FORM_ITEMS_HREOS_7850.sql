...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade el check de Clonar y anular en la tarea Resolución de expediente para la cartera Divarian.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-7583';
