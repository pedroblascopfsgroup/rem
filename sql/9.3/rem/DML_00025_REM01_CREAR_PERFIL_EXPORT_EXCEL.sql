...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'REMVIP-5696'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DEL PERFIL
    V_PEF_CODIGO VARCHAR2(50) := 'USUINT';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Usuario interno';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Usuario interno';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION('EXPORTAR_BUSQUEDA_TAREAS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_ALERTAS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_AVISOS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_ACTIVOS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_AGRUPACIONES'),
		T_FUNCION('EXPORTAR_BUSQUEDA_TRABAJOS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_PUBLICACIONES'),
		T_FUNCION('EXPORTAR_BUSQUEDA_OFERTAS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_GASTOS'),
		T_FUNCION('EXPORTAR_BUSQUEDA_PROVEEDORES')
    ); 
