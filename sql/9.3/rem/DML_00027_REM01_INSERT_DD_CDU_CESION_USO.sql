...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_CDU_CESION_USO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'CDU';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-8471';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01',  'Cáritas',  'Cáritas'),
    	T_TIPO_DATA('02',  'Cesión Generalitat CX'		,'Cesión Generalitat CX.'),
    	T_TIPO_DATA('03',  'Cesión Otras Corporaciones.',           'Cesión Otras Corporaciones.'),
        T_TIPO_DATA('04',  'En trámite Cesión Otras Corporaciones.',           'En trámite Cesión Otras Corporaciones.'),
        T_TIPO_DATA('05',  'No aplica.',           'No aplica.')
    ); 
