...
DECLARE
    ...
    V_PEF_CODIGO VARCHAR2(50) := 'EXPORTPUBLI';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Exportación publicaciones';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Exportación publicaciones';
