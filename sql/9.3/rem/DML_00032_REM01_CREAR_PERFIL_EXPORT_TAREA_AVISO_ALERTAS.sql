...
DECLARE
    ...
    V_PEF_CODIGO VARCHAR2(50) := 'EXPORTTARAVAL';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Exportación tareas, avisos Y alertas';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Exportación tareas, avisos Y alertas';
