...
BEGIN
	...
	V_SQL := 'SELECT count(1) FROM '||V_ESQUEMA_M||'.USU_USUARIOS WHERE USU_USERNAME = ''grupgact'' ';
	...
	IF V_NUM_TABLAS > 0 THEN
	     ...
	     -- Verificar el entorno en el que estamos
			...
			V_MSQL := ' 
				UPDATE '||V_ESQUEMA_M||'.USU_USUARIOS SET USU_NOMBRE = ''Grupo Gestion de activos'',
				USU_MAIL = ''usuariogenericogda@haya.es'',
				USUARIOMODIFICAR = ''REMVIP-5874'', 
				FECHAMODIFICAR = SYSDATE 
				WHERE USU_USERNAME = ''grupgact'' ';
			...
			V_MSQL := ' 
				UPDATE '||V_ESQUEMA_M||'.USU_USUARIOS SET USU_NOMBRE = ''Grupo Gestion de activos'',
				USU_MAIL = ''ovidiu.remus@pfsgroup.es'',
				USUARIOMODIFICAR = ''REMVIP-5874'', 
				FECHAMODIFICAR = SYSDATE 
				WHERE USU_USERNAME = ''grupgact'' ';
