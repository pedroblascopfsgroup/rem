...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-8544'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('PDTE', 'NO_COLAB'),
        T_TIPO_DATA('PDTE', 'CONT_ERR'),
        T_TIPO_DATA('PDTE', 'CONT_FALL'),
        T_TIPO_DATA('PDTE', 'GEST_LOC'),
        T_TIPO_DATA('PDTE', 'SIN_INI'),
        T_TIPO_DATA('PDTE', 'INC'),
        T_TIPO_DATA('PDTE', 'PDTE_DOC'),
        T_TIPO_DATA('PDTE', 'SIN_DEU'),
        T_TIPO_DATA('PDTE', 'SIN_TIT'),
        T_TIPO_DATA('PDTE', 'CON_CONT'),
        T_TIPO_DATA('IDENT', 'INC_PAG'),
        T_TIPO_DATA('IDENT', 'PDTE_DOC'),
        T_TIPO_DATA('IDENT', 'CONT_ERR'),
        T_TIPO_DATA('IDENT', 'CONT_FALL'),
        T_TIPO_DATA('IDENT', 'SIN_TIT'),
        T_TIPO_DATA('IDENT', 'NO_COLAB'),
        T_TIPO_DATA('IDENT', 'REG'),
        T_TIPO_DATA('IDENT', 'SIN_DEU'),
        T_TIPO_DATA('NOE', 'EN_CONST'),
        T_TIPO_DATA('NOE', 'SIN_CONST'),
        T_TIPO_DATA('NOE', 'NA'),
        T_TIPO_DATA('NOE', 'SUELO'),
        T_TIPO_DATA('NOE', 'SIN_DEU')
    ); 
