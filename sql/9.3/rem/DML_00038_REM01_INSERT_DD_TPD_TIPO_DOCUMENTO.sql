...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
 		T_TIPO_DATA('154','Recibí de Gestoría (Inscripción Título)','Recibí de Gestoría (Inscripción Título)','AI-01-PRPE-34'),
      	T_TIPO_DATA('155','Plan de Acción urbanístico','Plan de Acción urbanístico','AI-07-DOCA-46')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP      
		...
		V_SQL := 'SELECT COUNT(1)
			...
			WHERE DD_TPD_MATRICULA_GD = '''|| TRIM(V_TMP_TIPO_DATA(4)) ||'''';
