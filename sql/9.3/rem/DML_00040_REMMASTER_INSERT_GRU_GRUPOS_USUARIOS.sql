...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-8363'; -- USUARIO CREAR/MODIFICAR
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
				--USU GRUPO 	USU_USERNAME
   	  T_FUNCION( 'gestpbc', 'rcf'),  
	  T_FUNCION( 'gestpbc', 'sch'),
	  T_FUNCION( 'gestpbc', 'pmoliner'),  
	  T_FUNCION( 'gestpbc', 'vlouzan'),
	  T_FUNCION( 'gestpbc', 'jcano'),  
	  T_FUNCION( 'gestpbc', 'rescuredo'),
	  T_FUNCION( 'gestpbc', 'mperezg'),  
	  T_FUNCION( 'gestpbc', 'agonzalezr'),
	  T_FUNCION( 'gestpbc', 'lmorillom')  
