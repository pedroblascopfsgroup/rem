...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('ACPF', 'Precios: Actualizar valores FSV de los activos', 'Precios: Actualizar valores FSV de los activos','VALORES_FSV_ACTUALIZAR','nD*,i,i,i,i,f,s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-8925'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
