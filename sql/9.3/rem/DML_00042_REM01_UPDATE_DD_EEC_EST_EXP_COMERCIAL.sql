  	...
  	IF V_NUM_TABLAS = 1 THEN
    	...
    	IF V_NUM = 1 THEN
            ...
            V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
                    SET DD_EEC_DESCRIPCION = ''Pendiente Resolución Comité''
					, DD_EEC_DESCRIPCION_LARGA = ''Pendiente Resolución Comité''
    	...
    	IF V_NUM = 1 THEN
            ...
            V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
                    SET DD_EEC_DESCRIPCION = ''Denegada oferta''
					, DD_EEC_DESCRIPCION_LARGA = ''Denegada oferta''
					, USUARIOMODIFICAR = '''||V_USUARIO||'''
					, FECHAMODIFICAR = SYSDATE
            		WHERE  DD_EEC_CODIGO = ''37''';
            EXECUTE IMMEDIATE V_MSQL;
    	...
    	IF V_NUM = 1 THEN
            ...
            V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TEXT_TABLA||'
                    SET DD_EEC_DESCRIPCION = ''Contraofertado''
					, DD_EEC_DESCRIPCION_LARGA = ''Contraofertado''
					, USUARIOMODIFICAR = '''||V_USUARIO||'''
					, FECHAMODIFICAR = SYSDATE
            		WHERE  DD_EEC_CODIGO = ''38''';
            EXECUTE IMMEDIATE V_MSQL;
