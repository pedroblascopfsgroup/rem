...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('APD', 'Apple - Aprobadas en Delegación', 'Apple - Aprobadas en Delegación'),
        T_TIPO_DATA('DRD', 'Divarian-Remaining - Aprobadas en Delegación', 'Divarian-Remaining - Aprobadas en Delegación'),
        T_TIPO_DATA('APC', 'Apple - Aprobadas por Cerberus', 'Apple - Aprobadas por Cerberus'),
        T_TIPO_DATA('DRC', 'Divarian-Remaining - Aprobadas por Cerberus', 'Divarian-Remaining - Aprobadas por Cerberus')
		); 
