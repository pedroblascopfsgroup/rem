...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('156'	,'Nota simple titular anterior al cliente Haya'		,'Nota simple titular anterior al cliente Haya'		,'AI-12-ACTR-13'),
    	T_TIPO_DATA('157'	,'Nota simple inscrita/con cargas'					,'Nota simple inscrita/con cargas'					,'AI-12-ACTR-01')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
					...
					', USUARIOMODIFICAR = ''REMVIP-6261'' , FECHAMODIFICAR = SYSDATE, DD_'||V_TEXT_CHARS||'_VISIBLE = 1'||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ',  '''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', '''||TRIM(V_TMP_TIPO_DATA(4))||''', 1, 0, ''REMVIP-6261'',SYSDATE,0 '||
					  ' FROM DUAL';
