...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('65'	,'Escritura de ratificación de venta' 	,'Escritura de ratificación de venta' 	,'04', 'OP-07-ESCR-46', ''),
    	T_TIPO_DATA('66'	,'Contrato compraventa' 				,'Contrato compraventa' 				,'04', 'OP-07-CNCV-17', ''),
    	T_TIPO_DATA('67'	,'Cancelación condiciones resolutorias' ,'Cancelación condiciones resolutorias' ,'04', 'OP-07-CERJ-AJ', '')
    ); 
