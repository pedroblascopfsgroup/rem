...
--## INCIDENCIA_LINK=HREOS-9492
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de carga masiva Gestionar peticiones de precios masivo.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Gestionar peticiones de precios masivo', 'FUN_OM_GEST_PET_PRECIOS')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-9492'',SYSDATE,0 FROM DUAL';
