...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('FUN_OM_GEST_PET_PRECIOS',		'HAYAGESTPREC'),
        T_FUNCION('FUN_OM_GEST_PET_PRECIOS',		'HAYAGESTPUBL'),
        T_FUNCION('FUN_OM_GEST_PET_PRECIOS',		'HAYASUPER')
