...
--## INCIDENCIA_LINK=HREOS-8908
--## PRODUCTO=NO
--##
--## Finalidad: INSERTAR SUBTIPOS DE TRABAJO EN DD_STR_SUBTIPO_TRABAJO
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_INCIDENCIA VARCHAR2(25 CHAR) := 'HREOS-8908';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('143'	,'Informe vulnerabilidad',      'Informe vulnerabilidad'		,'07'),
    	T_TIPO_DATA('144'	,'Liquidación proveedores',     'Liquidación proveedores'	    ,'07'),
    	T_TIPO_DATA('145'	,'Actuaciones ambientales',     'Actuaciones ambientales'		,'07')
