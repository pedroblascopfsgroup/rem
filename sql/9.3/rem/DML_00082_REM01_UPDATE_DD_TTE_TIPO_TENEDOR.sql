...
--## INCIDENCIA_LINK=REMIVIP-6400
--## PRODUCTO=NO
--## Finalidad: ACTUALIZAR los datos del diccionario DD_TTE_TIPO_TENEDOR
--##           
...
DECLARE
	...
	T_TIPO_DATA('01','Api primario','Api primario'),
	T_TIPO_DATA('02','Api espejo','Api espejo'),
	T_TIPO_DATA('03','EMS','EMS'),
	T_TIPO_DATA('04','Gestoría','Gestoría'),
	T_TIPO_DATA('05','Oficina','Oficina'),
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_TTE_TIPO_TENEDOR '||
					...
					', USUARIOMODIFICAR = ''REMVIP-6400'' , FECHAMODIFICAR = SYSDATE '||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_TTE_TIPO_TENEDOR (' ||
                      ...
                      'SELECT '|| V_ID || ', '''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''REMVIP-6400'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
      ...
      END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: DICCIONARIO ACTUALIZADO CORRECTAMENTE ');
