...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en CCC_CONFIG_CTAS_CONTABLES en la cartera APPLE-2020 con lo existente en APPLE-2019
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
BEGIN   
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN CCC_CONFIG_CTAS_CONTABLES; PARA APPLE - 2020');

 
    V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.CCC_CONFIG_CTAS_CONTABLES 
		(' ||  'CCC_ID, DD_STG_ID, DD_CRA_ID, DD_SCR_ID, PRO_ID, EJE_ID, CCC_CUENTA_CONTABLE, CCC_CUENTA_ACTIVABLE, CCC_ARRENDAMIENTO, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) 
                SELECT ' 
