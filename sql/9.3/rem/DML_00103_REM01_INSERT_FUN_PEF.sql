...
--## INCIDENCIA_LINK=HREOS-9561
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade un perfil a un función en la tabla FUN_PEF
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('EDITAR_TAB_ACTIVO_COMERCIAL',		'DIRTERRITORIAL')
