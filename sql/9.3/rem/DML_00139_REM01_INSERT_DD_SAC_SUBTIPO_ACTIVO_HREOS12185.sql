...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      -- 					TIPO ACTIVO(DD_TPA_CODIGO),   		SUBTIPO(DD_SAC_CODIGO),  			DESCRIPCION,  			         DESCRIPCION LARGA          DD_SAC_EN_BBVA
		...
		T_TIPO_DATA(			'07',								'41',							'Hostelero',			        'Hostelero',                        1),
		T_TIPO_DATA(			'01',								'42',							'Suelo Urbano No Consolidado',	'Suelo Urbano No Consolidado',      1)
    ...
    IF V_NUM_TABLAS > 0 THEN
        ...
        LOOP
            ...
            V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_SAC_SUBTIPO_ACTIVO '||
                        ...
                        ', USUARIOMODIFICAR = ''HREOS-12185'' , FECHAMODIFICAR = SYSDATE '||
