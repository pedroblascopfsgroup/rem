...
DECLARE
	...
	V_USUARIOCREAR VARCHAR2(50 CHAR) := 'HREOS-9980';
	...
	V_USER T_USUARIOS := T_USUARIOS(
		T_USU('gestformdivarian', ''||V_PWD(1)||'', 'Grupo Gestor Formalizacion','','','1')
	...
	LOOP
		...
		IF V_COUNT > 0 THEN
			...
			V_SQL := 'UPDATE '||V_ESQUEMA_M||'.'||V_TABLA||' SET 
				...
				BORRADO = 0, 
				USU_FECHA_VIGENCIA_PASS = TO_DATE(''02/04/2022'',''DD/MM/YYYY'')
