...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-9980'; -- USUARIO CREAR/MODIFICAR
	...
	V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		...
		T_FUNCION( 'gestformdivarian' , 'alopezr'), -- Alejandro López
		T_FUNCION( 'gestformdivarian' , 'ebenitezt'), -- Evelio Rafael Benitez
		T_FUNCION( 'gestformdivarian' , 'gplana'), -- Gloria Plana
		T_FUNCION( 'gestformdivarian' , 'jcarbonell'), -- Julio Enrique Carbonell
        T_FUNCION( 'gestformdivarian' , 'jmartinezsa'),--  Juan Fco Martinez
        T_FUNCION( 'gestformdivarian' , 'ptranche') -- Pedro Tranche
	); 
