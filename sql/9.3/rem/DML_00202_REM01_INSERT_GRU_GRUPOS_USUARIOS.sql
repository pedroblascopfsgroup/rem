...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-10062'; -- USUARIO CREAR/MODIFICAR
	...
	V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		...
		T_FUNCION( 'gruspublidiv' , 'avilarino'), -- Alejandra Vilariño Targhetta
		T_FUNCION( 'gruspublidiv' , 'rblanco'), -- Raul Blanco Alvarez
		T_FUNCION( 'gruspublidiv' , 'blecea'), -- Blanca de las Mercedes	Lecea Gil
		T_FUNCION( 'gruspublidiv' , 'saragon') -- SARA ARAGÓN GUTIÉRREZ        
	); 
