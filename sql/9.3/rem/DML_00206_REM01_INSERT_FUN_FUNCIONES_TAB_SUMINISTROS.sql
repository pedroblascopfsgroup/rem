...
--## INCIDENCIA_LINK=HREOS-10400
--## PRODUCTO=NO
--##
--## INSTRUCCIONES: Crear y asignar permiso de edición para el grid de la pestaña de Suministros al gestor, supervisor y gestoría de Administración.
--## VERSIONES:
--## 		0.1 Versión inicial
--##########################################
--*/
...
DECLARE
	...
	V_ITEM VARCHAR2(30 CHAR) := 'HREOS-10400'; -- USUARIOCREAR/USUARIOMODIFICAR.
	
	--EDITAR: DATOS DE LA FUNCION
	V_FUN_CODIGO VARCHAR2(50) := 'EDITAR_TAB_ACTIVO_SUMINISTROS';
	V_FUN_DESCRIPCION VARCHAR2(255) := 'Función para editar la pestaña suministros';
