...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('10318'			,'Pueblonuevo del Miramonte'		,'Pueblonuevo del Miramonte'			,'10')
    ); 
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.DD_LOC_LOCALIDAD (' ||
						...
						', 0, ''REMVIP-7159'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
      ...
      END LOOP;
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('[FIN]: DICCIONARIO DD_LOC_LOCALIDAD ACTUALIZADO CORRECTAMENTE ');
