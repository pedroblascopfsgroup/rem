...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('CMCT', 'Carga masiva Complemento titulo', 'Carga masiva Complemento titulo','CARGA_MASIVA_COMPLEMENTO_TITULO','n*,s*,f,f,f,f,s')
    ); 
