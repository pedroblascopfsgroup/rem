...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_EAA_ESTADO_ACT_ADMISION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_EAA_ESTADO_ACT_ADMISION';
    V_CHARS VARCHAR2(3 CHAR):= 'EAA';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-10484';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			      DESCRIPCION                       DESCRIPCION_LARGA 
      T_TIPO_DATA('PET',			'Pendiente título',			             'Pendiente título'),
      T_TIPO_DATA('PRT',			'Pendiente revisión título',		     'Pendiente revisión título'),
      T_TIPO_DATA('PSR',      'Pendiente saneamiento registral',   'Pendiente saneamiento registral'),
