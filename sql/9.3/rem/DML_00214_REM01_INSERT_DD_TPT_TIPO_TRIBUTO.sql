...
--## PRODUCTO=NO
--## 
--## Finalidad: '||V_CHARS||'ipt que añade en DD_TPT_TIPO_TRIBUTO los datos añadidos en T_ARRAY_DATA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(30 CHAR) := 'DD_TPT_TIPO_TRIBUTO';  -- Tabla a modificar
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('01' ,'IBI urbana',' IBI urbana'),
		T_TIPO_DATA('02' ,'IBI rústica','IBI rústica'),
		T_TIPO_DATA('03' ,'Agua','Agua'),
		T_TIPO_DATA('04' ,'Alcantarillado','Alcantarillado'),
		T_TIPO_DATA('05' ,'Basura','Basura'),
		T_TIPO_DATA('06' ,'Exacciones municipales','Exacciones municipales'),
		T_TIPO_DATA('07' ,'Otras tasas municipales','Otras tasas municipales'),
		T_TIPO_DATA('08' ,'Tasa canalones','Tasa canalones'),
		T_TIPO_DATA('09' ,'Tasa regularización catastra','Tasa regularización catastra'),
