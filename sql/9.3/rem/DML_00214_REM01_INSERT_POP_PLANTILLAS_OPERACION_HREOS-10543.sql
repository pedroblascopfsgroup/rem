...
--## PRODUCTO=NO
--##
--## INSTRUCCIONES: Script que añade en POP_PLANTILLAS_OPERACION los datos añadidos en T_ARRAY_DATA.
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_ESTADOS_ADMISION', 'plantillas/plugin/masivo/EstadosAdmision.xls', 'CMESTADOADM')
    ); 
