...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      -- 					TIPO TRABAJO(DD_TGA_CODIGO),   		SUBTIPO(DD_STG_CODIGO),  			DESCRIPCION,  			                    DESCRIPCION LARGA
		T_TIPO_DATA(			'01',								'103',							'Agua',			                                'Agua'),
		T_TIPO_DATA(			'01',								'104',							'Alcantarillado',			                    'Alcantarillado'),
		T_TIPO_DATA(			'01',								'105',							'Basura',	                                    'Basura'),
		T_TIPO_DATA(			'01',								'106',							'Exacciones municipales',                       'Exacciones municipales'),
		T_TIPO_DATA(			'01',								'107',							'Otras tasas municipales',			            'Otras tasas municipales'),
		T_TIPO_DATA(			'01',								'108',							'Tasa canalones',			                    'Tasa canalones'),
		T_TIPO_DATA(			'01',								'109',							'Tasa incendios',			                    'Tasa incendios'),
        T_TIPO_DATA(			'01',								'110',							'Tasa regularización catastral',			    'Tasa regularización catastral'),
		T_TIPO_DATA(			'01',								'111',							'Tasas administrativas',			            'Tasas administrativas'),
		T_TIPO_DATA(			'01',								'112',							'Tributo metropolitano-movilidad',			    'Tributo metropolitano-movilidad'),
		T_TIPO_DATA(			'01',								'113',							'Vado',			                                'Vado')
