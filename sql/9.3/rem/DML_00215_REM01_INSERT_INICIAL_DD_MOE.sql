...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_MOE_MOTIVO_EXENTO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_MOE_MOTIVO_EXENTO';
    V_CHARS VARCHAR2(3 CHAR):= 'MOE';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-10658';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION                         DESCRIPCION_LARGA   
      T_TIPO_DATA('01',			'Rustica',			                  'Rustica'),
      T_TIPO_DATA('02',			'Organismo no recauda',		        'Organismo no recauda'),
      T_TIPO_DATA('03',			'Adquisición inferior 1 año',		  'Adquisición inferior 1 año'),
