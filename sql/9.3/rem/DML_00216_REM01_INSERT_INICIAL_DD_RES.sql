...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_RES_RESULTADO_SOLICITUD
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_RES_RESULTADO_SOLICITUD';
    V_CHARS VARCHAR2(3 CHAR):= 'RES';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-10658';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION                         DESCRIPCION_LARGA   
      T_TIPO_DATA('01',			'Desestimado',			                  'Desestimado'),
      T_TIPO_DATA('02',			'No recurrible por importe',		      'No recurrible por importe'),
      T_TIPO_DATA('03',			'Pendiente resolución',		            'Pendiente resolución'),
      T_TIPO_DATA('04',     'Resuelto favorable',                 'Resuelto favorable')
