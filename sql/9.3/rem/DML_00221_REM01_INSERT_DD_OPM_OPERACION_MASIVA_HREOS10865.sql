...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('CMCONFPERVOL', 'Carga masiva Configuración periodos voluntarios', 'Carga masiva Configuración periodos voluntarios','CARGA_MASIVA_CONFIG_PERIODOS_VOLUNTARIOS','s, s, s*, f*, f ,s, s')
    ); 
