...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMUG', 'Carga masiva única de gastos', 'Carga masiva única de gastos','CARGA_MASIVA_UNICA_GASTOS','n*,s*,s,s,s,s*,s*,s*,s*,f*,s,s,s,s,s,f,s,i,i,s,i,i,s,s,s,s,i*,s,n*,s*,i,i,s,i,i,i,i,i,s,s,s,i,s,n,s,i')
    ); 																												
