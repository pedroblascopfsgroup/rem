...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-7390';    

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('162',	'Justificante envío llaves central',	'Justificante envío llaves central',  'OP-13-CERJ-AQ'),
		T_TIPO_DATA('163',	'Justificante envío llaves API',	    'Justificante envío llaves API',        'OP-13-CERJ-AR')		
    ); 
