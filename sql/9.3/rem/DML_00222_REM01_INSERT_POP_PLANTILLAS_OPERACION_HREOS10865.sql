...
--## INCIDENCIA_LINK=HREOS-10865
--## PRODUCTO=NO
--##
--## FINALIDAD: Anyadir  registro
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_CONFIG_PERIODOS_VOLUNTARIOS', 'plantillas/plugin/masivo/CARGA_CONFIG_PERIODOS_VOLUNTARIOS.xls', 'CMCONFPERVOL')
    ); 
