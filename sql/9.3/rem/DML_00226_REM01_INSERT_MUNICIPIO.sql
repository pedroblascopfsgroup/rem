...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-8018'; --Vble. auxiliar para almacenar el usuario
    ...
    (
        ...
        T_TIPO_DATA('43908'			,'La Vall de L''''Arrabassada'		,'La Vall de L''''Arrabassada'			,'43')
    ); 
        ...
        IF V_NUM_TABLAS < 1 THEN				
          ...
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	         
            ...
            V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.'||V_TABLA||' (' ||
                      	'DD_LOC_ID, DD_LOC_CODIGO, DD_LOC_DESCRIPCION, DD_LOC_DESCRIPCION_LARGA, DD_PRV_ID, USUARIOCREAR, FECHACREAR) VALUES (
                      	'|| V_ID ||'
                        ,'''||V_TMP_TIPO_DATA(1)||'''
