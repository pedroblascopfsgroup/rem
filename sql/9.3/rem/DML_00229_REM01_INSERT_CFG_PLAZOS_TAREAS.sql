...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      ...
      T_TIPO_DATA('01','02',6),
      T_TIPO_DATA('01','03',4),
      T_TIPO_DATA('01','04',10),
      T_TIPO_DATA('01','05',1),
      T_TIPO_DATA('01','06',8),
      T_TIPO_DATA('01','07',20),
      T_TIPO_DATA('02','13',48),
      T_TIPO_DATA('02','14',20),
      T_TIPO_DATA('02','15',6),
      T_TIPO_DATA('02','16',4),
      T_TIPO_DATA('02','17',1),
      T_TIPO_DATA('02','18',16),
      T_TIPO_DATA('02','19',1),
      T_TIPO_DATA('02','20',0),
      T_TIPO_DATA('02','21',12),
      T_TIPO_DATA('02','22',9999),
      T_TIPO_DATA('02','23',3),
      T_TIPO_DATA('02','24',6),
      T_TIPO_DATA('02','25',4),
      T_TIPO_DATA('03','ACO',10)
    ); 
