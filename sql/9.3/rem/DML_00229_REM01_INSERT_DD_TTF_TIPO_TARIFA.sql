...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''HREOS-11427'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    (
		T_TIPO_DATA('EXT-01'  ,'Extras de cerradura'),
		T_TIPO_DATA('EXT-02'  ,'Extra de limpieza'),
		T_TIPO_DATA('EXT-03'  ,'Extra de limpieza y contenedores'),
		T_TIPO_DATA('EXT-04'  ,'Extra de cerraduras, limpiezas y contenedores')
	); 
