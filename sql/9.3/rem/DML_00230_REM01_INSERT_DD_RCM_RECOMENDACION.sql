...
--## PRODUCTO=NO
--## FINALIDAD: Script que añade en DD_RCM_RECOMENDACION los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_RCM_RECOMENDACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'RCM'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO_CREAR VARCHAR2(20 CHAR) := 'REMVIP-8069'; -- Vble. auxiliar para almacenar el usuario crear
    V_USUARIO_MODIFICAR VARCHAR2(20 CHAR) := 'REMVIP-8069'; -- Vble. auxiliar para almacenar el usuario modificar

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --T_TIPO_DATA('DD_SRA_CODIGO',		'DD_SRA_DESCRIPCION',		'DD_SRA_DESCRIPCION_LARGA')
      T_TIPO_DATA('01','Aprobar'),
      T_TIPO_DATA('02','Rechazar'),
      T_TIPO_DATA('03','Contraofertar')     
    ); 
      ...
      LOOP
        ...
        ELSE		
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ', '''|| TRIM(V_TMP_TIPO_DATA(1)) ||''', '''|| TRIM(V_TMP_TIPO_DATA(2)) ||''','''|| TRIM(V_TMP_TIPO_DATA(2)) ||''', 0, '''|| V_USUARIO_CREAR ||''',SYSDATE, 0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
