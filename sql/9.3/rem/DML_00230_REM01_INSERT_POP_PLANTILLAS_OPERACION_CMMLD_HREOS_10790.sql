...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR):='HREOS-10790'; -- Vble. que indica el usuario que realiza la operación (USUARIOCREAR)
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_MODIFICACION_LINEAS_DETALLE', 'plantillas/plugin/masivo/CARGA_MASIVA_MODIFICACION_LINEAS_DETALLE.xls', 'CMMLD')
    ); 
