...
--## INCIDENCIA_LINK=HREOS-11199
--## PRODUCTO=NO
--##
--## Finalidad: update TAP_TAREA_PROCEDIMIENTO script validacion T017_ResolucionCES, T017_RespuestaOfertanteCES, T017_RatificacionComiteCES
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
