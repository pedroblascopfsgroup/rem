...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('01','Gestión','información sobre el trabajo',0),
      T_TIPO_DATA('02','Estado de activo','Información sobre el estado físico del activo (ruinas, vandalizado, peligro de derrumbe)',1)
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_TAT_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||'''';
