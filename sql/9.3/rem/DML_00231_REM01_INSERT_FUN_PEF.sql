...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR):= 'HREOS-10790';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('CARGA_MASIVA_MODIFICACION_LINEAS_DETALLE')
      			...
      			LOOP
					...
					ELSE
						V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
							...
							' SELECT FUN.FUN_ID, PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, '''||V_USUARIO||''', SYSDATE, 0' ||
