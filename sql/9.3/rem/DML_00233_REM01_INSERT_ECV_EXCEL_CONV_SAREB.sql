...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('ACCS','ESPARTA_EXCEL1','ActualizadosConvivenciaSareb', 'campos actualizados en Convivencia Sareb'),
      T_TIPO_DATA('RECS','ESPARTA_EXCEL3','RechazadosConvivenciaSareb', 'campos rechazados en Convivencia Sareb'),
      T_TIPO_DATA('ALCS','ESPARTA_EXCEL4','AlertasConvivenciaSareb', 'campos alertas en Convivencia Sareb')
		); 
