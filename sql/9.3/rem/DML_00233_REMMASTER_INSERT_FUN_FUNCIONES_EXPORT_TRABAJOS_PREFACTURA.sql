...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función para permitir descargar la búsqueda de trabajos de la prefactura en excel
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Permitir descargar la búsqueda de trabajos de la prefactura en excel', 'EXPORTAR_BUSQUEDA_TRABAJOS_PREFACTURA')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-11154'',SYSDATE,0 FROM DUAL';
