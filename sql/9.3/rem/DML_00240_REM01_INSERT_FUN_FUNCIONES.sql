...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-11369'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DE LA FUNCION
    V_FUN_CODIGO VARCHAR2(50) := 'CARGA_MASIVA_TARIFAS_PRESUPUESTOS';
    V_FUN_DESCRIPCION VARCHAR2(255) := 'Carga masiva de tarifas y presupuestos';
