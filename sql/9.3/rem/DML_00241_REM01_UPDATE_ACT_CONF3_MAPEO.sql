...
DECLARE
  ...
  V_TABLA VARCHAR2(25 CHAR):= 'ACT_CONF3_MAPEO';
...
BEGIN
  ...
  V_SQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET 
        ...
        , AC3_TRANSFORMACION = ''LEFT JOIN '||V_ESQUEMA_M||'.DD_SIN_SINO CRUCE ON CRUCE.DD_SIN_CODIGO = ''''01'''' AND TMP.VALOR_NUEVO IS NOT NULL AND CRUCE.BORRADO = 0''
        ...
        WHERE CCS.BORRADO = 0 AND COS.DD_COS_CODIGO = ''141'')
        ';
