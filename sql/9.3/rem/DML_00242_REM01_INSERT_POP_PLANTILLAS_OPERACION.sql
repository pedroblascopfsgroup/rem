...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_TARIFAS_PRESUPUESTOS', 'plantillas/plugin/masivo/CARGA_MASIVA_TARIFAS_PRESUPUESTOS.xls', 'CMTARIFASPRESUP')
    ); 
