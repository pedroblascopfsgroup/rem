...
DECLARE
  ...
  V_COL T_ARRAY_COL := T_ARRAY_COL(
    T_COL('ADD_COLUMN', 'GDE_GASTOS_DETALLE_ECONOMICO', 'DD_TRE_ID', 'NUMBER(16)'),
    T_COL('ADD_FK', 'GDE_GASTOS_DETALLE_ECONOMICO', 'FK_GDE_DD_TRE_ID', 'DD_TRE_TIPO_RETENCION','DD_TRE_ID'),
