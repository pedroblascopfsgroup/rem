...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('078','¿Tiene boletin de agua?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('079','¿Tiene boletin de electricidad?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('080','¿Tiene boletin de gas?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('081','¿tiene cedula de habitabilidad?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('083','¿Tiene Certificado energetico?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('084','¿tienen informe 0?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('092','¿Tiene CFO?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID'),
      T_TIPO_DATA('094','¿Tiene LPO?','ACT_ADO_ADMISION_DOCUMENTO','ADO_FECHA_OBTENCION','ACT_ID')
    ); 
