...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-12316';
    ...
    --         NOMBRE_FUNCION                   NOMBRE_PERFIL
        T_FUNCION('CARGA_MASIVA_ALTA_TRABAJOS',		'HAYAGESACT'),
        T_FUNCION('CARGA_MASIVA_ALTA_TRABAJOS',		'HAYASUPER'),
        T_FUNCION('CARGA_MASIVA_ALTA_TRABAJOS',		'GESTEDI')
    ); 
