...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_TCC_TIPO_CUOTA_COM';
    V_CHARS VARCHAR2(3 CHAR):= 'TCC';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-13204';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION     DESCRIPCION_LARGA
      T_TIPO_DATA('01',			'Anual',			'Anual'),
      T_TIPO_DATA('02',			'Bimensual',		    'Bimensual'),
      T_TIPO_DATA('03',			'Cuatrimestral',			'Cuatrimestral'),
      T_TIPO_DATA('04',			'Mensual',		    'Mensual'),
      T_TIPO_DATA('05',			'Por liquidación',			'Por liquidación'),
      T_TIPO_DATA('06',			'Semestral',		    'Semestral'),
      T_TIPO_DATA('07',			'Sin cuota ordinaria',			'Sin cuota ordinaria'),
      T_TIPO_DATA('08',			'Trimestral',		    'Trimestral')
    ); 
