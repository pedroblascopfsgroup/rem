    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: LA ENTIDAD YA EXISTE '''|| TRIM(V_TMP_TIPO_DATA(2)) ||'''');
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_ENO_ENTIDAD_ORIGEN (' ||
                      'DD_ENO_ID, DD_ENO_CODIGO, DD_ENO_DESCRIPCION, DD_ENO_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) ' ||
