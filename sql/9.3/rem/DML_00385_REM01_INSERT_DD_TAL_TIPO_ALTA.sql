...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('AUT','Alta automática','Alta automática'),
        T_TIPO_DATA('MAA','Manual.Activo aparecido','Manual.Activo aparecido'),
        T_TIPO_DATA('MIA','Manual.Incidencia proceso automático	','Manual.Incidencia proceso automático'),
        T_TIPO_DATA('MDH','Manual.División horizontal','Manual.División horizontal'),
        T_TIPO_DATA('MAG','Manual.Agrupaciones	','Manual.Agrupaciones')
		); 
