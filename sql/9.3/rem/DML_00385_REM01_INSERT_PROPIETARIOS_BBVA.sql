...
BEGIN
	...
	COMMIT;
	 ...
	 V_MSQL := 'SELECT COUNT(1) FROM ALL_TAB_COLUMNS WHERE OWNER = '''||V_ESQUEMA||''' AND TABLE_NAME = ''GUNSHOTS_MIGDIVARIAN_PFS'' ';
    ...
    ELSE
    	DBMS_OUTPUT.PUT_LINE('  [INFO] GUNSHOTS_MIGDIVARIAN_PFS  NO existe.');
    END IF;
