...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('CMGASTOSASOCADQ', 'Carga masiva gastos asociados a la adquisición', 'Carga masiva gastos asociados a la adquisición','CARGA_MASIVA_GASTOS_ASOCIADOS_ADQUISICION','nD*,s*,f*,f*,s')
    ); 
