...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_SANCIONES_BBVA', 'plantillas/plugin/masivo/CargaSancionesBBVA.xls', 'CMSANCIONESBBVA')
    ); 
