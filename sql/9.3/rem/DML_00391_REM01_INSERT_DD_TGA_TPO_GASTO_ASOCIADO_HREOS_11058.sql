...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_TGA_TPO_GASTO_ASOCIADO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_TGA_TPO_GASTO_ASOCIADO';
    V_CHARS VARCHAR2(3 CHAR):= 'TGA';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-11058';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			      DESCRIPCION                                               DESCRIPCION_LARGA 
      T_TIPO_DATA('01',			'ITP',			    'ITP'),
      T_TIPO_DATA('02',			'Plusvalía de adquisición',			    'Plusvalía de adquisición'),
      T_TIPO_DATA('03',			'Notaría',			          'Notaría'),
      T_TIPO_DATA('04',			'Registro',			              'Registro'),
      T_TIPO_DATA('05',			'Otros gastos',		'Otros gastos')
    ); 
