...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-12351';
    ERR_NUM NUMBER(25);  -- Vble. auxiliar para registrar errores en el script.
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
    V_COUNT NUMBER(16); --Vble para comprobar si existe registro con el codigo
    --n*,s*,s,s,s,s*,s*,s*,s*,f*,s,s,s,s,s,f,s,i,s,i,i,s,s,s,s,i*,s,n*,s*,i,i,s,i,i,i,i,i,s,s,s,i,s,n,s,i
    V_VALIDACION VARCHAR2(256 CHAR):= 'n*,s*,s,s,s,s*,s*,s*,s*,f*,s*,s,s,s,s,f,s,i,s,i,i,s,s,s,s,i,s,n*,s*,i,i,s,i,i,i,i,i,s,s,s,i,s,n,s,i';
    V_OPM_COD VARCHAR2(256 CHAR):= 'CMUG';
