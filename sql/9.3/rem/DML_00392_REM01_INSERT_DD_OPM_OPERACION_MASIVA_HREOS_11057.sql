...
DECLARE
    ...
    TYPE T_FUNCION IS TABLE OF VARCHAR2(1000);
    TYPE T_ARRAY_FUNCION IS TABLE OF T_FUNCION;
   V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(									
	     T_FUNCION('CMALTABBVA', 'Carga Masiva Alta de activos BBVA', 'Carga Masiva Alta de activos BBVA','CARGA_MASIVA_ALTA_BBVA','n*')
       ); 
