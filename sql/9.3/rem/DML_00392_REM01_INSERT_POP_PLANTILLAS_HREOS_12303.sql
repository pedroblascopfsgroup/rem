...
--## INCIDENCIA_LINK=HREOS-12303
--## PRODUCTO=SI
--##
--## Finalidad: Actualizar instrucciones
--## INSTRUCCIONES: Actualizar el registro donde sea PORCENTAJE_CONSTRUCCION en la tabla POP_PLANTILLAS_OPERACION
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
--*/
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('ACTUALIZAR_PORCENTAJE_CONSTRUCCION', 'plantillas/plugin/masivo/ACTUALIZAR_PORCENTAJE_CONSTRUCCION.xls', 'PRCS')
    ); 
