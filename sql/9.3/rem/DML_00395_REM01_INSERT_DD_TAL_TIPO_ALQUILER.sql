...
--## INCIDENCIA_LINK=HREOS-11480
--## PRODUCTO=NO
--##
--## Finalidad: Insert en tabla DD_TAL_TIPO_ALQUILER.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'TAL';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-11480';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('13',  'Aceptadas Cesión Generalitat',      'Aceptadas Cesión Generalitat'),
    	T_TIPO_DATA('14',  'Alquiler Social BBVA ',             'Alquiler Social BBVA '),
    	T_TIPO_DATA('15',  'Alquiler Social CX ',               'Alquiler Social CX'),
        T_TIPO_DATA('16',  'Código Buenas Prácticas',           'Código Buenas Prácticas'),
        T_TIPO_DATA('17',  'En trámite de Cesión Generalitat',  'En trámite de Cesión Generalitat')
    ); 
