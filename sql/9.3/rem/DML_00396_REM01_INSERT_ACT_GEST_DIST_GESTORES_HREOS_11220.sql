...
DECLARE
    ...
    V_USU VARCHAR2(50 CHAR) := 'HREOS-11220'; -- Vble. auxiliar para almacenar el usuario crear  
    V_ENTIDAD_ID NUMBER(16);  
    V_ID NUMBER(16);
    V_COND1 VARCHAR2(400 CHAR) := 'IS NULL';
    V_COND2 VARCHAR2(400 CHAR) := 'IS NULL';
    V_COND3 VARCHAR2(400 CHAR) := 'IS NULL'; 
    V_COND4 VARCHAR2(400 CHAR) := 'IS NULL';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      ...
      T_TIPO_DATA('GBOAR', '1', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '2', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '3', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '4', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '5', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '6', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '7', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '8', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '9', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '10', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '11', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '12', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '13', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '14', '', '', '', '', '', 'gruboarding', '', ''),
      T_TIPO_DATA('GBOAR', '15', '', '', '', '', '', 'gruboarding', '', '')
