...
DECLARE
    ...
    (
    -- CODIGO_STG,		CUENTA_CONTABLE 		
	T_TIPO_DATA('95','6230010')	
    ); 
      ...
      LOOP      
        ...
        --Comprobamos el dato a insertar
	   	V_SQL :=   'SELECT COUNT(1) 
					...
					AND CCC_CUENTA_CONTABLE = '''||TRIM(V_TMP_TIPO_DATA(2))||''' 
					AND EJE_ID = '||V_EJE_ID||' 
       ...
       --Si no existe, lo insertamos
        IF V_NUM_TABLAS = 0 THEN            
         V_SQL :=    'INSERT INTO '||V_ESQUEMA||'.'||V_TABLA||'
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: REGISTRO CCC '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''  '''|| TRIM(V_TMP_TIPO_DATA(2)) ||''' INSERTADO CORRECTAMENTE');
          
        
        ELSE 
            DBMS_OUTPUT.PUT_LINE('[INFO] Ya existe el subgasto con código '||TRIM(V_TMP_TIPO_DATA(1))||' en la cuenta contable '||TRIM(V_TMP_TIPO_DATA(2))||' para el año 2021.');		
