...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade las funciones al gestor Gestor Boarding que tiene el Gestor Fomalizacion
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-11220';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('MODIFICAR_TAB_COMPRADORES_EXPEDIENTES_RESERVA'),
