...
--## FECHA_CREACION=20201206
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-12388
--## PRODUCTO=NO
--##
--## Finalidad: insert into DD_VEA_VALIDA_ESTADO_ACTIVO
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_VEA_VALIDA_ESTADO_ACTIVO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'VEA'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01'	,'No validado'		,'No validado'),
        T_TIPO_DATA('02'	,'Validado'		,'Validado')
    ); 
