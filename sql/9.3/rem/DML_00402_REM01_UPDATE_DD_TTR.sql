...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_TTR_TIPO_TRABAJO';
    V_CHARS VARCHAR2(3 CHAR):= 'TTR';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-12486';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION     DESCRIPCION_LARGA     BLOQUEADO
      T_TIPO_DATA('08',			'Suelo',			'Suelo',                 1)
      ...
      IF V_NUM_TABLAS > 0 THEN				
        ...
        V_MSQL := '
          ...
          SET 
            ...
            DD_'||V_CHARS||'_BLOQUEADO = '''||TRIM(V_TMP_TIPO_DATA(4))||''',
      ...
      ELSE
        ...
        V_MSQL := '
          	INSERT INTO '|| V_ESQUEMA ||'.'||V_TABLA||' (
				...
				DD_'||V_CHARS||'_BLOQUEADO, VERSION, USUARIOCREAR, FECHACREAR)
          	SELECT 
	            '|| V_ID || ',
	            '''||V_TMP_TIPO_DATA(1)||''',
	            '''||V_TMP_TIPO_DATA(2)||''',
