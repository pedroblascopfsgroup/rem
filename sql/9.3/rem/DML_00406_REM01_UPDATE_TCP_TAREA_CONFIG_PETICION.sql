...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      ...
      T_TIPO_DATA('T013_InstruccionesReserva',			     1,			         1),
      T_TIPO_DATA('T013_ObtencionContratoReserva',			 1,		           1),
      T_TIPO_DATA('T013_DocumentosPostVenta',            1,              1),
      T_TIPO_DATA('T013_ResolucionExpediente',			     1,		           1),
      T_TIPO_DATA('T017_InstruccionesReserva',           1,              1),
      T_TIPO_DATA('T017_ObtencionContratoReserva',       1,              1),
      T_TIPO_DATA('T017_PosicionamientoYFirma',          1,              1),
      T_TIPO_DATA('T017_DocsPosVenta',                   1,              1),
      T_TIPO_DATA('T017_ResolucionExpediente',           1,              1)
