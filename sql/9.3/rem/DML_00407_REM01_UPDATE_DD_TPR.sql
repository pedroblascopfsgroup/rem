...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_TPR_TIPO_PROVEEDOR';
    V_CHARS VARCHAR2(3 CHAR):= 'TPR';
    V_TABLA_TIPO VARCHAR2(50 CHAR):= 'DD_TEP_TIPO_ENTIDAD_PROVEEDOR';
    V_CHARS_TIPO VARCHAR2(50 CHAR):= 'TEP';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-12587';
    V_COD_SUP VARCHAR2(2 CHAR):= '03';
    V_ID_SUP NUMBER(16);
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			    DESCRIPCION                   DESCRIPCION_LARGA 
      T_TIPO_DATA('44',		 'Proveedor Tutelas',			       'Proveedor Tutelas')
