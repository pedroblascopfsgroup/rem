...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('ESTT', 'Carga masiva actualizar estado trabajos', 'Carga masiva actualizar estado trabajos','ACTUALIZAR_ESTADO_TRABAJOS','s*, s*, s')
    ); 
