...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('CMCAMACC', 'Carga masiva campos accesibilidad', 'Carga masiva campos accesibilidad','CARGA_MASIVA_CAMPOS_ACCESIBILIDAD','sD*,s,f,s,f,s,f,f,s,f,f')
    ); 
