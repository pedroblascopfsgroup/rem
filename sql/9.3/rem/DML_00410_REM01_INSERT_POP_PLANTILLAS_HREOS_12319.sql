...
--## INSTRUCCIONES: Actualizar el registro donde sea ESTADO_TRABAJO en la tabla POP_PLANTILLAS_OPERACION
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
--*/
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('ACTUALIZAR_ESTADO_TRABAJOS', 'plantillas/plugin/masivo/ACTUALIZAR_ESTADO_TRABAJOS.xls', 'ESTT')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.POP_PLANTILLAS_OPERACION' ||
							...
							' 0, ''HREOS-12319'', SYSDATE, 0 FROM DUAL';
