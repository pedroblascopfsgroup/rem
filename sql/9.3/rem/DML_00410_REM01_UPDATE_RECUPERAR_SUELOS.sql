...
--## INCIDENCIA_LINK=HREOS-13678
--## PRODUCTO=NO
--##
--## Finalidad: Recuperar registros con borrado logico
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(20 CHAR) := 'HREOS-13678';
 ...
 V_TMP_TIPO_DATA := V_TIPO_DATA(I);
	 ...
	 -- Verificar si la tabla ya existe
  	...
  	IF V_NUM_TABLAS = 1 THEN
                ...
                DBMS_OUTPUT.PUT_LINE('Recuperado logico de entradas en '||V_TMP_TIPO_DATA(1)||' creadas en '||V_USUARIO_CREADOR );
    	        ...
    	        IF V_NUM > 0 THEN
                        ...
                        V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TMP_TIPO_DATA(1)||' SET BORRADO = 0, 
					    USUARIOBORRAR =  NULL, 
					    FECHABORRAR = NULL,
                ...
                DBMS_OUTPUT.PUT_LINE('Recuperados '||V_NUM||' registros en la tabla '||V_TMP_TIPO_DATA(1));
