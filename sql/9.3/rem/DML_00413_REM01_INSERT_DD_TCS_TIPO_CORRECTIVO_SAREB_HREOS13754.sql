...
--## INCIDENCIA_LINK=HREOS-13754
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade nuevos datos del array en DD_TCS_TIPO_CORRECTIVO_SAREB
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-13754';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION                                                     DESCRIPCION_LARGA
      T_TIPO_DATA('103',		'Revisión técnica fachadas',			                'Revisión técnica fachadas'),
      T_TIPO_DATA('104',		'Pruebas estanqueidad/acústica/aislamiento',		    'Pruebas estanqueidad/acústica/aislamiento')
    ); 
