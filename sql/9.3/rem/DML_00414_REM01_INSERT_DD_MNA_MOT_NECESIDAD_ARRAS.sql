...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-14037';

    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MNA_MOT_NECESIDAD_ARRAS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		LOOP
			...
			V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE
				DD_MNA_CODIGO = '''||V_TMP_TIPO_DATA(1)||'''
				AND DD_MNA_DESCRIPCION = '''||V_TMP_TIPO_DATA(2)||'''
				AND DD_MNA_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(2)||'''';
