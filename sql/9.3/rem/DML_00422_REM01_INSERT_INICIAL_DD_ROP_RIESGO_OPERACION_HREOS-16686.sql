...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_ROP_RIESGO_OPERACION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_ROP_RIESGO_OPERACION';
    V_CHARS VARCHAR2(3 CHAR):= 'ROP';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-16686';
