...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-12155'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO] INSERCION TABLA PEF_PERFILES');
	
	V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.PEF_PERFILES WHERE PEF_CODIGO = ''HAYA_SUPER_CONTABILIDAD''';
	...
	IF V_NUM_FILAS = 0 THEN
		...
		V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.PEF_PERFILES 
					...
					''HAYA_SUPER_CONTABILIDAD'',
					''Superusuario de contabilidad'',
					''Superusuario de contabilidad'',
					0,
					''HREOS-12155'',
					SYSDATE,
