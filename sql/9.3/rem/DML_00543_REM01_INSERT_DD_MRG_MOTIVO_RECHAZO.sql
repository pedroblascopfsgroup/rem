...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('F57' ,'No pueden darse de alta dos gastos con el mismo código de gasto', '1', 'WHERE EXISTS (SELECT AUX2.COD_GASTO_GESTORIA FROM #ESQUEMA#.APR_AUX_GES_GASTOS_GR AUX2 WHERE AUX2.COD_GASTO_GESTORIA = AUX.COD_GASTO_GESTORIA GROUP BY AUX2.COD_GASTO_GESTORIA HAVING COUNT(1) > 1)')
		); 
