...
BEGIN
    ...
    IF V_NUM_TABLAS = 1 THEN
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO
						 SET TAP_SCRIPT_VALIDACION_JBPM = ''esOfertaPrincipalSinDependientes() ? existeAdjuntoUGCarteraValidacion("36", "E", "01") == null ? valores[''''T013_DefinicionOferta''''][''''comboConflicto''''] == DDSiNo.SI || valores[''''T013_DefinicionOferta''''][''''comboRiesgo''''] == DDSiNo.SI  ?  ''''El estado de la responsabilidad corporativa no es el correcto para poder avanzar.'''' : definicionOfertaT013(valores[''''T013_DefinicionOferta''''][''''comite'''']) == null ? actualizarOfertaBoarding() : definicionOfertaT013(valores[''''T013_DefinicionOferta''''][''''comite'''']) : existeAdjuntoUGCarteraValidacion("36", "E", "01") : ''''No se puede avanzar una oferta principal sin dependientes.''''''
