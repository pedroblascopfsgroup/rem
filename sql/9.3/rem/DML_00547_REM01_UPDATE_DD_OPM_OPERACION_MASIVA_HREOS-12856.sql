...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AFTYFS', 'Actualizar Fecha titulo y Fecha posesión', 'Actualizar Fecha titulo y Fecha posesión','ACTUALIZAR_F_TITULO_Y_F_POSESION','nD*,f,f')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-12856'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
