...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('ACTUALIZAR_F_TITULO_Y_F_POSESION', 'plantillas/plugin/masivo/ACTUALIZAR_F_TITULO_Y_F_POSESION.xls', 'AFTYFS')
    ); 
