...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-13138';
    ...
    -- DD_TPA_ID   DD_SAC_CODIGO  DD_SAC_DESCRIPCION   DD_SAC_DESCRIPCION_LARGA DD_SAC_EN_BBVA
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('5','43','Residencial (viviendas, locales, trasteros garajes)','Residencial (viviendas, locales, trasteros garajes)', 1)
		); 
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        DD_SAC_CODIGO = '''||V_TMP_TIPO_DATA(2)||'''
        AND DD_SAC_DESCRIPCION = '''||V_TMP_TIPO_DATA(3)||'''
        AND DD_SAC_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(4)||'''';
         DBMS_OUTPUT.PUT_LINE(V_SQL);
        EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
        IF V_NUM_TABLAS = 1 THEN
          DBMS_OUTPUT.PUT_LINE('[INFO]: La '''||TRIM(V_TMP_TIPO_DATA(2))||''' ya existe');
        ELSE
