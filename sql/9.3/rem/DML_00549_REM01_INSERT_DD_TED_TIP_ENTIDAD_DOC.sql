...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_TED_TIP_ENTIDAD_DOC';
    V_CHARS VARCHAR2(3 CHAR):= 'TED';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-13072';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			      DESCRIPCION                       DESCRIPCION_LARGA 
      T_TIPO_DATA('ACT',			'Activo',			                 'Activo'),
      T_TIPO_DATA('ECO',			'Expediente',			 'Expediente'),
      T_TIPO_DATA('TBJ',			'Trabajo',			     'Trabajo'),
      T_TIPO_DATA('GASTO',			'Gasto',			     'Gasto'),
      T_TIPO_DATA('PROY',			'Proyecto',			     'Proyecto'),
      T_TIPO_DATA('PROM',			'Promoción',			     'Promoción'),
      T_TIPO_DATA('TRIB',			'Tributo',			     'Tributo'),
      T_TIPO_DATA('PLUSV',			'Plusvalía',			     'Plusvalía'),
      T_TIPO_DATA('AGR',			'Agrupación',			     'Agrupación'),
      T_TIPO_DATA('JUNT',			'Juntas',			     'Juntas'),
      T_TIPO_DATA('PRV',			'Proveedores',			     'Proveedores'),
    T_TIPO_DATA('COMP',			'Compradores',			     'Compradores')
    ); 
