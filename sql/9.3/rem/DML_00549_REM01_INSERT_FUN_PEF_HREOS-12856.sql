...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-12856';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('ACTUALIZAR_F_TITULO_Y_F_POSESION',		'HAYASUPADM'),
        T_FUNCION('ACTUALIZAR_F_TITULO_Y_F_POSESION',		'HAYAGESTADM'),
        T_FUNCION('ACTUALIZAR_F_TITULO_Y_F_POSESION',		'HAYASUPER')
