...
DECLARE
	...
	V_USU VARCHAR2(30 CHAR) := 'HREOS-13132'; -- USUARIOCREAR/USUARIOMODIFICAR.
	V_PERFIL VARCHAR2(30 CHAR) := 'SEGURIDAD_REAM';
	V_PERFIL_DESC VARCHAR2(100 CHAR) := 'Seguridad REAM';
