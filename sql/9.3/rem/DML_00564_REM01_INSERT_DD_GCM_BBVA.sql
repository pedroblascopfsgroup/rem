...
--## INCIDENCIA_LINK=REMVIP-9000
--## PRODUCTO=NO
--##
--## Finalidad: Rellenar CONFIGURACION GESTORES BBVA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('GIAFORM',0,1,0,'BBVA'),
T_TIPO_DATA('GCAL',1,0,0,'BBVA'),
T_TIPO_DATA('SLLA',1,0,0,'BBVA'),
T_TIPO_DATA('GLLA',1,0,0,'BBVA'),
T_TIPO_DATA('GGADM',1,0,0,'BBVA'),
T_TIPO_DATA('SMARK',1,0,0,'BBVA'),
T_TIPO_DATA('GTOPDV',1,0,0,'BBVA'),
T_TIPO_DATA('GCOM',1,0,1,'BBVA'),
T_TIPO_DATA('GMARK',1,0,0,'BBVA'),
T_TIPO_DATA('HAYAGBOINM',1,0,0,'BBVA'),
T_TIPO_DATA('SCOM',1,0,1,'BBVA'),
T_TIPO_DATA('GFORM',0,1,0,'BBVA'),
T_TIPO_DATA('GTREE',1,0,0,'BBVA'),
T_TIPO_DATA('FVDBACKVNT',1,0,0,'BBVA'),
T_TIPO_DATA('SFORM',0,1,0,'BBVA'),
T_TIPO_DATA('SUPADM',1,0,0,'BBVA'),
T_TIPO_DATA('SPUBL',1,0,0,'BBVA'),
T_TIPO_DATA('SUPFVD',1,0,0,'BBVA'),
T_TIPO_DATA('FVDBACKOFR',1,0,0,'BBVA'),
T_TIPO_DATA('FVDNEG',1,0,0,'BBVA'),
T_TIPO_DATA('GFSV',1,0,0,'BBVA'),
T_TIPO_DATA('TECN',1,0,0,'BBVA'),
T_TIPO_DATA('GESTREC',1,0,0,'BBVA'),
T_TIPO_DATA('SADM',1,0,0,'BBVA'),
T_TIPO_DATA('GIAADMT',1,0,0,'BBVA'),
T_TIPO_DATA('SUPACT',1,0,0,'BBVA'),
T_TIPO_DATA('CERT',1,0,0,'BBVA'),
T_TIPO_DATA('GPM',1,0,0,'BBVA'),
T_TIPO_DATA('GCOMSIN',1,0,0,'BBVA'),
T_TIPO_DATA('GTOCED',1,0,0,'BBVA'),
T_TIPO_DATA('GADMT',1,0,0,'BBVA'),
T_TIPO_DATA('GESTCOMALQ',1,0,0,'BBVA'),
T_TIPO_DATA('SUPCOMALQ',1,0,0,'BBVA'),
T_TIPO_DATA('GADM',1,0,0,'BBVA'),
T_TIPO_DATA('SPREC',1,0,0,'BBVA'),
T_TIPO_DATA('PTEC',1,0,0,'BBVA'),
T_TIPO_DATA('GTOADM',1,0,0,'BBVA'),
T_TIPO_DATA('GPUBL',1,0,0,'BBVA'),
T_TIPO_DATA('GPREC',1,0,0,'BBVA'),
T_TIPO_DATA('GACT',1,0,0,'BBVA')
