...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-13206';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('A88203542','AAMAC01'),
		T_TIPO_DATA('A88203542','AACES01'),
		T_TIPO_DATA('A88203542','AAGIN01'),
    T_TIPO_DATA('A88203542','AAGEN01'),
    T_TIPO_DATA('A88203534','AVMAC01'),
    T_TIPO_DATA('A88203534','AVCES01'),
    T_TIPO_DATA('A88203534','AVGIN01'),
    T_TIPO_DATA('A88203534','AVGEN01'),
    T_TIPO_DATA('A81036501','DPMAC01'),
    T_TIPO_DATA('A81036501','DPCES01'),
    T_TIPO_DATA('A81036501','DPIND01'),
    T_TIPO_DATA('A81036501','DPICE01'),
    T_TIPO_DATA('B80775075','DDMAC01'),
    T_TIPO_DATA('B80775075','DDCES01'),
    T_TIPO_DATA('B80775075','DDIND01'),
    T_TIPO_DATA('B80775075','DDICE01')
    ); 
