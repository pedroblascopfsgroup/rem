...
DECLARE
    ...
    --				Codigo						Descripcion								Descripcion Larga
    	T_TIPO_DATA('SUPERCOMERCIAL',			'Superusuario de comercial',			'Superusuario de comercial')
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.PEF_PERFILES (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''',''HREOS-13405'',SYSDATE,0 FROM DUAL';
