...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('136','Seguros del activo (Siniestro)','ACT_SAREB_ACTIVOS','SINIESTRO','ACT_ID','05'),
      T_TIPO_DATA('143','Tipo correctivo SAREB','ACT_SAREB_ACTIVOS','DD_TCS_ID','ACT_ID','05'),
      T_TIPO_DATA('144','Fecha fin correctivo SAREB','ACT_SAREB_ACTIVOS','FEC_FIN_CORRECTIVO','ACT_ID','02')
    ); 
