...
DECLARE
	...
	V_USU VARCHAR2(30 CHAR) := 'REMVIP-9201';
    ...
    V_TIPO_DATA_MAPEO T_ARRAY_DATA_MAPEO := T_ARRAY_DATA_MAPEO(
		T_TIPO_DATA_MAPEO('Suelo','Suelo Urbano No Consolidado','Suelo'),
		T_TIPO_DATA_MAPEO('Otros','Hostelero','Local/nave/oficina'),
		T_TIPO_DATA_MAPEO('Otros','Apartamento','Vivienda'),
		T_TIPO_DATA_MAPEO('Edificio completo','Residencial (viviendas, locales, trasteros garajes)','Vivienda')
    ); 
