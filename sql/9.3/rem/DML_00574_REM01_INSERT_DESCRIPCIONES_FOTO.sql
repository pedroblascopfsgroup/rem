...
DECLARE
    ...
    V_TIPO_DATA_MAPEO T_ARRAY_DATA_MAPEO := T_ARRAY_DATA_MAPEO(
		T_TIPO_DATA_MAPEO('01','42','Suelo'),
		T_TIPO_DATA_MAPEO('07','41','Local/nave/oficina'),
		T_TIPO_DATA_MAPEO('07','40','Vivienda'),
		T_TIPO_DATA_MAPEO('05','43','Vivienda')
    ); 
    ...
    LOOP
		...
		IF V_TMP_TIPO_DATA_MAPEO(3) = 'Suelo' THEN
            ...
            LOOP
				...
				V_MSQL := 'SELECT DD_TPA_ID FROM '||V_ESQUEMA||'.'||V_TABLA_TPA||' WHERE DD_TPA_CODIGO = '''||V_TMP_TIPO_DATA_MAPEO(1)||''' AND BORRADO = 0';
				EXECUTE IMMEDIATE V_MSQL INTO V_ID_TIPO;
					
				V_MSQL := 'SELECT DD_SAC_ID FROM '||V_ESQUEMA||'.'||V_TABLA_SAC||' WHERE DD_SAC_CODIGO = '''||V_TMP_TIPO_DATA_MAPEO(2)||''' AND DD_TPA_ID = '||V_ID_TIPO||' AND BORRADO = 0';
