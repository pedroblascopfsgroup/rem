...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('166','Nº expdte. Riesgo asociado','167','ACT'),
      T_TIPO_DATA('167','Importe adjudicación','168','ACT'),
      T_TIPO_DATA('168','Tipo de juzgado','169','ACT'),
      T_TIPO_DATA('169','Población juzgado','170','ACT')
    ); 
