	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		LOOP
			...
			V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE
				DD_ECA_CODIGO = '''||V_TMP_TIPO_DATA(1)||'''
				AND DD_ECA_DESCRIPCION = '''||V_TMP_TIPO_DATA(2)||'''
				AND DD_ECA_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(3)||'''';
			...
			ELSE
				...
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (
					DD_ECA_ID,DD_ECA_CODIGO, DD_ECA_DESCRIPCION,DD_ECA_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES(
