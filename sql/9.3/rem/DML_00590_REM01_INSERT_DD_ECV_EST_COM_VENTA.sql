...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('V01','No en proceso comercial','No en proceso comercial'),
		T_TIPO_DATA('V02','Retirado de la comercialización','Retirado de la comercialización'),
		T_TIPO_DATA('V03','En trámite venta','En trámite venta'),
		T_TIPO_DATA('V04','Venta realizada','Venta realizada')
		); 
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		LOOP
			...
			V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE
				DD_ECV_CODIGO = '''||V_TMP_TIPO_DATA(1)||'''
				AND DD_ECV_DESCRIPCION = '''||V_TMP_TIPO_DATA(2)||'''
				AND DD_ECV_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(3)||'''';
			...
			ELSE
				...
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (
					DD_ECV_ID,DD_ECV_CODIGO, DD_ECV_DESCRIPCION,DD_ECV_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES(
