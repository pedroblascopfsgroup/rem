...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-9569';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('F59' ,'La longitud del NIF del proveedor es mayor de 10 caracteres' , '1', 'WHERE LENGTH(AUX.NIF_PROVEEDOR)>10' )
		); 
