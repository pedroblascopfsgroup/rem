...
BEGIN
  ...
  V_SQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET 
        ...
        , AC3_TRANSFORMACION = ''LEFT JOIN '||V_ESQUEMA||'.DD_SCG_SUBESTADO_CARGA CRUCE ON CRUCE.DD_SCG_CODIGO = TMP.VALOR_NUEVO AND CRUCE.BORRADO = 0''
        ...
        WHERE DD_CCS_CAMPO = ''DD_SCG_ID'' AND CCS.BORRADO = 0 AND COS.DD_COS_CODIGO = ''036'')
        ';
