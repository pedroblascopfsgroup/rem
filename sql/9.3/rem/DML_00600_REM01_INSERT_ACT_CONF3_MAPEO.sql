...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('106','Técnico tasadora asociado','ACT_TAS_TASACION','TAS_CODIGO_FIRMA','ACT_ID','LEFT JOIN '||V_ESQUEMA||'.DD_TRA_TASADORA CRUCE ON CRUCE.DD_TRA_CODIGO = TMP.VALOR_NUEVO AND CRUCE.BORRADO = 0')
    ); 
