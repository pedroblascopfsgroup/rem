...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('173','OK Técnico','ACT_ACTIVO','OK_TECNICO','ACT_ID','LEFT JOIN (SELECT CASE WHEN AUX.VALOR_NUEVO = 1 THEN 1 WHEN AUX.VALOR_NUEVO = 0 THEN 0 END OK_TECNICO, AUX.ACT_NUM_ACTIVO FROM ESPARTA_EXCEL1 AUX WHERE AUX.CAMPO = ''''173'''') CRUCE ON CRUCE.ACT_NUM_ACTIVO = ACT.ACT_NUM_ACTIVO')
