...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('011','Estado físico del activo','009','WRN_CND','INT_MOD','INT_MOD_DD_EAC'),
      T_TIPO_DATA('018','Fecha de inscripción','016','WRN_CND','INT_MOD','INT_MOD_FEC_INSC'),
      T_TIPO_DATA('021','Fecha Toma Posesion','022','WRN_CND','INT_MOD','INT_MOD_FEC_TOM_POS')
    ); 
