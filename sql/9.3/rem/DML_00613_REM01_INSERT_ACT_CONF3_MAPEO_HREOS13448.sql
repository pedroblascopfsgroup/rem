...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('176','Tipo de cuota comunidad','ACT_SAREB_ACTIVOS','DD_TCC_ID','ACT_ID', 'LEFT JOIN '||V_ESQUEMA||'.DD_TCC_TIPO_CUOTA_COM CRUCE ON CRUCE.DD_TCC_CODIGO = TMP.VALOR_NUEVO AND CRUCE.BORRADO = 0')      
    ); 
