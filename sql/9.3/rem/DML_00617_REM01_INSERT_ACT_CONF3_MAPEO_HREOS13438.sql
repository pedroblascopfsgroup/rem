...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('172','Segmentación','ACT_SAREB_ACTIVOS','SEGMENTO_SAREB','ACT_ID', 'LEFT JOIN '||V_ESQUEMA||'.DD_SGS_SEGMENTO_SAREB CRUCE ON CRUCE.DD_SGS_CODIGO = TMP.VALOR_NUEVO AND CRUCE.BORRADO = 0')      
    ); 
