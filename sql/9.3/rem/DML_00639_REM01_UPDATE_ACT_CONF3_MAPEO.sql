...
BEGIN
  ...
  V_SQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET 
        ...
        , AC3_TRANSFORMACION = ''LEFT JOIN '||V_ESQUEMA||'.DD_TPA_TIPO_TITULO_ACT CRUCE ON CRUCE.BORRADO = 0 AND CRUCE.DD_TPA_CODIGO = ''''02'''' AND TMP.VALOR_NUEVO = 1''
        ...
        WHERE DD_CCS_CAMPO = ''DD_TPA_ID'' AND CCS.BORRADO = 0 AND COS.DD_COS_CODIGO = ''009'')
        ';
