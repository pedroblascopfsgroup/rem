...
DECLARE
  ...
  V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-13973';
...
BEGIN
  ...
  V_SQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET 
        ...
        , DD_CCS_CAMPO = ''TIT_FECHA_PRESENT1_REG''
        WHERE DD_COS_ID = (SELECT COS.DD_COS_ID FROM '||V_ESQUEMA||'.DD_COS_CAMPOS_ORIGEN_CONV_SAREB COS
        WHERE DD_COS_CODIGO = ''159'' AND COS.BORRADO = 0) AND DD_CCS_CAMPO = ''TIT_FECHA_PRESENT2_REG''
        ';
