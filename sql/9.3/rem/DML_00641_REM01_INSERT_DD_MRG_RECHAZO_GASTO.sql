...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-9786';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('F60' ,'El activo asociado al gasto no esta incluido en perimetro haya' , '1', 'JOIN REM01.ACT_ACTIVO ACT ON ACT.ACT_NUM_ACTIVO = AUX.COD_ACTIVO AND ACT.BORRADO = 0 JOIN REM01.ACT_PAC_PERIMETRO_ACTIVO PAC ON PAC.ACT_ID = ACT.ACT_ID AND PAC.BORRADO = 0 WHERE PAC.PAC_INCLUIDO = 0' )
		); 
