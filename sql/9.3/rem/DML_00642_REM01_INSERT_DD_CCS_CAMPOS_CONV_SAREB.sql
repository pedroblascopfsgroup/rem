...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('183','Check Visible gestion comercial','ACT_PAC_PERIMETRO_ACTIVO','PAC_CHECK_GESTION_COMERCIAL','ACT_ID'),
      T_TIPO_DATA('183','Fecha Visible gestion comercial','ACT_PAC_PERIMETRO_ACTIVO','PAC_FECHA_GESTION_COMERCIAL','ACT_ID')
    ); 
