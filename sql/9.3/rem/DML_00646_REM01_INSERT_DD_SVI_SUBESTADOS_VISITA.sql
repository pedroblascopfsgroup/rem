...
DECLARE
    ...
    V_ID NUMBER(16);
    V_EVI_ID NUMBER(16);
    V_USUARIO VARCHAR2(250 CHAR):='REMVIP-9935';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(        
        T_TIPO_DATA('27','05','Cancelada - Rotación de cartera','Cancelada - Rotación de cartera')
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: YA EXISTE EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||''' - '''|| TRIM(V_TMP_TIPO_DATA(2)) ||''' - '''|| TRIM(V_TMP_TIPO_DATA(3)) ||''' ');
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_SVI_SUBESTADOS_VISITA (' ||
                      ...
                      'SELECT '|| V_ID || ','|| V_EVI_ID ||','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(3))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''', 0, '''||V_USUARIO||''',SYSDATE,0 FROM DUAL';
