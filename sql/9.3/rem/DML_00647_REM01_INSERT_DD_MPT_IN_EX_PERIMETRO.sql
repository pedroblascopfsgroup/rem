...
DECLARE
    ...
    V_USUARIO VARCHAR2(250 CHAR) := 'REMVIP-9954';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('42','20-No Publicación. Venta tras aprobacion - ROFO 4'),
      T_TIPO_DATA('43','20-No Publicación. Venta tras aprobacion - RSC Okupadas sin Vulnerabilidad')
    ); 
