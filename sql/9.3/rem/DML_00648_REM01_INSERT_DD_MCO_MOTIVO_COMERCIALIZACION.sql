...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('42','20-No Publicación. Venta tras aprobacion - ROFO 4','42'),
      T_TIPO_DATA('43','20-No Publicación. Venta tras aprobacion - RSC Okupadas sin Vulnerabilidad','43')
    ); 
