...
--## PRODUCTO=NO
--##
--## Finalidad: DML add valores al diccionario DD_TPV_TRIBUT_PROP_VENTA
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30):= 'DD_TPV_TRIBUT_PROP_VENTA'; -- Vble. del nombre de la tabla
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_TPV_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND BORRADO = 0';
