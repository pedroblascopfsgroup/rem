...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR) := 'REMVIP-10044';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('185','Fecha Formalizacion','ACT_PAC_PERIMETRO_ACTIVO','PAC_FECHA_FORMALIZAR','ACT_ID'),
      T_TIPO_DATA('183','Fecha Comercializacion','ACT_PAC_PERIMETRO_ACTIVO','PAC_FECHA_COMERCIALIZAR','ACT_ID'),
      T_TIPO_DATA('181','Fecha Publicacion','ACT_PAC_PERIMETRO_ACTIVO','PAC_FECHA_PUBLICAR','ACT_ID'),
      T_TIPO_DATA('179','Fecha Gestion','ACT_PAC_PERIMETRO_ACTIVO','PAC_FECHA_GESTIONAR','ACT_ID')
    ); 
