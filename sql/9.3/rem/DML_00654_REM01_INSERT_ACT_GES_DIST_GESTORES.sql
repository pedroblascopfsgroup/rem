...
BEGIN		
	...
	V_TMP_TIPO_DATA := V_TIPO_DATA(I);
		...
		V_MSQL:= 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.ACT_GES_DIST_GESTORES WHERE TIPO_GESTOR = '''||V_TIPO_GESTOR||''' AND COD_CARTERA = '||V_TMP_TIPO_DATA(1)||' AND USERNAME = '''||V_USERNAME||''' AND COD_PROVINCIA = '||V_TMP_TIPO_DATA(2)||'';
