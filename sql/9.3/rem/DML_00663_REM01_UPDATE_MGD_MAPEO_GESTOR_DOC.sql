...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('08', '18', 'Unicaja', 'UNICAJA'),
	  T_FUNCION('08', '56', 'Unicaja', 'UNICAJA'),
      T_FUNCION('08', '57', 'Unicaja', 'UNICAJA'),
      T_FUNCION('08', '58', 'Unicaja', 'UNICAJA'),
      T_FUNCION('08', '59', 'Unicaja', 'UNICAJA'),
      T_FUNCION('08', '60', 'Unicaja', 'UNICAJA')
    );          
