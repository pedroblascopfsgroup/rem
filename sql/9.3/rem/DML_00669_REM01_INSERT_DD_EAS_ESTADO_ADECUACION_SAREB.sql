...
--## INCIDENCIA_LINK=REMVIP-10215
--## PRODUCTO=NO
--##
--## Finalidad: Actualizar diccionario
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                                                                                                --DD_EAC_ID
      T_TIPO_DATA('43','SANCION', 'SANCION', ''),
      T_TIPO_DATA('44','REVISION PROPUESTA', 'REVISION PROPUESTA', '')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_EAS_DESCRIPCION = '''||TRIM(V_TMP_TIPO_DATA(2))||''' AND BORRADO = 0';
