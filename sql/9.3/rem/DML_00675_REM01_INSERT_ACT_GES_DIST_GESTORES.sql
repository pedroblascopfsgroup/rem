...
--## INCIDENCIA_LINK=HREOS-14913
--## PRODUCTO=NO
--##
--## Finalidad: Insertar gestores a ña cartera BFA
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-14913'; -- Usuario modificar
BEGIN
