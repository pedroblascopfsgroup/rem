...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
        T_FUNCION( 'jarandilla', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'jcolina', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'ekitchin', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'smateos', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'jmunoz', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'xpan', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'crivera', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'aruizc', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'asanchezt', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'dtejero', 	'HAYAGESTASSETMAN'  ),
        T_FUNCION( 'zboge', 	'HAYAGESTASSETMAN'  )
