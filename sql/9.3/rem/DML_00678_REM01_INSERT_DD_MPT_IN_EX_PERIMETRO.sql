...
DECLARE
    ...
    V_USUARIO VARCHAR2(250 CHAR) := 'REMVIP-10581';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('46','20-No Publicación. Venta tras aprobacion - Viviendas Canarias Bloqueo 20'),
      T_TIPO_DATA('47','30-Bloqueo Comercial - Viviendas Canarias Bloqueo 30'),
      T_TIPO_DATA('48','No comercializar por Proyectos Especiales/Carteras'),
      T_TIPO_DATA('49','30-Bloqueo Comercial - Bloqueos Extraordinarios')
    ); 
