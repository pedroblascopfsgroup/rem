...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('46','20-No Publicación. Venta tras aprobacion - Viviendas Canarias Bloqueo 20','46'),
      T_TIPO_DATA('47','30-Bloqueo Comercial - Viviendas Canarias Bloqueo 30','47'),
      T_TIPO_DATA('48','No comercializar por Proyectos Especiales/Carteras','48'),
      T_TIPO_DATA('49','30-Bloqueo Comercial - Bloqueos Extraordinarios','49')
    ); 
