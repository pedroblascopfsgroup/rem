...
--## PRODUCTO=NO
--##
--## Finalidad: Insertar diccionario DD_VIC_RESPUESTA_COMPRADOR
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-14699';
    ...
    -- DD_VIC_CODIGO  DD_VIC_DESCRIPCION
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('10','Empleado'),
        T_TIPO_DATA('20','Familiar')
		); 
	...
	FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		LOOP
			...
			V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE
				DD_VIC_CODIGO = '''||V_TMP_TIPO_DATA(1)||'''
				AND DD_VIC_DESCRIPCION = '''||V_TMP_TIPO_DATA(2)||'''
				AND DD_VIC_DESCRIPCION_LARGA = '''||V_TMP_TIPO_DATA(2)||'''';
