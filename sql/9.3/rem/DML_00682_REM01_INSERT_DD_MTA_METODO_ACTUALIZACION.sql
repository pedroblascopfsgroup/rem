...
--## PRODUCTO=NO
--## Finalidad: INSERCIÓN diccionario DD_MTA_METODO_ACTUALIZACION
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MTA_METODO_ACTUALIZACION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'MTA';
	V_TIQUET VARCHAR2(2400 CHAR) := 'HREOS-14714';
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      	T_TIPO_DATA('NIN','Ninguno'),
		T_TIPO_DATA('POR','Porcentual'),
		T_TIPO_DATA('MER','Mercado'),
		T_TIPO_DATA('IPM','IPC + Mercado'),
		T_TIPO_DATA('LIB','Libre')
    ); 
