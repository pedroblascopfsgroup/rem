...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	...
    	T_TIPO_DATA('T017_DocsPosVenta'		,'datefield', 	'1'		,'fechaIngreso'		    ,null	    ,null					,'Fecha ingreso cheque'),
    	T_TIPO_DATA('T017_DocsPosVenta'		,'datefield', 	'2'		,'fechaContabilizacion'	,null	    ,null		            ,'Fecha contabilización'),
    	T_TIPO_DATA('T017_DocsPosVenta'		,'checkbox', 	'3'		,'checkboxVentaDirecta'	,'false'	,null           		,'Venta directa'),
    	T_TIPO_DATA('T017_DocsPosVenta'		,'textarea', 	'4'		,'observaciones'		,null		,null					,'Observaciones')
    ); 
