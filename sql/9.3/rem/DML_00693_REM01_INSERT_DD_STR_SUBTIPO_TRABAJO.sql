...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := 'HREOS-16361'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    --			CODIGO				 DESCRIPCION									DESCRIPCION_LARGA			TIPO_TRABAJO_CODIGO
	T_TIPO_DATA('AMB',				'Actuaciones ambientales',					'Actuaciones ambientales',		'08'),
	T_TIPO_DATA('DEM',				'Demolición',								'Demolición',					'08'),
	T_TIPO_DATA('INF',				'Informes',									'Informes',						'08'),
	T_TIPO_DATA('PRO',				'Proyectos',								'Proyectos',					'08')
