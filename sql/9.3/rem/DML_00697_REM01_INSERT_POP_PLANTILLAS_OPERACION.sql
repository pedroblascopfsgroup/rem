...
DECLARE
    ...
    ERR_MSG VARCHAR2(1024 CHAR); -- Vble. auxiliar para registrar errores en el script.
	  V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-17111'; -- Vble. que indica el usuario que realiza la operación (USUARIOCREAR)
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_DE_ORGANISMOS', 'plantillas/plugin/masivo/CARGA_MASIVA_DE_ORGANISMOS.xls', 'CMO')
    ); 
