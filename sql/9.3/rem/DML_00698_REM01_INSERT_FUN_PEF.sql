...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-17111';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        ...
        T_FUNCION('CARGA_MASIVA_DE_ORGANISMOS',		'HAYASUPER'),
        T_FUNCION('CARGA_MASIVA_DE_ORGANISMOS',		'HAYASUPADM'),
        T_FUNCION('CARGA_MASIVA_DE_ORGANISMOS',		'HAYAGESTADM')
