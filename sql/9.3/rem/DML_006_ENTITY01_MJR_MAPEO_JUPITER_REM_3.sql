...
ARRAY_TABLE('GR389','Multiservicios Mapfre','Grupo de usuarios - Multiservicios Mapfre','map.mapfre','grupo'),
ARRAY_TABLE('GR390','QIPERT UGH GLOBAL','Grupo de usuarios - QIPERT UGH GLOBAL','q21.quipert','grupo')
	);
BEGIN
