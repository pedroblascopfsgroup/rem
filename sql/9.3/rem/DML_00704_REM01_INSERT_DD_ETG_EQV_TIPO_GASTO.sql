...
DECLARE
    ...
    M_TABLA T_ARRAY_TABLA := T_ARRAY_TABLA(
      --DD_ETG_CODIGO  Elemento PEP	CLASE/GRUPO	  TIPO	SUBTIPO	DD_TGA_CODIGO	DD_STG_CODIGO	DD_CBC_CODIGO	DD_EAL_CODIGO	DD_TTR_CODIGO	PRIMERA POSESION
		...
		T_TABLA('326','XXXX-22-2-C-IBIS','22','02','8','01','141','01','','','null'),
		T_TABLA('327','XXXX-22-2-A-C-IBIS','22','02','9','01','141','03','','','null'),
		T_TABLA('328','XXXX-22-2-C-IBIS','22','02','8','01','141','02','','','null'),
		...
		T_TABLA('333','XXXX-22-2-HSTK0%','22','01','20','13','145','','','','null'),
		T_TABLA('334','XXXX-22-2-A-HSTK0%','22','01','21','13','145','','','','null'),
		T_TABLA('335','XXXX-22-2-HSTK0%','22','01','20','13','145','','','','null'),
		T_TABLA('336','XXXX-22-2-HSTK100%','22','02','44','13','146','','','','null'),
		T_TABLA('337','XXXX-22-2-A-HSTK100%','22','02','41','13','146','','','','null'),
		T_TABLA('338','XXXX-22-2-HSTK100%','22','02','44','13','146','','','','null'),
		T_TABLA('339','XXXX-22-2-CGG0%','22','02','49','13','147','','','','null'),
		T_TABLA('340','XXXX-22-2-A-CGG0%','22','02','51','13','147','','','','null'),
		T_TABLA('341','XXXX-22-2-CGG0%','22','02','49','13','147','','','','null'),
		T_TABLA('342','XXXX-22-2-CGG100%','22','02','50','13','148','','','','null'),
		T_TABLA('343','XXXX-22-2-A-CGG100%','22','02','52','13','148','','','','null'),
		T_TABLA('344','XXXX-22-2-CGG100%','22','02','50','13','148','','','','null'),
		T_TABLA('345','XXXX-22-2-CGGF','22','02','53','13','149','','','','null'),
		T_TABLA('346','XXXX-22-2-TP0%','22','00','28','13','150','','','','null'),
		T_TABLA('347','XXXX-22-2-A-TP0%','22','00','32','13','150','','','','null'),
		T_TABLA('348','XXXX-22-2-TP0%','22','00','28','13','150','','','','null'),
		T_TABLA('349','XXXX-22-2-TP100%','22','02','42','13','151','','','','null'),
		T_TABLA('350','XXXX-22-2-A-TP100%','22','02','43','13','151','','','','null'),
		...
		T_TABLA('370','XXXX-22-3-REQ-SAN','22','00','23','04','25','','','','null'),
		T_TABLA('371','XXXX-22-3-REQ-SAN','22','00','23','04','23','','','','null'),
		T_TABLA('372','XXXX-22-3-REQ-SAN','22','00','23','04','22','','','','null'),
		T_TABLA('373','XXXX-22-3-REQ-SAN','22','00','23','04','21','','','','null'),
		T_TABLA('374','XXXX-22-1-PUE','22','00','48','15','71','','','','null'),
		T_TABLA('375','XXXX-22-2-INF MNTO','22','00','52','14','57','','','','null'),
		T_TABLA('376','XXXX-22-2-INF MNTO','22','00','52','15','159','','','','null'),
