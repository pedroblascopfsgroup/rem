...
DECLARE
    ...
    M_TABLA T_ARRAY_TABLA := T_ARRAY_TABLA(															--*******El DD_EAL_CODIGO ya NO se utiliza en la tabla, el array en esa posición está vacío**
      --DD_ETG_CODIGO  Elemento PEP	CLASE/GRUPO	  TIPO	SUBTIPO	DD_TGA_CODIGO	DD_STG_CODIGO	DD_CBC_CODIGO	DD_EAL_CODIGO	DD_TTR_CODIGO	PRIMERA POSESION    DD_SED_CODIGO    DD_PRO_ID	DD_SCM_CODIGO
		...
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','73','01','','','null','','',''),
		T_TABLA('192','XXXX-22-2-A-INC','22','00','30','15','73','03','','','null','','',''),
		T_TABLA('193','XXXX-22-2-LIMP','22','00','13','15','75','01','','','null','','',''),
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','75','01','','','null','','',''),
		T_TABLA('194','XXXX-22-2-A-INC','22','00','30','15','75','03','','','null','','',''),
		T_TABLA('195','XXXX-22-2-LIMP','22','00','13','15','74','01','','','null','','',''),
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','74','01','','','null','','',''),
		T_TABLA('196','XXXX-22-2-A-INC','22','00','30','15','74','03','','','null','','',''),
		...
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','78','01','','','null','','',''),
		T_TABLA('200','XXXX-22-2-A-INC','22','00','30','15','78','03','','','null','','',''),
		...
		T_TABLA('237','XXXX-22-2-COM MON','22','00','4','05','183','01','','','null','','',''),
		...
		--T_TABLA('241','XXXX-22-3-A-I-ADC OT','22','02','19','15','174','03','02','','null','','',''),
		T_TABLA('242','XXXX-22-3-A-I-MNTINC','22','02','24','15','174','03','01','','null','','',''),
		T_TABLA('243','XXXX-22-3-REQ DERR','22','00','24','15','189','','','','null','','',''),
		T_TABLA('244','XXXX-22-3-REQ LIMP','22','00','25','15','190','','','','null','','',''),
		T_TABLA('245','XXXX-22-3-REQ OTROS','22','00','26','15','191','','','','null','','',''),
		T_TABLA('246','XXXX-22-2-TAR.PL','22','00','28','13','192','01','','','null','','',''),
		T_TABLA('247','XXXX-22-2-A-TAR.PL','22','00','32','13','192','03','','','null','','',''),
		T_TABLA('248','XXXX-22-2-COM.BROK','22','00','36','10','193','01','','','null','','',''),
		T_TABLA('249','XXXX-22-2-A-COM.BROK','22','00','37','10','193','03','','','null','','',''),
		...
		T_TABLA('254','XXXX-22-2-A-INF ROT','22','00','54','14','194','03','','','null','','',''),
		T_TABLA('255','XXXX-22-2-A-INF LOC','22','00','55','14','157','03','','','null','','',''),
		T_TABLA('256','XXXX-22-2-A-INF OCU','22','00','56','14','158','03','','','null','','',''),
		T_TABLA('257','XXXX-22-2-INF-REOCU','22','00','58','14','159','','','','null','','',''),
		T_TABLA('258','XXXX-22-3-ABO FIS','22','00','83','11','160','01','','','null','','',''),
		T_TABLA('259','XXXX-22-3-A-ABO FIS','22','00','84','11','160','03','','','null','','',''),
		T_TABLA('260','XXXX-22-3-ABO LEY','22','00','87','11','161','01','','','null','','',''),
		T_TABLA('261','XXXX-22-3-A-ABO LEY','22','00','88','11','161','03','','','null','','',''),
		T_TABLA('262','XXXX-22-3-A-DES','22','01','1','11','162','03','','','null','','',''),
		T_TABLA('263','XXXX-22-3-A-T JD DES','22','01','2','02','163','03','','','null','','',''),
		T_TABLA('264','XXXX-22-3-REO','22','01','4','11','164','','','','null','','',''),
		T_TABLA('265','XXXX-22-3-T.JUD.REO','22','01','5','02','165','','','','null','','',''),
		T_TABLA('266','XXXX-22-2-A-HON ALT','22','01','19','13','166','03','','','null','','',''),
		T_TABLA('267','XXXX-22-2-FERIAS','22','01','50','17','167','01','','','null','','',''),
		T_TABLA('268','XXXX-22-2-A-FERIAS','22','01','51','17','167','03','','','null','','',''),
		T_TABLA('269','XXXX-22-2-COM VT','22','01','57','13','168','01','','','null','','',''),
		T_TABLA('270','XXXX-22-2-A-COM VT','22','01','58','13','168','03','','','null','','',''),
		T_TABLA('271','XXXX-22-2-COM VT GS','22','01','59','12','169','01','','','null','','',''),
		T_TABLA('272','XXXX-22-2-A-CM VT GS','22','01','60','12','169','03','','','null','','',''),
		T_TABLA('273','XXXX-22-2-CAMPAÑAS','22','01','62','17','170','01','','','null','','',''),
		T_TABLA('274','XXXX-22-2-A-CAMPAÑAS','22','01','63','17','170','03','','','null','','',''),
		T_TABLA('275','XXXX-22-2-C-COM','22','02','6','05','171','01','','','null','','',''),
		T_TABLA('276','XXXX-22-2-A-C-COM','22','02','7','05','171','03','','','null','','',''),
		T_TABLA('277','XXXX-22-2-C-IBIS','22','02','8','01','172','01','','','null','','',''),
		T_TABLA('278','XXXX-22-2-A-C-IBIS','22','02','9','01','172','03','','','null','','',''),
		T_TABLA('279','XXXX-22-3-I-ADC HB','22','02','16','15','173','01','','','null','','',''),
		T_TABLA('280','XXXX-22-3-A-I-ADC HB','22','02','18','15','173','03','','','null','','',''),
		T_TABLA('281','XXXX-22-3-I-MNT-REAH','22','02','21','15','175','','','','null','','',''),
		T_TABLA('282','XXXX-22-2-HSTK0%','22','01','20','13','176','','','','null','','',''),
		T_TABLA('283','XXXX-22-2-A-HSTK0%','22','01','21','13','176','','','','null','','',''),
		T_TABLA('284','XXXX-22-2-HSTK100%','22','02','44','13','177','','','','null','','',''),
		T_TABLA('285','XXXX-22-2-A-HSTK100%','22','02','41','13','177','','','','null','','',''),
		T_TABLA('286','XXXX-22-2-CGG0%','22','02','49','13','178','','','','null','','',''),
		T_TABLA('287','XXXX-22-2-A-CGG0%','22','02','51','13','178','','','','null','','',''),
		T_TABLA('288','XXXX-22-2-CGG100%','22','02','50','13','179','','','','null','','',''),
		T_TABLA('289','XXXX-22-2-A-CGG100%','22','02','52','13','179','','','','null','','',''),
		T_TABLA('290','XXXX-22-2-CGGF','22','02','53','13','180','','','','null','','',''),
		T_TABLA('291','XXXX-22-2-TP0%','22','00','28','13','181','','','','null','','',''),
		T_TABLA('292','XXXX-22-2-A-TP0%','22','00','32','13','181','','','','null','','',''),
		T_TABLA('293','XXXX-22-2-TP100%','22','02','42','13','182','','','','null','','',''),
		T_TABLA('294','XXXX-22-2-A-TP100%','22','02','43','13','182','','','','null','','',''),
		--Nuevos registros
		T_TABLA('295','XXXX-22-2-MNT INC','22','00','21','15','186','01','','','null','','',''),
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','186','01','','','null','','',''),
		T_TABLA('296','XXXX-22-2-A-INC','22','00','30','15','186','03','','','null','','',''),
		T_TABLA('297','XXXX-22-2-MNT INC','22','00','21','15','79','01','','','null','','',''),
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','79','01','','','null','','',''),
		T_TABLA('298','XXXX-22-2-A-INC','22','00','30','15','79','03','','','null','','',''),
		T_TABLA('299','XXXX-22-2-MNT INC','22','00','21','15','77','01','','','null','','',''),
		--T_TABLA('','XXXX-22-2-A-ROT','22','00','31','15','77','01','','','null','','',''),
		T_TABLA('300','XXXX-22-2-A-INC','22','00','30','15','77','03','','','null','','',''),
		...
		T_TABLA('307','XXXX-22-2-INF MNTO','22','00','52','15','187','','','','null','','',''),
		T_TABLA('308','XXXX-22-2-INF MNTO','22','00','52','11','188','','','','null','','',''),
		T_TABLA('309','XXXX-22-2-A-INF ROT','22','00','54','14','185','','','','null','','',''),
		T_TABLA('310','XXXX-22-3-NOT NEG','22','00','93','11','43','01','','','null','','',''),
		T_TABLA('311','XXXX-22-3-A-NOT NEG','22','00','94','11','43','03','','','null','','',''),
		--Registros IAEs
		T_TABLA('312','XXXX-22-2-IAE','22','01','7','01','238','','','','null','','',''),
		T_TABLA('313','XXXX-22-2-A_IAE','22','01','8','01','239','','','','null','','',''),
		T_TABLA('314','XXXX-22-2-IAE_CF','22','01','9','01','237','','','','null','','',''),
		--Promociones
		...
		--PEP espejo
		T_TABLA('399','OX-XXXX-22-2-MNT_INC','22','00','21','15','173','01','','','null','','','05'),
		T_TABLA('400','OX-XXXX-22-2-A_INC','22','00','31','15','173','03','','','null','','','05'),
		T_TABLA('401','OX-XXXX-22-2-MNT_INC','22','00','21','15','175','','','','null','','','05'),
		T_TABLA('402','OX-XXXX-22-2-MNT_INC','22','00','22','15','174','01','','','null','','','05'),
		T_TABLA('403','OX-XXXX-22-2-A_INC','22','00','31','15','174','03','01','','null','','','05'),
		T_TABLA('404','OX-XXXX-22-1-PUE','22','00','48','15','82','01','','','1','','','05'),
		T_TABLA('405','OX-XXXX-22-1-ALA','22','00','49','16','86','01','','','1','','','05'),
		T_TABLA('406','OX-XXXX-22-1-A_PUE','22','03','79','15','82','03','','','1','','','05'),
		T_TABLA('407','OX-XXXX-22-1-A_ALA','22','03','80','16','86','03','','','1','','','05'),
		T_TABLA('408','OX-XXXX-22-2-INF_MNTO','22','00','52','14','60','01','','','null','','','05'),
		T_TABLA('409','OX-XXXX-22-2-A_INF_OTROS','22','02','58','14','60','03','','','null','','','05'),

		--Misma PEP que los IBI (IBI Urbana), todos los gastos de tipología tasa y el subtipo ICIO
		T_TABLA('410','XXXX-22-2-IBI','22','00','7','01','06','01','','','null','','',''),
		T_TABLA('411','XXXX-22-2-A-IBI','22','00','9','01','06','03','','','null','','',''),
		T_TABLA('412','XXXX-22-2-IBI','22','00','7','23','229','01','','','null','','',''),
		T_TABLA('413','XXXX-22-2-A-IBI','22','00','9','23','229','03','','','null','','',''),
		T_TABLA('414','XXXX-22-2-IBI','22','00','7','02','08','01','','','null','','',''),
		T_TABLA('415','XXXX-22-2-A-IBI','22','00','9','02','08','03','','','null','','',''),
		T_TABLA('416','XXXX-22-2-IBI','22','00','7','02','09','01','','','null','','',''),
		T_TABLA('417','XXXX-22-2-A-IBI','22','00','9','02','09','03','','','null','','',''),
		T_TABLA('418','XXXX-22-2-IBI','22','00','7','02','10','01','','','null','','',''),
		T_TABLA('419','XXXX-22-2-A-IBI','22','00','9','02','10','03','','','null','','',''),
		T_TABLA('420','XXXX-22-2-IBI','22','00','7','02','11','01','','','null','','',''),
		T_TABLA('421','XXXX-22-2-A-IBI','22','00','9','02','11','03','','','null','','',''),
		T_TABLA('422','XXXX-22-2-IBI','22','00','7','02','12','01','','','null','','',''),
		T_TABLA('423','XXXX-22-2-A-IBI','22','00','9','02','12','03','','','null','','',''),
		T_TABLA('424','XXXX-22-2-IBI','22','00','7','02','120','01','','','null','','',''),
		T_TABLA('425','XXXX-22-2-A-IBI','22','00','9','02','120','03','','','null','','',''),
		T_TABLA('426','XXXX-22-2-IBI','22','00','7','02','121','01','','','null','','',''),
		T_TABLA('427','XXXX-22-2-A-IBI','22','00','9','02','121','03','','','null','','',''),
		T_TABLA('428','XXXX-22-2-IBI','22','00','7','02','122','01','','','null','','',''),
		T_TABLA('429','XXXX-22-2-A-IBI','22','00','9','02','122','03','','','null','','',''),
		T_TABLA('430','XXXX-22-2-IBI','22','00','7','02','123','01','','','null','','',''),
		T_TABLA('431','XXXX-22-2-A-IBI','22','00','9','02','123','03','','','null','','',''),
		T_TABLA('432','XXXX-22-2-IBI','22','00','7','02','124','01','','','null','','',''),
		T_TABLA('433','XXXX-22-2-A-IBI','22','00','9','02','124','03','','','null','','',''),
		T_TABLA('434','XXXX-22-2-IBI','22','00','7','02','125','01','','','null','','',''),
		T_TABLA('435','XXXX-22-2-A-IBI','22','00','9','02','125','03','','','null','','',''),
		T_TABLA('436','XXXX-22-2-IBI','22','00','7','02','126','01','','','null','','',''),
		T_TABLA('437','XXXX-22-2-A-IBI','22','00','9','02','126','03','','','null','','',''),
		T_TABLA('438','XXXX-22-2-IBI','22','00','7','02','127','01','','','null','','',''),
		T_TABLA('439','XXXX-22-2-A-IBI','22','00','9','02','127','03','','','null','','',''),
		T_TABLA('440','XXXX-22-2-IBI','22','00','7','02','128','01','','','null','','',''),
		T_TABLA('441','XXXX-22-2-A-IBI','22','00','9','02','128','03','','','null','','',''),
		T_TABLA('442','XXXX-22-2-IBI','22','00','7','02','129','01','','','null','','',''),
		T_TABLA('443','XXXX-22-2-A-IBI','22','00','9','02','129','03','','','null','','',''),
		T_TABLA('444','XXXX-22-2-IBI','22','00','7','02','13','01','','','null','','',''),
		T_TABLA('445','XXXX-22-2-A-IBI','22','00','9','02','13','03','','','null','','',''),
		T_TABLA('446','XXXX-22-2-IBI','22','00','7','02','130','01','','','null','','',''),
		T_TABLA('447','XXXX-22-2-A-IBI','22','00','9','02','130','03','','','null','','',''),
		T_TABLA('448','XXXX-22-2-IBI','22','00','7','02','14','01','','','null','','',''),
		T_TABLA('449','XXXX-22-2-A-IBI','22','00','9','02','14','03','','','null','','',''),
		T_TABLA('450','XXXX-22-2-IBI','22','00','7','02','15','01','','','null','','',''),
		T_TABLA('451','XXXX-22-2-A-IBI','22','00','9','02','15','03','','','null','','',''),
		T_TABLA('452','XXXX-22-2-IBI','22','00','7','02','153','01','','','null','','',''),
		T_TABLA('453','XXXX-22-2-A-IBI','22','00','9','02','153','03','','','null','','',''),
		T_TABLA('454','XXXX-22-2-IBI','22','00','7','02','16','01','','','null','','',''),
		T_TABLA('455','XXXX-22-2-A-IBI','22','00','9','02','16','03','','','null','','',''),
		T_TABLA('456','XXXX-22-2-IBI','22','00','7','02','17','01','','','null','','',''),
		T_TABLA('457','XXXX-22-2-A-IBI','22','00','9','02','17','03','','','null','','',''),
		T_TABLA('458','XXXX-22-2-IBI','22','00','7','02','18','01','','','null','','',''),
		T_TABLA('459','XXXX-22-2-A-IBI','22','00','9','02','18','03','','','null','','',''),

		--Nuevas PEPs A INCLUIR DIC 21
		T_TABLA('460','OX-XXXX-22-2-A_INF_OTROS','22','02','58','14','','03','','','null','','',''),
		--T_TABLA('461','OX-XXXX-22-3-I_VIV_VAC','22','02','60','','','01','','','null','','',''),
		--T_TABLA('462','OX-XXXX-22-3-A_I_VIV_VAC','22','02','61','','','03','','','null','','',''),
		T_TABLA('463','CX-XXXX-22-3-I_VIG','22','02','62','16','85','01','','','1','','',''),
		T_TABLA('464','CX-XXXX-22-3-A_I_VIG','22','02','63','16','85','03','','','1','','',''),
		--T_TABLA('465','CX-XXXX-22-3-A_I_R_SING','22','02','65','','','03','','','null','','',''),
		--T_TABLA('466','OX-XXXX-22-3-A_EST_2_POS','22','02','66','','','03','','','0','','',''),
		--T_TABLA('467','OX-XXXX-22-3-A_EST_CAPA','22','02','67','','','03','','','null','','',''),
		--T_TABLA('468','OX-XXXX-22-3-A_EST_OTROS','22','02','68','','','03','','','null','','',''),
		T_TABLA('469','OX-XXXX-22-3-A_HGALQ0%','22','02','69','13','248','','','','null','','',''),
		T_TABLA('470','OX-XXXX-22-3-A_HGALQ100%','22','02','70','13','249','','','','null','','',''),
		T_TABLA('471','OX-XXXX-22-2-C_OBJ0%','22','02','71','13','250','','','','null','','',''),
		T_TABLA('472','OX-XXXX-22-2-A_C_OBJ0%','22','02','73','13','252','','','','null','','',''),
