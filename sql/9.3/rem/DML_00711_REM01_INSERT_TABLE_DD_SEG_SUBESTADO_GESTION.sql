...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('ED_CONST', 'Edificación construcción', 'Edificación construcción'),
        T_TIPO_DATA('SDF', 'Sin decreto firme', 'Sin decreto firme'),
        T_TIPO_DATA('PUT', 'Putbacks', 'Putbacks'),
        T_TIPO_DATA('SINT', 'Sintéticos', 'Sintéticos'),
        T_TIPO_DATA('GEST_CP', 'Gestionada con pagos', 'Gestionada con pagos'),
        T_TIPO_DATA('NGCO', 'No genera cuota ordinaria', 'No genera cuota ordinaria')
...
BEGIN	
    ...
    -- LOOP para insertar los valores en DD_SEG_SUBESTADO_GESTION -----------------------------------------------------------------
