...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-9668';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Contrato marco PDV (Garantía)','GA-03-CNCV-22','174'),
          T_JBV('Contrato marco PDV (Reo)','AI-05-CNCV-22','175')
	); 
	V_TMP_JBV T_JBV;
