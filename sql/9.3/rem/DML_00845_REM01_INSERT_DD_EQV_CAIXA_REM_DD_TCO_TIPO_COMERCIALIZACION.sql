...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EQV_CAIXA_REM los datos añadidos en T_ARRAY_DATA para el diccionario DD_TCO_TIPO_COMERCIALIZACION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-14241';
