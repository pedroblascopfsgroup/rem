...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EQV_CAIXA_REM los datos añadidos en T_ARRAY_DATA para el diccionario DD_STC_SUBTIPO_CARGA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_STC_CODIGO','10', 'Opción de compra','DD_STC_SUBTIPO_CARGA','34'),
        T_TIPO_DATA('DD_STC_CODIGO','9', 'Hipotecaria','DD_STC_SUBTIPO_CARGA','09'),
        T_TIPO_DATA('DD_STC_CODIGO','8', 'Embargo','DD_STC_SUBTIPO_CARGA','010'),
        T_TIPO_DATA('DD_STC_CODIGO','5', 'Condición resolutoria','DD_STC_SUBTIPO_CARGA','011'),
        T_TIPO_DATA('DD_STC_CODIGO','4', 'Concurso de acreedores','DD_STC_SUBTIPO_CARGA','48'),
        T_TIPO_DATA('DD_STC_CODIGO','3', 'Censo','DD_STC_SUBTIPO_CARGA','49'),
        T_TIPO_DATA('DD_STC_CODIGO','2', 'Carga urbanística','DD_STC_SUBTIPO_CARGA','012')
