...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-10109';
	...
	V_TIPO_DATA T_ARRAY_TIPO_DATA := T_ARRAY_TIPO_DATA(
		  T_TIPO_DATA('Abanca','14'),
          T_TIPO_DATA('Banco Mediolanum','15'),		
          T_TIPO_DATA('Evo Banco','16'),
          T_TIPO_DATA('Ibercaja','17'),
          T_TIPO_DATA('Sabadell','18'),
          T_TIPO_DATA('Unicaja','19'),
          T_TIPO_DATA('Desconocido','20')
	); 
