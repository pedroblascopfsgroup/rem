...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EQV_CAIXA_REM los datos añadidos en T_ARRAY_DATA para el diccionario DD_EAT_EST_TECNICO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-14318';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DD_EAT_ID','E01', 'Pendiente actuación técnica','DD_EAT_EST_TECNICO','E01'),
        T_TIPO_DATA('DD_EAT_ID','E02', 'En Gestión entrada','DD_EAT_EST_TECNICO','E02'),
        T_TIPO_DATA('DD_EAT_ID','E03', 'Entrada Incidentada','DD_EAT_EST_TECNICO','E03'),
        T_TIPO_DATA('DD_EAT_ID','E04', 'Entrada finalizada/anulada','DD_EAT_EST_TECNICO','E04'),
        T_TIPO_DATA('DD_EAT_ID','E05', 'Incidencia Técnica en curso','DD_EAT_EST_TECNICO','E05'),
        T_TIPO_DATA('DD_EAT_ID','E06', 'Actuación gran envergadura en curso','DD_EAT_EST_TECNICO','E06'),
        T_TIPO_DATA('DD_EAT_ID','E07', 'Mantenimiento/actuación finalizada/anulada','DD_EAT_EST_TECNICO','E07'),
        T_TIPO_DATA('DD_EAT_ID','E08', 'Desarrollo en gestión','DD_EAT_EST_TECNICO','E08'),
        T_TIPO_DATA('DD_EAT_ID','E09', 'Desarrollo en tramitación final/finalizado','DD_EAT_EST_TECNICO','E09')
		); 
