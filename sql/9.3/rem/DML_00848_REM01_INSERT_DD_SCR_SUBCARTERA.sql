...
--## PRODUCTO=NO
--##
--## Finalidad: DML Aniadir subcartera Caixa en tabla DD_SCR_SUBCARTERA.
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                    --DD_CRA_CODIGO  --DD_SCR_CODIGO  --DD_SCR_DESCRIPCION
	     T_TIPO_DATA('03','0001','Caixabank')
	    ,T_TIPO_DATA('03','0015','Newco')
