...
DECLARE
    ...
    V_USUARIO VARCHAR2(250 CHAR) := 'HREOS-14916';
...
DBMS_OUTPUT.PUT_LINE('[INICIO]');
    ...
    V_SQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (CFT_ID,USUARIOCREAR,FECHACREAR,DD_CRA_ID,DD_TTF_ID,DD_TTR_ID,DD_STR_ID,
                ...
                (SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = ''17''),
                ...
                AND (DD_SCR_ID IS NULL OR DD_SCR_ID = (SELECT DD_sCR_ID FROM '||V_ESQUEMA||'.DD_SCR_SUBCARTERA WHERE DD_SCR_CODIGO = ''07''))
                AND BORRADO = 0';
