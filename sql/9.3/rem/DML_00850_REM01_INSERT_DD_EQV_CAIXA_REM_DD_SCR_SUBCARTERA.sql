...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_EQV_CAIXA_REM los datos añadidos en T_ARRAY_DATA para el diccionario DD_SCR_SUBCARTERA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('SOCIEDAD_PATRIMONIAL','0001', 'Caixabank','DD_SCR_SUBCARTERA','0001'),
        T_TIPO_DATA('SOCIEDAD_PATRIMONIAL','0015', 'Newco','DD_SCR_SUBCARTERA','0015'),
