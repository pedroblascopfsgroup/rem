...
--## INCIDENCIA_LINK=HREOS-14842
--## PRODUCTO=NO
--##
--## Finalidad: INSERTAR DD_REC_RECOMENDACION_RCDC
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_REC_RECOMENDACION_RCDC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'REC'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO VARCHAR2(250 CHAR) := 'HREOS-14842';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('01','Gestor comercial'),
      T_TIPO_DATA('02','Director territorial')
    ); 
