...
BEGIN	
	...
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS 
          SET TFI_VALIDACION = ''false'' ,TFI_TIPO = ''comboboxreadonly'',
          USUARIOMODIFICAR = ''HREOS-15088'', FECHAMODIFICAR = SYSDATE 
          WHERE TAP_ID = (SELECT TAP_ID FROM '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''T013_ResolucionComite'') 
          AND TFI_NOMBRE = ''comiteSancionador''';
