...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTAR DD_SNS_SINONOSABE
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_SNS_SINONOSABE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'SNS'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
