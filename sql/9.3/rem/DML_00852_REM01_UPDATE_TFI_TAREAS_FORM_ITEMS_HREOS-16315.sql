...
DECLARE
    ...
    (
		T_TIPO_DATA_2('7', 'combobox', 'comboReqAnalisisTec', 'Requiere análisis técnico', 'DDSiNo'),
		T_TIPO_DATA_2('8', 'textarea', 'observaciones', 'Observaciones', null)
	); 
	...
	FOR I IN V_TIPO_DATA_2.FIRST .. V_TIPO_DATA_2.LAST
		LOOP
			...
			V_MSQL :=  'SELECT COUNT(1) 
						...
						WHERE TAP_ID = (SELECT TAP_ID FROM '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''T018_Scoring'')
			...
			IF V_NUM_TABLAS > 0 THEN
                ...
                V_MSQL := 'UPDATE '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS '||
						  ...
						  '    ,USUARIOMODIFICAR = ''HREOS-16315'' ,FECHAMODIFICAR = SYSDATE '||
						  ' WHERE TFI_NOMBRE = '''||V_TMP_TIPO_DATA_2(3)||''' AND TAP_ID = (SELECT TAP_ID FROM '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''T018_Scoring'') 
		        ';
			...
			ELSE
				...
				V_MSQL :=  'INSERT INTO '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS (TFI_ID, TAP_ID, TFI_ORDEN, TFI_TIPO, TFI_NOMBRE, TFI_LABEL, TFI_BUSINESS_OPERATION, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
							...
							0 									AS VERSION,
							''HREOS-16315'' 					AS USUARIOCREAR,
							SYSDATE 							AS FECHACREAR,
							0									AS BORRADO
							FROM '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO TAP
							WHERE TAP_CODIGO = ''T018_Scoring''
				';
				EXECUTE IMMEDIATE V_MSQL;
