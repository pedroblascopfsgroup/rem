...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T017_BloqueoScreening'		,'combobox', 	'1'		,'comboResultado'						,'false' 	,'DDSiNo'				,'Bloqueado:'),
    	T_TIPO_DATA('T017_BloqueoScreening'		,'label', 		'2'		,'hueco'								,null 		,null					,''),
    	
    	T_TIPO_DATA('T017_BloqueoScreening'		,'combobox', 	'3'		,'motivoBloqueado'						,'false' 	,'DDMotivoBloqueo'		,'Motivo bloqueo'),
