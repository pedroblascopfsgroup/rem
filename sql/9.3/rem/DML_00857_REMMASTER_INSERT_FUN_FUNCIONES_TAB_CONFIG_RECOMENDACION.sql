...
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función de tab configuracion recomendacion rc dc.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Permite acceder a la tab de configuracion de recomendacion rc/dc de la tab administración de la configuración', 'TAB_CONFIG_RECOMENDACION')
    ); 
