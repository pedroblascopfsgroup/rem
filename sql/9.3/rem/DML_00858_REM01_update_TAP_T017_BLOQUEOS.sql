...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            ...
            T_TIPO_DATA('T017_RespuestaOfertantePM', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : 	checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ?	''''El activo est&aacute; vendido'''': (checkComercializable() ? (checkPoliticaCorporativa() ?	null : ''''El estado de la pol&iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '), 
            T_TIPO_DATA('T017_RespuestaOfertanteCES', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo est&aacute; vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ? null : ''''El estado de la pol%iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '),
            T_TIPO_DATA('T017_InformeJuridico', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :	!tieneTramiteGENCATVigenteByIdActivo() ? checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo est&aacute; vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ?  null : ''''El estado de la pol&iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' : ''''El activo tiene un tr&aacute;mite GENCAT en curso.'''' '),
            T_TIPO_DATA('T017_AdvisoryNote', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_PBCReserva', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_PBCVenta', '	!tieneTramiteGENCATVigenteByIdActivo() ? null : ''''El activo tiene un tr&aacute;mite GENCAT en curso.'''' '),
            T_TIPO_DATA('T017_RecomendCES', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_ResolucionPROManzana', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :null'),	
            T_TIPO_DATA('T017_ResolucionExpediente', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :	checkImporteParticipacion() ? null : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '),
            T_TIPO_DATA('T017_InstruccionesReserva', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :	checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo est&aacute; vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ? null : ''''El estado de la pol&iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '),
            ...
            T_TIPO_DATA('T017_ResolucionDivarian', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_ResolucionArrow', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :	checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo est&aacute; vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ?  null : ''''El estado de la pol&iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '),
            T_TIPO_DATA('T017_RatificacionComiteCES', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :	checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo est&aacute; vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ?  null : ''''El estado de la pol&iacute;tica corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participaci&oacute;n de los activos ha de ser el mismo que el importe total del expediente'''' '),
            T_TIPO_DATA('T017_PBC_CN', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' :null '),	
            T_TIPO_DATA('T017_AgendarFechaFirmaArras', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_ConfirmarFechaFirmaArras', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
            T_TIPO_DATA('T017_AgendarPosicionamiento', '(checkBankia() == true && checkExpedienteBloqueado() == true) ? '''' El expediente est&aacute; bloqueado '''' : null '),	
