...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-14583';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                -- CODIGO  			        DESCRIPCION                         DESCRIPCION_LARGA                 DD_EEB_VENTA  DD_EEB_ALQUILER
      T_TIPO_DATA('024',      'Arras pte. Documentación',             'Arras pte. Documentación',                 1,              0),
      T_TIPO_DATA('025',      'Arras aprobadas',                      'Arras aprobadas',                          1,              0),
      T_TIPO_DATA('026',      'Importe Final Pdte. Documentación',    'Importe Final Pdte. Documentación',        1,              0),
      T_TIPO_DATA('027',      'Importe final aprobado',               'Importe final aprobado',                   1,              0),
      T_TIPO_DATA('028',      'Pte. garantías adicionales',           'Pte. garantías adicionales',               0,              1),
      T_TIPO_DATA('029',      'Scoring aprobado',                     'Scoring aprobado',                         0,              1),
      T_TIPO_DATA('030',      'Contraofertado',                       'Contraofertado',                           0,              1),
      T_TIPO_DATA('031',      'Pte. sanción patrimonio',              'Pte. sanción patrimonio',                  0,              1),
      T_TIPO_DATA('032',      'Pte. Cálculo riesgo',                  'Pte. Cálculo riesgo',                      1,              0),
      T_TIPO_DATA('033',      'Solicitud Modificación y Valoración',  'Solicitud Modificación y Valoración',      0,              1)
