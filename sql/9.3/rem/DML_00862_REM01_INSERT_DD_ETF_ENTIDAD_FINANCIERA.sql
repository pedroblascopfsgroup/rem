...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTAR DD_ETF_ENTIDAD_FINANCIERA valor Kutxabank, S.A
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'ETF'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO VARCHAR2(250 CHAR) := 'HREOS-15566';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('22','Kutxabank, S.A', '2095')
    ); 
