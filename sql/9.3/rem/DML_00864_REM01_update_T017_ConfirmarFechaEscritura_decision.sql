...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_ConfirmarFechaEscritura', 'valores[''''T017_ConfirmarFechaEscritura''''][''''comboValidacionBC''''] == DDMotivosEstadoBC.CODIGO_APROBADA_BC ? ''''Confirmado'''' : ''''noConfirmado'''' ')                
    ); 
