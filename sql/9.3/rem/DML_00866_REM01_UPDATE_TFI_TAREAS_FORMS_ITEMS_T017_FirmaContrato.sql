...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T017_FirmaContrato'	,'datefield', 	'1'		,'fechaFirma'		    ,'false'	    ,null					,'Fecha firma'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textfield', 	'2'		,'numeroProtocolo'	    ,'false'	    ,null		            ,'Número de protocolo'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textarea', 	'3'		,'observaciones'		,null		,null					    ,'Observaciones')
    ); 
