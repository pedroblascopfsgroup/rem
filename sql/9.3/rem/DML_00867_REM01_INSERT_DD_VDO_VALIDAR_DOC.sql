...
--## PRODUCTO=NO
--##
--## Finalidad: DML add valores al diccionario DD_VDO_VALIDAR_DOC
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30):= 'DD_VDO_VALIDAR_DOC'; -- Vble. del nombre de la tabla
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                --CODIGO    DESCRIPCION
	    T_TIPO_DATA('01',	'Documentación validada'),
        T_TIPO_DATA('02',	'02 - Oferta caducada')
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_VDO_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND BORRADO = 0';
