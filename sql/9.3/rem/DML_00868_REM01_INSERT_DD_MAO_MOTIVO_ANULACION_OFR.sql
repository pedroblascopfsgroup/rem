...
--## PRODUCTO=NO
--##
--## Finalidad: DML add valores al diccionario DD_MAO_MOTIVO_ANULACION_OFR
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30):= 'DD_MAO_MOTIVO_ANULACION_OFR'; -- Vble. del nombre de la tabla
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                --CODIGO    DESCRIPCION
	    T_TIPO_DATA('04',	'Falta documentación previa')
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_MAO_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND BORRADO = 0';
