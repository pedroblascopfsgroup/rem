...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-14578';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_SolicitarGarantiasAdicionales'	,'combobox', 	'1'		,'comboResultado'	    	,'false'	    ,'DDSiNo'		            ,'Respuesta comprador'),
        T_TIPO_DATA('T015_SolicitarGarantiasAdicionales'	,'combobox', 	'2'		,'respuestaComprador'	    ,null	    	,'DDRespuestaComprador'		,'Tipo de respuesta'),
        T_TIPO_DATA('T015_SolicitarGarantiasAdicionales'	,'textarea', 	'3'		,'observaciones'			,null			,null						,'Observaciones')
    ); 
