...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_EnvioContrato'    ,'label', 		'0'		,'titulo'				,null		    ,null					,'<p style="margin-bottom:10px">Instrucciones por defecto de la tarea ''''Firma contrato'''' </p>'),        
        T_TIPO_DATA('T015_EnvioContrato'	,'combobox', 	'1'		,'comboResultado'		,'false' 	,'DDSiNo'				    ,'Cliente acepta clausulado'),
        T_TIPO_DATA('T015_EnvioContrato'	,'datefield', 	'2'		,'fechaEnvio'		    ,'false'	    ,null					,'Fecha envío'),
        T_TIPO_DATA('T015_EnvioContrato'	,'textarea', 	'3'		,'observaciones'		,null		,null					    ,'Observaciones')
    ); 
