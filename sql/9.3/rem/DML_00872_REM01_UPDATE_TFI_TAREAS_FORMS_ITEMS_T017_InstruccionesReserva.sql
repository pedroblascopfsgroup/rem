...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_InstruccionesReserva'	,'label',       '0',    'titulo'                   ,null   ,null                  ,'<p style="margin-bottom: 10px">Para finalizar esta tarea, recopile la información necesaria para remitirla a la oficina y anote en el campo "fecha de envío" en día efectivo en que lo ha hecho.
        ...
        T_TIPO_DATA('T017_InstruccionesReserva'	,'combobox', 	'1'		,'comboResultado'	    ,'false'   ,'DDSiNo'	        ,'Reagendar arras'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'textfield', 	'2'		,'motivoAplazamiento'	,'false'   ,null		        ,'Motivo Aplazamiento'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'combobox',    '3',    'tipoArras'             ,'false'   ,'DDTiposArras'     ,'Tipo de arras:'),
    	T_TIPO_DATA('T017_InstruccionesReserva'	,'datefield',   '4'		,'fechaEnvio'		    ,'false'   ,null               ,'Fecha de envío'),
    	T_TIPO_DATA('T017_InstruccionesReserva'	,'textarea', 	'5'		,'observaciones'	    ,null      ,null		        ,'Observaciones')
