...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-14636';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'combobox', 	'1'		,'comboResultado'	    ,'false'   ,'DDSiNo'	        ,'Reagendar arras'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textfield', 	'2'		,'motivoAplazamiento'	,'false'   ,null		        ,'Motivo Aplazamiento'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textinf',     '3'     ,'cartera'              ,null      ,null                ,'Cartera del activo:'),
    	T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textinf',     '4'		,'oficinaReserva'		,null      ,null               ,'Oficina en la que se ha firmado la reserva'),
    	T_TIPO_DATA('T017_ObtencionContratoReserva'	,'datefield',   '5'		,'fechaFirma'	        ,'false'   ,null		        ,'Fecha de firma'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textarea', 	'6'		,'observaciones'	    ,null      ,null		        ,'Observaciones')
