...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-14637';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T017_FirmaContrato'	,'combobox', 	'1'		,'comboResultado'	    ,''                                                 ,'false'   ,'DDSiNo'	        ,'Reagendar fecha firma'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textfield', 	'2'		,'motivoAplazamiento'	,''                                                 ,'false'   ,null		        ,'Motivo aplazamiento'),
        T_TIPO_DATA('T017_FirmaContrato'	,'combobox',    '3'     ,'comboFirma'           ,'Debe indicar si la reserva está firmada o no'     ,'false'   ,'DDSiNo'            ,'Reserva firmada'),
    	T_TIPO_DATA('T017_FirmaContrato'	,'datefield',   '4'		,'fechaFirma'		    ,''                                                 ,'false'   ,null                ,'Fecha firma'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textfield',   '5'		,'numeroProtocolo'		,''                                                 ,'false'   ,null                ,'Número de protocolo'),
    	T_TIPO_DATA('T017_FirmaContrato'	,'textarea', 	'6'		,'observaciones'	    ,''                                                 ,null      ,null		        ,'Observaciones')
