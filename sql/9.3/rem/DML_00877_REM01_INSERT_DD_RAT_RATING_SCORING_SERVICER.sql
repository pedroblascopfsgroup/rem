...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_RAT_RATING_SCORING_SERVICER
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_RAT_RATING_SCORING_SERVICER'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'RAT';
