...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_GAO_GARANTIAS_ADICIONALES_OFERTA
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_GAO_GARANTIAS_ADICIONALES_OFERTA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'GAO';
