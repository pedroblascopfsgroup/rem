...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_PBCReserva'	,'label',               '0'     ,'titulo'               ,null         ,null      ,null                  ,'<p style="margin-bottom: 10px">En la presente tarea deberá reflejar si se ha aprobado el proceso de PBC de la reserva.</p>
  ...
  <p style="margin-bottom: 10px"> En el campo "observaciones" puede hacer constar cualquier aspecto relevante que considere que debe quedar reflejado en este punto del trámite</p>'),
        T_TIPO_DATA('T017_PBCReserva'	,'combobox',            '1'     ,'comboQuitar'          ,null         ,null      ,'DDSiNo'              ,'Quitar Arras'),                                                                                                                                            
        T_TIPO_DATA('T017_PBCReserva'	,'comboboxinicialedi', 	'2'		,'comboRespuesta'	    ,null         ,'false'   ,'DDApruebaDeniega'	,'Respuesta'),
    	T_TIPO_DATA('T017_PBCReserva'	,'textarea', 	        '3'		,'observaciones'	    ,null         ,null      ,null		            ,'Observaciones')
