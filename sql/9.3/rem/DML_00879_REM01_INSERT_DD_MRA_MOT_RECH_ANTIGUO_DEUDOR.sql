...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_MRA_MOT_RECH_ANTIGUO_DEUDOR
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      	T_TIPO_DATA('DUR','Por duración'),
		T_TIPO_DATA('REN','Por renta'),
		T_TIPO_DATA('MPE','Por motivos personales'),
