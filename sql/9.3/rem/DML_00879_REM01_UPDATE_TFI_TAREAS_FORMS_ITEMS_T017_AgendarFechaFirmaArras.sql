...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-14640';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'label',               '0'     ,'titulo'               ,null         ,null      ,null                  ,'<p style="margin-bottom: 10px"> En esta tarea debe informar de la fecha propuesta para firmar el documento de arras. Al finalizarla, se enviaran los datos al propietario para su validación. Una vez recibida su respuesta, se le mostará la tarea "Confirmación fecha firma arras".</p><p style="margin-bottom: 10px"> En caso de haberse realizado una propuesta previa y no haber recibido todavía respuesta, podrá modificar la fecha propuesta desde el grid de la pestaña "Reserva"</p>'),
        T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'combobox',            '1'     ,'comboQuitar'          ,null         ,null      ,'DDSiNo'              ,'Quitar Arras'),
        T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'datefield', 	        '2'		  ,'fechaEnvio'	          ,null         ,'false'   ,null	                ,'Fecha envío'),
        T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'datefield',           '3'     ,'fechaEnvioPropuesta'  ,null         ,'false'   ,null                  ,'Fecha propuesta firma arras'),
    	  T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'textarea', 	          '4'		  ,'observaciones'	      ,null         ,null      ,null		              ,'Observaciones')
