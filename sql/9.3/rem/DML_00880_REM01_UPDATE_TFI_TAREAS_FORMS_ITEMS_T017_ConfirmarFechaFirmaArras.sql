...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'label',               '0'     ,'titulo'               ,null         ,null      ,null                  ,'<p style="margin-bottom: 10px"> Ha recibido respuesta del propietario. </p><p style="margin-bottom: 10px"> Si la respuesta ha sido positiva, al realizar esta tarea el proceso avanzará a "Instrucciones contrato reserva".</p><p style="margin-bottom: 10px"> Por el contrario, si la respuesta ha sido negativa, volverá a la tarea "Agendar fecha arras". </p>'),
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'combobox',            '1'     ,'comboQuitar'          ,null         ,null      ,'DDSiNo'              ,'Quitar Arras'),
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'datefield', 	        '2'		  ,'fechaPropuesta'	      ,null         ,'false'   ,null	                ,'Fecha propuesta'),
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'datefield',           '3'     ,'fechaValidacionBC'    ,null         ,'false'   ,null                  ,'Fecha validación BC'),
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'combobox',            '4'     ,'comboValidacionBC'    ,null         ,'false'   ,'DDMotivosEstadoBC'   ,'Validación BC'),
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'textarea',            '5'     ,'observacionesBC'      ,null         ,null      ,null                  ,'Observaciones BC'),
    	  T_TIPO_DATA('T017_ConfirmarFechaFirmaArras'	,'textarea', 	          '6'		  ,'observaciones'	      ,null         ,null      ,null		              ,'Observaciones')
