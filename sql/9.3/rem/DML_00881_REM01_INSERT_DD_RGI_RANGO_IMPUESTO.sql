...
--## PRODUCTO=NO
--##
--## Finalidad: Insertar en la tabla DD_RGI_RANGO_IMPUESTO
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(30):= 'DD_RGI_RANGO_IMPUESTO'; -- Vble. del nombre de la tabla
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                --CODIGO    DESCRIPCION
	    T_TIPO_DATA('01',	'General'),
        T_TIPO_DATA('02',	'Reducido'),
        T_TIPO_DATA('03',	'Exento'),
        T_TIPO_DATA('04',	'Super reducido')
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_RGI_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND BORRADO = 0';
