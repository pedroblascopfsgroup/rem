...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_InstruccionesReserva'	,'label',               '0'     ,'titulo'               ,null                             ,null      ,null                  ,'<p style="margin-bottom: 10px">Para finalizar esta tarea, recopile la información necesaria para remitirla a la oficina y anote en el campo "fecha de envío" en día efectivo en que lo ha hecho.
        ...
        T_TIPO_DATA('T017_InstruccionesReserva'	,'combobox',            '1'     ,'comboQuitar'          ,null                             ,null      ,'DDSiNo'              ,'Quitar Arras'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'combobox', 	          '2'		  ,'comboResultado'	      ,null                             ,'false'   ,'DDSiNo'              ,'Reagendar arras'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'textfield',           '3'     ,'motivoAplazamiento'   ,null                             ,'false'   ,null                  ,'Motivo Aplazamiento'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'combobox',            '4'     ,'tipoArras'            ,'Debe indicar el tipo de arras'  ,'false'   ,'DDTiposArras'        ,'Tipo de arras:'),
        T_TIPO_DATA('T017_InstruccionesReserva'	,'datefield',           '5'     ,'fechaEnvio'           ,null                             ,'false'   ,null                  ,'Fecha de envío'),
    	  T_TIPO_DATA('T017_InstruccionesReserva'	,'textarea', 	          '6'		  ,'observaciones'	      ,null                             ,null      ,null		              ,'Observaciones')
