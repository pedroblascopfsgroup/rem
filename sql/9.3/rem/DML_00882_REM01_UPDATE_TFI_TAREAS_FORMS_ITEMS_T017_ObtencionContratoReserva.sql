...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'label',               '0'     ,'titulo'               ,null     ,null      ,null                  ,'<p style="margin-bottom: 10px">Para dar por completada esta tarea deberá subir una copia del contrato de reserva a la pestaña "documentos" del expediente comercial. La siguiente tarea, que se lanzará al gestor de formalización, será "Resultado PBC".</p><p style="margin-bottom: 10px">En el campo "observaciones" puede hacer constar cualquier aspecto relevante que considere que debe quedar reflejado en este punto del trámite.</p>'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'combobox',            '1'     ,'comboQuitar'          ,null     ,null      ,'DDSiNo'              ,'Quitar Arras'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'combobox', 	          '2'		  ,'comboResultado'	      ,null     ,'false'   ,'DDSiNo'              ,'Reagendar arras'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textfield',           '3'     ,'motivoAplazamiento'   ,null     ,'false'   ,null                  ,'Motivo Aplazamiento'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textinf',             '4'     ,'cartera'              ,null     ,null      ,'DDTiposArras'        ,'Cartera del activo:'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textinf',             '5'     ,'oficinaReserva'       ,null     ,null      ,null                  ,'Oficina en la que se ha firmado la reserva'),
        T_TIPO_DATA('T017_ObtencionContratoReserva'	,'datefield',           '6'     ,'fechaFirma'           ,null     ,'false'   ,null                  ,'Fecha de firma'),
    	  T_TIPO_DATA('T017_ObtencionContratoReserva'	,'textarea', 	          '7'		  ,'observaciones'	      ,null     ,null      ,null		              ,'Observaciones')
