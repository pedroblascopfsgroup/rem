...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_PBCReserva',
                    'checkBankia() && valores[''''T017_PBCReserva''''][''''comboQuitar''''] == ''''01'''' ? ''''KO'''' : valores[''''T017_PBCReserva''''][''''comboRespuesta''''] == DDApruebaDeniega.CODIGO_APRUEBA ? checkBankia() ? ''''ApruebaBC'''' : ''''Aprueba'''' : ''''Deniega''''',
                    '')
    ); 
