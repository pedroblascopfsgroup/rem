...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_ConfirmarFechaFirmaArras',
                    'checkBankia() && valores[''''T017_ConfirmarFechaFirmaArras''''][''''comboQuitar''''] == ''''01'''' ? ''''KO'''' : valores[''''T017_ConfirmarFechaFirmaArras''''][''''comboValidacionBC''''] == DDMotivosEstadoBC.CODIGO_APROBADA_BC ? ''''Confirmado'''' : ''''noConfirmado''''',
                    '')
    ); 
