...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_InstruccionesReserva',
                    'checkBankia() && valores[''''T017_InstruccionesReserva''''][''''comboQuitar''''] == ''''01'''' ? ''''KO'''' : (checkBankia() &&  valores[''''T017_InstruccionesReserva''''][''''comboResultado''''] == ''''01'''') ? ''''Confirmado'''' : ''''noConfirmado''''')
    ); 
