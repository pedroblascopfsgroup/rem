...
--## INCIDENCIA_LINK=HREOS-15050
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nuevas funciones declaradas en el array
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
        T_FUNCION('Avance resolución comité BC','AV_RES_COMITE_BC'),
        T_FUNCION('Avance Confirmación Fecha Firma Arras','AV_CONF_FF_ARRAS'),
        T_FUNCION('Avance Confirmarción Fecha Escritura','AV_CONF_F_ESC'),
        T_FUNCION('Avance Expediente Comercial Bloqueado','AV_ECO_BLOQ')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-15050'',SYSDATE,0 FROM DUAL';
