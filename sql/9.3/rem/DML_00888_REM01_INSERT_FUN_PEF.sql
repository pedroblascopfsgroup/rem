...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-15050';
    ...
    --         NOMBRE_FUNCION                   NOMBRE_PERFIL
        T_FUNCION('AV_RES_COMITE_BC',		'HAYASUPER'),
        T_FUNCION('AV_CONF_FF_ARRAS',		'HAYASUPER'),
        T_FUNCION('AV_CONF_F_ESC',		    'HAYASUPER'),
        T_FUNCION('AV_ECO_BLOQ',		    'HAYASUPER')
    ); 
