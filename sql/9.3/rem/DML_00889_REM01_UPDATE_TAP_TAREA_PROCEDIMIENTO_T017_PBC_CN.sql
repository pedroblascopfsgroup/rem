...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_PBC_CN',
                    'valores[''''T017_PBC_CN''''][''''comboResultado''''] == DDSiNo.SI ? ''''resultadoPositivo'''' : ''''resultadoNegativo''''')
                    ); 
