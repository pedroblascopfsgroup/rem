...
DECLARE
	...
	V_USUARIO VARCHAR2(150 CHAR) := 'HREOS-14639';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(2400);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        
        T_TIPO_DATA('T017_PBCVenta'	            ,'label',               '0'     ,'titulo'               ,null                             ,null      ,null                  ,'"<p style="margin-bottom: 10px">En la presente tarea deberá reflejar si se ha aprobado el proceso de PBC.</p>
        ...
        T_TIPO_DATA('T017_PBCVenta'	            ,'combobox',            '1'     ,'comboArras'           ,null                             ,'false'      ,'DDSiNo'              ,'Añadir arras'),
        T_TIPO_DATA('T017_PBCVenta'	            ,'numberfield', 	    '2'		,'mesesFianza'	        ,null                             ,'false'      ,null                  ,'Meses de fianza'),
        T_TIPO_DATA('T017_PBCVenta'	            ,'numberfield', 	    '3'		,'importeFianza'	    ,null                             ,'false'      ,null                  ,'Importe de fianza'),
        T_TIPO_DATA('T017_PBCVenta'	            ,'comboboxinicialedi',  '4'     ,'comboRespuesta'       ,null                             ,'false'      ,'DDApruebaDeniega'    ,'Respuesta'),
        T_TIPO_DATA('T017_PBCVenta'	            ,'textarea', 	        '5'		,'observaciones'	    ,null                             ,null         ,null		          ,'Observaciones')
