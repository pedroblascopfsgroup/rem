...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_FirmaContrato'	,'label',       '0'     ,'titulo'               ,''                                                 ,null      ,null                ,'<p style="margin-bottom:10px">Instrucciones por defecto de la tarea "Firma contrato"</p>'),
        
        
        T_TIPO_DATA('T017_FirmaContrato'	,'combobox',            '1'     ,'comboArras'           ,null                                               ,'false'   ,'DDSiNo'            ,'Añadir arras'),
        T_TIPO_DATA('T017_FirmaContrato'	,'numberfield', 	    '2'		,'mesesFianza'	        ,null                                               ,'false'   ,null                ,'Meses de fianza'),
        T_TIPO_DATA('T017_FirmaContrato'	,'numberfield', 	    '3'		,'importeFianza'	    ,null                                               ,'false'   ,null                ,'Importe de fianza'),
        T_TIPO_DATA('T017_FirmaContrato'	,'combobox', 	        '4'		,'comboResultado'	    ,''                                                 ,'false'   ,'DDSiNo'	        ,'Reagendar fecha firma'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textfield', 	        '5'		,'motivoAplazamiento'	,''                                                 ,'false'   ,null		        ,'Motivo aplazamiento'),
        T_TIPO_DATA('T017_FirmaContrato'	,'combobox',            '6'     ,'comboFirma'           ,'Debe indicar si la reserva está firmada o no'     ,'false'   ,'DDSiNo'            ,'Reserva firmada'),
    	T_TIPO_DATA('T017_FirmaContrato'	,'datefield',           '7'		,'fechaFirma'		    ,''                                                 ,'false'   ,null                ,'Fecha firma'),
        T_TIPO_DATA('T017_FirmaContrato'	,'textfield',           '8'		,'numeroProtocolo'		,''                                                 ,'false'   ,null                ,'Número de protocolo'),
    	T_TIPO_DATA('T017_FirmaContrato'	,'textarea', 	        '9'		,'observaciones'	    ,''                                                 ,null      ,null		        ,'Observaciones')
