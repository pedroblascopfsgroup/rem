...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'combobox',        '1'     ,'comboArras'           ,'false'   ,'DDSiNo'            ,'Añadir arras'),
        T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'numberfield', 	'2'		,'mesesFianza'	        ,'false'   ,null                ,'Meses de fianza'),
        T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'numberfield', 	'3'		,'importeFianza'	    ,'false'   ,null                ,'Importe de fianza'),
    	T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'datefield', 	    '4'		,'fechaPropuesta'		,'false'	,null					,'Fecha propuesta'),
    	T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'combobox', 	    '5'		,'comboValidacionBC'	,'false'	,'DDMotivosEstadoBC'	,'Validación BC'),
    	T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'datefield', 	    '6'		,'fechaRespuesta'	    ,'false'	,null           		,'Fecha respuesta BC'),
    	T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'textarea', 	    '7'		,'observacionesBC'		,null		,null					,'Observaciones BC'),
        T_TIPO_DATA('T017_ConfirmarFechaEscritura'	,'textarea', 	    '8'		,'observaciones'		,null		,null					,'Observaciones')
    ); 
