...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-14639';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_AgendarPosicionamiento'       ,'label',           '0'     ,'titulo'               ,null      ,null                ,'<p style="margin-bottom: 10px">En esta tarea debe informar de la fecha propuesta para la firma del contrato de venta. Al finalizarla, se enviarán los datos al propietario para su validación. Una vez recibida su respuesta, se le mostrará la tarea "Confirmación fecha firma contrato".</p><p style="margin-bottom: 10px">En caso de haberse realizado una propuesta previa y no haber recibido todavía respuesta, podrá modificar la fecha propuesta desde el grid en la pestaña de "Formalización"</p>'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'	    ,'combobox',        '1'     ,'comboArras'           ,'false'   ,'DDSiNo'            ,'Añadir arras'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'	    ,'numberfield', 	'2'		,'mesesFianza'	        ,'false'   ,null                ,'Meses de fianza'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'	    ,'numberfield', 	'3'		,'importeFianza'	    ,'false'   ,null                ,'Importe de fianza'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'       ,'datefield',       '4'     ,'fechaEnvio'           ,'false'   ,null                ,'Fecha envío'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'       ,'datefield',       '5'     ,'fechaPropuestaFC'     ,'false'   ,null                ,'Fecha propuesta firma contrato'),
        T_TIPO_DATA('T017_AgendarPosicionamiento'       ,'textarea',        '6'     ,'observaciones'        ,null      ,null                ,'Observaciones')
    ); 
