...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_PBCVenta',
                    'valores[''''T017_PBCVenta''''][''''comboArras''''] == DDSiNo.NO ? valores[''''T017_PBCVenta''''][''''comboRespuesta''''] == DDApruebaDeniega.CODIGO_APRUEBA ? checkBankia() ? ''''ApruebaBC'''' : ''''Aprueba'''' : ''''Deniega'''' : ''''ReagendarArras'''' ')
    ); 
