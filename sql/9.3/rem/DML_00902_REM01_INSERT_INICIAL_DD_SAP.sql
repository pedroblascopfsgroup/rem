...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_SAP_SANCION_PBC
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_SAP_SANCION_PBC';
    V_CHARS VARCHAR2(3 CHAR):= 'SAP';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-15081';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION                 DESCRIPCION_LARGA  
      T_TIPO_DATA('10',			'Aprobada',			              'Aprobada'),
      T_TIPO_DATA('20',			'Aprobada arras',		          'Aprobada arras'),
      T_TIPO_DATA('30',			'Aprobada condicionada',		  'Aprobada condicionada'),
      T_TIPO_DATA('40',     'Rechazada',                  'Rechazada'),
      T_TIPO_DATA('50',     'Elevada a propietario',      'Elevada a propietario')
