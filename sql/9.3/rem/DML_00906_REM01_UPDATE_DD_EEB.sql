...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-8667';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			            DESCRIPCION                                       DESCRIPCION_LARGA                               CODIGO_C4C
      T_TIPO_DATA('028',			'Pte. garantías adicionales',			                   'Pte. garantías adicionales',                             470),
      T_TIPO_DATA('038',			'Pte. aprobacion garantías adiocionales BC',		     'Pte. aprobacion garantías adiocionales BC',              230)
      ...
      ELSE
        ...
        V_MSQL := '
          	INSERT INTO '|| V_ESQUEMA ||'.'||V_TABLA||' (
				...
				VERSION, USUARIOCREAR, FECHACREAR, DD_'||V_CHARS||'_CODIGO_C4C)
          	SELECT 
	            '|| V_ID || ',
	            '''||V_TMP_TIPO_DATA(1)||''',
	            '''||V_TMP_TIPO_DATA(2)||''',
	            '''||TRIM(V_TMP_TIPO_DATA(3))||''',
	            0, '''||V_USUARIO||''', SYSDATE, '||V_TMP_TIPO_DATA(4)||' FROM DUAL';
        EXECUTE IMMEDIATE V_MSQL;
