...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_ConfirmarFechaEscritura', '(checkBankia() == true && valores[''''T017_ConfirmarFechaEscritura''''][''''comboValidacionBC''''] != DDMotivosEstadoBC.CODIGO_APROBADA_BC && valores[''''T017_ConfirmarFechaEscritura''''][''''comboValidacionBC''''] != DDMotivosEstadoBC.CODIGO_RECHAZADA_BC) ? ''''El estado de Validaci&oacute;n BC tiene que ser Aceptado o Rechazado'''' : null')
    ); 
