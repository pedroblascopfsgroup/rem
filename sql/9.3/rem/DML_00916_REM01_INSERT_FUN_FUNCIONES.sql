...
--## INCIDENCIA_LINK=HREOS-15255
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en FUN_FUNCIONES una nueva función
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Resolución comité', 'AV_ALQ_RES_COMITE'),
      T_FUNCION('Scoring BC', 'AV_ALQ_SCORING_BC'),
      T_FUNCION('Sanción BC (scoring)', 'AV_ALQ_SANCION_BC'),
      T_FUNCION('Sanción Patrimonio', 'AV_ALQ_SAN_PATR')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-15255'',SYSDATE,0 FROM DUAL';
