...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Análisis BC', 'AV_ALQNC_ANALISIS_BC'),
      T_FUNCION('Scoring BC', 'AV_ALQNC_SCORING_BC'),
      T_FUNCION('Resolución comité', 'AV_ALQNC_RES_COMITE'),
      T_FUNCION('Pte. CL/ROD', 'AV_ALQNC_CL_ROD'),
      T_FUNCION('Revisión BC condiciones', 'AV_ALQNC_REV_BC_COND')
    ); 
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			ELSE		
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA_M ||'.FUN_FUNCIONES (' ||
						...
						'0, ''HREOS-15259'',SYSDATE,0 FROM DUAL';
