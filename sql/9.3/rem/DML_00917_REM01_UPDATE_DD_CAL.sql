...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_CAL_CLASIFICACION_ALQUILER
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_CAL_CLASIFICACION_ALQUILER';
    V_CHARS VARCHAR2(3 CHAR):= 'CAL';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-15564';
