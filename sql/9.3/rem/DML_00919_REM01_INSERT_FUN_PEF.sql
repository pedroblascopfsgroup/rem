...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-15255';
    ...
    --         NOMBRE_FUNCION                   NOMBRE_PERFIL
        T_FUNCION('AV_ALQ_RES_COMITE',		    'HAYASUPER'),
        T_FUNCION('AV_ALQ_SCORING_BC',		    'HAYASUPER'),
        T_FUNCION('AV_ALQ_SANCION_BC',		    'HAYASUPER'),
        T_FUNCION('AV_ALQ_SAN_PATR',		    'HAYASUPER'),
        T_FUNCION('AV_ALQNC_ANALISIS_BC',		'HAYASUPER'),
        T_FUNCION('AV_ALQNC_SCORING_BC',		'HAYASUPER'),
        T_FUNCION('AV_ALQNC_RES_COMITE',		'HAYASUPER'),
        T_FUNCION('AV_ALQNC_CL_ROD',		    'HAYASUPER'),
        T_FUNCION('AV_ALQNC_REV_BC_COND',		'HAYASUPER')
    ); 
