...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T015_CalculoRiesgo', 'Cálculo riesgo', '', '', '', 'true')
    ); 
		    ...
		    IF V_COUNT = 0 THEN
				V_MSQL := ' INSERT INTO '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS
			            VALUES (
			                    ...
			                    , null , null  , null , null  , 0, ''HREOS-16688'', SYSDATE , null, null, null , null  , 0)';
			    EXECUTE IMMEDIATE V_MSQL;
	        	...
	        	V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS
	                VALUES (
	                    ...
	                    , null , ''DDRiesgoOperacion''  , 0, ''HREOS-16688'', SYSDATE , null, null, null , null  , 0
	                )';
				EXECUTE IMMEDIATE V_MSQL;
				V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.TFI_TAREAS_FORM_ITEMS
	                VALUES (
	                    ...
	                    , null , null  , 0, ''HREOS-16688'', SYSDATE , null, null, null , null  , 0
	                )';
