...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade tareas al avanzador de tareas.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-15415';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            --            CODIGO TAREA  			     TCP_ACTIVADA     TCP_PERMITIDA
      T_TIPO_DATA('T018_PbcAlquiler',			     1,			         1),
      T_TIPO_DATA('T015_PBC',			     1,			         1)      
