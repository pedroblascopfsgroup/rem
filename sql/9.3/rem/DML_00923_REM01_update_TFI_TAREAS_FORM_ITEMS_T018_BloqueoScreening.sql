...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15407';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T018_BloqueoScreening'		,'combobox', 	'1'		,'comboResultado'						,'false' 	,'DDSiNo'				,'Bloqueado:'),
    	T_TIPO_DATA('T018_BloqueoScreening'		,'label', 		'2'		,'hueco'								,null 		,null					,''),
    	
    	T_TIPO_DATA('T018_BloqueoScreening'		,'combobox', 	'3'		,'motivoBloqueado'						,'false' 	,'DDMotivoBloqueo'		,'Motivo bloqueo'),
    	T_TIPO_DATA('T018_BloqueoScreening'		,'combobox', 	'4'		,'motivoDesbloqueado'					,'false' 	,'DDMotivosDesbloqueo'	,'Motivo desbloqueo'),
    	
    	T_TIPO_DATA('T018_BloqueoScreening'		,'textarea', 	'5'		,'observacionesBloqueado'				,null 		,null					,'Observaciones bloqueo'),
    	T_TIPO_DATA('T018_BloqueoScreening'		,'textarea', 	'6'		,'observacionesDesbloqueado'			,null 		,null					,'Observaciones desbloqueo')
    ); 
