...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15065';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_SolicitarGarantiasAdicionales'		,'combobox', 	'1'		,'respuestaComprador'),
    	T_TIPO_DATA('T015_SolicitarGarantiasAdicionales'		,'combobox', 	'2'		,'comboResultado')
    ); 
