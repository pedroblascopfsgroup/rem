...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T015_AgendarFechaFirma', 'checkBankia() == true ? checkContratoSubido() ? null : ''''Es necesario adjuntar sobre el Expediente Comercial, el documento Contrato.'''' : null')
    ); 
