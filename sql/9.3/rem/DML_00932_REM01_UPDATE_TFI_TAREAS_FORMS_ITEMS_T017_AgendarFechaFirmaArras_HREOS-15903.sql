...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15903';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'datefield',           '4'     ,'fechaVencimientoArras'  ,null         ,'false'   ,null                  ,'Fecha vencimiento arras'),
    	T_TIPO_DATA('T017_AgendarFechaFirmaArras'	,'textarea', 	          '5'		  ,'observaciones'	      ,null         ,null      ,null		              ,'Observaciones')
