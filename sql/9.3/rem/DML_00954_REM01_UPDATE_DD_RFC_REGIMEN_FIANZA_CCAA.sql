...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_RFC_REGIMEN_FIANZA_CCAA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15612';    
	V_ALIAS VARCHAR2(50 CHAR) := 'RFC';    
