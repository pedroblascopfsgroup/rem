...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MRA_MOT_RECH_ANTIGUO_DEUDOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15771';    
	V_ALIAS VARCHAR2(50 CHAR) := 'MRA';    
