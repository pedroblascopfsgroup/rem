...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
   		T_TIPO_DATA('T017_AgendarFechaFirmaArras' ,'valores[''''T017_AgendarFechaFirmaArras''''][''''comboQuitar''''] != DDSiNo.SI ? tieneFechaVencimientoReserva() ? null : '''' Debe tener fecha de vencimiento de arras'''' : null ' )
    );
