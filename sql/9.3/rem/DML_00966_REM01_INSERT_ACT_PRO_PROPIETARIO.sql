...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='HREOS-17286'; --Vble. auxiliar para almacenar el usuario
    ...
    V_PRO_DOCIDENTIF VARCHAR2(100 CHAR):='A16948200';
    V_COUNT NUMBER(16) :=0;
...
BEGIN	
    ...
    IF V_COUNT = 0 THEN     
        ...
        ''Promontoria Macc Marina RE, S.A.'',
