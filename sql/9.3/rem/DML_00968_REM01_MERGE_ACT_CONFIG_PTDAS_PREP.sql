...
--## PRODUCTO=NO
--##
--## Finalidad: Merge para insertar la configuración de cuentas y partidas de la subcartera MACC_MARINA
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
    ...
    V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_CONFIG_PTDAS_PREP act
                ...
                SELECT  DISTINCT
                    ...
                    WHERE  NOT EXISTS (
                        ...
                        ) us ON (us.CPP_PTDAS_ID = act.CPP_PTDAS_ID AND us.DD_SCR_CODIGO = ''71'')
