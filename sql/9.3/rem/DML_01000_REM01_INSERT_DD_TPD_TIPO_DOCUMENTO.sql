...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-10694';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Subsanación tanteo','AI-05-COMU-BE','179'),
          T_JBV('Comunicación tanteo','AI-05-COMU-86','180'),
          T_JBV('Solicitud visita tanteo','AI-05-COMU-87','181'),
          T_JBV('Respuesta tanteo','AI-05-ACUE-15','182'),
          T_JBV('Check List documental','AI-01-INLI-19','183')
	); 
	V_TMP_JBV T_JBV;
