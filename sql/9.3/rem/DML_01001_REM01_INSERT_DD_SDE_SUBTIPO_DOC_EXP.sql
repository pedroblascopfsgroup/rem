...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('88'	,'Instrucciones de reserva','03'	,'OP-08-PRPE-59')
    ); 
      ...
      LOOP
       	  ...
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' SET 
                      ...
                      DD_'||V_TEXT_CHARS||'_DESCRIPCION_LARGA = '''||TRIM(V_TMP_TIPO_DATA(2))||''',
          			      ...
          			      DD_TDE_ID = (SELECT DD_TDE_ID FROM DD_TDE_TIPO_DOC_EXP WHERE DD_TDE_CODIGO = '''||V_TMP_TIPO_DATA(4)||''') ,
					            USUARIOMODIFICAR = ''REMVIP-10847'' , FECHAMODIFICAR = SYSDATE 
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
                      (DD_'||V_TEXT_CHARS||'_ID, DD_TDE_ID, DD_'||V_TEXT_CHARS||'_CODIGO, DD_'||V_TEXT_CHARS||'_DESCRIPCION, DD_'||V_TEXT_CHARS||'_DESCRIPCION_LARGA, 
                      DD_'||V_TEXT_CHARS||'_MATRICULA_GD, USUARIOCREAR, FECHACREAR) VALUES
                      ...
                      '''||TRIM(V_TMP_TIPO_DATA(4))||''', ''REMVIP-10847'',SYSDATE)';
          EXECUTE IMMEDIATE V_MSQL;
