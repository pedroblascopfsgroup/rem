...
--## PRODUCTO=NO
--##
--## Finalidad: INSERTAR DD_MRR_MOTIVO_RECHAZO_RCDC
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MRR_MOTIVO_RECHAZO_RCDC'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'MRR'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    V_USUARIO VARCHAR2(250 CHAR) := 'REMVIP-10811';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('01','Precio'),
      T_TIPO_DATA('02','Otra oferta en gestión'),
      T_TIPO_DATA('03','Situación del activo'),
      T_TIPO_DATA('04','Otros')
    ); 
