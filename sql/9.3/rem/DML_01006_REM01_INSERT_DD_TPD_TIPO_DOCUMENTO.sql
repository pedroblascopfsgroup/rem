...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-10878';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Comunidad Propietarios - Notificación cambio de titularidad activos','AI-01-COMU-23','186')
	); 
	V_TMP_JBV T_JBV;
