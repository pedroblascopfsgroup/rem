...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T018_Scoring','valores[''''T018_Scoring''''][''''comboResolucion''''] == DDResultadoScoring.RESULTADO_APROBADO ? checkGarantiasNinguna(valores[''''T018_Scoring''''][''''comboReqAnalisisTec'''']) : ''''resultadoKoConDudas''''')
 	); 
