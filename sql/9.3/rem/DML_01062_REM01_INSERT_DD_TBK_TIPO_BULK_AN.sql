...
DECLARE
    ...
    V_INCIDENCIA VARCHAR2(25 CHAR) := 'HREOS-17983';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DID', 'Divarian-Industrial - Aprobadas en Delegación', 'Divarian-Industrial - Aprobadas en Delegación'),
        T_TIPO_DATA('DIC', 'Divarian-Industrial - Aprobadas por Cerberus', 'Divarian-Industrial - Aprobadas por Cerberus'),
        T_TIPO_DATA('APDB', 'Apple - Aprobadas en Delegación - Prescriptor = Bidx1', 'Apple - Aprobadas en Delegación - Prescriptor = Bidx1'),
        T_TIPO_DATA('APDO', 'Apple - Aprobadas en Delegación - Prescriptor = Okuant', 'Apple - Aprobadas en Delegación - Prescriptor = Okuant'),
        T_TIPO_DATA('DRDB', 'Divarian-Remaining - Aprobadas en Delegación - Prescriptor = Bidx1', 'Divarian-Remaining - Aprobadas en Delegación - Prescriptor = Bidx1'),
        T_TIPO_DATA('DRDO', 'Divarian-Remaining - Aprobadas en Delegación - Prescriptor = Okuant', 'Divarian-Remaining - Aprobadas en Delegación - Prescriptor = Okuant'),
        T_TIPO_DATA('JRCC', 'Jaguar - Aprobadas por Cerberus - Prescriptor = oficinas Cajamar', 'Jaguar - Aprobadas por Cerberus - Prescriptor = oficinas Cajamar'),
        T_TIPO_DATA('JRDC', 'Jaguar - Aprobadas en Delegación - Prescriptor = oficinas Cajamar', 'Jaguar - Aprobadas en Delegación - Prescriptor = oficinas Cajamar'),
        T_TIPO_DATA('JRDB', 'Jaguar - Aprobadas en Delegación - Prescriptor = Bidx1', 'Jaguar - Aprobadas en Delegación - Prescriptor = Bidx1'),
        T_TIPO_DATA('JRDO', 'Jaguar - Aprobadas en Delegación - Prescriptor = Okuant', 'Jaguar - Aprobadas en Delegación - Prescriptor = Okuant')
