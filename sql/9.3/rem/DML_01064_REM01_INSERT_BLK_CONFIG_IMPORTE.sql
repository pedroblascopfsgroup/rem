...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('DID', 750000),
        T_TIPO_DATA('DIC', 750000),

        T_TIPO_DATA('APDB', 750000),
        T_TIPO_DATA('APDO', 750000),
        T_TIPO_DATA('DRDB', 750000),
        T_TIPO_DATA('DRDO', 750000),
        T_TIPO_DATA('JRCC', 750000),
        T_TIPO_DATA('JRDC', 750000),
        T_TIPO_DATA('JRDB', 750000),
        T_TIPO_DATA('JRDO', 750000)
		); 
