...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_BDP_BLOQUE_DOC_PROVEEDOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'BDP';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-17664';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01',  'Documentos'),
    	T_TIPO_DATA('02',  'Conductas inapropiadas')
    ); 
