...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'HREOS-18338'; -- USUARIOCREAR/USUARIOMODIFICAR
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('PROC_PAGO', 'Procede pago', 'Procede pago'),
        T_TIPO_DATA('NPROC_PAGO', 'No procede pago', 'No procede pago')
