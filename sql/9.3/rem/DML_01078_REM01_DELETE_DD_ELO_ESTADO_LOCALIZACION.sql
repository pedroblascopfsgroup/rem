...
--## PRODUCTO=NO
--##
--## Finalidad: Script que borra los datos del array en DD_ELO_ESTADO_LOCALIZACION
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial 
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_ELO_ESTADO_LOCALIZACION';
    V_CHARS VARCHAR2(3 CHAR):= 'ELO';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-18402';
