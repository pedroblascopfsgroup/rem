...
--## INCIDENCIA_LINK=REMVIP-11520
--## PRODUCTO=NO
--##
--## Finalidad: Script que actualiza los datos del array en DD_TPR_TIPO_PROVEEDOR
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'REMVIP-11520';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('44','Intermediario', '03')
    ); 
