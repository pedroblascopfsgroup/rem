...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-12326';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T013_PBCReserva','esOmega() || esTitulizada() ? fechaReservaPBCReserva() || esTitulizada() ? null : ''''Es necesario cumplimentar el campo fecha de reserva'''' : ''''No es cartera Omega ni Titulizada.''''')
    );
