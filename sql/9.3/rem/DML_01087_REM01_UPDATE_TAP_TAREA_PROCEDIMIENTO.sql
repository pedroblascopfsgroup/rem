...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'REMVIP-12341'; -- Usuario modificar
    ...
    V_TIPO_DATA T_ARRAY_TIPO_DATA := T_ARRAY_TIPO_DATA(
	    T_TIPO_DATA('T018_AnalisisBc','valores[''''T018_AnalisisBc''''][''''comboResultado''''] != null ? valores[''''T018_AnalisisBc''''][''''comboResultado''''] : ''''default'''''),
        T_TIPO_DATA('T018_ScoringBc','valores[''''T018_ScoringBc''''][''''comboResultado''''] != null ? valores[''''T018_ScoringBc''''][''''comboResultado''''] : ''''default''''')
    );          
