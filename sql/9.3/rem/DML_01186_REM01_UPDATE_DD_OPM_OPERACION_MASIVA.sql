...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'REMVIP-12733';
...
BEGIN	
    ...
    LOOP
      ...
      V_MSQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TABLA||' WHERE DD_OPM_CODIGO = '''||V_TMP_FUNCION(1)||''' AND BORRADO = 0';
      EXECUTE IMMEDIATE V_MSQL INTO V_NUM_TABLAS;
        ...
        V_MSQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET
                DD_OPM_VALIDACION_FORMATO = '''||V_TMP_FUNCION(2)||''',
        ...
        EXECUTE IMMEDIATE V_MSQL;
			...
			ELSE
				DBMS_OUTPUT.PUT_LINE('[INFO] NO EXISTE LA OPERACION CON CODIGO '''||V_TMP_FUNCION(1)||'''');
