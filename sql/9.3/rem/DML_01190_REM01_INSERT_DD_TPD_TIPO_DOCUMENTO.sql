...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-12848';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Comunicación a Organismos: Vivienda Vacía','AI-02-COMU-BS','197'),
          T_JBV('Comunicación a Organismos: Gran Tenedor','AI-02-COMU-BT','198')
	); 
	V_TMP_JBV T_JBV;
