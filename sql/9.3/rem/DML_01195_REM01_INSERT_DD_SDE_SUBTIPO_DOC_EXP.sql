...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('91','Autorización Comisión API','10', 'OP-07-ACUE-61')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN
          DBMS_OUTPUT.PUT_LINE('[INFO]: REGISTRO CON CODIGO '||TRIM(V_TMP_TIPO_DATA(1))||' YA EXISTE. REVISA LOS CODIGOS');
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (
                      ...
                      , ''REMVIP-12538'',SYSDATE FROM DUAL';
