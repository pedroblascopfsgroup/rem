...
BEGIN
    ...
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.DD_TPD_TIPO_DOCUMENTO SET BORRADO = 1, USUARIOBORRAR = ''REMVIP-3593'', FECHABORRAR = SYSDATE WHERE DD_TPD_CODIGO = ''115''';
    ...
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''T013_ResolucionComite''''][''''comboResolucion''''] != DDResolucionComite.CODIGO_APRUEBA ? (valores[''''T013_ResolucionComite''''][''''comboResolucion''''] == DDResolucionComite.CODIGO_CONTRAOFERTA ? ((checkBankia() || checkLiberbank() || checkGiants()) ? null : existeAdjuntoUGValidacion("111","E")) : null) : resolucionComiteT013()'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_ResolucionComite''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''checkFechaEmisionInformeJuridico() ? mismoNumeroAdjuntosComoActivosExpedienteUGValidacion("93", "E") : "No todos los activos tienen fecha de emisión de informe en el listado de activos del expediente comercial." '', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_InformeJuridico''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''checkImporteParticipacion() ? (checkCompradores() ? (checkVendido() ? ''''El activo está vendido'''' : (checkComercializable() ? (checkPoliticaCorporativa() ? (checkCompradoresTienenNumeroUrsus() ?  (!esCajamar() ? (esLiberBank() ?  (mismoNumeroAdjuntosComoCompradoresExpedienteUGValidacion("37", "E", "01") == "" ? existeAdjuntoUGValidacion("97,E;91,E") : mismoNumeroAdjuntosComoCompradoresExpedienteUGValidacion("37", "E", "01")) : mismoNumeroAdjuntosComoCompradoresExpedienteUGValidacion("37", "E", "01")) : null) : ''''No todos los compradores tienen NºURSUS'''') : ''''El estado de la política corporativa no es el correcto para poder avanzar.'''') : ''''El activo debe ser comercializable'''') ) : ''''Los compradores deben sumar el 100%'''') : ''''El sumatorio de importes de participación de los activos ha de ser el mismo que el importe total del expediente'''''', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_InstruccionesReserva''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''!esLiberBank() ? existeAdjuntoUGValidacion("97,E;91,E") : null'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_ObtencionContratoReserva''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''existeAdjuntoUGValidacion("90,E") == "" ? valores[''''T013_ResolucionTanteo''''][''''comboEjerce''''] == DDSiNo.SI ? (checkEjercidoTanteo() ? null : ''''No existe ningún activo del expediente con tanteo Ejercido'''') : (checkRenunciaTanteo() ? null : ''''Existe algún activo del expediente sin tanteo Renuncia'''') : existeAdjuntoUGValidacion("90,E")'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_ResolucionTanteo''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''checkExpedienteBloqueado() ? (valores[''''T013_PosicionamientoYFirma''''][''''comboFirma''''] == DDSiNo.SI ? (checkPosicionamiento() ? existeAdjuntoUGValidacion("88,E") : ''''El expediente debe tener algún posicionamiento'''') : null) : ''''El expediente no está bloqueado'''''', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_PosicionamientoYFirma''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''existeAdjuntoUGValidacion("105,E;86,E")'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T013_DocumentosPostVenta''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''T014_ResolucionComiteExterno''''][''''comboResAprobada''''] == DDSiNo.SI ? (existeAdjuntoUGValidacion("95","E") == null ? existeAdjuntoUGCarteraValidacion("36", "E", "01") : existeAdjuntoUGValidacion("95","E")) : existeAdjuntoUGCarteraValidacion("36", "E", "01")'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T014_ResolucionComiteExterno''';    
    EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO SET TAP_SCRIPT_VALIDACION_JBPM = ''valores[''''T014_PosicionamientoFirma''''][''''comboFirma''''] == DDSiNo.SI ? existeAdjuntoUGValidacion("94","E") : null'', USUARIOMODIFICAR = ''REMVIP-3593'', FECHAMODIFICAR = SYSDATE WHERE TAP_CODIGO = ''T014_PosicionamientoFirma''';    
