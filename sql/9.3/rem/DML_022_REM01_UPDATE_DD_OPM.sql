...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AGAPA', 'Agrupaciones: Agrupar activos(Promoción Alquiler)', 'Agrupaciones: Agrupar activos (Promoción Alquiler)','MASIVO_AGRUPAR_ACTIVOS_PROMOCION_ALQUILER','nT*,s,n*,n*,s,s,s,s,s,s,s,i*,i*,i*')
    ); 
