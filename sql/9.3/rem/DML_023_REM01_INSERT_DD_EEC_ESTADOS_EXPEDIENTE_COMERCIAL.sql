--/*
--##########################################
--## AUTOR=Carlos Ruiz Beltran
--## FECHA_CREACION=20190423
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK= HREOS-6249
--## PRODUCTO=NO
--##
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('29'	,'Contraoferta denegada'					,'Contraoferta denegada')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAMOS EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.DD_EEC_EST_EXP_COMERCIAL '||
					...
					', USUARIOMODIFICAR = ''HREOS-6249'' , FECHAMODIFICAR = SYSDATE,  DD_EEC_VENTA = 1, DD_EEC_ALQUILER = 0'||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_EEC_EST_EXP_COMERCIAL (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''HREOS-6249'',SYSDATE,0, 1, 0  FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
