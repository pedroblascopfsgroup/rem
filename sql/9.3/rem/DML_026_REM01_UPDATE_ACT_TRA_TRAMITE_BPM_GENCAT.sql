...
BEGIN
	...
	EXECUTE IMMEDIATE 'MERGE
						...
						SET TEXT.TEX_TOKEN_ID_BPM = NULL, USUARIOMODIFICAR = ''REMVIP-4443'', FECHAMODIFICAR = SYSDATE';
	...
	EXECUTE IMMEDIATE 'MERGE
						...
						WHEN MATCHED THEN UPDATE
						SET TRA.TRA_PROCESS_BPM = NUL, USUARIOMODIFICAR = ''REMVIP-4443'', FECHAMODIFICAR = SYSDATE';
