...
--## INCIDENCIA_LINK=HREOS-6246
--## PRODUCTO=NO
--## 
--## Finalidad: Modificar la validación formato de las operaciones masivas CMOV y CMOA
--##            
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-6246';
...
BEGIN
	...
	V_SQL := 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET 
				...
				, DD_OPM_VALIDACION_FORMATO = ''nD*,s*,s,f*''
				WHERE DD_OPM_CODIGO = ''CMOV'' OR DD_OPM_CODIGO = ''CMOA''
				';
