...
BEGIN	
	...
	IF V_NUM_TABLAS > 0 THEN
		  ...
		  V_MSQL :=    'UPDATE '||V_ESQUEMA||'.GDE_GASTOS_DETALLE_ECONOMICO SET 
						GDE_IMPORTE_TOTAL= 
							(NVL(GDE_PRINCIPAL_SUJETO,0)+NVL(GDE_PRINCIPAL_NO_SUJETO,0)+NVL(GDE_RECARGO,0)+NVL(GDE_INTERES_DEMORA,0)+NVL(GDE_COSTAS,0)+NVL(GDE_OTROS_INCREMENTOS,0)+NVL(GDE_PROV_SUPLIDOS,0)),
