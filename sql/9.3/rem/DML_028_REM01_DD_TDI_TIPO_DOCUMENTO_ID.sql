...
DECLARE
	...
	ELSE
		V_MSQL:= 'UPDATE '||V_ESQUEMA||'.DD_TDI_TIPO_DOCUMENTO_ID SET DD_TDI_DESCRIPCION = ''TARJETA DE RESIDENTE'',DD_TDI_DESCRIPCION_LARGA=''TARJETA DE RESIDENTE'' WHERE DD_TDI_CODIGO=''03''';
