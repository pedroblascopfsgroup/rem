...
DECLARE
	...
	ELSE
		V_MSQL:= 'UPDATE '||V_ESQUEMA||'.DD_TDI_TIPO_DOCUMENTO_ID SET DD_TDI_DESCRIPCION = ''Tarjeta de residente'',DD_TDI_DESCRIPCION_LARGA=''TTarjeta de residente'' WHERE DD_TDI_CODIGO=''03''';
	...
	--RESUCITAMOS EL TIPO NIE
	V_MSQL:= 'UPDATE '||V_ESQUEMA||'.DD_TDI_TIPO_DOCUMENTO_ID SET BORRADO = 0 WHERE DD_TDI_CODIGO=''12''';
	EXECUTE IMMEDIATE V_MSQL;
