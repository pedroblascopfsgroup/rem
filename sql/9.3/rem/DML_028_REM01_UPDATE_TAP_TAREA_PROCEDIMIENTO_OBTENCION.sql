...
--## PRODUCTO=SI
--##
--## Finalidad: Actualizar T017_ObtencionContratoReserva
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
    ...
    V_TAP_CODIGO VARCHAR2(1024 CHAR):= 'T017_ObtencionContratoReserva';
    V_VALIDACION_JBPM VARCHAR2(2000 CHAR) := 'existeAdjuntoUGValidacion("06,E;12,E")';
