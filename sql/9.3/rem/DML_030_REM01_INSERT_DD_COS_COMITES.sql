...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('32', 'Haya', 'Haya', '11', '344')
		); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_COS_COMITES_SANCION (' ||
                      ...
                      '(SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(4))||'''), 0, ''HREOS-6791'',SYSDATE,0, '''||V_TMP_TIPO_DATA(5)||''' FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
