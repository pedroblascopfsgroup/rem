...
DECLARE
    ...
    V_TICKET VARCHAR2(100 CHAR) := 'REMVIP-4859';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('CAMBIAR_ESTADO_OFERTA_BANKIA')
    ); 
      			...
      			LOOP
					...
					ELSE
						V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.FUN_PEF' ||
							...
							' SELECT FUN.FUN_ID, PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, '''||V_TICKET||''', SYSDATE, 0' ||
