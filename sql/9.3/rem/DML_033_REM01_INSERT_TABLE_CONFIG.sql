...
DECLARE
    ...
    V_TICKET VARCHAR2(100 CHAR) := 'REMVIP-4813';

    TYPE T_FUNCION IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_FUNCION IS TABLE OF T_FUNCION;
    
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION('buzon.pfs','buzonpfs'),
		T_FUNCION('buzon.rem','buzonrem'),
		T_FUNCION('usuario.ficticio.oferta.cajamar','ficticioOfertaCajamar')
    ); 
