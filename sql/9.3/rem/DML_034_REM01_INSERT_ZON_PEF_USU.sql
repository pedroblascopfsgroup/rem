...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
	  T_FUNCION('ext.bcunningham',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.crenilla',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.drubio',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.gcalnan',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.ibastosmendes',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.jperezb',	'HAYAGRUPOCES'),
	  T_FUNCION('ext.mkelly',	'HAYAGRUPOCES')
