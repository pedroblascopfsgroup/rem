...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''REMVIP-4820'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
    ...
    --	TIPO_TARIFA_CODIGO		TIPO_TRABAJO_CODIGO		TIPO_SUBTRABAJO_CODIGO		CARTERA_CODIGO		SUBCARTERA_CODIGO			PRECIO_UNITARIO			UNIDAD_MEDIDA
		T_TIPO_DATA('AP-INF4',  '03',  '37', '07',  '138',  '21,65'  ,'€/ud')
    ); 
