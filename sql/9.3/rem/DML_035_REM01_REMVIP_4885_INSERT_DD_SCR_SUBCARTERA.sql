...
--## VERSIONES:
--##        0.1 Versión inicial
--##	    0.2 Se añade subcartera Omega Inmobiliario
--##########################################
--*/
...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-4885';
	...
	T_TIPO_DATA('65' ,'Omega - Inmobiliario','Omega - Inmobiliario','11')
