...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''HREOS-7164'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
...
BEGIN 
  ...
  LOOP
    ...
    EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
      ...
      V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' WHERE DD_'||V_TEXT_CHARS||'_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND DD_'||V_TEXT_CHARS||'_DESCRIPCION=''Haya''';
      EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
      IF V_NUM_TABLAS = 0 THEN
