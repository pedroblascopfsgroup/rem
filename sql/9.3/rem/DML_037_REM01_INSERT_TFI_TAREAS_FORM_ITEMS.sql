...
--## INCIDENCIA_LINK=HREOS-7063
--## PRODUCTO=NO
--##
--## Finalidad:	Insertar campos en T013_ResolucionComite para LIBERBANK
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-7063';
	V_TAP_CODIGO VARCHAR2(50 CHAR) := 'T013_ResolucionComite';
	
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
	TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('1', 'datefield',		'fechaRespuesta'		, 'Fecha de respuesta', 	 	'false',	'DDSiNo'),
		T_TIPO_DATA('2', 'numberfield', 	'importeTotalOfertaAgrupada'	, 'Importe total oferta agrupada', 	'',		''),
		T_TIPO_DATA('3', 'comboboxinicialedi',	'comboResolucion'		, 'Resolución', 	 		'false',	'DDResolucionComite'),
		T_TIPO_DATA('4', 'numberfield', 	'numImporteContra'		, 'Importe contraoferta', 		'', 		''),
		T_TIPO_DATA('5', 'combobox',		'comiteInternoSancionador'	, 'Comité sancionador', 		'', 		'DDCisComiteInternoSancionador'),
		T_TIPO_DATA('6', 'datefield',		'fechaReunionComite'		, 'Fecha reunión comité', 		'', 		''),
		T_TIPO_DATA('7', 'textfield',		'comitePropuesto'		, 'Comité propuesto', 			'', 		'DDComiteSancion'),
		T_TIPO_DATA('8', 'textarea',		'observaciones'			, 'Observaciones', 			'', 		'')
	); 
