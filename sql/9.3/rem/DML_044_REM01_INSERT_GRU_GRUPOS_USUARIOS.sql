...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-5092'; -- USUARIO CREAR/MODIFICAR
	...
	V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION( 'grusbackoffman' , 'lcarrillo'),
		T_FUNCION( 'grusbackoffman' , 'imartin'),
		T_FUNCION( 'gruscomman' , 'lcarrillo'),
		T_FUNCION( 'gruscomman' , 'imartin'),
		T_FUNCION( 'gruamvalman' , 'aferrandiz'),
		T_FUNCION( 'gruamvalman' , 'mjmagana')
	); 
