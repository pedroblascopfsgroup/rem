...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-5124'; -- USUARIO CREAR/MODIFICAR
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
   	  ...
   	  T_FUNCION( 'ogf03', 'ogf.cseijas'),  
	  T_FUNCION( 'ogf03', 'ogf.ctizon')
     ...
     FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      LOOP
      			...
      			IF V_NUM_REGISTRO < 1 THEN
      				DBMS_OUTPUT.PUT_LINE('[INFO] No existe usuario en en la tabla '||V_ESQUEMA_M||'.'||V_TABLA||' ...no se modifica nada.');
