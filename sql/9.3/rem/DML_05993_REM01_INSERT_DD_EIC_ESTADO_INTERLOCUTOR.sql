...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_EIC_ESTADO_INTERLOCUTOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('10',  'Activo',  'Activo'),
    	T_TIPO_DATA('20',  'Inactivo',  'Inactivo'),
    	T_TIPO_DATA('30',  'Solicitud de Alta',  'Solicitud de Alta'),
    	T_TIPO_DATA('40',  'Solicitud de Baja',  'Solicitud de Baja'),
    	T_TIPO_DATA('50',  'Solicitud Cambio % Compra', 'Solicitud Cambio % Compra')
    ); 
