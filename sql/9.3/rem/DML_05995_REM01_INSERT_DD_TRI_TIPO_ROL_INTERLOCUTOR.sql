...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TRI_TIPO_ROL_INTERLOCUTOR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('CRM000',  'cliente final',  'cliente final'),
    	T_TIPO_DATA('CRM011',  'Socio Comercial', 'Socio Comercial')
    ); 
