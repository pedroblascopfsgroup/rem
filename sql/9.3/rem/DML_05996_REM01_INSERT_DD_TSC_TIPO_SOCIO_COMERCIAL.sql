...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TSC_TIPO_SOCIO_COMERCIAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'TSC';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('ZAPI',  'API',  'API'),
    	T_TIPO_DATA('ZPRE',  'Prescriptor',  'Prescriptor'),
    	T_TIPO_DATA('ZNOT',  'Notaría',  'Notaría'),
    	T_TIPO_DATA('ZGES',  'Gestoría de Formalización',  'Gestoría de Formalización'),
    	T_TIPO_DATA('ZGAR',  'Garante', 'Garante')
    ); 
