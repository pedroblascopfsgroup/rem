...
--## PRODUCTO=NO
--##
--## Finalidad: Insert en tabla DD_ECC_ESTADO_COMUNICACION_C4C.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_ECC_ESTADO_COMUNICACION_C4C'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'ECC';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-14308';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('01',  'No enviado',  'No enviado'),
    	T_TIPO_DATA('02',  'Pte. validación',  'Pte. validación'),
    	T_TIPO_DATA('03',  'Bloqueo screening',  'Bloqueo screening'),
    	T_TIPO_DATA('04',  'Validado y bloqueado',  'Validado y bloqueado'),
    	T_TIPO_DATA('05',  'Validado', 'Validado')
    ); 
