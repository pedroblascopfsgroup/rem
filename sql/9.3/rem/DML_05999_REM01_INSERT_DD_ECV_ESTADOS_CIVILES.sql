...
DECLARE
    ...
    V_CODIGO_TABLA VARCHAR2(3 CHAR) := 'ECV';
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-14607';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('05',  'Separado',  'Separado'),
    	T_TIPO_DATA('06',  'Pareja de hecho', 'Pareja de hecho')
    ); 
