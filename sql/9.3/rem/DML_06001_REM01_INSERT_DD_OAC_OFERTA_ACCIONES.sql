...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-14619';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			                DESCRIPCION                               DESCRIPCION_LARGA   
      T_TIPO_DATA('997',			'Solicitud documentación mínima',			          'Solicitud documentación mínima'),
      T_TIPO_DATA('998',			'Confirmación Replicación Ofertas',		          'Confirmación Replicación Ofertas'),
      T_TIPO_DATA('999',			'Confirmación Replicación Interviniente',		    'Confirmación Replicación Interviniente')
