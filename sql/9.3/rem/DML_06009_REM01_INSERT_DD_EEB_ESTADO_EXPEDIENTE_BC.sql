...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-15245';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                -- CODIGO  			        DESCRIPCION                         DESCRIPCION_LARGA                 DD_EEB_VENTA  DD_EEB_ALQUILER
      T_TIPO_DATA('039',  'Pte. Screening y análisis BC', 'Pte. Screening y análisis BC', 0, 1),
      T_TIPO_DATA('040',  'Pte. CL/ROD', 'Pte. CL/ROD', 0, 1),
      T_TIPO_DATA('041',  'Pte. Análisis técnico', 'Pte. Análisis técnico', 0, 1),
      T_TIPO_DATA('042',  'Pte. Negociación', 'Pte. Negociación', 0, 1),
      T_TIPO_DATA('043',  'Pte. PBC Alquiler HRE', 'Pte. PBC Alquiler HRE', 0, 1),
      T_TIPO_DATA('044',  'Pte. Trasladar oferta al cliente', 'Pte. Trasladar oferta al cliente', 0, 1),
      T_TIPO_DATA('045',  'Pte. Agendar', 'Pte. Agendar', 0, 1)
    ); 
