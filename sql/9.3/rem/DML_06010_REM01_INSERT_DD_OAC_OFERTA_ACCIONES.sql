...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-15285';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			                DESCRIPCION                               DESCRIPCION_LARGA   
      T_TIPO_DATA('037',			'Pendiente Scoring',			          'Pendiente de Scoring'),
      T_TIPO_DATA('038',			'Pdte. Análisis Técnico',		          'Pendiente de Análisis Técnico'),
      T_TIPO_DATA('039',			'Pendiente Negociación',		          'Pendiente de Negociación'),
      T_TIPO_DATA('040',			'Pendiente CL/ROD',		                  'Pendiente de CL/ROD'),
      T_TIPO_DATA('041',			'Rechazo PBC',		                      'Rechazo PBC')
