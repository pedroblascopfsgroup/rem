...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15487';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T018_DefinicionOferta',
    		'(valores[''''T018_DefinicionOferta''''][''''tipoOfertaAlquiler''''] != DDSubtipoOfertaAlquiler.CODIGO_NOVACIONES && valores[''''T018_DefinicionOferta''''][''''tipoOfertaAlquiler''''] != DDSubtipoOfertaAlquiler.CODIGO_RENOVACIONES) ? null : existeExpedienteComercialByNumExpediente(valores[''''T018_DefinicionOferta''''][''''expedienteAnterior'''']) ? isExpedienteFirmado(valores[''''T018_DefinicionOferta''''][''''expedienteAnterior'''']) ? null : ''''El expediente anterior no tiene un contrato firmado'''' : ''''El expediente anterior no existe''''  ')
    ); 
