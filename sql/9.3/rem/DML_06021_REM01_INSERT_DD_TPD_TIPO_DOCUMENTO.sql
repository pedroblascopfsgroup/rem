...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'HREOS-15810';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Ficha Oferta','OP-29-FICH-53','176'),
          	  T_JBV('Estudio mercado','OP-29-ESIN-18','177'),
          	  T_JBV('Scoring de la operación','OP-29-ESIN-BP','178')
	); 
	V_TMP_JBV T_JBV;
