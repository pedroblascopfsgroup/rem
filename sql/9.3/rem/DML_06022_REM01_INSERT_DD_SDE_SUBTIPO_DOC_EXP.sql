...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('82'	,'Ficha Oferta' 	,'176', 'OP-29-FICH-53', '1', '06'),
    	T_TIPO_DATA('83'	,'Estudio mercado' 	,'177', 'OP-29-ESIN-18', '1', '06'),
    	T_TIPO_DATA('84'	,'Scoring de la operación' 	,'178', 'OP-29-ESIN-BP', '1', '06'),
    	T_TIPO_DATA('85'	,'Ficha Oferta' 	,'176', 'OP-29-FICH-53', '1', '09'),
    	T_TIPO_DATA('86'	,'Estudio mercado' 	,'177', 'OP-29-ESIN-18', '1', '09'),
    	T_TIPO_DATA('87'	,'Scoring de la operación' 	,'178', 'OP-29-ESIN-BP', '1', '09')
    ); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (DD_'||V_TEXT_CHARS||'_ID, DD_TDE_ID, 
                      ...
                      SELECT '|| V_ID || ', (SELECT DD_TDE_ID FROM DD_TDE_TIPO_DOC_EXP WHERE DD_TDE_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(6))||''')
