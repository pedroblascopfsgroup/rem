...
DECLARE
    ...
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'TFI'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
	  V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-15864';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T018_DefinicionOferta'		,'combobox', 	'4'		,'riesgoReputacional' ,'false' 	,'DDSiNo' ,'Riesgo reputacional:'),
    	T_TIPO_DATA('T018_DefinicionOferta'		,'combobox', 	'5'		,'conflictoIntereses' ,'false' 	,'DDSiNo'	,'Conflicto de intereses:'),
      T_TIPO_DATA('T018_DefinicionOferta'		,'textarea', 	'6'		,'observaciones'			,null 		,null			,'Observaciones')
    ); 
