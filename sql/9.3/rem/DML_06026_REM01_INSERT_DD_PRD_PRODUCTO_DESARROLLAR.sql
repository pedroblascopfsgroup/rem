...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_PRD_PRODUCTO_DESARROLLAR los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_PRD_PRODUCTO_DESARROLLAR'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'PRD'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('U39',' Residencial (viviendas protegidas)'),
      T_TIPO_DATA('U40','Residencial (viviendas libres de 1era Residencia)'),
      T_TIPO_DATA('U41','Residencial (viviendas libres de 2da Residencia)'),
      T_TIPO_DATA('U42','Oficinas'),
      T_TIPO_DATA('U43','Locales comerciales'),
      T_TIPO_DATA('U44','Uso Industria'),
