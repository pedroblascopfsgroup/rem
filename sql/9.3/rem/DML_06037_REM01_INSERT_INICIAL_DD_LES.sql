...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_LES_LISTA_ESTADO';
    V_CHARS VARCHAR2(3 CHAR):= 'LES';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-16840';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION
      T_TIPO_DATA('Z001', 'Prospect'),
      T_TIPO_DATA('Z002', 'Contactado'),
      T_TIPO_DATA('Z003', 'Servicio aceptado'),
      T_TIPO_DATA('Z004', 'Servicio finalizado'),
      T_TIPO_DATA('ZM01', 'Prospect mayorista'),
      T_TIPO_DATA('ZM02', 'No interesa'),
      T_TIPO_DATA('ZM03', 'Contactado mayorista'),
      T_TIPO_DATA('ZM04', 'Interesado mayorista'),
      T_TIPO_DATA('ZM05', 'Finalizado mayorista')
