...
DECLARE
    ...
    V_USUARIO VARCHAR2(250 CHAR) := 'REMVIP-10791';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --Codigo    Descripcion Corta   Descripcion Larga
      T_TIPO_DATA('53','20-No Publicación. Venta tras aprobacion - Proyecto TAS','20-No Publicación. Venta tras aprobacion - Proyecto TAS')
    ); 
