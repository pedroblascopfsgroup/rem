...
DECLARE
    ...
    V_USU VARCHAR2(25 CHAR):= 'HREOS-16757';

BEGIN	

    DBMS_OUTPUT.PUT_LINE('[INICIO] ');

    DBMS_OUTPUT.PUT_LINE('[INFO] MODIFICAMOS ACT_PVE_PROVEEDOR ');
    ...
    V_MSQL:= 'INSERT INTO '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR 
          ...
          SELECT
              ...
              , ''Caixa - Oficina '' || LPAD(COD_CAIXABANK, 5, ''0'') PVE_NOMBRE
              , ''Caixa - Oficina '' || LPAD(COD_CAIXABANK, 5, ''0'') PVE_NOMBRE_COMERCIAL
              ...
              , ''oficina_'' || LPAD(COD_CAIXABANK, 5, ''0'') || ''@dummycaixa.com'' PVE_EMAIL
              , 0 PVE_PAGINA_WEB
              , 0 PVE_FRANQUICIA
              , 0 PVE_IVA_CAJA
              , 0 VERSION
              ...
              , LPAD(COD_CAIXABANK, 5, ''0'') PVE_COD_API_PROVEEDOR
