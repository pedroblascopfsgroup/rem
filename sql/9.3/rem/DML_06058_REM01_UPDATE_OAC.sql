...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-18216';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			              DESCRIPCION                             DESCRIPCION_LARGA
      T_TIPO_DATA('993',			'Confirmación reposicionamiento PBC',			'Confirmación reposicionamiento PBC'),
      T_TIPO_DATA('996',			'Acción datos PBC',		                    'Acción datos PBC')
