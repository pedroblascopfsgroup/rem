...
DECLARE
    ...
    V_ID_ETP NUMBER(16);
    V_BOOLEAN NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'REMVIP-10988';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('JRD','appleofertas@haya.es'),
      T_TIPO_DATA('JRC','backup.rem@pfsgroup.es'),
      T_TIPO_DATA('JRC','appleofertas@haya.es'),
      T_TIPO_DATA('JRD','backup.rem@pfsgroup.es')
		); 
