...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-16986';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('048','Pte. cálculo riesgo HRE','Pte. cálculo riesgo HRE')
		...
		LOOP
			...
			ELSE
				...
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (
					DD_EEB_ID,DD_EEB_CODIGO, DD_EEB_DESCRIPCION,DD_EEB_DESCRIPCION_LARGA, DD_EEB_VENTA, DD_EEB_ALQUILER, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES(
