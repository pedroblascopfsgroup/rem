...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HHREOS-16816';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			                DESCRIPCION                               DESCRIPCION_LARGA   
		T_TIPO_DATA('Z35A', 'Z35', 'Representante adicional')
    ); 
      ...
      IF V_NUM_TABLAS > 0 THEN				
	    ...
	    USUARIOMODIFICAR = '''||V_USUARIO||''',
            FECHAMODIFICAR = SYSDATE
			    WHERE DD_'||V_CHARS||'_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(2))||'''';
      ...
      ELSE
        ...
        V_MSQL := '
          	INSERT INTO '|| V_ESQUEMA ||'.'||V_TABLA||' (
				DD_'||V_CHARS||'_ID, DD_'||V_CHARS||'_CODIGO, DD_'||V_CHARS||'_CODIGO_C4C, DD_'||V_CHARS||'_DESCRIPCION, DD_'||V_CHARS||'_DESCRIPCION_LARGA, 
