...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-16987';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('049','Pendiente sanción PBC Servicer','Pendiente sanción PBC Servicer', '480')
		...
		LOOP
			...
			ELSE
				...
				V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' (
					DD_EEB_ID,DD_EEB_CODIGO, DD_EEB_DESCRIPCION,DD_EEB_DESCRIPCION_LARGA, DD_EEB_VENTA, DD_EEB_ALQUILER, DD_EEB_CODIGO_C4C, VERSION, USUARIOCREAR, FECHACREAR, BORRADO) VALUES(
