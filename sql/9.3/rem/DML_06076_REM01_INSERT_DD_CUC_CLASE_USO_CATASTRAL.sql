...
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade en DD_CUC_CLASE_USO_CATASTRAL los datos añadidos en T_ARRAY_DATA.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_CUC_CLASE_USO_CATASTRAL'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'CUC'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('01','Urbana'),
      T_TIPO_DATA('02','Rústica')
    ); 
