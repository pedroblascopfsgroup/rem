...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-17333';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('187','01',NULL,'21'),
        T_TIPO_DATA('187','03','05','7'),
        T_TIPO_DATA('187','04','18','4'),
        T_TIPO_DATA('187','04','19','4')
        ); 
