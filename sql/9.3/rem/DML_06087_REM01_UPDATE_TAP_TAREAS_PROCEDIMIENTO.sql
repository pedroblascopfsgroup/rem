...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-11247';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T017_ResolucionDivarian','valores[''''T017_ResolucionDivarian''''][''''comboRespuesta''''] == DDApruebaDeniega.CODIGO_APRUEBA ? existeAdjuntoUGValidacion("23","E") : null'),
        T_TIPO_DATA('T017_ResolucionArrow','NULL'),
        T_TIPO_DATA('T017_RespuestaOfertanteCES','valores[''''T017_RespuestaOfertanteCES''''][''''comboRespuesta''''] == DDRespuestaOfertante.CODIGO_RECHAZA ? null : respuestaOfertanteT013(valores[''''T017_RespuestaOfertanteCES''''][''''importeOfertante''''])'),
        T_TIPO_DATA('T017_RespuestaOfertantePM','valores[''''T017_RespuestaOfertantePM''''][''''comboRespuesta''''] == DDRespuestaOfertante.CODIGO_RECHAZA ? null : respuestaOfertanteT013(valores[''''T017_RespuestaOfertantePM''''][''''importeOfertante''''])')
    );
