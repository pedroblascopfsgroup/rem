...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_TPB_TIPO_BLOQUEO
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_TPB_TIPO_BLOQUEO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'TPB';
	V_TIQUET VARCHAR2(2400 CHAR) := 'HREOS-17708';
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      	T_TIPO_DATA('CRA','Cartera'),
		T_TIPO_DATA('LN','Línea de negocio'),
		T_TIPO_DATA('PRV','Provincia'),
		T_TIPO_DATA('ESP','Especialidad')
    ); 
