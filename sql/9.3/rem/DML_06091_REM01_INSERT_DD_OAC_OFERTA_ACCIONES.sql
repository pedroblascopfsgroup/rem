...
--## INCIDENCIA_LINK=HREOS-17560
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade los datos del array en DD_OAC_OFERTA_ACCIONES
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_OAC_OFERTA_ACCIONES';
    V_CHARS VARCHAR2(3 CHAR):= 'OAC';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-17560';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			                DESCRIPCION                               DESCRIPCION_LARGA   
      T_TIPO_DATA('044',			'Ingresar Depósito',			          'Ingresar Depósito')
