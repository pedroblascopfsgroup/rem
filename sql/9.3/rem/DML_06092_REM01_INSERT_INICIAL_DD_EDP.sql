...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_EDP_EST_DEPOSITO';
    V_CHARS VARCHAR2(3 CHAR):= 'EDP';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-17564';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION     DESCRIPCION_LARGA
      T_TIPO_DATA('PIN',			'Pendiente de incautación',			                    'Pendiente de incautación'),
      T_TIPO_DATA('PDV',			'Pendiente de devolución',		                      'Pendiente de devolución'),
      T_TIPO_DATA('PDC',			'Pendiente de decisión devolución/incautación',		  'Pendiente de decisión devolución/incautación')
