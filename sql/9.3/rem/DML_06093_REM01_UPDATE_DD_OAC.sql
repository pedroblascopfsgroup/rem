...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-17565';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION     DESCRIPCION_LARGA
      T_TIPO_DATA('045',			'Devolver depósito',			    'Devolver depósito'),
      T_TIPO_DATA('046',			'Devolver inacutación',		    'Devolver inacutación'),
      T_TIPO_DATA('047',			'Devolución contabilizado',		'Devolución contabilizado'),
      T_TIPO_DATA('048',      'Devolución incautación',     'Devolución incautación')
