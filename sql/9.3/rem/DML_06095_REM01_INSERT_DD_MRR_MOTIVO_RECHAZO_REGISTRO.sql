...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-17628';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('F73','Formato númerico del campo ANYO_CONSTRUCCION incorrecto','Formato númerico del campo ANYO_CONSTRUCCION incorrecto',1,'WHERE 0 = IS_NUMERIC_WITHOUT_DECIMALS(AUX.ANYO_CONSTRUCCION)'),
        T_TIPO_DATA('F74','Formato númerico del campo IDEN_PL_PARKING incorrecto','Formato númerico del campo IDEN_PL_PARKING incorrecto',1,'WHERE 0 = IS_NUMERIC_WITHOUT_DECIMALS(AUX.IDEN_PL_PARKING)'),
        T_TIPO_DATA('F75','Formato númerico del campo IDEN_TRASTERO incorrecto','Formato númerico del campo IDEN_TRASTERO incorrecto',1,'WHERE 0 = IS_NUMERIC_WITHOUT_DECIMALS(AUX.IDEN_TRASTERO)')
    ); 
