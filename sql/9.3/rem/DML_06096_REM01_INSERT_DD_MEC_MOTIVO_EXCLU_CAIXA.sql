...
DECLARE
    ...
    V_ID NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'REMVIP-11574';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('19', 'Posible invendible'),
        T_TIPO_DATA('20', 'Inmueble dummy'),
        T_TIPO_DATA('21', 'Invendible'),
        T_TIPO_DATA('22', 'Posible destino reubicación'),
        T_TIPO_DATA('23', 'Posible ocupacion pdte IO/Denuncia')
		); 
