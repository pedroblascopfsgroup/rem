...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-11400';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T017_ResolucionPROManzana','valores["T017_ResolucionPROManzana"]["comboRespuesta"] == DDApruebaDeniega.CODIGO_APRUEBA ? existeAdjuntoUGValidacion("68","E") : null'),
        T_TIPO_DATA('T017_RespuestaOfertanteCES','valores[''''T017_RespuestaOfertanteCES''''][''''comboRespuesta''''] == DDRespuestaOfertante.CODIGO_ACEPTA ? respuestaOfertanteT013(valores[''''T017_RespuestaOfertanteCES''''][''''importeOfertante'''']) ? actualizarOfertaBoarding() : actualizarOfertaBoarding() : valores[''''T017_RespuestaOfertanteCES''''][''''comboRespuesta''''] == DDRespuestaOfertante.CODIGO_CONTRAOFERTA ? respuestaOfertanteT013(valores[''''T017_RespuestaOfertanteCES''''][''''importeOfertante'''']) : null
')
    );
