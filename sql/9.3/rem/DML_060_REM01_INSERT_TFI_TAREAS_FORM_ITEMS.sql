...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-5414';
	V_TAP_CODIGO VARCHAR2(50 CHAR) := 'T013_ResolucionComite';
	
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
	TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('5', 'combobox',		'comiteInternoSancionador'		, 'Comité interno sancionador', 			'', 		'DDCisComiteInternoSancionador'),
		T_TIPO_DATA('8', 'combobox',		'comiteSancionador'		, 'Comité sancionador', 			'', 		'DDComiteSancion'),
		T_TIPO_DATA('9', 'textarea',		'observaciones'		, 'observaciones', 			'', 		'')
	); 
