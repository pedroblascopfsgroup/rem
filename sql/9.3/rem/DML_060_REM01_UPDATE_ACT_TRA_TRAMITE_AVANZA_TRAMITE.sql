	...
	FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
		LOOP
			...
			IF V_NUM_TABLAS > 0 THEN
				...
				EXECUTE IMMEDIATE 'SELECT DD_COS_ID FROM '||V_ESQUEMA||'.DD_COS_COMITE_SANCION WHERE DD_COS_CODIGO = '''||V_TMP_FUNCION(2)||'''' INTO V_COS_ID;
				...
				REM01.AVANCE_TRAMITE('VRO',V_NUM_ECO,'T013_ResolucionComite',null,null,PL_OUTPUT);
