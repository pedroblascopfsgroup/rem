...
DECLARE
    ...
    V_USUARIO VARCHAR2(250 CHAR) := 'REMVIP-11682';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('56','30-Bloqueo Comercial - Proyecto TAS'),
      T_TIPO_DATA('57','No comercializar por exceso de producto en la zona.')
    ); 
