...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_SOR_SISTEMA_ORIGEN';
    V_CHARS VARCHAR2(3 CHAR):= 'SOR';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-11098';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            -- CODIGO  			DESCRIPCION     DESCRIPCION_LARGA
      T_TIPO_DATA('07',			'Minerva',			'Minerva')
    ); 
