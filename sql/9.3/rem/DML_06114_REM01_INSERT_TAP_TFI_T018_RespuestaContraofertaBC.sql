...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_RespuestaContraofertaBC', 'Respuesta contraoferta BC', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_RespuestaContraofertaBC'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Acepta contraoferta'),
		T_TIPO_DATA2('T018_RespuestaContraofertaBC'	,'datefield', 	'2'		,'fechaAlta' 				,'' 										,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_RespuestaContraofertaBC'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
