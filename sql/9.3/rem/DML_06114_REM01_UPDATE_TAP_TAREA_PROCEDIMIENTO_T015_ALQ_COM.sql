...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T015_AgendarFechaFirma', 'checkBankia() ? checkCuentasVirtualesAlquilerLibres() ? valores[''''T015_AgendarFechaFirma''''][''''ibanDev''''] != null  ? checkIBANValido(valores[''''T015_AgendarFechaFirma''''][''''ibanDev''''])  ? null  : ''''El formato del IBAN no es v&aacute;lido'''': null : ''''No existen cuentas virtuales libres'''' : null', 'checkBankia() ? valores[''''T015_AgendarFechaFirma''''][''''comboFianza''''] == DDSiNo.SI ? ''''AceptaFirma''''  : valores[''''T015_AgendarFechaFirma''''][''''comboFianza''''] == DDSiNo.NO ? ''''AceptaFianza''''  : null  : valores[''''T015_AgendarFechaFirma''''][''''comboResultado''''] == ''''01'''' ? ''''OK''''  : ''''Anulada'''''),
        T_TIPO_DATA('T015_Firma', '', 'checkBankia() ? valores[''''T015_Firma''''][''''comboFirma''''] == DDSiNo.SI ? ''''Firmado'''' : ''''Anulada'''' : null'),
        T_TIPO_DATA('T015_EntregaFianzas', '', 'checkBankia() ? valores[''''T015_EntregaFianzas''''][''''comboFianza''''] == DDSiNo.SI ? ''''FianzaOK''''  : valores[''''T015_EntregaFianzas''''][''''comboFianza''''] == DDSiNo.NO && getRespuestaHistReagendacionMayor() == true ? ''''ExoneradaMayor''''  : valores[''''T015_EntregaFianzas''''][''''comboFianza''''] == DDSiNo.NO && getRespuestaHistReagendacionMenor() == true ? ''''ExoneradaMenor''''  : null : null')
