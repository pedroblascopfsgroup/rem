...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_EntregaFianzas', 'Entrega fianzas', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_EntregaFianzas'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Fianza abonada'),
		T_TIPO_DATA2('T018_EntregaFianzas'	,'datefield', 	'2'		,'fechaAbono' 				,'' 										,'false'   ,null          	,'Fecha de abono'),
		T_TIPO_DATA2('T018_EntregaFianzas'	,'textarea', 	'3'		,'justificacion'	        ,''         								,null      ,null		    ,'Justificación'),
		T_TIPO_DATA2('T018_EntregaFianzas'	,'textarea', 	'4'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
