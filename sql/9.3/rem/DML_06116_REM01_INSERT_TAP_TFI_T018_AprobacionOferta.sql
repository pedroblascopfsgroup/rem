...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_AprobacionOferta', 'Aprobacion oferta', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_AprobacionOferta'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    				,'false'   ,'DDSiNo'	    ,'Condiciones pactadas aprobadas'),
        T_TIPO_DATA2('T018_AprobacionOferta'	,'combobox', 	'2'		,'comboAprobadoApi'	        ,'Debe indicar si se Aprueba o No'                  ,'false'   ,'DDSiNo'	    ,'Aprobación comunicada a API'),
        T_TIPO_DATA2('T018_AprobacionOferta'	,'combobox', 	'3'		,'comboBorradorContratoApi'	,'Debe indicar si se Aprueba o No'                  ,'false'   ,'DDSiNo'	    ,'Borrador de contrato enviado a API'),
		T_TIPO_DATA2('T018_AprobacionOferta'	,'combobox', 	'4'		,'comboClienteAcepBorr'	    ,'Debe indicar si se Aprueba o No'                  ,'false'   ,'DDSiNo'	    ,'Cliente acepta borrado'),
        T_TIPO_DATA2('T018_AprobacionOferta'	,'datefield', 	'5'		,'fecha'		        	,''                                                 ,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_AprobacionOferta'	,'textarea', 	'6'		,'justificacion'	        ,''                                                 ,null      ,null		    ,'Justificación'),
    	T_TIPO_DATA2('T018_AprobacionOferta'	,'textarea', 	'7'		,'observaciones'	        ,''                                                 ,null      ,null		    ,'Observaciones')
    ); 
