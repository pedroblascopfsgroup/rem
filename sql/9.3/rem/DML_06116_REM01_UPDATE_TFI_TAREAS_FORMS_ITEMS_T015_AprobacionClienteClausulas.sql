...
DECLARE
    ...
    V_TEXT_CHARS VARCHAR2(2400 CHAR) := 'TFI'; -- Vble. auxiliar para almacenar las 3 letras orientativas de la tabla de ref.
	  V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-18264';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T015_AprobacionClienteClausulas'	,'datefield', '2'		,'fechaFirma'		          ,''                                                 ,'false'   ,null          ,'Fecha aceptación'),
        T_TIPO_DATA('T015_AprobacionClienteClausulas'	,'combobox', 	'3'		,'comboBcRenegocia'	      ,'Debe indicar si se BC renegocia o No'             ,null      ,'DDSiNo'	    ,'BC va a renegociar'),
        T_TIPO_DATA('T015_AprobacionClienteClausulas'	,'textarea', 	'4'		,'justificacion'	        ,''                                                 ,null      ,null          ,'Justificación'),
    	  T_TIPO_DATA('T015_AprobacionClienteClausulas'	,'textarea', 	'5'		,'observaciones'	        ,''                                                 ,null      ,null		      ,'Observaciones')
    ); 
