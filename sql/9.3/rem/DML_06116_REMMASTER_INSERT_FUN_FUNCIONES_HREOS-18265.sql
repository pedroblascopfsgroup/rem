...
--## INCIDENCIA_LINK=HREOS-18265
--## PRODUCTO=NO
--##
--## Finalidad: Inserción nueva función FUN_AVANZAR_PBC.
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('Permite avanzar formalización alquiler comercial BC', 'FUNC_AVANZA_FORMALIZACION_ALQUILER_BC'),
      T_FUNCION('Permite avanzar formalización alquiler no comercial BC', 'FUNC_AVANZA_FORMALIZACION_ALQUILER_NC_BC')
    ); 
