...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_ComunicarSubrogacion', 'Comunicar Subrogacion', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_ComunicarSubrogacion'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    				,'false'   ,'DDSiNo'	    ,'Título obtenido'),
        T_TIPO_DATA2('T018_ComunicarSubrogacion'	,'combobox', 	'2'		,'comboComSubrogacion'	    ,'Debe indicar si se Aprueba o No'                  ,'false'   ,'DDSiNo'	    ,'Comunicada subrogación a arrendatario'),
		T_TIPO_DATA2('T018_ComunicarSubrogacion'	,'textarea', 	'3'		,'justificacion'	        ,''                                                 ,null      ,null		    ,'Justificación'),
    	T_TIPO_DATA2('T018_ComunicarSubrogacion'	,'textarea', 	'4'		,'observaciones'	        ,''                                                 ,null      ,null		    ,'Observaciones')
    ); 
