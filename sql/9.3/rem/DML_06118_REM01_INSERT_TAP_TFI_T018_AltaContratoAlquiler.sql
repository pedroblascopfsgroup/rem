...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_AltaContratoAlquiler', 'Alta contrato alquiler', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_AltaContratoAlquiler'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    				,'false'   ,'DDSiNo'	    ,'Dado de alta'),
		T_TIPO_DATA2('T018_AltaContratoAlquiler'	,'datefield', 	'2'		,'fecha'		        	,''                                                 ,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_AltaContratoAlquiler'	,'textarea', 	'3'		,'justificacion'	        ,''                                                 ,null      ,null		    ,'Justificación'),
    	T_TIPO_DATA2('T018_AltaContratoAlquiler'	,'textarea', 	'4'		,'observaciones'	        ,''                                                 ,null      ,null		    ,'Observaciones')
    ); 
