...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('CMEG', 'Carga masiva cambio de estados de gastos', 'Carga masiva cambio de estados de gastos','CARGA_MASIVA_CAMBIO_ESTADO_GASTO','nD*,s*,s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-18339'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
