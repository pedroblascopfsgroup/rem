...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_AprobacionContrato', 'Aprobacion contrato', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_AprobacionContrato'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    				,'false'   ,'DDSiNo'	    ,'Contrato aprobado'),
		T_TIPO_DATA2('T018_AprobacionContrato'	,'datefield', 	'2'		,'fechaAprobacion'       	,''                                                 ,'false'   ,null          	,'Fecha aprobación'),
		T_TIPO_DATA2('T018_AprobacionContrato'	,'combobox', 	'3'		,'comboTipoAdenda'	        ,''									 				,'false'   ,'DDTipoAdenda'  ,'Tipo de adenda'),
		T_TIPO_DATA2('T018_AprobacionContrato'	,'textarea', 	'4'		,'justificacion'	        ,''                                                 ,null      ,null		    ,'Justificación'),
    	T_TIPO_DATA2('T018_AprobacionContrato'	,'textarea', 	'5'		,'observaciones'	        ,''                                                 ,null      ,null		    ,'Observaciones')
    ); 
