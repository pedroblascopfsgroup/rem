...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T015_NegociacionClausulasAlquiler'	,'datefield', '2'		,'fecha'		              ,''                                                 ,'false'   ,null          ,'Fecha'),
        T_TIPO_DATA('T015_NegociacionClausulasAlquiler'	,'textarea', 	'3'		,'justificacion'	        ,''                                                 ,null      ,null          ,'Justificación'),
    	  T_TIPO_DATA('T015_NegociacionClausulasAlquiler'	,'textarea', 	'4'		,'observaciones'	        ,''                                                 ,null      ,null		      ,'Observaciones')
    ); 
