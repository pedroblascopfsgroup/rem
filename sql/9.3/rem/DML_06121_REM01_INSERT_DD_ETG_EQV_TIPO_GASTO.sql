...
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial  [REMVIP-11840] - Juan Bautista Alfonso
--#########################################
--*/
...
DECLARE
    ...
    M_TABLA T_ARRAY_TABLA := T_ARRAY_TABLA(															
      --DD_ETG_CODIGO  Elemento PEP	CLASE/GRUPO	  TIPO	SUBTIPO	DD_TGA_CODIGO	DD_STG_CODIGO	PRO_SOCIEDAD_PAGADORA  EJE_ANYO
		--BH
		T_TABLA('1115','XXXX-21-1-COM','2','2','1','05','131','3148','2021'),
		--BANKIA
		T_TABLA('1116','XXXX-21-1-COM','2','2','1','05','131','null','2021')
    ); 
    V_TMP_TABLA T_TABLA;
