...
DECLARE
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_AltaContratoAlquilerAdenda'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Dado de alta'),
		T_TIPO_DATA2('T018_AltaContratoAlquilerAdenda'	,'datefield', 	'2'		,'fechaAlta' 				,'' 										,'false'   ,null          	,'Fecha alta'),
    	T_TIPO_DATA2('T018_AltaContratoAlquilerAdenda'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
