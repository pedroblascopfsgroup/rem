...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('T015_RespuestaBcReagendacion'	,'combobox'   ,'1'		,'comboReagendacion'	          ,'Debe indicar si se Aprueba o No'                  ,'false'   ,'DDSiNo'	    ,'Reagendación'),
    	  T_TIPO_DATA('T015_RespuestaBcReagendacion'	,'textarea'   ,'2'		,'observaciones'	              ,''                                                 ,null      ,null		      ,'Observaciones')
    ); 
