...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_FirmaAdenda', 'Firma adenda', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_FirmaAdenda'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Adenda firmada'),
		T_TIPO_DATA2('T018_FirmaAdenda'	,'textarea', 	'2'		,'justificacion'	        ,''         								,null      ,null		    ,'Justificación'),
    	T_TIPO_DATA2('T018_FirmaAdenda'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
