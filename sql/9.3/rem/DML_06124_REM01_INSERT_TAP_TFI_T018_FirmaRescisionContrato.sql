...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_FirmaRescisionContrato', 'Firma rescision contrato', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_FirmaRescisionContrato'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Firmado'),
		T_TIPO_DATA2('T018_FirmaRescisionContrato'	,'datefield', 	'2'		,'fechaFirma' 				,'' 										,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_FirmaRescisionContrato'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
