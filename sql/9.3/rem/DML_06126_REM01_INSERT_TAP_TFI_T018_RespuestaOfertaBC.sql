...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_RespuestaOfertaBC', 'Respuesta oferta BC', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_RespuestaOfertaBC'	,'combobox', 	'1'		,'comboResultado'	        ,'Debe indicar si se Aprueba o No'    		,'false'   ,'DDSiNo'	    ,'Realiza oferta alquiler'),
		T_TIPO_DATA2('T018_RespuestaOfertaBC'	,'datefield', 	'2'		,'fecha' 					,'' 										,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_RespuestaOfertaBC'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
