...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_FirmaContrato', 'Firma Contrato', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_FirmaContrato'	,'datefield', 	'2'		,'fechaFirma' 				,'' 										,'false'   ,null          	,'Fecha'),
		T_TIPO_DATA2('T018_FirmaContrato'	,'textarea', 	'3'		,'observaciones'	        ,''        									,null      ,null		    ,'Observaciones')
    ); 
