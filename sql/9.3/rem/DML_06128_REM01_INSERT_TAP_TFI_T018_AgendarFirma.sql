...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_AgendarFirma', 'Agendar Firma', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
        ...
        T_TIPO_DATA2('T018_AgendarFirma'	,'textarea'     ,'8'	,'justificacion'	        ,''                                         ,null      ,null            ,'Justificación'),
    	T_TIPO_DATA2('T018_AgendarFirma'	,'textarea'     ,'9'	,'observaciones'	        ,''                                         ,null      ,null            ,'Observaciones')
    ); 
