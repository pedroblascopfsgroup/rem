...
DECLARE
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		...
		T_TIPO_DATA2('T018_DecisionContinuidadOferta'	,'combobox'		,'1'	,'seguirOferta'	        	,'Debe indicar si se sigue con la oferta o No'    		,'false'   ,'DDSiNo'	    ,'Seguir con la oferta'),
        T_TIPO_DATA2('T018_DecisionContinuidadOferta'	,'textarea'     ,'2'	,'justificacion'	        ,''                                        				,'false'   ,null            ,'Justificación')
        );
