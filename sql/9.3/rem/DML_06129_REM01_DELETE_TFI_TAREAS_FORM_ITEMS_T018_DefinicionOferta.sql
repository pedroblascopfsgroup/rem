...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-18858';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(800);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T018_DefinicionOferta','textfield','3','expedienteAnterior')
    ); 
...
DBMS_OUTPUT.PUT_LINE('[INICIO]');
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: DELETE EN '||V_TEXT_TABLA);
