...
DECLARE
    ...
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'CCA';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('Contrato alquiler vivienda','Z101'),
      T_TIPO_DATA('Contrato alquiler uso distinto vivienda','Z102'),
      T_TIPO_DATA('Contrato alquiler rústico','Z103'),
      T_TIPO_DATA('Contrato cesión derecho vuelo', 'Z104'),
      T_TIPO_DATA('Contrato comodato', 'Z105'),
      T_TIPO_DATA('Contrato cesión derecho superficie', 'Z106'),
      T_TIPO_DATA('Contrato alquiler opción compra', 'Z107'),
      T_TIPO_DATA('Contrato alquiler por Ley', 'Z108'),
      T_TIPO_DATA('Contrato usufructo', 'Z110'),
      T_TIPO_DATA('Contrato subarriendo', 'Z111'),
      T_TIPO_DATA('Contrato explotación', 'Z112'),
      T_TIPO_DATA('Contrato alquiler Código Buenas Prácticas', 'Z113'),
      T_TIPO_DATA('Contrato cesión de uso', 'Z114')
    );
