...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_CCD_CLASE_CONDICION
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_CCD_CLASE_CONDICION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'CCD';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('Alta fianza heredada Sin justificante','101'),
      T_TIPO_DATA('Alta fianza heredada Con justificante','111'),
      T_TIPO_DATA('Alta fianza propietario Subrogación','121'),
      T_TIPO_DATA('Alta depósito Subrogado','131'),
      T_TIPO_DATA('Alta propietario depósito Subrogado', '141')
    );
