...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_DAR_DERECHO_ARRENDAMIENTO
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_DAR_DERECHO_ARRENDAMIENTO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'DAR';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('00122 RD Ley 1/2022','101'),
      T_TIPO_DATA('00416 RD Ley 4/2016','111'),
      T_TIPO_DATA('00517 RD Ley 5/2017','121'),
      T_TIPO_DATA('00612 RD Ley 6/2012', '131'),
      T_TIPO_DATA('01719 RD Ley 17/2019', '141'),
      T_TIPO_DATA('02415 RD Ley 14/2015', '151')
    );
