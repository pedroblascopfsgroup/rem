...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_MEF_MOTIVO_EXONERACION_FIANZA
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MEF_MOTIVO_EXONERACION_FIANZA'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'MEF';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('Por decisión de la propiedad','101'),
      T_TIPO_DATA('Por el objeto','111'),
      T_TIPO_DATA('Por naturaleza de la parte arrendataria','121'),
      T_TIPO_DATA('Por origen subrogado', '131')
    );
