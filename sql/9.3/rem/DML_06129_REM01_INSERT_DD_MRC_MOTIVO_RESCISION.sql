...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_MRC_MOTIVO_RESCISION
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MRC_MOTIVO_RESCISION'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'MRC';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('Morosidad:Entrega Voluntaria','101'),
      T_TIPO_DATA('Vencimiento:entrega voluntaria','111'),
      T_TIPO_DATA('Libre:entrega voluntaria','121'),
      T_TIPO_DATA('Morosidad:proceso judicial', '131'),
      T_TIPO_DATA('Vencimiento:proceso judicial', '141'),
      T_TIPO_DATA('Lanzamiento judicial', '151'),
      T_TIPO_DATA('Morosidad:nuevo contrato', '161'),
      T_TIPO_DATA('Venta inmueble inquilino', '171'),
      T_TIPO_DATA('Venta inmueble tercero', '181'),
      T_TIPO_DATA('Cambio de sociedad en activo', '191'),
      T_TIPO_DATA('Rescisión por renovación', '201'),
      T_TIPO_DATA('Proceso - Asignación erronea', '211'),
      T_TIPO_DATA('Otros - Fin de contrato', '221')
    );
