...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'REMVIP-12495';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('F79','Formato numérico del campo NUM_INMUEBLE incorrecto','Formato numérico del campo NUM_INMUEBLE incorrecto',1,'WHERE 0 = ISNUMERIC(AUX.NUM_INMUEBLE)'),
        T_TIPO_DATA('F80','Formato numérico del campo NUM_INMUEBLE_ANTERIOR incorrecto','Formato numérico del campo NUM_INMUEBLE_ANTERIOR incorrecto',1,'WHERE 0 = ISNUMERIC(AUX.NUM_INMUEBLE_ANTERIOR)')
    ); 
