...
--## PRODUCTO=NO
--## Finalidad: Inserción diccionario DD_RIM_RETENCIONES_IMPUESTOS
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_RIM_RETENCIONES_IMPUESTOS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    V_CLAVE_DICCIONARIO VARCHAR2(25 CHAR):= 'RIM';

    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('Ret. Ingresos por Arrendamientos 19%', 'Z1')
    );
