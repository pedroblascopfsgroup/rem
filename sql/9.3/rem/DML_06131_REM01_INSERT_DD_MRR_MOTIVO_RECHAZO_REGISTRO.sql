...
DECLARE
    ...
    V_USUARIO VARCHAR2(25 CHAR):= 'REMVIP-12679';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('F81','Tiene informado NUM_UNIDAD por lo que es UA','Tiene informado NUM_UNIDAD por lo que es UA',1,'WHERE AUX.NUM_UNIDAD IS NOT NULL')
    ); 
