...
--## PRODUCTO=NO
--## Finalidad: Ampliar la tabla FIA_FIANZAS
--##           
...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'FIA_FIANZAS'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
    ...
    V_ALTER T_ARRAY_ALTER := T_ARRAY_ALTER(
		...
		T_ALTER('ENTREGA_FIANZA_AAPP',			'NUMBER(1,0)',					'Entrega fianza AAPP'	)
