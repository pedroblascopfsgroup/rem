...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	-- Registros a borrar
	    T_TIPO_DATA('T015_AgendarFechaFirma','combobox','comboResultado'),
	    T_TIPO_DATA('T015_AgendarFechaFirma','datefield','fechaFin'),
	    T_TIPO_DATA('T015_AgendarFechaFirma','datefield','fechaInicio'),
