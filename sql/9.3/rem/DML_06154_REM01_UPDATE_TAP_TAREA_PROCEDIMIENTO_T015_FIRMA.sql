...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_Firma', '(valores[''''T015_CalculoRiesgo''''][''''comboRiesgo''''] == DDRiesgoOperacion.CODIGO_ROP_MEDIO || valores[''''T015_CalculoRiesgo''''][''''comboRiesgo''''] == DDRiesgoOperacion.CODIGO_ROP_BAJO) ? ''''RiesgoMedioBajo'''' : valores[''''T015_CalculoRiesgo''''][''''comboRiesgo''''] == DDRiesgoOperacion.CODIGO_ROP_NO_APLICA ? ''''NoAplica'''' : ''''RiesgoAlto'''' ')
    ); 
