...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_Firma', 'checkBankia() == true ? null : checkContratoSubido() ? null : checkConOpcionCompra() ? ''''Es necesario adjuntar sobre el Expediente Comercial, el documento Contrato con opción a compra.'''': ''''Es necesario adjuntar sobre el Expediente Comercial, el documento Contrato.''''')
    ); 
