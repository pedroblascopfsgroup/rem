...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-18737';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_EsperaComitePosesiones', 'Espera comité posesiones', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
    	...
    	T_TIPO_DATA2('T018_EsperaComitePosesiones'    	,'label'		,'0'	,'titulo'					,'<p style="margin-bottom:10px">Instrucciones por defecto de la tarea ''''Espera comité posesiones'''' </p>'		    					,null		,null),
   		T_TIPO_DATA2('T018_EsperaComitePosesiones'		,'combobox'		,'1'	,'aprueba'	        		,'Aprueba'    																																,'false'   	,'DDSiNo'),
   		T_TIPO_DATA2('T018_EsperaComitePosesiones'		,'textarea'     ,'2'	,'justificacion'	        ,'Jusificación'                                       																						,null   	,null)
     ); 
