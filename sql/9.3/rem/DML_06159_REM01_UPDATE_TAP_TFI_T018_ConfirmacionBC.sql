...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('T018_ConfirmacionBC', 'Confirmación BC', '', '', '')
    ); 
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
    	...
    	T_TIPO_DATA2('T018_ConfirmacionBC'    	,'label'		,'0'	,'titulo'					,'<p style="margin-bottom:10px">Instrucciones por defecto de la tarea ''''Confirmación BC'''' </p>'		    								,null		,null),
   		T_TIPO_DATA2('T018_ConfirmacionBC'		,'combobox'		,'1'	,'confirma'	        		,'Confirma'    																																,'false'   	,'DDSiNo'),
   		T_TIPO_DATA2('T018_ConfirmacionBC'		,'datefield'    ,'2'	,'fecha'	        		,'Fecha'                                       																								,'false'   	,null)
     ); 
