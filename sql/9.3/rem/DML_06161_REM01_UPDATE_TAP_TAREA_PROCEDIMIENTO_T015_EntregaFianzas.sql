...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T015_EntregaFianzas', 'checkBankia() ? valores[''''T015_EntregaFianzas''''][''''comboFianza''''] == DDSiNo.SI ? ''''FianzaOK''''  : valores[''''T015_EntregaFianzas''''][''''comboFianza''''] == DDSiNo.NO && seHaReagendado2VecesOMas() == true ? ''''ExoneradaMayor''''  :  ''''ExoneradaMenor''''  : null ')
    ); 
