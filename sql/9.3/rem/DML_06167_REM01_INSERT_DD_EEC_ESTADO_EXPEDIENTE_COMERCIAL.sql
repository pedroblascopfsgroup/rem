...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('66', '0', '1', 'Pte. Comité'),
        T_TIPO_DATA('67', '0', '1', 'Pte. Proponer rescisión'),
        T_TIPO_DATA('68', '0', '1', 'Pte. Firma rescisión')
	); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_EEC_EST_EXP_COMERCIAL (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(4))||''','''||TRIM(V_TMP_TIPO_DATA(4))||''', 0, ''HREOS-18888'',SYSDATE,0, '''||TRIM(V_TMP_TIPO_DATA(2))||''', '''||TRIM(V_TMP_TIPO_DATA(3))||'''  FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
