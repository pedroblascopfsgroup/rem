...
DECLARE
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
      	...
      	T_TIPO_DATA2('T018_FirmaContrato'	,'combobox'		,'1'	,'comboResultado' 			,'Debe indicar si se Aprueba o No' 			,'false'   ,'DDSiNo'         ,'Firmado'),
		T_TIPO_DATA2('T018_FirmaContrato'	,'datefield'	,'2'	,'fechaFirma' 				,'' 										,null      ,null          	 ,'Fecha'),
		T_TIPO_DATA2('T018_FirmaContrato'	,'datefield'	,'3'	,'fechaInicioAlquiler'	    ,'Debe indicar una fecha de inicio'    		,'false'   ,null	    	 ,'Fecha inicio alquiler'),
		T_TIPO_DATA2('T018_FirmaContrato'	,'datefield'    ,'4'	,'fechaFinAlquiler'    		,'Debe indicar una fecha de fin'            ,'false'   ,null             ,'Fecha fin alquiler'),
		T_TIPO_DATA2('T018_FirmaContrato'	,'textarea'     ,'5'	,'observaciones'    		,''                   						,null      ,null             ,'Observaciones')
