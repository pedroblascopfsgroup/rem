...
DECLARE
    ...
    V_TIPO_DATA2 T_ARRAY_DATA2 := T_ARRAY_DATA2(
		T_TIPO_DATA2('T018_RespuestaReagendacionBC'	,'combobox'    ,'2'		,'comboComite' 		,''       ,null   	,null	  ,'Ir a comité'),
		T_TIPO_DATA2('T018_RespuestaReagendacionBC'	,'textarea'    ,'3'		,'observaciones'	,''       ,null     ,null     ,'Observaciones')
    ); 
