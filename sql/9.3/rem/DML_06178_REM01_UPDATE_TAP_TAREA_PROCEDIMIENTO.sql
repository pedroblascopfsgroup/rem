...
--##########################################
--## AUTOR=Alvaro Valero
--## FECHA_CREACION=20221112
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-18997
--## PRODUCTO=NO
--##
--## Finalidad:
--## INSTRUCCIONES: 
...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-18997';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        ...
        T_TIPO_DATA('T015_AgendarFechaFirma', 'valores[''''T015_AgendarFechaFirma''''][''''comboFianza''''] == DDSiNo.SI ? ''''AceptaFirma'''' : ''''AceptaFianza''''')
    ); 
