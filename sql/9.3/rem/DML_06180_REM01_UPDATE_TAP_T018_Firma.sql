...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('T018_RespuestaReagendacionBC','(checkBankia() == true && checkExpedienteBloqueadoPorFuncion() == true) ? ''''El expediente est&aacute; bloqueado'''' : estaPermitidoClaseCondicion()  ? null  : ''''Clase condicion solo puede tener el valor no aplica para este tipo de alquiler''''')
    ); 
