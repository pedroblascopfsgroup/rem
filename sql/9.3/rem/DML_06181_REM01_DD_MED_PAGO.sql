...
DECLARE
    ...
    V_TEXT_TABLA VARCHAR2(2400 CHAR) := 'DD_MEP_MEDIO_PAGO'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
	V_LETRAS_TABLA VARCHAR2(2400 CHAR) := 'MEP';
	V_TIQUET VARCHAR2(2400 CHAR) := 'HREOS-18888';
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      	T_TIPO_DATA('3','30','Domiciliación')
    ); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.'||V_TEXT_TABLA||' 
					WHERE DD_'||V_LETRAS_TABLA||'_CODIGO_PBC = '''||TRIM(V_TMP_TIPO_DATA(1))||''' AND BORRADO = 0';
        ...
        ELSE 
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: El valor '''||TRIM(V_TMP_TIPO_DATA(1))||''' no existe');
            ...
            V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (
              ...
              DD_'||V_LETRAS_TABLA||'_CODIGO_PBC,
			  DD_'||V_LETRAS_TABLA||'_CODIGO_BC,
