...
DECLARE
    ...
    V_USU_MODIFICAR VARCHAR2(30 CHAR) := '''REMVIP-12774'''; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
...
BEGIN 
  ...
  LOOP
    ...
    EXECUTE IMMEDIATE V_SQL INTO V_NUM_TABLAS;
      ...
      DBMS_OUTPUT.PUT_LINE('[INFO]: REGISTRO '''||TRIM(V_TMP_TIPO_DATA(1))||''' MODIFICADO CORRECTAMENTE');

       ELSE
        DBMS_OUTPUT.PUT_LINE('[WARN]: YA EXISTE EL REGISTRO '''||TRIM(V_TMP_TIPO_DATA(1))||'''');
