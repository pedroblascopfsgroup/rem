...
--## INCIDENCIA_LINK=REMVIP-12922
--## PRODUCTO=NO
--## 
--## Finalidad: Actualizacion registros 
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial - [REMVIP-12922]- Juan Bautista Alfonso
--#########################################
--*/
...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-12922';
...
T_TABLA('UPDATE','01','01','2','1','1','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','01','02','2','1','9','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
--##
T_TABLA('UPDATE','01','06','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','08','2','1','2','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','09','2','1','3','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','10','2','1','4','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','11','2','1','7','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','12','2','1','8','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','13','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','14','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','15','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','17','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','02','18','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','03','19','2','1','5','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','03','20','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','04','21','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','04','22','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','04','23','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','04','24','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','04','25','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI'),
T_TABLA('UPDATE','14','65','2','1','6','22','00','07','2021','B46644290','OX-3148-22-2-IBI')
