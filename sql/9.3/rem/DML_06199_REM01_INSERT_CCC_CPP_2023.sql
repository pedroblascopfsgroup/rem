...
--## FECHA_CREACION=20220103
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=REMVIP-13067
--## PRODUCTO=NO
--##
--## Finalidad: Script que añade cuentas y partidas presupuestarias de 2023 copiando las de 2022
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USR VARCHAR2(400 CHAR):= 'REMVIP-13067';
    V_TEXT1 VARCHAR2(2400 CHAR); -- Vble. auxiliar
    V_ENTIDAD_ID NUMBER(16);
    V_ID NUMBER(16);
    V_ANYO VARCHAR2(200 CHAR):='2023';
    V_ANYO_ANT VARCHAR2(200 CHAR):='2022';
    HORA_INI TIMESTAMP;
    HORA_FIN TIMESTAMP;
...
BEGIN   
        ...
        DBMS_OUTPUT.PUT_LINE('[INFO]: INICIO: '||HORA_INI||'');
...
WHERE CCC.BORRADO = 0 AND eje2.eje_anyo='''||V_ANYO_ANT||'''
	...
	EXECUTE IMMEDIATE V_MSQL;
	    ...
	    HORA_FIN := SYSTIMESTAMP;
                DBMS_OUTPUT.PUT_LINE('[FIN]: Ha finalizado la ejecicion '||HORA_FIN||' ');  
