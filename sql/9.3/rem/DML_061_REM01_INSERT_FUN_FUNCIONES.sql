...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-7997'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DE LA FUNCION
    V_FUN_CODIGO VARCHAR2(50) := 'MASIVO_DOCUMENTACION_ADMINISTRATIVA';
    V_FUN_DESCRIPCION VARCHAR2(255) := 'Permitir seleccionar el procesado de carga masiva de documentación de administrativa';
