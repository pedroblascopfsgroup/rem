...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('152'	,'Recepcion convocatoria'		,'Recepcion convocatoria'		,'AI-12-ACTR-13'),
    	T_TIPO_DATA('153'	,'Asamblea y/o consejo: acta'		,'Asamblea y/o consejo: acta'		,'AI-12-ACTR-01')
    ); 
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: MODIFICAR EL REGISTRO '''|| TRIM(V_TMP_TIPO_DATA(1)) ||'''');
       	  V_MSQL := 'UPDATE '|| V_ESQUEMA ||'.'||V_TEXT_TABLA||' '||
					...
					', USUARIOMODIFICAR = ''HREOS-7756'' , FECHAMODIFICAR = SYSDATE, DD_'||V_TEXT_CHARS||'_VISIBLE = 0'||
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' (' ||
                      ...
                      'SELECT '|| V_ID || ',  '''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', '''||TRIM(V_TMP_TIPO_DATA(4))||''', 0, 0, ''HREOS-7756'',SYSDATE,0 '||
					  ' FROM DUAL';
