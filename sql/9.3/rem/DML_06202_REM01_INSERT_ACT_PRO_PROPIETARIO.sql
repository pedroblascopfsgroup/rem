...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-12966'; --Vble. auxiliar para almacenar el usuario
    V_TABLA VARCHAR2(100 CHAR) :='ACT_PRO_PROPIETARIO'; --Vble. auxiliar para almacenar la tabla a insertar
    V_PRO_DOCIDENTIF VARCHAR2(100 CHAR):='E16731531';
    V_COUNT NUMBER(16) :=0;
