...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('MSDOCADM', 'Carga masiva documentación administrativa', 'Carga masiva documentación administrativa','MASIVO_DOCUMENTACION_ADMINISTRATIVA','s*, n*, n*, s, f, f, f, f, f, s, n')
    ); 
