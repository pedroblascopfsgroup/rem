...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('MASIVO_DOCUMENTACION_ADMINISTRATIVA', 'plantillas/plugin/masivo/MASIVO_DOCUMENTACION_ADMINISTRATIVA.xls', 'MSDOCADM')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.POP_PLANTILLAS_OPERACION' ||
							...
							' 0, ''HREOS-7997'', SYSDATE, 0 FROM DUAL';
