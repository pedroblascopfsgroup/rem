...
--## PRODUCTO=NO
--##
--## FINALIDAD: Script que añade una función a la tabla FUN_FUNCIONES y la relaciona con un perfil
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-8172'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DE LA FUNCION
    V_FUN_CODIGO VARCHAR2(50) := 'CARGA_MASIVA_INSCRIPCIONES';
    V_FUN_DESCRIPCION VARCHAR2(255) := 'Carga masiva de inscripciones';
