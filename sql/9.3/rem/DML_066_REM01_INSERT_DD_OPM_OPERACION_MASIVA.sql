...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('CMIN', 'Carga masiva de inscripciones', 'Carga masiva de inscripciones','CARGA_MASIVA_INSCRIPCIONES','n*,s,s,s,s,s,s,s*')
    ); 
