...
--## FECHA_CREACION=20192511
--## ARTEFACTO=online
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=HREOS-8575
--## PRODUCTO=NO
--##
--## Finalidad: DML Aniadir subcartera Divarian Arrow Inmb en tabla DD_SCR_SUBCARTERA.
--##           
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        T_TIPO_DATA('151' ,'Divarian Arrow Inmb'	,'Divarian Arrow Inmb'		,'07'),
        T_TIPO_DATA('152' ,'Divarian Remaining Inmb'	,'Divarian Remaining Inmb'		,'07')
		); 
      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '|| V_ESQUEMA ||'.DD_SCR_SUBCARTERA (' ||
                      ...
                      '(SELECT DD_CRA_ID FROM '||V_ESQUEMA||'.DD_CRA_CARTERA WHERE DD_CRA_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(4))||'''), 0, ''HREOS-8575'',SYSDATE,0 FROM DUAL';
