...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('130'	,'Obra edificación'			,'Obra edificación' 	,'07'),
    	T_TIPO_DATA('131'	,'Obra urbanización'		,'Obra urbanización'	,'07'),
    	T_TIPO_DATA('132'	,'Adecuación'				,'Adecuación'			,'07'),
    	T_TIPO_DATA('133'	,'Mantenimiento'			,'Mantenimiento'		,'07'),
    	T_TIPO_DATA('134'	,'Demolición'				,'Demolición'			,'07'),
    	T_TIPO_DATA('135'	,'Informes'					,'Informes'				,'07'),
    	T_TIPO_DATA('136'	,'Gestión documental'		,'Gestión documental'	,'07'),
    	T_TIPO_DATA('137'	,'Proyectos'				,'Proyectos'			,'07'),
    	T_TIPO_DATA('138'	,'Postventa'				,'Postventa'			,'07'),
    	T_TIPO_DATA('139'	,'Terceros'					,'Terceros'				,'07'),
    	T_TIPO_DATA('140'	,'Otros'					,'Otros'				,'07'),
    	T_TIPO_DATA('141'	,'Certificaciones'			,'Certificaciones'		,'07'),
    	T_TIPO_DATA('142'	,'Due Diligence'			,'Due Diligence'		,'07')
