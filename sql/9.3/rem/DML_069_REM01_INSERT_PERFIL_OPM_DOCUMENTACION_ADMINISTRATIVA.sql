...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'REMVIP-5769'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DEL PERFIL
    V_PEF_CODIGO VARCHAR2(50) := 'USUMASIVODOC';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Usuario masivo documentación administrativa';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Usuario masivo documentación administrativa';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION('MASIVO_DOCUMENTACION_ADMINISTRATIVA')
    ); 
