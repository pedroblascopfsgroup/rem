...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
      T_FUNCION( 'purquiza', 			'USUMASIVODOC'  ),  
	  T_FUNCION( 'asaceda', 			'USUMASIVODOC'  ),
	  T_FUNCION( 'agarciaa', 			'USUMASIVODOC'  ),
	  T_FUNCION( 'abarbasp', 			'USUMASIVODOC'  ),
	  T_FUNCION( 'bmimosa', 			'USUMASIVODOC'  ),
	  T_FUNCION( 'orubio', 				'USUMASIVODOC'  ),
	  T_FUNCION( 'asanchezgui',			'USUMASIVODOC'  ),
	  T_FUNCION( 'mgarciaj',			'USUMASIVODOC'  )
    );
