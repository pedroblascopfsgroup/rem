      ...
      LOOP
       ...
       ELSE
          ...
          V_MSQL := 'INSERT INTO '||V_ESQUEMA||'.DD_TTE_TIPO_TENEDOR (' ||
                      ...
                      'SELECT '|| V_ID || ','''||V_TMP_TIPO_DATA(1)||''','''||TRIM(V_TMP_TIPO_DATA(2))||''','''||TRIM(V_TMP_TIPO_DATA(3))||''', 0, ''REMVIP-5787'',SYSDATE,0 FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL;
