...
DECLARE
	...
	T_FUNCION('CARGA_DISTRIBUCION_PRECIOS', 'HAYAGESTCOM'),
	T_FUNCION('CARGA_DISTRIBUCION_PRECIOS', 'HAYAGBOINM')	
    ); 
      ...
      LOOP
			...
			IF V_NUM_TABLAS = 0 THEN	
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||'' ||
							...
							' SELECT FUN.FUN_ID, PEF.PEF_ID, '||V_ESQUEMA||'.S_FUN_PEF.NEXTVAL, 0, ''HREOS-8584'', SYSDATE, 0' ||
