...
DECLARE
	...
	V_USUARIO VARCHAR2(32 CHAR) := 'HREOS-8487';

    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	T_TIPO_DATA('07',  'Cáritas',                     'Cáritas'),
    	T_TIPO_DATA('08',  'Ley Catalana 24/2015',        'Ley Catalana 24/2015'),
    	T_TIPO_DATA('09',  'Alquiler Social Ordinario',   'Alquiler Social Ordinario'),
        T_TIPO_DATA('10',  'Cesión Generalitat CX',       'Cesión Generalitat CX'),
        T_TIPO_DATA('11',  'Cesión Otras Corporaciones',  'Cesión Otras Corporaciones')
    ); 
