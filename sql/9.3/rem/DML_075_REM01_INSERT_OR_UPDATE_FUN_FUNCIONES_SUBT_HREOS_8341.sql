...
DECLARE
    ...
    V_USUARIO VARCHAR(40 CHAR); -- Usuario (Artefacto)
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
      T_FUNCION('SuperUsuario (Área Operaciones): Borrado trabajos' , 'SUPER_OPERACIONES_BORRADO_TRABAJOS')
    ); 
...
BEGIN	
    ...
    FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      ...
      ' AND FUN_DESCRIPCION_LARGA = ''' || TRIM(V_TMP_FUNCION(1)) || '''';
