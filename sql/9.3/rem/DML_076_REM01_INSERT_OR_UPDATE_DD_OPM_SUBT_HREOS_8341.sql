...
--## PRODUCTO=NO
--##
--## Finalidad: Script que ACTUALIZA o INSERTA en DD_OPM_OPERACION_MASIVA los datos añadidos en T_ARRAY_FUNCION.
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	     T_FUNCION('SUBT', 'SuperUsuario (Área Operaciones): Borrado trabajos', 'SuperUsuario (Área Operaciones): Borrado trabajos','SUPER_OPERACIONES_BORRADO_TRABAJOS','n*')
    ); 
...
BEGIN	
  ...
  V_TABLA_2 := 'FUN_FUNCIONES';
    ...
    FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      ...
      ' AND DD_OPM_DESCRIPCION = ''' ||V_TMP_FUNCION(2)|| ''' AND DD_OPM_DESCRIPCION_LARGA = '''||V_TMP_FUNCION(3) || '''';
