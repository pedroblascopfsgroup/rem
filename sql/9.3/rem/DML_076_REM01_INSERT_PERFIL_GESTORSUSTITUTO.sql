...
DECLARE
    ...
    V_PEF_CODIGO VARCHAR2(50) := 'GESTSUSTITUTO';
    V_PEF_DESCRIPCION VARCHAR2(50) := 'Perfil gestión gestores sustitutos';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Perfil de usuario para gestionar los gestores sustitutos';
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION('TAB_GESTORES_SUSTITUTOS'),
		T_FUNCION('ADD_QUITAR_GESTORESSUSTITUTOS')
    ); 
