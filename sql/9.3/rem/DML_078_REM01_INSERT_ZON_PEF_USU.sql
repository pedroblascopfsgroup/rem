...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
		T_FUNCION('acarabal', 'GESTSUSTITUTO'),
		T_FUNCION('dmontero', 'GESTSUSTITUTO'),
		T_FUNCION('acampos', 'GESTSUSTITUTO'),
		T_FUNCION('csanchezb', 'GESTSUSTITUTO'),
		T_FUNCION('jdominguezr', 'GESTSUSTITUTO'),
		T_FUNCION('jgracia', 'GESTSUSTITUTO'),
		T_FUNCION('lmartinga', 'GESTSUSTITUTO'),
		T_FUNCION('mblascop', 'GESTSUSTITUTO'),
		T_FUNCION('aruiz', 'GESTSUSTITUTO'),
		T_FUNCION('selena', 'GESTSUSTITUTO'),
		T_FUNCION('avalerog', 'GESTSUSTITUTO'),
		T_FUNCION('afraile', 'GESTSUSTITUTO'),
		T_FUNCION('imartin', 'GESTSUSTITUTO'),
		T_FUNCION('lclaret', 'GESTSUSTITUTO'),
		T_FUNCION('mruiz', 'GESTSUSTITUTO'),
		T_FUNCION('rsanchez', 'GESTSUSTITUTO'),
		T_FUNCION('pnevot', 'GESTSUSTITUTO'),
		T_FUNCION('fvaldes', 'GESTSUSTITUTO'),
		T_FUNCION('rpavon', 'GESTSUSTITUTO'),
		T_FUNCION('saragon', 'GESTSUSTITUTO'),
		T_FUNCION('falonsor', 'GESTSUSTITUTO'),
		T_FUNCION('fmalvarez', 'GESTSUSTITUTO'),
		T_FUNCION('jvila', 'GESTSUSTITUTO'),
		T_FUNCION('ecabrera', 'GESTSUSTITUTO'),
		T_FUNCION('emaurizot', 'GESTSUSTITUTO'),
		T_FUNCION('msanchezf', 'GESTSUSTITUTO'),
		T_FUNCION('jmartinezn', 'GESTSUSTITUTO'),
		T_FUNCION('ecabrera', 'GESTSUSTITUTO'),
		T_FUNCION('emaurizot', 'GESTSUSTITUTO'),
		T_FUNCION('mganan', 'GESTSUSTITUTO'),
		T_FUNCION('agimenez', 'GESTSUSTITUTO'),
		T_FUNCION('jdrodriguez', 'GESTSUSTITUTO'),
		T_FUNCION('falves', 'GESTSUSTITUTO'),
		T_FUNCION('dmiquel', 'GESTSUSTITUTO'),
		T_FUNCION('bruiz', 'GESTSUSTITUTO'),
		T_FUNCION('vmartinez', 'GESTSUSTITUTO'),
		T_FUNCION('eblanco', 'GESTSUSTITUTO')
    );
