...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'REMVIP-5930'; -- USUARIOCREAR/USUARIOMODIFICAR.

    --EDITAR: DATOS DEL PERFIL
    V_PEF_CODIGO VARCHAR2(50) := 'SUPEREXPORTTARAVAL';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Super Exportación tareas, avisos Y alertas';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Super Exportación tareas, avisos Y alertas';
