...
DECLARE
    ...
    V_PEF_CODIGO VARCHAR2(50) := 'SUPEREXPORTOFR';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Super Exportación ofertas';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Super Exportación ofertas';
