...
DECLARE
    ...
    V_PEF_CODIGO VARCHAR2(50) := 'SUPEREXPORTTBJ';
    V_PEF_DESCRIPCION VARCHAR2(255) := 'Super Exportación trabajos';
    V_PEF_DESCRIPCION_LARGA VARCHAR2(255) := 'Super Exportación trabajos';
