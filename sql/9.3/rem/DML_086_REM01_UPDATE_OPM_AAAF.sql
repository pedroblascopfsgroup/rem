...
DECLARE
    ...
    TYPE T_FUNCION IS TABLE OF VARCHAR2(450);
    TYPE T_ARRAY_FUNCION IS TABLE OF T_FUNCION;
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('AAAF', 'nD*,s*,s*,s*,n,n,n,s*,s*,s*,s*,s*,s*,s*,s*,s,s,s,s*,s,s*,s*,s*,s*,s*,s*,s,s*,n*,s*,s,s,n,s*,s*,n,n,n,s*,s,n,n,n,s,b,s*,s,n,s*,b*,s,s,n,n,n,n,b,b,b,i*,i*,i,f')
    ); 
