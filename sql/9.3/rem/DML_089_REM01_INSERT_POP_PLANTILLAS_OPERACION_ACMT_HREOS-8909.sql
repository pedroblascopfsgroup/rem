...
--##                V_ITEM Contiene el usuario que crea, modifica o borra.
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
--*/
...
DECLARE
    ...
    V_ITEM VARCHAR(50); -- Vble. que indica el usuario que realiza la operación (USUARIOCREAR)
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_TRABAJOS', 'plantillas/plugin/masivo/CARGA_MASIVA_TRABAJOS_API_AUT.xls', 'ACMT')
    ); 
