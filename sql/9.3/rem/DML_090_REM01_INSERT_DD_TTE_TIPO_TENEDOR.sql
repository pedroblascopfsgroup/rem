...
DECLARE
    ...
    V_USUARIO_CREAR VARCHAR2(50 CHAR) := 'HREOS-9065'; -- Vble. auxiliar para almacenar el usuario crear
    V_USUARIO_MODIFICAR VARCHAR2(50 CHAR) := 'HREOS-9065'; -- Vble. auxiliar para almacenar el usuario modificar   
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	...
    	T_TIPO_DATA('06'	        ,'HRE'							  ,'HRE'),
      T_TIPO_DATA('07'	        ,'Central de llaves'	,'Central de llaves')
    ); 
