...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-9322';
    V_ARRAY T_ARRAY := T_ARRAY (
        T_LISTA ('grucontroller', NULL, 'grucontroller', 'GCONT', 'GCONT', 'Gestor Controller', 'PERFGCONTROLLER' , 'Gestor Controller', 'GCONT'  , 'Gestor Controller', NULL, 0)
    );
    V_TMP_LISTA T_LISTA;
