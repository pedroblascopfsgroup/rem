  ...
  EXECUTE IMMEDIATE V_MSQL INTO V_NUM_TABLAS;
    ...
    FOR I IN 1..V_NUM_TABLAS
      LOOP
          ...
          V_MSQL := 'SELECT REM01.S_GEH_GESTOR_ENTIDAD_HIST.NEXTVAL FROM DUAL';
          EXECUTE IMMEDIATE V_MSQL INTO V_ID;	
          
          V_MSQL := 'INSERT INTO REM01.GEH_GESTOR_ENTIDAD_HIST (GEH_ID, USU_ID, DD_TGE_ID, GEH_FECHA_DESDE, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
                      SELECT '|| V_ID || '
