...
BEGIN	
  ...
  V_MSQL := 'INSERT INTO REM01.GCO_GESTOR_ADD_ECO (ECO_ID, GEE_ID)
  SELECT ECO_ID, GEE_ID FROM REM01.'||V_TEXT_TABLA||'';
  EXECUTE IMMEDIATE V_MSQL;
  DBMS_OUTPUT.PUT_LINE('[INFO] REGISTROS INSERTADOS CORRECTAMENTE EN GCO_GESTOR_ADD_ECO: ' || sql%rowcount);

  V_MSQL := 'INSERT INTO REM01.GCH_GESTOR_ECO_HISTORICO (ECO_ID, GEH_ID)
  SELECT ECO_ID, GEH_ID FROM REM01.'||V_TEXT_TABLA||'';
  EXECUTE IMMEDIATE V_MSQL;
  ...
  V_MSQL := 'DROP TABLE REM01.TMP_GCO_GCH';
  EXECUTE IMMEDIATE V_MSQL;
