...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-9316';
    V_ARRAY T_ARRAY := T_ARRAY (
        T_LISTA ('grucierreventa', NULL, 'grucierreventa', 'GCV', 'GCV', 'Gestor Cierre Venta', 'PERFGCV' , 'Gestor Cierre Venta', 'GCV'  , 'Gestor Cierre Venta', NULL, 0)
    );
    V_TMP_LISTA T_LISTA;
