...
DECLARE
    ...
    V_USU VARCHAR2(50 CHAR) := 'HREOS-9330'; -- Vble. auxiliar para almacenar el usuario crear  
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    	...
    	T_TIPO_DATA('GCV', '7', '', '', '', '', '', 'grucierreventa', '', '151'),
      T_TIPO_DATA('GCV', '7', '', '', '', '', '', 'grucierreventa', '', '152')
    );
