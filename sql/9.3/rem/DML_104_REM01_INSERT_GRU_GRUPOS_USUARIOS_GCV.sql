...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-9330'; -- USUARIO CREAR/MODIFICAR
	...
	V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION( 'grucierreventa' , 'ext.mlucas'), -- Mónica Lucas
		--T_FUNCION( 'grucierreventa' , ''), -- Daniel López García
		T_FUNCION( 'grucierreventa' , 'ext.erodrigue'), -- Elena Rodríguez
		T_FUNCION( 'grucierreventa' , 'ext.rberenguer') -- Rosa María Berenguer
	); 
