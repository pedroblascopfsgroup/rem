...
DECLARE
    ...
    V_ITEM VARCHAR2(20) := 'HREOS-9310';
	V_PERFIL VARCHAR2(20) := 'HAYAGESTFORM';
	V_PERFIL_COPIA VARCHAR2(20) := 'CPHAYAGESTFORM';
	V_PEF_DESC VARCHAR2(100) := 'Perfil copia Gestor formalización';
	V_NUM NUMBER;
	V_NUM2 NUMBER;
