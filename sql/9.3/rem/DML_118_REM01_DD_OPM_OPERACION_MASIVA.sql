...
DECLARE
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('MSTP', 'Carga masiva actualiza toma de posesión', 'Carga masiva actualiza toma de posesión','TOMA_POSESION','n*, *s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s')
    ); 
      ...
      LOOP
			...
			ELSE
				V_MSQL_1 := 'INSERT INTO '||V_ESQUEMA||'.DD_OPM_OPERACION_MASIVA' ||
							...
							' 0, ''HREOS-8165'', SYSDATE, 0, '''||V_TMP_FUNCION(5)||''' FROM DUAL';
