...
T_TIPO_DATA('ANGELS LOPEZ GARCIA','43444793R','angels.lopez@aldesign.cat',1,'41',0,0,0,0,1),
...
T_TIPO_DATA('TASIBERICA SA','A28842045','jgonzalez@gesiberica.com',1,'41',0,0,0,0,1),
...
T_TIPO_DATA('ASISTENCIA TECNICA INTEGRAL AL DESARROLLO INM. SL','B47704838','aresarquitecto@hotmail.es',1,'41',0,0,0,0,1),
...
T_TIPO_DATA('SBS SIMON I BLANCO SL','B64168933','lsimon@sbs-enginyers.com',1,'41',0,0,0,0,1),
...
T_TIPO_DATA('ASSISTA CASA 2005 SL','B97600001','c.sanz@grupoassista.com',1,'41',0,0,0,0,1),
...
T_TIPO_DATA('JOSE IGNACIO PUERTAS MEDINA','19848053L','joseignaciopuertas@gmail.com',1,'39',0,0,0,0,1),
T_TIPO_DATA('JOSE OCTAVIO ORDINYANA POVEDA','20447058N','jose@ijarquitectos.com',1,'39',0,0,1,0,0),
T_TIPO_DATA('JUSTINO ANDRES ALONSO HERMOSA','22562062M','justino@adagronomos.es',1,'39',0,0,0,0,1),
T_TIPO_DATA('ARISTEA CORTES BALLESTER','29010659T','acortesbal@gmail.com',1,'39',0,0,0,0,1),
T_TIPO_DATA('GRV Arquitectura','33399807N','grv.arquitectura@gmail.com',1,'39',1,1,0,0,0),
T_TIPO_DATA('Drago32','42793075B','drago32.Arquitectos@drago32.com',1,'39',1,1,0,0,0),
T_TIPO_DATA('Alfonso Ortega Garcia','50074661G','10530ortega@coam.es',1,'39',0,0,1,0,0),
T_TIPO_DATA('JUAN JOSE CAPOTE JURADO','80147162M','juanjo.capote@coacordoba.net',1,'39',0,0,1,0,0),
T_TIPO_DATA('INVESTIGACIÓN Y CONTROL DE CALIDAD S.A.U','A24036691','clientes@incosa.es',1,'39',0,0,1,0,0),
T_TIPO_DATA('OMICRON AMEPRO SA','A28520278','isuarez@omicronamepro.es',1,'39',0,0,0,0,1),
T_TIPO_DATA('VALTECNIC SA','A28903920','bcabeza@organismodecontrol.com',1,'39',0,0,0,0,1),
T_TIPO_DATA('OCT CONTROLIA, S.A.','A82838350','silviagarcia@controliaga.com',1,'39',0,0,0,1,0),
T_TIPO_DATA('José Ángel Ferrer Arquitectos, S.L.P.','B04336301','info@ferrerarquitectos.com',1,'39',0,0,1,0,0),
T_TIPO_DATA('ARKU3 URBAN SLP','B25752395','marcribes@arku3.com',1,'39',0,0,0,0,1),
T_TIPO_DATA('ECA S.L. GRUPO BUREAU VERITAS ','B28205904','buraudio@buraudio.com',1,'39',0,0,1,0,0),
T_TIPO_DATA('Unicontrol','B45740818','chinjos@unicontrol.es',1,'39',0,0,0,1,0),
T_TIPO_DATA('Resulta Soluciones inmobiliarias','B54478755','david.martinez@resultasoluciones.com',1,'39',1,1,0,0,0),
T_TIPO_DATA('Akra','B54780697','amador.suarez@grupoakra.es',1,'39',1,1,0,0,0),
T_TIPO_DATA('APROTECNIC GROUP SL','B65472789','e.fernandez@aprotecnic.com',1,'39',0,0,0,0,1),
T_TIPO_DATA('Securama','B73496200','es@securama.es',1,'39',1,1,0,0,0),
T_TIPO_DATA('UVE','B86140878','mlq@v-valoraciones.es',1,'39',1,1,0,1,0),
T_TIPO_DATA('Almar Consulting','B86408374','info@almarconsulting.com',1,'39',1,1,0,0,0),
T_TIPO_DATA('Tinsa Certify','B86689494','marta.garciahernandez@tinsa.com',1,'39',0,0,1,0,0),
T_TIPO_DATA('GESVALT PROPERTY SERVICES SL','B87212122','jpgil@gesvaltservices.es',1,'39',0,0,0,0,1),
T_TIPO_DATA('ALL GLOBAL','B87300349','maberengue@allgpm.es',1,'39',1,1,1,1,0),
T_TIPO_DATA('FM Ingenieros','B87764841','gizquierdo@fmingenieros.com',1,'39',0,0,0,1,0),
T_TIPO_DATA('Premea','B96595897','premea@premea.com',1,'39',1,1,1,1,0),
T_TIPO_DATA('Llorens Fornes y Navarro','B96836739','laura@llfnarquitectos.com',1,'39',1,1,1,0,0),
T_TIPO_DATA('ACTUA','B98562036','jorgemarco@actua-ga.es',1,'39',1,1,0,0,0),
...
T_TIPO_DATA('CASER','A28013050','MGALEANO@aciertaasistencia.es/',1,'40',1,0,0,0,0),
...
T_TIPO_DATA('Acierta','A28346054','vlabella@aciertaasistencia.es',1,'40',0,0,0,1,0),
...
T_TIPO_DATA('J2 DE SIMON Y CUERVA ARQUITECTOS SLP','B04816906','estudio@j2arquitectos.com',1,'40',0,0,1,0,0),
...
T_TIPO_DATA('AVANZA SERVICIOS INTEGRALES SLU','B23657521','recuperaciones@avanzasi.es',1,'40',0,0,1,0,0),
...
T_TIPO_DATA('SERVICIOS INTEGRALES','B35828995','central@serviciosintegralesdecanarias.com',1,'40',1,1,0,0,0),
...
T_TIPO_DATA('SIVERIO LOPEZ COACH CONSTRUCCION SL','B38966362','info@coachconstruccion.com',1,'40',0,0,0,0,1),
...
T_TIPO_DATA('SBS SIMON I BLANCO SL','B64168933','lsimon@sbs-enginyers.com',1,'40',0,0,0,0,1),
...
T_TIPO_DATA('PROGUARD SISTEMAS, SL','B73281081','proguard@proguardsistemas.com',1,'40',0,0,1,0,0),
...
T_TIPO_DATA('ARQUITECTURA Y URBANISMO SINGULARQ SLP','B97570063','estudio@qarq.es',1,'40',0,0,0,0,1),
T_TIPO_DATA('ASSISTA','B97600001','jm.asensi@grupoassista.com',1,'40',1,0,0,0,0),
...
T_TIPO_DATA('AVANZA URBANA SIGLO XXI SL','B98327943','mmpuchades@avanzaurbana.com',1,'40',0,0,1,0,0),
      ...
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN				
          ...
          IF V_NUM_TABLAS > 0 THEN
            ...
            , PVE.USUARIOMODIFICAR = ''HREOS-9607''
            , PVE.FECHAMODIFICAR = SYSDATE  
            WHERE PVE.PVE_DOCIDENTIF = '''||TRIM(V_TMP_TIPO_DATA(2))||'''
            AND PVE.DD_TPR_ID = (SELECT TPR.DD_TPR_ID FROM DD_TPR_TIPO_PROVEEDOR TPR WHERE TPR.DD_TPR_CODIGO = '''||TRIM(V_TMP_TIPO_DATA(5))||''') AND PVE.PVE_FECHA_BAJA IS NULL
            AND PVE.DD_EPR_ID IS NULL AND PVE.BORRADO = 0';
