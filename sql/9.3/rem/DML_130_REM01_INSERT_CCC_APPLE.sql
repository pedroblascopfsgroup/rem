...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('01','2020', '138','6310000000'),
      T_TIPO_DATA('01','2019', '138','6311000002'),
      T_TIPO_DATA('01','2018', '138','6310000001'),
      T_TIPO_DATA('02','2020', '138','6310000000'),
      T_TIPO_DATA('02','2019', '138','6311000002'),
      T_TIPO_DATA('02','2018', '138','6310000001'),
      T_TIPO_DATA('01','2016', '138','6310000001'),
      T_TIPO_DATA('01','2017', '138','6310000001'),
      T_TIPO_DATA('02','2016', '138','6310000001'),
      T_TIPO_DATA('02','2017', '138','6310000001')
		); 
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
      LOOP
        ...
        IF V_NUM_TABLAS > 0 THEN	
          ...
          DBMS_OUTPUT.PUT_LINE('[INFO]: YA EXISTE LA CUENTA: '''|| TRIM(V_TMP_TIPO_DATA(4)) ||'''');  
