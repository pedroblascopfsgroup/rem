...
DECLARE
    ...
    V_ITEM VARCHAR2(30 CHAR) := 'HREOS-10454'; -- USUARIOCREAR/USUARIOMODIFICAR.
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		  T_FUNCION('CARGA_MASIVA_SUMINISTROS', 'plantillas/plugin/masivo/CARGA_MASIVA_SUMINISTROS.xls', 'CMS')
    ); 
