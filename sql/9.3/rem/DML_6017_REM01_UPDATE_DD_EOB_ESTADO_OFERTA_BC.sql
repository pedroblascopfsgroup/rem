...
--## PRODUCTO=NO
--##
--## Finalidad: Script que modifica la descripcion en DD_EOB_ESTADO_OFERTA_BC
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_TABLA VARCHAR2(50 CHAR):= 'DD_EOB_ESTADO_OFERTA_BC';
    V_CHARS VARCHAR2(3 CHAR):= 'EOB';
    V_USUARIO VARCHAR2(25 CHAR):= 'HREOS-17942';
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
               -- CODIGO  			            DESCRIPCION                                       DESCRIPCION_LARGA                                        CODIGO_C4C
      T_TIPO_DATA('09',			'Solicitar devolución de arras a BC',			                   'Solicitar devolución de arras a BC',                             290)
