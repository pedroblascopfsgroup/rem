...
BEGIN
	...
	V_SENTENCIA := 'INSERT INTO '||V_ESQUEMA||'.MIG2_ECO_EXPEDIENTE_CAIXA(ECO_NUM_EXPEDIENTE	,
		OFR_ID	,
		DD_EEC_ID	,
		ECO_FECHA_ALTA	,
		ECO_FECHA_SANCION	,
		...
		)SELECT '||V_ESQUEMA||'.S_ECO_NUM_EXPEDIENTE.NEXTVAL, MIG.OFR_ID,
		ECO.DD_EEC_ID,
		ECO.ECO_FECHA_ALTA,
