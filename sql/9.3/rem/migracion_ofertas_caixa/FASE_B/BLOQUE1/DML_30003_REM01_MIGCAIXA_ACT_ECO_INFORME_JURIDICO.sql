...
ELSE
	...
	EXECUTE IMMEDIATE '
		INSERT INTO '||V_ESQUEMA||'.ACT_ECO_INFORME_JURIDICO(
		ACT_ECO_IJ_ID,
		ECO_ID,
		ACT_ID,
		...
		BORRADO)
		SELECT
		'||V_ESQUEMA||'.S_ACT_ECO_INFORME_JURIDICO.NEXTVAL,
		MIG.ECO_ID, 
		INF.ACT_ID, 
		INF.ACT_ECO_FECHA_EMISION,
		1,
		''MIG_CAIXA'',
		SYSDATE,
		0 
		FROM '||V_ESQUEMA||'.MIG2_ACT_INFORME_JURIDICO_CAIXA INF
		JOIN '||V_ESQUEMA||'.MIG2_OFR_MAPEO_NUM_OFERTAS MIG ON INF.NUM_OFERTA = MIG.COD_OFERTA_CAIXA
	';
