...
BEGIN
	...
	V_SENTENCIA := 'INSERT INTO '||V_ESQUEMA||'.ACT_OFR (ACT_ID,
		...
		SELECT ACO.ACT_ID, MIG.OFR_ID, ACO.ACT_OFR_IMPORTE, VERSION, ACO.OFR_ACT_PORCEN_PARTICIPACION 
		FROM '||V_ESQUEMA||'.MIG2_OFA_OFERTAS_ACTIVO_CAIXA ACO 
		JOIN '||V_ESQUEMA||'.MIG2_OFR_MAPEO_NUM_OFERTAS MIG ON MIG.COD_OFERTA_CAIXA = ACO.OFR_NUM_OFERTA';
