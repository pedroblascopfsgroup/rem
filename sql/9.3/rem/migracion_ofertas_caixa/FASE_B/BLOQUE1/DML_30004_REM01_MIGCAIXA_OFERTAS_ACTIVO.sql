...
DECLARE
	...
	V_TABLA2 VARCHAR2(40 CHAR) := 'ECO_EXPEDIENTE_COMERCIAL';
	V_TABLA3 VARCHAR2(40 CHAR) := 'ACT_ECO_INFORME_JURIDICO';
	V_TABLA4 VARCHAR2(40 CHAR) := 'FOR_FORMALIZACION';
	V_TABLA_MIG VARCHAR2(40 CHAR) := 'MIG2_OFR_OFERTAS_CAIXA';
	V_TABLA_MIG2 VARCHAR2(40 CHAR) := 'MIG2_OFR_OFERTAS_CAMPOS_SUELTOS_CAIXA';
	V_TABLA_MIG3 VARCHAR2(40 CHAR) := 'MIG2_RES_RESERVAS_CAIXA';
...
BEGIN
	...
	V_SENTENCIA := 'INSERT INTO '||V_ESQUEMA||'.ACT_OFR (ACT_ID,
		OFR_ID,
		ACT_OFR_IMPORTE,
		VERSION,
		OFR_ACT_PORCEN_PARTICIPACION) SELECT ACO.ACT_ID, ACO.OFR_ID, ACO.ACT_OFR_IMPORTE, VERSION, ACO.OFR_ACT_PORCEN_PARTICIPACION 
		FROM '||V_ESQUEMA||'.MIG2_OFA_OFERTAS_ACTIVO_CAIXA ACO 
		JOIN '||V_ESQUEMA||'.MIG2_OFR_MAPEO_NUM_OFERTAS MIG ON MIG.OFR_ID = ACO.OFR_ID';
