...
ELSE
	...
	EXECUTE IMMEDIATE '
	INSERT INTO '||V_ESQUEMA||'.OFR_TIA_TITULARES_ADICIONALES (
		TIA_ID,
		OFR_ID,
		TIA_NOMBRE,
		DD_TDI_ID,
		...
		'||V_ESQUEMA||'.S_OFR_TIA_TIT_ADICIONALES.NEXTVAL,
		MIG2.OFR_ID,
		TIA_NOMBRE,
		DD_TDI_ID,
		TIA_DOCUMENTO,
		...
		DD_LOC_NAC_ID,
		DD_PAI_NAC_ID										
		FROM '||V_ESQUEMA||'.MIG2_OFR_TIA_TITULARES_ADI_CAIXA INF
		JOIN '||V_ESQUEMA||'.MIG2_OFR_MAPEO_NUM_OFERTAS MIG2 ON MIG2.COD_OFERTA_CAIXA = INF.OFR_ID
	';
