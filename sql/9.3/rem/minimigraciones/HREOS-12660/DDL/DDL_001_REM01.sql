...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_HREOS_12660'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_HREOS_12660';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			CARTERA NUMBER(16,0),
			NIF_PROVEEDOR VARCHAR2(20 CHAR),
			TIPO_PROVEEDOR NUMBER(16,0),
			TIPO_TRABAJO NUMBER(16,0),
			SUBTIPO_TRABAJO NUMBER(16,0),
			DESCRIPCION_CORTA VARCHAR2(250 CHAR),
			UNIDAD_MEDIDA VARCHAR2(80 CHAR),
			TARIFA_PROVEEDOR NUMBER(16,2)
		)'
;
