...
BEGIN
	...
	V_SQL := ('INSERT INTO '||V_ESQUEMA||'.'||V_TABLA_TIPO||' (DD_TTF_ID, DD_TTF_CODIGO, DD_TTF_DESCRIPCION, DD_TTF_DESCRIPCION_LARGA, VERSION, USUARIOCREAR, FECHACREAR, BORRADO)
        SELECT '||V_ESQUEMA||'.S_'||V_TABLA_TIPO||'.NEXTVAL,REGEXP_REPLACE( TMP.CODIGO, ''[[:space:]]'', '''' ), SUBSTR(TMP.DESCRIPCION_CORTA,1,100), TMP.DESCRIPCION_CORTA, 0, '''||V_USUARIO||''', SYSDATE, 0
