...
V_TABLA VARCHAR2(40 CHAR) := 'ACT_PVE_BACKUP_CX';
...
ELSE 
    EXECUTE IMMEDIATE 'CREATE TABLE '||V_ESQUEMA_1||'.'||V_TABLA||' AS (SELECT PVE_ID, PVE_DOCIDENTIF, PVE_COD_UVEM, DD_TDI_ID FROM '||V_ESQUEMA_1||'.ACT_PVE_PROVEEDOR)';
