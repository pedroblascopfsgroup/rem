...
BEGIN
	...
	SELECT
		...
		NULL                        TIT_FECHA_ENTREGA_GESTORIA,
		NULL                        TIT_FECHA_PRESENT_HACIENDA,
		NULL                             TIT_FECHA_ENVIO_AUTO,
		NULL                            TIT_FECHA_PRESENT1_REG,
		NULL                            TIT_FECHA_PRESENT2_REG,
		NULL                                TIT_FECHA_INSC_REG,
		NULL                            TIT_FECHA_RETIRADA_REG,
		NULL                             TIT_FECHA_NOTA_SIMPLE,
		''0''                                                 VERSION,
