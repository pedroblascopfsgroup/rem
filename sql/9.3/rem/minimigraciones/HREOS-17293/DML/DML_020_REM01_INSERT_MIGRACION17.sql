...
DBMS_OUTPUT.PUT_LINE('[INFO] COMIENZA EL PROCESO DE MIGRACION SOBRE LA TABLA '||V_ESQUEMA||'.'||V_TABLA_7||'. [PATRIMONIO]');
	...
	ALQUILER_GESTION,
    PRECIO_COMPRA,
    ALTA_PRIMA_OPCION_COMPRA,
    RENUNCIA_DERECHO_TANTEO,
    DD_SOC_ID,
    OBLIGADO_CUMPLIMIENTO,
    FIANZA_OBLIGATORIA,
    FECHA_AVAL_BANC,
    IMPORTE_AVAL_BANC,
    IMPORTE_DEPOS_BANC
	...
	ACT_PTA.ACUERDO_PAGO                                		ACUERDO_PAGO,
    ACT_PTA.MOROSO                                      		MOROSO,
    ACT_PTA.ACTIVO_PROMO_ESTRATEG                       		ACTIVO_PROMO_ESTRATEG,
    ACT_PTA.ALQUILER_GESTION                                    ALQUILER_GESTION,
    ACT_PTA.PRECIO_COMPRA                                       PRECIO_COMPRA,
    ACT_PTA.ALTA_PRIMA_OPCION_COMPRA        ALTA_PRIMA_OPCION_COMPRA,
    ACT_PTA.RENUNCIA_DERECHO_TANTEO         RENUNCIA_DERECHO_TANTEO,
    ACT_PTA.DD_SOC_ID                       DD_SOC_ID,
    ACT_PTA.OBLIGADO_CUMPLIMIENTO           OBLIGADO_CUMPLIMIENTO,
    ACT_PTA.FIANZA_OBLIGATORIA              FIANZA_OBLIGATORIA,
    ACT_PTA.FECHA_AVAL_BANC                 FECHA_AVAL_BANC,
    ACT_PTA.IMPORTE_AVAL_BANC               IMPORTE_AVAL_BANC,
    ACT_PTA.IMPORTE_DEPOS_BANC              IMPORTE_DEPOS_BANC
