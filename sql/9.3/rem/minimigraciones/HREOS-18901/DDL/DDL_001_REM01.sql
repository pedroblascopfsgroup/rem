...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_HREOS_18901'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_HREOS_18901';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DESCRIPCION_TIPO_TARIF		VARCHAR2(250 CHAR),
			CARTERA 					VARCHAR2(20 CHAR),
			SUBCARTERA 					VARCHAR2(20 CHAR),
			NOMBRE_PROVEEDOR 			VARCHAR2(250 CHAR),
			TIPO_TRABAJO 				VARCHAR2(250 CHAR),
			SUBTIPO_TRABAJO 			VARCHAR2(250 CHAR),
			PRECIO 						NUMBER(16,2),
