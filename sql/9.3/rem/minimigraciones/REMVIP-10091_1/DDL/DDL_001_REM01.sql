...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10091_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10091_1';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_ID	NUMBER(16, 0),
			ADN_FECHA_TITULO varchar2(20 char),
			ADN_FECHA_FIRMA_TITULO varchar2(20 char),
			ADN_VALOR_ADQUISICION  NUMBER(16, 0),
			ADN_TRAMITADOR_TITULO varchar2(200 char),
			ADN_NUM_REFERENCIA varchar2(200 char),
			FECHA_POSESION	 varchar2(20 char)	
		)'
;
