...
--## INCIDENCIA_LINK=REMVIP-10327
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10327'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10327';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			NUEVA NUMBER(16, 0),
			NUM_EXPEDIENTE NUMBER(16, 0),
			RESPONSE VARCHAR2 (200 CHAR),
			REQUEST VARCHAR2 (200 CHAR),
			VIAJADO NUMBER(16,0)
		)'
;
