...
--## INCIDENCIA_LINK=REMVIP-10387
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10368'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10387';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			num_agrupacion number (16, 0),
			estado_publi varchar2( 100 char),
			sit_comercial varchar2( 100 char),
			publicar_sin_precio varchar2( 100 char),
			estado_publi_anterior varchar2( 100 char),
			estado_publi_actual varchar2( 100 char),
			estado_pep varchar2( 100 char)
		)'
;
