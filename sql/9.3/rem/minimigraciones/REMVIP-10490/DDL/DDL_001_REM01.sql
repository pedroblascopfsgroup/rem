...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10487'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10490';
...
EXECUTE IMMEDIATE '
		...
		(
			USERNAME_REM VARCHAR2(200 CHAR),
			USU_NOMBRE_REM VARCHAR2(200 CHAR),
			USU_APELLIDO1_REM VARCHAR2(200 CHAR),
			USU_APELLIDO2_REM VARCHAR2(200 CHAR),
			USU_MAIL_REM VARCHAR2(200 CHAR),
			USERNAME_JUP VARCHAR2(200 CHAR),
			USU_NOMBRE_JUP VARCHAR2(200 CHAR),
			USU_APELLIDO1_JUP VARCHAR2(200 CHAR),
			USU_APELLIDO2_JUP VARCHAR2(200 CHAR),
			USU_MAIL_JUP VARCHAR2(200 CHAR),
			DISTINTO_NOMBRE VARCHAR2(200 CHAR),
			DISTINTO_APELLIDO1 VARCHAR2(200 CHAR),
			DISTINTO_APELLIDO2 VARCHAR2(200 CHAR),
			DISTINTO_EMAIL VARCHAR2(200 CHAR)
		)'
;
