--/*
--#########################################
--## AUTOR=Alejadnra García
--## FECHA_CREACION=20210929
--## ARTEFACTO=batch
--## VERSION_ARTEFACTO=9.3
--## INCIDENCIA_LINK=REMVIP-10505
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP-10505'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10505_NOCFV2020';
...
EXECUTE IMMEDIATE '
		...
		(
			OFR_OFERTA NUMBER(16, 0),
			ACT_aCTIVO NUMBER(16, 0)
		)'
;
