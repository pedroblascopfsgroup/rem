...
--## INCIDENCIA_LINK=REMVIP-10532
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10532'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10532';
...
EXECUTE IMMEDIATE '
		...
		(
			OFERTA VARCHAR2(500 CHAR),
			NOMBRE VARCHAR2(500 CHAR),
			USU_ID VARCHAR2(500 CHAR)
		)'
;
