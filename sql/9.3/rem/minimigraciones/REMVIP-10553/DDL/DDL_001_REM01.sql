...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10553'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10553';
...
EXECUTE IMMEDIATE '
		...
		(
			 ID_HAYA_STOCK						NUMBER(35,0)
			,VALOR_CONSTRUCCION					NUMBER(16,2)
			,VALOR_SUELO						NUMBER(16,2)
			,ID_HAYA_REM						VARCHAR2(35 CHAR)
		)'
;
