...
--## INCIDENCIA_LINK=REMVIP_10777
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10777'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10777';
...
EXECUTE IMMEDIATE '
		...
		(
		ID_PERSONA_HAYA VARCHAR2(30 CHAR),
		ID_PERSONA_HAYA_CAIXA VARCHAR2(30 CHAR),
		NOMBRE		VARCHAR2(100 CHAR),
		APELLIDO_1	VARCHAR2(100 CHAR),
		TIPO_PERSONA	VARCHAR2(30 CHAR),
		ESTADO_CIVIL   VARCHAR2(10 CHAR),
		DOMICILIO VARCHAR2(500 CHAR),
		COD_POSTAL 	VARCHAR2(30 CHAR),
		POBLACION	VARCHAR2(100 CHAR),
		PROVINCIA	VARCHAR2(50 CHAR),
		TEL_1 		VARCHAR2(30 CHAR),
		EMAIL		VARCHAR(100 CHAR),
		TIPO_DOCUMENTO	VARCHAR2(30 CHAR),
		DOCUMENTO	VARCHAR2(100 CHAR)
		)'
;
