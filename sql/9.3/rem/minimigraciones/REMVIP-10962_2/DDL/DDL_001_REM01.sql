...
--## INCIDENCIA_LINK=REMVIP_10962
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_10962'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10962_DIVARIAN';
...
EXECUTE IMMEDIATE '
		...
		(
		CPP VARCHAR2(250 CHAR),
		NOMBRE VARCHAR2(250 CHAR),
		TIPO_GASTO VARCHAR2(250 CHAR),
		SUBTIPO_GASTO VARCHAR2(250 CHAR),
		CCC VARCHAR2(250 CHAR),
		AREA_RESP VARCHAR2(250 CHAR),
