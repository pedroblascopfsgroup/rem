...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_11097'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_11097';
...
EXECUTE IMMEDIATE '
		...
		DOMICILIO VARCHAR(500 CHAR),
		COD_POSTAL 	VARCHAR2(30 CHAR),
		TEL_1 		VARCHAR2(30 CHAR),
		TEL_2		VARCHAR2(30 CHAR),
		TEL_3		VARCHAR2(30 CHAR),
