...
--## INCIDENCIA_LINK=REMVIP_11118
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_11118'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_11118';
...
EXECUTE IMMEDIATE '
		...
		(
		NUMOFERTA VARCHAR2(250 CHAR),
		FECHAPENDIENTE VARCHAR2(250 CHAR)
		)'
;
