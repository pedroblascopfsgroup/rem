...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_12965';
...
(
	 		ELEMENTO_PEP						VARCHAR2(200 CHAR)
			 ,DESCRIPCION						VARCHAR2(200 CHAR)
			 ,VENTA						VARCHAR2(100 CHAR)
 			 ,ALQUILER						VARCHAR2(100 CHAR)
  			 ,ESTRUCTURA						VARCHAR2(100 CHAR)
   			 ,DD_CBC_CODIGO					VARCHAR2(100 CHAR)
    			 ,GRUPO						VARCHAR2(100 CHAR)
    			 ,TIPO							VARCHAR2(100 CHAR)
     			 ,SUBTIPO						VARCHAR2(100 CHAR)
      			 ,COINCIDE_PEP_2022					VARCHAR2(100 CHAR)
      			 ,TIPO_GASTO						VARCHAR2(300 CHAR)
      			 ,SUBTIPO_GASTO					VARCHAR2(300 CHAR)
      			 ,CARTERA						VARCHAR2(300 CHAR)
