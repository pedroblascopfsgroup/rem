...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de la tabla auxiliar 'TMP_ACT_PLS_PLUSVALIA_REMVIP_6525'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TMP_ACT_PLS_PLUSVALIA_REMVIP_6525';
...
'(
	...
	FECHA_RECEPCION_PLUSVALIA		VARCHAR2(20 CHAR),
	FECHA_PRESENTACION_PLUSVALIA		VARCHAR2(20 CHAR),
	FECHA_PRESENTACION_RECURSO		VARCHAR2(20 CHAR),
	FECHA_RESPUESTA_RECURSO			VARCHAR2(20 CHAR),
	APERTURA_SEGUIMIENTO_EXPEDIENTE		VARCHAR2(20 CHAR),
	IMPORTE_PAGADO_PLUSVALIA		VARCHAR2(20 CHAR),
	GASTO_ASOCIADO				VARCHAR2(20 CHAR),
	MINUSVALIA				VARCHAR2(20 CHAR),
	EXENTO					VARCHAR2(20 CHAR),
	AUTOLIQUIDACION				VARCHAR2(20 CHAR)
