...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de la tabla auxiliar 'TMP_COM_COMPRADOR_REMVIP_6685'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TMP_COM_COMPRADOR_REMVIP_6685';
...
EXECUTE IMMEDIATE 
	...
	'(
		COM_DOCUMENTO		VARCHAR2(20 CHAR),	
		COM_ID            					VARCHAR2(20 CHAR),
		COM_ENVIADO     			VARCHAR2(20 CHAR)
	)'
	;
