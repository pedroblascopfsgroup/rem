...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de la tabla auxiliar 'TMP_INFO_COMERCIAL_REMVIP_6792'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TMP_INFO_COMERCIAL_REMVIP_6792';
...
EXECUTE IMMEDIATE 
	...
	'(
		ID_AAII		VARCHAR2(20 CHAR),	
		TIPO       	VARCHAR2(250 CHAR),
		TEXTO   	VARCHAR2(250 CHAR)
	)'
	;
