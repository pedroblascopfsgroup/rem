...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'TMP_DESCRIPCION_COMERCIAL_DISTRIBUCION_REMVIP_6793'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(75 CHAR) := 'TMP_DESCRIPCION_COMERCIAL_DISTRIBUCION_REMVIP_6793';
...
END IF;
/*DESCRIPCION_COMERCIAL      VARCHAR2(4000),
    DESCRIPCION_EDIFICIO       VARCHAR2(4000)    */
EXECUTE IMMEDIATE 
'CREATE TABLE '||V_ESQUEMA_1||'.'||V_TABLA||
'(
	NUM_ACTIVO                 VARCHAR2(50),
    DESCRIPCION_COMERCIAL      VARCHAR2(3000),
    DESCRIPCION_EDIFICIO       VARCHAR2(3000)    
)'
;
