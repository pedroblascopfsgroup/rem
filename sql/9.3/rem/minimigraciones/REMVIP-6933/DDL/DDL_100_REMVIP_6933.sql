...
--## INCIDENCIA_LINK=REMVIP_6933
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_6933'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(75 CHAR) := 'AUX_REMVIP_6933';
...
'(
	ACT_NUM_ACTIVO                  NUMBER(16,0),
    	ALQUILER_SOCIAL      		VARCHAR(50),
    	CESION_USO            		VARCHAR(50),
	TIPO_ALQUILER			VARCHAR(50)
)'
;
