...
--## INCIDENCIA_LINK=REMVIP_7010
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_7010'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(75 CHAR) := 'AUX_REMVIP_7010';
...
'(
	...
	DD_TPA_CODIGO				VARCHAR2(50),
	DD_SAC_CODIGO				VARCHAR2(50),
	PVE_COD_ORIGEN				NUMBER(16,0)
)'
;
