...
--## INCIDENCIA_LINK=REMVIP-7274
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_7274'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_7274';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DESC_ESTADO VARCHAR2(50 CHAR),
			ID_ESTADO NUMBER(16,0),
			DESC_TIPO VARCHAR2(50 CHAR),
			DESC_SUBTIPO VARCHAR2(50 CHAR),
			IMPORTE NUMBER(16,2),
