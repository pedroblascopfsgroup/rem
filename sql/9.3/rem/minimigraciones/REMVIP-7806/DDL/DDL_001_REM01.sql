...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_7806'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_7806';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ACT_VPO NUMBER(16,0),
			ADM_DESCALIFICADO NUMBER(16,0),
			DD_TPV_ID VARCHAR2 (50 CHAR),
			ADM_FECHA_CALIFICAION VARCHAR2 (50 CHAR),
			ADM_VIGENCIA VARCHAR2 (50 CHAR),
			ADM_NUM_ECPEDIENTE VARCHAR2 (50 CHAR),
			ADM_MAX_PRECIO_VENTA VARCHAR2 (50 CHAR)
		)'
;
