...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_7876'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_7876';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ACT_VPO VARCHAR2 (50 CHAR),
			ADM_DESCALIFICADO VARCHAR2 (50 CHAR),
			DD_TPV_ID VARCHAR2 (50 CHAR),
			ADM_FECHA_CALIFICACION VARCHAR2 (50 CHAR),
