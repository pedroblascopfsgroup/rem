...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8133'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8133';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			PARTIDA_PRESUPUESTARIA_ACTUAL VARCHAR2(100),
			PARTIDA_PRESUPUESTARIA_CORRECTA VARCHAR2(100)
		)'
;
