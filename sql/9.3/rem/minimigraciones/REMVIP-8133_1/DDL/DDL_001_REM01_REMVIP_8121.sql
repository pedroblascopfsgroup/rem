...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8133_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8133_1';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			GGE_FECHA_EAH VARCHAR2(100),
			DD_EAP_ID NUMBER( 16, 0 ),
			GGE_FECHA_EAP VARCHAR2(100),
			GGE_MOTIVO_RECHAZO_PROP VARCHAR2(100),
			GGE_FECHA_ENVIO_PRPTRIO VARCHAR2(100)
		)'
;
