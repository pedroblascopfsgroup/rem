...
DECLARE
   ...
   V_USUARIOMODIFICAR VARCHAR(100 CHAR):= 'REMVIP-8225';
   V_COUNT NUMBER(16):= 0;
   HORA_INI TIMESTAMP;
   HORA_FIN TIMESTAMP;
...
BEGIN
   ...
   LOOP
       ...
       REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-8225', PL_OUTPUT, FILA.ACT_ID, NULL, '02' );

       DBMS_OUTPUT.PUT_LINE(PL_OUTPUT); 
	
       PL_OUTPUT := '';

       REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-8225', PL_OUTPUT, FILA.ACT_ID, NULL, '01' );
