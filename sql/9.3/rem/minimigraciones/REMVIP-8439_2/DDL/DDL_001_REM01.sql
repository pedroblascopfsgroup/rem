...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8439_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8439_2';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DD_TPH_DESCRIPCION VARCHAR2 ( 50 CHAR ),
			GEX_PROVEEDOR NUMBER ( 16,0 ),
			DD_TCC_DESCRIPCION VARCHAR2 ( 50 CHAR ),
			GEX_IMPORTE_CALCULO NUMBER( 16,2 ),
			GEX_IMPORTE_FINAL NUMBER( 16,2 ),
			GEX_OBSERVACIONES VARCHAR2 ( 50 CHAR ),
			ID NUMBER(16)
		)'
;
