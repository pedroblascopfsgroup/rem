...
--## INCIDENCIA_LINK=REMVIP-8505
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8505'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8505';
...
EXECUTE IMMEDIATE '
		...
		(
			DOCIDENTIF VARCHAR2(50 CHAR),
			TPR_DESCRIPCION VARCHAR2(150 CHAR),
			NOMBRE	VARCHAR2(150 CHAR),		
			NOMBRE_COMERCIAL VARCHAR2(150 CHAR),	
			CREACION VARCHAR2(150 CHAR)	
		)'
;
