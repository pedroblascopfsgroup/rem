...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8512'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8512';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			NUM_GASTO_REM NUMBER(16),
			NUM_AGRUP_REM	NUMBER(16),		
			CIF VARCHAR2(50 CHAR),	
			PROVEEDOR VARCHAR2(150 CHAR),
			NUM_FACTURA VARCHAR2(50 CHAR),
			FECHA_CONTABILIZADO VARCHAR2(150 CHAR),
			FECHA_PAGADO VARCHAR2(150 CHAR)
		)'
;
