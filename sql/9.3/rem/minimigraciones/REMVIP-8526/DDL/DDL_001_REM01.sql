...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8526'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8526';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			VALOR_VENTA_HAYA NUMBER( 16,0 ),
			VALOR_RENTA_HAYA  NUMBER( 16,0 ),
			FECHA_VALOR_VENTA VARCHAR2(50 CHAR),
			VALOR_VENTA_HET  NUMBER( 16,0 ),
			LIQUIDEZ VARCHAR2 (10 CHAR)			
		)'
;
