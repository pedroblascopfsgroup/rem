...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8542_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8542_1';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			ICO_DESCRIPCION VARCHAR2( 4000 BYTE ),
			ICO_INFO_DISTRIBUCION_INTERIOR VARCHAR2( 1000 CHAR )
		)'
;
