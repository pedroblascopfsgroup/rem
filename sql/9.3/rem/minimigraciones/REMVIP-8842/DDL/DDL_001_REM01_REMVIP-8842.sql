...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8842'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8842';
...
EXECUTE IMMEDIATE '
		...
		(	
			...
			DESCRIPCION VARCHAR2(3200 CHAR),
			UNIDAD VARCHAR2(80 CHAR),
			TARIFA NUMBER(16,2),
			TARIFA_CLIENTE NUMBER(16,2),
			TARIFARIO VARCHAR2(100 CHAR)
		)'
;
