...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8880_1'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8880_1';
...
EXECUTE IMMEDIATE '
		...
		(			
				COD_SUBTIPO_TRABAJO VARCHAR2 (50 CHAR),
				PROVEEDOR VARCHAR2 (250 CHAR),
				COD_PROVEEDOR VARCHAR2 (50 CHAR),
				TARIFA_DESCRIPCION VARCHAR2 (250 CHAR),
				TARIFA_CODIGO VARCHAR2 (50 CHAR)
		)'
;
