...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_9283'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_9283';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			FECHA_VAL_ACTUAL VARCHAR2(20 CHAR),
			FECHA_VAL_DATA VARCHAR2(20 CHAR),
			FECHA_HORA_DATA VARCHAR2(50 CHAR),
			AREA_PETICIONARIA VARCHAR2(50 CHAR)
		)'
;
