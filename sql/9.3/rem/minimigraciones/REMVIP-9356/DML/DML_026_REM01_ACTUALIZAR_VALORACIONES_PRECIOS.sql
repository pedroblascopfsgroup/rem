...
DECLARE
    ...
    --Nº ACTIVO -PRECIO VENTA WEB-VALOR TASACIÓN-FECHA TASACIÓN
		T_TIPO_DATA('7461428','0,01','',''),
		T_TIPO_DATA('7461427','0,01','',''),
		T_TIPO_DATA('7461429','0,01','',''),
		T_TIPO_DATA('7461430','0,01','',''),
		T_TIPO_DATA('7461431','0,01','',''),
		T_TIPO_DATA('7461432','0,01','',''),
		T_TIPO_DATA('7461487','0,01','',''),
		T_TIPO_DATA('7461488','0,01','',''),
		T_TIPO_DATA('7461489','0,01','',''),
		T_TIPO_DATA('7461490','0,01','',''),
		T_TIPO_DATA('7461491','0,01','','')
