...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_9531'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_9531';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			DOC_IDENTIF VARCHAR2 (200 CHAR),
			CODIGO_REM NUMBER(16,0),
			PVE_ID_PERSONA VARCHAR2 (50 CHAR)
		)'
;
