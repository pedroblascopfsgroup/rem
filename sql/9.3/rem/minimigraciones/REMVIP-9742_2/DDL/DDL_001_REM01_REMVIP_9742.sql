...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_9742_2'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_9742_2';
...
EXECUTE IMMEDIATE '
		...
		(
			...
			SPS_ALARMA NUMBER(1,0),
			SPS_FECHA_INSTALA_ALARMA DATE,
			SPS_FECHA_DESINSTALA_ALARMA DATE,
			SPS_VIGILANCIA NUMBER(1,0),
			SPS_FECHA_INSTALA_VIGILANCIA DATE,
			SPS_FECHA_DESINSTALA_VIGIL DATE
		)'
;
