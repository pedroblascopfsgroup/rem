...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_9782_PARAM'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_9782_PARAM';
...
EXECUTE IMMEDIATE '
		...
		(
			TGA_DESCRIPCION VARCHAR2(250 CHAR),
			STG_DESCRIPCION VARCHAR2(250 CHAR),
			C_BASE VARCHAR2 (200 CHAR),
			C_INTERES VARCHAR2 (200 CHAR),
			C_COSTAS VARCHAR2 (200 CHAR),
			C_RECARGO VARCHAR2 (200 CHAR)
		)'
;
