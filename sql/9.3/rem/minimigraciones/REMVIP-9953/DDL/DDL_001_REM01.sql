...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_9953'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_9953';
...
EXECUTE IMMEDIATE '
		...
		(
			DataID VARCHAR2(250 CHAR),
			tipo_expediente VARCHAR2(250 CHAR),
			clase_expediente VARCHAR2(250 CHAR),
			id_activo VARCHAR2(250 CHAR),
			id_externo VARCHAR2(250 CHAR),
			id_sistema_origen VARCHAR2(250 CHAR),
			cliente VARCHAR2(250 CHAR),
			Creado_por VARCHAR2(250 CHAR)
		)'
;
