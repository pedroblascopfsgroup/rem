...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('CREATE OR REPLACE VIEW '|| V_ESQUEMA ||'.V_FECHA_POSESION_ACTIVO...');
  EXECUTE IMMEDIATE 'CREATE OR REPLACE VIEW ' || V_ESQUEMA || '.V_FECHA_POSESION_ACTIVO 
	AS    
    ...
    SELECT DISTINCT ACT.ACT_ID,
        ...
        CASE WHEN CRA.DD_CRA_CODIGO !=''03'' THEN
            ...
            LEFT JOIN '|| V_ESQUEMA ||'.DD_ETP_ESTADO_POSESORIO ETP ON ETP.DD_ETP_ID = CBX.DD_ETP_ID AND ETP.BORRADO = 0
