...
BEGIN
  ...
  AS
    ...
    SELECT TED.GPV_ID
        ...
        , CASE WHEN NVL(SUJ.SUJETO, 0) > 0 THEN SUJ.SUJETO                   WHEN (NVL(NSU.NO_SUJETO, 0) + NVL(SUE.SUJETO_EXENTO, 0)) > 0 THEN NSU.NO_SUJETO + SUE.SUJETO_EXENTO ELSE NULL END DIARIO1_BASE
        ...
        , CASE WHEN NVL(SUJ.SUJETO, 0) = 0 THEN NULL                         WHEN (NVL(NSU.NO_SUJETO, 0) + NVL(SUE.SUJETO_EXENTO, 0)) > 0 THEN NSU.NO_SUJETO + SUE.SUJETO_EXENTO ELSE NULL END DIARIO2_BASE
