  ...
  AS
    WITH TIPO_DIARIO AS (
        ...
        SELECT GLD.GPV_ID, GLD.GLD_ID
            ...
            , ROW_NUMBER() OVER(PARTITION BY GLD.GPV_ID ORDER BY NVL(GLD.GLD_IMP_IND_TIPO_IMPOSITIVO, 0) DESC) RN
        ...
        SELECT GLD.GPV_ID
            ...
            , CASE WHEN SUM(NVL(GLD.GLD_PRINCIPAL_SUJETO, 0)) > 0 THEN TEF.TIPO_IMPOSITIVO_EFECTIVO ELSE 0 END TIPO_IMPOSITIVO_EFECTIVO
        FROM '||V_ESQUEMA||'.GLD_GASTOS_LINEA_DETALLE GLD
