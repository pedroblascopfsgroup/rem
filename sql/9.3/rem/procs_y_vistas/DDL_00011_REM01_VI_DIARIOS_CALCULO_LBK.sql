  ...
  AS
    WITH CARTERA_LIBERBANK AS (
        ...
        SELECT GLD.GPV_ID
            ...
            , CASE WHEN SUM(NVL(GLD.GLD_PRINCIPAL_SUJETO, 0)) > 0 THEN ROUND(SUM(NVL(GLD.GLD_IMP_IND_CUOTA, 0)) / SUM(NVL(GLD.GLD_PRINCIPAL_SUJETO, 0)) * 100, 2) ELSE 0 END TIPO_IMPOSITIVO_EFECTIVO
