  ...
  EXECUTE IMMEDIATE 'CREATE VIEW V_LISTADO_ACT_EXP_BBVA_GRID AS 
       ...
       MINI AS (
        ...
        CASE 
            ...
            ELSE 0
        END AS CONDICIONES,
        ACT.ACT_NUM_ACTIVO, TPA.DD_TPA_DESCRIPCION, SAC.DD_SAC_DESCRIPCION, LOC.DD_LOC_DESCRIPCION,BIE.BIE_LOC_DIRECCION,SIN_BBVA.DD_SIN_DESCRIPCION BBVA_ACTIVO_EPA
        FROM '|| V_ESQUEMA ||'.ECO_EXPEDIENTE_COMERCIAL ECO
        JOIN '|| V_ESQUEMA ||'.ACT_OFR OFR ON ECO.OFR_ID = OFR.OFR_ID
		...
		LEFT JOIN '|| V_ESQUEMA_M ||'.DD_SIN_SINO SIN_BBVA ON ACTB.BBVA_ACTIVO_EPA = SIN_BBVA.DD_SIN_ID AND SIN_BBVA.BORRADO = 0
  ';
