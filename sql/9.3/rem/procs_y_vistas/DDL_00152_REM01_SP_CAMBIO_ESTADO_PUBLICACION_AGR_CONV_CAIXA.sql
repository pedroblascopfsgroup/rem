...
create or replace PROCEDURE       SP_CAMBIO_ESTADO_PUBLI_AGR_CONV_CAIXA (pAGR_ID IN NUMBER DEFAULT NULL
...
ELSE
 ...
 END IF;
  ...
  BEGIN
      ...
      LOOP
        ...
        IF vDD_TCO_CODIGO IN ('02','03','04') THEN
          IF (vCODIGO_ESTADO_A = '03' AND vCHECK_PUBLICAR_A = 1) THEN
            #ESQUEMA#.SP_MOTIVO_OCULTACION_AGR_CONV_CAIXA (nAGR_ID, 'A', OutOCULTAR, OutMOTIVO);
        ...
        IF vDD_TCO_CODIGO IN ('01','02') THEN
          IF (vCODIGO_ESTADO_V = '03' AND vCHECK_PUBLICAR_V = 1) THEN
            #ESQUEMA#.SP_MOTIVO_OCULTACION_AGR_CONV_CAIXA (nAGR_ID, 'V', OutOCULTAR, OutMOTIVO);
	...
	END SP_CAMBIO_ESTADO_PUBLI_AGR_CONV_CAIXA;
