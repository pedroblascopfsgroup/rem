...
--##	      0.29 Tipo/subtipo, CLASE_USO PRIORIZA ANTES DE CLASE_USO_REGISTRAL [REMVIP-12804] - IVAN REPISO
--##########################################
--*/
       ...
       V_MSQL := ' MERGE INTO '|| V_ESQUEMA ||'.ACT_ACTIVO act
            using (           
                  ...
                  CASE
                     ...
                     WHEN AUX.CLASE_USO IS NULL AND SAC_REG.DD_TPA_ID IS NOT NULL THEN SAC_REG.DD_TPA_ID
                     ELSE TPA.DD_TPA_ID
                  END DD_TPA_ID,
                  CASE 
                     ...
                     WHEN AUX.CLASE_USO IS NULL AND SAC_REG.DD_SAC_ID IS NOT NULL THEN SAC_REG.DD_SAC_ID
                  ...
                  LEFT JOIN '|| V_ESQUEMA ||'.DD_SAC_SUBTIPO_ACTIVO SAC_REG ON SAC_REG.DD_SAC_CODIGO = eqv4.DD_CODIGO_REM
                  ...
                  LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM eqv11 ON eqv11.DD_NOMBRE_CAIXA = ''TIPO_ACTIVO'' AND eqv11.DD_CODIGO_CAIXA = NVL(aux.CLASE_USO,aux.CLASE_USO_REGISTRAL) AND eqv11.BORRADO = 0
                  ...
                  LEFT JOIN '|| V_ESQUEMA ||'.DD_SAC_SUBTIPO_ACTIVO SAC_USO ON SAC_USO.DD_SAC_CODIGO = EQV12.DD_CODIGO_REM
