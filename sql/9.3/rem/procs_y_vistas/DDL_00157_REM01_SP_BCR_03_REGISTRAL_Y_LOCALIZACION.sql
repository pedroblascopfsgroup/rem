...
BEGIN
      ...
      V_MSQL := 'MERGE INTO '|| V_ESQUEMA ||'.BIE_LOCALIZACION BIE_LOC
                  ...
                  LEFT JOIN REMMASTER.DD_TVI_TIPO_VIA TVI ON TVI.DD_TVI_CODIGO = EQV.DD_CODIGO_REM AND TVI.BORRADO = 0
                  ...
                  LEFT JOIN REMMASTER.DD_PRV_PROVINCIA PRV ON PRV.DD_PRV_CODIGO = EQV.DD_CODIGO_REM AND PRV.BORRADO = 0
     ...
     SALIDA := SALIDA || '   [INFO] ACTUALIZADOS '|| SQL%ROWCOUNT|| CHR(10);
      ...
      V_MSQL := 'MERGE INTO '|| V_ESQUEMA ||'.ACT_LOC_LOCALIZACION ACT_LOC
                  ...
                  , APR.X_GOOGLE LOC_LONGITUD
                  , APR.Y_GOOGLE LOC_LATITUD
