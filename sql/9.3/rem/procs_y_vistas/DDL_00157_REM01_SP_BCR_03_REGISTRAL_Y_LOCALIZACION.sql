...
--##	      0.17 Añadimos REG_SUPERFICIE_ALQUILABLE - HREOS-18641 - Alejandro Valverde
--##	      0.18 Modificar el campo SUP_REG_ALQUILABLE por SUP_ALQUILABLE - HREOS-18690 - Alejandro Valverde
--##########################################
--*/
...
BEGIN
      ...
      V_MSQL := 'MERGE INTO '|| V_ESQUEMA ||'.ACT_REG_INFO_REGISTRAL REG
                  ...
                  , NVL(APR.SUP_ALQUILABLE, REG.REG_SUPERFICIE_ALQUILABLE)/100 REG_SUPERFICIE_ALQUILABLE
                  FROM '|| V_ESQUEMA ||'.AUX_APR_BCR_STOCK APR
                  JOIN '|| V_ESQUEMA ||'.ACT_ACTIVO ACT ON ACT.ACT_NUM_ACTIVO_CAIXA = APR.NUM_IDENTIFICATIVO AND ACT.BORRADO = 0
                  JOIN '|| V_ESQUEMA ||'.BIE_BIEN BIE ON ACT.BIE_ID = BIE.BIE_ID AND BIE.BORRADO = 0
		   ...
		   , REG.REG_SUPERFICIE_ALQUILABLE = AUX.REG_SUPERFICIE_ALQUILABLE
