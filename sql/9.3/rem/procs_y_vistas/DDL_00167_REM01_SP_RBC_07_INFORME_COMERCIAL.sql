...
--1º Merge tabla AUX_APR_RBC_STOCK
	...
	USING (			
           SELECT
            ...
            LEFT JOIN '|| V_ESQUEMA_M ||'.DD_SIN_SINO SIN_CALEF ON SIN_CALEF.DD_SIN_ID = ICO.ICO_CALEFACCION  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV2 ON EQV2.DD_NOMBRE_CAIXA = ''CALEFACCION'' AND EQV2.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV2.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA_M ||'.DD_SIN_SINO SIN_COC ON SIN_COC.DD_SIN_ID = ICO.ICO_COCINA_AMUEBLADA  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV3 ON EQV3.DD_NOMBRE_CAIXA = ''COCINA_EQUIPADA'' AND EQV3.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV3.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA ||'.DD_DIS_DISPONIBILIDAD DIS_JAR ON DIS_JAR.DD_DIS_ID = ICO.ICO_JARDIN  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV4 ON EQV4.DD_NOMBRE_CAIXA = ''JARDIN'' AND EQV4.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV4.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA ||'.DD_DIS_DISPONIBILIDAD DIS_USO_JAR ON DIS_USO_JAR.DD_DIS_ID = ICO.ICO_JARDIN  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV5 ON EQV5.DD_NOMBRE_CAIXA = ''USO_JARDIN'' AND EQV5.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV5.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA ||'.DD_DIS_DISPONIBILIDAD DIS_PISC ON DIS_PISC.DD_DIS_ID = ICO.ICO_PISCINA  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV6 ON EQV6.DD_NOMBRE_CAIXA = ''PISCINA'' AND EQV6.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV6.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA_M ||'.DD_SIN_SINO SIN_HUM ON SIN_HUM.DD_SIN_ID = ICO.ICO_SALIDA_HUMOS  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV7 ON EQV7.DD_NOMBRE_CAIXA = ''SALIDA_HUMOS'' AND EQV7.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV7.BORRADO=0
            LEFT JOIN '|| V_ESQUEMA_M ||'.DD_SIN_SINO SIN_TER ON SIN_TER.DD_SIN_ID = ICO.ICO_TERRAZA  
            LEFT JOIN '|| V_ESQUEMA ||'.DD_EQV_CAIXA_REM EQV8 ON EQV8.DD_NOMBRE_CAIXA = ''TERRAZA'' AND EQV8.DD_CODIGO_REM = ECV.DD_ECV_CODIGO AND EQV8.BORRADO=0
