...
--1º Merge tabla AUX_APR_RBC_STOCK
   ...
   SALIDA := SALIDA || '   [INFO] ACTUALIZADOS '|| SQL%ROWCOUNT|| CHR(10);
	...
	USING (WITH FEC_INF AS (
            ...
            , TO_CHAR(FEC_FIN.HFP_FECHA_INI,''YYYYMMDD'') FEC_COMERCIAL_SERVICER
            ...
            LEFT JOIN FEC_INF FASE_ANT ON FASE_ANT.ACT_ID = ACT.ACT_ID AND FASE_ANT.RN > 1 AND FEC_INI.DD_FSP_CODIGO = ''05''
