...
create or replace PROCEDURE       #ESQUEMA#.SP_EXT_GASTOS_REPERCUTIBLES_CAIXA (
...
V_NOMBRESP VARCHAR2(50 CHAR) := 'SP_EXT_GASTOS_REPERCUTIBLES_CAIXA';			-- Nombre del SP.
...
EXCEPTION
   WHEN OTHERS THEN
	  ...
	  COMMIT;
      RAISE;
END SP_EXT_GASTOS_REPERCUTIBLES_CAIXA;
/
EXIT;
