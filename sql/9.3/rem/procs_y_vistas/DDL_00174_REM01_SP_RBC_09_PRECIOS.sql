...
--1º Merge tabla AUX_APR_RBC_STOCK
   DBMS_OUTPUT.PUT_LINE('[INFO] 1 MERGE A LA TABLA AUX_APR_RBC_STOCK.');
    ...
    V_MSQL := 'MERGE INTO REM01.AUX_APR_RBC_STOCK AUX
		USING (
			SELECT ACT.ACT_NUM_ACTIVO_CAIXA NUM_IDENTIFICATIVO, VAL.VAL_IMPORTE 
		    ...
		    WHERE TPC.DD_TPC_CODIGO = ''12'' AND ACT.BORRADO = 0 AND CRA.DD_CRA_CODIGO = ''03'' AND ACT.ACT_NUM_ACTIVO_CAIXA IS NOT NULL
