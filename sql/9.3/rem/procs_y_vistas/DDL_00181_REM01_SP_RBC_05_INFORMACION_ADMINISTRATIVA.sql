...
--1º Merge tabla AUX_APR_RBC_STOCK
	...
	USING (			
           SELECT
            ...
            , CASE WHEN ADM.COMPRADOR_ACOJE_AYUDA = 1 THEN ''S'' ELSE ''N'' END IND_COMPRADOR_ACOGE_AYUDA
            , ADM.IMPORTE_AYUDA_FINANCIACION*100 IMP_AYUDA_FINANCIACION
            , TO_CHAR(ADM.FECHA_VENCIMIENTO_AVAL_SEGURO,''YYYYMMDD'') FEC_VENCIMIENTO_SEGURO
            , TO_CHAR(ADM.FECHA_DEVOLUCION_AYUDA,''YYYYMMDD'') FEC_DEVOLUCION_AYUDA
