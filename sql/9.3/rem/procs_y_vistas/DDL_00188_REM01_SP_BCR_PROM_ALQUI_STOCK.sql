...
DBMS_OUTPUT.PUT_LINE('[INFO] 3.3 DAR DE BAJA LAS AGRUPACIONES DE ESOS ACTIVOS ');  
SALIDA := SALIDA ||'[INFO] 3.3 DAR DE BAJA LAS AGRUPACIONES DE ESOS ACTIVOS'||CHR(10);
...
DBMS_OUTPUT.PUT_LINE('[INFO] 5.3 CALCULAR LAS PARTICIPACIONES DE LAS UAs CUANDO ALGUNA DE ELLAS SE HA BORRADO'); 
SALIDA := SALIDA ||'[INFO] 5.3 CALCULAR LAS PARTICIPACIONES DE LAS UAs CUANDO ALGUNA DE ELLAS SE HA BORRADO'||CHR(10);
