...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW '|| V_ESQUEMA ||'.V_ALERTAS_PUBLICACION 
	...
	CASE WHEN COND.PENDIENTE_INSCRIPCION = 1 THEN 0 ELSE 1 END AS ALERTA_INSCRIPCION,
	COND.CON_CARGAS AS ALERTA_CARGAS,                   
	COND.SIN_TOMA_POSESION_INICIAL AS ALERTA_POSESION,     
	NVL2 (TAL.DD_TAL_ID, 1, 0) AS ALERTA_TIPO_ALQUILER,                   
	...
	LEFT JOIN '|| V_ESQUEMA ||'.V_COND_DISPONIBILIDAD COND ON COND.ACT_ID = ACT.ACT_ID 
	WHERE ACT.BORRADO = 0';
