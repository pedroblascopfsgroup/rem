...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW '|| V_ESQUEMA ||'.V_CONF_ALERTAS_PUBLICACION 
	...
	CASE WHEN (T1.ALERTA_ALQUILER * T2.ALQUILADO) = 1 OR (T1.ALERTA_TIPO_ALQUILER * T2.TIPO_ALQUILER) = 1 OR (T1.ALERTA_OKUPADO * T2.OCUPADO) = 1 OR (T1.ALERTA_TCO_ALQUILER * T2.TCO_ALQUILER * T1.ALERTA_OKUPADO) = 1 THEN 1 ELSE 0 END AS INDICADOR_1,
