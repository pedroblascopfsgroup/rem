...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW '|| V_ESQUEMA ||'.V_CONF_ALERTAS_PUBLICACION 
	...
	OR (T1.CARTERA NOT IN (''BANKIA'', ''SAREB'',''CAJAMAR'',''LIBERBANK'') AND ((T1.CARTERA <> T2.CARTERA AND T1.CARTERA <> ''CERBERUS'') OR (T1.CARTERA =''CERBERUS'' AND T1.SUBCARTERA  NOT IN (''APPLE - INMOBILIARIO'',''DIVARIAN REMAINING INMB'',''DIVARIAN ARROW INMB'',''JAIPUR - FINANCIERO'',''AIPUR - INMOBILIARIO'')))  AND T2.CARTERA = ''OTRA CARTERA'') 
	';
