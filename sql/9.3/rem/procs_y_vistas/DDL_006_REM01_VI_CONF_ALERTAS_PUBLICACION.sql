...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW '|| V_ESQUEMA ||'.V_CONF_ALERTAS_PUBLICACION 
	...
	ON (T1.CARTERA = T2.CARTERA AND T1.CARTERA <> ''CERBERUS'' AND T1.CARTERA = ''BANKIA''  AND T2.TIPO_TITULO IS NULL AND T1.TIPO_TITULO <> ''Adjudicación no judicial'')
   	OR (T1.CARTERA = T2.CARTERA AND T1.CARTERA <> ''CERBERUS'' AND T1.CARTERA = ''BANKIA'' AND T1.TIPO_TITULO = T2.TIPO_TITULO AND T2.TIPO_TITULO IS NOT NULL AND T1.TIPO_TITULO = ''Adjudicación no judicial'')  
    	OR (T1.CARTERA = T2.CARTERA AND T1.CARTERA <> ''CERBERUS'' AND T1.CARTERA <> ''BANKIA'' AND T2.TIPO_TITULO IS NULL ) 
