...
BEGIN
  ...
  EXECUTE IMMEDIATE 'CREATE VIEW ' || V_ESQUEMA || '.VI_ELEMENTOS_LINEA_DETALLE ("GLD_ENT_ID", "GLD_ID", "TIPOENTIDAD_COD", "TIPOENTIDAD_DESC", "ENTIDAD", "GLD_PARTICIPACION_GASTO", "GLD_REFERENCIA_CATASTRAL", "ACTIVO", "DIRECCION", "TIPOACTIVO",  "IMPORTE_PROPORCIONAL_TOTAL", "GPV_ID", "DESCRIPCION_LINEA", "GLD_IMPORTE_TOTAL", "BBVA_LINEA_FACTURA", "IMPORTE_SUJETO_TOTAL", "IMPORTE_PROPORCIONAL_SUJETO", "ESTADOALQ_COD", "ESTADOALQ_DESC", "TIPOCOMERC_COD", "TIPOCOMERC_DESC", "TIPOTRANS_COD", "TIPOTRANS_DESC", "GRUPO", "TIPO", "SUBTIPO", "PRIM_TOMA_POSESION", "SUBPARTEDIF_COD", "SUBPARTEDIF_DESC", "ELEMENTO_PEP") AS 
  SELECT
			GLDENT.GLD_ENT_ID,
            GLDENT.GLD_ID,                            
