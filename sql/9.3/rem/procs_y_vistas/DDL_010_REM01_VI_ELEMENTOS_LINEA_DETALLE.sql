...
BEGIN
  ...
  "ACTIVO", "DIRECCION", "TIPOACTIVO",  "IMPORTE_PROPORCIONAL_TOTAL", "GPV_ID", "DESCRIPCION_LINEA", "GLD_IMPORTE_TOTAL") AS 
  SELECT
			GLDENT.GLD_ENT_ID,
            GLDENT.GLD_ID,                            
            ENT.DD_ENT_CODIGO AS TIPOENTIDAD_COD ,
            ENT.DD_ENT_DESCRIPCION AS TIPOENTIDAD_DESC,
            CASE WHEN( ACT.ACT_NUM_ACTIVO IS NOT NULL)
                THEN ACT.ACT_NUM_ACTIVO
                ELSE GLDENT.ENT_ID
            END ENTIDAD,
            GLDENT.GLD_PARTICIPACION_GASTO,          
            GLDENT.GLD_REFERENCIA_CATASTRAL,
            ACT.ACT_NUM_ACTIVO AS ACTIVO,
