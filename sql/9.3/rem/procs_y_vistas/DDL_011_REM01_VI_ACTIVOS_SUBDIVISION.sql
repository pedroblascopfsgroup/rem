  ...
  FROM (SELECT SUBD.ID, SUBD.ACT_ID, SUBD.ACT_NUM_ACTIVO, SUBD.BIE_DREG_NUM_FINCA, TPA.DD_TPA_DESCRIPCION, SAC.DD_SAC_DESCRIPCION, SUBD.DD_AIC_DESCRIPCION
          FROM (SELECT   ACT.ACT_ID, ACT.ACT_NUM_ACTIVO, ACT.DD_TPA_ID, ACT.DD_SAC_ID, BIEDREG.BIE_DREG_NUM_FINCA, AIC.DD_AIC_DESCRIPCION,
                    ...
                    FROM '|| V_ESQUEMA ||'.ACT_ICO_INFO_COMERCIAL ICO 
                        ...
                        WHERE ICO.BORRADO = 0
                        GROUP BY ACT.ACT_ID, ACT.ACT_NUM_ACTIVO, ACT.DD_TPA_ID, ACT.DD_SAC_ID, BIEDREG.BIE_DREG_NUM_FINCA, AIC.DD_AIC_DESCRIPCION, ICO.ICO_NUM_PLANTAS, ICO.ICO_NUM_DORMITORIOS,ICO.ICO_NUM_BANYOS) SUBD
		...
		JOIN ACT_AGA_AGRUPACION_ACTIVO AGA ON AGA.ACT_ID = ACT_SD.ACT_ID AND (AGA.BORRADO IS NULL OR AGA.BORRADO = 0)
