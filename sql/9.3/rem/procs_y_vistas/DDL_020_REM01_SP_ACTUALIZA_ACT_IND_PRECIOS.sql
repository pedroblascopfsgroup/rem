...
create or replace PROCEDURE ACTUALIZA_ACT_IND_PRECIOS (P_DD_CRA_ID IN REM01.ACT_ACTIVO.DD_CRA_ID%TYPE DEFAULT NULL
    ...
    dACT_FECHA_IND_REPRECIAR   #ESQUEMA#.ACT_ACTIVO.ACT_FECHA_IND_REPRECIAR%TYPE;
    dACT_FECHA_IND_DESCUENTO #ESQUEMA#.ACT_ACTIVO.ACT_FECHA_IND_DESCUENTO%TYPE;
    
    vDD_CIP_TEXTO                       #ESQUEMA#.DD_CIP_CONDIC_IND_PRECIOS.DD_CIP_TEXTO%TYPE;
    Aux_DD_CIP_TEXTO                 VARCHAR2(32000 CHAR);
    nDD_TPP_ID                             #ESQUEMA#.CCP_CARTERA_CONDIC_PRECIOS.DD_TPP_ID%TYPE;
    nDD_CRA_ID                            #ESQUEMA#.ACT_ACTIVO.DD_CRA_ID%TYPE;
    vDD_TPP_CODIGO                    #ESQUEMA#.DD_TPP_TIPO_PROP_PRECIO.DD_TPP_ID%TYPE; 
    vACT_FECHA_IND                     VARCHAR2(50 CHAR);
    vDD_CRA_DESCRIPCION            #ESQUEMA#.DD_CRA_CARTERA.DD_CRA_DESCRIPCION%TYPE;
