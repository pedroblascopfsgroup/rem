...
--##		0.28 Versión Jesus J -> REMVIP-11865 - Eliminar campos WS Activo
--##        0.29 Añadir campos concurrencia - Vicente Martinez - [HREOS-18353]
--##		0.30 Versión IRC -> REMVIP-12573 - Añadimos codEstadoRegistralActivo del activo
--##########################################
--*/
...
BEGIN/*Versión 0.18*/
	...
	AS
		...
		CASE ASCE.DD_SIN_CODIGO
			...
			ELSE NULL
		END 																				AS ASCENSOR,
		CAST(ICO.ICO_NUM_DORMITORIOS  AS NUMBER(16,0))  									AS DORMITORIOS,
		CAST(ICO.ICO_NUM_BANYOS  AS NUMBER(16,0)) 											AS BANYOS,
		CAST(ICO.ICO_NUM_ASEOS  AS NUMBER(16,0)) 											AS ASEOS,
		CAST(ICO.ICO_NUM_GARAJE  AS NUMBER(16,0))											AS GARAJES,
		...
		CAST(ICO.ICO_DESCRIPCION AS VARCHAR2(4000 CHAR))									AS DESCRIPCION,
		...
		CAST(PIVOT_AGR.OBRA_NUEVA_PISO_PILOTO AS NUMBER(1,0))	  							AS ES_PISO_PILOTO,
       ...
       v.descripcion_otros																	AS descripcion_otros,
		...
		CAST(GALQ.NOMBRE AS VARCHAR2(60 CHAR)) 														AS NOMBRE_GESTOR_COMERCIAL_ALQUILER,
