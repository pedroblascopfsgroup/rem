...
BEGIN/*Versión 0.18*/
	...
	AS
       ...
       v.descripcion_otros																	AS descripcion_otros,
        ...
        CAST(TDC.DD_TDC_CODIGO AS VARCHAR2(5 CHAR))	 												AS COD_DIR_COMERCIAL,
        CASE WHEN (SPS.SPS_OCUPADO = 1 AND SPS.DD_TPA_ID IN (SELECT DD_TPA_ID FROM '||V_ESQUEMA||'.DD_TPA_TIPO_TITULO_ACT WHERE DD_TPA_CODIGO IN (''02'',''03'')) OR ACT.ACT_ID IN (SELECT ACTOFR.ACT_ID FROM '||V_ESQUEMA||'.ACT_OFR ACTOFR
