--/*
--##########################################
--## AUTOR=Juan Jose Sanjuan Cortina
...
BEGIN
   ...
   -- Creamos vista materializada
	...
	AS
		...
		CAST(OFR.OFR_SALESFORCE_COD AS NUMBER(16,0)) 											AS COD_OFERTA_SALESFORCE,
		...
		CAST(OFR.OFR_ORIGEN_OFERTA AS VARCHAR2(5 CHAR))											AS COD_ORIGEN_OFERTA,
