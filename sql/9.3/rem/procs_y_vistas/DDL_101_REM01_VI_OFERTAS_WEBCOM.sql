...
--##        0.11 Añadir campo ESTADO DEPOSITO - IRC - [REMVIP-12638]
--##########################################
--*/
...
BEGIN
   ...
   -- Creamos vista materializada
	...
	MRO.DD_MRO_DESCRIPCION 																		AS MOTIVO_RECHAZO,
		...
		CAST(DDEDP.DD_EDP_CODIGO AS VARCHAR2(5 CHAR)) 										AS COD_ESTADO_DEPOSITO
		...
		LEFT JOIN '||V_ESQUEMA||'.DEP_DEPOSITO DEP ON OFR.OFR_ID = DEP.OFR_ID AND DEP.BORRADO = 0
		LEFT JOIN '||V_ESQUEMA||'.CVC_CUENTAS_VIRTUALES CVC ON OFR.CVC_ID = CVC.CVC_ID
		LEFT JOIN '||V_ESQUEMA||'.DD_EDP_EST_DEPOSITO DDEDP ON DDEDP.DD_EDP_ID = DEP.DD_EDP_ID AND DDEDP.BORRADO = 0
