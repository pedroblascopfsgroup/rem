...
BEGIN
   ...
   -- Creamos vista materializada
	...
	AS
		...
		CAST(OFR.OFR_ORIGEN_OFERTA AS VARCHAR2(5 CHAR))										AS ORIGEN_OFERTA,
		CAST(OFR.OFR_MESES_CARENCIA AS NUMBER(16,2))											AS MESES_CARENCIA,
		CAST(OFR.OFR_CONTRATO_RESERVA AS NUMBER(1,0))											AS CONTRATO_RESERVA,
		CAST(OFR.OFR_MOTIVO_CONGELACION AS VARCHAR2(250 CHAR))									AS MOTIVO_CONGELACION,
		CAST(OFR.OFR_IBI AS NUMBER(1,0))												AS IBI,
		CAST(OFR.OFR_IMPORTE_IBI AS NUMBER(16,2))											AS IMPORTE_IBI,
		CAST(OFR.OFR_OTRAS_TASAS AS NUMBER(1,0))											AS OTRAS_TASAS,
		CAST(OFR.OFR_IMPORTE_OTRAS_TASAS AS NUMBER(16,2))										AS IMPORTE_OTRAS_TASAS,
		CAST(OFR.OFR_CCPP AS NUMBER(1,0))												AS CCPP,
		CAST(OFR.OFR_IMPORTE_CCPP AS NUMBER(16,2))											AS IMPORTE_CCPP,
		CAST(OFR.OFR_PORCENTAJE_1_ANYO AS NUMBER(16,2))										AS PORCENTAJE_1_ANYO,
		CAST(OFR.OFR_PORCENTAJE_2_ANYO AS NUMBER(16,2))										AS PORCENTAJE_2_ANYO,
		CAST(OFR.OFR_PORCENTAJE_3_ANYO AS NUMBER(16,2))										AS PORCENTAJE_3_ANYO,
		CAST(OFR.OFR_PORCENTAJE_4_ANYO AS NUMBER(16,2))										AS PORCENTAJE_4_ANYO,
		CAST(OFR.OFR_MESES_CARENCIA_CTRAOFR AS NUMBER(16,2))										AS MESES_CARENCIA_CTRAOFR,
		CAST(OFR.OFR_PORCENTAJE_1_ANYO_CTRAOFR AS NUMBER(16,2))									AS PORCENTAJE_1_ANYO_CTRAOFR,
		CAST(OFR.OFR_PORCENTAJE_2_ANYO_CTRAOFR AS NUMBER(16,2))									AS PORCENTAJE_2_ANYO_CTRAOFR,
		CAST(OFR.OFR_PORCENTAJE_3_ANYO_CTRAOFR AS NUMBER(16,2))									AS PORCENTAJE_3_ANYO_CTRAOFR,
		CAST(OFR.OFR_PORCENTAJE_4_ANYO_CTRAOFR AS NUMBER(16,2))									AS PORCENTAJE_4_ANYO_CTRAOFR
