   ...
   -- Creamos vista materializada
	...
	AS
		...
		FROM(
		    ...
		    WHERE (DDTAG.DD_TAG_CODIGO IN (''01'',''13'',''02'',''17'',''18'') OR (DDTAG.DD_TAG_CODIGO = ''16'' AND AGA.AGA_PRINCIPAL = 0)) AND (AGA.BORRADO IS NULL OR AGA.BORRADO = 0) AND AGR.BORRADO = 0
		) ACT_SD
