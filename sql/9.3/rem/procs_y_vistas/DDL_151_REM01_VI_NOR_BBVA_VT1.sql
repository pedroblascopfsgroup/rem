	    ...
	    THEN (
		 CASE
			WHEN VTA_POS.FECHA_POSESION IS NOT NULL
		        ...
		        AND VTA_POS.FECHA_POSESION>=CASE WHEN CANCEL.FC_CANCELACION_ULTIMA_CARGA IS NOT NULL AND CANCEL.FC_CANCELACION_ULTIMA_CARGA <> to_date(''19000101'',''yyyymmdd'') THEN CANCEL.FC_CANCELACION_ULTIMA_CARGA ELSE NVL(ACT.ACT_FECHA_REV_CARGAS,to_date(''19000101'',''yyyymmdd'')) END


		    THEN VTA_POS.FECHA_POSESION
		    WHEN COALESCE(TIT.TIT_FECHA_INSC_REG,BIEADJ.BIE_ADJ_F_INSCRIP_TITULO) IS NOT NULL
		        ...
		        AND COALESCE(TIT.TIT_FECHA_INSC_REG,BIEADJ.BIE_ADJ_F_INSCRIP_TITULO)>=CASE WHEN CANCEL.FC_CANCELACION_ULTIMA_CARGA IS NOT NULL AND CANCEL.FC_CANCELACION_ULTIMA_CARGA <> to_date(''19000101'',''yyyymmdd'') THEN CANCEL.FC_CANCELACION_ULTIMA_CARGA ELSE NVL(ACT.ACT_FECHA_REV_CARGAS,to_date(''19000101'',''yyyymmdd'')) END
		    THEN COALESCE(TIT.TIT_FECHA_INSC_REG,BIEADJ.BIE_ADJ_F_INSCRIP_TITULO)
		    ...
		    THEN CANCEL.FC_CANCELACION_ULTIMA_CARGA 
