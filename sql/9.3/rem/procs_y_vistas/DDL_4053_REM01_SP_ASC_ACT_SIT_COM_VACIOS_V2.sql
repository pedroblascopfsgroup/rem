...
--##		0.3 Santi Monzó [HREOS-17293] Añadir select Alquilado, añadir DD_EAL_CODIGO = ''02''
--##########################################
--*/
							...
							FROM(
								...
								UNION
								   ...
								   ,2 ORDEN
										...
										WHERE ACT.DD_TCO_ID = (SELECT DD_TCO_ID FROM '||V_ESQUEMA||'.DD_TCO_TIPO_COMERCIALIZACION WHERE DD_TCO_CODIGO = '''||TIPOCOMERCIALIZACION_ALQUILER||''')
