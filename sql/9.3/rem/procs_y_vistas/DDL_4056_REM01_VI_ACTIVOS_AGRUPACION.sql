...
BEGIN
  ...
  V_MSQL := 'CREATE OR REPLACE VIEW ' || V_ESQUEMA || '.V_ACTIVOS_AGRUPACION
	AS
        ...
        LEFT JOIN '||V_ESQUEMA||'.DD_ETI_ESTADO_TITULO            ETI     ON ETI.DD_ETI_ID = TIT.DD_ETI_ID     AND ETI.BORRADO = 0
        ...
        LEFT JOIN '||V_ESQUEMA||'.DD_TAG_TIPO_AGRUPACION TAG ON AGRU.DD_TAG_ID = TAG.DD_TAG_ID
