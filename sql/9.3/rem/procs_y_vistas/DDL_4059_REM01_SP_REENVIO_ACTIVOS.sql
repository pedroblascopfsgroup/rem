...
CREATE OR REPLACE PROCEDURE #ESQUEMA#.REENVIO_ACTIVOS
   (  ACTIVOS IN VARCHAR2
...
BEGIN
	...
	V_SQL := 'DELETE FROM '||V_ESQUEMA||'.SWH_STOCK_ACT_WEBCOM_HIST WHERE ID_ACTIVO_HAYA IN ('||ACTIVOS||')';

	EXECUTE IMMEDIATE V_SQL;

	PL_OUTPUT := '[INFO] Se han eliminado '||SQL%ROWCOUNT||' activos'
					;
