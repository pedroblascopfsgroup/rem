...
-- Modificación de la vista V_TASACION_CALCULO_LBK de Fase1.
  ...
  LEFT JOIN '|| V_ESQUEMA ||'.V_PRECIOS_VIGENTES V_PRE_2 ON ACT.ACT_ID = V_PRE_2.ACT_ID AND V_PRE_2.DD_TPC_CODIGO = ''02'' AND V_PRE_2.VAL_FECHA_FIN IS NULL
  LEFT JOIN '|| V_ESQUEMA ||'.V_PRECIOS_VIGENTES V_PRE_4 ON ACT.ACT_ID = V_PRE_4.ACT_ID AND V_PRE_4.DD_TPC_CODIGO = ''04'' AND V_PRE_4.VAL_FECHA_FIN IS NULL
  LEFT JOIN '|| V_ESQUEMA ||'.V_PRECIOS_VIGENTES V_PRE_7 ON ACT.ACT_ID = V_PRE_7.ACT_ID AND V_PRE_7.DD_TPC_CODIGO = ''07'' AND V_PRE_7.VAL_FECHA_FIN IS NULL
