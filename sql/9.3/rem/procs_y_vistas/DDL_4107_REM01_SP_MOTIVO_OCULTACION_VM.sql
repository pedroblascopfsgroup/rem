...
create or replace PROCEDURE SP_MOTIVO_OCULTACION_VM  (pACT_ID IN NUMBER
                         ...
                         ' UNION
                          SELECT APU.ACT_ID
                               ...
                               , MTO.DD_MTO_ORDEN ORDEN
                                    ...
                                    JOIN '|| V_ESQUEMA ||'.V_CAMBIO_ESTADO_PUBLI_VM EST ON EST.ACT_ID = APU.ACT_ID AND EST.INFORME_COMERCIAL = 0
