...
create or replace PROCEDURE REM01.SP_CAMBIO_ESTADO_PUBLICACION_VM  (pACT_ID IN NUMBER DEFAULT NULL
    ...
    vDD_TCO_CODIGO    #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_TCO_CODIGO%TYPE;
    vCODIGO_ESTADO_A  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CODIGO_ESTADO_A%TYPE;
    vDESC_ESTADO_A    #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DESC_ESTADO_A%TYPE;
    vCHECK_PUBLICAR_A #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CHECK_PUBLICAR_A%TYPE;
    vCHECK_OCULTAR_A  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CHECK_OCULTAR_A%TYPE;
    vDD_MTO_CODIGO_A  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_MTO_CODIGO_A%TYPE;    
    vDD_MTO_MANUAL_A  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_MTO_MANUAL_A%TYPE; 
    vCODIGO_ESTADO_V  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CODIGO_ESTADO_V%TYPE;
    vDESC_ESTADO_V    #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DESC_ESTADO_V%TYPE;
    vCHECK_PUBLICAR_V #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CHECK_PUBLICAR_V%TYPE;
    vCHECK_OCULTAR_V  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CHECK_OCULTAR_V%TYPE;
    vDD_MTO_CODIGO_V  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_MTO_CODIGO_V%TYPE;
    vDD_MTO_MANUAL_V  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_MTO_MANUAL_V%TYPE; 
    vDD_TPU_CODIGO_A  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_TPU_CODIGO_A%TYPE;
    vDD_TPU_CODIGO_V  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_TPU_CODIGO_V%TYPE;
    vDD_TAL_CODIGO	  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .DD_TAL_CODIGO%TYPE;	
    nADMISION         #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .ADMISION%TYPE;
    nGESTION          #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .GESTION%TYPE;
    nINFORME_COMERCIAL #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .INFORME_COMERCIAL%TYPE;
    nPRECIO_A         #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .PRECIO_A%TYPE;
    nPRECIO_V         #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .PRECIO_V%TYPE;
    nCEE_VIGENTE      #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CEE_VIGENTE%TYPE;
    nADECUADO         #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .ADECUADO%TYPE;
    nES_CONDICIONADO  #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .ES_CONDICIONADO_PUBLI%TYPE;
    ...
    cCODIGO_ESTADO_V #ESQUEMA#.V_CAMBIO_ESTADO_PUBLI_VM .CODIGO_ESTADO_V%TYPE;
  ...
  BEGIN
      ...
      V_MSQL := '
        SELECT
          ...
          FROM '|| V_ESQUEMA ||'.V_CAMBIO_ESTADO_PUBLI_VM  V'
          ||vWHERE
       ;
	...
	END SP_CAMBIO_ESTADO_PUBLICACION_VM ;
