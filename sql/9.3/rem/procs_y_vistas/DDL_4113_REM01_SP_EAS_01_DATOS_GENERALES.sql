    ...
    DBMS_OUTPUT.PUT_LINE('[INICIO]');
   	...
   	EXECUTE IMMEDIATE V_SQL;
        ...
        V_SQL := 'MERGE INTO ' || V_ESQUEMA || '.AUX_APR_DATOS_GENERALES APR USING(
					...
					SELECT AGA.AGR_ID, ACT.ACT_NUM_ACTIVO, ACT.ACT_ID, ACT.DD_SAC_ID, ACT.DD_TPA_ID, ACT.ACT_NUM_ACTIVO_CAIXA, REG.REG_SUPERFICIE_UTIL
					...
					MAT.REG_SUPERFICIE_UTIL AS XMMEAS,
