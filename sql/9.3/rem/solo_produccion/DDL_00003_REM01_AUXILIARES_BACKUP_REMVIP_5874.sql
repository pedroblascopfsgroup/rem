...
END IF;
	...
	V_MSQL := 'CREATE INDEX IDX_AUX_5874_1 ON '||V_ESQUEMA_1||'.AUX_TBJ_EXCEL_REMVIP_5874';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] CREADO INDICE PARA AUX_GEE_REMVIP_5874'); 

	V_MSQL := 'CREATE INDEX IDX_AUX_5874_2 ON '||V_ESQUEMA_1||'.AUX_TBJ_NO_EXCEL_5874';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] CREADO INDICE PARA AUX_GAC_REMVIP_5874'); 

	V_MSQL := 'CREATE INDEX IDX_AUX_5874_3 ON '||V_ESQUEMA_1||'.AUX_TAR_EXCEL_REMVIP_5874';
	EXECUTE IMMEDIATE V_MSQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] CREADO INDICE PARA AUX_GEH_REMVIP_5874'); 

	V_MSQL := 'CREATE INDEX IDX_AUX_5874_4 ON '||V_ESQUEMA_1||'.AUX_TAR_NO_EXCEL_REMVIP_5874';
	EXECUTE IMMEDIATE V_MSQL;
