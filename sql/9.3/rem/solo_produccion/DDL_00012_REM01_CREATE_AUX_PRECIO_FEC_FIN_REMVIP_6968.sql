...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_PRECIO_FEC_FIN_REMVIP_6968';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUMERO_ACTIVO NUMBER(16), TIPO_PRECIO VARCHAR2(5 CHAR), VAL_FECHA_INICIO VARCHAR2(8 CHAR), VAL_FECHA_FIN VARCHAR2(8 CHAR)
		)'
;
