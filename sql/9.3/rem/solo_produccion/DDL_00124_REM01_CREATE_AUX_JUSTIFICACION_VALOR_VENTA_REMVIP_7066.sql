...
--## PRODUCTO=NO
--## 
--## Finalidad: Carga masiva. ICO Justificacion Valor estimado Venta
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(50 CHAR) := 'AUX_JUSTIFICACION_VALOR_VENTA_REMVIP_7066';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUMERO_ACTIVO NUMBER(16), JUSTIFICACION_VALOR_VENTA VARCHAR2(3000 CHAR)
		)'
;
