...
--## PRODUCTO=NO
--## 
--## Finalidad: Carga masiva. ICO Valor estimado Venta
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_VALOR_ESTIMADO_VENTA_REMVIP_7077';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUMERO_ACTIVO NUMBER(16), VALOR_ESTIMADO_VENTA NUMBER(16,2)
		)'
;
