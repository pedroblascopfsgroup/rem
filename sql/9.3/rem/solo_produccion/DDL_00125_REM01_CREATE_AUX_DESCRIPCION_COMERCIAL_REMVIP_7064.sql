...
--## PRODUCTO=NO
--## 
--## Finalidad: Carga masiva. ICO Descripcion comercial
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(50 CHAR) := 'AUX_DESCRIPCION_COMERCIAL_REMVIP_7064';
...
EXECUTE IMMEDIATE '
		...
		(
			ACT_NUMERO_ACTIVO NUMBER(16), DESCRIPCION_COMERCIAL VARCHAR2(3000 CHAR)
		)'
;
