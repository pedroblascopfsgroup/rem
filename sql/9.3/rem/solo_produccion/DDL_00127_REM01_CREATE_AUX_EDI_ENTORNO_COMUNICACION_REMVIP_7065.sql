...
--## PRODUCTO=NO
--## 
--## Finalidad: Carga masiva. EDI_EDIFICIO.EDI_ENTORNO_COMUNICACION carga masiva
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(50 CHAR) := 'AUX_EDI_ENTORNO_COMUNICACION_REMVIP_7065';
...
EXECUTE IMMEDIATE '
		...
		(
			ACTIVO NUMBER(16), ENTORNO_COMUNICACION VARCHAR2(1000 CHAR)
		)'
;
