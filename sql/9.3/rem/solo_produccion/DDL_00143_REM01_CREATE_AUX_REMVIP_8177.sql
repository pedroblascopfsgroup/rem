...
--## INCIDENCIA_LINK=REMVIP_8177
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8177'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8177';
...
BEGIN
	...
	EXECUTE IMMEDIATE '
			...
			(
				...
				GEH_ID NUMBER(16,0),
				DD_TGE_BY_GEH_ID NUMBER(16,0),
				GEE_ID NUMBER(16,0),
				USU_ID_BY_GEE_ID NUMBER(16,0),
				DD_TGE_BY_GEE_ID NUMBER(16,0)
			)';
