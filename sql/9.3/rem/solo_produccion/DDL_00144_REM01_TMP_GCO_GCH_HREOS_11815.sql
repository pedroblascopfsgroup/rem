...
--## INCIDENCIA_LINK=HREOS_11815
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de la tabla 'TMP_GCO_GCH_HREOS_11815'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'TMP_GCO_GCH_HREOS_11815';
...
IF V_ESQUEMA_2 != V_ESQUEMA_1 THEN
	...
	EXECUTE IMMEDIATE 'GRANT ALL ON "'||V_ESQUEMA_1||'"."TMP_GCO_GCH_HREOS_11815" TO "'||V_ESQUEMA_3||'" WITH GRANT OPTION';
	DBMS_OUTPUT.PUT_LINE('[INFO] PERMISOS SOBRE LA TABLA '||V_ESQUEMA_1||'.'||V_TABLA||' OTORGADOS A '||V_ESQUEMA_3||''); 
	
	EXECUTE IMMEDIATE 'GRANT ALL ON "'||V_ESQUEMA_1||'"."TMP_GCO_GCH_HREOS_11815" TO "'||V_ESQUEMA_4||'" WITH GRANT OPTION';
