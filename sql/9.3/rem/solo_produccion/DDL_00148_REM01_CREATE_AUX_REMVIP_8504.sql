...
--## INCIDENCIA_LINK=REMVIP_8504
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_REMVIP_8504'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_8504_ACT';
	V_TABLA2 VARCHAR2(40 CHAR) := 'AUX_REMVIP_8504_EXP';
...
BEGIN
	...
	EXECUTE IMMEDIATE '
			CREATE TABLE '||V_ESQUEMA_1||'.'||V_TABLA2||'
			(
				ECO_ID NUMBER(16,0),
	...
	IF V_ESQUEMA_3 != V_ESQUEMA_1 THEN
		...
		EXECUTE IMMEDIATE 'GRANT ALL ON "'||V_ESQUEMA_1||'"."'||V_TABLA2||'" TO "'||V_ESQUEMA_3||'" WITH GRANT OPTION';
		DBMS_OUTPUT.PUT_LINE('[INFO] PERMISOS SOBRE LA TABLA '||V_ESQUEMA_1||'.'||V_TABLA2||' OTORGADOS A '||V_ESQUEMA_3||''); 
