...
NVL2(VEN.GLD_ID, 1, 0) VENDIDO FROM '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV
...
JOIN '||V_ESQUEMA||'.aux_remvip_9782_gastos AUX2 ON AUX2.NUM_GASTO=gpv.gpv_num_gasto_haya
