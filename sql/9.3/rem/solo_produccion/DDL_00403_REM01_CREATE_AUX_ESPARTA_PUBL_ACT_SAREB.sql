...
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de tabla 'AUX_ESPARTA_PUBL_ACT_SAREB'
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
V_TABLA VARCHAR2(40 CHAR) := 'AUX_ESPARTA_PUBL_ACT_SAREB';
...
EXECUTE IMMEDIATE '
		...
		AS (
			...
			, 0 AS PROCESADO
			FROM '||V_ESQUEMA_1||'.H_CCN_CAMBIOS_CONV_SAREB CCN
			JOIN '||V_ESQUEMA_1||'.ACT_ACTIVO ACT ON CCN.ACT_ID = ACT.ACT_ID
			JOIN '||V_ESQUEMA_1||'.DD_COS_CAMPOS_ORIGEN_CONV_SAREB COS ON COS.DD_COS_ID = CCN.DD_COS_ID
