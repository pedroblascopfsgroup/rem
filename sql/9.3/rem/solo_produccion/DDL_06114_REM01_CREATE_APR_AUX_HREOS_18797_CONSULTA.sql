...
V_TABLA VARCHAR2(40 CHAR) := 'APR_AUX_HREOS_18797_CONSULTA';
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] '||V_ESQUEMA_1||'.'||V_TABLA||' CREADA');
            ...
            EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.'||V_TABLA||'.DD_EEC_CODIGO_ANTIGUO IS ''Código estado haya de la oferta antes de ejecutar la minimigración''';
            EXECUTE IMMEDIATE 'COMMENT ON COLUMN ' || V_ESQUEMA_1 || '.'||V_TABLA||'.DD_EEB_CODIGO_ANTIGUO IS ''Código estado BC de la oferta antes de ejecutar la minimigración''';
