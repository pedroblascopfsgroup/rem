...
--## PRODUCTO=NO
--## 
--## Finalidad: Borrado de gestores PTEC para volver a asignar
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
	...
	V_MSQL :=  'DELETE FROM '||V_ESQUEMA||'.GAH_GESTOR_ACTIVO_HISTORICO GAH
                WHERE GAH.GEH_ID IN(
                SELECT GEH_ID FROM '||V_ESQUEMA||'.AUX_GEH_REMVIP_5665)';
    ...
    V_MSQL :=  'DELETE FROM '||V_ESQUEMA||'.GAC_GESTOR_ADD_ACTIVO GAC
                WHERE GAC.GEE_ID IN(
                SELECT GEE_ID FROM '||V_ESQUEMA||'.AUX_GEE_REMVIP_5665)';
	...
	REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-5665', PL_OUTPUT, NULL, NULL, '01' );
	...
	REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-5665', PL_OUTPUT, NULL, NULL, '02' );
