...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-5728'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
...
BEGIN	
	...
	ALTA_BPM_INSTANCES('REMVIP-5212', PL_OUTPUT);
