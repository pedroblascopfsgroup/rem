...
--BUSCA Y ACTUALIZA  RESPONSABLE TRABAJOS 
		...
		DBMS_OUTPUT.PUT_LINE('[INICIO] Comienza el proceso de actualizacion DE TRABAJOS DE EXCEL (AUX_TBJ_TAR_MULTIACT_REMVIP_6174).');
		
		V_SQL := '   MERGE INTO REM01.ACT_TBJ_TRABAJO T1
					USING (
						SELECT TBJ.TBJ_NUM_TRABAJO FROM REM01.ACT_TBJ_TRABAJO TBJ 
						INNER JOIN REM01.AUX_TBJ_TAR_MULTIACT_REMVIP_6174 TBJ1 ON TBJ1.TBJ_NUM_TRABAJO = TBJ.TBJ_NUM_TRABAJO 
                    			)T2
