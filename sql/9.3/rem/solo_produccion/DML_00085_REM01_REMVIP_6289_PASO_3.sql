...
--## PRODUCTO=NO
--## 
--## Finalidad: REMVIP-6289, paso 3, update SPS_FECHA_LANZAMIENTO_EFECTIVO a NULL
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USUARIOMODIFICAR VARCHAR(100 CHAR):= 'REMVIP-6289_3';
...
BEGIN	
    ...
    V_SQL :='MERGE INTO '||V_ESQUEMA||'.ACT_SPS_SIT_POSESORIA T1 USING (
		...
		INNER JOIN '||V_ESQUEMA||'.AUX_REMVIP_6289_5 AUX ON SPS.ACT_ID = AUX.ACT_ID
		)T2
	ON (T1.ACT_ID=T2.ACT_ID)
	WHEN MATCHED THEN UPDATE SET 
	T1.SPS_FECHA_LANZAMIENTO_EFECTIVO = NULL,
