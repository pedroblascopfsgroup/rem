...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-6369';    
    
    TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(150);
    TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    			-- NUM_ACT	NºFINCA 	FECHA_TAS	IMPORTE_TAS	TASADORA,  FECHA_CADUCIDAD
			T_TIPO_DATA('7031853','','17/05/2018','75076,65','', '','16/11/2018'),
			T_TIPO_DATA('7072605','','17/12/2018','581927,86','', '','16/06/2019'),
			T_TIPO_DATA('7071617','','19/07/2018','107460,15','', '','')
