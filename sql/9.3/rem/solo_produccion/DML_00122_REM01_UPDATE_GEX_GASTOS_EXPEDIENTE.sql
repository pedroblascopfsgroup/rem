...
--## PRODUCTO=NO
--##
--## Finalidad: Modificar GEX_PROVEEDOR
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TABLA VARCHAR2(27 CHAR) := 'GEX_GASTOS_EXPEDIENTE'; -- Vble. auxiliar para almacenar el nombre de la tabla de ref.
 ...
 BEGIN
  ...
  EXECUTE IMMEDIATE 'UPDATE '||V_ESQUEMA||'.'||V_TABLA||' SET
	  					   GEX_PROVEEDOR = 103977
						 , USUARIOMODIFICAR = '''||V_USUARIO||'''
						 , FECHAMODIFICAR = SYSDATE
					 WHERE GEX_PROVEEDOR = 11335
  					';
