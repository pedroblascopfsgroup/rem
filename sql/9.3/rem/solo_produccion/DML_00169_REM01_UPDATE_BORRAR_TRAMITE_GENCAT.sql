	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] Actualiza TAR_TAREAS_NOTIFICACIONES - Borrado lógico ');
	 ...
	 V_SQL := 'MERGE INTO '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES T1
		...
		FROM '||V_ESQUEMA||'.ACT_TRA_TRAMITE TRA 
		     INNER JOIN '||V_ESQUEMA||'.ACT_ACTIVO ACT ON TRA.ACT_ID = ACT.ACT_ID AND ACT.BORRADO = 0
		     ...
		     INNER JOIN '||V_ESQUEMA||'.TAP_TAREA_PROCEDIMIENTO TAP ON TEX.TAP_ID = TAP.TAP_ID AND TAP.BORRADO = 0
