...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-6340_5'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
	...
	--TRA_ID , TAR_ID, TEX_ID, TEX_TOKEN, ACT_ID, USU_ID, SUP_ID, TBJ_NUM_TRABAJO

	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		T_JBV(456812,4963817 ,9703662 ,60634689 ,427628 ,86356 , 60579, 9000294671)
		); 
	V_TMP_JBV T_JBV;
...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ELIMINAR TAREAS MAL CREADAS');

	V_SQL := 'delete from REM01.TEV_TAREA_EXTERNA_VALOR where tex_id = 9703662 '; --tex_id
	EXECUTE IMMEDIATE V_SQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] Se han eliminado '||SQL%ROWCOUNT||' registros');

	V_SQL := 'delete from REM01.TEX_TAREA_EXTERNA where tar_id = 4985562'; --tar_id
	EXECUTE IMMEDIATE V_SQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] Se han eliminado '||SQL%ROWCOUNT||' registros'); 

	V_SQL := 'delete from REM01.TAC_TAREAS_ACTIVOS where tar_id = 4985562'; --tar_id
	EXECUTE IMMEDIATE V_SQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] Se han eliminado '||SQL%ROWCOUNT||' registros');  

	V_SQL := 'delete from REM01.TAR_TAREAS_NOTIFICACIONES where tar_id = 4985562'; --tar_id
	EXECUTE IMMEDIATE V_SQL;
	DBMS_OUTPUT.PUT_LINE('[INFO] Se han eliminado '||SQL%ROWCOUNT||' registros');  
