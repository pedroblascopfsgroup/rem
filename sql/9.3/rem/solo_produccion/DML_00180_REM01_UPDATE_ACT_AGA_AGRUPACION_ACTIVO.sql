...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-7925'; -- USUARIOCREAR/USUARIOMODIFICAR
...
BEGIN
        ...
        V_MSQL :=   'UPDATE '||V_ESQUEMA||'.'||V_TABLA||'
                    ...
                    USUARIOBORRAR = '''|| V_USR ||''',
                    FECHABORRAR = SYSDATE
                    WHERE AGA_ID IN (SELECT aga.aga_id FROM '||V_ESQUEMA||'.act_aga_agrupacion_activo aga
