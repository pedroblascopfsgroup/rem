...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-6688_4'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
	...
	T_JBV(253707,	3918534,	45054,	53048,	141508),
	T_JBV(256773,	3935882,	2332,	39900,	142764),
	T_JBV(253689,	3918409,	2533,	39900,	141500),
	T_JBV(237056,	3831177,	4462,	39900,	135503),
	T_JBV(237065,	3831201,	4867,	39900,	135507),
	T_JBV(253209,	3915661,	42470,	39451,	141333),
	T_JBV(253202,	3915587,	42472,	39451,	141329)
		); 
	V_TMP_JBV T_JBV;
