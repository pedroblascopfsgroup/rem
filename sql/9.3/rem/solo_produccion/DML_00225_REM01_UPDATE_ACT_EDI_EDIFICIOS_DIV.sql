...
BEGIN
    ...
    V_SQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_EDI_EDIFICIO EDI USING(
		SELECT EDI.EDI_ID, AUX.DESCRIPCION_EDI FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT
        	JOIN '||V_ESQUEMA||'.AUX_REMVIP_6931 AUX ON AUX.ACT_NUM_ACTIVO = ACT.ACT_NUM_ACTIVO
		...
		EDI.EDI_DESCRIPCION = AUX.DESCRIPCION_EDI,
