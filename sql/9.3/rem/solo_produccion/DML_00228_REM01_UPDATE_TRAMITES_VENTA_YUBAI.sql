...
DECLARE
   ...
   USUARIO VARCHAR2(50 CHAR):= 'REMVIP-6826'; -- Usuario con el que se registraran las modificaciones. Campo obligatorio
   LIST_EXP_REP VARCHAR2(1024 CHAR):= '196824,181297,187120'; -- Ej. 'XXX,XXX,XXX'-- Lista de números de expedientes comerciales, separados por comas, que queramos reposicionar. Es obligatorio.
   TRAM_DESTINO VARCHAR2(1024 CHAR):= 'T013_InstruccionesReserva' ; -- Trámite al que se quiere avanzar cada expediente comercial. Es obligatorio.
