...
--## INCIDENCIA_LINK=REMVIP-6731
--## PRODUCTO=NO
--## Finalidad: Elimina vínculo entre tabajo y gasto (Borrado físico en tabla vinculante).
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_USUARIO VARCHAR2(20 CHAR) := 'REMVIP-6731';
    V_TABLA VARCHAR2(50 CHAR) := 'GPV_TBJ';
    V_NUM_GASTO VARCHAR(30 CHAR) := '11115840';
    V_NUM_TRABAJO VARCHAR2(30 CHAR) := '9000267135';
