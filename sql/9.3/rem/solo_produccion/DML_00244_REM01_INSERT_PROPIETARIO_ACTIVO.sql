...
--## INCIDENCIA_LINK=REMVIP-6872
--## PRODUCTO=SI
--##
--## Finalidad: Script que inserta una asignación entre propietario y activo en la tabla ACT_PAC_PROPIETARIO_ACTIVO.
--## INSTRUCCIONES:
--## VERSIONES:
--## 		0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_USR VARCHAR2(30 CHAR) := 'REMVIP-6872'; -- USUARIOCREAR/USUARIOMODIFICAR.
	
	TYPE T_VAR IS TABLE OF VARCHAR2(50);
	TYPE T_ARRAY_VAR IS TABLE OF T_VAR; 
	V_VAR T_ARRAY_VAR := T_ARRAY_VAR(   
		T_VAR('7027063', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7027476', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028035', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028036', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028350', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028379', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028380', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028623', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028794', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028795', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('7028796', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100'),
		T_VAR('6952676', 'B86053394', 'CERBERUS IBERIA ADVISORS', '01', '100')
	); 
	V_TMP_VAR T_VAR;
	...
	FOR I IN V_VAR.FIRST .. V_VAR.LAST LOOP
		...
		IF V_NUM = 1 THEN
			...
			VALUES(
				...
				(
					SELECT PRO_ID FROM '||V_ESQUEMA||'.ACT_PRO_PROPIETARIO WHERE PRO_DOCIDENTIF = '''||V_TMP_VAR(2)||''' AND PRO_NOMBRE = '''||V_TMP_VAR(3)||'''
				),
				(
