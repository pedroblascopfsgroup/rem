...
--## INCIDENCIA_LINK=HREOS-8784
--## PRODUCTO=NO
--## 
--## Finalidad: Creación de AVANCE_TRAMITE_MIG_DIVARIAN
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
create or replace PROCEDURE AVANCE_TRAMITE_MIG_DIVARIAN (USUARIO VARCHAR2
...
EXCEPTION
    WHEN OTHERS THEN
      ...
      ROLLBACK;
      RAISE;
END AVANCE_TRAMITE_MIG_DIVARIAN;
/
