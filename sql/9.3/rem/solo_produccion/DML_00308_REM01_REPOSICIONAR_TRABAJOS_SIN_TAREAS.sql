...
BEGIN	
	...
	LOOP 
		V_TMP_JBV1 := V_JBV1(I);
		V_MSQL := 'SELECT TRA_ID FROM '||V_ESQUEMA||'.ACT_TRA_TRAMITE WHERE TBJ_ID = (SELECT TBJ_ID FROM '||V_ESQUEMA||'.ACT_TBJ_TRABAJO WHERE TBJ_NUM_TRABAJO = '||V_TMP_JBV1(1)||') AND BORRADO = 0';
	...
	LOOP 
		V_TMP_JBV2 := V_JBV2(I);
		V_MSQL := 'SELECT TRA_ID FROM '||V_ESQUEMA||'.ACT_TRA_TRAMITE WHERE TBJ_ID = (SELECT TBJ_ID FROM '||V_ESQUEMA||'.ACT_TBJ_TRABAJO WHERE TBJ_NUM_TRABAJO = '||V_TMP_JBV2(1)||') AND BORRADO = 0';
		EXECUTE IMMEDIATE V_MSQL INTO V_TRA_ID;
	...
	LOOP 
		V_TMP_JBV3 := V_JBV3(I);
		V_MSQL := 'SELECT TRA_ID FROM '||V_ESQUEMA||'.ACT_TRA_TRAMITE WHERE TBJ_ID = (SELECT TBJ_ID FROM '||V_ESQUEMA||'.ACT_TBJ_TRABAJO WHERE TBJ_NUM_TRABAJO = '||V_TMP_JBV3(1)||') AND BORRADO = 0';
		EXECUTE IMMEDIATE V_MSQL INTO V_TRA_ID;
