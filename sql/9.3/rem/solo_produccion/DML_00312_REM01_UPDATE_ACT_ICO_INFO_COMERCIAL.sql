...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-7304'; -- USUARIOCREAR/USUARIOMODIFICAR.
    NUM_ACT NUMBER(16);
    VALOR_VENTA NUMBER(16);
    ACT_ID NUMBER(16);

    TYPE T_JBV IS TABLE OF VARCHAR2(32000);
    TYPE T_ARRAY_JBV IS TABLE OF T_JBV; 
	
	--act_num_activo, valor_estimado_venta

	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(

	T_JBV(7288562,110000)
	...
	-- Si existe ACTUALIZAMOS
		IF V_NUM_TABLAS > 0 THEN
			...
			V_MSQL := 'UPDATE '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL 
				...
				, ICO_VALOR_ESTIMADO_VENTA = '||VALOR_VENTA||' 
				WHERE ACT_ID ='||ACT_ID||'';
