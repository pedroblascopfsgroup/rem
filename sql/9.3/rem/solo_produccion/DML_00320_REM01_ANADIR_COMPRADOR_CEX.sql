...
BEGIN	
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] ');
    	...
    	DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN CEX_COMPRADOR_EXPEDIENTE] ');
                ...
                V_MSQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.ECO_EXPEDIENTE_COMERCIAL WHERE ECO_NUM_EXPEDIENTE = 210599';
				...
				VALUES (
				(SELECT COM_ID FROM '||V_ESQUEMA||'.COM_COMPRADOR WHERE COM_DOCUMENTO = ''44446088Z''),
