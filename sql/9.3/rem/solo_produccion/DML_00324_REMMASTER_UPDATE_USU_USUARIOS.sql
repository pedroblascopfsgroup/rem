...
DECLARE
  ...
  V_USUARIOMODIFICAR VARCHAR2(100 CHAR) := 'REMVIP-7442';
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZAR USU_USUARIOS ' );
		...
		V_MSQL := ' 
		UPDATE '||V_ESQUEMA_M||'.USU_USUARIOS SET USU_TELEFONO = ''639942769'', 
		USUARIOMODIFICAR = ''REMVIP-7442'', 
		FECHAMODIFICAR = SYSDATE 
		WHERE USU_USERNAME = ''mpelegay''';
