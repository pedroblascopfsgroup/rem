...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-7548'; -- USUARIOCREAR/USUARIOMODIFICAR
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] ACTUALIZAR VAL_FECHA_APROBACION MIGRADAS DIVARIAN A NULL');
        ...
        V_MSQL :=   'UPDATE '||V_ESQUEMA||'.ACT_VAL_VALORACIONES SET 
			...
			USUARIOMODIFICAR = ''REMVIP-7778''
			WHERE VAL_FECHA_APROBACION IS NOT NULL AND  USUARIOCREAR = ''MIG_DIVARIAN2''';
