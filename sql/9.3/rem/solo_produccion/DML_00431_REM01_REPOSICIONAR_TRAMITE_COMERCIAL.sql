...
DECLARE
    ...
    V_USR VARCHAR2(50 CHAR) := 'REMVIP-7972';
...
BEGIN
	...
	#ESQUEMA#.AVANCE_TRAMITE_MIG_DIVARIAN(V_USR, EXPEDIENTES, 'T017_RecomendCES', NULL, NULL, PL_OUTPUT);
	...
	FOR CURSOR IN (SELECT 
		...
		WHERE TRA.USUARIOMODIFICAR = 'REMVIP-7972'
		AND TAP_CODIGO IN (
		'T017_AdvisoryNote',
