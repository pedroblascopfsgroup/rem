...
DECLARE
    ...
    V_ID_ETP NUMBER(16);
    V_BOOLEAN NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'REMVIP-8099';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('APD','backup.rem@pfsgroup.es'),
      T_TIPO_DATA('APC','backup.rem@pfsgroup.es'),
      T_TIPO_DATA('DRD','backup.rem@pfsgroup.es'),
      T_TIPO_DATA('DRC','backup.rem@pfsgroup.es')
		); 
