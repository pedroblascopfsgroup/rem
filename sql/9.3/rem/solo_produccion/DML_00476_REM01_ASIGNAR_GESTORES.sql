...
--## INCIDENCIA_LINK=REMVIP-8212
--## PRODUCTO=NO
--## 
--## Finalidad: Asignacion gestores
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
BEGIN
	...
	REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-8212', PL_OUTPUT, NULL, NULL, '01' );
	...
	REM01.SP_AGA_ASIGNA_GESTOR_ACTIVO_V3('REMVIP-8212', PL_OUTPUT, NULL, NULL, '02' );
