...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-8323'; --Vble. auxiliar para almacenar el usuario
    ...
    V_COUNT_TOTAL NUMBER(16):=0; --Vble para contar registros totales
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            ...
            T_TIPO_DATA('8485','96'),
            T_TIPO_DATA('7495','2299'),
            T_TIPO_DATA('7277','3277'),
            T_TIPO_DATA('9408','3301'),
...
BEGIN	
    ...
    FOR I IN V_TIPO_DATA.FIRST .. V_TIPO_DATA.LAST
		...
		ELSE
			...
			DBMS_OUTPUT.PUT_LINE('[INFO]: NO EXISTE EL PROVEEDOR CON PVE_COD_REM: '''||V_TMP_TIPO_DATA(2)||''' ');
