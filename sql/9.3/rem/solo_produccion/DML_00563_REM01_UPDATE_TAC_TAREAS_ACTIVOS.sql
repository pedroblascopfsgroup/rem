...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8460'; -- USUARIO CREAR/MODIFICAR
    V_USUARIO_ORIGEN VARCHAR2(50 CHAR) := 'jtoro';
    V_USUARIO_DESTINO VARCHAR2(50 CHAR) := 'mruiz';
    
BEGIN	
	
	DBMS_OUTPUT.PUT_LINE('[INICIO] ');
    
    DBMS_OUTPUT.PUT_LINE('[INFO]: REASIGNACIÓN DE TAREAS DE USUARIO ''JTORO'' A USUARIO ''MRUIZ''');  
