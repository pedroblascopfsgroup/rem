...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8461'; -- USUARIO CREAR/MODIFICAR
...
BEGIN	
    ...
    V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.TAC_TAREAS_ACTIVOS T1
                USING (SELECT DISTINCT TAC.TAR_ID FROM '||V_ESQUEMA||'.ECO_EXPEDIENTE_COMERCIAL ECO
                    ...
                    AND ACT.DD_TCR_ID = 1
                    AND TAP.TAP_CODIGO IN (''T013_InstruccionesReserva'',''T013_DefinicionOferta'',''T013_FirmaPropietario'',''T013_ResolucionComite'',''T013_ResolucionExpediente'',''T013_RespuestaOfertante'')
                ) T2 
