...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8493';    
...
BEGIN	
	...
	V_SQL := 'MERGE INTO REM01.ACT_VAL_VALORACIONES T1 USING 
			(SELECT ACT.ACT_NUM_ACTIVO, ACT.ACT_ID, VAL.VAL_ID, AUX.VALOR_VENTA_HAYA, AUX.VALOR_RENTA_HAYA, AUX.FECHA_VALOR_VENTA, AUX.VALOR_VENTA_HET, AUX.LIQUIDEZ
           		 ...
           		 INNER JOIN REM01.AUX_REMVIP_8493 AUX ON ACT.ACT_NUM_ACTIVO = AUX.ACT_NUM_ACTIVO
           		 LEFT JOIN REM01.ACT_VAL_VALORACIONES VAL ON VAL.ACT_ID = ACT.ACT_ID AND VAL.DD_TPC_ID = 27 AND VAL.BORRADO = 0
           		 WHERE AUX.VALOR_VENTA_HAYA <> 0) T2
		...
		WHEN MATCHED THEN UPDATE SET 
			...
			T1.USUARIOMODIFICAR = ''REMVIP-8493'',
		...
		WHEN NOT MATCHED THEN INSERT
			 (VAL_ID,ACT_ID,DD_TPC_ID,FECHACREAR,USUARIOCREAR,BORRADO,VERSION,VAL_IMPORTE,VAL_FECHA_VENTA,VAL_FECHA_INICIO,VAL_FECHA_CARGA,VAL_LIQUIDEZ   )
    			  VALUES
			 (REM01.S_ACT_VAL_VALORACIONES.NEXTVAL, T2.ACT_ID, 27, SYSDATE, ''REMVIP-8493'', 0, 0, T2.VALOR_VENTA_HAYA, TO_DATE(T2.FECHA_VALOR_VENTA,''DD/MM/YYYY''), SYSDATE, SYSDATE,T2.LIQUIDEZ )';
	...
	V_SQL := 'MERGE INTO REM01.ACT_VAL_VALORACIONES T1 USING 
			(SELECT ACT.ACT_NUM_ACTIVO, ACT.ACT_ID, VAL.VAL_ID, AUX.VALOR_VENTA_HAYA, AUX.VALOR_RENTA_HAYA, AUX.FECHA_VALOR_VENTA, AUX.VALOR_VENTA_HET, AUX.LIQUIDEZ
			    ...
			    WHERE AUX.VALOR_RENTA_HAYA <> 0) T2
		ON (T1.VAL_ID = T2.VAL_ID)
		WHEN MATCHED THEN UPDATE SET 
		...
		WHEN NOT MATCHED THEN INSERT
			(VAL_ID,ACT_ID,DD_TPC_ID,FECHACREAR,USUARIOCREAR,BORRADO,VERSION,VAL_IMPORTE,VAL_FECHA_VENTA,VAL_FECHA_INICIO,VAL_FECHA_CARGA,VAL_LIQUIDEZ   )
    			 VALUES
			(REM01.S_ACT_VAL_VALORACIONES.NEXTVAL, T2.ACT_ID, 28, SYSDATE, ''REMVIP-8493'', 0, 0, T2.VALOR_RENTA_HAYA,CASE WHEN T2.FECHA_VALOR_VENTA IS NULL THEN NULL ELSE TO_DATE(T2.FECHA_VALOR_VENTA,''DD/MM/YYYY'') END, SYSDATE, SYSDATE,T2.LIQUIDEZ)';
	...
	V_SQL := 'MERGE INTO REM01.ACT_VAL_VALORACIONES T1 USING 
			(SELECT ACT.ACT_NUM_ACTIVO, ACT.ACT_ID, VAL.VAL_ID, AUX.VALOR_VENTA_HAYA, AUX.VALOR_RENTA_HAYA, AUX.FECHA_VALOR_VENTA, AUX.VALOR_VENTA_HET, AUX.LIQUIDEZ
			    ...
			    WHERE AUX.VALOR_VENTA_HET <> 0) T2
		ON (T1.VAL_ID = T2.VAL_ID)
		WHEN MATCHED THEN UPDATE SET 
		...
		WHEN NOT MATCHED THEN INSERT
			(VAL_ID,ACT_ID,DD_TPC_ID,FECHACREAR,USUARIOCREAR,BORRADO,VERSION,VAL_IMPORTE,VAL_FECHA_VENTA,VAL_FECHA_INICIO,VAL_FECHA_CARGA,VAL_LIQUIDEZ   )
    			VALUES
			(REM01.S_ACT_VAL_VALORACIONES.NEXTVAL, T2.ACT_ID, 81, SYSDATE, ''REMVIP-8493'', 0, 0, T2.VALOR_VENTA_HET,CASE WHEN T2.FECHA_VALOR_VENTA IS NULL THEN NULL ELSE TO_DATE(T2.FECHA_VALOR_VENTA,''DD/MM/YYYY'') END, SYSDATE, SYSDATE,T2.LIQUIDEZ)';
