...
DECLARE
    ...
    V_EXISTS NUMBER(1);
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-8485'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_ACTIVO NUMBER(16) := 7249792; 
...
BEGIN
    ...
    --ACTIVOS OFERTAS EN BLOQUEO ADMINISTRATIVO, VENDIDO, RESERVADO O APROBADO SIN RESERVA
    V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.AUX_MIGRA_GENCAT AS
        ...
        FROM (
            ...
            JOIN '||V_ESQUEMA||'.DD_SCM_SITUACION_COMERCIAL SCM ON SCM.DD_SCM_ID = ACT.DD_SCM_ID
                AND SCM.DD_SCM_CODIGO NOT IN (''01'',''06'')
            ...
            JOIN '||V_ESQUEMA||'.DD_EEC_EST_EXP_COMERCIAL EEC ON EEC.DD_EEC_ID = ECO.DD_EEC_ID
                AND EEC.DD_EEC_CODIGO IN (''05'',''06'',''11'',''08'')
