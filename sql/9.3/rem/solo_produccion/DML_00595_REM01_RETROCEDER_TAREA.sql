...
DECLARE
   ...
   V_USUARIO VARCHAR(25 CHAR) := 'REMVIP-8598';
...
BEGIN
   ...
   V_SQL :='SELECT COUNT(1) FROM '||V_ESQUEMA||'.ECO_EXPEDIENTE_COMERCIAL WHERE ECO_NUM_EXPEDIENTE = ''232429''';
