...
--## INCIDENCIA_LINK=REMVIP-8716
--## PRODUCTO=NO
--##            
--## INSTRUCCIONES: EXCEPCIONAR MODULO GENCAT
--## VERSIONES:
--##        0.1 Versión inicial
--#########################################
--*/
...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-8716'; --Vble. auxiliar para almacenar el usuario
    V_SQL VARCHAR2(4000 CHAR);
    V_SUBSQL1 VARCHAR2(200 CHAR);
    V_SUBSQL2 VARCHAR2(1000 CHAR);
    V_SUBSQL3 VARCHAR2(500 CHAR);
    V_SUBSQL4 VARCHAR2(500 CHAR);
    V_ACTIVOS VARCHAR2(4000 CHAR) := '7256267';
...
-----------------------------------------------------------------------------------------------------------------
	...
	VALUES
	( T2.ACT_ID, 0, ''' || V_USUARIO || ''', SYSDATE, 0)	
	';
