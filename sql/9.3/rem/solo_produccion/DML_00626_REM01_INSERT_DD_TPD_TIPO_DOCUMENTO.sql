...
DECLARE
    ...
    V_USUARIO VARCHAR2(32 CHAR):= 'REMVIP-8736';
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
		  T_JBV('Acta Cesión de remate','AI-01-DOCJ-92','168'),		
          T_JBV('Alquiler: Justificante ingreso pago alquiler','AI-02-CERJ-91','169')
	); 
	V_TMP_JBV T_JBV;
