...
--## INCIDENCIA_LINK=REMVIP-8770
--## PRODUCTO=NO
--## 
--## Finalidad: CREAR PRESUPUESTOS 2021 EN ACT_PTO_PRESUPUESTO
--##                    
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
  ...
  V_USER VARCHAR2(50 CHAR):= 'REMVIP-8770';

BEGIN

	--Comprobamos SI ESTA EL EJERCICIO 2021

        	V_SQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.ACT_EJE_EJERCICIO WHERE EJE_ANYO = ''2021''';
		      ...
		      V_SQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_PTO_PRESUPUESTO T1
						USING (
							...
							FROM '||V_ESQUEMA||'.ACT_ACTIVO ACT 
                            				LEFT JOIN '||V_ESQUEMA||'.ACT_EJE_EJERCICIO EJE ON EJE.EJE_ANYO = 2021
		...
		ELSE
          		DBMS_OUTPUT.PUT_LINE('[INFO]: NO EXISTE EL EJERCICIO 2021');
