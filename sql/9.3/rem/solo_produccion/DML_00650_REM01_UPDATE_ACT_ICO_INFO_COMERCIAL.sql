...
--## INCIDENCIA_LINK=REMVIP-8836
--## PRODUCTO=NO
--## 
--## Finalidad: Informar DD_TIC_ID para que el activo pueda usar el combo de plantas
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8836';
    ...
    V_NUM_ACTIVO VARCHAR2(100 CHAR):='7423140';
