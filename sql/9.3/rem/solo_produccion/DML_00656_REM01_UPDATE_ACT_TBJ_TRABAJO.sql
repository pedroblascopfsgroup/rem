...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8843'; --Vble USUARIOMODIFICAR/USUARIOCREAR
    ...
    V_PROVEEDOR_REM VARCHAR2(100 CHAR):='110169787'; --Vble. codigo proveedor rem
    
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	TYPE T_ARRAY_DATA IS TABLE OF T_TIPO_DATA;
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            T_TIPO_DATA('916964382351'),
            T_TIPO_DATA('916964380168')
        ...
        V_TMP_TIPO_DATA := V_TIPO_DATA(I);
            ...
            IF V_COUNT = 1 THEN
                ...
                V_MSQL := 'SELECT COUNT(1) FROM '||V_ESQUEMA||'.ACT_PVE_PROVEEDOR PVE
                            ...
                            WHERE PVE.PVE_COD_REM='||V_PROVEEDOR_REM||' AND PVC.BORRADO=0 ';
                EXECUTE IMMEDIATE V_MSQL INTO V_COUNT;
                ...
                IF V_COUNT = 1 THEN
                    ...
                    --Actualizamos el proveedor contacto del trabajo
