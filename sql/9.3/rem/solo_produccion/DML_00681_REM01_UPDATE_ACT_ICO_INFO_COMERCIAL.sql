...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-8896'; -- USUARIO CREAR/MODIFICAR
...
BEGIN
	...
	V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL T1 USING (
					...
					WHERE ACT.ACT_NUM_ACTIVO IN (6048623 , 6844275) AND ACT.BORRADO = 0 AND ICO.BORRADO = 0) T2
