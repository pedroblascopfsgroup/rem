...
DECLARE
    ...
    V_USUARIO VARCHAR(100 CHAR):= 'REMVIP-9144';

BEGIN
    DBMS_OUTPUT.PUT_LINE('[INICIO]');
    DBMS_OUTPUT.PUT_LINE('[INFO] REENVIAR AGRUPACION WEBCOM' || V_USUARIO);

    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.AWH_AGRUP_ONV_WEBCOM_HIST WHERE ID_AGRUPACION_REM = 95045';
    EXECUTE IMMEDIATE V_MSQL;
    DBMS_OUTPUT.PUT_LINE('[INFO] ELIMINADOS '||SQL%ROWCOUNT||' REGISTROS EN AWH_AGRUP_ONV_WEBCOM_HIST');

    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.CWH_CABEC_ONV_WEBCOM_HIST WHERE ID_AGRUPACION_REM = 95045';
    EXECUTE IMMEDIATE V_MSQL;
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.SWH_STOCK_ACT_WEBCOM_HIST WHERE ID_ACTIVO_HAYA IN (
                ...
                WHERE AGR.AGR_NUM_AGRUP_REM = 95045)';
    EXECUTE IMMEDIATE V_MSQL;
