...
--## INCIDENCIA_LINK=REMVIP-9174
--## PRODUCTO=NO
--## 
--## Finalidad: FORZAR REENVIO AGRUPACION ON, CON SUS SUBDIVISIONES Y ACTIVOS
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Version inicial
--##########################################
...
BEGIN
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.AWH_AGRUP_ONV_WEBCOM_HIST WHERE ID_AGRUPACION_REM = 96318';
    EXECUTE IMMEDIATE V_MSQL;
    DBMS_OUTPUT.PUT_LINE('[INFO] ELIMINADOS '||SQL%ROWCOUNT||' REGISTROS EN AWH_AGRUP_ONV_WEBCOM_HIST');

    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.CWH_CABEC_ONV_WEBCOM_HIST WHERE ID_AGRUPACION_REM = 96318';
    EXECUTE IMMEDIATE V_MSQL;
    DBMS_OUTPUT.PUT_LINE('[INFO] ELIMINADOS '||SQL%ROWCOUNT||' REGISTROS EN CWH_CABEC_ONV_WEBCOM_HIST');
    ...
    V_MSQL := 'DELETE FROM '||V_ESQUEMA||'.SWH_STOCK_ACT_WEBCOM_HIST WHERE ID_ACTIVO_HAYA IN (
                ...
                WHERE AGR.AGR_NUM_AGRUP_REM = 96318)';
    EXECUTE IMMEDIATE V_MSQL;
