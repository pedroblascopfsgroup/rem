...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-9196_2'; --Vble USUARIOMODIFICAR/USUARIOCREAR
    ...
    V_GASTO NUMBER(16):= 13650949;
    V_IMPORTE_LINEA VARCHAR2(50 CHAR):='1353,09';
    V_IMPUESTO VARCHAR2(50 CHAR):='284,14';
    V_IMPORTE_TOTAL VARCHAR2(50 CHAR):='1637,23';
...
BEGIN
    ...
    IF V_COUNT = 1 THEN
        ...
        V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.'||V_TABLA_LINEA||' T1
                    ...
                    T1.GLD_PRINCIPAL_SUJETO=TO_NUMBER('''||V_IMPORTE_LINEA||'''),
                    T1.GLD_IMP_IND_CUOTA=TO_NUMBER('''||V_IMPUESTO||'''),
                    T1.GLD_IMPORTE_TOTAL=TO_NUMBER('''||V_IMPORTE_TOTAL||'''),
