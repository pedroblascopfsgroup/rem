...
--## PRODUCTO=NO
--##
--## Finalidad: Script modifica DD_IRE_ID = 6 -> RAM
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
	...
	V_TEXT_TABLA_AUX VARCHAR2(27 CHAR) := 'AUX_REMVIP_9373';
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-9373'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
...
BEGIN		
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] MODIFICADOS DD_IRE_ID = 6  '|| SQL%ROWCOUNT ||' TRABAJOS EN '||V_TEXT_TABLA);
