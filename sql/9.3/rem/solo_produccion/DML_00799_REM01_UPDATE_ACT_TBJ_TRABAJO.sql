...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-9433'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		-- 			NUM_TRABAJO  
		T_TIPO_DATA(924567831249),
		T_TIPO_DATA(924567831252)); 
