...
DECLARE
    ...
    V_EXISTS NUMBER(1);
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-9308'; -- USUARIOCREAR/USUARIOMODIFICAR
    V_ACTIVO NUMBER(16) := 7312797;
...
BEGIN
    ...
    V_MSQL := 'CREATE TABLE '||V_ESQUEMA||'.AUX_MIGRA_GENCAT AS
        ...
        FROM (
            ...
            JOIN '||V_ESQUEMA||'.DD_EEC_EST_EXP_COMERCIAL EEC ON EEC.DD_EEC_ID = ECO.DD_EEC_ID
                AND EEC.DD_EEC_CODIGO IN (''05'',''06'',''11'', ''16'')
    ...
    SELECT '||V_ESQUEMA||'.S_ACT_CMG_COMUNICACION_GENCAT.NEXTVAL CMG_ID, AUX.ACT_ID
        , CASE 
            WHEN AUX.DD_EEC_CODIGO IN (''11'', ''16'') THEN AUX.ECO_FECHA_SANCION
