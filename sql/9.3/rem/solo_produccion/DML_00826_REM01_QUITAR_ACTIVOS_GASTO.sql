...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-9390'; --Vble. auxiliar para almacenar el usuario
 ...
 TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
        --GPV_NUM_GASTO_HAYA
        T_TIPO_DATA('12336370'),
        T_TIPO_DATA('12442430'),
        T_TIPO_DATA('12474290'),
        T_TIPO_DATA('12527251'),
        T_TIPO_DATA('12376779'),
        T_TIPO_DATA('12505464')
            ...
            IF V_NUM_TABLAS > 0 THEN
                ...
                V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.'||V_TABLA||' T1 USING (
                                    SELECT GENT.GLD_ENT_ID FROM '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV
                                        ...
                                        AND GPV.GPV_NUM_GASTO_HAYA='''||V_TMP_TIPO_DATA(1)||''' AND ACT.BORRADO=1
