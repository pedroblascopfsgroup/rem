...
--## INCIDENCIA_LINK=REMVIP-9638
--## PRODUCTO=NO
--## 
--## Finalidad: Actualización ICO_POSIBLE_HACER_INF = 1 en activo V_ACTIVO
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-9638'; -- USUARIO CREAR/MODIFICAR
	V_COUNT NUMBER(16); -- Vble. para comprobar
	err_num NUMBER; -- Numero de errores
	err_msg VARCHAR2(2048); -- Mensaje de error
	V_ACTIVO NUMBER(16):= 6781401;
...
BEGIN
	...
	V_MSQL := 'MERGE INTO '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL T1 USING (
					...
					WHERE ACT.ACT_NUM_ACTIVO = '||V_ACTIVO||' AND ACT.BORRADO = 0 AND ICO.BORRADO = 0) T2
