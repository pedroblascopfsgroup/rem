...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-9699'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
...
BEGIN		
	...
	V_MSQL:= 'MERGE INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' T1 USING (
				...
				T1.FECHA_POSESION = TO_DATE(TO_CHAR(T2.POSESION,''DD/MM/YYYY''),''DD/MM/YYYY''),               
