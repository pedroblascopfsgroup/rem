...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-9725'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
...
BEGIN		
	...
	V_MSQL:= 'MERGE INTO '||V_ESQUEMA||'.BLK_OFR T1 USING (
					...
					WHERE OFR.OFR_NUM_OFERTA = 90316612 AND OFR.BORRADO = 0) T2
