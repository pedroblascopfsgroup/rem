...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		-- 			NUM_TRABAJO  
        T_TIPO_DATA(916964354899),
        T_TIPO_DATA(916964355356),
        T_TIPO_DATA(916964357341),
        T_TIPO_DATA(916964357984),
        T_TIPO_DATA(916964367244),
        T_TIPO_DATA(924567803850),
        T_TIPO_DATA(924567822426)
