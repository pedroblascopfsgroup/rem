...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-9776'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            T_TIPO_DATA('924567848388', '220', '286'),
            T_TIPO_DATA('916964389374', '504.32', '504.32')
    	); 
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            V_MSQL:= 'UPDATE '||V_ESQUEMA||'.ACT_TBJ_TRABAJO SET
               TBJ_IMPORTE_PRESUPUESTO = '||V_TMP_TIPO_DATA(2)||',    
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO]: TRABAJO '''||V_TMP_TIPO_DATA(1)||''' MODIFICADO');
