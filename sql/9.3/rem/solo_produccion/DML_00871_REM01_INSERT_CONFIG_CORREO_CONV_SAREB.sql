...
DECLARE
    ...
    V_ID_ETP NUMBER(16);
    V_BOOLEAN NUMBER(16);
    V_ITEM VARCHAR2(25 CHAR):= 'HREOS-14112';
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
      T_TIPO_DATA('ACCS','ndelaossa@haya.es'),
      T_TIPO_DATA('RECS','ndelaossa@haya.es'),
      T_TIPO_DATA('ALCS','ndelaossa@haya.es'),
      
      T_TIPO_DATA('ACCS','irodriguez@haya.es'),
      T_TIPO_DATA('RECS','irodriguez@haya.es'),
      T_TIPO_DATA('ALCS','irodriguez@haya.es'),
      
      T_TIPO_DATA('ACCS','dgutierrez@haya.es'),
      T_TIPO_DATA('RECS','dgutierrez@haya.es'),
      T_TIPO_DATA('ALCS','dgutierrez@haya.es'),
