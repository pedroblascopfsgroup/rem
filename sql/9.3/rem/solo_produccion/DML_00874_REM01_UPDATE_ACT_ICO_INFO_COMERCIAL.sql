...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-9794'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            T_TIPO_DATA('7433726', '865533'),
            T_TIPO_DATA('7433729', '865535'),
            T_TIPO_DATA('7433733', '866109')
    	); 
