...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-9912'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            T_TIPO_DATA('916964382662'),
            T_TIPO_DATA('916964367213'),
            T_TIPO_DATA('916964367231')
    	); 
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            V_MSQL:= 'UPDATE '||V_ESQUEMA||'.ACT_TBJ_TRABAJO SET
               DD_IRE_ID = NULL,
               PFA_ID = NULL,    
               TBJ_IMPORTE_TOTAL = TBJ_IMPORTE_PRESUPUESTO,  
