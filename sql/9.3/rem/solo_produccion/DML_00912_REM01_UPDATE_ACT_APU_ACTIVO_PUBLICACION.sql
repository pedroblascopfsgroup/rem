...
--## INCIDENCIA_LINK=REMVIP-10010
--## PRODUCTO=NO
--## 
--## Finalidad: Poner activo en Oculto
--##			
--## INSTRUCCIONES:  
--## VERSIONES:
--##        0.1 Versión inicial
...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-10010';
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZAR ACTIVO A OCULTO');
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            APU_FECHA_CAMB_PUBL_VENTA = TO_DATE(''18/06/2021'',''DD/MM/YYYY'')
            WHERE ACT_ID = '||V_ID||'';
            ...
            AHP_FECHA_FIN_VENTA = TO_DATE(''18/06/2021'',''DD/MM/YYYY''),
            USUARIOMODIFICAR = '''|| V_USUARIO ||''',
            FECHAMODIFICAR = SYSDATE 
