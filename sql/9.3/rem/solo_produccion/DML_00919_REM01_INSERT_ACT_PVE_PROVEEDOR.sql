...
BEGIN	
    ...
    IF V_NUM_TABLAS = 0 THEN  
        ...
        ''B97538672'',
        (SELECT DD_PRV_ID FROM '||V_ESQUEMA||'.APR_AUX_DD_PRV_PROVINCIA WHERE DD_PRV_CODIGO = ''46''),
        (SELECT DD_LOC_ID FROM '||V_ESQUEMA||'.APR_AUX_DD_LOC_LOCALIDAD WHERE DD_LOC_CODIGO = ''46701''),
        46701,
