...
--## PRODUCTO=NO
--##
--## Finalidad: Script modifica el tipo del gasto
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('13802524'),
		T_TIPO_DATA('13802533'),
		T_TIPO_DATA('13839518'),
		T_TIPO_DATA('13977593'),
		T_TIPO_DATA('14077049')
...
BEGIN		
	...
	V_MSQL := 'SELECT DD_TGA_ID FROM '||V_ESQUEMA||'.DD_TGA_TIPOS_GASTO WHERE DD_TGA_CODIGO = ''02''';
