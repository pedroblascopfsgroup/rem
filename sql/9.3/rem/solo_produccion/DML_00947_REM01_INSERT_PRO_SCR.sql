...
DECLARE
    ...
    V_USUARIO VARCHAR2(100 CHAR):='REMVIP-10131'; --Vble. auxiliar para almacenar el usuario
    ...
    V_COUNT_TOTAL NUMBER(16):=0; --Vble para contar registros totales
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
    		T_TIPO_DATA('A14010342','08'),
			T_TIPO_DATA('A86201993','56')
    	); 
