...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-100135'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            V_MSQL:= 'UPDATE '||V_ESQUEMA||'.ACT_TBJ_TRABAJO SET
               DD_IRE_ID = (SELECT DD_IRE_ID FROM '||V_ESQUEMA||'.DD_IRE_IDENTIFICADOR_REAM WHERE DD_IRE_CODIGO = ''03''),
               PFA_ID = 1983,
