...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10155'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ECO_ID NUMBER(16);
...
BEGIN		
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
		...
		IF V_COUNT = 1 THEN
			...
			DBMS_OUTPUT.PUT_LINE('[INFO] EXPEDIENTE ACTUALIZADO  '||V_TMP_TIPO_DATA(1)||'');
