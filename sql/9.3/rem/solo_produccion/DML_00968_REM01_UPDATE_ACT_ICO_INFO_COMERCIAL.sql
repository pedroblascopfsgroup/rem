...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10207'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ACT_ID NUMBER(16);
	V_ICO_ID NUMBER(16);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		T_TIPO_DATA('7433773','872193'),
		T_TIPO_DATA('7433775','872197'),
		T_TIPO_DATA('7433779','886703'),
		T_TIPO_DATA('7433759','870153')
...
BEGIN		
	...
	V_TMP_TIPO_DATA := V_TIPO_DATA(I);
		...
		IF V_COUNT = 1 THEN
			...
			DBMS_OUTPUT.PUT_LINE('[INFO]: WEBCOM ID ACTUALIZADO PARA '||V_TMP_TIPO_DATA(1)||'');
