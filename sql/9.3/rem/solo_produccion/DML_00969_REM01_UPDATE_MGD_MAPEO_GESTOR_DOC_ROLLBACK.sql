...
--## PRODUCTO=NO
--##
--## Finalidad: Se hace rollback del DML_00663_UPDATE_MGD_MAPEO_GESTOR_DOC.sql
--## INSTRUCCIONES:
--## VERSIONES:
--##        0.1 Versión inicial
--##########################################
...
DECLARE
    ...
    V_ID NUMBER(16);
    V_USUARIO VARCHAR2(150 CHAR):='HREOS-14647';
    
    TYPE T_FUNCION IS TABLE OF VARCHAR2(1500);
    TYPE T_ARRAY_FUNCION IS TABLE OF T_FUNCION;
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
	  T_FUNCION('08', '18', 'Liberbank', 'LIBERBANK'),
	  T_FUNCION('08', '56', 'Liberbank', 'LIBERBANK'),
      T_FUNCION('08', '57', 'Liberbank', 'LIBERBANK'),
      T_FUNCION('08', '58', 'Liberbank', 'LIBERBANK'),
      T_FUNCION('08', '59', 'Liberbank', 'LIBERBANK'),
      T_FUNCION('08', '60', 'Liberbank', 'LIBERBANK')
    );          
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: INSERCION EN MGD_MAPEO_GESTOR_DOC] ');
     FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      LOOP
			...
			ELSE
				DBMS_OUTPUT.PUT_LINE('[INFO] No existe el registro en la tabla MGD_MAPEO_GESTOR_DOC '''||V_TMP_FUNCION(1)||''' - '''||V_TMP_FUNCION(2)||''' - '''||V_TMP_FUNCION(3)||''' - '''||V_TMP_FUNCION(4)||''' ');
