...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-10239'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            V_MSQL:= 'UPDATE '||V_ESQUEMA||'.ACT_SPS_SIT_POSESORIA SET
               DD_SIJ_ID = (SELECT DD_SIJ_ID FROM DD_SIJ_SITUACION_JURIDICA WHERE DD_SIJ_CODIGO = ''7''),               
            ...
            DBMS_OUTPUT.PUT_LINE('[INFO]: SITUACIÓN JURIDICA DEL ACTIVO '''||V_TMP_TIPO_DATA(1)||''' ACTUALIZADA');
