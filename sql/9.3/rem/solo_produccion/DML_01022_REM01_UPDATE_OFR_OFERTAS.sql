...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-10376'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            T_TIPO_DATA('90332544','110083389')
