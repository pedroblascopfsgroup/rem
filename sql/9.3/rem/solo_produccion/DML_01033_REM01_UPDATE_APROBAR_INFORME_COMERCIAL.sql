...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10417'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_TABLA_AUX VARCHAR( 100 CHAR ) := 'AUX_REMVIP_10417';
    V_COUNT NUMBER(16);	
    V_ID NUMBER(16);
...
BEGIN		
	...
	V_MSQL := ' MERGE INTO '|| V_ESQUEMA ||'.ACT_ICO_INFO_COMERCIAL ICO
		    ...
		    ICO_FECHA_ACEPTACION = TO_DATE(''06/09/2021'', ''DD-MM-YYYY''),
