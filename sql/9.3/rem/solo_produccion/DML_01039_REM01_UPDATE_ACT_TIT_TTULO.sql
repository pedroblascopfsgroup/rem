...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10446'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ACT_ID NUMBER(16);
...
BEGIN		
	...
	V_TMP_TIPO_DATA := V_TIPO_DATA(I);
		...
		IF V_COUNT = 1 THEN
			...
			DBMS_OUTPUT.PUT_LINE('[INFO]: INFORMACIÓN DE TÍTULO DE ACTIVO '||V_TMP_TIPO_DATA(1)||' BORRADA');
