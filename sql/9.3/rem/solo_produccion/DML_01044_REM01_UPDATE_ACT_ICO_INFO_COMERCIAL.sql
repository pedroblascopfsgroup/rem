...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10483'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ACT_ID NUMBER(16);
	V_ICO_ID NUMBER(16);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
			--Activo_haya	--Id_informe_webcom
		T_TIPO_DATA('7471435','897389'),
		T_TIPO_DATA('7471950','897887')
