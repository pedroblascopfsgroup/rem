...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10535'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ACT_ID NUMBER(16);
	V_ICO_ID NUMBER(16);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('897371','7471434'),
		T_TIPO_DATA('897885','7471938')
