...
BEGIN		
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO]');
		...
		V_MSQL:= 'MERGE INTO '||V_ESQUEMA||'.'||V_TEXT_TABLA||' T1 USING (
						...
						JOIN '||V_ESQUEMA||'.AUX_REMVIP_10583 AUX ON AUX.ID_HAYA = ACT.ACT_NUM_ACTIVO 
		...
		DBMS_OUTPUT.PUT_LINE('[INFO] MODIFICADOS '||SQL%ROWCOUNT||' ACTIVOS CON ACT_GESTION_DND A SÍ');
