...
DECLARE
    ...
    V_USU VARCHAR2(30 CHAR) := 'REMVIP-10624'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ACT_ID NUMBER(16);
	V_ICO_ID NUMBER(16);
    ...
    V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
		...
		T_TIPO_DATA('897367','7471438'),
		T_TIPO_DATA('898241','7482870')
