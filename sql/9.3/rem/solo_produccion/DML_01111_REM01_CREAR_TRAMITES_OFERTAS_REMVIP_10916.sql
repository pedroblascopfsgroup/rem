...
DECLARE
      ...
      V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-10916';
      V_TABLA VARCHAR2(40 CHAR) := 'AUX_REMVIP_10916'; -- Vble. Tabla pivote
      ...
      SELECT DISTINCT NUM_OFERTA  FROM REM01.AUX_REMVIP_10916 TRA
      ;
...
BEGIN
      ...
      ---------------------------------------------------------------------------------------------------------------
      -- UPDATE AUX_REMVIP_10916 (TBJ_ID, TRA_ID, TAR_ID, TEX_ID) --
      ---------------------------------------------------------------------------------------------------------------
      ...
      LOOP
            ...
            EXIT WHEN CURSOR_OFERTAS%NOTFOUND;
                  ...
                  EXECUTE IMMEDIATE '
                        UPDATE '||V_ESQUEMA||'.AUX_REMVIP_10916 TRA
