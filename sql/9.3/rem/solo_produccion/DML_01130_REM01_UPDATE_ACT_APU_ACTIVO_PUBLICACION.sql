...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-11171';
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            IF V_ESTA_PUBLICADO = 4 THEN
                ...
                APU_FECHA_CAMB_PUBL_VENTA = TO_DATE(''16/02/2022'',''DD/MM/YYYY'')
                WHERE ACT_ID = '||V_ID||'';
                ...
                AHP_FECHA_FIN_VENTA = TO_DATE(''16/02/2022'',''DD/MM/YYYY''),
                USUARIOMODIFICAR = '''|| V_USUARIO ||''',
                FECHAMODIFICAR = SYSDATE 
                ...
                VALUES(
                    ...
                    1,0,0,0,0,0,0,0,TO_DATE(''16/02/2022'',''DD/MM/YYYY''),
                    '''|| V_USUARIO ||''',SYSDATE,0,2,
