...
DECLARE
    ...
    V_USUARIO VARCHAR2(30 CHAR) := 'REMVIP-10809'; -- Vble. auxiliar para almacenar el nombre de usuario que modifica los registros.
	V_COUNT NUMBER(16);
	V_ID NUMBER(16);
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
            --          ID_ACTIVO        ID_WEBCOM         
            T_TIPO_DATA('7471437',      '897373'),
            T_TIPO_DATA('7482901',      '899661'),
            T_TIPO_DATA('7482905',      '899741'),
            T_TIPO_DATA('7484475',      '900251')
    	); 
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            V_MSQL:= 'UPDATE '||V_ESQUEMA||'.ACT_ICO_INFO_COMERCIAL SET
               ICO_WEBCOM_ID = '||V_TMP_TIPO_DATA(2)||',               
               USUARIOMODIFICAR = '''|| V_USUARIO ||''',
               FECHAMODIFICAR = SYSDATE               
               WHERE ACT_ID = '||V_ID||'';
            EXECUTE IMMEDIATE V_MSQL;

            DBMS_OUTPUT.PUT_LINE('[INFO]: ID WEBCOM DEL ACTIVO '''||V_TMP_TIPO_DATA(1)||''' ACTUALIZADO');
