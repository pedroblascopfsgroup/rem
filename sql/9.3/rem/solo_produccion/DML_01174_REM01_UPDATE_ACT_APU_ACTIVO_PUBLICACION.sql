...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-11615';
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                                -- EPA actual del activo
            T_TIPO_DATA('5949470', '04'),
            T_TIPO_DATA('6824887', '01'),
            T_TIPO_DATA('7296052', '01')
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            IF V_ESTADO_PUBLICACION = 4 THEN
                ...
                APU_FECHA_CAMB_PUBL_VENTA = TO_DATE(''20/06/2022'',''DD/MM/YYYY'')
                WHERE ACT_ID = '||V_ID||'';
                ...
                AHP_FECHA_FIN_VENTA = TO_DATE(''20/06/2022'',''DD/MM/YYYY''),
                USUARIOMODIFICAR = '''|| V_USUARIO ||''',
                FECHAMODIFICAR = SYSDATE 
