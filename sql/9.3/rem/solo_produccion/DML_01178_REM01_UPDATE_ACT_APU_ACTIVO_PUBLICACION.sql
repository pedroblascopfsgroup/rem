...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-11409';
	...
	TYPE T_TIPO_DATA IS TABLE OF VARCHAR2(32000 CHAR);
    	...
    	V_TIPO_DATA T_ARRAY_DATA := T_ARRAY_DATA(
                                -- TCO
            T_TIPO_DATA('7296052', '02'),
            T_TIPO_DATA('5928805', '01'),
            T_TIPO_DATA('6891612', '02')
    ...
    V_TMP_TIPO_DATA := V_TIPO_DATA(I);
        ...
        IF V_COUNT = 1 THEN
            ...
            IF V_ESTADO_PUBLICACION = 4 THEN
                ...
                APU_FECHA_CAMB_PUBL_VENTA = TO_DATE(''04/07/2022'',''DD/MM/YYYY'')
                WHERE ACT_ID = '||V_ID||'';
                ...
                AHP_FECHA_FIN_VENTA = TO_DATE(''04/07/2022'',''DD/MM/YYYY''),
                USUARIOMODIFICAR = '''|| V_USUARIO ||''',
                FECHAMODIFICAR = SYSDATE 
                ...
                VALUES(
                    ...
                    (SELECT DD_TCO_ID FROM '||V_ESQUEMA||'.DD_TCO_TIPO_COMERCIALIZACION WHERE DD_TCO_CODIGO = '''||V_TMP_TIPO_DATA(2)||'''),
                    1,
                    0,
                    0,
                    0,
