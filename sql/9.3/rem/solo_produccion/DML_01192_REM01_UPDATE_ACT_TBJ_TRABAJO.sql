...
TTR.DD_TTR_CODIGO,
STR.DD_STR_CODIGO,
TTR2.DD_TTR_ID AS TIPO_PONER,
STR2.DD_STR_ID AS SUBTIPO_PONER
...
JOIN '||V_ESQUEMA||'.dd_ttr_tipo_trabajo TTR2 ON TTR2.DD_TTR_ID=STR2.DD_TTR_ID AND TTR2.BORRADO = 0
