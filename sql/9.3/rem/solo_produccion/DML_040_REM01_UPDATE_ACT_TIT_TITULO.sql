...
DECLARE
  ...
  V_USUARIOMODIFICAR VARCHAR2(100 CHAR) := 'REMVIP-5314';
...
BEGIN	
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZAR ACT_SPS_SIT_POSESORIA ' );
		...
		V_MSQL := ' 
		UPDATE '||V_ESQUEMA||'.ACT_TIT_TITULO SET TIT_FECHA_INSC_REG = TO_DATE(''01/01/19'',''DD/MM/RR''),
       		DD_ETI_ID = (SELECT DD_ETI_ID FROM '||V_ESQUEMA||'.DD_ETI_ESTADO_TITULO WHERE DD_ETI_CODIGO = ''02''),
		USUARIOMODIFICAR = ''REMVIP-5314'', 
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO] Actualizados '||SQL%ROWCOUNT||' registros en ACT_TIT_TITULO');  
