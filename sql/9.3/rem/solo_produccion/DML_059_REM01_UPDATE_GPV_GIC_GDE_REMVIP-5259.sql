...
*/
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: CAMBIANDO NLS_DATE_FORMAT A mm/dd/rr ' );
	 ...
	 V_SQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE OWNER = '''||V_ESQUEMA||''' AND TABLE_NAME = ''TMP_CUADRE_ALL_ASPRO_160919_2''';
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] TABLA '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_2 YA EXISTENTE. SE PROCEDE A BORRAR Y CREAR DE NUEVO.');
	EXECUTE IMMEDIATE 'DROP TABLE '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_2';
	...
	END IF;
		...
		V_MSQL:= q'[CREATE TABLE REM01.TMP_CUADRE_ALL_ASPRO_160919_2 AS
			SELECT 
	...
	V_SQL := 'SELECT COUNT(1) FROM ALL_TABLES WHERE OWNER = '''||V_ESQUEMA||'''  AND TABLE_NAME = ''TMP_CUADRE_ALL_ASPRO_160919_3''';
		DBMS_OUTPUT.PUT_LINE(V_SQL);
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] TABLA '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_3 YA EXISTENTE. SE PROCEDE A BORRAR Y CREAR DE NUEVO.');
	EXECUTE IMMEDIATE 'DROP TABLE '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_3';
	...
	END IF; 
		...
		V_MSQL:= q'[CREATE TABLE REM01.TMP_CUADRE_ALL_ASPRO_160919_3 AS
			SELECT 
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: CONCEDIENDO PRIVILEGIOS A REM01 SOBRE REM_EXT.TMP_CUADRE_ALL_ASPRO_160919_2 ' );
		...
		V_MSQL := 'GRANT ALL ON REM01.TMP_CUADRE_ALL_ASPRO_160919_2 TO PFSREM WITH GRANT OPTION';
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: CONCEDIENDO PRIVILEGIOS A REM01 SOBRE REM_EXT.TMP_CUADRE_ALL_ASPRO_160919_3 ' );
		...
		V_MSQL := 'GRANT ALL ON REM01.TMP_CUADRE_ALL_ASPRO_160919_3 TO PFSREM WITH GRANT OPTION';
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZANDO FECHA DE CONTABILIZACIÓN EN GIC_GASTOS_INFO_CONTABILIDAD ' );
		...
		V_MSQL := ' 
			...
			(
			  ...
			  FROM '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_2 TMP 
			...
			WHEN MATCHED THEN UPDATE SET 
			 ...
			 , GPV_OLD.USUARIOMODIFICAR             = ''' || V_USUARIOMODIFICAR || '''
			 , GPV_OLD.FECHAMODIFICAR               = sysdate
		';
    ...
    DBMS_OUTPUT.PUT_LINE('[INFO]: ACTUALIZANDO FECHA DE PAGO EN GDE_GASTOS_DETALLE_ECONOMICO ' );
		...
		V_MSQL := ' 
			...
			(
			  ...
			  FROM '||V_ESQUEMA||'.TMP_CUADRE_ALL_ASPRO_160919_3 TMP 
			  INNER JOIN '||V_ESQUEMA||'.GPV_GASTOS_PROVEEDOR GPV ON TMP.GPV_NUM_GASTO_HAYA = GPV.GPV_NUM_GASTO_HAYA
