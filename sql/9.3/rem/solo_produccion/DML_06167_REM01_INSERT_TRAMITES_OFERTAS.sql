...
DECLARE
      ...
      V_TABLA VARCHAR2(40 CHAR) := 'APR_AUX_HREOS_18797'; -- Vble. Tabla pivote
      ...
      SELECT DISTINCT NUM_OFERTA  FROM REM01.APR_AUX_HREOS_18797 TRA
      ;
...
BEGIN
      ...
      ---------------------------------------------------------------------------------------------------------------
      -- UPDATE APR_AUX_HREOS_18797 (TBJ_ID, TAR_ID, TEX_ID) --
      ---------------------------------------------------------------------------------------------------------------
      ...
      LOOP
            ...
            EXIT WHEN CURSOR_OFERTAS%NOTFOUND;
                  ...
                  EXECUTE IMMEDIATE '
                        UPDATE '||V_ESQUEMA||'.APR_AUX_HREOS_18797 TRA
