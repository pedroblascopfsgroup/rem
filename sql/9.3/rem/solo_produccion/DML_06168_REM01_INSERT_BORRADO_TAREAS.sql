...
BEGIN
	...
	CASE 
		WHEN AUX.TAREA_ANTIGUA_TRAMITE = ''T015_AgendarFechaFirma'' THEN ''055''
		WHEN AUX.TAREA_ANTIGUA_TRAMITE = ''T015_CierreContrato'' THEN ''020''
		WHEN AUX.TAREA_ANTIGUA_TRAMITE = ''T015_SancionPatrimonio'' THEN ''052''
		WHEN AUX.TAREA_ANTIGUA_TRAMITE = ''T015_EnvioContrato'' THEN ''027''
