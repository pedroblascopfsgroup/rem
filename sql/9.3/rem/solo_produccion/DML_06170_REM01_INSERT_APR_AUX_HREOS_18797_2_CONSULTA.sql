...
V_SENTENCIA := 'TRUNCATE TABLE '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2_CONSULTA';

	EXECUTE IMMEDIATE V_SENTENCIA;

	DBMS_OUTPUT.PUT_LINE('[INFO] COMIENZA EL PROCESO DE MIGRACION SOBRE LA TABLA '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2_CONSULTA');

	
	V_SENTENCIA := 'INSERT INTO '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2_CONSULTA(
						 NUM_OFERTA            
						,ACT_ID		
						,ECO_ID		
						,TBJ_ID		
        	...
        	EXECUTE IMMEDIATE V_SENTENCIA;
       		...
       		V_SENTENCIA := 'MERGE INTO '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2_CONSULTA T1 
			   				USING(
								SELECT DISTINCT      
									 AUX.NUM_OFERTA		
									,EEC.DD_EEC_CODIGO
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] - '||to_char(sysdate,'HH24:MI:SS')||'  '||V_ESQUEMA||'..APR_AUX_HREOS_18797_2_CONSULTA cargada. '||SQL%ROWCOUNT||' Filas.');
