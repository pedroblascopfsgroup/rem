...
V_SENTENCIA := 'TRUNCATE TABLE '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2';
	...
	DBMS_OUTPUT.PUT_LINE('[INFO] COMIENZA EL PROCESO DE MIGRACION SOBRE LA TABLA '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2');
        	...
        	V_SENTENCIA := 'INSERT INTO '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2(NUM_OFERTA, TBJ_ID, ECO_ID, TPO_ID, TAREA_ANTIGUA_TRAMITE, TAREA_NUEVA_TRAMITE, USU_ID, SUP_ID, TRA_ID, TAR_ID_ANTERIOR, TEX_ID_ANTERIOR)(SELECT OFR_NUM_OFERTA,TBJ_ID, ECO_ID, (SELECT DD_TPO_CODIGO FROM '||V_ESQUEMA||'.DD_TPO_TIPO_PROCEDIMIENTO WHERE DD_TPO_CODIGO = ''T015''),TAP_CODIGO , NUEVA_TAREA, USU_ID, SUP_ID, TRA_ID, TAR_ID, TEX_ID
