...
DECLARE
      ...
      V_USUARIO VARCHAR2(50 CHAR) := 'HREOS-18797';
      V_TABLA VARCHAR2(40 CHAR) := 'APR_AUX_HREOS_18797_2'; -- Vble. Tabla pivote
      ...
      SELECT DISTINCT NUM_OFERTA  FROM REM01.APR_AUX_HREOS_18797_2 TRA
      ;
...
BEGIN
      ...
      ---------------------------------------------------------------------------------------------------------------
      -- UPDATE APR_AUX_HREOS_18797_2 (TBJ_ID, TAR_ID, TEX_ID) --
      ---------------------------------------------------------------------------------------------------------------
      
      DBMS_OUTPUT.PUT_LINE('[INFO] GENERANDO TBJ_ID, TAR_ID, TEX_ID...');
      ...
      LOOP
            ...
            EXIT WHEN CURSOR_OFERTAS%NOTFOUND;
                  ...
                  EXECUTE IMMEDIATE '
                        UPDATE '||V_ESQUEMA||'.APR_AUX_HREOS_18797_2 TRA
     ...
     /* EXECUTE IMMEDIATE '
      ...
      EXECUTE IMMEDIATE '
            ...
            FROM '||V_ESQUEMA||'.'||V_TABLA||' MIG2 WHERE MIG2.TAREA_NUEVA_TRAMITE IS NOT NULL
      '
      ;
