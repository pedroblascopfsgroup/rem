...
BEGIN
	...
	SELECT DISTINCT ECO.ECO_ID, CASE WHEN AUX.TAREA_ANTIGUA_TRAMITE = ''T018_TrasladarOfertaCliente'' OR AUX.TAREA_ANTIGUA_TRAMITE = ''T018_RevisionBcYCondiciones'' THEN  ''??''
    ...
    END AS DD_EEB_ID FROM REM01.OFR_OFERTAS OFR
    	...
    	JOIN '||V_ESQUEMA||'.ACT_ACTIVO ACT ON ACT.ACT_ID = ACO.ACT_D
