...
DECLARE
    ...
    V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-5361'; -- USUARIO CREAR/MODIFICAR
    ...
    V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
   	  ...
   	  T_FUNCION( 'gestinmug', 'lib.mcarreno'),  
	  T_FUNCION( 'gestinmug', 'lib.aortega'),
	  T_FUNCION( 'gestinmug', 'lib.gcampillo'),  
	  T_FUNCION( 'gestinmug', 'lib.smacanas'),
	  T_FUNCION( 'gestinmug', 'lib.jgil'),  
	  T_FUNCION( 'gestinmug', 'lib.jfernandez'),
	  T_FUNCION( 'gestinmug', 'lib.lgarcia'),  
	  T_FUNCION( 'gestinmug', 'lib.lmunoz'),
	  ----
	  T_FUNCION( 'dirgestinmug', 'lib.mcarreno'),  
	  T_FUNCION( 'dirgestinmug', 'lib.aortega'),
	  T_FUNCION( 'dirgestinmug', 'lib.gcampillo'),  
	  T_FUNCION( 'dirgestinmug', 'lib.smacanas'),
	  T_FUNCION( 'dirgestinmug', 'lib.jgil'),  
	  T_FUNCION( 'dirgestinmug', 'lib.jfernandez'),
	  T_FUNCION( 'dirgestinmug', 'lib.lgarcia'),  
	  T_FUNCION( 'dirgestinmug', 'lib.lmunoz'),
	  ----
	  T_FUNCION( 'cominvinmug', 'lib.mcarreno'),  
	  T_FUNCION( 'cominvinmug', 'lib.aortega'),
	  T_FUNCION( 'cominvinmug', 'lib.gcampillo'),  
	  T_FUNCION( 'cominvinmug', 'lib.smacanas'),
	  T_FUNCION( 'cominvinmug', 'lib.jgil'),  
	  T_FUNCION( 'cominvinmug', 'lib.jfernandez'),
	  T_FUNCION( 'cominvinmug', 'lib.lgarcia'),  
	  T_FUNCION( 'cominvinmug', 'lib.lmunoz'),
 	  ----
	  T_FUNCION( 'comdirug', 'lib.mcarreno'),  
	  T_FUNCION( 'comdirug', 'lib.aortega'),
	  T_FUNCION( 'comdirug', 'lib.gcampillo'),  
	  T_FUNCION( 'comdirug', 'lib.smacanas'),
	  T_FUNCION( 'comdirug', 'lib.jgil'),  
	  T_FUNCION( 'comdirug', 'lib.jfernandez'),
	  T_FUNCION( 'comdirug', 'lib.lgarcia'),  
	  T_FUNCION( 'comdirug', 'lib.lmunoz')
