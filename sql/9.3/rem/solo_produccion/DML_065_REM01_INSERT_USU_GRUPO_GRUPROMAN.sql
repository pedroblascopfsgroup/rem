...
DECLARE
	...
	V_USUARIO VARCHAR2(50 CHAR) := 'REMVIP-5378'; -- USUARIO CREAR/MODIFICAR
	...
	V_FUNCION T_ARRAY_FUNCION := T_ARRAY_FUNCION(
		T_FUNCION( 'gruproman' , 'lrisco'),
		T_FUNCION( 'gruproman' , 'msanzi'),
		T_FUNCION( 'gruproman' , 'imartin'),
		T_FUNCION( 'gruproman' , 'lcarrillo')
