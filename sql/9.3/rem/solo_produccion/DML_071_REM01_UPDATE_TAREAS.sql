...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-5403'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
				T_JBV(253584,3930642,8934350),
				T_JBV(253584,3930644,8934352)
				); 
	V_TMP_JBV T_JBV;
...
BEGIN	
	...
	ALTA_BPM_INSTANCES('REMVIP-5403', PL_OUTPUT);
