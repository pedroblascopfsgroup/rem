...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-5631'; -- USUARIOCREAR/USUARIOMODIFICAR.
...
BEGIN		
	...
	V_MSQL := ' MERGE INTO REM01.TAR_TAREAS_NOTIFICACIONES TAR
		    USING( 
				...
				AND TRA.TRA_ID IN (SELECT TRA_ID FROM REM01.AUX_REMVIP_5631)
			) AUX
		    ON ( AUX.TAR_ID = TAR.TAR_ID )
		    WHEN MATCHED THEN UPDATE SET
		    TAR_FECHA_FIN = TO_DATE(''30/10/2019'',''DD/MM/YYYY''),
