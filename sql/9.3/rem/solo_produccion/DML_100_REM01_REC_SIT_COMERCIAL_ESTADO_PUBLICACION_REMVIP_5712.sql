...
DECLARE
	...
	V_USUARIOMODIFICAR VARCHAR(100 CHAR):= 'REMVIP-5440';
   	...
   	V_MAX_PTO_ID NUMBER(16,0);
    	...
    	CURSOR ESTADO_PUBLI_RECALCULAR IS SELECT ACT.ACT_ID, AUX.ACT_NUM_ACTIVO
					  FROM REM01.AUX_REMVIP_5712 AUX, REM01.ACT_ACTIVO ACT 
...
--**************************************************************************************************************************
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] Guardando situación comercial inicial '); 


--	
	V_MSQL := 'UPDATE '||V_ESQUEMA||'.AUX_REMVIP_5712 
...
--**************************************************************************************************************************
	...
	DBMS_OUTPUT.PUT_LINE('[INICIO] Recalcular Estado publicación '); 
