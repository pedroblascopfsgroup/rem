...
DECLARE
    ...
    V_USR VARCHAR2(30 CHAR) := 'REMVIP-5927'; -- USUARIOCREAR/USUARIOMODIFICAR.
    V_ECO_ID NUMBER(16); 
	...
	V_JBV T_ARRAY_JBV := T_ARRAY_JBV(
				T_JBV(417215,	4799368,	9574595)
				); 
	V_TMP_JBV T_JBV;
    
BEGIN	
	DBMS_OUTPUT.PUT_LINE('[INICIO]');
	V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES WHERE TAR_ID = 4796030';
	...
	IF V_NUM_FILAS_2 > 0 THEN
		...
		V_MSQL := 'UPDATE '||V_ESQUEMA||'.TAR_TAREAS_NOTIFICACIONES 
				   ...
				   WHERE TAR_ID = 4796030';

	
		EXECUTE IMMEDIATE V_MSQL;
    
		DBMS_OUTPUT.PUT_LINE('[INFO] REGISTRO CON TAR_ID: 4796030 ACTUALIZADO');
	...
	V_SQL := 'SELECT COUNT(*) FROM '||V_ESQUEMA||'.TEX_TAREA_EXTERNA WHERE TEX_ID = 9571961';
	...
	IF V_NUM_FILAS_3 > 0 THEN
		...
		DBMS_OUTPUT.PUT_LINE('[INFO] REGISTRO CON TEX_ID: 9571961 ACTUALIZADO');
