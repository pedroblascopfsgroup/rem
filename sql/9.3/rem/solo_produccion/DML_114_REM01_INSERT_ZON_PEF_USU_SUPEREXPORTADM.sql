...
DECLARE
    ...
    --			USU_USERNAME			CODIGO PERFIL
	  T_FUNCION('smoya',			'SUPEREXPORTADMIN'),
	  T_FUNCION('gchisvert',		'SUPEREXPORTADMIN'),
	  T_FUNCION('pramirez',			'SUPEREXPORTADMIN'),
	  T_FUNCION('biglesias',		'SUPEREXPORTADMIN'),
	  T_FUNCION('vcastillo',		'SUPEREXPORTADMIN'),
	  T_FUNCION('amanzanob',		'SUPEREXPORTADMIN'),
	  T_FUNCION('eluque',			'SUPEREXPORTADMIN'),
	  T_FUNCION('mcastillol',		'SUPEREXPORTADMIN'),
	  T_FUNCION('mcanton',			'SUPEREXPORTADMIN'),
	  T_FUNCION('cberenguel',		'SUPEREXPORTADMIN'),
	  T_FUNCION('oramirez',			'SUPEREXPORTADMIN'),
	  T_FUNCION('abotella',			'SUPEREXPORTADMIN'),
	  T_FUNCION('ep.kdarocha',		'SUPEREXPORTADMIN'),
	  T_FUNCION('ep.acueto',		'SUPEREXPORTADMIN'),
	  T_FUNCION('zel.zjaimes',		'SUPEREXPORTADMIN'),
	  T_FUNCION('zel.lvelasco',		'SUPEREXPORTADMIN'),
	  T_FUNCION('ext.mvalenzuela',	'SUPEREXPORTADMIN'),
	  T_FUNCION('ext.agallo',		'SUPEREXPORTADMIN'),
	  T_FUNCION('zel.vgomez',		'SUPEREXPORTADMIN'),
	  T_FUNCION('zel.jmoreno',		'SUPEREXPORTADMIN'),
	  T_FUNCION('zel.atabares',		'SUPEREXPORTADMIN')
    );
