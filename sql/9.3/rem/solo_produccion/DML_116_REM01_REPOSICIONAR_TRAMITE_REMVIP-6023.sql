...
BEGIN	        
	...
	V_SQL := 'UPDATE '||V_ESQUEMA||'.OFR_OFERTAS SET DD_EOF_ID = 1 WHERE OFR_NUM_OFERTA = 90140051';
	EXECUTE IMMEDIATE V_SQL;
	
	-- CALL REPOSICIONAMIENTO_TRAMITE
	#ESQUEMA#.REPOSICIONAMIENTO_TRAMITE(V_USR, '145016', 'T013_RespuestaBankiaDevolucion', '145016', '06', PL_OUTPUT);
