...
DECLARE
	...
	--				    NOMBRE						TIPO COLUMNA		                COMENTARIO
		ARRAY_TABLE('DD_ABC_ID', 			    'NUMBER(16) NOT NULL',              'Comentario de ejemplo columna diccionario con FK.'),
		ARRAY_TABLE('XYZ_COLUMNA_A', 		    'VARCHAR2(20 CHAR)',                'Comentario de ejemplo columna a.'),
        ARRAY_TABLE('XYZ_COLUMNA_B', 		    'NUMBER(16, 2) NULL',               'Comentario de ejemplo columna b.')
	);
