...
DECLARE
    ...
    V_TABLE_NAME VARCHAR2(125 CHAR)      := 'DD_XYZ_EJEMPLO_TABLA'; -- Indica el nombre de la tabla de referencia.
	V_TABLE_COMMENT VARCHAR2(250 CHAR)  := 'Tabla diccionario de ejemplo'; -- Indica el comentario de la tabla de referencia.
