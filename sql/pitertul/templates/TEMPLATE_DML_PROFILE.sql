...
DECLARE
	...
	V_PROFILE_CODE VARCHAR2(100 CHAR) 			:= 'PERFIL_1'; -- Indica el código del perfil a unir con las funciones.
	V_PROFILE_DESCRIPTION VARCHAR2(50 CHAR)		:= 'Perfil de mismo'; -- Indica la descripción del perfil a unir con las funciones.
	V_PROFILE_L_DESCRIPTION VARCHAR2(250 CHAR)	:= 'Perfil para usuario de tipo mismo'; -- Indica la descripción larga del perfil a unir con las funciones.
