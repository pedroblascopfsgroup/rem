...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(  
      T_TIPO_TFA('SUPER_UCO','DSUPASU'),
      T_TIPO_TFA('SUPER_ULI','DSUPASU'),
      T_TIPO_TFA('S_UCO_V','DSUPASU'),
      T_TIPO_TFA('S_ULI_V','DSUPASU'),
      T_TIPO_TFA('S_UCO_H','DSUPASU'),
      T_TIPO_TFA('S_ULI_H','DSUPASU')
    ); 
