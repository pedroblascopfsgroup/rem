...
CREATE TABLESPACE "HAYA02" DATAFILE
	 '/oradata/HAYA02-01.dbf' SIZE 1G AUTOEXTEND ON NEXT 512M MAXSIZE  UNLIMITED
	,'/oradata/HAYA02-02.dbf' SIZE 1G AUTOEXTEND ON NEXT 512M MAXSIZE  UNLIMITED
	,'/oradata/HAYA02-03.dbf' SIZE 1G AUTOEXTEND ON NEXT 512M MAXSIZE  UNLIMITED
	LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
...
CREATE TABLESPACE "MINIREC" DATAFILE
	 '/oradata/MINIREC-01.dbf' SIZE 1G AUTOEXTEND ON NEXT 512M MAXSIZE  UNLIMITED 
	LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
