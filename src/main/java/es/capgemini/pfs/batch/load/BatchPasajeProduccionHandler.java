...
public abstract class BatchPasajeProduccionHandler extends FileHandler implements BatchPCRConstantes {
    ...
    /**
     * Variable static que referencia el canal al que se enviar� el evento.
     */
    ...
    public void run() {
        ...
        try {
            eventManager.fireEvent(EventManager.GENERIC_CHANNEL, "Inicio de pasaje de datos temporales a producci�n [" + workingCode + "]");
    ...
    /**
     * Lanza el veneto de que termin� en el canal que corresponde.
     */
