 ...
 */
@Entity
@Table(name = "TMP_RECOBRO_DETALLE_FACTURA", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Where(clause= Auditoria.UNDELETED_RESTICTION)
public class RecobroDetalleFacturacionTemporal implements Serializable{

	/**
	 * SERIALUID
	 */
	private static final long serialVersionUID = -3302804948552711179L;
