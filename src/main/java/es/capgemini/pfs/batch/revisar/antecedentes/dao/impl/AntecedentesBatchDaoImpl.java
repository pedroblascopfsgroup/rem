...
public class AntecedentesBatchDaoImpl implements AntecedentesBatchDao {
	 ...
	 * @param diasIrregular
	 *            cantidad máxima de dias en falta
	 * @param fechaExtraccion
	 *            Date
	 * @param contratoId
	 *            id del contrato
	 */
	public void actualizarAntecedenteInterno(Long contratoId,
			Double posIrregular, Long diasIrregular, Date fechaExtraccion) {
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		Object[] args = { posIrregular, posIrregular, diasIrregular,
				diasIrregular, df.format(fechaExtraccion), contratoId };
		JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
		jdbcTemplate.update(updateAntecedenteInternoQuery, args);
		logger.debug("Se actualizó el antecedente interno para el contrato con id: "
				+ contratoId);
	}
	...
	public Long buscarAntecedente(Long personaId) {
		...
		return (Long) jdbcTemplate.queryForObject(
				buscarAntecedentePersonaQuery, new Object[] { personaId },
				Long.class);
	...
	public Long buscarAntecedenteInterno(Long contratoId) {
		...
		try {
			return (Long) jdbcTemplate.queryForObject(
					buscarAntecendeteInternoQuery, new Object[] { contratoId },
					Long.class);
	...
	public void generarAntecedenteBase(Long personaId) {
		...
		Long antecedente = (Long) jdbcTemplate.queryForObject(
				buscarUltimoAntecedenteQuery, Long.class);

		Object[] argsUpdateAntecedenteEnPersona = { antecedente, personaId };

		jdbcTemplate.update(updateAntecedenteEnPersonaQuery,
				argsUpdateAntecedenteEnPersona);
		logger.debug("Se generó un antecendete base para la persona con id: "
				+ personaId);
	}
	 ...
	 *            date
	 */
	public void generarAntecedenteInterno(Long cntId, Double posIrregularMax,
			Long diasIrregularMax, Date fechaExtraccion) {
		JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		Object[] argsInsertarAntecedenteInterno = { cntId, posIrregularMax,
				diasIrregularMax, df.format(fechaExtraccion) };
		jdbcTemplate.update(insertarNuevoAntecedenteInternoQuery,
				argsInsertarAntecedenteInterno);
		logger.debug("Se generó un antecedente interno para el contrato con id: "
				+ cntId);
	}
	...
	public void incrementarReincidencia(Long contratoId) {
		JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
		jdbcTemplate.update(incrementarAntecedenteQuery,
				new Object[] { contratoId });
		logger.debug("Se incrementó en 1 la cantidad de reincidencias para el contrato con id: "
				+ contratoId);
	}
	 ...
	 */
	public void setUpdateAntecedenteInternoQuery(
			String updateAntecedenteInternoQuery) {
	 ...
	 */
	public void setBuscarAntecedentePersonaQuery(
			String buscarAntecedentePersonaQuery) {
	 ...
	 */
	public void setBuscarAntecendeteInternoQuery(
			String buscarAntecendeteInternoQuery) {
	 ...
	 */
	public void setBuscarUltimoAntecedenteQuery(
			String buscarUltimoAntecedenteQuery) {
	 ...
	 */
	public void setInsertarNuevoAntecedenteQuery(
			String insertarNuevoAntecedenteQuery) {
	 ...
	 */
	public void setUpdateAntecedenteEnPersonaQuery(
			String updateAntecedenteEnPersonaQuery) {
	 ...
	 */
	public void setInsertarNuevoAntecedenteInternoQuery(
			String insertarNuevoAntecedenteInternoQuery) {
	 ...
	 */
	public void setIncrementarAntecedenteQuery(
			String incrementarAntecedenteQuery) {
