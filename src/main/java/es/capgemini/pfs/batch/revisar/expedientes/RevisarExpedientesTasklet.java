...
public class RevisarExpedientesTasklet implements ValidationTasklet {
    ...
    public ExitStatus execute() throws Exception {
        ...
        if (expedientesBatchManager == null){
        	throw new IllegalStateException("Componente mal configurado, falta expedientesBatchManager");
        }
        
        if (movimientosBatchManager == null){
        	throw new IllegalStateException("Componente mal configurado, falta movimientosBatchManager");
        }
