...
public class EXTExpedientesManager implements EXTExpedientesApi{
	 ...
	 * congelado. De ser asi lanza una excepciï¿½n
	 * 
	 * @param idContrato
	 ...
	 * congelado de seguimiento. De ser asi lanza una excepciï¿½n
	 * 
	 * @param idPersona
	 * @throws BusinessOperationException
	 *             contrato en otro expediente.
	...
	private List<ExpedienteContrato> setearContratosExpediente(
		 ...
		 * auditorï¿½a poruqe los objetos ExpedienteContrato se salvan
		 * indirectamente al salvar el expediente, por lo tanto nunca se ejecuta
		 * el save de su dao, que es el que deberï¿½a crear el obj de
		 * auditorï¿½a. No se puede llamar al save del dao de ExpedienteContrato
		 * porque todavï¿½a no existe el Expediente al cual asociarlo.
		 */
		List<Long> contratosPase = new ArrayList<Long>(1);
		List<Long> contratosMarcados = hContratos.get(MAP_CONTRATOS_MARCADOS);
