 ...
 */
@Entity
@Table(name = "DD_TIC_TIPO_CONCURSO", schema = "${entity.schema}")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
public class DDTipoConcurso implements Auditable, Dictionary {

	private static final long serialVersionUID = 1L;
	public static final String FASE_COMUN_ABREVIADO = "ABREVIADO";
	public static final String FASE_COMUN_ORDINARIO = "ORDINARIO";
