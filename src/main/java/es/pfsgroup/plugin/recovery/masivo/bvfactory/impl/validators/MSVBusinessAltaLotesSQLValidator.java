...
@Component
public class MSVBusinessAltaLotesSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {
	
	@Autowired(required=false)
	MSVFactoriaQuerysSQLValidarAltaLotes msvQuerys;

	public String getCodigoTipoOperacion() {
		return MSVDDOperacionMasiva.CODIGO_ALTA_LOTES;
	}
	...
	public MSVFactoriaQuerysSQLValidarAltaLotes getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLValidarAltaLotes msvQuerys) {
