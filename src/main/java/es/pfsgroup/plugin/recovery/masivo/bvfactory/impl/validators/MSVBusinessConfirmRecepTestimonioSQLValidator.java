...
@Component
public class MSVBusinessConfirmRecepTestimonioSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLConfirmRecepTestimonio msvQuerys;
	...
	public MSVFactoriaQuerysSQLConfirmRecepTestimonio getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLConfirmRecepTestimonio msvQuerys) {
