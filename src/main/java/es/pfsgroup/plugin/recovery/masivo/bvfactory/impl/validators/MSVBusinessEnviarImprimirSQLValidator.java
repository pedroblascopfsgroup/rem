...
@Component
public class MSVBusinessEnviarImprimirSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLEnviarImprimir msvQuerys;

	@Override
	public String getCodigoTipoOperacion() {
		return MSVDDOperacionMasiva.CODIGO_IMPRESION_DOCUMENTACION;
	}
	...
	public MSVFactoriaQuerysSQLEnviarImprimir getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLEnviarImprimir msvQuerys) {
