...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.querys.MSVFactoriaQuerysSQLEnvioDemanda;
...
@Component
public class MSVBusinessEnvioDemandaSQLValidator implements
		MSVBusinessValidatorsAutowiredSupport {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLEnvioDemanda msvQuerys;

	@Override
	public String getCodigoTipoOperacion() {
		return MSVDDOperacionMasiva.CODIGO_ENVIO_DEMANDA;
	}
	...
	public MSVFactoriaQuerysSQLEnvioDemanda getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLEnvioDemanda msvQuerys) {
