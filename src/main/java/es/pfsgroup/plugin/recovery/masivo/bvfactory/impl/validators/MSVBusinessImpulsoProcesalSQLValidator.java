...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.querys.MSVFactoriaQuerysSQLImpulsoProcesal;
...
@Component
public class MSVBusinessImpulsoProcesalSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLImpulsoProcesal msvQuerys;
	...
	public MSVFactoriaQuerysSQLImpulsoProcesal getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLImpulsoProcesal msvQuerys) {
