...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.querys.MSVFactoriaQuerysSQLValidarFicheroTasas;
...
@Component
public class MSVBusinessValidarFicheroTasasSQLValidator implements MSVBusinessValidatorsAutowiredSupport  {

	@Autowired(required=false)
	MSVFactoriaQuerysSQLValidarFicheroTasas msvQuerys;
	...
	public MSVFactoriaQuerysSQLValidarFicheroTasas getMsvQuerys() {
		return msvQuerys;
	}

	public void setMsvQuerys(MSVFactoriaQuerysSQLValidarFicheroTasas msvQuerys) {
