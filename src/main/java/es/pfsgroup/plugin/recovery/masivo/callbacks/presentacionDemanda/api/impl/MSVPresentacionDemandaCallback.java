package es.pfsgroup.plugin.recovery.masivo.callbacks.presentacionDemanda.api.impl;
...
@Component
public class MSVPresentacionDemandaCallback extends
		AbstractRecoveryBPMfwCallbackBOTemplate implements
		MSVPresentacionDemandaCallbackApi {
	 ...
	 */
	@Override
	@BusinessOperation(MSV_PRESENTACION_DEMANDA_CALLBACK_ONEND)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_PRESENTACION_DEMANDA_CALLBACK_ONERROR)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_PRESENTACION_DEMANDA_CALLBACK_ONSTART)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_PRESENTACION_DEMANDA_CALLBACK_ONSUCCESS)
...
//		} else {
//			BigDecimal principal = MSVUtils.getBigDecimal(String.valueOf(input.getDatos().get(MSVPresentacionDemandaColumns.PRINCIPAL)));
//			if (!Checks.esNulo(principal)) {
//				procedimiento.setSaldoRecuperacion(principal);
//				actualizaProc = true;
//			}
//			
//			String partidoJudicial = String.valueOf(input.getDatos().get(MSVPresentacionDemandaColumns.PARTIDO_JUDICIAL));
//			if (!Checks.esNulo(partidoJudicial)) {				
