package es.pfsgroup.plugin.recovery.masivo.callbacks.redaccDem.api.impl;
...
@Component
public class MSVRedaccDemCallback extends
		AbstractRecoveryBPMfwCallbackBOTemplate implements
		MSVRedaccDemCallbackApi {
	 ...
	 */
	@Override
	@BusinessOperation(MSV_REDACC_DEM_CALLBACK_ONEND)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_REDACC_DEM_CALLBACK_ONERROR)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_REDACC_DEM_CALLBACK_ONSTART)
	 ...
	 */
	@Override
	@BusinessOperation(MSV_REDACC_DEM_CALLBACK_ONSUCCESS)
