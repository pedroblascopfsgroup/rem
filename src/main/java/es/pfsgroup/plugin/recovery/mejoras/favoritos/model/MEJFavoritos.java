package es.pfsgroup.plugin.recovery.mejoras.favoritos.model;
...
public class MEJFavoritos implements Serializable, Auditable {
    ...
    public Long getEntidadId() {
        ...
        } else if (MEJFavoritosDaoImpl.CODIGO_ENTIDAD_BIEN.equals(entidadInformacion.getCodigo())) {
            return this.getBien().getId();
        } else if (MEJFavoritosDaoImpl.CODIGO_ENTIDAD_ASUNTOND.equals(entidadInformacion.getCodigo())) {
            return this.getAsunto().getId();
        } else {
            return null;
        }
    ...
    public String getNombre() {
        if (DDTipoEntidad.CODIGO_ENTIDAD_ASUNTO.equals(entidadInformacion.getCodigo())) {
            ...
            return this.getBien().getId().toString()+ ' ' + this.getBien().getTipoBien().getDescripcion().toUpperCase();
        } else if (MEJFavoritosDaoImpl.CODIGO_ENTIDAD_ASUNTOND.equals(entidadInformacion.getCodigo())) {
        	return this.getAsunto().getNombre();
        } else {
            return null;
