...
@Component
public class MEJHistoricoModProcedimientoBuilder implements HistoricoProcedimientoBuilder {

	public static final String NOMBRE_TAREA = "Modificaci�n datos Procedimiento";

	protected static final long ID_TIPO_ENTIDAD_INFORMACION = 14 ;
	...
	private MEJTrazaDto dtoBusqueda(final long idProcedimiento) {
		...
		params.put("tipoEvento", MEJDDTipoRegistro.CODIGO_EDICION_PROCEDIMIENTO);
