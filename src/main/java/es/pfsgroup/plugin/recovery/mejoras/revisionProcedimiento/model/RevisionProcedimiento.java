package es.pfsgroup.plugin.recovery.mejoras.revisionProcedimiento.model;
...
public class RevisionProcedimiento implements Serializable, Auditable {

	private static final long serialVersionUID = -3745056486147306300L;

	@Id
	@Column(name = "RPR_ID")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "RevisionProcedimientoGenerator")
	@SequenceGenerator(name = "RevisionProcedimientoGenerator", sequenceName = "S_RPR_REVISION_PROCEDIMIENTO")
	private Long id;
	...
	@Column(name = "RPR_FECHA_REVISADO")
