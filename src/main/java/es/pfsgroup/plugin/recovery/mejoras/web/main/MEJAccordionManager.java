...
@Component
public class MEJAccordionManager {

	@Autowired
	private ApiProxyFactory proxyFactory;

	@BusinessOperation("accordionManager.getAccordionExtrasDefinition")
	List<DynamicElement> getAccordionExtrasDefinition(String entity) {
		List<DynamicElement> l = proxyFactory.proxy(DynamicElementApi.class)
				.getDynamicElements(entity, null);
		if (l == null)
