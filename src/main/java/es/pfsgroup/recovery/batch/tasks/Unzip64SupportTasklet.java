...
import es.pfsgroup.commons.utils.PFSZipUtil;

public class Unzip64SupportTasklet implements Tasklet, StepExecutionListener {
    ...
    public ExitStatus execute() {
        ...
        try {
        	File archiveFile = new File(zipFileName);
            File unzipDestFolder = null;
        	
        	PFSZipUtil.extractZip(zipFileName, pathToExtract);
            
        } catch (Exception e) {
        	 File unzipDestFolder = new File(pathToExtract);
