...
'IMPULSO_PROC_BATCH' BPM_DD_TIN_CODIGO, 
...
WHERE BPM_DD_TIN_CODIGO = 'IMPULSO_PROC');
...
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT WHERE BPM_DD_TIN_CODIGO = 'IMPULSO_PROC_BATCH') BPM_DD_TIN_ID,
DD_INFORME_ID, BPM_TPI_NODE_INC, BPM_TPI_NODE_EXC,
0 VERSION, 'MASIVO' USUARIOCREAR, SYSDATE FECHACREAR, 
...
WHERE BPM_DD_TIN_ID IN
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT
WHERE BPM_DD_TIN_CODIGO = 'IMPULSO_PROC_BATCH')) TIN,
...
WHERE BPM_DD_TIN_ID IN
(SELECT BPM_DD_TIN_ID FROM BPM_DD_TIN_TIPO_INPUT
WHERE BPM_DD_TIN_CODIGO = 'IMPULSO_PROC'))) DAT
