...
--## Author: Gonzalo
--## T.Fase Convenio
--## Finalidad: Adaptar los valores de diccionario para definir resultado SAREB
--## INSTRUCCIONES: 
--## VERSIONES:
--##        0.1 Versión inicial
--######################################################################
...
BEGIN	
    ...
    EXECUTE IMMEDIATE V_SQL;
	V_SQL := 'UPDATE '||V_ESQUEMA||'.DD_RCC_RES_COMITE_CONCURS SET BORRADO=1,FECHABORRAR=sysdate,USUARIOBORRAR=''DD'' WHERE DD_RCC_CODIGO=''MODIFICAR''';
    EXECUTE IMMEDIATE V_SQL;
