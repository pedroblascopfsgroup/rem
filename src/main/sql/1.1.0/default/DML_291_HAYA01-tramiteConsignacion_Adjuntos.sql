...
DECLARE
    ...
    V_TIPO_TFA T_ARRAY_TFA := T_ARRAY_TFA(
      ...
      T_TIPO_TFA('JUSPG', 'Justificante de pago (Consignación)', 'Justificante de pago (Consignación)', 'AP'),
      T_TIPO_TFA('ESCPRJUZ', 'Escrito de presentación en el juzgado (Consignación)', 'Escrito de presentación en el juzgado (Consignación)', 'AP')
