...
BEGIN
    ...
    V_MSQL := 'DELETE FROM TFI_TAREAS_FORM_ITEMS '
 				|| ' WHERE TFI_NOMBRE = ''comboEntidadAdjudicataria'' AND TAP_ID = (SELECT TAP_ID FROM TAP_TAREA_PROCEDIMIENTO WHERE TAP_CODIGO = ''H005_notificacionDecretoAdjudicacionAEntidad'')';
