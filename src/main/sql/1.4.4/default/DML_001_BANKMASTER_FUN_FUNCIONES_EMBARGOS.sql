...
--##########################################
--## Author: Carlos Pérez
--## Finalidad: DML para insertar la funcion para visualizar la pestaña de embargos de un bien
	...
	FOR I IN V_FUNCION.FIRST .. V_FUNCION.LAST
      LOOP
        ...
        EXECUTE IMMEDIATE V_MSQL INTO V_ENTIDAD_ID;
			...
			V_SQL := 'SELECT COUNT(1) FROM FUN_FUNCIONES WHERE FUN_DESCRIPCION = '''||TRIM(V_TMP_FUNCION(2))||'''';
