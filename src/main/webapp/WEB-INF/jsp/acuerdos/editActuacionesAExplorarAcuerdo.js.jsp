...
<fwk:page>
	...
	var btnGuardar = new Ext.Button({
		...
		<app:test id="btnGuardarActAExplorar" addComa="true" />
		,iconCls : 'icon_ok'
		,handler : function(){
			if (!observaciones.validate()) {
				...
				page.webflow({
					flow : 'acuerdos/saveActuacionAExplorar'
					,params : {idAcuerdo: '${idAcuerdo}', idActuacion: '${actuaciones.id}'
	                           ,ddSubtipoSolucionAmistosaAcuerdo:'${subtipoSolucionAmistosa.codigo}', ddValoracionActuacionAmistosa:tipoValoracionActual.getValue()
