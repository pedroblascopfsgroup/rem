...
var crearAcuerdosTab=function(){
   ...
   var despuesDeEvento = function(){
   		acuerdosGrid.getSelectionModel().selectRow(acuerdoSeleccionado-1);
		acuerdosGrid.fireEvent('rowclick', acuerdosGrid, acuerdoSeleccionado-1);
