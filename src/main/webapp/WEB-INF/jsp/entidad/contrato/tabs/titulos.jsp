...
(function(page,entidad){
   ...
   var deshabilitarBotones = function(){
    ...
    var titulosCM  = new Ext.grid.ColumnModel([
		...
		{header:'Notario',dataIndex:'notario',width:120},
		{header:'Calle',dataIndex:'calleNotario',width:120,hidden:true},
		{header:'Teléfono1',dataIndex:'telefono1Notario',width:120,hidden:true},
		{header:'Provincia',dataIndex:'provinciaNotario',width:120,hidden:true}
    ]);
