...
(function(page,entidad){
  ...
  panel.setValue = function(){
    gestionesRealizadas.setText(entidad.getData("gestion.gestiones"));
    causasImpago.setText(entidad.getData("gestion.causaImpago"));
    comentarios.setText(entidad.getData("gestion.comentariosSituacion"));
    propuesta.setText(entidad.getData("gestion.propuestaActuacion"));
    tipoAyuda.setText(entidad.getData("gestion.tipoAyuda"));
    descripcionTipoAyudaActuacion.setText(entidad.getData("gestion.descripcionTipoAyudaActuacion"));
    tipoPropuestaActuacion.setText(entidad.getData("gestion.tipoPropuestaActuacion"));
    revision.setText(entidad.getData("gestion.revision"));
  ...
  var estadoItinerario = entidad.getData('gestion.estadoItinerario');
	...
	<sec:authorize ifAllGranted="EDITAR_GYA_REV">
    if ((estadoExpediente != app.estExpediente.ESTADO_CANCELADO && estadoExpediente != app.estExpediente.ESTADO_BLOQUEADO) && (estadoItinerario==app.estItinerario.ESTADO_RE) && (permisosVisibilidadGestorSupervisor(perfilGestor) || permisosVisibilidadGestorSupervisor(perfilSupervisor) ) ){
