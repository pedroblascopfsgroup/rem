...
Ext.onReady(function() {
	...
	var nodos = [
	             { text : '<s:message code="main.arbol_tareas.pendientes" text="**Tareas pendientes" /> (${countTareas[0]})'
					...
					,listeners :tabListener("<s:message code="tareas.pendientes" text="**tareas pendientes"/>", "tareas/listadoTareas",
								{
									codigoTipoTarea:'1',
									alerta:false,									
									espera:false,
							...
							,listeners: tabListener("<s:message code="tareas.pendientes" text="**tareas pendientes"/>", "tareas/listadoTareas",
								{
									...
									,isBusqueda:true
									,noGrouping:true
									,fechaVencDesde:app.format.dateRenderer(new Date().getLastDateOfMonth())
									,fechaVencDesdeOp:'>'
	             ...
	             ,{ text : '<s:message code="main.arbol_tareas.espera" text="**Tareas espera" /> (${countTareas[1]})'
					...
					,style:nodeStyle
					,iconCls:'icon_espera'
					,listeners :tabListener("<s:message code="tareas.enespera" text="**tareas en espera"/>", "tareas/listadoTareas",
								{
									codigoTipoTarea:'1',
									alerta:false,
									espera:true,
					...
					,listeners :tabListener("<s:message code="tareas.notificaciones" text="**Notificaciones"/>", "tareas/listadoTareas",
								{
									codigoTipoTarea:'3',
									alerta:false,
									espera:false,
							...
							,listeners: tabListener('<s:message code="tareas.notificaciones" text="**Notificaciones"/>', "tareas/listadoTareas",
								{
									...
									,isBusqueda:true
									,noGrouping:true
									,fechaInicioDesde:app.format.dateRenderer(new Date())
									,fechaInicioDesdeOp:'='
									,tituloAdicionalGrid:'<s:message code="main.arbol_tareas.groups.hoy" text="**Hoy" /> '
								},
								{id:'tareas_notificaciones',iconCls:'icon_comunicacion_tab'})
							...
							,listeners: tabListener('<s:message code="tareas.notificaciones" text="**Notificaciones"/>', "tareas/listadoTareas",
								{
									...
									,isBusqueda:true
									,noGrouping:true
									,fechaInicioDesde:app.format.dateRenderer(app.getFirstDateOfWeek(new Date()))
									,fechaInicioDesdeOp:'>='
									,fechaInicioHasta:app.format.dateRenderer(app.getLastDateOfWeek(new Date()))
									,fechaInicioHastaOp:'<='
									,tituloAdicionalGrid:'<s:message code="main.arbol_tareas.groups.estasemana" text="**Esta Semana" /> '
								},
								{id:'tareas_notificaciones',iconCls:'icon_comunicacion_tab'})
							...
							,listeners: tabListener('<s:message code="tareas.notificaciones" text="**Notificaciones"/>', "tareas/listadoTareas",
								{
									...
									,isBusqueda:true
									,noGrouping:true
									,fechaInicioDesde:app.format.dateRenderer(new Date().getFirstDateOfMonth())
									,fechaInicioDesdeOp:'>='
									,fechaInicioHasta:app.format.dateRenderer(new Date().getLastDateOfMonth())
									,fechaInicioHastaOp:'<='
									,tituloAdicionalGrid:'<s:message code="main.arbol_tareas.groups.estemes" text="**Este Mes" /> '
								},
								{id:'tareas_notificaciones',iconCls:'icon_comunicacion_tab'})
							...
							,listeners: tabListener('<s:message code="tareas.notificaciones" text="**Notificaciones"/>', "tareas/listadoTareas",
								{
									...
									,isBusqueda:true
									,noGrouping:true
									,fechaInicioHasta:app.format.dateRenderer(new Date().getFirstDateOfMonth())
									,fechaInicioHastaOp:'<'
					...
					,style:nodeStyle
					,iconCls:'icon_alerta'
					,listeners :tabListener('<s:message code="tareas.alertas" text="**Alertas"/>', "tareas/listadoTareas",
								{
									codigoTipoTarea:'1',
									alerta:true,
									espera:false,
