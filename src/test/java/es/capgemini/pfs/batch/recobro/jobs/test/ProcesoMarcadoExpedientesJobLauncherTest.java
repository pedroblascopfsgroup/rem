...
import es.capgemini.pfs.batch.recobro.api.test.GenericConstantsTest.ProcesoMarcadoExpedientes;
...
public class ProcesoMarcadoExpedientesJobLauncherTest extends GenericTest{
	...
	public void test() {	
		try{
			...
			testLaunchDevonJob(getJob(ProcesoMarcadoExpedientes.PROCESO_MARCADO_EXPEDIENTES_JOBNAME), parameters);			
		}catch(Throwable e){
			logger.error(e);
			fail();
		}
	...
	protected ConfigLoadData loadConfigLoadDataTest() {
		...
		try{
			...
			configLoadDataTest.setSqlFile("loadTestData/recobro/procesoMarcadoExpedientes.xml");
		}catch(Throwable e){
			logger.error(e);
			fail();
		}
	...
	protected ConfigValidationData loadConfigValidationDataTest() {
		...
		try{
			...
			configValidationDataTest.setSqlFile("validationTestData/recobro/procesoMarcadoExpedientes.xml");
		}catch(Throwable e){
			logger.error(e);
			fail();
		}
	...
	protected ConfigPostData loadConfigPostDataTest() {
		...
		try{
			...
			configPostDataTest.setSqlFile("postTestData/recobro/procesoMarcadoExpedientes.xml");
		}catch(Throwable e){
			logger.error(e);
			fail();
		}
