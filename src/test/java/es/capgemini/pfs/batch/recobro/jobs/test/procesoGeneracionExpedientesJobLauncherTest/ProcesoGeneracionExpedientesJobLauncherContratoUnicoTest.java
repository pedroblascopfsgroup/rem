 ...
 * Recobro. Este test prueba la generación del expediente en base a un contrato
 * único.
 * 
 * @author Guillem
 * 
...
public class ProcesoGeneracionExpedientesJobLauncherContratoUnicoTest extends
		GenericTest {
	...
	protected ConfigLoadData loadConfigLoadDataTest() {
		...
		try {
			...
			configLoadDataTest
					.setSqlFile("loadTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_contratoUnico.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
	...
	protected ConfigValidationData loadConfigValidationDataTest() {
		...
		try {
			...
			configValidationDataTest
					.setSqlFile("validationTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_contratoUnico.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
