 ...
 * contratos del grupo y de la segunda generación.
 * 
 * @author Guillem
 * 
 */
...
public class ProcesoGeneracionExpedientesJobLauncherGrupoySegundaGeneracionTest
		extends GenericTest {
	...
	protected ConfigLoadData loadConfigLoadDataTest() {
		...
		try {
			...
			configLoadDataTest
					.setSqlFile("loadTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_segundaGeneracion.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
	...
	protected ConfigValidationData loadConfigValidationDataTest() {
		...
		try {
			...
			configValidationDataTest
					.setSqlFile("validationTestData/recobro/procesoGeneracionExpedientes/procesoGeneracionExpedientes_segundaGeneracion.xml");
		} catch (Throwable e) {
			logger.error(e);
			fail();
		}
