 ...
 *
 */
public class ArquetipoFechaMenorXML extends ArquetipoTest {

    public ArquetipoFechaMenorXML() {
        id = 1L;
        ...
        definitionRule = "<rule type=\"compare1\" title=\"Fecha creacion &lt;20/12/1900\" ruleid=\""
                + Arquetipo_Test_Constants.DD_RULE_CNT_FECHA_CREACION + "\" operator=\"lessThan\" values=\"[20/12/1900]\" />";
    }
