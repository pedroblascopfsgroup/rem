package es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.es.pfsgroup.plugin.recovery.masivo.test.bvfactory.impl.validators.MSVBusinessEnviarJuzgadoSQLValidator;
...
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.MSVBusinessEnviarJuzgadoSQLValidator;
import es.pfsgroup.plugin.recovery.masivo.bvfactory.impl.validators.querys.MSVFactoriaQuerysSQLEnviarJuzgado;
...
public class TestMSVBusinessEnviarJuzgadoSQLValidator extends MSVBusiness_OPERACIONES_SQLValidator {
	@Mock
	private MSVFactoriaQuerysSQLEnviarJuzgado mockMsvQuerys;

	@InjectMocks
	private MSVBusinessEnviarJuzgadoSQLValidator validator;

	@Test
	public void testCodigoTipoOperacion() {
		super.testCodigoTipoOperacion(MSVDDOperacionMasiva.CODIGO_ENVIO_JUZGADO, validator);
	}
