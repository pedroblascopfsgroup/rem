 ...
 *
 */
public abstract class AbstractRecoveryBPMfwkInputAvanzarBPMExecutorTest extends AbstractRecoveryBPMFwkTests{

    @InjectMocks
    protected RecoveryBPMfwkInputAvanzarBPMExecutor executor;
    ...
    @Mock
    protected EXTJBPMProcessApi mockEXTJBPMProcessManager;
    
    @Mock
    private ApiProxyFactory mockProxyFactory;
    
    @Mock
    protected RecoveryBPMFwkProcessApi mockBpmFwkProcessManager;
