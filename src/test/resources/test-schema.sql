...
(
  USU_ID                   NUMBER(16)           IDENTITY NOT NULL,
...
(
  DES_ID                NUMBER(16)              IDENTITY NOT NULL,
...
CREATE TABLE USD_USUARIOS_DESPACHOS (
    USD_ID              INTEGER                    IDENTITY NOT NULL,
...
CREATE TABLE PEF_PERFILES  (
   PEF_ID               INTEGER              IDENTITY NOT NULL,
   ...
   FECHABORRAR          DATETIME,
   BORRADO              INTEGER             DEFAULT 0 NOT NULL,
   PEF_ES_CARTERIZADO     NUMBER(1)              DEFAULT 0,
   DTYPE                  VARCHAR2(200 CHAR)     DEFAULT 'EXTPerfil',
...
(
  ...
  ZPU_ID            NUMBER(16)                  IDENTITY NOT NULL,
  VERSION           INTEGER                     DEFAULT 0                     NOT NULL,
  USUARIOCREAR      VARCHAR2(10 CHAR)           NOT NULL,
  FECHACREAR        TIMESTAMP(6)                NOT NULL,
  USUARIOMODIFICAR  VARCHAR2(10 CHAR),
...
(
  ...
  PEF_ID            NUMBER(16)                  NOT NULL,
  FP_ID             NUMBER(16)                  IDENTITY NOT NULL,
