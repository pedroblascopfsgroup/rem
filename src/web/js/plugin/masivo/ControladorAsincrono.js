...
es.pfs.plugins.masivo.ControladorAsincrono = Ext.extend(Object,{  //Step 1  
...
//        console.debug("ControladorAsincrono constructor!");  
    ...
    recargarAyuda: function(idTipoResolucion, funcionCallBack){
		//debugger;
		Ext.Ajax.request({
			url: '/pfs/msvprocesadoresoluciones/dameAyuda.htm'
    ...
    procesarResolucion: function(idResolucion, funcionCallBack){
		...
		//var idTipoOperacion = form.findField('id').getValue();
		Ext.Ajax.request({
			url: '/pfs/msvprocesadoresoluciones/procesarResolucion.htm'
