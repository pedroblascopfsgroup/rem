...
<fwk:page>
	...
	**************DATOS DEL ASUNTO*************************
	...
	<pfsforms:datefield labelKey="plugin.busquedaProcedimientos.busca.fechaConformacionAsuntoDesde" 
		label="**Fecha de conformación entre" name="filtroFechaConformacionAsuntoDesde"/>
	<%-- 	
	...
	<pfsforms:datefield labelKey="plugin.busquedaProcedimientos.busca.fechaAceptacionInicialMin" 
		label="**Fecha de aceptación desde " name="filtroFechaAceptacionInicialDesde"/>
	<%--	
	<pfsforms:datefield labelKey="plugin.busquedaProcedimientos.busca.fechaAceptacionInicialMax" 
		label="**Fecha de aceptación hasta " name="filtroFechaAceptacionInicialHasta"/>
	 --%>
	...
	*************************************************************************--%>	
	...
	filtroPorcentajeRecup.min.on('blur', function(field) {
            	if (!field.isValid()) {
                	Ext.Msg.alert('', 'El valor: ' + field.getValue() + ' es inválido');
                	field.reset();
                }
            });
	...
	var fechaCrecionMinMax = function(){
		...
		return {
			min : min
			,max : max
			,panel : app.creaPanelHz(cfgPanel,[{html:**Fecha creación+ ":", border: false, width : labelWidth, cls: 'x-form-item'}, min, {html : ' ', border:false, width : 5},  max])
		};
	};
	 --%>
	...
	************************************************************************************** --%>	 
	...
	<pfsforms:datefield labelKey="plugin.busquedaProcedimientos.busqueda.finSegundaTarea" label="**Fecha de fin de la última tarea" name="filtroFechaFinUltimaTarea"/>
	...
	<pfsforms:datefield labelKey="plugin.busquedaProcedimientos.busqueda.finSegundaTarea" label="**Fecha de fin de la última tarea" name="filtroFechaFinUltimaTareaDesde"/>
	...
	*******************************************************************************************
	...
	<%--**************************************************************************
	************DEFINIMOS EL GRID RESULTADO DE LA BÚSQUEDA************************
	 *******************************************************************************--%>
