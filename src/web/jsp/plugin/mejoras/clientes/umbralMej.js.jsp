...
<fwk:page>
		...
		var today = new Date();
		var plazoMilisegundos = today.getTime() + ${plazoMaximo.plazo};
		var maxDate=new Date(plazoMilisegundos);
		...
		var observaciones = new Ext.form.TextArea({
				...
				,value:'<s:message text="${persona.comentarioUmbral}" javaScriptEscape="true" />'
