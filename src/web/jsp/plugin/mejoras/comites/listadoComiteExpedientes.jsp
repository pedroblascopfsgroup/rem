...
<fwk:page>
   ...
   asistenteStore.webflow();
	...
	var expCm = new Ext.grid.ColumnModel([
		    ...
		    {	header: '<s:message code="expedientes.listado.fechacreacion" text="**Fecha Creacion"/>',width: 120, sortable: true, dataIndex: 'fechacrear'},
		    ...
		    {	header: '<s:message code="expedientes.listado.fvencimiento" text="**Fecha Vencimiento"/>', width: 120, sortable: true, dataIndex: 'fechaVencimiento'},
    ...
    var asuntosStore = page.getStore({
        flow:'plugin/mejoras/comites/plugin.mejoras.comites.listadoPreAsuntos'
        ,eventName : 'listado'
        ,limit:5
        ,reader: new Ext.data.JsonReader({
            root : 'asuntos'
	...
	Ext.onReady(function()
	{
	    ...
	    //Hace la búsqueda inicial
	    asuntosStore.webflow({idComite:'${dtoSesionComite.comite.id}'});
	});	
