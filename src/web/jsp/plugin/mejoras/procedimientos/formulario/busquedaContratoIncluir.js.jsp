...
<fwk:page>
	...
	var btnIncluir = new Ext.Button({
		text : '<s:message code="plugin.mejoras.procedimiento.incluirContrato.formulario.button.incluir" text="**Incluir contratos seleccionados" />'
		,iconCls:'icon_ok'
		,handler : function(){
      		page.webflow({
      			flow:'plugin.mejoras.procedimientos.incluirContratoUpdate'
				,eventName: 'update'
      			,params:{
