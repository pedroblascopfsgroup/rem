...
(function(){
	...
	var nombreAsunto = '<s:message text="${procedimiento.asunto.nombre}" javaScriptEscape="true" />';
	var href = 'javascript:app.abreAsunto(${procedimiento.asunto.id}, &quot;'+nombreAsunto+'&quot;,null);'
	var link = '<a href="'+href+'">'+nombreAsunto+'</a>';
	...
	var contratoPase=app.creaLabel('<s:message code="plugin.mejoras.procedimiento.tabcabecera.contratoPase" text="**Contrato pase"/>','${contratoPrincipal.codigoContrato}',{labelStyle:labelStyle2});
	...
	var panelAsunto = new Ext.form.FieldSet({
		    ...
		    ,items : [{items:[asunto,despacho,fechaInicio,contratoPase]},
