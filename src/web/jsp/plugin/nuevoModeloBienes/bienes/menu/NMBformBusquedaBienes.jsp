...
var formBusquedaBienes=function(){
	...
	var txtIdBien = app.creaInteger('id', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.codBien" text="**C�digo del bien" />', '${id}'); 
	var txtPoblacion = app.creaText('poblacion', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.poblacion" text="**Poblaci�n" />', '${poblacion}');
	var txtCodPostal = app.creaText('codPostal', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.codPostal" text="**C�digo Postal" />', '${codPostal}');
	...
	var txtNumActivo = app.creaInteger('numActivo', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.numActivo" text="**N� activo" />', '${numActivo}'); 
	var txtNumRegistro = app.creaInteger('numRegistro', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.numRegistro" text="**N� registro" />', '${numRegistro}'); 
	...
	var txtCodigoPostal = app.creaText('codigoPostal', '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.filtros.codPostal" text="**C�digo Postal" />', '${codigoPostal}');
	
	
	var buttonsR = <app:includeArray files="${buttonsRight}" />;
	var buttonsL = <app:includeArray files="${buttonsLeft}" />;
	
<%-- ************************* PESTA�A 1 FILTROS BIEN *************************************** --%>
...
<%-- ************************* PESTA�A 3 FILTROS BIEN LOCALIZACI�N *************************************** --%>
...
<%-- **************************** PANEL QUE CONTIENE EL PANEL DE PESTA�AS******************** --%>
	...
	var bienesCm = new Ext.grid.ColumnModel([
		...
		,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.numActivo" text="**N� activo"/>', sortable: false, dataIndex: 'numActivo'}
	    ...
	    ,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.descripcion" text="**Descipci�n"/>', width: 200, sortable: true, dataIndex: 'descripcionBien'}
	    ,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.poblacion" text="**Poblaci�n"/>', width: 200, sortable: false, dataIndex: 'poblacion'}
	    ...
	    ,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.idBien" text="**C�digo"/>', dataIndex: 'id', sortable: true, hidden:true}
...
<%-- 		,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.numRegistro" text="**N� registro"/>', sortable: false, dataIndex: 'numRegistro', hidden:true} --%>
...
<%-- 		,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.direccion" text="**Direcci�n"/>', sortable: false, dataIndex: 'direccion', hidden:true} --%>
...
<%-- 		,{header: '<s:message code="plugin.nuevoModeloBienes.busquedaBienes.grid.codigoPostal" text="**C�digo postal"/>', sortable: false, dataIndex: 'codigoPostal', hidden:true} --%>
	]);
