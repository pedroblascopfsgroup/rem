...
var cb_otrosTitulares = items[6 + muestraBotonGuardar];
var n_numeroOtrosTitulares = items[7 + muestraBotonGuardar];
var ta_descOtrosTitulares = items[8 + muestraBotonGuardar];

n_numeroOtrosTitulares.setDisabled(true);
n_numeroOtrosTitulares.setValue('');
ta_descOtrosTitulares.setDisabled(true);
ta_descOtrosTitulares.setValue('');

cb_otrosTitulares.on('select', function(){
	if(cb_otrosTitulares.getValue() == '01') {//si
		n_numeroOtrosTitulares.setDisabled(false);
		ta_descOtrosTitulares.setDisabled(false);
	}
	else if(cb_otrosTitulares.getValue() == '02') {//no
		n_numeroOtrosTitulares.setDisabled(true);
		n_numeroOtrosTitulares.setValue('');
		ta_descOtrosTitulares.setDisabled(true);
		ta_descOtrosTitulares.setValue('');
