...
var cb_suspender = items[2 + muestraBotonGuardar];
var cb_requerida = items[3 + muestraBotonGuardar];
var cb_notaSimple = items[4 + muestraBotonGuardar];
var cb_motivoSuspension = items[5 + muestraBotonGuardar];
...
cb_suspender.on('select', function(){
	...
	cb_notaSimple.setValue('');
	
	if(cb_suspender.getValue() == '01') {//si
		cb_motivoSuspension.setDisabled(false);
		cb_requerida.setDisabled(true);
		cb_notaSimple.setDisabled(true);
	}
	else if(cb_suspender.getValue() == '02') {//no
		cb_motivoSuspension.setDisabled(true);
		cb_requerida.setDisabled(false);
		cb_notaSimple.setDisabled(false);
	}
});
