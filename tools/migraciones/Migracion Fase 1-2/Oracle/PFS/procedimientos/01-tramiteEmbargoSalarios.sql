...
--Values(S_DD_TPO_TIPO_PROCEDIMIENTO.nextval, 'P09', 'Embargo de Salarios', 'Trámite de Embargo de Salarios', '<h1>FIXME</h1>Texto descripcion tarea... ', 'tramiteEmbargoSalarios', 0, 'DD', SYSDATE, 0);
...
Values(S_TAP_TAREA_PROCEDIMIENTO.nextval, (select DD_TPO_ID from DD_TPO_TIPO_PROCEDIMIENTO where DD_TPO_CODIGO='P09'), 'P09_SolicitarNotificacion', 0, 'Solicitar la notificación Ret. pagador', 0, 'DD', SYSDATE, 0);
