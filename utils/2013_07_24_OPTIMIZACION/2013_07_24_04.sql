...
AS
   SELECT DISTINCT tar_id, tar_id, asu_nombre, dd_tpo_descripcion, nombre_cliente, exp_descripcion, est_id, pef_id_gestor, pef_id_supervisor, CAST (MAX (usugestor) AS NUMBER (16)),
              ...
              FROM (SELECT tar.tar_id, asu.asu_nombre, tpo.dd_tpo_descripcion,
                           ...
                           asu.asu_id, tar.tar_id_dest, tar.tar_emisor, tipo_anotacion, CASE
                              WHEN flag_envio_correo = 1
                                 THEN 'true'
                              ELSE 'false'
                           END flag_envio_correo, tarusu.usu_id, 'UGASTareaEncontrada' AS dtype
